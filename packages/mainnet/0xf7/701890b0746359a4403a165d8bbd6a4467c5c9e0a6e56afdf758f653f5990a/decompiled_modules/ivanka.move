module 0xf7701890b0746359a4403a165d8bbd6a4467c5c9e0a6e56afdf758f653f5990a::ivanka {
    ...
    fun init(arg0: IVANKA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/4ymkKp2gri9M1sNb4ZJ1H8YutdNeneiQZESawasqpump.png?size=lg&key=45df2b                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<IVANKA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"IVANKA  ")))), trim_right(b"Ivanka Trump                    "), trim_right(b"Get ready to supercharge your portfolio with an amazing coin! Invest now and watch your wealth grow!                                                                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
