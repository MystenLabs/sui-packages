module 0xf75ecb1f190021c29eb2d4ca8c766d28749acd272972ca734350fb5539e6e295::cnsnft7766 {
    struct CNSNFT7766 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7766, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7676"));
        let v4 = 0x2::package::claim<CNSNFT7766>(arg0, arg1);
