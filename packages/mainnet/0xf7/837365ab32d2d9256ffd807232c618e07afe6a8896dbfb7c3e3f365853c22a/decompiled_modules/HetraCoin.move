module 0xf7837365ab32d2d9256ffd807232c618e07afe6a8896dbfb7c3e3f365853c22a::HetraCoin {
    ...
    fun create_currency_internal(arg0: HETRACOIN, arg1: &mut 0x2::tx_context::TxContext) : (0x2::coin::TreasuryCap<HETRACOIN>, 0x2::coin::CoinMetadata<HETRACOIN>) {
        0x2::coin::create_currency<HETRACOIN>(arg0, 9, b"HETRA", b"HetraCoin", b"The official decentralized gaming token powering the Hetrafi ecosystem", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://cyan-careful-badger-476.mypinata.cloud/ipfs/bafkreic3li5r3gt3wqrbkepq23ru5nckeoxfpbzelondeix3usfdvqmbii")), arg1)
    }
