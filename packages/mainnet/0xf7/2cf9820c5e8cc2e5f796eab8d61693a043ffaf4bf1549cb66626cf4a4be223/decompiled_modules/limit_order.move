module 0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order {
    ...
    public fun cancel_order_by_keeper<T0, T1>(arg0: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::BaseConfig, arg1: &mut RateOrdersIndexer<T0, T1>, arg2: &mut LimitOrder<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::checked_package_version(arg0);
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::checked_keeper(arg0, 0x2::tx_context::sender(arg4));
        let v0 = 0;
    ...
    public fun cancel_order_by_owner<T0, T1>(arg0: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::BaseConfig, arg1: &mut RateOrdersIndexer<T0, T1>, arg2: &mut LimitOrder<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::checked_package_version(arg0);
        assert!(arg2.owner == 0x2::tx_context::sender(arg4), 13);
        cancel_order<T0, T1>(arg1, arg2, 2, arg3, arg4);
    }

    public fun claim_target_coin<T0, T1>(arg0: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::BaseConfig, arg1: &mut LimitOrder<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::checked_package_version(arg0);
    ...
    public fun create_indexer_and_place_limit_order<T0, T1>(arg0: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::BaseConfig, arg1: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::LimitOrderConfig, arg2: &mut RateOrdersIndexers, arg3: &mut UserOrdersIndexer, arg4: 0x2::coin::Coin<T0>, arg5: u128, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::checked_package_version(arg0);
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::checked_pool_token_types<T0, T1>(arg1);
        assert!(arg5 > 0, 15);
    ...
    public fun create_rate_orders_indexer<T0, T1>(arg0: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::BaseConfig, arg1: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::LimitOrderConfig, arg2: &mut RateOrdersIndexers, arg3: &mut 0x2::tx_context::TxContext) {
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::checked_package_version(arg0);
        0x2::transfer::public_share_object<RateOrdersIndexer<T0, T1>>(create_rate_orders_indexer_internal<T0, T1>(arg1, arg2, arg3));
    }

    fun create_rate_orders_indexer_internal<T0, T1>(arg0: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::LimitOrderConfig, arg1: &mut RateOrdersIndexers, arg2: &mut 0x2::tx_context::TxContext) : RateOrdersIndexer<T0, T1> {
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::checked_pool_token_types<T0, T1>(arg0);
    ...
    fun delete_limit_order<T0, T1>(arg0: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::LimitOrderConfig, arg1: LimitOrder<T0, T1>, arg2: &mut UserOrdersIndexer, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(arg1.canceled_ts != 18446744073709551615, 8);
        assert!(0x2::clock::timestamp_ms(arg3) > arg1.canceled_ts + 0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::get_deletion_grace_period(arg0), 12);
        delete_user_order_indexes<T0, T1>(&arg1, arg2, arg4);
        destroy_limit_order<T0, T1>(arg1);
    }

    public fun delete_order<T0, T1>(arg0: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::BaseConfig, arg1: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::LimitOrderConfig, arg2: LimitOrder<T0, T1>, arg3: &mut UserOrdersIndexer, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::checked_package_version(arg0);
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::checked_keeper(arg0, 0x2::tx_context::sender(arg5));
    ...
    public fun flash_loan<T0, T1>(arg0: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::BaseConfig, arg1: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::LimitOrderConfig, arg2: &mut LimitOrder<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoanReceipt<T1>) {
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::checked_package_version(arg0);
        let v0 = 0x2::tx_context::sender(arg5);
        if (0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::get_require_flash_loan_auth(arg1)) {
            0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::checked_keeper(arg0, v0);
        };
        assert!(arg3 > 0, 5);
        assert!(0x2::clock::timestamp_ms(arg4) < arg2.expire_ts, 6);
        assert!(0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::check_token_and_min_trade_amount<T0>(arg1, arg3), 14);
        ...
        let v2 = (v1 as u64);
        let v3 = v2;
        let v4 = mul_div_ceil((arg2.total_pay_amount as u128), 1000000000000000000, arg2.rate);
        assert!(v4 <= (18446744073709551615 as u128), 16);
        let v5 = (v4 as u64);
        if (arg2.obtained_amount + v2 >= v5) {
            v3 = v5 - arg2.obtained_amount;
            arg2.obtained_amount = v5;
        } else {
            arg2.obtained_amount = arg2.obtained_amount + v2;
        };
        let v6 = FlashLoanReceipt<T1>{
        ...
        (0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg2.pay_balance, arg3), arg5), v6)
    }
    ...
    public fun place_limit_order<T0, T1>(arg0: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::BaseConfig, arg1: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::LimitOrderConfig, arg2: &mut RateOrdersIndexer<T0, T1>, arg3: &mut UserOrdersIndexer, arg4: 0x2::coin::Coin<T0>, arg5: u128, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::checked_package_version(arg0);
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::checked_pool_token_types<T0, T1>(arg1);
        assert!(arg5 > 0, 15);
        assert!(0x2::coin::value<T0>(&arg4) > 0, 19);
    ...
    public fun repay_flash_loan<T0, T1>(arg0: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::BaseConfig, arg1: &0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::LimitOrderConfig, arg2: &mut 0x2::coin::Coin<T1>, arg3: &mut LimitOrder<T0, T1>, arg4: FlashLoanReceipt<T1>, arg5: &mut 0x2::tx_context::TxContext) {
        0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::base_config::checked_package_version(arg0);
        let v0 = 0x2::tx_context::sender(arg5);
        if (0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::get_require_flash_loan_auth(arg1)) {
            0xf72cf9820c5e8cc2e5f796eab8d61693a043ffaf4bf1549cb66626cf4a4be223::limit_order_config::checked_keeper(arg0, v0);
