module 0xf7a566b523396b7b416fc149730657eedcb3e7939f4433138c1dd14249838118::paths {
        ...
        while (v1 < 0x1::vector::length<PriceNode>(arg1)) {
            ...
            if (v4 > 0) {
                ...
                while (v5 < v4) {
                    ...
                    let v8 = 0xf7a566b523396b7b416fc149730657eedcb3e7939f4433138c1dd14249838118::arithmetic::mul_128(0x1::vector::borrow<Route>(&v3, v5).sqrtPrice, v2.sqrtPrice);
                    if (v8 > v7 || v6 < arg2) {
