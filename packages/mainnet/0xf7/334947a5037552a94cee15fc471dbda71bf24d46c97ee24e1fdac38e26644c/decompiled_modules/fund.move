module 0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::fund {
    ...
    public fun to_shares(arg0: &Fund, arg1: u64, arg2: bool) : u64 {
        ...
        if (arg2) {
            (0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::math128::mul_div_up((arg1 as u128), arg0.shares, arg0.underlying) as u64)
        } else {
            (0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::math128::mul_div_down((arg1 as u128), arg0.shares, arg0.underlying) as u64)
        }
    }
    ...
    public fun to_underlying(arg0: &Fund, arg1: u64, arg2: bool) : u64 {
        ...
        if (arg2) {
            (0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::math128::mul_div_up((arg1 as u128), arg0.underlying, arg0.shares) as u64)
        } else {
            (0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::math128::mul_div_down((arg1 as u128), arg0.underlying, arg0.shares) as u64)
        }
    }
