module 0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::linear_vesting_airdrop {
    ...
    public fun destroy_zero<T0>(arg0: Airdrop<T0>) {
        ...
        0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::bitmap::destroy(v5);
    }
    ...
    public fun new<T0>(arg0: 0x2::coin::Coin<T0>, arg1: vector<u8>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : Airdrop<T0> {
        ...
        Airdrop<T0>{
            ...
            start    : arg2,
            duration : arg3,
            map      : 0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::bitmap::new(arg5),
        }
    }
    ...
    public fun get_airdrop<T0>(arg0: &mut Airdrop<T0>, arg1: vector<vector<u8>>, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::linear_vesting_wallet::Wallet<T0> {
        ...
        0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::linear_vesting_wallet::new<T0>(0x2::coin::take<T0>(&mut arg0.balance, arg3, arg4), arg2, arg0.start, arg0.duration, arg4)
    }
