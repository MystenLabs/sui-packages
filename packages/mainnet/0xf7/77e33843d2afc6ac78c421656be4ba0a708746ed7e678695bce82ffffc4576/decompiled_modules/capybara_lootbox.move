module 0xf777e33843d2afc6ac78c421656be4ba0a708746ed7e678695bce82ffffc4576::capybara_lootbox {
    ...
    public fun mint_lootbox(arg0: &mut DataStorage, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg4 > 0) {
            ...
            0x2::transfer::public_transfer<NFTLootbox>(new_lootbox(arg8, arg0.total_lootbox), v0);
            arg4 = arg4 - 1;
        };
        let v2 = MintLootbox{
            from         : v0,
            lootboxes    : 0x1::vector::empty<0x2::object::ID>(),
            lootbox_idxs : 0x1::vector::empty<u64>(),
            random_id    : arg2,
        };
        0x2::event::emit<MintLootbox>(v2);
    }
    ...
    public fun update_storage(arg0: &0xf777e33843d2afc6ac78c421656be4ba0a708746ed7e678695bce82ffffc4576::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
