module 0xf7b6613bf20d39eef91bfd4f89a13f3969837555b5962e544cf2c3052f2f285f::cnsnft4321 {
    struct CNSNFT4321 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4321, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4321>(arg0, arg1);
