module 0xf766408b39384ff99fcfe49f0bed65799a4f9a8c35da8f18b25a9042be9b7a02::token17 {
    ...
    fun init(arg0: TOKEN17, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN17>(arg0, 9, b"li.fi", b"li.fi", b"", 0x1::option::none<0x2::url::Url>(), arg1);
