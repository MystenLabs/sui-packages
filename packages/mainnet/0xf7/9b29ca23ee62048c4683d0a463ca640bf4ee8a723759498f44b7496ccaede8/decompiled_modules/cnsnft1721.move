module 0xf79b29ca23ee62048c4683d0a463ca640bf4ee8a723759498f44b7496ccaede8::cnsnft1721 {
    struct CNSNFT1721 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1721, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7186"));
        let v4 = 0x2::package::claim<CNSNFT1721>(arg0, arg1);
