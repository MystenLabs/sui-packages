module 0xf71e85afa159e4b47e68841d5406f49254029ccd99d2402625d47d37810f992f::cnsnft5355 {
    struct CNSNFT5355 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5355, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5355>(arg0, arg1);
