module 0xf7070d7ced5d7b76879ec77df4c3057a14f5db5b38ff50d3d434e8536c111240::reward2208 {
    struct REWARD2208 has drop {
        dummy_field: bool,
    }

    struct TICKET_2208 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2208(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2208>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2208>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2208, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2208>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2208>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2208>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2208>>(v5, 0x2::tx_context::sender(arg1));
    }
