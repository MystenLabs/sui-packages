module 0xf781d9c9c78d8ecc277d3a8e8ce544cfcf6617497f96e059ad4acb4386f71c29::alloy {
    ...
    struct MarketInstance has store {
        market_name: 0x1::string::String,
        guesses: 0xf781d9c9c78d8ecc277d3a8e8ce544cfcf6617497f96e059ad4acb4386f71c29::big_queue::BigQueue<Guess>,
        round_number: u64,
        ai_prediction: 0x1::option::Option<u64>,
    ...
    public fun create_market_instance<T0>(arg0: &MarketAdminCap, arg1: &mut MarketConfig, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = MarketInstance{
            market_name         : arg3,
            guesses             : 0xf781d9c9c78d8ecc277d3a8e8ce544cfcf6617497f96e059ad4acb4386f71c29::big_queue::new<Guess>(5000, arg7),
    ...
    public fun delete_earliest_market_instance<T0>(arg0: &MarketAdminCap, arg1: &mut MarketConfig, arg2: 0x1::string::String, arg3: 0x1::string::String) {
        ...
        0xf781d9c9c78d8ecc277d3a8e8ce544cfcf6617497f96e059ad4acb4386f71c29::big_queue::drop<Guess>(v3);
    }
    ...
    public fun place_guess<T0>(arg0: &mut MarketConfig, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: address, arg5: u64, arg6: 0x2::coin::Coin<T0>, arg7: 0x1::string::String, arg8: &0x2::clock::Clock) {
        ...
        0xf781d9c9c78d8ecc277d3a8e8ce544cfcf6617497f96e059ad4acb4386f71c29::big_queue::push_back<Guess>(&mut v3.guesses, v4);
    }
    ...
    public fun release_unsettled_market<T0>(arg0: &MarketAdminCap, arg1: &mut MarketConfig, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: &0x2::clock::Clock, arg6: 0x1::option::Option<u64>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<u64>(&arg6)) {
            v2 = 0xf781d9c9c78d8ecc277d3a8e8ce544cfcf6617497f96e059ad4acb4386f71c29::big_queue::length<Guess>(&v1.guesses) - *0x1::option::borrow<u64>(&arg6);
        };
        while (0xf781d9c9c78d8ecc277d3a8e8ce544cfcf6617497f96e059ad4acb4386f71c29::big_queue::length<Guess>(&v1.guesses) > v2) {
            let v3 = 0xf781d9c9c78d8ecc277d3a8e8ce544cfcf6617497f96e059ad4acb4386f71c29::big_queue::pop_front<Guess>(&mut v1.guesses);
        ...
        if (0xf781d9c9c78d8ecc277d3a8e8ce544cfcf6617497f96e059ad4acb4386f71c29::big_queue::length<Guess>(&v1.guesses) == 0) {
            v1.released = true;
