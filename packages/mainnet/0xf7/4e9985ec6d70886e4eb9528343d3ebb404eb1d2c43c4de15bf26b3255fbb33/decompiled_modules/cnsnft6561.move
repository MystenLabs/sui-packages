module 0xf74e9985ec6d70886e4eb9528343d3ebb404eb1d2c43c4de15bf26b3255fbb33::cnsnft6561 {
    struct CNSNFT6561 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6561, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6561>(arg0, arg1);
