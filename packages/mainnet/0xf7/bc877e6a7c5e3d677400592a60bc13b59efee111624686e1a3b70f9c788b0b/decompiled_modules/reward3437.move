module 0xf7bc877e6a7c5e3d677400592a60bc13b59efee111624686e1a3b70f9c788b0b::reward3437 {
    struct REWARD3437 has drop {
        dummy_field: bool,
    }

    struct TICKET_3437 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3437(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3437>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3437>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3437, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3437>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3437>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3437>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3437>>(v5, 0x2::tx_context::sender(arg1));
    }
