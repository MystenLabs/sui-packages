module 0xf772a0848296f0f8d3ca35e3c73b477e7fee4bd9a9c6b118f16fa9ff5ae8e2b4::cnsnft5802 {
    struct CNSNFT5802 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5802, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5453"));
        let v4 = 0x2::package::claim<CNSNFT5802>(arg0, arg1);
