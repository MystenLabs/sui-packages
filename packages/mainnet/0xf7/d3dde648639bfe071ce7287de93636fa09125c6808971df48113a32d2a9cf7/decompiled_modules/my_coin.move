module 0xf7d3dde648639bfe071ce7287de93636fa09125c6808971df48113a32d2a9cf7::my_coin {
    ...
    fun init(arg0: MY_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MY_COIN>(arg0, 2, b"Feng Yi Yuan", b"FYY", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://fyy-hk.oss-cn-hongkong.aliyuncs.com/coin-icon/fyy.jpg")), arg1);
