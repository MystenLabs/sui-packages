module 0xf7e83bdff289b61a3f3b794943c4f809f950b22abb4938e92a9b96c4b56ea30a::cross_chain_airdrop {
    ...
    struct PerContractAirdropInfo has store {
        ...
        claimed_source_token_ids: vector<0xf7e83bdff289b61a3f3b794943c4f809f950b22abb4938e92a9b96c4b56ea30a::erc721_metadata::TokenID>,
    }
    ...
    public entry fun claim(arg0: &mut CrossChainAirdropOracle, arg1: address, arg2: vector<u8>, arg3: u256, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0xf7e83bdff289b61a3f3b794943c4f809f950b22abb4938e92a9b96c4b56ea30a::erc721_metadata::new_token_id(arg3);
        assert!(!is_token_claimed(v0, &v1), 0);
        mint(arg4, arg7, arg6, arg1, arg8);
        0x1::vector::push_back<0xf7e83bdff289b61a3f3b794943c4f809f950b22abb4938e92a9b96c4b56ea30a::erc721_metadata::TokenID>(&mut v0.claimed_source_token_ids, v1);
    }
    ...
    fun create_contract(arg0: &mut CrossChainAirdropOracle, arg1: &vector<u8>) : &mut PerContractAirdropInfo {
        ...
        let v1 = PerContractAirdropInfo{
            ...
            claimed_source_token_ids : 0x1::vector::empty<0xf7e83bdff289b61a3f3b794943c4f809f950b22abb4938e92a9b96c4b56ea30a::erc721_metadata::TokenID>(),
        };
    ...
    fun init(arg0: CROSS_CHAIN_AIRDROP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://twitter.com/staccoverflow"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"notStacc"));
    ...
    fun is_token_claimed(arg0: &PerContractAirdropInfo, arg1: &0xf7e83bdff289b61a3f3b794943c4f809f950b22abb4938e92a9b96c4b56ea30a::erc721_metadata::TokenID) : bool {
        let v0 = 0;
        while (v0 < 0x1::vector::length<0xf7e83bdff289b61a3f3b794943c4f809f950b22abb4938e92a9b96c4b56ea30a::erc721_metadata::TokenID>(&arg0.claimed_source_token_ids)) {
            if (0x1::vector::borrow<0xf7e83bdff289b61a3f3b794943c4f809f950b22abb4938e92a9b96c4b56ea30a::erc721_metadata::TokenID>(&arg0.claimed_source_token_ids, v0) == arg1) {
                return true
            };
            v0 = v0 + 1;
        };
