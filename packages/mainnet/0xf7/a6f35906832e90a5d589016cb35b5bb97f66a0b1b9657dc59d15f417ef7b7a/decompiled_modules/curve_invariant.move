module 0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::curve_invariant {
    public(friend) fun a(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: &0x2::clock::Clock) : u256 {
        let v0 = 0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::uint_convert::to_u256(0x2::clock::timestamp_ms(arg4));
        if (v0 >= arg3) {
            return arg2
        };
        if (arg2 > arg0) {
    ...
    public(friend) fun d(arg0: u256, arg1: vector<u256>) : u256 {
        ...
        if (v0 == 0) {
            ...
            let v3 = 0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::uint_convert::to_u256(v2);
            let v4 = v0;
            let v5 = arg0 * v3;
            let v6 = 100;
            let v7 = 0;
    ...
    public(friend) fun y(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: vector<u256>) : u256 {
        ...
        let v1 = v0;
        let v2 = 0;
        let v3 = 0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::uint_convert::to_u256(0x1::vector::length<u256>(&arg4));
        let v4 = arg0 * v3;
        let v5 = 100;
        let v6 = 0;
        while (v3 > v6) {
            if (v6 == arg1) {
                ...
                let v8 = *0x1::vector::borrow<u256>(&arg4, 0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::uint_convert::to_u64(v6));
                v2 = v2 + v8;
                let v9 = v1 * v0;
                v1 = v9 / v8 * v3;
            };
    ...
    public(friend) fun y_d(arg0: u256, arg1: u256, arg2: vector<u256>, arg3: u256) : u256 {
        let v0 = arg3;
        let v1 = 0;
        let v2 = 0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::uint_convert::to_u256(0x1::vector::length<u256>(&arg2));
        let v3 = arg0 * v2;
        let v4 = 0;
        while (v2 > v4) {
            if (v4 != arg1) {
                let v5 = *0x1::vector::borrow<u256>(&arg2, 0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::uint_convert::to_u64(v4));
                v1 = v1 + v5;
                let v6 = v0 * arg3;
                v0 = v6 / v5 * v2;
            };
