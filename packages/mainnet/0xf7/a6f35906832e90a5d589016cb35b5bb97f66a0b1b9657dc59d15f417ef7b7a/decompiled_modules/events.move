module 0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::events {
    ...
    public(friend) fun swap(arg0: address, arg1: 0x1::type_name::TypeName, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u256>) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<Swap>(v0);
    }
    ...
    public(friend) fun add_liquidity(arg0: address, arg1: vector<0x1::type_name::TypeName>, arg2: vector<u64>, arg3: vector<u256>, arg4: vector<u256>, arg5: u64) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<AddLiquidity>(v0);
    }
    ...
    public(friend) fun commit_stable_fee(arg0: address, arg1: 0x1::option::Option<u256>, arg2: 0x1::option::Option<u256>) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<CommitStableFee>(v0);
    }

    public(friend) fun finish_super_admin_transfer(arg0: address) {
        let v0 = FinishSuperAdminTransfer{pos0: arg0};
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<FinishSuperAdminTransfer>(v0);
    }

    public(friend) fun new_admin(arg0: address) {
        let v0 = NewAdmin{pos0: arg0};
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<NewAdmin>(v0);
    }
    ...
    public(friend) fun new_pool(arg0: address, arg1: address, arg2: vector<0x1::type_name::TypeName>, arg3: 0x1::type_name::TypeName, arg4: u256) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<NewPool>(v0);
    }

    public(friend) fun pause(arg0: address) {
        let v0 = Paused{pos0: arg0};
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<Paused>(v0);
    }
    ...
    public(friend) fun ramp_a(arg0: address, arg1: u256, arg2: u256, arg3: u256, arg4: u256) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<RampA>(v0);
    }

    public(friend) fun remove_admin(arg0: address) {
        let v0 = RemoveAdmin{pos0: arg0};
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<RemoveAdmin>(v0);
    }
    ...
    public(friend) fun remove_liquidity(arg0: address, arg1: vector<0x1::type_name::TypeName>, arg2: u64, arg3: vector<u64>, arg4: vector<u256>) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<RemoveLiquidity>(v0);
    }
    ...
    public(friend) fun remove_liquidity_one_coin(arg0: address, arg1: 0x1::type_name::TypeName, arg2: u64, arg3: u64, arg4: u64, arg5: vector<u256>) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<RemoveLiquidityOneCoin>(v0);
    }
    ...
    public(friend) fun start_super_admin_transfer(arg0: address, arg1: u64) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<StartSuperAdminTransfer>(v0);
    }
    ...
    public(friend) fun stop_ramp_a(arg0: address, arg1: u256, arg2: u64) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<StopRampA>(v0);
    }
    ...
    public(friend) fun take_fees(arg0: address, arg1: 0x1::type_name::TypeName, arg2: u64) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<TakeFees>(v0);
    }

    public(friend) fun unpause(arg0: address) {
        let v0 = Unpaused{pos0: arg0};
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<Unpaused>(v0);
    }
    ...
    public(friend) fun update_stable_fee(arg0: address, arg1: u256, arg2: u256) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::event_wrapper::emit_event<UpdateStableFee>(v0);
    }
