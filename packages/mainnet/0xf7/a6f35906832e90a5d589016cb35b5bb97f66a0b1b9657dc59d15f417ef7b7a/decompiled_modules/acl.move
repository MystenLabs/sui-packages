module 0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::acl {
    ...
    public fun destroy_admin(arg0: &mut InterestStableSwapACL, arg1: InterestStableSwapAdmin) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::events::remove_admin(0x2::object::uid_to_address(&v0));
        0x2::object::delete(v0);
    }
    ...
    public fun finish_transfer(arg0: InterestStableSwapSuperAdmin, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::events::finish_super_admin_transfer(v0);
    }
    ...
    public fun new_admin(arg0: &mut InterestStableSwapACL, arg1: &InterestStableSwapSuperAdmin, arg2: &mut 0x2::tx_context::TxContext) : InterestStableSwapAdmin {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::events::new_admin(0x2::object::uid_to_address(&v0.id));
        v0
    }
    ...
    public fun revoke(arg0: &mut InterestStableSwapACL, arg1: &InterestStableSwapSuperAdmin, arg2: address) {
        ...
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::events::remove_admin(arg2);
    }
    ...
    public fun start_transfer(arg0: &mut InterestStableSwapSuperAdmin, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.new_admin = arg1;
        0xf7a6f35906832e90a5d589016cb35b5bb97f66a0b1b9657dc59d15f417ef7b7a::events::start_super_admin_transfer(arg1, arg0.deadline);
    }
