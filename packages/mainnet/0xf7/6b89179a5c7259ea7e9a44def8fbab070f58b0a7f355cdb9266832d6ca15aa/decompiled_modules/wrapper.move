module 0xf76b89179a5c7259ea7e9a44def8fbab070f58b0a7f355cdb9266832d6ca15aa::wrapper {
    ...
    public fun admin_withdraw_deep_reserves_coverage_fee<T0>(arg0: &0xf76b89179a5c7259ea7e9a44def8fbab070f58b0a7f355cdb9266832d6ca15aa::admin::AdminCap, arg1: &mut Wrapper, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        abort 13906835179365859331
    }

    public fun admin_withdraw_deep_reserves_coverage_fee_v2<T0>(arg0: &mut Wrapper, arg1: &0xf76b89179a5c7259ea7e9a44def8fbab070f58b0a7f355cdb9266832d6ca15aa::admin::AdminCap, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        withdraw_deep_reserves_coverage_fee_internal<T0>(arg0, arg2)
    }

    public fun admin_withdraw_protocol_fee<T0>(arg0: &0xf76b89179a5c7259ea7e9a44def8fbab070f58b0a7f355cdb9266832d6ca15aa::admin::AdminCap, arg1: &mut Wrapper, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        abort 13906835248085336067
    }

    public fun admin_withdraw_protocol_fee_v2<T0>(arg0: &mut Wrapper, arg1: &0xf76b89179a5c7259ea7e9a44def8fbab070f58b0a7f355cdb9266832d6ca15aa::admin::AdminCap, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
    ...
    public fun create_fund_cap(arg0: &0xf76b89179a5c7259ea7e9a44def8fbab070f58b0a7f355cdb9266832d6ca15aa::admin::AdminCap, arg1: &Wrapper, arg2: &mut 0x2::tx_context::TxContext) : FundCap {
        abort 13906835041926905859
    }

    public fun create_fund_cap_v2(arg0: &Wrapper, arg1: &0xf76b89179a5c7259ea7e9a44def8fbab070f58b0a7f355cdb9266832d6ca15aa::admin::AdminCap, arg2: &mut 0x2::tx_context::TxContext) : FundCap {
        FundCap{
    ...
    public fun withdraw_deep_reserves(arg0: &0xf76b89179a5c7259ea7e9a44def8fbab070f58b0a7f355cdb9266832d6ca15aa::admin::AdminCap, arg1: &mut Wrapper, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP> {
        abort 13906835308214878211
    }
    ...
    public fun withdraw_deep_reserves_coverage_fee_v2<T0>(arg0: &mut Wrapper, arg1: &FundCap, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg1.wrapper_id == 0x2::object::uid_to_inner(&arg0.id), 13906834419156516865);
        withdraw_deep_reserves_coverage_fee_internal<T0>(arg0, arg2)
    }

    public fun withdraw_deep_reserves_v2(arg0: &mut Wrapper, arg1: &0xf76b89179a5c7259ea7e9a44def8fbab070f58b0a7f355cdb9266832d6ca15aa::admin::AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP> {
