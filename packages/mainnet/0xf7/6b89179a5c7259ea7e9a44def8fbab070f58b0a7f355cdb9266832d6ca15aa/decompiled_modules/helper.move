module 0xf76b89179a5c7259ea7e9a44def8fbab070f58b0a7f355cdb9266832d6ca15aa::helper {
    public(friend) fun apply_slippage(arg0: u64, arg1: u64) : u64 {
        if (arg0 == 0) {
            return 0
        };
        arg0 + 0xf76b89179a5c7259ea7e9a44def8fbab070f58b0a7f355cdb9266832d6ca15aa::math::mul(arg0, arg1)
    }
    ...
    public(friend) fun get_sui_per_deep<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &0x2::clock::Clock) : u64 {
        ...
        if (v0 == v2) {
            ...
            0xf76b89179a5c7259ea7e9a44def8fbab070f58b0a7f355cdb9266832d6ca15aa::math::div(1000000000, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::mid_price<T0, T1>(arg0, arg1))
        }
    }
