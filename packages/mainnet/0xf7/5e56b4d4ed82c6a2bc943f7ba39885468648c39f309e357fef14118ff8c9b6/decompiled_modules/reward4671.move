module 0xf75e56b4d4ed82c6a2bc943f7ba39885468648c39f309e357fef14118ff8c9b6::reward4671 {
    struct REWARD4671 has drop {
        dummy_field: bool,
    }

    struct TICKET_4671 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4671(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4671>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4671>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4671, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4671>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4671>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4671>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4671>>(v5, 0x2::tx_context::sender(arg1));
    }
