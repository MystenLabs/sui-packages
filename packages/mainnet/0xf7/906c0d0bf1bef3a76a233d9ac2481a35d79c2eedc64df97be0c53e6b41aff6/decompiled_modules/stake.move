module 0xf7906c0d0bf1bef3a76a233d9ac2481a35d79c2eedc64df97be0c53e6b41aff6::stake {
    ...
    public fun stake<T0>(arg0: &mut GlobalConfig<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 < 3, 2);
        let v0 = 0;
        let v1 = 0;
        if (arg2 == 0) {
    ...
    fun create_config<T0>(arg0: &AdminCapability, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun unstake<T0>(arg0: &mut GlobalConfig<T0>, arg1: &mut Stake<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
