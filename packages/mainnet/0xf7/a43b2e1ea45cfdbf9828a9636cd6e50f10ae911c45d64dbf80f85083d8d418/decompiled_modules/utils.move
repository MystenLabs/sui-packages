module 0xf7a43b2e1ea45cfdbf9828a9636cd6e50f10ae911c45d64dbf80f85083d8d418::utils {
    ...
    public fun check_is_fix_coin_a(arg0: u128, arg1: u128, arg2: u128, arg3: u64, arg4: u64) : (bool, u64, u64) {
        let (v0, v1) = 0x40b6713907acadc6c8b8d9d98f36d2f24f80bd08440d5477f9f868e3b5e1e12d::liquidity_math::get_amounts_for_liquidity(arg2, arg0, arg1, 0x40b6713907acadc6c8b8d9d98f36d2f24f80bd08440d5477f9f868e3b5e1e12d::liquidity_math::get_liquidity_for_amounts(arg2, arg0, arg1, arg3, arg4), false);
        let v2 = true;
        if (v0 == arg3) {
            v2 = true;
        } else if (v1 == arg4) {
