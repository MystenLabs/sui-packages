module 0x9d515d7da4e0cd99321cf69fa2a33decb3b1cd9e769a7b316219bc552a130b4c::usdc {
    ...
    fun init(arg0: USDC, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v1;
        0x2::coin::mint_and_transfer<USDC>(&mut v3, 0x1::u64::pow(10, v0 + 3), 0x2::tx_context::sender(arg1), arg1);
        let v4 = Treasury{
