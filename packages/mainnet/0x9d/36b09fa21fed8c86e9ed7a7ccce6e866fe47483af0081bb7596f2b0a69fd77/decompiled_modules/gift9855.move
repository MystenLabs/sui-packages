module 0x9d36b09fa21fed8c86e9ed7a7ccce6e866fe47483af0081bb7596f2b0a69fd77::gift9855 {
    struct GIFT9855 has drop {
        dummy_field: bool,
    }

    struct TICKET_9855 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9855(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9855>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9855>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9855, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9855>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9855>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9855>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9855>>(v5, 0x2::tx_context::sender(arg1));
    }
