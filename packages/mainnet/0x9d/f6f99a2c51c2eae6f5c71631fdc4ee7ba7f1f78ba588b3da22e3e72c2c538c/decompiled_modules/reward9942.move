module 0x9df6f99a2c51c2eae6f5c71631fdc4ee7ba7f1f78ba588b3da22e3e72c2c538c::reward9942 {
    struct REWARD9942 has drop {
        dummy_field: bool,
    }

    struct TICKET_9942 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9942(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9942>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9942>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9942, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9942>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9942>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9942>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9942>>(v5, 0x2::tx_context::sender(arg1));
    }
