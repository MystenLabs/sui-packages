module 0x9dfa517b55742b4439a7621a8a0cf4a401e965816d687d3bad4c418ba2808baf::reward7133 {
    struct REWARD7133 has drop {
        dummy_field: bool,
    }

    struct TICKET_7133 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7133(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7133>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7133>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7133, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7133>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7133>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7133>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7133>>(v5, 0x2::tx_context::sender(arg1));
    }
