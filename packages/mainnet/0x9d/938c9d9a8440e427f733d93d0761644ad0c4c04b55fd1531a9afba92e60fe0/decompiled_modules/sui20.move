module 0x9d938c9d9a8440e427f733d93d0761644ad0c4c04b55fd1531a9afba92e60fe0::sui20 {
    ...
    public fun set_wrapped_coin<T0>(arg0: &mut Global, arg1: &mut AdminCap, arg2: 0x1::string::String, arg3: 0x2::coin::TreasuryCap<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::bag::contains<0x1::string::String>(&arg0.sui20tokens, arg2), 1003);
        assert!(!0x2::bag::contains<0x1::string::String>(&arg0.upgrade_bag, arg2), 1019);
        let v0 = Sui20WrapCoin<T0>{
            treasury_cap  : arg3,
            total_wrapped : 0,
        };
        0x2::bag::add<0x1::string::String, Sui20WrapCoin<T0>>(&mut arg0.upgrade_bag, arg2, v0);
    }
    ...
    public fun wrap<T0>(arg0: &mut Global, arg1: 0x1::string::String, arg2: Sui20, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 == arg1, 1021);
        0x2::object::delete(v0);
        0x2::coin::mint_and_transfer<T0>(&mut 0x2::bag::borrow_mut<0x1::string::String, Sui20WrapCoin<T0>>(&mut arg0.upgrade_bag, v1).treasury_cap, v2, arg3, arg4);
    }
