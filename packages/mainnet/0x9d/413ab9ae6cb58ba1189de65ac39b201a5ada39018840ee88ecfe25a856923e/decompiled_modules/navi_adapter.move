module 0x9d413ab9ae6cb58ba1189de65ac39b201a5ada39018840ee88ecfe25a856923e::navi_adapter {
    public fun select_withdraw_amount(arg0: u128, arg1: u128, arg2: u64) : u64 {
        0x3777fbddf314316bb4b3618538255b09eff5460de094f5084f21edbeacbec9a8::vault_math::select_withdraw_amount(arg0, arg1, arg2)
    }

    public fun calculate_real_balance(arg0: u256, arg1: u256) : u128 {
        calculate_real_normalized(arg0, arg1)
    }

    fun calculate_real_normalized(arg0: u256, arg1: u256) : u128 {
        saturating_u256_to_u128(0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::ray_math::ray_mul(arg0, arg1))
    }
    ...
    public fun get_underlying_balance<T0>(arg0: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg1: &0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg2: u8, arg3: address) : u128 {
        ...
        (normalized_underlying_to_asset_decimals(calculate_real_normalized(v0, v2), 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::get_coin_decimal<T0>(arg1)) as u128)
    }
