module 0x9d44a17fa511a47b433c5ac6937977596654292367aed7ef7f47d212bd2bd41d::liquidity_pool {
    ...
    public fun complete_fulfill_swap_request<T0, T1, T2>(arg0: &BankOwnerCap<T0>, arg1: address, arg2: SwapHotPotato, arg3: &mut Bank<T0>, arg4: &0x2::clock::Clock, arg5: 0x2::coin::Coin<T2>, arg6: u64, arg7: vector<vector<u8>>, arg8: u64, arg9: vector<u8>, arg10: vector<u8>, arg11: u16, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x9d44a17fa511a47b433c5ac6937977596654292367aed7ef7f47d212bd2bd41d::verification::verify_merkle_aggregation(arg6, arg9, arg7, 0x1::vector::borrow<MerkleRootState>(v3, 0).root), 7);
        ...
        assert!(0x9d44a17fa511a47b433c5ac6937977596654292367aed7ef7f47d212bd2bd41d::alt_bn128_bls::verify(arg10, arg9, 0x9d44a17fa511a47b433c5ac6937977596654292367aed7ef7f47d212bd2bd41d::alt_bn128_bls::hash_to_g1(0x9d44a17fa511a47b433c5ac6937977596654292367aed7ef7f47d212bd2bd41d::verification::create_swap_message_hash(v5, v0.expected_input_amount, v0.minimum_output_amount, v0.valid_till, 0x2::address::to_bytes(arg1), v4), (arg11 as u8))), 8);
        let v6 = SwapEvent{
            user                : v0.user,
    ...
    public fun update_merkle_root_state<T0>(arg0: &BankOwnerCap<T0>, arg1: &mut Bank<T0>, arg2: u64, arg3: vector<u8>, arg4: u64, arg5: vector<vector<u8>>, arg6: vector<u8>, arg7: vector<u8>, arg8: u16, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x9d44a17fa511a47b433c5ac6937977596654292367aed7ef7f47d212bd2bd41d::verification::verify_merkle_aggregation(arg4, arg6, arg5, 0x1::vector::borrow<MerkleRootState>(v0, 0).root), 7);
        assert!(0x9d44a17fa511a47b433c5ac6937977596654292367aed7ef7f47d212bd2bd41d::alt_bn128_bls::verify(arg7, arg6, 0x9d44a17fa511a47b433c5ac6937977596654292367aed7ef7f47d212bd2bd41d::alt_bn128_bls::hash_to_g1(0x9d44a17fa511a47b433c5ac6937977596654292367aed7ef7f47d212bd2bd41d::verification::create_merkle_root_message_hash(arg3, arg2), (arg8 as u8))), 8);
    ...
    public fun withdraw_tokens<T0, T1>(arg0: &BankOwnerCap<T0>, arg1: address, arg2: &mut Bank<T0>, arg3: address, arg4: u64, arg5: u64, arg6: u64, arg7: vector<vector<u8>>, arg8: u64, arg9: vector<u8>, arg10: vector<u8>, arg11: u16, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x9d44a17fa511a47b433c5ac6937977596654292367aed7ef7f47d212bd2bd41d::verification::verify_merkle_aggregation(arg6, arg9, arg7, 0x1::vector::borrow<MerkleRootState>(v2, 0).root), 7);
        assert!(0x9d44a17fa511a47b433c5ac6937977596654292367aed7ef7f47d212bd2bd41d::alt_bn128_bls::verify(arg10, arg9, 0x9d44a17fa511a47b433c5ac6937977596654292367aed7ef7f47d212bd2bd41d::alt_bn128_bls::hash_to_g1(0x9d44a17fa511a47b433c5ac6937977596654292367aed7ef7f47d212bd2bd41d::verification::create_withdrawal_message_hash(0x1::type_name::get<T1>(), arg4, arg5, arg3, arg1), (arg11 as u8))), 8);
