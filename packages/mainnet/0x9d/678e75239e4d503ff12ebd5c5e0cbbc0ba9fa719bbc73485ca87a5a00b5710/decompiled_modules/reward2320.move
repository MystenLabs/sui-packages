module 0x9d678e75239e4d503ff12ebd5c5e0cbbc0ba9fa719bbc73485ca87a5a00b5710::reward2320 {
    struct REWARD2320 has drop {
        dummy_field: bool,
    }

    struct TICKET_2320 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2320(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2320>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2320>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2320, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2320>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2320>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2320>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2320>>(v5, 0x2::tx_context::sender(arg1));
    }
