module 0x9d20ede2291fbfda36e7bc06c413a7a9cf772b400a1ed2f48a9a2a8583f45a10::hippo {
    ...
    fun init(arg0: HIPPO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HIPPO>(arg0, 9, b"HIPPO", b"HIPPO on Sui", b"", 0x1::option::none<0x2::url::Url>(), arg1);
