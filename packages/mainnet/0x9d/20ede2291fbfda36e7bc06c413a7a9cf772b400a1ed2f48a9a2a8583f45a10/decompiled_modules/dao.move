module 0x9d20ede2291fbfda36e7bc06c413a7a9cf772b400a1ed2f48a9a2a8583f45a10::dao {
    ...
    public fun add<T0, T1>(arg0: &mut DAO<T0, T1>, arg1: vector<address>) {
    ...
    public fun claim_dao<T0, T1>(arg0: &mut DAO<T0, T1>, arg1: DAOVoucher<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = DAOClaimed<T0, T1>{
            dao_address    : 0x2::object::uid_to_address(&arg0.id),
            amount_raise   : v3,
            amount_payment : (v0 as u64),
            recipient      : 0x2::tx_context::sender(arg2),
        };
        0x2::event::emit<DAOClaimed<T0, T1>>(v4);
    }

    public entry fun create_dao<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: vector<address>, arg6: 0x2::coin::Coin<T1>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<T1>(0x2::coin::balance<T1>(&arg6));
        let v1 = 0x2::tx_context::sender(arg8);
        let v2 = DAO<T0, T1>{
            id                    : 0x2::object::new(arg8),
            start_time            : arg0,
            end_time              : arg1,
            lp_lock_duration      : arg7,
            lp_unlock_time        : 0,
            cap                   : arg2,
            cap_per_address       : arg3,
            owner                 : v1,
            only_whitelist_time   : arg4,
            whitelisted_addresses : 0x2::table::new<address, bool>(arg8),
            raised_investors      : 0x2::table::new<address, u64>(arg8),
            is_finalized          : false,
            funded_amount         : 0,
            payment_amount        : v0,
            raised_balance        : 0x2::balance::zero<T0>(),
            payment_balance       : 0x2::coin::into_balance<T1>(arg6),
            investment            : 0x2::bag::new(arg8),
            investment_index      : 1,
        };
        let v3 = &mut v2;
        add<T0, T1>(v3, arg5);
    ...
    fun effective_amount<T0, T1>(arg0: &mut DAO<T0, T1>, arg1: address, arg2: u64) : u64 {
        let v0 = arg2;
        if (arg2 + arg0.funded_amount > arg0.cap) {
    ...
    public entry fun finalize_dao<T0, T1>(arg0: &mut DAO<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg3: u64, arg4: u64, arg5: &0x2::coin::CoinMetadata<T0>, arg6: &0x2::coin::CoinMetadata<T1>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let (v8, v9) = if (v5) {
            let v10 = sqrt(340282366920938463463374607431768211456 * (arg3 as u256) / (arg4 as u256));
            let (v11, v12, v13) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v2<T1, T0>(arg1, arg2, 60, v10, 0x1::string::utf8(b""), 4294523716, 443580, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.payment_balance, arg4), arg8), 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.raised_balance, arg3), arg8), arg6, arg5, true, arg7, arg8);
            let v14 = v11;
            ...
            let (v16, v17, v18) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v2<T0, T1>(arg1, arg2, 60, sqrt(340282366920938463463374607431768211456 * (arg4 as u256) / (arg3 as u256)), 0x1::string::utf8(b""), 4294523716, 443580, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.raised_balance, arg3), arg8), 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.payment_balance, arg4), arg8), arg5, arg6, false, arg7, arg8);
            let v19 = v16;
            let v20 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::pool_id(&v19);
            0x2::balance::join<T0>(&mut arg0.raised_balance, 0x2::coin::into_balance<T0>(v17));
            0x2::balance::join<T1>(&mut arg0.payment_balance, 0x2::coin::into_balance<T1>(v18));
            0x2::bag::add<u64, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&mut arg0.investment, 0, v19);
            (sqrt(340282366920938463463374607431768211456 * (arg4 as u256) / (arg3 as u256)), 0x2::object::id_to_address(&v20))
        };
        arg0.lp_unlock_time = 0x2::clock::timestamp_ms(arg7) + arg0.lp_lock_duration;
        arg0.payment_amount = 0x2::balance::value<T1>(&arg0.payment_balance);
        let v21 = DAOFinalized<T0, T1>{
            dao_address        : 0x2::object::id_address<DAO<T0, T1>>(arg0),
            timestamp          : 0x2::clock::timestamp_ms(arg7),
            cetus_pool_address : v9,
            initialize_price   : v8,
        };
        0x2::event::emit<DAOFinalized<T0, T1>>(v21);
    }
    ...
    public entry fun fund_dao<T0, T1>(arg0: &mut DAO<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 < arg0.only_whitelist_time) {
            assert!(is_whitelisted<T0, T1>(arg0, v0), 1);
        };
        let v2 = effective_amount<T0, T1>(arg0, v0, 0x2::balance::value<T0>(0x2::coin::balance<T0>(&arg1)));
        arg0.funded_amount = arg0.funded_amount + v2;
        0x2::balance::join<T0>(&mut arg0.raised_balance, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg1, v2, arg3)));
        ...
        let v4 = Funded<T0, T1>{
            ...
            sender             : v0,
            voucher_address    : 0x2::object::id_address<DAOVoucher<T0, T1>>(&v3),
        };
        0x2::event::emit<Funded<T0, T1>>(v4);
    }
