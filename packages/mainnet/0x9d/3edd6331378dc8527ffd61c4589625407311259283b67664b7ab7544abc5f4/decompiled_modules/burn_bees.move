module 0x9d3edd6331378dc8527ffd61c4589625407311259283b67664b7ab7544abc5f4::burn_bees {
    ...
    public fun bees_tokens_to_coin<T0>(arg0: &mut 0x2::token::Token<T0>, arg1: &BurnCap<T0>, arg2: &mut 0x2::token::TokenPolicy<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v3 = 0x2::token::spend<T0>(0x2::token::split<T0>(&mut v0, 0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::math::mul_div_u128((arg3 as u128), (3 as u128), (100 as u128)), arg4), arg4);
        let v4 = &mut v3;
    ...
    public fun transfer_bees<T0>(arg0: &mut 0x2::token::Token<T0>, arg1: &BurnCap<T0>, arg2: &mut 0x2::token::TokenPolicy<T0>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::token::spend<T0>(0x2::token::split<T0>(&mut v0, 0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::math::mul_div_u128((arg3 as u128), (3 as u128), (100 as u128)), arg5), arg5);
        let v3 = &mut v2;
