module 0x9d43c568acd9998198b5d20af228ef402b3aa4c528e3e89a5aa408fb78ea8240::gift4997 {
    struct GIFT4997 has drop {
        dummy_field: bool,
    }

    struct TICKET_4997 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4997(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4997>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4997>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4997, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4997>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4997>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4997>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4997>>(v5, 0x2::tx_context::sender(arg1));
    }
