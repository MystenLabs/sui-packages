module 0x9d0bbe9113ffb6211ad14403a6c530dbea950c09a4d22487d8ad77f01fadc447::cnsnft6736 {
    struct CNSNFT6736 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6736, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8113"));
        let v4 = 0x2::package::claim<CNSNFT6736>(arg0, arg1);
