module 0x9dc8328ef8e4a79cd9a83acb40d5fb7e3d88f30301ca90b9027afbeea2d23d56::banana_cores {
    struct BANANA_CORES has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BANANA_CORES, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BANANA_CORES>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"banana cores"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"lfmdlmdlkmkldkm"));
