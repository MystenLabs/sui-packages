module 0x9d22b638d5e6477474df062dff4768fac0ff4b578722938b9cfce2eb6445a470::presale {
    ...
    public entry fun purchase_token(arg0: &mut PresaleStorage, arg1: &0x2::clock::Clock, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::vec_map::insert<address, u64>(&mut arg0.balances, 0x2::tx_context::sender(arg3), *0x2::vec_map::get<address, u64>(&arg0.balances, &v1) + v0);
