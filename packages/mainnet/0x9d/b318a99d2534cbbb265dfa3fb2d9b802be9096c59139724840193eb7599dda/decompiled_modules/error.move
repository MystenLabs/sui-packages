module 0x9db318a99d2534cbbb265dfa3fb2d9b802be9096c59139724840193eb7599dda::error {
    ...
    public fun flashloan_exceed_single_cap_error() : u64 {
        1285
    }
    ...
    public fun invalid_reward_address_error() : u64 {
        98305
    }

    public fun market_paused_error() : u64 {
        90113
    }
    ...
    public fun staking_fee_exceeds_amount_error() : u64 {
        94215
    }

    public fun staking_gr_amount_not_divisible_error() : u64 {
        94216
    }

    public fun staking_gr_gy_mismatch_error() : u64 {
        94210
    }

    public fun staking_insufficient_gr_gy_error() : u64 {
        94211
    }

    public fun staking_invalid_params_error() : u64 {
        94213
    }

    public fun staking_min_xaum_error() : u64 {
        94209
    }

    public fun staking_not_admin_error() : u64 {
        94212
    }

    public fun staking_pool_xaum_not_enough_error() : u64 {
        94214
    }

    public fun staking_stake_cap_exceeded_error() : u64 {
        94217
    }
