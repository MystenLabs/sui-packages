module 0x9d8935916884b5f94bd549802201a158e6e660bba022fa185cdc1e3da43c3862::acl {
    struct Qsddybrciaivpuh has key {
        id: 0x2::object::UID,
        pools: 0x2::table::Table<0x1::ascii::String, Abkyiberguginqi>,
    }

    struct Abkyiberguginqi has store {
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    public entry fun edqqxpcvyyylbyb(arg0: &mut Qsddybrciaivpuh, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Abkyiberguginqi>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Abkyiberguginqi>(&mut arg0.pools, arg1);
    ...
    public entry fun fxrwoyttvpzlnrb(arg0: &mut Qsddybrciaivpuh, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<0x1::ascii::String, Abkyiberguginqi>(&arg0.pools, arg1)) {
            let v4 = 0x2::table::borrow_mut<0x1::ascii::String, Abkyiberguginqi>(&mut arg0.pools, arg1);
            ...
            0x2::table::add<0x1::ascii::String, Abkyiberguginqi>(&mut arg0.pools, arg1, v6);
            let v7 = PoolCreated{pool_name: arg1};
            0x2::event::emit<PoolCreated>(v7);
        };
    }

    public entry fun hanrdxowheikndi(arg0: &mut Qsddybrciaivpuh, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Abkyiberguginqi>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Abkyiberguginqi>(&mut arg0.pools, arg1);
    ...
    public entry fun hgmujqdkdsysobj(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Qsddybrciaivpuh, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Abkyiberguginqi>(&arg2.pools, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Abkyiberguginqi>(&mut arg2.pools, arg3);
        if (v0.initialized) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Qsddybrciaivpuh{
            id    : 0x2::object::new(arg0),
            pools : 0x2::table::new<0x1::ascii::String, Abkyiberguginqi>(arg0),
        };
        0x2::transfer::share_object<Qsddybrciaivpuh>(v0);
    }

    public entry fun nnnngppclizykbw<T0>(arg0: &mut Qsddybrciaivpuh, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Abkyiberguginqi>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Abkyiberguginqi>(&mut arg0.pools, arg1);
    ...
    public entry fun qohxsxhmwlcidfs(arg0: &mut Qsddybrciaivpuh, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Abkyiberguginqi{
        ...
        0x2::table::add<0x1::ascii::String, Abkyiberguginqi>(&mut arg0.pools, arg1, v0);
    }

    public entry fun qtnzmchyknkvmqg<T0: store + key>(arg0: &mut Qsddybrciaivpuh, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Abkyiberguginqi>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Abkyiberguginqi>(&mut arg0.pools, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.delegate, 0);
