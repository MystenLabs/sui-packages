module 0x9df3b93cfc12b0a8dfa8c89712b001ef1cc28f2bb2b1bb82d6daa3573846c5b7::pool {
    ...
    public fun add_pool_manager<T0>(arg0: &PoolAdminCap, arg1: &mut Pool<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_field::add<PoolManagerKey, 0x9df3b93cfc12b0a8dfa8c89712b001ef1cc28f2bb2b1bb82d6daa3573846c5b7::pool_manager::PoolManager<T0>>(&mut arg1.id, v1, 0x9df3b93cfc12b0a8dfa8c89712b001ef1cc28f2bb2b1bb82d6daa3573846c5b7::pool_manager::new<T0>(0x2::balance::value<T0>(&arg1.balance), arg2));
    }
    ...
    public(friend) fun create_pool<T0>(arg0: &PoolAdminCap, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut v0;
        add_pool_manager<T0>(arg0, v1, arg2);
        0x2::transfer::share_object<Pool<T0>>(v0);
        let v2 = PoolCreate{creator: 0x2::tx_context::sender(arg2)};
        0x2::event::emit<PoolCreate>(v2);
    }
    ...
    public(friend) fun deposit_balance<T0>(arg0: &mut Pool<T0>, arg1: 0x2::balance::Balance<T0>, arg2: address) {
        ...
        let v0 = PoolManagerKey{dummy_field: false};
        0x9df3b93cfc12b0a8dfa8c89712b001ef1cc28f2bb2b1bb82d6daa3573846c5b7::pool_manager::refresh_after_deposit<T0>(0x2::dynamic_field::borrow_mut<PoolManagerKey, 0x9df3b93cfc12b0a8dfa8c89712b001ef1cc28f2bb2b1bb82d6daa3573846c5b7::pool_manager::PoolManager<T0>>(&mut arg0.id, v0), &mut arg0.balance);
        let v1 = PoolDeposit{
            sender : arg2,
    ...
    public(friend) fun deposit_treasury<T0>(arg0: &mut Pool<T0>, arg1: u64) {
        assert!(0x2::balance::value<T0>(&arg0.balance) >= arg1, 0x9df3b93cfc12b0a8dfa8c89712b001ef1cc28f2bb2b1bb82d6daa3573846c5b7::error::insufficient_balance());
    ...
    public fun withdraw_treasury<T0>(arg0: &mut PoolAdminCap, arg1: &mut Pool<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<T0>(&arg1.treasury_balance) >= arg2, 0x9df3b93cfc12b0a8dfa8c89712b001ef1cc28f2bb2b1bb82d6daa3573846c5b7::error::insufficient_balance());
