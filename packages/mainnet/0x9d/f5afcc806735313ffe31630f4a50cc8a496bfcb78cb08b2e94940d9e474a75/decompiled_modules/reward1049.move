module 0x9df5afcc806735313ffe31630f4a50cc8a496bfcb78cb08b2e94940d9e474a75::reward1049 {
    struct REWARD1049 has drop {
        dummy_field: bool,
    }

    struct TICKET_1049 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1049(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1049>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1049>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1049, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1049>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1049>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1049>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1049>>(v5, 0x2::tx_context::sender(arg1));
    }
