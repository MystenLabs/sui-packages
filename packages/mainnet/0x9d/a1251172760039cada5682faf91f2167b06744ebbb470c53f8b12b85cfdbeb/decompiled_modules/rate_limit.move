module 0x9da1251172760039cada5682faf91f2167b06744ebbb470c53f8b12b85cfdbeb::rate_limit {
    ...
    public(friend) fun set(arg0: &mut RateLimit, arg1: u64, arg2: u64) {
        ...
        arg0.window_ms = arg1;
        arg0.amount = arg2;
        0x9da1251172760039cada5682faf91f2167b06744ebbb470c53f8b12b85cfdbeb::structs::emit_rate_limit_set(arg1, arg2);
    }
