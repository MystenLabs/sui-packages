module 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::pyth {
    ...
    public fun add(arg0: &mut PythPriceInfo, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject) {
        ...
        let v3 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_timestamp(&v1);
        assert!(v3 <= arg0.current_ts_sec + 60, 3);
        arg0.max_age_secs = 0x1::u64::max(arg0.max_age_secs, 0x1::u64::saturating_sub(arg0.current_ts_sec, v3));
    }
