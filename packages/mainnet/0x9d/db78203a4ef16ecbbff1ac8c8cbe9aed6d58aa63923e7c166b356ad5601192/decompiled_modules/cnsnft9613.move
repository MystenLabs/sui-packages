module 0x9ddb78203a4ef16ecbbff1ac8c8cbe9aed6d58aa63923e7c166b356ad5601192::cnsnft9613 {
    struct CNSNFT9613 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9613, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9613>(arg0, arg1);
