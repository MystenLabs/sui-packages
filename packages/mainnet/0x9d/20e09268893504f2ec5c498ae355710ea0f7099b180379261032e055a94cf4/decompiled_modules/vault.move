module 0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::vault {
    ...
    public fun new<T0, T1>(arg0: &0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::Stingray, arg1: 0x2::coin::TreasuryCap<T1>, arg2: &0x2::coin::CoinMetadata<T1>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : VaultCap {
        if (!0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::is_allowed_base<T0>(arg0)) {
        ...
        0x2::dynamic_field::add<ManagementKey, 0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::collector::Collector<T0>>(&mut v1.id, v5, 0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::collector::new<T0>());
    ...
    fun borrow_collector_mut<T0, T1>(arg0: &mut Vault<T0, T1>) : &mut 0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::collector::Collector<T0> {
        let v0 = ManagementKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<ManagementKey, 0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::collector::Collector<T0>>(&mut arg0.id, v0)
    }
    ...
    public fun buy_share<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::Stingray, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        if (arg0.is_individual) {
            err_individual_vault();
        };
        0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::assert_version_not_allowed(arg1);
        ...
        let v3 = if (v2 != 0) {
            ...
            0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::add_record<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id), v4);
            0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::fill_record<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id), &mut v1);
            ...
            0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::collector::add_unclaimed_amount<T0>(v6, v5);
            0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::collector::fill_balance<T0>(v6, &mut v1);
        ...
        0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::vault_event::buy_share_event<T0, ShareMetadata>(*0x2::object::uid_as_inner(&arg0.id), v0, v7);
    ...
    fun calculate_platform_fee<T0, T1>(arg0: &Vault<T0, T1>, arg1: u64, arg2: &0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::Stingray, arg3: &0x2::clock::Clock) : u64 {
        0xce36dcf1d175659e78e42e3478e6fea3110fc3914bb70210df51dec9ef3d6c37::float::floor(0xce36dcf1d175659e78e42e3478e6fea3110fc3914bb70210df51dec9ef3d6c37::float::mul_u64(0xce36dcf1d175659e78e42e3478e6fea3110fc3914bb70210df51dec9ef3d6c37::float::mul_u64(0xce36dcf1d175659e78e42e3478e6fea3110fc3914bb70210df51dec9ef3d6c37::float::div_u64(0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::vault_platform_fee(arg2), 31536000), (0x2::clock::timestamp_ms(arg3) - arg0.latest_updated_ts) / 1000), arg1))
    }
    ...
    public fun claim_management_fee<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultCap) : 0x2::balance::Balance<T0> {
        ...
        0x2::balance::withdraw_all<T0>(0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::collector::borrow_balance_mut<T0>(borrow_collector_mut<T0, T1>(arg0)))
    }
    ...
    public fun create_sell_share_request<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::Stingray, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::clock::Clock) : SellShareRequest<T0> {
        ...
        0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::add_record<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id), v3);
        let v4 = calculate_management_fee<T0, T1>(arg0, v2, arg3);
        let v5 = borrow_collector_mut<T0, T1>(arg0);
        0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::collector::add_unclaimed_amount<T0>(v5, v4);
        arg0.latest_updated_ts = 0x2::clock::timestamp_ms(arg3);
    ...
    public fun create_sell_share_request_by_stingray<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::Stingray, arg2: &0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::AdminCap, arg3: &0x2::clock::Clock) : SellShareRequest<T0> {
        let v0 = SellShareRequest<T0>{
            vault_id                 : *0x2::object::uid_as_inner(&arg0.id),
            burned_share             : 0,
            weight                   : 0xce36dcf1d175659e78e42e3478e6fea3110fc3914bb70210df51dec9ef3d6c37::float::from(0),
        ...
        0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::add_record<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id), calculate_platform_fee<T0, T1>(arg0, v1, arg1, arg3));
        let v2 = calculate_management_fee<T0, T1>(arg0, v1, arg3);
        let v3 = borrow_collector_mut<T0, T1>(arg0);
        0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::collector::add_unclaimed_amount<T0>(v3, v2);
        arg0.latest_updated_ts = 0x2::clock::timestamp_ms(arg3);
        0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::set_unclaimed_amount_to_zero<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id));
        v0.weight = get_fee_float(0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::unclaimed_base_amount<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id)), v1);
        let v4 = 0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::unclaimed_base_amount<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id));
    ...
    public fun create_sell_share_request_for_claiming_management_fee<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::Stingray, arg2: &VaultCap, arg3: &0x2::clock::Clock) : SellShareRequest<T0> {
        ...
        let v3 = borrow_collector_mut<T0, T1>(arg0);
        0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::collector::add_unclaimed_amount<T0>(v3, v2);
        0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::collector::set_unclaimed_amount_to_zero<T0>(v3);
        v0.weight = get_fee_float(0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::collector::unclaimed_amount<T0>(v3), v1);
        let v4 = 0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::unclaimed_base_amount<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id));
        let v5 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.reserve, 0x1::type_name::get<T0>());
        if (0x2::balance::value<T0>(v5) >= v4) {
            v0.weight = 0xce36dcf1d175659e78e42e3478e6fea3110fc3914bb70210df51dec9ef3d6c37::float::from(0);
    ...
    public fun put_asset_back_<T0, T1, T2: drop, T3>(arg0: &mut Vault<T0, T1>, arg1: &0x6e9ee79a8ac36806d5db62f5578ce4f38c6c79fb5937fcf3b2fdae7285811d3f::whitelist::Whitelist, arg2: 0xd0a66f97193dde2b87a4c3e817bba626114067f27e1323086fb1f41b1117451d::asset::Asset<T2, MainVault, T3>) {
        ...
        0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::vault_event::put_balance_event<T0, T1, T2, T3>(*0x2::object::uid_as_inner(&arg0.id), 0x2::balance::value<T3>(&v0));
    ...
    public fun repay_sell_share<T0, T1>(arg0: &Vault<T0, T1>, arg1: SellShareRequest<T0>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, RedeemSuccessReceipt) {
        ...
        0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::vault_event::sell_share_event<T0, T1>(*0x2::object::uid_as_inner(&arg0.id), 0x2::balance::value<T0>(&v11), v1);
    ...
    fun take_asset_out_<T0, T1, T2: drop, T3>(arg0: &mut Vault<T0, T1>, arg1: &0x6e9ee79a8ac36806d5db62f5578ce4f38c6c79fb5937fcf3b2fdae7285811d3f::whitelist::Whitelist, arg2: u64) : 0x2::balance::Balance<T3> {
        ...
        0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::vault_event::take_balance_event<T0, T1, T2, T3>(*0x2::object::uid_as_inner(&arg0.id), 0x2::balance::value<T3>(&v3));
        v3
    }
    ...
    public fun vault_total_base_amount<T0, T1>(arg0: &Vault<T0, T1>, arg1: &0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::Stingray, arg2: &0x2::clock::Clock) : u64 {
        let v0 = 0;
        ...
        while (0x1::vector::length<0x1::type_name::TypeName>(&v1) > 0) {
            ...
            if (0x2::clock::timestamp_ms(arg2) - v3.last_update_ts > 0xc6e0aa4123bec375ffa2fd6d7d98591ac43b290533a611c5ccf67d7b5b0a157e::stingray::tolerance_ts(arg1)) {
