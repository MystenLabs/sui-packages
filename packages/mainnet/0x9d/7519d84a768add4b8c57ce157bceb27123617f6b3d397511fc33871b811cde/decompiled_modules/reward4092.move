module 0x9d7519d84a768add4b8c57ce157bceb27123617f6b3d397511fc33871b811cde::reward4092 {
    struct REWARD4092 has drop {
        dummy_field: bool,
    }

    struct TICKET_4092 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4092(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4092>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4092>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4092, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4092>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4092>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4092>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4092>>(v5, 0x2::tx_context::sender(arg1));
    }
