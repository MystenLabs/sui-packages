module 0x9dc607111f3f9c2c7ebe08d311bb035fb39d06c940f604971318c79a2d5c3531::reward4466 {
    struct REWARD4466 has drop {
        dummy_field: bool,
    }

    struct TICKET_4466 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4466(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4466>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4466>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4466, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4466>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4466>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4466>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4466>>(v5, 0x2::tx_context::sender(arg1));
    }
