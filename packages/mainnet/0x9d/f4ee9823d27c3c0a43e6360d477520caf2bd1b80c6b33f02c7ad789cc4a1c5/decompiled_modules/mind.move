module 0x9df4ee9823d27c3c0a43e6360d477520caf2bd1b80c6b33f02c7ad789cc4a1c5::mind {
    ...
    fun init(arg0: MIND, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/M1NDeERjDqMGUA3bqZpNLwGmVUuy1EbjPk9PpYhgJGS.png?size=lg&key=0fe846                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<MIND>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MIND    ")))), trim_right(b"Hivemind Terminal               "), trim_right(b"Aligning data-driven AI with community incentives through trading                                                                                                                                                                                                                                                               "), v2, arg1);
        let v5 = v3;
