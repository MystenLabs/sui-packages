module 0x9dd3bbca11dcd5ce70991383bd25ed9ecd874c27e71804fa1bb4acb2911a8429::bp {
    struct BP has drop {
        dummy_field: bool,
    }
    ...
    struct PlayerBoard has store, key {
        ...
        board_num: u64,
        player: address,
        current_board: 0x9dd3bbca11dcd5ce70991383bd25ed9ecd874c27e71804fa1bb4acb2911a8429::board::Round,
    ...
    public fun current_stage(arg0: &PlayerBoard) : &u64 {
        0x9dd3bbca11dcd5ce70991383bd25ed9ecd874c27e71804fa1bb4acb2911a8429::board::current_stage(current_board(arg0))
    }
    ...
    public entry fun StartBoard(arg0: &mut LobbyManager, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = PlayerBoard{
            ...
            player        : arg1,
            current_board : 0x9dd3bbca11dcd5ce70991383bd25ed9ecd874c27e71804fa1bb4acb2911a8429::board::new_board(),
    ...
    public entry fun UpdateBoard(arg0: &mut PlayerBoard, arg1: &mut LobbyManager, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x9dd3bbca11dcd5ce70991383bd25ed9ecd874c27e71804fa1bb4acb2911a8429::board::update_stage(&mut v0, arg2, arg3);
    ...
    public fun current_board(arg0: &PlayerBoard) : &0x9dd3bbca11dcd5ce70991383bd25ed9ecd874c27e71804fa1bb4acb2911a8429::board::Round {
        &arg0.current_board
    }
