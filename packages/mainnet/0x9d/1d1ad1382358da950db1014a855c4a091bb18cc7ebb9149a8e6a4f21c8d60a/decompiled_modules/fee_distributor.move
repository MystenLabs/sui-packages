module 0x9d1d1ad1382358da950db1014a855c4a091bb18cc7ebb9149a8e6a4f21c8d60a::fee_distributor {
    ...
    public(friend) fun create_vault<T0>(arg0: address, arg1: address, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        assert!(arg1 != @0x0, 3);
        let v0 = 0x9d1d1ad1382358da950db1014a855c4a091bb18cc7ebb9149a8e6a4f21c8d60a::token_factory::toastr_bps();
        let v1 = 0x9d1d1ad1382358da950db1014a855c4a091bb18cc7ebb9149a8e6a4f21c8d60a::token_factory::staker_bps();
        let v2 = 0x9d1d1ad1382358da950db1014a855c4a091bb18cc7ebb9149a8e6a4f21c8d60a::token_factory::total_bps();
    ...
    public fun distribute<T0>(arg0: &FeeVault<T0>, arg1: &mut 0x9d1d1ad1382358da950db1014a855c4a091bb18cc7ebb9149a8e6a4f21c8d60a::staking_pool::StakingPool<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg2);
        assert!(v0 > 0, 2);
        let v1 = 0x9d1d1ad1382358da950db1014a855c4a091bb18cc7ebb9149a8e6a4f21c8d60a::token_factory::total_bps();
        let v2 = v0 * 0x9d1d1ad1382358da950db1014a855c4a091bb18cc7ebb9149a8e6a4f21c8d60a::token_factory::staker_bps() / v1;
        let v3 = v0 * 0x9d1d1ad1382358da950db1014a855c4a091bb18cc7ebb9149a8e6a4f21c8d60a::token_factory::toastr_bps() / v1;
        let v4 = v0 * arg0.partner_bps / v1;
        let v5 = 0x2::coin::into_balance<0x2::sui::SUI>(arg2);
        0x9d1d1ad1382358da950db1014a855c4a091bb18cc7ebb9149a8e6a4f21c8d60a::staking_pool::deposit_rewards<T0>(arg1, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v5, v2), arg3));
