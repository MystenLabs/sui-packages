module 0x9d774048e563064ada31680c978e45552cfd2cc80bcd2e50f870ec0de4a85b05::fairmiles {
    ...
    public fun depositSUI<T0>(arg0: &mut SuiTreasury<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(0x2::tx_context::sender(arg2) == @0x79a745e2f4cc3787e87c3cd2d7dae72dd52e9de78a986d76adbb2e1ca77dabbf, 100);
    ...
    public fun initializeSuiObject<T0>(arg0: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg0) == @0x79a745e2f4cc3787e87c3cd2d7dae72dd52e9de78a986d76adbb2e1ca77dabbf, 100);
    ...
    public fun withdrawSUI<T0>(arg0: &mut SuiTreasury<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x79a745e2f4cc3787e87c3cd2d7dae72dd52e9de78a986d76adbb2e1ca77dabbf, 100);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.sui_amount, arg1), arg2), @0x79a745e2f4cc3787e87c3cd2d7dae72dd52e9de78a986d76adbb2e1ca77dabbf);
    }

    public fun withdrawUSDC<T0>(arg0: &mut UsdcTreasury<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x79a745e2f4cc3787e87c3cd2d7dae72dd52e9de78a986d76adbb2e1ca77dabbf, 100);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.usdc_amount, arg1), arg2), @0x79a745e2f4cc3787e87c3cd2d7dae72dd52e9de78a986d76adbb2e1ca77dabbf);
    }

    public fun withdrawWETH<T0>(arg0: &mut WethTreasury<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x79a745e2f4cc3787e87c3cd2d7dae72dd52e9de78a986d76adbb2e1ca77dabbf, 100);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.weth_amount, arg1), arg2), @0x79a745e2f4cc3787e87c3cd2d7dae72dd52e9de78a986d76adbb2e1ca77dabbf);
    }
