module 0x9dbfcad92c88bf9ee96e3cc1949644244ea2da33d051bbdb80638b6ffdf02a46::reward1756 {
    struct REWARD1756 has drop {
        dummy_field: bool,
    }

    struct TICKET_1756 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1756(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1756>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1756>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1756, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1756>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1756>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1756>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1756>>(v5, 0x2::tx_context::sender(arg1));
    }
