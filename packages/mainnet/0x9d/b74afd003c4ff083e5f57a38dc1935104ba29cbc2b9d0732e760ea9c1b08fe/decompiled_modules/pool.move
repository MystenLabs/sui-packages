module 0x9db74afd003c4ff083e5f57a38dc1935104ba29cbc2b9d0732e760ea9c1b08fe::pool {
    ...
    public fun calc_pending_rewards(arg0: &Pool, arg1: &0x9db74afd003c4ff083e5f57a38dc1935104ba29cbc2b9d0732e760ea9c1b08fe::position::Position) : u64 {
        ((calc_rewards_for(arg0, arg1) - 0x9db74afd003c4ff083e5f57a38dc1935104ba29cbc2b9d0732e760ea9c1b08fe::position::reward_debt(arg1)) as u64)
    }

    public fun calc_rewards_for(arg0: &Pool, arg1: &0x9db74afd003c4ff083e5f57a38dc1935104ba29cbc2b9d0732e760ea9c1b08fe::position::Position) : u256 {
        (0x9db74afd003c4ff083e5f57a38dc1935104ba29cbc2b9d0732e760ea9c1b08fe::position::value(arg1) as u256) * arg0.acc_reward_per_share / 1000000000000
    }

    public(friend) fun create_pool(arg0: u64, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Pool {
        let v0 = 0x9db74afd003c4ff083e5f57a38dc1935104ba29cbc2b9d0732e760ea9c1b08fe::utils::to_seconds(0x2::clock::timestamp_ms(arg3));
        let v1 = new(arg4);
    ...
    public fun pending_reward(arg0: &Pool, arg1: &0x9db74afd003c4ff083e5f57a38dc1935104ba29cbc2b9d0732e760ea9c1b08fe::position::Position, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) : u64 {
        let v0 = 0x9db74afd003c4ff083e5f57a38dc1935104ba29cbc2b9d0732e760ea9c1b08fe::utils::to_seconds(0x2::clock::timestamp_ms(arg4));
        ...
        (((0x9db74afd003c4ff083e5f57a38dc1935104ba29cbc2b9d0732e760ea9c1b08fe::position::value(arg1) as u256) * v2 / 1000000000000 - 0x9db74afd003c4ff083e5f57a38dc1935104ba29cbc2b9d0732e760ea9c1b08fe::position::reward_debt(arg1)) as u64)
    }
