module 0x9d0f1db960a9647414bcb29877881e5daed7be1e337e3a852207fe5dd9dd8932::seal_early_badge {
    struct SEAL_EARLY_BADGE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SEAL_EARLY_BADGE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SEAL_EARLY_BADGE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Seal Early Badge"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Welcome to the Seal NFT Early Badge, an innovative platform built on the Sui blockchain's testnet, designed to revolutionize the way you create, manage, and showcase your NFT assets."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibq7hgkcvjaqreqa2ambjjkkbakd5v7d7qvrpbuwo7jv7edln73su"));
