module 0x9d6488ee550cc6cc45a54706e5714db8dac70660e63db484bc0ca5ae2e0906cf::vault {
    ...
    entry fun change_limit<T0>(arg0: &mut Vault<T0>, arg1: &0x9d6488ee550cc6cc45a54706e5714db8dac70660e63db484bc0ca5ae2e0906cf::owner_cap::OwnerCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun create_vault<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x9d6488ee550cc6cc45a54706e5714db8dac70660e63db484bc0ca5ae2e0906cf::owner_cap::create_owner_cap(&v0.id, 0x2::tx_context::sender(arg2), arg2);
    ...
    entry fun liquidate_vault<T0>(arg0: &mut Vault<T0>, arg1: &0x9d6488ee550cc6cc45a54706e5714db8dac70660e63db484bc0ca5ae2e0906cf::owner_cap::OwnerCap, arg2: &mut 0x2::tx_context::TxContext) {
        0x9d6488ee550cc6cc45a54706e5714db8dac70660e63db484bc0ca5ae2e0906cf::owner_cap::is_owned(&arg0.id, arg1);
