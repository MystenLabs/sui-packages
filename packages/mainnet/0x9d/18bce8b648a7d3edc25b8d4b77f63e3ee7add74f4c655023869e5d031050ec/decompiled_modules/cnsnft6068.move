module 0x9d18bce8b648a7d3edc25b8d4b77f63e3ee7add74f4c655023869e5d031050ec::cnsnft6068 {
    struct CNSNFT6068 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6068, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6068>(arg0, arg1);
