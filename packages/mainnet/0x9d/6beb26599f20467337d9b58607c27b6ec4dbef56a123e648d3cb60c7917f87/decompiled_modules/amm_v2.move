module 0x9d6beb26599f20467337d9b58607c27b6ec4dbef56a123e648d3cb60c7917f87::amm_v2 {
    ...
    public fun create_pool<T0, T1>(arg0: &0x9d6beb26599f20467337d9b58607c27b6ec4dbef56a123e648d3cb60c7917f87::admin::AdminCap, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 < 0x9d6beb26599f20467337d9b58607c27b6ec4dbef56a123e648d3cb60c7917f87::math::fee_denom(), 1);
        let v0 = Pool<T0, T1>{
    ...
    public fun fund<T0, T1>(arg0: &0x9d6beb26599f20467337d9b58607c27b6ec4dbef56a123e648d3cb60c7917f87::admin::AdminCap, arg1: &mut Pool<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>) {
    ...
    public fun quote_a_to_b<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64) : u64 {
        0x9d6beb26599f20467337d9b58607c27b6ec4dbef56a123e648d3cb60c7917f87::math::get_amount_out(arg1, 0x2::balance::value<T0>(&arg0.reserve_a), 0x2::balance::value<T1>(&arg0.reserve_b), arg0.fee_bps)
    }

    public fun quote_b_to_a<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64) : u64 {
        0x9d6beb26599f20467337d9b58607c27b6ec4dbef56a123e648d3cb60c7917f87::math::get_amount_out(arg1, 0x2::balance::value<T1>(&arg0.reserve_b), 0x2::balance::value<T0>(&arg0.reserve_a), arg0.fee_bps)
    }
    ...
    public fun swap_a_to_b<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v1 = 0x9d6beb26599f20467337d9b58607c27b6ec4dbef56a123e648d3cb60c7917f87::math::get_amount_out(v0, 0x2::balance::value<T0>(&arg0.reserve_a), 0x2::balance::value<T1>(&arg0.reserve_b), arg0.fee_bps);
        assert!(v1 >= arg2, 1);
    ...
    public fun swap_b_to_a<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = 0x9d6beb26599f20467337d9b58607c27b6ec4dbef56a123e648d3cb60c7917f87::math::get_amount_out(v0, 0x2::balance::value<T1>(&arg0.reserve_b), 0x2::balance::value<T0>(&arg0.reserve_a), arg0.fee_bps);
        assert!(v1 >= arg2, 1);
