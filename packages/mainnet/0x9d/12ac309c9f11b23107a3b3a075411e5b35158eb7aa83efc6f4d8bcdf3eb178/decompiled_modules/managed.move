module 0x9d12ac309c9f11b23107a3b3a075411e5b35158eb7aa83efc6f4d8bcdf3eb178::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"FUSDT", b"fcihpy token", b"fcihpy test move token", 0x1::option::none<0x2::url::Url>(), arg1);
