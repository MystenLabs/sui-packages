module 0x48db008a3c9e638dd17d20702632d9909c3c075e44eb339f890fb29503ec3050::memory_nft {
    ...
    public fun blob_ids(arg0: &MemoryPack) : vector<0x2::object::ID> {
        arg0.blob_ids
    }
    ...
    public fun namespace(arg0: &MemoryPack) : 0x1::string::String {
        arg0.namespace
    }

    public fun namespace_bytes(arg0: &MemoryPack) : vector<u8> {
        *0x1::string::bytes(&arg0.namespace)
    }

    public fun pack_type(arg0: &MemoryPack) : u8 {
        arg0.pack_type
    }

    public fun performance_score(arg0: &MemoryPack) : u8 {
        arg0.performance_score
    }

    public fun poa_proofs(arg0: &MemoryPack) : vector<vector<u8>> {
        arg0.poa_proofs
    }
    ...
    public(friend) fun uid(arg0: &MemoryPack) : &0x2::object::UID {
        &arg0.id
    }

    public(friend) fun uid_mut(arg0: &mut MemoryPack) : &mut 0x2::object::UID {
        &mut arg0.id
    }
