module 0x9d20be5433fb0c7ee558ab8e1e4cde5f64bff3987fc799a929bd04c5a953ab6c::cnsnft1327 {
    struct CNSNFT1327 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1327, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1327>(arg0, arg1);
