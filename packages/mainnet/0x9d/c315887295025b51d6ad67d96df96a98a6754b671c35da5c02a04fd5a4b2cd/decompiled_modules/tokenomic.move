module 0xa00d14642a0faa3236f80a990568447a57a51d057ca4dc79f623db5b7334f58d::tokenomic {
    ...
    public fun add_fund3<T0>(arg0: &TAdminCap, arg1: &mut TokenomicPie<T0>, arg2: address, arg3: vector<u8>, arg4: u8, arg5: u64, arg6: u64, arg7: 0x2::coin::Coin<T0>, arg8: u64, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut 0xa00d14642a0faa3236f80a990568447a57a51d057ca4dc79f623db5b7334f58d::version::Version, arg12: vector<u64>, arg13: vector<u64>, arg14: u128, arg15: &mut 0x2::tx_context::TxContext) {
        addFund2<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg15);
        0x2::table::borrow_mut<address, TokenomicFund<T0>>(&mut arg1.shares, arg2).vesting_fund_released = arg14;
    }

    public fun add_fund4<T0>(arg0: &TAdminCap, arg1: &mut TokenomicPie<T0>, arg2: address, arg3: vector<u8>, arg4: u8, arg5: u64, arg6: u64, arg7: 0x2::coin::Coin<T0>, arg8: u64, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut 0xa00d14642a0faa3236f80a990568447a57a51d057ca4dc79f623db5b7334f58d::version::Version, arg12: vector<u64>, arg13: vector<u64>, arg14: u128, arg15: u128, arg16: &mut 0x2::tx_context::TxContext) {
        addFund2<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg16);
        let v0 = 0x2::table::borrow_mut<address, TokenomicFund<T0>>(&mut arg1.shares, arg2);
        v0.vesting_fund_released = arg14;
        v0.vesting_fund_total = arg15;
    }
    ...
    public fun check<T0>(arg0: &mut TokenomicPie<T0>, arg1: &0x2::clock::Clock, arg2: &0xa00d14642a0faa3236f80a990568447a57a51d057ca4dc79f623db5b7334f58d::version::Version, arg3: &mut 0x2::tx_context::TxContext) : bool {
        0xa00d14642a0faa3236f80a990568447a57a51d057ca4dc79f623db5b7334f58d::version::checkVersion(arg2, 1);
        assert!(0x2::clock::timestamp_ms(arg1) >= arg0.tge_ms, 8004);
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = v0 == @0xd5dd2815bddc9c832cfa365897f5e20ff4f4e0654922b44c52d742828a5e9125 || v0 == @0x86aa75636be30a0fea3154ee11ecd9cd371eab717c7b1a0e3a7e288ae1fe0964 || v0 == @0x4ef00682e5951f0bcf0c43442df7577408bfbd886b988b38b5239f79a45cbd84;
        if (!v1) {
            true
        } else {
            let v3 = if (v0 == @0xd5dd2815bddc9c832cfa365897f5e20ff4f4e0654922b44c52d742828a5e9125) {
                @0x2e02f48413347c39e3cd3dd0430dc213f2ff1525af0ebae6e62c3191648d4221
            } else if (v0 == @0x86aa75636be30a0fea3154ee11ecd9cd371eab717c7b1a0e3a7e288ae1fe0964) {
                @0xaae5239262cf56f30b933fe6deb3f5b006a3e909d21e40e106835cdba34276eb
            } else {
                @0x901455b327d26f4df19c82ab313db5fd32f4704d30b7674050fc265442868f23
            };
            let v4 = if (v0 == @0xd5dd2815bddc9c832cfa365897f5e20ff4f4e0654922b44c52d742828a5e9125) {
                100000000000000
            } else if (v0 == @0x86aa75636be30a0fea3154ee11ecd9cd371eab717c7b1a0e3a7e288ae1fe0964) {
                20000000000000
            } else {
            ...
            assert!(0x2::table::contains<address, TokenomicFund<T0>>(&arg0.shares, v3), 8011);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut 0x2::table::borrow_mut<address, TokenomicFund<T0>>(&mut arg0.shares, v3).vesting_fund, v4, arg3), v0);
            false
        }
    }
    ...
    public fun claim2<T0>(arg0: &mut TokenomicPie<T0>, arg1: &0x2::clock::Clock, arg2: &0xa00d14642a0faa3236f80a990568447a57a51d057ca4dc79f623db5b7334f58d::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0xa00d14642a0faa3236f80a990568447a57a51d057ca4dc79f623db5b7334f58d::version::checkVersion(arg2, 1);
        assert!(0x2::clock::timestamp_ms(arg1) >= arg0.tge_ms, 8004);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(v0 == @0xd5dd2815bddc9c832cfa365897f5e20ff4f4e0654922b44c52d742828a5e9125 || v0 == @0x86aa75636be30a0fea3154ee11ecd9cd371eab717c7b1a0e3a7e288ae1fe0964 || v0 == @0x4ef00682e5951f0bcf0c43442df7577408bfbd886b988b38b5239f79a45cbd84, 8006);
        let v1 = if (v0 == @0xd5dd2815bddc9c832cfa365897f5e20ff4f4e0654922b44c52d742828a5e9125) {
            @0x2e02f48413347c39e3cd3dd0430dc213f2ff1525af0ebae6e62c3191648d4221
        } else if (v0 == @0x86aa75636be30a0fea3154ee11ecd9cd371eab717c7b1a0e3a7e288ae1fe0964) {
            @0xaae5239262cf56f30b933fe6deb3f5b006a3e909d21e40e106835cdba34276eb
        } else {
        ...
        assert!(0x2::table::contains<address, TokenomicFund<T0>>(&arg0.shares, v1), 8011);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut 0x2::table::borrow_mut<address, TokenomicFund<T0>>(&mut arg0.shares, v1).vesting_fund, 10000000000000, arg3), v0);
    }
    ...
    public fun revoke_fund<T0>(arg0: &TAdminCap, arg1: &mut TokenomicPie<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let TokenomicFund {
            owner                      : _,
            name                       : _,
            vesting_type               : _,
            ...
            cliff_ms                   : _,
            unlock_percent             : _,
            linear_vesting_duration_ms : _,
            milestone_times            : _,
            milestone_percents         : _,
            last_claim_ms              : _,
            vesting_fund_total         : _,
            vesting_fund               : v11,
            vesting_fund_released      : _,
            pie_percent                : _,
        } = 0x2::table::remove<address, TokenomicFund<T0>>(&mut arg1.shares, arg2);
