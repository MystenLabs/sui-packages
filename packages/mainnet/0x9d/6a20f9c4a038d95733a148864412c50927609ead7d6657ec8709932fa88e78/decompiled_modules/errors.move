module 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors {
    ...
    public fun gas_extract_exceeds_24h_cap() : u64 {
        37
    }

    public fun gas_extract_exceeds_call_cap() : u64 {
        36
    }
    ...
    public fun op_value_exceeds_cap() : u64 {
        38
    }
