module 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::accounting {
    ...
    public fun charge_deposit_fee<T0>(arg0: &mut 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::UserPool, arg1: &mut 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::FeePool, arg2: u64) {
        if (arg2 > 0) {
            0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::fee_join<T0>(arg1, 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::user_split<T0>(arg0, arg2));
        };
    }

    public fun charge_limit_order_fee<T0>(arg0: &mut 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::FeePool, arg1: &mut 0x2::balance::Balance<T0>, arg2: u64) {
        if (arg2 > 0) {
            0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::fee_join<T0>(arg0, 0x2::balance::split<T0>(arg1, arg2));
        };
    }

    public fun charge_yield_fee<T0>(arg0: &mut 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::FeePool, arg1: &mut 0x2::balance::Balance<T0>, arg2: u64) {
        if (arg2 > 0) {
            0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::fee_join<T0>(arg0, 0x2::balance::split<T0>(arg1, arg2));
        };
    }
    ...
    public fun debit_deposits(arg0: &mut 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, arg1: 0x1::type_name::TypeName, arg2: u64) {
        assert!(0x2::vec_map::contains<0x1::type_name::TypeName, u64>(arg0, &arg1), 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors::insufficient_balance());
        let v0 = 0x2::vec_map::get_mut<0x1::type_name::TypeName, u64>(arg0, &arg1);
        assert!(*v0 >= arg2, 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors::insufficient_balance());
        *v0 = *v0 - arg2;
    }
    ...
    public fun lock_amount(arg0: &mut 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, arg1: 0x1::type_name::TypeName, arg2: u64, arg3: u64, arg4: u64) {
        ...
        assert!(v0 + arg2 <= arg3, 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors::exceeds_max_lock());
        assert!(v0 + arg2 <= arg4, 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors::insufficient_unlocked_balance());
