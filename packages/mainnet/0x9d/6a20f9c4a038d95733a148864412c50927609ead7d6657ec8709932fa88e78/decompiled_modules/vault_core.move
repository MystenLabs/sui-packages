module 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::vault_core {
    struct Vault has key {
        id: 0x2::object::UID,
        balances: 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::UserPool,
        fee_balances: 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::FeePool,
    ...
    struct GasBucket has copy, drop, store {
        bucket: u64,
        amount: u64,
    }
    ...
    struct UserRateState has drop, store {
        window_start: u64,
        ops: u64,
        value: u64,
    }

    struct DepositCapState has drop, store {
        cap: u64,
        net_deposited: u64,
    }
    ...
    public fun account_gas_extracted_24h(arg0: &UserAccount, arg1: u64, arg2: u64, arg3: u64) : u64 {
        let v0 = &arg0.gas_buckets;
        let v1 = 0;
        let v2 = 0;
        while (v2 < 0x1::vector::length<GasBucket>(v0)) {
            let v3 = 0x1::vector::borrow<GasBucket>(v0, v2);
            if (bucket_in_window(v3.bucket, arg1, arg2, arg3)) {
                v1 = v1 + v3.amount;
            };
            v2 = v2 + 1;
        };
    ...
    public(friend) fun add_gas_to_bucket(arg0: &mut UserAccount, arg1: u64, arg2: u64, arg3: u64) {
        let v0 = arg1 / arg2;
        let v1 = &mut arg0.gas_buckets;
        let v2 = 0;
        while (v2 < 0x1::vector::length<GasBucket>(v1)) {
            let v3 = 0x1::vector::borrow_mut<GasBucket>(v1, v2);
            if (v3.bucket == v0) {
        ...
        0x1::vector::push_back<GasBucket>(v1, v4);
    }
    ...
    public(friend) fun assert_not_paused(arg0: &Vault) {
        assert!(!arg0.paused, 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors::vault_paused());
    }

    public(friend) fun assert_paused(arg0: &Vault) {
        assert!(arg0.paused, 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors::vault_not_paused());
    }

    public(friend) fun assert_version(arg0: &Vault) {
        assert!(arg0.version == 11, 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors::version_mismatch());
    }

    public(friend) fun borrow_account(arg0: &Vault, arg1: address) : &UserAccount {
        assert!(0x2::table::contains<address, UserAccount>(&arg0.accounts, arg1), 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors::account_not_found());
    ...
    public(friend) fun borrow_fee_pool(arg0: &Vault) : &0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::FeePool {
        &arg0.fee_balances
    }

    public(friend) fun borrow_fee_pool_mut(arg0: &mut Vault) : &mut 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::FeePool {
    ...
    public(friend) fun borrow_position(arg0: &Vault, arg1: 0x2::object::ID) : &PositionRecord {
        assert!(0x2::table::contains<0x2::object::ID, PositionRecord>(&arg0.positions, arg1), 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors::position_not_found());
    ...
    public(friend) fun borrow_user_pool(arg0: &Vault) : &0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::UserPool {
        &arg0.balances
    }

    public(friend) fun borrow_user_pool_mut(arg0: &mut Vault) : &mut 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::UserPool {
        &mut arg0.balances
    }

    fun bucket_in_window(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : bool {
        let v0 = if (arg1 > arg2) {
            arg1 - arg2
        } else {
            0
    ...
    public(friend) fun check_and_record_deposit<T0>(arg0: &mut Vault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        let v1 = deposit_caps_mut(arg0, arg2);
        assert!(0x2::table::contains<0x1::type_name::TypeName, DepositCapState>(v1, v0), 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors::deposit_cap_exceeded());
        let v2 = 0x2::table::borrow_mut<0x1::type_name::TypeName, DepositCapState>(v1, v0);
        assert!(v2.net_deposited + arg1 <= v2.cap, 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors::deposit_cap_exceeded());
        v2.net_deposited = v2.net_deposited + arg1;
    }
    ...
    public(friend) fun create_account(arg0: &mut Vault, arg1: address) {
        let v0 = UserAccount{
            ...
            gas_buckets           : 0x1::vector::empty<GasBucket>(),
    ...
    public fun create_vault(arg0: u64, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (Vault, AdminCap, TreasurerCap, GuardianCap) {
        let v0 = 0x2::object::new(arg3);
        let v1 = 0x2::object::uid_to_inner(&v0);
        let v2 = 0x2::clock::timestamp_ms(arg2) / 1000;
        let v3 = Vault{
            id                     : v0,
            balances               : 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::new_user_pool(arg3),
            fee_balances           : 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::pools::new_fee_pool(arg3),
        ...
        0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::events::emit_vault_created(v1, 0x2::tx_context::sender(arg3), arg0, v2);
        (v3, v4, v5, v6)
    }
    ...
    fun default_config(arg0: address) : VaultConfig {
        let v0 = OperatorRateLimits{
            ...
            max_value_per_window : 500000000000000,
    ...
    public fun deposit_cap_state<T0>(arg0: &Vault) : (u64, u64) {
        if (!0x2::dynamic_object_field::exists_<vector<u8>>(&arg0.id, b"deposit_caps_v11")) {
            return (0, 0)
        };
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        let v1 = 0x2::dynamic_object_field::borrow<vector<u8>, 0x2::table::Table<0x1::type_name::TypeName, DepositCapState>>(&arg0.id, b"deposit_caps_v11");
        if (0x2::table::contains<0x1::type_name::TypeName, DepositCapState>(v1, v0)) {
            let v4 = 0x2::table::borrow<0x1::type_name::TypeName, DepositCapState>(v1, v0);
            (v4.cap, v4.net_deposited)
        } else {
            (0, 0)
        }
    }

    fun deposit_caps_mut(arg0: &mut Vault, arg1: &mut 0x2::tx_context::TxContext) : &mut 0x2::table::Table<0x1::type_name::TypeName, DepositCapState> {
        if (!0x2::dynamic_object_field::exists_<vector<u8>>(&arg0.id, b"deposit_caps_v11")) {
            0x2::dynamic_object_field::add<vector<u8>, 0x2::table::Table<0x1::type_name::TypeName, DepositCapState>>(&mut arg0.id, b"deposit_caps_v11", 0x2::table::new<0x1::type_name::TypeName, DepositCapState>(arg1));
        };
        0x2::dynamic_object_field::borrow_mut<vector<u8>, 0x2::table::Table<0x1::type_name::TypeName, DepositCapState>>(&mut arg0.id, b"deposit_caps_v11")
    }

    public(friend) fun get_or_init_user_rate_state(arg0: &mut Vault, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : &mut UserRateState {
        if (!0x2::dynamic_object_field::exists_<vector<u8>>(&arg0.id, b"user_rate_states_v9")) {
            0x2::dynamic_object_field::add<vector<u8>, 0x2::table::Table<address, UserRateState>>(&mut arg0.id, b"user_rate_states_v9", 0x2::table::new<address, UserRateState>(arg2));
        };
        let v0 = 0x2::dynamic_object_field::borrow_mut<vector<u8>, 0x2::table::Table<address, UserRateState>>(&mut arg0.id, b"user_rate_states_v9");
        if (!0x2::table::contains<address, UserRateState>(v0, arg1)) {
            let v1 = UserRateState{
                window_start : 0,
                ops          : 0,
                value        : 0,
            };
            0x2::table::add<address, UserRateState>(v0, arg1, v1);
        };
        0x2::table::borrow_mut<address, UserRateState>(v0, arg1)
    }

    public fun guardian_cap_vault_id(arg0: &GuardianCap) : 0x2::object::ID {
        arg0.vault_id
    }
    ...
    public(friend) fun increment_user_rate(arg0: &mut UserRateState, arg1: u64) {
        arg0.ops = arg0.ops + 1;
    ...
    public fun init_vault(arg0: u64, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3) = create_vault(arg0, arg1, arg2, arg3);
        ...
        0x2::transfer::public_transfer<GuardianCap>(v3, 0x2::tx_context::sender(arg3));
    }
    ...
    public fun migrate(arg0: &mut Vault, arg1: &AdminCap) {
        assert!(arg1.vault_id == 0x2::object::uid_to_inner(&arg0.id), 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors::not_admin());
        assert!(arg0.version < 11, 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::errors::version_mismatch());
        arg0.version = 11;
    }
    ...
    public(friend) fun prune_and_sum_gas_buckets(arg0: &mut UserAccount, arg1: u64, arg2: u64, arg3: u64) : u64 {
        let v0 = &arg0.gas_buckets;
        let v1 = 0x1::vector::empty<GasBucket>();
        let v2 = 0;
        let v3 = 0;
        while (v3 < 0x1::vector::length<GasBucket>(v0)) {
            let v4 = *0x1::vector::borrow<GasBucket>(v0, v3);
            if (bucket_in_window(v4.bucket, arg1, arg2, arg3)) {
                v2 = v2 + v4.amount;
                0x1::vector::push_back<GasBucket>(&mut v1, v4);
            };
            v3 = v3 + 1;
        };
        arg0.gas_buckets = v1;
    ...
    public(friend) fun record_withdrawal<T0>(arg0: &mut Vault, arg1: u64) {
        if (!0x2::dynamic_object_field::exists_<vector<u8>>(&arg0.id, b"deposit_caps_v11")) {
            return
        };
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        let v1 = 0x2::dynamic_object_field::borrow_mut<vector<u8>, 0x2::table::Table<0x1::type_name::TypeName, DepositCapState>>(&mut arg0.id, b"deposit_caps_v11");
        if (0x2::table::contains<0x1::type_name::TypeName, DepositCapState>(v1, v0)) {
            let v2 = 0x2::table::borrow_mut<0x1::type_name::TypeName, DepositCapState>(v1, v0);
            let v3 = if (v2.net_deposited > arg1) {
                v2.net_deposited - arg1
            } else {
                0
            };
            v2.net_deposited = v3;
    ...
    public(friend) fun reset_user_rate_window(arg0: &mut UserRateState, arg1: u64) {
    ...
    public(friend) fun set_deposit_cap_for<T0>(arg0: &mut Vault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        let v1 = deposit_caps_mut(arg0, arg2);
        if (0x2::table::contains<0x1::type_name::TypeName, DepositCapState>(v1, v0)) {
            0x2::table::borrow_mut<0x1::type_name::TypeName, DepositCapState>(v1, v0).cap = arg1;
        } else {
            let v2 = DepositCapState{
                cap           : arg1,
                net_deposited : 0,
            };
            0x2::table::add<0x1::type_name::TypeName, DepositCapState>(v1, v0, v2);
        };
    }
    ...
    public(friend) fun user_rate_ops(arg0: &UserRateState) : u64 {
        arg0.ops
    }

    public(friend) fun user_rate_value(arg0: &UserRateState) : u64 {
        arg0.value
    }

    public(friend) fun user_rate_window_start(arg0: &UserRateState) : u64 {
        arg0.window_start
    }
