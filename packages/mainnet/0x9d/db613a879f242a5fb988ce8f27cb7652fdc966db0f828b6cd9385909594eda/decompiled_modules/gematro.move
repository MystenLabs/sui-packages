module 0x9ddb613a879f242a5fb988ce8f27cb7652fdc966db0f828b6cd9385909594eda::gematro {
    ...
    fun init(arg0: GEMATRO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<GEMATRO>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<GEMATRO>>(v4);
    }
