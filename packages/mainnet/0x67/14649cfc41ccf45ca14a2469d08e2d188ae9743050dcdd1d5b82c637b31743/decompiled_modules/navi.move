module 0x6714649cfc41ccf45ca14a2469d08e2d188ae9743050dcdd1d5b82c637b31743::navi {
    struct NaviAccountCapKey has copy, drop, store {
        dummy_field: bool,
    }

    public(friend) fun balance(arg0: &0x6714649cfc41ccf45ca14a2469d08e2d188ae9743050dcdd1d5b82c637b31743::vault::Vault, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg2: u8) : (u256, u256) {
    ...
    fun get_account_cap(arg0: &0x6714649cfc41ccf45ca14a2469d08e2d188ae9743050dcdd1d5b82c637b31743::vault::Vault) : &0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap {
        let v0 = NaviAccountCapKey{dummy_field: false};
        0x6714649cfc41ccf45ca14a2469d08e2d188ae9743050dcdd1d5b82c637b31743::vault::borrow_object<NaviAccountCapKey, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap>(arg0, v0)
    }

    public(friend) fun setup(arg0: &mut 0x6714649cfc41ccf45ca14a2469d08e2d188ae9743050dcdd1d5b82c637b31743::vault::Vault, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = NaviAccountCapKey{dummy_field: false};
        0x6714649cfc41ccf45ca14a2469d08e2d188ae9743050dcdd1d5b82c637b31743::vault::put_object<NaviAccountCapKey, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap>(arg0, v0, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::create_account(arg1));
    }

    public(friend) fun withdraw<T0>(arg0: &0x6714649cfc41ccf45ca14a2469d08e2d188ae9743050dcdd1d5b82c637b31743::vault::Vault, arg1: &0x2::clock::Clock, arg2: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: u8, arg6: u64, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive::Incentive, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive) : 0x2::balance::Balance<T0> {
