module 0x67b9a3afa65422e87765f198809a9bb4048a964a9b0679a2d5fd9a7a975231ce::reward6736 {
    struct REWARD6736 has drop {
        dummy_field: bool,
    }

    struct TICKET_6736 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6736(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6736>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6736>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6736, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6736>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6736>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6736>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6736>>(v5, 0x2::tx_context::sender(arg1));
    }
