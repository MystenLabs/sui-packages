module 0x9e8b7adea5d41fbd07865145dbbc068f35a8bc908213b5ac5219d10b3072789c::dca_order {
    ...
    public fun fill_dca_order<T0, T1>(arg0: &0x9e8b7adea5d41fbd07865145dbbc068f35a8bc908213b5ac5219d10b3072789c::config::GlobalConfig, arg1: &mut DcaOrder<T0, T1>, arg2: DcaOrderPrefill, arg3: 0x2::coin::Coin<T1>, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x9e8b7adea5d41fbd07865145dbbc068f35a8bc908213b5ac5219d10b3072789c::config::only_operator(arg0, arg6);
    ...
    public entry fun place_dca_order<T0, T1>(arg0: &0x9e8b7adea5d41fbd07865145dbbc068f35a8bc908213b5ac5219d10b3072789c::config::GlobalConfig, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<0x2::coin::Coin<T0>>(&arg1) > 0, 0);
        assert!(0x1::vector::length<0x2::coin::Coin<T0>>(&arg1) <= 0x9e8b7adea5d41fbd07865145dbbc068f35a8bc908213b5ac5219d10b3072789c::config::get_max_dca_order_count(arg0), 0);
        assert!(arg2 <= 0x9e8b7adea5d41fbd07865145dbbc068f35a8bc908213b5ac5219d10b3072789c::config::get_max_interval(arg0), 10);
        ...
        0x2::event::emit<DcaOrderCreated>(v8);
        0x2::transfer::share_object<DcaOrder<T0, T1>>(v7);
    }

    public fun prefill_dca_order<T0, T1>(arg0: &0x9e8b7adea5d41fbd07865145dbbc068f35a8bc908213b5ac5219d10b3072789c::config::GlobalConfig, arg1: &mut DcaOrder<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, DcaOrderPrefill) {
        assert!(0x1::vector::length<0x2::balance::Balance<T0>>(&arg1.pay_balance) > 0, 4);
        0x9e8b7adea5d41fbd07865145dbbc068f35a8bc908213b5ac5219d10b3072789c::config::only_operator(arg0, arg4);
        ...
        let v2 = (((v1 as u256) * (arg1.min_rate as u256) * ((10000 - arg1.slippage) as u256) / 10000000000000000) as u64);
        0x9e8b7adea5d41fbd07865145dbbc068f35a8bc908213b5ac5219d10b3072789c::config::only_valid_fee(arg0, arg2, v2);
        let v3 = v2 - arg2;
        let v4 = (((v1 as u256) * (arg1.max_rate as u256) * ((10000 + arg1.slippage) as u256) / 10000000000000000) as u64);
        arg1.last_filled_ts = 0x2::clock::timestamp_ms(arg3);
        let v5 = DcaOrderPrefilled{
            order_id         : 0x2::object::id<DcaOrder<T0, T1>>(arg1),
            min_repay_amount : v3,
            max_repay_amount : v4,
        };
        0x2::event::emit<DcaOrderPrefilled>(v5);
        let v6 = DcaOrderPrefill{
            order_id         : 0x2::object::id<DcaOrder<T0, T1>>(arg1),
            min_repay_amount : v3,
            max_repay_amount : v4,
        };
        (0x2::coin::from_balance<T0>(v0, arg4), v6)
    }
