module 0x67c0fbf4ba0b369cc5210a7dc88b4fa345fa43c037f526fe970654658a1aa0c3::app_cap_display {
    ...
    public(friend) fun new(arg0: 0x67c0fbf4ba0b369cc5210a7dc88b4fa345fa43c037f526fe970654658a1aa0c3::name::Name, arg1: bool) : AppCapDisplay {
        let v0 = if (arg1) {
            100
        } else {
            0
        ...
        AppCapDisplay{
            title            : 0x67c0fbf4ba0b369cc5210a7dc88b4fa345fa43c037f526fe970654658a1aa0c3::name::to_string(&arg0),
            link_opacity     : v0,
    ...
    public(friend) fun uri_encode_text(arg0: 0x67c0fbf4ba0b369cc5210a7dc88b4fa345fa43c037f526fe970654658a1aa0c3::name::Name) : 0x1::string::String {
        let v0 = 0x1::string::utf8(b"");
        let (v1, v2) = render_batch(0x67c0fbf4ba0b369cc5210a7dc88b4fa345fa43c037f526fe970654658a1aa0c3::name::app_to_string(&arg0), 13, 40, 26, 26, 0x1::string::utf8(b"FFFFFF"));
        0x1::string::append(&mut v0, v1);
        let (v3, _) = render_batch(0x67c0fbf4ba0b369cc5210a7dc88b4fa345fa43c037f526fe970654658a1aa0c3::name::org_to_string(&arg0), 22, v2, 15, 15, 0x1::string::utf8(b"E0E1EC"));
