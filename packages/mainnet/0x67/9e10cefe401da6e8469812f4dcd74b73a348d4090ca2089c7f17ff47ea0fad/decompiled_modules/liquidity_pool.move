module 0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::liquidity_pool {
    struct LiquidityPool has key {
        id: 0x2::object::UID,
        usdt_reserve: 0x2::balance::Balance<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>,
    ...
    public entry fun add_liquidity(arg0: &mut LiquidityPool, arg1: 0x2::coin::Coin<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(&arg1);
        ...
        let v2 = if (arg0.lp_token_supply == 0) {
            ...
            let v3 = v0 * arg0.lp_token_supply / 0x2::balance::value<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(&arg0.usdt_reserve);
        ...
        0x2::balance::join<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(&mut arg0.usdt_reserve, 0x2::coin::into_balance<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(arg1));
    ...
    public entry fun create_pool(arg0: 0x2::coin::Coin<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(&arg0);
        ...
        let v4 = LiquidityPool{
            id              : v2,
            usdt_reserve    : 0x2::coin::into_balance<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(arg0),
            sui_reserve     : 0x2::coin::into_balance<0x2::sui::SUI>(arg1),
            lp_token_supply : 0x1::u64::sqrt(v0 * v1),
            fee_rate        : 30,
            price_usdt_usd  : 100,
        };
        let v5 = LPToken{
    ...
    public fun get_reserves(arg0: &LiquidityPool) : (u64, u64) {
        (0x2::balance::value<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(&arg0.usdt_reserve), 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_reserve))
    }
    ...
    public entry fun remove_liquidity(arg0: &mut LiquidityPool, arg1: LPToken, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2 * 0x2::balance::value<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(&arg0.usdt_reserve) / arg0.lp_token_supply;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>>(0x2::coin::take<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(&mut arg0.usdt_reserve, v3, arg2), 0x2::tx_context::sender(arg2));
    ...
    public entry fun swap_sui_for_usdt(arg0: &mut LiquidityPool, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 4);
        let v1 = 0x2::balance::value<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(&arg0.usdt_reserve);
    ...
    public entry fun swap_usdt_for_sui(arg0: &mut LiquidityPool, arg1: 0x2::coin::Coin<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(&arg1);
        assert!(v0 > 0, 4);
        let v1 = 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_reserve);
        let v2 = v0 * (10000 - arg0.fee_rate) / 10000;
        let v3 = v1 * v2 / (0x2::balance::value<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(&arg0.usdt_reserve) + v2);
        assert!(v3 >= arg2, 2);
        assert!(v3 < v1, 1);
        0x2::balance::join<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(&mut arg0.usdt_reserve, 0x2::coin::into_balance<0x679e10cefe401da6e8469812f4dcd74b73a348d4090ca2089c7f17ff47ea0fad::tether_usdt_sui::TETHER_USDT_SUI>(arg1));
        let v4 = SwapExecuted{
