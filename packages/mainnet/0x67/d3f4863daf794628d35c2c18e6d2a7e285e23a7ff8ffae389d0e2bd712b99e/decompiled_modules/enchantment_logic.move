module 0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::enchantment_logic {
    ...
    fun budget_for_rarity(arg0: u8) : u64 {
        ...
        (((50 as u128) * (v0 as u128) / (0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::constants::bp_den() as u128)) as u64)
    }
    ...
    public(friend) fun enchant_inventory_slot(arg0: &mut 0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::character_data::Character, arg1: &0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::game_data::GameData, arg2: u64, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) : EnchantmentResult {
        ...
        let v1 = 0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::inventory_item::item_id(v0);
        let v2 = 0x2::random::new_generator(arg3, arg4);
        let v3 = if (0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::inventory_item::enchantment_rarity(v0) > 0) {
            true
        } else if (0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::inventory_item::agility_bonus(v0) > 0) {
            true
        } else if (0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::inventory_item::endurance_bonus(v0) > 0) {
            true
        } else if (0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::inventory_item::stealth_bonus(v0) > 0) {
            true
        } else {
            0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::inventory_item::luck_bonus(v0) > 0
        };
        let v4 = &mut v2;
        ...
        let v12 = 0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::character_data::get_item_by_instance_id_mut(arg0, arg2);
        0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::inventory_item::set_bonuses(v12, v8, v9, v10, v11, v5);
        if (0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::inventory_management::is_type_equipped(arg0, 0x67d3f4863daf794628d35c2c18e6d2a7e285e23a7ff8ffae389d0e2bd712b99e::inventory_item::type_id(v12))) {
