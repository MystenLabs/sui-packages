module 0x6715a220c284826e6ee977b9af09340f6b9266b93a337fbed90a5c1299066a04::sui_spooker {
    struct SUI_SPOOKER has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_SPOOKER, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_SPOOKER>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sui Spooker"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"In the shadowy recesses of your mind, it stirs. The entity known only as Spooker - a creature with many forms"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiao4uk5z6ivjg2aocrmspznt43x2e5nifnkffwu3czb6xgtoxrl3i"));
