module 0x675421a1f47d085431359a5f6b03d3d00bfd4146b1116441ec5af8cb2933384d::reward9105 {
    struct REWARD9105 has drop {
        dummy_field: bool,
    }

    struct TICKET_9105 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9105(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9105>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9105>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9105, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9105>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9105>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9105>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9105>>(v5, 0x2::tx_context::sender(arg1));
    }
