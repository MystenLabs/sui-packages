module 0x67c8f306d37e9584f07d66042bed786c662b2d876162761a22f861056daf8fb0::cnsnft8782 {
    struct CNSNFT8782 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8782, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8782>(arg0, arg1);
