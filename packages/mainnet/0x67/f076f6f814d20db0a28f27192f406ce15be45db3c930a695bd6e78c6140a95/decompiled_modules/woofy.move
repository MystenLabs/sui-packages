module 0x67f076f6f814d20db0a28f27192f406ce15be45db3c930a695bd6e78c6140a95::woofy {
    ...
    fun init(arg0: WOOFY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/ButrUKN9jKVzZykMwTHSQ6i2tMaawMvsTjFb6MBSpump.png?size=lg&key=693a0d                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<WOOFY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"WOOFY   ")))), trim_right(b"WOOFY DOG                       "), trim_right(b"Hey there! Im Woofy, your friendly and fluffy companion. Im here to bring fun, community, and exciting adventures to everyone who joins my pack.                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
