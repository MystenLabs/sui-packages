module 0x67ab6bd272b78780524310b8c81b413305103eef2954db358f39ae32718e6434::vaults_manager {
    ...
    struct VaultsManager has store, key {
        id: 0x2::object::UID,
        package_version: u64,
        acl: 0x67ab6bd272b78780524310b8c81b413305103eef2954db358f39ae32718e6434::acl::ACL,
    }
    ...
    public fun add_role(arg0: &AdminCap, arg1: &mut VaultsManager, arg2: address, arg3: u8) {
        ...
        0x67ab6bd272b78780524310b8c81b413305103eef2954db358f39ae32718e6434::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun remove_member(arg0: &AdminCap, arg1: &mut VaultsManager, arg2: address) {
        checked_package_version(arg1);
        0x67ab6bd272b78780524310b8c81b413305103eef2954db358f39ae32718e6434::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut VaultsManager, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0x67ab6bd272b78780524310b8c81b413305103eef2954db358f39ae32718e6434::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &AdminCap, arg1: &mut VaultsManager, arg2: address, arg3: u128) {
        checked_package_version(arg1);
        0x67ab6bd272b78780524310b8c81b413305103eef2954db358f39ae32718e6434::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    public fun check_compound_role(arg0: &VaultsManager, arg1: address) {
        assert!(0x67ab6bd272b78780524310b8c81b413305103eef2954db358f39ae32718e6434::acl::has_role(&arg0.acl, arg1, 1), 1006);
    }

    public fun check_operation_role(arg0: &VaultsManager, arg1: address) {
        assert!(0x67ab6bd272b78780524310b8c81b413305103eef2954db358f39ae32718e6434::acl::has_role(&arg0.acl, arg1, 1) || 0x67ab6bd272b78780524310b8c81b413305103eef2954db358f39ae32718e6434::acl::has_role(&arg0.acl, arg1, 2), 1002);
    }

    public fun check_pool_manager_role(arg0: &VaultsManager, arg1: address) {
        assert!(0x67ab6bd272b78780524310b8c81b413305103eef2954db358f39ae32718e6434::acl::has_role(&arg0.acl, arg1, 3), 1003);
    }

    public fun check_protocol_fee_claim_role(arg0: &VaultsManager, arg1: address) {
        assert!(0x67ab6bd272b78780524310b8c81b413305103eef2954db358f39ae32718e6434::acl::has_role(&arg0.acl, arg1, 0), 1004);
    }

    public fun check_rebalance_role(arg0: &VaultsManager, arg1: address) {
        assert!(0x67ab6bd272b78780524310b8c81b413305103eef2954db358f39ae32718e6434::acl::has_role(&arg0.acl, arg1, 2), 1005);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = VaultsManager{
            ...
            package_version : 1,
            acl             : 0x67ab6bd272b78780524310b8c81b413305103eef2954db358f39ae32718e6434::acl::new(arg0),
        };
        let v2 = InitEvent{
