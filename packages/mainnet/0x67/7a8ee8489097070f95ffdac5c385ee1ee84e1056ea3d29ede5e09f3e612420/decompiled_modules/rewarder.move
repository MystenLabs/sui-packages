module 0x677a8ee8489097070f95ffdac5c385ee1ee84e1056ea3d29ede5e09f3e612420::rewarder {
    ...
    public fun deposit_reward<T0>(arg0: &0x677a8ee8489097070f95ffdac5c385ee1ee84e1056ea3d29ede5e09f3e612420::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) : u64 {
    ...
    public fun emergent_withdraw<T0>(arg0: &0x677a8ee8489097070f95ffdac5c385ee1ee84e1056ea3d29ede5e09f3e612420::config::AdminCap, arg1: &0x677a8ee8489097070f95ffdac5c385ee1ee84e1056ea3d29ede5e09f3e612420::config::GlobalConfig, arg2: &mut RewarderGlobalVault, arg3: u64) : 0x2::balance::Balance<T0> {
        0x677a8ee8489097070f95ffdac5c385ee1ee84e1056ea3d29ede5e09f3e612420::config::checked_package_version(arg1);
    ...
    public(friend) fun settle(arg0: &mut RewarderManager, arg1: u128, arg2: u64) {
        ...
        while (v2 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            ...
            0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v2).growth_global = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).growth_global + 0xe31ab475dde2448379d2c24fef23c0a3cb68fd11226984ee7c3a561aadc78ad4::full_math_u128::mul_div_floor((v1 as u128), v3, arg1);
            v2 = v2 + 1;
        };
        let v4 = 18446744073709551616000000;
        arg0.points_released = arg0.points_released + (v1 as u128) * v4;
        arg0.points_growth_global = arg0.points_growth_global + 0xe31ab475dde2448379d2c24fef23c0a3cb68fd11226984ee7c3a561aadc78ad4::full_math_u128::mul_div_floor((v1 as u128), v4, arg1);
    }
