module 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_staker {
    ...
    fun epoch_staked_sui_growth_rates(arg0: &mut SuidoubleLiquidStaker, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: u64) : vector<u128> {
        ...
        while (v0 < 0x1::vector::length<0x3::staking_pool::StakedSui>(&arg0.staked_pool)) {
            let v3 = 0x3::staking_pool::pool_id(0x1::vector::borrow<0x3::staking_pool::StakedSui>(&arg0.staked_pool, v0));
            let v4 = 0x3::sui_system::pool_exchange_rates(arg1, &v3);
            let v5 = staking_pool_echange_rate_at_epoch(v4, arg2);
            let v6 = staking_pool_echange_rate_at_epoch(v4, arg2 - 5);
            let v7 = 0x3::staking_pool::pool_token_amount(&v5);
            if (v7 == 0) {
                0x1::vector::push_back<u128>(&mut v1, 0);
            } else {
                let v8 = 0x3::staking_pool::pool_token_amount(&v6);
                if (v8 == 0) {
                    0x1::vector::push_back<u128>(&mut v1, 0);
                } else {
                    let v9 = (0x3::staking_pool::sui_amount(&v5) as u128) * (v2 as u128) / (v7 as u128);
                    let v10 = (0x3::staking_pool::sui_amount(&v6) as u128) * (v2 as u128) / (v8 as u128);
                    if (v10 >= v9) {
                        0x1::vector::push_back<u128>(&mut v1, 0);
                    } else {
                        0x1::vector::push_back<u128>(&mut v1, v9 - v10);
                    };
                };
            };
            v0 = v0 + 1;
    ...
    public(friend) fun stake_sui(arg0: &mut SuidoubleLiquidStaker, arg1: &mut 0x2::balance::Balance<0x2::sui::SUI>, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x2::balance::value<0x2::sui::SUI>(arg1) / 1000000000 * 1000000000;
        if (v0 > 0) {
            let v1 = 0x2::object::new(arg3);
            0x2::object::delete(v1);
            let v2 = random_validator_address(arg2, 0x2::object::uid_to_bytes(&v1));
            0x1::vector::push_back<0x3::staking_pool::StakedSui>(&mut arg0.staked_pool, 0x3::sui_system::request_add_stake_non_entry(arg2, 0x2::coin::take<0x2::sui::SUI>(arg1, v0, arg3), v2, arg3));
