module 0x67c66c0152e79ef906e86e4e43efe541b354a7a4e13baeb0a1649ca0626a27c5::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"ZOO", b"Zuii.....", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-03T09-22-06.721Z-ronaldo.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Zuii....."),
            symbol     : 0x1::string::utf8(b"ZOO"),
            decimals   : 9,
