module 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault {
    ...
    public entry fun add_withdraw_assets<T0, T1, T2>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: 0x2::coin::Coin<T2>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::bag::contains<0x1::ascii::String>(&v2, v0)) {
            0x2::coin::join<T2>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut v2, v0), arg3);
        } else {
    ...
    public entry fun deposit_with_sigs_credit_time<T0, T1>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::mint_and_transfer<T1>(&mut arg1.treasury_cap, v7, 0x2::tx_context::sender(arg11), arg11);
        let v8 = DepositWithSigTimeEvent{
        ...
        0x2::event::emit<DepositWithSigTimeEvent>(v8);
    }
    ...
    public entry fun move_token_to_withdraw_assets<T0, T1, T2>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 == 0x1::type_name::into_string(0x1::type_name::get<T0>())) {
            ...
            let v3 = get_dynamic_field_or_default<T0, T1, vector<0x1::ascii::String>>(arg2, b"withdraw_asset_keys", 0x1::vector::empty<0x1::ascii::String>());
            if (!0x2::dynamic_field::exists_<vector<u8>>(&arg2.id, b"withdraw_assets")) {
                0x2::dynamic_field::add<vector<u8>, 0x2::bag::Bag>(&mut arg2.id, b"withdraw_assets", 0x2::bag::new(arg4));
            };
            let v4 = 0x2::dynamic_field::remove<vector<u8>, 0x2::bag::Bag>(&mut arg2.id, b"withdraw_assets");
            if (0x2::bag::contains<0x1::ascii::String>(&v4, v0)) {
                0x2::coin::join<T0>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut v4, v0), v2);
            } else {
                0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut v4, v0, v2);
                0x1::vector::push_back<0x1::ascii::String>(&mut v3, v0);
            };
            0x2::dynamic_field::add<vector<u8>, 0x2::bag::Bag>(&mut arg2.id, b"withdraw_assets", v4);
            set_dynamic_field<T0, T1, vector<0x1::ascii::String>>(arg2, b"withdraw_asset_keys", v3);
            ...
            let v7 = 0x2::coin::split<T2>(v6, arg3, arg4);
            ...
            let v10 = get_dynamic_field_or_default<T0, T1, vector<0x1::ascii::String>>(arg2, b"withdraw_asset_keys", 0x1::vector::empty<0x1::ascii::String>());
            if (!0x2::dynamic_field::exists_<vector<u8>>(&arg2.id, b"withdraw_assets")) {
                0x2::dynamic_field::add<vector<u8>, 0x2::bag::Bag>(&mut arg2.id, b"withdraw_assets", 0x2::bag::new(arg4));
            };
            let v11 = 0x2::dynamic_field::remove<vector<u8>, 0x2::bag::Bag>(&mut arg2.id, b"withdraw_assets");
            if (0x2::bag::contains<0x1::ascii::String>(&v11, v0)) {
                0x2::coin::join<T2>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut v11, v0), v7);
            } else {
                0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut v11, v0, v7);
                0x1::vector::push_back<0x1::ascii::String>(&mut v10, v0);
            };
            0x2::dynamic_field::add<vector<u8>, 0x2::bag::Bag>(&mut arg2.id, b"withdraw_assets", v11);
            set_dynamic_field<T0, T1, vector<0x1::ascii::String>>(arg2, b"withdraw_asset_keys", v10);
            let v12 = MoveTokenToWithdrawAssetEvent{
                amount   : arg3,
                vault_id : 0x2::object::id<Vault<T0, T1>>(arg2),
                token    : v0,
            };
            0x2::event::emit<MoveTokenToWithdrawAssetEvent>(v12);
        };
    }
    ...
    fun spend_withdraw_asset<T0, T1, T2>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        0x2::coin::split<T2>(v3, arg1, arg2)
    }
