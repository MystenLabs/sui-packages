module 0x67b217f486e48d7fa9fdee83f2fde54823d4da77ef72c59875e2c25c1ca8d37d::dex_aftermath {
    ...
    public fun get_aftermath_package() : address {
        0x67b217f486e48d7fa9fdee83f2fde54823d4da77ef72c59875e2c25c1ca8d37d::constants::aftermath_package()
    }
    ...
    public fun is_aftermath_operational() : bool {
        0x67b217f486e48d7fa9fdee83f2fde54823d4da77ef72c59875e2c25c1ca8d37d::constants::aftermath_package() != @0x0
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = AftermathSwapExecuted{
            ...
            package        : 0x67b217f486e48d7fa9fdee83f2fde54823d4da77ef72c59875e2c25c1ca8d37d::constants::aftermath_package(),
