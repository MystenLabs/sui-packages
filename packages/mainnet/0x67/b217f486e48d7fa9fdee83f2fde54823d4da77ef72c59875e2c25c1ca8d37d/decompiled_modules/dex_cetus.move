module 0x67b217f486e48d7fa9fdee83f2fde54823d4da77ef72c59875e2c25c1ca8d37d::dex_cetus {
    ...
    public fun get_cetus_package() : address {
        0x67b217f486e48d7fa9fdee83f2fde54823d4da77ef72c59875e2c25c1ca8d37d::constants::cetus_package()
    }

    public fun get_cetus_sui_usdc_pool() : address {
        0x67b217f486e48d7fa9fdee83f2fde54823d4da77ef72c59875e2c25c1ca8d37d::constants::cetus_sui_usdc_pool()
    }

    public fun is_cetus_operational() : bool {
        0x67b217f486e48d7fa9fdee83f2fde54823d4da77ef72c59875e2c25c1ca8d37d::constants::cetus_package() != @0x0
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = CetusSwapExecuted{
            ...
            package        : 0x67b217f486e48d7fa9fdee83f2fde54823d4da77ef72c59875e2c25c1ca8d37d::constants::cetus_package(),
