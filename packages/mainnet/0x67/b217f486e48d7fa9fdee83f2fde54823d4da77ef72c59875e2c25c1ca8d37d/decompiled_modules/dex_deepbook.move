module 0x67b217f486e48d7fa9fdee83f2fde54823d4da77ef72c59875e2c25c1ca8d37d::dex_deepbook {
    ...
    public fun get_deepbook_package() : address {
        0x67b217f486e48d7fa9fdee83f2fde54823d4da77ef72c59875e2c25c1ca8d37d::constants::deepbook_package()
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = DeepBookRealSwapExecuted{
            ...
            pool_id         : arg2,
            package         : 0x67b217f486e48d7fa9fdee83f2fde54823d4da77ef72c59875e2c25c1ca8d37d::constants::deepbook_package(),
