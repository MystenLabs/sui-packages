module 0x670144b6d4a8b1d28da587f6fcaf1e175a35fde9ab9f3a85e30d93e64bdeeed8::reward1738 {
    struct REWARD1738 has drop {
        dummy_field: bool,
    }

    struct TICKET_1738 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1738(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1738>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1738>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1738, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1738>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1738>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1738>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1738>>(v5, 0x2::tx_context::sender(arg1));
    }
