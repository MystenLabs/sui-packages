module 0x679db47f827f997906ced6ab18fd9cf1eeb8a2a3d0c33db984dd7b4c5c1363c8::cnsnft2809 {
    struct CNSNFT2809 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2809, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7269"));
        let v4 = 0x2::package::claim<CNSNFT2809>(arg0, arg1);
