module 0x674db3e3726a0153e717be26e3227a6f67e9af24fc8a2943c86c0a6b0a6e318b::registry {
    ...
    public fun activity(arg0: &Registry, arg1: u16) : ActivityDef {
        assert!(0x2::table::contains<u16, ActivityDef>(&arg0.activities, arg1), 13906835699056771073);
    ...
    public fun add_enemy(arg0: &AdminCap, arg1: &mut Registry, arg2: u16, arg3: u8, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: vector<u16>, arg12: vector<u64>, arg13: vector<u64>) {
        assert!(0x1::vector::length<u16>(&arg11) == 0x1::vector::length<u64>(&arg12) && 0x1::vector::length<u16>(&arg11) == 0x1::vector::length<u64>(&arg13), 13906835488603504643);
        let v0 = EnemyDef{
            level           : arg3,
            hp              : arg4,
            attack          : arg5,
    ...
    public fun add_location(arg0: &AdminCap, arg1: &mut Registry, arg2: u16, arg3: u16, arg4: u16, arg5: u16, arg6: u64, arg7: vector<u16>, arg8: vector<u64>) {
        assert!(0x1::vector::length<u16>(&arg7) == 0x1::vector::length<u64>(&arg8), 13906835617452523523);
        let v0 = LocationDef{
            level_req     : arg3,
            x             : arg4,
            y             : arg5,
    ...
    public fun add_recipe(arg0: &AdminCap, arg1: &mut Registry, arg2: u16, arg3: u8, arg4: u8, arg5: u64, arg6: u64, arg7: vector<u16>, arg8: vector<u64>, arg9: u16, arg10: u64, arg11: u16, arg12: u16, arg13: u64) {
        assert!(0x1::vector::length<u16>(&arg7) == 0x1::vector::length<u64>(&arg8), 13906835329689714691);
        let v0 = RecipeDef{
            skill            : arg3,
            level_req        : arg4,
            duration_ms      : arg5,
    ...
    public(friend) fun assert_version(arg0: &Registry) {
        assert!(arg0.version == 1, 13906834844358541317);
    }

    public fun enemy(arg0: &Registry, arg1: u16) : EnemyDef {
        assert!(0x2::table::contains<u16, EnemyDef>(&arg0.enemies, arg1), 13906835742006444033);
    ...
    public fun equipment(arg0: &Registry, arg1: u16) : EquipmentDef {
        assert!(0x2::table::contains<u16, EquipmentDef>(&arg0.equipment, arg1), 13906835677581934593);
    ...
    public fun item(arg0: &Registry, arg1: u16) : ItemDef {
        assert!(0x2::table::contains<u16, ItemDef>(&arg0.items, arg1), 13906835656107098113);
    ...
    public fun location(arg0: &Registry, arg1: u16) : LocationDef {
        assert!(0x2::table::contains<u16, LocationDef>(&arg0.locations, arg1), 13906835763481280513);
    ...
    public fun recipe(arg0: &Registry, arg1: u16) : RecipeDef {
        assert!(0x2::table::contains<u16, RecipeDef>(&arg0.recipes, arg1), 13906835720531607553);
