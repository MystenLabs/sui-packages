module 0xa32574713e612fa6d9eb439723cb7d69f06ae55117d8c9a028330cea98c5f391::marketplace {
    ...
    public fun accept_unlisted_bid<T0: store + key>(arg0: &0x2::clock::Clock, arg1: &mut MarketPlaceStore, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: address, arg7: 0x2::object::ID, arg8: u64, arg9: bool, arg10: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg11: &mut 0xb2f3f2134577e6cd3ef312b099f05e48964301262a1158416143e57358d2e455::ions::AnimaIONs, arg12: &mut 0xb2f3f2134577e6cd3ef312b099f05e48964301262a1158416143e57358d2e455::ions::AnimaChef, arg13: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        let v14 = 0x2::balance::value<0x2::sui::SUI>(&v9) - arg8;
        0x2::kiosk::list<T0>(arg2, arg4, arg5, v14);
        let (v15, v16) = 0x2::kiosk::purchase<T0>(arg2, arg5, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v9, v14), arg13));
        let v17 = v16;
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg10, &mut v17, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v9, arg8), arg13));
        let v18 = 0x2::balance::value<0x2::sui::SUI>(&v9);
        ...
        0x2::kiosk::lock<T0>(arg3, &arg1.escrow_kiosk_cap, arg10, v15);
        let v19 = PendingClaim{
            buyer    : arg6,
            nft_type : v1,
            price    : v18 - v13,
        };
        if (0x2::linked_table::contains<address, PendingClaims>(&arg1.pending_claims, arg6)) {
            0x2::linked_table::push_back<0x2::object::ID, PendingClaim>(&mut 0x2::linked_table::borrow_mut<address, PendingClaims>(&mut arg1.pending_claims, arg6).pending_claims, arg5, v19);
        } else {
            let v20 = PendingClaims{pending_claims: 0x2::linked_table::new<0x2::object::ID, PendingClaim>(arg13)};
            0x2::linked_table::push_back<0x2::object::ID, PendingClaim>(&mut v20.pending_claims, arg5, v19);
            0x2::linked_table::push_back<address, PendingClaims>(&mut arg1.pending_claims, arg6, v20);
        };
        let (v21, v22) = if (v8.ion_points_enabled) {
            let v23 = if (v8.ion_collection_multiplier == 0) {
                1000
            } else {
                v8.ion_collection_multiplier
            };
            let v24 = 0xa32574713e612fa6d9eb439723cb7d69f06ae55117d8c9a028330cea98c5f391::helpers::calculate_bid_proximity_multiplier(v18, v8.avg_sale_price);
            let v25 = 0xa32574713e612fa6d9eb439723cb7d69f06ae55117d8c9a028330cea98c5f391::helpers::calculate_time_multiplier(0x2::clock::timestamp_ms(arg0) - v3, true);
            let v26 = 0xa32574713e612fa6d9eb439723cb7d69f06ae55117d8c9a028330cea98c5f391::helpers::calculate_ion_points(v18, v23, v24, v25);
            award_ion_points_with_referral(v0, arg1, arg11, v26, arg0, arg12);
            let v27 = 0xa32574713e612fa6d9eb439723cb7d69f06ae55117d8c9a028330cea98c5f391::helpers::calculate_ion_points(v18, v23, v24, v25);
            let v28 = 0x2::linked_table::borrow_mut<address, UserInfo>(&mut arg1.user_activity, arg6);
            v28.claimable_points = v28.claimable_points + v27;
            (v27, v26)
        } else {
            (0, 0)
        };
        let v29 = BidAcceptedEvent{
            nft_type          : v1,
            nft_id            : arg5,
            seller            : v0,
            buyer             : arg6,
        ...
        0x2::event::emit<BidAcceptedEvent>(v29);
        v17
    }
