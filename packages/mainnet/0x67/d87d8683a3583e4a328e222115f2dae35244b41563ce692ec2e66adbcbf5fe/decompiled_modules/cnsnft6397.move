module 0x67d87d8683a3583e4a328e222115f2dae35244b41563ce692ec2e66adbcbf5fe::cnsnft6397 {
    struct CNSNFT6397 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6397, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5682"));
        let v4 = 0x2::package::claim<CNSNFT6397>(arg0, arg1);
