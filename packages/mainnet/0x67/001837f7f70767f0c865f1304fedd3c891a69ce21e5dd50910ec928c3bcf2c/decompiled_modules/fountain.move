module 0x5d019c033bb8051fe9631cf910d0f4d077364d64ed4bb1940e98e6dc419a8d59::fountain {
    ...
    public fun liquidate_with_info<T0, T1>(arg0: &mut Fountain<T0, T1>, arg1: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::BucketProtocol, arg2: &0x2::clock::Clock, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : (bool, 0x2::object::ID, u64) {
        if (bottle_exists<T0>(arg1, arg3)) {
            let v3 = 0x2::table::borrow<address, StrapData<T0>>(&arg0.strap_table, arg3);
            (false, v3.proof_id, v3.debt_amount)
        } else {
            let v4 = claim_internal<T0, T1>(arg0, arg2, arg3, arg4);
            let StrapData {
                strap       : v5,
                start_unit  : _,
                proof_id    : v7,
            ...
            arg0.total_debt_amount = total_debt_amount<T0, T1>(arg0) - v8;
            let v9 = SurplusData<T0, T1>{
                strap   : v5,
                surplus : 0x2::coin::into_balance<T1>(v4),
            };
            0x2::table::add<0x2::object::ID, SurplusData<T0, T1>>(&mut arg0.surplus_table, v7, v9);
            (true, v7, v8)
        }
    }
    ...
    entry fun supply_and_update_flow_rate_<T0, T1>(arg0: &AdminCap, arg1: &0x2::clock::Clock, arg2: &mut Fountain<T0, T1>, arg3: u64, arg4: 0x2::coin::Coin<T1>) {
        update_flow_rate<T0, T1>(arg0, arg1, arg2, 0x2::coin::value<T1>(&arg4), arg3);
        supply<T0, T1>(arg2, arg1, arg4);
    }
