module 0x6780b573fba2b55f5e81532b9223110ec36e55cc00630d13414aac531125a2a4::reward7176 {
    struct REWARD7176 has drop {
        dummy_field: bool,
    }

    struct TICKET_7176 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7176(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7176>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7176>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7176, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7176>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7176>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7176>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7176>>(v5, 0x2::tx_context::sender(arg1));
    }
