module 0x67a2e83f4b39ae4d5fb950a7a07ed2e1861bcef51987a3501be46ad6f29f5c68::cnsnft7417 {
    struct CNSNFT7417 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7417, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7417>(arg0, arg1);
