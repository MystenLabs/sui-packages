module 0x67732f2152b7797e55060598e32d73d27dcd008cf61799f260a6e603289aba02::cnsnft6906 {
    struct CNSNFT6906 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6906, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6906>(arg0, arg1);
