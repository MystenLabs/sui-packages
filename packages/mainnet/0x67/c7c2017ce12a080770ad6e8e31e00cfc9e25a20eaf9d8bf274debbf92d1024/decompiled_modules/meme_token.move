module 0x67c7c2017ce12a080770ad6e8e31e00cfc9e25a20eaf9d8bf274debbf92d1024::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"FUI", b"FLIPSUI", b"undefined", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/media/G4pY6AvbQAE2xnt.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"FLIPSUI"),
            symbol     : 0x1::string::utf8(b"FUI"),
            decimals   : 9,
