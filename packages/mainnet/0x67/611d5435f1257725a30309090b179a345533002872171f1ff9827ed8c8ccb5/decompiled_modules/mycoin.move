module 0x67611d5435f1257725a30309090b179a345533002872171f1ff9827ed8c8ccb5::mycoin {
    ...
    fun init(arg0: MYCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MYCOIN>(arg0, 2, b"31", b"31", b"31", 0x1::option::none<0x2::url::Url>(), arg1);
    ...
    public entry fun mint(arg0: &mut 0x2::coin::TreasuryCap<MYCOIN>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::mint_and_transfer<MYCOIN>(arg0, 31, arg2, arg3);
    }
