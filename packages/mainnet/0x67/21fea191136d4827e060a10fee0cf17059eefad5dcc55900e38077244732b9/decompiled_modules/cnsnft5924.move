module 0x6721fea191136d4827e060a10fee0cf17059eefad5dcc55900e38077244732b9::cnsnft5924 {
    struct CNSNFT5924 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5924, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5924>(arg0, arg1);
