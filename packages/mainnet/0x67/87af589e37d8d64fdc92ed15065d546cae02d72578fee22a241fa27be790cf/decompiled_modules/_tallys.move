module 0x6787af589e37d8d64fdc92ed15065d546cae02d72578fee22a241fa27be790cf::_tallys {
    ...
    fun init(arg0: _TALLYS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Forged in the heart of the Talus Kingdom, Tally NFTs grant their bearers the mantle of guardians, shaping the fate of AI agents on Sui and guiding its next great evolution"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidvf6u7c7rxyykc3pw4qeg3p4dashv5uc5bwmmhkkva3wvabbf7mm"));
