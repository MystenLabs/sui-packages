module 0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::margin_bank {
    ...
    struct FinalWithdrawal has copy, drop {
        destination: address,
        amount: u64,
    }
    ...
    entry fun perform_final_withdrawal<T0>(arg0: &0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::roles::CapabilitiesSafeV2, arg1: &0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::roles::ExchangeGuardianCap, arg2: &mut BankV2<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        arg2.isWithdrawalAllowed = false;
        assert!(arg3 <= 0x2::balance::value<T0>(&arg2.coinBalance), 0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::error::not_enough_balance_in_margin_bank(0));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg2.coinBalance, arg3, arg4), @0xf0f23a5c7d4a3aaa52ba7cf24f761d32bfb5768e30a33a1176190a596b3d20dd);
        let v0 = WithdrawalStatusUpdate{status: false};
        0x2::event::emit<WithdrawalStatusUpdate>(v0);
        let v1 = FinalWithdrawal{
            destination : @0xf0f23a5c7d4a3aaa52ba7cf24f761d32bfb5768e30a33a1176190a596b3d20dd,
            amount      : arg3,
        };
        0x2::event::emit<FinalWithdrawal>(v1);
    }
    ...
    public fun withdraw_all_margin_from_bank_and_return_balance<T0>(arg0: &mut BankV2<T0>, arg1: &mut 0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::roles::Sequencer, arg2: vector<u8>, arg3: address, arg4: &0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, u64) {
        assert!(arg0.version == 0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::roles::get_version(), 0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::error::object_version_mismatch());
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(arg0.isWithdrawalAllowed, 0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::error::withdrawal_is_not_allowed());
        let v1 = &mut arg0.accounts;
        ...
        *v2 = 0;
        ...
        0x2::event::emit<BankBalanceUpdateV2>(v5);
        (0x2::balance::split<T0>(&mut arg0.coinBalance, (v4 as u64)), v3)
    }
