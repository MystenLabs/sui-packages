module 0x6775bcc1a7c7963f65954b5a1a05ab461ac3809718b3406e54f8ead07d1c66b0::reward2408 {
    struct REWARD2408 has drop {
        dummy_field: bool,
    }

    struct TICKET_2408 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2408(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2408>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2408>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2408, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2408>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2408>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2408>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2408>>(v5, 0x2::tx_context::sender(arg1));
    }
