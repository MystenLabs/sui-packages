module 0x6714eea43d2b5eacb0f29a192fccf64d21626ce41f4cd6856ec18d0c019d64a8::reward5214 {
    struct REWARD5214 has drop {
        dummy_field: bool,
    }

    struct TICKET_5214 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5214(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5214>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5214>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5214, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5214>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5214>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5214>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5214>>(v5, 0x2::tx_context::sender(arg1));
    }
