module 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::orchestrator {
    ...
    struct OrchestratorState has key {
        ...
        total_processed: u64,
        treasury: 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::treasury::Treasury,
    }
    ...
    public fun add_ika_payment(arg0: &mut OrchestratorState, arg1: &OrchestratorAdminCap, arg2: 0x2::coin::Coin<0x7262fb2f7a3a14c888c438a3cd9b912469a58cf60f367352c46584262e8299aa::ika::IKA>) {
        0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::treasury::add_ika(&mut arg0.treasury, arg2);
    }

    public fun add_sui_payment(arg0: &mut OrchestratorState, arg1: &OrchestratorAdminCap, arg2: 0x2::coin::Coin<0x2::sui::SUI>) {
        0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::treasury::add_sui(&mut arg0.treasury, arg2);
    }

    public fun complete_seal(arg0: &mut OrchestratorState, arg1: &mut 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::dwallet_registry::DWalletRegistry, arg2: &MintingAuthority, arg3: vector<u8>, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::dwallet_registry::is_registered(arg1, &v0.deposit_address)) {
            0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::dwallet_registry::mark_dwallet_used(arg1, &v0.deposit_address);
        };
        let v1 = SealSigned{
    ...
    public fun create_minting_dwallet(arg0: &mut OrchestratorState, arg1: &mut 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::signing::SigningState, arg2: &OrchestratorAdminCap, arg3: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg4: 0x2::object::ID, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: &mut 0x2::tx_context::TxContext) {
        0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::signing::create_minting_dwallet(arg1, &mut arg0.treasury, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
    }

    public fun deposit_popkins(arg0: &mut OrchestratorState, arg1: &MintingAuthority, arg2: 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::popkins_nft::Popkins, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg4) / 1000;
        assert!(0x1::vector::length<u8>(&arg3) == 32, 12);
        let v1 = 0x2::object::id<0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::popkins_nft::Popkins>(&arg2);
        let v2 = 0x2::object::id_to_bytes(&v1);
        let v3 = 0x1::hash::sha2_256(0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::with_defining_ids<0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::popkins_nft::Popkins>())));
        let v4 = 21;
        let v5 = 0x1::string::into_bytes(0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::popkins_nft::image_url(&arg2));
        let v6 = 0x1::vector::empty<u8>();
        0x1::vector::push_back<u8>(&mut v6, ((v4 >> 8) as u8));
        0x1::vector::push_back<u8>(&mut v6, ((v4 & 255) as u8));
        0x1::vector::append<u8>(&mut v6, v3);
        0x1::vector::append<u8>(&mut v6, v2);
        0x1::vector::append<u8>(&mut v6, arg3);
        let v7 = 0x1::hash::sha2_256(v6);
        assert!(!0x2::table::contains<vector<u8>, bool>(&arg0.processed_vaas, v7), 7);
        assert!(!0x2::table::contains<vector<u8>, bool>(&arg0.used_dwallets, v2), 11);
        let v8 = 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::payload::construct_signing_message(&v5, &v2, &arg3);
        let v9 = PendingSeal{
            source_chain     : v4,
            nft_contract     : v3,
            token_id         : v2,
        ...
        0x2::table::add<vector<u8>, PendingSeal>(&mut arg0.pending_seals, v7, v9);
        0x2::table::add<vector<u8>, bool>(&mut arg0.processed_vaas, v7, true);
        0x2::dynamic_object_field::add<0x2::object::ID, 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::popkins_nft::Popkins>(&mut arg0.id, v1, arg2);
        let v10 = SealPending{
            vaa_hash        : v7,
            source_chain    : v4,
            deposit_address : v2,
        ...
        0x2::event::emit<SealPending>(v10);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = OrchestratorState{
            ...
            total_processed : 0,
            treasury        : 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::treasury::new(),
        };
    ...
    public fun process_vaa(arg0: &mut OrchestratorState, arg1: &0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::state::State, arg2: &0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::dwallet_registry::DWalletRegistry, arg3: vector<u8>, arg4: 0x2::object::ID, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::payload::decode_seal_payload(&v7);
        let v9 = *0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::payload::get_deposit_address(&v8);
        assert!(!0x2::table::contains<vector<u8>, bool>(&arg0.used_dwallets, v9), 11);
        assert!(0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::dwallet_registry::is_registered(arg2, &v9), 2);
        let v10 = 0x2::object::id_to_bytes(&arg4);
        assert!(0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::dwallet_registry::get_dwallet_id(arg2, &v9) == v10, 3);
        let v11 = 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::payload::construct_signing_message(0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::payload::get_token_uri(&v8), 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::payload::get_token_id(&v8), 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::payload::get_receiver(&v8));
        let v12 = PendingSeal{
            source_chain     : 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::payload::get_source_chain(&v8),
            nft_contract     : *0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::payload::get_nft_contract(&v8),
            token_id         : *0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::payload::get_token_id(&v8),
            token_uri        : *0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::payload::get_token_uri(&v8),
            receiver         : *0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::payload::get_receiver(&v8),
            deposit_address  : v9,
            dwallet_pubkey   : 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::dwallet_registry::get_dwallet_pubkey(arg2, &v9),
            message_hash     : v11,
    ...
    public fun request_presign(arg0: &mut OrchestratorState, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: &OrchestratorAdminCap, arg3: 0x2::object::ID, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::treasury::withdraw_coins(&mut arg0.treasury, arg5);
        let v2 = v1;
        let v3 = v0;
        0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::signing::request_presign(arg1, arg3, arg4, &mut v3, &mut v2, arg5);
        0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::treasury::return_coins(&mut arg0.treasury, v3, v2);
    }

    public fun request_sign_seal(arg0: &mut OrchestratorState, arg1: &mut 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::signing::SigningState, arg2: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg3: vector<u8>, arg4: vector<u8>, arg5: 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<vector<u8>, PendingSeal>(&arg0.pending_seals, arg3), 9);
        let v0 = 0x2::table::borrow<vector<u8>, PendingSeal>(&arg0.pending_seals, arg3);
        assert!(!v0.completed, 10);
        let v1 = v0.message_hash;
        let (v2, v3) = 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::treasury::withdraw_coins(&mut arg0.treasury, arg7);
        let v4 = v3;
        let v5 = v2;
        0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::signing::request_sign(arg1, arg2, v1, arg4, arg5, arg3, arg6, &mut v5, &mut v4, arg7);
        0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::treasury::return_coins(&mut arg0.treasury, v5, v4);
    }

    public fun reset_minting_cap(arg0: &mut 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::signing::SigningState, arg1: &OrchestratorAdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::signing::reset_minting_cap(arg0, arg2);
    }
    ...
    public fun treasury_ika_balance(arg0: &OrchestratorState) : u64 {
        0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::treasury::ika_balance(&arg0.treasury)
    }

    public fun treasury_sui_balance(arg0: &OrchestratorState) : u64 {
        0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::treasury::sui_balance(&arg0.treasury)
    }

    public fun update_signing_params(arg0: &mut 0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::signing::SigningState, arg1: &OrchestratorAdminCap, arg2: u32, arg3: u32, arg4: u32) {
        0x67d388ce8b52c6b30ffdb0870fdcc7c4b123ce8d6ae2b380357afb388a6e3516::signing::update_params(arg0, arg2, arg3, arg4);
    }
