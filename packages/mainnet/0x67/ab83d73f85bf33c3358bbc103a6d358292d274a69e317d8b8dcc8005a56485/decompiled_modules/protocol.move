module 0x67ab83d73f85bf33c3358bbc103a6d358292d274a69e317d8b8dcc8005a56485::protocol {
    ...
    public fun admin_emergency_recover<T0: store + key>(arg0: &0x67ab83d73f85bf33c3358bbc103a6d358292d274a69e317d8b8dcc8005a56485::fee_manager::AdminCap, arg1: &0x67ab83d73f85bf33c3358bbc103a6d358292d274a69e317d8b8dcc8005a56485::fee_manager::PlatformConfig, arg2: &mut GlobalRegistry, arg3: SwapOffer, arg4: address) {
        assert!(0x2::object::id<0x67ab83d73f85bf33c3358bbc103a6d358292d274a69e317d8b8dcc8005a56485::fee_manager::AdminCap>(arg0) == 0x67ab83d73f85bf33c3358bbc103a6d358292d274a69e317d8b8dcc8005a56485::fee_manager::admin_cap_id(arg1), 1);
        let SwapOffer {
            id                 : v0,
            maker              : _,
            taker              : _,
        ...
        let v8 = v5;
        0x2::table::remove<0x2::object::ID, bool>(&mut arg2.active_offers, v3);
        let v9 = v0;
        let v10 = OfferedNftKey{dummy_field: false};
        0x2::transfer::public_transfer<T0>(0x2::dynamic_object_field::remove<OfferedNftKey, T0>(&mut v9, v10), arg4);
        if (0x1::option::is_some<0x2::coin::Coin<0x2::sui::SUI>>(&v8)) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x1::option::destroy_some<0x2::coin::Coin<0x2::sui::SUI>>(v8), arg4);
        } else {
            0x1::option::destroy_none<0x2::coin::Coin<0x2::sui::SUI>>(v8);
        };
        let v11 = AdminRecoveryClaimed{
            offer_id  : 0x2::object::uid_to_inner(&v9),
            recipient : arg4,
        };
        0x2::event::emit<AdminRecoveryClaimed>(v11);
    ...
    public fun execute_kiosk_swap<T0: store + key, T1: store + key>(arg0: &mut GlobalRegistry, arg1: SwapOffer, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &0x2::transfer_policy::TransferPolicy<T1>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x67ab83d73f85bf33c3358bbc103a6d358292d274a69e317d8b8dcc8005a56485::fee_manager::PlatformConfig, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v16 = 0x67ab83d73f85bf33c3358bbc103a6d358292d274a69e317d8b8dcc8005a56485::fee_manager::get_flat_fee(arg7, 0x1::type_name::with_defining_ids<T1>());
        if (v16 > 0) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg6) >= v7 + v16, 4);
            0x67ab83d73f85bf33c3358bbc103a6d358292d274a69e317d8b8dcc8005a56485::fee_manager::collect_fee(arg7, 0x2::coin::split<0x2::sui::SUI>(&mut arg6, v16, arg9));
        };
        0x2::table::remove<0x2::object::ID, bool>(&mut arg0.active_offers, v4);
        let v17 = v1;
    ...
    public fun execute_swap<T0: store + key, T1: store + key>(arg0: &mut GlobalRegistry, arg1: SwapOffer, arg2: T1, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x67ab83d73f85bf33c3358bbc103a6d358292d274a69e317d8b8dcc8005a56485::fee_manager::PlatformConfig, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = 0x67ab83d73f85bf33c3358bbc103a6d358292d274a69e317d8b8dcc8005a56485::fee_manager::get_flat_fee(arg4, 0x1::type_name::with_defining_ids<T1>());
        if (v11 > 0) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg3) >= v7 + v11, 4);
            0x67ab83d73f85bf33c3358bbc103a6d358292d274a69e317d8b8dcc8005a56485::fee_manager::collect_fee(arg4, 0x2::coin::split<0x2::sui::SUI>(&mut arg3, v11, arg6));
        };
        0x2::table::remove<0x2::object::ID, bool>(&mut arg0.active_offers, v4);
        let v12 = v1;
