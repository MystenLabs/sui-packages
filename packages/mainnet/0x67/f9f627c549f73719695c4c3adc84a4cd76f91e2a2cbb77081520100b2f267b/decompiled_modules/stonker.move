module 0x67f9f627c549f73719695c4c3adc84a4cd76f91e2a2cbb77081520100b2f267b::stonker {
    ...
    fun balance_manager_has_any_trade_between_prices(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: u64, arg3: u64) : bool {
        let v0 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::account_open_orders<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg0, arg1);
        let v1 = 0x2::vec_set::keys<u128>(&v0);
        let v2 = 0;
        if (v2 < 0x1::vector::length<u128>(v1)) {
            let (v3, v4, _) = decode_order_id(*0x1::vector::borrow<u128>(v1, v2));
            if (v3 && v4 >= arg2) {
                return true
            };
            if (!v3 && v4 <= arg3) {
    ...
    fun check_sender(arg0: &Stonker, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 13906834526530699263);
    }
    ...
    fun default_stonker_parameters() : StonkerParameters {
        StonkerParameters{
            ...
            minimum_order_size_base  : 380000000000,
            order_size_step_base     : 285000000000,
            allowed_to_buy           : true,
    ...
    public fun input_signal(arg0: &mut Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg5: &0x2::clock::Clock, arg6: u64, arg7: bool, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        check_sender(arg0, arg9);
        if (0x2::clock::timestamp_ms(arg5) >= arg8) {
            emit_could_not_trade_event(b"expired");
            return
        };
        let (v0, v1, v2, v3) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::get_level2_ticks_from_mid<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, 10, arg5);
        let v4 = v2;
        let v5 = v0;
        let v6 = *0x1::vector::borrow<u64>(&v5, 0);
        let v7 = *0x1::vector::borrow<u64>(&v4, 0);
        let v8 = arg6 * arg0.parameters.trigger_bps_times_1k / 1000 / 10000;
        ...
        if (arg7 && v7 + v8 < arg6) {
            ...
            let v19 = arg0.parameters.minimum_order_size_base + 1000000 * (arg6 - v7 - v8) / v7 * arg0.parameters.order_size_step_base / 100;
            let v20 = v19;
            if (balance_manager_has_any_trade_between_prices(arg2, arg4, 18446744073709551615, v13)) {
                v20 = v19 * 2;
            };
            if (v20 > v15) {
                v20 = v15;
            ...
            let v21 = v20 / v11 * v11;
            if (v21 < arg0.parameters.minimum_order_size_base) {
            ...
            if (0x2::clock::timestamp_ms(arg5) < arg0.last_trade_time_ms + arg0.parameters.cooldown_ms) {
            ...
            let v22 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg9);
        ...
        if (!arg7 && arg6 + v8 < v6) {
            ...
            let v28 = (arg6 + v8 + v25 - 1) / v25 * v25;
            let v29 = arg0.parameters.minimum_order_size_base + 1000000 * (v6 - v8 - arg6) / v7 * arg0.parameters.order_size_step_base / 100;
            let v30 = v29;
            if (balance_manager_has_any_trade_between_prices(arg2, arg4, v28, 0)) {
                v30 = v29 * 2;
            };
            ...
            let v32 = v30 / v26 * v26;
            if (v32 < arg0.parameters.minimum_order_size_base) {
                emit_could_not_trade_event(b"at_limit");
                return
            };
            ...
            let v33 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg9);
            ...
            ensure_deep_balance(arg1, &v33, arg3, v34, arg5, arg9);
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v33, 0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::immediate_or_cancel(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::self_matching_allowed(), v28, v32, false, true, 0x2::clock::timestamp_ms(arg5) + 1000, arg5, arg9);
            arg0.last_trade_time_ms = 0x2::clock::timestamp_ms(arg5);
            return
        };
    }
