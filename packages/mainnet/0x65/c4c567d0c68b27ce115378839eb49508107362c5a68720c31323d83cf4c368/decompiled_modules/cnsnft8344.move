module 0x65c4c567d0c68b27ce115378839eb49508107362c5a68720c31323d83cf4c368::cnsnft8344 {
    struct CNSNFT8344 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8344, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8344>(arg0, arg1);
