module 0x6538bd2913d613c7c67fc81b4e1a5642ee330a9b8177cf37c812827017a9784d::oink_nfts {
    ...
    public fun burn<T0>(arg0: &mut Config, arg1: &mut Fee<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg1.balance), arg2), @0x0);
    }

    fun check_minted(arg0: &mut Config, arg1: &mut 0x2::tx_context::TxContext) {
        if (0x2::table::contains<address, u64>(&arg0.minted, 0x2::tx_context::sender(arg1))) {
            let v0 = 0x2::table::borrow_mut<address, u64>(&mut arg0.minted, 0x2::tx_context::sender(arg1));
            if (*v0 >= arg0.max_mint_per_address) {
                abort 3
            };
            if (*v0 >= arg0.max_mint_per_address) {
                abort 3
            ...
            *v0 = *v0 + 1;
            ...
            if (arg0.max_mint_per_address < 1) {
                abort 3
            };
            0x2::table::add<address, u64>(&mut arg0.minted, 0x2::tx_context::sender(arg1), 1);
        };
    }
    ...
    entry fun mint<T0>(arg0: &mut Config, arg1: &0x2::random::Random, arg2: &0x2::clock::Clock, arg3: &mut Fee<T0>, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        check_minted(arg0, arg5);
        pay_before_mint<T0>(arg0, arg3, arg4, arg5);
        let v2 = 0x2::random::new_generator(arg1, arg5);
        let v3 = 0x1::vector::swap_remove<OinkNFTMetadata>(&mut arg0.nft_metadata, 0x2::random::generate_u64(&mut v2) % 0x1::vector::length<OinkNFTMetadata>(&arg0.nft_metadata));
