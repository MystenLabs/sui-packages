module 0x652a9da4e7b8fc29bdc52eb18553d0930c000a989b1989f2b8673a3b2bfd40da::reward8772 {
    struct REWARD8772 has drop {
        dummy_field: bool,
    }

    struct TICKET_8772 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8772(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8772>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8772>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8772, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8772>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8772>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8772>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8772>>(v5, 0x2::tx_context::sender(arg1));
    }
