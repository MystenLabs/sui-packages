module 0x65744abbdffc289c16bad644a749e3351a241ab3512892796a63cda05d1a31e2::cnsnft7182 {
    struct CNSNFT7182 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7182, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7182>(arg0, arg1);
