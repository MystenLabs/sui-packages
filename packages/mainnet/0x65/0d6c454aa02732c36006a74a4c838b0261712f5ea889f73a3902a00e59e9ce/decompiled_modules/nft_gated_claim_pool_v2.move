module 0x650d6c454aa02732c36006a74a4c838b0261712f5ea889f73a3902a00e59e9ce::nft_gated_claim_pool_v2 {
    ...
    public entry fun claim_with_kiosk_nft<T0: store + key>(arg0: &mut NFTGatedClaimPoolV2, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.claiming_enabled, 4);
        assert!(!0x1::vector::is_empty<0x2::object::ID>(&arg0.nft_ids), 2);
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(!0x2::table::contains<address, bool>(&arg0.claims, v0), 3);
        assert!(is_collection_eligible(arg0, &arg4), 5);
