module 0x653f557f93c8307d15cc614465e4449594e73b3d70d9691368e5e289c7e5b374::amm {
    ...
    fun calc_trade_sell_pt<T0, T1>(arg0: &mut Market<T0, T1>, arg1: PreComputeMarket, arg2: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg3: u64) : (u64, u64) {
        ...
        let v7 = 0x653f557f93c8307d15cc614465e4449594e73b3d70d9691368e5e289c7e5b374::utils::asset_to_sy(((0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::get_raw_value(v6) >> 64) as u64), arg2);
        let v8 = 0x653f557f93c8307d15cc614465e4449594e73b3d70d9691368e5e289c7e5b374::utils::asset_to_sy(((0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::get_raw_value(v5) >> 64) as u64), arg2);
    ...
    public fun pre_compute_value<T0, T1>(arg0: &Market<T0, T1>, arg1: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg2: &0x2::clock::Clock) : PreComputeMarket {
        ...
        let v3 = 0x653f557f93c8307d15cc614465e4449594e73b3d70d9691368e5e289c7e5b374::utils::sy_to_asset(0x2::balance::value<T1>(&arg0.total_sy), arg1);
        assert!(v2 > 0 && v3 > 0, 6);
        PreComputeMarket{
            rate_scalar : v1,
            total_asset : v3,
    ...
    fun set_initial_ln_implied_rate<T0, T1>(arg0: &mut Market<T0, T1>, arg1: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg2: &0x2::clock::Clock) {
        ...
        let v0 = arg0.expiry - 0x2::clock::timestamp_ms(arg2);
        arg0.last_ln_implied_rate = get_ln_implied_rate(0x2::balance::value<T0>(&arg0.total_pt), 0x653f557f93c8307d15cc614465e4449594e73b3d70d9691368e5e289c7e5b374::utils::sy_to_asset(0x2::balance::value<T1>(&arg0.total_sy), arg1), get_rate_scalar<T0, T1>(arg0, v0), arg0.initial_anchor, v0);
    }

    fun set_new_market_state_trade<T0, T1>(arg0: &mut Market<T0, T1>, arg1: PreComputeMarket, arg2: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg3: u64, arg4: &0x2::clock::Clock) {
