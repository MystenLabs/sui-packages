module 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::pool_tranche {
    ...
    public fun new<T0, T1>(arg0: &mut PoolTrancheManager, arg1: &0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::pool::Pool<T0, T1>, arg2: bool, arg3: u128, arg4: vector<u64>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_admin(arg0, 0x2::tx_context::sender(arg6));
        let v0 = 0x2::object::id<0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::pool::Pool<T0, T1>>(arg1);
        let v1 = PoolTranche{
    ...
    public fun add_reward<T0>(arg0: &mut PoolTrancheManager, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: u64, arg4: 0x2::balance::Balance<T0>, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(arg0.ignore_whitelist || 0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.whitelisted_tokens, &v0), 932069230794534963);
        let v1 = get_tranche_by_id(arg0, arg1, arg2);
        add_reward_internal<T0>(v1, 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::time_manager::epoch_start(arg3), arg4, arg5)
    }
    ...
    public fun add_token_types_to_whitelist(arg0: &mut PoolTrancheManager, arg1: vector<0x1::type_name::TypeName>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<0x1::type_name::TypeName>(&arg1)) {
            ...
            if (!0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.whitelisted_tokens, &v1)) {
                0x2::vec_set::insert<0x1::type_name::TypeName>(&mut arg0.whitelisted_tokens, v1);
    ...
    public(friend) fun fill_tranches(arg0: &mut PoolTranche, arg1: u128) {
        ...
        if (arg0.current_volume == arg0.total_volume || 0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::full_math_u128::mul_div_round(arg0.total_volume, (arg0.minimum_remaining_volume_percentage as u128), (0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::consts::minimum_remaining_volume_percentage_denom() as u128)) >= arg0.total_volume - arg0.current_volume) {
            arg0.filled = true;
        };
    ...
    public(friend) fun get_reward_balance<T0>(arg0: &mut PoolTrancheManager, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        checked_package_version(arg0);
        let v0 = get_tranche_by_id(arg0, arg1, arg2);
        let v1 = 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::time_manager::epoch_start(arg5);
        ...
        let v5 = 0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::full_math_u64::mul_div_floor(*0x2::table::borrow<0x1::type_name::TypeName, u64>(0x2::table::borrow<u64, 0x2::table::Table<0x1::type_name::TypeName, u64>>(&v0.total_balance_epoch, v1), v2), arg4, *0x2::table::borrow<u64, u64>(&v0.total_income_epoch, v1));
    ...
    public fun get_whitelisted_tokens(arg0: &PoolTrancheManager) : vector<0x1::type_name::TypeName> {
    ...
    public fun remove_token_types_from_whitelist(arg0: &mut PoolTrancheManager, arg1: vector<0x1::type_name::TypeName>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<0x1::type_name::TypeName>(&arg1)) {
            let v1 = *0x1::vector::borrow<0x1::type_name::TypeName>(&arg1, v0);
            if (0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.whitelisted_tokens, &v1)) {
                0x2::vec_set::remove<0x1::type_name::TypeName>(&mut arg0.whitelisted_tokens, &v1);
    ...
    public fun set_total_incomed_and_add_reward<T0>(arg0: &mut PoolTrancheManager, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: u64, arg4: 0x2::balance::Balance<T0>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : u64 {
        checked_package_version(arg0);
        check_admin(arg0, 0x2::tx_context::sender(arg6));
        let v0 = 0x1::type_name::get<T0>();
        assert!(arg0.ignore_whitelist || 0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.whitelisted_tokens, &v0), 932069230794534963);
        let v1 = get_tranche_by_id(arg0, arg1, arg2);
        let v2 = 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::time_manager::epoch_start(arg3);
        assert!(!0x2::table::contains<u64, u64>(&v1.total_income_epoch, v2), 932078340620346346);
        0x2::table::add<u64, u64>(&mut v1.total_income_epoch, v2, arg5);
        ...
        add_reward_internal<T0>(v1, v2, arg4, arg6)
    }
    ...
    public fun update_tranche(arg0: &mut PoolTrancheManager, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: bool, arg4: u128, arg5: vector<u64>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = get_tranche_by_id(arg0, arg1, arg2);
        assert!(v0.current_volume == 0, 909797676721269952);
