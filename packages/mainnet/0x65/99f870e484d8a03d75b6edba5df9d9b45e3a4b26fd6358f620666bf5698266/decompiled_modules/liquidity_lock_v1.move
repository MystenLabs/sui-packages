module 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::liquidity_lock_v1 {
    ...
    fun calculate_liquidity_split(arg0: u128, arg1: u64) : (u128, u128) {
        assert!(arg1 <= 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::consts::lock_liquidity_share_denom(), 902354235823942382);
        let v0 = 0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::full_math_u128::mul_div_floor(arg0, (arg1 as u128), (0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::consts::lock_liquidity_share_denom() as u128));
        (v0, arg0 - v0)
    }

    fun calculate_remainder_coin_split(arg0: u64, arg1: u64) : u64 {
        assert!(arg1 <= 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::consts::lock_liquidity_share_denom(), 902354235823942382);
        0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::full_math_u64::mul_div_floor(arg0, ((0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::consts::lock_liquidity_share_denom() - arg1) as u64), (0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::consts::lock_liquidity_share_denom() as u64))
    }
    ...
    public fun lock_position<T0, T1>(arg0: &0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::config::GlobalConfig, arg1: &mut 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::rewarder::RewarderGlobalVault, arg2: &mut Locker, arg3: &mut 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::pool_tranche::PoolTrancheManager, arg4: &mut 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::pool::Pool<T0, T1>, arg5: 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::position::Position, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : vector<LockedPosition<T0, T1>> {
        ...
        let v2 = 0x2::object::id<0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::position::Position>(&arg5);
        assert!(!0x2::object_table::contains<0x2::object::ID, 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::position::Position>(&arg2.positions, v2), 9387246576346433);
        assert!(arg6 < 0x1::vector::length<u64>(&arg2.periods_blocking), 938724654546442874);
        let v3 = 0x2::clock::timestamp_ms(arg7) / 1000;
        let v4 = 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::time_manager::epoch_next(v3 + 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::time_manager::epoch_to_seconds(*0x1::vector::borrow<u64>(&arg2.periods_blocking, arg6)));
        let v5 = 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::pool_tranche::get_tranches(arg3, 0x2::object::id<0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::pool::Pool<T0, T1>>(arg4));
        assert!(0x1::vector::length<0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::pool_tranche::PoolTranche>(v5) > 0, 9823742374723842);
        let v6 = 0x1::vector::empty<LockedPosition<T0, T1>>();
        let v7 = v2;
        let v8 = 0;
        while (v8 < 0x1::vector::length<0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::pool_tranche::PoolTranche>(v5)) {
            let v9 = 0x1::vector::borrow_mut<0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::pool_tranche::PoolTranche>(v5, v8);
            if (0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::pool_tranche::is_filled(v9)) {
                v8 = v8 + 1;
                continue
            };
            let v10 = 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::pool_tranche::get_duration_profitabilities(v9);
            assert!(0x1::vector::length<u64>(&v10) == 0x1::vector::length<u64>(&arg2.periods_blocking), 93877534345684724);
            let (v11, v12) = 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::pool_tranche::get_free_volume(v9);
            let v13 = if (v12) {
                0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::locker_utils::calculate_position_liquidity_in_token_a<T0, T1>(arg4, v7)
            } else {
                0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::locker_utils::calculate_position_liquidity_in_token_b<T0, T1>(arg4, v7)
            };
            let (v14, v15, v16, v17, v18) = if (v13 > v11) {
                let v19 = &mut arg5;
                let (v20, v21, v22, v23, v24) = split_position_internal<T0, T1>(arg0, arg1, arg4, v19, (0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::full_math_u128::mul_div_floor(v11, (0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::consts::lock_liquidity_share_denom() as u128), v13) as u64), arg7, arg8);
                let v25 = v21;
                let v26 = v20;
                v7 = v25.position_id;
                0x2::object_table::add<0x2::object::ID, 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::position::Position>(&mut arg2.positions, v25.position_id, v24);
                0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::pool_tranche::fill_tranches(v9, v11);
                (v26.position_id, v26.liquidity, v22, v23, true)
            } else {
                0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::pool_tranche::fill_tranches(v9, v13);
                (v7, 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::position::info_liquidity(0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::position::borrow_position_info(0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::pool::position_manager<T0, T1>(arg4), v7)), 0x2::balance::zero<T0>(), 0x2::balance::zero<T1>(), false)
            };
            ...
            let v28 = LockedPosition<T0, T1>{
                ...
                position_id               : v14,
                tranche_id                : 0x2::object::id<0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::pool_tranche::PoolTranche>(v9),
                start_lock_time           : v3,
                expiration_time           : v4,
                full_unlocking_time       : v4 + 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::time_manager::epoch_to_seconds(*0x1::vector::borrow<u64>(&arg2.periods_post_lockdown, arg6)),
            ...
            let v30 = v8 + 1;
            v8 = v30;
            assert!(v30 < 0x1::vector::length<0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::pool_tranche::PoolTranche>(v5) || v7 == v14, 92035925692467234);
        };
        0x2::object_table::add<0x2::object::ID, 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::position::Position>(&mut arg2.positions, v2, arg5);
        v6
    }
    ...
    public fun remove_lock_liquidity<T0, T1>(arg0: &0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::config::GlobalConfig, arg1: &mut 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::rewarder::RewarderGlobalVault, arg2: &mut Locker, arg3: &mut 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::pool::Pool<T0, T1>, arg4: LockedPosition<T0, T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let v2 = if (v1) {
            ...
            let v3 = 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::time_manager::number_epochs_in_timestamp(v0 - arg4.lock_liquidity_info.last_remove_liquidity_time);
            assert!(v3 > 0, 91877547573637423);
            0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::full_math_u128::mul_div_floor(arg4.lock_liquidity_info.total_lock_liquidity, (v3 as u128), (0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::time_manager::number_epochs_in_timestamp(arg4.full_unlocking_time - arg4.expiration_time) as u128))
        };
        let v4 = v2;
        ...
        if (v1) {
            ...
            0x2::transfer::public_transfer<0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::position::Position>(v5, 0x2::tx_context::sender(arg6));
        } else {
            ...
            arg4.lock_liquidity_info.last_remove_liquidity_time = 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::time_manager::epoch_start(v0);
    ...
    public fun split_position<T0, T1>(arg0: &0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::config::GlobalConfig, arg1: &mut 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::rewarder::RewarderGlobalVault, arg2: &mut Locker, arg3: &mut 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::pool::Pool<T0, T1>, arg4: LockedPosition<T0, T1>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (LockedPosition<T0, T1>, LockedPosition<T0, T1>) {
        ...
        assert!(arg5 <= 0x6599f870e484d8a03d75b6edba5df9d9b45e3a4b26fd6358f620666bf5698266::consts::lock_liquidity_share_denom() && arg5 > 0, 902354235823942382);
