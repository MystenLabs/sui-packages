module 0x650aa868bf57ff27bb25435f99ef92c57fa14cb5cd7d3fe486334f6e96165a9b::reward6679 {
    struct REWARD6679 has drop {
        dummy_field: bool,
    }

    struct TICKET_6679 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6679(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6679>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6679>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6679, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6679>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6679>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6679>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6679>>(v5, 0x2::tx_context::sender(arg1));
    }
