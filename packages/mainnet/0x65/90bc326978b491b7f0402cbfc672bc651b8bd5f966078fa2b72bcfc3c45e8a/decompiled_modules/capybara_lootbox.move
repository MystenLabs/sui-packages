module 0x6590bc326978b491b7f0402cbfc672bc651b8bd5f966078fa2b72bcfc3c45e8a::capybara_lootbox {
    ...
    fun init(arg0: CAPYBARA_LOOTBOX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v15, v16) = 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::init_policy<NFTLootbox>(&v3, arg1);
        let v17 = v16;
        let v18 = v15;
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::p2p_list::enforce<NFTLootbox>(&mut v18, &v17);
        ...
        0x1::vector::push_back<0x1::string::String>(v20, 0x1::string::utf8(b"image_url"));
        0x1::vector::push_back<0x1::string::String>(v20, 0x1::string::utf8(b"thumbnail_url"));
        let v21 = 0x1::vector::empty<0x1::string::String>();
        let v22 = &mut v21;
        0x1::vector::push_back<0x1::string::String>(v22, 0x1::string::utf8(b"Money Bag"));
        0x1::vector::push_back<0x1::string::String>(v22, 0x1::string::utf8(x""));
        0x1::vector::push_back<0x1::string::String>(v22, 0x1::string::utf8(b"https://api.capybara.vip/api/nft/bag"));
        0x1::vector::push_back<0x1::string::String>(v22, 0x1::string::utf8(b"https://api.capybara.vip/api/nft/bag"));
        let v23 = 0x2::display::new_with_fields<NFTLootbox>(&v3, v19, v21, arg1);
        0x2::display::update_version<NFTLootbox>(&mut v23);
        let v24 = 0x2::address::from_bytes(0x2::address::to_bytes(@0xf322f525e7370de05cf773b522c4611b483c94533b61f2da4cb9d4f81d3ff2d));
        let v25 = DataStorage{
        ...
        0x2::transfer::share_object<DataStorage>(v25);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v3, v24);
        0x2::transfer::public_transfer<0x2::display::Display<NFTLootbox>>(v23, v24);
        0x2::transfer::public_transfer<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<NFTLootbox>>(v1, v24);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<NFTLootbox>>(v13, v24);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<NFTLootbox>>(v17, v24);
        ...
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<NFTLootbox>>(v18);
    }

    public fun mint_lootbox(arg0: &mut DataStorage, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg4 > 0) {
            ...
            let (v5, _) = 0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::new_for_address(v0, arg6);
            let v7 = v5;
            0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::deposit<NFTLootbox>(&mut v7, v4, arg6);
    ...
    public fun update_storage(arg0: &0x6590bc326978b491b7f0402cbfc672bc651b8bd5f966078fa2b72bcfc3c45e8a::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
