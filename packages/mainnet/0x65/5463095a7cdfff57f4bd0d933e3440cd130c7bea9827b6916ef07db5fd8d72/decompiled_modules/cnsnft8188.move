module 0x655463095a7cdfff57f4bd0d933e3440cd130c7bea9827b6916ef07db5fd8d72::cnsnft8188 {
    struct CNSNFT8188 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8188, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7246"));
        let v4 = 0x2::package::claim<CNSNFT8188>(arg0, arg1);
