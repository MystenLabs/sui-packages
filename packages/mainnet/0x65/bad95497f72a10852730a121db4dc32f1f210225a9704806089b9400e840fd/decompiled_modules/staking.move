module 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::staking {
    ...
    public fun calculate_rewards<T0: drop>(arg0: &mut Staking, arg1: &mut Staked<T0>, arg2: &0x2::clock::Clock) : u64 {
        ...
        0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::math::mul_div_down((0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::math::sub_u128(v1.reward_index, arg1.reward_index) as u64), arg1.value, 1000000000)
    }

    public fun claim<T0: drop>(arg0: &mut 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::mazu::Vault, arg1: &mut Staking, arg2: &mut Staked<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::mazu::MAZU> {
        assert_active(arg1);
        ...
        0x2::coin::mint<0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::mazu::MAZU>(0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::mazu::cap_mut(arg0), ((0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::math::sub_u128(v1.reward_index, arg2.reward_index) * (arg2.value as u128) / (1000000000 as u128)) as u64), arg4)
    }
    ...
    public fun complete_start(arg0: &0x2::clock::Clock, arg1: &mut Staking, arg2: StartRequest) {
        ...
        arg1.start = v0;
        let v1 = PoolKey<0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::mazu::MAZU>{dummy_field: false};
        0x2::dynamic_field::borrow_mut<PoolKey<0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::mazu::MAZU>, Pool>(&mut arg1.id, v1).last_updated = v0;
        let v2 = PoolKey<0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::af_lp::AF_LP>{dummy_field: false};
        0x2::dynamic_field::borrow_mut<PoolKey<0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::af_lp::AF_LP>, Pool>(&mut arg1.id, v2).last_updated = v0;
    }
    ...
    fun get_emitted(arg0: &Pool, arg1: u64, arg2: u64) : u64 {
        let v0 = 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::math::min((arg0.last_updated - arg1) / 604800000, 143);
        let v1 = 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::math::min((arg2 - arg1) / 604800000, 143);
        let v2 = 0;
        while (v0 < v1 + 1) {
            ...
            if (v0 == v1) {
                v2 = v2 + 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::math::mul_div_down(v3, 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::math::min(arg2 - arg1 - v1 * 604800000, 604800000), 604800000);
            };
            if (v0 == v0) {
                v2 = v2 - 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::math::mul_div_down(v3, 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::math::min(arg0.last_updated - arg1 - v0 * 604800000, 604800000), 604800000);
            };
            v0 = v0 + 1;
        };
        v2
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_field::add<PoolKey<0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::mazu::MAZU>, Pool>(&mut v0.id, v1, v2);
        let v3 = PoolKey<0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::af_lp::AF_LP>{dummy_field: false};
        let v4 = Pool{
            total_value  : 0,
            total_staked : 0,
        ...
        0x2::dynamic_field::add<PoolKey<0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::af_lp::AF_LP>, Pool>(&mut v0.id, v3, v4);
    ...
    public fun propose_start(arg0: &mut 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::multisig::Multisig, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = StartRequest{dummy_field: false};
        0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::multisig::create_proposal<StartRequest>(arg0, arg1, v0, arg2);
    }
    ...
    public fun stake<T0: drop>(arg0: &mut Staking, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : Staked<T0> {
        ...
        let v4 = 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::math::mul_div_down(0x2::coin::value<T0>(&arg1), get_boost(arg3), 1000000000);
    ...
    public fun start_start(arg0: 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::multisig::Proposal) : StartRequest {
        0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::multisig::get_request<StartRequest>(arg0)
    }

    public fun unstake<T0: drop>(arg0: &mut 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::mazu::Vault, arg1: &mut Staking, arg2: Staked<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::mazu::MAZU>) {
        assert_active(arg1);
        assert_last_version(arg1);
        ...
        v8.total_value = 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::math::sub(v8.total_value, v3);
        v8.total_staked = 0x65bad95497f72a10852730a121db4dc32f1f210225a9704806089b9400e840fd::math::sub(v8.total_staked, 0x2::balance::value<T0>(&v6));
