module 0x65543e5fde012a1df909039427d120c2819fdd429faf5b2644a3bb1ba59447f2::cnsnft3734 {
    struct CNSNFT3734 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3734, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3734>(arg0, arg1);
