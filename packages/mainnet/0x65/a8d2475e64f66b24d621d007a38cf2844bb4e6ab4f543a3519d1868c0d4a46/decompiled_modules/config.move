module 0x65a8d2475e64f66b24d621d007a38cf2844bb4e6ab4f543a3519d1868c0d4a46::config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x65a8d2475e64f66b24d621d007a38cf2844bb4e6ab4f543a3519d1868c0d4a46::acl::ACL,
        package_version: u64,
    }
    ...
    public entry fun add_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        ...
        0x65a8d2475e64f66b24d621d007a38cf2844bb4e6ab4f543a3519d1868c0d4a46::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public entry fun remove_member(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address) {
        checked_package_version(arg1);
        0x65a8d2475e64f66b24d621d007a38cf2844bb4e6ab4f543a3519d1868c0d4a46::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public entry fun remove_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0x65a8d2475e64f66b24d621d007a38cf2844bb4e6ab4f543a3519d1868c0d4a46::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public entry fun set_roles(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u128) {
        checked_package_version(arg1);
        0x65a8d2475e64f66b24d621d007a38cf2844bb4e6ab4f543a3519d1868c0d4a46::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    public fun checked_has_add_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x65a8d2475e64f66b24d621d007a38cf2844bb4e6ab4f543a3519d1868c0d4a46::acl::has_role(&arg0.acl, arg1, 0), 2);
    }

    public fun checked_has_delete_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x65a8d2475e64f66b24d621d007a38cf2844bb4e6ab4f543a3519d1868c0d4a46::acl::has_role(&arg0.acl, arg1, 2), 4);
    }

    public fun checked_has_update_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x65a8d2475e64f66b24d621d007a38cf2844bb4e6ab4f543a3519d1868c0d4a46::acl::has_role(&arg0.acl, arg1, 1), 3);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl             : 0x65a8d2475e64f66b24d621d007a38cf2844bb4e6ab4f543a3519d1868c0d4a46::acl::new(),
            package_version : 1,
        };
