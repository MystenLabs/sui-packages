module 0x65ca11df447f32d5be293b8eb6fc402e492d7a0e1e2d8d932ef94dfad181961b::xcetus {
    ...
    public fun can_set_dividend_correction(arg0: &XcetusManager, arg1: address) : bool {
        0x65ca11df447f32d5be293b8eb6fc402e492d7a0e1e2d8d932ef94dfad181961b::acl::is_authorized(&arg0.id, dividend_correction_acl_key(), arg1)
    }
    ...
    public fun grant_dividend_correction_operator(arg0: &AdminCap, arg1: &mut XcetusManager, arg2: address) {
        0x65ca11df447f32d5be293b8eb6fc402e492d7a0e1e2d8d932ef94dfad181961b::acl::grant(&mut arg1.id, dividend_correction_acl_key(), arg2);
    }
    ...
    public fun revoke_dividend_correction_operator(arg0: &AdminCap, arg1: &mut XcetusManager, arg2: address) {
        0x65ca11df447f32d5be293b8eb6fc402e492d7a0e1e2d8d932ef94dfad181961b::acl::revoke(&mut arg1.id, dividend_correction_acl_key(), arg2);
    }

    public fun set_dividend_correction(arg0: &mut XcetusManager, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x65ca11df447f32d5be293b8eb6fc402e492d7a0e1e2d8d932ef94dfad181961b::acl::assert_authorized(&arg0.id, dividend_correction_acl_key(), 0x2::tx_context::sender(arg3));
