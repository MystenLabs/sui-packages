module 0x657aeedcd2bbd551202e9e1fb7bf5534a527f933035eb85bb8f8226a766095a7::st8 {
    ...
    struct St8 has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public fun add_manager(arg0: &mut St8Bank, arg1: &AdminCap, arg2: address) {
        0x2::vec_set::insert<address>(&mut arg0.managers, arg2);
    }

    public fun add_player_balance<T0>(arg0: &mut St8Bank, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun add_version(arg0: &AdminCap, arg1: &mut St8Bank, arg2: u64) {
    ...
    fun assert_sender_is_manager(arg0: &St8Bank, arg1: &0x2::tx_context::TxContext) {
    ...
    fun assert_valid_package_version(arg0: &St8Bank) {
    ...
    fun borrow_house_pool_mut<T0>(arg0: &mut St8Bank) : &mut HousePoolValue<T0> {
        0x2::dynamic_object_field::borrow_mut<0x1::type_name::TypeName, HousePoolValue<T0>>(&mut arg0.id, 0x1::type_name::get<T0>())
    }

    fun borrow_player_balance_mut<T0>(arg0: &mut St8Bank, arg1: address) : &mut PlayerBalanceValue<T0> {
    ...
    public fun deposit<T0>(arg0: &mut St8Bank, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        assert_valid_package_version(arg0);
    ...
    fun house_pool_exists<T0>(arg0: &St8Bank) : bool {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<St8Bank>(v1);
    }

    public fun managers(arg0: &St8Bank) : &0x2::vec_set::VecSet<address> {
        &arg0.managers
    }
    ...
    fun player_balance_exists<T0>(arg0: &St8Bank, arg1: address) : bool {
        let v0 = PlayerBalanceKey<T0>{player_address: arg1};
        0x2::dynamic_object_field::exists_<PlayerBalanceKey<T0>>(&arg0.id, v0)
    }

    public fun remove_manager(arg0: &mut St8Bank, arg1: &AdminCap, arg2: address) {
        0x2::vec_set::remove<address>(&mut arg0.managers, &arg2);
    }

    public fun remove_version(arg0: &AdminCap, arg1: &mut St8Bank, arg2: u64) {
        0x2::vec_set::remove<u64>(&mut arg1.version_set, &arg2);
    }

    public fun sub_player_balance<T0>(arg0: &mut St8Bank, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert_valid_package_version(arg0);
        assert_sender_is_manager(arg0, arg3);
        let v0 = borrow_player_balance_mut<T0>(arg0, arg1);
        v0.amount = v0.amount - arg2;
    ...
    public fun transfer_player_loss_to_unihouse<T0>(arg0: &mut St8Bank, arg1: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert_valid_package_version(arg0);
        ...
        let v1 = St8{dummy_field: false};
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::join_with_fee<T0, St8>(arg1, v1, 0x2::balance::split<T0>(&mut borrow_house_pool_mut<T0>(arg0).balance, arg3));
    }

    public fun versions(arg0: &St8Bank) : &0x2::vec_set::VecSet<u64> {
        &arg0.version_set
    }

    public fun withdraw<T0>(arg0: &mut St8Bank, arg1: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_valid_package_version(arg0);
        assert_sender_is_manager(arg0, arg4);
        if (!player_balance_exists<T0>(arg0, arg2)) {
            err_user_balance_does_not_exist();
        ...
        let v0 = arg3;
        let v1 = borrow_player_balance_mut<T0>(arg0, arg2);
        let v2 = 0x2::balance::zero<T0>();
        if (v1.amount < arg3) {
            let v3 = arg3 - v1.amount;
            let v4 = St8{dummy_field: false};
            0x2::balance::join<T0>(&mut v2, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::split_with_reimbursement<T0, St8>(arg1, v4, v3));
            v0 = arg3 - v3;
            v1.amount = 0;
        } else {
            v1.amount = v1.amount - arg3;
        };
        0x2::balance::join<T0>(&mut v2, 0x2::balance::split<T0>(&mut borrow_house_pool_mut<T0>(arg0).balance, v0));
        0x2::coin::from_balance<T0>(v2, arg4)
    }

    public fun withdraw_from_pool<T0>(arg0: &mut St8Bank, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_valid_package_version(arg0);
