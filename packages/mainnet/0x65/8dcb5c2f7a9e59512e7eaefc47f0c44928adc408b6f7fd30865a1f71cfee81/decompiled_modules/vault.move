module 0x658dcb5c2f7a9e59512e7eaefc47f0c44928adc408b6f7fd30865a1f71cfee81::vault {
    ...
    public fun lock<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = VaultMembership<T0>{
            id       : 0x2::object::new(arg3),
            vault_id : v4,
        };
        0x2::transfer::public_transfer<VaultMembership<T0>>(v5, v2);
        0x2::transfer::share_object<Vault<T0>>(v3);
        let v6 = VaultLockedEvent<T0>{
            vault_id     : v4,
            owner        : v2,
            amount       : v1,
            unlock_ms    : arg1,
        ...
        0x2::event::emit<VaultLockedEvent<T0>>(v6);
    }
    ...
    public fun top_up<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<VaultToppedUpEvent<T0>>(v2);
    }
