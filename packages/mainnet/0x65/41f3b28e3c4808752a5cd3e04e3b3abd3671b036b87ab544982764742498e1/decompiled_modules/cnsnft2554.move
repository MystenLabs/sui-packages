module 0x6541f3b28e3c4808752a5cd3e04e3b3abd3671b036b87ab544982764742498e1::cnsnft2554 {
    struct CNSNFT2554 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2554, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2554>(arg0, arg1);
