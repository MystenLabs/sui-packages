module 0xd84e2676e42f2b5932d61c29bc2972972709aec7477370f20231d4c1fbdaf0a1::pandorian {
    ...
    struct Pandorian has store, key {
        ...
        url: 0x2::url::Url,
        attributes: 0xd84e2676e42f2b5932d61c29bc2972972709aec7477370f20231d4c1fbdaf0a1::attributes::Attributes,
    }
    ...
    fun init(arg0: PANDORIAN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xd84e2676e42f2b5932d61c29bc2972972709aec7477370f20231d4c1fbdaf0a1::collection::display(&v0, arg1);
        ...
        0x2::transfer::public_share_object<0xd84e2676e42f2b5932d61c29bc2972972709aec7477370f20231d4c1fbdaf0a1::collection::Collection>(0xd84e2676e42f2b5932d61c29bc2972972709aec7477370f20231d4c1fbdaf0a1::collection::new(arg1));
    }
    ...
    public(friend) fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: vector<u8>, arg3: vector<0x1::ascii::String>, arg4: vector<0x1::ascii::String>, arg5: &mut 0x2::tx_context::TxContext) : Pandorian {
        Pandorian{
            ...
            attributes  : 0xd84e2676e42f2b5932d61c29bc2972972709aec7477370f20231d4c1fbdaf0a1::attributes::new_from_vec(arg3, arg4),
        }
    }
