module 0x65908bbeb1a359ba6154b056cd22c660793404733bc6e1e60d7ae885cdb0f940::cnsnft1086 {
    struct CNSNFT1086 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1086, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1086>(arg0, arg1);
