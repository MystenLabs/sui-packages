module 0x6565a2afea5dac9a1b4106c9a5e990043f2e812a5975dcefeb4c4d647013ada7::dialog_management {
    ...
    public entry fun send_message(arg0: &mut UserDialogs, arg1: &mut UserDialogHashes, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        if (!0x2::table::contains<vector<u8>, 0x2::table::Table<u64, Message>>(&arg0.dialogs, arg2)) {
            0x2::table::add<vector<u8>, 0x2::table::Table<u64, Message>>(&mut arg0.dialogs, arg2, 0x2::table::new<u64, Message>(arg4));
            if (!0x2::table::contains<address, vector<u8>>(&arg1.dialog_hashes, v0)) {
                0x2::table::add<address, vector<u8>>(&mut arg1.dialog_hashes, v0, arg2);
            };
        };
