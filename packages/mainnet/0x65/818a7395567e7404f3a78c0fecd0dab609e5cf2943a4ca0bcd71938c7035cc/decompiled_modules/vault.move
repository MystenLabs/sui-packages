module 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault {
    ...
    public entry fun deposit_with_sigs<T0, T1>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: vector<vector<u8>>, arg8: vector<vector<u8>>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::object::id<0x2::coin::Coin<T0>>(&arg2);
        ...
        arg1.total_liquidity = arg1.total_liquidity + (v6 as u128);
        arg1.available_liquidity = (0x2::coin::value<T0>(0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg1.coin_store.coin)) as u128);
        arg1.liquidity = arg1.liquidity + (v6 as u128);
        arg1.deposit.total_fee = arg1.deposit.total_fee + v5;
        let v8 = get_dynamic_field_or_default<T0, T1, u64>(arg1, b"hwm", (arg1.liquidity as u64)) + v6;
        set_dynamic_field<T0, T1, u64>(arg1, b"hwm", v8);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg2, v5, arg10), arg1.fee_receiver);
        0x2::coin::mint_and_transfer<T1>(&mut arg1.treasury_cap, v7, 0x2::tx_context::sender(arg10), arg10);
        let v9 = DepositWithSigEvent{
        ...
        0x2::event::emit<DepositWithSigEvent>(v9);
    }
    ...
    public entry fun withdraw_with_sigs<T0, T1>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: vector<vector<u8>>, arg8: vector<vector<u8>>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::object::id<0x2::coin::Coin<T1>>(&arg2);
        ...
        let v6 = 0;
        let v7 = false;
        if (arg1.lock_duration_ms == 0 && (v5 as u128) <= arg1.available_liquidity) {
            let v8 = 0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg1.coin_store.coin);
            assert!(0x2::coin::value<T0>(v8) >= v5, 2);
            let v9 = 0x2::coin::split<T0>(v8, v5, arg10);
            let v10 = calculate_fee(v5, arg1.withdraw.fee_bps);
            v6 = v10;
            arg1.withdraw.total_fee = arg1.withdraw.total_fee + v10;
            arg1.available_liquidity = arg1.available_liquidity - (v5 as u128);
            v7 = true;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v9, v10, arg10), arg1.fee_receiver);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v9, v1);
        } else {
            let v11 = PendingRedeem{
                withdraw_time : v0,
                amount        : v5,
            };
            if (0x2::table::contains<address, vector<PendingRedeem>>(&arg1.pending_redeems, v1)) {
                0x1::vector::push_back<PendingRedeem>(0x2::table::borrow_mut<address, vector<PendingRedeem>>(&mut arg1.pending_redeems, v1), v11);
            } else {
                let v12 = 0x1::vector::empty<PendingRedeem>();
                0x1::vector::push_back<PendingRedeem>(&mut v12, v11);
                0x2::table::add<address, vector<PendingRedeem>>(&mut arg1.pending_redeems, v1, v12);
            };
        };
        arg1.liquidity = arg1.liquidity - (v5 as u128);
        arg1.pending_redemptions = arg1.pending_redemptions + (v5 as u128);
        let v13 = get_dynamic_field_or_default<T0, T1, u64>(arg1, b"hwm", (arg1.liquidity as u64));
        let v14 = if (v13 >= v5) {
            v13 - v5
        } else {
            0
        };
        set_dynamic_field<T0, T1, u64>(arg1, b"hwm", v14);
        0x2::coin::burn<T1>(&mut arg1.treasury_cap, arg2);
        let v15 = WithdrawWithSigEvent{
            user     : v1,
            lp       : v2,
            amount   : v5,
            vault_id : 0x2::object::id<Vault<T0, T1>>(arg1),
        ...
        0x2::event::emit<WithdrawWithSigEvent>(v15);
    }
