module 0x65dcfa0a85de7357ac4bc83fefd8ed2b8b94ebe04fbe3f165784d37ad5451aeb::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"GPC", b"GHOST PUNK ", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-04T07-20-08.887Z-600x600 (3).png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"GHOST PUNK "),
            symbol     : 0x1::string::utf8(b"GPC"),
            decimals   : 9,
