module 0x65e2d3b08d08606ea629c9b6d3b1b668217e57c143d4c055c714e821df3c479b::reward3136 {
    struct REWARD3136 has drop {
        dummy_field: bool,
    }

    struct TICKET_3136 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3136(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3136>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3136>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3136, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3136>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3136>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3136>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3136>>(v5, 0x2::tx_context::sender(arg1));
    }
