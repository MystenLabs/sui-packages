module 0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::treasury {
    ...
    public fun withdraw<T0>(arg0: &0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::admin::AdminCap, arg1: &mut Treasury, arg2: &mut 0x2::tx_context::TxContext) {
        check_version(arg1);
        let v0 = 0x2::bag::remove<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.funds, 0x1::type_name::get<T0>());
        0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::events::emit_withdraw_event<T0>(0x2::balance::value<T0>(&v0));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg2), 0x2::tx_context::sender(arg2));
    }

    public fun withdraw_some<T0>(arg0: &0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::admin::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        check_version(arg1);
