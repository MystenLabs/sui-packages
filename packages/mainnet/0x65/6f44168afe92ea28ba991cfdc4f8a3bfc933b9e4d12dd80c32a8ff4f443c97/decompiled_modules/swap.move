module 0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::swap {
    ...
    public fun begin_swap_router<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: &mut 0x2::tx_context::TxContext) : RouterCap<T0, T1> {
        ...
        let v2 = RouterMetadata{
            typeName : 0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::utils::type_to_bytes<T1>(),
            amount   : 0,
        };
    ...
    public fun end_swap_router<T0, T1>(arg0: RouterCap<T0, T1>, arg1: &0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::protocol_fee::ProtocolFeeConfig, arg2: &0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::nft::NftConfig, arg3: &mut 0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::treasury::Treasury, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v7 = v3;
        let v8 = v2;
        0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::protocol_fee::distribute_protocol_fees<T1>(arg1, arg3, &mut v8, arg6);
        0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::nft::zero_obj_mint_with_points(arg2, arg3, 0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::nft::get_points_per_swap(arg2), arg5, arg6);
        0x2::coin::destroy_zero<T0>(v1);
        0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::events::emit_swap_completed_event(v7.typeName, v7.amount, v6.typeName, v6.amount, arg4, arg6);
        v8
    }
    ...
    public fun initiate_path<T0, T1>(arg0: &mut RouterCap<T0, T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        update_previous_swap_metadata<T0, T1>(arg0, 0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::utils::type_to_bytes<T0>(), arg1);
    ...
    fun is_valid_swap<T0, T1>(arg0: &RouterCap<T0, T1>, arg1: &0x2::coin::Coin<T1>) : bool {
        arg0.previous_swap.typeName == 0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::utils::type_to_bytes<T1>() && arg0.previous_swap.amount == 0x2::coin::value<T1>(arg1)
    }
    ...
    public fun update_path_metadata<T0, T1>(arg0: &mut RouterCap<T0, T1>, arg1: 0x2::coin::Coin<T1>) {
        ...
        update_previous_swap_metadata<T0, T1>(arg0, 0x656f44168afe92ea28ba991cfdc4f8a3bfc933b9e4d12dd80c32a8ff4f443c97::utils::type_to_bytes<T1>(), 0x2::coin::value<T1>(&arg1));
    }
