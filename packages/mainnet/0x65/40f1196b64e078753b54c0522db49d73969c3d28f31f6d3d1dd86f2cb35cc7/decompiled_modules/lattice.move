module 0x6540f1196b64e078753b54c0522db49d73969c3d28f31f6d3d1dd86f2cb35cc7::lattice {
    ...
    public fun admin_cancel_intent<T0>(arg0: &mut LatticeEscrow<T0>, arg1: &AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x6540f1196b64e078753b54c0522db49d73969c3d28f31f6d3d1dd86f2cb35cc7::events::emit_intent_cancelled(0x2::object::id<LatticeEscrow<T0>>(arg0), arg2, v2, v1);
    }
    ...
    public fun cancel_intent<T0>(arg0: &mut LatticeEscrow<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x6540f1196b64e078753b54c0522db49d73969c3d28f31f6d3d1dd86f2cb35cc7::events::emit_intent_cancelled(0x2::object::id<LatticeEscrow<T0>>(arg0), arg1, 0x2::tx_context::sender(arg3), v1);
    }
    ...
    public fun confirm_fulfillment<T0>(arg0: &mut LatticeEscrow<T0>, arg1: &AdminCap, arg2: u64, arg3: vector<u8>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x6540f1196b64e078753b54c0522db49d73969c3d28f31f6d3d1dd86f2cb35cc7::events::emit_intent_fulfilled(0x2::object::id<LatticeEscrow<T0>>(arg0), arg2, 0x2::tx_context::sender(arg5), v3, v2, v0.fulfillment_tx, arg4);
    }
    ...
    public fun set_fee_bps<T0>(arg0: &mut LatticeEscrow<T0>, arg1: &AdminCap, arg2: u64) {
        assert!(arg2 <= 500, 11);
        arg0.fee_bps = arg2;
        0x6540f1196b64e078753b54c0522db49d73969c3d28f31f6d3d1dd86f2cb35cc7::events::emit_fee_updated(0x2::object::id<LatticeEscrow<T0>>(arg0), arg2);
    }

    public fun set_paused<T0>(arg0: &mut LatticeEscrow<T0>, arg1: &AdminCap, arg2: bool) {
        arg0.paused = arg2;
        0x6540f1196b64e078753b54c0522db49d73969c3d28f31f6d3d1dd86f2cb35cc7::events::emit_pause_updated(0x2::object::id<LatticeEscrow<T0>>(arg0), arg2);
    }
    ...
    public fun submit_intent<T0>(arg0: &mut LatticeEscrow<T0>, arg1: 0x2::coin::Coin<T0>, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        0x6540f1196b64e078753b54c0522db49d73969c3d28f31f6d3d1dd86f2cb35cc7::events::emit_intent_created(0x2::object::id<LatticeEscrow<T0>>(arg0), v4, 0x2::tx_context::sender(arg7), v3.user_solana_address, v0, v3.output_token_mint, arg4, v2);
    ...
    public fun withdraw_fees<T0>(arg0: &mut LatticeEscrow<T0>, arg1: &AdminCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x6540f1196b64e078753b54c0522db49d73969c3d28f31f6d3d1dd86f2cb35cc7::events::emit_fees_withdrawn(0x2::object::id<LatticeEscrow<T0>>(arg0), arg2, v0);
    }
