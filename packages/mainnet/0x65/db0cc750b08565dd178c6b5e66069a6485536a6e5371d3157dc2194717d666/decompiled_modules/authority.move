module 0x65db0cc750b08565dd178c6b5e66069a6485536a6e5371d3157dc2194717d666::authority {
    struct PACKAGE {
        dummy_field: bool,
    }
    ...
    public fun add_authorization(arg0: &mut 0x2::object::UID, arg1: &AuthorityCap<PACKAGE, ADMIN>) {
        ...
        0x65db0cc750b08565dd178c6b5e66069a6485536a6e5371d3157dc2194717d666::events::emit_added_authorization(0x2::object::uid_to_inner(arg0));
    }
    ...
    public fun remove_authorization(arg0: &mut 0x2::object::UID, arg1: &AuthorityCap<PACKAGE, ADMIN>) {
        ...
        0x65db0cc750b08565dd178c6b5e66069a6485536a6e5371d3157dc2194717d666::events::emit_removed_authorization(0x2::object::uid_to_inner(arg0));
    }
