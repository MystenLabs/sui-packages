module 0x65ab6763b92cbf4eeea10524edbea11322298ee14ac925b32e3c6c6df8a84e85::reward2355 {
    struct REWARD2355 has drop {
        dummy_field: bool,
    }

    struct TICKET_2355 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2355(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2355>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2355>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2355, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2355>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2355>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2355>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2355>>(v5, 0x2::tx_context::sender(arg1));
    }
