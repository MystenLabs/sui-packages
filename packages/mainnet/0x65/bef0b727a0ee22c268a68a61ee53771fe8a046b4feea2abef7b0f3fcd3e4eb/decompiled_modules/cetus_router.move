module 0x65bef0b727a0ee22c268a68a61ee53771fe8a046b4feea2abef7b0f3fcd3e4eb::cetus_router {
    ...
    public entry fun buy_exact_in<T0, T1>(arg0: &FeeObject, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: u64, arg7: u128, arg8: &0x2::clock::Clock, arg9: bool, arg10: 0x1::string::String, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = arg5 - v0;
        if (arg9) {
            0x65bef0b727a0ee22c268a68a61ee53771fe8a046b4feea2abef7b0f3fcd3e4eb::utils::send_coin<T0>(0x2::coin::split<T0>(&mut arg3, v0, arg11), arg0.admin);
        } else {
            0x65bef0b727a0ee22c268a68a61ee53771fe8a046b4feea2abef7b0f3fcd3e4eb::utils::send_coin<T1>(0x2::coin::split<T1>(&mut arg4, v0, arg11), arg0.admin);
        };
        ...
        0x65bef0b727a0ee22c268a68a61ee53771fe8a046b4feea2abef7b0f3fcd3e4eb::utils::send_coin<T0>(arg3, 0x2::tx_context::sender(arg11));
        0x65bef0b727a0ee22c268a68a61ee53771fe8a046b4feea2abef7b0f3fcd3e4eb::utils::send_coin<T1>(arg4, 0x2::tx_context::sender(arg11));
        if (arg9) {
            let v12 = BuyEvent<T1>{
    ...
    public entry fun sell_exact_in<T0, T1>(arg0: &FeeObject, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: u64, arg7: u128, arg8: &0x2::clock::Clock, arg9: bool, arg10: 0x1::string::String, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg9) {
            0x65bef0b727a0ee22c268a68a61ee53771fe8a046b4feea2abef7b0f3fcd3e4eb::utils::send_coin<T1>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v4, v10), arg11), arg0.admin);
        } else {
            0x65bef0b727a0ee22c268a68a61ee53771fe8a046b4feea2abef7b0f3fcd3e4eb::utils::send_coin<T0>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v5, v10), arg11), arg0.admin);
        };
