module 0x650e5f60012b3b3e67da6473cc9b65b528921ebd1f49389af2fba39f94e73fcb::jypa {
    ...
    fun init(arg0: JYPA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3, v4) = 0x2::coin::create_regulated_currency_v2<JYPA>(arg0, 6, trim_right(b"JYPA"), trim_right(b"JYPAMMUS"), trim_right(b"JYPA "), v1, true, arg1);
        let v5 = v2;
        let v6 = 0x2::tx_context::sender(arg1);
        if (999997000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<JYPA>>(0x2::coin::mint<JYPA>(&mut v5, 999997000000, arg1), v6);
        };
