module 0x655f107663ba0bf578f79ce8e8ead416824e4ff74ad6e1e999f05cd5b4386725::reward7168 {
    struct REWARD7168 has drop {
        dummy_field: bool,
    }

    struct TICKET_7168 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7168(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7168>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7168>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7168, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7168>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7168>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7168>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7168>>(v5, 0x2::tx_context::sender(arg1));
    }
