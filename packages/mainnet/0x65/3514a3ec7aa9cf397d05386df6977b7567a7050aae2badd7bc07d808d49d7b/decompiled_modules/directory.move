module 0x653514a3ec7aa9cf397d05386df6977b7567a7050aae2badd7bc07d808d49d7b::directory {
    ...
    public fun delist<T0>(arg0: &mut AgentDirectory<T0>, arg1: &T0, arg2: &0x653514a3ec7aa9cf397d05386df6977b7567a7050aae2badd7bc07d808d49d7b::identity::AgentIdentity) {
        let v0 = 0x2::object::id<0x653514a3ec7aa9cf397d05386df6977b7567a7050aae2badd7bc07d808d49d7b::identity::AgentIdentity>(arg2);
    ...
    public fun list<T0>(arg0: &mut AgentDirectory<T0>, arg1: &T0, arg2: &0x653514a3ec7aa9cf397d05386df6977b7567a7050aae2badd7bc07d808d49d7b::identity::AgentIdentity, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0x653514a3ec7aa9cf397d05386df6977b7567a7050aae2badd7bc07d808d49d7b::identity::AgentIdentity>(arg2);
        assert!(!0x2::table::contains<0x2::object::ID, DirectoryEntry>(&arg0.listings, v0), 0);
        let v1 = DirectoryEntry{
            agent_id    : v0,
            owner       : 0x2::tx_context::sender(arg3),
            name        : *0x653514a3ec7aa9cf397d05386df6977b7567a7050aae2badd7bc07d808d49d7b::identity::name(arg2),
            description : *0x653514a3ec7aa9cf397d05386df6977b7567a7050aae2badd7bc07d808d49d7b::identity::description(arg2),
            tags        : *0x653514a3ec7aa9cf397d05386df6977b7567a7050aae2badd7bc07d808d49d7b::identity::tags(arg2),
    ...
    public fun update_listing<T0>(arg0: &mut AgentDirectory<T0>, arg1: &T0, arg2: &0x653514a3ec7aa9cf397d05386df6977b7567a7050aae2badd7bc07d808d49d7b::identity::AgentIdentity, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0x653514a3ec7aa9cf397d05386df6977b7567a7050aae2badd7bc07d808d49d7b::identity::AgentIdentity>(arg2);
        assert!(0x2::table::contains<0x2::object::ID, DirectoryEntry>(&arg0.listings, v0), 1);
        let v1 = 0x2::table::borrow_mut<0x2::object::ID, DirectoryEntry>(&mut arg0.listings, v0);
        v1.owner = 0x2::tx_context::sender(arg3);
        v1.name = *0x653514a3ec7aa9cf397d05386df6977b7567a7050aae2badd7bc07d808d49d7b::identity::name(arg2);
        v1.description = *0x653514a3ec7aa9cf397d05386df6977b7567a7050aae2badd7bc07d808d49d7b::identity::description(arg2);
        v1.tags = *0x653514a3ec7aa9cf397d05386df6977b7567a7050aae2badd7bc07d808d49d7b::identity::tags(arg2);
    }
