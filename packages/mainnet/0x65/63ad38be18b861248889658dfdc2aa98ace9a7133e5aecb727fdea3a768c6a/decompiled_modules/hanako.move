module 0x6563ad38be18b861248889658dfdc2aa98ace9a7133e5aecb727fdea3a768c6a::hanako {
    struct HANAKO has drop {
        dummy_field: bool,
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<HANAKO>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<HANAKO>>(0x2::coin::mint<HANAKO>(arg0, arg1, arg3), arg2);
    }
    ...
    fun init(arg0: HANAKO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<HANAKO>>(0x2::coin::mint<HANAKO>(&mut v5, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
