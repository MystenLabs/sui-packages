module 0x65a558e6d90d28f6acaf5bf46d891f23d1227ae376b3ace5f9ed253694de5c94::reward2584 {
    struct REWARD2584 has drop {
        dummy_field: bool,
    }

    struct TICKET_2584 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2584(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2584>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2584>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2584, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2584>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2584>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2584>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2584>>(v5, 0x2::tx_context::sender(arg1));
    }
