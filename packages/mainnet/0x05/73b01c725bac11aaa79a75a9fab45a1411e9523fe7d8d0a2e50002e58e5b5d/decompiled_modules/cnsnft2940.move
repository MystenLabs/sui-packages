module 0x573b01c725bac11aaa79a75a9fab45a1411e9523fe7d8d0a2e50002e58e5b5d::cnsnft2940 {
    struct CNSNFT2940 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2940, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2940>(arg0, arg1);
