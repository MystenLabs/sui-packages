module 0x5574b5426f9f08398ef44300d1c96f6d9dc63041edbec108060759d41eee9ab::reward5360 {
    struct REWARD5360 has drop {
        dummy_field: bool,
    }

    struct TICKET_5360 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5360(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5360>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5360>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5360, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5360>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5360>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5360>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5360>>(v5, 0x2::tx_context::sender(arg1));
    }
