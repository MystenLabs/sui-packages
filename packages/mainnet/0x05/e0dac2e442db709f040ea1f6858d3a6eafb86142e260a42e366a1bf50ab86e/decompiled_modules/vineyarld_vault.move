module 0x5e0dac2e442db709f040ea1f6858d3a6eafb86142e260a42e366a1bf50ab86e::vineyarld_vault {
    struct VINEYARLD_VAULT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: VINEYARLD_VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<VINEYARLD_VAULT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"VINEYARLD VAULT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The VINE NFTs collections are a unique set of digital art pieces that showcase vibrant, playful, and intricate designs inspired by vines, grapes, and wine. Each collection offers a distinct theme, style, and level of rarity, ensuring that there's something for every collector and enthusiast."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreifdhyyrwlt4ix5mrwhkrzwu5usz72bh5ewwanksrwhvvvsu25wtga"));
