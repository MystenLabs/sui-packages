module 0x5d81749223f194d29af5aabdaee373a9a27762327c66c7a6929650d50bf707e::usdt {
    ...
    fun init(arg0: USDT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<USDT>(arg0, 9, b"USDD", b"Tether USDD", b"yulezhuanyong", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/QmbddSNUZY83SpwcsEUjgW82umeZqQBXGt3LEdPXMe9bNk")), arg1);
        let v2 = v0;
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<USDT>>(v1);
        let v3 = &mut v2;
        mint(v3, 9800000000000000, @0x3b00383fd3d4ba0ff00cdbaa8f99bbc6adcf156fcf134a8c46f778e39f8401f, arg1);
