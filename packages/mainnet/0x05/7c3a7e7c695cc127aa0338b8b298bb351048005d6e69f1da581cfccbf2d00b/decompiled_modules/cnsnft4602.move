module 0x57c3a7e7c695cc127aa0338b8b298bb351048005d6e69f1da581cfccbf2d00b::cnsnft4602 {
    struct CNSNFT4602 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4602, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4602>(arg0, arg1);
