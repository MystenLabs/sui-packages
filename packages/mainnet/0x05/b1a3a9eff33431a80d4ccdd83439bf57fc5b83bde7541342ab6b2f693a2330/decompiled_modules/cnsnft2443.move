module 0x5b1a3a9eff33431a80d4ccdd83439bf57fc5b83bde7541342ab6b2f693a2330::cnsnft2443 {
    struct CNSNFT2443 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2443, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2443>(arg0, arg1);
