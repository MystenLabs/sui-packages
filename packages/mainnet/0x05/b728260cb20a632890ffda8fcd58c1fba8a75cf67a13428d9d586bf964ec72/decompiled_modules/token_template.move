module 0x5b728260cb20a632890ffda8fcd58c1fba8a75cf67a13428d9d586bf964ec72::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"FIN105990", b"FixedInit 105990", b"Fixed with initial supply verification", 0x1::option::none<0x2::url::Url>(), arg1);
