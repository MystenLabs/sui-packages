module 0x592540e7936da9c85a671bec203c1678a24831563e9177786e3a8c6d0220a2e::calculate_mctp_fee {
    ...
    public fun calculate_mctp_fee(arg0: &0x592540e7936da9c85a671bec203c1678a24831563e9177786e3a8c6d0220a2e::state::FeeManagerState, arg1: 0x592540e7936da9c85a671bec203c1678a24831563e9177786e3a8c6d0220a2e::mctp_init_order_params_ticket::MctpInitOrderParamsTicket, arg2: &mut 0x2::tx_context::TxContext) : MctpInitOrderParams {
        0x592540e7936da9c85a671bec203c1678a24831563e9177786e3a8c6d0220a2e::state::assert_valid_version(arg0);
        let (v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12) = 0x592540e7936da9c85a671bec203c1678a24831563e9177786e3a8c6d0220a2e::mctp_init_order_params_ticket::unpack(arg1);
        MctpInitOrderParams{
            payload_type     : v0,
            trader           : v1,
            coin_metadata_id : v2,
    ...
    public fun prepare_calc_mctp_fee<T0>(arg0: &0x2::coin::CoinMetadata<T0>, arg1: u8, arg2: address, arg3: &0x2::coin::Coin<T0>, arg4: address, arg5: u16, arg6: address, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: address, arg12: u8) : 0x592540e7936da9c85a671bec203c1678a24831563e9177786e3a8c6d0220a2e::mctp_init_order_params_ticket::MctpInitOrderParamsTicket {
        0x592540e7936da9c85a671bec203c1678a24831563e9177786e3a8c6d0220a2e::mctp_init_order_params_ticket::new(arg1, arg2, 0x2::object::id<0x2::coin::CoinMetadata<T0>>(arg0), 0x2::coin::value<T0>(arg3), arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12)
    }
