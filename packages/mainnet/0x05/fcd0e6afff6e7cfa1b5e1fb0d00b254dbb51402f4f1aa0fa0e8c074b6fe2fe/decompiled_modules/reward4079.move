module 0x5fcd0e6afff6e7cfa1b5e1fb0d00b254dbb51402f4f1aa0fa0e8c074b6fe2fe::reward4079 {
    struct REWARD4079 has drop {
        dummy_field: bool,
    }

    struct TICKET_4079 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4079(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4079>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4079>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4079, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4079>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4079>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4079>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4079>>(v5, 0x2::tx_context::sender(arg1));
    }
