module 0x5ac772557fd1c6a218ce61fd3114e7d0da27af6e7c20241627bdc95eb64b243::tenor_registry {
    ...
    struct MarketRegistry has key {
        ...
        pool_infos: 0x2::table::Table<0x2::object::ID, PoolInfo>,
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = MarketRegistry{
            ...
            pool_infos : 0x2::table::new<0x2::object::ID, PoolInfo>(arg0),
        };
    ...
    public fun pool_info(arg0: &MarketRegistry, arg1: 0x2::object::ID) : 0x1::option::Option<PoolInfo> {
        if (0x2::table::contains<0x2::object::ID, PoolInfo>(&arg0.pool_infos, arg1)) {
            0x1::option::some<PoolInfo>(*0x2::table::borrow<0x2::object::ID, PoolInfo>(&arg0.pool_infos, arg1))
        } else {
    ...
    public(friend) fun set_pool_info(arg0: &mut MarketRegistry, arg1: 0x2::object::ID, arg2: 0x1::string::String, arg3: address) {
        if (0x2::table::contains<0x2::object::ID, PoolInfo>(&arg0.pool_infos, arg1)) {
            ...
            *0x2::table::borrow_mut<0x2::object::ID, PoolInfo>(&mut arg0.pool_infos, arg1) = v0;
        } else {
            let v1 = PoolInfo{
                dex     : arg2,
                pool_id : arg3,
            };
            0x2::table::add<0x2::object::ID, PoolInfo>(&mut arg0.pool_infos, arg1, v1);
        };
        0x5ac772557fd1c6a218ce61fd3114e7d0da27af6e7c20241627bdc95eb64b243::events::emit_pool_info_set(arg1, arg2, arg3);
    }
