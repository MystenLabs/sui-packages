module 0x5f99ecf9a57a0a4e707936492eed0020469ea5efd02179a81b1c4246f78b0fd::marketplace {
    struct MarketplaceCreationEvent has copy, drop {
        marketplace_id: 0x2::object::ID,
    }

    struct SignerSetEvent has copy, drop {
        signer_id: 0x2::object::ID,
        new_signer_public_key_bytes: vector<u8>,
    }
    ...
    struct MarketplaceAdminChangedEvent has copy, drop {
        admin: address,
    }

    struct MarketplaceOwnerChangedEvent has copy, drop {
        owner: address,
    }
    ...
    public entry fun change_admin(arg0: Admin, arg1: address) {
        ...
        let v0 = MarketplaceAdminChangedEvent{admin: arg1};
        0x2::event::emit<MarketplaceAdminChangedEvent>(v0);
    }

    public entry fun change_owner(arg0: Owner, arg1: address) {
        0x2::transfer::transfer<Owner>(arg0, arg1);
        let v0 = MarketplaceOwnerChangedEvent{owner: arg1};
        0x2::event::emit<MarketplaceOwnerChangedEvent>(v0);
    }
    ...
    public entry fun create_marketplace<T0>(arg0: &Admin, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun mint_and_buy<T0>(arg0: &mut 0x5f99ecf9a57a0a4e707936492eed0020469ea5efd02179a81b1c4246f78b0fd::nft::MembershipCap, arg1: &mut Marketplace<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x5f99ecf9a57a0a4e707936492eed0020469ea5efd02179a81b1c4246f78b0fd::nft::CollectionDetails, arg4: &mut 0x5f99ecf9a57a0a4e707936492eed0020469ea5efd02179a81b1c4246f78b0fd::nft::QuestionInfo, arg5: &mut MarketInfo, arg6: &mut 0x5f99ecf9a57a0a4e707936492eed0020469ea5efd02179a81b1c4246f78b0fd::nft::Supply, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::ascii::String, arg10: bool, arg11: u64, arg12: 0x1::string::String, arg13: u64, arg14: address, arg15: vector<u8>, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        v1.counter = v1.counter + 1;
        0x5f99ecf9a57a0a4e707936492eed0020469ea5efd02179a81b1c4246f78b0fd::nft::batch_mint(arg0, arg3, arg6, arg4, arg7, arg8, arg9, arg10, arg12, arg13, arg14, arg16);
    ...
    public entry fun set_signer<T0>(arg0: &Admin, arg1: vector<u8>, arg2: &mut Marketplace<T0>) {
        let v0 = 0x2::dynamic_object_field::borrow_mut<vector<u8>, Signer>(&mut arg2.id, b"signer");
        v0.signer_public_key_bytes = arg1;
        let v1 = SignerSetEvent{
            signer_id                   : 0x2::object::uid_to_inner(&v0.id),
            new_signer_public_key_bytes : arg1,
        };
        0x2::event::emit<SignerSetEvent>(v1);
    }
