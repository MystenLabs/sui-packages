module 0x5e30341e5568c53e4b20c699ab356b3a641f4038e93fca18e386ab3b4e4dc85::cnsnft2384 {
    struct CNSNFT2384 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2384, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2384>(arg0, arg1);
