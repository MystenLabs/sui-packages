module 0x5e8bc6e97554fdd756240f932dcdb862a9d43d88a45e66a1b1c24741b558f3b::cnsnft4233 {
    struct CNSNFT4233 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4233, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4233>(arg0, arg1);
