module 0x60d87ec0ec29e681db4a68d56fe832f84687b6c9078f843ffa965397f0de0128::vault {
    ...
    public entry fun create_and_share_vault<T0, T1>(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = create_vault<T0, T1>(arg0, arg1, arg2, arg3, arg4);
        0x2::transfer::share_object<Vault<T0, T1>>(v0);
        0x2::transfer::transfer<VaultCap>(v1, 0x2::tx_context::sender(arg4));
    }

    public fun create_vault<T0, T1>(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (Vault<T0, T1>, VaultCap) {
        ...
        let v2 = Vault<T0, T1>{
            ...
            total_shares        : 0,
            user_shares         : 0x2::table::new<address, u64>(arg4),
    ...
    public fun withdraw<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: VaultShare, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        0x2::event::emit<UserWithdrew>(v7);
        (0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance_a, v5), arg3), 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.balance_b, v6), arg3))
    }
