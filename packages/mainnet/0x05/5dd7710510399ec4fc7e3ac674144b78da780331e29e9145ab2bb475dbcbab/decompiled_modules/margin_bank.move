module 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_bank {
    ...
    public(friend) fun credit_fee_rebate<T0>(arg0: &mut MarginBank<T0>, arg1: address, arg2: address, arg3: u64) : u64 {
        if (arg3 == 0) {
            return 0
        };
        if (!0x2::table::contains<address, UserBalance>(&arg0.balances, arg1)) {
        ...
        let v0 = 0x2::table::borrow<address, UserBalance>(&arg0.balances, arg1).available;
        let v1 = if (arg3 > v0) {
            v0
        } else {
            arg3
        ...
        if (!0x2::table::contains<address, UserBalance>(&arg0.balances, arg2)) {
            ...
            0x2::table::add<address, UserBalance>(&mut arg0.balances, arg2, v2);
        };
        let v3 = 0x2::table::borrow_mut<address, UserBalance>(&mut arg0.balances, arg1);
        v3.available = v3.available - v1;
        let v4 = 0x2::table::borrow_mut<address, UserBalance>(&mut arg0.balances, arg2);
