module 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::mm_registry {
    ...
    public fun register_mm(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut MMRegistry, arg2: address, arg3: vector<vector<u8>>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock) {
    ...
    public fun remove_mm(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut MMRegistry, arg2: address) {
    ...
    public fun renew_mm(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut MMRegistry, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(0x2::table::contains<address, MMEntry>(&arg1.entries, arg2), 1);
    ...
    public fun update_mm(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut MMRegistry, arg2: address, arg3: vector<vector<u8>>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock) {
        assert!(0x2::table::contains<address, MMEntry>(&arg1.entries, arg2), 1);
        assert!(arg4 > 0, 4);
        assert!(0x1::vector::length<vector<u8>>(&arg3) > 0, 6);
        assert!(arg5 > 0x2::clock::timestamp_ms(arg6), 5);
