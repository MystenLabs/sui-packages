module 0x54f358d5d3894dd260160eb04d7bf098dc198c79147ca9432e9c7c9828a1728::oracle {
    ...
    public fun update_with_pyth(arg0: &mut Oracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x54f358d5d3894dd260160eb04d7bf098dc198c79147ca9432e9c7c9828a1728::pyth_parser::get_price(arg1, arg2, arg4);
        assert!(v2 > 0, 2);
        let v4 = if (v3 > arg0.decimal) {
            v2 / 0x2::math::pow(10, ((v3 - arg0.decimal) as u8))
        } else {
            v2 * 0x2::math::pow(10, ((arg0.decimal - v3) as u8))
        };
        let (v5, v6) = 0x54f358d5d3894dd260160eb04d7bf098dc198c79147ca9432e9c7c9828a1728::pyth_parser::get_price(arg1, arg3, arg4);
        assert!(v5 > 0, 2);
        let v7 = (((v4 as u128) * (0x2::math::pow(10, (v6 as u8)) as u128) / (v5 as u128)) as u64);
        arg0.price = v7;
        let v8 = 0x2::clock::timestamp_ms(arg4);
        arg0.ts_ms = v8;
        arg0.epoch = 0x2::tx_context::epoch(arg5);
        let (v9, v10, v11) = 0x54f358d5d3894dd260160eb04d7bf098dc198c79147ca9432e9c7c9828a1728::pyth_parser::get_ema_price(arg2);
        assert!(v9 > 0, 2);
        assert!(v8 / 1000 - v11 < arg0.time_interval, 1);
        let v12 = if (v10 > arg0.decimal) {
            v9 / 0x2::math::pow(10, ((v10 - arg0.decimal) as u8))
        } else {
            v9 * 0x2::math::pow(10, ((arg0.decimal - v10) as u8))
        };
        let (v13, v14, v15) = 0x54f358d5d3894dd260160eb04d7bf098dc198c79147ca9432e9c7c9828a1728::pyth_parser::get_ema_price(arg3);
        assert!(v13 > 0, 2);
        assert!(v8 / 1000 - v15 < arg0.time_interval, 1);
        arg0.twap_price = (((v12 as u128) * (0x2::math::pow(10, (v14 as u8)) as u128) / (v13 as u128)) as u64);
        let v16 = PriceEvent{
            id    : 0x2::object::id<Oracle>(arg0),
            price : v7,
            ts_ms : v8,
    ...
    entry fun update_with_supra(arg0: &mut Oracle, arg1: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x54f358d5d3894dd260160eb04d7bf098dc198c79147ca9432e9c7c9828a1728::supra::retrieve_price(arg1, *0x2::dynamic_field::borrow<0x1::string::String, u32>(&arg0.id, 0x1::string::utf8(b"supra_pair")));
        assert!(v0 > 0, 2);
    ...
    entry fun update_with_switchboard(arg0: &mut Oracle, arg1: &0x8d79f4d920b03d88faca1e421af023a87fbb1e4a6fd200248e6e9998d09e470::aggregator::Aggregator, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x54f358d5d3894dd260160eb04d7bf098dc198c79147ca9432e9c7c9828a1728::switchboard_feed_parser::log_aggregator_info(arg1);
        assert!(v2 > 0, 2);
        let v4 = (v3 as u64);
