module 0x5ae538f3d3532c3ed0383260b2680bf845162040eb98573c8d640c64dd29fad::splo_exploring_tradeport_ {
    struct SPLO_EXPLORING_TRADEPORT_ has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"fb164151-9186-4a61-b5de-f862d33a44f6"),
        };
    ...
    fun init(arg0: SPLO_EXPLORING_TRADEPORT_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SPLO_EXPLORING_TRADEPORT_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SPLO exploring TradePort "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Check social, join our community. We preparing something special for SPLO-holders soon..."));
