module 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::storage {
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : Storage {
        Storage{
            ...
            version                         : 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::version::new(1),
    ...
    public(friend) fun decrease_validator_stake<T0>(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::events::emit_event<DecreaseValidatorStakeEvent>(v2);
        v1
    }
    ...
    public(friend) fun increase_validator_stake<T0>(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::events::emit_event<IncreaseValidatorStakeEvent>(v2);
    ...
    public(friend) fun rebalance<T0>(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v12 < 0x1::vector::length<address>(v10)) {
            let v13 = find_validator_index_by_address(arg0, *0x1::vector::borrow<address>(v10, v12));
            let v14 = if (v13 >= 0x1::vector::length<ValidatorInfo>(validators(arg0))) {
                0
            } else {
                total_sui_amount(0x1::vector::borrow<ValidatorInfo>(validators(arg0), v13))
            };
        ...
        while (v15 < 0x1::vector::length<address>(&v7)) {
            if (*0x1::vector::borrow<u64>(&v11, v15) > *0x1::vector::borrow<u64>(&v8, v15)) {
                decrease_validator_stake<T0>(arg0, arg1, *0x1::vector::borrow<address>(&v7, v15), *0x1::vector::borrow<u64>(&v11, v15) - *0x1::vector::borrow<u64>(&v8, v15), arg2);
            };
            v15 = v15 + 1;
        };
        let v16 = 0;
        while (v16 < 0x1::vector::length<address>(&v7)) {
            if (*0x1::vector::borrow<u64>(&v11, v16) < *0x1::vector::borrow<u64>(&v8, v16)) {
                increase_validator_stake<T0>(arg0, arg1, *0x1::vector::borrow<address>(&v7, v16), *0x1::vector::borrow<u64>(&v8, v16) - *0x1::vector::borrow<u64>(&v11, v16), arg2);
            };
            v16 = v16 + 1;
        };
        let v17 = 0x1::vector::length<ValidatorInfo>(&arg0.validator_infos);
        while (v17 > 0) {
            v17 = v17 - 1;
            let v18 = 0x1::vector::borrow<ValidatorInfo>(&arg0.validator_infos, v17).validator_address;
            let (v19, v20) = 0x1::vector::index_of<address>(&v7, &v18);
            if (v19 == true) {
                0x1::vector::borrow_mut<ValidatorInfo>(&mut arg0.validator_infos, v17).assigned_weight = *0x1::vector::borrow<u64>(&v6, v20);
            };
        };
    ...
    public(friend) fun refresh<T0>(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) : bool {
        0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::version::assert_version_and_upgrade(&mut arg0.version, 1);
