module 0x58b796f6de49b44d2f670b8238c9e7cea8ac25944e36652bb92d84415be4686::events {
    ...
    struct IncomeSwappedToSui has copy, drop {
        vault_id: 0x2::object::ID,
        profit_recipient: address,
        usdc_input: u64,
        cetus_input: u64,
        direct_sui_income: u64,
        usdc_sui_output: u64,
        cetus_sui_output: u64,
        total_sui_payout: u64,
        remaining_pending_fee_usdc: u64,
        remaining_pending_reward_usdc: u64,
        remaining_pending_fee_sui: u64,
        remaining_pending_reward_sui: u64,
        remaining_pending_cetus: u64,
        usdc_sui_route_id: 0x2::object::ID,
        cetus_sui_route_id: 0x2::object::ID,
        sequence: u64,
        generation: u64,
        policy_version: u64,
        deadline_ms: u64,
    ...
    public(friend) fun emit_income_swapped_to_sui(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: 0x2::object::ID, arg14: 0x2::object::ID, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: vector<u8>) {
        let v0 = IncomeSwappedToSui{
            vault_id                      : arg0,
            profit_recipient              : arg1,
            usdc_input                    : arg2,
            cetus_input                   : arg3,
            direct_sui_income             : arg4,
            usdc_sui_output               : arg5,
            cetus_sui_output              : arg6,
            total_sui_payout              : arg7,
            remaining_pending_fee_usdc    : arg8,
            remaining_pending_reward_usdc : arg9,
            remaining_pending_fee_sui     : arg10,
            remaining_pending_reward_sui  : arg11,
            remaining_pending_cetus       : arg12,
            usdc_sui_route_id             : arg13,
            cetus_sui_route_id            : arg14,
            sequence                      : arg15,
            generation                    : arg16,
            policy_version                : arg17,
            deadline_ms                   : arg18,
            seal_hash                     : arg19,
        };
        0x2::event::emit<IncomeSwappedToSui>(v0);
    }
