module 0x51d39812a0c63ee243edc7566728897ce557a220bb1c7b59722ec65a250354a::cnsnft2184 {
    struct CNSNFT2184 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2184, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2184>(arg0, arg1);
