module 0x5400d64123f8cd14f23c09d652e2862419eb15320eb4610973883132ec8b010::cropz_land_nfts {
    struct CROPZ_LAND_NFTS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CROPZ_LAND_NFTS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CROPZ_LAND_NFTS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"CROPZ Land NFTs"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"CROPZ Land NFTs represent ownership of virtual agricultural plots within the CROPZ Farming Game, a Web3 farming simulation with play-and-earn mechanics. Each distinct land type comes with unique attributes, offering strategic benefits for crop cultivation and gameplay."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeie2w5phqdtnkth634ar2v6223ua5ni4zskj327uj7d3ikgfdirnfi"));
