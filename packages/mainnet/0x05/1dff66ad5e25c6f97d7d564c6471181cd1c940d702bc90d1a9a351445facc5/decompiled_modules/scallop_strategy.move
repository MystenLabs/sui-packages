module 0x51dff66ad5e25c6f97d7d564c6471181cd1c940d702bc90d1a9a351445facc5::scallop_strategy {
    struct ScallopStrategy<phantom T0> has key {
        id: 0x2::object::UID,
        admin_cap_id: 0x2::object::ID,
        vault_access: 0x1::option::Option<0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::VaultAccess>,
    ...
    fun assert_vault_access<T0>(arg0: &ScallopStrategy<T0>) {
        assert!(0x1::option::is_some<0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::VaultAccess>(&arg0.vault_access), 8);
    }
    ...
    public fun create_strategy<T0>(arg0: &0x2::clock::Clock, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = ScallopStrategy<T0>{
            id                       : v0,
            admin_cap_id             : v3,
            vault_access             : 0x1::option::none<0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::VaultAccess>(),
    ...
    public fun emergency_withdraw<T0, T1>(arg0: &mut ScallopStrategy<T0>, arg1: &StrategyAdminCap, arg2: &mut 0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::Vault<T0, T1>, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg4: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_version<T0>(arg0);
        assert_admin<T0>(arg1, arg0);
        assert_vault_access<T0>(arg0);
        assert_scallop_version(arg3);
        assert_scallop_market(arg4);
        let v0 = 0x1::option::borrow<0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::VaultAccess>(&arg0.vault_access);
        ...
        0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::emergency_defund_strategy<T0, T1>(arg2, v0, v2, arg5);
        arg0.underlying_nominal_value = 0;
    ...
    public fun harvest_profit<T0, T1>(arg0: &mut ScallopStrategy<T0>, arg1: &StrategyAdminCap, arg2: &mut 0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::Vault<T0, T1>, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg4: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (v2 > v3) {
            let v6 = v2 - v3;
            0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::add_strategy_profit<T0, T1>(arg2, v0, 0x2::balance::split<T0>(&mut v4, v6), arg5);
            let v7 = StrategyProfitEvent{
                vault_id      : 0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::vault_id<T0, T1>(arg2),
                strategy_id   : 0x2::object::id<ScallopStrategy<T0>>(arg0),
                profit_amount : v6,
                timestamp     : 0x2::clock::timestamp_ms(arg5),
            };
    ...
    public fun has_vault_access<T0>(arg0: &ScallopStrategy<T0>) : bool {
        0x1::option::is_some<0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::VaultAccess>(&arg0.vault_access)
    }
    ...
    public fun join_vault<T0, T1>(arg0: &0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::AdminCap, arg1: &mut 0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::Vault<T0, T1>, arg2: &StrategyAdminCap, arg3: &mut ScallopStrategy<T0>, arg4: &0x2::clock::Clock) {
        assert_version<T0>(arg3);
        assert_admin<T0>(arg2, arg3);
        assert!(0x1::option::is_none<0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::VaultAccess>(&arg3.vault_access), 4);
        0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::set_target_allocation<T0, T1>(arg0, arg1, 0x2::object::id<ScallopStrategy<T0>>(arg3), 3500, arg4);
        0x1::option::fill<0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::VaultAccess>(&mut arg3.vault_access, 0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::add_strategy<T0, T1>(arg0, arg1, 0x2::object::id<ScallopStrategy<T0>>(arg3), b"SCALLOP_STRATEGY_LENDING_USDC", 5000, arg4));
        let v0 = StrategyJoinedVault{
            strategy_id : 0x2::object::id<ScallopStrategy<T0>>(arg3),
            vault_id    : 0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::vault_id<T0, T1>(arg1),
    ...
    public fun ptb_withdraw<T0, T1>(arg0: &mut ScallopStrategy<T0>, arg1: &mut 0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::Vault<T0, T1>, arg2: &mut 0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::WithdrawReceipt<T0, T1>, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg4: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_version<T0>(arg0);
        assert_vault_access<T0>(arg0);
        assert_scallop_version(arg3);
        assert_scallop_market(arg4);
        let v0 = 0x2::object::id<ScallopStrategy<T0>>(arg0);
        if (!0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::is_strategy_allocated_in_receipt<T0, T1>(arg2, v0)) {
            return
        };
        let v1 = 0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::get_strategy_allocation_from_receipt<T0, T1>(arg2, v0);
        if (v1 == 0) {
            0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::update_receipt_after_strategy_withdrawal<T0, T1>(arg1, arg2, v0, 0x2::balance::zero<T0>(), arg6);
            return
        };
        if (0x2::balance::value<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(&arg0.s_asset_balance) == 0 || arg0.underlying_nominal_value == 0) {
            0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::update_receipt_after_strategy_withdrawal<T0, T1>(arg1, arg2, v0, 0x2::balance::zero<T0>(), arg6);
        ...
        0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::update_receipt_after_strategy_withdrawal<T0, T1>(arg1, arg2, v0, 0x2::balance::split<T0>(&mut v4, v1), arg6);
    ...
    public fun rebalance<T0, T1>(arg0: &StrategyAdminCap, arg1: &mut ScallopStrategy<T0>, arg2: &mut 0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::Vault<T0, T1>, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg4: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_version<T0>(arg1);
        assert_admin<T0>(arg0, arg1);
        assert_vault_access<T0>(arg1);
        assert_scallop_version(arg3);
        assert_scallop_market(arg4);
        let v0 = 0x1::option::borrow<0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::VaultAccess>(&arg1.vault_access);
        let v1 = 0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::calc_rebalance_amounts<T0, T1>(arg2);
        let (v2, v3) = 0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::rebalance_amounts_get(&v1, v0);
        if (v2 == 0 && v3 == 0) {
            return
        };
        if (v3 > 0) {
            ...
            0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::defund_strategy<T0, T1>(arg2, v0, 0x2::balance::split<T0>(&mut v6, v3), v3, arg5);
        ...
        if (v2 > 0) {
            0x2::balance::join<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(&mut arg1.s_asset_balance, 0x2::coin::into_balance<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::mint::mint<T0>(arg3, arg4, 0x2::coin::from_balance<T0>(0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::fund_strategy<T0, T1>(arg2, v0, v2, arg5), arg6), arg5, arg6)));
            arg1.underlying_nominal_value = arg1.underlying_nominal_value + v2;
        };
        0x441a10547ecbb5409b098da554ad1b9a9c63a53f2c4a626de1a021f75d5fce7::usdc_vault::validate_vault_invariants<T0, T1>(arg2);
        if (v2 > 0 || v3 > 0) {
