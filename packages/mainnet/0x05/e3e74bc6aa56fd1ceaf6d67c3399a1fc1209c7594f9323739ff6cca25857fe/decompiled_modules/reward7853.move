module 0x5e3e74bc6aa56fd1ceaf6d67c3399a1fc1209c7594f9323739ff6cca25857fe::reward7853 {
    struct REWARD7853 has drop {
        dummy_field: bool,
    }

    struct TICKET_7853 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7853(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7853>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7853>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7853, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7853>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7853>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7853>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7853>>(v5, 0x2::tx_context::sender(arg1));
    }
