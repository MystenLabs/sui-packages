module 0x501c7f5f4193c1db3092c064468b29bd969a579362936ec100e41ba8253f608::cnsnft7118 {
    struct CNSNFT7118 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7118, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7118>(arg0, arg1);
