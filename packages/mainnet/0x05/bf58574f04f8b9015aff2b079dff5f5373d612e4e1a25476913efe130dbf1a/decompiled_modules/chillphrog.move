module 0x5bf58574f04f8b9015aff2b079dff5f5373d612e4e1a25476913efe130dbf1a::chillphrog {
    ...
    fun init(arg0: CHILLPHROG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::coin::create_currency<CHILLPHROG>(arg0, 6, b"CHILLPHROG", b"Chill Phrog", b"The chillest frog meme coin on Sui. Join our vibrant community of chill frogs. Ribbit responsibly.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"ipfs://bafkreiftbkwmnkynxk2lynsmjnhavaaw6q2nbwqzriusyjk2iyoyljpq5e")), arg1);
        let v3 = TokenConfig{
