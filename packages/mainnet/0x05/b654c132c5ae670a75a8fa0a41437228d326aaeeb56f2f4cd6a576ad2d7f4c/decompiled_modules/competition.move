module 0xffb4d59fc5c3340d623597f5695d48f44341b6116e5fdbe4b2675716914e436a::competition {
    ...
    public entry fun add_points(arg0: &AdminCap, arg1: &mut RewardPoint, arg2: vector<address>, arg3: vector<u64>) {
        assert!(0x1::vector::length<address>(&arg2) == 0x1::vector::length<u64>(&arg3), 6);
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            let v1 = *0x1::vector::borrow<address>(&arg2, v0);
            if (0x2::table::contains<address, u64>(&arg1.player_points, v1)) {
                let v2 = 0x2::table::borrow_mut<address, u64>(&mut arg1.player_points, v1);
                *v2 = *v2 + *0x1::vector::borrow<u64>(&arg3, v0);
            } else {
                0x2::table::add<address, u64>(&mut arg1.player_points, v1, *0x1::vector::borrow<u64>(&arg3, v0));
            };
            v0 = v0 + 1;
        };
    }

    public entry fun buy_ticket<T0>(arg0: &Config, arg1: &CompetitionBucket, arg2: vector<u8>, arg3: &mut 0xffb4d59fc5c3340d623597f5695d48f44341b6116e5fdbe4b2675716914e436a::sequence_number::Registry, arg4: &mut 0x2::coin::Coin<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun buy_ticket_and_submit_answer_with_discount<T0>(arg0: &Config, arg1: &CompetitionBucket, arg2: &mut RewardPoint, arg3: vector<u8>, arg4: &mut 0xffb4d59fc5c3340d623597f5695d48f44341b6116e5fdbe4b2675716914e436a::sequence_number::Registry, arg5: &mut 0x2::coin::Coin<T0>, arg6: vector<vector<u64>>, arg7: u64, arg8: bool, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = buy_ticket_internal_with_discount<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg7, arg8, arg9, arg10);
        let v1 = 0;
        while (v1 < arg7) {
            let v2 = 0x1::vector::pop_back<Ticket>(&mut v0);
            let v3 = &mut v2;
            submit_answer(v3, 0x1::vector::pop_back<vector<u64>>(&mut arg6));
            0x2::transfer::transfer<Ticket>(v2, 0x2::tx_context::sender(arg10));
            v1 = v1 + 1;
        };
        0x1::vector::destroy_empty<Ticket>(v0);
    }

    fun buy_ticket_internal<T0>(arg0: &Config, arg1: &CompetitionBucket, arg2: vector<u8>, arg3: &mut 0xffb4d59fc5c3340d623597f5695d48f44341b6116e5fdbe4b2675716914e436a::sequence_number::Registry, arg4: &mut 0x2::coin::Coin<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : vector<Ticket> {
    ...
    fun buy_ticket_internal_with_discount<T0>(arg0: &Config, arg1: &CompetitionBucket, arg2: &mut RewardPoint, arg3: vector<u8>, arg4: &mut 0xffb4d59fc5c3340d623597f5695d48f44341b6116e5fdbe4b2675716914e436a::sequence_number::Registry, arg5: &mut 0x2::coin::Coin<T0>, arg6: u64, arg7: bool, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : vector<Ticket> {
        let v0 = 0x2::clock::timestamp_ms(arg8);
        assert!(v0 >= arg1.start_ts && v0 < arg1.end_ts, 0);
        let v1 = arg6;
        if (arg7) {
            let v2 = 0x2::table::borrow_mut<address, u64>(&mut arg2.player_points, 0x2::tx_context::sender(arg9));
            let v3 = *v2 / 100;
            v1 = arg6 - v3;
            *v2 = *v2 - v3 * 100;
        };
        let v4 = 0x2::table::borrow<vector<u8>, Competition>(&arg1.competitions, arg3).ticket_price * v1;
        let v5 = v4;
        if (arg6 >= 50) {
            v5 = v4 * 75 / 100;
        } else if (arg6 >= 40) {
        ...
        assert!(0x2::coin::value<T0>(arg5) >= v5, 1);
        let v6 = 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>()));
        assert!(is_coin_supported(arg0, &v6), 4);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg5, v5, arg9), arg0.treasury);
        let v7 = 0;
        let v8 = 0x1::vector::empty<Ticket>();
        while (v7 < arg6) {
            0x1::vector::push_back<Ticket>(&mut v8, new_ticket(arg4, 0x2::object::uid_to_address(&arg1.id), arg3, arg9));
            v7 = v7 + 1;
        };
        v8
    }
    ...
    public entry fun buy_ticket_with_discount<T0>(arg0: &Config, arg1: &CompetitionBucket, arg2: &mut RewardPoint, arg3: vector<u8>, arg4: &mut 0xffb4d59fc5c3340d623597f5695d48f44341b6116e5fdbe4b2675716914e436a::sequence_number::Registry, arg5: &mut 0x2::coin::Coin<T0>, arg6: u64, arg7: bool, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = buy_ticket_internal_with_discount<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
        let v1 = 0;
        while (v1 < arg6) {
            0x2::transfer::transfer<Ticket>(0x1::vector::pop_back<Ticket>(&mut v0), 0x2::tx_context::sender(arg9));
            v1 = v1 + 1;
        };
        0x1::vector::destroy_empty<Ticket>(v0);
    }
    ...
    fun new_ticket(arg0: &mut 0xffb4d59fc5c3340d623597f5695d48f44341b6116e5fdbe4b2675716914e436a::sequence_number::Registry, arg1: address, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : Ticket {
        Ticket{
            id                    : 0x2::object::new(arg3),
            serial_number         : 0xffb4d59fc5c3340d623597f5695d48f44341b6116e5fdbe4b2675716914e436a::sequence_number::new(arg0),
    ...
    public entry fun reveal_winner(arg0: &OperatorCap, arg1: &mut CompetitionBucket, arg2: 0x1::string::String, arg3: address) {
        ...
        assert!(0xffb4d59fc5c3340d623597f5695d48f44341b6116e5fdbe4b2675716914e436a::compare::cmp_bcs_bytes(&v1, &v2) == 0, 5);
