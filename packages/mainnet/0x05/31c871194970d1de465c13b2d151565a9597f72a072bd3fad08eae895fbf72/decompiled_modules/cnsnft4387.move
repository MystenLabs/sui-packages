module 0x531c871194970d1de465c13b2d151565a9597f72a072bd3fad08eae895fbf72::cnsnft4387 {
    struct CNSNFT4387 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4387, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4387>(arg0, arg1);
