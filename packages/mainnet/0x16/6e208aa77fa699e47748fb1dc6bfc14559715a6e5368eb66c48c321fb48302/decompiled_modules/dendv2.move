module 0x166e208aa77fa699e47748fb1dc6bfc14559715a6e5368eb66c48c321fb48302::dendv2 {
    ...
    fun add_dividend_v2(arg0: &mut Manager, arg1: 0x2::object::ID, arg2: u64, arg3: 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>) : bool {
        ...
        let (v2, _) = 0x2::vec_map::get_entry_by_idx<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&v1.dividends, 0x2::vec_map::size<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&v1.dividends) - 1);
        if (*v2 == arg2) {
            let (_, _) = 0x2::vec_map::pop<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&mut v1.dividends);
            0x2::vec_map::insert<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&mut v1.dividends, arg2, arg3);
            return false
        };
        assert!(arg2 > *v2, 500);
        0x2::vec_map::insert<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&mut v1.dividends, arg2, arg3);
    ...
    public entry fun settle(arg0: &mut Manager, arg1: &0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::XcetusManager, arg2: u64, arg3: vector<0x2::object::ID>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::option::is_some<0x2::object::ID>(&v2) && v3 < arg4) {
            ...
            while (v8 < 0x1::vector::length<0x1::type_name::TypeName>(&v5)) {
                ...
                v9 = add_dividend_v2(arg0, v7, arg2, v10);
                v8 = v8 + 1;
            };
            if (v9) {
                v4 = v4 + 1;
