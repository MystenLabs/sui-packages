module 0x16967c1e176c7dc11a0d2d1b33797ef01e6a482cb00952518dc4a1608201fd94::xbird {
    ...
    public fun depositToken(arg0: vector<u8>, arg1: vector<u8>, arg2: &ValidatorVault, arg3: &mut PegVault<XBIRD>, arg4: &mut 0x16967c1e176c7dc11a0d2d1b33797ef01e6a482cb00952518dc4a1608201fd94::archieve::UserArchieve, arg5: &0x16967c1e176c7dc11a0d2d1b33797ef01e6a482cb00952518dc4a1608201fd94::version::Version, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<XBIRD>, DepositProof) {
        ...
        assert!(v2 > 0, 1002);
        0x16967c1e176c7dc11a0d2d1b33797ef01e6a482cb00952518dc4a1608201fd94::archieve::verUpdateTokenPegNonce(v3, arg4);
        let v4 = DepositProof{
            owner   : v0,
            balance : v2,
        };
        let v5 = XBirdDeposited{
            ...
            nonce         : v3,
            balance       : v2,
            total_deposit : 0x16967c1e176c7dc11a0d2d1b33797ef01e6a482cb00952518dc4a1608201fd94::archieve::increaseTotalDeposit(v2, arg4),
        };
    ...
    fun init(arg0: XBIRD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x16967c1e176c7dc11a0d2d1b33797ef01e6a482cb00952518dc4a1608201fd94::cap_vault::createVault<XBirdAdminCap>(arg1);
    }

    public fun setValidator(arg0: &XBirdAdminCap, arg1: vector<u8>, arg2: &mut ValidatorVault, arg3: &0x16967c1e176c7dc11a0d2d1b33797ef01e6a482cb00952518dc4a1608201fd94::version::Version) {
