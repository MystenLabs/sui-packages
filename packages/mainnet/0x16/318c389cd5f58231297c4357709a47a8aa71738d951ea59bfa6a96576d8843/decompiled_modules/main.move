module 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::main {
    ...
    struct DepositCap has copy, drop, store {
        cap_share: u128,
        enabled: bool,
    }

    struct DepositCapUpdatedEvent has copy, drop {
        farm_id: 0x2::object::ID,
        cap_share: u128,
        enabled: bool,
    }
    ...
    public(friend) fun add_farm<T0, T1>(arg0: u64, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg2: &0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_config::IncentiveConfig, arg3: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_pool::IncentivePools, arg4: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_account::IncentiveAccounts, arg5: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation_access::ObligationAccessStore, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0 <= 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::max_percent(), 103);
    ...
    public(friend) fun add_liquidity<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: &mut 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::Position, arg2: 0x2::coin::Coin<T0>, arg3: &0xca5a5a62f01c79a104bf4d31669e29daa387f325c241de4edbe30986a9bc8b0d::coin_decimals_registry::CoinDecimalsRegistry, arg4: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg5: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation_access::ObligationAccessStore, arg6: &0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_config::IncentiveConfig, arg7: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_pool::IncentivePools, arg8: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_account::IncentiveAccounts, arg9: &mut 0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberTable, arg10: &0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberWhitelist, arg11: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg12: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg13: &0x1478a432123e4b3d61878b629f2c692969fdb375644f1251cd278a4b1e7d7cd6::x_oracle::XOracle, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_collateral_amount<T0>(arg4);
        let v2 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_mul_div(arg0.total_deposit_share, (v0 as u128), (v1 as u128));
        ...
        assert!(arg0.collateral_weight < 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::max_percent(), 103);
        let v3 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::mul_div_u64(v0, arg0.collateral_weight, 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::max_percent());
        let v4 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_debt_amount<T1>(arg4);
        let v5 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_mul_div(arg0.total_debt_share, (v3 as u128), (v4 as u128));
        ...
        let v9 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_mul_div(arg0.total_lend_share, (0x2::coin::value<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T1>>(&v7) as u128), (v8 as u128));
        ...
        0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::increase_deposit_share(arg1, v2);
        0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::increase_debt_share(arg1, v5);
        0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::increase_lend_share(arg1, v9);
        assert_within_deposit_cap<T0, T1>(arg0, v2);
        ...
        let v10 = AddLiquidityEvent{
            ...
            borrow_fee               : 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_debt_amount<T1>(arg4) - v4 + 0x2::coin::value<T1>(&v6),
            ...
            new_total_debt_amount    : 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_debt_amount<T1>(arg4),
            new_total_deposit_amount : 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_collateral_amount<T0>(arg4),
        };
        0x2::event::emit<AddLiquidityEvent>(v10);
    }

    fun assert_within_deposit_cap<T0, T1>(arg0: &Farm<T0, T1>, arg1: u128) {
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"deposit_cap")) {
            return
        };
        let v0 = 0x2::dynamic_field::borrow<vector<u8>, DepositCap>(&arg0.id, b"deposit_cap");
        if (!v0.enabled) {
            return
        };
        assert!(arg0.total_deposit_share + arg1 <= v0.cap_share, 9001);
    }
    ...
    public fun deposit_cap<T0, T1>(arg0: &Farm<T0, T1>) : (u128, bool, bool) {
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"deposit_cap")) {
            return (0, false, false)
        };
        let v0 = 0x2::dynamic_field::borrow<vector<u8>, DepositCap>(&arg0.id, b"deposit_cap");
        (v0.cap_share, v0.enabled, true)
    }

    public(friend) fun force_liquidate<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: 0x2::transfer::Receiving<0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::Position>, arg2: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation_access::ObligationAccessStore, arg4: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg5: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg6: &0xca5a5a62f01c79a104bf4d31669e29daa387f325c241de4edbe30986a9bc8b0d::coin_decimals_registry::CoinDecimalsRegistry, arg7: &0x1478a432123e4b3d61878b629f2c692969fdb375644f1251cd278a4b1e7d7cd6::x_oracle::XOracle, arg8: &0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_config::IncentiveConfig, arg9: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_pool::IncentivePools, arg10: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_account::IncentiveAccounts, arg11: &mut 0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberTable, arg12: &0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberWhitelist, arg13: &0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::GlobalConfig, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::transfer::public_receive<0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::Position>(&mut arg0.id, arg1);
        assert!(0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::farm_id(&v0) == 0x2::object::id<Farm<T0, T1>>(arg0), 120);
        let v1 = &mut v0;
        liquidate<T0, T1>(arg0, v1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15);
        remove_position<T0, T1>(arg0, v0, arg15);
    }

    public(friend) fun force_liquidate_flashswap<T0, T1, T2, T3>(arg0: &mut Farm<T0, T1>, arg1: 0x2::transfer::Receiving<0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::Position>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T3>, arg4: u128, arg5: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg6: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation_access::ObligationAccessStore, arg7: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg8: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg9: &0xca5a5a62f01c79a104bf4d31669e29daa387f325c241de4edbe30986a9bc8b0d::coin_decimals_registry::CoinDecimalsRegistry, arg10: &0x1478a432123e4b3d61878b629f2c692969fdb375644f1251cd278a4b1e7d7cd6::x_oracle::XOracle, arg11: &0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_config::IncentiveConfig, arg12: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_pool::IncentivePools, arg13: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_account::IncentiveAccounts, arg14: &mut 0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberTable, arg15: &0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberWhitelist, arg16: &0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::GlobalConfig, arg17: &0x2::clock::Clock, arg18: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::transfer::public_receive<0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::Position>(&mut arg0.id, arg1);
        assert!(0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::farm_id(&v0) == 0x2::object::id<Farm<T0, T1>>(arg0), 120);
        let v1 = &mut v0;
        liquidate_flashswap<T0, T1, T2, T3>(arg0, v1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18);
        remove_position<T0, T1>(arg0, v0, arg18);
    }
    ...
    public fun info<T0, T1>(arg0: &Farm<T0, T1>, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market) : (u64, u128, u128, u128, u64, u64, u64, u64, u64) {
        ...
        (arg0.collateral_weight, arg0.total_deposit_share, arg0.total_debt_share, arg0.total_lend_share, 0x2::bag::length(&arg0.rewards), 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_collateral_amount<T0>(arg1), 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_debt_amount<T1>(arg1), v0, 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::compute_underlying_amount<T1>(arg2, v0))
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::new(3000, 500, @0x5b3587896d2340e5741424d891a61dc4ce7e18e3c48a10b5ca78eabccb2769f5, 9000, arg0);
    }

    public(friend) fun liquidate<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: &mut 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::Position, arg2: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation_access::ObligationAccessStore, arg4: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg5: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg6: &0xca5a5a62f01c79a104bf4d31669e29daa387f325c241de4edbe30986a9bc8b0d::coin_decimals_registry::CoinDecimalsRegistry, arg7: &0x1478a432123e4b3d61878b629f2c692969fdb375644f1251cd278a4b1e7d7cd6::x_oracle::XOracle, arg8: &0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_config::IncentiveConfig, arg9: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_pool::IncentivePools, arg10: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_account::IncentiveAccounts, arg11: &mut 0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberTable, arg12: &0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberWhitelist, arg13: &0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::GlobalConfig, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::get_liquidation_threshold(arg13);
        let (_, v2, v3, _) = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::info(arg1);
        let v5 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::to_u64(0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::mul_div((0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_debt_amount<T1>(arg2) as u128), v3, arg0.total_debt_share));
        let v6 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::to_u64(0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::mul_div((0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_collateral_amount<T0>(arg2) as u128), v2, arg0.total_deposit_share));
        ...
        let v8 = if (v7 == 0) {
            0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::max_percent()
        } else {
            0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::mul_div_u64(0x1::fixed_point32::multiply_u64(v5, 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::price::get_price(arg7, 0x1::type_name::get<T1>(), arg14)), 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::max_percent(), v7)
        };
        assert!(v8 >= v0, 125);
        let v9 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::deposit_share(arg1);
        let (v10, v11, v12, v13) = remove_liquidity_internal_start<T0, T1>(arg0, arg1, v9, arg5, arg2);
        let v14 = 0x2::coin::zero<T1>(arg15);
        let (v15, v16) = remove_liquidity_internal_end<T0, T1>(arg0, v10, v11, v12, v13, v14, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg14, arg15);
        let v17 = v16;
        let v18 = v15;
        let v19 = 0x2::coin::value<T0>(&v18);
        let v20 = 0x2::coin::value<T1>(&v17);
        let v21 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::get_liquidation_fee_wallet(arg13);
        if (v19 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v18, v21);
        } else {
            0x2::coin::destroy_zero<T0>(v18);
        };
        if (v20 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v17, v21);
        } else {
            0x2::coin::destroy_zero<T1>(v17);
        };
        let v22 = LiquidateEvent{
            caller                         : 0x2::tx_context::sender(arg15),
            farm_id                        : 0x2::object::id<Farm<T0, T1>>(arg0),
            position_id                    : 0x2::object::id<0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::Position>(arg1),
            debt_coin_type                 : 0x1::type_name::get<T1>(),
            deposit_coin_type              : 0x1::type_name::get<T0>(),
            health_ratio                   : v8,
            liquidation_threshold          : v0,
            debt_amount                    : v5,
            deposit_amount                 : v6,
            liquidation_fee_deposit_amount : v19,
            liquidation_fee_debt_amount    : v20,
        };
        0x2::event::emit<LiquidateEvent>(v22);
    }

    public(friend) fun liquidate_flashswap<T0, T1, T2, T3>(arg0: &mut Farm<T0, T1>, arg1: &mut 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::Position, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T3>, arg4: u128, arg5: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg6: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation_access::ObligationAccessStore, arg7: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg8: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg9: &0xca5a5a62f01c79a104bf4d31669e29daa387f325c241de4edbe30986a9bc8b0d::coin_decimals_registry::CoinDecimalsRegistry, arg10: &0x1478a432123e4b3d61878b629f2c692969fdb375644f1251cd278a4b1e7d7cd6::x_oracle::XOracle, arg11: &0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_config::IncentiveConfig, arg12: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_pool::IncentivePools, arg13: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_account::IncentiveAccounts, arg14: &mut 0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberTable, arg15: &0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberWhitelist, arg16: &0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::GlobalConfig, arg17: &0x2::clock::Clock, arg18: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::get_liquidation_threshold(arg16);
        let (_, v2, v3, _) = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::info(arg1);
        let v5 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::to_u64(0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::mul_div((0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_debt_amount<T1>(arg5) as u128), v3, arg0.total_debt_share));
        let v6 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::to_u64(0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::mul_div((0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_collateral_amount<T0>(arg5) as u128), v2, arg0.total_deposit_share));
        let v7 = 0x1::fixed_point32::multiply_u64(v6, 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::price::get_price(arg10, 0x1::type_name::get<T0>(), arg17));
        let v8 = if (v7 == 0) {
            0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::max_percent()
        } else {
            0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::mul_div_u64(0x1::fixed_point32::multiply_u64(v5, 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::price::get_price(arg10, 0x1::type_name::get<T1>(), arg17)), 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::max_percent(), v7)
        };
        assert!(v8 >= v0, 125);
        let v9 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::deposit_share(arg1);
        let (v10, v11) = remove_liquidity_flashswap<T0, T1, T2, T3>(arg0, v9, arg2, arg3, arg4, arg1, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg17, arg18);
        let v12 = v11;
        let v13 = v10;
        let v14 = 0x2::coin::value<T0>(&v13);
        let v15 = 0x2::coin::value<T1>(&v12);
        let v16 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::get_liquidation_fee_wallet(arg16);
        if (v14 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v13, v16);
        } else {
            0x2::coin::destroy_zero<T0>(v13);
        };
        if (v15 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v12, v16);
        } else {
            0x2::coin::destroy_zero<T1>(v12);
        };
        let v17 = LiquidateEvent{
    ...
    public(friend) fun remove_liquidity_flashswap<T0, T1, T2, T3>(arg0: &mut Farm<T0, T1>, arg1: u128, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T3>, arg4: u128, arg5: &mut 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::Position, arg6: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg7: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation_access::ObligationAccessStore, arg8: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg9: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg10: &0xca5a5a62f01c79a104bf4d31669e29daa387f325c241de4edbe30986a9bc8b0d::coin_decimals_registry::CoinDecimalsRegistry, arg11: &0x1478a432123e4b3d61878b629f2c692969fdb375644f1251cd278a4b1e7d7cd6::x_oracle::XOracle, arg12: &0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_config::IncentiveConfig, arg13: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_pool::IncentivePools, arg14: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_account::IncentiveAccounts, arg15: &mut 0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberTable, arg16: &0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberWhitelist, arg17: &0x2::clock::Clock, arg18: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        if (v1 > v3) {
            ...
            if (v6) {
                let v16 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::change_coin_type<T3, T1>(0x2::coin::from_balance<T3>(v12, arg18), arg18);
                ...
                0x2::balance::join<T2>(&mut v13, 0x2::coin::into_balance<T2>(0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::change_coin_type<T0, T2>(0x2::coin::split<T0>(&mut v20, v14, arg18), arg18)));
                ...
                let v21 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::change_coin_type<T2, T1>(0x2::coin::from_balance<T2>(v13, arg18), arg18);
                ...
                0x2::balance::join<T3>(&mut v12, 0x2::coin::into_balance<T3>(0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::change_coin_type<T0, T3>(0x2::coin::split<T0>(&mut v25, v14, arg18), arg18)));
    ...
    public(friend) fun remove_liquidity_internal_end<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: 0x2::coin::Coin<T1>, arg6: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg7: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation_access::ObligationAccessStore, arg8: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg9: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg10: &0xca5a5a62f01c79a104bf4d31669e29daa387f325c241de4edbe30986a9bc8b0d::coin_decimals_registry::CoinDecimalsRegistry, arg11: &0x1478a432123e4b3d61878b629f2c692969fdb375644f1251cd278a4b1e7d7cd6::x_oracle::XOracle, arg12: &0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_config::IncentiveConfig, arg13: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_pool::IncentivePools, arg14: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_account::IncentiveAccounts, arg15: &mut 0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberTable, arg16: &0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca_subscriber::VeScaSubscriberWhitelist, arg17: &0x2::clock::Clock, arg18: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v7 = RemoveLiquidityInternalEndEvent{
            ...
            new_total_lend_share      : arg0.total_lend_share,
            new_total_lend_amount     : 0x2::balance::value<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T1>>(&arg0.scoin_balance),
            new_total_debt_amount     : 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_debt_amount<T1>(arg6),
            new_total_deposit_amount  : 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_collateral_amount<T0>(arg6),
        };
    ...
    fun remove_liquidity_internal_start<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: &mut 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::Position, arg2: u128, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation) : (u64, u64, u64, u64) {
        let (_, v1, v2, v3) = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::info(arg1);
        assert!(v1 >= arg2, 109);
        let v4 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::mul_div(v2, arg2, v1);
        let v5 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::mul_div(v3, arg2, v1);
        let v6 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_collateral_amount<T0>(arg4);
        let v7 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::to_u64(0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::mul_div((v6 as u128), arg2, arg0.total_deposit_share));
        let v8 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::safe_get_debt_amount<T1>(arg4);
        let v9 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::to_u64(0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::mul_div((v8 as u128), v4, arg0.total_debt_share));
        ...
        let v11 = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::to_u64(0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::mul_div((v10 as u128), v5, arg0.total_lend_share));
        0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::decrease_deposit_share(arg1, arg2);
        0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::decrease_debt_share(arg1, v4);
        0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::decrease_lend_share(arg1, v5);
        ...
        (v7, v9, v11, 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::utils::compute_underlying_amount<T1>(arg3, v11))
    }

    public(friend) fun remove_position<T0, T1>(arg0: &Farm<T0, T1>, arg1: 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::Position, arg2: &0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3) = 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::info(&arg1);
        ...
        0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position::destroy(arg1);
    }

    public(friend) fun set_collateral_weight<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: u64) {
        assert!(arg1 <= 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::global_config::max_percent(), 103);
        arg0.collateral_weight = arg1;
    }

    public(friend) fun set_deposit_cap_internal<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: u128, arg2: bool) {
        let v0 = DepositCap{
            cap_share : arg1,
            enabled   : arg2,
        };
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"deposit_cap")) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, DepositCap>(&mut arg0.id, b"deposit_cap") = v0;
        } else {
            0x2::dynamic_field::add<vector<u8>, DepositCap>(&mut arg0.id, b"deposit_cap", v0);
        };
        let v1 = DepositCapUpdatedEvent{
            farm_id   : 0x2::object::id<Farm<T0, T1>>(arg0),
            cap_share : arg1,
            enabled   : arg2,
        };
        0x2::event::emit<DepositCapUpdatedEvent>(v1);
    }

    public(friend) fun shortfall_amount(arg0: u64, arg1: u64) : u64 {
        if (arg0 > arg1) {
            arg0 - arg1
        } else {
            0
