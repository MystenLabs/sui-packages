module 0x1602eb2bb9550742261509b091b16dad3af823df8eed2c7909e311933bcc649b::lx_pool_stake {
    ...
    public entry fun stake_yusd_coin<T0, T1, T2>(arg0: &mut StakingPool<T2>, arg1: &mut PoolInfo<T0>, arg2: &mut 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::implements::Global, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T2>, arg5: 0x1::string::String, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 8);
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(arg6 >= 100000000, 1);
        assert!(is_eco_coin<T2>(arg0, &arg5), 2);
        let v1 = 0x2::coin::value<T0>(&arg3);
        let v2 = calculate_burn_percentage<T2>(arg0, arg7);
        let v3 = 0x2::coin::value<T2>(&arg4);
        assert!(v3 >= 0x1602eb2bb9550742261509b091b16dad3af823df8eed2c7909e311933bcc649b::coin_price::calculate_yswap_amount_out<T1, T2>(arg2, arg6 * v2 / 100), 7);
        let v4 = calculate_power(arg6, false);
        arg0.order_counter = arg0.order_counter + 1;
    ...
    public entry fun stake_yy_coin<T0, T1, T2, T3>(arg0: &mut StakingPool<T0>, arg1: &mut PoolInfo<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T3, T2>, arg3: &mut 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::implements::Global, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T1>, arg6: 0x1::string::String, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 8);
        let v0 = 0x2::tx_context::sender(arg9);
        assert!(arg7 >= 100000000, 1);
        assert!(is_eco_coin<T0>(arg0, &arg6), 2);
        let (_, v2) = 0x1602eb2bb9550742261509b091b16dad3af823df8eed2c7909e311933bcc649b::coin_price::calculate_usdc_to_yy_route<T3, T2, T0>(arg2, arg3, arg7);
        let v3 = 0x2::coin::value<T0>(&arg4);
        assert!(v2 >= v3, 11);
        let v4 = calculate_burn_percentage<T0>(arg0, arg8);
        let v5 = 0x2::coin::value<T1>(&arg5);
        assert!(v5 >= 0x1602eb2bb9550742261509b091b16dad3af823df8eed2c7909e311933bcc649b::coin_price::calculate_yswap_amount_out<T3, T1>(arg3, arg7 * v4 / 100), 7);
        let v6 = calculate_power(arg7, false);
        arg0.order_counter = arg0.order_counter + 1;
