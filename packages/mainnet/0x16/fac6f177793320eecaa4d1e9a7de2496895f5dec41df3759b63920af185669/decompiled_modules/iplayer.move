module 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iplayer {
    ...
    public(friend) fun add_capture_pro_timer(arg0: &mut Player) {
        0x2::vec_map::insert<0x1::string::String, u64>(&mut arg0.timers, 0x1::string::utf8(b"capture_cooldown"), 0);
    }
    ...
    public(friend) fun check_key_exist_accolade(arg0: &Player, arg1: 0x1::string::String) : bool {
        let (v0, _) = 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::get_accolade(0x2::dynamic_field::borrow<0x1::string::String, 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::Accolade>(&arg0.id, 0x1::string::utf8(b"accolade")));
    ...
    public(friend) fun get_claimed_rewards(arg0: &Player) : &0x2::vec_map::VecMap<0x1::string::String, vector<u128>> {
        let (_, v1) = 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::get_accolade(0x2::dynamic_field::borrow<0x1::string::String, 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::Accolade>(&arg0.id, 0x1::string::utf8(b"accolade")));
        v1
    }
    ...
    public(friend) fun has_player_df(arg0: &Player, arg1: 0x1::string::String) : bool {
    ...
    public(friend) fun insert_claimed_rewards(arg0: &mut Player, arg1: 0x1::string::String, arg2: vector<u128>) {
        0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::insert_accolade_claimed_rewards(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::Accolade>(&mut arg0.id, 0x1::string::utf8(b"accolade")), arg1, arg2);
    }

    public(friend) fun push_back_claimed_rewards(arg0: &mut Player, arg1: 0x1::string::String, arg2: u128) {
        0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::push_back_accolade_claimed_rewards(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::Accolade>(&mut arg0.id, 0x1::string::utf8(b"accolade")), arg1, arg2);
    }
    ...
    public(friend) fun update_accolade_value(arg0: &mut Player, arg1: 0x1::string::String, arg2: u128, arg3: u8) {
        if (arg3 == 0) {
            0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::update_accolade_data(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::Accolade>(&mut arg0.id, 0x1::string::utf8(b"accolade")), arg1, arg2);
        } else {
            0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::insert_accolade_data(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::Accolade>(&mut arg0.id, 0x1::string::utf8(b"accolade")), arg1, arg2);
        };
    }

    public(friend) fun update_player_stats(arg0: &mut Player, arg1: 0x1::string::String, arg2: u128) {
        let (v0, _) = 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::get_accolade(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::Accolade>(&mut arg0.id, 0x1::string::utf8(b"accolade")));
