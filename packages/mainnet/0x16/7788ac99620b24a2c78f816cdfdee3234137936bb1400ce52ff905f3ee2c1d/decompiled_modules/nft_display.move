module 0x167788ac99620b24a2c78f816cdfdee3234137936bb1400ce52ff905f3ee2c1d::nft_display {
    ...
    fun init(arg0: NFT_DISPLAY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<0x167788ac99620b24a2c78f816cdfdee3234137936bb1400ce52ff905f3ee2c1d::anniversary_vault::Today365>(&v0, v1, v3, arg1);
        0x2::display::update_version<0x167788ac99620b24a2c78f816cdfdee3234137936bb1400ce52ff905f3ee2c1d::anniversary_vault::Today365>(&mut v5);
        0x2::transfer::public_share_object<0x2::display::Display<0x167788ac99620b24a2c78f816cdfdee3234137936bb1400ce52ff905f3ee2c1d::anniversary_vault::Today365>>(v5);
        ...
        let v10 = 0x2::display::new_with_fields<0x167788ac99620b24a2c78f816cdfdee3234137936bb1400ce52ff905f3ee2c1d::nostalgia_ticket::NostalgiaTicket>(&v0, v6, v8, arg1);
        0x2::display::update_version<0x167788ac99620b24a2c78f816cdfdee3234137936bb1400ce52ff905f3ee2c1d::nostalgia_ticket::NostalgiaTicket>(&mut v10);
        0x2::transfer::public_share_object<0x2::display::Display<0x167788ac99620b24a2c78f816cdfdee3234137936bb1400ce52ff905f3ee2c1d::nostalgia_ticket::NostalgiaTicket>>(v10);
