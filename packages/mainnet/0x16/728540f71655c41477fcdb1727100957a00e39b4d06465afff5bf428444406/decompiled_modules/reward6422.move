module 0x16728540f71655c41477fcdb1727100957a00e39b4d06465afff5bf428444406::reward6422 {
    struct REWARD6422 has drop {
        dummy_field: bool,
    }

    struct TICKET_6422 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6422(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6422>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6422>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6422, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6422>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6422>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6422>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6422>>(v5, 0x2::tx_context::sender(arg1));
    }
