module 0x16947c61aa436851e3682fa213fdcd152839cbf254a0a18ca03c1e42124bee58::cnsnft2383 {
    struct CNSNFT2383 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2383, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2383>(arg0, arg1);
