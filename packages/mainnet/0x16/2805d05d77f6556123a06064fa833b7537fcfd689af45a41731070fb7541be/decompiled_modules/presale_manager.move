module 0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::presale_manager {
    ...
    public entry fun init_contract_v2(arg0: &PresaleOwnerCap, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<UpgradeMap>(v0);
    }
    ...
    public fun join_chest(arg0: &mut UpgradeMap, arg1: u128, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: &0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::signature_verifier::PubKey, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 > 0, 4);
        assert!(0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::signature_verifier::verify_signature(arg5, arg1, arg2, arg3, arg4) == true, 3);
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(0x2::table::contains<address, u128>(&arg0.table, v0), 5);
        let v1 = 0x2::table::borrow_mut<address, u128>(&mut arg0.table, v0);
        assert!(*v1 == arg1, 4);
        *v1 = 0;
        0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::mint_to(v0, arg2, arg3, arg1, arg6);
    }
    ...
    public entry fun mint_by_admin(arg0: &PresaleOwnerCap, arg1: &mut Presale, arg2: u128, arg3: vector<u8>, arg4: vector<u8>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::mint_to(arg5, arg3, arg4, arg2, arg6);
    }

    public fun mint_from_migration(arg0: &mut Presale, arg1: &mut MigrationMap, arg2: u128, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: &0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::signature_verifier::PubKey, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 4);
        assert!(0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::signature_verifier::verify_signature(arg6, arg2, arg3, arg4, arg5) == true, 3);
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(0x2::table::contains<address, u128>(&arg1.table, v0), 5);
        let v1 = 0x2::table::borrow_mut<address, u128>(&mut arg1.table, v0);
        assert!(*v1 == arg2, 4);
        *v1 = 0;
        0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::mint_to(v0, arg3, arg4, arg2, arg7);
    }

    public entry fun mint_with_sui(arg0: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg1: &mut Presale, arg2: &mut ReferralMap, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: &0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::signature_verifier::PubKey, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::signature_verifier::verify_signature(arg9, (arg5 as u128), arg6, arg7, arg8) == true, 3);
        ...
        0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::mint_to(0x2::tx_context::sender(arg10), arg6, arg7, v0, arg10);
    }

    public entry fun mint_with_usdc(arg0: &mut Presale, arg1: &mut ReferralMap, arg2: 0x1::option::Option<address>, arg3: &mut 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: u64, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: &0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::signature_verifier::PubKey, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::signature_verifier::verify_signature(arg8, (arg4 as u128), arg5, arg6, arg7) == true, 3);
        ...
        0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::mint_to(0x2::tx_context::sender(arg9), arg5, arg6, v0, arg9);
    }

    public fun request_burn_chest(arg0: &mut UpgradeMap, arg1: 0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::AllocationNFT, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        if (!0x2::table::contains<address, u128>(&arg0.table, v0)) {
            0x2::table::add<address, u128>(&mut arg0.table, v0, 0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::invested_amount_of(&arg1));
        } else {
            let v1 = 0x2::table::borrow_mut<address, u128>(&mut arg0.table, v0);
            *v1 = *v1 + 0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::invested_amount_of(&arg1);
        };
        0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::burn(arg1, arg2);
    }
    ...
    public fun summon(arg0: &mut vector<0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::AllocationNFT>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::signature_verifier::PubKey, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        while (!0x1::vector::is_empty<0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::AllocationNFT>(arg0)) {
            let v1 = 0x1::vector::pop_back<0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::AllocationNFT>(arg0);
            v0 = v0 + 0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::invested_amount_of(&v1);
            0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::burn(v1, arg5);
        };
        assert!(0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::signature_verifier::verify_signature(arg4, v0, arg1, arg2, arg3) == true, 3);
        0x8fba96f09a1d5d9387f448c64a6f92fa561af5bf29e38153903e6c37a5ce2358::collection::mint_to(0x2::tx_context::sender(arg5), arg1, arg2, v0, arg5);
    }
