module 0xd971609b7feb6230585831e7aeb3c121fb21b9431337a30fc99185eb459a05ee::borrow_referral {
    ...
    public fun borrowed<T0, T1>(arg0: &BorrowReferral<T0, T1>) : u64 {
        ...
        *0x2::dynamic_field::borrow<BorrowedKey, u64>(&arg0.id, v0)
    }
    ...
    public fun destroy_borrow_referral<T0, T1: drop>(arg0: T1, arg1: BorrowReferral<T0, T1>) : 0x2::balance::Balance<T0> {
        ...
        let v1 = BorrowedKey{dummy_field: false};
        0x2::dynamic_field::remove<BorrowedKey, u64>(&mut arg1.id, v1);
        let BorrowReferral {
            id                  : v2,
        ...
        if (0x2::balance::value<T0>(&v8) > 0 || v5 > 0) {
            abort 0
        };
    ...
    public fun remove_referral_cfg<T0, T1: drop, T2: drop + store>(arg0: &mut BorrowReferral<T0, T1>) {
        let v0 = BorrowReferralCfgKey<T2>{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<BorrowReferralCfgKey<T2>>(&arg0.id, v0) == true, 715);
        let v1 = BorrowReferralCfgKey<T2>{dummy_field: false};
        0x2::dynamic_field::remove<BorrowReferralCfgKey<T2>, T2>(&mut arg0.id, v1);
    }
