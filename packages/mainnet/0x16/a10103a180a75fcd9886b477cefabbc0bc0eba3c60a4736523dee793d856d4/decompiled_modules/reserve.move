module 0xd971609b7feb6230585831e7aeb3c121fb21b9431337a30fc99185eb459a05ee::reserve {
    ...
    fun borrow_flash_loan_internal<T0>(arg0: &mut Reserve, arg1: u64, arg2: u64, arg3: u64) : (0x2::balance::Balance<T0>, FlashLoan<T0>) {
        assert!(arg3 > 0, 0xd971609b7feb6230585831e7aeb3c121fb21b9431337a30fc99185eb459a05ee::error::invalid_flash_loan_fee_discount_error());
        assert!(arg2 <= arg3, 0xd971609b7feb6230585831e7aeb3c121fb21b9431337a30fc99185eb459a05ee::error::invalid_flash_loan_fee_discount_error());
        ...
        let v1 = if (v0 > 0) {
            0xad013d5fde39e15eabda32b3dbdafd67dac32b798ce63237c27a8f73339b9b6f::u64::mul_div(arg1, v0, 10000) + 1
        } else {
            0
        };
    ...
    public fun flash_loan_fee_denominator() : u64 {
        10000
    }
    ...
    public(friend) fun handle_borrow<T0>(arg0: &mut Reserve, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!(v1.cash >= arg1, 0xd971609b7feb6230585831e7aeb3c121fb21b9431337a30fc99185eb459a05ee::error::reserve_not_enough_error());
        v1.cash = v1.cash - arg1;
        v1.debt = v1.debt + arg1;
        assert!(v1.cash >= v1.revenue, 0xd971609b7feb6230585831e7aeb3c121fb21b9431337a30fc99185eb459a05ee::error::pool_liquidity_not_enough_error());
    ...
    public(friend) fun handle_revenue<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<T0>) {
        let v0 = BalanceSheets{dummy_field: false};
        let v1 = 0x779b5c547976899f5474f3a5bc0db36ddf4697ad7e5a901db0415c2281d28162::wit_table::borrow_mut<BalanceSheets, 0x1::type_name::TypeName, BalanceSheet>(v0, &mut arg0.balance_sheets, 0x1::type_name::get<T0>());
        v1.cash = v1.cash + 0x2::balance::value<T0>(&arg1);
        v1.revenue = v1.revenue + 0x2::balance::value<T0>(&arg1);
        0x779b5c547976899f5474f3a5bc0db36ddf4697ad7e5a901db0415c2281d28162::balance_bag::join<T0>(&mut arg0.underlying_balances, arg1);
    }
    ...
    public(friend) fun init_market_coin_price_table(arg0: &mut Reserve, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_with_type<MarketCoinPriceTableKey, 0x2::table::Table<0x1::type_name::TypeName, 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::Decimal>>(&arg0.id, v0)) {
            return
        };
        let v1 = MarketCoinPriceTableKey{dummy_field: false};
        0x2::dynamic_field::add<MarketCoinPriceTableKey, 0x2::table::Table<0x1::type_name::TypeName, 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::Decimal>>(&mut arg0.id, v1, 0x2::table::new<0x1::type_name::TypeName, 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::Decimal>(arg1));
    }
    ...
    public(friend) fun mint_market_coin<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<T0>) : 0x2::balance::Balance<MarketCoin<T0>> {
        ...
        let v2 = 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::floor(0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::div(0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::from(v0), v1));
        assert!(v2 > 0, 0xd971609b7feb6230585831e7aeb3c121fb21b9431337a30fc99185eb459a05ee::error::mint_market_coin_too_small_error());
    ...
    public(friend) fun redeem_underlying_coin<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<MarketCoin<T0>>) : 0x2::balance::Balance<T0> {
        ...
        let v1 = update_and_get_market_coin_price(arg0, 0x1::type_name::get<T0>());
        let v2 = 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::floor(0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::mul(0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::from(v0), v1));
        assert!(v2 > 0, 0xd971609b7feb6230585831e7aeb3c121fb21b9431337a30fc99185eb459a05ee::error::redeem_market_coin_too_small_error());
        let v3 = BalanceSheets{dummy_field: false};
        let v4 = 0x779b5c547976899f5474f3a5bc0db36ddf4697ad7e5a901db0415c2281d28162::wit_table::borrow_mut<BalanceSheets, 0x1::type_name::TypeName, BalanceSheet>(v3, &mut arg0.balance_sheets, 0x1::type_name::get<T0>());
        assert!(v4.cash >= v2, 0xd971609b7feb6230585831e7aeb3c121fb21b9431337a30fc99185eb459a05ee::error::reserve_not_enough_error());
        v4.cash = v4.cash - v2;
        v4.market_coin_supply = v4.market_coin_supply - v0;
        assert!(v4.cash >= v4.revenue, 0xd971609b7feb6230585831e7aeb3c121fb21b9431337a30fc99185eb459a05ee::error::pool_liquidity_not_enough_error());
    ...
    public(friend) fun repay_flash_loan<T0>(arg0: &mut Reserve, arg1: 0x2::coin::Coin<T0>, arg2: FlashLoan<T0>) {
        ...
        assert!(v2 >= v0 + v1, 0xd971609b7feb6230585831e7aeb3c121fb21b9431337a30fc99185eb459a05ee::error::flash_loan_repay_not_enough_error());
        let v3 = v2 - v0;
    ...
    fun update_and_get_market_coin_price(arg0: &mut Reserve, arg1: 0x1::type_name::TypeName) : 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::Decimal {
        let v0 = MarketCoinPriceTableKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<MarketCoinPriceTableKey, 0x2::table::Table<0x1::type_name::TypeName, 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::Decimal>>(&mut arg0.id, v0);
        if (0x2::table::contains<0x1::type_name::TypeName, 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::Decimal>(v1, arg1) == false) {
            0x2::table::add<0x1::type_name::TypeName, 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::Decimal>(v1, arg1, 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::from(1));
        };
        let v2 = 0x2::table::borrow_mut<0x1::type_name::TypeName, 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::Decimal>(v1, arg1);
        let v3 = BalanceSheets{dummy_field: false};
        ...
        let v5 = if (v4.market_coin_supply > 0) {
            let v6 = 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::div(0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::from(v4.cash + v4.debt - v4.revenue), 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::from(v4.market_coin_supply));
            assert!(0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::ge(v6, *v2), 0xd971609b7feb6230585831e7aeb3c121fb21b9431337a30fc99185eb459a05ee::error::market_coin_price_cannot_decrease_error());
            v6
        } else {
            0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::from(1)
        };
        *v2 = v5;
        v5
    }
