module 0x16f5ac72bd3482c5f5a768b7bbc85a0f54d76cb48dc529133e75770fa1da9c4d::reward2955 {
    struct REWARD2955 has drop {
        dummy_field: bool,
    }

    struct TICKET_2955 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2955(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2955>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2955>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2955, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2955>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2955>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2955>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2955>>(v5, 0x2::tx_context::sender(arg1));
    }
