module 0x16ba824675de785b7c5adc84a82a55b0d6ed3eb603284673d9367bfe550d11bd::reward9206 {
    struct REWARD9206 has drop {
        dummy_field: bool,
    }

    struct TICKET_9206 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9206(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9206>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9206>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9206, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9206>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9206>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9206>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9206>>(v5, 0x2::tx_context::sender(arg1));
    }
