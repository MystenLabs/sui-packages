module 0x16e4a7173fc2006fa60ec0a1836dfeedfdc9fe4c0a1e9f9489ed4a851356537b::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"VT565462", b"ValidToken 565462", b"This should succeed", 0x1::option::none<0x2::url::Url>(), arg1);
