module 0x1676645082414625193af8bdfa6a73dd2209d143cd964851a3c89f50ef4157d1::splash {
    struct SPLASH has drop {
        dummy_field: bool,
    }

    fun init(arg0: SPLASH, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SPLASH>(arg0, 6, b"Splash", b"SplashCat", b"SplashCat is the cutest Cat in Crypto, ready to explode on the Sui Network. Just a beautiful cat Rocking the SUI Chain having fun, Surrounded by friends and poised to create a community that will last.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/splashcatred_5042605c99.jpg")), arg1);
