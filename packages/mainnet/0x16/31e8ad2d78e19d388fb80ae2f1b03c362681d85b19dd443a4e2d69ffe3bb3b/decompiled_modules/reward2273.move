module 0x1631e8ad2d78e19d388fb80ae2f1b03c362681d85b19dd443a4e2d69ffe3bb3b::reward2273 {
    struct REWARD2273 has drop {
        dummy_field: bool,
    }

    struct TICKET_2273 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2273(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2273>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2273>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2273, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2273>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2273>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2273>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2273>>(v5, 0x2::tx_context::sender(arg1));
    }
