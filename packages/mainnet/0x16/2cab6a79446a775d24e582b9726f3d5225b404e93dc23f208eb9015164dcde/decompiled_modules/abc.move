module 0x162cab6a79446a775d24e582b9726f3d5225b404e93dc23f208eb9015164dcde::abc {
    struct ABC has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ABC, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ABC>(arg0, 5, b"ABC", b"XXXXXXXX", b"description containing multiple words and special characters!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.ibb.co/SXytMt5b/panda.jpg")), arg1);
        let v2 = v0;
