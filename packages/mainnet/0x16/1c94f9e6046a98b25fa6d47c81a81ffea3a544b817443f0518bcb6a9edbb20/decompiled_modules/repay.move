module 0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::repay {
    ...
    struct RepayRegistry has key {
        id: 0x2::object::UID,
        treasury_cap: 0x2::coin::TreasuryCap<0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::neom::NEOM>,
    ...
    public fun add_balance<T0: drop>(arg0: &0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::Version, arg1: &mut RepayRegistry, arg2: 0x2::coin::Coin<T0>, arg3: &AdminCap, arg4: &mut 0x2::tx_context::TxContext) {
        0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::assert_current_version(arg0);
    ...
    public fun batch_add_claims<T0: drop>(arg0: &0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::Version, arg1: &mut RepayRegistry, arg2: &AdminCap, arg3: vector<address>, arg4: vector<u64>, arg5: u64, arg6: &0x2::tx_context::TxContext) {
        0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::assert_current_version(arg0);
        ...
        if (v0 == 0x1::type_name::get<0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::neom::NEOM>()) {
    ...
    public fun claim_neom(arg0: &0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::Version, arg1: &mut RepayRegistry, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::neom::NEOM> {
        0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::assert_current_version(arg0);
        assert!(arg1.is_claim_started, 4115);
        let v0 = 0x1::type_name::get<0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::neom::NEOM>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, ClaimsTable>(&arg1.claims_by_token, v0), 4099);
        ...
        0x2::coin::mint<0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::neom::NEOM>(&mut arg1.treasury_cap, v3, arg2)
    }

    public fun claim_yield_tokens<T0: drop>(arg0: &0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::Version, arg1: &mut RepayRegistry, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::assert_current_version(arg0);
        assert!(arg1.is_claim_started, 4115);
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, ClaimsTable>(&arg1.claims_by_token, v0), 4099);
    ...
    public fun init_registry(arg0: 0x2::coin::TreasuryCap<0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::neom::NEOM>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::total_supply<0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::neom::NEOM>(&arg0) == 0, 4112);
        ...
        0x2::table::add<0x1::type_name::TypeName, ClaimsTable>(&mut v0.claims_by_token, 0x1::type_name::get<0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::neom::NEOM>(), v1);
    ...
    public fun register_token_type<T0: drop>(arg0: &0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::Version, arg1: &mut RepayRegistry, arg2: &AdminCap, arg3: &mut 0x2::tx_context::TxContext) {
        0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::assert_current_version(arg0);
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun remove_claim<T0: drop>(arg0: &0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::Version, arg1: &mut RepayRegistry, arg2: &AdminCap, arg3: address, arg4: &0x2::tx_context::TxContext) {
        0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::assert_current_version(arg0);
        assert!(!arg1.is_claim_started, 4116);
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, ClaimsTable>(&arg1.claims_by_token, v0), 4099);
    ...
    public fun set_claim<T0: drop>(arg0: &0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::Version, arg1: &mut RepayRegistry, arg2: &AdminCap, arg3: address, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::assert_current_version(arg0);
        assert!(arg4 > 0, 4104);
        assert!(!arg1.is_claim_started, 4116);
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun skim_excess_yield_tokens<T0: drop>(arg0: &0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::Version, arg1: &mut RepayRegistry, arg2: u64, arg3: &AdminCap, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::assert_current_version(arg0);
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.balances, 0x1::type_name::get<T0>()), arg2), arg4)
    }

    public fun start_claim(arg0: &0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::Version, arg1: &mut RepayRegistry, arg2: &AdminCap, arg3: &mut 0x2::tx_context::TxContext) {
        0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::assert_current_version(arg0);
        assert!(!arg1.is_claim_started, 4116);
    ...
    public fun stop_claim(arg0: &0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::Version, arg1: &mut RepayRegistry, arg2: &AdminCap, arg3: &mut 0x2::tx_context::TxContext) {
        0x575d6dfb7994eadbc3a02195b04b15b495edfd1ada9162ec7de512ac6235e4d4::version::assert_current_version(arg0);
        assert!(arg1.is_claim_started, 4115);
