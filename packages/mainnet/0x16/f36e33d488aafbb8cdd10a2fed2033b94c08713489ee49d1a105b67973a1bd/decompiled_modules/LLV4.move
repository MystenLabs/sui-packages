module 0x16f36e33d488aafbb8cdd10a2fed2033b94c08713489ee49d1a105b67973a1bd::LLV4 {
    ...
    public entry fun new_lotus_pool<T0, T1>(arg0: &CreatePoolLock, arg1: &mut Factory, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: address, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: address, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v2 * 30 / 100;
        assert!(v4 > 0, 21);
        let v5 = 0x2::coin::split<T1>(&mut v1, v3, arg17);
        assert!(0x2::coin::value<T1>(&v5) == arg8 * arg9, 23);
        let v6 = 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, arg3, arg17));
        let v7 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v1, v4, arg17));
        create_lotus_pool<T0, T1>(arg1, v6, 0x2::coin::into_balance<T1>(v5), v7, 0x2::coin::into_balance<T1>(v1), arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17);
    ...
    public entry fun set_pool_buyback_closed<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg1.launch_manager, 4);
        let v0 = get_timestamp(arg2);
        let v1 = v0 + 86400000;
        arg0.buyback_open = false;
        arg0.close_deadline = 0x1::option::some<u64>(v1);
        let v2 = BuybackClosed{
            pool_id        : 0x2::object::id<Pool<T0, T1>>(arg0),
            blocks_sold    : arg0.blocks_sold,
            close_deadline : v1,
            timestamp      : v0,
        };
        0x2::event::emit<BuybackClosed>(v2);
    }

    public entry fun set_pool_closed<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg1.launch_manager, 4);
    ...
    public entry fun set_pool_sold_out<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg1.launch_manager, 4);
        arg0.sold_out = arg2;
        let v0 = PoolSoldOut{
            pool_id     : 0x2::object::id<Pool<T0, T1>>(arg0),
    ...
    public fun trade_a_for_b<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        ...
        let v4 = arg0.block_price;
        let (v5, v6) = compute_total_input(arg0.block_price, arg1.trade_fee);
        assert!(0x2::balance::value<T0>(&arg2) == v6, 19);
        assert!(0x2::balance::value<T1>(&arg0.balance_b) >= arg0.block_quantity, 20);
        0x2::balance::join<T0>(&mut arg0.balance_a, arg2);
        0x2::balance::join<T0>(&mut arg0.trade_balance_a, 0x2::balance::split<T0>(&mut arg2, v5));
        distribute_trade_fee<T0, T1>(arg0, arg1, v1, arg4);
        let v7 = arg0.block_quantity;
        ...
        if (arg0.blocks_sold == arg0.buyback_limit && arg0.buyback_open) {
            arg0.buyback_open = false;
            arg0.close_deadline = 0x1::option::some<u64>(v8);
            v2 = true;
            let v9 = BuybackClosed{
                pool_id        : 0x2::object::id<Pool<T0, T1>>(arg0),
                blocks_sold    : arg0.blocks_sold,
                close_deadline : v8,
                timestamp      : v1,
            };
            0x2::event::emit<BuybackClosed>(v9);
        };
        let v10 = 0x1::option::none<u64>();
        if (v2) {
            v10 = 0x1::option::some<u64>(v8);
        };
        if (arg0.blocks_sold == arg0.max_blocks && !arg0.sold_out) {
            ...
            0x2::event::emit<PoolSoldOut>(v11);
        };
        let v12 = Trade{
            pool_id        : 0x2::object::id<Pool<T0, T1>>(arg0),
            wallet         : v0,
        ...
        0x2::balance::split<T1>(&mut arg0.balance_b, v7)
    }
