module 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool {
    ...
    public(friend) fun charge_pool_loss_budget<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: u128, arg3: u64) {
        ...
        charge_pool_loss_budget_with_total_assets<T0, T1>(arg0, arg1, arg2, arg3, v0);
    }

    fun charge_pool_loss_budget_with_total_assets<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: u128, arg3: u64, arg4: u128) {
        ensure_socialized_loss_limit<T0, T1>(arg0, arg4);
        if (arg2 == 0) {
            return
        };
        charge_protocol_loss_budget<T0, T1>(arg0, arg1, arg2, arg3);
    ...
    fun charge_protocol_loss_budget<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: u128, arg3: u64) {
        let v0 = get_socialized_loss_limit_bps<T0, T1>(arg0);
        let v1 = if (v0 == 0) {
            0
        } else {
            0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_math::mul_div_ceil(get_protocol_balance<T0, T1>(arg0, arg1), (v0 as u128), (10000 as u128))
        };
    ...
    public(friend) fun charge_rebalance_loss_budget<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: u128, arg3: u64, arg4: u128) {
        let v0 = get_total_assets<T0, T1>(arg0) + arg4;
        charge_pool_loss_budget_with_total_assets<T0, T1>(arg0, arg1, arg2, arg3, v0);
    }
    ...
    public fun effective_user_withdraw_loss_bps<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8, arg2: u64) : u64 {
        min_u64(arg2, withdraw_settlement_loss_ceiling_bps<T0, T1>(arg0, arg1))
    }
    ...
    fun socialized_settlement_loss_ceiling_bps<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8) : u64 {
        ...
        if (arg1 == 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_CETUS_CLMM()) {
            let v1 = get_protocol_config<T0, T1>(arg0, arg1);
            min_u64(get_socialized_loss_limit_bps<T0, T1>(arg0), 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_cetus_clmm_params::max_accounted_value_gap_bps(0x1::option::destroy_some<u64>(config_get_value(&v1, 0)), 0x1::option::destroy_some<u64>(config_get_value(&v1, 1)), 0x1::option::destroy_some<u64>(config_get_value(&v1, 2))))
        } else {
    ...
    fun withdraw_settlement_loss_ceiling_bps<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8) : u64 {
        if (!0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::is_known_protocol(arg1) || 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::is_idle_protocol(arg1)) {
            return 0
        };
        if (arg1 == 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_CETUS_CLMM()) {
            let v1 = get_protocol_config<T0, T1>(arg0, arg1);
            min_u64(10, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_cetus_clmm_params::max_accounted_value_gap_bps(0x1::option::destroy_some<u64>(config_get_value(&v1, 0)), 0x1::option::destroy_some<u64>(config_get_value(&v1, 1)), 0x1::option::destroy_some<u64>(config_get_value(&v1, 2))))
        } else {
            10
        }
    }
