module 0x1679b610b25e0f2ef1320bce7de716204881a2805a4c44142abb6fff755fcea9::blockblock {
    ...
    struct FormerPresidentWitness has drop {
        term: u64,
        member_address: address,
    }
    ...
    public(friend) fun borrow_marketing_team(arg0: &BlockBlockClub) : &vector<address> {
        &arg0.marketing_team
    }
    ...
    public(friend) fun borrow_planning_team(arg0: &BlockBlockClub) : &vector<address> {
        &arg0.planning_team
    }

    public(friend) fun borrow_project_leaders(arg0: &BlockBlockClub) : &vector<address> {
        &arg0.project_leaders
    }
    ...
    public fun create_former_president_witness(arg0: &BlockBlockYonsei, arg1: &BlockBlockRegistry, arg2: &BlockBlockClub, arg3: &0x2::tx_context::TxContext) : FormerPresidentWitness {
        assert!(arg1.blockblock_ys == 0x2::object::uid_to_inner(&arg0.id), 0);
        assert!(arg2.is_active == false, 10);
        assert!(arg2.president == 0x2::tx_context::sender(arg3), 3);
        FormerPresidentWitness{
            term           : arg2.term,
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = create_blockblockclub(&v1, 0, v2, arg0);
        v3.is_active = false;
        let v4 = 0x2::tx_context::sender(arg0);
        let v5 = create_blockblockclub(&v1, 0, v4, arg0);
        let v6 = BlockBlockRegistry{
            id                : 0x2::object::new(arg0),
            blockblock_ys     : 0x2::object::uid_to_inner(&v1.id),
            current_term      : 0,
            current_club      : 0x2::object::uid_to_inner(&v5.id),
            previous_term     : 0,
            previous_club     : 0x2::object::uid_to_inner(&v3.id),
            current_president : 0x2::tx_context::sender(arg0),
        };
        0x2::transfer::share_object<BlockBlockYonsei>(v1);
        0x2::transfer::share_object<BlockBlockClub>(v5);
        0x2::transfer::share_object<BlockBlockClub>(v3);
        0x2::transfer::share_object<BlockBlockRegistry>(v6);
    }
    ...
    public(friend) fun previous_club(arg0: &BlockBlockRegistry) : 0x2::object::ID {
        arg0.previous_club
    }

    public(friend) fun previous_term(arg0: &BlockBlockRegistry) : u64 {
        arg0.previous_term
    }
    ...
    public fun register_marketing_team_member(arg0: PresidentWitness, arg1: &mut BlockBlockClub, arg2: address) {
        ...
        assert!(v0, 4);
        assert!(!0x1::vector::contains<address>(&arg1.planning_team, &arg2) && !0x1::vector::contains<address>(&arg1.marketing_team, &arg2), 13906835063401611263);
    ...
    public fun register_planning_team_member(arg0: PresidentWitness, arg1: &mut BlockBlockClub, arg2: address) {
        ...
        assert!(v0, 4);
        assert!(!0x1::vector::contains<address>(&arg1.planning_team, &arg2) && !0x1::vector::contains<address>(&arg1.marketing_team, &arg2), 13906835003272069119);
