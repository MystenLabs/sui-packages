module 0x1671773c1fe715a5af39131ffa0ae44a4168247278162df547732fccd23da815::nft {
    ...
    fun isWhitelist<T0>(arg0: &mut Phaser<T0>, arg1: u64, arg2: vector<vector<u8>>, arg3: &mut 0x2::tx_context::TxContext) : bool {
        ...
        0x1671773c1fe715a5af39131ffa0ae44a4168247278162df547732fccd23da815::merkle_proof::verify(&arg2, arg0.whitelist_merkle_root, 0x1::hash::sha2_256(0x2::bcs::to_bytes<Ticket>(&v0)))
    }
