module 0x16b5d15f4e4a5f6f5f60ee4c438c2eee284353150f66a13c1430ca9386ec8829::pyth_adaptor {
    fun assert_price_conf_within_range(arg0: u64, arg1: u64, arg2: u64) {
        let v0 = 10000;
        assert!(((((arg1 * v0 * 100) as u128) / (arg0 as u128)) as u64) <= arg2 * v0 * 100 / 0x16b5d15f4e4a5f6f5f60ee4c438c2eee284353150f66a13c1430ca9386ec8829::pyth_registry::conf_tolerance_denominator(), 70297);
    }
    ...
    public(friend) fun get_pyth_price(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x16b5d15f4e4a5f6f5f60ee4c438c2eee284353150f66a13c1430ca9386ec8829::pyth_registry::PythFeedData, arg3: &0x2::clock::Clock) : (u64, u64, u8, u64) {
        ...
        assert_price_conf_within_range(v2, v3, 0x16b5d15f4e4a5f6f5f60ee4c438c2eee284353150f66a13c1430ca9386ec8829::pyth_registry::price_conf_tolerance(arg2));
