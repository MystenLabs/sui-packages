module 0x16af2ff86a93b3b337cb2d972124d215fe0b25f1f821456799804d7774a1e3a2::gift4869 {
    struct GIFT4869 has drop {
        dummy_field: bool,
    }

    struct TICKET_4869 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4869(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4869>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4869>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4869, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4869>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4869>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4869>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4869>>(v5, 0x2::tx_context::sender(arg1));
    }
