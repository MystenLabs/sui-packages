module 0x16449e257729a52e125d5245e82de65468d0bf9c6e580d5c74733079b7b4839d::register {
    ...
    public fun add_minter_whitelist(arg0: &mut Register, arg1: address, arg2: &mut 0x16449e257729a52e125d5245e82de65468d0bf9c6e580d5c74733079b7b4839d::caps::AdminCap, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun remove_minter_whitelist(arg0: &mut Register, arg1: address, arg2: &mut 0x16449e257729a52e125d5245e82de65468d0bf9c6e580d5c74733079b7b4839d::caps::AdminCap, arg3: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x1::vector::index_of<address>(&arg0.minter_whitelist, &arg1);
        assert!(v0, 2);
        0x1::vector::remove<address>(&mut arg0.minter_whitelist, v1);
    }

    public fun whitelist(arg0: &mut Register, arg1: &mut 0x16449e257729a52e125d5245e82de65468d0bf9c6e580d5c74733079b7b4839d::caps::AdminCap, arg2: &mut 0x2::tx_context::TxContext) : vector<address> {
