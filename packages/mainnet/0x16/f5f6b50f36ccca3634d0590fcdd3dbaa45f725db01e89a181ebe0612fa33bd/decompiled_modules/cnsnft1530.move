module 0x16f5f6b50f36ccca3634d0590fcdd3dbaa45f725db01e89a181ebe0612fa33bd::cnsnft1530 {
    struct CNSNFT1530 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1530, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1530>(arg0, arg1);
