module 0x1697fade94a5d2ec0fb28c75f0eb5d0c9d1da2178c23528bf1131e8663dbe04a::reward7928 {
    struct REWARD7928 has drop {
        dummy_field: bool,
    }

    struct TICKET_7928 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7928(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7928>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7928>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7928, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7928>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7928>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7928>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7928>>(v5, 0x2::tx_context::sender(arg1));
    }
