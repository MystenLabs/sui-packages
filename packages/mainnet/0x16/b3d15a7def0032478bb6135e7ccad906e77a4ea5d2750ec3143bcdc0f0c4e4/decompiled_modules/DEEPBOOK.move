module 0x16b3d15a7def0032478bb6135e7ccad906e77a4ea5d2750ec3143bcdc0f0c4e4::DEEPBOOK {
    ...
    public entry fun GiveRewardTicket(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = DEEPBOOK_TICKET{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/deepbook/deepbook_0708/deepbook_0708_0.jpg"),
    ...
    fun init(arg0: DEEPBOOK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/deepbook/deepbook_0708/deepbook_0708_0.jpg"));
