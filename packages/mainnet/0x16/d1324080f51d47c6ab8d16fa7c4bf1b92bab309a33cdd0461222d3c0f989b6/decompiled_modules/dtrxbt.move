module 0x16d1324080f51d47c6ab8d16fa7c4bf1b92bab309a33cdd0461222d3c0f989b6::dtrxbt {
    ...
    fun init(arg0: DTRXBT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/base/0x84a9aae8fcc085dbe11524f570716d89b772f430.png?size=lg&key=9acee3                                                                                                                                                                                                                ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DTRXBT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DTRXBT  ")))), trim_right(b"DTRXBT by Virtuals              "), trim_right(b"AI Alpha insights & exclusive opportunities from DTR.                                                                                                                                                                                                                                                                           "), v2, arg1);
        let v5 = v3;
