module 0x164428fc8f560e954d8cb4b6d49e11e1c43621f847cafab506c7e527bd4d719f::pyro_legends_ {
    struct PYRO_LEGENDS_ has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"aa027083-8168-4ee2-a077-909975f8e2da"),
        };
    ...
    fun init(arg0: PYRO_LEGENDS_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PYRO_LEGENDS_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Pyro Legends "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Pyro Legends: Fire-wielding warriors forged in flames, embodying power, resilience, and legend."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://Qmb1HELxmgac9ZTEJUyCQXGXkaJvBELTdn53GjXEBmEgG7"));
