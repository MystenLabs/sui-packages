module 0x16f41fd874bd7afe9fb22dcc0b9bf48998ee48ba612bbf052b19809d8efcc8d7::dbke {
    ...
    public fun ef(arg0: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(arg0);
        if (v0 < arg2) {
            0x2::coin::join<0x2::sui::SUI>(arg0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::withdraw<0x2::sui::SUI>(arg1, arg2 * 2 - v0, arg3));
        };
    }
    ...
    public fun elf<T0, T1, T2>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2::clock::Clock, arg4: &mut 0x7e5c9a5a5e505816e99df9ab6a076e8a3f23ddf0c3dab7c3666bbdc66a60e2d8::sq::SQR, arg5: u64, arg6: bool, arg7: u64, arg8: u64, arg9: vector<u64>, arg10: vector<u64>, arg11: vector<u64>, arg12: vector<u64>, arg13: vector<u64>, arg14: vector<u64>, arg15: vector<u64>, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 != 0x16f41fd874bd7afe9fb22dcc0b9bf48998ee48ba612bbf052b19809d8efcc8d7::ct::e_no_error()) {
            let v1 = EE{
                e : v0,
                l : 699,
            };
    ...
    fun emo<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<u64>, arg10: vector<u64>, arg11: vector<u64>, arg12: u64, arg13: u64, arg14: u64, arg15: &0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        while (v11 < 0x1::vector::length<u64>(&arg7)) {
            ...
            if (v13 < 0x2::clock::timestamp_ms(arg3)) {
                let v14 = EE{
                    e : 0x16f41fd874bd7afe9fb22dcc0b9bf48998ee48ba612bbf052b19809d8efcc8d7::ct::e_order_expired(),
                    l : 486,
                };
            ...
            let (v18, v19) = vbac<T0, T1>(arg0, v8, v9, v10, arg13, arg14, arg12, v16, *0x1::vector::borrow<u64>(&arg10, v12), true, true, true);
            let v20 = v19;
            let v21 = &v20;
            let v22 = 0;
            if (v21 == &v22) {
        ...
        while (v11 < 0x1::vector::length<u64>(&arg8)) {
            ...
            let (v33, v34) = vbac<T0, T1>(arg0, v8, v9, v10, arg13, arg14, arg12, v31, *0x1::vector::borrow<u64>(&arg10, v27), false, true, true);
            let v35 = v34;
            let v36 = &v35;
            let v37 = 0;
            if (v36 == &v37) {
                let v38 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg0, arg1, arg2, 0, v0, v1, v31, v33, false, true, v28, arg3, arg15);
                v8 = v8 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v38);
                v9 = v9 + (((0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v38) as u128) * (v31 as u128) / 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling_u128()) as u64);
                v10 = v10 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::paid_fees(&v38);
                continue
            };
            let v39 = 102;
            if (v36 == &v39) {
    ...
    fun sp(arg0: &vector<u64>, arg1: &vector<u64>, arg2: u64, arg3: u64, arg4: bool) : u64 {
        ...
        if (arg4) {
            ...
            if (v2 > 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::max_u64() - arg2) {
                return 0
            };
            v2 + arg2
        }
