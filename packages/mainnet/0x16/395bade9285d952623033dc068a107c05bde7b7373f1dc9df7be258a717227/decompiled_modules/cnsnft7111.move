module 0x16395bade9285d952623033dc068a107c05bde7b7373f1dc9df7be258a717227::cnsnft7111 {
    struct CNSNFT7111 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7111, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7111>(arg0, arg1);
