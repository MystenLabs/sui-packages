module 0x16c8b69b117db9be429b5d75dfe9bf9a24a64c2987510d94e0c4f82d907b4473::gift1815 {
    struct GIFT1815 has drop {
        dummy_field: bool,
    }

    struct TICKET_1815 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift1815(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1815>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1815>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT1815, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1815>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1815>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1815>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1815>>(v5, 0x2::tx_context::sender(arg1));
    }
