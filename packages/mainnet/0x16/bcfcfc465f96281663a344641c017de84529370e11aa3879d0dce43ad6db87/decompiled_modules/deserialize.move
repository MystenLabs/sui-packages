module 0x16bcfcfc465f96281663a344641c017de84529370e11aa3879d0dce43ad6db87::deserialize {
    public fun deserialize_address(arg0: &vector<u8>, arg1: u64, arg2: u64) : address {
        let v0 = 0x2::bcs::new(0x16bcfcfc465f96281663a344641c017de84529370e11aa3879d0dce43ad6db87::vector_utils::slice<u8>(arg0, arg1, arg1 + arg2));
        0x2::bcs::peel_address(&mut v0)
    }

    public fun deserialize_u256_be(arg0: &vector<u8>, arg1: u64, arg2: u64) : u256 {
        let v0 = 0x16bcfcfc465f96281663a344641c017de84529370e11aa3879d0dce43ad6db87::vector_utils::slice<u8>(arg0, arg1, arg1 + arg2);
