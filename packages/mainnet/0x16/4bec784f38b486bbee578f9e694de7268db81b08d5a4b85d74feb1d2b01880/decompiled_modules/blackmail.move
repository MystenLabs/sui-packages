module 0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::blackmail {
    ...
    public fun record_blackmail(arg0: &0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::crimes_authority::CrimesCap, arg1: &0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::crimes_version::Version, arg2: u64, arg3: u64, arg4: &mut 0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::iblackmail::PlayerBlackmailInfo, arg5: &0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::iblackmail::PlayerBlackmailInfo, arg6: &0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::iblackmail::BlackmailType, arg7: &0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::iblackmail::BlackmailRegistry, arg8: u128, arg9: &0x2::random::Random, arg10: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, 0x1::string::String, u128, bool) {
        0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::crimes_version::validate_version(arg1);
        let v0 = 0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::iblackmail::borrow_blackmail_resource_type(arg6);
        let v1 = 0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::iblackmail::borrow_blackmail_registry(arg7);
        let (v2, v3) = find_player_level_difference(arg2, arg3);
        let (v4, v5) = calculate_success_chance(get_hidden_resource_match(0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::iblackmail::get_blackmail_defending_resource(arg5), v0), *0x1::vector::borrow<u64>(&v1, 4), *0x1::vector::borrow<u64>(&v1, 5), *0x1::vector::borrow<u64>(&v1, 6), *0x1::vector::borrow<u64>(&v1, 7), *0x1::vector::borrow<u64>(&v1, 8), *0x1::vector::borrow<u64>(&v1, 9), v2, v3, arg9, arg10);
        let (v6, v7) = if (v5) {
        ...
        if (v5 && v13 >= 1 * 0x1::u128::pow(2, 64)) {
            0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::iblackmail::set_blackmail_success_count(arg4, 1);
        } else {
            0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::iblackmail::set_blackmail_failed_count(arg4, 1);
        };
