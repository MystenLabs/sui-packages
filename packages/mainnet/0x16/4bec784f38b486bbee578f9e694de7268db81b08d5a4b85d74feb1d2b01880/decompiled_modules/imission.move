module 0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::imission {
    ...
    public fun new_mission_info(arg0: &0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::crimes_authority::CrimesCap, arg1: &MissionRegistry, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
    ...
    public(friend) fun process_current_success_chance(arg0: &mut MissionInfo, arg1: &MissionRegistry, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v11 = 0x164bec784f38b486bbee578f9e694de7268db81b08d5a4b85d74feb1d2b01880::utils_crime::flip_coin(arg4, *v10, arg5);
        let v12 = if (v11) {
            v0.success_increase
        } else {
            v0.failed_increase
