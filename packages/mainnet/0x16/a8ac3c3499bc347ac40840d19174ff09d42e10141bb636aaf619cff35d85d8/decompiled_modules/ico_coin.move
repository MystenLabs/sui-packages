module 0x16a8ac3c3499bc347ac40840d19174ff09d42e10141bb636aaf619cff35d85d8::ico_coin {
    struct ICO has drop {
        dummy_field: bool,
    }
    ...
    public fun get_lightweight_info() : (0x1::string::String, 0x1::string::String, u8) {
        (0x1::string::utf8(b"RCO"), 0x1::string::utf8(b"Rno Protocol"), 9)
    }
    ...
    public fun get_token_display_info() : (0x1::string::String, 0x1::string::String, u8, 0x1::string::String, 0x1::string::String) {
        (0x1::string::utf8(b"Rno Protocol"), 0x1::string::utf8(b"RCO"), 9, 0x1::string::utf8(b"10000000"), 0x1::string::utf8(b"https://magenta-quickest-fly-406.mypinata.cloud/ipfs/bafkreic32lutm2qbfcvjkfvdbpoveohx2lfanvj3jaynjw3ivlqkzungam"))
    }

    fun init(arg0: ICO_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 10000000000000000;
        assert!(4000000000000000 + 3000000000000000 + 3000000000000000 == v0, 0);
        let (v1, v2) = 0x2::coin::create_currency<ICO_COIN>(arg0, 9, b"RCO", b"Rno Protocol", b"Decentralized Rno token on Sui blockchain", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://magenta-quickest-fly-406.mypinata.cloud/ipfs/bafkreic32lutm2qbfcvjkfvdbpoveohx2lfanvj3jaynjw3ivlqkzungam")), arg1);
        let v3 = v1;
        0x2::transfer::public_transfer<0x2::coin::Coin<ICO_COIN>>(0x2::coin::mint<ICO_COIN>(&mut v3, 4000000000000000, arg1), @0x8bc9201bea8600f2212f1df3d9b0a2aae5db7ff5d8c78ac262e88fc8d0a692ca);
        0x2::transfer::public_transfer<0x2::coin::Coin<ICO_COIN>>(0x2::coin::mint<ICO_COIN>(&mut v3, 3000000000000000, arg1), @0xe304a8a53a84d4f63a3a8c86376d13d81e205eb75cceca5bf388630c002e1070);
        0x2::transfer::public_transfer<0x2::coin::Coin<ICO_COIN>>(0x2::coin::mint<ICO_COIN>(&mut v3, 3000000000000000, arg1), @0x8f6cb62de26e16d10409921140534d6c1f31ec136c6885250586d9f0fb352160);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<ICO_COIN>>(v3, @0x0);
        0x2::transfer::public_transfer<0x2::coin::CoinMetadata<ICO_COIN>>(v2, 0x2::tx_context::sender(arg1));
        let v4 = 0x1::vector::empty<address>();
        0x1::vector::push_back<address>(&mut v4, @0x8bc9201bea8600f2212f1df3d9b0a2aae5db7ff5d8c78ac262e88fc8d0a692ca);
        0x1::vector::push_back<address>(&mut v4, @0xe304a8a53a84d4f63a3a8c86376d13d81e205eb75cceca5bf388630c002e1070);
        0x1::vector::push_back<address>(&mut v4, @0x8f6cb62de26e16d10409921140534d6c1f31ec136c6885250586d9f0fb352160);
        let v5 = TokenCreatedEvent{
            total_supply    : v0,
            initial_holders : v4,
            decimals        : 9,
            symbol          : 0x1::string::utf8(b"RCO"),
            name            : 0x1::string::utf8(b"Rno Protocol"),
        };
