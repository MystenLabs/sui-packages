module 0x16d97510fc8a67a3010ecb407af961eb3e9d94c8610d1a91a5be408a07b8d898::pat {
    struct PAT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PAT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<PAT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PAT     ")))), trim_right(b"Pepe's Cat                      "), trim_right(b"Meet PAT the cat. It's Pepe's time to move aside cause PAT just moved into town. Pepe flexes his marketcap so PAT decided to walk Pepe's wife all over town.                                                                                                                                                                    "), v2, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<PAT>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<PAT>>(v4);
    }
