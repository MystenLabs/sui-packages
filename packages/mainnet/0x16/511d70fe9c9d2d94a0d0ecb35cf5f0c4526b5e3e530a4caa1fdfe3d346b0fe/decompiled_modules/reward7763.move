module 0x16511d70fe9c9d2d94a0d0ecb35cf5f0c4526b5e3e530a4caa1fdfe3d346b0fe::reward7763 {
    struct REWARD7763 has drop {
        dummy_field: bool,
    }

    struct TICKET_7763 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7763(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7763>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7763>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7763, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7763>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7763>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7763>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7763>>(v5, 0x2::tx_context::sender(arg1));
    }
