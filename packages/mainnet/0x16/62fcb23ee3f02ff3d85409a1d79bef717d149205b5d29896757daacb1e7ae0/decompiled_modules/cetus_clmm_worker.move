module 0x960ab11d560f05f0ec260c7ac87074b569334713594aa02580642e029fd9dd86::cetus_clmm_worker {
    ...
    public fun collect_reward_two_others<T0, T1, T2, T3, T4>(arg0: &mut WorkerInfo<T0, T1, T2>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::rewarder::RewarderGlobalVault, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T3>, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T3>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T4>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T4>, arg8: bool, arg9: bool, arg10: bool, arg11: bool, arg12: bool, arg13: bool, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        if (arg10) {
            ...
            if (v5 > 0) {
                if (arg12) {
                    ...
                    0x2::balance::join<T1>(&mut arg0.tiny_coin_farming_bounty, 0x2::balance::split<T1>(&mut v11, 0x9ec6f17e19c5e64c8872779a635235497fd6c71f7b5c23b07f652b02a240c84a::mole_math::mul_div(0x2::balance::value<T1>(&v11), arg0.reinvest_bounty_bps, 10000)));
                };
            } else {
        ...
        if (arg11) {
            let v12 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::collect_reward<T0, T1, T4>(arg1, arg3, 0x1::option::borrow<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&arg0.position_nft), arg2, true, arg14);
            let v13 = 0x2::balance::value<T4>(&v12);
            if (v13 > 0) {
                if (arg13) {
                    let (v14, v15) = 0xb40b95dfee63de4d308b5b3118d1f127950d15184cad3ee762bba7594f26dd40::cetus_clmm_utils::swap_exact<T0, T4>(arg1, arg6, 0x2::coin::zero<T0>(arg15), 0x2::coin::from_balance<T4>(v12, arg15), false, true, v13, arg14, arg15);
                    0x2::coin::destroy_zero<T4>(v15);
                    let v16 = 0x2::coin::into_balance<T0>(v14);
                    0x2::balance::join<T0>(&mut arg0.tiny_coin_base, v16);
                    0x2::balance::join<T0>(&mut arg0.tiny_coin_base_bounty, 0x2::balance::split<T0>(&mut v16, 0x9ec6f17e19c5e64c8872779a635235497fd6c71f7b5c23b07f652b02a240c84a::mole_math::mul_div(0x2::balance::value<T0>(&v16), arg0.reinvest_bounty_bps, 10000)));
                } else {
                    let (v17, v18) = 0xb40b95dfee63de4d308b5b3118d1f127950d15184cad3ee762bba7594f26dd40::cetus_clmm_utils::swap_exact<T1, T4>(arg1, arg7, 0x2::coin::zero<T1>(arg15), 0x2::coin::from_balance<T4>(v12, arg15), false, true, v13, arg14, arg15);
                    0x2::coin::destroy_zero<T4>(v18);
                    let v19 = 0x2::coin::into_balance<T1>(v17);
                    0x2::balance::join<T1>(&mut arg0.tiny_coin_farming, v19);
                    0x2::balance::join<T1>(&mut arg0.tiny_coin_farming_bounty, 0x2::balance::split<T1>(&mut v19, 0x9ec6f17e19c5e64c8872779a635235497fd6c71f7b5c23b07f652b02a240c84a::mole_math::mul_div(0x2::balance::value<T1>(&v19), arg0.reinvest_bounty_bps, 10000)));
                };
            } else {
                0x2::coin::destroy_zero<T4>(0x2::coin::from_balance<T4>(v12, arg15));
            };
        };
        0x2::balance::join<T0>(&mut arg0.tiny_coin_base, v0);
        0x2::balance::join<T1>(&mut arg0.tiny_coin_farming, v1);
