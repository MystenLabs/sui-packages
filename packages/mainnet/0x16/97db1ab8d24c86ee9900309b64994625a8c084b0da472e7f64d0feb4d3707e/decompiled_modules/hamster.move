module 0x1697db1ab8d24c86ee9900309b64994625a8c084b0da472e7f64d0feb4d3707e::hamster {
    ...
    fun init(arg0: HAMSTER, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HAMSTER>(arg0, 6, b"Hamster", b"Hamsters AI Life", b"Hamsters AI Life eep-eep-eep on Sui - Free mint for all", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://gateway.pinata.cloud/ipfs/QmQgeb5N6DyXtuFve1nD7vbsU3pmvdadnUMsQDtFiptjBd"))), arg1);
        let v2 = v0;
        ...
        0x2::transfer::public_share_object<0x2::coin::TreasuryCap<HAMSTER>>(v2);
