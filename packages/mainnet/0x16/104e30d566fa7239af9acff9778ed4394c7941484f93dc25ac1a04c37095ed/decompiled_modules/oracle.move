module 0x16104e30d566fa7239af9acff9778ed4394c7941484f93dc25ac1a04c37095ed::oracle {
    struct HiveOracle has store, key {
        id: 0x2::object::UID,
        update_cap: 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::TwapUpdateCap,
    ...
    fun calculate_twap(arg0: u256, arg1: u256, arg2: u64) : u256 {
        let v0 = if (arg0 >= arg1) {
            ...
            0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::overflow_add_u256(arg0, 0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::sub_from_max_u256(arg1))
        };
        v0 / (arg2 as u256)
    }
    ...
    public fun setup_hive_oracle(arg0: 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::TwapUpdateCap, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = HiveOracle{
    ...
    public fun update_hive_oracle(arg0: &0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::config::HiveDaoCapability, arg1: &mut HiveOracle, arg2: 0x1::option::Option<address>, arg3: 0x1::option::Option<address>, arg4: &0x2::tx_context::TxContext) {
    ...
    public entry fun update_hive_oracle_price<T0, T1, T2, T3, T4, T5>(arg0: &0x2::clock::Clock, arg1: &mut HiveOracle, arg2: &mut 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::HiveManager, arg3: &0x16104e30d566fa7239af9acff9778ed4394c7941484f93dc25ac1a04c37095ed::two_pool::LiquidityPool<T0, T1, T4>, arg4: &0x16104e30d566fa7239af9acff9778ed4394c7941484f93dc25ac1a04c37095ed::two_pool::LiquidityPool<T2, T3, T5>, arg5: &0x2::tx_context::TxContext) {
        ...
        let v2 = 0x16104e30d566fa7239af9acff9778ed4394c7941484f93dc25ac1a04c37095ed::two_pool::get_liquidity_pool_id<T2, T3, T5>(arg4);
        assert!(0x2::object::id_to_address(&v2) == *0x1::option::borrow<address>(&arg1.sui_hive_pool_addr), 1974);
        let v3 = 0x16104e30d566fa7239af9acff9778ed4394c7941484f93dc25ac1a04c37095ed::two_pool::get_liquidity_pool_id<T0, T1, T4>(arg3);
        assert!(0x2::object::id_to_address(&v3) == *0x1::option::borrow<address>(&arg1.usdc_sui_pool_addr), 1974);
        let (_, v5, v6) = 0x16104e30d566fa7239af9acff9778ed4394c7941484f93dc25ac1a04c37095ed::two_pool::get_pool_cumulative_prices<T2, T3, T5>(arg4);
        let (_, v8, v9) = 0x16104e30d566fa7239af9acff9778ed4394c7941484f93dc25ac1a04c37095ed::two_pool::get_pool_cumulative_prices<T0, T1, T4>(arg3);
        ...
        if (0x1::option::is_some<HiveTwapSnapshot>(&v20)) {
            ...
            let v28 = 0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::mul_div_u256(v26, v27, (0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::pow(10, (9 as u128)) as u256));
            if (v28 > 0) {
                0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::update_hive_twap_info(&arg1.update_cap, arg0, arg2, v26, v27, v28);
            };
        };
