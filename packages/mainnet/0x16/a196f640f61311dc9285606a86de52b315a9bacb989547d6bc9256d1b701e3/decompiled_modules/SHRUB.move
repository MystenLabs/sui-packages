module 0x16a196f640f61311dc9285606a86de52b315a9bacb989547d6bc9256d1b701e3::SHRUB {
    struct SHRUB has drop {
        dummy_field: bool,
    }

    fun init(arg0: SHRUB, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<SHRUB>(arg0, 2, b"SHRUB", b"SHRUB", b"SHRUB", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/ZOuPki64N47SPPWjgWJF-_CV55suMVuhEOIulspBCVU?ext=png")), arg1);
