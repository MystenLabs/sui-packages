module 0xb0b38712b6e5adfc097f3315685925d1880e973fbee63826e3bacd0cacfe599b::usd1 {
    ...
    fun init(arg0: USD1, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<USD1>(arg0, 9, b"AGLD", b"AGLD", b"This is AGLD. ", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://s2.coinmarketcap.com/static/img/coins/64x64/11568.png")), arg1);
