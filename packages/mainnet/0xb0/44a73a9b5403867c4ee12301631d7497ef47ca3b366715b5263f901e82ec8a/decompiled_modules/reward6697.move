module 0xb044a73a9b5403867c4ee12301631d7497ef47ca3b366715b5263f901e82ec8a::reward6697 {
    struct REWARD6697 has drop {
        dummy_field: bool,
    }

    struct TICKET_6697 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6697(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6697>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6697>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6697, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6697>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6697>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6697>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6697>>(v5, 0x2::tx_context::sender(arg1));
    }
