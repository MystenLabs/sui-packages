module 0xb01397ac4725cda2476e8a1cd3dccba6d7abe62cbbac3b4d13829abfa8287b2c::vesting {
    ...
    entry fun claim<T0>(arg0: &0x2::clock::Clock, arg1: &mut Vesting<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = if (v0.claimTimes == 0) {
            0xb01397ac4725cda2476e8a1cd3dccba6d7abe62cbbac3b4d13829abfa8287b2c::math::mul_div(v0.amount, arg1.tge_percent, 10000)
        } else {
            0xb01397ac4725cda2476e8a1cd3dccba6d7abe62cbbac3b4d13829abfa8287b2c::math::mul_div(v0.amount, arg1.cycle_percent, 10000)
        };
