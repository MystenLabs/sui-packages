module 0xb049437236374b4fb7a325eafc49d6df679d86adc45b074892b83a2ec5946d7c::xx {
    struct XX has drop {
        dummy_field: bool,
    }

    fun init(arg0: XX, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/0avLXkYUvvpKMKCHJOczAJ5SUCaUmNttcXELwo7BZq8";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/0avLXkYUvvpKMKCHJOczAJ5SUCaUmNttcXELwo7BZq8"))
        };
