module 0xb08ff9ee02bfdaa7545fdec2c93034112032bad30cea368ce06c205bc25a5672::evosgenesisegg {
    ...
    fun create_nft(arg0: &mut 0x2::tx_context::TxContext) : EvosGenesisEgg {
        EvosGenesisEgg{
            ...
            name : 0x1::string::utf8(b"Evos Genesis EvosGenesisEgg"),
            url  : 0x2::url::new_unsafe_from_bytes(b"https://test-videos.co.uk/vids/bigbuckbunny/mp4/h264/360/Big_Buck_Bunny_360_10s_1MB.mp4"),
        }
    }
    ...
    fun init(arg0: EVOSGENESISEGG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<EvosGenesisEgg>(&mut v9, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<EvosGenesisEgg>(&mut v9, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://{url}"));
        0x2::display::add<EvosGenesisEgg>(&mut v9, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{attributes}"));
