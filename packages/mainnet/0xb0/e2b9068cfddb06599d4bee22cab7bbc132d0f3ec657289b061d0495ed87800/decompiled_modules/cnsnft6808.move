module 0xb0e2b9068cfddb06599d4bee22cab7bbc132d0f3ec657289b061d0495ed87800::cnsnft6808 {
    struct CNSNFT6808 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6808, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6808>(arg0, arg1);
