module 0xb007086976819f5ec38994aed78aa0b0984df62c4ffc4bc22356770e9d45de9e::order {
    ...
    public(friend) fun add_target(arg0: &mut Order, arg1: u8, arg2: u128, arg3: u128, arg4: u64) : u64 {
        ...
        assert!(v0 < 18446744073709551615, 13906837447109902359);
        let v1 = (v0 as u64);
        ...
        if (arg1 == 0) {
            0x1::vector::push_back<Target>(&mut arg0.tp_targets, v2);
        } else {
            0x1::vector::push_back<Target>(&mut arg0.sl_targets, v2);
        };
        v1
    }

    public(friend) fun assert_market_matches(arg0: &Order, arg1: 0x2::object::ID) {
        assert!(arg0.market_id == arg1, 13906837962504929287);
    }

    public(friend) fun assert_order_book_matches<T0, T1, T2>(arg0: &OrderBook<T0, T1, T2>, arg1: &Order) {
        assert!(arg1.order_book_id == 0x2::object::id<OrderBook<T0, T1, T2>>(arg0), 13906837941029961733);
        assert!(arg1.market_id == arg0.market_id, 13906837945324929029);
    }

    public(friend) fun assert_order_cap_matches(arg0: &Order, arg1: &OrderCap) {
        assert!(arg1.order_id == 0x2::object::uid_to_inner(&arg0.id), 13906837919554994179);
        assert!(arg1.position_id == arg0.position_id, 13906837923849961475);
    }

    public(friend) fun assert_receipt_matches_order(arg0: &Order, arg1: &ExecuteReceipt) {
        assert!(arg1.order_id == 0x2::object::uid_to_inner(&arg0.id), 13906837979684929545);
        assert!(arg1.position_id == arg0.position_id, 13906837983979896841);
    }
    ...
    public(friend) fun cancel<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: Order, arg2: OrderCap) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        ...
        assert!(arg1.status == 0, 13906836875878727695);
        let (v3, v4, v5, _) = destroy_order(arg1);
        assert!(v1 == v3, 13906836884467875843);
    ...
    public(friend) fun claim_orphan<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: OrderCap) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        ...
        assert!(0x2::dynamic_field::exists_<OrphanDfKey>(&arg0.id, v3), 13906837210886045709);
    ...
    public(friend) fun cleanup_and_claim_orphan<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: Order, arg2: OrderCap) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        ...
        assert!(v1 == v4, 13906837159345782787);
        v3
    }
    ...
    public(friend) fun close<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: Order, arg2: OrderCap) {
        ...
        0x2::object::delete(v0);
        assert!(arg1.status == 2, 13906836970368139281);
        let (v3, v4, v5, _) = destroy_order(arg1);
        assert!(v1 == v3, 13906836978957156355);
    ...
    public fun create_order_book<T0, T1, T2>(arg0: &0xb007086976819f5ec38994aed78aa0b0984df62c4ffc4bc22356770e9d45de9e::global_config::AdminCap, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_order_book_with_registry<T0, T1, T2>(arg0: &0xb007086976819f5ec38994aed78aa0b0984df62c4ffc4bc22356770e9d45de9e::global_config::AdminCap, arg1: &mut 0xb007086976819f5ec38994aed78aa0b0984df62c4ffc4bc22356770e9d45de9e::order_book_registry::OrderBookRegistry, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = new_order_book<T0, T1, T2>(arg2, arg3, arg4, arg5, arg6);
        let v1 = 0x2::object::id<OrderBook<T0, T1, T2>>(&v0);
        0xb007086976819f5ec38994aed78aa0b0984df62c4ffc4bc22356770e9d45de9e::order_book_registry::register(arg1, arg2, v1);
    ...
    fun destroy_order(arg0: Order) : (0x2::object::ID, 0x2::object::ID, 0x1::option::Option<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>, u8) {
        ...
        let v15 = v9;
        let v16 = v0;
        assert!(0x2::bag::is_empty(&v15), 13906836227338928147);
    ...
    public fun harvest_fees<T0, T1, T2, T3>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0xb007086976819f5ec38994aed78aa0b0984df62c4ffc4bc22356770e9d45de9e::global_config::AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    fun new_order_book<T0, T1, T2>(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : OrderBook<T0, T1, T2> {
        assert!(arg1 <= 10000, 13906835578797686783);
        OrderBook<T0, T1, T2>{
    ...
    public fun next_target_id(arg0: &Order) : u128 {
        arg0.next_target_id
    }
    ...
    public fun pause<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0xb007086976819f5ec38994aed78aa0b0984df62c4ffc4bc22356770e9d45de9e::global_config::AdminCap) {
    ...
    public fun register_existing_order_book<T0, T1, T2>(arg0: &0xb007086976819f5ec38994aed78aa0b0984df62c4ffc4bc22356770e9d45de9e::global_config::AdminCap, arg1: &mut 0xb007086976819f5ec38994aed78aa0b0984df62c4ffc4bc22356770e9d45de9e::order_book_registry::OrderBookRegistry, arg2: &OrderBook<T0, T1, T2>) {
        0xb007086976819f5ec38994aed78aa0b0984df62c4ffc4bc22356770e9d45de9e::order_book_registry::register(arg1, arg2.market_id, 0x2::object::id<OrderBook<T0, T1, T2>>(arg2));
    }
    ...
    public(friend) fun remove_settlement<T0>(arg0: &mut Order) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.settlements, v0), 13906836811453956107);
    ...
    public fun resume<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0xb007086976819f5ec38994aed78aa0b0984df62c4ffc4bc22356770e9d45de9e::global_config::AdminCap) {
        arg0.is_active = true;
        let v0 = OrderBookPausedEvent{
            order_book_id : 0x2::object::id<OrderBook<T0, T1, T2>>(arg0),
            is_active     : true,
    ...
    public(friend) fun store_order<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: bool, arg5: u128, arg6: vector<Target>, arg7: vector<Target>, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : OrderCap {
        assert!(!0x2::table::contains<0x2::object::ID, 0x2::object::ID>(&arg0.order_index, arg2), 13906836321827028993);
        let v0 = Order{
    ...
    public(friend) fun take_position_cap(arg0: &mut Order) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        assert!(arg0.status == 0, 13906836635360559119);
        arg0.status = 1;
    ...
    public fun update_fee_params<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0xb007086976819f5ec38994aed78aa0b0984df62c4ffc4bc22356770e9d45de9e::global_config::AdminCap, arg2: u64, arg3: u64) {
        assert!(arg2 <= 10000, 13906835995409514495);
        arg0.fee_rate_bps = arg2;
        arg0.fee_cap = arg3;
    }

    public fun update_params<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0xb007086976819f5ec38994aed78aa0b0984df62c4ffc4bc22356770e9d45de9e::global_config::AdminCap, arg2: u64) {
