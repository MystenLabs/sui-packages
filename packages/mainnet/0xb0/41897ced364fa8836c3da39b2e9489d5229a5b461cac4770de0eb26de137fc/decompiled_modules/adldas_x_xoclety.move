module 0xb041897ced364fa8836c3da39b2e9489d5229a5b461cac4770de0eb26de137fc::adldas_x_xoclety {
    struct ADLDAS_X_XOCLETY has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ADLDAS_X_XOCLETY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ADLDAS_X_XOCLETY>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"ADlDAS X XOClETY"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"ADIDAS x XOCIETY is an exclusive digital collectible that unlocks premium branded in-game content and special XOCIETY ecosystem rewards."));
