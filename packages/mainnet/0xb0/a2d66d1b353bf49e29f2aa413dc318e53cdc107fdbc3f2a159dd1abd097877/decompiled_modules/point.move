module 0xb0a2d66d1b353bf49e29f2aa413dc318e53cdc107fdbc3f2a159dd1abd097877::point {
    ...
    public fun add_point_raw<T0>(arg0: &mut PointDashBoard<T0>, arg1: address, arg2: u256, arg3: &mut 0x2::tx_context::TxContext) {
        if (!0x2::table::contains<address, u256>(&arg0.user_points, arg1)) {
            0x2::table::add<address, u256>(&mut arg0.user_points, arg1, 0);
        };
        arg0.total_points = arg0.total_points + arg2;
        *0x2::table::borrow_mut<address, u256>(&mut arg0.user_points, arg1) = *0x2::table::borrow<address, u256>(&arg0.user_points, arg1) + arg2;
    }
    ...
    public fun send_add_point_req<T0: drop>(arg0: u256, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        send_add_point_req_<T0>(0xb0a2d66d1b353bf49e29f2aa413dc318e53cdc107fdbc3f2a159dd1abd097877::constant::point_updater(), v0, arg0, arg2);
    }
    ...
    public fun send_add_point_req_with_owner<T0>(arg0: address, arg1: u256, arg2: &mut 0x2::tx_context::TxContext) {
        send_add_point_req_<T0>(0xb0a2d66d1b353bf49e29f2aa413dc318e53cdc107fdbc3f2a159dd1abd097877::constant::point_updater(), arg0, arg1, arg2);
    }

    public fun send_sub_point_req<T0>(arg0: u256, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        send_sub_point_req_<T0>(0xb0a2d66d1b353bf49e29f2aa413dc318e53cdc107fdbc3f2a159dd1abd097877::constant::point_updater(), v0, arg0, arg1);
    }
    ...
    public fun send_sub_point_req_with_owner<T0>(arg0: address, arg1: u256, arg2: &mut 0x2::tx_context::TxContext) {
        send_sub_point_req_<T0>(0xb0a2d66d1b353bf49e29f2aa413dc318e53cdc107fdbc3f2a159dd1abd097877::constant::point_updater(), arg0, arg1, arg2);
    }
