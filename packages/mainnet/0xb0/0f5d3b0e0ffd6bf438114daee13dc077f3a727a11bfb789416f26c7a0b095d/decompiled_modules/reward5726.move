module 0xb00f5d3b0e0ffd6bf438114daee13dc077f3a727a11bfb789416f26c7a0b095d::reward5726 {
    struct REWARD5726 has drop {
        dummy_field: bool,
    }

    struct TICKET_5726 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5726(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5726>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5726>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5726, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5726>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5726>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5726>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5726>>(v5, 0x2::tx_context::sender(arg1));
    }
