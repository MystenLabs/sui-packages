module 0xb07227dcd1293734e4288556dcb230dff5966d0815ca2aa1d6a2f1dce409f2f8::um_salve_para_o_elcartel_e_tambem_para_o_snk {
    ...
    fun init(arg0: UM_SALVE_PARA_O_ELCARTEL_E_TAMBEM_PARA_O_SNK, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<UM_SALVE_PARA_O_ELCARTEL_E_TAMBEM_PARA_O_SNK>(arg0, 6, b"UM_SALVE_PARA_O_ELCARTEL_E_TAMBEM_PARA_O_SNK", b"UM_SALVE_PARA_O_ELCARTEL_E_TAMBEM_PARA_O_SNK", b"telegram: elcartelounge", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://i.imgur.com/blXVsod.png"))), arg1);
        let v2 = v0;
