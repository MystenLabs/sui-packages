module 0xb0d6e792f08e75482b105b0e937102ac75e30cff323a553d1ff92613d39c600a::vault {
    ...
    public fun get_token_price<T0, T1>(arg0: &Vault<T0, T1>) : u64 {
        arg0.target_amount * 10000 / arg0.total_rewards
    }
    ...
    public fun get_user_total_reward<T0, T1>(arg0: &Vault<T0, T1>, arg1: &InvestCertificate) : u64 {
        if (arg0.invested_amount <= arg0.target_amount) {
            arg1.deposit * 10000 / get_token_price<T0, T1>(arg0)
        } else {
            arg0.total_rewards * 10000 / arg0.invested_amount * 10000 / arg1.deposit
        }
    }
