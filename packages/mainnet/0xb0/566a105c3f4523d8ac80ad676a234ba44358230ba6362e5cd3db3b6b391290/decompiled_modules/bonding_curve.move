module 0xb0566a105c3f4523d8ac80ad676a234ba44358230ba6362e5cd3db3b6b391290::bonding_curve {
    ...
    public(friend) fun buy_<T0>(arg0: &mut BondingCurve<T0>, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: bool, arg3: u64, arg4: u64, arg5: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0xb0566a105c3f4523d8ac80ad676a234ba44358230ba6362e5cd3db3b6b391290::locked_coin::LockedCoin<T0>, 0x2::balance::Balance<0x2::sui::SUI>) {
        assert!(!arg0.ended, 3);
        ...
        let v14 = if (v13 >= arg0.lock_amount) {
            0xb0566a105c3f4523d8ac80ad676a234ba44358230ba6362e5cd3db3b6b391290::locked_coin::zero<T0>(arg6)
        } else {
            ...
            v12 = v15;
            0xb0566a105c3f4523d8ac80ad676a234ba44358230ba6362e5cd3db3b6b391290::locked_coin::from_balance<T0>(0x2::balance::split<T0>(&mut v11, v15), arg6)
        };
    ...
    fun seed_to_dex<T0>(arg0: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg1: &mut BondingCurve<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        let v3 = 0x2::balance::value<T0>(&arg1.coin_vault);
        ...
        let v4 = if (0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::swap_utils::is_ordered<0x2::sui::SUI, T0>()) {
            add_liquidity<0x2::sui::SUI, T0>(arg0, v1, 0x2::balance::split<T0>(&mut arg1.coin_vault, v3), arg2)
        } else {
            add_liquidity<T0, 0x2::sui::SUI>(arg0, 0x2::balance::split<T0>(&mut arg1.coin_vault, v3), v1, arg2)
        };
