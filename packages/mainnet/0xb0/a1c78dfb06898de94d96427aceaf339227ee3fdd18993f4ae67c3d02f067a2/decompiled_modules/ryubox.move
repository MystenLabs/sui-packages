module 0xb0a1c78dfb06898de94d96427aceaf339227ee3fdd18993f4ae67c3d02f067a2::ryubox {
    ...
    public entry fun add_white(arg0: &mut RyuBoxCollect, arg1: vector<address>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: RYUBOX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b" Ryu Mysterious Box "));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"https://ryu.finance"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"https://ryu.finance"));
    ...
    fun mint(arg0: &mut RyuBoxCollect, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = RYUBOXNFT{
            ...
            description : 0x1::string::utf8(b" Ryu Mysterious Box"),
    ...
    public entry fun mint_by_fragment(arg0: 0x2::coin::Coin<0xb0a1c78dfb06898de94d96427aceaf339227ee3fdd18993f4ae67c3d02f067a2::fragment::FRAGMENT>, arg1: &mut 0xb0a1c78dfb06898de94d96427aceaf339227ee3fdd18993f4ae67c3d02f067a2::fragment::FragmentInfo, arg2: &mut RyuBoxCollect, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(get_current_timestamp(arg3) < arg2.close_mint_time, 1004);
        let v1 = 0x2::coin::value<0xb0a1c78dfb06898de94d96427aceaf339227ee3fdd18993f4ae67c3d02f067a2::fragment::FRAGMENT>(&arg0) / arg2.consumes_fragment;
        assert!(v1 > 0, 1005);
        0xb0a1c78dfb06898de94d96427aceaf339227ee3fdd18993f4ae67c3d02f067a2::fragment::burn(arg1, 0x2::coin::split<0xb0a1c78dfb06898de94d96427aceaf339227ee3fdd18993f4ae67c3d02f067a2::fragment::FRAGMENT>(&mut arg0, v1 * arg2.consumes_fragment, arg4));
        while (v1 > 0) {
            mint(arg2, arg4);
            v1 = v1 - 1;
        };
        if (0x2::coin::value<0xb0a1c78dfb06898de94d96427aceaf339227ee3fdd18993f4ae67c3d02f067a2::fragment::FRAGMENT>(&arg0) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xb0a1c78dfb06898de94d96427aceaf339227ee3fdd18993f4ae67c3d02f067a2::fragment::FRAGMENT>>(arg0, v0);
        } else {
            0x2::coin::destroy_zero<0xb0a1c78dfb06898de94d96427aceaf339227ee3fdd18993f4ae67c3d02f067a2::fragment::FRAGMENT>(arg0);
        };
    }

    public entry fun mint_by_white(arg0: &mut RyuBoxCollect, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
