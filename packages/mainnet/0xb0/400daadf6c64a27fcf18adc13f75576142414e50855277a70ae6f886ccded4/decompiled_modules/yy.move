module 0xb0400daadf6c64a27fcf18adc13f75576142414e50855277a70ae6f886ccded4::yy {
    struct YY has drop {
        dummy_field: bool,
    }

    fun init(arg0: YY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<YY>(arg0, 4, b"TTXXTEST", b"TTXXTEST", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://galactic100.s3.us-west-1.amazonaws.com/y3ycoin.png")), arg1);
        let v2 = v0;
