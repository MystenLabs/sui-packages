module 0xb06383fe06064df216b0f0114d13c149dd5c594b2458a6712c4cdc86fd105e6d::drog {
    ...
    fun init(arg0: DROG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<DROG>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DROG    ")))), trim_right(b"Drog                            "), trim_right(b"DOGE + FROG = DROG                                                                                                                                                                                                                                                                                                              "), v2, arg1);
