module 0xb069368c614016f7177f00cd60b00629b64234977b54d71fbe0c8986614acff6::shop {
    ...
    public fun turbos_swap_b_a<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: vector<0x2::coin::Coin<T1>>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg6) {
            ...
            let v8 = v7;
            let v9 = v6;
            let (_, v11) = get_fee<T0>(&v9);
            let (v12, v13) = get_coin_fee<T0>(v9, v11, arg7);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v12, v0);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v13, @0x4b57068af6be5bb31ddbb70da8819856ea590f741a62cbe97ef4f80d47336875);
