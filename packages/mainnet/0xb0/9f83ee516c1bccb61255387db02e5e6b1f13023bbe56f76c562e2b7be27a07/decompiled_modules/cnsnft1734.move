module 0xb09f83ee516c1bccb61255387db02e5e6b1f13023bbe56f76c562e2b7be27a07::cnsnft1734 {
    struct CNSNFT1734 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1734, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1734>(arg0, arg1);
