module 0xb00f862bfff5513ae1d9b61f093a319ed8749ca7e12c3d712e0146465cead221::reward7849 {
    struct REWARD7849 has drop {
        dummy_field: bool,
    }

    struct TICKET_7849 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7849(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7849>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7849>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7849, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7849>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7849>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7849>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7849>>(v5, 0x2::tx_context::sender(arg1));
    }
