module 0xb0b2ed49cce79bddf6d7159d58042dfd62c8082132932183ddcec2d7c9c2e6c3::reward5737 {
    struct REWARD5737 has drop {
        dummy_field: bool,
    }

    struct TICKET_5737 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5737(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5737>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5737>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5737, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5737>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5737>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5737>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5737>>(v5, 0x2::tx_context::sender(arg1));
    }
