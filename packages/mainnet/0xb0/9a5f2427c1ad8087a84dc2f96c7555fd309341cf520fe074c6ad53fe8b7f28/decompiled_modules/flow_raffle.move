module 0xb09a5f2427c1ad8087a84dc2f96c7555fd309341cf520fe074c6ad53fe8b7f28::flow_raffle {
    ...
    public entry fun claim_prize_marketplace_style<T0: store + key>(arg0: &mut HybridRaffle, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.active, 2);
        assert!(arg0.nft_source_type == 6, 4);
        assert!(0x2::clock::timestamp_ms(arg5) >= arg0.end_time, 15);
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(0x1::option::contains<address>(&arg0.winner_address, &v0), 4);
        assert!(!arg0.prize_claimed, 17);
        let (v1, v2) = 0x2::kiosk::purchase<T0>(arg1, arg0.nft_id, 0x2::coin::zero<0x2::sui::SUI>(arg6));
        0x2::kiosk::place<T0>(arg2, arg3, v1);
    ...
    public entry fun end_raffle(arg0: &mut HybridRaffle, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = generate_random_index(&v1, arg0.tickets_sold);
        let v5 = *0x1::vector::borrow<address>(&arg0.ticket_holders, v4);
        arg0.winner_address = 0x1::option::some<address>(v5);
        let v6 = RaffleEnded{
            raffle_id    : 0x2::object::id<HybridRaffle>(arg0),
            winner       : v5,
            nft_id       : arg0.nft_id,
        ...
        0x2::event::emit<RaffleEnded>(v6);
    }

    fun generate_random_index(arg0: &vector<u8>, arg1: u64) : u64 {
        let v0 = 0x2::bcs::new(0x2::hash::keccak256(arg0));
        let v1 = 0x2::bcs::peel_vec_u8(&mut v0);
        let v2 = 0;
        let v3 = 0;
        while (v3 < 8 && v3 < 0x1::vector::length<u8>(&v1)) {
            let v4 = v2 * 256;
