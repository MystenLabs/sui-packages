module 0xb0a97777f6e09385823af730f0ddf4a7786a06e4598d4eca1e100ceca1b31da8::suilend_adapter {
    ...
    public fun select_ctoken_withdraw_amount(arg0: u128, arg1: u64, arg2: u128, arg3: u128, arg4: u64) : u64 {
        ...
        let v2 = 0xc0b2d3f71a30453e0606923a024acf9597909c8c5ec78ee84ee00d2d26f269d3::llv_math::mul_div((arg4 as u128), arg3, arg2);
        let v3 = if (v1 < v2) {
            v1
        } else {
            v2
