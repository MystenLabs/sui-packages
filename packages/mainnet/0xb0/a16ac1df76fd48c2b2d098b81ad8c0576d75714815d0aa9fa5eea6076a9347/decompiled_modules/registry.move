module 0xb0a16ac1df76fd48c2b2d098b81ad8c0576d75714815d0aa9fa5eea6076a9347::registry {
    ...
    public(friend) fun add(arg0: u16, arg1: 0x2::object::ID, arg2: &mut Registry) {
        ...
        if ((0x2::table::length<u16, 0x2::object::ID>(&arg2.pfps) as u16) == 0xb0a16ac1df76fd48c2b2d098b81ad8c0576d75714815d0aa9fa5eea6076a9347::collection::size()) {
            arg2.is_initialized = true;
        };
    }

    public fun admin_freeze_registry(arg0: &0xb0a16ac1df76fd48c2b2d098b81ad8c0576d75714815d0aa9fa5eea6076a9347::admin::AdminCap, arg1: Registry, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun pfp_id_from_number(arg0: u16, arg1: &Registry) : 0x2::object::ID {
        assert!(arg0 >= 1 && arg0 <= 0xb0a16ac1df76fd48c2b2d098b81ad8c0576d75714815d0aa9fa5eea6076a9347::collection::size(), 1);
