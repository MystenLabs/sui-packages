module 0xb0a6fcc726318ea90644231ec78d0df8e4e9c5be483e13dd1695ab107e20513c::reward9996 {
    struct REWARD9996 has drop {
        dummy_field: bool,
    }

    struct TICKET_9996 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9996(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9996>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9996>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9996, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9996>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9996>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9996>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9996>>(v5, 0x2::tx_context::sender(arg1));
    }
