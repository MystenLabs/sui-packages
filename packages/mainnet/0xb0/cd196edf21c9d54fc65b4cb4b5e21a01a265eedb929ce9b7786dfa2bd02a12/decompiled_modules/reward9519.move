module 0xb0cd196edf21c9d54fc65b4cb4b5e21a01a265eedb929ce9b7786dfa2bd02a12::reward9519 {
    struct REWARD9519 has drop {
        dummy_field: bool,
    }

    struct TICKET_9519 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9519(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9519>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9519>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9519, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9519>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9519>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9519>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9519>>(v5, 0x2::tx_context::sender(arg1));
    }
