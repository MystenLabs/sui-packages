module 0xb050a77c365d17e367dbefc877030d2909cfeb2825651a8fc0c2a248c76032c0::cnsnft5990 {
    struct CNSNFT5990 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5990, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5990>(arg0, arg1);
