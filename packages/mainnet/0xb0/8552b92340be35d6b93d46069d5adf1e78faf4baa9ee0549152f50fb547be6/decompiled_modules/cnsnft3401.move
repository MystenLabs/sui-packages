module 0xb08552b92340be35d6b93d46069d5adf1e78faf4baa9ee0549152f50fb547be6::cnsnft3401 {
    struct CNSNFT3401 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3401, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3401>(arg0, arg1);
