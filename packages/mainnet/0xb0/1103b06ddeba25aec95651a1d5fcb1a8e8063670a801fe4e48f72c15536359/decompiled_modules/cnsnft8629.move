module 0xb01103b06ddeba25aec95651a1d5fcb1a8e8063670a801fe4e48f72c15536359::cnsnft8629 {
    struct CNSNFT8629 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8629, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8629>(arg0, arg1);
