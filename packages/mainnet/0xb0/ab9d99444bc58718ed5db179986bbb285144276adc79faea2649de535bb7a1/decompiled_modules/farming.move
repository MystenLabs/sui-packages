module 0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming {
    ...
    public fun add_banker(arg0: &mut Farming, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        ...
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_role_update(3, arg1, true, arg2);
    }

    public fun add_minor(arg0: &mut Farming, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        assert_owner(arg0, arg2);
        assert!(!0x1::vector::contains<address>(&arg0.minors, &arg1), 13);
        0x1::vector::push_back<address>(&mut arg0.minors, arg1);
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_role_update(2, arg1, true, arg2);
    }

    public fun add_operator(arg0: &mut Farming, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        assert_owner(arg0, arg2);
        assert!(!0x1::vector::contains<address>(&arg0.operators, &arg1), 13);
        0x1::vector::push_back<address>(&mut arg0.operators, arg1);
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_role_update(1, arg1, true, arg2);
    }
    ...
    public fun add_reward_config<T0, T1>(arg0: &Farming, arg1: &mut Pool<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : address {
        ...
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_reward_config_add(pool_id<T0>(arg1), v4, 0x1::type_name::with_defining_ids<T1>(), arg3, arg2, arg4, arg6);
    ...
    public fun assert_banker(arg0: &Farming, arg1: &0x2::tx_context::TxContext) {
    ...
    public fun assert_minor(arg0: &Farming, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        let v1 = if (is_owner(arg0, v0)) {
            true
        } else if (is_operator(arg0, v0)) {
    ...
    public fun assert_operator(arg0: &Farming, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(is_owner(arg0, v0) || is_operator(arg0, v0), 10);
    }

    public fun assert_owner(arg0: &Farming, arg1: &0x2::tx_context::TxContext) {
    ...
    fun calc_pool_acc_reward_per_share(arg0: &RewardConfig, arg1: u128, arg2: u64) : u128 {
        ...
        arg0.acc_reward_per_share + 0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_math::mul_div_down(0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_math::checked_mul_u128(((v2 - v1) as u128), (arg0.reward_per_second as u128)), 1000000000000, arg1)
    }
    ...
    fun calc_user_boost_shares<T0>(arg0: &Pool<T0>, arg1: &address, arg2: u128) : u128 {
        ...
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_math::checked_mul_u128(arg2, get_boost<T0>(arg0, arg1)) / 1000
    }
    ...
    public fun claim<T0, T1>(arg0: &mut Farming, arg1: &mut Pool<T0>, arg2: &mut RewardBank<T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0x2::coin::Coin<T1>> {
        ...
        store_or_delete_position_if_empty<T0>(arg0, arg1, v0, v1);
        let v7 = 0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_math::to_u64(v5);
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_claim(pool_id<T0>(arg1), v4, v0, v7, arg4);
    ...
    public fun create_borrow_pool<T0>(arg0: &mut Farming, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : address {
        ...
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_pool_create(v2, 0x1::type_name::with_defining_ids<T0>(), 2, arg2, arg1, @0x0, arg3);
    ...
    public fun create_lend_pool<T0>(arg0: &mut Farming, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : address {
        ...
        let v2 = pool_id<T0>(&v1);
        0x2::transfer::share_object<Pool<T0>>(v1);
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_pool_create(v2, v0, 1, 0, @0x0, arg1, arg2);
    ...
    public fun del_banker(arg0: &mut Farming, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        assert_owner(arg0, arg2);
        let (v0, v1) = 0x1::vector::index_of<address>(&arg0.bankers, &arg1);
        assert!(v0, 14);
        0x1::vector::remove<address>(&mut arg0.bankers, v1);
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_role_update(3, arg1, false, arg2);
    }

    public fun del_minor(arg0: &mut Farming, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        assert_owner(arg0, arg2);
        let (v0, v1) = 0x1::vector::index_of<address>(&arg0.minors, &arg1);
        assert!(v0, 14);
        0x1::vector::remove<address>(&mut arg0.minors, v1);
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_role_update(2, arg1, false, arg2);
    }

    public fun del_operator(arg0: &mut Farming, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        assert_owner(arg0, arg2);
        let (v0, v1) = 0x1::vector::index_of<address>(&arg0.operators, &arg1);
        assert!(v0, 14);
        0x1::vector::remove<address>(&mut arg0.operators, v1);
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_role_update(1, arg1, false, arg2);
    }
    ...
    public fun extract_reward_bank<T0, T1>(arg0: &Farming, arg1: &Pool<T0>, arg2: &mut RewardBank<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_reward_bank_extract(pool_id<T0>(arg1), reward_bank_id<T1>(arg2), 0x1::type_name::with_defining_ids<T1>(), v0, arg4);
    ...
    public fun fund_reward_bank<T0, T1>(arg0: &Farming, arg1: &Pool<T0>, arg2: &mut RewardBank<T1>, arg3: 0x2::coin::Coin<T1>, arg4: &0x2::tx_context::TxContext) : u64 {
        assert_version(arg0);
        assert_banker(arg0, arg4);
        assert_reward_bank<T0, T1>(arg1, arg2);
        let v0 = 0x2::coin::value<T1>(&arg3);
        0x2::balance::join<T1>(&mut arg2.reward_reserve, 0x2::coin::into_balance<T1>(arg3));
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_reward_bank_fund(pool_id<T0>(arg1), reward_bank_id<T1>(arg2), 0x1::type_name::with_defining_ids<T1>(), v0, arg4);
        v0
    }
    ...
    public fun get_claimable_rewards<T0>(arg0: &Pool<T0>, arg1: address, arg2: &0x2::clock::Clock) : vector<ClaimableReward> {
        ...
        while (v2 < 0x2::vec_map::length<0x1::type_name::TypeName, RewardConfig>(&arg0.reward_configs)) {
            ...
            let v5 = 0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_math::mul_div_down(v0.boost_shares, calc_pool_acc_reward_per_share(v4, arg0.total_boost_shares, 0x2::clock::timestamp_ms(arg2) / 1000), 1000000000000);
            ...
            if (v8 > 0) {
                let v9 = ClaimableReward{
                    ...
                    amount            : 0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_math::to_u64_saturating(v8),
                };
    ...
    public fun migrate(arg0: &mut Farming, arg1: &0x2::tx_context::TxContext) {
        assert_owner(arg0, arg1);
        assert!(arg0.version < 1, 20);
        arg0.version = 1;
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_migrate(arg0.version, arg1);
    }
    ...
    public fun pause<T0>(arg0: &Farming, arg1: &mut Pool<T0>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        assert_operator(arg0, arg3);
        update_pool_acc_reward_per_share<T0>(arg1, arg2);
        arg1.is_paused = true;
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_pool_pause(pool_id<T0>(arg1), arg3);
    }
    ...
    public fun resume<T0>(arg0: &Farming, arg1: &mut Pool<T0>, arg2: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        assert_operator(arg0, arg2);
        arg1.is_paused = false;
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_pool_resume(pool_id<T0>(arg1), arg2);
    }
    ...
    public fun set_boost<T0>(arg0: &Farming, arg1: &mut Pool<T0>, arg2: address, arg3: u128, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        ...
        let v2 = if (v0.shares == 0) {
            ...
            0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_math::checked_mul_u128(v0.shares, arg3) / 1000
        };
    ...
    public fun set_reward_config<T0, T1>(arg0: &Farming, arg1: &mut Pool<T0>, arg2: &RewardBank<T1>, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        ...
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_reward_config_update(pool_id<T0>(arg1), v2, v0, v1.start_time, v1.reward_per_second, v1.end_time, arg7);
    }
    ...
    public fun stake<T0>(arg0: &mut Farming, arg1: &mut Pool<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_stake(pool_id<T0>(arg1), v1, v0, arg1.total_shares, arg4);
    }
    ...
    public fun stake_adjust<T0>(arg0: &mut Farming, arg1: &mut Pool<T0>, arg2: address, arg3: u64, arg4: address, arg5: u128, arg6: bool, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg6) {
            0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_stake(pool_id<T0>(arg1), arg4, arg5, arg1.total_shares, arg8);
        } else {
            0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_unstake(pool_id<T0>(arg1), arg4, arg5, arg1.total_shares, arg8);
        };
    }
    ...
    public fun unstake<T0>(arg0: &mut Farming, arg1: &mut Pool<T0>, arg2: u128, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_events::emit_unstake(pool_id<T0>(arg1), v0, arg2, arg1.total_shares, arg4);
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.staked_balance, 0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_math::to_u64(arg2)), arg4)
    }
    ...
    fun update_position_debts<T0>(arg0: &Pool<T0>, arg1: &mut Position) {
        ...
        while (v0 < 0x2::vec_map::length<0x1::type_name::TypeName, RewardConfig>(&arg0.reward_configs)) {
            ...
            map_set_u128(v3, *v1, 0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_math::mul_div_down(arg1.boost_shares, v2.acc_reward_per_share, 1000000000000));
            v0 = v0 + 1;
        };
    }
    ...
    fun update_reward_config(arg0: &mut RewardConfig, arg1: u64, arg2: u128) {
        ...
        if (v4) {
            arg0.acc_reward_per_share = arg0.acc_reward_per_share + 0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_math::mul_div_down(0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_math::checked_mul_u128(((v3 - v2) as u128), (arg0.reward_per_second as u128)), 1000000000000, arg2);
        };
    ...
    fun update_user_position_pending<T0>(arg0: &Pool<T0>, arg1: &mut Position) {
        ...
        while (v0 < 0x2::vec_map::length<0x1::type_name::TypeName, RewardConfig>(&arg0.reward_configs)) {
            let (v1, v2) = 0x2::vec_map::get_entry_by_idx<0x1::type_name::TypeName, RewardConfig>(&arg0.reward_configs, v0);
            let v3 = 0x7018bee5f4190741b1f76d05bf2ed7e5f4f6a2fa2a1e1e4a62d67bf2a0278e54::farming_math::mul_div_down(arg1.boost_shares, v2.acc_reward_per_share, 1000000000000);
