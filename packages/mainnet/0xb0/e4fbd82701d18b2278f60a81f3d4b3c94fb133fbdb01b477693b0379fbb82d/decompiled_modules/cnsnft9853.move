module 0xb0e4fbd82701d18b2278f60a81f3d4b3c94fb133fbdb01b477693b0379fbb82d::cnsnft9853 {
    struct CNSNFT9853 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9853, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9853>(arg0, arg1);
