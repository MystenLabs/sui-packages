module 0x6f1f094263ee2ede57427387e2d2a2ee9cdae47d9feeb7e7ea028c319c029f1f::claimup {
    ...
    public fun admin_direct_transfer_from_pool(arg0: &mut EventPool, arg1: &0x2::clock::Clock, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg3), 101);
        assert!(arg0.is_active, 106);
        assert!(0x2::table::contains<address, WinnerInfo>(&arg0.winners, arg2), 103);
        let v0 = 0x2::table::borrow_mut<address, WinnerInfo>(&mut arg0.winners, arg2);
        assert!(!v0.claimed, 104);
        let v1 = v0.reward_amount;
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.balance) >= v1, 105);
        v0.claimed = true;
        ...
        let v2 = RewardReceipt{
            id           : 0x2::object::new(arg3),
            image_url    : arg0.image_url,
            project_name : v0.project_name,
            project_link : v0.project_link,
            amount       : v1,
            claimed_at   : 0x2::clock::timestamp_ms(arg1),
        };
        0x2::transfer::transfer<RewardReceipt>(v2, arg2);
    }
