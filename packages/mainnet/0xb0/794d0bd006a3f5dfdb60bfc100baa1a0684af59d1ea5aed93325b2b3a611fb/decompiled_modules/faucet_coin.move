module 0xb0794d0bd006a3f5dfdb60bfc100baa1a0684af59d1ea5aed93325b2b3a611fb::faucet_coin {
    ...
    public entry fun faucet(arg0: &mut FaucetCoin, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<FAUCET_COIN>(&arg0.coin) >= 10000, 0);
    ...
    fun init(arg0: FAUCET_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCET_COIN>(arg0, 6, b"TC", b"test_coin", b"for test", 0x1::option::none<0x2::url::Url>(), arg1);
