module 0xb0ff0f2741a27cf6a10b67fff1717e9f9bced9ae215b00e183fc5e6b168cbd08::cnsnft5305 {
    struct CNSNFT5305 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5305, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3732"));
        let v4 = 0x2::package::claim<CNSNFT5305>(arg0, arg1);
