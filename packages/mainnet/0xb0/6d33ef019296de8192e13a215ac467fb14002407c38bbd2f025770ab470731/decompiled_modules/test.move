module 0xb06d33ef019296de8192e13a215ac467fb14002407c38bbd2f025770ab470731::test {
    ...
    public entry fun mint(arg0: &mut EventConfig, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0xb06d33ef019296de8192e13a215ac467fb14002407c38bbd2f025770ab470731::nft::new(arg3, arg4, arg5, arg1, arg7);
        0x2::dynamic_field::add<0x1::string::String, u64>(0xb06d33ef019296de8192e13a215ac467fb14002407c38bbd2f025770ab470731::nft::uid_mut_as_owner(&mut v1), count_key(), 1);
        0x2::dynamic_field::add<0x1::string::String, 0x2::vec_set::VecSet<0x1::string::String>>(0xb06d33ef019296de8192e13a215ac467fb14002407c38bbd2f025770ab470731::nft::uid_mut_as_owner(&mut v1), date_key(), 0x2::vec_set::singleton<0x1::string::String>(arg6));
        0x2::transfer::public_transfer<0xb06d33ef019296de8192e13a215ac467fb14002407c38bbd2f025770ab470731::nft::CoCoNFT>(v1, 0x2::tx_context::sender(arg7));
    }
