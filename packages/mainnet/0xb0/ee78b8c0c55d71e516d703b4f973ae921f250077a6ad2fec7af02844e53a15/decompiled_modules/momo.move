module 0xb0ee78b8c0c55d71e516d703b4f973ae921f250077a6ad2fec7af02844e53a15::momo {
    ...
    fun init(arg0: MOMO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/ethereum/0xd323e5804b5e240aba36bc30885ebf090fcc821a.png?size=lg&key=e75ff3                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<MOMO>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MOMO    ")))), trim_right(b"Momo                            "), trim_right(b"Ballze's new dog, Momo!                                                                                                                                                                                                                                                                                                         "), v2, arg1);
        let v5 = v3;
