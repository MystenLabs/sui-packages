module 0xb0967c3ae81cc0057097e225f5cd2038d826d088f34f358bba2153da22489513::cnsnft8676 {
    struct CNSNFT8676 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8676, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8676>(arg0, arg1);
