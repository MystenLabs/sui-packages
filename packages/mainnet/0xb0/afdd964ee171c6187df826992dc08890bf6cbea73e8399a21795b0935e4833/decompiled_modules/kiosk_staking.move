module 0xb0afdd964ee171c6187df826992dc08890bf6cbea73e8399a21795b0935e4833::kiosk_staking {
    ...
    public fun admin_force_unstake<T0: store + key>(arg0: &AdminCap, arg1: &mut Global, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x2::object::ID, StakedItemInfo>(&arg1.staked, arg4), 2);
        let v0 = 0x2::table::borrow<0x2::object::ID, StakedItemInfo>(&arg1.staked, arg4);
        let v1 = 0x2::object::id<0x2::kiosk::Kiosk>(arg2);
        assert!(v1 == v0.kiosk_id, 6);
        assert_type_matches<T0>(v0);
        let v2 = 0x2::clock::timestamp_ms(arg5);
        let v3 = v2 - v0.staked_at;
        assert!(0x2::kiosk::has_item_with_type<T0>(arg2, arg4), 2);
        assert!(!0x2::kiosk::is_listed(arg2, arg4), 7);
        let (v4, v5) = 0x2::kiosk::borrow_val<T0>(arg2, arg3, arg4);
        0x2::kiosk::return_val<T0>(arg2, v4, v5);
        let v6 = 0x2::table::remove<0x2::object::ID, StakedItemInfo>(&mut arg1.staked, arg4);
        dec_active(arg1, v6.staker);
        let v7 = ForceUnstaked{
            kiosk       : v1,
            item        : arg4,
            at          : v2,
            staker      : v6.staker,
        ...
        0x2::event::emit<ForceUnstaked>(v7);
    }

    public fun admin_purge_if_missing<T0: store + key>(arg0: &AdminCap, arg1: &mut Global, arg2: &0x2::kiosk::Kiosk, arg3: 0x2::object::ID) {
        ...
        assert!(0x2::object::id<0x2::kiosk::Kiosk>(arg2) == v0.kiosk_id, 6);
        assert_type_matches<T0>(v0);
        assert!(!0x2::kiosk::has_item_with_type<T0>(arg2, arg3), 5);
        let v1 = 0x2::table::remove<0x2::object::ID, StakedItemInfo>(&mut arg1.staked, arg3);
        dec_active(arg1, v1.staker);
    }
    ...
    fun init(arg0: KIOSK_STAKING, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Global{
            ...
            enabled                 : true,
            min_staking_duration_ms : 1728000000,
        ...
        0x2::transfer::public_share_object<Global>(v1);
    }
    ...
    public fun owner_cleanup_orphan<T0: store + key>(arg0: &mut Global, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID) {
        assert!(0x2::table::contains<0x2::object::ID, StakedItemInfo>(&arg0.staked, arg3), 2);
        let v0 = 0x2::table::borrow<0x2::object::ID, StakedItemInfo>(&arg0.staked, arg3);
        assert!(0x2::object::id<0x2::kiosk::Kiosk>(arg1) == v0.kiosk_id, 6);
        assert_type_matches<T0>(v0);
        assert!(!0x2::kiosk::has_item_with_type<T0>(arg1, arg3), 5);
        let v1 = 0x2::table::remove<0x2::object::ID, StakedItemInfo>(&mut arg0.staked, arg3);
        dec_active(arg0, v1.staker);
    }

    public fun stake<T0: store + key>(arg0: &mut Global, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.enabled, 1);
        let v0 = ensure_supported<T0>(arg0);
        assert!(0x2::kiosk::has_item_with_type<T0>(arg1, arg3), 2);
        assert!(0x2::kiosk::is_locked(arg1, arg3), 5);
        assert!(!0x2::kiosk::is_listed(arg1, arg3), 7);
        assert!(!0x2::table::contains<0x2::object::ID, StakedItemInfo>(&arg0.staked, arg3), 4);
        let (v1, v2) = 0x2::kiosk::borrow_val<T0>(arg1, arg2, arg3);
        let v3 = 0x2::object::id<0x2::kiosk::Kiosk>(arg1);
        let v4 = 0x2::tx_context::sender(arg5);
        let v5 = 0x2::clock::timestamp_ms(arg4);
        let v6 = StakedItemInfo{
            kiosk_id  : v3,
            staker    : v4,
            staked_at : v5,
            item_type : v0,
        };
        0x2::table::add<0x2::object::ID, StakedItemInfo>(&mut arg0.staked, arg3, v6);
        inc_active(arg0, v4);
        0x2::kiosk::return_val<T0>(arg1, v1, v2);
        let v7 = Staked{
            kiosk            : v3,
            item             : arg3,
            at               : v5,
    ...
    public fun unstake<T0: store + key>(arg0: &mut Global, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x2::object::ID, StakedItemInfo>(&arg0.staked, arg3), 2);
        let v0 = 0x2::table::borrow<0x2::object::ID, StakedItemInfo>(&arg0.staked, arg3);
        ...
        let v3 = v2 - v0.staked_at;
        assert!(v3 >= arg0.min_staking_duration_ms, 3);
        assert!(0x2::kiosk::has_item_with_type<T0>(arg1, arg3), 2);
        assert!(!0x2::kiosk::is_listed(arg1, arg3), 7);
        let (v4, v5) = 0x2::kiosk::borrow_val<T0>(arg1, arg2, arg3);
        0x2::kiosk::return_val<T0>(arg1, v4, v5);
        let v6 = 0x2::table::remove<0x2::object::ID, StakedItemInfo>(&mut arg0.staked, arg3);
        dec_active(arg0, v6.staker);
        let v7 = Unstaked{
            kiosk       : v1,
            item        : arg3,
            at          : v2,
