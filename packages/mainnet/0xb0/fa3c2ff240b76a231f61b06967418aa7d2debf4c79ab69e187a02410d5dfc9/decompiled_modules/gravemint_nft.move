module 0xb0fa3c2ff240b76a231f61b06967418aa7d2debf4c79ab69e187a02410d5dfc9::gravemint_nft {
    ...
    public entry fun add_to_whitelist(arg0: &mut Collection, arg1: &CollectionAdminCap, arg2: vector<address>) {
        let v0 = 0;
    ...
    public entry fun admin_mint_to_kiosk(arg0: &CollectionAdminCap, arg1: &mut Collection, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<NFT>, arg5: address, arg6: u64, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<vector<u8>>, arg10: vector<vector<u8>>, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1.current_supply < arg1.max_supply || arg1.max_supply == 0, 4);
    ...
    public entry fun clear_whitelist(arg0: &mut Collection, arg1: &CollectionAdminCap) {
    ...
    public fun is_whitelisted(arg0: &Collection, arg1: address) : bool {
    ...
    public entry fun mint(arg0: &mut Collection, arg1: &PlatformMintCap, arg2: u64, arg3: address, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<vector<u8>>, arg7: vector<vector<u8>>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0;
        while (v5 < 0x1::vector::length<vector<u8>>(&arg6)) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v4, 0x1::string::utf8(*0x1::vector::borrow<vector<u8>>(&arg6, v5)), 0x1::string::utf8(*0x1::vector::borrow<vector<u8>>(&arg7, v5)));
            v5 = v5 + 1;
        };
        let v6 = NFT{
            id            : v3,
        ...
        0x2::transfer::public_transfer<NFT>(v6, arg3);
    }
    ...
    public entry fun remove_from_whitelist(arg0: &mut Collection, arg1: &CollectionAdminCap, arg2: vector<address>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            let v1 = *0x1::vector::borrow<address>(&arg2, v0);
            if (0x2::vec_set::contains<address>(&arg0.whitelist, &v1)) {
    ...
    public entry fun rent_nft(arg0: &mut NFT, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3 * arg1;
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= v4, 6);
        let v5 = 0x2::tx_context::sender(arg4);
        let v6 = 0x2::clock::timestamp_ms(arg3) / 1000 + arg1 * 86400;
        let v7 = 0x1::string::utf8(b"_rental_renter");
        if (0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, v7)) {
            *0x2::dynamic_field::borrow_mut<0x1::string::String, address>(&mut arg0.id, v7) = v5;
        } else {
            0x2::dynamic_field::add<0x1::string::String, address>(&mut arg0.id, v7, v5);
        };
        if (0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, v2)) {
            *0x2::dynamic_field::borrow_mut<0x1::string::String, u64>(&mut arg0.id, v2) = v6;
        } else {
            0x2::dynamic_field::add<0x1::string::String, u64>(&mut arg0.id, v2, v6);
        };
        let v8 = 0x1::string::utf8(b"_rental_owner");
        let v9 = if (0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, v8)) {
            *0x2::dynamic_field::borrow<0x1::string::String, address>(&arg0.id, v8)
        } else {
            v5
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg2, v9);
        let v10 = NFTRented{
            nft_id      : 0x2::object::uid_to_inner(&arg0.id),
            owner       : v9,
            renter      : v5,
