module 0xb0fa3c2ff240b76a231f61b06967418aa7d2debf4c79ab69e187a02410d5dfc9::gravemint_edition_nft {
    ...
    public entry fun add_to_whitelist(arg0: &mut EditionCollection, arg1: &CollectionAdminCap, arg2: vector<address>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            let v1 = *0x1::vector::borrow<address>(&arg2, v0);
            if (!0x2::vec_set::contains<address>(&arg0.whitelist, &v1)) {
                0x2::vec_set::insert<address>(&mut arg0.whitelist, v1);
            };
            v0 = v0 + 1;
        };
    }
    ...
    public entry fun clear_whitelist(arg0: &mut EditionCollection, arg1: &CollectionAdminCap) {
        arg0.whitelist = 0x2::vec_set::empty<address>();
    }
    ...
    public fun is_whitelisted(arg0: &EditionCollection, arg1: address) : bool {
        0x2::vec_set::is_empty<address>(&arg0.whitelist) || 0x2::vec_set::contains<address>(&arg0.whitelist, &arg1)
    }
    ...
    public entry fun mint_edition(arg0: &mut EditionCollection, arg1: &mut MasterEdition, arg2: &PlatformMintCap, arg3: address, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::vec_set::is_empty<address>(&arg0.whitelist)) {
            assert!(0x2::vec_set::contains<address>(&arg0.whitelist, &arg3), 8);
        };
        ...
        if (arg0.mint_price > 0) {
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::balance::split<0x2::sui::SUI>(&mut v2, arg0.mint_price));
        };
    ...
    public entry fun platform_mint_edition_to_kiosk(arg0: &PlatformAdminCap, arg1: &mut EditionCollection, arg2: &mut MasterEdition, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<EditionNFT>, arg6: address, arg7: vector<vector<u8>>, arg8: vector<vector<u8>>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg2.current_supply < arg2.max_supply || arg2.max_supply == 0, 19);
    ...
    public entry fun remove_from_whitelist(arg0: &mut EditionCollection, arg1: &CollectionAdminCap, arg2: vector<address>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            let v1 = *0x1::vector::borrow<address>(&arg2, v0);
            if (0x2::vec_set::contains<address>(&arg0.whitelist, &v1)) {
                0x2::vec_set::remove<address>(&mut arg0.whitelist, &v1);
            };
            v0 = v0 + 1;
        };
    }
    ...
    public entry fun rent_edition(arg0: &mut EditionNFT, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2 * arg1;
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= v3, 6);
        let v4 = 0x2::tx_context::sender(arg4);
        let v5 = 0x2::clock::timestamp_ms(arg3) / 1000 + arg1 * 86400;
        let v6 = 0x1::string::utf8(b"_rental_renter");
        if (0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, v6)) {
            *0x2::dynamic_field::borrow_mut<0x1::string::String, address>(&mut arg0.id, v6) = v4;
        } else {
            0x2::dynamic_field::add<0x1::string::String, address>(&mut arg0.id, v6, v4);
        };
        if (0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, v0)) {
            *0x2::dynamic_field::borrow_mut<0x1::string::String, u64>(&mut arg0.id, v0) = v5;
        } else {
            0x2::dynamic_field::add<0x1::string::String, u64>(&mut arg0.id, v0, v5);
        };
        let v7 = *0x2::dynamic_field::borrow<0x1::string::String, address>(&arg0.id, 0x1::string::utf8(b"_rental_owner"));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg2, v7);
        let v8 = EditionRented{
            edition_id  : 0x2::object::uid_to_inner(&arg0.id),
            owner       : v7,
            renter      : v4,
            rental_end  : v5,
        ...
        0x2::event::emit<EditionRented>(v8);
    }
    ...
    public entry fun withdraw_payments(arg0: &mut EditionCollection, arg1: &CollectionAdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 6);
        let v1 = v0 * arg0.platform_fee_bps / 10000;
        let v2 = v0 - v1;
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.balance, v1), arg2), arg0.platform_fee_recipient);
        };
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.balance, v2), arg2), arg0.payment_recipient);
            let v3 = PaymentWithdrawn{
                collection_id : 0x2::object::uid_to_inner(&arg0.id),
                amount        : v2,
                recipient     : arg0.payment_recipient,
            };
            0x2::event::emit<PaymentWithdrawn>(v3);
        };
    }
