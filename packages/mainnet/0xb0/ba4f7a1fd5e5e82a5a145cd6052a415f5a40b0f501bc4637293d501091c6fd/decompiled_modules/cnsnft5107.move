module 0xb0ba4f7a1fd5e5e82a5a145cd6052a415f5a40b0f501bc4637293d501091c6fd::cnsnft5107 {
    struct CNSNFT5107 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5107, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5107>(arg0, arg1);
