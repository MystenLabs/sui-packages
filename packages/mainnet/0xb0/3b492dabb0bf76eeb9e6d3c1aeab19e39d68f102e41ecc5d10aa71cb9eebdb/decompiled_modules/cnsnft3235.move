module 0xb03b492dabb0bf76eeb9e6d3c1aeab19e39d68f102e41ecc5d10aa71cb9eebdb::cnsnft3235 {
    struct CNSNFT3235 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3235, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3235>(arg0, arg1);
