module 0x63d5fa6a5e173de759525146d52148a8aa38168d3daffbbbc0ad382487b7c1ec::vault {
    ...
    struct PartialWithdrawn has copy, drop {
        vault_id: 0x2::object::ID,
        position_id: 0x2::object::ID,
        share_bps: u64,
        amount_x: u64,
    ...
    public fun add_to_position<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultOwnerCap, arg2: &Registry, arg3: &mut 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::Pool<T0, T1>, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T1>, arg6: &0x2::clock::Clock, arg7: &0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::version::Version, arg8: &mut 0x2::tx_context::TxContext) {
        assert_version(arg2);
        ...
        0x2::balance::join<T0>(&mut arg0.balance_x, 0x2::coin::into_balance<T0>(arg4));
        0x2::balance::join<T1>(&mut arg0.balance_y, 0x2::coin::into_balance<T1>(arg5));
        ...
        assert!(is_in_range<T0, T1>(arg3, &v0), 36);
        let (v1, v2) = 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::liquidity::add_liquidity<T0, T1>(arg3, &mut v0, 0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg0.balance_x), arg8), 0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(&mut arg0.balance_y), arg8), 0, 0, arg6, arg7, arg8);
        0x2::balance::join<T0>(&mut arg0.balance_x, 0x2::coin::into_balance<T0>(v1));
        0x2::balance::join<T1>(&mut arg0.balance_y, 0x2::coin::into_balance<T1>(v2));
        0x1::option::fill<0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position>(&mut arg0.position, v0);
        let v3 = 0x2::balance::value<T0>(&arg0.balance_x) - 0x2::balance::value<T0>(&arg0.balance_x);
        let v4 = 0x2::balance::value<T1>(&arg0.balance_y) - 0x2::balance::value<T1>(&arg0.balance_y);
        assert!(v3 > 0 || v4 > 0, 38);
    ...
    public fun begin_rebalance_as_owner_v2<T0, T1>(arg0: &Registry, arg1: &mut Vault<T0, T1>, arg2: &VaultOwnerCap, arg3: &mut 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::Pool<T0, T1>, arg4: &0x2::clock::Clock, arg5: &0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::version::Version, arg6: &mut 0x2::tx_context::TxContext) : (0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position, RebalanceTicket) {
        ...
        let v0 = oor_since<T0, T1>(arg1);
        assert!(v0 != 0, 9);
        assert!(0x2::clock::timestamp_ms(arg4) >= v0 + 300000, 9);
    ...
    fun begin_rebalance_inner<T0, T1>(arg0: &Registry, arg1: &mut Vault<T0, T1>, arg2: &mut 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::version::Version, arg5: &mut 0x2::tx_context::TxContext) : (0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position, RebalanceTicket) {
        ...
        let v3 = 0x1::vector::empty<RewardDebt>();
        let v4 = 0;
        while (v4 < 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::reward_length(&v0)) {
            ...
            if (v5 > 0) {
                let v6 = RewardDebt{
                    coin_type : 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::reward_coin_type<T0, T1>(arg2, v4),
                    amount    : v5,
                };
                0x1::vector::push_back<RewardDebt>(&mut v3, v6);
            };
            v4 = v4 + 1;
        };
        let v7 = RewardDebtKey{dummy_field: false};
        if (0x2::dynamic_field::exists<RewardDebtKey>(&arg1.id, v7)) {
            let v8 = RewardDebtKey{dummy_field: false};
            0x2::dynamic_field::remove<RewardDebtKey, vector<u64>>(&mut arg1.id, v8);
        };
        let v9 = RewardDebtV2Key{dummy_field: false};
        if (0x2::dynamic_field::exists<RewardDebtV2Key>(&arg1.id, v9)) {
            let v10 = RewardDebtV2Key{dummy_field: false};
            0x2::dynamic_field::remove<RewardDebtV2Key, vector<RewardDebt>>(&mut arg1.id, v10);
        };
        let v11 = RewardDebtV2Key{dummy_field: false};
        0x2::dynamic_field::add<RewardDebtV2Key, vector<RewardDebt>>(&mut arg1.id, v11, v3);
        let v12 = 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::sqrt_price<T0, T1>(arg2);
        let v13 = RebalanceTicket{
            ...
            value_before        : position_value_in_y(v12, &v0) + idle_value_in_y<T0, T1>(arg1, v12),
            sqrt_price_snapshot : v12,
    ...
    public fun begin_rebalance_v2<T0, T1>(arg0: &Registry, arg1: &mut Vault<T0, T1>, arg2: &KeeperCap, arg3: &mut 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::Pool<T0, T1>, arg4: &0x2::clock::Clock, arg5: &0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::version::Version, arg6: &mut 0x2::tx_context::TxContext) : (0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position, RebalanceTicket) {
        ...
        let v0 = oor_since<T0, T1>(arg1);
        assert!(v0 != 0, 9);
        assert!(0x2::clock::timestamp_ms(arg4) >= v0 + keeper_wait_ms(arg1.config.delay_ms), 9);
        assert!(0x2::vec_map::contains<0x2::object::ID, PoolConfig>(&arg0.allowed_pools, &arg1.pool_id), 4);
        let v1 = pool_min_value(arg0, &arg1.pool_id);
        if (v1 > 0) {
            assert!(0x1::option::is_some<0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position>(&arg1.position), 16);
            assert!(total_value_in_y<T0, T1>(arg1, 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::sqrt_price<T0, T1>(arg3)) >= v1, 15);
        };
        begin_rebalance_inner<T0, T1>(arg0, arg1, arg3, arg4, arg5, arg6)
    }
    ...
    public fun end_rebalance<T0, T1>(arg0: &Registry, arg1: &mut Vault<T0, T1>, arg2: RebalanceTicket, arg3: 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position, arg4: &0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::Pool<T0, T1>, arg5: &0x2::clock::Clock) {
        ...
        let v15 = RewardDebtV2Key{dummy_field: false};
        let v16 = 0x2::dynamic_field::remove<RewardDebtV2Key, vector<RewardDebt>>(&mut arg1.id, v15);
        assert!(0x1::vector::is_empty<RewardDebt>(&v16), 31);
    ...
    public fun new_vault<T0, T1>(arg0: &Registry, arg1: &0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::Pool<T0, T1>, arg2: 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position, arg3: u32, arg4: u64, arg5: bool, arg6: bool, arg7: 0x1::option::Option<address>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : VaultOwnerCap {
        ...
        let v4 = OorSinceKey{dummy_field: false};
        0x2::dynamic_field::add<OorSinceKey, u64>(&mut v3.id, v4, 0);
        let v5 = 0x2::object::id<Vault<T0, T1>>(&v3);
        ...
        if (0x1::option::is_some<address>(&v3.affiliate)) {
            let v8 = ReferralRecorded{
                vault_id  : v5,
                owner     : v3.beneficiary,
                affiliate : *0x1::option::borrow<address>(&v3.affiliate),
            };
            0x2::event::emit<ReferralRecorded>(v8);
        };
    ...
    fun settle_reward_debt<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x1::type_name::TypeName, arg2: u64) {
        ...
        assert!(0x2::dynamic_field::exists<RewardDebtV2Key>(&arg0.id, v0), 31);
        ...
        assert!(remove_first_matching(v2, arg1, arg2), 31);
    }

    fun share_of_liquidity(arg0: u128, arg1: u64) : u128 {
    ...
    public fun withdraw_partial<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultOwnerCap, arg2: &mut 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::Pool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::version::Version, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert_cap<T0, T1>(arg0, arg1);
        assert!(0x2::object::id<0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::Pool<T0, T1>>(arg2) == arg0.pool_id, 5);
        assert!(0x1::option::is_some<0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position>(&arg0.position), 16);
        assert!(arg3 > 0 && arg3 < 10000, 37);
        let v0 = 0x1::option::extract<0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position>(&mut arg0.position);
        let v1 = share_of_liquidity(0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::liquidity(&v0), arg3);
        let (v2, v3) = if (v1 > 0) {
            0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::liquidity::remove_liquidity<T0, T1>(arg2, &mut v0, v1, 0, 0, arg4, arg5, arg6)
        } else {
        ...
        let v5 = v2;
        0x1::option::fill<0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position>(&mut arg0.position, v0);
        let v6 = mul_div_to_u64(0x2::balance::value<T0>(&arg0.balance_x), arg3, 10000);
        let v7 = mul_div_to_u64(0x2::balance::value<T1>(&arg0.balance_y), arg3, 10000);
        if (v6 > 0) {
            0x2::coin::join<T0>(&mut v5, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance_x, v6), arg6));
        };
        if (v7 > 0) {
            0x2::coin::join<T1>(&mut v4, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.balance_y, v7), arg6));
        };
        let v8 = 0x2::coin::value<T0>(&v5);
        let v9 = 0x2::coin::value<T1>(&v4);
        assert!(v8 > 0 || v9 > 0, 38);
        let v10 = PartialWithdrawn{
            vault_id    : 0x2::object::id<Vault<T0, T1>>(arg0),
            position_id : 0x2::object::id<0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position>(&v0),
            share_bps   : arg3,
            amount_x    : v8,
        ...
        0x2::event::emit<PartialWithdrawn>(v10);
        (v5, v4)
    }
