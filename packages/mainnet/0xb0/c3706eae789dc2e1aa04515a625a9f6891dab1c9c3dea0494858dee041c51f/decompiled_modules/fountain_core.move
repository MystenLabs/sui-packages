module 0xb0c3706eae789dc2e1aa04515a625a9f6891dab1c9c3dea0494858dee041c51f::fountain_core {
    ...
    public fun claim<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut Fountain<T0, T1>, arg2: &mut StakeProof<T0, T1>) : 0x2::balance::Balance<T1> {
        ...
        let v0 = (0xb0c3706eae789dc2e1aa04515a625a9f6891dab1c9c3dea0494858dee041c51f::math::mul_factor_u128((arg2.stake_weight as u128), arg1.cumulative_unit - arg2.start_uint, 18446744073709551616) as u64);
        if (v0 > 0) {
    ...
    fun collect_resource<T0, T1>(arg0: &mut Fountain<T0, T1>, arg1: 0x2::balance::Balance<T1>) {
        ...
        if (v0 > 0) {
            ...
            arg0.cumulative_unit = arg0.cumulative_unit + 0xb0c3706eae789dc2e1aa04515a625a9f6891dab1c9c3dea0494858dee041c51f::math::mul_factor_u128((v0 as u128), 18446744073709551616, (arg0.total_weight as u128));
        } else {
    ...
    public fun get_virtual_released_amount<T0, T1>(arg0: &Fountain<T0, T1>, arg1: u64) : u64 {
        if (arg1 > arg0.latest_release_time) {
            let v1 = 0xb0c3706eae789dc2e1aa04515a625a9f6891dab1c9c3dea0494858dee041c51f::math::mul_factor(arg0.flow_amount, arg1 - arg0.latest_release_time, arg0.flow_interval);
            let v2 = v1;
    ...
    fun release_resource<T0, T1>(arg0: &mut Fountain<T0, T1>, arg1: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        if (v0 > arg0.latest_release_time) {
            let v2 = 0xb0c3706eae789dc2e1aa04515a625a9f6891dab1c9c3dea0494858dee041c51f::math::mul_factor(arg0.flow_amount, v0 - arg0.latest_release_time, arg0.flow_interval);
            let v3 = v2;
    ...
    public fun stake<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut Fountain<T0, T1>, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : StakeProof<T0, T1> {
        ...
        let v1 = 0xb0c3706eae789dc2e1aa04515a625a9f6891dab1c9c3dea0494858dee041c51f::math::compute_weight(v0, arg3, arg1.min_lock_time, arg1.max_lock_time);
