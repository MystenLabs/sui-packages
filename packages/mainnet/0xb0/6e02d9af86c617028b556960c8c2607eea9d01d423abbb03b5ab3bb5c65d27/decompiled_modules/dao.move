module 0xb06e02d9af86c617028b556960c8c2607eea9d01d423abbb03b5ab3bb5c65d27::dao {
    ...
    public entry fun change_fund_status<T0>(arg0: &mut DAOFund<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 < arg0.fundraise_end_at && 0x2::balance::value<0x2::sui::SUI>(&arg0.balance) >= v1) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.dao_token_balance, ((arg0.total_supply * 10 / 100) as u64)), arg2), arg0.creator);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0xb06e02d9af86c617028b556960c8c2607eea9d01d423abbb03b5ab3bb5c65d27::dao_config::new_global_dao_fee_and_shared(arg0);
    }
    ...
    public entry fun set_platform_fee(arg0: &OperatorCap, arg1: &mut 0xb06e02d9af86c617028b556960c8c2607eea9d01d423abbb03b5ab3bb5c65d27::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0xb06e02d9af86c617028b556960c8c2607eea9d01d423abbb03b5ab3bb5c65d27::dao_config::set_platform_fee(arg1, arg2, arg3, arg4);
    }
