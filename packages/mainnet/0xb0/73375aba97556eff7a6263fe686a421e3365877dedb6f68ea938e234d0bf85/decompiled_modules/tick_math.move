module 0xb073375aba97556eff7a6263fe686a421e3365877dedb6f68ea938e234d0bf85::tick_math {
    ...
    public fun get_amounts_for_liquidity(arg0: u256, arg1: u256, arg2: u256, arg3: u128) : (u64, u64) {
        ...
        if (arg0 <= v0) {
            ((mul_div_u256((arg3 as u256), v1 - arg0, v1) as u64), 0)
        } else if (arg0 < v1) {
            ((mul_div_u256((arg3 as u256), v1 - arg0, v1) as u64), (mul_div_u256((arg3 as u256), arg0 - v0, arg0) as u64))
        } else {
            (0, (mul_div_u256((arg3 as u256), arg0 - v0, v0) as u64))
        }
    }
    ...
    public fun get_liquidity_for_amounts(arg0: u256, arg1: u256, arg2: u256, arg3: u64, arg4: u64) : u128 {
        ...
        if (arg0 <= v0) {
            (mul_div_u256((arg3 as u256), v1, v1 - arg0) as u128)
        } else if (arg0 < v1) {
            let v3 = (mul_div_u256((arg3 as u256), v1, v1 - arg0) as u128);
            let v4 = (mul_div_u256((arg4 as u256), arg0, arg0 - v0) as u128);
            if (v3 < v4) {
                v3
            } else {
                v4
            ...
            (mul_div_u256((arg4 as u256), arg0, arg0 - v0) as u128)
        }
    }
