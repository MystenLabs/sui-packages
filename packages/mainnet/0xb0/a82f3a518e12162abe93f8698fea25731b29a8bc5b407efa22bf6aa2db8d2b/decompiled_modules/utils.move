module 0xb0a82f3a518e12162abe93f8698fea25731b29a8bc5b407efa22bf6aa2db8d2b::utils {
    ...
    fun compare_struct<T0, T1>() : u8 {
        ...
        let v2 = 0xb0a82f3a518e12162abe93f8698fea25731b29a8bc5b407efa22bf6aa2db8d2b::comparator::compare_u8_vector(v0, v1);
        if (0xb0a82f3a518e12162abe93f8698fea25731b29a8bc5b407efa22bf6aa2db8d2b::comparator::is_greater_than(&v2)) {
            2
        } else {
            let v4 = 0xb0a82f3a518e12162abe93f8698fea25731b29a8bc5b407efa22bf6aa2db8d2b::comparator::compare_u8_vector(v0, v1);
            if (0xb0a82f3a518e12162abe93f8698fea25731b29a8bc5b407efa22bf6aa2db8d2b::comparator::is_equal(&v4)) {
                0
            } else {
                1
            }
