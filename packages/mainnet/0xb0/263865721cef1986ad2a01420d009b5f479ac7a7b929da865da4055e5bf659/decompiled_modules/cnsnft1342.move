module 0xb0263865721cef1986ad2a01420d009b5f479ac7a7b929da865da4055e5bf659::cnsnft1342 {
    struct CNSNFT1342 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1342, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1342>(arg0, arg1);
