module 0x316457eb0ccdfec8f0fae5c457093622dc5f696df26c71b1fdc01f5794a6a9f7::revs {
    ...
    fun init(arg0: REVS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<REVS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"REVS        ")))), trim_right(b"REVSHARE                        "), trim_right(b"Launch your token, set up automatic rewards distribution in SOL or any token, and get a professional landing page - all in one platform. No coding required. Start building your community today.                                                                                                                               "), v2, arg1);
