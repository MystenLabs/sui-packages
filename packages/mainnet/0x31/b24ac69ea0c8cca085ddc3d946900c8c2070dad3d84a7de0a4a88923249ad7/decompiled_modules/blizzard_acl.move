module 0x31b24ac69ea0c8cca085ddc3d946900c8c2070dad3d84a7de0a4a88923249ad7::blizzard_acl {
    ...
    public fun finish_transfer<T0>(arg0: BlizzardSuperAdmin<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x31b24ac69ea0c8cca085ddc3d946900c8c2070dad3d84a7de0a4a88923249ad7::blizzard_events::finish_super_admin_transfer(v0);
    }
    ...
    public fun new_admin<T0>(arg0: &mut BlizzardACL<T0>, arg1: &BlizzardSuperAdmin<T0>, arg2: &mut 0x2::tx_context::TxContext) : BlizzardAdmin<T0> {
        ...
        0x31b24ac69ea0c8cca085ddc3d946900c8c2070dad3d84a7de0a4a88923249ad7::blizzard_events::new_admin(0x2::object::uid_to_address(&v0.id));
        v0
    }
    ...
    public fun revoke<T0>(arg0: &mut BlizzardACL<T0>, arg1: &BlizzardSuperAdmin<T0>, arg2: address) {
        ...
        0x31b24ac69ea0c8cca085ddc3d946900c8c2070dad3d84a7de0a4a88923249ad7::blizzard_events::revoke_admin(arg2);
    }
    ...
    public fun start_transfer<T0>(arg0: &mut BlizzardSuperAdmin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.new_admin = arg1;
        0x31b24ac69ea0c8cca085ddc3d946900c8c2070dad3d84a7de0a4a88923249ad7::blizzard_events::start_super_admin_transfer(arg1, arg0.start);
    }
