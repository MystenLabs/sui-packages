module 0x31163e150371f65affa0491282091e30a5fc62d2012451a8ac38c99ed05a1ccd::test {
    ...
    fun init(arg0: TEST, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST>(arg0, 9, b"SUP", b"TEST", b"Test Token https://t.me/test", 0x1::option::none<0x2::url::Url>(), arg1);
