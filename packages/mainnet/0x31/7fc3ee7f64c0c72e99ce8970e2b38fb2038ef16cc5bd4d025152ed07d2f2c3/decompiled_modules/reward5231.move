module 0x317fc3ee7f64c0c72e99ce8970e2b38fb2038ef16cc5bd4d025152ed07d2f2c3::reward5231 {
    struct REWARD5231 has drop {
        dummy_field: bool,
    }

    struct TICKET_5231 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5231(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5231>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5231>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5231, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5231>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5231>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5231>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5231>>(v5, 0x2::tx_context::sender(arg1));
    }
