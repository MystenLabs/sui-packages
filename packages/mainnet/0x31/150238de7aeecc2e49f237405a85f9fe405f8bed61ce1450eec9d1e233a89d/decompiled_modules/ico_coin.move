module 0x31150238de7aeecc2e49f237405a85f9fe405f8bed61ce1450eec9d1e233a89d::ico_coin {
    struct ICO has drop {
        dummy_field: bool,
    }
    ...
    public fun get_lightweight_info() : (0x1::string::String, 0x1::string::String, u8) {
        (0x1::string::utf8(b"ROO"), 0x1::string::utf8(b"ROO Protocol"), 9)
    }
    ...
    public fun get_token_display_info() : (0x1::string::String, 0x1::string::String, u8, 0x1::string::String, 0x1::string::String) {
        (0x1::string::utf8(b"ROO Protocol"), 0x1::string::utf8(b"ROO"), 9, 0x1::string::utf8(b"10000000"), 0x1::string::utf8(b"https://magenta-quickest-fly-406.mypinata.cloud/ipfs/bafkreiatacmygy63ulv6r5gzqs4ic6l7fucsavftuzwhrquak6mldfax7m"))
    }

    fun init(arg0: ICO_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        let (v1, v2) = 0x2::coin::create_currency<ICO_COIN>(arg0, 9, b"ROO", b"ROO Protocol", b"ROO is a utility token built on Sui blockchain with advanced features including batch transfers, burn mechanisms, and Web3 wallet compatibility. ROO serves as the native utility token for the ROO ecosystem.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://magenta-quickest-fly-406.mypinata.cloud/ipfs/bafkreiatacmygy63ulv6r5gzqs4ic6l7fucsavftuzwhrquak6mldfax7m")), arg1);
        let v3 = v1;
        0x2::transfer::public_transfer<0x2::coin::Coin<ICO_COIN>>(0x2::coin::mint<ICO_COIN>(&mut v3, 2000000000000000, arg1), v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<ICO_COIN>>(0x2::coin::mint<ICO_COIN>(&mut v3, 3000000000000000, arg1), v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<ICO_COIN>>(0x2::coin::mint<ICO_COIN>(&mut v3, 5000000000000000, arg1), v0);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<ICO_COIN>>(v3, @0x0);
        0x2::transfer::public_transfer<0x2::coin::CoinMetadata<ICO_COIN>>(v2, v0);
        ...
        let v5 = TokenCreatedEvent{
            ...
            initial_holders : v4,
            decimals        : 9,
            symbol          : 0x1::string::utf8(b"ROO"),
            name            : 0x1::string::utf8(b"ROO Protocol"),
        };
