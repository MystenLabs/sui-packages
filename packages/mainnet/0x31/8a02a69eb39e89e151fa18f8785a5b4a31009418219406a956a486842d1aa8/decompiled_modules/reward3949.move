module 0x318a02a69eb39e89e151fa18f8785a5b4a31009418219406a956a486842d1aa8::reward3949 {
    struct REWARD3949 has drop {
        dummy_field: bool,
    }

    struct TICKET_3949 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3949(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3949>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3949>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3949, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3949>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3949>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3949>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3949>>(v5, 0x2::tx_context::sender(arg1));
    }
