module 0x31eb3e5a8cb10b132ed7efa0d9e15619f183d552af110684d1f0d7d9976959a5::cnsnft9183 {
    struct CNSNFT9183 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9183, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9183>(arg0, arg1);
