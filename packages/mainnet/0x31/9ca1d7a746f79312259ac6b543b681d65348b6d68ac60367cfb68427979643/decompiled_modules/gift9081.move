module 0x319ca1d7a746f79312259ac6b543b681d65348b6d68ac60367cfb68427979643::gift9081 {
    struct GIFT9081 has drop {
        dummy_field: bool,
    }

    struct TICKET_9081 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9081(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9081>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9081>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9081, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9081>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9081>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9081>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9081>>(v5, 0x2::tx_context::sender(arg1));
    }
