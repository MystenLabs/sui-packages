module 0x31737183e69c35cc559deb110b5f97a375653488f673402c3b40b7fdf8c35e48::fff {
    struct FFF has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: FFF, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<FFF>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"fff"));
