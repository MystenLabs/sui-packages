module 0x31be6ce419a1ca37f757735fd094c6c9c1d3ce7514ebde007dbebd0a618bf5fd::sui_logo {
    struct SUI_LOGO has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_LOGO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_LOGO>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"sui logo"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"1000"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreifmgr5tbwl74mhwgoaghcx7bgcurbjx4q254np7f7vhr5lsecxyui"));
