module 0x31efd9b36ae164ecbd63682416ab9ecf945d7d10ae362e68aaaf97aaeab10e17::capybara_lootbox {
    ...
    struct EmptyTransferPolicy<T0> has key {
        id: 0x2::object::UID,
    ...
    public fun mint_and_share_empty_transfer_policy(arg0: &mut 0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::transfer_policy::new<NFTLootbox>(arg0, arg1);
        let v2 = EmptyTransferPolicy<NFTLootbox>{
            id              : 0x2::object::new(arg1),
            transfer_policy : v0,
        };
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<NFTLootbox>>(v1, 0x2::tx_context::sender(arg1));
        0x2::transfer::share_object<EmptyTransferPolicy<NFTLootbox>>(v2);
    }
    ...
    public entry fun open_lootbox(arg0: &mut DataStorage, arg1: &0x2::random::Random, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &EmptyTransferPolicy<NFTLootbox>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        let (v1, v2) = 0x2::kiosk::purchase_with_cap<NFTLootbox>(arg3, 0x2::kiosk::list_with_purchase_cap<NFTLootbox>(arg3, arg4, arg2, 0, arg6), 0x2::coin::zero<0x2::sui::SUI>(arg6));
    ...
    public fun update_storage(arg0: &0x31efd9b36ae164ecbd63682416ab9ecf945d7d10ae362e68aaaf97aaeab10e17::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
