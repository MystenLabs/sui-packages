module 0x31363086e130d0495bd41284c04d1b4700c08b67e448f068b9cab483a2f682f3::utils {
    public fun get_description_nft() : vector<u8> {
        b"1,111 Bohos trying some wtf experiment."
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/QmYGktx1Xai7QhJ6MkQU1yDGMWs9pLpPRuW8ntPHCcdYvV/"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/QmViajBni3JayiwQcTXFXoHYJhAVXCLk9vQ5c81WTSmG9w/ "
    }
