module 0x311cfa09a29dc71600f81e7f8ea460dbab7070d925b3aa039f7ec1d13dc720c5::omni {
    ...
    fun init(arg0: OMNI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/93e198908002ae513646d1ee9f37d56b7e0b46cfa372dc616602fd3688c3410c?width=150&height=150&fit=crop&quality=95&format=auto                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<OMNI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"OMNI    ")))), trim_right(b"Omni Launch                     "), trim_right(b"Launch meme tokens on Cetus, Turbos with ultimate Omni Launch Bot.                                                                                                                                                                                                                                                              "), v2, arg1);
        let v5 = v3;
