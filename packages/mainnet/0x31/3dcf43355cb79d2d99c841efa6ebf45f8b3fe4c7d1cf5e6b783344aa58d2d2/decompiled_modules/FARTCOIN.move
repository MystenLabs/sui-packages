module 0x313dcf43355cb79d2d99c841efa6ebf45f8b3fe4c7d1cf5e6b783344aa58d2d2::FARTCOIN {
    struct FARTCOIN has drop {
        dummy_field: bool,
    }

    fun init(arg0: FARTCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<FARTCOIN>(arg0, 2, b"FARTCOIN", b"Fartcoin", b"Fartcoin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/Ngzb8hUn6DsBJIKnBnu-kO2Bo6LB1Grv_ZgvGzE4_Tw?ext=png")), arg1);
