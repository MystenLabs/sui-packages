module 0x31496bc96fb3a967f2bd7083d5e68a6cc2c6a145b6e56c983b6985a5f2e2be88::cnsnft1380 {
    struct CNSNFT1380 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1380, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1380>(arg0, arg1);
