module 0x319c63f7cc07dbf881db2557c8d4df18ade262bcf09154f13ca5757bd6b72f24::dao {
    ...
    fun effective_amount<T0, T1>(arg0: &mut DAO<T0, T1>, arg1: address, arg2: u64, arg3: bool) : u64 {
        let v0 = arg2;
        if (arg3 && arg2 + arg0.funded_amount > *0x2::table::borrow<address, u64>(&arg0.whitelisted_addresses, arg1)) {
            v0 = *0x2::table::borrow<address, u64>(&arg0.whitelisted_addresses, arg1) - arg0.funded_amount;
        };
