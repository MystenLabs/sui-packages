module 0x7285a36371bfa08508b0580f61c30ff4f3dbd3a5747523313563492ff4b7ed8e::registry {
    ...
    public fun assert_output(arg0: &Registry, arg1: u64, arg2: u64) {
        ...
        assert!(0x7285a36371bfa08508b0580f61c30ff4f3dbd3a5747523313563492ff4b7ed8e::safe_math::mul_div_u64(v0, 0x7285a36371bfa08508b0580f61c30ff4f3dbd3a5747523313563492ff4b7ed8e::constants::scaling_pips(), arg1) <= arg0.max_output_delta_pips, 4);
    }
    ...
    public fun assert_price(arg0: &Registry, arg1: u128, arg2: u128) {
        ...
        assert!((0x7285a36371bfa08508b0580f61c30ff4f3dbd3a5747523313563492ff4b7ed8e::safe_math::mul_div_u128(v0, 0x7285a36371bfa08508b0580f61c30ff4f3dbd3a5747523313563492ff4b7ed8e::constants::scaling_pips_u128(), arg1) as u64) <= arg0.max_price_delta_pips, 3);
    }

    public(friend) fun assert_witness<T0>(arg0: &Registry) {
        assert!(arg0.version <= 0x7285a36371bfa08508b0580f61c30ff4f3dbd3a5747523313563492ff4b7ed8e::constants::current_version(), 0);
        let v0 = type_name<T0>();
    ...
    public fun collect_fees<T0, T1>(arg0: &mut Registry, arg1: &mut 0x2::balance::Balance<T0>, arg2: &mut 0x2::balance::Balance<T1>, arg3: u64) : (u64, u64) {
        let v0 = collect_minus_fee<T0>(arg0, arg1, arg3);
        (v0, collect_minus_fee<T1>(arg0, arg2, arg3))
    }

    fun collect_minus_fee<T0>(arg0: &mut Registry, arg1: &mut 0x2::balance::Balance<T0>, arg2: u64) : u64 {
        let v0 = 0x7285a36371bfa08508b0580f61c30ff4f3dbd3a5747523313563492ff4b7ed8e::safe_math::mul_div_u64(0x2::balance::value<T0>(arg1), arg2, 0x7285a36371bfa08508b0580f61c30ff4f3dbd3a5747523313563492ff4b7ed8e::constants::scaling_pips());
        let v1 = type_name<T0>();
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.fee_balances, v1)) {
            0x2::balance::join<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.fee_balances, v1), 0x2::balance::split<T0>(arg1, v0));
        } else {
            0x2::bag::add<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.fee_balances, v1, 0x2::balance::split<T0>(arg1, v0));
        };
        v0
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Registry{
            ...
            version               : 0x7285a36371bfa08508b0580f61c30ff4f3dbd3a5747523313563492ff4b7ed8e::constants::current_version(),
    ...
    public fun update_fee_configs(arg0: &mut Registry, arg1: vector<u64>, arg2: vector<u64>, arg3: vector<u64>, arg4: vector<u64>, arg5: &AdminCap) {
        ...
        while (v1 < 0x1::vector::length<u64>(&arg1)) {
            assert!(v0 <= *0x1::vector::borrow<u64>(&arg4, v1), 2);
            ...
            0x1::vector::push_back<FeeConfig>(&mut arg0.fee_configs, v2);
            v1 = v1 + 1;
        };
    }

    public fun update_max_output_delta_pips(arg0: &mut Registry, arg1: u64, arg2: &AdminCap) {
        assert!(arg1 < 0x7285a36371bfa08508b0580f61c30ff4f3dbd3a5747523313563492ff4b7ed8e::constants::scaling_pips(), 2);
