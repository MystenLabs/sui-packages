module 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_fixed_yield_oracle {
    ...
    public fun calculate_current_price<T0>(arg0: &FixedYieldOracle<T0>, arg1: u64) : u64 {
        ...
        arg0.initial_price + 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::mul_div((arg0.initial_price as u64) * arg0.annual_rate_bps, arg1 - arg0.start_timestamp, 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::seconds_per_year() * 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::bps_precision())
    }
    ...
    fun calculate_price_from_params(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        ...
        arg0 + 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::mul_div(arg0 * arg1, arg3 - arg2, 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::seconds_per_year() * 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::bps_precision())
    }
    ...
    public fun create_fixed_yield_oracle<T0>(arg0: 0x2::object::ID, arg1: address, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (FixedYieldOracleAdminCap, FixedYieldOracleManagerCap) {
        ...
        assert!(arg3 > 0, 3);
        assert!(arg4 <= 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::bps_precision(), 5);
        assert!(arg5 >= 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::min_cooldown_secs() && arg5 <= 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::max_cooldown_secs(), 5);
    ...
    public fun create_global_yield_state<T0>(arg0: &mut FixedYieldOracle<T0>, arg1: &FixedYieldOracleAdminCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::tx_context::TxContext) {
        ...
        assert!(arg2 > 0, 3);
        assert!(arg3 <= 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::bps_precision() && arg5 <= 1, 5);
    ...
    public fun propose_cooldown<T0>(arg0: &mut FixedYieldOracle<T0>, arg1: &FixedYieldOracleManagerCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(arg2 >= 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::min_cooldown_secs() && arg2 <= 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::max_cooldown_secs(), 5);
    ...
    public fun propose_global_yield_parameters<T0>(arg0: &mut FixedYieldOracle<T0>, arg1: &FixedYieldOracleManagerCap, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        assert!(arg3 > 0 && arg2 <= 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::bps_precision(), 5);
    ...
    public fun propose_yield_parameters<T0>(arg0: &mut FixedYieldOracle<T0>, arg1: &FixedYieldOracleManagerCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg4) == arg0.manager, 1);
        assert!(arg2 <= 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::bps_precision(), 5);
    ...
    public fun update_price_from_global_yield<T0, T1>(arg0: &mut FixedYieldOracle<T0>, arg1: &mut 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_vault::Vault<T0, T1>, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg6) == arg0.authority, 1);
        assert!(0x2::object::id<0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_vault::Vault<T0, T1>>(arg1) == arg0.vault_id, 5);
        let v0 = 0x2::object::id<FixedYieldOracle<T0>>(arg0);
        let v1 = global_state_mut<T0>(arg0);
        assert!(v1.oracle_id == v0 && v1.vault_id == 0x2::object::id<0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_vault::Vault<T0, T1>>(arg1), 5);
        ...
        assert!(arg2 >= 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::mul_div(v2, 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::bps_precision() - v1.tolerance_bps, 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::bps_precision()) && arg2 <= 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::mul_div(v2, 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::bps_precision() + v1.tolerance_bps, 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_math::bps_precision()), 3);
        v1.last_round_id = arg3;
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_vault::update_price_from_oracle_service<T0, T1>(arg1, arg2, arg5);
    ...
    public fun update_vault_price_from_yield<T0, T1>(arg0: &mut FixedYieldOracle<T0>, arg1: &mut 0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_vault::Vault<T0, T1>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_version<T0>(arg0);
        assert!(!has_global_state<T0>(arg0), 5);
        ...
        assert!(v0 > 0, 3);
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_vault::update_price_from_oracle_service<T0, T1>(arg1, v0, arg2);
