module 0x31063a9ff9f57c079400eee6d1dbc53717c60f3ef839ed8794028ff4d07f2ee5::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"TESTS", b"TESTS", b"", 0x1::option::none<0x2::url::Url>(), arg1);
