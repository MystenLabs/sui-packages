module 0x31ef62d67af0a007067bc0b1e2ae2c9d8b808f05ba66d382f1e96438c5050a29::reward8805 {
    struct REWARD8805 has drop {
        dummy_field: bool,
    }

    struct TICKET_8805 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8805(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8805>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8805>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8805, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8805>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8805>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8805>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8805>>(v5, 0x2::tx_context::sender(arg1));
    }
