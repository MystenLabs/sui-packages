module 0x3199f2a8aa719ffd5bdd84428a3be23272a703619cffd9cc64cd9ae3e1b57878::gift5056 {
    struct GIFT5056 has drop {
        dummy_field: bool,
    }

    struct TICKET_5056 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5056(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5056>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5056>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5056, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5056>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5056>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5056>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5056>>(v5, 0x2::tx_context::sender(arg1));
    }
