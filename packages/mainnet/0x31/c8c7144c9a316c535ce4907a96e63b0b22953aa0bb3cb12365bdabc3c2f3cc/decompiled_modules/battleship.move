module 0x31c8c7144c9a316c535ce4907a96e63b0b22953aa0bb3cb12365bdabc3c2f3cc::battleship {
    ...
    public fun game_over(arg0: &mut State, arg1: u256) {
        let v0 = 0x2::table::borrow_mut<u256, Game>(&mut arg0.games, arg1);
        assert!(*0x1::vector::borrow<u256>(&v0.hit_nonce, 0) == 2 || *0x1::vector::borrow<u256>(&v0.hit_nonce, 1) == 2, 4);
        assert!(v0.winner == 0x2::address::from_u256(0), 4);
        if (*0x1::vector::borrow<u256>(&v0.hit_nonce, 0) == 2) {
    ...
    public entry fun join_game(arg0: &mut State, arg1: u256, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x31c8c7144c9a316c535ce4907a96e63b0b22953aa0bb3cb12365bdabc3c2f3cc::board_verifier::verify(arg2, arg3) == true, 8);
        let v0 = 0x2::table::borrow_mut<u256, Game>(&mut arg0.games, arg1);
    ...
    public entry fun new_game(arg0: &mut State, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x31c8c7144c9a316c535ce4907a96e63b0b22953aa0bb3cb12365bdabc3c2f3cc::board_verifier::verify(arg1, arg2) == true, 8);
        let v0 = Game{
    ...
    public entry fun turn(arg0: &mut State, arg1: u256, arg2: u256, arg3: u256, arg4: u256, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x31c8c7144c9a316c535ce4907a96e63b0b22953aa0bb3cb12365bdabc3c2f3cc::shot_verify::verify(v3, arg5) == true, 9);
        ...
        if (*0x1::vector::borrow<u256>(&v0.hit_nonce, (v0.nonce - 1) % 2) >= 2) {
            game_over(arg0, arg1);
        } else {
