module 0x31e692b5beaa0ab92fe0a7a2f8502af6681f6d5f26d553c6f7db4b481969e3a5::ctx {
    struct CTX has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CTX, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CTX>(arg0, 9, b"SUI", b"SUI", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://s2.coinmarketcap.com/static/img/coins/64x64/20947.png")), arg1);
