module 0x31b54633ec11c438b4c0ead2fef3dd7964e129a2a20cb36cd0bba5babd9e7a5a::sgt {
    struct SGT has drop {
        dummy_field: bool,
    }
    ...
    public entry fun buy_nft(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: 0x2::object::ID, arg2: &mut SgtPlatform, arg3: &mut AMMPool, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 > 0, 3);
        let v2 = calculate_tax(calculate_token_out(v1, 0x2::balance::value<0x2::sui::SUI>(&arg3.sui_reserve), 0x2::balance::value<SGT>(&arg3.token_reserve)), 9000);
        if (0x2::balance::value<SGT>(&arg2.token_balance) >= v2 && v2 > 0) {
            0x2::balance::join<SGT>(&mut arg3.token_reserve, 0x2::balance::split<SGT>(&mut arg2.token_balance, v2));
        };
        assert!(0x2::table::length<0x2::object::ID, SgtNFT>(&arg2.nft_table) > 0, 10);
        let v3 = 0x2::coin::into_balance<0x2::sui::SUI>(arg0);
        0x2::balance::join<0x2::sui::SUI>(&mut arg3.sui_reserve, 0x2::balance::split<0x2::sui::SUI>(&mut v3, calculate_tax(v1, 4000)));
        0x2::balance::join<0x2::sui::SUI>(&mut arg2.operation_sui_balance, 0x2::balance::split<0x2::sui::SUI>(&mut v3, calculate_tax(v1, 500)));
        0x2::balance::join<0x2::sui::SUI>(&mut arg2.sui_balance, v3);
