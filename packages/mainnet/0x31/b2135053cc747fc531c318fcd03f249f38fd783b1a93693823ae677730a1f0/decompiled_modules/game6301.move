module 0x31b2135053cc747fc531c318fcd03f249f38fd783b1a93693823ae677730a1f0::game6301 {
    struct GAME6301 has drop {
        dummy_field: bool,
    }

    struct TICKET_6301 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6301(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6301>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6301>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME6301, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME6301>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6301>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6301>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6301>>(v5, 0x2::tx_context::sender(arg1));
    }
