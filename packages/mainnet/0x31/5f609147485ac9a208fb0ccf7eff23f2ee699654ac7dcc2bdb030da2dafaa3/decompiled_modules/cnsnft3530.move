module 0x315f609147485ac9a208fb0ccf7eff23f2ee699654ac7dcc2bdb030da2dafaa3::cnsnft3530 {
    struct CNSNFT3530 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3530, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3530>(arg0, arg1);
