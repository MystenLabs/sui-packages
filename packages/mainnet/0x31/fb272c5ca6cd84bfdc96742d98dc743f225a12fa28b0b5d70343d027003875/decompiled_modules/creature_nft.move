module 0x1f246b075220ec5f49435224ca862fa60c254b9c544c8961764b1bfe77bf8728::creature_nft {
    ...
    public entry fun mint_from_elements(arg0: &mut BrainrotCollection, arg1: 0x1::string::String, arg2: vector<u64>, arg3: vector<u64>, arg4: 0x1::string::String, arg5: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg6: address, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun mint_from_prompt(arg0: &AdminCap, arg1: &mut BrainrotCollection, arg2: 0x1::string::String, arg3: vector<u64>, arg4: vector<u64>, arg5: 0x1::string::String, arg6: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg7: address, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
