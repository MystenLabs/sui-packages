module 0x31b355b7ec1959b74461b0294ba60156af5e9031629e0b00056866908d076601::gift4612 {
    struct GIFT4612 has drop {
        dummy_field: bool,
    }

    struct TICKET_4612 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4612(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4612>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4612>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4612, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4612>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4612>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4612>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4612>>(v5, 0x2::tx_context::sender(arg1));
    }
