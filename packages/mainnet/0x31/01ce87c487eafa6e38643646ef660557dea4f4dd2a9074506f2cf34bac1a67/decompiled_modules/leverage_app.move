module 0x81fefef907d775faab48dbfd64cb7d37596ea5565de1850937c8807c2ce33f40::leverage_app {
    ...
    public(friend) fun ensure_version_matches(arg0: &LeverageApp) {
        assert!(arg0.version == 2, 0x81fefef907d775faab48dbfd64cb7d37596ea5565de1850937c8807c2ce33f40::leverage_error::version_mismatch());
    }
    ...
    public(friend) fun migrate(arg0: &mut LeverageApp) : u64 {
        assert!(arg0.version == 2 - 1, 0x81fefef907d775faab48dbfd64cb7d37596ea5565de1850937c8807c2ce33f40::leverage_error::version_mismatch());
        arg0.version = 2;
        2
    }
