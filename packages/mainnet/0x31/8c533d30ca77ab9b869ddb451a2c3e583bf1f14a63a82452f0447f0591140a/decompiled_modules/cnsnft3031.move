module 0x318c533d30ca77ab9b869ddb451a2c3e583bf1f14a63a82452f0447f0591140a::cnsnft3031 {
    struct CNSNFT3031 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3031, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3031>(arg0, arg1);
