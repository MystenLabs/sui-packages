module 0x3159234ccfdc6b5a81c0287f3d3e58e97b7b6057041daa01b2dfafede5a13597::vault {
    ...
    entry fun change_limit<T0>(arg0: &mut Vault<T0>, arg1: &0x3159234ccfdc6b5a81c0287f3d3e58e97b7b6057041daa01b2dfafede5a13597::owner_cap::OwnerCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun create_vault<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x3159234ccfdc6b5a81c0287f3d3e58e97b7b6057041daa01b2dfafede5a13597::owner_cap::create_owner_cap(&v0.id, 0x2::tx_context::sender(arg2), arg2);
    ...
    entry fun liquidate_vault<T0>(arg0: &mut Vault<T0>, arg1: &0x3159234ccfdc6b5a81c0287f3d3e58e97b7b6057041daa01b2dfafede5a13597::owner_cap::OwnerCap, arg2: &mut 0x2::tx_context::TxContext) {
        0x3159234ccfdc6b5a81c0287f3d3e58e97b7b6057041daa01b2dfafede5a13597::owner_cap::is_owned(&arg0.id, arg1);
