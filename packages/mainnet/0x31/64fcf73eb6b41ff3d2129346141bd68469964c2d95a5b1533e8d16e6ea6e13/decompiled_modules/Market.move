module 0x3164fcf73eb6b41ff3d2129346141bd68469964c2d95a5b1533e8d16e6ea6e13::Market {
    ...
    public fun buy_with_sui<T0: store + key>(arg0: &0x56714d6578dafaaec566c1483ac0fc5fb206b506455a8d59b043d67d243243eb::version::Version, arg1: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg2: &mut Listing<0x2::sui::SUI>, arg3: &mut 0x3164fcf73eb6b41ff3d2129346141bd68469964c2d95a5b1533e8d16e6ea6e13::marketplace::MarketPlace<0x2::sui::SUI>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v2 = 0x2::transfer_policy::new_request<T0>(arg2.nft, arg2.price, arg2.nft);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg1, &mut v2, 0x2::coin::take<0x2::sui::SUI>(v0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<T0>(arg1, arg2.price), arg5));
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(v0, arg2.price - v1, arg5), arg2.seller);
        let v6 = arg2.seller;
        let v7 = 0x2::tx_context::sender(arg5);
        assert!(v6 != v7, 2);
        let v8 = Item{id: arg2.nft};
        0x2::transfer::public_transfer<T0>(0x2::dynamic_field::remove<Item, T0>(&mut arg2.id, v8), v7);
        let v9 = BuyEvent<0x2::sui::SUI>{
            seller      : v6,
            buyer       : v7,
        ...
        0x2::event::emit<BuyEvent<0x2::sui::SUI>>(v9);
        arg4
    }
