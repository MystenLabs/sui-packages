module 0x3111aad23590a7ba7fd1a100f9589949a78bd409f3a8e70f3c787a4d8b7a3716::cnsnft6062 {
    struct CNSNFT6062 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6062, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6062>(arg0, arg1);
