module 0x3169910289fafe53160855fd1a486a8d548a85fb4be3ba7d0059b465f121a48e::cnsnft1999 {
    struct CNSNFT1999 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1999, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1999>(arg0, arg1);
