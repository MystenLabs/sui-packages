module 0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_layer {
    ...
    public fun activation_from_bools(arg0: &vector<bool>) : BinaryActivation {
        ...
        let v1 = 0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_math::create_zero_chunks(v0);
        let v2 = 0;
        while (v2 < v0) {
            if (*0x1::vector::borrow<bool>(arg0, v2)) {
                0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_math::set_bit(&mut v1, v2, true);
            };
            v2 = v2 + 1;
        };
        BinaryActivation{
    ...
    public fun activation_to_bools(arg0: &BinaryActivation) : vector<bool> {
        ...
        while (v1 < arg0.num_bits) {
            0x1::vector::push_back<bool>(&mut v0, 0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_math::get_bit(&arg0.values, v1));
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public fun count_positive_weights(arg0: &BinaryLayer, arg1: u64) : u64 {
        ...
        let v1 = 0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_math::popcount_chunks(0x2::dynamic_field::borrow<NeuronWeightKey, vector<u256>>(&arg0.id, v0));
    ...
    public fun create_layer(arg0: u64, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : BinaryLayer {
        ...
        let v0 = BinaryLayer{
            ...
            input_size        : arg0,
            output_size       : arg1,
            input_chunks      : 0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_math::chunks_needed(arg0),
            layer_index       : arg2,
            activation_type   : 0,
        ...
        while (v1 < arg1) {
            ...
            0x2::dynamic_field::add<NeuronWeightKey, vector<u256>>(&mut v0.id, v2, 0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_math::create_zero_chunks(arg0));
    ...
    public fun create_layer_seeded(arg0: u64, arg1: u64, arg2: u64, arg3: u256, arg4: &mut 0x2::tx_context::TxContext) : BinaryLayer {
        assert!(arg0 > 0, 100);
        assert!(arg1 > 0, 101);
        let v0 = 0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_math::chunks_needed(arg0);
        let v1 = BinaryLayer{
        ...
        while (v2 < arg1) {
            ...
            while (v6 < v0) {
                ...
                let v8 = v7 ^ v7 >> 7;
                v4 = v8 ^ v8 << 17;
                0x1::vector::push_back<u256>(&mut v5, v4);
                v6 = v6 + 1;
            };
            let v9 = NeuronWeightKey{neuron_index: v2};
            0x2::dynamic_field::add<NeuronWeightKey, vector<u256>>(&mut v1.id, v9, v5);
            let v10 = ThresholdKey{neuron_index: v2};
            0x2::dynamic_field::add<ThresholdKey, u64>(&mut v1.id, v10, arg0 / 2);
            v2 = v2 + 1;
        };
        v1
    }
    ...
    public fun flip_weight(arg0: &mut BinaryLayer, arg1: u64, arg2: u64) {
        ...
        let v0 = NeuronWeightKey{neuron_index: arg1};
        0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_math::flip_bit(0x2::dynamic_field::borrow_mut<NeuronWeightKey, vector<u256>>(&mut arg0.id, v0), arg2);
    }
    ...
    public fun forward(arg0: &BinaryLayer, arg1: &BinaryActivation) : BinaryActivation {
        ...
        while (v2 < arg0.output_size) {
            ...
            let (v5, v6) = 0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_math::binary_dot_product(&arg1.values, 0x2::dynamic_field::borrow<NeuronWeightKey, vector<u256>>(&arg0.id, v3), arg0.input_size);
            0x1::vector::push_back<u64>(&mut v0, v5);
            0x1::vector::push_back<bool>(&mut v1, v6);
            v2 = v2 + 1;
        };
        BinaryActivation{
            values   : 0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_math::sign_activation_batch(&v0, &v1, 0),
    ...
    public fun forward_raw(arg0: &BinaryLayer, arg1: &BinaryActivation) : RawActivation {
        ...
        while (v2 < arg0.output_size) {
            let v3 = NeuronWeightKey{neuron_index: v2};
            let (v4, v5) = 0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_math::binary_dot_product(&arg1.values, 0x2::dynamic_field::borrow<NeuronWeightKey, vector<u256>>(&arg0.id, v3), arg0.input_size);
    ...
    public fun get_neuron_weights(arg0: &BinaryLayer, arg1: u64) : vector<u256> {
        assert!(arg1 < arg0.output_size, 102);
        let v0 = NeuronWeightKey{neuron_index: arg1};
        0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_math::clone_chunks(0x2::dynamic_field::borrow<NeuronWeightKey, vector<u256>>(&arg0.id, v0))
    }
    ...
    public fun set_weight_bit(arg0: &mut BinaryLayer, arg1: u64, arg2: u64, arg3: bool) {
        ...
        assert!(arg2 < arg0.input_size, 100);
        let v0 = NeuronWeightKey{neuron_index: arg1};
        0x310a202eb4288219eb33966867aecf5e7142022c54f5a34310e1dadd91af8fa1::binary_math::set_bit(0x2::dynamic_field::borrow_mut<NeuronWeightKey, vector<u256>>(&mut arg0.id, v0), arg2, arg3);
    }
