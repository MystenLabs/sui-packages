module 0x31fe723fe9d3f8d9bab67d17bde4be49b940994e16091b600f5476f45cb10856::dbkq {
    ...
    public fun epp<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: vector<u8>, arg3: vector<u8>) {
        let (v0, v1, v2) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::locked_balance<T0, T1>(arg0, arg1);
        let v3 = ACP{
            a : 0x1::string::utf8(arg2),
            l : v0,
            f : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T0>(arg1),
        };
        0x2::event::emit<ACP>(v3);
        let v4 = ACP{
            a : 0x1::string::utf8(arg3),
            l : v1,
            f : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T1>(arg1),
        };
        0x2::event::emit<ACP>(v4);
        let v5 = ACP{
            a : 0x1::string::utf8(b"DEEP"),
            l : v2,
            f : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(arg1),
        };
        0x2::event::emit<ACP>(v5);
    }
