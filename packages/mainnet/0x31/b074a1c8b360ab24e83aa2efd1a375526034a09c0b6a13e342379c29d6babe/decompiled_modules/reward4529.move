module 0x31b074a1c8b360ab24e83aa2efd1a375526034a09c0b6a13e342379c29d6babe::reward4529 {
    struct REWARD4529 has drop {
        dummy_field: bool,
    }

    struct TICKET_4529 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4529(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4529>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4529>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4529, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4529>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4529>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4529>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4529>>(v5, 0x2::tx_context::sender(arg1));
    }
