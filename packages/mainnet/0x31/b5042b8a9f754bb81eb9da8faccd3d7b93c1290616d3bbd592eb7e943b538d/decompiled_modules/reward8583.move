module 0x31b5042b8a9f754bb81eb9da8faccd3d7b93c1290616d3bbd592eb7e943b538d::reward8583 {
    struct REWARD8583 has drop {
        dummy_field: bool,
    }

    struct TICKET_8583 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8583(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8583>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8583>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8583, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8583>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8583>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8583>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8583>>(v5, 0x2::tx_context::sender(arg1));
    }
