module 0x4a46a0c4d615d9d39f5be704b5ecab0e98dba1d48b5eb6165d4e18cc7f0eb63e::token_sale {
    ...
    struct TokenSale has key {
        id: 0x2::object::UID,
        tokens_for_sale: 0x2::balance::Balance<0x4a46a0c4d615d9d39f5be704b5ecab0e98dba1d48b5eb6165d4e18cc7f0eb63e::shttoken::SHTTOKEN>,
    ...
    public entry fun claim_tokens(arg0: &mut TokenSale, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        v1.claimed = true;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x4a46a0c4d615d9d39f5be704b5ecab0e98dba1d48b5eb6165d4e18cc7f0eb63e::shttoken::SHTTOKEN>>(0x2::coin::from_balance<0x4a46a0c4d615d9d39f5be704b5ecab0e98dba1d48b5eb6165d4e18cc7f0eb63e::shttoken::SHTTOKEN>(0x2::balance::split<0x4a46a0c4d615d9d39f5be704b5ecab0e98dba1d48b5eb6165d4e18cc7f0eb63e::shttoken::SHTTOKEN>(&mut arg0.tokens_for_sale, v2), arg2), v0);
    ...
    public entry fun deposit_tokens(arg0: &SaleAdminCap, arg1: &mut TokenSale, arg2: 0x2::coin::Coin<0x4a46a0c4d615d9d39f5be704b5ecab0e98dba1d48b5eb6165d4e18cc7f0eb63e::shttoken::SHTTOKEN>) {
        0x2::balance::join<0x4a46a0c4d615d9d39f5be704b5ecab0e98dba1d48b5eb6165d4e18cc7f0eb63e::shttoken::SHTTOKEN>(&mut arg1.tokens_for_sale, 0x2::coin::into_balance<0x4a46a0c4d615d9d39f5be704b5ecab0e98dba1d48b5eb6165d4e18cc7f0eb63e::shttoken::SHTTOKEN>(arg2));
        arg1.tokens_remaining = 0x2::balance::value<0x4a46a0c4d615d9d39f5be704b5ecab0e98dba1d48b5eb6165d4e18cc7f0eb63e::shttoken::SHTTOKEN>(&arg1.tokens_for_sale);
        let v0 = TokensDeposited{
            amount          : 0x2::coin::value<0x4a46a0c4d615d9d39f5be704b5ecab0e98dba1d48b5eb6165d4e18cc7f0eb63e::shttoken::SHTTOKEN>(&arg2),
    ...
    public fun get_phase_constants() : (u64, u64, u64) {
        (38000000000000000, 2000000000000000, 14400000)
    }
    ...
    public fun get_phase_status(arg0: &SalePhaseConfig, arg1: &0x2::clock::Clock) : (bool, bool, u64, u64, u64) {
        let v0 = if (arg0.whitelist_phase_active) {
            let v1 = arg0.whitelist_start_time + 14400000;
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = TokenSale{
            ...
            tokens_for_sale          : 0x2::balance::zero<0x4a46a0c4d615d9d39f5be704b5ecab0e98dba1d48b5eb6165d4e18cc7f0eb63e::shttoken::SHTTOKEN>(),
            tokens_remaining         : 0,
    ...
    public entry fun purchase_v2(arg0: &mut TokenSale, arg1: &mut SaleWhitelist, arg2: &mut SalePhaseConfig, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2.whitelist_phase_active) {
            if (0x2::clock::timestamp_ms(arg4) >= arg2.whitelist_start_time + 14400000) {
