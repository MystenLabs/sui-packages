module 0x316b5a66a59fdbfab57cb6041a2510e344b19a3b6da7274d5044242b23ee1200::reward9649 {
    struct REWARD9649 has drop {
        dummy_field: bool,
    }

    struct TICKET_9649 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9649(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9649>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9649>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9649, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9649>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9649>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9649>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9649>>(v5, 0x2::tx_context::sender(arg1));
    }
