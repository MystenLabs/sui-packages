module 0x3197abfef7dbed630f2cbae13cbf078a94904a95c0d44f06bfcece384d00687b::AgentO {
    ...
    fun init(arg0: AGENTO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<AGENTO>>(0x2::coin::split<AGENTO>(&mut v3, v4 * 50 / 100, arg1), @0x8da9a726eff987a854161291073eb95726ebc3fc83084f2846b3ec3afdebda76);
        0x2::transfer::public_transfer<0x2::coin::Coin<AGENTO>>(0x2::coin::split<AGENTO>(&mut v3, v4 * 20 / 100, arg1), @0x81450ed5bdbe2f9528560d2edb59cef5df40ab3ba335a947862334fadae1e108);
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<AGENTO>>(v2, @0x0);
    }
