module 0x3110164d8a9fd514cc224a7f81794753b421ae836218bba1da6faa7904f51d5f::cnsnft3302 {
    struct CNSNFT3302 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3302, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5564"));
        let v4 = 0x2::package::claim<CNSNFT3302>(arg0, arg1);
