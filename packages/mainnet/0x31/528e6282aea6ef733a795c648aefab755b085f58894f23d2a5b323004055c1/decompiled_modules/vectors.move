module 0x31528e6282aea6ef733a795c648aefab755b085f58894f23d2a5b323004055c1::vectors {
    public fun find_upper_bound(arg0: &vector<u64>, arg1: u64) : u64 {
        ...
        while (v0 < v1) {
            v1 = 0x31528e6282aea6ef733a795c648aefab755b085f58894f23d2a5b323004055c1::math::average(v0, v1);
    ...
    public fun gt(arg0: &vector<u8>, arg1: &vector<u8>) : bool {
        ...
        assert!(v1 == 0x1::vector::length<u8>(arg1), 112);
        while (v0 < v1) {
    ...
    public fun lt(arg0: &vector<u8>, arg1: &vector<u8>) : bool {
        let v0 = 0;
        let v1 = 0x1::vector::length<u8>(arg0);
        assert!(v1 == 0x1::vector::length<u8>(arg1), 0x1::vector::length<u8>(arg1));
        while (v0 < v1) {
            let v2 = *0x1::vector::borrow<u8>(arg0, v0);
            let v3 = *0x1::vector::borrow<u8>(arg1, v0);
            if (v2 < v3) {
