module 0x31528e6282aea6ef733a795c648aefab755b085f58894f23d2a5b323004055c1::merkle_proof {
    ...
    fun hash_pair(arg0: vector<u8>, arg1: vector<u8>) : vector<u8> {
        if (0x31528e6282aea6ef733a795c648aefab755b085f58894f23d2a5b323004055c1::vectors::lt(&arg0, &arg1)) {
    ...
    fun process_multi_proof(arg0: &vector<vector<u8>>, arg1: &vector<bool>, arg2: &vector<vector<u8>>) : vector<u8> {
        ...
        assert!(v0 + 0x1::vector::length<vector<u8>>(arg0) - 1 == v1, 111);
