module 0x3189485dc51b35a4bc6c563225890389babbaad9ba12ee9d2edef61b2db29c90::cnsnft2858 {
    struct CNSNFT2858 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2858, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2858>(arg0, arg1);
