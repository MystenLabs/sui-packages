module 0x316fbd1fa880298d2c9c03ea013a8a912edff0411a015b6f6f543100e796a25d::cnsnft4959 {
    struct CNSNFT4959 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4959, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4959>(arg0, arg1);
