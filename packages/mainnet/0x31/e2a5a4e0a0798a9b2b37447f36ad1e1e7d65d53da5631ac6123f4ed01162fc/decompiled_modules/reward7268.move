module 0x31e2a5a4e0a0798a9b2b37447f36ad1e1e7d65d53da5631ac6123f4ed01162fc::reward7268 {
    struct REWARD7268 has drop {
        dummy_field: bool,
    }

    struct TICKET_7268 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7268(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7268>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7268>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7268, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7268>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7268>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7268>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7268>>(v5, 0x2::tx_context::sender(arg1));
    }
