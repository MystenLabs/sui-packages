module 0x31dd562066d33b07af0b710b768f14b7c16e76952128dfb1cc459edf3316493d::cnsnft2190 {
    struct CNSNFT2190 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2190, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2190>(arg0, arg1);
