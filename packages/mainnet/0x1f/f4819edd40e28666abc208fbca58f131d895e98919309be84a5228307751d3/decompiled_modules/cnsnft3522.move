module 0x1ff4819edd40e28666abc208fbca58f131d895e98919309be84a5228307751d3::cnsnft3522 {
    struct CNSNFT3522 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3522, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4236"));
        let v4 = 0x2::package::claim<CNSNFT3522>(arg0, arg1);
