module 0x1f63febcfc0702a28d15b4a5a704ad25b5e583c8c6dc66fa668ac8a56e66598e::eat_fruit_fun {
    struct EAT_FRUIT_FUN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: EAT_FRUIT_FUN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<EAT_FRUIT_FUN>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Eat Fruit Fun"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Eat Fruit Fun $EAT is a playful and creative meme coin built on the Sui Network"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidfrkcatzzyceptzqvsckcidnsfw2vcabehz2dpffcve3nkiayfmq"));
