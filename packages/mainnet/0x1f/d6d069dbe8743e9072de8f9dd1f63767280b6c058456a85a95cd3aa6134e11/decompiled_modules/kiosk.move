module 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::kiosk {
    ...
    public fun accept_item_offer(arg0: &mut 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::fee_manager::FeeManager, arg1: &0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Collection, arg2: &mut Kiosk, arg3: u64, arg4: u64, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x2::dynamic_field::remove<u64, 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(&mut arg2.id, arg3);
        let v7 = 0x2::dynamic_field::remove<u64, 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(&mut arg2.id, get_offered_item_key(arg3, arg4));
        let v8 = 0x2::dynamic_field::remove<u64, 0x2::coin::Coin<0x2::sui::SUI>>(&mut arg2.id, get_gas_payment_key(arg3, arg4));
        let v9 = 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::get_item_id(&v6);
        let v10 = 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::get_item_id(&v7);
        assert!(v9 == v5.item_id, 8);
        assert!(v10 == v4.offered_item_id, 8);
        let v11 = 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::get_collection_owner(arg1);
        let (_, _, _, _, v16) = 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::fee_manager::get_fee_manager(arg0);
        ...
        let v19 = 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::fee_manager::calculate_item_swap_developer_royalty(arg0, v11, v18);
        if (v19 > 0) {
        ...
        if (0x2::coin::value<0x2::sui::SUI>(&v8) > 0) {
            0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::fee_manager::deposit_service_fee(arg0, v8, arg6);
        } else {
            0x2::coin::destroy_zero<0x2::sui::SUI>(v8);
        };
        let v20 = v4.offerer;
        0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::update_item_owner(&mut v6, v20);
        0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::update_item_owner(&mut v7, v0);
        0x2::transfer::public_transfer<0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(v6, v20);
        0x2::transfer::public_transfer<0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(v7, v0);
        v4.status = 2;
        v5.is_active = false;
    ...
    public fun admin_create_kiosk(arg0: &0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::role_manager::RoleManager, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::role_manager::has_role(arg0, 0x2::tx_context::sender(arg2), 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::role_manager::factory_role()), 1);
        let v0 = Kiosk{
    ...
    public fun buy_item_with_coins(arg0: &0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Collection, arg1: &mut Kiosk, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::fee_manager::FeeManager, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::dynamic_field::remove<u64, 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(&mut arg1.id, arg2);
        assert!(v3.is_active, 7);
        let v5 = 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::get_item_id(&v4);
        ...
        let v8 = v7;
        let v9 = 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::get_collection_owner(arg0);
        let v10 = 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::fee_manager::calculate_purchase_fee(arg4, v3.price);
        let v11 = 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::fee_manager::calculate_purchase_developer_royalty(arg4, v9, v3.price);
        assert!(v10 >= 0, 9);
        assert!(v11 >= 0, 9);
        let v12 = v10 + v11;
        ...
        if (v10 > 0) {
            0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::fee_manager::deposit_service_fee(arg4, 0x2::coin::split<0x2::sui::SUI>(&mut v8, v10, arg5), arg5);
        };
        if (v11 > 0) {
        ...
        0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::update_item_owner(&mut v4, v0);
        0x2::transfer::public_transfer<0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(v4, v0);
        v3.is_active = false;
    ...
    public fun cancel_item_offer(arg0: &mut Kiosk, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(0x2::dynamic_field::remove<u64, 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(&mut arg0.id, get_offered_item_key(arg1, arg2)), v0);
    ...
    public fun cancel_kiosk_item(arg0: &mut Kiosk, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x2::dynamic_field::remove<u64, 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(&mut arg0.id, arg1);
        assert!(0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::get_item_id(&v6) == v4, 8);
        0x2::transfer::public_transfer<0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(v6, v3);
        let v7 = KioskItem{
            id             : v5.id,
    ...
    public fun create_item_offer(arg0: &0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::fee_manager::FeeManager, arg1: &mut Kiosk, arg2: u64, arg3: 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = get_kiosk_item_key(arg2);
        assert!(0x2::dynamic_field::exists_<vector<u8>>(&arg1.id, v1), 4);
        let v2 = 0x2::dynamic_field::borrow<vector<u8>, KioskItem>(&arg1.id, v1);
        assert!(v2.is_active, 4);
        assert!(v0 != v2.seller, 6);
        let v3 = 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::get_item_id(&arg3);
        assert!(v3 != v2.item_id, 8);
        let (_, _, _, _, v8) = 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::fee_manager::get_fee_manager(arg0);
        ...
        0x2::dynamic_field::add<u64, 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(&mut arg1.id, get_offered_item_key(arg2, v10), arg3);
    ...
    public fun create_kiosk_item(arg0: &mut Kiosk, arg1: 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::get_item_id(&arg1);
        ...
        0x2::dynamic_field::add<u64, 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(&mut arg0.id, v2, arg1);
    ...
    public fun reject_all_other_offers(arg0: &mut 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::role_manager::RoleManager, arg1: &mut Kiosk, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::role_manager::has_role(arg0, 0x2::tx_context::sender(arg4), 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::role_manager::factory_role()), 1);
        let v0 = 1;
        while (v0 <= 1000) {
            if (v0 != arg3) {
                ...
                if (0x2::dynamic_field::exists_<u64>(&arg1.id, v1)) {
                    if (0x2::dynamic_field::borrow<u64, KioskItemOffer>(&arg1.id, v1).status == 1) {
                        ...
                        0x2::transfer::public_transfer<0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(0x2::dynamic_field::remove<u64, 0x1fd6d069dbe8743e9072de8f9dd1f63767280b6c058456a85a95cd3aa6134e11::item::Item>(&mut arg1.id, get_offered_item_key(arg2, v0)), v2.offerer);
