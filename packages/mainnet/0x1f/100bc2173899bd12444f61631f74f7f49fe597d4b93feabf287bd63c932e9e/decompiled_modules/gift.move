module 0x1f100bc2173899bd12444f61631f74f7f49fe597d4b93feabf287bd63c932e9e::gift {
    ...
    fun init(arg0: GIFT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<GIFT>(arg0, 9, b"Sui36.com", b"Sui36.com", b"Exchange at sui36.com", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://jsoncdn.com/sui/cnft.png")), arg1);
