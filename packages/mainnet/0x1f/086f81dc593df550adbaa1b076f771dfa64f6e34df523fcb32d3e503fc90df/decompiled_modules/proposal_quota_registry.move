module 0x1f086f81dc593df550adbaa1b076f771dfa64f6e34df523fcb32d3e503fc90df::proposal_quota_registry {
        ...
        while (v2 < 0x1::vector::length<address>(&arg2)) {
            ...
            if (v0) {
                ...
                if (v7) {
                    ...
                    assert!(0x1::vector::length<QuotaEntry>(&arg0.quotas) < 0xcc850ba260a5e370a0e98b96db02037f6b84893754b6c6c198f3e4f24feea81e::constants::max_quota_entries(), 1);
                    let v19 = QuotaEntry{
                        user : v3,
                        info : v6,
                    };
