module 0x1f8fb9507325b619bc7b0a766c21502e70000f6bbc6293d318a9a542fbd5a737::reward4596 {
    struct REWARD4596 has drop {
        dummy_field: bool,
    }

    struct TICKET_4596 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4596(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4596>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4596>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4596, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4596>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4596>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4596>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4596>>(v5, 0x2::tx_context::sender(arg1));
    }
