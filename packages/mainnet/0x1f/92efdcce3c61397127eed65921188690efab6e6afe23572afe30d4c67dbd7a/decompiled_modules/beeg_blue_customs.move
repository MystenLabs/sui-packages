module 0x1f92efdcce3c61397127eed65921188690efab6e6afe23572afe30d4c67dbd7a::beeg_blue_customs {
    ...
    fun init(arg0: BEEG_BLUE_CUSTOMS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BEEG_BLUE_CUSTOMS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Beeg Blue Customs"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Beeg Blue Customs is a specially designed collection for Sui OGs and KOLs. Holders of these NFTs have a say in Beeg Blue DAO governance."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreigututw2vw6nh2mbmfl3voqlosq3ousokpwdmd2kdf2ks6g3uskam"));
