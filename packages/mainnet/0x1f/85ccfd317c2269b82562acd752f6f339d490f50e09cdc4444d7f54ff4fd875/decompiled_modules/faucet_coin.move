module 0x1f85ccfd317c2269b82562acd752f6f339d490f50e09cdc4444d7f54ff4fd875::faucet_coin {
    struct FAUCET_COIN has drop {
        dummy_field: bool,
    }

    fun init(arg0: FAUCET_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCET_COIN>(arg0, 8, b"FaucetCoin", b"faucet coin", b"this is faucet coin", 0x1::option::none<0x2::url::Url>(), arg1);
