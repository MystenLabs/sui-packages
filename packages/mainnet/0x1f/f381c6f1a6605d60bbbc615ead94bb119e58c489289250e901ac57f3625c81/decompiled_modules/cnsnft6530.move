module 0x1ff381c6f1a6605d60bbbc615ead94bb119e58c489289250e901ac57f3625c81::cnsnft6530 {
    struct CNSNFT6530 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6530, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6530>(arg0, arg1);
