module 0x1fa69b0a97dd11d89790cd56494250cd4a16b99a4fc1567e0c54a238b5978bbe::elonius {
    struct ELONIUS has drop {
        dummy_field: bool,
    }

    public entry fun burn(arg0: &mut 0x2::coin::TreasuryCap<ELONIUS>, arg1: 0x2::coin::Coin<ELONIUS>) {
        0x2::coin::burn<ELONIUS>(arg0, arg1);
    }

    fun mint_and_transfer(arg0: &mut 0x2::coin::TreasuryCap<ELONIUS>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::mint_and_transfer<ELONIUS>(arg0, arg1, arg2, arg3);
    }
