module 0x1fbb21c35b78f2a5e0caa93bb5c4ca031505e055df58d5d8d6a932c7dc7e657b::cnsnft6161 {
    struct CNSNFT6161 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6161, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6161>(arg0, arg1);
