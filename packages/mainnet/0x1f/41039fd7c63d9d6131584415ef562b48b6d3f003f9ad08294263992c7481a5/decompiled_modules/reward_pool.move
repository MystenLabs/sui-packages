module 0x1f41039fd7c63d9d6131584415ef562b48b6d3f003f9ad08294263992c7481a5::reward_pool {
    ...
    public(friend) fun new<T0>(arg0: u64, arg1: u64) : RewardPool<T0> {
        assert!(arg1 > 0, 0x1f41039fd7c63d9d6131584415ef562b48b6d3f003f9ad08294263992c7481a5::app_error::reward_exchange_rate_numerator_zero());
        RewardPool<T0>{
    ...
    public(friend) fun update_reward_pool<T0>(arg0: &mut RewardPool<T0>, arg1: u64, arg2: u64) {
        assert!(arg2 > 0, 0x1f41039fd7c63d9d6131584415ef562b48b6d3f003f9ad08294263992c7481a5::app_error::reward_exchange_rate_numerator_zero());
