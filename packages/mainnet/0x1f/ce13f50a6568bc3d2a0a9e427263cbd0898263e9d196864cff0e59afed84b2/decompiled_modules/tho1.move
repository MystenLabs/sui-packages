module 0x1fce13f50a6568bc3d2a0a9e427263cbd0898263e9d196864cff0e59afed84b2::tho1 {
    struct THO1 has drop {
        dummy_field: bool,
    }

    public entry fun burn(arg0: &mut 0x2::coin::TreasuryCap<THO1>, arg1: 0x2::coin::Coin<THO1>) {
        0x2::coin::burn<THO1>(arg0, arg1);
    }
