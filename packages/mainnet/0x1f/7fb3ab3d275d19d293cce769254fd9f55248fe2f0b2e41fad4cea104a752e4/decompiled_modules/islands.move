module 0x81d7c71f84b6bcf810b67cea876b3af2952455ab9fb562a1e501353da77b0cfa::islands {
    ...
    struct WorldItem has store, key {
        id: 0x2::object::UID,
        name: 0x1::string::String,
        description: 0x1::string::String,
        image_url: 0x2::url::Url,
    ...
    struct WorldItemMinted has copy, drop {
        id: 0x2::object::ID,
        mint_cap_id: 0x2::object::ID,
        name: 0x1::string::String,
        created_by: address,
    ...
    fun attach_world_item(arg0: &mut Island, arg1: WorldItem, arg2: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<Island>) {
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::composable_nft::compose_into_nft<Island, WorldItem>(0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::composable_nft::borrow_domain<Island>(0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::borrow_uid<Island>(arg2)), &mut arg0.id, arg1);
    }

    entry fun attach_world_item_from_other_kiosk(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<Island>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap) {
        let v0 = 0x2::kiosk::borrow_mut<Island>(arg3, arg4, arg0);
        attach_world_item(v0, 0x2::kiosk::take<WorldItem>(arg5, arg6, arg1), arg2);
    }

    entry fun attach_world_item_from_same_kiosk(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<Island>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap) {
        let v0 = 0x2::kiosk::borrow_mut<Island>(arg3, arg4, arg0);
        attach_world_item(v0, 0x2::kiosk::take<WorldItem>(arg3, arg4, arg1), arg2);
    }
    ...
    fun detach_world_item(arg0: &mut Island, arg1: 0x2::object::ID, arg2: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<Island>) : WorldItem {
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::composable_nft::decompose_from_nft<Island, WorldItem>(0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::composable_nft::borrow_domain<Island>(0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::borrow_uid<Island>(arg2)), &mut arg0.id, arg1)
    }

    entry fun detach_world_item_to_kiosk(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<Island>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap) {
        let v0 = 0x2::kiosk::borrow_mut<Island>(arg3, arg4, arg0);
        0x2::kiosk::place<WorldItem>(arg3, arg4, detach_world_item(v0, arg1, arg2));
    }
    ...
    fun init(arg0: ISLANDS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v14 = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::composable_nft::new_composition<Island>();
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::composable_nft::add_relationship<Island, WorldItem>(&mut v14, 100);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::add_domain<Island, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::composable_nft::Composition<Island>>(v1, &mut v5, v14);
    ...
    fun mint_island(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<0x1::ascii::String>, arg5: vector<0x1::ascii::String>, arg6: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<Island>, arg7: &mut 0x2::tx_context::TxContext) : Island {
        let v0 = Island{
        ...
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::add_domain(&mut v0.id, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::new(arg7));
        let v1 = IslandMinted{
    ...
    fun mint_world_item(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<0x1::ascii::String>, arg5: vector<0x1::ascii::String>, arg6: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<Island>, arg7: &mut 0x2::tx_context::TxContext) : WorldItem {
        let v0 = WorldItem{
            id          : 0x2::object::new(arg7),
            name        : 0x1::string::utf8(arg0),
            description : 0x1::string::utf8(arg1),
        ...
        let v1 = WorldItemMinted{
            id          : 0x2::object::id<WorldItem>(&v0),
            mint_cap_id : 0x2::object::id<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<Island>>(arg6),
            name        : 0x1::string::utf8(arg0),
            created_by  : 0x2::tx_context::sender(arg7),
        };
        0x2::event::emit<WorldItemMinted>(v1);
        let v2 = Witness{dummy_field: false};
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_event::emit_mint<WorldItem>(0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::from_witness<WorldItem, Witness>(v2), 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::collection_id<Island>(arg6), &v0);
        v0
    }

    entry fun mint_world_item_to_address(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<0x1::ascii::String>, arg5: vector<0x1::ascii::String>, arg6: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<Island>, arg7: address, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = mint_world_item(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg8);
        let (v1, v2) = 0x2::kiosk::new(arg8);
        let v3 = v2;
        let v4 = v1;
        0x2::kiosk::set_owner_custom(&mut v4, &v3, arg7);
        0x2::kiosk::place<WorldItem>(&mut v4, &v3, v0);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v3, arg7);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v4);
        0x2::object::id<WorldItem>(&v0)
    }

    entry fun mint_world_item_to_kiosk(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<0x1::ascii::String>, arg5: vector<0x1::ascii::String>, arg6: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<Island>, arg7: &mut 0x2::kiosk::Kiosk, arg8: &0x2::kiosk::KioskOwnerCap, arg9: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = mint_world_item(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg9);
        0x2::kiosk::place<WorldItem>(arg7, arg8, v0);
        0x2::object::id<WorldItem>(&v0)
    }
