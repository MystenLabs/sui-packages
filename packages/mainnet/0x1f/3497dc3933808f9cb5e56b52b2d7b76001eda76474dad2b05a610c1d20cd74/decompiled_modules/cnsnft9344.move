module 0x1f3497dc3933808f9cb5e56b52b2d7b76001eda76474dad2b05a610c1d20cd74::cnsnft9344 {
    struct CNSNFT9344 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9344, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9344>(arg0, arg1);
