module 0x1fa9c5ed7d49b2fe51d2d751f029feb8af0550065d85e1a2897673fd9420ef9c::reward6296 {
    struct REWARD6296 has drop {
        dummy_field: bool,
    }

    struct TICKET_6296 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6296(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6296>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6296>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6296, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6296>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6296>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6296>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6296>>(v5, 0x2::tx_context::sender(arg1));
    }
