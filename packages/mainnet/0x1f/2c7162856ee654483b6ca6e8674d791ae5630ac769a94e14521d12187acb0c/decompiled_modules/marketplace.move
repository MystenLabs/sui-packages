module 0x1f2c7162856ee654483b6ca6e8674d791ae5630ac769a94e14521d12187acb0c::marketplace {
    ...
    public entry fun buy<T0: store + key>(arg0: &mut MarketplaceConfig, arg1: &mut 0x1f2c7162856ee654483b6ca6e8674d791ae5630ac769a94e14521d12187acb0c::royalty_fee::RoyaltyBag, arg2: 0x2::object::ID, arg3: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0x1f2c7162856ee654483b6ca6e8674d791ae5630ac769a94e14521d12187acb0c::royalty_fee::charge_royalty<T0>(arg1, v3, &mut v1, arg4);
        assert!(v8 + v9 < v3, 5);
        let v10 = v3 - v8 - v9;
    ...
    public entry fun change_price(arg0: &mut MarketplaceConfig, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 2);
    ...
    public entry fun delist<T0: store + key>(arg0: &mut MarketplaceConfig, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        let Listing {
            id       : v0,
            price    : _,
            owner    : v2,
    ...
    public entry fun force_batch_delist<T0: store + key>(arg0: &mut MarketplaceConfig, arg1: vector<0x2::object::ID>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = MarketplaceConfig{
            ...
            beneficiary : @0xe76e8792889a2c3d6f7cf3b8b21be9c9f162ae98e1f218f23ac6d09e70931a2d,
            balance     : 0x2::balance::zero<0x2::sui::SUI>(),
            list_items  : 0x2::object_table::new<0x2::object::ID, Listing>(arg0),
        };
        0x2::transfer::public_share_object<MarketplaceConfig>(v0);
        0x1f2c7162856ee654483b6ca6e8674d791ae5630ac769a94e14521d12187acb0c::royalty_fee::init_royalty_bag(arg0);
    }

    public entry fun list<T0: store + key>(arg0: &mut MarketplaceConfig, arg1: T0, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 2);
    ...
    public entry fun set_marketplace_admin(arg0: &mut MarketplaceConfig, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg2), 1);
        arg0.admin = arg1;
    }

    public entry fun set_marketplace_fee(arg0: &mut MarketplaceConfig, arg1: u16, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg2), 1);
        arg0.fee_bps = arg1;
    }
    ...
    public entry fun withdraw(arg0: &mut MarketplaceConfig, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1) || arg0.beneficiary == 0x2::tx_context::sender(arg1), 1);
