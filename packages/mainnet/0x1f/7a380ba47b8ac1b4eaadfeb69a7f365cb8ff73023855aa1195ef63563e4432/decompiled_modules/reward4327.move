module 0x1f7a380ba47b8ac1b4eaadfeb69a7f365cb8ff73023855aa1195ef63563e4432::reward4327 {
    struct REWARD4327 has drop {
        dummy_field: bool,
    }

    struct TICKET_4327 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4327(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4327>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4327>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4327, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4327>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4327>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4327>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4327>>(v5, 0x2::tx_context::sender(arg1));
    }
