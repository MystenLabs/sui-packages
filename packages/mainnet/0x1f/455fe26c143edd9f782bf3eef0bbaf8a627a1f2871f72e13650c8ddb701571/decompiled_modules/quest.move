module 0x1f455fe26c143edd9f782bf3eef0bbaf8a627a1f2871f72e13650c8ddb701571::quest {
    ...
    public fun finish<T0: store>(arg0: Quest<T0>) : T0 {
        ...
        while (0x2::vec_set::size<0x1::type_name::TypeName>(&v4) > v7) {
            assert!(0x1::vector::contains<0x1::type_name::TypeName>(&v6, 0x1::vector::borrow<0x1::type_name::TypeName>(&v5, v7)), 1);
            v7 = v7 + 1;
        };
        v3
    }
