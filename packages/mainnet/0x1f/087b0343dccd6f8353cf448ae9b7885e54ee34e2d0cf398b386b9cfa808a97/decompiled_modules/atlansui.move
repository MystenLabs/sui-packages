module 0x1f087b0343dccd6f8353cf448ae9b7885e54ee34e2d0cf398b386b9cfa808a97::atlansui {
    ...
    public fun accept_offer_with_kiosk<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: 0x2::object::ID, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<bool, 0x2::kiosk::PurchaseCap<T1>>(&mut v9.id, true, 0x2::kiosk::list_with_purchase_cap<T1>(arg4, arg5, arg6, 0, arg8));
        v9.start_time = v1;
        v9.is_started = true;
        0x1::option::fill<address>(&mut v9.borrower, v0);
        0x1::option::fill<0x2::object::ID>(&mut v9.item_id, arg6);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v2.balance, v9.value, arg8), v0);
        let v10 = AcceptOfferEvent<Collection<T0, T1>>{
            offer_id           : 0x2::object::id<Offer>(v9),
            nft_id             : arg6,
            creator            : v9.creator,
            borrower           : v0,
            borrower_kiosk     : 0x2::object::id<0x2::kiosk::Kiosk>(arg4),
            borrower_kiosk_cap : 0x2::object::id<0x2::kiosk::KioskOwnerCap>(arg5),
            value              : v9.value,
            time               : v1,
        };
        0x2::event::emit<AcceptOfferEvent<Collection<T0, T1>>>(v10);
    }
    ...
    public fun accept_offer_with_originbyte_kiosk<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: &mut 0x2::kiosk::Kiosk, arg5: 0x2::object::ID, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0x2::object_table::borrow_mut<u64, Offer>(&mut v8.offers, arg3);
        assert!(!v9.is_started, 103);
        let v10 = 0x2::object::id<0x2::kiosk::Kiosk>(arg4);
        0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::auth_exclusive_transfer(arg4, arg5, &v2.id, arg7);
        0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::assert_nft_type<T1>(arg4, arg5);
        v9.start_time = v1;
        v9.is_started = true;
        0x1::option::fill<address>(&mut v9.borrower, v0);
        0x1::option::fill<0x2::object::ID>(&mut v9.item_id, arg5);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v2.balance, v9.value, arg7), v0);
        let v11 = AcceptOfferEvent<Collection<T0, T1>>{
            offer_id           : 0x2::object::id<Offer>(v9),
            nft_id             : arg5,
            creator            : v9.creator,
            borrower           : v0,
        ...
        0x2::event::emit<AcceptOfferEvent<Collection<T0, T1>>>(v11);
    }
