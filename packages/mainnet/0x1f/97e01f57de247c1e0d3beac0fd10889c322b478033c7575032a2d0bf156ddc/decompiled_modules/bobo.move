module 0x1f97e01f57de247c1e0d3beac0fd10889c322b478033c7575032a2d0bf156ddc::bobo {
    ...
    fun init(arg0: BOBO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<BOBO>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BOBO    ")))), trim_right(b"BOBO                            "), trim_right(b"Bobo the Bear is a meme character that has become a symbol of satirical wisdom and collective pessimism in financial markets                                                                                                                                                                                                    "), v2, arg1);
