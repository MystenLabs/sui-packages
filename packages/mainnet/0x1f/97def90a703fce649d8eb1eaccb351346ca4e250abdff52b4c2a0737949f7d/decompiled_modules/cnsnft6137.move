module 0x1f97def90a703fce649d8eb1eaccb351346ca4e250abdff52b4c2a0737949f7d::cnsnft6137 {
    struct CNSNFT6137 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6137, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6137>(arg0, arg1);
