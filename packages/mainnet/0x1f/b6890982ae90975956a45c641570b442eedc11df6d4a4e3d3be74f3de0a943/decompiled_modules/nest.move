module 0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::nest {
    ...
    struct StakedDuck has store {
        duck: 0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::duck_nft::DuckNFT,
        stake_time: u64,
    ...
    public fun get_available_harvest_cycles(arg0: &Nest, arg1: &0x2::clock::Clock) : u64 {
        ...
        if (v1 < v0.last_harvest_time + 180000) {
            return 0
        };
        let v2 = (v1 - v0.last_harvest_time) / 180000;
        if (v2 > 30) {
            30
        } else {
            v2
    ...
    public fun get_duck_harvest_stats(arg0: &Nest) : (u8, u8, u8) {
        ...
        let v0 = 0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::duck_nft::get_rarity_level(&0x1::option::borrow<StakedDuck>(&arg0.staked_duck).duck);
    ...
    public fun get_time_until_harvest(arg0: &Nest, arg1: &0x2::clock::Clock) : u64 {
        ...
        let v1 = 0x1::option::borrow<StakedDuck>(&arg0.staked_duck).last_harvest_time + 180000;
        if (v0 >= v1) {
            0
        } else {
            v1 - v0
    ...
    public entry fun harvest_duck(arg0: &mut Nest, arg1: &mut HarvestStats, arg2: &0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::shttoken::NestMintCap, arg3: &mut 0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::shttoken::SharedTreasury, arg4: &0x2::random::Random, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 >= v2.last_harvest_time + 180000, 3);
        let v3 = (v1 - v2.last_harvest_time) / 180000;
        let v4 = if (v3 > 30) {
            30
        } else {
            v3
        };
        let v5 = 0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::duck_nft::get_rarity_level(&v2.duck);
        let v6 = 0x2::object::id<0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::duck_nft::DuckNFT>(&v2.duck);
        ...
        if (v11 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::shttoken::SHTTOKEN>>(0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::shttoken::mint_for_nest(arg2, arg3, v11, arg6), v0);
        };
    ...
    public fun is_duck_ready_to_harvest(arg0: &Nest, arg1: &0x2::clock::Clock) : bool {
        ...
        0x2::clock::timestamp_ms(arg1) >= 0x1::option::borrow<StakedDuck>(&arg0.staked_duck).last_harvest_time + 180000
    }
    ...
    public entry fun stake_duck(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut Nest, arg4: &NestRegistry, arg5: &mut HarvestStats, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(arg4.is_initialized, 10);
        assert!(arg3.owner == v0, 6);
        assert!(0x1::option::is_none<StakedDuck>(&arg3.staked_duck), 1);
        let v1 = 0x2::kiosk::take<0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::duck_nft::DuckNFT>(arg0, arg1, arg2);
        let v2 = 0x2::clock::timestamp_ms(arg6);
        let v3 = StakedDuck{
            duck              : v1,
            stake_time        : v2,
            last_harvest_time : v2,
        };
        0x1::option::fill<StakedDuck>(&mut arg3.staked_duck, v3);
        ...
        let v4 = DuckStaked{
            ...
            duck_id    : 0x2::object::id<0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::duck_nft::DuckNFT>(&v1),
            owner      : v0,
    ...
    public entry fun unstake_duck(arg0: &mut Nest, arg1: &mut HarvestStats, arg2: &0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::shttoken::NestMintCap, arg3: &mut 0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::shttoken::SharedTreasury, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(arg0.owner == v0, 6);
        assert!(0x1::option::is_some<StakedDuck>(&arg0.staked_duck), 2);
        let v1 = 0x2::object::id<Nest>(arg0);
        let v2 = 0x1::option::borrow<StakedDuck>(&arg0.staked_duck);
        let v3 = (0x2::clock::timestamp_ms(arg7) - v2.last_harvest_time) / 180000;
        if (v3 > 0) {
            let v4 = if (v3 > 30) {
                30
            } else {
            ...
            let v10 = 0x2::random::new_generator(arg4, arg8);
            let v11 = 0;
            let v12 = 0x1::vector::empty<HarvestResult>();
            let v13 = 1;
            let v14 = 0;
            ...
            if (v11 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::shttoken::SHTTOKEN>>(0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::shttoken::mint_for_nest(arg2, arg3, v11, arg8), v0);
            };
            update_harvest_stats(arg1, v0, v4, v14, v11, arg7);
        ...
        update_user_stake_stats(arg1, v0, false, arg7);
        let v20 = DuckUnstaked{
            nest_id    : v1,
            duck_id    : 0x2::object::id<0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::duck_nft::DuckNFT>(&v19.duck),
            owner      : v0,
        ...
        0x2::kiosk::place<0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::duck_nft::DuckNFT>(arg5, arg6, v21);
    }
    ...
    public entry fun upgrade_nest(arg0: &mut Nest, arg1: &mut 0x2::coin::Coin<0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::shttoken::SHTTOKEN>, arg2: &mut 0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::shttoken::SharedTreasury, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::shttoken::SHTTOKEN>(arg1) >= v3, 5);
        0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::shttoken::burn(arg2, 0x2::coin::split<0x1fb6890982ae90975956a45c641570b442eedc11df6d4a4e3d3be74f3de0a943::shttoken::SHTTOKEN>(arg1, v3, arg3));
        arg0.level = v2;
        let v4 = SlotUpgraded{
            nest_id    : 0x2::object::id<Nest>(arg0),
            owner      : v0,
