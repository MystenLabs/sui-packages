module 0x1f8ec4e341f43928de6cc4031cb97d62aca7fee4b3161703f5bf10121bfaa91c::token14 {
    ...
    fun init(arg0: TOKEN14, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN14>(arg0, 9, b"li.fi", b"li.fi", b"", 0x1::option::none<0x2::url::Url>(), arg1);
