module 0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::xcore_inner {
    ...
    struct App has store, key {
        ...
        unverified_presign_caps: 0x2::table::Table<u64, vector<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>>,
        wallet_count: u64,
        paused: bool,
    }
    ...
    public(friend) fun add_wallet(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: 0x1::type_name::TypeName, arg3: 0x2::object::ID, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: u32, arg9: u32, arg10: u32, arg11: &mut 0x2::tx_context::TxContext) : (u64, address) {
        ...
        0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::events::emit_wallet_added(arg2, v10.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v10.dwallet_cap), arg3, v11, arg8, arg9, arg10);
        0x2::object_table::add<u64, Wallet>(&mut v0.wallets, v11, v10);
        0x2::table::add<u64, vector<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>>(&mut v0.unverified_presign_caps, v11, 0x1::vector::empty<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>());
    ...
    fun consume_presign_cap(arg0: &mut App, arg1: u64) : 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap {
        assert!(!0x1::vector::is_empty<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>(0x2::table::borrow<u64, vector<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>>(&arg0.unverified_presign_caps, arg1)), 6);
        0x1::vector::remove<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>(0x2::table::borrow_mut<u64, vector<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>>(&mut arg0.unverified_presign_caps, arg1), 0)
    }

    public(friend) fun decrement_balance<T0: drop>(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: 0x1::type_name::TypeName, arg3: 0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::presign_cap::PresignCap<T0>, arg4: vector<u8>, arg5: vector<u8>, arg6: address, arg7: u64, arg8: vector<u8>, arg9: u256, arg10: &mut 0x2::tx_context::TxContext) : (u256, 0x2::object::ID) {
        let (v0, v1) = 0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::presign_cap::destroy<T0>(arg3);
        let v2 = app_state_mut(arg0, arg2);
        assert!(!v2.paused, 12);
        assert!(v0 < v2.wallet_count, 7);
        let v3 = subtract_balance(v2, v0, arg6, arg7, arg8, arg9);
        let (v4, v5) = withdraw_payment_coins(v2, arg10);
        let v6 = v5;
        let v7 = v4;
        let v8 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::verify_presign_cap(arg1, v1, arg10);
        let v9 = wallet(v2, v0);
        let v10 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::approve_message(arg1, &v9.dwallet_cap, v9.signature_algorithm, v9.hash_scheme, arg5);
        let v11 = random_session_identifier(arg1, arg10);
        let v12 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::request_sign_and_return_id(arg1, v8, v10, arg4, v11, &mut v7, &mut v6, arg10);
        0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::events::emit_decrement_balance(arg2, v0, arg6, arg7, arg8, arg9, v3, arg4, arg5, v12, v9.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v9.dwallet_cap));
        return_payment_coins(v2, v7, v6);
        (v3, v12)
    }
    ...
    public(friend) fun increment_balance(arg0: &mut StateV1, arg1: 0x1::type_name::TypeName, arg2: vector<u8>, arg3: u64, arg4: address, arg5: u64, arg6: vector<u8>, arg7: u256, arg8: &mut 0x2::tx_context::TxContext) : u256 {
        ...
        *v5 = v6;
        ...
        0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::events::emit_increment_balance(arg1, arg2, arg3, arg4, arg5, arg6, arg7, v6, v7.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v7.dwallet_cap));
        v6
    }
    ...
    public(friend) fun init_app(arg0: &mut StateV1, arg1: 0x1::type_name::TypeName, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = App{
            ...
            unverified_presign_caps : 0x2::table::new<u64, vector<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>>(arg2),
            wallet_count            : 0,
            paused                  : true,
        };
        ...
        0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::events::emit_app_initialized(arg1);
    }

    public(friend) fun mint_presign(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = app_state_mut(arg0, arg2);
        assert!(!v0.paused, 12);
        ...
        0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::events::emit_presign_added(arg2, v5.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v5.dwallet_cap));
        0x1::vector::push_back<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>(0x2::table::borrow_mut<u64, vector<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>>(&mut v0.unverified_presign_caps, arg3), 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::request_global_presign(arg1, v5.dwallet_network_encryption_key_id, v5.curve, v5.signature_algorithm, v6, &mut v4, &mut v3, arg4));
        assert!(0x1::vector::length<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>(0x2::table::borrow<u64, vector<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>>(&v0.unverified_presign_caps, arg3)) <= 250, 15);
        return_payment_coins(v0, v4, v3);
    }
    ...
    public(friend) fun sign<T0: drop>(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: 0x1::type_name::TypeName, arg3: 0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::presign_cap::PresignCap<T0>, arg4: vector<u8>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let (v0, v1) = 0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::presign_cap::destroy<T0>(arg3);
        let v2 = app_state_mut(arg0, arg2);
        assert!(!v2.paused, 12);
        assert!(v0 < v2.wallet_count, 7);
        let (v3, v4) = withdraw_payment_coins(v2, arg6);
        let v5 = v4;
        let v6 = v3;
        let v7 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::verify_presign_cap(arg1, v1, arg6);
        let v8 = wallet(v2, v0);
        let v9 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::approve_message(arg1, &v8.dwallet_cap, v8.signature_algorithm, v8.hash_scheme, arg5);
        let v10 = random_session_identifier(arg1, arg6);
        let v11 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::request_sign_and_return_id(arg1, v7, v9, arg4, v10, &mut v6, &mut v5, arg6);
        0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::events::emit_sign_requested(arg2, v0, arg4, arg5, v11, v8.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v8.dwallet_cap));
        return_payment_coins(v2, v6, v5);
        v11
    }
    ...
    public(friend) fun take_presign<T0: drop>(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::presign_cap::PresignCap<T0> {
        let v0 = app_state_mut(arg0, arg2);
        assert!(!v0.paused, 12);
        assert!(arg3 < v0.wallet_count, 7);
        let v1 = consume_presign_cap(v0, arg3);
        let (v2, v3) = withdraw_payment_coins(v0, arg4);
        let v4 = v3;
        let v5 = v2;
        let v6 = wallet(v0, arg3);
        let v7 = random_session_identifier(arg1, arg4);
        0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::events::emit_presign_added(arg2, v6.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v6.dwallet_cap));
        0x1::vector::push_back<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>(0x2::table::borrow_mut<u64, vector<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>>(&mut v0.unverified_presign_caps, arg3), 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::request_global_presign(arg1, v6.dwallet_network_encryption_key_id, v6.curve, v6.signature_algorithm, v7, &mut v5, &mut v4, arg4));
        return_payment_coins(v0, v5, v4);
        0x1f9ded5e071cc9cb59dc1c4a0249e5674b82af44241092a0f40fc7a9bf6ea251::presign_cap::new<T0>(arg3, v1, arg4)
    }
