module 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::alphapool {
    ...
    public fun create<T0>(arg0: &0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::alpha::Admin_cap, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: &0x2::clock::Clock, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Pool<T0>{
    ...
    public fun deposit<T0>(arg0: 0x1::option::Option<Receipt>, arg1: &mut Pool<T0>, arg2: &mut 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::distributor::Distributor, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : Receipt {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v0, 0x2::balance::value<T0>(&v0) * arg1.deposit_fee / 100), arg5), 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::distributor::get_fee_wallet_address(arg2));
        ...
        let v5 = if (0x1::option::is_some<Receipt>(&arg0) == true) {
            ...
            let v7 = &mut v6;
            unlock_locked_balance_for_user<T0>(arg1, v7, arg4);
            if (0x2::linked_table::contains<u64, u64>(&v6.locked_balance, v4) == true) {
                let v8 = 0x2::linked_table::borrow_mut<u64, u64>(&mut v6.locked_balance, v4);
                *v8 = *v8 + v3;
            } else {
                let v9 = &mut v6;
                insert_to_locked_balance(v9, v4, v3, arg5);
            };
            v6
        } else {
            let v10 = 0x2::vec_map::empty<0x1::type_name::TypeName, u256>();
            let v11 = 0;
            while (v11 < 0x2::vec_map::size<0x1::type_name::TypeName, u256>(&arg1.acc_rewards_per_xtoken)) {
                let (v12, v13) = 0x2::vec_map::get_entry_by_idx_mut<0x1::type_name::TypeName, u256>(&mut arg1.acc_rewards_per_xtoken, v11);
                0x2::vec_map::insert<0x1::type_name::TypeName, u256>(&mut v10, *v12, *v13);
                v11 = v11 + 1;
            };
            let v14 = 0x2::linked_table::new<u64, u64>(arg5);
            0x2::linked_table::push_back<u64, u64>(&mut v14, v4, v3);
            Receipt{id: 0x2::object::new(arg5), name: 0x1::string::utf8(arg1.name), image_url: 0x1::string::utf8(arg1.image_url), pool_id: 0x2::object::uid_to_inner(&arg1.id), xTokenBalance: (v2 as u64), last_acc_reward_per_xtoken: v10, locked_balance: v14, balance: 0}
        };
        0x1::option::destroy_none<Receipt>(arg0);
        v5
    }

    public fun destroy_receipt_and_transfer_rewards<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg0;
    ...
    fun get_rewards<T0, T1>(arg0: &mut Pool<T0>, arg1: &mut 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::distributor::Distributor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::string::index_of(&v0, &v1) < 0x1::string::length(&v0)) {
            0x2::balance::join<T0>(&mut arg0.alpha_bal, 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::distributor::get_rewards<T0>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3));
        } else {
            let v2 = 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::distributor::get_rewards<T1>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3);
    ...
    public fun get_user_rewards<T0, T1>(arg0: &mut Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
    ...
    public fun get_user_rewards_all<T0>(arg0: &mut Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun set_lock_period<T0>(arg0: &0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::alpha::Admin_cap, arg1: &mut Pool<T0>, arg2: u64) {
    ...
    public fun user_deposit<T0>(arg0: 0x1::option::Option<Receipt>, arg1: &mut Pool<T0>, arg2: &mut 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::distributor::Distributor, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = deposit<T0>(arg0, arg1, arg2, arg3, arg4, arg5);
        0x2::transfer::public_transfer<Receipt>(v0, 0x2::tx_context::sender(arg5));
    }

    public fun user_withdraw<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::distributor::Distributor, arg3: u64, arg4: &0x2::clock::Clock, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun withdraw<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::distributor::Distributor, arg3: u64, arg4: &0x2::clock::Clock, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : Receipt {
        update_pool<T0>(arg1, arg4);
        ...
        if (v3 > 0) {
            ...
            0x2::balance::join<T0>(&mut v5, 0x2::balance::split<T0>(&mut arg1.alpha_bal, v3 - v3 * arg1.instant_withdraw_fee / 100));
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v5, 0x2::balance::value<T0>(&v5) * arg1.withdrawal_fee / 100), arg6), 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::distributor::get_fee_wallet_address(arg2));
