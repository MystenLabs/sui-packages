module 0x1f5f80ae239870fcb82d65224e956a2e6feff8e11dc63ebb9dbafbcbadbf2aad::allocator {
    ...
    public(friend) fun delete_pool(arg0: &mut Allocator, arg1: 0x2::object::ID) {
        assert!(0x2::vec_map::contains<0x2::object::ID, Pool_info>(&arg0.members, &arg1) == true, 4);
