module 0x1fb3641de92cffb705a4a87f2dfc9dacb80a0234c23d2c8c04cd3655972ae491::m0 {
    ...
    public fun p0(arg0: &0x2::clock::Clock, arg1: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg2: u8) : vector<OP> {
        ...
        let v1 = 0;
        while (v1 < arg2) {
            let (v2, v3, v4) = 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::get_token_price(arg0, arg1, arg2);
            let v5 = OP{
                id       : v1,
                is_valid : v2,
                price    : v3,
