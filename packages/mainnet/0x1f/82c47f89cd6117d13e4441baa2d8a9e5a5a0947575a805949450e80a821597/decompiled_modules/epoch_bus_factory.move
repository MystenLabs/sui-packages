module 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::epoch_bus_factory {
    ...
    public fun migrate_tick_record_to_v2_no_drop(arg0: &mut 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::DeployRecord, arg1: &mut 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::TickRecord, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = if (0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::tick_record_v2_remain(&v6) == 0) {
            ...
            let v8 = 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::tick_record_epoch_records(arg1);
            let v9 = 0x2::table::new<u64, EpochRecord>(arg2);
            let v10 = 0;
            while (v10 < v4) {
                let (_, _, _, v14) = 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::unwrap_epoch_record(0x2::table::remove<u64, 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::EpochRecord>(v8, v10));
                0x2::table::destroy_empty<address, 0x2::balance::Balance<0x2::sui::SUI>>(v14);
                v10 = v10 + 1;
            };
            0x2::table::add<u64, EpochRecord>(&mut v9, v4, migrate_epoch_record(0x2::table::remove<u64, 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::EpochRecord>(v8, v4)));
            v9
        };
        let v15 = EpochBusFactory{
            init_locked_sui : v5,
            start_time_ms   : v2,
            epoch_count     : v3,
        ...
        0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::tick_record_add_df<EpochBusFactory, WITNESS>(&mut v6, v15, v16);
