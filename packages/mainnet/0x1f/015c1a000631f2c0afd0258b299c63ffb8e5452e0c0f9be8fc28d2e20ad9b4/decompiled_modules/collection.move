module 0x1f015c1a000631f2c0afd0258b299c63ffb8e5452e0c0f9be8fc28d2e20ad9b4::collection {
    struct HouseCollectionNFT has store, key {
        ...
        dummy_level: u64,
        dummy_character: u64,
        attributes: 0x1f015c1a000631f2c0afd0258b299c63ffb8e5452e0c0f9be8fc28d2e20ad9b4::attributes::Attributes,
    }
    ...
    fun init(arg0: COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3;
        let v5 = v2;
        0x1f015c1a000631f2c0afd0258b299c63ffb8e5452e0c0f9be8fc28d2e20ad9b4::royalty_rule::add<HouseCollectionNFT>(&mut v5, &v4, 600, 0);
        0x1f015c1a000631f2c0afd0258b299c63ffb8e5452e0c0f9be8fc28d2e20ad9b4::kiosk_lock_rule::add<HouseCollectionNFT>(&mut v5, &v4);
    ...
    public(friend) fun mint_(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : HouseCollectionNFT {
        ...
        HouseCollectionNFT{
            id              : 0x2::object::new(arg1),
            url             : 0x2::url::new_unsafe_from_bytes(0x1f015c1a000631f2c0afd0258b299c63ffb8e5452e0c0f9be8fc28d2e20ad9b4::constants::get_nft_image((arg0 as u64))),
            level           : (arg0 as u64),
            character       : 0x1::string::utf8(0x1f015c1a000631f2c0afd0258b299c63ffb8e5452e0c0f9be8fc28d2e20ad9b4::constants::get_character_name((v0 as u64))),
            dummy_level     : v1,
            dummy_character : (v0 as u64),
            attributes      : 0x1f015c1a000631f2c0afd0258b299c63ffb8e5452e0c0f9be8fc28d2e20ad9b4::attributes::from_vec(&mut v2, &mut v4),
        }
    }
