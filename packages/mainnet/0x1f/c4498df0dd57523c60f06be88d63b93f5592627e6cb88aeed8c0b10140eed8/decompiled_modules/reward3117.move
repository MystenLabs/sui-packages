module 0x1fc4498df0dd57523c60f06be88d63b93f5592627e6cb88aeed8c0b10140eed8::reward3117 {
    struct REWARD3117 has drop {
        dummy_field: bool,
    }

    struct TICKET_3117 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3117(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3117>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3117>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3117, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3117>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3117>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3117>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3117>>(v5, 0x2::tx_context::sender(arg1));
    }
