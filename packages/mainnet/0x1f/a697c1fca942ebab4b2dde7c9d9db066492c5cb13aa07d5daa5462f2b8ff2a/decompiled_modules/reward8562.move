module 0x1fa697c1fca942ebab4b2dde7c9d9db066492c5cb13aa07d5daa5462f2b8ff2a::reward8562 {
    struct REWARD8562 has drop {
        dummy_field: bool,
    }

    struct TICKET_8562 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8562(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8562>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8562>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8562, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8562>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8562>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8562>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8562>>(v5, 0x2::tx_context::sender(arg1));
    }
