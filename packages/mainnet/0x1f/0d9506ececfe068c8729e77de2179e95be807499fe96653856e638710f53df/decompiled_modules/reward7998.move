module 0x1f0d9506ececfe068c8729e77de2179e95be807499fe96653856e638710f53df::reward7998 {
    struct REWARD7998 has drop {
        dummy_field: bool,
    }

    struct TICKET_7998 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7998(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7998>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7998>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7998, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7998>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7998>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7998>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7998>>(v5, 0x2::tx_context::sender(arg1));
    }
