module 0x1fcf1701d602419456a362139cf0fe4a05bd6df24b6cced32abf81ae51bf5b4f::geckogenesis {
    struct GECKOGENESIS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: GECKOGENESIS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<GECKOGENESIS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"GeckoGenesis"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The GeckoGenesis collection immortalizes the journey of warrior geckos who witnessed humanity's greatest conflicts from the shadows, adapting to every battlefield with scales that reflect patterns of countless military campaigns. These aren't simple reptiles, but resilient veterans whose regenerative ability symbolizes the eternal cycle of conflict and rebirth in our shared history, honoring everyone from scouts who infiltrated enemy lines during the Punic Wars to messengers who traversed trenches in the Great War, capturing moments where these extraordinary creatures transcended their nature to become legends in the conflicts that shaped our world."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://ZMvYU52t2aAJlzLyHsNuHqflMbi8V_Om08AYF1xvRkI"));
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Nft>(&mut v5, &v4, 1500, 0);
