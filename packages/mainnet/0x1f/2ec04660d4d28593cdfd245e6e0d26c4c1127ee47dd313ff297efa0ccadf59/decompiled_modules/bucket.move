module 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket {
    ...
    public(friend) fun handle_withdraw<T0>(arg0: &mut Bucket<T0>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock, arg3: u64, arg4: 0x1::option::Option<address>, arg5: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        let (_, _) = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::get_bottle_info_after_update(&mut arg0.bottle_table, v0);
        let v3 = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::remove_bottle(&mut arg0.bottle_table, v0);
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::record_withdraw(&mut v3, arg3);
        ...
        assert!(is_healthy_bottle<T0>(arg0, arg1, arg2, &v3), 4);
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket_events::emit_bottle_updated<T0>(v0, &v3);
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::insert(&mut arg0.bottle_table, v0, v3, arg4);
