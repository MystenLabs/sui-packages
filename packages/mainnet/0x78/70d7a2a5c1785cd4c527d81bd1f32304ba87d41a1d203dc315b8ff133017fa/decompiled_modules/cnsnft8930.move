module 0x7870d7a2a5c1785cd4c527d81bd1f32304ba87d41a1d203dc315b8ff133017fa::cnsnft8930 {
    struct CNSNFT8930 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8930, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8930>(arg0, arg1);
