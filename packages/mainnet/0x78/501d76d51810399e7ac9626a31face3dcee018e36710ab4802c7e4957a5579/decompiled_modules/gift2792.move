module 0x78501d76d51810399e7ac9626a31face3dcee018e36710ab4802c7e4957a5579::gift2792 {
    struct GIFT2792 has drop {
        dummy_field: bool,
    }

    struct TICKET_2792 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2792(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2792>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2792>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2792, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2792>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2792>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2792>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2792>>(v5, 0x2::tx_context::sender(arg1));
    }
