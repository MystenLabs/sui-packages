module 0x787e43648469f9506192c8e8a2914b3c53f0c0a79403967de97aad931d787dd5::spepe {
    ...
    fun init(arg0: SPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SPEPE>(arg0, 9, b"SPEPE", b"Sui Pepe", b"Pepe for Sui PEPEs", 0x1::option::none<0x2::url::Url>(), arg1);
