module 0x7807dc55e217543512cec4222490606ae74568f68eebc307788252a9f439e022::af_lp {
    ...
    fun init(arg0: AF_LP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = &mut v1;
        0x1::vector::push_back<u64>(v2, 761999999999999968);
        0x1::vector::push_back<u64>(v2, 238000000000000050);
