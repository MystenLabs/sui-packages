module 0x785e755b23e21589ff041689940ece21e03d2323f8bc69fed0a3853c3e58965f::dex_aftermath {
    ...
    public fun get_aftermath_package() : address {
        0x785e755b23e21589ff041689940ece21e03d2323f8bc69fed0a3853c3e58965f::constants::aftermath_package()
    }
    ...
    public fun is_aftermath_operational() : bool {
        0x785e755b23e21589ff041689940ece21e03d2323f8bc69fed0a3853c3e58965f::constants::aftermath_package() != @0x0
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = AftermathSwapExecuted{
            ...
            package        : 0x785e755b23e21589ff041689940ece21e03d2323f8bc69fed0a3853c3e58965f::constants::aftermath_package(),
