module 0x785e755b23e21589ff041689940ece21e03d2323f8bc69fed0a3853c3e58965f::dex_deepbook {
    ...
    public fun get_deepbook_package() : address {
        0x785e755b23e21589ff041689940ece21e03d2323f8bc69fed0a3853c3e58965f::constants::deepbook_package()
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = DeepBookRealSwapExecuted{
            ...
            pool_id         : arg2,
            package         : 0x785e755b23e21589ff041689940ece21e03d2323f8bc69fed0a3853c3e58965f::constants::deepbook_package(),
