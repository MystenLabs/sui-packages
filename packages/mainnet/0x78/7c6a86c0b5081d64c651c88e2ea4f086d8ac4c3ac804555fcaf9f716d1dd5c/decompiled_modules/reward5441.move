module 0x787c6a86c0b5081d64c651c88e2ea4f086d8ac4c3ac804555fcaf9f716d1dd5c::reward5441 {
    struct REWARD5441 has drop {
        dummy_field: bool,
    }

    struct TICKET_5441 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5441(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5441>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5441>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5441, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5441>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5441>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5441>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5441>>(v5, 0x2::tx_context::sender(arg1));
    }
