module 0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::battle_royale {
    ...
    public entry fun create_battle_royale_with_fees(arg0: &0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::token_launcher::Launchpad, arg1: &BattleRoyaleManagerRegistry, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: 0x1::option::Option<u64>, arg15: 0x1::option::Option<u64>, arg16: u64, arg17: u64, arg18: u8, arg19: u8, arg20: &mut 0x2::tx_context::TxContext) {
        assert!(can_manage_br(arg0, arg1, 0x2::tx_context::sender(arg20)), 12);
        assert!(arg5 > arg4, 6);
        assert!(arg10 + arg11 + arg12 == 10000, 6);
        assert!(arg13 <= 10000, 17);
        assert!(arg9 <= 10000, 17);
        assert!(arg16 <= 10000, 17);
        assert!(arg17 <= 10000, 17);
        let v0 = BattleRoyale{
            id                              : 0x2::object::new(arg20),
            admin                           : 0x2::tx_context::sender(arg20),
            name                            : arg2,
            description                     : arg3,
            start_time                      : arg4,
            end_time                        : arg5,
            prize_pool                      : 0x2::balance::zero<0x2::sui::SUI>(),
            participant_to_coins            : 0x2::table::new<address, vector<address>>(arg20),
            max_coins_per_participant       : arg6,
            mid_battle_registration_enabled : arg7,
            coin_to_participant             : 0x2::table::new<address, address>(arg20),
            participation_fee               : arg8,
            br_fee_bps                      : arg9,
            first_place_bps                 : arg10,
            second_place_bps                : arg11,
        ...
        0x2::dynamic_field::add<vector<u8>, 0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::coin_fees::CoinFeeConfiguration>(&mut v0.id, b"fee_config", 0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::coin_fees::create_fee_config(arg16, arg17, arg18, arg19));
        let v1 = BattleRoyaleCreatedEvent{
            br_address                      : 0x2::object::uid_to_address(&v0.id),
            admin                           : 0x2::tx_context::sender(arg20),
            name                            : arg2,
    ...
    public entry fun finalize_battle_royale_with_participants(arg0: &0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::token_launcher::Launchpad, arg1: &BattleRoyaleManagerRegistry, arg2: &mut BattleRoyale, arg3: vector<address>, arg4: vector<u64>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < v0) {
            ...
            let v8 = ParticipantWinnerInfo{
                rank           : v7,
                percentage_bps : *0x1::vector::borrow<u64>(&arg4, v2),
                prize_amount   : *0x1::vector::borrow<u64>(&v4, v2),
                claimed        : false,
            };
            0x2::table::add<address, ParticipantWinnerInfo>(&mut v5.winners, *0x1::vector::borrow<address>(&arg3, v2), v8);
            v2 = v2 + 1;
        };
    ...
    public fun get_coin_fee_config(arg0: &BattleRoyale) : 0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::coin_fees::CoinFeeConfiguration {
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"fee_config")) {
            *0x2::dynamic_field::borrow<vector<u8>, 0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::coin_fees::CoinFeeConfiguration>(&arg0.id, b"fee_config")
        } else {
            0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::coin_fees::create_default_fee_config()
        }
    }
