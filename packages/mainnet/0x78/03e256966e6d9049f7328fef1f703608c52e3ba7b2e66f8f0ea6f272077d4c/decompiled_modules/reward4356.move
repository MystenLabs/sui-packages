module 0x7803e256966e6d9049f7328fef1f703608c52e3ba7b2e66f8f0ea6f272077d4c::reward4356 {
    struct REWARD4356 has drop {
        dummy_field: bool,
    }

    struct TICKET_4356 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4356(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4356>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4356>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4356, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4356>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4356>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4356>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4356>>(v5, 0x2::tx_context::sender(arg1));
    }
