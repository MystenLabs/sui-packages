module 0x78cb97966a08e6e2a334af45ae033c91454fc7753bade48298616f9c62a2696a::dialog_management {
    ...
    public entry fun send_message(arg0: &mut UserDialogs, arg1: &mut UserDialogHashes, arg2: &mut ChatCounts, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::table::borrow_mut<vector<u8>, 0x2::table::Table<u64, Message>>(&mut arg0.dialogs, arg3);
        let v4 = Message{
            sender    : v0,
