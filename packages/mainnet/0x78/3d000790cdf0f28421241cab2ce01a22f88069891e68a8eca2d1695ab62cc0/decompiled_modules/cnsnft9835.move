module 0x783d000790cdf0f28421241cab2ce01a22f88069891e68a8eca2d1695ab62cc0::cnsnft9835 {
    struct CNSNFT9835 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9835, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2986"));
        let v4 = 0x2::package::claim<CNSNFT9835>(arg0, arg1);
