module 0x78f926832ba13f33d2145adfcf56ab0446939eaa9c03526fe97afa80572a1458::move_pump_router {
    ...
    public entry fun buy_exact_out<T0>(arg0: &FeeObject, arg1: &mut 0x92fecee99603c0628ced2fbd37f85c05f6c0049c183eb6b1b58db24764c6c7bc::move_pump::Configuration, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        let v3 = TestEvent{
            a : 0x2::coin::value<0x2::sui::SUI>(&arg2),
            b : 0x2::coin::value<0x2::sui::SUI>(&v2),
        };
        0x2::event::emit<TestEvent>(v3);
        0x78f926832ba13f33d2145adfcf56ab0446939eaa9c03526fe97afa80572a1458::utils::send_coin<T0>(v1, 0x2::tx_context::sender(arg7));
        0x78f926832ba13f33d2145adfcf56ab0446939eaa9c03526fe97afa80572a1458::utils::send_coin<0x2::sui::SUI>(v2, 0x2::tx_context::sender(arg7));
    }
    ...
    public entry fun sell_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0x92fecee99603c0628ced2fbd37f85c05f6c0049c183eb6b1b58db24764c6c7bc::move_pump::Configuration, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x78f926832ba13f33d2145adfcf56ab0446939eaa9c03526fe97afa80572a1458::utils::send_coin<T0>(v1, 0x2::tx_context::sender(arg6));
        0x78f926832ba13f33d2145adfcf56ab0446939eaa9c03526fe97afa80572a1458::utils::send_coin<T0>(arg2, 0x2::tx_context::sender(arg6));
        0x78f926832ba13f33d2145adfcf56ab0446939eaa9c03526fe97afa80572a1458::utils::send_coin<0x2::sui::SUI>(v2, 0x2::tx_context::sender(arg6));
        0x78f926832ba13f33d2145adfcf56ab0446939eaa9c03526fe97afa80572a1458::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v2, v4, arg6), arg0.admin);
        let v5 = SellEvent<T0>{
