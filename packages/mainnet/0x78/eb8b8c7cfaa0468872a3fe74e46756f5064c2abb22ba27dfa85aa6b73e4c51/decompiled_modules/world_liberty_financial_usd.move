module 0x78eb8b8c7cfaa0468872a3fe74e46756f5064c2abb22ba27dfa85aa6b73e4c51::world_liberty_financial_usd {
    ...
    fun init(arg0: WORLD_LIBERTY_FINANCIAL_USD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<WORLD_LIBERTY_FINANCIAL_USD>(arg0, 9, trim_right(b"USD1"), trim_right(b"World Liberty Financial USD"), trim_right(x"54686520555320446f6c6c617220757067726164656420666f722061206e657720657261206f662066696e616e636520e2809420737461626c652c207365637572652c20616e64207472616e73706172656e742062792064657369676e2e"), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(trim_right(b"https://ipfs.io/ipfs/bafkreiegajmvnizo3rludbgidfzomuutzdwpwyet5rl4ypfr2mehjhvus4"))), arg1);
        let v2 = v0;
        if (155687655000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<WORLD_LIBERTY_FINANCIAL_USD>>(0x2::coin::mint<WORLD_LIBERTY_FINANCIAL_USD>(&mut v2, 155687655000000000, arg1), 0x2::tx_context::sender(arg1));
        };
