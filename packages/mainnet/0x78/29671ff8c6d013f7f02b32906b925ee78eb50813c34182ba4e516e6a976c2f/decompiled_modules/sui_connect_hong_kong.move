module 0x7829671ff8c6d013f7f02b32906b925ee78eb50813c34182ba4e516e6a976c2f::sui_connect_hong_kong {
    ...
    struct SUI_CONNECT_HONG_KONG has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUI_CONNECT_HONG_KONG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Sui Connect Hong Kong"));
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://images.lumacdn.com/cdn-cgi/image/format=auto,fit=cover,dpr=2,background=white,quality=75,width=400,height=400/event-covers/k0/d812ee77-fceb-4a8f-a3b8-adc61e21ac9c.png"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://giftdrop.io/nft"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"1739908080219"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x2::address::to_string(0x2::tx_context::sender(arg1)));
        let v4 = 0x2::package::claim<SUI_CONNECT_HONG_KONG>(arg0, arg1);
