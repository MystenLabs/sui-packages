module 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::fee_vault {
    ...
    public entry fun add_participant(arg0: &0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::PumpAdminCap, arg1: &0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::Configs, arg2: &mut FeeVault, arg3: address, arg4: u16, arg5: &mut 0x2::tx_context::TxContext) {
        0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::assert_valid_package(arg1);
        assert!(!0x2::linked_table::contains<address, Participant>(&arg2.participants, arg3), 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::errors::participant_already_exists());
        let v0 = Participant{
            address     : arg3,
            share_ratio : arg4,
    ...
    public fun claim_earning<T0>(arg0: &0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::Configs, arg1: &mut FeeVault, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::assert_valid_package(arg0);
        assert!(0x2::linked_table::contains<address, Participant>(&arg1.participants, 0x2::tx_context::sender(arg2)), 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::errors::not_participant());
        let v0 = 0x2::linked_table::borrow_mut<address, Participant>(&mut arg1.participants, 0x2::tx_context::sender(arg2));
        assert!(v0.address == 0x2::tx_context::sender(arg2), 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::errors::participant_error());
    ...
    public fun distribute_earnings<T0>(arg0: &mut FeeVault, arg1: 0x2::balance::Balance<T0>) {
        assert!(arg0.total_ratio > 0 && 0x2::linked_table::length<address, Participant>(&arg0.participants) > 0, 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::errors::no_participant_exists());
    ...
    public entry fun remove_participant(arg0: &0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::PumpAdminCap, arg1: &0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::Configs, arg2: &mut FeeVault, arg3: address) {
        0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::assert_valid_package(arg1);
        assert!(0x2::linked_table::contains<address, Participant>(&arg2.participants, arg3), 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::errors::no_participant_exists());
    ...
    public entry fun update_share_ratio(arg0: &0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::PumpAdminCap, arg1: &0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::Configs, arg2: &mut FeeVault, arg3: address, arg4: u16) {
        0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::assert_valid_package(arg1);
        assert!(0x2::linked_table::contains<address, Participant>(&arg2.participants, arg3), 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::errors::no_participant_exists());
    ...
    fun valid_participants(arg0: &FeeVault) {
        ...
        assert!(v2 == arg0.total_ratio, 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::errors::share_error());
    }
