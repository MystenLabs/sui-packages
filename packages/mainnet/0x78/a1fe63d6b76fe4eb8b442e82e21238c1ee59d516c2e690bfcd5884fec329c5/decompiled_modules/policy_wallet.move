module 0x78a1fe63d6b76fe4eb8b442e82e21238c1ee59d516c2e690bfcd5884fec329c5::policy_wallet {
    ...
    public fun create_proposal(arg0: &mut PolicyWallet, arg1: u8, arg2: vector<u8>, arg3: 0x1::option::Option<address>, arg4: vector<u8>, arg5: vector<u128>, arg6: bool, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) : u64 {
        ...
        validate_proposal(arg0, arg1, &arg2, &arg3, &arg5);
    ...
    public fun create_spend_request(arg0: &mut PolicyWallet, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u128, arg6: vector<vector<u8>>, arg7: vector<vector<u8>>, arg8: vector<0x2::object::ID>, arg9: vector<vector<u8>>, arg10: bool, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(arg5 <= v0.per_tx_limit, 20);
        ...
        let v1 = v0.kind;
        let v2 = v0.curve;
        let v3 = v0.signature_algorithm;
        let v4 = v0.hash_scheme;
        assert!(v1 != 3, 36);
        let v5 = if (arg10 || v1 == 4) {
            ...
            assert!(v1 == 2, 12);
            assert!(0x1::vector::length<vector<u8>>(&arg6) == 1, 25);
            assert!(0x1::vector::is_empty<u8>(&arg3), 12);
            0x78a1fe63d6b76fe4eb8b442e82e21238c1ee59d516c2e690bfcd5884fec329c5::verify_solana::verify(0x1::vector::borrow<vector<u8>>(&arg6, 0), borrow_address_book(arg0, &arg2), &arg4, arg5);
            true
        };
        let v6 = 0x1::vector::empty<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPartialUserSignatureCap>();
        let v7 = 0x1::vector::length<vector<u8>>(&arg6);
        assert!(0x1::vector::length<vector<u8>>(&arg7) == v7, 25);
        assert!(0x1::vector::length<0x2::object::ID>(&arg8) == v7, 25);
        assert!(0x2::table::contains<u32, DWalletEntry>(&arg0.dwallets, v2), 30);
        let v8 = 0x2::table::borrow<u32, DWalletEntry>(&arg0.dwallets, v2).dwallet_id;
        let (v9, v10) = withdraw_payments(arg0, arg12);
        let v11 = v10;
        let v12 = v9;
        let v13 = PresignKey{
            curve               : v2,
            signature_algorithm : v3,
        };
        let v14 = 0;
        while (v14 < v7) {
            assert!(0x2::table::contains<PresignKey, vector<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>>(&arg0.presigns, v13), 27);
            let v15 = 0x2::table::borrow_mut<PresignKey, vector<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>>(&mut arg0.presigns, v13);
            assert!(!0x1::vector::is_empty<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>(v15), 27);
            let v16 = 0x1::vector::pop_back<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>(v15);
            assert!(0x2::object::id<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>(&v16) == *0x1::vector::borrow<0x2::object::ID>(&arg8, v14), 28);
            assert!(0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::is_presign_valid(arg1, &v16), 29);
            let v17 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::verify_presign_cap(arg1, v16, arg12);
            let v18 = fresh_session(arg1, arg12);
            0x1::vector::push_back<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPartialUserSignatureCap>(&mut v6, 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::request_future_sign(arg1, v8, v17, *0x1::vector::borrow<vector<u8>>(&arg6, v14), v4, *0x1::vector::borrow<vector<u8>>(&arg7, v14), v18, &mut v12, &mut v11, arg12));
            v14 = v14 + 1;
        };
        return_payments(arg0, v12, v11);
        store_request(arg0, arg2, arg3, arg4, arg5, v5, arg6, arg9, v6, v2, v3, v4, 0x2::clock::timestamp_ms(arg11), arg12)
    }
    ...
    public fun create_vault_spend_request(arg0: &mut PolicyWallet, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u128, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(v0.kind == 3, 42);
        assert!(v0.enabled, 10);
        assert!(arg4 <= v0.per_tx_limit, 20);
    ...
    public fun execute_spend(arg0: &mut PolicyWallet, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::clock::timestamp_ms(arg3);
        let v1 = 0x2::object::id<PolicyWallet>(arg0);
        let (v2, v3, v4, v5, v6, v7) = validate_execution(arg0, arg2, v0, false);
        let v8 = v7;
        let v9 = v2;
        record_window_spend(arg0, &v9, v3, v0);
        let v10 = 0x1::vector::empty<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPartialUserSignatureCap>();
        let v11 = 0x2::table::borrow_mut<u64, SpendRequest>(&mut arg0.requests, arg2);
        while (!0x1::vector::is_empty<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPartialUserSignatureCap>(&v11.partial_sig_caps)) {
            0x1::vector::push_back<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPartialUserSignatureCap>(&mut v10, 0x1::vector::pop_back<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPartialUserSignatureCap>(&mut v11.partial_sig_caps));
        };
        0x1::vector::reverse<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPartialUserSignatureCap>(&mut v10);
        v11.status = 1;
        let (v12, v13) = withdraw_payments(arg0, arg4);
        let v14 = v13;
        let v15 = v12;
        let v16 = 0x1::vector::empty<0x2::object::ID>();
        let v17 = 0x2::table::borrow<u32, DWalletEntry>(&arg0.dwallets, v4);
        while (!0x1::vector::is_empty<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPartialUserSignatureCap>(&v10)) {
            let v18 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::verify_partial_user_signature_cap(arg1, 0x1::vector::pop_back<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPartialUserSignatureCap>(&mut v10), arg4);
            let v19 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::approve_message(arg1, &v17.cap, v5, v6, *0x1::vector::borrow<vector<u8>>(&v8, 0x1::vector::length<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPartialUserSignatureCap>(&v10)));
            let v20 = fresh_session(arg1, arg4);
            0x1::vector::push_back<0x2::object::ID>(&mut v16, 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::request_sign_with_partial_user_signature_and_return_id(arg1, v18, v19, v20, &mut v15, &mut v14, arg4));
        };
        0x1::vector::destroy_empty<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPartialUserSignatureCap>(v10);
        return_payments(arg0, v15, v14);
        0x1::vector::reverse<0x2::object::ID>(&mut v16);
        0x2::table::borrow_mut<u64, SpendRequest>(&mut arg0.requests, arg2).sign_ids = v16;
        0x78a1fe63d6b76fe4eb8b442e82e21238c1ee59d516c2e690bfcd5884fec329c5::events::spend_executed(v1, arg2, 0x2::tx_context::sender(arg4), v16);
    }
    ...
    public fun execute_vault_spend<T0>(arg0: &mut PolicyWallet, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::object::id<PolicyWallet>(arg0);
        let (v2, v3, _, _, _, _) = validate_execution(arg0, arg1, v0, true);
        let v8 = v2;
        record_window_spend(arg0, &v8, v3, v0);
        let v9 = 0x2::table::borrow_mut<u64, SpendRequest>(&mut arg0.requests, arg1);
        v9.status = 1;
        let v10 = v9.destination;
        let v11 = 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>()));
        assert!(v9.asset == v11, 37);
        assert!(v3 <= 18446744073709551615, 39);
        let v12 = (v3 as u64);
        let v13 = 0x1::type_name::get<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.vault, v13), 38);
        let v14 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.vault, v13);
        assert!(0x2::balance::value<T0>(v14) >= v12, 38);
        let v15 = 0x2::address::from_bytes(v10);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v14, v12), arg3), v15);
        0x78a1fe63d6b76fe4eb8b442e82e21238c1ee59d516c2e690bfcd5884fec329c5::events::vault_withdrawal(v1, arg1, v11, v12, v15);
    ...
    fun is_fast_path(arg0: &PolicyWallet, arg1: u64) : bool {
        ...
        if (v1.fast_path_limit > 0) {
            if (v0.amount <= v1.fast_path_limit) {
                if (v0.verified_intent) {
    ...
    fun record_window_spend(arg0: &mut PolicyWallet, arg1: &vector<u8>, arg2: u128, arg3: u64) {
        let v0 = 0x2::table::borrow_mut<vector<u8>, ChainPolicy>(&mut arg0.chains, *arg1);
        if (arg3 >= v0.window_started_at_ms + v0.window_ms) {
            v0.spent_in_window = 0;
            v0.window_started_at_ms = arg3;
        };
        assert!(v0.spent_in_window + arg2 <= v0.window_limit, 21);
        v0.spent_in_window = v0.spent_in_window + arg2;
    }
    ...
    fun validate_execution(arg0: &PolicyWallet, arg1: u64, arg2: u64, arg3: bool) : (vector<u8>, u128, u32, u32, u32, vector<vector<u8>>) {
        assert!(0x2::table::contains<u64, SpendRequest>(&arg0.requests, arg1), 13);
        let v0 = 0x2::table::borrow<u64, SpendRequest>(&arg0.requests, arg1);
        assert!(v0.status == 0, 14);
        let v1 = 0x2::table::borrow<vector<u8>, ChainPolicy>(&arg0.chains, v0.chain_key);
        ...
        let v2 = if (v1.fast_path_limit > 0) {
            if (v0.amount <= v1.fast_path_limit) {
                if (v0.verified_intent) {
                    0x2::vec_set::length<address>(&v0.rejections) == 0
                } else {
        ...
        let v4 = v0.threshold_reached_at_ms + v3;
        assert!(arg2 >= v4, 18);
        assert!(arg2 <= v4 + arg0.request_expiry_ms, 16);
        (v0.chain_key, v0.amount, v0.curve, v0.signature_algorithm, v0.hash_scheme, v0.messages)
    }

    fun validate_proposal(arg0: &PolicyWallet, arg1: u8, arg2: &vector<u8>, arg3: &0x1::option::Option<address>, arg4: &vector<u128>) {
        if (arg1 == 1) {
            ...
            assert!(0x1::vector::length<u128>(arg4) == 2, 35);
        } else if (arg1 == 4) {
            assert!(0x1::vector::length<u128>(arg4) == 2, 35);
        } else if (arg1 == 5) {
            assert!(0x1::vector::length<u128>(arg4) == 1 && *0x1::vector::borrow<u128>(arg4, 0) > 0, 35);
        } else if (arg1 == 6) {
            assert!(0x2::table::contains<vector<u8>, ChainPolicy>(&arg0.chains, *arg2), 9);
            assert!(0x1::vector::length<u128>(arg4) == 5, 35);
        } else {
            let v0 = if (arg1 == 7) {
                true
            } else if (arg1 == 8) {
    ...
    public fun vote_proposal(arg0: &mut PolicyWallet, arg1: u64, arg2: bool, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(v2.status == 0, 34);
        if (v0 > v2.created_at_ms + arg0.request_expiry_ms && v2.threshold_reached_at_ms == 0) {
            v2.status = 4;
        ...
        let v4 = 0x2::vec_set::length<address>(&v2.rejections);
        0x78a1fe63d6b76fe4eb8b442e82e21238c1ee59d516c2e690bfcd5884fec329c5::events::proposal_vote_cast(v1, arg1, 0x2::tx_context::sender(arg4), arg2, 0x2::vec_set::length<address>(&v2.approvals), v4);
        if (v4 > 0x1::vector::length<address>(&arg0.signers) - arg0.admin_threshold) {
    ...
    public fun vote_spend(arg0: &mut PolicyWallet, arg1: u64, arg2: bool, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::vec_set::length<address>(&v2.rejections);
        0x78a1fe63d6b76fe4eb8b442e82e21238c1ee59d516c2e690bfcd5884fec329c5::events::spend_vote_cast(v1, arg1, 0x2::tx_context::sender(arg4), arg2, 0x2::vec_set::length<address>(&v2.approvals), v4);
        if (v4 > 0x1::vector::length<address>(&arg0.signers) - required_approvals_for(arg0, arg1)) {
