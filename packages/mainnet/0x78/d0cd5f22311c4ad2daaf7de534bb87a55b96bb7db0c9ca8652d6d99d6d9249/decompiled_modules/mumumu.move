module 0x78d0cd5f22311c4ad2daaf7de534bb87a55b96bb7db0c9ca8652d6d99d6d9249::mumumu {
    ...
    fun init(arg0: MUMUMU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = &mut v5;
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Mumumu v5 #{token_id}"));
