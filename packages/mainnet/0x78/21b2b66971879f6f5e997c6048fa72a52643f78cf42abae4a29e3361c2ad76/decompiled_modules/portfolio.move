module 0x7821b2b66971879f6f5e997c6048fa72a52643f78cf42abae4a29e3361c2ad76::portfolio {
    ...
    public fun disable_auto_compound(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32) {
        ...
        0x2::dynamic_field::borrow_mut<PositionKey, PositionSettings>(&mut arg0.id, v0).auto_compound = false;
    }

    public fun disable_auto_exit(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32) {
        assert!(0x2::object::id<PositionManager>(arg0) == arg1.manager_id, 1);
        assert!(arg0.initialized, 3);
        let v0 = PositionKey{
            pool_id    : arg2,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow_mut<PositionKey, PositionSettings>(&mut arg0.id, v0).auto_exit = true;
    }

    public fun disable_auto_harvest(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32) {
        assert!(0x2::object::id<PositionManager>(arg0) == arg1.manager_id, 1);
        assert!(arg0.initialized, 3);
        let v0 = PositionKey{
            pool_id    : arg2,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow_mut<PositionKey, PositionSettings>(&mut arg0.id, v0).auto_harvest = false;
    }

    public fun enable_auto_compound(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32) {
        assert!(0x2::object::id<PositionManager>(arg0) == arg1.manager_id, 1);
        assert!(arg0.initialized, 3);
        let v0 = PositionKey{
            pool_id    : arg2,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow_mut<PositionKey, PositionSettings>(&mut arg0.id, v0).auto_compound = true;
    }

    public fun enable_auto_exit(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32) {
        assert!(0x2::object::id<PositionManager>(arg0) == arg1.manager_id, 1);
        assert!(arg0.initialized, 3);
        let v0 = PositionKey{
            pool_id    : arg2,
    ...
    public fun enable_auto_harvest(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32) {
        assert!(0x2::object::id<PositionManager>(arg0) == arg1.manager_id, 1);
        assert!(arg0.initialized, 3);
        let v0 = PositionKey{
            pool_id    : arg2,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow_mut<PositionKey, PositionSettings>(&mut arg0.id, v0).auto_harvest = true;
    }
    ...
    public fun is_enable_auto_compound(arg0: &PositionManager, arg1: 0x2::object::ID, arg2: u32, arg3: u32) : bool {
        let v0 = PositionKey{
            pool_id    : arg1,
            tick_lower : arg2,
            tick_upper : arg3,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow<PositionKey, PositionSettings>(&arg0.id, v0).auto_compound
    }

    public fun is_enable_auto_exit(arg0: &PositionManager, arg1: 0x2::object::ID, arg2: u32, arg3: u32) : bool {
        let v0 = PositionKey{
            pool_id    : arg1,
            tick_lower : arg2,
            tick_upper : arg3,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow<PositionKey, PositionSettings>(&arg0.id, v0).auto_exit
    }

    public fun is_enable_auto_harvest(arg0: &PositionManager, arg1: 0x2::object::ID, arg2: u32, arg3: u32) : bool {
        let v0 = PositionKey{
            pool_id    : arg1,
            tick_lower : arg2,
            tick_upper : arg3,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow<PositionKey, PositionSettings>(&arg0.id, v0).auto_harvest
    }
