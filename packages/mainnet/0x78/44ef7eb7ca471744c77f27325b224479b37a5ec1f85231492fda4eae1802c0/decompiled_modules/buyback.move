module 0x7844ef7eb7ca471744c77f27325b224479b37a5ec1f85231492fda4eae1802c0::buyback {
    ...
    public fun create_new_buyback<T0: drop>(arg0: vector<u8>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = initialize<T0>(arg0, arg2, 0x2::coin::into_balance<0x2::sui::SUI>(arg1), arg3, arg4);
        0x2::transfer::transfer<BuybackAdminCap>(v0, 0x2::tx_context::sender(arg4));
    }

    fun deposit_sui<T0: drop>(arg0: &mut Buyback<T0>, arg1: 0x2::balance::Balance<0x2::sui::SUI>) {
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.sui_balance, arg1);
    }

    fun exchange_balance_for_sui<T0: drop>(arg0: &mut Buyback<T0>, arg1: vector<vector<u8>>, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
    ...
    public fun initialize<T0: drop>(arg0: vector<u8>, arg1: u64, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) : BuybackAdminCap {
        let v0 = Buyback<T0>{
            id                  : 0x2::object::new(arg4),
            merkle_root         : arg0,
            completed_addresses : 0x2::table::new<address, Unit>(arg4),
    ...
    public fun make_exchange<T0: drop>(arg0: &mut Buyback<T0>, arg1: vector<vector<u8>>, arg2: &mut 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(exchange_balance_for_sui<T0>(arg0, arg1, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(arg2, arg3, arg4)), arg4), arg4), 0x2::tx_context::sender(arg4));
    }

    public fun make_sui_deposit<T0: drop>(arg0: &mut Buyback<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>) {
        deposit_sui<T0>(arg0, 0x2::coin::into_balance<0x2::sui::SUI>(arg1));
    }

    public fun make_withdrawal<T0: drop>(arg0: &mut Buyback<T0>, arg1: &BuybackAdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        0x2::coin::from_balance<0x2::sui::SUI>(withdraw_sui<T0>(arg0, arg1, arg2), arg3)
    }
    ...
    fun validate_buyback_from_merkle_root<T0: drop>(arg0: &Buyback<T0>, arg1: vector<vector<u8>>, arg2: address, arg3: u64) : bool {
        0x7844ef7eb7ca471744c77f27325b224479b37a5ec1f85231492fda4eae1802c0::merkle_proof::verify(&arg1, arg0.merkle_root, 0x1::hash::sha3_256(serialize_buyback_leaf(&arg2, arg3)))
    }

    fun withdraw_sui<T0: drop>(arg0: &mut Buyback<T0>, arg1: &BuybackAdminCap, arg2: u64) : 0x2::balance::Balance<0x2::sui::SUI> {
