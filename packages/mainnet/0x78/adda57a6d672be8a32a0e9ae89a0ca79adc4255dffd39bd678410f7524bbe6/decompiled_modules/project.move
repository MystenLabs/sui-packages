module 0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::project {
    ...
    public fun add_whitelist<T0, T1>(arg0: &AdminCap, arg1: &mut Project<T0, T1>, arg2: bool, arg3: vector<address>, arg4: vector<u64>, arg5: &mut 0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::Version) {
        0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::checkVersion(arg5, 1);
    ...
    public fun buy<T0, T1>(arg0: &mut Project<T0, T1>, arg1: bool, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::Version, arg5: &0x2::tx_context::TxContext) {
        0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::checkVersion(arg4, 1);
    ...
    public fun claim<T0, T1>(arg0: &mut Project<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::Version, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::checkVersion(arg2, 1);
        validate_status<T0, T1>(arg0);
    ...
    public fun distribute_fund_to_owner<T0, T1>(arg0: &AdminCap, arg1: &mut Project<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::checkVersion(arg3, 1);
    ...
    public fun emergency_withdraw<T0, T1>(arg0: &AdminCap, arg1: &mut Project<T0, T1>, arg2: &mut 0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::checkVersion(arg2, 1);
        validate_status<T0, T1>(arg1);
    ...
    public fun new_project<T0, T1>(arg0: &AdminCap, arg1: address, arg2: 0x2::coin::TreasuryCap<T1>, arg3: u8, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::Version, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::checkVersion(arg9, 1);
        ...
        assert!(v0, 1005);
        assert!(0x2::clock::timestamp_ms(arg10) < arg6, 1001);
        let v1 = RoundInfo{
    ...
    public fun refund<T0, T1>(arg0: &mut Project<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::Version, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::checkVersion(arg2, 1);
        validate_status<T0, T1>(arg0);
        assert!(!arg0.raising_threshold, 1007);
        assert!(0x2::clock::timestamp_ms(arg1) >= arg0.release_time, 1001);
    ...
    public fun remove_whitelist<T0, T1>(arg0: &AdminCap, arg1: &mut Project<T0, T1>, arg2: bool, arg3: vector<address>, arg4: &mut 0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::Version) {
        0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::checkVersion(arg4, 1);
        validate_status<T0, T1>(arg1);
    ...
    public fun trigger_project_status<T0, T1>(arg0: &AdminCap, arg1: &mut Project<T0, T1>, arg2: bool, arg3: &mut 0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::Version) {
        0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::checkVersion(arg3, 1);
        arg1.pause = arg2;
    ...
    public fun update_round_info<T0, T1>(arg0: &AdminCap, arg1: &mut Project<T0, T1>, arg2: bool, arg3: u64, arg4: u64, arg5: u64, arg6: bool, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::Version) {
        0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::checkVersion(arg9, 1);
        validate_status<T0, T1>(arg1);
        assert!(arg3 > 0, 1005);
    ...
    public fun withdraw_liquidity_fund<T0, T1>(arg0: &AdminCap, arg1: &mut Project<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x78adda57a6d672be8a32a0e9ae89a0ca79adc4255dffd39bd678410f7524bbe6::version::checkVersion(arg3, 1);
        assert!(arg1.raising_threshold, 1007);
        assert!(0x2::clock::timestamp_ms(arg2) >= arg1.release_time, 1001);
        assert!(0x2::balance::value<T0>(&arg1.funded_balance) > 0, 1011);
