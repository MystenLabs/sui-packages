module 0x780eff0fc3bdb2787600d6e9bea3c17ff712217515c54ff95466e19664b10617::community {
    ...
    public entry fun create_community(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<0x1::string::String>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<0x1::string::String>, arg8: u8, arg9: vector<u8>, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = CommunityCreatedEvent{community_id: 0x2::object::id<Community>(&v1)};
        0x2::event::emit<CommunityCreatedEvent>(v2);
        ...
        0x2::transfer::public_transfer<Community>(v1, 0x2::tx_context::sender(arg10));
    }
    ...
    public fun update_status_community(arg0: &AdminConfig, arg1: &mut Community, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
