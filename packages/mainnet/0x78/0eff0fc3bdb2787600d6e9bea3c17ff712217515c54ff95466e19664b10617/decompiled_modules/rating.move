module 0x780eff0fc3bdb2787600d6e9bea3c17ff712217515c54ff95466e19664b10617::rating {
    ...
    public entry fun rating_and_comment(arg0: &mut 0x780eff0fc3bdb2787600d6e9bea3c17ff712217515c54ff95466e19664b10617::community::Community, arg1: u64, arg2: 0x1::string::String, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x780eff0fc3bdb2787600d6e9bea3c17ff712217515c54ff95466e19664b10617::community::update_total_comments(arg0, arg4);
        0x780eff0fc3bdb2787600d6e9bea3c17ff712217515c54ff95466e19664b10617::community::update_total_reviewers(arg0, arg1, arg4);
        0x2::transfer::public_transfer<RateAndComment>(v0, 0x2::tx_context::sender(arg4));
    }

    public entry fun reply_comment(arg0: &mut 0x780eff0fc3bdb2787600d6e9bea3c17ff712217515c54ff95466e19664b10617::community::Community, arg1: &mut RateAndComment, arg2: 0x1::string::String, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = CommentChild{
            id          : 0x2::object::new(arg4),
            comment     : arg2,
            is_hidden   : 0,
