module 0x780eff0fc3bdb2787600d6e9bea3c17ff712217515c54ff95466e19664b10617::qanda {
    ...
    public entry fun question(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Qanda{
            ...
            owner           : 0x780eff0fc3bdb2787600d6e9bea3c17ff712217515c54ff95466e19664b10617::community::get_address_admin(),
    ...
    public entry fun question_by_admin(arg0: &mut 0x780eff0fc3bdb2787600d6e9bea3c17ff712217515c54ff95466e19664b10617::community::Community, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = Qanda{
    ...
    public entry fun reply_qanda(arg0: &mut 0x780eff0fc3bdb2787600d6e9bea3c17ff712217515c54ff95466e19664b10617::community::Community, arg1: address, arg2: &mut Qanda, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        0x780eff0fc3bdb2787600d6e9bea3c17ff712217515c54ff95466e19664b10617::community::validate_owner_community(arg0, arg4);
        let v0 = CommentChild{
