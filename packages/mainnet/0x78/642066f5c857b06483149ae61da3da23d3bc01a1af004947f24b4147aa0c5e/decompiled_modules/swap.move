module 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::swap {
    ...
    public fun init_funds_from_main_contract(arg0: &mut SwapGlobal, arg1: &mut 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::Global, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.creator == 0x2::tx_context::sender(arg2), 1);
        0x2::balance::join<0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::SHUI>(&mut arg0.balance_SHUI, 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::extract_swap_balance(arg1, arg2));
    }
    ...
    public fun set_whitelist(arg0: &mut SwapGlobal, arg1: &mut 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::boat_ticket::BoatTicket, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::table::add<address, u64>(&mut arg0.whitelist_table, 0x2::tx_context::sender(arg2), 50000);
        assert!(0x2::table::contains<u64, bool>(&arg0.ticket_map, 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::boat_ticket::get_index(arg1)), 8);
        0x2::table::add<u64, bool>(&mut arg0.ticket_map, 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::boat_ticket::get_index(arg1), true);
