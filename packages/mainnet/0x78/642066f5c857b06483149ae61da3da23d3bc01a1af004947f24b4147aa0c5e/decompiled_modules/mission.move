module 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::mission {
    ...
    public(friend) fun add_process(arg0: &mut MissionGlobal, arg1: 0x1::string::String, arg2: &0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity::MetaIdentity) {
        ...
        if (0x2::linked_table::contains<0x1::string::String, MissionInfo>(v0, arg1)) {
            ...
            let v2 = 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity::get_meta_id(arg2);
    ...
    public entry fun claim_invite_mission(arg0: &mut MissionGlobal, arg1: &0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity::MetaInfoGlobal, arg2: u64, arg3: &mut 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity::MetaIdentity, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 9);
        let v0 = 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity::query_invited_num(arg1, 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity::getMetaId(arg3));
        let v1 = false;
        if (arg2 == 2 && v0 >= 2) {
            arg0.invite_pool_limit = arg0.invite_pool_limit + 100;
            if (!has_clamied_invite(arg0, 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity::getMetaId(arg3), arg2)) {
                ...
                record_invite_clamied(arg0, 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity::getMetaId(arg3), arg2, arg4);
                v1 = true;
            };
        };
        if (arg2 == 5 && v0 >= 5) {
    ...
    public entry fun claim_mission(arg0: &mut MissionGlobal, arg1: 0x1::string::String, arg2: &mut 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity::MetaIdentity) {
        assert!(arg0.version == 0, 9);
        let v0 = &mut arg0.mission_records;
    ...
    public fun init_funds_from_main_contract(arg0: &mut MissionGlobal, arg1: &mut 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::Global, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.creator == 0x2::tx_context::sender(arg2), 2);
        0x2::balance::join<0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::SHUI>(&mut arg0.balance_SHUI, 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::extract_mission_reserve_balance(arg1, arg2));
    }
    ...
    public entry fun query_invite_status(arg0: &MissionGlobal, arg1: &0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity::MetaInfoGlobal, arg2: u64) : 0x1::string::String {
        let v0 = 0x1::string::utf8(b"");
        let v1 = *0x1::string::bytes(&v0);
        let v2 = 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity::query_invited_num(arg1, arg2);
    ...
    public entry fun query_mission_list(arg0: &MissionGlobal, arg1: &mut 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity::MetaIdentity, arg2: &0x2::clock::Clock) : 0x1::string::String {
        ...
        let v7 = 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity::get_meta_id(arg1);
