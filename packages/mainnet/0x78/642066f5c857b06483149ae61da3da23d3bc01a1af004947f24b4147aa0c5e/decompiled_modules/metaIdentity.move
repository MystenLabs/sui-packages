module 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::metaIdentity {
    struct MetaIdentity has key {
        ...
        bind_status: bool,
        items: 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::items::Items,
        wallet: address,
    }
    ...
    public fun get_items_info(arg0: &MetaIdentity, arg1: &0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::items::ItemGlobal) : 0x1::string::String {
        0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::items::get_items_info(arg1, &arg0.items)
    }
    ...
    public entry fun deleteMeta(arg0: MetaIdentity) {
        ...
        0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::items::destroy_empty(v6);
    ...
    public fun get_items(arg0: &mut MetaIdentity) : &mut 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::items::Items {
        &mut arg0.items
    }
    ...
    public entry fun mintInviteMeta(arg0: &mut MetaInfoGlobal, arg1: u64, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = MetaIdentity{
            ...
            email       : arg4,
            bind_status : true,
            items       : 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::items::new(arg6),
    ...
    public entry fun mintMeta(arg0: &mut MetaInfoGlobal, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = MetaIdentity{
            ...
            email       : arg3,
            bind_status : true,
            items       : 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::items::new(arg5),
