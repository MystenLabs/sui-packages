module 0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::boat_ticket {
    ...
    public entry fun buy_ticket(arg0: &mut BoatTicketGlobal, arg1: vector<0x2::coin::Coin<0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::SHUI>>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 25;
        let v1 = 0x1::vector::pop_back<0x2::coin::Coin<0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::SHUI>>(&mut arg1);
        assert!(arg0.num < 5000, 6);
        0x2::pay::join_vec<0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::SHUI>(&mut v1, arg1);
        assert!(0x2::coin::value<0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::SHUI>(&v1) >= v0 * 1000000000, 4);
        0x2::balance::join<0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::SHUI>(&mut arg0.balance_SHUI, 0x2::coin::into_balance<0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::SHUI>(0x2::coin::split<0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::SHUI>(&mut v1, v0 * 1000000000, arg2)));
        if (0x2::coin::value<0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::SHUI>(&v1) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::SHUI>>(v1, 0x2::tx_context::sender(arg2));
        } else {
            0x2::coin::destroy_zero<0x78642066f5c857b06483149ae61da3da23d3bc01a1af004947f24b4147aa0c5e::shui::SHUI>(v1);
        };
        arg0.num = arg0.num + 1;
        let v2 = BoatTicket{
