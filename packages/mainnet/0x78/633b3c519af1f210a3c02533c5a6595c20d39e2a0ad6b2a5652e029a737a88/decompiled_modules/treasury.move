module 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury {
    ...
    public fun deposit_balance<T0>(arg0: &mut Vault<T0>, arg1: 0x2::balance::Balance<T0>) {
        0x2::balance::join<T0>(&mut arg0.balance, arg1);
    }

    public fun deposit_balance_with_event<T0>(arg0: &mut Vault<T0>, arg1: 0x2::balance::Balance<T0>) {
        0x2::balance::join<T0>(&mut arg0.balance, arg1);
    ...
    public fun deposit_balance_with_threshold<T0>(arg0: &mut Vault<T0>, arg1: 0x2::balance::Balance<T0>, arg2: u64) {
        assert!(0x2::balance::value<T0>(&arg1) >= arg2, 2);
        0x2::balance::join<T0>(&mut arg0.balance, arg1);
    }

    public fun deposit_balance_with_threshold_and_event<T0>(arg0: &mut Vault<T0>, arg1: 0x2::balance::Balance<T0>, arg2: u64) {
