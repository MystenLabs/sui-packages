module 0x7853a6de8198d75894e4376bdd8c6349dda7446345de6454feb6fab6ed26ef91::u128 {
    ...
    public fun average_vector(arg0: vector<u128>) : u128 {
        ...
        if (v0 == 0) {
            ...
            while (v2 < 0x1::vector::length<u128>(&arg0)) {
                let v4 = (v3 as u256);
                v3 = v4 + (*0x1::vector::borrow<u128>(&arg0, v2) as u256);
                v2 = v2 + 1;
            };
            ((v3 / (v0 as u256)) as u128)
        }
    }
    ...
    public fun mul_div_up(arg0: u128, arg1: u128, arg2: u128) : u128 {
        ...
        (((((v0 as u256) * (v1 as u256) / (v2 as u256)) as u256) + v3) as u128)
    }
    ...
    public fun sum(arg0: vector<u128>) : u128 {
        ...
        while (v0 < 0x1::vector::length<u128>(&arg0)) {
            let v2 = (v1 as u128);
            v1 = v2 + (*0x1::vector::borrow<u128>(&arg0, v0) as u128);
            v0 = v0 + 1;
        };
        v1
    }
    ...
    public fun try_add(arg0: u128, arg1: u128) : (bool, u128) {
        let v0 = (arg0 as u256);
        let v1 = (arg1 as u256);
        let v2 = (340282366920938463463374607431768211455 as u256);
        if (v0 == v2 && v1 != 0) {
            (false, 0)
        } else if (v1 > v2 - v0) {
            (false, 0)
    ...
    public fun try_mul(arg0: u128, arg1: u128) : (bool, u128) {
        ...
        let (v2, v3) = if (v1 == 0) {
            (true, 0)
        } else if (v0 > (340282366920938463463374607431768211455 as u256) / v1) {
            (false, 0)
        } else {
            (true, v0 * v1)
        };
    ...
    public fun try_mul_div_down(arg0: u128, arg1: u128, arg2: u128) : (bool, u128) {
        ...
        if (v2 == 0) {
            ...
            if (!v7) {
                ...
                if (v8 > (340282366920938463463374607431768211455 as u256)) {
                    (false, 0)
                } else {
                    (true, (v8 as u128))
                }
    ...
    public fun try_mul_div_up(arg0: u128, arg1: u128, arg2: u128) : (bool, u128) {
        ...
        if (v2 == 0) {
            ...
            if (!v7) {
                ...
                if (v12 > (340282366920938463463374607431768211455 as u256)) {
                    (false, 0)
                } else {
                    (true, (v12 as u128))
                }
