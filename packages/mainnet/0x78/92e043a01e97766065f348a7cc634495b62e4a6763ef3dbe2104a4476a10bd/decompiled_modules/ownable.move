module 0x7892e043a01e97766065f348a7cc634495b62e4a6763ef3dbe2104a4476a10bd::ownable {
    ...
    public fun assert_version(arg0: &AdminCap) {
        assert!(arg0.version == 0x7892e043a01e97766065f348a7cc634495b62e4a6763ef3dbe2104a4476a10bd::version::get_program_version(), 2);
    }
    ...
    public(friend) fun grant_admin_cap(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = AdminCap{
            ...
            version : 0x7892e043a01e97766065f348a7cc634495b62e4a6763ef3dbe2104a4476a10bd::version::get_program_version(),
        };
    ...
    public(friend) fun migrate(arg0: &mut AdminCap, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x7892e043a01e97766065f348a7cc634495b62e4a6763ef3dbe2104a4476a10bd::version::get_program_version();
