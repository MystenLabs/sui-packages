module 0x7669be207f9ac28a34d2cbd45dcfdade11e6fd503ad24e687c180931be9a45e9::registry {
    ...
    public fun renounce_ownership(arg0: &mut Registry, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0);
        assert!(0x2::table::contains<address, AgentRecord>(&arg0.agents, arg1), 1);
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = 0x2::clock::timestamp_ms(arg2);
        let v2 = 0x2::table::borrow_mut<address, AgentRecord>(&mut arg0.agents, arg1);
        assert!(0x1::option::contains<address>(&v2.owner, &v0), 2);
        v2.owner = 0x1::option::none<address>();
        v2.updated_at_ms = v1;
        let v3 = OwnershipRenounced{
            agent        : arg1,
            owner        : v0,
            timestamp_ms : v1,
        };
        0x2::event::emit<OwnershipRenounced>(v3);
    }
