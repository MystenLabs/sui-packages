module 0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::vesting {
    ...
    public entry fun acceptAdmin3(arg0: &mut AdminCapVault, arg1: &mut 0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg1, 3);
        let v0 = *0x1::option::borrow<address>(&arg0.to);
        execTransferAdmin3(arg0, v0, arg1, arg2);
    }
    ...
    public fun addFund3<T0>(arg0: &AdminCap, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: &mut Project<T0>, arg4: &mut ProjectRegistry, arg5: &0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg5, 3);
        assert!(!arg3.deprecated, 8009);
        let v0 = (0x2::coin::value<T0>(&arg2) as u128);
        assert!(v0 > 0, 8001);
        arg3.deposited = arg3.deposited + v0;
    ...
    public entry fun addFundAfterRemoved3<T0>(arg0: &AdminCap, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: u128, arg4: u128, arg5: &mut Project<T0>, arg6: &mut ProjectRegistry, arg7: &0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg7, 3);
        assert!(!arg5.deprecated, 8009);
        let v0 = (0x2::coin::value<T0>(&arg2) as u128);
        assert!(v0 > 0 && arg4 >= 0 && arg3 >= arg4 && arg3 - arg4 >= v0, 8001);
        assert!(!0x2::table::contains<address, Fund<T0>>(&mut arg5.funds, arg1), 8012);
    ...
    public fun addFunds3<T0>(arg0: &AdminCap, arg1: vector<address>, arg2: vector<u64>, arg3: 0x2::coin::Coin<T0>, arg4: &mut Project<T0>, arg5: &mut ProjectRegistry, arg6: &0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version, arg7: &mut 0x2::tx_context::TxContext) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg6, 3);
        let v0 = 0x1::vector::length<address>(&arg1);
        let v1 = 0;
        assert!(0x1::vector::length<u64>(&arg2) == v0, 8001);
        while (v1 < v0) {
            addFund3<T0>(arg0, *0x1::vector::borrow<address>(&arg1, v1), 0x2::coin::split<T0>(&mut arg3, *0x1::vector::borrow<u64>(&arg2, v1), arg7), arg4, arg5, arg6);
            v1 = v1 + 1;
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg3, 0x2::tx_context::sender(arg7));
    }

    public fun addFundsAfterRemoved3<T0>(arg0: &AdminCap, arg1: vector<address>, arg2: vector<u64>, arg3: 0x2::coin::Coin<T0>, arg4: vector<u128>, arg5: vector<u128>, arg6: &mut Project<T0>, arg7: &mut ProjectRegistry, arg8: &0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version, arg9: &mut 0x2::tx_context::TxContext) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg8, 3);
        assert!(!arg6.deprecated, 8009);
        let v0 = 0x1::vector::length<address>(&arg1);
        let v1 = 0;
        assert!(0x1::vector::length<u64>(&arg2) == v0 && 0x1::vector::length<u128>(&arg4) == v0 && 0x1::vector::length<u128>(&arg5) == v0, 8001);
        while (v1 < v0) {
            addFundAfterRemoved3<T0>(arg0, *0x1::vector::borrow<address>(&arg1, v1), 0x2::coin::split<T0>(&mut arg3, *0x1::vector::borrow<u64>(&arg2, v1), arg9), *0x1::vector::borrow<u128>(&arg4, v1), *0x1::vector::borrow<u128>(&arg5, v1), arg6, arg7, arg8);
            v1 = v1 + 1;
        };
    ...
    public fun claim3<T0>(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut Project<T0>, arg2: &0x2::clock::Clock, arg3: &0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version, arg4: &mut ProjectRegistry, arg5: &mut 0x2::tx_context::TxContext) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg3, 3);
        assert!(!arg1.paused, 8010);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg0) >= arg1.fee, 8008);
        let v0 = 0x2::clock::timestamp_ms(arg2);
        assert!(v0 >= arg1.tge_ms, 8002);
    ...
    public fun createProject3<T0>(arg0: &AdminCap, arg1: vector<u8>, arg2: vector<u8>, arg3: u128, arg4: u64, arg5: u8, arg6: u64, arg7: u64, arg8: u64, arg9: vector<u64>, arg10: vector<u64>, arg11: &0x2::clock::Clock, arg12: &mut 0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version, arg13: u64, arg14: &mut ProjectRegistry, arg15: &mut 0x2::tx_context::TxContext) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg12, 3);
        assert!(arg5 >= 1 && arg5 <= 4, 8005);
        assert!(arg4 >= 0x2::clock::timestamp_ms(arg11) && arg3 > 0 && 0x1::vector::length<u8>(&arg1) > 0 && 0x1::vector::length<u8>(&arg2) > 0 && arg7 >= 0 && arg7 <= 10000 && arg6 >= 0, 8001);
        if (arg5 == 2 || arg5 == 1) {
            assert!(0x1::vector::length<u64>(&arg9) == 0x1::vector::length<u64>(&arg10) && 0x1::vector::length<u64>(&arg9) >= 0 && arg8 == 0, 8006);
    ...
    fun execTransferAdmin3(arg0: &mut AdminCapVault, arg1: address, arg2: &mut 0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg2, 3);
        assert!(0x1::option::is_some<AdminCap>(&arg0.cap) && arg1 == 0x2::tx_context::sender(arg3), 8003);
        0x2::transfer::transfer<AdminCap>(0x1::option::extract<AdminCap>(&mut arg0.cap), 0x2::tx_context::sender(arg3));
        0x1::option::extract<address>(&mut arg0.owner);
        0x1::option::extract<address>(&mut arg0.to);
    ...
    public fun pauseProject3<T0>(arg0: &AdminCap, arg1: &mut Project<T0>, arg2: bool, arg3: &mut 0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg3, 3);
        arg1.paused = arg2;
    }
    ...
    public fun removeFund3<T0>(arg0: &AdminCap, arg1: address, arg2: &mut Project<T0>, arg3: &mut ProjectRegistry, arg4: &0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg4, 3);
        assert!(0x2::table::contains<address, Fund<T0>>(&mut arg2.funds, arg1), 8004);
        let Fund {
            owner         : v0,
            total         : _,
        ...
        arg2.deposited = arg2.deposited - v6;
        arg2.deposited_percent = arg2.deposited * 10000 / arg2.supply;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v5, @0x28518ae2df96db91c63d77ec3f39c4ba53c7c2fae0976a7d6ef84eb9c9507545);
        removeProjectFromRegistry(arg3, v0, 0x2::object::id_address<Project<T0>>(arg2));
        let v7 = FundRemoveEvent{
            owner   : v0,
            project : 0x2::object::id_address<Project<T0>>(arg2),
        ...
        let v8 = FundRemoveEvent2{
            owner    : v0,
            receiver : @0x28518ae2df96db91c63d77ec3f39c4ba53c7c2fae0976a7d6ef84eb9c9507545,
            project  : 0x2::object::id_address<Project<T0>>(arg2),
            fund     : v6,
        };
        0x2::event::emit<FundRemoveEvent2>(v8);
    ...
    public fun removeFunds3<T0>(arg0: &AdminCap, arg1: vector<address>, arg2: &mut Project<T0>, arg3: &mut ProjectRegistry, arg4: &0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg4, 3);
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg1)) {
            removeFund3<T0>(arg0, *0x1::vector::borrow<address>(&arg1, v0), arg2, arg3, arg4, arg5);
            v0 = v0 + 1;
        };
    }
    ...
    public entry fun revokeAdmin3(arg0: &mut AdminCapVault, arg1: &mut 0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg1, 3);
        let v0 = *0x1::option::borrow<address>(&arg0.owner);
        execTransferAdmin3(arg0, v0, arg1, arg2);
    }
    ...
    public fun setDeprecated3<T0>(arg0: &AdminCap, arg1: &mut Project<T0>, arg2: bool, arg3: &mut 0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg3, 3);
        arg1.deprecated = arg2;
    }
    ...
    public fun setProjectFee3<T0>(arg0: &AdminCap, arg1: &mut Project<T0>, arg2: u64, arg3: &mut 0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg3, 3);
        arg1.fee = arg2;
    }
    ...
    public entry fun transferAdmin3(arg0: AdminCap, arg1: address, arg2: &mut AdminCapVault, arg3: &mut 0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg3, 3);
        0x1::option::fill<address>(&mut arg2.owner, 0x2::tx_context::sender(arg4));
        0x1::option::fill<address>(&mut arg2.to, arg1);
        0x1::option::fill<AdminCap>(&mut arg2.cap, arg0);
    ...
    public fun withdrawFee3<T0>(arg0: &AdminCap, arg1: &mut Project<T0>, arg2: &mut 0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg2, 3);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1.feeTreasury, 0x2::coin::value<0x2::sui::SUI>(&arg1.feeTreasury), arg3), @0x28518ae2df96db91c63d77ec3f39c4ba53c7c2fae0976a7d6ef84eb9c9507545);
    }
