module 0x78651a6b80ca0eb35dcb3034a35eac6f18e51992a697427a4d351b9e56b56de5::distribution_config {
    ...
    public fun checked_package_version(arg0: &DistributionConfig) {
        assert!(arg0.version == 2, 458466182903521300);
    }
    ...
    public fun set_package_version(arg0: &mut DistributionConfig, arg1: &0x2::package::Publisher, arg2: u64) {
        ...
        assert!(arg2 <= 2, 326963916733903800);
        arg0.version = arg2;
    }
