module 0x78bdf769b85d6a0fa787561739df0e55063d9eca79aa1cce3904f3e9aeac3273::authentication {
    ...
    public fun new<T0>(arg0: &mut Registry, arg1: address, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &T0, arg5: &mut 0x2::tx_context::TxContext) : Protocol<T0> {
        0x2::dynamic_field::add<0x1::string::String, bool>(&mut arg0.id, 0x78bdf769b85d6a0fa787561739df0e55063d9eca79aa1cce3904f3e9aeac3273::utils::type_to_string<T0>(), true);
    ...
    public fun get_initiator<T0>(arg0: &Authentication<T0>) : address {
        arg0.initiater
    }

    public fun get_one_output<T0>(arg0: &Authentication<T0>, arg1: &0x1::string::String) : &0x1::string::String {
        0x2::vec_map::get<0x1::string::String, 0x1::string::String>(&arg0.output, arg1)
    }

    public fun get_output<T0>(arg0: &Authentication<T0>) : 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
        arg0.output
    }
    ...
    public fun into_output_keys<T0>(arg0: &Authentication<T0>) : vector<0x1::string::String> {
        0x2::vec_map::keys<0x1::string::String, 0x1::string::String>(&arg0.output)
    }

    public fun protocol_ouput_keys<T0>(arg0: &Protocol<T0>) : vector<0x1::string::String> {
        0x2::vec_map::keys<0x1::string::String, 0x1::string::String>(&arg0.config.output)
    }
    ...
    public fun signin<T0: store + key, T1>(arg0: &Protocol<T1>, arg1: &mut HolderCap<T0>, arg2: vector<u8>, arg3: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>, arg4: &mut 0x2::tx_context::TxContext) : Authentication<T0> {
        let (v0, v1) = 0x78bdf769b85d6a0fa787561739df0e55063d9eca79aa1cce3904f3e9aeac3273::utils::extract_signature_and_pubilc_key(arg2);
        let v2 = v1;
        let v3 = v0;
        assert!(arg0.config.address == 0x78bdf769b85d6a0fa787561739df0e55063d9eca79aa1cce3904f3e9aeac3273::utils::derive_address_from_ed25519(v2), 103);
        ...
        while (v7 < 0x1::vector::length<0x1::string::String>(&v6)) {
            ...
            if (v9 == 0x1::string::utf8(b"sender")) {
                ...
                0x1::string::append(&mut v10, 0x78bdf769b85d6a0fa787561739df0e55063d9eca79aa1cce3904f3e9aeac3273::utils::type_to_string<T0>());
                0x1::string::append(&mut v8, v10);
            } else {
        ...
        let v11 = 0x78bdf769b85d6a0fa787561739df0e55063d9eca79aa1cce3904f3e9aeac3273::utils::hash_message(0x1::string::into_bytes(v5));
        assert!(0x2::ed25519::ed25519_verify(&v3, &v2, &v11), 102);
