module 0x78d6799251d023fee532b00ed9e50f3c5d3e1a860d88a72b9993567c7f628cec::agialpha {
    struct AGIALPHA has drop {
        dummy_field: bool,
    }

    public entry fun burn(arg0: &mut 0x2::coin::TreasuryCap<AGIALPHA>, arg1: 0x2::coin::Coin<AGIALPHA>) {
        0x2::coin::burn<AGIALPHA>(arg0, arg1);
    }

    fun mint_and_transfer(arg0: &mut 0x2::coin::TreasuryCap<AGIALPHA>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::mint_and_transfer<AGIALPHA>(arg0, arg1, arg2, arg3);
    }
