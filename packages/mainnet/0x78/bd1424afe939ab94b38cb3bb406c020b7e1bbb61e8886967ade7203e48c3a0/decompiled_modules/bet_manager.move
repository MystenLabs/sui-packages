module 0x78bd1424afe939ab94b38cb3bb406c020b7e1bbb61e8886967ade7203e48c3a0::bet_manager {
    ...
    public(friend) fun get_bet_payout(arg0: &BetManager, arg1: &BetSetting, arg2: u64, arg3: vector<Placement>, arg4: vector<u64>) : (u64, u64) {
        ...
        let v5 = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(v4, 10, 1);
        while (v0 < 0x1::vector::length<Placement>(&arg3)) {
            let (v6, v7) = get_placement_data(0x1::vector::borrow<Placement>(&arg3, v0));
            let v8 = v6;
            assert!(0x1::vector::contains<u64>(&arg4, &v8), 1);
            assert!((v7 as u64) < v4, 2);
            v1 = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(v1, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_rate(v5, v3 - v2 - v0 * arg0.combo_edge), *0x2::vec_map::get<u64, u64>(&arg1.odd_weights, &v8), 1), 10);
            v0 = v0 + 1;
        };
        (v1, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(arg2, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_rate(v5, v3 - v2), 10))
    }
    ...
    public(friend) fun won_bet(arg0: vector<Placement>, arg1: vector<u64>) : bool {
        ...
        while (v1 < 0x1::vector::length<Placement>(&arg0)) {
            ...
            if ((v2.rank_index as u64) >= 0x1::vector::length<u64>(&arg1)) {
                break
            };
