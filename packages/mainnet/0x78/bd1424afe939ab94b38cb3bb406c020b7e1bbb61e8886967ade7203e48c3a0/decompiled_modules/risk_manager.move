module 0x78bd1424afe939ab94b38cb3bb406c020b7e1bbb61e8886967ade7203e48c3a0::risk_manager {
    ...
    public(friend) fun add_risk(arg0: &mut RiskManager, arg1: 0x1::type_name::TypeName, arg2: vector<0x78bd1424afe939ab94b38cb3bb406c020b7e1bbb61e8886967ade7203e48c3a0::bet_manager::Placement>, arg3: u64) {
        ...
        let v3 = 0;
        while (v3 < 0x1::vector::length<0x78bd1424afe939ab94b38cb3bb406c020b7e1bbb61e8886967ade7203e48c3a0::bet_manager::Placement>(&arg2)) {
            let (v4, v5) = 0x78bd1424afe939ab94b38cb3bb406c020b7e1bbb61e8886967ade7203e48c3a0::bet_manager::get_placement_data(0x1::vector::borrow<0x78bd1424afe939ab94b38cb3bb406c020b7e1bbb61e8886967ade7203e48c3a0::bet_manager::Placement>(&arg2, v3));
