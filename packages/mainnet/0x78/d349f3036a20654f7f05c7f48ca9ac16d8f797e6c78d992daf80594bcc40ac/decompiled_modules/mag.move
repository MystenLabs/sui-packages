module 0x78d349f3036a20654f7f05c7f48ca9ac16d8f797e6c78d992daf80594bcc40ac::mag {
    struct MAG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MAG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/Gi2ce3Eu6dt8iAS2pa8hLsoudSEvew477SVJkHUipump.png?size=lg&key=851e0d                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<MAG>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MAG     ")))), trim_right(b"Magnum SniperBot                "), trim_right(b"The Fastest On-chain Automated Trading Platform                                                                                                                                                                                                                                                                                 "), v2, arg1);
        let v5 = v3;
