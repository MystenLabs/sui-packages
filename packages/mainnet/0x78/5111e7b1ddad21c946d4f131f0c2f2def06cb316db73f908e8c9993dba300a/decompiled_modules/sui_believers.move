module 0x785111e7b1ddad21c946d4f131f0c2f2def06cb316db73f908e8c9993dba300a::sui_believers {
    struct SUI_BELIEVERS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_BELIEVERS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_BELIEVERS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SUI Believers"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"In SUI We Trust"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifharffclenxbt5mdnazyprcmp4tcp47c4axd4fjpbysybcbefnaa"));
