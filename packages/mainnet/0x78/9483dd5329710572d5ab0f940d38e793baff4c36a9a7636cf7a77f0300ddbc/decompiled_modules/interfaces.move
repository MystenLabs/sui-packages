module 0x789483dd5329710572d5ab0f940d38e793baff4c36a9a7636cf7a77f0300ddbc::interfaces {
    ...
    public fun get_reward_pool_apy(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle::PriceOracle, arg2: u16, arg3: address, arg4: u16, arg5: &0x2::clock::Clock) : u256 {
        ...
        let v2 = if (0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::get_reward_action(v1) == 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_codec::get_supply_type()) {
    ...
    public fun get_reward_pool_loop_apy(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle::PriceOracle, arg2: u16, arg3: address, arg4: u16, arg5: &0x2::clock::Clock) : u256 {
        let v0 = if (arg2 == 3) {
            9
        } else if (arg4 == 8) {
            6
        ...
        let v6 = if (v3 == 0 || 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_timestamp(arg5) >= 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::get_end_time(v1)) {
            0
        } else {
            0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_value(arg1, arg2, v5) * 10000 / v3 / 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray()
        };
        v6 * 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray_div(0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray(), 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray() - 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray_div(0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_collateral_coefficient(arg0, arg4), 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_borrow_coefficient(arg0, arg4))) / 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray()
    }

    public entry fun get_reward_pool_loop_apys(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle::PriceOracle, arg2: vector<u16>, arg3: vector<address>, arg4: vector<u16>, arg5: &0x2::clock::Clock) {
        let v0 = 0x1::vector::empty<RewardPoolApy>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<address>(&arg3)) {
            let v2 = *0x1::vector::borrow<address>(&arg3, v1);
            let v3 = RewardPoolApy{
                reward_pool_info : v2,
                apy              : get_reward_pool_loop_apy(arg0, arg1, *0x1::vector::borrow<u16>(&arg2, v1), v2, *0x1::vector::borrow<u16>(&arg4, v1), arg5),
            };
            0x1::vector::push_back<RewardPoolApy>(&mut v0, v3);
            v1 = v1 + 1;
        };
    ...
    public entry fun get_user_allowed_withdraw(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::pool_manager::PoolManagerInfo, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg2: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle::PriceOracle, arg3: u16, arg4: vector<u8>, arg5: u64, arg6: u16, arg7: bool) {
        ...
        let (v3, v4, v5) = if (0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::is_liquid_asset(arg1, arg5, arg6)) {
            ...
            let v9 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_amount(arg2, arg6, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray_div(v0 - 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray_mul(v1, 1050000000000000000000000000), v2));
            ...
            if (arg7 && v14 > 1050000000000000000000000000 && v9 >= v10) {
                v5 = v11 * 10;
            };
            (v12, v13, v5)
        };
