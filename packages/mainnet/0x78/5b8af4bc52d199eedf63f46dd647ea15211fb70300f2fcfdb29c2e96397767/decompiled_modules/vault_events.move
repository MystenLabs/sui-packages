module 0x9b149fa785d17c7f7d94c6132c21649cc13e73f55e0e8d6bf957f4dc208d22b6::vault_events {
    ...
    struct AdminDepositRecordFixed has copy, drop {
        user: address,
        record_id: u64,
        old_status: u8,
        new_status: u8,
    ...
    struct AdminUserRecordSharesFixed has copy, drop {
        user: address,
        record_id: u64,
        old_shares: u64,
        new_shares: u64,
    ...
    public fun emit_admin_deposit_record_fixed(arg0: address, arg1: u64, arg2: u8, arg3: u8) {
        let v0 = AdminDepositRecordFixed{
            user       : arg0,
            record_id  : arg1,
            old_status : arg2,
            new_status : arg3,
        };
        0x2::event::emit<AdminDepositRecordFixed>(v0);
    }
    ...
    public fun emit_admin_user_record_shares_fixed(arg0: address, arg1: u64, arg2: u64, arg3: u64) {
        let v0 = AdminUserRecordSharesFixed{
            user       : arg0,
            record_id  : arg1,
            old_shares : arg2,
            new_shares : arg3,
        };
        0x2::event::emit<AdminUserRecordSharesFixed>(v0);
    }
