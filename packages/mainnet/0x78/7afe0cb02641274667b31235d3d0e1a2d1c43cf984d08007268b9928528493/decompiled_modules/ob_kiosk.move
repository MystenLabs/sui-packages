module 0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk {
    ...
    fun assert_is_ob_kiosk_imut(arg0: &0x2::kiosk::Kiosk) {
        assert!(is_ob_kiosk_imut(arg0), 5);
    }
    ...
    fun deposit_setting(arg0: &mut 0x2::kiosk::Kiosk) : &DepositSetting {
        assert_is_ob_kiosk(arg0);
        let v0 = DepositSettingDfKey{dummy_field: false};
        0x2::dynamic_field::borrow<DepositSettingDfKey, DepositSetting>(0x2::kiosk::uid(arg0), v0)
    }
