module 0x78ff861b557bcda92429d482d485d6cc1d405d0e74619537d193c692d6c8ecf1::reward3798 {
    struct REWARD3798 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeReward3798(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REWARD3798, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3798>(arg0, arg1);
