module 0x785d4ce35c6285c54455cfe349a2aadb1952257aa53227a1200409a55957a77d::xcore_inner {
    ...
    public(friend) fun add_wallet(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: 0x1::type_name::TypeName, arg3: 0x2::object::ID, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: u32, arg9: u32, arg10: u32, arg11: &mut 0x2::tx_context::TxContext) : (u64, address) {
        ...
        0x785d4ce35c6285c54455cfe349a2aadb1952257aa53227a1200409a55957a77d::events::emit_wallet_added(arg2, v10.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v10.dwallet_cap), arg3, v11, arg8, arg9, arg10);
    ...
    public(friend) fun decrement_balance(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: PresignCap, arg3: 0x1::type_name::TypeName, arg4: vector<u8>, arg5: vector<u8>, arg6: address, arg7: u64, arg8: vector<u8>, arg9: u256, arg10: &mut 0x2::tx_context::TxContext) : (u256, 0x2::object::ID) {
        let PresignCap {
            id            : v0,
            app_type_name : v1,
            wallet_key    : v2,
        ...
        assert!(v1 == arg3, 15);
        let v4 = app_state_mut(arg0, arg3);
        assert!(!v4.paused, 12);
        assert!(v2 < v4.wallet_count, 7);
        let v5 = subtract_balance(v4, v2, arg6, arg7, arg8, arg9);
        let (v6, v7) = withdraw_payment_coins(v4, arg10);
        let v8 = v7;
        let v9 = v6;
        let v10 = wallet(v4, v2);
        let v11 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::verify_presign_cap(arg1, v3, arg10);
        let v12 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::approve_message(arg1, &v10.dwallet_cap, v10.signature_algorithm, v10.hash_scheme, arg5);
        let v13 = random_session_identifier(arg1, arg10);
        let v14 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::request_sign_and_return_id(arg1, v11, v12, arg4, v13, &mut v9, &mut v8, arg10);
        0x785d4ce35c6285c54455cfe349a2aadb1952257aa53227a1200409a55957a77d::events::emit_decrement_balance(arg3, v2, arg6, arg7, arg8, arg9, v5, arg4, arg5, v14, v10.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v10.dwallet_cap));
        return_payment_coins(v4, v9, v8);
        (v5, v14)
    }
    ...
    public(friend) fun increment_balance(arg0: &mut StateV1, arg1: 0x1::type_name::TypeName, arg2: vector<u8>, arg3: u64, arg4: address, arg5: u64, arg6: vector<u8>, arg7: u256, arg8: &mut 0x2::tx_context::TxContext) : u256 {
        ...
        *v5 = v6;
        ...
        0x785d4ce35c6285c54455cfe349a2aadb1952257aa53227a1200409a55957a77d::events::emit_increment_balance(arg1, arg2, arg3, arg4, arg5, arg6, arg7, v6, v7.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v7.dwallet_cap));
        v6
    }
    ...
    public(friend) fun init_app(arg0: &mut StateV1, arg1: 0x1::type_name::TypeName, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x785d4ce35c6285c54455cfe349a2aadb1952257aa53227a1200409a55957a77d::events::emit_app_initialized(arg1);
    }

    public(friend) fun mint_presign(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : PresignCap {
        let v0 = app_state_mut(arg0, arg2);
        assert!(!v0.paused, 12);
        ...
        0x785d4ce35c6285c54455cfe349a2aadb1952257aa53227a1200409a55957a77d::events::emit_presign_added(arg2, v5.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v5.dwallet_cap));
        let v7 = PresignCap{
            id            : 0x2::object::new(arg4),
            app_type_name : arg2,
            wallet_key    : arg3,
            cap           : 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::request_global_presign(arg1, v5.dwallet_network_encryption_key_id, v5.curve, v5.signature_algorithm, v6, &mut v4, &mut v3, arg4),
        };
        return_payment_coins(v0, v4, v3);
        v7
    }
    ...
    public(friend) fun sign(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: PresignCap, arg3: 0x1::type_name::TypeName, arg4: vector<u8>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let PresignCap {
            id            : v0,
            app_type_name : v1,
            wallet_key    : v2,
        ...
        assert!(!v4.paused, 12);
        assert!(v2 < v4.wallet_count, 7);
        let (v5, v6) = withdraw_payment_coins(v4, arg6);
        let v7 = v6;
        let v8 = v5;
        let v9 = wallet(v4, v2);
        let v10 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::verify_presign_cap(arg1, v3, arg6);
        ...
        let v12 = random_session_identifier(arg1, arg6);
        let v13 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::request_sign_and_return_id(arg1, v10, v11, arg4, v12, &mut v8, &mut v7, arg6);
        0x785d4ce35c6285c54455cfe349a2aadb1952257aa53227a1200409a55957a77d::events::emit_sign_requested(arg3, v2, arg4, arg5, v13, v9.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v9.dwallet_cap));
        return_payment_coins(v4, v8, v7);
        v13
    }
