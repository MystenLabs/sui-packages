module 0x785d4ce35c6285c54455cfe349a2aadb1952257aa53227a1200409a55957a77d::upgrade {
    struct UpgradeManager has key {
        id: 0x2::object::UID,
        upgrade_cap: 0x2::package::UpgradeCap,
    }

    public fun admin_upgrade(arg0: &mut UpgradeManager, arg1: &0x785d4ce35c6285c54455cfe349a2aadb1952257aa53227a1200409a55957a77d::admin::AdminCap, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::package::UpgradeTicket {
