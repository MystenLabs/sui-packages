module 0x78fdd92810f35c26367002f2406cc48f510f2ab3f37736163ef570a9249acb83::congratulationsyouwon1000suiclaimyourgainnowatwwwsuilotterycom {
    ...
    fun init(arg0: CONGRATULATIONSYOUWON1000SUICLAIMYOURGAINNOWATWWWSUILOTTERYCOM, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CONGRATULATIONSYOUWON1000SUICLAIMYOURGAINNOWATWWWSUILOTTERYCOM>(arg0, 9, b"congratulations! you won 1000 sui ! claim your gain now at: www.sui-lottery.com", b"won", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/Fqpoqu0.png")), arg1);
        let v2 = v0;
