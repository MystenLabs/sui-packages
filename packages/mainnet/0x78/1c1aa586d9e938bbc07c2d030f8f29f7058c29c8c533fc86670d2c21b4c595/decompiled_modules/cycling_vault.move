module 0x781c1aa586d9e938bbc07c2d030f8f29f7058c29c8c533fc86670d2c21b4c595::cycling_vault {
    ...
    public fun withdraw<T0, T1>(arg0: &mut VaultConfig, arg1: Vault<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v15 = v3;
        let v16 = v4;
        0x2::balance::join<T0>(&mut v15, v5);
        0x2::balance::join<T1>(&mut v16, v6);
        let v17 = VaultWithdrawn{
            vault_id : 0x2::object::uid_to_address(&v14),
            owner    : v1,
            total_x  : 0x2::balance::value<T0>(&v15),
            total_y  : 0x2::balance::value<T1>(&v16),
        };
        0x2::event::emit<VaultWithdrawn>(v17);
        0x2::object::delete(v14);
        (0x2::coin::from_balance<T0>(v15, arg2), 0x2::coin::from_balance<T1>(v16, arg2))
    }
