module 0x78430a0e1a73894ee4d9bbadc9353cc48cffe0f9bb62a61846bb47699f0fcb8f::sui {
    struct SUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<SUI>(&mut v2, 300000 * 0x1::u64::pow(10, 9), 0x2::tx_context::sender(arg1), arg1);
