module 0x78382793ee7a27d0a4ee440203382bb63f383d9b52feb425b839a9ac4d6dc443::time_locked_balance {
    ...
    public fun change_unlock_per_second<T0>(arg0: &mut TimeLockedBalance<T0>, arg1: u64, arg2: &0x2::clock::Clock) {
        ...
        arg0.final_unlock_ts_sec = calc_final_unlock_ts_sec(0x1::u64::max(arg0.unlock_start_ts_sec, 0x78382793ee7a27d0a4ee440203382bb63f383d9b52feb425b839a9ac4d6dc443::utils::timestamp_sec(arg2)), 0x2::balance::value<T0>(&arg0.locked_balance), arg1);
    }

    public fun change_unlock_start_ts_sec<T0>(arg0: &mut TimeLockedBalance<T0>, arg1: u64, arg2: &0x2::clock::Clock) {
        unlock<T0>(arg0, arg2);
        let v0 = 0x1::u64::max(arg1, 0x78382793ee7a27d0a4ee440203382bb63f383d9b52feb425b839a9ac4d6dc443::utils::timestamp_sec(arg2));
    ...
    public fun remaining_unlock<T0>(arg0: &TimeLockedBalance<T0>, arg1: &0x2::clock::Clock) : u64 {
        let v0 = 0x1::u64::max(arg0.unlock_start_ts_sec, 0x78382793ee7a27d0a4ee440203382bb63f383d9b52feb425b839a9ac4d6dc443::utils::timestamp_sec(arg1));
    ...
    public fun top_up<T0>(arg0: &mut TimeLockedBalance<T0>, arg1: 0x2::balance::Balance<T0>, arg2: &0x2::clock::Clock) {
        ...
        arg0.final_unlock_ts_sec = calc_final_unlock_ts_sec(0x1::u64::max(arg0.unlock_start_ts_sec, 0x78382793ee7a27d0a4ee440203382bb63f383d9b52feb425b839a9ac4d6dc443::utils::timestamp_sec(arg2)), 0x2::balance::value<T0>(&arg0.locked_balance), arg0.unlock_per_second);
    }

    fun unlock<T0>(arg0: &mut TimeLockedBalance<T0>, arg1: &0x2::clock::Clock) {
        let v0 = 0x78382793ee7a27d0a4ee440203382bb63f383d9b52feb425b839a9ac4d6dc443::utils::timestamp_sec(arg1);
