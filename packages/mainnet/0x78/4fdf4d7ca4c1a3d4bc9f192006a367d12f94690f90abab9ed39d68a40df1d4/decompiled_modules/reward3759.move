module 0x784fdf4d7ca4c1a3d4bc9f192006a367d12f94690f90abab9ed39d68a40df1d4::reward3759 {
    struct REWARD3759 has drop {
        dummy_field: bool,
    }

    struct TICKET_3759 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3759(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3759>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3759>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3759, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3759>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3759>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3759>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3759>>(v5, 0x2::tx_context::sender(arg1));
    }
