module 0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::jellyfish {
    ...
    public fun do_merge(arg0: &mut JellyFish, arg1: JellyFish) {
        ...
        arg0.alpha = 0x1::string::utf8(0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::string_utils::num_to_alpha(arg0.amount));
        drop_jellyfish(arg1);
    }
    ...
    fun init(arg0: JELLYFISH, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrcs_svg::generatejfSVG(b"{color}", b"{alpha}")));
    ...
    fun new_jellyfish(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : JellyFish {
        ...
        let v1 = 0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::string_utils::data_to_RGB(0x2::object::uid_to_bytes(&v0), arg1);
        let v2 = NewJellyFish{
        ...
        JellyFish{
            ...
            amount : arg0,
            color  : v1,
            alpha  : 0x1::string::utf8(0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::string_utils::num_to_alpha(arg0)),
        }
    }
