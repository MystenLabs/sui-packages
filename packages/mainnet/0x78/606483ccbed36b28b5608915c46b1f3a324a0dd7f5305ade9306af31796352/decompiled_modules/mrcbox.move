module 0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrcbox {
    ...
    struct MrcBoxRepo has key {
        id: 0x2::object::UID,
        balance: 0x2::balance::Balance<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>,
    }
    ...
    public fun current_value(arg0: &MrcBox) : u64 {
        0x2::balance::value<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&arg0.balance)
    }
    ...
    public fun do_burn(arg0: MrcBox, arg1: &BoxSwitch, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&arg0.balance) == 0, 4);
        let MrcBox {
            id         : v1,
            init_value : _,
            period     : _,
        ...
        0x2::balance::destroy_zero<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(v6);
    ...
    public fun do_merge(arg0: &mut MrcBox, arg1: MrcBox) {
        ...
        0x2::balance::join<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&mut arg0.balance, v5);
    }
    ...
    public fun do_mint(arg0: &MintCap, arg1: &mut MrcBoxRepo, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : MrcBox {
        ...
        let v0 = new_mrcbox(0x2::balance::split<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&mut arg1.balance, arg2), arg4);
    ...
    public fun do_split(arg0: &mut MrcBox, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : MrcBox {
        ...
        let v0 = new_mrcbox(0x2::balance::split<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&mut arg0.balance, (((0x2::balance::value<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&arg0.balance) as u128) * (arg1 as u128) / (arg0.init_value as u128)) as u64)), arg2);
        v0.init_value = arg1;
        v0.type = arg0.type;
    ...
    fun init(arg0: MRCBOX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrcs_svg::generateboxSVG(b"{color}")));
        ...
        let v7 = MrcBoxRepo{
            ...
            balance : 0x2::balance::zero<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(),
        };
    ...
    public fun inject_mrccoin_to_mrcbox(arg0: &mut MrcBox, arg1: 0x2::coin::Coin<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>) {
        0x2::coin::put<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&mut arg0.balance, arg1);
    }

    public entry fun inject_mrccoin_to_mrcboxrepo(arg0: &MintCap, arg1: &mut MrcBoxRepo, arg2: 0x2::coin::Coin<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>) {
        let v0 = SaveIntoRepo{amount: 0x2::coin::value<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&arg2)};
        0x2::event::emit<SaveIntoRepo>(v0);
        0x2::coin::put<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&mut arg1.balance, arg2);
    }
    ...
    fun new_mrcbox(arg0: 0x2::balance::Balance<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>, arg1: &mut 0x2::tx_context::TxContext) : MrcBox {
        MrcBox{
            id         : 0x2::object::new(arg1),
            init_value : 0x2::balance::value<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&arg0),
            period     : 0,
    ...
    public entry fun withdraw_from_mrcbox(arg0: &mut MrcBox, arg1: &BoxSwitch, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::balance::value<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&arg0.balance) - get_remain_value(arg0.init_value, arg1.free_time, arg0.period, v0);
        let v2 = 0x2::tx_context::sender(arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>>(0x2::coin::take<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&mut arg0.balance, v1, arg3), v2);
        let v3 = Withdraw{
    ...
    public entry fun withdraw_from_mrcboxrepo(arg0: &MintCap, arg1: &mut MrcBoxRepo, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::take<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&mut arg1.balance, arg2, arg3);
        let v1 = WithdrawRepo{amount: 0x2::coin::value<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>(&v0)};
        0x2::event::emit<WithdrawRepo>(v1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x78606483ccbed36b28b5608915c46b1f3a324a0dd7f5305ade9306af31796352::mrc::MRC>>(v0, 0x2::tx_context::sender(arg3));
    }
