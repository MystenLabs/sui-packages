module 0x78a7f7fab96c84a2575dc7ff25dfc9d83809e9ff3bc78c9354c65e54d1db5aa6::utils {
    ...
    public(friend) fun close_position<T0, T1, T2>(arg0: &mut 0x78a7f7fab96c84a2575dc7ff25dfc9d83809e9ff3bc78c9354c65e54d1db5aa6::vault::Vault<T0, T1, T2>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::close_position<T0, T1>(arg2, arg1, 0x78a7f7fab96c84a2575dc7ff25dfc9d83809e9ff3bc78c9354c65e54d1db5aa6::vault::remove_position<T0, T1, T2>(arg0));
        (v0, v1)
    }

    public(friend) fun create_position<T0, T1, T2>(arg0: &mut 0x78a7f7fab96c84a2575dc7ff25dfc9d83809e9ff3bc78c9354c65e54d1db5aa6::vault::Vault<T0, T1, T2>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x2::balance::Balance<T0>, arg4: &mut 0x2::balance::Balance<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (u32, u32) {
        let v0 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg1);
        let v1 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::get_tick_at_sqrt_price(scale(v0, 0x78a7f7fab96c84a2575dc7ff25dfc9d83809e9ff3bc78c9354c65e54d1db5aa6::vault::lower_price_scalling_fac<T0, T1, T2>(arg0), false));
        let v2 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::get_tick_at_sqrt_price(scale(v0, 0x78a7f7fab96c84a2575dc7ff25dfc9d83809e9ff3bc78c9354c65e54d1db5aa6::vault::upper_price_scalling_fac<T0, T1, T2>(arg0), true));
        ...
        let v6 = v0 > 0x78a7f7fab96c84a2575dc7ff25dfc9d83809e9ff3bc78c9354c65e54d1db5aa6::vault::last_rebalance_sqrt_price<T0, T1, T2>(arg0);
        let v7 = if (v6) {
        ...
        0x78a7f7fab96c84a2575dc7ff25dfc9d83809e9ff3bc78c9354c65e54d1db5aa6::vault::insert_position<T0, T1, T2>(arg0, v5);
        (v3, v4)
    }

    fun scale(arg0: u128, arg1: u64, arg2: bool) : u128 {
        if (arg2) {
            arg0 + (arg0 as u128) * (arg1 as u128) / 0x78a7f7fab96c84a2575dc7ff25dfc9d83809e9ff3bc78c9354c65e54d1db5aa6::vault::scalling_factor()
        } else {
            arg0 - (arg0 as u128) * (arg1 as u128) / 0x78a7f7fab96c84a2575dc7ff25dfc9d83809e9ff3bc78c9354c65e54d1db5aa6::vault::scalling_factor()
        }
    }
