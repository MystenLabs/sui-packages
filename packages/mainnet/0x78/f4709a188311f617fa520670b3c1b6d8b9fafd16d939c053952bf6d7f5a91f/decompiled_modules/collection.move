module 0x78f4709a188311f617fa520670b3c1b6d8b9fafd16d939c053952bf6d7f5a91f::collection {
    ...
    public fun lock_nft_into_kiosk(arg0: TestNFT, arg1: &0x2::transfer_policy::TransferPolicy<TestNFT>, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap) {
        0x2::kiosk::lock<TestNFT>(arg2, arg3, arg1, arg0);
    }
    ...
    public fun mint_admin_free(arg0: &mut Gate, arg1: &mut ArtTicket, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = NftMinted{
            nft_id     : 0x2::object::id<TestNFT>(&v2),
            minter     : 0x2::tx_context::sender(arg2),
            tier       : 0x1::string::utf8(b"Admin"),
            price_mist : 0,
    ...
    fun mint_common(arg0: &mut Gate, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut ArtTicket, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>();
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1, 0x1::string::utf8(b"Tier"), 0x1::string::sub_string(&arg3, 0, 0x1::string::length(&arg3)));
    ...
    public fun owner_update_image_host(arg0: &mut TestNFT, arg1: 0x1::string::String) {
        ...
        let v3 = ImageHostUpdated{
            nft_id   : 0x2::object::id<TestNFT>(arg0),
    ...
    public fun setup_display_nft(arg0: &0x2::package::Publisher, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::display::new_with_fields<TestNFT>(arg0, v0, v2, arg2);
        0x2::display::update_version<TestNFT>(&mut v4);
        0x2::transfer::public_transfer<0x2::display::Display<TestNFT>>(v4, 0x2::tx_context::sender(arg2));
    }
    ...
    public fun setup_transfer_policy_nft(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::transfer_policy::new<TestNFT>(arg0, arg1);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<TestNFT>>(v0);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<TestNFT>>(v1, 0x2::tx_context::sender(arg1));
    }
