module 0x784c316cfdbe37c6b9754cf7d849811fef382e4b7ea0ef8eb8c7e8d5d4811dfb::cnsnft6608 {
    struct CNSNFT6608 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6608, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6608>(arg0, arg1);
