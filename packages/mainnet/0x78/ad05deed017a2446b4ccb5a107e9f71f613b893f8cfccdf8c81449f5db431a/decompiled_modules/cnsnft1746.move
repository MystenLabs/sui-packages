module 0x78ad05deed017a2446b4ccb5a107e9f71f613b893f8cfccdf8c81449f5db431a::cnsnft1746 {
    struct CNSNFT1746 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1746, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1746>(arg0, arg1);
