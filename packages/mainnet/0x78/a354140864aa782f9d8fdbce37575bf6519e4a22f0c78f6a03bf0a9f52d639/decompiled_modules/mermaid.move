module 0x78a354140864aa782f9d8fdbce37575bf6519e4a22f0c78f6a03bf0a9f52d639::mermaid {
    ...
    fun init(arg0: MERMAID, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{image_url}/{id_number}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{project_url}"));
        let v4 = 0x2::package::claim<MERMAID>(arg0, arg1);
        0x78a354140864aa782f9d8fdbce37575bf6519e4a22f0c78f6a03bf0a9f52d639::collection::display(&v4, arg1);
        ...
        0x2::transfer::public_share_object<0x78a354140864aa782f9d8fdbce37575bf6519e4a22f0c78f6a03bf0a9f52d639::collection::Collection>(0x78a354140864aa782f9d8fdbce37575bf6519e4a22f0c78f6a03bf0a9f52d639::collection::new(arg1));
    }

    public entry fun mint_nft(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Mermaid{
            id          : 0x2::object::new(arg1),
            name        : 0x1::string::utf8(b"AtlanSui Mermaid"),
            description : 0x1::string::utf8(b"AtlanSui NFT."),
            image_url   : 0x2::url::new_unsafe_from_bytes(b"ipfs://bafybeieawbqes2l2ca6dhpz7mqmbztmno4k5o2fuwbqeufvp7rnku4jn3m"),
        ...
        0x2::transfer::public_transfer<Mermaid>(v0, 0x2::tx_context::sender(arg1));
    }
