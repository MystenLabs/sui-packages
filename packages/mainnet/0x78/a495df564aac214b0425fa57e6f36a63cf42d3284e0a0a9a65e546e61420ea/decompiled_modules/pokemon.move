module 0x78a495df564aac214b0425fa57e6f36a63cf42d3284e0a0a9a65e546e61420ea::pokemon {
    ...
    fun init(arg0: POKEMON, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<POKEMON>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Pokemon"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A funny Pokemon NFT Collection to test this shit up!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://x1nop7foyDSB8Kb73cYuhmPPnh7glaLxFfjMs-8pqlc"));
