module 0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::vector {
    ...
    public fun scale_fixed_vector_128_by_128(arg0: u128, arg1: &vector<u128>) : vector<u128> {
        ...
        while (v1 < 0x1::vector::length<u128>(arg1)) {
            0x1::vector::push_back<u128>(&mut v0, 0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::fixed::mul_down_128(*0x1::vector::borrow<u128>(arg1, v1), arg0));
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public fun scale_fixed_vector_128_by_64(arg0: u64, arg1: &vector<u128>) : vector<u128> {
        ...
        let v1 = 0;
        while (v1 < 0x1::vector::length<u128>(arg1)) {
            0x1::vector::push_back<u128>(&mut v0, (0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::fixed::mul_down((*0x1::vector::borrow<u128>(arg1, v1) as u256), (arg0 as u256)) as u128));
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public fun scale_fixed_vector_64_by_128(arg0: u128, arg1: &vector<u64>) : vector<u64> {
        ...
        while (v1 < 0x1::vector::length<u64>(arg1)) {
            0x1::vector::push_back<u64>(&mut v0, 0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::fixed::convert_fixed_to_int(0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::fixed::mul_down(0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::fixed::convert_int_to_fixed(*0x1::vector::borrow<u64>(arg1, v1)), (arg0 as u256))));
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public fun scale_mut_vector_128_128(arg0: &mut vector<u128>, arg1: u128) {
        ...
        while (v0 < 0x1::vector::length<u128>(arg0)) {
            *0x1::vector::borrow_mut<u128>(arg0, v0) = 0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::fixed::mul_down_128(*0x1::vector::borrow<u128>(arg0, v0), arg1);
            v0 = v0 + 1;
        };
    }
    ...
    public fun scale_mut_vector_128_64(arg0: &mut vector<u128>, arg1: u64) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<u128>(arg0)) {
            *0x1::vector::borrow_mut<u128>(arg0, v0) = 0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::fixed::mul_by_fraction_128_64(*0x1::vector::borrow<u128>(arg0, v0), arg1);
            v0 = v0 + 1;
        };
    }
    ...
    public fun scale_mut_vector_64_128(arg0: &mut vector<u64>, arg1: u128) {
        ...
        while (v0 < 0x1::vector::length<u64>(arg0)) {
            *0x1::vector::borrow_mut<u64>(arg0, v0) = 0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::fixed::mul_by_fraction_64_128(*0x1::vector::borrow<u64>(arg0, v0), arg1);
            v0 = v0 + 1;
        };
    }
    ...
    public fun scale_mut_vector_64_64(arg0: &mut vector<u64>, arg1: u64) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<u64>(arg0)) {
            *0x1::vector::borrow_mut<u64>(arg0, v0) = 0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::fixed::mul_by_fraction(*0x1::vector::borrow<u64>(arg0, v0), arg1);
            v0 = v0 + 1;
        };
    }
