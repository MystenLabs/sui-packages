module 0x78bfb044a244a6d4412196ec4ee73af6b6c8ea1b48ed94a835784caed76e6633::reward4907 {
    struct REWARD4907 has drop {
        dummy_field: bool,
    }

    struct TICKET_4907 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4907(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4907>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4907>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4907, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4907>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4907>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4907>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4907>>(v5, 0x2::tx_context::sender(arg1));
    }
