module 0x277b5088c3d5d8632cfa1f97a0596b21b914de0c4481322e050b588e2157685d::presale {
    ...
    public entry fun purchase_token(arg0: &mut PresaleStorage, arg1: &0x2::clock::Clock, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0 + *0x2::vec_map::get<address, u64>(&arg0.balances, &v1);
        0x2::vec_map::insert<address, u64>(&mut arg0.balances, 0x2::tx_context::sender(arg3), v2);
        arg0.totalRaised = arg0.totalRaised + v2;
    }
