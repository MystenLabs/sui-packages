module 0x2730c5c55af55df2944cc881f28855cb7045e106707ae1911a42f05df1868251::RockPaperScissors {
    ...
    fun random(arg0: &0x2::clock::Clock) : u64 {
        ...
        let v1 = ((0x2::clock::timestamp_ms(arg0) * (0x1::vector::pop_back<u8>(&mut v0) as u64) % 3) as u64);
