module 0x2755c0b895605f21f67b67f8ba58aa4b4b83759cd0d1a1fbb666ec9355c29d50::stake_vault {
    ...
    entry fun withdraw(arg0: &mut Vault, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: StakeReceipt, arg3: &mut 0x2755c0b895605f21f67b67f8ba58aa4b4b83759cd0d1a1fbb666ec9355c29d50::loyalty_tracker::LoyaltyRecord, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (v7 > v2) {
            ...
            0x2755c0b895605f21f67b67f8ba58aa4b4b83759cd0d1a1fbb666ec9355c29d50::loyalty_tracker::reset(arg3, arg4, arg5);
            let v9 = Withdrawn{
