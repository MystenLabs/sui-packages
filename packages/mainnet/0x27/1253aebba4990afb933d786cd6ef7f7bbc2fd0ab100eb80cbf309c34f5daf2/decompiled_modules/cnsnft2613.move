module 0x271253aebba4990afb933d786cd6ef7f7bbc2fd0ab100eb80cbf309c34f5daf2::cnsnft2613 {
    struct CNSNFT2613 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2613, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2613>(arg0, arg1);
