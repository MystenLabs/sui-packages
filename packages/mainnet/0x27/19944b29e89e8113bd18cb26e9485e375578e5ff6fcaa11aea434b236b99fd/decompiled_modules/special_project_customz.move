module 0x2719944b29e89e8113bd18cb26e9485e375578e5ff6fcaa11aea434b236b99fd::special_project_customz {
    struct SPECIAL_PROJECT_CUSTOMZ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SPECIAL_PROJECT_CUSTOMZ, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SPECIAL_PROJECT_CUSTOMZ>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SPECIAL PROJECT CUSTOMZ"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Communities im involved with NFTs with my twist of humor or artistic style. My very own 1:1 "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://-gfuHQpDcbwo2OYgUCrFOifQMM0sad6nyazd1Th0zkE"));
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Nft>(&mut v5, &v4, 3500, 0);
