module 0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::hsui_vault {
    struct HSuiVault has key {
        id: 0x2::object::UID,
        version: u64,
        hsui_treasury_cap: 0x2::coin::TreasuryCap<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>,
        pause_stake: bool,
        pause_unstake: bool,
    ...
    struct ValidatorPool has store {
        staked_sui_objects: 0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::TableQueue<0x3::staking_pool::StakedSui>,
        total_principal_staked: u64,
        accrued_rewards: u64,
    }
    ...
    fun calculate_staked_sui_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &0x3::staking_pool::StakedSui, arg2: u64) : u64 {
        ...
        0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::helper::calculate_rewards(arg0, 0x3::staking_pool::pool_id(arg1), 0x3::staking_pool::staked_sui_amount(arg1), 0x3::staking_pool::stake_activation_epoch(arg1), arg2)
    }
    ...
    fun calculate_validator_pool_rewards_increase(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: address, arg2: &mut ValidatorPool, arg3: u64) : u64 {
        let v0 = 0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::length<0x3::staking_pool::StakedSui>(&arg2.staked_sui_objects);
        if (v0 == 0) {
            return 0
        };
        let v1 = 0;
        let v2 = 0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::head<0x3::staking_pool::StakedSui>(&arg2.staked_sui_objects);
        while (v2 < 0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::tail<0x3::staking_pool::StakedSui>(&arg2.staked_sui_objects)) {
            ...
            v1 = v1 + calculate_staked_sui_rewards(arg0, 0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::borrow<0x3::staking_pool::StakedSui>(&arg2.staked_sui_objects, v2), arg3);
            v2 = v2 + 1;
        };
    ...
    public fun claim_collected_fees(arg0: &0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::config::HiveDaoCapability, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut HSuiVault, arg3: &mut 0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::config::Treasury<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = 0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::math::mul_div_u128((0x2::balance::value<0x2::sui::SUI>(&arg2.hive_fee_vault) as u128), (arg2.fee_distribution.treasury_percent as u128), (100000 as u128));
        if (v0 > 0) {
            ...
            0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::config::deposit_to_treasury<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>(arg3, v2);
        };
    ...
    fun destroy_staking_pool(arg0: &mut HSuiVault, arg1: address, arg2: u64) : (u64, u64) {
        ...
        let (_, _) = 0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::destroy_empty<0x3::staking_pool::StakedSui>(v0);
    ...
    public fun emergency_pause_update(arg0: &0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::config::HiveDaoCapability, arg1: &mut HSuiVault, arg2: bool) {
    ...
    fun execute_validator_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut HSuiVault, arg2: &mut 0x2::balance::Balance<0x2::sui::SUI>, arg3: address, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (u64, bool) {
        ...
        while (arg4 > 0 && 0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::length<0x3::staking_pool::StakedSui>(&v5.staked_sui_objects) > 0) {
            let v6 = 0x1::string::utf8(b"staked_sui_obj borrowed");
            0x1::debug::print<0x1::string::String>(&v6);
            let (_, _, v9, v10) = get_split_amount(arg0, 0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::borrow_tail<0x3::staking_pool::StakedSui>(&v5.staked_sui_objects), arg4, arg5);
            let v11 = v10;
            let v12 = v9;
            ...
            if (v11 > 0) {
                let v16 = if (v12 > 0) {
                    0x3::staking_pool::split(0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::borrow_tail_mut<0x3::staking_pool::StakedSui>(&mut v5.staked_sui_objects), v11, arg6)
                } else {
                    0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::pop_from_tail<0x3::staking_pool::StakedSui>(&mut v5.staked_sui_objects)
                };
        ...
        if (0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::is_empty<0x3::staking_pool::StakedSui>(&v5.staked_sui_objects)) {
    ...
    public fun get_hsui_by_sui(arg0: &HSuiVault, arg1: u64) : u64 {
        ...
        0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::math::mul_div_u128((arg1 as u128), (arg0.hsui_supply as u128), (v0 as u128))
    }
    ...
    fun get_split_amount(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &0x3::staking_pool::StakedSui, arg2: u64, arg3: u64) : (u64, u64, u64, u64) {
        ...
        let v7 = ((0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::math::mul_div_u256((1000000000 as u256) * (arg2 as u256), (v1 as u256), (v4 as u256)) / (1000000000 as u256)) as u64) + 1;
        let v8 = v1 - v7;
    ...
    public fun get_sui_by_hsui(arg0: &HSuiVault, arg1: u64) : u64 {
        ...
        0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::math::mul_div_u128((v0 as u128), (arg1 as u128), (arg0.hsui_supply as u128))
    }
    ...
    public fun get_sui_claimable_per_hsui(arg0: &HSuiVault) : u128 {
        ...
        (0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::math::mul_div_u128((v0 as u128), (1000000000 as u128), (v1 as u128)) as u128)
    }
    ...
    public fun init_hsui_vault(arg0: 0x2::coin::TreasuryCap<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun query_request_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut HSuiVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let v2 = 0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::math::mul_div_u128((v1 as u128), (arg1.service_fee_percent as u128), (100000 as u128));
        (v1 - v2, v2)
    }
    ...
    public fun query_staked_objs_for_validator(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &HSuiVault, arg2: address, arg3: u64) : (vector<u64>, vector<u64>, vector<u64>) {
        ...
        let v4 = 0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::length<0x3::staking_pool::StakedSui>(&v0.staked_sui_objects);
        while (v4 > 0) {
            let v5 = 0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::borrow<0x3::staking_pool::StakedSui>(&v0.staked_sui_objects, v4 - 1);
            ...
            0x1::vector::push_back<u64>(&mut v3, 0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::helper::calculate_rewards(arg0, 0x3::staking_pool::pool_id(v5), v7, v6, arg3));
            v4 = v4 - 1;
        };
        (v1, v2, v3)
    }
    ...
    public fun request_delayed_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut HSuiVault, arg2: 0x2::balance::Balance<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>, arg3: &mut 0x2::tx_context::TxContext) : UnstakeRequest {
        ...
        let v2 = get_sui_by_hsui(arg1, 0x2::balance::value<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>(&arg2));
        ...
        let v10 = UnstakeRequest{
            ...
            hsui_amount        : 0x2::balance::value<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>(&arg2),
            sui_amount         : v2,
            claim_epoch        : v1 + arg1.unstake_delay_epoches,
            requested_at_epoch : v1,
        };
        0x2::coin::burn<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>(&mut arg1.hsui_treasury_cap, 0x2::coin::from_balance<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>(arg2, arg3));
        arg1.hsui_supply = 0x2::coin::total_supply<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>(&arg1.hsui_treasury_cap);
    ...
    public fun request_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut HSuiVault, arg2: 0x2::balance::Balance<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = 0x1::string::utf8(b"STAKING VAULT ::request_instant_unstake() FUNCTION -::- ");
        0x1::debug::print<0x1::string::String>(&v0);
        assert!(arg1.version == 0, 9002);
        assert!(arg1.pause_unstake == false, 9005);
        update_calculated_accrued_rewards(arg0, arg1, arg3);
        let v1 = get_sui_by_hsui(arg1, 0x2::balance::value<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>(&arg2));
        ...
        let v3 = 0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::math::mul_div_u128((v1 as u128), (arg1.service_fee_percent as u128), (100000 as u128));
        let v4 = 0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::math::mul_div(v3, arg1.protocol_fee_percent, 100000);
        ...
        let v7 = UserUnstakedInstantly{
            ...
            hsui_burnt             : 0x2::balance::value<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>(&arg2),
    ...
    public fun stake_sui_request(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut HSuiVault, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI> {
        assert!(arg1.version == 0, 9002);
        assert!(arg1.pause_stake == false, 9003);
        ...
        0x2::coin::mint_balance<0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::hsui::HSUI>(&mut arg1.hsui_treasury_cap, v1)
    }
    ...
    fun stake_with_validator(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut HSuiVault, arg2: address, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<address, ValidatorPool>(&arg1.validator_pools, arg2)) {
            let v1 = ValidatorPool{
                staked_sui_objects     : 0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::new<0x3::staking_pool::StakedSui>(arg4),
                total_principal_staked : 0,
                accrued_rewards        : 0,
            };
        ...
        if (0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::length<0x3::staking_pool::StakedSui>(&v2.staked_sui_objects) == 0) {
            0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::push_back<0x3::staking_pool::StakedSui>(&mut v2.staked_sui_objects, v3);
        } else if (0x3::staking_pool::stake_activation_epoch(&v3) == 0x3::staking_pool::stake_activation_epoch(0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::borrow_tail<0x3::staking_pool::StakedSui>(&v2.staked_sui_objects))) {
            0x3::staking_pool::join_staked_sui(0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::borrow_tail_mut<0x3::staking_pool::StakedSui>(&mut v2.staked_sui_objects), v3);
        } else {
            0x27e0df03aead8beed62eaf8e0bd299a4d6693886b5d88a1edf7d0e4453239e04::table_queue::push_back<0x3::staking_pool::StakedSui>(&mut v2.staked_sui_objects, v3);
        };
    ...
    public fun update_calculated_accrued_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut HSuiVault, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::math::mul_div_u128((v2 as u128), (arg1.protocol_fee_percent as u128), (100000 as u128));
    ...
    public fun update_global_fee_config(arg0: &0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::config::HiveDaoCapability, arg1: &mut HSuiVault, arg2: u64, arg3: u64) {
        assert!(arg1.version == 0, 9002);
    ...
    public fun update_protocol_fee_distribution(arg0: &0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::config::HiveDaoCapability, arg1: &mut HSuiVault, arg2: u64) {
        assert!(arg1.version == 0, 9002);
    ...
    public fun update_validator_list(arg0: &0xf7d07d53cf2996ec31c7df19a58420bf0614735a25a7db62a27f39ec973ae612::config::HiveDaoCapability, arg1: &mut HSuiVault, arg2: vector<address>, arg3: bool) {
        assert!(arg1.version == 0, 9002);
