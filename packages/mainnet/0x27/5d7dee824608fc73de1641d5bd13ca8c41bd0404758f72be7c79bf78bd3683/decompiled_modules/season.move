module 0x275d7dee824608fc73de1641d5bd13ca8c41bd0404758f72be7c79bf78bd3683::season {
    ...
    struct SeasonVoided has copy, drop {
        season_id: 0x2::object::ID,
    }
    ...
    public fun admin_void<T0>(arg0: &mut Season<T0>, arg1: &AdminCap) {
        assert!(!arg0.settled, 20);
        assert!(!arg0.voided, 28);
        let v0 = 0x2::balance::value<T0>(&arg0.treasury);
        if (v0 > 0) {
            0x2::balance::join<T0>(&mut arg0.prize_pool, 0x2::balance::split<T0>(&mut arg0.treasury, v0));
        };
        arg0.voided = true;
        let v1 = SeasonVoided{season_id: 0x2::object::id<Season<T0>>(arg0)};
        0x2::event::emit<SeasonVoided>(v1);
    }
    ...
    fun assert_distinct_addrs(arg0: &vector<address>) {
        let v0 = 0x1::vector::length<address>(arg0);
        let v1 = 0;
        while (v1 < v0) {
            let v2 = v1 + 1;
            while (v2 < v0) {
                assert!(0x1::vector::borrow<address>(arg0, v1) != 0x1::vector::borrow<address>(arg0, v2), 31);
                v2 = v2 + 1;
            };
            v1 = v1 + 1;
        };
    ...
    public fun refund<T0>(arg0: &mut Season<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg0.voided, 29);
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x2::table::contains<address, PlayerEntry>(&arg0.entries, v0), 7);
        let v1 = 0x2::table::remove<address, PlayerEntry>(&mut arg0.entries, v0);
        let v2 = v1.paid_in;
        let v3 = Refunded{
            season_id : 0x2::object::id<Season<T0>>(arg0),
            player    : v0,
        ...
        0x2::event::emit<Refunded>(v3);
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.prize_pool, v2), arg1)
    }
    ...
    public fun settle_season<T0>(arg0: &mut Season<T0>, arg1: &AdminCap, arg2: vector<address>, arg3: vector<u64>, arg4: &0x2::clock::Clock) {
        ...
        let v0 = 0;
        while (v0 < num_days<T0>(arg0)) {
            assert!(0x2::table::contains<u64, DaySnapshot>(&arg0.snapshots, v0), 32);
            assert!(0x2::table::borrow<u64, DaySnapshot>(&arg0.snapshots, v0).finalized, 32);
            v0 = v0 + 1;
        };
        assert!(0x1::vector::length<address>(&arg2) == 0x1::vector::length<u64>(&arg3), 17);
        assert_distinct_addrs(&arg2);
        let v1 = 0;
        let v2 = 0;
    ...
    public fun sweep_remainder<T0>(arg0: &mut Season<T0>, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1::vector::length<address>(&arg0.winners);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.prize_pool, v3), arg2), arg0.treasury_wallet);
        let v4 = RemainderSwept{
            season_id : 0x2::object::id<Season<T0>>(arg0),
            amount    : v3,
        };
        0x2::event::emit<RemainderSwept>(v4);
    }
