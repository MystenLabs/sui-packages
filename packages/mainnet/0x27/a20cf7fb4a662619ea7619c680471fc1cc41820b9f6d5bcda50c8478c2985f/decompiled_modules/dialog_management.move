module 0x27a20cf7fb4a662619ea7619c680471fc1cc41820b9f6d5bcda50c8478c2985f::dialog_management {
    ...
    public entry fun send_message(arg0: &mut UserDialogs, arg1: &mut UserDialogHashes, arg2: &mut UserDialogHashes, arg3: &mut ChatCounts, arg4: address, arg5: vector<u8>, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<address, vector<u8>>(&arg1.dialog_hashes, v0)) {
            0x2::table::add<address, vector<u8>>(&mut arg1.dialog_hashes, v0, arg5);
        };
        if (!0x2::table::contains<address, vector<u8>>(&arg2.dialog_hashes, arg4)) {
            0x2::table::add<address, vector<u8>>(&mut arg2.dialog_hashes, arg4, arg5);
        };
