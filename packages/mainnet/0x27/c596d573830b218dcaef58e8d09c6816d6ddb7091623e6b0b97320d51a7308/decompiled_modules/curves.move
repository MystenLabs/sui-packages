module 0x27c596d573830b218dcaef58e8d09c6816d6ddb7091623e6b0b97320d51a7308::curves {
    ...
    public fun buy<T0>(arg0: &mut BondingCurve<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        if (v12 >= 2000000000) {
            ...
            let v14 = MigrationPendingEvent{
                ...
                sui_reserve_val  : 1000000000 + 500000000,
    ...
    public fun list<T0>(arg0: &mut Configurator, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0x27c596d573830b218dcaef58e8d09c6816d6ddb7091623e6b0b97320d51a7308::admin::AdminAccess, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u8, arg6: 0x1::option::Option<0x2::url::Url>, arg7: 0x1::option::Option<0x2::url::Url>, arg8: 0x1::option::Option<0x2::url::Url>, arg9: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        ...
        0x27c596d573830b218dcaef58e8d09c6816d6ddb7091623e6b0b97320d51a7308::freezer::freeze_object<0x2::coin::TreasuryCap<T0>>(arg1, arg9);
        let (_, _, v3) = 0x27c596d573830b218dcaef58e8d09c6816d6ddb7091623e6b0b97320d51a7308::admin::get_addresses(arg3);
        let v4 = v3;
        let v5 = b"+++++++++++++++++++++++++++++";
    ...
    public fun migrating<T0>(arg0: &mut BondingCurve<T0>, arg1: &mut Configurator, arg2: &0x27c596d573830b218dcaef58e8d09c6816d6ddb7091623e6b0b97320d51a7308::admin::AdminAccess, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (v10, v11, v12) = 0x27c596d573830b218dcaef58e8d09c6816d6ddb7091623e6b0b97320d51a7308::admin::get_addresses(arg2);
        let v13 = v11;
        let v14 = b"====================";
    ...
    public fun update_listing_fee(arg0: &0x27c596d573830b218dcaef58e8d09c6816d6ddb7091623e6b0b97320d51a7308::admin::AdminCap, arg1: &mut Configurator, arg2: u64) {
        arg1.listing_fee = arg2;
    }

    public fun update_migration_fee(arg0: &0x27c596d573830b218dcaef58e8d09c6816d6ddb7091623e6b0b97320d51a7308::admin::AdminCap, arg1: &mut Configurator, arg2: u64) {
        arg1.migration_fee = arg2;
    }

    public fun update_target_supply_threshold(arg0: &0x27c596d573830b218dcaef58e8d09c6816d6ddb7091623e6b0b97320d51a7308::admin::AdminCap, arg1: &mut Configurator, arg2: u64) {
        arg1.target_supply_threshold = arg2;
    }

    public fun update_virtual_sui_liq(arg0: &0x27c596d573830b218dcaef58e8d09c6816d6ddb7091623e6b0b97320d51a7308::admin::AdminCap, arg1: &mut Configurator, arg2: u64) {
        arg1.virtual_sui_amt = arg2;
    }

    public fun withdraw_fee(arg0: &0x27c596d573830b218dcaef58e8d09c6816d6ddb7091623e6b0b97320d51a7308::admin::AdminCap, arg1: &0x27c596d573830b218dcaef58e8d09c6816d6ddb7091623e6b0b97320d51a7308::admin::AdminAccess, arg2: &mut Configurator, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let (_, _, v2) = 0x27c596d573830b218dcaef58e8d09c6816d6ddb7091623e6b0b97320d51a7308::admin::get_addresses(arg1);
