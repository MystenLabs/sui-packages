module 0x277230eb2abcd712b9036fb2f9fbf04e1c0e6dda58ef9e736c04383d2e70990f::ledger_inner {
    ...
    public(friend) fun add_allowed_chain(arg0: &mut StateV1, arg1: u8, arg2: u64) {
    ...
    public(friend) fun add_wallet(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: 0x1::type_name::TypeName, arg3: 0x2::object::ID, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: u32, arg9: u32, arg10: u32, arg11: &mut 0x2::tx_context::TxContext) : (u64, address) {
        ...
        0x277230eb2abcd712b9036fb2f9fbf04e1c0e6dda58ef9e736c04383d2e70990f::events::emit_wallet_added(arg2, v10.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v10.dwallet_cap), arg3, v11, arg8, arg9, arg10);
    ...
    public(friend) fun decrement_balance(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: vector<u8>, arg5: vector<u8>, arg6: address, arg7: u8, arg8: vector<u8>, arg9: u256, arg10: &mut 0x2::tx_context::TxContext) : (u256, 0x2::object::ID) {
        ...
        0x277230eb2abcd712b9036fb2f9fbf04e1c0e6dda58ef9e736c04383d2e70990f::events::emit_decrement_balance(arg2, arg3, arg6, arg7, arg8, arg9, v1, arg4, arg5, v12, v8.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v8.dwallet_cap));
        return_payment_coins(v0, v5, v4);
        (v1, v12)
    }

    fun get_or_create_balance_mut(arg0: &mut App, arg1: u8, arg2: address, arg3: vector<u8>) : &mut u256 {
    ...
    public(friend) fun increment_balance(arg0: &mut StateV1, arg1: 0x1::type_name::TypeName, arg2: vector<u8>, arg3: u64, arg4: address, arg5: u8, arg6: vector<u8>, arg7: u256, arg8: &mut 0x2::tx_context::TxContext) : u256 {
        ...
        *v5 = v6;
        ...
        0x277230eb2abcd712b9036fb2f9fbf04e1c0e6dda58ef9e736c04383d2e70990f::events::emit_increment_balance(arg1, arg2, arg3, arg4, arg5, arg6, arg7, v6, v7.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v7.dwallet_cap));
        v6
    }
    ...
    public(friend) fun init_app(arg0: &mut StateV1, arg1: 0x1::type_name::TypeName, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x277230eb2abcd712b9036fb2f9fbf04e1c0e6dda58ef9e736c04383d2e70990f::events::emit_app_initialized(arg1);
    }
    ...
    fun subtract_balance(arg0: &mut App, arg1: u64, arg2: address, arg3: u8, arg4: vector<u8>, arg5: u256) : u256 {
