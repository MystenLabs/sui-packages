module 0x27251e34753ea8bbbf3013f237b08a28a4b8289d1d2aac6316a6f13906588e55::PCW_TWAP_oracle {
    ...
    fun finalize_window(arg0: &mut SimpleTWAP, arg1: u64, arg2: u64, arg3: u128) {
        ...
        let v7 = (v0 as u256) * (arg0.max_movement_ppm as u256) / (0xcc850ba260a5e370a0e98b96db02037f6b84893754b6c6c198f3e4f24feea81e::constants::ppm_denominator() as u256);
    ...
    public fun get_ninety_day_twap(arg0: &SimpleTWAP, arg1: &0x2::clock::Clock) : 0x1::option::Option<u128> {
        get_window_twap(arg0, 0xcc850ba260a5e370a0e98b96db02037f6b84893754b6c6c198f3e4f24feea81e::constants::ninety_days_ms(), arg1)
    }
    ...
    fun maybe_commit_checkpoint(arg0: &mut SimpleTWAP, arg1: u64) {
        if (arg1 >= arg0.last_checkpoint_at + 0xcc850ba260a5e370a0e98b96db02037f6b84893754b6c6c198f3e4f24feea81e::constants::one_week_ms()) {
    ...
    public fun new(arg0: u128, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) : SimpleTWAP {
        assert!(arg0 > 0, 1);
        assert!(arg1 > 0, 1);
        assert!(arg2 > 0 && arg2 < 0xcc850ba260a5e370a0e98b96db02037f6b84893754b6c6c198f3e4f24feea81e::constants::ppm_denominator(), 1);
    ...
    public fun new_default(arg0: u128, arg1: &0x2::clock::Clock) : SimpleTWAP {
        new(arg0, 0xcc850ba260a5e370a0e98b96db02037f6b84893754b6c6c198f3e4f24feea81e::constants::twap_price_cap_window(), 0xcc850ba260a5e370a0e98b96db02037f6b84893754b6c6c198f3e4f24feea81e::constants::default_twap_max_movement_ppm(), arg1)
    }
    ...
    fun record_checkpoint(arg0: &mut SimpleTWAP, arg1: u64) {
        ...
        if (0x1::vector::length<Checkpoint>(&arg0.checkpoints) >= 0xcc850ba260a5e370a0e98b96db02037f6b84893754b6c6c198f3e4f24feea81e::constants::max_twap_checkpoints()) {
    ...
    fun simulate_triangle_correction(arg0: &SimpleTWAP, arg1: u256, arg2: u64, arg3: u64) : u256 {
        ...
        let v9 = (v0 as u256) * (arg0.max_movement_ppm as u256) / (0xcc850ba260a5e370a0e98b96db02037f6b84893754b6c6c198f3e4f24feea81e::constants::ppm_denominator() as u256);
    ...
    public fun try_commit_checkpoint(arg0: &mut SimpleTWAP, arg1: &0x2::clock::Clock) : bool {
        let v0 = 0x2::clock::timestamp_ms(arg1);
        if (v0 >= arg0.last_checkpoint_at + 0xcc850ba260a5e370a0e98b96db02037f6b84893754b6c6c198f3e4f24feea81e::constants::one_week_ms()) {
            catch_up_to(arg0, v0);
