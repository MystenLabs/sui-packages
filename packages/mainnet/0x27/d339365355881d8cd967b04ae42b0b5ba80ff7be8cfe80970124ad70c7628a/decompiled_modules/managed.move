module 0x27d339365355881d8cd967b04ae42b0b5ba80ff7be8cfe80970124ad70c7628a::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"MUSK", b"MUSK", b"", 0x1::option::none<0x2::url::Url>(), arg1);
