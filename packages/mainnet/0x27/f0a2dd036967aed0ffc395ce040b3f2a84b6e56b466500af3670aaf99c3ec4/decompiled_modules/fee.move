module 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::fee {
    ...
    public fun assert_valid_version(arg0: &FeeConfig) {
        assert!(arg0.version == 1, 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::errors::invalid_version());
    }
    ...
    public fun migrate(arg0: &AdminCap, arg1: &mut FeeConfig) {
        assert!(arg1.version < 1, 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::errors::invalid_version());
        arg1.version = 1;
    }

    public fun set_fee_rate(arg0: &AdminCap, arg1: &mut FeeConfig, arg2: u32) {
        assert!(arg2 <= 20000, 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::errors::too_large_fee_rate());
        if (arg2 > 0) {
            assert!(arg1.fee_recipient != @0x0, 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::errors::invalid_fee_recipient());
        };
        arg1.fee_rate = arg2;
    ...
    public fun set_fee_recipient(arg0: &AdminCap, arg1: &mut FeeConfig, arg2: address) {
        if (arg1.fee_rate > 0) {
            assert!(arg2 != @0x0, 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::errors::invalid_fee_recipient());
        };
