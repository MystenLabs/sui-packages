module 0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::universal_router {
    ...
    public fun build<T0, T1>(arg0: &mut 0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::partner_manager::PartnerRegistry, arg1: 0x2::coin::Coin<T0>, arg2: u256, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u64>, arg7: 0x1::option::Option<address>, arg8: u8, arg9: u64, arg10: bool, arg11: &mut 0x2::tx_context::TxContext) : Trade<T0, T1> {
        if (arg4 > 1000000) {
            abort 2
        };
        if (arg8 != 0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::commission_type::percentage() && arg8 != 0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::commission_type::flat() || arg8 == 0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::commission_type::percentage() && arg9 > 0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::partner_manager::max_comission_percentage(arg0) || arg9 == 0) {
            abort 7
        };
        ...
        while (0x1::vector::is_empty<u64>(&arg6)) {
            ...
            let v3 = Route{
                trade_id  : arg2,
                amount_in : 0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::math::mul_div(0x2::coin::value<T0>(&arg1), v2, 100),
                current   : 0,
        ...
        if (0x1::option::is_some<address>(&arg7) && arg10) {
            0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::partner_manager::register_partner_if_necessary(arg0, *0x1::option::borrow<address>(&arg7), arg11);
            0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::partner_manager::collect_commission_if_necessary<T0>(arg0, &mut v4.coin_in, *0x1::option::borrow<address>(&arg7), arg8, arg9, arg11);
        };
        v4
    }
    ...
    public entry fun set_fee_on(arg0: &0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::admin_cap::AdminCap, arg1: &mut Treasury, arg2: bool) {
        arg1.fee_on = arg2;
    }

    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: &mut 0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::partner_manager::PartnerRegistry, arg2: Trade<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let Trade {
            trade_id                    : v0,
            amount_in                   : v1,
        ...
        if (0x2::coin::value<T1>(&v14) < 0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::math::mul_div(1000000 - v3, v2, 1000000)) {
            abort 1
        };
        ...
        if (0x1::option::is_some<address>(&v12) && !v7) {
            0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::partner_manager::collect_commission_if_necessary<T1>(arg1, &mut v14, *0x1::option::borrow<address>(&v12), v5, v6, arg4);
        };
        let v16 = Swap{
    ...
    public entry fun withdraw<T0>(arg0: &0x2750789157efc9cd36737504b7f8b35ce1e8cf8ed0ef8d24b5eb38dd3dbff295::admin_cap::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
