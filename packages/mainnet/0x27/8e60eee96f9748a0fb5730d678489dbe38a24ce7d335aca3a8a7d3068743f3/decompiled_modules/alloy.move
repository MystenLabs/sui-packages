module 0x89748c0f249d011dedba4d4376a2d7ad83e55f24ee7c05be44e38cfbd4ad59ea::alloy {
    ...
    struct MarketInstance has store {
        market_name: 0x1::string::String,
        guesses: 0x89748c0f249d011dedba4d4376a2d7ad83e55f24ee7c05be44e38cfbd4ad59ea::big_queue::BigQueue<Guess>,
        round_number: u64,
        ai_prediction: 0x1::option::Option<u64>,
    ...
    public fun create_market_instance<T0>(arg0: &MarketAdminCap, arg1: &mut MarketConfig, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = MarketInstance{
            market_name         : arg3,
            guesses             : 0x89748c0f249d011dedba4d4376a2d7ad83e55f24ee7c05be44e38cfbd4ad59ea::big_queue::new<Guess>(5000, arg7),
    ...
    public fun place_guess<T0>(arg0: &mut MarketConfig, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: address, arg5: u64, arg6: 0x2::coin::Coin<T0>, arg7: 0x1::string::String, arg8: &0x2::clock::Clock) {
        ...
        0x89748c0f249d011dedba4d4376a2d7ad83e55f24ee7c05be44e38cfbd4ad59ea::big_queue::push_back<Guess>(&mut v4.guesses, v5);
    }
    ...
    public fun release_unsettled_market<T0>(arg0: &MarketAdminCap, arg1: &mut MarketConfig, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: &0x2::clock::Clock, arg6: 0x1::option::Option<u64>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<u64>(&arg6)) {
            v3 = 0x89748c0f249d011dedba4d4376a2d7ad83e55f24ee7c05be44e38cfbd4ad59ea::big_queue::length<Guess>(&v2.guesses) - *0x1::option::borrow<u64>(&arg6);
        };
        while (0x89748c0f249d011dedba4d4376a2d7ad83e55f24ee7c05be44e38cfbd4ad59ea::big_queue::length<Guess>(&v2.guesses) > v3) {
            let v4 = 0x89748c0f249d011dedba4d4376a2d7ad83e55f24ee7c05be44e38cfbd4ad59ea::big_queue::pop_front<Guess>(&mut v2.guesses);
        ...
        if (0x89748c0f249d011dedba4d4376a2d7ad83e55f24ee7c05be44e38cfbd4ad59ea::big_queue::length<Guess>(&v2.guesses) == 0) {
            v2.released = true;
