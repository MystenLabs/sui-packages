module 0x275808be8b38c4d37af30ac0550e419cb0261f85d9abe6d3bed0a65695243ef2::reward5810 {
    struct REWARD5810 has drop {
        dummy_field: bool,
    }

    struct TICKET_5810 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5810(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5810>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5810>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5810, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5810>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5810>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5810>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5810>>(v5, 0x2::tx_context::sender(arg1));
    }
