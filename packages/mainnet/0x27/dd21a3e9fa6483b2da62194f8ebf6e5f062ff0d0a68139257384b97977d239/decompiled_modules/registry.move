module 0x27dd21a3e9fa6483b2da62194f8ebf6e5f062ff0d0a68139257384b97977d239::registry {
    ...
    public(friend) fun add(arg0: u16, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: &mut Registry, arg4: &0x27dd21a3e9fa6483b2da62194f8ebf6e5f062ff0d0a68139257384b97977d239::collection::Collection) {
        ...
        if ((0x2::table::length<u16, 0x2::object::ID>(&arg3.num_to_nft) as u16) == (0x27dd21a3e9fa6483b2da62194f8ebf6e5f062ff0d0a68139257384b97977d239::collection::supply(arg4) as u16)) {
            arg3.is_ready = true;
        };
    }

    public(friend) fun add_new(arg0: u16, arg1: 0x2::object::ID, arg2: &mut Registry, arg3: &0x27dd21a3e9fa6483b2da62194f8ebf6e5f062ff0d0a68139257384b97977d239::collection::Collection) {
        ...
        if ((0x2::table::length<u16, 0x2::object::ID>(&arg2.num_to_nft) as u16) == (0x27dd21a3e9fa6483b2da62194f8ebf6e5f062ff0d0a68139257384b97977d239::collection::supply(arg3) as u16)) {
            arg2.is_ready = true;
        };
    }
    ...
    public fun nft_id_from_number(arg0: &Registry, arg1: &0x27dd21a3e9fa6483b2da62194f8ebf6e5f062ff0d0a68139257384b97977d239::collection::Collection, arg2: u16) : 0x2::object::ID {
        assert!(arg2 >= 1 && arg2 <= 0x27dd21a3e9fa6483b2da62194f8ebf6e5f062ff0d0a68139257384b97977d239::collection::supply(arg1), 1);
