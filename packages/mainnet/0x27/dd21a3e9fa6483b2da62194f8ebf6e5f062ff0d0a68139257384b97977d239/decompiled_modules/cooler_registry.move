module 0x27dd21a3e9fa6483b2da62194f8ebf6e5f062ff0d0a68139257384b97977d239::cooler_registry {
    ...
    public entry fun register_water_cooler(arg0: &mut CoolerRegistry, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x27dd21a3e9fa6483b2da62194f8ebf6e5f062ff0d0a68139257384b97977d239::water_cooler::WaterCooler, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) == arg0.fee, 0);
        assert!(0x27dd21a3e9fa6483b2da62194f8ebf6e5f062ff0d0a68139257384b97977d239::water_cooler::owner(arg2) == 0x2::tx_context::sender(arg4), 1);
        assert!(!0x2::table::contains<0x1::string::String, 0x2::object::ID>(&arg0.name_to_id, arg3), 2);
        0x2::table::add<0x1::string::String, 0x2::object::ID>(&mut arg0.name_to_id, arg3, 0x2::object::id<0x27dd21a3e9fa6483b2da62194f8ebf6e5f062ff0d0a68139257384b97977d239::water_cooler::WaterCooler>(arg2));
        send_fees(arg0, arg1);
    }
