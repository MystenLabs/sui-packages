module 0x27a4934ecf9206b541318848a616440e0c31c9f297bc130f80d24db22eaf838b::xbird {
    ...
    public entry fun depositToken(arg0: vector<u8>, arg1: vector<u8>, arg2: &ValidatorVault, arg3: &mut PegVault<XBIRD>, arg4: &mut 0x27a4934ecf9206b541318848a616440e0c31c9f297bc130f80d24db22eaf838b::archieve::UserArchieve, arg5: &0x27a4934ecf9206b541318848a616440e0c31c9f297bc130f80d24db22eaf838b::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x27a4934ecf9206b541318848a616440e0c31c9f297bc130f80d24db22eaf838b::version::checkVersion(arg5, 1);
        0x27a4934ecf9206b541318848a616440e0c31c9f297bc130f80d24db22eaf838b::archieve::verifySignature(arg0, arg1, &arg2.validator);
        ...
        assert!(v2 > 0, 1002);
        0x27a4934ecf9206b541318848a616440e0c31c9f297bc130f80d24db22eaf838b::archieve::verUpdateTokenPegNonce(v3, arg4);
    ...
    fun init(arg0: XBIRD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut v0;
        mintToSender(v1, 1000000000, arg1);
    ...
    public entry fun setValidator(arg0: &XBirdAdminCap, arg1: vector<u8>, arg2: &mut ValidatorVault, arg3: &0x27a4934ecf9206b541318848a616440e0c31c9f297bc130f80d24db22eaf838b::version::Version) {
    ...
    public entry fun withdrawToken(arg0: &mut PegVault<XBIRD>, arg1: &mut 0x27a4934ecf9206b541318848a616440e0c31c9f297bc130f80d24db22eaf838b::archieve::UserArchieve, arg2: 0x2::token::Token<XBIRD>, arg3: &0x27a4934ecf9206b541318848a616440e0c31c9f297bc130f80d24db22eaf838b::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x27a4934ecf9206b541318848a616440e0c31c9f297bc130f80d24db22eaf838b::version::checkVersion(arg3, 1);
        let v0 = WithdrawToken{
            owner  : 0x2::tx_context::sender(arg4),
            amount : 0x2::token::value<XBIRD>(&arg2),
            type   : 0x1::type_name::get<XBIRD>(),
            nonce  : 0x27a4934ecf9206b541318848a616440e0c31c9f297bc130f80d24db22eaf838b::archieve::increaseGetTokenDepegNonce(arg1),
        };
