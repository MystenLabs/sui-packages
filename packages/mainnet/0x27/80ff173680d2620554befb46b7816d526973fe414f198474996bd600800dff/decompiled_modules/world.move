module 0x2780ff173680d2620554befb46b7816d526973fe414f198474996bd600800dff::world {
    ...
    public entry fun transfer(arg0: 0x2::coin::Coin<WORLD>, arg1: address) {
        0x2::transfer::public_transfer<0x2::coin::Coin<WORLD>>(arg0, arg1);
    }

    fun init(arg0: WORLD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<WORLD>(arg0, 9, b"WORLD", b"hello", b"ddd", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://sui-dev.interestprotocol.com/dapp/create-token")), arg1);
        let v2 = v0;
        let v3 = 0x2::tx_context::sender(arg1);
        0x2::coin::mint_and_transfer<WORLD>(&mut v2, 10000000000000, v3, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<WORLD>>(v2, v3);
