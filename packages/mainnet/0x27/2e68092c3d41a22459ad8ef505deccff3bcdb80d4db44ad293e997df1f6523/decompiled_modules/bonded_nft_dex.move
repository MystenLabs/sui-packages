module 0x272e68092c3d41a22459ad8ef505deccff3bcdb80d4db44ad293e997df1f6523::bonded_nft_dex {
    ...
    public fun create_collection(arg0: &PlatformConfig, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::ascii::String>(&mut v1, 0x1::type_name::into_string(0x1::type_name::get_with_original_ids<0x2::sui::SUI>()));
        let v2 = Collection{
