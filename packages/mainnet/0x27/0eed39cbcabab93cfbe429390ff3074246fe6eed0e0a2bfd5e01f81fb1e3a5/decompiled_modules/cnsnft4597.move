module 0x270eed39cbcabab93cfbe429390ff3074246fe6eed0e0a2bfd5e01f81fb1e3a5::cnsnft4597 {
    struct CNSNFT4597 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4597, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4597>(arg0, arg1);
