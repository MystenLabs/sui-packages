module 0x2789c8ef5a679feb7ff70c0deec58f24fccfa5cba3e90a25fd8bd541909c4354::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"$5", b"$5", b"Official token on Sui blockchain. Banner, ads and boost on dexscreener already paid.", 0x1::option::none<0x2::url::Url>(), arg1);
