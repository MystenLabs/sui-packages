module 0x27701e9dc63bb25e7cb43c9a7b1ce77ea9328eef1d81b375493cbc5cda34d73d::reward4903 {
    struct REWARD4903 has drop {
        dummy_field: bool,
    }

    struct TICKET_4903 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4903(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4903>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4903>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4903, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4903>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4903>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4903>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4903>>(v5, 0x2::tx_context::sender(arg1));
    }
