module 0x273b2d161fa3a287f16ca3ef110a4d8100fea6937042bfcb7c61d37fec5a0aa9::vault {
    ...
    public fun compound_reward_x<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &RebalanceTicket, arg2: &Registry, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 6);
        let v0 = 0x2::coin::into_balance<T0>(arg3);
        let v1 = &mut v0;
        let (v2, v3) = split_fee<T0>(arg2, &arg0.affiliate, v1, arg4);
    ...
    public fun compound_reward_y<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &RebalanceTicket, arg2: &Registry, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 6);
        let v0 = 0x2::coin::into_balance<T1>(arg3);
        let v1 = &mut v0;
        let (v2, v3) = split_fee<T1>(arg2, &arg0.affiliate, v1, arg4);
        let v4 = RewardCompounded{
            vault_id   : 0x2::object::id<Vault<T0, T1>>(arg0),
            is_token_x : false,
    ...
    public fun destroy_empty_vault<T0, T1>(arg0: Vault<T0, T1>, arg1: VaultOwnerCap) {
        ...
        assert!(0x2::balance::value<T0>(&v13) == 0 && 0x2::balance::value<T1>(&v12) == 0, 21);
        ...
        let v15 = VaultDestroyed{vault_id: v0};
    ...
    public fun payout_reward<T0, T1, T2>(arg0: &mut Vault<T0, T1>, arg1: &RebalanceTicket, arg2: &Registry, arg3: 0x2::coin::Coin<T2>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 6);
        let v0 = 0x2::coin::into_balance<T2>(arg3);
        let v1 = &mut v0;
        let (v2, v3) = split_fee<T2>(arg2, &arg0.affiliate, v1, arg4);
        let v4 = RewardPaid{
            vault_id       : 0x2::object::id<Vault<T0, T1>>(arg0),
        ...
        send_balance<T2>(v0, arg0.beneficiary, arg4);
    }
    ...
    public fun skim_yield<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &RebalanceTicket, arg2: &Registry, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 6);
        let v0 = 0x2::coin::into_balance<T0>(arg3);
        let v1 = 0x2::coin::into_balance<T1>(arg4);
        let v2 = (0x2::balance::value<T0>(&v0) as u128) * (arg2.fee_bps as u128) / (10000 as u128);
        let v3 = (0x2::balance::value<T1>(&v1) as u128) * (arg2.fee_bps as u128) / (10000 as u128);
        let v4 = 0;
        let v5 = 0;
        if (v2 > 0 || v3 > 0) {
            let v6 = 0x2::balance::split<T0>(&mut v0, (v2 as u64));
            let v7 = 0x2::balance::split<T1>(&mut v1, (v3 as u64));
            let v8 = if (0x1::option::is_some<address>(&arg0.affiliate)) {
                if (arg2.affiliate_bps > 0) {
                    arg2.fee_bps > 0
                } else {
                    false
                }
            ...
            if (v8) {
                let v9 = (0x2::balance::value<T0>(&v6) as u128) * (arg2.affiliate_bps as u128) / (arg2.fee_bps as u128);
                v4 = v9;
                let v10 = (0x2::balance::value<T1>(&v7) as u128) * (arg2.affiliate_bps as u128) / (arg2.fee_bps as u128);
                v5 = v10;
                let v11 = *0x1::option::borrow<address>(&arg0.affiliate);
                send_balance<T0>(0x2::balance::split<T0>(&mut v6, (v9 as u64)), v11, arg5);
                send_balance<T1>(0x2::balance::split<T1>(&mut v7, (v10 as u64)), v11, arg5);
            };
            send_balance<T0>(v6, arg2.dev_address, arg5);
            send_balance<T1>(v7, arg2.dev_address, arg5);
        };
        let v12 = YieldSkimmed{
            vault_id    : 0x2::object::id<Vault<T0, T1>>(arg0),
            fee_x       : (v2 as u64),
            fee_y       : (v3 as u64),
            affiliate_x : (v4 as u64),
            affiliate_y : (v5 as u64),
        };
        0x2::event::emit<YieldSkimmed>(v12);
        0x2::balance::join<T0>(&mut arg0.balance_x, v0);
        0x2::balance::join<T1>(&mut arg0.balance_y, v1);
    }

    fun split_fee<T0>(arg0: &Registry, arg1: &0x1::option::Option<address>, arg2: &mut 0x2::balance::Balance<T0>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        let v0 = (((0x2::balance::value<T0>(arg2) as u128) * (arg0.fee_bps as u128) / (10000 as u128)) as u64);
        if (v0 == 0) {
            return (0, 0)
        };
        ...
        if (v3) {
            let v4 = (((v0 as u128) * (arg0.affiliate_bps as u128) / (arg0.fee_bps as u128)) as u64);
            v2 = v4;
            send_balance<T0>(0x2::balance::split<T0>(&mut v1, v4), *0x1::option::borrow<address>(arg1), arg3);
        };
        send_balance<T0>(v1, arg0.dev_address, arg3);
        (v0, v2)
    }
