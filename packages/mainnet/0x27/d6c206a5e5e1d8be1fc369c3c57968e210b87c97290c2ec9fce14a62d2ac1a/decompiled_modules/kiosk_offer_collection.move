module 0xc51203fb802e09f7bdb87e8433ea2fa4a19068164040f5fac284a032ee433e7a::kiosk_offer_collection {
    ...
    public entry fun accept_offer_collection<T0: store + key>(arg0: &mut 0xc51203fb802e09f7bdb87e8433ea2fa4a19068164040f5fac284a032ee433e7a::kiosk_trade::Market, arg1: &mut CollectionOfferData, arg2: u64, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun cancel_offer_collection<T0: store + key>(arg0: &mut CollectionOfferData, arg1: u64, arg2: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        while (!0x2::vec_map::is_empty<0x2::object::ID, AcceptedItem<T0>>(&v11)) {
            ...
            let (_, v15) = 0x2::vec_map::remove<0x2::object::ID, AcceptedItem<T0>>(&mut v11, &v13);
            let (_, v17) = 0x1::vector::index_of<0x2::object::ID>(&v10, &v13);
            0x1::vector::remove<0x2::object::ID>(&mut v10, v17);
            let AcceptedItem {
                kiosk_id     : _,
                nft_id       : _,
                purchase_cap : v20,
            } = v15;
            let (v21, v22) = 0x2::kiosk::purchase_with_cap<T0>(arg3, v20, 0x2::coin::zero<0x2::sui::SUI>(arg7));
            let v23 = v22;
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg2, &mut v23, 0x2::coin::split<0x2::sui::SUI>(&mut arg6, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<T0>(arg2, 0), arg7));
            0x2::kiosk::lock<T0>(arg4, arg5, arg2, v21);
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<T0>(&mut v23, arg4);
            let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg2, v23);
            let v27 = ClaimNFTEvent{
                collection_offer_id : arg1,
                nft_id              : v13,
                collection_type     : v4,
            };
            0x2::event::emit<ClaimNFTEvent>(v27);
        };
        ...
        let v28 = CancelOfferCollectionEvent{
            collection_offer_id : arg1,
            collection_type     : v4,
            offerer             : v0,
            quantity            : 0,
        ...
        0x2::event::emit<CancelOfferCollectionEvent>(v28);
    }
