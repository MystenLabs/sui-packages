module 0x2782c42546e5721972ad51344139b064effe5a6f4cdb4ead81182efda492e16d::cnsnft7392 {
    struct CNSNFT7392 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7392, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7392>(arg0, arg1);
