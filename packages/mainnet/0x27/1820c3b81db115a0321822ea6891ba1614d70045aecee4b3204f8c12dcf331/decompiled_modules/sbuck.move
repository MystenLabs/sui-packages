module 0x271820c3b81db115a0321822ea6891ba1614d70045aecee4b3204f8c12dcf331::sbuck {
    ...
    public fun collect_rewards<T0>(arg0: &mut Flask<T0>, arg1: &CollectRewardsCap<T0>, arg2: 0x2::balance::Balance<T0>) {
        ...
        0x271820c3b81db115a0321822ea6891ba1614d70045aecee4b3204f8c12dcf331::event::collect_rewards(v0);
    }
    ...
    public fun deposit<T0>(arg0: &mut Flask<T0>, arg1: 0x2::coin::Coin<T0>) : 0x2::balance::Balance<SBUCK> {
        ...
        let v1 = if (sbuck_supply<T0>(arg0) == 0) {
            ...
            0x271820c3b81db115a0321822ea6891ba1614d70045aecee4b3204f8c12dcf331::utils::mul_div(v0, sbuck_supply<T0>(arg0), reserves<T0>(arg0))
        };
        assert!(v1 > 0, 102);
        0x2::coin::put<T0>(&mut arg0.reserves, arg1);
        let v2 = 0x2::balance::increase_supply<SBUCK>(&mut arg0.sbuck_supply, v1);
        0x271820c3b81db115a0321822ea6891ba1614d70045aecee4b3204f8c12dcf331::event::deposit(v0, 0x2::balance::value<SBUCK>(&v2));
        v2
    }
    ...
    public fun claimable<T0>(arg0: &Flask<T0>, arg1: u64) : u64 {
        ...
        0x271820c3b81db115a0321822ea6891ba1614d70045aecee4b3204f8c12dcf331::utils::mul_div(arg1, reserves<T0>(arg0), sbuck_supply<T0>(arg0))
    }
    ...
    public fun withdraw<T0>(arg0: &mut Flask<T0>, arg1: 0x2::coin::Coin<SBUCK>) : 0x2::balance::Balance<T0> {
        ...
        assert!(v0 > 0, 101);
        let v1 = 0x2::balance::split<T0>(&mut arg0.reserves, 0x271820c3b81db115a0321822ea6891ba1614d70045aecee4b3204f8c12dcf331::utils::mul_div(v0, reserves<T0>(arg0), sbuck_supply<T0>(arg0)));
        0x271820c3b81db115a0321822ea6891ba1614d70045aecee4b3204f8c12dcf331::event::burn(0x2::balance::decrease_supply<SBUCK>(&mut arg0.sbuck_supply, 0x2::coin::into_balance<SBUCK>(arg1)), 0x2::balance::value<T0>(&v1));
        v1
    }
