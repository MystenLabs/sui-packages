module 0x27b1eef9edbb8595f4f41c7638d8a161f01938ebd468ec9d5c008f6c3a945a9c::cnsnft2189 {
    struct CNSNFT2189 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2189, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7093"));
        let v4 = 0x2::package::claim<CNSNFT2189>(arg0, arg1);
