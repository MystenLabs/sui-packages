module 0x270df1578ac76ce372315af5673e0902353410234598d569b9bf8f6f294dc96e::spring_sui_adapter {
    ...
    public fun new<T0: drop>(arg0: &mut SpringSuiAdapterRegistry, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, SpringSui>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x270df1578ac76ce372315af5673e0902353410234598d569b9bf8f6f294dc96e::spring_sui_adapter_event::new_spring_sui_vault_event(*0x2::object::uid_as_inner(&v4.id), v3);
        0x2::transfer::share_object<SpringSuiPass>(v4);
    }

    entry fun add_whitelist<T0>(arg0: &mut SpringSuiAdapterRegistry, arg1: &SpringSuiAdapterAdminCap) {
    ...
    public fun fetch_total_value<T0: drop>(arg0: &mut SpringSuiPass, arg1: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<SpringSui, T0> {
        new_total_value_message<T0>(arg0, 0x1::vector::empty<0x1::ascii::String>(), 0x1::vector::empty<u64>(), 0x1::vector::empty<bool>(), arg1)
    }
    ...
    entry fun remove_whitelist<T0>(arg0: &mut SpringSuiAdapterRegistry, arg1: &SpringSuiAdapterAdminCap) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
    ...
    public fun stake_sui<T0: drop>(arg0: &mut SpringSuiPass, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<T0, SpringSui, 0x2::sui::SUI>, arg2: &mut 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<0x83556891f4a0f233ce7b05cfe7f957d4020492a34f5405b2cb9377d060bef4bf::spring_sui::SPRING_SUI>, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<SpringSui, T0, 0x83556891f4a0f233ce7b05cfe7f957d4020492a34f5405b2cb9377d060bef4bf::spring_sui::SPRING_SUI> {
        ...
        0x270df1578ac76ce372315af5673e0902353410234598d569b9bf8f6f294dc96e::spring_sui_adapter_event::stake_sui_event(0x2::object::id<SpringSuiPass>(arg0), 0x2::balance::value<0x2::sui::SUI>(&v0), 0x2::coin::value<0x83556891f4a0f233ce7b05cfe7f957d4020492a34f5405b2cb9377d060bef4bf::spring_sui::SPRING_SUI>(&v1));
