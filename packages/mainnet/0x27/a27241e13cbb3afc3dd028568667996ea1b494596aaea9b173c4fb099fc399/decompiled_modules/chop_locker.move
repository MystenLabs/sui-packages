module 0x27a27241e13cbb3afc3dd028568667996ea1b494596aaea9b173c4fb099fc399::chop_locker {
    ...
    fun calculate_adjusted_reward_rate(arg0: u64, arg1: u64, arg2: u64) : u64 {
        arg0 * calculate_depletion_factor(arg1, arg2) / 10000
    }
    ...
    public entry fun lock_tokens<T0>(arg0: &mut PoolConfig<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = if (0x2::balance::value<T0>(&arg0.reward_balance) > 0) {
            ...
            let v5 = calculate_adjusted_reward_rate(calculate_base_reward_rate(v1, calculate_apy(v1)), 0x2::balance::value<T0>(&arg0.reward_balance), arg0.total_rewards_added_by_admin);
            v3 = v5;
            let v6 = v0 * v5 / 1000000000;
            let v7 = 1;
            let v8 = if (v6 < v7) {
                v6
            } else {
            ...
            assert!(v8 <= 0x2::balance::value<T0>(&arg0.reward_balance), 11);
            let v9 = &mut arg0.reward_balance;
            let v4 = withdraw_from_balance<T0>(v9, v8, arg5);
            arg0.total_weighted_stake = arg0.total_weighted_stake + v0 / 1000000000 * v5;
            v4
        } else {
            let v10 = &mut arg0.reward_balance;
            withdraw_from_balance<T0>(v10, 0, arg5)
        };
        let v11 = Lock<T0>{
        ...
        0x2::transfer::transfer<Lock<T0>>(v11, 0x2::tx_context::sender(arg5));
    }
    ...
    public entry fun sqrt(arg0: u64) : u64 {
        if (arg0 == 0) {
            return 0
        };
        if (arg0 == 1) {
