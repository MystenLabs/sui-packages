module 0x27cbe70a550cbe75b57f91aea89be0ed448b2132d8b15c751a85037920c1da6f::cnsnft8805 {
    struct CNSNFT8805 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8805, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8805>(arg0, arg1);
