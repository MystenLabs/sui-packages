module 0x277f719462a2380810f1e72bcdba617bd008090374cfde7d47487d85d252503b::helper {
    ...
    public(friend) fun calculate_order_amount(arg0: u64, arg1: u64, arg2: bool) : u64 {
        if (arg2) {
            0x277f719462a2380810f1e72bcdba617bd008090374cfde7d47487d85d252503b::math::mul(arg0, arg1)
        } else {
            arg0
        }
    }
