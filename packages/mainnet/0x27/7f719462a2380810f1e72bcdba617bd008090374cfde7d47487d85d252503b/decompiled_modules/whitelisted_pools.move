module 0x277f719462a2380810f1e72bcdba617bd008090374cfde7d47487d85d252503b::whitelisted_pools {
    struct WhitelistRegistry has key {
        id: 0x2::object::UID,
        pools: 0x2::table::Table<0x2::object::ID, bool>,
    }

    public entry fun add_pool_to_whitelist(arg0: &0x277f719462a2380810f1e72bcdba617bd008090374cfde7d47487d85d252503b::admin::AdminCap, arg1: &mut WhitelistRegistry, arg2: 0x2::object::ID) {
    ...
    public entry fun remove_pool_from_whitelist(arg0: &0x277f719462a2380810f1e72bcdba617bd008090374cfde7d47487d85d252503b::admin::AdminCap, arg1: &mut WhitelistRegistry, arg2: 0x2::object::ID) {
