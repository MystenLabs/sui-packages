module 0x271f4e91d125a7ae43f9f779efb055ff8d335c3532aacee7dafb0a319f2fd96c::reward6773 {
    struct REWARD6773 has drop {
        dummy_field: bool,
    }

    struct TICKET_6773 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6773(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6773>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6773>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6773, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6773>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6773>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6773>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6773>>(v5, 0x2::tx_context::sender(arg1));
    }
