module 0x272b20a77a33151e2c8686e2fa0abe97ac48a676316a8f4a71cab00ae391aadf::fee_tier {
    ...
    public fun set_default_fee_rate(arg0: &mut FeeTier, arg1: u32, arg2: &0x272b20a77a33151e2c8686e2fa0abe97ac48a676316a8f4a71cab00ae391aadf::admin_cap::AdminCap) {
        assert!(arg1 <= 200000, 0x272b20a77a33151e2c8686e2fa0abe97ac48a676316a8f4a71cab00ae391aadf::errors::err_max_fee_rate_limit());
    ...
    public fun set_fee_rate<T0, T1>(arg0: &mut FeeTier, arg1: u32, arg2: &0x272b20a77a33151e2c8686e2fa0abe97ac48a676316a8f4a71cab00ae391aadf::admin_cap::AdminCap) {
        assert!(arg1 <= 200000, 0x272b20a77a33151e2c8686e2fa0abe97ac48a676316a8f4a71cab00ae391aadf::errors::err_max_fee_rate_limit());
        let v0 = fee_rate_key<T0, T1>();
        let v1 = if (0x2::table::contains<0x1::ascii::String, u32>(&arg0.fee_rates, v0)) {
