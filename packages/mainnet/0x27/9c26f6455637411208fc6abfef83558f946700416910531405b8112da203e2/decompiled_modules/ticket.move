module 0x279c26f6455637411208fc6abfef83558f946700416910531405b8112da203e2::ticket {
    ...
    fun init(arg0: TICKET, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = MinterData{
            ...
            collection_description : 0x1::string::utf8(b"This ticket serves as your official invitation to claim your exclusive Freemint NFT Tier 3 from the Desui."),
            image_url              : 0x1::string::utf8(b"http://ipfs.io/ipfs/QmbuKzymdaYiGyz4E9Cz4XcqmuTMwMzZidJv7YrtidSoKq"),
