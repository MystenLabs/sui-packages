module 0x952dcd47c23154658d3e441dbe489adcb84bcff00cd29e12fd657068dbb6ae02::meta_ghost_beta_access {
    struct META_GHOST_BETA_ACCESS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: META_GHOST_BETA_ACCESS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<META_GHOST_BETA_ACCESS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Meta Ghost Beta Access"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A limited set of digital badges awarded to the first hunters who trusted in the existence of the supernatural. Each access symbolizes pioneering spirit, trust and direct participation in MTG's field tests, experimental technologies and secret protocols. Only a few were allowed to bear this seal."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidfkaduen6ekrpxzwpggdtcarkaxqksyb7ojteudmekyztc2ofs2a"));
