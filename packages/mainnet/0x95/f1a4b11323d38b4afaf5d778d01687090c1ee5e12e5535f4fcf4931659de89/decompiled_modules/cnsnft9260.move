module 0x95f1a4b11323d38b4afaf5d778d01687090c1ee5e12e5535f4fcf4931659de89::cnsnft9260 {
    struct CNSNFT9260 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9260, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9260>(arg0, arg1);
