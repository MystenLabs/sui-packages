module 0x9535f3741dff18f21fc27dd8886b39b752642d57f3665ba13ff955d56bdc731c::game2514 {
    struct GAME2514 has drop {
        dummy_field: bool,
    }

    struct TICKET_2514 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2514(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2514>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2514>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME2514, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME2514>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2514>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2514>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2514>>(v5, 0x2::tx_context::sender(arg1));
    }
