module 0x959987422e144ef7f3fdca9885aa5e782418dd4e8d27696ce8992de050ec2795::oracle {
    struct HiveOracle has store, key {
        id: 0x2::object::UID,
        update_cap: 0xce5c7485a2bc8e523dd57635c43ec1e1912d22289eb34b39b8ac1fe3454ba812::dragon_trainer::TwapUpdateCap,
    ...
    fun calculate_twap(arg0: u256, arg1: u256, arg2: u64) : u256 {
        let v0 = if (arg0 >= arg1) {
            ...
            0x49ff1fad22d99ddda9118f3df46b83dccdc040f914f715c753aad0321bcd2f8e::math::overflow_add_u256(arg0, 0x49ff1fad22d99ddda9118f3df46b83dccdc040f914f715c753aad0321bcd2f8e::math::sub_from_max_u256(arg1))
        };
        v0 / (arg2 as u256)
    }
    ...
    public fun setup_hive_oracle(arg0: 0xce5c7485a2bc8e523dd57635c43ec1e1912d22289eb34b39b8ac1fe3454ba812::dragon_trainer::TwapUpdateCap, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = HiveOracle{
            ...
            window_size        : 0x49ff1fad22d99ddda9118f3df46b83dccdc040f914f715c753aad0321bcd2f8e::constants::twap_init_window_size(),
            tolerance          : 0x49ff1fad22d99ddda9118f3df46b83dccdc040f914f715c753aad0321bcd2f8e::constants::twap_init_tolerance(),
            module_version     : 0,
        };
        0x2::transfer::share_object<HiveOracle>(v0);
    }

    public fun update_hive_oracle(arg0: &0x49ff1fad22d99ddda9118f3df46b83dccdc040f914f715c753aad0321bcd2f8e::yield_flow::DragonDaoCapability, arg1: &mut HiveOracle, arg2: 0x1::option::Option<address>, arg3: 0x1::option::Option<address>, arg4: u64, arg5: u64, arg6: &0x2::tx_context::TxContext) {
        ...
        if (arg4 > 0) {
            assert!(arg4 <= 0x49ff1fad22d99ddda9118f3df46b83dccdc040f914f715c753aad0321bcd2f8e::constants::twap_max_window_size(), 1977);
            arg1.window_size = arg4;
        };
        if (arg5 > 0) {
            assert!(arg5 <= 0x49ff1fad22d99ddda9118f3df46b83dccdc040f914f715c753aad0321bcd2f8e::constants::twap_max_tolerance(), 1978);
            arg1.tolerance = arg5;
        };
    ...
    public entry fun update_hive_oracle_price<T0, T1, T2, T3, T4, T5>(arg0: &0x2::clock::Clock, arg1: &mut HiveOracle, arg2: &mut 0xce5c7485a2bc8e523dd57635c43ec1e1912d22289eb34b39b8ac1fe3454ba812::dragon_trainer::HiveGraph, arg3: &0x959987422e144ef7f3fdca9885aa5e782418dd4e8d27696ce8992de050ec2795::two_pool::LiquidityPool<T0, T1, T4>, arg4: &0x959987422e144ef7f3fdca9885aa5e782418dd4e8d27696ce8992de050ec2795::two_pool::LiquidityPool<T2, T3, T5>, arg5: &0x2::tx_context::TxContext) {
        ...
        let v2 = 0x959987422e144ef7f3fdca9885aa5e782418dd4e8d27696ce8992de050ec2795::two_pool::get_liquidity_pool_id<T2, T3, T5>(arg4);
        assert!(0x2::object::id_to_address(&v2) == *0x1::option::borrow<address>(&arg1.sui_hive_pool_addr), 1974);
        let v3 = 0x959987422e144ef7f3fdca9885aa5e782418dd4e8d27696ce8992de050ec2795::two_pool::get_liquidity_pool_id<T0, T1, T4>(arg3);
        assert!(0x2::object::id_to_address(&v3) == *0x1::option::borrow<address>(&arg1.usdc_sui_pool_addr), 1974);
        let (_, v5, v6) = 0x959987422e144ef7f3fdca9885aa5e782418dd4e8d27696ce8992de050ec2795::two_pool::get_pool_cumulative_prices<T2, T3, T5>(arg4);
        let (_, v8, v9) = 0x959987422e144ef7f3fdca9885aa5e782418dd4e8d27696ce8992de050ec2795::two_pool::get_pool_cumulative_prices<T0, T1, T4>(arg3);
        ...
        if (0x1::option::is_some<HiveTwapSnapshot>(&v20)) {
            ...
            let v28 = 0x49ff1fad22d99ddda9118f3df46b83dccdc040f914f715c753aad0321bcd2f8e::math::mul_div_u256(v26, v27, (0x49ff1fad22d99ddda9118f3df46b83dccdc040f914f715c753aad0321bcd2f8e::math::pow(10, (0x49ff1fad22d99ddda9118f3df46b83dccdc040f914f715c753aad0321bcd2f8e::constants::twap_precision() as u128)) as u256));
            if (v28 > 0) {
                0xce5c7485a2bc8e523dd57635c43ec1e1912d22289eb34b39b8ac1fe3454ba812::dragon_trainer::update_hive_twap_info(&arg1.update_cap, arg0, arg2, v26, v27, v28);
            };
        };
