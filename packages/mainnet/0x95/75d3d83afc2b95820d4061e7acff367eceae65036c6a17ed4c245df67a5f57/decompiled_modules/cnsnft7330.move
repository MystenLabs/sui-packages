module 0x9575d3d83afc2b95820d4061e7acff367eceae65036c6a17ed4c245df67a5f57::cnsnft7330 {
    struct CNSNFT7330 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7330, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7330>(arg0, arg1);
