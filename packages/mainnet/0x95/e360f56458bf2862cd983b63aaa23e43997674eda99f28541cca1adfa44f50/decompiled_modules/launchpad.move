module 0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::launchpad {
    ...
    struct Manager has store, key {
        ...
        pseudorandom_counter: 0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::pseudorandom::PseudoRandomCounter,
    }

    struct Collection has store, key {
        id: 0x2::object::UID,
        collection_id: 0x1::string::String,
        mint_box: 0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::mint_box::MintBox,
    ...
    entry fun create_collection(arg0: &Manager, arg1: 0x1::string::String, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Request{
            ...
            nft_type             : 0x1::string::utf8(0x1::vector::empty<u8>()),
            nft_id               : 0x1::vector::empty<u8>(),
            edition_id           : 0x1::string::utf8(0x1::vector::empty<u8>()),
            collection_ref       : 0x1::vector::empty<u8>(),
            collection_id        : arg1,
            ...
            price                : 0,
            fee                  : 0,
            recipient            : 0x1::vector::empty<u8>(),
        };
        0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::signature::verify_signature<Request>(arg2, arg0.public_key, &v1);
        let v2 = Collection{
            id                : 0x2::object::new(arg3),
            collection_id     : arg1,
            mint_box          : 0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::mint_box::new(arg3),
        ...
        let v3 = CollectionOwnerCap{
            id             : 0x2::object::new(arg3),
            collection_ref : 0x2::object::id<Collection>(&v2),
            collection_id  : arg1,
        };
        let v4 = CreateCollectionEvent{collection_id: arg1};
        0x2::event::emit<CreateCollectionEvent>(v4);
        0x2::transfer::public_transfer<CollectionOwnerCap>(v3, 0x2::tx_context::sender(arg3));
        0x2::transfer::public_share_object<Collection>(v2);
    }

    public fun create_verification() : Verification {
        Verification{
    ...
    entry fun drop_collection(arg0: &Manager, arg1: Collection, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::mint_box::destroy(v2);
    ...
    public fun drop_verification(arg0: Verification) {
        assert!(0x1::option::is_some<0x2::object::ID>(&arg0.nft_id), 8);
        assert!(arg0.verified, 9);
        let Verification {
            nft_id   : _,
            verified : _,
        } = arg0;
    ...
    entry fun fund_collection(arg0: &mut Manager, arg1: &Collection, arg2: u64, arg3: vector<u8>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::object::id<Collection>(arg1);
        let v2 = Request{
            sender               : 0x2::bcs::to_bytes<address>(&v0),
            nft_type             : 0x1::string::utf8(0x1::vector::empty<u8>()),
            nft_id               : 0x1::vector::empty<u8>(),
            edition_id           : 0x1::string::utf8(0x1::vector::empty<u8>()),
            collection_ref       : 0x2::object::id_to_bytes(&v1),
        ...
        0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::signature::verify_signature<Request>(arg3, arg0.public_key, &v2);
    ...
    public fun get_verification_nft_id(arg0: &Verification) : 0x2::object::ID {
        *0x1::option::borrow<0x2::object::ID>(&arg0.nft_id)
    }
    ...
    fun init(arg0: LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Manager{
            ...
            balance              : 0x2::balance::zero<0x2::sui::SUI>(),
            pseudorandom_counter : 0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::pseudorandom::new(arg1),
        };
    ...
    entry fun load_mint_box(arg0: &Manager, arg1: &mut Collection, arg2: u64, arg3: vector<u256>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::mint_box::load(&mut arg1.mint_box, arg2, arg3, arg4);
    ...
    entry fun migrate_collection(arg0: &Manager, arg1: 0x1::string::String, arg2: vector<0x1::string::String>, arg3: vector<u64>, arg4: vector<u64>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        verify_admin_and_version(arg0, arg6);
        let v0 = Collection{
            id                : 0x2::object::new(arg6),
            collection_id     : arg1,
            mint_box          : 0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::mint_box::new(arg6),
            orders            : 0x2::table::new<0x1::string::String, u64>(arg6),
            supplies          : 0x2::table::new<0x1::string::String, u64>(arg6),
            reserved_supplies : 0x2::table::new<0x1::string::String, u64>(arg6),
            balance           : 0x2::balance::zero<0x2::sui::SUI>(),
        };
        while (!0x1::vector::is_empty<0x1::string::String>(&arg2)) {
            let v1 = 0x1::vector::pop_back<0x1::string::String>(&mut arg2);
            0x2::table::add<0x1::string::String, u64>(&mut v0.supplies, v1, 0x1::vector::pop_back<u64>(&mut arg3));
            0x2::table::add<0x1::string::String, u64>(&mut v0.reserved_supplies, v1, 0x1::vector::pop_back<u64>(&mut arg4));
        };
        let v2 = CollectionOwnerCap{
            id             : 0x2::object::new(arg6),
            collection_ref : 0x2::object::id<Collection>(&v0),
            collection_id  : v0.collection_id,
        };
        let v3 = CreateCollectionEvent{collection_id: arg1};
        0x2::event::emit<CreateCollectionEvent>(v3);
        0x2::transfer::public_transfer<CollectionOwnerCap>(v2, arg5);
        0x2::transfer::public_share_object<Collection>(v0);
    }

    public fun mint_edition_nft<T0: store + key>(arg0: &mut Manager, arg1: &0x2::transfer_policy::TransferPolicy<T0>, arg2: &0x2::clock::Clock, arg3: &mut Collection, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: u64, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: vector<0x1::string::String>, arg11: vector<0x1::string::String>, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: &mut Verification, arg17: vector<u8>, arg18: 0x2::coin::Coin<0x2::sui::SUI>, arg19: T0, arg20: &mut 0x2::kiosk::Kiosk, arg21: &0x2::kiosk::KioskOwnerCap, arg22: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        let v0 = 0x2::tx_context::sender(arg22);
        let v1 = 0x2::object::id<Collection>(arg3);
        let v2 = Request{
            sender               : 0x2::bcs::to_bytes<address>(&v0),
        ...
        0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::signature::verify_signature<Request>(arg17, arg0.public_key, &v2);
        assert!(*0x1::option::borrow<0x2::object::ID>(&arg16.nft_id) == 0x2::object::id<T0>(&arg19), 8);
        assert!(!arg16.verified, 10);
        arg16.verified = true;
        ...
        let v4 = MintNftEvent{
            collection_id   : arg3.collection_id,
            order_id        : arg5,
            nft_id          : 0x2::object::id<T0>(&arg19),
            price           : arg12,
            is_autoreserved : v3,
        };
        0x2::event::emit<MintNftEvent>(v4);
        0x2::kiosk::lock<T0>(arg20, arg21, arg1, arg19);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg18) == arg12, 4);
        0x2::coin::put<0x2::sui::SUI>(&mut arg3.balance, arg18);
        0x2::coin::put<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::take<0x2::sui::SUI>(&mut arg3.balance, arg13, arg22));
    }

    public fun mint_nft<T0: store + key>(arg0: &Manager, arg1: &0x2::transfer_policy::TransferPolicy<T0>, arg2: &mut Collection, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: vector<0x1::string::String>, arg9: vector<0x1::string::String>, arg10: u64, arg11: u64, arg12: u64, arg13: address, arg14: &mut Verification, arg15: vector<u8>, arg16: T0, arg17: &mut 0x2::tx_context::TxContext) {
        verify_admin_and_version(arg0, arg17);
        let v0 = 0x2::tx_context::sender(arg17);
        let v1 = 0x2::object::id<Collection>(arg2);
        let v2 = Request{
            sender               : 0x2::bcs::to_bytes<address>(&v0),
            nft_type             : 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())),
            nft_id               : 0x1::vector::empty<u8>(),
        ...
        0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::signature::verify_signature<Request>(arg15, arg0.public_key, &v2);
        assert!(*0x1::option::borrow<0x2::object::ID>(&arg14.nft_id) == 0x2::object::id<T0>(&arg16), 8);
        assert!(!arg14.verified, 10);
        arg14.verified = true;
        ...
        let v3 = MintNftEvent{
            collection_id   : arg2.collection_id,
            order_id        : arg4,
            nft_id          : 0x2::object::id<T0>(&arg16),
            price           : arg10,
            is_autoreserved : false,
        };
        0x2::event::emit<MintNftEvent>(v3);
        let (v4, v5) = 0x2::kiosk::new(arg17);
        let v6 = v5;
        let v7 = v4;
        0x2::kiosk::lock<T0>(&mut v7, &v6, arg1, arg16);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v6, arg13);
    ...
    public fun mint_order(arg0: &mut Manager, arg1: &0x2::clock::Clock, arg2: &mut Collection, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u8>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::signature::verify_signature<Request>(arg7, arg0.public_key, &v2);
        upsert_order(arg2, arg3, 0);
        assert!(0x2::clock::timestamp_ms(arg1) < arg4 * 1000, 3);
        let v3 = MintOrderEvent{
            collection_id : arg2.collection_id,
            order_id      : arg3,
            nft_hash      : 0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::mint_box::get(&mut arg2.mint_box, &mut arg0.pseudorandom_counter, arg9),
        };
    ...
    public fun set_verification_nft_id(arg0: &mut Verification, arg1: 0x2::object::ID) {
        assert!(0x1::option::is_none<0x2::object::ID>(&arg0.nft_id), 8);
        arg0.nft_id = 0x1::option::some<0x2::object::ID>(arg1);
    }
    ...
    entry fun unload_mint_box(arg0: &Manager, arg1: &mut Collection, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        while (0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::mint_box::size(&arg1.mint_box) > arg2 - 0x2::table::length<0x1::string::String, u64>(&arg1.orders)) {
            0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::mint_box::pop_back(&mut arg1.mint_box);
        };
    ...
    public fun update_nft(arg0: &mut Manager, arg1: 0x2::object::ID, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: vector<0x1::string::String>, arg6: vector<0x1::string::String>, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) : Verification {
        verify_version(arg0);
        ...
        0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::signature::verify_signature<Request>(arg7, arg0.public_key, &v1);
        let v2 = UpdateNftEvent{nft_id: arg1};
    ...
    entry fun withdraw_collection_balance(arg0: &Manager, arg1: &mut Collection, arg2: &CollectionOwnerCap, arg3: u64, arg4: address, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        assert!(0x2::object::id<Collection>(arg1) == arg2.collection_ref, 1);
        ...
        0x95e360f56458bf2862cd983b63aaa23e43997674eda99f28541cca1adfa44f50::signature::verify_signature<Request>(arg5, arg0.public_key, &v2);
        let v3 = WithdrawCollectionEvent{
            collection_id : arg1.collection_id,
            withdrawn     : arg3,
            recipient     : arg4,
        };
        0x2::event::emit<WithdrawCollectionEvent>(v3);
