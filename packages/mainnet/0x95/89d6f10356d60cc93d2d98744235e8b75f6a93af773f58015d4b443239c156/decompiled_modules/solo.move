module 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::solo {
    ...
    public entry fun accept_swap_offer<T0: store + key, T1: store + key>(arg0: &mut Store, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: &mut 0x2::kiosk::Kiosk, arg5: &mut 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::PersonalKioskCap, arg6: &mut 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::PersonalKioskCap, arg7: &0x2::transfer_policy::TransferPolicy<T1>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        v0.status = 1;
        let (v1, v2) = 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::borrow_val(arg5);
        let v3 = v1;
        let (v4, v5) = 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::borrow_val(arg6);
        let v6 = v4;
        0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::return_val(arg6, v6, v5);
        ...
        0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::return_val(arg5, v3, v2);
    ...
    public entry fun buy_and_place_in_kiosk<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::kiosk::Kiosk, arg6: &mut 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::PersonalKioskCap, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::is_personal(arg1), 10);
        assert!(0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::is_personal(arg5), 10);
        assert!(0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::owner(arg5) == 0x2::tx_context::sender(arg7), 1);
        ...
        let (v15, v16) = 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::borrow_val(arg6);
        let v17 = v15;
        0x2::kiosk::place<T0>(arg5, &v17, v10);
        0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::return_val(arg6, v17, v16);
    ...
    public entry fun create_swap_offer(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::PersonalKioskCap, arg3: 0x2::object::ID, arg4: &0x2::kiosk::Kiosk, arg5: 0x2::object::ID, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::is_personal(arg1), 10);
        assert!(0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::is_personal(arg4), 10);
        assert!(0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::owner(arg1) == 0x2::tx_context::sender(arg6), 1);
        ...
        let v0 = SwapOffer{
            ...
            receiver          : 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::owner(arg4),
    ...
    public entry fun delist_nft<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::PersonalKioskCap, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::is_personal(arg1), 10);
        assert!(0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::owner(arg1) == 0x2::tx_context::sender(arg4), 1);
        assert!(0x2::kiosk::has_item(arg1, arg3), 2);
        ...
        let (v8, v9) = 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::borrow_val(arg2);
        0x2::kiosk::return_purchase_cap<T0>(arg1, v4);
        0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::return_val(arg2, v8, v9);
    ...
    public entry fun list_nft<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::PersonalKioskCap, arg3: 0x2::object::ID, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::is_personal(arg1), 10);
        assert!(0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::owner(arg1) == 0x2::tx_context::sender(arg5), 1);
        assert!(0x2::kiosk::has_item(arg1, arg3), 2);
        assert!(!0x2::kiosk::is_listed(arg1, arg3), 6);
        assert!(arg4 > 0, 7);
        let (v0, v1) = 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::borrow_val(arg2);
        let v2 = v0;
        0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::return_val(arg2, v2, v1);
        let v3 = Listing<T0>{
    ...
    public entry fun list_nft_sui<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::PersonalKioskCap, arg3: 0x2::object::ID, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::is_personal(arg1), 10);
        assert!(0x9589d6f10356d60cc93d2d98744235e8b75f6a93af773f58015d4b443239c156::personal_kiosk::owner(arg1) == 0x2::tx_context::sender(arg5), 1);
        assert!(0x2::kiosk::has_item(arg1, arg3), 2);
        assert!(!0x2::kiosk::is_listed(arg1, arg3), 6);
