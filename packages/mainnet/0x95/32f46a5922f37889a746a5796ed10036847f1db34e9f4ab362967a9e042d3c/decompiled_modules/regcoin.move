module 0x9532f46a5922f37889a746a5796ed10036847f1db34e9f4ab362967a9e042d3c::regcoin {
    ...
    fun init(arg0: REGCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<REGCOIN>(arg0, 6, b"delp", b"dop :dopin::DOPIN", b"elooo", 0x1::option::none<0x2::url::Url>(), false, arg1);
