module 0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::pyth {
    ...
    public fun decimals(arg0: 0x1::type_name::TypeName) : u8 {
        if (arg0 == 0x1::type_name::get<0x2::sui::SUI>()) {
            ...
            assert!(arg0 == 0x1::type_name::get<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(), 0);
            6
        }
    }
