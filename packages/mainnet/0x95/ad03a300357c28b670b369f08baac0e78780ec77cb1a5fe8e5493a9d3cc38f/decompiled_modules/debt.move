module 0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::debt {
    ...
    public fun borrow_treasury_cap<T0>(arg0: &DebtTreasury<T0>) : &0x2::coin::TreasuryCap<T0> {
        &arg0.cap
    }

    public fun calc_balance_repay_for_amount<T0>(arg0: &DebtRegistry<T0>, arg1: u64) : (u64, u64) {
        let v0 = (0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::util::muldiv_u128((arg1 as u128), arg0.supply_x64, arg0.liability_value_x64) as u64);
    ...
    public fun calc_repay_for_amount<T0>(arg0: &DebtRegistry<T0>, arg1: u64) : u128 {
        0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::util::muldiv_u128((arg1 as u128) * 18446744073709551616, arg0.supply_x64, arg0.liability_value_x64)
    }

    public fun calc_repay_for_amount_x64<T0>(arg0: &DebtRegistry<T0>, arg1: u128) : (u128, u128) {
        let v0 = 0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::util::muldiv_u128(arg1, arg0.supply_x64, arg0.liability_value_x64);
        (v0, calc_repay_x64<T0>(arg0, v0))
    }

    public fun calc_repay_lossy<T0>(arg0: &DebtRegistry<T0>, arg1: u128) : u64 {
        (0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::util::divide_and_round_up_u128(calc_repay_x64<T0>(arg0, arg1), 18446744073709551616) as u64)
    }

    public fun calc_repay_x64<T0>(arg0: &DebtRegistry<T0>, arg1: u128) : u128 {
        0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::util::muldiv_round_up_u128(arg0.liability_value_x64, arg1, arg0.supply_x64)
    }
    ...
    public fun create_registry_with_cap<T0: drop>(arg0: &0x2::coin::TreasuryCap<T0>) : DebtRegistry<T0> {
        DebtRegistry<T0>{
            supply_x64          : 0,
            liability_value_x64 : 0,
        }
    ...
    public fun increase_liability_and_issue_x64<T0>(arg0: &mut DebtRegistry<T0>, arg1: u128) : DebtShareBalance<T0> {
        ...
        let v0 = 0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::util::muldiv_round_up_u128(arg0.supply_x64, arg1, arg0.liability_value_x64);
        arg0.liability_value_x64 = arg0.liability_value_x64 + arg1;
    ...
    public fun into_balance_lossy<T0>(arg0: DebtShareBalance<T0>, arg1: &mut DebtTreasury<T0>) : 0x2::balance::Balance<T0> {
        ...
        0x2::coin::mint_balance<T0>(&mut arg1.cap, (0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::util::divide_and_round_up_u128(v0, 18446744073709551616) as u64))
    }
    ...
    public fun repay_lossy<T0>(arg0: &mut DebtRegistry<T0>, arg1: DebtShareBalance<T0>) : u64 {
        ...
        (0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::util::divide_and_round_up_u128(v0, 18446744073709551616) as u64)
    }

    public fun repay_x64<T0>(arg0: &mut DebtRegistry<T0>, arg1: DebtShareBalance<T0>) : u128 {
        let DebtShareBalance { value_x64: v0 } = arg1;
        let v1 = 0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::util::muldiv_round_up_u128(arg0.liability_value_x64, v0, arg0.supply_x64);
        arg0.liability_value_x64 = arg0.liability_value_x64 - v1;
        arg0.supply_x64 = arg0.supply_x64 - v0;
        v1
    }
