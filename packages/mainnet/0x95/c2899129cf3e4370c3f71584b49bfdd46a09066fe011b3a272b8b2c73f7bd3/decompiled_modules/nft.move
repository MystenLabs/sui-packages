module 0x95c2899129cf3e4370c3f71584b49bfdd46a09066fe011b3a272b8b2c73f7bd3::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public fun depositNft(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut NftPegVault, arg3: &mut 0xeab088d2d5183176929471adff45132c6651dc62dc0cf126cc3cd2054cee76e2::archieve::UserArchieve, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0xeab088d2d5183176929471adff45132c6651dc62dc0cf126cc3cd2054cee76e2::version::Version, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0xeab088d2d5183176929471adff45132c6651dc62dc0cf126cc3cd2054cee76e2::archieve::verUpdateNftPegNonce(v2, arg3);
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xeab088d2d5183176929471adff45132c6651dc62dc0cf126cc3cd2054cee76e2::cap_vault::createVault<NftAdminCap>(arg1);
    }
    ...
    public fun setValidator(arg0: &NftAdminCap, arg1: vector<u8>, arg2: &mut NftPegVault, arg3: &0xeab088d2d5183176929471adff45132c6651dc62dc0cf126cc3cd2054cee76e2::version::Version) {
    ...
    public fun withdrawFee(arg0: &NftAdminCap, arg1: &mut NftPegVault, arg2: &0xeab088d2d5183176929471adff45132c6651dc62dc0cf126cc3cd2054cee76e2::version::Version, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        0xeab088d2d5183176929471adff45132c6651dc62dc0cf126cc3cd2054cee76e2::version::checkVersion(arg2, 1);
        0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.fee, 0x2::balance::value<0x2::sui::SUI>(&arg1.fee)), arg3)
    }

    public fun withdrawNft(arg0: &mut 0xeab088d2d5183176929471adff45132c6651dc62dc0cf126cc3cd2054cee76e2::archieve::UserArchieve, arg1: BirdNFT, arg2: &0xeab088d2d5183176929471adff45132c6651dc62dc0cf126cc3cd2054cee76e2::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0xeab088d2d5183176929471adff45132c6651dc62dc0cf126cc3cd2054cee76e2::version::checkVersion(arg2, 1);
        ...
        let v6 = NFTWithdrawn{
            ...
            rare     : v4,
            value    : v5,
            nonce    : 0xeab088d2d5183176929471adff45132c6651dc62dc0cf126cc3cd2054cee76e2::archieve::increaseGetNftDepegNonce(arg0),
        };
