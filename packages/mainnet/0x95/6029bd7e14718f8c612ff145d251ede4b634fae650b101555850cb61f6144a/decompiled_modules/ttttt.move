module 0x956029bd7e14718f8c612ff145d251ede4b634fae650b101555850cb61f6144a::ttttt {
    ...
    fun init(arg0: TTTTT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TTTTT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"ttttt"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"tttt"));
