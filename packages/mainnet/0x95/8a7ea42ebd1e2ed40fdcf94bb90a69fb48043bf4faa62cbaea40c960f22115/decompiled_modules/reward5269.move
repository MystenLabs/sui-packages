module 0x958a7ea42ebd1e2ed40fdcf94bb90a69fb48043bf4faa62cbaea40c960f22115::reward5269 {
    struct REWARD5269 has drop {
        dummy_field: bool,
    }

    struct TICKET_5269 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5269(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5269>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5269>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5269, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5269>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5269>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5269>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5269>>(v5, 0x2::tx_context::sender(arg1));
    }
