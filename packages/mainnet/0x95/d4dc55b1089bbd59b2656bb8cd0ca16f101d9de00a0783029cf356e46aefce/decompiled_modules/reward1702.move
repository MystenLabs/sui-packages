module 0x95d4dc55b1089bbd59b2656bb8cd0ca16f101d9de00a0783029cf356e46aefce::reward1702 {
    struct REWARD1702 has drop {
        dummy_field: bool,
    }

    struct TICKET_1702 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1702(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1702>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1702>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1702, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1702>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1702>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1702>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1702>>(v5, 0x2::tx_context::sender(arg1));
    }
