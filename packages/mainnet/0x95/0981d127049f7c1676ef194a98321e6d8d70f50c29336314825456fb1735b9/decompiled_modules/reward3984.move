module 0x950981d127049f7c1676ef194a98321e6d8d70f50c29336314825456fb1735b9::reward3984 {
    struct REWARD3984 has drop {
        dummy_field: bool,
    }

    struct TICKET_3984 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3984(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3984>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3984>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3984, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3984>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3984>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3984>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3984>>(v5, 0x2::tx_context::sender(arg1));
    }
