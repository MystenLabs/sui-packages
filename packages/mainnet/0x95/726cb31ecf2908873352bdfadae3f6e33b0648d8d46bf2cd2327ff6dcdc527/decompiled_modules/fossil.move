module 0x95726cb31ecf2908873352bdfadae3f6e33b0648d8d46bf2cd2327ff6dcdc527::fossil {
    ...
    public entry fun burn(arg0: &BurnCap, arg1: &mut 0x95726cb31ecf2908873352bdfadae3f6e33b0648d8d46bf2cd2327ff6dcdc527::supply::Supply, arg2: Fossil, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Burn{
            token_id : 0x2::object::id<Fossil>(&arg2),
            sender   : 0x2::tx_context::sender(arg3),
        };
        0x2::event::emit<Burn>(v0);
        0x95726cb31ecf2908873352bdfadae3f6e33b0648d8d46bf2cd2327ff6dcdc527::supply::decrement(arg1, 1);
    ...
    fun init(arg0: FOSSIL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_share_object<0x95726cb31ecf2908873352bdfadae3f6e33b0648d8d46bf2cd2327ff6dcdc527::supply::Supply>(0x95726cb31ecf2908873352bdfadae3f6e33b0648d8d46bf2cd2327ff6dcdc527::supply::new(3500, arg1));
    }

    public fun mint(arg0: &MintCap, arg1: &mut 0x95726cb31ecf2908873352bdfadae3f6e33b0648d8d46bf2cd2327ff6dcdc527::supply::Supply, arg2: &mut 0x2::tx_context::TxContext) : Fossil {
        let v0 = Fossil{id: 0x2::object::new(arg2)};
        0x95726cb31ecf2908873352bdfadae3f6e33b0648d8d46bf2cd2327ff6dcdc527::supply::increment(arg1, 1);
        let v1 = Mint{
    ...
    public entry fun mint_and_transfer(arg0: &MintCap, arg1: &mut 0x95726cb31ecf2908873352bdfadae3f6e33b0648d8d46bf2cd2327ff6dcdc527::supply::Supply, arg2: &mut 0x2::tx_context::TxContext) {
