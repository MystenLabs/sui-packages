module 0x95da6768f115e250607b37fc6c32922dbb51f5ea5d4f2c6f76a9463cbf7eb13e::reward7737 {
    struct REWARD7737 has drop {
        dummy_field: bool,
    }

    struct TICKET_7737 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7737(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7737>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7737>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7737, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7737>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7737>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7737>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7737>>(v5, 0x2::tx_context::sender(arg1));
    }
