module 0x958999f756bf4402180e25b068b1abf6c48611fd978d194523aacf1346cd7872::dont_trust_verify {
    struct DONT_TRUST_VERIFY has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DONT_TRUST_VERIFY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DONT_TRUST_VERIFY>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"dont_trust_verify"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"accept 30sui, bro."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://snQLESjG35InN_0VyaQx-9Zk28kjkYIovWnAw3dCPfo"));
