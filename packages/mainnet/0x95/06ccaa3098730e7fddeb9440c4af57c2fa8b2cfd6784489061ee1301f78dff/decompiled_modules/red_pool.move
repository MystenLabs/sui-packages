module 0x7e30d2b545257c794147131e15a29e035321ab61450b223d1234d89ffe639b2b::red_pool {
    ...
    public fun emergency_withdraw<T0>(arg0: &RedPoolCap, arg1: &mut RedPool, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(!arg1.circuit_breaker.deposit_enabled, 5);
        assert!(!arg1.circuit_breaker.redemption_enabled, 6);
        0x7e30d2b545257c794147131e15a29e035321ab61450b223d1234d89ffe639b2b::reserve::take<T0>(&mut arg1.reserve, arg2, 0x7e30d2b545257c794147131e15a29e035321ab61450b223d1234d89ffe639b2b::reserve::amount(&arg1.reserve, 0x1::type_name::get<T0>()))
    }
