module 0x954bbf6ab93e47c5204c92157bbc5de2fcf52f37e578d6e3162e187b111df57c::SUILEND {
    ...
    public entry fun RewardVoucher(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SUILEND_VOUCHER{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/suilend_0702/suilend_0702_1.jpg"),
    ...
    fun init(arg0: SUILEND, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/suilend_0702/suilend_0702_1.jpg"));
