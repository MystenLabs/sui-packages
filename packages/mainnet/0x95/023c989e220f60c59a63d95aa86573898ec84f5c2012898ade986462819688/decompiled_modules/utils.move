module 0xa6ce917b3fea8d6b32e7811b555f7d00b4364d0d18ea3dcb2cc340420a220a76::utils {
    ...
    public fun get_token_out_amount(arg0: 0x1::ascii::String, arg1: 0x1::ascii::String, arg2: vector<0x1::ascii::String>, arg3: vector<u64>, arg4: vector<u64>, arg5: u64) : u128 {
        let (v0, v1) = 0x1::vector::index_of<0x1::ascii::String>(&arg2, &arg0);
        assert!(v0, 7);
        let (v2, v3) = 0x1::vector::index_of<0x1::ascii::String>(&arg2, &arg1);
        assert!(v2, 8);
        let (_, _, v6) = calculate_output(*0x1::vector::borrow<u64>(&arg4, v1), *0x1::vector::borrow<u64>(&arg4, v3), *0x1::vector::borrow<u64>(&arg3, v1), *0x1::vector::borrow<u64>(&arg3, v3), arg5);
        (v6 as u128)
    }
