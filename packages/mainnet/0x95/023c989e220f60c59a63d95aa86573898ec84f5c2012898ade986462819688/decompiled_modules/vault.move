    ...
    public fun move_token_to_withdraw_assets_sigs_v2<T0, T1, T2>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: address, arg4: u64, arg5: u64, arg6: u64, arg7: vector<vector<u8>>, arg8: vector<vector<u8>>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        while (v6 < 0x1::vector::length<PendingRedeemV2>(v5)) {
            ...
            if (v8.withdraw_time == arg4) {
                v7 = true;
                if (0x1::option::is_some<0x1::ascii::String>(&v8.token_a)) {
                ...
                if (0x1::option::is_some<0x1::ascii::String>(&v8.token_b)) {
                    if (0x1::option::borrow<0x1::ascii::String>(&v8.token_b) == &v0 && v3 > 0) {
        ...
        if (v0 == 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())) {
            ...
            let v9 = 0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg2.coin_store.coin);
            assert!(0x2::coin::value<T0>(v9) >= arg5, 2);
            arg2.available_liquidity = arg2.available_liquidity - (arg5 as u128);
            let v10 = 0x2::coin::split<T0>(v9, arg5, arg10);
            if (0x2::bag::contains<0x1::ascii::String>(&arg2.withdraw_assets, v0)) {
                increase_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T0>(&v10) as u128), arg10);
                0x2::coin::join<T0>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg2.withdraw_assets, v0), v10);
            } else {
                add_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T0>(&v10) as u128), arg10);
                0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg2.withdraw_assets, v0, v10);
                0x1::vector::push_back<0x1::ascii::String>(&mut arg2.withdraw_asset_keys, v0);
            };
            let v11 = arg2.available_liquidity;
            add_table_vault_asset<T0, T1>(arg2, v0, v11, arg10);
        } else {
            assert!(0x2::bag::contains<0x1::ascii::String>(&arg2.harvest_assets, v0), 14);
            let v12 = 0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.harvest_assets, v0);
            assert!(0x2::coin::value<T2>(v12) >= arg5, 2);
            let v13 = 0x2::coin::split<T2>(v12, arg5, arg10);
            if (0x2::coin::value<T2>(v12) == 0) {
                ...
                let (v14, v15) = 0x1::vector::index_of<0x1::ascii::String>(&arg2.harvest_asset_keys, &v0);
                if (v14) {
                    0x1::vector::swap_remove<0x1::ascii::String>(&mut arg2.harvest_asset_keys, v15);
                };
            } else {
                add_table_vault_asset<T0, T1>(arg2, v0, (0x2::coin::value<T2>(v12) as u128), arg10);
            };
            if (0x2::bag::contains<0x1::ascii::String>(&arg2.withdraw_assets, v0)) {
                increase_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T2>(&v13) as u128), arg10);
                0x2::coin::join<T2>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.withdraw_assets, v0), v13);
            } else {
                add_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T2>(&v13) as u128), arg10);
                0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.withdraw_assets, v0, v13);
                0x1::vector::push_back<0x1::ascii::String>(&mut arg2.withdraw_asset_keys, v0);
            };
        };
        let v16 = MoveTokenToWithdrawAssetEvent{
            amount   : arg5,
            vault_id : 0x2::object::id<Vault<T0, T1>>(arg2),
            token    : v0,
        };
        0x2::event::emit<MoveTokenToWithdrawAssetEvent>(v16);
    }
