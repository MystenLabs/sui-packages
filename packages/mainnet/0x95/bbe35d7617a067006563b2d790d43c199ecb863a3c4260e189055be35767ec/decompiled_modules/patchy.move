module 0x95bbe35d7617a067006563b2d790d43c199ecb863a3c4260e189055be35767ec::patchy {
    ...
    fun init(arg0: PATCHY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<PATCHY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Patchy      ")))), trim_right(b"Patchy                          "), trim_right(b"Patchy the Gecko | I Kill bears for a living                                                                                                                                                                                                                                                                                    "), v2, arg1);
