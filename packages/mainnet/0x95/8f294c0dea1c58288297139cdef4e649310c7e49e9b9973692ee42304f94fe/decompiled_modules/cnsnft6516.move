module 0x958f294c0dea1c58288297139cdef4e649310c7e49e9b9973692ee42304f94fe::cnsnft6516 {
    struct CNSNFT6516 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6516, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6516>(arg0, arg1);
