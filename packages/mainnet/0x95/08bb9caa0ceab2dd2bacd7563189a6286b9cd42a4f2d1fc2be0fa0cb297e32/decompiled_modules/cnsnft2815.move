module 0x9508bb9caa0ceab2dd2bacd7563189a6286b9cd42a4f2d1fc2be0fa0cb297e32::cnsnft2815 {
    struct CNSNFT2815 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2815, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2815>(arg0, arg1);
