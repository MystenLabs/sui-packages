module 0x95ff3c78171652b0992665b03223cd19ec5298e7ab848c782ae0351315e8680c::reward7305 {
    struct REWARD7305 has drop {
        dummy_field: bool,
    }

    struct TICKET_7305 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7305(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7305>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7305>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7305, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7305>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7305>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7305>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7305>>(v5, 0x2::tx_context::sender(arg1));
    }
