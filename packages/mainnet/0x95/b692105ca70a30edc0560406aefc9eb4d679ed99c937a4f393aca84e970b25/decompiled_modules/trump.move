module 0x95b692105ca70a30edc0560406aefc9eb4d679ed99c937a4f393aca84e970b25::trump {
    ...
    fun init(arg0: TRUMP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/33dhV1iMDitcac2vCgzfUNDn5LXBBgg7khcoqRM1znwt.png?size=lg&key=0f1450                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<TRUMP>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"trump   ")))), trim_right(b"TrumpEffect69420                "), trim_right(b"TrumpEffect69420 takes center stage as a phenomenon fueled by an extraordinary blend of market optimism                                                                                                                                                                                                                         "), v2, arg1);
        let v5 = v3;
