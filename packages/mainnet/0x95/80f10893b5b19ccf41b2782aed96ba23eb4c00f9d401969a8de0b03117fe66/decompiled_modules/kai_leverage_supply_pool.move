module 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::kai_leverage_supply_pool {
    ...
    public fun admin_cap_id<T0, T1>(arg0: &Strategy<T0, T1>) : 0x2::object::ID {
        arg0.admin_cap_id
    }
    ...
    public(friend) fun max_withdraw_within_reserve(arg0: u64, arg1: u128) : u64 {
        let v0 = (100 as u128);
        (0x1::u128::saturating_sub((arg0 as u128), 0x1::u128::div_ceil(arg1 * v0, 10000 - v0)) as u64)
    }
    ...
    public fun rebalance<T0, T1, T2>(arg0: &mut Strategy<T0, T1>, arg1: &AdminCap, arg2: &mut 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::Vault<T0, T2>, arg3: &0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::RebalanceAmounts, arg4: &mut 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::SupplyPool<T0, T1>, arg5: &0xd9dd55ac7eb676dc78f7d0ae3bc5529d7fd6b52ac0d0edb2d7820c52d080026::access::Policy, arg6: address, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 > 0) {
            let v3 = 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::util::muldiv(0x2::balance::value<T1>(&arg0.shares), v2, arg0.underlying_nominal_value_t);
            let v4 = max_withdraw_within_reserve(0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::available_balance_value<T0, T1>(arg4), 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::total_liabilities_x64<T0, T1>(arg4) >> 64);
            let v5 = if (0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::calc_withdraw_by_shares<T0, T1>(arg4, v3, arg7) > v4) {
                let (v6, _) = 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::calc_withdraw_by_amount<T0, T1>(arg4, v4, arg7);
                0x1::u64::max(v6, 1) - 1
            } else {
                v3
            };
            ...
            let v8 = 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::withdraw<T0, T1>(arg4, 0x2::balance::split<T1>(&mut arg0.shares, v5), arg7);
            if (0x2::balance::value<T0>(&v8) > v2) {
                0x2::balance::join<T0>(&mut arg0.collected_profit_t, 0x2::balance::split<T0>(&mut v8, 0x2::balance::value<T0>(&v8) - v2));
            };
            0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::strategy_repay<T0, T2>(arg2, v0, v8);
            arg0.underlying_nominal_value_t = arg0.underlying_nominal_value_t - 0x2::balance::value<T0>(&v8);
        } else if (v1 > 0) {
            let v9 = 0x1::u64::min(v1, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::free_balance<T0, T2>(arg2));
            let (v10, v11) = 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::supply<T0, T1>(arg4, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::strategy_borrow<T0, T2>(arg2, v0, v9), arg7, arg8);
            0xd9dd55ac7eb676dc78f7d0ae3bc5529d7fd6b52ac0d0edb2d7820c52d080026::access::approve_request(v11, &arg0.entity, arg5, arg6);
            0x2::balance::join<T1>(&mut arg0.shares, v10);
            arg0.underlying_nominal_value_t = arg0.underlying_nominal_value_t + v9;
        };
    }
    ...
    fun skim_base_profits<T0, T1>(arg0: &mut Strategy<T0, T1>, arg1: &mut 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::SupplyPool<T0, T1>, arg2: &0x2::clock::Clock) {
        ...
        if (v0 > arg0.underlying_nominal_value_t) {
            let v1 = 0x1::u64::min(v0 - arg0.underlying_nominal_value_t, 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::available_balance_value<T0, T1>(arg1));
            if (v1 == 0) {
                return
            };
            let (v2, _) = 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::calc_withdraw_by_amount<T0, T1>(arg1, v1, arg2);
            0x2::balance::join<T0>(&mut arg0.collected_profit_t, 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::withdraw<T0, T1>(arg1, 0x2::balance::split<T1>(&mut arg0.shares, 0x1::u64::max(v2, 1) - 1), arg2));
        };
    }
    ...
    public fun withdraw<T0, T1, T2>(arg0: &mut Strategy<T0, T1>, arg1: &mut 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::WithdrawTicket<T0, T2>, arg2: &mut 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::SupplyPool<T0, T1>, arg3: &0x2::clock::Clock) {
        ...
        let v2 = 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::util::muldiv(0x2::balance::value<T1>(&arg0.shares), v1, arg0.underlying_nominal_value_t);
        assert!(withdraw_leaves_reserve(0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::available_balance_value<T0, T1>(arg2), 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::total_liabilities_x64<T0, T1>(arg2) >> 64, 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::calc_withdraw_by_shares<T0, T1>(arg2, v2, arg3)), 4);
        let v3 = 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::withdraw<T0, T1>(arg2, 0x2::balance::split<T1>(&mut arg0.shares, v2), arg3);
        if (0x2::balance::value<T0>(&v3) > v1) {
            0x2::balance::join<T0>(&mut arg0.collected_profit_t, 0x2::balance::split<T0>(&mut v3, 0x2::balance::value<T0>(&v3) - v1));
        };
        0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::strategy_withdraw_to_ticket<T0, T2>(arg1, v0, v3);
        arg0.underlying_nominal_value_t = arg0.underlying_nominal_value_t - v1;
    }

    public(friend) fun withdraw_leaves_reserve(arg0: u64, arg1: u128, arg2: u64) : bool {
        if (arg2 == 0) {
            return true
        };
        if (arg0 < arg2) {
        ...
        let v0 = ((arg0 - arg2) as u128);
        v0 >= (v0 + arg1) * (100 as u128) / 10000
    }
