module 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault {
    ...
    fun has_rate_limiter<T0, T1>(arg0: &Vault<T0, T1>) : bool {
        0x2::dynamic_field::exists<vector<u8>>(&arg0.id, b"rate_limiter")
    }
    ...
    entry fun set_withdrawals_disabled<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>, arg2: bool) {
        assert_version<T0, T1>(arg1);
        if (0x2::dynamic_field::exists<vector<u8>>(&arg1.id, b"withdrawals_disabled")) {
    ...
    public(friend) fun strategy_hand_over_profit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultAccess, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        ...
        0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.time_locked_profit, 0x1::u64::div_ceil(0x2::balance::value<T0>(&v4), arg0.profit_unlock_duration_sec), arg3);
    ...
    public fun withdrawals_disabled<T0, T1>(arg0: &Vault<T0, T1>) : bool {
        0x2::dynamic_field::exists<vector<u8>>(&arg0.id, b"withdrawals_disabled") && *0x2::dynamic_field::borrow<vector<u8>, bool>(&arg0.id, b"withdrawals_disabled")
    }
