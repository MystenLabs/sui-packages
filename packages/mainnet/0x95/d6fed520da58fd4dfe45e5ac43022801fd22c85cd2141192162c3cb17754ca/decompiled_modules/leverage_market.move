module 0x95d6fed520da58fd4dfe45e5ac43022801fd22c85cd2141192162c3cb17754ca::leverage_market {
    ...
    public(friend) fun ensure_leverage_on_going(arg0: &LeverageMarket) {
        assert!(arg0.leverage_on_going, 0x95d6fed520da58fd4dfe45e5ac43022801fd22c85cd2141192162c3cb17754ca::leverage_error::leverage_not_on_going());
    }

    public(friend) fun ensure_no_leverage_on_going(arg0: &LeverageMarket) {
        assert!(!arg0.leverage_on_going, 0x95d6fed520da58fd4dfe45e5ac43022801fd22c85cd2141192162c3cb17754ca::leverage_error::leverage_on_going());
    }

    public(friend) fun ensure_supporting_market<T0>(arg0: &LeverageMarket, arg1: &0xce265981a720274f6032324a42be65b2d9c280c8882243adb11d4222837444c0::market::Market<T0>) {
        assert!(arg0.supported_market_id == 0x2::object::id<0xce265981a720274f6032324a42be65b2d9c280c8882243adb11d4222837444c0::market::Market<T0>>(arg1), 0x95d6fed520da58fd4dfe45e5ac43022801fd22c85cd2141192162c3cb17754ca::leverage_error::market_not_supported());
    }
