module 0x95464b857cf02fb4c8b8cbadcb6c251b74027c0aa46ade563e6dd513ae30de17::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public fun depositNft(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut NftPegVault, arg3: &mut 0x9edc63266f79189c33c3d663a97b372c8188074a03b601487a763f9a9e6372b3::archieve::UserArchieve, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x9edc63266f79189c33c3d663a97b372c8188074a03b601487a763f9a9e6372b3::version::Version, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x9edc63266f79189c33c3d663a97b372c8188074a03b601487a763f9a9e6372b3::version::checkVersion(arg5, 1);
        ...
        0x9edc63266f79189c33c3d663a97b372c8188074a03b601487a763f9a9e6372b3::archieve::verUpdateNftPegNonce(v2, arg3);
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x9edc63266f79189c33c3d663a97b372c8188074a03b601487a763f9a9e6372b3::cap_vault::createVault<NftAdminCap>(arg1);
    }
    ...
    public fun setValidator(arg0: &NftAdminCap, arg1: vector<u8>, arg2: &mut NftPegVault, arg3: &0x9edc63266f79189c33c3d663a97b372c8188074a03b601487a763f9a9e6372b3::version::Version) {
        0x9edc63266f79189c33c3d663a97b372c8188074a03b601487a763f9a9e6372b3::version::checkVersion(arg3, 1);
    ...
    public fun withdrawFee(arg0: &NftAdminCap, arg1: &mut NftPegVault, arg2: &0x9edc63266f79189c33c3d663a97b372c8188074a03b601487a763f9a9e6372b3::version::Version, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        0x9edc63266f79189c33c3d663a97b372c8188074a03b601487a763f9a9e6372b3::version::checkVersion(arg2, 1);
        0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.fee, 0x2::balance::value<0x2::sui::SUI>(&arg1.fee)), arg3)
    }

    public fun withdrawNft(arg0: &mut 0x9edc63266f79189c33c3d663a97b372c8188074a03b601487a763f9a9e6372b3::archieve::UserArchieve, arg1: BirdNFT, arg2: &0x9edc63266f79189c33c3d663a97b372c8188074a03b601487a763f9a9e6372b3::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x9edc63266f79189c33c3d663a97b372c8188074a03b601487a763f9a9e6372b3::version::checkVersion(arg2, 1);
        ...
        let v6 = NFTWithdrawn{
            ...
            rare     : v4,
            value    : v5,
            nonce    : 0x9edc63266f79189c33c3d663a97b372c8188074a03b601487a763f9a9e6372b3::archieve::increaseGetNftDepegNonce(arg0),
        };
