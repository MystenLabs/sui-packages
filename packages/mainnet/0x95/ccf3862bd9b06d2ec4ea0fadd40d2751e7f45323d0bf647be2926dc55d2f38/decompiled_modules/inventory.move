module 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::inventory {
    ...
    public fun borrow_warehouse<T0: store + key>(arg0: &Inventory<T0>) : &0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::Warehouse<T0> {
        ...
        if (0x2::dynamic_field::exists_with_type<WarehouseKey, 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::Warehouse<T0>>(&arg0.id, v0)) {
            let v1 = WarehouseKey{dummy_field: false};
            return 0x2::dynamic_field::borrow<WarehouseKey, 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::Warehouse<T0>>(&arg0.id, v1)
        };
        assert_warehouse<T0>(arg0);
        let v2 = WarehouseKey{dummy_field: false};
        0x2::dynamic_object_field::borrow<WarehouseKey, 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::Warehouse<T0>>(&arg0.id, v2)
    }
    ...
    fun borrow_warehouse_mut<T0: store + key>(arg0: &mut Inventory<T0>) : &mut 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::Warehouse<T0> {
        ...
        if (0x2::dynamic_field::exists_with_type<WarehouseKey, 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::Warehouse<T0>>(&arg0.id, v0)) {
            let v1 = WarehouseKey{dummy_field: false};
            return 0x2::dynamic_field::borrow_mut<WarehouseKey, 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::Warehouse<T0>>(&mut arg0.id, v1)
        };
        assert_warehouse<T0>(arg0);
        let v2 = WarehouseKey{dummy_field: false};
        0x2::dynamic_object_field::borrow_mut<WarehouseKey, 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::Warehouse<T0>>(&mut arg0.id, v2)
    }
