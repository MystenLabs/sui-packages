module 0xfab804e980fbb981fad4f62f55027cc3587bdb9b1c7daa438a7751faef0c6375::mtoken {
    ...
    struct UpdateOzPerTokenBaseEvent has copy, drop {
        oz_per_token_base: u64,
        oz_per_token_base_time: u64,
    }
    ...
    public fun cc_receive<T0>(arg0: &mut State<T0>, arg1: &MessengerCap, arg2: vector<u8>, arg3: &0x2::deny_list::DenyList, arg4: &mut 0x2::tx_context::TxContext) : (address, 0x1::option::Option<0x2::coin::Coin<T0>>) {
        ...
        let v0 = 0xfab804e980fbb981fad4f62f55027cc3587bdb9b1c7daa438a7751faef0c6375::message_codec::decode_cc_message(arg2);
        if (0xfab804e980fbb981fad4f62f55027cc3587bdb9b1c7daa438a7751faef0c6375::message_codec::is_mint_budget(&v0)) {
            let v3 = 0xfab804e980fbb981fad4f62f55027cc3587bdb9b1c7daa438a7751faef0c6375::message_codec::extract_mint_budget(v0);
            ...
            assert!(0xfab804e980fbb981fad4f62f55027cc3587bdb9b1c7daa438a7751faef0c6375::message_codec::is_token(&v0), 111);
            let (v5, v6, v7) = 0xfab804e980fbb981fad4f62f55027cc3587bdb9b1c7daa438a7751faef0c6375::message_codec::extract_token_info(v0);
    ...
    public fun msg_of_cc_send_mint_budget(arg0: u64) : vector<u8> {
        0xfab804e980fbb981fad4f62f55027cc3587bdb9b1c7daa438a7751faef0c6375::message_codec::encode_cc_mint_budget_message(arg0)
    }

    public fun msg_of_cc_send_token(arg0: address, arg1: vector<u8>, arg2: u64) : vector<u8> {
        0xfab804e980fbb981fad4f62f55027cc3587bdb9b1c7daa438a7751faef0c6375::message_codec::encode_cc_token_message(arg0, arg1, arg2)
    }
    ...
    entry fun update_oz_per_token_base<T0>(arg0: &mut State<T0>, arg1: u64, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        check_version<T0>(arg0);
        check_owner<T0>(arg0, arg3);
        assert!(arg1 <= 1000000000, 204);
        arg0.oz_per_token_base = arg1;
        arg0.oz_per_token_base_time = arg2;
        let v0 = UpdateOzPerTokenBaseEvent{
            oz_per_token_base      : arg1,
            oz_per_token_base_time : arg2,
        };
        0x2::event::emit<UpdateOzPerTokenBaseEvent>(v0);
    }
