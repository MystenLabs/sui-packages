module 0x95b3f4e9e174974823c230e353799d0ace88f01114b5f55d6f99dcacfc7a30ca::cnsnft5031 {
    struct CNSNFT5031 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5031, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5031>(arg0, arg1);
