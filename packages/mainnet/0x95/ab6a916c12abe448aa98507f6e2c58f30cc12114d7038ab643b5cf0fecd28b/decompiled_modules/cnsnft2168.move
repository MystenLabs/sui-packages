module 0x95ab6a916c12abe448aa98507f6e2c58f30cc12114d7038ab643b5cf0fecd28b::cnsnft2168 {
    struct CNSNFT2168 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2168, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2168>(arg0, arg1);
