module 0x95aa6a3d8ed28841fdb7377ed17a6812a3a604eddf70330d65a23f6cccdfd792::maga {
    ...
    fun init(arg0: MAGA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<MAGA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MAGA    ")))), trim_right(b"MAGA                            "), trim_right(b"MAGA is a meme coin inspired by the famous MAGA memecoin.                                                                                                                                                                                                                                                                       "), v2, arg1);
