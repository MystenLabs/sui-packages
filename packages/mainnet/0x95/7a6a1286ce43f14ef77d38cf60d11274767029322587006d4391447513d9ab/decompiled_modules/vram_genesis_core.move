module 0x957a6a1286ce43f14ef77d38cf60d11274767029322587006d4391447513d9ab::vram_genesis_core {
    struct VRAM_GENESIS_CORE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: VRAM_GENESIS_CORE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<VRAM_GENESIS_CORE>(arg0, arg1);
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreicieskhixlo5oxaohsnri3wylrhszye4rzt4tawfcrr3dft2ko7gi"));
