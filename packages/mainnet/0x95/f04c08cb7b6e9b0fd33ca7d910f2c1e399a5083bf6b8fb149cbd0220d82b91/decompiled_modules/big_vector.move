module 0x95f04c08cb7b6e9b0fd33ca7d910f2c1e399a5083bf6b8fb149cbd0220d82b91::big_vector {
    ...
    fun leaf_insert<T0: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u128, arg3: T0) : (u128, u64) {
        ...
        let v3 = Slice<T0>{
            prev : arg1,
            next : v0.next,
            keys : 0x95f04c08cb7b6e9b0fd33ca7d910f2c1e399a5083bf6b8fb149cbd0220d82b91::utils::pop_until<u128>(&mut v0.keys, v2),
            vals : 0x95f04c08cb7b6e9b0fd33ca7d910f2c1e399a5083bf6b8fb149cbd0220d82b91::utils::pop_until<T0>(&mut v0.vals, v2),
            size : 0,
        };
    ...
    fun node_insert<T0: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u8, arg3: u128, arg4: T0) : (u128, u64) {
        ...
        let v7 = Slice<u64>{
            prev : arg1,
            next : v5.next,
            keys : 0x95f04c08cb7b6e9b0fd33ca7d910f2c1e399a5083bf6b8fb149cbd0220d82b91::utils::pop_until<u128>(&mut v5.keys, v6),
            vals : 0x95f04c08cb7b6e9b0fd33ca7d910f2c1e399a5083bf6b8fb149cbd0220d82b91::utils::pop_until<u64>(&mut v5.vals, v6),
            size : 0,
        };
    ...
    fun slice_redistribute<T0: store, T1: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u128, arg3: u64) : u128 {
        ...
        let (v8, v22) = if (v21) {
            let v23 = 0x95f04c08cb7b6e9b0fd33ca7d910f2c1e399a5083bf6b8fb149cbd0220d82b91::utils::pop_until<T1>(&mut v8, v19);
            0x1::vector::append<T1>(&mut v23, v15);
            (v8, v23)
        } else {
            0x1::vector::append<T1>(&mut v8, v15);
            (v8, 0x95f04c08cb7b6e9b0fd33ca7d910f2c1e399a5083bf6b8fb149cbd0220d82b91::utils::pop_n<T1>(&mut v15, v20))
        };
        let v24 = v22;
        let (v9, v25, v26) = if (v2 && v21) {
            let v27 = 0x95f04c08cb7b6e9b0fd33ca7d910f2c1e399a5083bf6b8fb149cbd0220d82b91::utils::pop_until<u128>(&mut v9, v19);
            0x1::vector::append<u128>(&mut v27, v12);
            (v9, *0x1::vector::borrow<u128>(&v27, 0), v27)
        } else {
            let (v28, v29, v9) = if (v2 && !v21) {
                let v30 = v12;
                let v31 = 0x95f04c08cb7b6e9b0fd33ca7d910f2c1e399a5083bf6b8fb149cbd0220d82b91::utils::pop_n<u128>(&mut v30, v20);
                0x1::vector::append<u128>(&mut v9, v30);
                (*0x1::vector::borrow<u128>(&v31, 0), v31, v9)
            } else {
                let (v9, v32, v33) = if (!v2 && v21) {
                    let v34 = 0x95f04c08cb7b6e9b0fd33ca7d910f2c1e399a5083bf6b8fb149cbd0220d82b91::utils::pop_until<u128>(&mut v9, v19);
                    ...
                    (v9, 0x1::vector::pop_back<u128>(&mut v35), 0x95f04c08cb7b6e9b0fd33ca7d910f2c1e399a5083bf6b8fb149cbd0220d82b91::utils::pop_n<u128>(&mut v35, v20 - 1))
                };
                (v32, v33, v9)
            };
            (v9, v28, v29)
