module 0x95e595a77c2e4e9513ac8c8cd34fb9ded58b4be34718b2da318624e07c0d87da::client {
    ...
    public fun create(arg0: &0x3c549f2ed5cd05b87faafff02e6f7769dd51cc703090df0e962c5a8e1bbc937b::core::AdminCap, arg1: vector<u64>, arg2: vector<vector<u8>>, arg3: u32, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun submit_header(arg0: &mut SwaplockLightClient, arg1: u32, arg2: vector<u8>, arg3: u32, arg4: u64, arg5: vector<u8>, arg6: u64, arg7: vector<u8>) {
        ...
        assert!(0x95e595a77c2e4e9513ac8c8cd34fb9ded58b4be34718b2da318624e07c0d87da::light_client::verify_witness_signature(arg2, arg3, arg4, arg5, arg6, arg7, *0x2::vec_map::get<u64, vector<u8>>(&arg0.witnesses, &arg4)), 2);
        let v0 = HeaderMeta{
            witness     : arg4,
            merkle_root : arg5,
        };
