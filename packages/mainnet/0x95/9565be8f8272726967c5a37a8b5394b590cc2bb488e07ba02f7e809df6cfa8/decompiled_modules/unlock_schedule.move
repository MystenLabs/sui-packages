module 0x959565be8f8272726967c5a37a8b5394b590cc2bb488e07ba02f7e809df6cfa8::unlock_schedule {
    ...
    public(friend) fun add_future_unlock_amount(arg0: &mut VeScaUnlockSchedule, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(arg0.refreshed_at == 0x2::clock::timestamp_ms(arg3) / 1000, 0x959565be8f8272726967c5a37a8b5394b590cc2bb488e07ba02f7e809df6cfa8::error_code::should_refresh_first());
    ...
    fun calculate_lock_history_snapshots(arg0: &VeScaUnlockSchedule, arg1: &0x2::clock::Clock) : vector<LockHistorySnapshot> {
        ...
        while (v2 != v1) {
            v2 = 0x2::math::min(v2 + 0x959565be8f8272726967c5a37a8b5394b590cc2bb488e07ba02f7e809df6cfa8::constants::unlock_round_duration() - v2 % 0x959565be8f8272726967c5a37a8b5394b590cc2bb488e07ba02f7e809df6cfa8::constants::unlock_round_duration(), v1);
    ...
    public(friend) fun extend_lock_period(arg0: &mut VeScaUnlockSchedule, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(arg0.refreshed_at == 0x2::clock::timestamp_ms(arg4) / 1000, 0x959565be8f8272726967c5a37a8b5394b590cc2bb488e07ba02f7e809df6cfa8::error_code::should_refresh_first());
        let v0 = nearest_unlock_amount_mut(arg0, arg2);
        *v0 = *v0 - arg1;
    ...
    public(friend) fun new() : VeScaUnlockSchedule {
        ...
        let v1 = 0;
        while (v1 < 0x959565be8f8272726967c5a37a8b5394b590cc2bb488e07ba02f7e809df6cfa8::constants::max_lock_rounds()) {
    ...
    fun rounds_passed_since_last_refresh(arg0: &VeScaUnlockSchedule, arg1: u64) : u64 {
        arg1 / 0x959565be8f8272726967c5a37a8b5394b590cc2bb488e07ba02f7e809df6cfa8::constants::unlock_round_duration() - arg0.refreshed_at / 0x959565be8f8272726967c5a37a8b5394b590cc2bb488e07ba02f7e809df6cfa8::constants::unlock_round_duration()
    }
