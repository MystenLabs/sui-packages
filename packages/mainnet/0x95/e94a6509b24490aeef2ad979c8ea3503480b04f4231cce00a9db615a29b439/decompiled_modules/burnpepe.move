module 0x95e94a6509b24490aeef2ad979c8ea3503480b04f4231cce00a9db615a29b439::burnpepe {
    ...
    fun init(arg0: BURNPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BURNPEPE>(arg0, 9, b"BURNPEPE", b"Burn Pepe", b"10M $BPEPE Token Airdrop https://t.me/burnpepeSUI", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/8gZC5e1.jpg")), arg1);
        let v2 = v0;
