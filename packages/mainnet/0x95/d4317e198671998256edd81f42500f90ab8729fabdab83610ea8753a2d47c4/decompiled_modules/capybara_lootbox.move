module 0x95d4317e198671998256edd81f42500f90ab8729fabdab83610ea8753a2d47c4::capybara_lootbox {
    ...
    public fun mint_fruit_by_admin(arg0: &0x95d4317e198671998256edd81f42500f90ab8729fabdab83610ea8753a2d47c4::capybara_game_card::AdminCap, arg1: &mut DataStorage, arg2: vector<0x1::string::String>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
    ...
    public fun update_storage(arg0: &0x95d4317e198671998256edd81f42500f90ab8729fabdab83610ea8753a2d47c4::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
