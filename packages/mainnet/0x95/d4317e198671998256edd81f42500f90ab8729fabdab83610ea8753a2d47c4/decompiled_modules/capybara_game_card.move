module 0x95d4317e198671998256edd81f42500f90ab8729fabdab83610ea8753a2d47c4::capybara_game_card {
    ...
    public entry fun checkin(arg0: &mut NFTData, arg1: &mut Treasury, arg2: &mut Registry, arg3: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(1 == 1, 1);
        ...
        if (0x1::option::is_some<u64>(&arg6)) {
            let v2 = *0x1::option::borrow<u64>(&arg6);
    ...
    public entry fun mint(arg0: &mut Registry, arg1: address, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(1 == 1, 1);
        let v0 = 0x2::tx_context::sender(arg6);
        if (arg0.check_signature) {
            assert!(!0x2::table::contains<address, RegistryItem>(&arg0.items, arg1), 3);
            let v1 = serialize_checkin_args(arg2, arg3, arg4);
            assert!(0x2::ecdsa_k1::secp256k1_verify(&arg5, &arg0.pk, &v1, 1), 4);
            let v2 = 0x2::table::borrow_mut<address, RegistryItem>(&mut arg0.items, v0);
            assert!(v2.nonce == arg2, 5);
            v2.nonce = v2.nonce + 1;
        };
        ...
        let v5 = new_nft(arg1, v3, v4, arg6);
        let v6 = 0x2::object::id<NFTData>(&v5);
        let v7 = RegistryItem{
            id    : v6,
            nonce : 0,
        };
        0x2::table::add<address, RegistryItem>(&mut arg0.items, arg1, v7);
        let v8 = MintNFT{
            from   : v0,
            to     : arg1,
            points : v4,
        ...
        0x2::transfer::transfer<NFTData>(v5, arg1);
    }
    ...
    public fun serialize_checkin_args(arg0: u64, arg1: 0x1::option::Option<u64>, arg2: 0x1::option::Option<u64>) : vector<u8> {
