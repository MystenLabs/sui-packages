module 0x9584c0ae8c124ad281bfb329cbb7db25d95884f02f0df464e6b1f89a598b7a8d::swap {
    ...
    public entry fun convert_to_csc(arg0: &mut CasuinoStorage, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg1) * 1000 / 15;
    ...
    public entry fun convert_to_sui(arg0: &mut CasuinoStorage, arg1: 0x2::coin::Coin<0x8cfcd7e02e562c4302cfc1f9ad9e425358fe23b42f948dd430e855227494642a::csc::CSC>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::coin::value<0x8cfcd7e02e562c4302cfc1f9ad9e425358fe23b42f948dd430e855227494642a::csc::CSC>(&arg1) * 15 / 1000;
    ...
    public entry fun transfer_admin(arg0: &CasuinoCap, arg1: CasuinoCap, arg2: address) {
        0x2::transfer::transfer<CasuinoCap>(arg1, arg2);
    }
