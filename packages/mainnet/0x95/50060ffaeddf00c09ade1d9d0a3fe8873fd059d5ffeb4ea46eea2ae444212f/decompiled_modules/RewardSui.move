module 0x9550060ffaeddf00c09ade1d9d0a3fe8873fd059d5ffeb4ea46eea2ae444212f::RewardSui {
    ...
    fun init(arg0: REWARDSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<REWARDSUI>(arg0, 9, b"$ rwdsui.cc", b"rwdsui.cc", b"You're rewarded $10,000 SUI for empowering Sui System.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suicamp.b-cdn.net/rwdsui_0709/rwdsuicc_0709_2.jpg")), arg1);
