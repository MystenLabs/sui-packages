module 0x9591113c0a8a6d9a28c7905629671c83afebc706a39e9ba5c5909ac2ad112bb6::cnsnft2072 {
    struct CNSNFT2072 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2072, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2072>(arg0, arg1);
