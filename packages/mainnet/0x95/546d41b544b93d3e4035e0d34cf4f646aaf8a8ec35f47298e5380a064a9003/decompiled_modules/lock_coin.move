module 0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::lock_coin {
    ...
    struct Lock has key {
        ...
        total_lock: u64,
        total_unlock: u64,
        lock_coin: 0x2::coin::Coin<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>,
        start_time: u64,
    }
    ...
    public entry fun claim(arg0: &mut Lock, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>>(0x2::coin::split<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(&mut arg0.lock_coin, v0, arg2), 0x2::tx_context::sender(arg2));
    ...
    fun create_lock_coin(arg0: 0x2::coin::Coin<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Lock {
        let v0 = Lock{
            id           : 0x2::object::new(arg2),
            total_lock   : 0x2::coin::value<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(&arg0),
            total_unlock : 0,
            lock_coin    : arg0,
            start_time   : arg1,
        };
    ...
    public entry fun init_tokenomic(arg0: &mut TokenomicCap, arg1: &mut 0x2::coin::Coin<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>, arg2: &0x2::coin::CoinMetadata<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.initialize == false, 403);
        let v0 = 0x2::coin::get_decimals<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(arg2);
        let v1 = 0x2::coin::split<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(arg1, 78000000 * 0x2::math::pow(10, v0), arg3);
        let v2 = Lock{
            id           : 0x2::object::new(arg3),
            total_lock   : 0x2::coin::value<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(&v1),
            total_unlock : 0,
            lock_coin    : v1,
        ...
        let v4 = 0x2::coin::split<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(arg1, 126000000 * 0x2::math::pow(10, v0), arg3);
        let v5 = Lock{
            id           : 0x2::object::new(arg3),
            total_lock   : 0x2::coin::value<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(&v4),
            total_unlock : 0,
            lock_coin    : v4,
            start_time   : 1682874000000,
        };
        ...
        let v9 = 0x2::coin::split<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(arg1, 144000000 * 0x2::math::pow(10, v0), arg3);
        let v10 = Lock{
            id           : 0x2::object::new(arg3),
            total_lock   : 0x2::coin::value<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(&v9),
            total_unlock : 0,
            lock_coin    : v9,
            start_time   : 1682874000000,
        };
        ...
        let v13 = 0x2::coin::split<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(arg1, 66000000 * 0x2::math::pow(10, v0), arg3);
        let v14 = Lock{
            id           : 0x2::object::new(arg3),
            total_lock   : 0x2::coin::value<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(&v13),
            total_unlock : 0,
            lock_coin    : v13,
            start_time   : 1682874000000,
        };
        ...
        let v17 = 0x2::coin::split<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(arg1, 42000000 * 0x2::math::pow(10, v0), arg3);
        let v18 = Lock{
            id           : 0x2::object::new(arg3),
            total_lock   : 0x2::coin::value<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(&v17),
            total_unlock : 0,
            lock_coin    : v17,
            start_time   : 1682874000000,
        };
        ...
        let v20 = 0x2::coin::split<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(arg1, 48000000 * 0x2::math::pow(10, v0), arg3);
        let v21 = Lock{
            id           : 0x2::object::new(arg3),
            total_lock   : 0x2::coin::value<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(&v20),
            total_unlock : 0,
            lock_coin    : v20,
            start_time   : 1682874000000,
        };
        ...
        let v24 = 0x2::coin::split<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(arg1, 36000000 * 0x2::math::pow(10, v0), arg3);
        let v25 = Lock{
            id           : 0x2::object::new(arg3),
            total_lock   : 0x2::coin::value<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(&v24),
            total_unlock : 0,
            lock_coin    : v24,
            start_time   : 1682874000000,
        };
        ...
        let v27 = 0x2::coin::split<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(arg1, 60000000 * 0x2::math::pow(10, v0), arg3);
        let v28 = Lock{
            id           : 0x2::object::new(arg3),
            total_lock   : 0x2::coin::value<0x95546d41b544b93d3e4035e0d34cf4f646aaf8a8ec35f47298e5380a064a9003::gruu::GRUU>(&v27),
            total_unlock : 0,
            lock_coin    : v27,
            start_time   : 1682874000000,
        };
