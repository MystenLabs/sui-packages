module 0x28769bd9787bc855835a8caaf1a82d4ddfdff97b2ecb32cfe96b6d8d7480ec0a::reward9499 {
    struct REWARD9499 has drop {
        dummy_field: bool,
    }

    struct TICKET_9499 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9499(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9499>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9499>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9499, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9499>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9499>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9499>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9499>>(v5, 0x2::tx_context::sender(arg1));
    }
