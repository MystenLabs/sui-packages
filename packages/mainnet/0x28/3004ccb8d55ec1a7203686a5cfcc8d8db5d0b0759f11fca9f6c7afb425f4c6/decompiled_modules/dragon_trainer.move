module 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer {
    ...
    fun add_capabilities_based_on_gene(arg0: &BeesManager, arg1: &mut MysticalBee) {
        ...
        let v1 = 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::beescience::decode_dominant_power_traits(arg1.genes);
    ...
    fun evolve_bee_powers(arg0: &BeesManager, arg1: &mut MysticalBee, arg2: &mut 0x2::random::RandomGenerator, arg3: u64, arg4: u64, arg5: u64) {
        let v0 = 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::beescience::decode_dominant_power_traits(arg1.genes);
    ...
    fun evolved_gene_generator(arg0: &mut 0x2::random::RandomGenerator, arg1: u256) : u256 {
        ...
        0x1::vector::push_back<u256>(&mut v0, (0x2::random::generate_u128_in_range(arg0, 340282, 340384634633755) as u256) << 128 | (0x2::random::generate_u128_in_range(arg0, 340282, 340282366920938463463) as u256));
        0x1::vector::push_back<u256>(&mut v0, (0x2::random::generate_u128_in_range(arg0, 340282, 340384634633755) as u256) << 128 | (0x2::random::generate_u128_in_range(arg0, 340282, 340282366920938463463) as u256));
        0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::beescience::evolve_bee(arg1, v0)
    }
    ...
    public fun get_bee_family(arg0: &MysticalBee) : u64 {
        (0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::beescience::get_family_type(arg0.genes) as u64)
    }
    ...
    public fun get_prices_for_dragonbee_eggs(arg0: &0x2::clock::Clock, arg1: &mut BeesManager, arg2: address, arg3: u64) : (u64, vector<u64>, u64) {
        ...
        while (v9 < arg3) {
            let v10 = if (v7 > 0) {
                ...
                0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::beescience::compute_gene_price(v1.base_price, v1.curve_a, v6)
            };
            v6 = v6 + 1;
    ...
    fun internal_make_bee_queen(arg0: &mut BeesManager, arg1: &mut MysticalBee, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = (0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::beescience::get_family_type(arg1.genes) as u64);
    ...
    fun lay_dragon_egg(arg0: u64, arg1: u64, arg2: u64, arg3: address, arg4: u64, arg5: 0x1::option::Option<address>, arg6: 0x1::option::Option<address>, arg7: u256, arg8: 0x2::linked_table::LinkedTable<u64, 0x1::string::String>, arg9: address, arg10: &mut BeesManager, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) : MysticalBee {
        ...
        let v3 = NectarStore{
            evolution_stage       : 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::beescience::get_evolution_stage(arg7),
            lockup_weeks          : 0,
            hive_locked           : 0x2::balance::zero<0x76edbed77a22cdae87fe5a92a8d9fec34f1ea4c9005976ffce5ca89f43297bac::hive::HIVE>(),
    ...
    fun lay_genesis_dragonbee_egg(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut 0x76edbed77a22cdae87fe5a92a8d9fec34f1ea4c9005976ffce5ca89f43297bac::yield_flow::FeeCollector<0x2::sui::SUI>, arg3: &mut BeesManager, arg4: &mut YieldFarm, arg5: &mut DragonTrainer, arg6: 0x2::balance::Balance<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        *v4 = *v4 + v2;
        ...
        if (v5 == 0) {
            v5 = 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::beescience::compute_gene_price(v3.base_price, v3.curve_a, v3.eggs_laid);
        };
    ...
    fun lock_honey_with_bee(arg0: &mut YieldFarm, arg1: &mut MysticalBee, arg2: 0x2::balance::Balance<0x76edbed77a22cdae87fe5a92a8d9fec34f1ea4c9005976ffce5ca89f43297bac::honey::HONEY>) {
        ...
        let v0 = (0x76edbed77a22cdae87fe5a92a8d9fec34f1ea4c9005976ffce5ca89f43297bac::math::mul_div_u256((0x2::balance::value<0x76edbed77a22cdae87fe5a92a8d9fec34f1ea4c9005976ffce5ca89f43297bac::honey::HONEY>(&arg1.nectar.honey_locked) as u256), (get_evolution_multiplier(0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::beescience::get_evolution_stage(arg1.genes)) as u256), (1000000 as u256)) as u128);
    ...
    public fun validate_if_can_beed(arg0: &0x2::clock::Clock, arg1: &BeesManager, arg2: address, arg3: u64, arg4: u64, arg5: &MysticalBee) : (bool, u64, u64) {
        if ((0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::beescience::get_family_type(arg5.genes) as u64) != arg4) {
            return (false, 0, 0)
        };
        ...
        let v2 = if (0x2::linked_table::contains<u64, u64>(&v0.friends_list, arg5.version)) {
            *0x2::linked_table::borrow<u64, u64>(&v0.friends_list, arg5.version)
            ...
            0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::beescience::compute_gene_price(v0.base_price, v0.curve_a, v0.eggs_incubated)
        };
