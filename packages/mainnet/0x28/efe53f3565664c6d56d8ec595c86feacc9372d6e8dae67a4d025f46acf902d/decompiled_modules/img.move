module 0x28efe53f3565664c6d56d8ec595c86feacc9372d6e8dae67a4d025f46acf902d::img {
    struct IMG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: IMG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v2;
        0x2::coin::mint_and_transfer<IMG>(&mut v4, 100000000000, 0x2::tx_context::sender(arg1), arg1);
