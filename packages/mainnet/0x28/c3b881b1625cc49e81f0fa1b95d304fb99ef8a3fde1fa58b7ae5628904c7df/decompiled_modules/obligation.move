module 0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation {
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : (Obligation, ObligationKey) {
        let v0 = Obligation{
            ...
            debts                      : 0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_debts::new(arg0),
            collaterals                : 0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_collaterals::new(arg0),
            rewards_point              : 0,
    ...
    public(friend) fun accrue_interests_and_rewards(arg0: &mut Obligation, arg1: &0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::market::Market) {
        ...
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&v0)) {
            ...
            arg0.rewards_point = arg0.rewards_point + 0x1::fixed_point32::multiply_u64(0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_debts::accrue_interest(&mut arg0.debts, v2, 0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::market::borrow_index(arg1, v2)), 0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::incentive_rewards::reward_factor(0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::market::reward_factor(arg1, v2)));
            v1 = v1 + 1;
        };
    }
    ...
    public fun collateral(arg0: &Obligation, arg1: 0x1::type_name::TypeName) : u64 {
        0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_collaterals::collateral(&arg0.collaterals, arg1)
    }
    ...
    public fun debt(arg0: &Obligation, arg1: 0x1::type_name::TypeName) : (u64, u64) {
        0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_debts::debt(&arg0.debts, arg1)
    }
    ...
    public(friend) fun decrease_debt(arg0: &mut Obligation, arg1: 0x1::type_name::TypeName, arg2: u64) {
        0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_debts::decrease(&mut arg0.debts, arg1, arg2);
    }

    public(friend) fun deposit_collateral<T0>(arg0: &mut Obligation, arg1: 0x2::balance::Balance<T0>) {
        0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_collaterals::increase(&mut arg0.collaterals, 0x1::type_name::get<T0>(), 0x2::balance::value<T0>(&arg1));
    ...
    public fun has_coin_x_as_collateral(arg0: &Obligation, arg1: 0x1::type_name::TypeName) : bool {
        0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_collaterals::has_coin_x_as_collateral(&arg0.collaterals, arg1)
    }

    public fun has_coin_x_as_debt(arg0: &Obligation, arg1: 0x1::type_name::TypeName) : bool {
        0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_debts::has_coin_x_as_debt(&arg0.debts, arg1)
    }

    public(friend) fun increase_debt(arg0: &mut Obligation, arg1: 0x1::type_name::TypeName, arg2: u64) {
        0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_debts::increase(&mut arg0.debts, arg1, arg2);
    }

    public(friend) fun init_debt(arg0: &mut Obligation, arg1: &0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::market::Market, arg2: 0x1::type_name::TypeName) {
        0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_debts::init_debt(&mut arg0.debts, arg2, 0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::market::borrow_index(arg1, arg2));
    }
    ...
    public fun lock<T0: drop>(arg0: &mut Obligation, arg1: &ObligationKey, arg2: &0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_access::ObligationAccessStore, arg3: bool, arg4: bool, arg5: bool, arg6: bool, arg7: bool, arg8: T0) {
    ...
    public fun redeem_rewards_point<T0: drop>(arg0: &mut Obligation, arg1: &ObligationKey, arg2: &0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_access::ObligationAccessStore, arg3: T0, arg4: u64) {
        assert_key_match(arg0, arg1);
        0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_access::assert_reward_key_in_store<T0>(arg2, arg3);
    ...
    public(friend) fun set_lock<T0: drop>(arg0: &mut Obligation, arg1: &0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_access::ObligationAccessStore, arg2: bool, arg3: bool, arg4: bool, arg5: bool, arg6: bool, arg7: T0) {
        assert!(0x1::option::is_none<0x1::type_name::TypeName>(&arg0.lock_key), 0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::error::obligation_already_locked());
        0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_access::assert_lock_key_in_store<T0>(arg1, arg7);
    ...
    public(friend) fun set_unlock<T0: drop>(arg0: &mut Obligation, arg1: T0) {
        assert!(*0x1::option::borrow<0x1::type_name::TypeName>(&arg0.lock_key) == 0x1::type_name::get<T0>(), 0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::error::obligation_unlock_with_wrong_key());
    ...
    public(friend) fun withdraw_collateral<T0>(arg0: &mut Obligation, arg1: u64) : 0x2::balance::Balance<T0> {
        0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::obligation_collaterals::decrease(&mut arg0.collaterals, 0x1::type_name::get<T0>(), arg1);
