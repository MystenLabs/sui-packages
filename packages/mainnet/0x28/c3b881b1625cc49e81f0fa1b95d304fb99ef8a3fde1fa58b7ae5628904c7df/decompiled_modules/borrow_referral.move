module 0x87ddec2984645dbbe2403a509cc6edf393a43acdba9b77d45da2bcbefcf733c1::borrow_referral {
    ...
    public fun set_borrowed<T0, T1: drop>(arg0: &mut BorrowReferral<T0, T1>, arg1: u64) {
        arg0.borrowed = arg1;
    }
