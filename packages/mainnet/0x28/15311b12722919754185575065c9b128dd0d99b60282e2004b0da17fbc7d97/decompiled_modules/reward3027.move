module 0x2815311b12722919754185575065c9b128dd0d99b60282e2004b0da17fbc7d97::reward3027 {
    struct REWARD3027 has drop {
        dummy_field: bool,
    }

    struct TICKET_3027 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3027(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3027>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3027>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3027, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3027>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3027>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3027>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3027>>(v5, 0x2::tx_context::sender(arg1));
    }
