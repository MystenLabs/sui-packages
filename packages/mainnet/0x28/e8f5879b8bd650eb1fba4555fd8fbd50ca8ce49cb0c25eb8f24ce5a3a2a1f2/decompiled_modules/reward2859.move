module 0x28e8f5879b8bd650eb1fba4555fd8fbd50ca8ce49cb0c25eb8f24ce5a3a2a1f2::reward2859 {
    struct REWARD2859 has drop {
        dummy_field: bool,
    }

    struct TICKET_2859 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2859(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2859>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2859>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2859, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2859>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2859>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2859>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2859>>(v5, 0x2::tx_context::sender(arg1));
    }
