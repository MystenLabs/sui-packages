module 0x4a9dd2c87bffe9779233053a70e46def51e4bf12b4b805ba80a16af1ed679765::nature_stories_se {
    struct NATURE_STORIES_SE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NATURE_STORIES_SE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NATURE_STORIES_SE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Nature Stories SE"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeie76fsqddn7tag2js4ckcvjadeopiwianjjdhu4wychq42xgzt4ka"));
