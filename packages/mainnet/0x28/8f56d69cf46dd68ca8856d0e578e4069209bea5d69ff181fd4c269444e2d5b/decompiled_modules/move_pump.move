module 0xc45cd4efcd2963bdee861ddef337f2eba4e3815ec425ae216f8bf0bd21e81ee9::move_pump {
    ...
    public entry fun buy<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg3 > 0, 2);
        let v3 = v2.virtual_token_reserves - 0x2::coin::value<T0>(&v2.remain_token_reserves);
        let v4 = 0x2::math::min(arg3, v3);
        let v5 = 0xc45cd4efcd2963bdee861ddef337f2eba4e3815ec425ae216f8bf0bd21e81ee9::curves::calculate_add_liquidity_cost(v2.virtual_sui_reserves, v2.virtual_token_reserves, v4) + 1;
        ...
        assert!(v7 >= v5 + v6, 6);
        let v8 = 0x2::coin::split<0x2::sui::SUI>(&mut arg1, v6, arg5);
        let v9 = 0x2::coin::zero<T0>(arg5);
        let (v10, v11) = swap<T0>(v2, v9, arg1, v4, v7 - v5 - v6, arg5);
        ...
        if (v3 == v4) {
            transfer_pool<T0>(v2, arg2, v12, arg0.graduated_fee, arg4, arg5);
        };
        let v13 = TradedEvent{
            is_buy                 : true,
            user                   : v0,
    ...
    public entry fun sell<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v3 > 0, 2);
        let v4 = 0xc45cd4efcd2963bdee861ddef337f2eba4e3815ec425ae216f8bf0bd21e81ee9::curves::calculate_remove_liquidity_return(v2.virtual_token_reserves, v2.virtual_sui_reserves, v3);
        let v5 = 0xc45cd4efcd2963bdee861ddef337f2eba4e3815ec425ae216f8bf0bd21e81ee9::utils::as_u64(0xc45cd4efcd2963bdee861ddef337f2eba4e3815ec425ae216f8bf0bd21e81ee9::utils::div(0xc45cd4efcd2963bdee861ddef337f2eba4e3815ec425ae216f8bf0bd21e81ee9::utils::mul(0xc45cd4efcd2963bdee861ddef337f2eba4e3815ec425ae216f8bf0bd21e81ee9::utils::from_u64(v4), 0xc45cd4efcd2963bdee861ddef337f2eba4e3815ec425ae216f8bf0bd21e81ee9::utils::from_u64(arg0.platform_fee)), 0xc45cd4efcd2963bdee861ddef337f2eba4e3815ec425ae216f8bf0bd21e81ee9::utils::from_u64(10000)));
        assert!(v4 - v5 >= arg2, 2);
