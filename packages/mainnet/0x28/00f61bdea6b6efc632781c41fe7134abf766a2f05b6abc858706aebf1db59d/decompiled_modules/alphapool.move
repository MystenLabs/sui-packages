module 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::alphapool {
    ...
    fun assert_receipt<T0>(arg0: &Receipt, arg1: &Pool<T0>) {
        assert!(arg0.pool_id == 0x2::object::uid_to_inner(&arg1.id), 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::error::invalid_receipt_error());
    }

    public fun create<T0>(arg0: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::AdminCap, arg1: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::Version, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun deposit<T0>(arg0: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::Version, arg1: 0x1::option::Option<Receipt>, arg2: &mut Pool<T0>, arg3: &mut 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::Distributor, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : Receipt {
        0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::assert_current_version(arg0);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v1, 0x2::balance::value<T0>(&v1) * arg2.deposit_fee / 10000), arg6), 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::get_fee_wallet_address(arg3));
        let v2 = 0x2::balance::value<T0>(&v1);
        arg2.tokensInvested = arg2.tokensInvested + v2;
        0x2::balance::join<T0>(&mut arg2.alpha_bal, v1);
        let v3 = (v2 as u256) * (1000000000 as u256) / exchange_rate<T0>(arg2);
        ...
        let v6 = if (0x1::option::is_some<Receipt>(&arg1) == true) {
            ...
            let v9 = &mut v7;
            unlock_locked_balance_for_user<T0>(arg2, v9, arg5);
            if (0x2::linked_table::contains<u64, u64>(&v7.locked_balance, v5) == true) {
                ...
                *v10 = *v10 + v4;
                ...
                let v11 = &mut v7;
                insert_to_locked_balance(v11, v5, v4, arg6);
            };
            v7
        } else {
            ...
            let v17 = 0x2::linked_table::new<u64, u64>(arg6);
            0x2::linked_table::push_back<u64, u64>(&mut v17, v5, v4);
            Receipt{id: 0x2::object::new(arg6), name: 0x1::string::utf8(arg2.name), image_url: 0x1::string::utf8(arg2.image_url), pool_id: 0x2::object::uid_to_inner(&arg2.id), xTokenBalance: (v3 as u64), last_acc_reward_per_xtoken: v12, locked_balance: v17, balance: 0, pending_rewards: 0x2::vec_map::empty<0x1::type_name::TypeName, u64>()}
        };
        0x1::option::destroy_none<Receipt>(arg1);
        v6
    }

    fun destroy_receipt_and_transfer_rewards<T0>(arg0: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::Version, arg1: Receipt, arg2: &mut Pool<T0>, arg3: &mut 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::Distributor, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::assert_current_version(arg0);
        assert!(arg1.xTokenBalance == 0, 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::error::receipt_not_empty());
        let v0 = &mut arg1;
    ...
    public fun get_pool_rewards_all<T0>(arg0: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::Version, arg1: &mut Pool<T0>, arg2: &mut 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::assert_current_version(arg0);
        get_rewards<T0, 0x683cf59e036ebcb8cf98c712532726b4aa6801eb33168f860fc08b373a5c7f82::beta::BETA>(arg1, arg2, arg3, arg4);
        get_rewards<T0, 0x2::sui::SUI>(arg1, arg2, arg3, arg4);
    }

    fun get_rewards<T0, T1>(arg0: &mut Pool<T0>, arg1: &mut 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::Distributor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 == 0x1::type_name::get<0x683cf59e036ebcb8cf98c712532726b4aa6801eb33168f860fc08b373a5c7f82::beta::BETA>()) {
            0x2::balance::join<T0>(&mut arg0.alpha_bal, 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::get_rewards<T0>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3));
        } else {
            let v1 = 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::get_rewards<T1>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3);
    ...
    fun get_user_rewards<T0, T1>(arg0: &mut Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
    ...
    public fun get_user_rewards_all<T0>(arg0: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::Version, arg1: &mut Receipt, arg2: &mut Pool<T0>, arg3: &mut 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::Distributor, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::assert_current_version(arg0);
    ...
    entry fun set_deposit_fee<T0>(arg0: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::AdminCap, arg1: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::Version, arg2: &mut Pool<T0>, arg3: u64) {
        0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::assert_current_version(arg1);
        assert!(arg3 <= arg2.deposit_fee_max_cap, 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::error::fee_too_high_error());
        arg2.deposit_fee = arg3;
    }

    entry fun set_instant_withdraw_fee<T0>(arg0: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::AdminCap, arg1: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::Version, arg2: &mut Pool<T0>, arg3: u64) {
        0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::assert_current_version(arg1);
        assert!(arg3 <= arg2.instant_withdraw_fee_max_cap, 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::error::fee_too_high_error());
        arg2.instant_withdraw_fee = arg3;
    }

    entry fun set_lock_period<T0>(arg0: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::AdminCap, arg1: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::Version, arg2: &mut Pool<T0>, arg3: u64) {
        0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::assert_current_version(arg1);
        arg2.locked_period_in_days = arg3;
    }

    entry fun set_withdrawal_fee<T0>(arg0: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::AdminCap, arg1: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::Version, arg2: &mut Pool<T0>, arg3: u64) {
        0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::assert_current_version(arg1);
        assert!(arg3 <= arg2.withdraw_fee_max_cap, 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::error::fee_too_high_error());
    ...
    public fun user_deposit<T0>(arg0: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::Version, arg1: 0x1::option::Option<Receipt>, arg2: &mut Pool<T0>, arg3: &mut 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::Distributor, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::assert_current_version(arg0);
        let v0 = deposit<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        0x2::transfer::public_transfer<Receipt>(v0, 0x2::tx_context::sender(arg6));
    }

    public fun user_withdraw<T0>(arg0: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::Version, arg1: Receipt, arg2: &mut Pool<T0>, arg3: &mut 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::Distributor, arg4: u64, arg5: &0x2::clock::Clock, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::assert_current_version(arg0);
    ...
    public fun withdraw<T0>(arg0: &0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::Version, arg1: Receipt, arg2: &mut Pool<T0>, arg3: &mut 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::Distributor, arg4: u64, arg5: &0x2::clock::Clock, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<Receipt> {
        0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::version::assert_current_version(arg0);
        ...
        if (arg6 == true) {
            assert!(arg4 <= (((arg1.xTokenBalance as u256) * v1 / (1000000000 as u256)) as u64), 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::error::insufficient_balance_error());
        } else {
            assert!(arg4 <= (arg1.balance as u64), 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::error::insufficient_balance_error());
        };
        ...
        if (arg4 > (arg1.balance as u64)) {
            let v6 = 0x2::math::min((arg4 - (arg1.balance as u64)) * 10000 / (10000 - v4), (((arg1.xTokenBalance as u256) * v1 / (1000000000 as u256) - arg1.balance) as u64));
            arg4 = (arg1.balance as u64) + v6;
            let v7 = &mut arg1;
            unlock_xtokens_from_locked(v7, (((v6 as u256) * (1000000000 as u256) / v1) as u64));
            arg1.balance = 0;
            v5 = v6 * arg2.instant_withdraw_fee / 10000;
        } else {
            arg1.balance = arg1.balance - (arg4 as u256);
        };
        let v8 = (((arg4 as u256) * (1000000000 as u256) / v1) as u64);
        ...
        let v9 = (arg4 - v5) * arg2.withdrawal_fee / 10000 + v5;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg2.alpha_bal, v9), arg7), 0x2800f61bdea6b6efc632781c41fe7134abf766a2f05b6abc858706aebf1db59d::distributor::get_fee_wallet_address(arg3));
