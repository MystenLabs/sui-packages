module 0x283b47b9ade30b7dde2fde04d7a91c5ce05b7dd84a16b92cbb0867200ff86176::cnsnft9803 {
    struct CNSNFT9803 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9803, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9803>(arg0, arg1);
