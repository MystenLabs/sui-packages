module 0x28808dd702d20997f8fc0c7d8d40ec21d779a4252957432bf307a1f6bb11e897::mycoin {
    ...
    struct Global has store, key {
        id: 0x2::object::UID,
        admin_list: 0x2::table::Table<address, bool>,
        fee_rate: u8,
        fee_wallet: address,
    ...
    public entry fun add_admin(arg0: &mut Global, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<address, bool>(&arg0.admin_list, 0x2::tx_context::sender(arg2)), 100);
        0x2::table::add<address, bool>(&mut arg0.admin_list, arg1, true);
    }
    ...
    fun init(arg0: MYCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<MYCOIN>>(0x2::coin::mint<MYCOIN>(&mut v3, 3000000000000, arg1), v0);
        let v4 = 0x2::table::new<address, bool>(arg1);
        0x2::table::add<address, bool>(&mut v4, v0, true);
        let v5 = Global{
    ...
    public entry fun remove_admin(arg0: &mut Global, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<address, bool>(&arg0.admin_list, 0x2::tx_context::sender(arg2)), 100);
        assert!(0x2::table::contains<address, bool>(&arg0.admin_list, arg1), 101);
        0x2::table::remove<address, bool>(&mut arg0.admin_list, arg1);
    }
    ...
    public entry fun update_fee_percentage(arg0: &mut Global, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<address, bool>(&arg0.admin_list, 0x2::tx_context::sender(arg2)), 100);
        arg0.fee_rate = arg1;
    }
