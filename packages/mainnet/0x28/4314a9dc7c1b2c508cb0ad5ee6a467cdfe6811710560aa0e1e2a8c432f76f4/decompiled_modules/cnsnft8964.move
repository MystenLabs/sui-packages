module 0x284314a9dc7c1b2c508cb0ad5ee6a467cdfe6811710560aa0e1e2a8c432f76f4::cnsnft8964 {
    struct CNSNFT8964 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8964, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8964>(arg0, arg1);
