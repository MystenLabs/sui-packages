module 0x28e9caddc341af40747ed4aeec0e44b27ff78b8b875c86080126c2304a01edfc::cnsnft3955 {
    struct CNSNFT3955 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3955, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3955>(arg0, arg1);
