module 0x283ec22de8e5a2c998f71e818a1583d76791bcb64a7bc42eecd22ee99eb6b3e2::foundry {
    ...
    struct RigMinted has copy, drop {
        buyer: address,
        rig_id: 0x2::object::ID,
        drill: u8,
        capacity: u8,
        armour: u8,
        serial: u64,
    ...
    public fun admin_mint(arg0: &AdminCap, arg1: &mut Config, arg2: u8, arg3: u8, arg4: u8, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x283ec22de8e5a2c998f71e818a1583d76791bcb64a7bc42eecd22ee99eb6b3e2::rig::Rig>(build(arg1, arg2, arg3, arg4, arg1.minted, arg6), arg5);
    }

    fun build(arg0: &Config, arg1: u8, arg2: u8, arg3: u8, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x283ec22de8e5a2c998f71e818a1583d76791bcb64a7bc42eecd22ee99eb6b3e2::rig::Rig {
        let v0 = 0x1::string::utf8(b"Rig #");
        0x1::string::append(&mut v0, 0x1::u64::to_string(arg4));
        let v1 = arg0.media_base;
        0x1::string::append(&mut v1, 0x1::string::utf8(b"mining-rig.png"));
        ...
        0x283ec22de8e5a2c998f71e818a1583d76791bcb64a7bc42eecd22ee99eb6b3e2::rig::mint(arg1, arg2, arg3, arg4, v0, 0x1::string::utf8(b"It drills the bones of the old world. Unarmed, slow, and worth every convoy sent to guard it."), v1, v2, arg5)
    }
    ...
    entry fun mint<T0>(arg0: &mut Config, arg1: &0x2::random::Random, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x283ec22de8e5a2c998f71e818a1583d76791bcb64a7bc42eecd22ee99eb6b3e2::rig::Rig>(v11, v0);
        let v12 = RigMinted{
            buyer    : v0,
            rig_id   : 0x2::object::id<0x283ec22de8e5a2c998f71e818a1583d76791bcb64a7bc42eecd22ee99eb6b3e2::rig::Rig>(&v11),
            drill    : v7,
            capacity : v8,
            armour   : v9,
            serial   : v10,
