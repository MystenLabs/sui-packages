module 0x2846f93d9d2f52df606fdebbd349a81deb9f32d9528a50e0b617a7bbad6c3df5::cnsnft3252 {
    struct CNSNFT3252 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3252, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3252>(arg0, arg1);
