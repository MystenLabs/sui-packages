module 0x28695f910692c6036ad8a9560e0353ac96ebc75836c5b14f09a088589a8f9190::reward7593 {
    struct REWARD7593 has drop {
        dummy_field: bool,
    }

    struct TICKET_7593 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7593(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7593>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7593>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7593, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7593>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7593>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7593>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7593>>(v5, 0x2::tx_context::sender(arg1));
    }
