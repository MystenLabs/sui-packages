module 0x28cc8722d2d5b08d69860a17907ded65a450b102b250d1c73cd7083e26b7dbf5::m {
    ...
    fun opt<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: bool, arg2: u128, arg3: u128, arg4: u64, arg5: u64, arg6: u8, arg7: u8, arg8: u64, arg9: bool) : u64 {
        assert!(arg4 > 0, 13906835265265270788);
        assert!(arg4 <= arg5, 13906835269560369158);
        assert!(arg8 < arg4, 13906835273855467528);
        let v0 = 0;
        let v1 = 0;
        let v2 = arg4;
        let v3 = 0;
    ...
    fun tt<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &mut 0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg4: &0x2::clock::Clock, arg5: u128, arg6: bool, arg7: u64, arg8: u64, arg9: u8, arg10: u8, arg11: u64, arg12: bool, arg13: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let (v6, v7, v8) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::flash_swap<T0, T1, T2>(arg0, 0x2::tx_context::sender(arg13), v4, (v3 as u128), true, v5, arg4, arg3, arg13);
        let v9 = v8;
        let v10 = v7;
        let v11 = v6;
        let (_, _, v14) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_flash_swap_receipt_info<T0, T1>(&v9);
        let (v15, v16) = if (v4) {
            (v14, 0)
        } else {
            (0, v14)
        ...
        let v19 = if (arg6) {
            (((v17 as u128) * 1000000000000 / v2) as u64)
        } else {
            (((v17 as u128) * v2 / 1000000000000) as u64)
        };
        assert!(v18 >= v19, 13906836102783762434);
        let (v20, v21) = if (v4) {
            (0x2::coin::zero<T1>(arg13), 0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::wd<T0>(arg1, arg2, v15, arg13))
        } else {
            (0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::wd<T1>(arg1, arg2, v16, arg13), 0x2::coin::zero<T0>(arg13))
        };
        let v22 = v20;
        let v23 = v21;
        let (v24, v25) = if (v4) {
            (0x2::coin::split<T0>(&mut v23, v15, arg13), 0x2::coin::zero<T1>(arg13))
        } else {
            (0x2::coin::zero<T0>(arg13), 0x2::coin::split<T1>(&mut v22, v16, arg13))
        };
        0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::repay_flash_swap<T0, T1, T2>(arg0, v24, v25, v9, arg3);
        0x2::coin::join<T0>(&mut v23, v11);
        0x2::coin::join<T1>(&mut v22, v10);
    ...
    public fun ttb<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &mut 0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg4: &0x2::clock::Clock, arg5: vector<u128>, arg6: vector<u64>, arg7: vector<u64>, arg8: u64, arg9: vector<u128>, arg10: vector<u64>, arg11: vector<u64>, arg12: u64, arg13: u8, arg14: u8, arg15: bool, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < 0x1::vector::length<u128>(&arg5)) {
            ...
            let (v7, v8) = tt<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, *0x1::vector::borrow<u128>(&arg5, v4), true, arg8, v6, arg13, arg14, *0x1::vector::borrow<u64>(&arg7, v4), arg15, arg16);
            if (v7 == 0 || v8 == 0) {
                break
            };
            v1 = v1 - v7;
        ...
        while (v4 < 0x1::vector::length<u128>(&arg9)) {
            ...
            let (v11, v12) = tt<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, *0x1::vector::borrow<u128>(&arg9, v4), false, arg12, v10, arg13, arg14, *0x1::vector::borrow<u64>(&arg11, v4), arg15, arg16);
            if (v11 == 0 || v12 == 0) {
                break
            };
            v3 = v3 - v11;
