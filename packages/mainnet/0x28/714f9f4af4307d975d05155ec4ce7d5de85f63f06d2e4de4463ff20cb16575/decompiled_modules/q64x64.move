module 0x28714f9f4af4307d975d05155ec4ce7d5de85f63f06d2e4de4463ff20cb16575::q64x64 {
    ...
    public fun liquidity_from_amounts(arg0: u64, arg1: u64, arg2: u128) : u128 {
        ((arg0 as u128) * arg2 >> 64) + (arg1 as u128)
    }
    ...
    public fun log2(arg0: u128) : u128 {
        ...
        let v3 = 0x28714f9f4af4307d975d05155ec4ce7d5de85f63f06d2e4de4463ff20cb16575::bit_math::most_significant_bit_u128(v1);
        let v4 = 64;
        let v5 = if (v3 >= v4) {
    ...
    public fun sqrt(arg0: u128) : u128 {
        ...
        let v0 = 0x28714f9f4af4307d975d05155ec4ce7d5de85f63f06d2e4de4463ff20cb16575::bit_math::most_significant_bit_u128(arg0);
        let v1 = if (v0 >= 64) {
            1 << (v0 + 64) / 2
        } else {
            1 << (v0 + 64) / 2
    ...
    public fun x_from_y_price(arg0: u64, arg1: u128) : u64 {
        ...
        let v0 = (arg0 as u128) << 64;
        let v1 = 0x1::string::utf8(b"X_FROM_Y_PRICE:");
