module 0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::vault {
    ...
    struct Vault has store, key {
        ...
        ctoken: 0x2::table::Table<u64, 0x2::object::ID>,
        obligation_cap: 0x2::table::Table<u64, 0x2::object::ID>,
    }
    ...
    public fun accrue_performance_fee_with_adapter<T0>(arg0: &mut Vault, arg1: u64, arg2: u64, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::suilend_adapter::get_suilend_reserve<T0, 0x2::sui::SUI>(arg3);
        let v0 = 0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::suilend_adapter::get_suilend_fee_receiver<T0>(arg3);
    ...
    public entry fun admin_claim_and_compound_reward<T0>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::suilend_adapter::get_suilend_reserve<T0, 0x2::sui::SUI>(arg1);
        0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::suilend_adapter::get_suilend_fee_receiver<T0>(arg1);
        let v0 = 0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::suilend_adapter::claim_rewards_from_suilend<T0, 0x2::sui::SUI>(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    ...
    public entry fun admin_claim_reward<T0, T1>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg7) == arg0.admin, 1001);
        0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::suilend_adapter::get_suilend_reserve<T0, T1>(arg1);
        let v0 = 0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::suilend_adapter::claim_rewards_from_suilend<T0, T1>(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
        let v1 = 0x2::coin::value<T1>(&v0);
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v0, 0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::suilend_adapter::get_suilend_fee_receiver<T0>(arg1));
    ...
    public entry fun borrow_from_vault<T0, T1>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: u64, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>, arg4: &0x2::clock::Clock, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::suilend_adapter::borrow_from_suilend<T0, T1>(arg1, arg2, arg3, arg4, arg5, arg6), 0x2::tx_context::sender(arg6));
        let v0 = BorrowEvent{
            vault_id        : 0x2::object::id_address<Vault>(arg0),
    ...
    public entry fun deposit<T0, T1>(arg0: &mut Vault, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::strategy::Strategies, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::strategy::allocate_and_execute(arg6, v0, arg7);
        let (v2, v3) = 0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::suilend_adapter::deposit_to_suilend<T0, T1>(arg2, arg3, arg5, arg1, arg0.admin, arg7);
        let v4 = v3;
        let v5 = v2;
        0x2::table::add<u64, 0x2::object::ID>(&mut arg0.ctoken, arg4, 0x2::object::id<0x2::coin::Coin<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::CToken<T0, 0x2::sui::SUI>>>(&v5));
        0x2::table::add<u64, 0x2::object::ID>(&mut arg0.obligation_cap, arg4, 0x2::object::id<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>>(&v4));
    ...
    public entry fun emergency_liquidate<T0, T1, T2>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: 0x2::object::ID, arg3: &mut 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let (v0, _) = 0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::suilend_adapter::liquidate_obligation<T0, T1, T2>(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
        let v2 = v0;
    ...
    fun init(arg0: VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = Vault{
            ...
            usdc_index     : 1,
            share_treasury : v0,
            ctoken         : 0x2::table::new<u64, 0x2::object::ID>(arg1),
            obligation_cap : 0x2::table::new<u64, 0x2::object::ID>(arg1),
        };
    ...
    public entry fun withdraw<T0>(arg0: &mut Vault, arg1: &mut 0x2::coin::Coin<VAULT>, arg2: u64, arg3: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: u64, arg5: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 > (arg0.hwm as u128)) {
            let v2 = 0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::suilend_adapter::get_suilend_fee_receiver<T0>(arg3);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x28612b49de307b93301221844ebe339e384e613c53c514ef3a534c4022280a81::suilend_adapter::withdraw_from_suilend<T0>(arg3, arg4, arg6, arg5, arg2, arg7), 0x2::tx_context::sender(arg7));
