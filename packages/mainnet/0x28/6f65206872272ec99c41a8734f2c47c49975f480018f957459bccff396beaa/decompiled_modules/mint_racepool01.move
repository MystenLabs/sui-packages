module 0x286f65206872272ec99c41a8734f2c47c49975f480018f957459bccff396beaa::mint_racepool01 {
    ...
    public entry fun create_pool(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<RacePool>(v0, 0x2::tx_context::sender(arg0));
    }

    public entry fun enter_race(arg0: &mut RacePool, arg1: MONSTER, arg2: TicketNFT, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<MONSTER>(arg1, 0x2::tx_context::sender(arg3));
    }
    ...
    public entry fun mint_monster(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<MONSTER>(v0, 0x2::tx_context::sender(arg5));
    }
