module 0x28d1ba2fc72534c769e7ddbf8537567142d36b80715a19f451619d7ef7e0454c::suigpt {
    ...
    fun init(arg0: SUIGPT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"1737546275616"));
