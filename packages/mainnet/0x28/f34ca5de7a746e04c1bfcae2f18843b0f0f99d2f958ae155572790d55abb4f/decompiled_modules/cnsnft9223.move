module 0x28f34ca5de7a746e04c1bfcae2f18843b0f0f99d2f958ae155572790d55abb4f::cnsnft9223 {
    struct CNSNFT9223 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9223, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9223>(arg0, arg1);
