module 0x28c2945154a0fc10770844b699def8c97c8d534005c124b9699ffb98113364ce::cnsnft5382 {
    struct CNSNFT5382 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5382, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5382>(arg0, arg1);
