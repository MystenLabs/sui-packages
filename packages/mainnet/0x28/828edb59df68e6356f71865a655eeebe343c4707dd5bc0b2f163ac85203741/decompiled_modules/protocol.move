module 0x28828edb59df68e6356f71865a655eeebe343c4707dd5bc0b2f163ac85203741::protocol {
    ...
    public fun admin_emergency_recover<T0: store + key>(arg0: &0x28828edb59df68e6356f71865a655eeebe343c4707dd5bc0b2f163ac85203741::fee_manager::AdminCap, arg1: &0x28828edb59df68e6356f71865a655eeebe343c4707dd5bc0b2f163ac85203741::fee_manager::PlatformConfig, arg2: SwapOffer, arg3: address) {
        assert!(0x2::object::id<0x28828edb59df68e6356f71865a655eeebe343c4707dd5bc0b2f163ac85203741::fee_manager::AdminCap>(arg0) == 0x28828edb59df68e6356f71865a655eeebe343c4707dd5bc0b2f163ac85203741::fee_manager::admin_cap_id(arg1), 1);
        let SwapOffer {
            id                 : v0,
            maker              : _,
            taker              : _,
    ...
    public fun execute_swap<T0: store + key, T1: store + key>(arg0: SwapOffer, arg1: T1, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x28828edb59df68e6356f71865a655eeebe343c4707dd5bc0b2f163ac85203741::fee_manager::PlatformConfig, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = 0x28828edb59df68e6356f71865a655eeebe343c4707dd5bc0b2f163ac85203741::fee_manager::get_flat_fee(arg3, 0x1::type_name::with_defining_ids<T1>());
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= v6 + v11, 4);
        if (v11 > 0) {
            0x28828edb59df68e6356f71865a655eeebe343c4707dd5bc0b2f163ac85203741::fee_manager::collect_fee(arg3, 0x2::coin::split<0x2::sui::SUI>(&mut arg2, v11, arg5));
        };
