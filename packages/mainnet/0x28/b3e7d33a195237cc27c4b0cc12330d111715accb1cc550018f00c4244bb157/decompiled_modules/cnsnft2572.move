module 0x28b3e7d33a195237cc27c4b0cc12330d111715accb1cc550018f00c4244bb157::cnsnft2572 {
    struct CNSNFT2572 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2572, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7727"));
        let v4 = 0x2::package::claim<CNSNFT2572>(arg0, arg1);
