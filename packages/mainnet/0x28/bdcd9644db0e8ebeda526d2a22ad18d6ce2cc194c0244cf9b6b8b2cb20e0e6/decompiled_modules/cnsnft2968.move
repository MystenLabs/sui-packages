module 0x28bdcd9644db0e8ebeda526d2a22ad18d6ce2cc194c0244cf9b6b8b2cb20e0e6::cnsnft2968 {
    struct CNSNFT2968 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2968, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2968>(arg0, arg1);
