module 0x286a592459b27dbe6b35d8a5e5b9c1b2ba5448bd3b2214d129ebb23c8f073e15::nba_nft {
    ...
    public fun mint_nft(arg0: &mut MintConfig, arg1: &AdminCap, arg2: &mut 0x286a592459b27dbe6b35d8a5e5b9c1b2ba5448bd3b2214d129ebb23c8f073e15::reward_pool::RewardPool, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u8, arg5: vector<u8>, arg6: u8, arg7: vector<u8>, arg8: address, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = arg0.mint_price * arg0.pool_percentage / 100;
        let v1 = arg0.mint_price * arg0.marketing_percentage / 100;
        0x286a592459b27dbe6b35d8a5e5b9c1b2ba5448bd3b2214d129ebb23c8f073e15::reward_pool::add_funds(arg2, 0x2::coin::split<0x2::sui::SUI>(&mut arg3, v0, arg9));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg3, v1, arg9), arg0.marketing_wallet);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg3, arg0.dev_wallet);
        let v2 = PaymentDistributed{
            total        : arg0.mint_price,
            to_pool      : v0,
            to_marketing : v1,
            to_dev       : arg0.mint_price * arg0.dev_percentage / 100,
        };
        0x2::event::emit<PaymentDistributed>(v2);
        ...
        0x2::transfer::public_transfer<NBANft>(v5, arg8);
    }
    ...
    public fun withdraw_pool_funds(arg0: &MintConfig, arg1: &AdminCap, arg2: &mut 0x286a592459b27dbe6b35d8a5e5b9c1b2ba5448bd3b2214d129ebb23c8f073e15::reward_pool::RewardPool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.admin, 4);
        0x286a592459b27dbe6b35d8a5e5b9c1b2ba5448bd3b2214d129ebb23c8f073e15::reward_pool::withdraw_all(arg2, arg0.admin, arg3);
    }
