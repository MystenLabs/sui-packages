module 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::round_manager {
    ...
    struct Global has store, key {
        ...
        round: Round,
        paused: bool,
        fee_split: 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::FeeSplit,
        vaults: 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::Vaults,
        cap: 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::SupplyCap,
        idx: 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::RadianceIndex,
        buckets: 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::Buckets,
        miracle: 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::miracle::Miracle,
    ...
    fun assert_admin(arg0: &Global, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.admin, 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::errors::E_UNAUTH());
    }

    public entry fun claim_all_entry(arg0: &mut Global, arg1: &mut 0x2::coin::TreasuryCap<0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::FAITH>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun claim_faith_entry(arg0: &mut Global, arg1: &mut 0x2::coin::TreasuryCap<0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::FAITH>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
        claim_faith_internal(arg0, arg1, arg2, arg3);
    }

    fun claim_faith_internal(arg0: &mut Global, arg1: &mut 0x2::coin::TreasuryCap<0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::FAITH>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::claim_if_any_with_multiplier(arg2, 1000, soul_age_multiplier_bps_for_user(arg0, arg2), &mut arg0.cap, &mut arg0.idx, &mut arg0.buckets);
        if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::FAITH>>(0x2::coin::mint<0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::FAITH>(arg1, v0, arg3), arg2);
            if (0x2::table::contains<address, PlayerRecord>(&arg0.player_records, arg2)) {
                0x2::table::borrow_mut<address, PlayerRecord>(&mut arg0.player_records, arg2).soul_start_round = arg0.round.index;
            };
        };
        v0
    }
    ...
    fun claim_sui_internal(arg0: &mut Global, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::withdraw_faithgg(&mut arg0.vaults, v0, arg2), arg1);
        };
        v0
    }

    public entry fun create_global_shared(arg0: address, arg1: 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::SupplyCap, arg2: 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::RadianceIndex, arg3: 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::Buckets, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::create(arg6);
        let v2 = Round{
        ...
        let v3 = Global{
            ...
            idx              : arg2,
            buckets          : arg3,
            miracle          : 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::miracle::create(arg4, arg5, arg6),
    ...
    fun enter(arg0: &mut Global, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::deposit_to_faithgg(&mut arg0.vaults, arg2);
    }
    ...
    public fun get_soul_age(arg0: &Global, arg1: address) : u64 {
        ...
        let v0 = 0x2::table::borrow<address, PlayerRecord>(&arg0.player_records, arg1);
        if (arg0.round.index <= v0.soul_start_round) {
            0
        } else {
            arg0.round.index - v0.soul_start_round
        }
    }
    ...
    public entry fun season_award_sui_from_pilgrimage_entry(arg0: &mut Global, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::withdraw_pilgrimage(&mut arg0.vaults, arg2, arg3), arg1);
    ...
    public entry fun set_fee_split_entry(arg0: &mut Global, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.paused, 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::errors::E_NOT_PAUSED());
        0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::set_split(&mut arg0.fee_split, arg1, arg2, arg3, arg4);
    ...
    fun settle(arg0: &mut Global, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.round.phase = 2;
        let v2 = 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::rng_oracle::pick(arg2, 25);
        ...
        if (v7 > 0 && v5 > 0) {
            ...
            while (v8 < v7) {
                ...
                0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::accrue_to(v9.owner, v11, &mut arg0.cap, &arg0.idx, &mut arg0.buckets, arg3);
                v8 = v8 + 1;
            };
        };
        if (v4 > 0) {
            0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::split_and_route_internal(0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::withdraw_faithgg(&mut arg0.vaults, v4, arg3), &arg0.fee_split, &mut arg0.vaults, arg3);
        };
        0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::miracle::accrue(&mut arg0.miracle);
        let (v14, v15) = 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::miracle::maybe_trigger(&mut arg0.miracle, arg2 + 7919);
        if (v14 && v7 > 0) {
            let v16 = 0;
            while (v16 < v7) {
                ...
                0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::faith::accrue_to(v17.owner, v19, &mut arg0.cap, &arg0.idx, &mut arg0.buckets, arg3);
                v16 = v16 + 1;
            };
        } else if (v7 > 0) {
            let v21 = 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::pilgrimage_balance(&arg0.vaults);
            if (v21 > 0) {
                let v22 = v21 / 50;
                let v23 = v22;
                if (v22 == 0) {
                ...
                let v24 = 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::withdraw_pilgrimage(&mut arg0.vaults, v23, arg3);
                let v25 = v23;
                let v26 = 0;
                while (v26 < v7 && v25 > 0) {
                    let v27 = *0x1::vector::borrow<Entry>(v6, v26);
                    let v28;
                    let v29 = if (v26 == v7 - 1) {
                        v25
                    } else {
                        let v30 = v23 * v27.amount / sum_block(v6);
                        v28 = v30;
                        if (v30 == 0 && v25 > 0) {
                            v28 = 1;
                        };
                    ...
                    if (v29 > 0) {
                        v25 = v25 - v29;
                        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v24, v28, arg3), v27.owner);
                    };
                    v26 = v26 + 1;
                };
        ...
        arg0.round.phase = 0;
        let v31 = RoundSettled{
            index         : arg0.round.index,
            winning       : v2,
            fee           : v4,
            redistributed : v5,
        };
        0x2::event::emit<RoundSettled>(v31);
    }
    ...
    public entry fun withdraw_faith_cron_entry(arg0: &mut Global, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::withdraw_faithgg(&mut arg0.vaults, arg1, arg2), v0);
    ...
    public entry fun withdraw_faithgg_entry(arg0: &mut Global, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
        assert!(arg0.paused, 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::errors::E_NOT_PAUSED());
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::withdraw_faithgg(&mut arg0.vaults, arg2, arg3), arg1);
    ...
    public entry fun withdraw_manifest_cron_entry(arg0: &mut Global, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg2);
        let v0 = 0x2::tx_context::sender(arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::withdraw_manifest_buyback(&mut arg0.vaults, arg1, arg2), v0);
    ...
    public entry fun withdraw_manifest_entry(arg0: &mut Global, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
        assert!(arg0.paused, 0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::errors::E_NOT_PAUSED());
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2838031f3b57e62746f34f99c9d614ca64edc4d9e5dc9323b384b1951a4a97bb::treasury::withdraw_manifest_buyback(&mut arg0.vaults, arg2, arg3), arg1);
