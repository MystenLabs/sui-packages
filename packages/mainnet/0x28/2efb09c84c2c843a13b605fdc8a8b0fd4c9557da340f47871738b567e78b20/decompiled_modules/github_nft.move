module 0x282efb09c84c2c843a13b605fdc8a8b0fd4c9557da340f47871738b567e78b20::github_nft {
    ...
    fun init(arg0: GITHUB_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{Seal Pioneer} #{ID}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"A follow-up badge for true pioneers. For those who keep forging the path in Seal expedition."));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://moccasin-applicable-coyote-183.mypinata.cloud/ipfs/bafkreib3rezp2lcgy3ukmqn3u57dbqgfnbiqv33c6anj67yprtrys2jsoi"));
