module 0x28d8021fd936e8e611782faeb67a3b0ab15325a9866fdb977bc83d8877dec452::volcano {
    ...
    public entry fun decrease_eruption(arg0: &mut Volcano, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x28d8021fd936e8e611782faeb67a3b0ab15325a9866fdb977bc83d8877dec452::position::decrease(v4, arg2, v2);
        let v5 = EruptionDecreased{
            user            : v1,
            amount          : arg2,
            new_level       : arg0.eruption_level,
            total_decreases : 0x28d8021fd936e8e611782faeb67a3b0ab15325a9866fdb977bc83d8877dec452::position::get_total_decreases(v4),
        };
    ...
    public fun get_or_create_position(arg0: &mut Volcano, arg1: address, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) : &mut 0x28d8021fd936e8e611782faeb67a3b0ab15325a9866fdb977bc83d8877dec452::position::Position {
        if (!0x2::dynamic_field::exists_<address>(&arg0.id, arg1)) {
            0x2::dynamic_field::add<address, 0x28d8021fd936e8e611782faeb67a3b0ab15325a9866fdb977bc83d8877dec452::position::Position>(&mut arg0.id, arg1, 0x28d8021fd936e8e611782faeb67a3b0ab15325a9866fdb977bc83d8877dec452::position::create_position_with_display(arg2, arg3));
        };
        0x2::dynamic_field::borrow_mut<address, 0x28d8021fd936e8e611782faeb67a3b0ab15325a9866fdb977bc83d8877dec452::position::Position>(&mut arg0.id, arg1)
    }
    ...
    public fun get_user_stats(arg0: &Volcano, arg1: address) : (u64, u64, u64) {
        ...
        let v0 = 0x2::dynamic_field::borrow<address, 0x28d8021fd936e8e611782faeb67a3b0ab15325a9866fdb977bc83d8877dec452::position::Position>(&arg0.id, arg1);
        (0x28d8021fd936e8e611782faeb67a3b0ab15325a9866fdb977bc83d8877dec452::position::get_total_increases(v0), 0x28d8021fd936e8e611782faeb67a3b0ab15325a9866fdb977bc83d8877dec452::position::get_total_decreases(v0), 0x28d8021fd936e8e611782faeb67a3b0ab15325a9866fdb977bc83d8877dec452::position::get_last_action(v0))
    }
    ...
    public entry fun increase_eruption(arg0: &mut Volcano, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        v3.last_action = v2;
        let v4 = get_or_create_position(arg0, v1, arg3, arg4);
        0x28d8021fd936e8e611782faeb67a3b0ab15325a9866fdb977bc83d8877dec452::position::increase(v4, arg2, v2);
        ...
        let v6 = EruptionIncreased{
            ...
            amount          : arg2,
            new_level       : arg0.eruption_level,
            total_increases : 0x28d8021fd936e8e611782faeb67a3b0ab15325a9866fdb977bc83d8877dec452::position::get_total_increases(v4),
        };
