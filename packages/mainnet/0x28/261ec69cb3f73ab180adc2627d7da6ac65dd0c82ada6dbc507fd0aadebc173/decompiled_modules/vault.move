module 0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::vault {
    ...
    public fun new<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: 0x2::coin::TreasuryCap<T2>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Vault<T0, T1, T2>{
            ...
            rewards_bag                  : 0x2::bag::new(arg10),
            swap_routes                  : 0x2::bag::new(arg10),
        ...
        0x2::transfer::transfer<VaultCap>(v1, 0x2::tx_context::sender(arg10));
    }
    ...
    public fun issue_rebalance_cap(arg0: &VaultCap, arg1: address, arg2: &0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun set_slippage<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &VaultCap, arg2: u64) {
        check_vault_cap_compatibility<T0, T1, T2>(arg0, arg1);
        arg0.slippage_price_scalling = arg2;
    }

    public fun slippage<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) : u64 {
        arg0.slippage_price_scalling
    }
    ...
    public fun update_rebalance_cap_ownership(arg0: &VaultCap, arg1: &mut RebalanceCap, arg2: address, arg3: &0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::version::Version) {
