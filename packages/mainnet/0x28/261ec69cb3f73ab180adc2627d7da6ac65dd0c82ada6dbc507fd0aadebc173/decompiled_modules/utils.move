module 0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::utils {
    ...
    public(friend) fun close_position<T0, T1, T2>(arg0: &mut 0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::vault::Vault<T0, T1, T2>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::close_position<T0, T1>(arg2, arg1, 0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::vault::remove_position<T0, T1, T2>(arg0));
        (v0, v1)
    }
    ...
    public(friend) fun create_position<T0, T1, T2>(arg0: &mut 0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::vault::Vault<T0, T1, T2>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x2::balance::Balance<T0>, arg4: &mut 0x2::balance::Balance<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (u32, u32, u128, u128) {
        ...
        let v1 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::get_tick_at_sqrt_price(scale(v0, 0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::vault::upper_price_scalling<T0, T1, T2>(arg0)));
        let v2 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::get_tick_at_sqrt_price(scale(v0, 0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::vault::lower_price_scalling<T0, T1, T2>(arg0)));
        ...
        0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::vault::update_last_rebalance_sqrt_price<T0, T1, T2>(arg0, v0);
        0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::vault::insert_position<T0, T1, T2>(arg0, v5);
        (v3, v4, scale(v0, 0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::vault::lower_trigger_price_scalling<T0, T1, T2>(arg0)), scale(v0, 0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::vault::upper_trigger_price_scalling<T0, T1, T2>(arg0)))
    }

    fun scale(arg0: u128, arg1: u64) : u128 {
        (((arg0 as u256) * (arg1 as u256) / (0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::vault::scalling_factor() as u256)) as u128)
    }

    public fun slippage_adjusted_sqrt_price(arg0: bool, arg1: u64, arg2: u128) : u128 {
        if (arg1 == 0) {
            if (arg0) {
                4295048016
            } else {
            ...
            let v1 = if (arg0) {
                (0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::vault::scalling_factor() as u64) - arg1
            } else {
                (0x28261ec69cb3f73ab180adc2627d7da6ac65dd0c82ada6dbc507fd0aadebc173::vault::scalling_factor() as u64) + arg1
            };
            scale(arg2, v1)
