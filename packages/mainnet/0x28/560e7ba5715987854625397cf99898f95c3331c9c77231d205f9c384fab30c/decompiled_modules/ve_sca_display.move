module 0x28560e7ba5715987854625397cf99898f95c3331c9c77231d205f9c384fab30c::ve_sca_display {
    ...
    fun init(arg0: VE_SCA_DISPLAY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<0x28560e7ba5715987854625397cf99898f95c3331c9c77231d205f9c384fab30c::linear_ve_sca::LinearVeSca>(&v0, v1, v3, arg1);
        0x2::display::update_version<0x28560e7ba5715987854625397cf99898f95c3331c9c77231d205f9c384fab30c::linear_ve_sca::LinearVeSca>(&mut v5);
        let v6 = 0x2::tx_context::sender(arg1);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, v6);
        0x2::transfer::public_transfer<0x2::display::Display<0x28560e7ba5715987854625397cf99898f95c3331c9c77231d205f9c384fab30c::linear_ve_sca::LinearVeSca>>(v5, v6);
    }
