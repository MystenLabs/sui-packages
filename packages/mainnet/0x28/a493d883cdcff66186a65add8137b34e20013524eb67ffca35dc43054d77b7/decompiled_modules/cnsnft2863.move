module 0x28a493d883cdcff66186a65add8137b34e20013524eb67ffca35dc43054d77b7::cnsnft2863 {
    struct CNSNFT2863 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2863, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2863>(arg0, arg1);
