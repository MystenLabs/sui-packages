module 0x28e198b84ef7a80ec3595e76ae4f250e3f1512aa4ff53b71fa963f38e875b1e7::smoon {
    ...
    fun init(arg0: SMOON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<SMOON>>(0x2::coin::from_balance<SMOON>(0x2::balance::increase_supply<SMOON>(&mut v2, 1000000000000), arg1), 0x2::tx_context::sender(arg1));
