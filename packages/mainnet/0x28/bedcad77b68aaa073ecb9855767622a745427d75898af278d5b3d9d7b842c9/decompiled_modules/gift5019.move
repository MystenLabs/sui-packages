module 0x28bedcad77b68aaa073ecb9855767622a745427d75898af278d5b3d9d7b842c9::gift5019 {
    struct GIFT5019 has drop {
        dummy_field: bool,
    }

    struct TICKET_5019 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5019(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5019>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5019>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5019, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5019>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5019>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5019>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5019>>(v5, 0x2::tx_context::sender(arg1));
    }
