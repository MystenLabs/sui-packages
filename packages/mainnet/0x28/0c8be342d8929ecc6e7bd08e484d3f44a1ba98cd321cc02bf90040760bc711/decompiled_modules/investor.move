module 0x7cb3a546202773a06b0b18c9af9c76c8679a2a0fe8d653cecb7dfbf7933e019::investor {
    ...
    public fun withdraw_from_navi<T0, T1>(arg0: &mut Investor<T1>, arg1: &0x2::clock::Clock, arg2: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T1>, arg6: u8, arg7: u8, arg8: u64, arg9: u64, arg10: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive::Incentive, arg11: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg12: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg13: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg14: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg15: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_loan_value(arg1, arg2, arg3, arg7, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::account_owner(&arg0.navi_acc.navi_account));
        let v1 = 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool_account::stake_amount<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T1>>(&arg0.s_acc.scallop_pool_account);
        let v2 = (arg8 as u128) * (v1 as u128) / (arg9 as u128);
        let v3 = CheckStake{
            val  : (v2 as u64),
            loan : v1,
        };
        0x2::event::emit<CheckStake>(v3);
        let v4 = unstake_and_withdraw_from_scallop<T1>(arg0, arg13, arg14, arg12, arg1, (v2 as u64), arg15);
        let v5 = 0x2::coin::split<T1>(&mut v4, (((arg8 as u256) * v0 / (arg9 as u256)) as u64), arg15);
        let v6 = CheckStake{
            val  : 0x2::coin::value<T1>(&v5),
            loan : (v0 as u64),
        };
        0x2::event::emit<CheckStake>(v6);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v4, 0x2::tx_context::sender(arg15));
        repay_to_navi<T1>(arg0, arg1, arg2, arg3, arg5, arg7, v5, arg11, arg15);
        let v7 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::withdraw_with_account_cap<T0>(arg1, arg2, arg3, arg4, arg6, arg8, arg10, arg11, &mut arg0.navi_acc.navi_account);
        let v8 = if (0x2::balance::value<T0>(&v7) > arg0.invested) {
            0
        } else {
            arg0.invested - 0x2::balance::value<T0>(&v7)
        };
        arg0.invested = v8;
