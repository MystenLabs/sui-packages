module 0x28f9aaf29528c2019fd8b817fe226f59cf2732d88e94d9f3c7008e8845854581::reward4851 {
    struct REWARD4851 has drop {
        dummy_field: bool,
    }

    struct TICKET_4851 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4851(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4851>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4851>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4851, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4851>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4851>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4851>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4851>>(v5, 0x2::tx_context::sender(arg1));
    }
