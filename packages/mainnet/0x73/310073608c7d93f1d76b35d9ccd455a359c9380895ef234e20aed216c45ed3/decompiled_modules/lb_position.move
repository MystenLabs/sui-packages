module 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::lb_position {
    ...
    public(friend) fun add_bin(arg0: &mut LBPositionManager, arg1: &mut LBPosition, arg2: u32, arg3: LBBinPosition) {
        if (arg1.total_bins + 1 > 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::constants::max_bins_in_position()) {
            abort 205
        };
    ...
    public(friend) fun collect_fees(arg0: &mut LBBinPosition, arg1: u128, arg2: u128) : (u64, u64, u64, u64) {
        let v0 = arg0.amount;
        let v1 = ((0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::mul_u128(v0, 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::sub_u128(arg1, arg0.fee_growth_inside_last_x)) >> 64) as u64);
        let v2 = ((0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::mul_u128(v0, 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::sub_u128(arg2, arg0.fee_growth_inside_last_y)) >> 64) as u64);
        arg0.collected_fees_x = 0;
        arg0.collected_fees_y = 0;
        arg0.fee_growth_inside_last_x = arg1;
        arg0.fee_growth_inside_last_y = arg2;
        (v1, v2, 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::add_u64(arg0.collected_fees_x, v1), 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::add_u64(arg0.collected_fees_y, v2))
    }
    ...
    public(friend) fun collect_reward(arg0: &mut LBBinPosition, arg1: u64, arg2: u128, arg3: u128) : u64 {
        ...
        *0x1::vector::borrow_mut<u128>(&mut arg0.reward_growth_inside_last, arg1) = arg2;
        0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::u128_to_u64(arg3 * 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::sub_u128(arg2, v0) >> 64)
    }
    ...
    public(friend) fun get_pending_fees(arg0: &LBBinPosition, arg1: u128, arg2: u128) : (u64, u64) {
        ...
        (0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::add_u64(arg0.collected_fees_x, ((v0 * (arg1 - arg0.fee_growth_inside_last_x) >> 64) as u64)), 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::add_u64(arg0.collected_fees_y, ((v0 * (arg2 - arg0.fee_growth_inside_last_y) >> 64) as u64)))
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 3) {
            ...
            v3 = 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }
    ...
    public(friend) fun increase_bin_liquidity(arg0: &mut LBBinPosition, arg1: u128, arg2: u128, arg3: u128, arg4: vector<u128>, arg5: &mut vector<u64>, arg6: u128) : (u64, u64) {
        ...
        arg0.amount = 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::add_u128(arg0.amount, arg1);
        (v0, v1)
    }

    public(friend) fun increase_position_total_bins(arg0: &mut LBPosition, arg1: u64) {
        if (arg0.total_bins + arg1 > 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::constants::max_bins_in_position()) {
            abort 205
        };
    ...
    public(friend) fun remove_bin(arg0: &mut LBPositionManager, arg1: &mut LBPosition, arg2: u32) : bool {
        ...
        arg1.total_bins = 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::sub_u64(arg1.total_bins, 1);
    ...
    public(friend) fun remove_bins(arg0: &mut LBPositionManager, arg1: &mut LBPosition, arg2: vector<u32>) {
        ...
        while (v2 < 0x1::vector::length<u32>(&arg2)) {
            ...
            if (v6 != v3) {
                let v8 = if (v3 != 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::constants::max_u32()) {
    ...
    public(friend) fun save_reward(arg0: &mut LBPosition, arg1: u64, arg2: u64) {
        if (arg2 > 0) {
            ...
            *0x1::vector::borrow_mut<u64>(&mut arg0.saved_rewards, arg1) = 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::add_u64(*0x1::vector::borrow<u64>(&arg0.saved_rewards, arg1), arg2);
        };
    }
    ...
    public(friend) fun settle_position_bin_fees_and_rewards(arg0: &mut LBBinPosition, arg1: u128, arg2: u128, arg3: vector<u128>, arg4: &mut vector<u64>, arg5: u128) : (u64, u64) {
        ...
        let v1 = 0;
        if (arg0.amount > 0) {
            let v2 = 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::u128_to_u64(arg0.amount * 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::sub_u128(arg1, arg0.fee_growth_inside_last_x) >> 64);
            v0 = v2;
            let v3 = 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::u128_to_u64(arg0.amount * 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::sub_u128(arg2, arg0.fee_growth_inside_last_y) >> 64);
            v1 = v3;
            arg0.collected_fees_x = 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::add_u64(arg0.collected_fees_x, v2);
            arg0.collected_fees_y = 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::add_u64(arg0.collected_fees_y, v3);
            let v4 = 0;
            ...
            while (v4 < v7) {
                ...
                if (v8 > v9) {
                    let v10 = 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::u128_to_u64(0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::q64x64::liquidity_from_amounts(v2, v3, arg5) * (v8 - v9) >> 64);
                    if (v10 > 0) {
                        while (0x1::vector::length<u64>(arg4) <= v4) {
                            0x1::vector::push_back<u64>(arg4, 0);
                        };
                        *0x1::vector::borrow_mut<u64>(arg4, v4) = 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::add_u64(*0x1::vector::borrow<u64>(arg4, v4), v10);
                    };
                };
                v4 = v4 + 1;
            };
            ...
            while (v4 < v7) {
                ...
                if (v8 > v9) {
                    ...
                    if (v10 > 0) {
                        ...
                        *0x1::vector::borrow_mut<u64>(&mut arg4, v4) = 0x73310073608c7d93f1d76b35d9ccd455a359c9380895ef234e20aed216c45ed3::safe_math::add_u64(*0x1::vector::borrow<u64>(&arg4, v4), v10);
                    };
                };
                v4 = v4 + 1;
            };
