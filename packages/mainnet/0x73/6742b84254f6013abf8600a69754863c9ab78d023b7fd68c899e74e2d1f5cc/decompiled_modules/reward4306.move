module 0x736742b84254f6013abf8600a69754863c9ab78d023b7fd68c899e74e2d1f5cc::reward4306 {
    struct REWARD4306 has drop {
        dummy_field: bool,
    }

    struct TICKET_4306 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4306(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4306>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4306>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4306, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4306>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4306>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4306>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4306>>(v5, 0x2::tx_context::sender(arg1));
    }
