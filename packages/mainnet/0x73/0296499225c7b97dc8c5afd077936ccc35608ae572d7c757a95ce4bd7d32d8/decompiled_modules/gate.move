module 0x240bbb3e1ad8e9b3d5171e63c613fed052d3a202b2173f03027fb351013f4b70::gate {
    ...
    public fun assert_health_factor_at_least(arg0: &0x2::clock::Clock, arg1: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: address, arg4: u256, arg5: bool) {
        0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::update_state_of_user(arg0, arg2, arg3);
        let v0 = if (arg5) {
            0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_health_factor(arg0, arg2, arg1, arg3)
        } else {
            standard_health_factor(arg0, arg1, arg2, arg3)
        };
        assert!(v0 >= arg4, 1);
    }
    ...
    public fun liquidation_gate_batch(arg0: &0x2::clock::Clock, arg1: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: address, arg4: vector<address>, arg5: u256, arg6: bool) : (vector<u256>, vector<bool>, vector<bool>, vector<bool>, vector<vector<u8>>, vector<vector<u8>>) {
        ...
        while (v6 < 0x1::vector::length<address>(&arg4)) {
            ...
            let (v8, v9) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_user_assets(arg2, v7);
            let v10 = v9;
            let v11 = v8;
            let v12 = user_asset_prices_valid(arg0, arg1, arg2, &v11, &v10);
            let v13 = if (!v12) {
            ...
            let v14 = v12 && 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::is_liquidatable(arg2, arg3, v7);
            let v15 = if (v12) {
                if (v13 <= 1000000000000000000000000000) {
                    v14
                } else {
                    false
                }
            ...
            0x1::vector::push_back<u256>(&mut v0, v13);
            let v16 = v12 && v13 <= arg5;
            0x1::vector::push_back<bool>(&mut v1, v16);
            0x1::vector::push_back<bool>(&mut v2, v14);
            0x1::vector::push_back<bool>(&mut v3, v15);
            0x1::vector::push_back<vector<u8>>(&mut v4, v11);
            0x1::vector::push_back<vector<u8>>(&mut v5, v10);
            v6 = v6 + 1;
        };
        (v0, v1, v2, v3, v4, v5)
    }
    ...
    fun user_asset_prices_valid(arg0: &0x2::clock::Clock, arg1: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg2: &0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &vector<u8>, arg4: &vector<u8>) : bool {
        let v0 = 0;
        while (v0 < 2) {
            let v1 = if (v0 == 0) {
                arg3
            ...
            while (v2 < 0x1::vector::length<u8>(v1)) {
                let (v3, _, _) = 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::get_token_price(arg0, arg1, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_oracle_id(arg2, *0x1::vector::borrow<u8>(v1, v2)));
                if (!v3) {
                    return false
                };
                v2 = v2 + 1;
