module 0x73884803a7fd3027500d9530d1662a2185a488ad056b06a6d18c2b036a7924f4::prediction {
    ...
    public entry fun claim(arg0: &mut Rounds, arg1: u64, arg2: &mut Epoch, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0.upordown) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(v1, *0x2::table::borrow<address, u64>(&v0.upaddress, 0x2::tx_context::sender(arg3)) / v0.upamount * 0x2::balance::value<0x2::sui::SUI>(v1) * 10000000000 / 10000000000, arg3), 0x2::tx_context::sender(arg3));
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(v2, *0x2::table::borrow<address, u64>(&v0.downaddress, 0x2::tx_context::sender(arg3)) / v0.downamount * 0x2::balance::value<0x2::sui::SUI>(v2) * 10000000000 / 10000000000, arg3), 0x2::tx_context::sender(arg3));
