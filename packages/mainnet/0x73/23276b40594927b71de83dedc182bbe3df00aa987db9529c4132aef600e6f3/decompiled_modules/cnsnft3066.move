module 0x7323276b40594927b71de83dedc182bbe3df00aa987db9529c4132aef600e6f3::cnsnft3066 {
    struct CNSNFT3066 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3066, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3066>(arg0, arg1);
