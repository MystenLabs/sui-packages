module 0xf857fa9df5811e6df2a0240a1029d365db24b5026896776ddd1c3c70803bccd3::ethereum {
    ...
    public fun link_v3(arg0: &mut 0xf857fa9df5811e6df2a0240a1029d365db24b5026896776ddd1c3c70803bccd3::registry_v2::SuiLinkRegistryV2, arg1: vector<u8>, arg2: &0x2::clock::Clock, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::string::append_utf8(&mut v0, 0x1::string::into_bytes(arg3));
        0x1::string::append_utf8(&mut v0, x"0a53756920416464726573733a203078");
        0x1::string::append_utf8(&mut v0, 0x1::string::into_bytes(0x2::address::to_string(0x2::tx_context::sender(arg4))));
        assert!(arg3 == 0xf857fa9df5811e6df2a0240a1029d365db24b5026896776ddd1c3c70803bccd3::utils::bytes_to_hex(ecrecover_eth_address(arg1, 0x1::string::into_bytes(v0))), 0);
