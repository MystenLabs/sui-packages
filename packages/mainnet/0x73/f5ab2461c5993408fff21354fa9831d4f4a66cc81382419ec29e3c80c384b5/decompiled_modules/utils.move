module 0xf857fa9df5811e6df2a0240a1029d365db24b5026896776ddd1c3c70803bccd3::utils {
    ...
    public(friend) fun hash_registry_entry(arg0: u32, arg1: address, arg2: 0x1::string::String) : vector<u8> {
        let v0 = 0x1::vector::empty<vector<u8>>();
        let v1 = &mut v0;
        0x1::vector::push_back<vector<u8>>(v1, 0x2::bcs::to_bytes<u32>(&arg0));
        0x1::vector::push_back<vector<u8>>(v1, hash_sui_address_and_network_address(arg1, arg2));
        let v2 = 0x2::bcs::to_bytes<vector<vector<u8>>>(&v0);
        0x2::hash::blake2b256(&v2)
    }

    public(friend) fun hash_sui_address_and_network_address(arg0: address, arg1: 0x1::string::String) : vector<u8> {
        let v0 = 0x1::vector::empty<vector<u8>>();
        let v1 = &mut v0;
        0x1::vector::push_back<vector<u8>>(v1, 0x2::bcs::to_bytes<address>(&arg0));
        0x1::vector::push_back<vector<u8>>(v1, 0x1::string::into_bytes(arg1));
        let v2 = 0x2::bcs::to_bytes<vector<vector<u8>>>(&v0);
        0x2::hash::blake2b256(&v2)
    }
    ...
    public(friend) fun migration_hash_registry_entry(arg0: u32, arg1: vector<u8>) : vector<u8> {
        let v0 = 0x1::vector::empty<vector<u8>>();
        let v1 = &mut v0;
        0x1::vector::push_back<vector<u8>>(v1, 0x2::bcs::to_bytes<u32>(&arg0));
