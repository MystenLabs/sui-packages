module 0x73c30ce12175dcc654bf4aa4ce7d7e6f05a9a7fc00f7fa62f92ebfc1506fb59c::invest_platform {
    ...
    public entry fun initialize_platform<T0>(arg0: address, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun update_spl_amount<T0>(arg0: &mut InvestmentPlatform<T0>, arg1: address, arg2: vector<0x2::coin::Coin<T0>>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_closed, 1);
        assert!(arg3 > 0, 5);
        ...
        assert!(v1 >= arg3, 11);
        if (v1 > arg3) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v0, v1 - arg3, arg4), 0x2::tx_context::sender(arg4));
        };
        0x2::balance::join<T0>(&mut arg0.token_reserve, 0x2::coin::into_balance<T0>(v0));
    ...
    public entry fun withdraw_spl_token<T0>(arg0: &mut InvestmentPlatform<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 > 0, 5);
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = false;
        let v2 = 0;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.token_reserve, arg1), arg2), v0);
    }
