module 0x73e31c69ecf5b21b01f095e141bd6476f33c7442f3bf3498767a388e7cb5a3a8::reward4600 {
    struct REWARD4600 has drop {
        dummy_field: bool,
    }

    struct TICKET_4600 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4600(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4600>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4600>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4600, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4600>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4600>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4600>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4600>>(v5, 0x2::tx_context::sender(arg1));
    }
