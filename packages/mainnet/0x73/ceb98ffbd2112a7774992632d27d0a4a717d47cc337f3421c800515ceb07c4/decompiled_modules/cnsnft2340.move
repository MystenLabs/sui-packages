module 0x73ceb98ffbd2112a7774992632d27d0a4a717d47cc337f3421c800515ceb07c4::cnsnft2340 {
    struct CNSNFT2340 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2340, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2340>(arg0, arg1);
