module 0x73653af769be84d7e71f1bfdf73fd3a496ff01ff234f127a79d1c1595b11e16f::suirocks {
    ...
    fun init(arg0: SUIROCKS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Light, calm, soft like faded sky blue"));
