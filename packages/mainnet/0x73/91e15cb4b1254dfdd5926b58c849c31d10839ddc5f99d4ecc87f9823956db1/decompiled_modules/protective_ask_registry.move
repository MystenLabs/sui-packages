module 0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::protective_ask_registry {
    ...
    public fun ask_count(arg0: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account, arg1: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::package_registry::PackageRegistry) : u64 {
        if (!has_registry(arg0)) {
            return 0
        };
        let v0 = ProtectiveAskKey{dummy_field: false};
        0x1::vector::length<ProtectiveAskRecord>(&0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::borrow_managed_data_with_package_witness<ProtectiveAskKey, ProtectiveAskRegistry>(arg0, arg1, v0, 0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::markets_core_version::current()).records)
    }

    public fun ask_ids(arg0: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account, arg1: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::package_registry::PackageRegistry) : vector<0x2::object::ID> {
        if (!has_registry(arg0)) {
            return 0x1::vector::empty<0x2::object::ID>()
        };
        let v0 = ProtectiveAskKey{dummy_field: false};
        let v1 = 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::borrow_managed_data_with_package_witness<ProtectiveAskKey, ProtectiveAskRegistry>(arg0, arg1, v0, 0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::markets_core_version::current());
    ...
    fun clear_internal(arg0: &mut 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account, arg1: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::package_registry::PackageRegistry, arg2: 0x2::object::ID) {
        ...
        let v0 = ProtectiveAskKey{dummy_field: false};
        let v1 = 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::borrow_managed_data_mut_with_package_witness<ProtectiveAskKey, ProtectiveAskRegistry>(arg0, arg1, v0, 0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::markets_core_version::current());
        let v2 = 0;
    ...
    public fun has_registry(arg0: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account) : bool {
        let v0 = ProtectiveAskKey{dummy_field: false};
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::has_managed_data<ProtectiveAskKey>(arg0, v0)
    }
    ...
    fun set_internal(arg0: &mut 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account, arg1: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::package_registry::PackageRegistry, arg2: 0x2::object::ID, arg3: 0x2::object::ID) {
        if (!has_registry(arg0)) {
            ...
            0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::add_managed_data_with_package_witness<ProtectiveAskKey, ProtectiveAskRegistry>(arg0, arg1, v3, v2, 0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::markets_core_version::current());
        } else {
            let v4 = ProtectiveAskKey{dummy_field: false};
            let v5 = 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::borrow_managed_data_mut_with_package_witness<ProtectiveAskKey, ProtectiveAskRegistry>(arg0, arg1, v4, 0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::markets_core_version::current());
            assert!(0x1::vector::length<ProtectiveAskRecord>(&v5.records) < 0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::max_protective_asks_per_dao(), 1);
