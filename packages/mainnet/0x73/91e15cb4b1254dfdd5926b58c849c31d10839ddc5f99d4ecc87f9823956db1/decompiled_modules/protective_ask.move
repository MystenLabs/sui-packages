module 0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::protective_ask {
    ...
    public fun buy_from_ask<T0: store, T1, T2, T3>(arg0: &mut ProtectiveAsk<T1, T2>, arg1: &mut 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account, arg2: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::package_registry::PackageRegistry, arg3: &0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::unified_spot_pool::UnifiedSpotPool<T1, T2, T3>, arg4: 0x2::coin::Coin<T2>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, 0x2::coin::Coin<T2>) {
        ...
        assert!(0x2::object::id<0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account>(arg1) == arg0.account_id, 4);
        assert!(0x2::object::id<0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::unified_spot_pool::UnifiedSpotPool<T1, T2, T3>>(arg3) == arg0.pool_id, 9);
        assert!(!0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::unified_spot_pool::is_locked_for_proposal<T1, T2, T3>(arg3), 8);
        ...
        assert!(arg5 > 0, 3);
        assert!(arg5 <= v0, 6);
        let v1 = 0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::math::mul_div_mixed_up((arg0.price_per_token as u128), arg5, (0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::price_precision_scale() as u128));
        assert!(v1 <= 18446744073709551615, 16);
        let v2 = (v1 as u64);
        assert!(0x2::coin::value<T2>(&arg4) >= v2, 14);
        let v3 = 0x2::coin::into_balance<T2>(arg4);
        0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::vault::deposit_approved<T0, T2>(arg1, arg2, 0x1::string::utf8(b"treasury"), 0x2::coin::from_balance<T2>(0x2::balance::split<T2>(&mut v3, v2), arg7));
        ...
        (0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::currency::mint_with_package_witness<T1>(arg1, arg2, arg5, 0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::markets_core_version::current(), arg7), 0x2::coin::from_balance<T2>(v3, arg7))
    }

    public fun cancel<T0, T1>(arg0: &mut ProtectiveAsk<T0, T1>, arg1: &mut 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account, arg2: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::package_registry::PackageRegistry, arg3: 0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::spot_pool_mutation_auth::SpotPoolMutationAuth, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert!(0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::spot_pool_mutation_auth::target_id(&arg3) == arg0.pool_id, 13);
        assert!(arg0.active, 1);
        assert!(0x2::object::id<0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account>(arg1) == arg0.account_id, 4);
        arg0.active = false;
        0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::protective_ask_registry::clear_with_package_witness(arg1, arg2, 0x2::object::id<ProtectiveAsk<T0, T1>>(arg0));
        let v0 = AskReleased{
    ...
    public fun close<T0, T1>(arg0: &mut ProtectiveAsk<T0, T1>, arg1: &mut 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account, arg2: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::package_registry::PackageRegistry, arg3: &0x2::clock::Clock) {
        assert!(arg0.active, 1);
    ...
    public fun create<T0, T1>(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64, arg5: 0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::spot_pool_mutation_auth::SpotPoolMutationAuth, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : ProtectiveAsk<T0, T1> {
        assert!(arg3 > 0, 3);
        assert!(arg2 > 0, 19);
        assert!(0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::spot_pool_mutation_auth::target_id(&arg5) == arg1, 13);
        let v0 = if (arg4 == 0) {
            0
        } else {
    ...
    public fun emergency_withdraw_stable<T0, T1>(arg0: &mut ProtectiveAsk<T0, T1>, arg1: &0xcb4dee85f5e93cab3a34f549d59eab8524898d493295f1db3eea4fe387085591::emergency_cap::EmergencyCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
    ...
    public fun quote_buy<T0, T1>(arg0: &ProtectiveAsk<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock) : u64 {
        ...
        let v1 = 0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::math::mul_div_mixed_up((arg0.price_per_token as u128), arg1, (0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::price_precision_scale() as u128));
