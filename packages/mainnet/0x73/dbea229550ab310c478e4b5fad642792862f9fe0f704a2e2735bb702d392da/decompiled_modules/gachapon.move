module 0x73dbea229550ab310c478e4b5fad642792862f9fe0f704a2e2735bb702d392da::gachapon {
    struct GACHAPON has drop {
        dummy_field: bool,
    }

    struct EggContent has copy, drop, store {
        obj_type: 0x1::type_name::TypeName,
    ...
    struct Gachapon<phantom T0> has key {
        id: 0x2::object::UID,
        lootbox: 0x73dbea229550ab310c478e4b5fad642792862f9fe0f704a2e2735bb702d392da::big_vector::BigVector<Egg>,
    ...
    public fun lock<T0, T1: store + key>(arg0: &mut Gachapon<T0>, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::transfer_policy::TransferPolicy<T1>, arg3: T1, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v1;
        0x73dbea229550ab310c478e4b5fad642792862f9fe0f704a2e2735bb702d392da::big_vector::push_back<Egg>(&mut arg0.lootbox, v3);
    ...
    public fun take<T0>(arg0: &mut Gachapon<T0>, arg1: &mut 0x2::kiosk::Kiosk, arg2: &KeeperCap, arg3: u64) : Egg {
        ...
        assert_valid_kiosk<T0>(arg0, arg1);
        let v0 = 0x73dbea229550ab310c478e4b5fad642792862f9fe0f704a2e2735bb702d392da::big_vector::swap_remove<Egg>(&mut arg0.lootbox, arg3);
        let v1 = EggOut{
            gachapon_id : 0x2::object::id<Gachapon<T0>>(arg0),
    ...
    public fun close<T0>(arg0: Gachapon<T0>, arg1: KeeperCap, arg2: 0x2::kiosk::Kiosk, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        if (!0x73dbea229550ab310c478e4b5fad642792862f9fe0f704a2e2735bb702d392da::big_vector::is_empty<Egg>(&v10)) {
            err_delete_non_empty_gachapon();
        };
        0x73dbea229550ab310c478e4b5fad642792862f9fe0f704a2e2735bb702d392da::big_vector::destroy_empty<Egg>(v10);
    ...
    public fun content_type(arg0: &Egg) : 0x1::option::Option<0x1::type_name::TypeName> {
        let v0 = arg0.content;
        if (0x1::option::is_some<EggContent>(&v0)) {
            let v2 = 0x1::option::destroy_some<EggContent>(v0);
            0x1::option::some<0x1::type_name::TypeName>(v2.obj_type)
        } else {
            0x1::option::destroy_none<EggContent>(v0);
    ...
    public fun create<T0>(arg0: u64, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : KeeperCap {
        ...
        let v4 = Gachapon<T0>{
            ...
            lootbox   : 0x73dbea229550ab310c478e4b5fad642792862f9fe0f704a2e2735bb702d392da::big_vector::new<Egg>(slice_size(), arg2),
    ...
    entry fun draw<T0>(arg0: &mut Gachapon<T0>, arg1: &0x2::random::Random, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0;
        while (v1 < arg2) {
            let v2 = 0x73dbea229550ab310c478e4b5fad642792862f9fe0f704a2e2735bb702d392da::big_vector::swap_remove<Egg>(&mut arg0.lootbox, 0x2::random::generate_u64(&mut v0) % egg_supply<T0>(arg0));
            let v3 = EggOut{
                gachapon_id : 0x2::object::id<Gachapon<T0>>(arg0),
                egg_id      : 0x2::object::id<Egg>(&v2),
                by_taken    : false,
            };
            0x2::event::emit<EggOut>(v3);
            0x2::transfer::transfer<Egg>(v2, arg4);
            v1 = v1 + 1;
        };
    }

    public fun egg_supply<T0>(arg0: &Gachapon<T0>) : u64 {
        0x73dbea229550ab310c478e4b5fad642792862f9fe0f704a2e2735bb702d392da::big_vector::length<Egg>(lootbox<T0>(arg0))
    }
    ...
    public fun lootbox<T0>(arg0: &Gachapon<T0>) : &0x73dbea229550ab310c478e4b5fad642792862f9fe0f704a2e2735bb702d392da::big_vector::BigVector<Egg> {
        &arg0.lootbox
    }
    ...
    public fun redeem_locked<T0, T1: store + key>(arg0: &mut Gachapon<T0>, arg1: &mut 0x2::kiosk::Kiosk, arg2: Egg, arg3: &mut 0x2::tx_context::TxContext) : (T1, 0x2::transfer_policy::TransferRequest<T1>) {
        assert_valid_kiosk<T0>(arg0, arg1);
        let Egg {
            id      : v0,
            content : v1,
        ...
        0x2::kiosk::list<T1>(arg1, &arg0.kiosk_cap, v4, 0);
        let v6 = EggRedeemed<T1>{
            gachapon_id : 0x2::object::id<Gachapon<T0>>(arg0),
            kiosk_id    : 0x2::object::id<0x2::kiosk::Kiosk>(arg1),
            obj_id      : v4,
        };
        0x2::event::emit<EggRedeemed<T1>>(v6);
        0x2::kiosk::purchase<T1>(arg1, v4, 0x2::coin::zero<0x2::sui::SUI>(arg3))
    }
    ...
    public fun redeem_unlocked<T0, T1: store + key>(arg0: &Gachapon<T0>, arg1: &mut 0x2::kiosk::Kiosk, arg2: Egg) : T1 {
        ...
        0x2::event::emit<EggRedeemed<T1>>(v6);
        0x2::kiosk::take<T1>(arg1, &arg0.kiosk_cap, v4)
    }
    ...
    public fun stuff<T0>(arg0: &mut Gachapon<T0>, arg1: &KeeperCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0;
        while (v0 < arg2) {
            0x73dbea229550ab310c478e4b5fad642792862f9fe0f704a2e2735bb702d392da::big_vector::push_back<Egg>(&mut arg0.lootbox, new_empty_egg(arg3));
            v0 = v0 + 1;
        };
