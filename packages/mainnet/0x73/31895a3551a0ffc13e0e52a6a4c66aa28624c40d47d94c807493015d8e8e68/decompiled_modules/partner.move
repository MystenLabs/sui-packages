module 0x7331895a3551a0ffc13e0e52a6a4c66aa28624c40d47d94c807493015d8e8e68::partner {
    ...
    public fun claim_ref_fee<T0>(arg0: &0x7331895a3551a0ffc13e0e52a6a4c66aa28624c40d47d94c807493015d8e8e68::config::GlobalConfig, arg1: &PartnerCap, arg2: &mut Partner, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_partner(arg0: &0x7331895a3551a0ffc13e0e52a6a4c66aa28624c40d47d94c807493015d8e8e68::config::GlobalConfig, arg1: &mut Partners, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: address, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg5 > arg4, 2);
        ...
        0x7331895a3551a0ffc13e0e52a6a4c66aa28624c40d47d94c807493015d8e8e68::config::checked_package_version(arg0);
        0x7331895a3551a0ffc13e0e52a6a4c66aa28624c40d47d94c807493015d8e8e68::config::check_partner_manager_role(arg0, 0x2::tx_context::sender(arg8));
        let v0 = Partner{
    ...
    public fun update_ref_fee_rate(arg0: &0x7331895a3551a0ffc13e0e52a6a4c66aa28624c40d47d94c807493015d8e8e68::config::GlobalConfig, arg1: &mut Partner, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert!(arg2 < 10000, 3);
        0x7331895a3551a0ffc13e0e52a6a4c66aa28624c40d47d94c807493015d8e8e68::config::checked_package_version(arg0);
        0x7331895a3551a0ffc13e0e52a6a4c66aa28624c40d47d94c807493015d8e8e68::config::check_partner_manager_role(arg0, 0x2::tx_context::sender(arg3));
    ...
    public fun update_time_range(arg0: &0x7331895a3551a0ffc13e0e52a6a4c66aa28624c40d47d94c807493015d8e8e68::config::GlobalConfig, arg1: &mut Partner, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 > arg2, 2);
        assert!(arg3 > 0x2::clock::timestamp_ms(arg4) / 1000, 2);
        0x7331895a3551a0ffc13e0e52a6a4c66aa28624c40d47d94c807493015d8e8e68::config::checked_package_version(arg0);
        0x7331895a3551a0ffc13e0e52a6a4c66aa28624c40d47d94c807493015d8e8e68::config::check_partner_manager_role(arg0, 0x2::tx_context::sender(arg5));
