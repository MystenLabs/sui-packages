module 0x739f5f2ff512b3cbe00b8bc77be87d117ab1c4880ff806e8f60d1c6b504a65a5::cnsnft9053 {
    struct CNSNFT9053 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9053, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8422"));
        let v4 = 0x2::package::claim<CNSNFT9053>(arg0, arg1);
