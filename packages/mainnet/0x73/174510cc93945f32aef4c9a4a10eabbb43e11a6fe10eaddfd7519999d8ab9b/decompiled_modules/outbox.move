module 0x73174510cc93945f32aef4c9a4a10eabbb43e11a6fe10eaddfd7519999d8ab9b::outbox {
    struct Outbox<T0: store> has store {
        entries: 0x2::table::Table<OutboxKey, OutboxItem<T0>>,
        rate_limit: 0x73174510cc93945f32aef4c9a4a10eabbb43e11a6fe10eaddfd7519999d8ab9b::rate_limit::RateLimitState,
    }
    ...
    struct OutboxItem<T0> has store {
        ...
        released: 0xfe2b7e6d1cc5d05fa38318dd13c496b04c6c861462bc672c83a77e1fe3209450::bitmap::Bitmap,
        ...
        data: 0xfe2b7e6d1cc5d05fa38318dd13c496b04c6c861462bc672c83a77e1fe3209450::ntt_manager_message::NttManagerMessage<T0>,
    }
    ...
    public fun add<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxItem<T0>) : OutboxKey {
        let v0 = OutboxKey{id: 0xfe2b7e6d1cc5d05fa38318dd13c496b04c6c861462bc672c83a77e1fe3209450::ntt_manager_message::get_id<T0>(&arg1.data)};
    ...
    public(friend) fun new<T0: store>(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : Outbox<T0> {
        Outbox<T0>{
            ...
            rate_limit : 0x73174510cc93945f32aef4c9a4a10eabbb43e11a6fe10eaddfd7519999d8ab9b::rate_limit::new(arg0),
        }
    }

    public fun borrow_data<T0: store>(arg0: &OutboxItem<T0>) : &0xfe2b7e6d1cc5d05fa38318dd13c496b04c6c861462bc672c83a77e1fe3209450::ntt_manager_message::NttManagerMessage<T0> {
        &arg0.data
    }

    public fun borrow_rate_limit_mut<T0: store>(arg0: &mut Outbox<T0>) : &mut 0x73174510cc93945f32aef4c9a4a10eabbb43e11a6fe10eaddfd7519999d8ab9b::rate_limit::RateLimitState {
        &mut arg0.rate_limit
    }
    ...
    public fun new_outbox_item<T0>(arg0: u64, arg1: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg2: 0xfe2b7e6d1cc5d05fa38318dd13c496b04c6c861462bc672c83a77e1fe3209450::ntt_manager_message::NttManagerMessage<T0>) : OutboxItem<T0> {
        OutboxItem<T0>{
            release_timestamp     : arg0,
            released              : 0xfe2b7e6d1cc5d05fa38318dd13c496b04c6c861462bc672c83a77e1fe3209450::bitmap::empty(),
    ...
    public(friend) fun try_release<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxKey, arg2: u8, arg3: &0x2::clock::Clock) : bool {
        ...
        if (0xfe2b7e6d1cc5d05fa38318dd13c496b04c6c861462bc672c83a77e1fe3209450::bitmap::get(&v0.released, arg2)) {
            abort 13906834586660241409
        };
        0xfe2b7e6d1cc5d05fa38318dd13c496b04c6c861462bc672c83a77e1fe3209450::bitmap::enable(&mut v0.released, arg2);
        true
    }
