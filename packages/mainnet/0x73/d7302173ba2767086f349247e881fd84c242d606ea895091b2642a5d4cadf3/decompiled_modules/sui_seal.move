module 0x73d7302173ba2767086f349247e881fd84c242d606ea895091b2642a5d4cadf3::sui_seal {
    ...
    public fun mark_intent_executed<T0>(arg0: &0x73d7302173ba2767086f349247e881fd84c242d606ea895091b2642a5d4cadf3::sui_vault::SuiVault<T0>, arg1: &0x73d7302173ba2767086f349247e881fd84c242d606ea895091b2642a5d4cadf3::sui_vault::SuiLeaderCap, arg2: &mut SealedTradeIntent, arg3: &0x2::clock::Clock) {
        let v0 = 0x2::object::id<0x73d7302173ba2767086f349247e881fd84c242d606ea895091b2642a5d4cadf3::sui_vault::SuiVault<T0>>(arg0);
        assert!(0x73d7302173ba2767086f349247e881fd84c242d606ea895091b2642a5d4cadf3::sui_vault::leader_cap_vault_id(arg1) == v0, 200);
    ...
    entry fun seal_approve_vault_member<T0>(arg0: vector<u8>, arg1: &0x73d7302173ba2767086f349247e881fd84c242d606ea895091b2642a5d4cadf3::sui_vault::SuiVault<T0>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::bcs::new(arg0);
        let v1 = 0x2::bcs::into_remainder_bytes(v0);
        assert!(0x1::vector::length<u8>(&v1) == 0, 202);
        let v2 = 0x2::object::id<0x73d7302173ba2767086f349247e881fd84c242d606ea895091b2642a5d4cadf3::sui_vault::SuiVault<T0>>(arg1);
