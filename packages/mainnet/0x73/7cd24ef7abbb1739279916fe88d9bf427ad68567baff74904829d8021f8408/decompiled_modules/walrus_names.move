module 0x5dd1fb9f784129f0815c8e54ed917ad698401c0900ebeb1525f37fac98a94dda::walrus_names {
    ...
    struct PartnerLaunch has copy, drop {
    ...
    public fun assert_registry_version(arg0: &Registry) {
        assert!(arg0.version == 1, 14);
    }

    public fun assert_treasury_version(arg0: &WalNamesTreasury) {
        assert!(arg0.version == 1, 14);
    }
    ...
    public fun migrate(arg0: &AdminCap, arg1: &mut WalNamesTreasury, arg2: &mut Registry) {
        assert!(arg1.version < 1, 14);
        assert!(arg2.version < 1, 14);
        arg1.version = 1;
        arg2.version = 1;
    }
    ...
    public fun record_partner_launch(arg0: &mut WalNamesTreasury, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 14);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::into_balance<0x2::sui::SUI>(arg3));
        let v0 = PartnerLaunch{
            partner : arg1,
            name    : arg2,
            payer   : 0x2::tx_context::sender(arg4),
            amount  : 0x2::coin::value<0x2::sui::SUI>(&arg3),
        };
        0x2::event::emit<PartnerLaunch>(v0);
    }
    ...
    public fun register(arg0: &mut Registry, arg1: &mut WalNamesTreasury, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, bool>(&arg1.whitelist, v3) && v1 >= 4) {
            0x2::table::remove<address, bool>(&mut arg1.whitelist, v3);
            let v4 = WhitelistRemoved{wallet: v3};
            0x2::event::emit<WhitelistRemoved>(v4);
            ...
            let v5 = registration_fee(arg1.fee_base, v1);
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg4) >= v5, 4);
            0x2::balance::join<0x2::sui::SUI>(&mut arg1.balance, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg4, v5, arg5)));
            if (0x2::coin::value<0x2::sui::SUI>(&arg4) > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg4, v3);
            } else {
                0x2::coin::destroy_zero<0x2::sui::SUI>(arg4);
        ...
        0x2::table::add<0x1::string::String, NameRecord>(&mut arg0.records, arg2, v6);
        ...
        let v8 = NameRegistered{
            name    : v7.name,
            owner   : v3,
            blob_id : 0x2::table::borrow<0x1::string::String, NameRecord>(&arg0.records, v7.name).blob_id,
        };
        0x2::event::emit<NameRegistered>(v8);
        0x2::transfer::transfer<NameCap>(v7, v3);
    }
    ...
    public fun treasury_balance(arg0: &WalNamesTreasury) : u64 {
