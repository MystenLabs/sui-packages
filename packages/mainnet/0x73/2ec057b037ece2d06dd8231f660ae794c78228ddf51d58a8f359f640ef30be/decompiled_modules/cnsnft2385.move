module 0x732ec057b037ece2d06dd8231f660ae794c78228ddf51d58a8f359f640ef30be::cnsnft2385 {
    struct CNSNFT2385 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2385, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2385>(arg0, arg1);
