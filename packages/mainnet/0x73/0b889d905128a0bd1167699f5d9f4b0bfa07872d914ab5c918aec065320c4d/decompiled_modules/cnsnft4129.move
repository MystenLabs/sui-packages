module 0x730b889d905128a0bd1167699f5d9f4b0bfa07872d914ab5c918aec065320c4d::cnsnft4129 {
    struct CNSNFT4129 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4129, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1786"));
        let v4 = 0x2::package::claim<CNSNFT4129>(arg0, arg1);
