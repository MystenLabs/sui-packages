module 0x73027e236c46ad109d6211e2c83bc1020445a869462d3398dae3e4b6f6e84aef::btcs {
    ...
    fun init(arg0: BTCS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/AMQhRaDiwEGPURye7jeVNwzoVGoYuGDDyyw2d72EtRLL.png?claimId=qQfaEzIp1CZGs2kI                                                                                                                                                                                                      ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BTCS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BTCS      ")))), trim_right(b"BTC on SUI                      "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
