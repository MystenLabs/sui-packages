module 0x738b89715a09531115ae251d83447d42ffbec32b586e9b61e6e7c55adcbb31fd::reward5357 {
    struct REWARD5357 has drop {
        dummy_field: bool,
    }

    struct TICKET_5357 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5357(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5357>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5357>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5357, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5357>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5357>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5357>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5357>>(v5, 0x2::tx_context::sender(arg1));
    }
