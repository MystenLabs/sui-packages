module 0x7399985e637f9790738d1361aa52835e26643ac7836729c04394f55191520cd8::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"DIP", b"Buy the dip", b"I love ketchup", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-13T09-50-22.714Z-dipdogketchup-hotdog.gif")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Buy the dip"),
            symbol     : 0x1::string::utf8(b"DIP"),
            decimals   : 9,
