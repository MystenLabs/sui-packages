module 0x73cd042786bfe33e8cacb50b9d1c2b3833dd08bd75cc0aeefc99eba9deb51116::cnsnft4046 {
    struct CNSNFT4046 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4046, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8028"));
        let v4 = 0x2::package::claim<CNSNFT4046>(arg0, arg1);
