module 0x73e4271fee9cd6f07845f536362578550f4ce2330e7ba38dec37261287735164::jk {
    ...
    public fun deepbookswap_0<T0, T1>(arg0: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg1: &0xdee9::custodian_v2::AccountCap, arg2: &0x2::clock::Clock, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let (v0, v1) = 0xdee9::clob_v2::place_market_order<T0, T1>(arg0, arg1, arg3, 0x2::coin::value<T0>(&arg4), false, arg4, 0x2::coin::zero<T1>(arg5), arg2, arg5);
        transfer_or_destroy_zero<T0>(v0, 0x2::tx_context::sender(arg5));
        v1
    }
