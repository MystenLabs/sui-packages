module 0x73385915e6faf7aef254b630a6ed12e7d8690b4e254982d1bfa53cc622c4c96a::bag {
    struct BAG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BAG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://i.imgur.com/xEqESaQ.jpeg                                                                                                                                                                                                                                                                                                ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BAG>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BAG       ")))), trim_right(b"Bag                             "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
