module 0x738e729948d2be93e512f6a22a46d7bb8eccf2074ceab42b26bd7795f5776361::recorder {
    ...
    public(friend) fun add_spent(arg0: &mut Recorder, arg1: address, arg2: u64) {
        ...
        assert!(points_of(arg0, arg1) >= arg2, 0x738e729948d2be93e512f6a22a46d7bb8eccf2074ceab42b26bd7795f5776361::errors::insufficient_points());
    ...
    fun ensure_record_cap_working(arg0: &Recorder, arg1: &RecordCap) {
        assert!(0x2::object::id<RecordCap>(arg1) == arg0.record_cap, 0x738e729948d2be93e512f6a22a46d7bb8eccf2074ceab42b26bd7795f5776361::errors::invalid_record_cap());
    }

    public(friend) fun ensure_version_matches(arg0: &Recorder) {
        assert!(arg0.version == 1, 0x738e729948d2be93e512f6a22a46d7bb8eccf2074ceab42b26bd7795f5776361::errors::wrong_version());
    }
    ...
    public fun record_batch(arg0: &mut Recorder, arg1: &RecordCap, arg2: vector<address>, arg3: vector<u64>) {
        ...
        assert!(v0 == 0x1::vector::length<u64>(&arg3), 0x738e729948d2be93e512f6a22a46d7bb8eccf2074ceab42b26bd7795f5776361::errors::length_mismatch());
        let v1 = 0;
        while (v1 < v0) {
    ...
    fun write_earned(arg0: &mut Recorder, arg1: address, arg2: u64) {
        assert!(arg2 >= earned_of(arg0, arg1), 0x738e729948d2be93e512f6a22a46d7bb8eccf2074ceab42b26bd7795f5776361::errors::invalid_earned());
        if (0x2::table::contains<address, u64>(&arg0.earned, arg1)) {
