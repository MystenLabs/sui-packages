module 0x73c6e1b7c5d852835247d892e17e46756d48bac0b235b5e50241a23cb1a3ab5c::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"MTC", b"Mainnet Test Coin", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-16T07-13-05.264Z-toji-fushiguro-anime-character-mqjc41j5m0opdlf8.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Mainnet Test Coin"),
            symbol     : 0x1::string::utf8(b"MTC"),
            decimals   : 9,
