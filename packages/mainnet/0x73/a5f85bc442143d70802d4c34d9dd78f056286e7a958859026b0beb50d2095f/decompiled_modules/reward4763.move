module 0x73a5f85bc442143d70802d4c34d9dd78f056286e7a958859026b0beb50d2095f::reward4763 {
    struct REWARD4763 has drop {
        dummy_field: bool,
    }

    struct TICKET_4763 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4763(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4763>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4763>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4763, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4763>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4763>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4763>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4763>>(v5, 0x2::tx_context::sender(arg1));
    }
