module 0x73511ba39a22254f8a39f791d96578563c345b73b0b92d087b6a5fd878ed778c::cnsnft3596 {
    struct CNSNFT3596 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3596, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3596>(arg0, arg1);
