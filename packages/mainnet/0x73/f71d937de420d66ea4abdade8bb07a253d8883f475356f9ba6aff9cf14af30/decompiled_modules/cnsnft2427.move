module 0x73f71d937de420d66ea4abdade8bb07a253d8883f475356f9ba6aff9cf14af30::cnsnft2427 {
    struct CNSNFT2427 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2427, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2427>(arg0, arg1);
