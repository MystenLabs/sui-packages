module 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::implements {
    ...
    public(friend) fun swap_out<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        if (arg3) {
            ...
            if (v3) {
                let v10 = v7 * (v2.free_ratio as u64) / 100;
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v9, v10, arg4), v2.burn_address);
                v8 = v7 - v10;
            };
            let v11 = get_fee_to_fundation(v8, v0);
            let v12 = v8 - v11;
            ...
            if (!v3) {
                ...
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut v2.coin_y, v15, arg4), v2.burn_address);
                v14 = v13 - v15;
            };
            assert!(v14 >= arg2, 7);
            0x2::balance::join<T0>(&mut v2.fee_coin_x, 0x2::balance::split<T0>(&mut v9, v11));
