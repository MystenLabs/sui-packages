module 0x593a2e87f393dcb14e0f8c88d587c04e9bc98295e13212e8992343377bf7f313::moonbags {
    ...
    fun init_cetus_aida_pool_inner<T0>(arg0: address, arg1: &mut Pool<T0>, arg2: 0x2::coin::Coin<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg7: &0x2::coin::CoinMetadata<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>, arg8: &0x2::coin::CoinMetadata<T0>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::coin::value<T0>(&arg3) * 10 / 10000;
        if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg3, v0, arg10), arg0);
        };
        let v1 = 0x2::coin::get_icon_url<T0>(arg8);
        let v2 = if (0x1::option::is_some<0x2::url::Url>(&v1)) {
            let v3 = 0x2::coin::get_icon_url<T0>(arg8);
            let v4 = 0x1::option::extract<0x2::url::Url>(&mut v3);
            0x1::string::from_ascii(0x2::url::inner_url(&v4))
        } else {
            0x1::string::utf8(b"")
        };
        let v5 = if (token_gt_aida<T0>()) {
            let (v6, v7, v8) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v2<T0, 0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(arg6, arg5, 200, sqrt(340282366920938463463374607431768211456 * (0x2::coin::value<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(&arg2) as u256) / (0x2::coin::value<T0>(&arg3) as u256)), v2, 4294523696, 443600, arg3, arg2, arg8, arg7, true, arg9, arg10);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v7, arg0);
            0x2::transfer::public_transfer<0x2::coin::Coin<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>>(v8, arg0);
            0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::burn_lp_v2(arg4, v6, arg10)
        } else {
            let (v9, v10, v11) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v2<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA, T0>(arg6, arg5, 200, sqrt(340282366920938463463374607431768211456 * (0x2::coin::value<T0>(&arg3) as u256) / (0x2::coin::value<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(&arg2) as u256)), v2, 4294523696, 443600, arg2, arg3, arg7, arg8, false, arg9, arg10);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v11, arg0);
            0x2::transfer::public_transfer<0x2::coin::Coin<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>>(v10, arg0);
            0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::burn_lp_v2(arg4, v9, arg10)
        };
        0x2::dynamic_object_field::add<vector<u8>, 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::CetusLPBurnProof>(&mut arg1.id, b"burn_proof", v5);
    }
