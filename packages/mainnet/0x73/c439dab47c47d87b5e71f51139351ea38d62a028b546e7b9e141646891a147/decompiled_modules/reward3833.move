module 0x73c439dab47c47d87b5e71f51139351ea38d62a028b546e7b9e141646891a147::reward3833 {
    struct REWARD3833 has drop {
        dummy_field: bool,
    }

    struct TICKET_3833 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3833(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3833>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3833>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3833, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3833>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3833>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3833>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3833>>(v5, 0x2::tx_context::sender(arg1));
    }
