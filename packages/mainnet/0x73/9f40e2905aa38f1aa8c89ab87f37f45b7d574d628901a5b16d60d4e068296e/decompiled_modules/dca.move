module 0x739f40e2905aa38f1aa8c89ab87f37f45b7d574d628901a5b16d60d4e068296e::dca {
    ...
    public fun assert_not_expired<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0x2::clock::Clock) {
        assert!(0x739f40e2905aa38f1aa8c89ab87f37f45b7d574d628901a5b16d60d4e068296e::utils::get_sec(arg1) <= arg0.end_time + 30, 111);
    }

    public fun assert_time_window<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0x2::clock::Clock) {
        assert!(0x739f40e2905aa38f1aa8c89ab87f37f45b7d574d628901a5b16d60d4e068296e::utils::get_sec(arg1) <= get_current_epoch<T0, T1>(arg0, arg1) * arg0.frequency + arg0.deposit_time + 30, 114);
    }
