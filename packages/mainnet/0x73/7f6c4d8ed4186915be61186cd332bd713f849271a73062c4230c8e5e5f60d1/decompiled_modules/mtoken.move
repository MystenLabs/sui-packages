module 0x737f6c4d8ed4186915be61186cd332bd713f849271a73062c4230c8e5e5f60d1::mtoken {
    ...
    struct TestMintEvent has copy, drop {
        to_address: address,
        amount: u64,
    }
    ...
    public fun test_mint<T0>(arg0: &mut State<T0>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::mint<T0>(borrow_treasury_cap_mut<T0>(arg0), arg1, arg3), arg2);
        let v0 = TestMintEvent{
            to_address : arg2,
            amount     : arg1,
        };
        0x2::event::emit<TestMintEvent>(v0);
    }
