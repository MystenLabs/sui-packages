module 0x7385541b99d5c4423e0152ec76cbf2fa0cfaeb60b27e90d99919a34917451f14::suifren_dao {
    ...
    entry fun create_dao<T0: store + key>(arg0: &0x7385541b99d5c4423e0152ec76cbf2fa0cfaeb60b27e90d99919a34917451f14::staking::AdminCap, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Dao<T0>{
            ...
            proposals     : 0x2::table::new<0x2::object::ID, Proposal>(arg7),
