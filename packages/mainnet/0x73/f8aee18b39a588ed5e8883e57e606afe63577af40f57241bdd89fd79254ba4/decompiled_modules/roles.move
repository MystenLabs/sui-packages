module 0x73f8aee18b39a588ed5e8883e57e606afe63577af40f57241bdd89fd79254ba4::roles {
    ...
    public fun check_queue_processor(arg0: &Safe, arg1: &QueueProcessorCap) {
        assert!(arg0.queue_processor_id == 0x2::object::uid_to_inner(&arg1.id), 0x73f8aee18b39a588ed5e8883e57e606afe63577af40f57241bdd89fd79254ba4::errors::inactive_queue_processor());
    }

    public fun check_safe_version(arg0: &Safe) {
        assert!(arg0.version == 0x73f8aee18b39a588ed5e8883e57e606afe63577af40f57241bdd89fd79254ba4::constants::get_version(), 0x73f8aee18b39a588ed5e8883e57e606afe63577af40f57241bdd89fd79254ba4::errors::version_mismatch());
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Safe{
            ...
            queue_created      : false,
            version            : 0x73f8aee18b39a588ed5e8883e57e606afe63577af40f57241bdd89fd79254ba4::constants::get_version(),
        };
