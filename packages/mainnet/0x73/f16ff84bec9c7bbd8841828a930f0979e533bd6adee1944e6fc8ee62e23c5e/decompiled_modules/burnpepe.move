module 0x73f16ff84bec9c7bbd8841828a930f0979e533bd6adee1944e6fc8ee62e23c5e::burnpepe {
    ...
    fun init(arg0: BURNPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BURNPEPE>(arg0, 9, b"BURNPEPE", b"Burn Pepe", b"Burn pepe sui, 100% LP will burn https://t.me/burnpepeSUI , follow our twitter https://twitter.com/burnpepe_sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
        let v2 = v0;
