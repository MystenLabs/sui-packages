module 0x7374864d4b729a425e40f498233c8d8a1253dc7e4a3a0f5e0623a6cd51c9d378::test {
    ...
    fun init(arg0: TEST, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST>(arg0, 5, b"TEST$", b"TEST COIN", b"TEST COIN ON SUI.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://ipfs.io/ipfs/QmNbm298Tu3H1BmuVytxD6HSYCjmhk4j8bMwCNubtaHaCK"))), arg1);
        let v2 = v0;
