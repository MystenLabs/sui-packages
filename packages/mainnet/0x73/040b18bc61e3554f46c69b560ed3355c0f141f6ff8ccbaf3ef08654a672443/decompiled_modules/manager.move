module 0x73040b18bc61e3554f46c69b560ed3355c0f141f6ff8ccbaf3ef08654a672443::manager {
    ...
    public fun transfer(arg0: &mut SpacePoint, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.transferable, 13906835428474093573);
        let v0 = 0x2::table::borrow_mut<address, Point>(&mut arg0.balances, 0x2::tx_context::sender(arg3));
        assert!(v0.owner == 0x2::tx_context::sender(arg3), 13906835441358733313);
        assert!(v0.amount >= arg2, 13906835445654355979);
    ...
    public fun add_minter(arg0: &mut SpacePoint, arg1: address, arg2: &0x2::tx_context::TxContext) {
    ...
    fun check_permission(arg0: &SpacePoint, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(arg0.admin == v0 || v0 == @0x8e5af77d009beba83288e6c9164f0f1b4dc05c2895941842eeec1677935bac20, 13906836171503173633);
    }

    fun consume_signature(arg0: &GalxeTable, arg1: &vector<u8>, arg2: &vector<u8>) {
        let v0 = 0x2::hash::keccak256(arg1);
        let v1 = arg0.public_key;
        assert!(0x2::ed25519::ed25519_verify(arg2, &v1, &v0), 13906836197273501705);
    }
    ...
    entry fun decreasePoint(arg0: &GalxeTable, arg1: &mut SpacePoint, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::tx_context::TxContext) {
        ...
        assert!(!arg1.paused, 13906835333984813061);
        assert!(!0x2::table::contains<u64, bool>(&arg1.has_claimed, arg3), 13906835338279649283);
        assert!(arg5 != 0x1::vector::empty<u8>(), 13906835342574878727);
        ...
        assert!(v3.amount >= arg2, 13906835376934879243);
    ...
    entry fun decreasePoints(arg0: &GalxeTable, arg1: &mut SpacePoint, arg2: vector<u64>, arg3: vector<u64>, arg4: vector<address>, arg5: vector<u8>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::tx_context::TxContext) {
        ...
        while (v3 < 0x1::vector::length<u64>(&arg2)) {
            ...
            assert!(v5.amount >= v4, 13906836089899450379);
    ...
    entry fun increasePoint(arg0: &GalxeTable, arg1: &mut SpacePoint, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!arg1.paused, 13906835157891153925);
        assert!(!0x2::table::contains<u64, bool>(&arg1.has_claimed, arg3), 13906835162185990147);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg6, arg0.treasurer);
        0x2::table::add<u64, bool>(&mut arg1.has_claimed, arg3, true);
    ...
    public fun remove_minter(arg0: &mut SpacePoint, arg1: address, arg2: &0x2::tx_context::TxContext) {
        check_permission(arg0, arg2);
