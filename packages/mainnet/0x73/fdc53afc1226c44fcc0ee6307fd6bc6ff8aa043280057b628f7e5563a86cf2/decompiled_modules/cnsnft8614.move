module 0x73fdc53afc1226c44fcc0ee6307fd6bc6ff8aa043280057b628f7e5563a86cf2::cnsnft8614 {
    struct CNSNFT8614 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8614, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8614>(arg0, arg1);
