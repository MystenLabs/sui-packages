module 0x739a39981f6a32db44543371bc8ea7f856f0abcc0429a79f6d128084b02191b3::coinFlip {
    ...
    public entry fun play_game(arg0: &mut CoinFlip, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1::hash::sha2_256(0x2::object::uid_to_bytes(&v1));
        let v3 = b"lose";
        let v4 = 0;
        let v5 = if (safe_selection(999, &v2) % 2 == 0) {
            b"head"
        } else {
            b"tail"
        };
        ...
        let v9 = History{
            ...
            bet_amount : v0,
            result     : 0x1::string::utf8(v5),
            profit     : v4,
            time       : 0x2::clock::timestamp_ms(arg3),
            winning    : 0x1::string::utf8(v3),
        };
        if (0x2::table::contains<address, 0x2::table::Table<u64, History>>(&arg0.history, 0x2::tx_context::sender(arg4))) {
            0x2::table::add<u64, History>(0x2::table::borrow_mut<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg4)), 0x2::table::length<u64, History>(0x2::table::borrow<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg4))) + 1, v9);
        } else {
            let v10 = 0x2::table::new<u64, History>(arg4);
            0x2::table::add<u64, History>(&mut v10, 1, v9);
            0x2::table::add<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg4), v10);
        };
        0x2::table::add<u64, History>(&mut arg0.history_all, 0x2::table::length<u64, History>(&arg0.history_all) + 1, v9);
        0x2::event::emit<History>(v9);
    }
