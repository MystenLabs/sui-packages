module 0xc660f1bedb30b2c6bb6e491f0492cae64768063063237d29a2f8b893d5a54ddb::dave {
    ...
    public entry fun transfer(arg0: 0x2::coin::Coin<DAVE>, arg1: address) {
        0x2::transfer::public_transfer<0x2::coin::Coin<DAVE>>(arg0, arg1);
    }

    fun init(arg0: DAVE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DAVE>(arg0, 9, b"DAVE", b"dave.sui", b"A completely worthless shitcoin created by dave.sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/rijhC5w.png")), arg1);
        let v2 = v0;
        let v3 = 0x2::tx_context::sender(arg1);
        0x2::coin::mint_and_transfer<DAVE>(&mut v2, 1000000000000000000, v3, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<DAVE>>(v2, v3);
