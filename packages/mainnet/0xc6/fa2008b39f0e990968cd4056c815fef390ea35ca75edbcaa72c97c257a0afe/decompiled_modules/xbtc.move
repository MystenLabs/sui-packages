module 0xc6fa2008b39f0e990968cd4056c815fef390ea35ca75edbcaa72c97c257a0afe::xbtc {
    ...
    fun init(arg0: XBTC, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<XBTC>(arg0, 8, b"xBTC", b"OKX Wrapped BTC", b"A wrapped BTC that is backed 1:1 by Bitcoin (BTC) securely held by OKX", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://static.coinall.ltd/cdn/oksupport/common/20250512-095503.72e1f41d9b9a06.png"))), true, arg1);
        let v3 = XBTCReceiver{
            id       : 0x2::object::new(arg1),
            receiver : @0x0,
        };
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<XBTC>>(v0, @0x87016cddc4e4bbbf62178048fb1cc7051b53d462e95dc276c88557012a050189);
        0x2::transfer::public_transfer<0x2::coin::DenyCapV2<XBTC>>(v1, @0x7ef2da06e687ec88854899307928c0f3508f1e914fa2e4127fb34379a80398cc);
