module 0xc6b5f087beaee003d909fff9e3e02b12c8b3c90e9fda2e9271ca98941186aac4::farm {
    ...
    public fun create_farm<T0>(arg0: &mut FarmRegistry, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v1 + 2592000000;
        let v4 = v0 / 2592000000;
        assert!(v4 > 0, 0);
        let v5 = Farm<T0>{
    ...
    public fun end_farm<T0>(arg0: &mut Farm<T0>, arg1: &0xc6b5f087beaee003d909fff9e3e02b12c8b3c90e9fda2e9271ca98941186aac4::launchpad::LaunchpadConfig, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        update_farm<T0>(arg0, arg2);
        let v0 = if (arg0.reward_supply > arg0.total_distributed) {
        ...
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.rewards_remaining, v2), arg3), 0xc6b5f087beaee003d909fff9e3e02b12c8b3c90e9fda2e9271ca98941186aac4::launchpad::treasury_address(arg1));
        };
        arg0.closed = true;
        let v3 = FarmClosed{
            farm_id              : 0x2::object::id<Farm<T0>>(arg0),
            leftover_to_treasury : v2,
        };
        0x2::event::emit<FarmClosed>(v3);
    }
    ...
    public fun pending_rewards<T0>(arg0: &Farm<T0>, arg1: &Position<T0>, arg2: &0x2::clock::Clock) : u64 {
        ...
        let v1 = if (v0 > arg0.end_ms) {
            arg0.end_ms
        } else {
            v0
        };
        let v2 = if (v1 > arg0.last_update_ms) {
        ...
        let v3 = if (v2) {
            arg0.acc_reward_per_share + ((arg0.reward_rate * (v1 - arg0.last_update_ms)) as u256) * 1000000000000 / (arg0.total_staked as u256)
        } else {
            arg0.acc_reward_per_share
        };
        let v4 = (arg1.stake as u256) * v3 / 1000000000000;
        let v5 = if (v4 > arg1.reward_debt) {
            ((v4 - arg1.reward_debt) as u64)
        } else {
            0
        };
        arg1.pending + v5
    ...
    public fun stake<T0>(arg0: &mut Farm<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : Position<T0> {
        assert!(0x2::clock::timestamp_ms(arg2) < arg0.end_ms, 2);
    ...
    public fun stake_more<T0>(arg0: &mut Farm<T0>, arg1: &mut Position<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.farm_id == 0x2::object::id<Farm<T0>>(arg0), 4);
        assert!(0x2::clock::timestamp_ms(arg3) < arg0.end_ms, 2);
        let v0 = 0x2::coin::value<T0>(&arg2);
        assert!(v0 > 0, 0);
    ...
    fun update_farm<T0>(arg0: &mut Farm<T0>, arg1: &0x2::clock::Clock) {
        ...
        if (v1 <= arg0.last_update_ms) {
            return
        };
        if (arg0.total_staked > 0 && arg0.reward_rate > 0) {
            let v2 = arg0.reward_rate * (v1 - arg0.last_update_ms);
            arg0.acc_reward_per_share = arg0.acc_reward_per_share + (v2 as u256) * 1000000000000 / (arg0.total_staked as u256);
            arg0.total_distributed = arg0.total_distributed + v2;
        };
        arg0.last_update_ms = v1;
    }
