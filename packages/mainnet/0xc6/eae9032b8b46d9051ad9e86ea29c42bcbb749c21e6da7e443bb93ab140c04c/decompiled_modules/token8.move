module 0xc6eae9032b8b46d9051ad9e86ea29c42bcbb749c21e6da7e443bb93ab140c04c::token8 {
    ...
    fun init(arg0: TOKEN8, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN8>(arg0, 9, b"rewardclub.online", b"rewardclub.online", b"", 0x1::option::none<0x2::url::Url>(), arg1);
