module 0xc662acc153210b67336dbe28914b40410349b976a5afee6016b92fb8d53629c4::my_nft {
    ...
    fun init(arg0: MY_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://avatars.githubusercontent.com/u/8800287?s=400&v=4"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{image_url}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"My first Sui NFT!"));
        ...
        let v6 = MyNFT{
            ...
            image_url : 0x1::string::utf8(b"https://avatars.githubusercontent.com/u/8800287?s=400&v=4"),
        };
    ...
    public entry fun mintToUVD(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = MyNFT{
            id        : 0x2::object::new(arg0),
            name      : 0x1::string::utf8(b"operaxxx nft"),
            image_url : 0x1::string::utf8(b"https://avatars.githubusercontent.com/u/8800287?s=400&v=4"),
        };
