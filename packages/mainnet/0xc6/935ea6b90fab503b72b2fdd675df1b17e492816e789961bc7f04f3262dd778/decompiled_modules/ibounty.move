module 0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::ibounty {
    ...
    public(friend) fun claim_reward(arg0: &mut BattleSessionRegistry, arg1: 0x2::object::ID) : u128 {
        let (_, v1) = 0x1::vector::index_of<0x2::object::ID>(&arg0.active_bounty_session, &arg1);
    ...
    public(friend) fun close_bounty(arg0: &mut BattleSessionRegistry, arg1: 0x2::object::ID, arg2: 0x2::object::ID) : u128 {
        let v0 = remove_active_session(arg0, arg2);
        if (v0 == 1) {
            let v2 = 0x2::table::remove<0x2::object::ID, BattleBountySession>(&mut arg0.bounty_assign_to_target, arg2);
            let (_, v4) = 0x2::vec_map::remove<0x2::object::ID, u128>(&mut v2.reward, &arg1);
            v4
        } else {
            let v5 = 0x2::table::borrow_mut<0x2::object::ID, BattleBountySession>(&mut arg0.bounty_assign_to_target, arg2);
            let (v6, v7) = 0x1::vector::index_of<0x2::object::ID>(&v5.bounty_assign_by, &arg1);
            if (v6) {
                0x1::vector::remove<0x2::object::ID>(&mut v5.bounty_assign_by, v7);
            };
            v5.count = v5.count - 1;
            let (_, v9) = 0x2::vec_map::remove<0x2::object::ID, u128>(&mut v5.reward, &arg1);
            v5.total_reward = v5.total_reward - v9;
            v9
        }
    }
    ...
    public(friend) fun pay_off_bounty(arg0: &mut BattleSessionRegistry, arg1: 0x2::object::ID, arg2: 0x2::object::ID) {
        ...
        if (0x2::vec_map::length<0x2::object::ID, u128>(&v0.reward) != 1) {
            let (_, _) = 0x2::vec_map::remove<0x2::object::ID, u128>(&mut v0.reward, &arg2);
        } else {
            let (_, v4) = 0x1::vector::index_of<0x2::object::ID>(&arg0.active_bounty_session, &arg1);
            0x1::vector::remove<0x2::object::ID>(&mut arg0.active_bounty_session, v4);
            0x2::table::remove<0x2::object::ID, BattleBountySession>(&mut arg0.bounty_assign_to_target, arg1);
        };
    }

    fun remove_active_session(arg0: &mut BattleSessionRegistry, arg1: 0x2::object::ID) : u8 {
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, BattleBountySession>(&mut arg0.bounty_assign_to_target, arg1);
        if (v0.count == 1) {
            let (v1, v2) = 0x1::vector::index_of<0x2::object::ID>(&arg0.active_bounty_session, &arg1);
            if (v1) {
                0x1::vector::remove<0x2::object::ID>(&mut arg0.active_bounty_session, v2);
            };
        };
        v0.count
    }
    ...
    public(friend) fun toggle_pause(arg0: &mut BattleSessionRegistry) {
        if (arg0.paused) {
            arg0.paused = false;
        } else {
            arg0.paused = true;
