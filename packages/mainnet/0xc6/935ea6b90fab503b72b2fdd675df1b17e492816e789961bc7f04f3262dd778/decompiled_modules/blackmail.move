module 0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::blackmail {
    ...
    public(friend) fun calculate_success_chance(arg0: bool, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u8, arg8: u64, arg9: &0x2::random::Random, arg10: &mut 0x2::tx_context::TxContext) : (u64, bool) {
        ...
        let v3 = 0x1::u64::max(0x1::u64::min(arg6, v0), arg5);
        (v3, flip_coin(arg9, v3, arg10))
    }
    ...
    public fun record_blackmail(arg0: &0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::crimes_authority::CrimesCap, arg1: &0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::crimes_version::Version, arg2: u64, arg3: u64, arg4: &mut 0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::iblackmail::PlayerBlackmailInfo, arg5: &0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::iblackmail::PlayerBlackmailInfo, arg6: &0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::iblackmail::BlackmailType, arg7: &0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::iblackmail::BlackmailRegistry, arg8: u128, arg9: &0x2::random::Random, arg10: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, 0x1::string::String, u128, bool) {
        0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::crimes_version::validate_version(arg1);
        let v0 = 0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::iblackmail::borrow_blackmail_resource_type(arg6);
        let v1 = 0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::iblackmail::borrow_blackmail_registry(arg7);
        let (v2, v3) = find_player_level_difference(arg2, arg3);
        let (v4, v5) = calculate_success_chance(get_hidden_resource_match(0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::iblackmail::get_blackmail_defending_resource(arg5), v0), *0x1::vector::borrow<u64>(&v1, 4), *0x1::vector::borrow<u64>(&v1, 5), *0x1::vector::borrow<u64>(&v1, 6), *0x1::vector::borrow<u64>(&v1, 7), *0x1::vector::borrow<u64>(&v1, 8), *0x1::vector::borrow<u64>(&v1, 9), v2, v3, arg9, arg10);
        let (v6, v7) = if (v5) {
        ...
        if (v5 && v13 >= 1 * 0x1::u128::pow(2, 64)) {
            0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::iblackmail::set_blackmail_success_count(arg4, 1);
        } else {
            0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::iblackmail::set_blackmail_failed_count(arg4, 1);
        };
