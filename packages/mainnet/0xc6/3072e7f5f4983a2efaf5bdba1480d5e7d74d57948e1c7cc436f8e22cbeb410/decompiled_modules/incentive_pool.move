module 0x41c0788f4ab64cf36dc882174f467634c033bf68c3c1b5ef9819507825eb510b::incentive_pool {
    ...
    struct IncentivePools<phantom T0> has store, key {
        ...
        reward_pool: 0x41c0788f4ab64cf36dc882174f467634c033bf68c3c1b5ef9819507825eb510b::reward_pool::RewardPool<T0>,
    }

    struct IncentivePoolRewardFeeKey has copy, drop, store {
        dummy_field: bool,
    }

    struct IncentivePoolRewardFee has store {
        fee_rate_numerator: u64,
        fee_rate_denominator: u64,
        recipient: address,
    }

    struct IncentivePoolRewardBalanceKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public(friend) fun add_rewards<T0>(arg0: &mut IncentivePools<T0>, arg1: 0x2::balance::Balance<T0>) {
        ...
        let v0 = IncentivePoolRewardBalanceKey{dummy_field: false};
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<IncentivePoolRewardBalanceKey, 0x2::balance::Balance<T0>>(&mut arg0.id, v0), arg1);
    }
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut IncentivePools<T0>, arg1: u64) : (u64, 0x2::balance::Balance<T0>) {
        let (v0, v1) = 0x41c0788f4ab64cf36dc882174f467634c033bf68c3c1b5ef9819507825eb510b::reward_pool::claim_reward<T0>(&mut arg0.reward_pool, remaining_rewards<T0>(arg0), arg1);
        (v0, take_rewards<T0>(arg0, v1))
    }
    ...
    public(friend) fun create_incentive_pools<T0>(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : IncentivePools<T0> {
        IncentivePools<T0>{
            ...
            reward_pool : 0x41c0788f4ab64cf36dc882174f467634c033bf68c3c1b5ef9819507825eb510b::reward_pool::new<T0>(arg0, arg1),
        }
    }

    fun create_rewards_balance_if_not_exists<T0>(arg0: &mut IncentivePools<T0>) {
        let v0 = IncentivePoolRewardBalanceKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<IncentivePoolRewardBalanceKey>(&arg0.id, v0)) {
            let v1 = IncentivePoolRewardBalanceKey{dummy_field: false};
            0x2::dynamic_field::add<IncentivePoolRewardBalanceKey, 0x2::balance::Balance<T0>>(&mut arg0.id, v1, 0x2::balance::zero<T0>());
        };
    }
    ...
    public fun pool_types<T0>(arg0: &IncentivePools<T0>) : 0x2::vec_set::VecSet<0x1::type_name::TypeName> {
        arg0.pool_types
    }

    public fun pools<T0>(arg0: &IncentivePools<T0>) : &0x2::table::Table<0x1::type_name::TypeName, IncentivePool> {
        &arg0.pools
    }

    public fun remaining_rewards<T0>(arg0: &IncentivePools<T0>) : u64 {
        let v0 = IncentivePoolRewardBalanceKey{dummy_field: false};
        0x2::balance::value<T0>(0x2::dynamic_field::borrow<IncentivePoolRewardBalanceKey, 0x2::balance::Balance<T0>>(&arg0.id, v0))
    }

    public fun reward_fee<T0>(arg0: &IncentivePools<T0>) : (u64, u64) {
        let v0 = IncentivePoolRewardFeeKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<IncentivePoolRewardFeeKey>(&arg0.id, v0)) {
            let v3 = IncentivePoolRewardFeeKey{dummy_field: false};
            let v4 = 0x2::dynamic_field::borrow<IncentivePoolRewardFeeKey, IncentivePoolRewardFee>(&arg0.id, v3);
    ...
    public fun reward_fee_recipient<T0>(arg0: &IncentivePools<T0>) : address {
        let v0 = IncentivePoolRewardFeeKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<IncentivePoolRewardFeeKey>(&arg0.id, v0), 0);
        let v1 = IncentivePoolRewardFeeKey{dummy_field: false};
        0x2::dynamic_field::borrow<IncentivePoolRewardFeeKey, IncentivePoolRewardFee>(&arg0.id, v1).recipient
    }

    public fun reward_pool<T0>(arg0: &IncentivePools<T0>) : &0x41c0788f4ab64cf36dc882174f467634c033bf68c3c1b5ef9819507825eb510b::reward_pool::RewardPool<T0> {
        &arg0.reward_pool
    }
    ...
    public(friend) fun take_old_rewards<T0>(arg0: &mut IncentivePools<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        0x41c0788f4ab64cf36dc882174f467634c033bf68c3c1b5ef9819507825eb510b::reward_pool::take_old_reward<T0>(&mut arg0.reward_pool, arg1)
    }

    public(friend) fun take_rewards<T0>(arg0: &mut IncentivePools<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = IncentivePoolRewardBalanceKey{dummy_field: false};
        0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<IncentivePoolRewardBalanceKey, 0x2::balance::Balance<T0>>(&mut arg0.id, v0), arg1)
    }
    ...
    public(friend) fun update_reward_fee<T0>(arg0: &mut IncentivePools<T0>, arg1: u64, arg2: u64, arg3: address) {
        let v0 = IncentivePoolRewardFeeKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<IncentivePoolRewardFeeKey>(&arg0.id, v0)) {
            let v1 = IncentivePoolRewardFeeKey{dummy_field: false};
            let v2 = 0x2::dynamic_field::borrow_mut<IncentivePoolRewardFeeKey, IncentivePoolRewardFee>(&mut arg0.id, v1);
            v2.fee_rate_numerator = arg1;
            v2.fee_rate_denominator = arg2;
            v2.recipient = arg3;
        } else {
            let v3 = IncentivePoolRewardFee{
                fee_rate_numerator   : arg1,
                fee_rate_denominator : arg2,
                recipient            : arg3,
            };
            let v4 = IncentivePoolRewardFeeKey{dummy_field: false};
            0x2::dynamic_field::add<IncentivePoolRewardFeeKey, IncentivePoolRewardFee>(&mut arg0.id, v4, v3);
        };
    }

    public(friend) fun update_reward_pool<T0>(arg0: &mut IncentivePools<T0>, arg1: u64, arg2: u64) {
        0x41c0788f4ab64cf36dc882174f467634c033bf68c3c1b5ef9819507825eb510b::reward_pool::update_reward_pool<T0>(&mut arg0.reward_pool, arg1, arg2);
    }
