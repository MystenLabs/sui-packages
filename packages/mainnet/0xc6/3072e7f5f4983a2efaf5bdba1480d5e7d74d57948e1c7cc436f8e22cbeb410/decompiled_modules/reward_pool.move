module 0x41c0788f4ab64cf36dc882174f467634c033bf68c3c1b5ef9819507825eb510b::reward_pool {
    ...
    public(friend) fun add_reward<T0>(arg0: &mut RewardPool<T0>, arg1: 0x2::balance::Balance<T0>) {
        abort 0x41c0788f4ab64cf36dc882174f467634c033bf68c3c1b5ef9819507825eb510b::app_error::deprecated()
    }
    ...
    public(friend) fun claim_reward<T0>(arg0: &mut RewardPool<T0>, arg1: u64, arg2: u64) : (u64, u64) {
        let v0 = 0x2::math::min(calculate_points_to_reward<T0>(arg0, arg2), arg1);
        arg0.claimed_rewards = arg0.claimed_rewards + v0;
        (calculate_reward_to_points<T0>(arg0, v0), v0)
    }
    ...
    public(friend) fun take_old_reward<T0>(arg0: &mut RewardPool<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
