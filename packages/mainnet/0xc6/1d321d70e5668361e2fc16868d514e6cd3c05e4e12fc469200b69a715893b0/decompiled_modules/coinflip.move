module 0xc61d321d70e5668361e2fc16868d514e6cd3c05e4e12fc469200b69a715893b0::coinflip {
    ...
    public fun join(arg0: &mut HouseData, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x1::string::String, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::clock::timestamp_ms(arg4) > arg0.round_begin_date + 86400) {
            ...
            0x2::event::emit<NewRound>(v1);
        };
        let v2 = 0x2::coin::zero<0x2::sui::SUI>(arg5);
        0x2::pay::join<0x2::sui::SUI>(&mut v2, arg1);
        let v3 = v0 / 100 * 40;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v3, arg0.static_arrange, arg5);
        let v4 = get_mut_account(arg0, 0x2::tx_context::sender(arg5));
        v4.contributed = v4.contributed + v0;
        if (v4.refer == @0x0) {
            v4.refer = arg3;
        };
        let v5 = v0 / 100 * 5;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v5, arg0.g1, arg5);
        let v6 = v0 / 100 * 4;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v6, arg0.g2, arg5);
        let v7 = v0 / 100 * 3;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v7, arg0.g3, arg5);
        let v8 = v0 / 100 * 2;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v8, arg0.g4, arg5);
        let v9 = v0 / 100 * 1;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v9, arg0.g5, arg5);
        let v10 = v0 / 100 * 3;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v10, arg0.node, arg5);
        let v11 = v0 / 100 * 8;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v11, arg0.fund, arg5);
        let v12 = v0 / 1000 * 15;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v12, arg0.top_refers, arg5);
        let v13 = v0 / 1000 * 15;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v13, arg0.top_order, arg5);
        let v14 = v0 / 1000 * 15;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v14, arg0.week_performance, arg5);
        let v15 = v0 / 1000 * 15;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v15, arg0.daily_award, arg5);
        let v16 = v0 / 100;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v16, arg0.insurance, arg5);
        let v17 = v0 / 100 * 5;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v17, arg0.operation, arg5);
        let v18 = v0 / 100 * 2;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v18, arg0.ecosys, arg5);
        if (arg0.bank == @0x0) {
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::into_balance<0x2::sui::SUI>(v2));
        } else {
            0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v2, v0 - v3 - v5 - v6 - v7 - v8 - v9 - v10 - v11 - v12 - v13 - v14 - v15 - v16 - v17 - v18, arg0.bank, arg5);
        ...
        let v19 = get_mut_account(arg0, 0x2::tx_context::sender(arg5));
        v19.contributed = v19.contributed + v0;
        let v20 = JoinGame{
            round         : arg0.round,
