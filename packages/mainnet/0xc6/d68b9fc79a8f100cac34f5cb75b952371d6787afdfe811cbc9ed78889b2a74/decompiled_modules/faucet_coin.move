module 0xc6d68b9fc79a8f100cac34f5cb75b952371d6787afdfe811cbc9ed78889b2a74::faucet_coin {
    ...
    fun init(arg0: FAUCET_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCET_COIN>(arg0, 8, b"MKSNMRF", b"Maki Sonomura's Faucet Coin", b"Nothing", 0x1::option::none<0x2::url::Url>(), arg1);
