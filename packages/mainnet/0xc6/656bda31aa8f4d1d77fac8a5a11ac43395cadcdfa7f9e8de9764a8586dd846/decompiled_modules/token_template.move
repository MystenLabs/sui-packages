module 0xc6656bda31aa8f4d1d77fac8a5a11ac43395cadcdfa7f9e8de9764a8586dd846::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"BT1087802", b"BatchToken1 087802", b"First parallel deployment", 0x1::option::none<0x2::url::Url>(), arg1);
