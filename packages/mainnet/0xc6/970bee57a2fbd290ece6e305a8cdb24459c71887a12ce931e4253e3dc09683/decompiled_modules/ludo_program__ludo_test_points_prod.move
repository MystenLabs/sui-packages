module 0xc6970bee57a2fbd290ece6e305a8cdb24459c71887a12ce931e4253e3dc09683::ludo_program__ludo_test_points_prod {
    ...
    fun init(arg0: LUDO_PROGRAM__LUDO_TEST_POINTS_PROD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::token::new_policy<LUDO_PROGRAM__LUDO_TEST_POINTS_PROD>(&v0, arg1);
        let v3 = v2;
        let v4 = v1;
        0x746d4e65fe817d0528d097a5e44de2a2266373fb45dc902886a870ad664188a0::core::set_rules<LUDO_PROGRAM__LUDO_TEST_POINTS_PROD>(&mut v4, &v3, arg1);
        0x746d4e65fe817d0528d097a5e44de2a2266373fb45dc902886a870ad664188a0::core::create_protected_treasury_policy_caps<LUDO_PROGRAM__LUDO_TEST_POINTS_PROD>(v0, v3, arg1);
        0x2::token::share_policy<LUDO_PROGRAM__LUDO_TEST_POINTS_PROD>(v4);
    }
