module 0xc6f981bb7d069d0efb19514aa94ce27f4a9ff1dbb76e0d0fe2934b770a7f2c56::aaeb58f742bb7d09d {
    ...
    public(friend) fun a2daef4381117fe2e(arg0: &0xc6f981bb7d069d0efb19514aa94ce27f4a9ff1dbb76e0d0fe2934b770a7f2c56::a783956f993d811bc::A0ea878587b719a64, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &vector<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>, arg3: u64, arg4: &0x2::clock::Clock) : Aacc01655d0dfbab1 {
        ...
        while (v8 < 0x1::vector::length<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(arg2)) {
            ...
            let (v10, v11, _) = 0xc6f981bb7d069d0efb19514aa94ce27f4a9ff1dbb76e0d0fe2934b770a7f2c56::a10868438248226c1::a726fc82fd84e5e03(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::order_id(v9));
            let v13 = v11;
            if (v10) {
        ...
        while (v22 < 0x1::vector::length<u64>(&v7)) {
            if (*0x1::vector::borrow<u64>(&v6, v22) < 0xc6f981bb7d069d0efb19514aa94ce27f4a9ff1dbb76e0d0fe2934b770a7f2c56::a783956f993d811bc::ad2616e93a0796e5b(arg0)) {
                v22 = v22 + 1;
            } else {
                break
            };
        ...
        while (v23 < 0x1::vector::length<u64>(&v5)) {
            if (*0x1::vector::borrow<u64>(&v4, v23) < 0xc6f981bb7d069d0efb19514aa94ce27f4a9ff1dbb76e0d0fe2934b770a7f2c56::a783956f993d811bc::ad2616e93a0796e5b(arg0)) {
                v23 = v23 + 1;
            } else {
                break
            };
    ...
    public(friend) fun ad2b2505b5ae4a829(arg0: &Aacc01655d0dfbab1, arg1: &0xc6f981bb7d069d0efb19514aa94ce27f4a9ff1dbb76e0d0fe2934b770a7f2c56::a783956f993d811bc::A0ea878587b719a64, arg2: u64, arg3: bool, arg4: u64) : u64 {
        if (arg3) {
            let v0 = 0;
            while (v0 < 0x1::vector::length<u64>(&arg0.a49526e8be3cf123e)) {
                ...
                if (*0x1::vector::borrow<u64>(&arg0.aa784e08665117e43, v0) < 0xc6f981bb7d069d0efb19514aa94ce27f4a9ff1dbb76e0d0fe2934b770a7f2c56::a783956f993d811bc::ad2616e93a0796e5b(arg1)) {
                    v0 = v0 + 1;
                    continue
                };
                return v1 + arg4
            ...
            while (v2 < 0x1::vector::length<u64>(&arg0.afc35d9b0ccb52fbe)) {
                ...
                if (*0x1::vector::borrow<u64>(&arg0.a650b4a54924e6b42, v2) < 0xc6f981bb7d069d0efb19514aa94ce27f4a9ff1dbb76e0d0fe2934b770a7f2c56::a783956f993d811bc::ad2616e93a0796e5b(arg1)) {
                    v2 = v2 + 1;
                    continue
                };
                return v3 - arg4
