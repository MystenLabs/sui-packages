module 0xc63f10aea8ef8dd6e1201aadc1e82283a88e0edb205d8082faca6ffc7d20f007::gift4348 {
    struct GIFT4348 has drop {
        dummy_field: bool,
    }

    struct TICKET_4348 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4348(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4348>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4348>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4348, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4348>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4348>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4348>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4348>>(v5, 0x2::tx_context::sender(arg1));
    }
