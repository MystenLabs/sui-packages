module 0xc60dab8a6cd56ca6a4dfba8a7e9eb1d8ee4ccefd8ed86ea1fc79947399ec8e04::reward5585 {
    struct REWARD5585 has drop {
        dummy_field: bool,
    }

    struct TICKET_5585 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5585(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5585>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5585>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5585, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5585>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5585>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5585>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5585>>(v5, 0x2::tx_context::sender(arg1));
    }
