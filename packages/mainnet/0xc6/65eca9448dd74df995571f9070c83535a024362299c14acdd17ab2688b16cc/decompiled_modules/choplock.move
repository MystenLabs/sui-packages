module 0xbfc8310ded6a444807564c0f3e34681b68594fd74b716b2ad9ee71ecaf7119c3::choplock {
    ...
    public fun last_updated<T0>(arg0: &LockedTokens<T0>) : u64 {
        arg0.last_updated
    }
    ...
    public fun locker_id<T0>(arg0: &LockedTokens<T0>) : 0x2::object::ID {
    ...
    public fun unlockChopLockers<T0>(arg0: LockedTokens<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let LockedTokens {
            id                 : v0,
            owner              : v1,
            tokens             : v2,
