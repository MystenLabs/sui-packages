module 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::alphapool {
    ...
    public fun deposit<T0>(arg0: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::version::Version, arg1: 0x1::option::Option<Receipt>, arg2: &mut Pool<T0>, arg3: &mut 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<Receipt> {
        ...
        if (0x1::option::is_some<Receipt>(&arg1) == true) {
            if (0x1::option::borrow<Receipt>(&arg1).owner != 0x2::tx_context::sender(arg6)) {
                0x2::transfer::public_transfer<Receipt>(0x1::option::extract<Receipt>(&mut arg1), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::get_onhold_receipts_wallet_address(arg3));
        ...
        let v2 = (0x2::balance::value<T0>(&v1) as u128) * (arg2.deposit_fee as u128) / 10000;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v1, (v2 as u64)), arg6), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::get_fee_wallet_address(arg3));
        let v3 = 0x2::balance::value<T0>(&v1);
        arg2.tokensInvested = arg2.tokensInvested + v3;
        ...
        let v5 = (v4 as u64);
        let v6 = arg2.locking_start_ms + arg2.locked_period_in_ms;
        let v7 = if (0x1::option::is_some<Receipt>(&arg1) == true) {
            let v8 = 0x1::option::extract<Receipt>(&mut arg1);
            let v9 = &mut v8;
            update_user_rewards_all<T0>(v9, arg2);
            v8.xTokenBalance = v8.xTokenBalance + (v5 as u64);
            if (0x2::linked_table::contains<u64, u64>(&v8.locked_balance, v6) == true) {
                let v10 = 0x2::linked_table::borrow_mut<u64, u64>(&mut v8.locked_balance, v6);
                *v10 = *v10 + v5;
            } else {
                let v11 = &mut v8;
                insert_to_locked_balance(v11, v6, v5, arg6);
            };
            v8
        } else {
            ...
            0x2::linked_table::push_back<u64, u64>(&mut v17, v6, v5);
            Receipt{id: 0x2::object::new(arg6), owner: 0x2::tx_context::sender(arg6), name: 0x1::string::utf8(arg2.name), image_url: 0x1::string::utf8(arg2.image_url), pool_id: 0x2::object::uid_to_inner(&arg2.id), xTokenBalance: (v4 as u64), last_acc_reward_per_xtoken: v12, locked_balance: v17, unlocked_xtokens: 0, pending_rewards: v13}
        };
        let v18 = v7;
        0x1::option::destroy_none<Receipt>(arg1);
        ...
        check_locked_balance(&v18);
        0x1::option::some<Receipt>(v18)
    }

    fun destroy_receipt_and_transfer_rewards<T0>(arg0: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::version::Version, arg1: Receipt, arg2: &mut Pool<T0>, arg3: &mut 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::version::assert_current_version(arg0);
        assert!(arg1.xTokenBalance < 2, 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::error::receipt_not_empty());
        let v0 = &mut arg1;
    ...
    fun get_rewards<T0, T1>(arg0: &mut Pool<T0>, arg1: &mut 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 == 0x1::type_name::get<0x3813ca8aa2849b6369106ea749b0bdc5d72a671a267bf55a4be68c6c86fb911f::beta::BETA>()) {
            ...
            let v5 = 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::get_rewards<T1>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3);
    ...
    entry fun set_instant_withdraw_fee<T0>(arg0: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::AdminCap, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::version::Version, arg2: &mut Pool<T0>, arg3: u64) {
        0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::version::assert_current_version(arg1);
        assert!(arg3 <= arg2.instant_withdraw_fee_max_cap, 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::error::fee_too_high_error());
        arg2.instant_withdraw_fee = arg3;
    }

    entry fun set_lock_period_in_ms<T0>(arg0: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::AdminCap, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::version::Version, arg2: &mut Pool<T0>, arg3: u64) {
        0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::version::assert_current_version(arg1);
    ...
    entry fun set_performance_fee<T0>(arg0: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::AdminCap, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::version::Version, arg2: &mut Pool<T0>, arg3: u64) {
        0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::version::assert_current_version(arg1);
    ...
    public fun withdraw<T0>(arg0: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::version::Version, arg1: Receipt, arg2: &mut Pool<T0>, arg3: &mut 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg4: u64, arg5: &0x2::clock::Clock, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<Receipt> {
        ...
        if (arg6 == true) {
            assert!(arg4 <= (((arg1.xTokenBalance as u256) * v1 / (1000000000000000000000000000000000000 as u256)) as u64), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::error::insufficient_balance_error());
        } else {
            assert!(arg4 <= (v3 as u64), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::error::insufficient_balance_error());
        };
        ...
        if (arg4 > (v3 as u64)) {
            ...
            v5 = (v6 as u128) * (arg2.instant_withdraw_fee as u128) / 10000;
        } else {
        ...
        let v9 = ((((arg4 - (v5 as u64)) as u128) * (arg2.withdrawal_fee as u128) / 10000) as u64) + (v5 as u64);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg2.alpha_bal, v9), arg7), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::get_fee_wallet_address(arg3));
