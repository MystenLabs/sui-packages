module 0xf3d61bec8382328f2cf8afe0aa827946141f91c9cb666736c0a8690a1f5c6331::exchange {
    ...
    public fun admin_swap_a_to_b_with_custodial_account<T0, T1>(arg0: &mut AdminSettings, arg1: &mut CustodialPoolsIndex, arg2: 0x2::object::ID, arg3: &mut FeeCollector, arg4: u64, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        assert_valid_version(arg0);
        assert_valid_custodial_version(arg1);
        assert_is_manager(arg1, arg6);
        let v0 = get_curve_mut<T0, T1>(arg0, arg2);
        ...
        deposit_custodial_pool<T1>(arg1, arg5, v11, arg6);
    }

    public fun admin_swap_b_to_a_with_custodial_account<T0, T1>(arg0: &mut AdminSettings, arg1: &mut CustodialPoolsIndex, arg2: 0x2::object::ID, arg3: &mut FeeCollector, arg4: u64, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        assert_valid_version(arg0);
        assert_valid_custodial_version(arg1);
        assert_is_manager(arg1, arg6);
        let v0 = get_curve_mut<T0, T1>(arg0, arg2);
        ...
        deposit_custodial_pool<T0>(arg1, arg5, v11, arg6);
    }
