module 0xc6a2f4a8997ba8a9ebb854a6565c9a8b2fa623b6be5c6a3d426b6ffdbaab40f2::LADYS {
    struct LADYS has drop {
        dummy_field: bool,
    }

    fun init(arg0: LADYS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<LADYS>(arg0, 2, b"LADYS", b"Milady", b"Milady", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/z0yWtDbwFG4GtyFOhL7gdQ687buovhnHIZ51Lm8wISY?ext=png")), arg1);
