module 0xc6fa932178703e70509b8e7b0f3c971550cd4e3cd2c70f58311fa0dff17d14f5::cnsnft8203 {
    struct CNSNFT8203 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8203, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8203>(arg0, arg1);
