module 0xc6ed2e597e789cca38979f0787190cf0aaa33753f3789f497ded7ee5f1c9d6a1::reward7332 {
    struct REWARD7332 has drop {
        dummy_field: bool,
    }

    struct TICKET_7332 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7332(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7332>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7332>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7332, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7332>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7332>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7332>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7332>>(v5, 0x2::tx_context::sender(arg1));
    }
