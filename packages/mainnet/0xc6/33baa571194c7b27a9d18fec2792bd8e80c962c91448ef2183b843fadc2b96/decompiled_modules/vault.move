module 0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::vault {
    ...
    struct SuiX5Vault has key {
        ...
        usdc_reserve: u64,
        suix5_treasury: 0x2::coin::TreasuryCap<0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::suix5::SUIX5>,
        suix5_supply: u64,
        oracle: 0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::oracle::OracleConfig,
        composition: 0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::composition::Composition,
    ...
    entry fun register_feed<T0>(arg0: &mut SuiX5Vault, arg1: vector<u8>, arg2: u8, arg3: &0x2::tx_context::TxContext) {
        ...
        0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::oracle::register_feed<T0>(&mut arg0.oracle, arg1, arg2);
    }
    ...
    entry fun remove_feed<T0>(arg0: &mut SuiX5Vault, arg1: &0x2::tx_context::TxContext) {
        ...
        0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::oracle::remove_feed<T0>(&mut arg0.oracle);
    }

    entry fun reset_breaker<T0>(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
        0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::oracle::reset_breaker<T0>(&mut arg0.oracle, arg2);
    }
    ...
    public(friend) fun burn_suix5(arg0: &mut SuiX5Vault, arg1: 0x2::coin::Coin<0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::suix5::SUIX5>) : u64 {
        let v0 = 0x2::coin::value<0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::suix5::SUIX5>(&arg1);
        assert!(v0 > 0, 105);
        assert!(arg0.suix5_supply >= v0, 104);
        arg0.suix5_supply = arg0.suix5_supply - v0;
        0x2::coin::burn<0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::suix5::SUIX5>(&mut arg0.suix5_treasury, arg1);
        v0
    }
    ...
    entry fun cancel_composition(arg0: &mut SuiX5Vault, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        ...
        0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::composition::cancel_pending(&mut arg0.composition, arg1, arg2);
    }
    ...
    public(friend) fun composition_mut(arg0: &mut SuiX5Vault) : &mut 0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::composition::Composition {
        &mut arg0.composition
    }

    public(friend) fun composition_ref(arg0: &SuiX5Vault) : &0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::composition::Composition {
        &arg0.composition
    }

    entry fun create_vault(arg0: 0x2::coin::TreasuryCap<0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::suix5::SUIX5>, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = SuiX5Vault{
            ...
            suix5_treasury            : arg0,
            suix5_supply              : 0,
            oracle                    : 0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::oracle::new(arg2),
            composition               : 0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::composition::new(arg2),
    ...
    entry fun execute_composition(arg0: &mut SuiX5Vault, arg1: &0x2::clock::Clock) {
        0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::composition::execute_pending(&mut arg0.composition, &arg0.oracle, arg1);
    }
    ...
    public(friend) fun mint_suix5(arg0: &mut SuiX5Vault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::suix5::SUIX5> {
        assert!(arg1 > 0, 105);
        arg0.suix5_supply = arg0.suix5_supply + arg1;
        0x2::coin::mint<0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::suix5::SUIX5>(&mut arg0.suix5_treasury, arg1, arg2)
    }
    ...
    public(friend) fun oracle_mut(arg0: &mut SuiX5Vault) : &mut 0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::oracle::OracleConfig {
        &mut arg0.oracle
    }

    public(friend) fun oracle_ref(arg0: &SuiX5Vault) : &0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::oracle::OracleConfig {
        &arg0.oracle
    }
    ...
    public fun orphans(arg0: &SuiX5Vault) : vector<0x1::type_name::TypeName> {
        ...
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&arg0.discovered_tokens)) {
            ...
            if (tracked_balance(arg0, v2) > 0 && !0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::composition::contains(&arg0.composition, v2)) {
    ...
    entry fun propose_composition<T0, T1, T2, T3, T4>(arg0: &mut SuiX5Vault, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        ...
        0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::composition::propose(&mut arg0.composition, &arg0.oracle, v1, v3, arg6, arg7, arg8);
    }
    ...
    entry fun set_composition_timelock(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
        0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::composition::set_timelock(&mut arg0.composition, arg2);
    }
    ...
    entry fun set_genesis_composition<T0, T1, T2, T3, T4>(arg0: &mut SuiX5Vault, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        ...
        0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::composition::set_genesis(&mut arg0.composition, &arg0.oracle, v0, v2, arg6, arg7);
    }
    ...
    entry fun set_oracle_config(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        0xc633baa571194c7b27a9d18fec2792bd8e80c962c91448ef2183b843fadc2b96::oracle::set_config(&mut arg0.oracle, arg2, arg3, arg4);
    }
