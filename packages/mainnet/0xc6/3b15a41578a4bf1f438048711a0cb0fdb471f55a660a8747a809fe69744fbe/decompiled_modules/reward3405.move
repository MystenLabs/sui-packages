module 0xc63b15a41578a4bf1f438048711a0cb0fdb471f55a660a8747a809fe69744fbe::reward3405 {
    struct REWARD3405 has drop {
        dummy_field: bool,
    }

    struct TICKET_3405 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3405(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3405>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3405>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3405, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3405>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3405>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3405>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3405>>(v5, 0x2::tx_context::sender(arg1));
    }
