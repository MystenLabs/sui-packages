module 0xc6cdd662bba036a823f8ac927522a7c07dd317ed1f8170f8024da86f551c4a20::display_nft {
    ...
    fun init(arg0: DISPLAY_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = MyNFT{
            ...
            name      : 0x1::string::utf8(b"lteng display nft"),
            image_url : 0x1::string::utf8(b"https://avatars.githubusercontent.com/u/78733621?v=4&size=64"),
        };
