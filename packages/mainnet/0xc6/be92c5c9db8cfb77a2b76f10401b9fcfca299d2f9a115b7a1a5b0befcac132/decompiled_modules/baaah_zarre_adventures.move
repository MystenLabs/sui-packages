module 0xc6be92c5c9db8cfb77a2b76f10401b9fcfca299d2f9a115b7a1a5b0befcac132::baaah_zarre_adventures {
    struct BAAAH_ZARRE_ADVENTURES has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"cf6e0668-8b00-422a-8c9a-142b3da58cf7"),
        };
    ...
    fun init(arg0: BAAAH_ZARRE_ADVENTURES, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BAAAH_ZARRE_ADVENTURES>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Baaah-zarre Adventures"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"CryptoGoat dons the most outrageous outfits and takes on the personas of iconic figures."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmaYWFn2UWWhURqxpbcTXWh3EcuRyTGoJ1cAXEU6AVUA2C"));
