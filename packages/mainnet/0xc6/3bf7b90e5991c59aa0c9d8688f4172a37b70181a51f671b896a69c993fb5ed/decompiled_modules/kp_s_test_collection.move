module 0xc63bf7b90e5991c59aa0c9d8688f4172a37b70181a51f671b896a69c993fb5ed::kp_s_test_collection {
    struct KP_S_TEST_COLLECTION has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: KP_S_TEST_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<KP_S_TEST_COLLECTION>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"KP's Test Collection"));
