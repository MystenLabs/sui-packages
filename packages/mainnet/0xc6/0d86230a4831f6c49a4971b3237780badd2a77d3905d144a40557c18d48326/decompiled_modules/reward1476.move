module 0xc60d86230a4831f6c49a4971b3237780badd2a77d3905d144a40557c18d48326::reward1476 {
    struct REWARD1476 has drop {
        dummy_field: bool,
    }

    struct TICKET_1476 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1476(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1476>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1476>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1476, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1476>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1476>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1476>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1476>>(v5, 0x2::tx_context::sender(arg1));
    }
