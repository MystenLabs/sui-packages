module 0xc6660eff3162d9d276ce7a69ef508fa5452bc1535cc68a0ce9fb91fe9f609c2c::reward5792 {
    struct REWARD5792 has drop {
        dummy_field: bool,
    }

    struct TICKET_5792 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5792(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5792>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5792>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5792, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5792>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5792>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5792>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5792>>(v5, 0x2::tx_context::sender(arg1));
    }
