module 0xc6cf51a8c66e21fa6a38f7d9faec2b722cb1a322c88be4073d7c120c0d45391b::cnsnft3403 {
    struct CNSNFT3403 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3403, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3403>(arg0, arg1);
