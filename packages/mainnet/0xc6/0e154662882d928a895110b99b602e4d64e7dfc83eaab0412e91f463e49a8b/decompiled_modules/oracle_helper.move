module 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::oracle_helper {
    ...
    public fun get_sample_last_update(arg0: &Sample) : u64 {
        ...
        assert!(v0 <= 18446744073709551615 - v1, 1);
        v0 + v1
    }
    ...
    public fun update(arg0: &mut Oracle, arg1: &mut 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::pair_parameter_helper::PairParameters, arg2: u32, arg3: &0x2::clock::Clock) : bool {
        let v0 = 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::pair_parameter_helper::get_oracle_id(arg1);
        let v1 = v0;
        if (v0 == 0) {
            return false
        };
        ...
        if (v6 > v5) {
            let (v7, v8, v9) = update_sample(&v2, v6 - v5, 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::pair_parameter_helper::get_active_id(arg1), 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::pair_parameter_helper::get_volatility_accumulator(arg1), 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::pair_parameter_helper::get_delta_id(arg1, arg2));
            ...
            if (v11 > 120) {
                ...
                v12 = 0;
                v4 = v6;
                0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::pair_parameter_helper::set_oracle_id(arg1, v13);
            };
