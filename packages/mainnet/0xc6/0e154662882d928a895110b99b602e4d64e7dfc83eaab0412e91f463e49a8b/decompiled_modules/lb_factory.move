module 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::lb_factory {
    ...
    struct LBPairWrapper<phantom T0, phantom T1> has store, key {
        id: 0x2::object::UID,
        pair: 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::lb_pair::LBPair<T0, T1>,
    }
    ...
    public fun create_lb_pair<T0, T1>(arg0: &mut LBFactory, arg1: u32, arg2: u16, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::price_helper::get_price_from_id(arg1, arg2);
        let v4 = create_pair_key(v0, v1, arg2);
        assert!(!0x2::table::contains<PairKey, LBPairInformation>(&arg0.lb_pairs_info, v4), 3004);
        let v5 = 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::lb_pair::create_pair<T0, T1>(type_name_to_bytes(v0), type_name_to_bytes(v1), arg2, arg3);
        0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::lb_pair::initialize<T0, T1>(&mut v5, v2.base_factor, v2.filter_period, v2.decay_period, v2.reduction_factor, v2.variable_fee_control, v2.protocol_share, v2.max_volatility_accumulator, arg1, arg3);
    ...
    public fun get_lb_pair<T0, T1>(arg0: &LBPairWrapper<T0, T1>) : &0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::lb_pair::LBPair<T0, T1> {
        &arg0.pair
    }
    ...
    public fun get_lb_pair_mut<T0, T1>(arg0: &mut LBPairWrapper<T0, T1>) : &mut 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::lb_pair::LBPair<T0, T1> {
        &mut arg0.pair
    }
