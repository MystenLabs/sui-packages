module 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::uint128x128_math {
    ...
    public fun log2(arg0: u256) : u256 {
        assert!(arg0 > 0, 300);
        if (arg0 == 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::constants::scale()) {
            return 0
        };
        let v0 = shr(arg0, 1);
        ...
        let v3 = (0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::bit_math::most_significant_bit(shr(v1, 127)) as u256);
        ...
        if (v5 != 170141183460469231731687303715884105728) {
            ...
            loop {
                ...
                v6 = shr(v6 * v6, 127);
                if (v6 >= 2 * 170141183460469231731687303715884105728) {
                    v4 = v4 + v7;
                    v6 = shr(v6, 1);
                };
                v7 = shr(v7, 1);
    ...
    public fun pow(arg0: u256, arg1: u256) : u256 {
        if (arg1 == 0) {
            return 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::constants::scale()
        };
        if (arg0 == 0) {
            return 0
        };
        let v0 = 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::constants::scale();
