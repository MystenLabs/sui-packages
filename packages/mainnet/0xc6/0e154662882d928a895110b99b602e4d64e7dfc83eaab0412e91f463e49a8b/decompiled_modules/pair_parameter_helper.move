module 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::pair_parameter_helper {
    ...
    public fun get_base_fee(arg0: &PairParameters, arg1: u16) : u256 {
        (arg0.base_factor as u256) * (arg1 as u256) * 10000000000
    }
    ...
    public fun get_total_fee(arg0: &PairParameters, arg1: u16) : u128 {
        let v0 = get_base_fee(arg0, arg1) + get_variable_fee(arg0, arg1);
        assert!(v0 <= 340282366920938463463374607431768211455, 600);
        (v0 as u128)
    }

    public fun get_variable_fee(arg0: &PairParameters, arg1: u16) : u256 {
        let v0 = (arg0.variable_fee_control as u256);
        if (v0 != 0) {
            let v2 = (arg0.volatility_accumulator as u256) * (arg1 as u256);
            (v2 * v2 * v0 + 99) / 100
        } else {
            0
        }
    ...
    public fun set_static_fee_parameters(arg0: &mut PairParameters, arg1: u16, arg2: u16, arg3: u16, arg4: u16, arg5: u32, arg6: u16, arg7: u32) {
        let v0 = if (arg2 <= arg3) {
            if ((arg4 as u256) <= 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::constants::basis_point_max()) {
                if ((arg6 as u256) <= 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::constants::max_protocol_share()) {
                    arg7 <= 1048575
                } else {
                    false
                }
    ...
    public fun update_volatility_accumulator(arg0: &mut PairParameters, arg1: u32) {
        ...
        let v2 = (arg0.volatility_reference as u256) + (v1 as u256) * 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::constants::basis_point_max();
        let v3 = (arg0.max_volatility_accumulator as u256);
        let v4 = if (v2 > v3) {
            v3
        } else {
            v2
        };
        arg0.volatility_accumulator = (v4 as u32);
    }
    ...
    public fun update_volatility_reference(arg0: &mut PairParameters) {
        arg0.volatility_reference = (((arg0.volatility_accumulator as u256) * (arg0.reduction_factor as u256) / 0xc60e154662882d928a895110b99b602e4d64e7dfc83eaab0412e91f463e49a8b::constants::basis_point_max()) as u32);
    }
