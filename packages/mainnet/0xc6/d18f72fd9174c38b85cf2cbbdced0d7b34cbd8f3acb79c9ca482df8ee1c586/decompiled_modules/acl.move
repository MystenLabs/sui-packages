module 0xc6d18f72fd9174c38b85cf2cbbdced0d7b34cbd8f3acb79c9ca482df8ee1c586::acl {
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : ACL {
        ...
        0x2::vec_set::insert<address>(&mut v0, @0x640c172b4e4dedbf97cbebba412cac0e5dfe417d012eab9e3277579100d2843a);
        0x2::vec_set::insert<address>(&mut v0, @0x93e07864e87bad3c0260d0aa594a75a7994ce2634cc99fdaa445c689b59f04b0);
        0x2::vec_set::insert<address>(&mut v0, @0xf5b856f7e3d8b99eda7091f0f4e4681cfc2d578f7e85b24b1cd64630376b6908);
    ...
    public(friend) fun set_upgrade_cap(arg0: &mut ACL, arg1: 0x2::package::UpgradeCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(is_admin(arg0, v0), 1);
        assert!(get_upgrade_cap_id(&arg1) == @0x293fb8dc8c186548a76846f34eaae72a614b8d20e85fe32bda758876a1e108f5, 16);
