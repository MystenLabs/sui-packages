module 0xc662382f53e0a37cba7c9725288cca7618dd4814698c5f28c4fdae0975f4debe::game {
    ...
    public fun compute_fomove_reward(arg0: &FOMOVEGame, arg1: &FOMOVEReward) : u64 {
        ...
        let v1 = if (arg1.is_winner) {
            ...
            v3 * v0.reward_amt * (1000 - arg0.finnal_reward_rate - arg0.fee) / v0.player_count * 1000 / 10000
        };
