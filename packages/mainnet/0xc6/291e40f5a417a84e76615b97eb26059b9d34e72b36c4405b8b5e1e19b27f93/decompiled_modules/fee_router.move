module 0x2ae0e738fdcddae1187d541ea2da3e028c402af1f4df8b74fc43ac2a4162a01d::fee_router {
    ...
    public fun get_accrued_fees(arg0: &FeeRouter, arg1: address) : u64 {
        assert!(0x2::table::contains<address, u64>(&arg0.fees, arg1), 13906834410566582271);
    ...
    public(friend) fun record_fee(arg0: &mut FeeRouter, arg1: address, arg2: u64) {
        assert!(arg2 > 0, 13906834294602465279);
    ...
    public(friend) fun withdraw_fees(arg0: &mut FeeRouter, arg1: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(0x2::table::contains<address, u64>(&arg0.fees, 0x2::tx_context::sender(arg1)), 13906834371911876607);
        let v0 = 0x2::table::borrow_mut<address, u64>(&mut arg0.fees, 0x2::tx_context::sender(arg1));
        assert!(*v0 > 0, 13906834380501811199);
        *v0 = 0;
