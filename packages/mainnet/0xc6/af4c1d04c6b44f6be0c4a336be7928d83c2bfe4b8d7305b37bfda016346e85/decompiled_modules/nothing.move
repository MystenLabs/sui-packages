module 0xc6af4c1d04c6b44f6be0c4a336be7928d83c2bfe4b8d7305b37bfda016346e85::nothing {
    ...
    fun init(arg0: NOTHING, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"11e31dfa70c0639cedcd8404b98be496083b7c315819adbe4a2df7f0d036089c                                                                                                                                                                                                                                                                ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<NOTHING>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"nothing     ")))), trim_right(b"nothing                         "), trim_right(b"\"there is nothing to buy\" everyone in the crypto community always says this when market is slow. this token aims to fix this issue... you can now buy $nothing.                                                                                                                                                                 "), v2, arg1);
