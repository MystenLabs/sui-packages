module 0xc6a7efd07944ce0c8edd0712f5cbde2df3ca0e39971c69a6a1a79076cd571920::bosu {
    struct BOSU has drop {
        dummy_field: bool,
    }

    public entry fun burn(arg0: &mut 0x2::coin::TreasuryCap<BOSU>, arg1: 0x2::coin::Coin<BOSU>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0xf9a5128ab91040496078b515c9e0db0c0bec3261d8d2fa696a45e01def6d7362, 2);
    ...
    public entry fun mint(arg0: &mut 0x2::coin::TreasuryCap<BOSU>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == @0xf9a5128ab91040496078b515c9e0db0c0bec3261d8d2fa696a45e01def6d7362, 1);
