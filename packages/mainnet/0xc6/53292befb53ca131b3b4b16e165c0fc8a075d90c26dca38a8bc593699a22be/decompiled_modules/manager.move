module 0xc653292befb53ca131b3b4b16e165c0fc8a075d90c26dca38a8bc593699a22be::manager {
    ...
    public fun active(arg0: &mut GalxeTable, arg1: u256, arg2: 0x1::ascii::String, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun increasePoint(arg0: &mut GalxeTable, arg1: u256, arg2: u64, arg3: u256, arg4: address, arg5: vector<u8>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::table::contains<u256, bool>(&v3.has_claimed, arg3), 13906834981797363715);
