module 0xc6a165ec0e66c821a03f6176f210ff8c7f5ade2dbfb30ad83da28d942eb3b7cb::pilgrimage {
    ...
    public entry fun claim(arg0: Stake, arg1: &mut PilgrimageTracker, arg2: &mut 0xe14da14335e447badce718ab503f2bc7488dc2c26961a4d14eb2648e5bdda728::holy_lottery::LotteryState, arg3: &0xe14da14335e447badce718ab503f2bc7488dc2c26961a4d14eb2648e5bdda728::holy_lottery::PilgrimageCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (v8 > 0) {
            0xe14da14335e447badce718ab503f2bc7488dc2c26961a4d14eb2648e5bdda728::holy_lottery::add_faith_scrolls(arg2, arg3, v2, v8, arg5);
        };
        let v9 = StakeClaimed{
            staker               : v2,
            amount               : v3,
    ...
    public entry fun claim_v2(arg0: Stake, arg1: &mut PilgrimageTracker, arg2: &0xe14da14335e447badce718ab503f2bc7488dc2c26961a4d14eb2648e5bdda728::holy_lottery::PilgrimageCap, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v8 > 0) {
            0xe14da14335e447badce718ab503f2bc7488dc2c26961a4d14eb2648e5bdda728::holy_lottery::issue_faith_balance(arg2, v2, v8, arg4);
        };
        let v9 = StakeClaimed{
            staker               : v2,
            amount               : v3,
