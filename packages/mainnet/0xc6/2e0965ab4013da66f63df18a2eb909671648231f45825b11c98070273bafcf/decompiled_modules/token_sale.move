module 0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::token_sale {
    ...
    struct TokenSale has key {
        id: 0x2::object::UID,
        tokens_for_sale: 0x2::balance::Balance<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>,
    ...
    public entry fun claim_tokens(arg0: &mut TokenSale, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        v1.claimed = true;
        0x2::transfer::public_transfer<0x2::coin::Coin<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>>(0x2::coin::from_balance<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>(0x2::balance::split<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>(&mut arg0.tokens_for_sale, v2), arg2), v0);
    ...
    public entry fun deposit_tokens(arg0: &SaleAdminCap, arg1: &mut TokenSale, arg2: 0x2::coin::Coin<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>) {
        0x2::balance::join<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>(&mut arg1.tokens_for_sale, 0x2::coin::into_balance<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>(arg2));
        arg1.tokens_remaining = 0x2::balance::value<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>(&arg1.tokens_for_sale);
        let v0 = TokensDeposited{
            amount          : 0x2::coin::value<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>(&arg2),
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = TokenSale{
            ...
            tokens_for_sale          : 0x2::balance::zero<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>(),
            tokens_remaining         : 0,
    ...
    public entry fun withdraw_unsold_tokens(arg0: &SaleAdminCap, arg1: &mut TokenSale, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.sold_out, 9);
        if (0x2::balance::value<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>(&arg1.tokens_for_sale) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>>(0x2::coin::from_balance<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>(0x2::balance::withdraw_all<0xc62e0965ab4013da66f63df18a2eb909671648231f45825b11c98070273bafcf::shttoken::SHTTOKEN>(&mut arg1.tokens_for_sale), arg2), arg1.treasury_wallet);
        };
    }
