module 0xc6315eadd5557175b0216ad78eba3632135147d44bfa0e5c3cfac4b0be0d481d::cnsnft8630 {
    struct CNSNFT8630 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8630, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8630>(arg0, arg1);
