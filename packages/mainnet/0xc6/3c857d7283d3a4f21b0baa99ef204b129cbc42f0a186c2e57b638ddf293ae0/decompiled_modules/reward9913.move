module 0xc63c857d7283d3a4f21b0baa99ef204b129cbc42f0a186c2e57b638ddf293ae0::reward9913 {
    struct REWARD9913 has drop {
        dummy_field: bool,
    }

    struct TICKET_9913 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9913(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_9913>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9913, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9913>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9913>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9913>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9913>>(v5, 0x2::tx_context::sender(arg1));
    }
