module 0xc690abc0d2ed1d258a5d1e4ec420a34c86c6525d99df1fa3c832bb3cf3e3dcee::claim {
    ...
    public entry fun create_claim_params(arg0: address, arg1: vector<0x1::ascii::String>, arg2: vector<u64>, arg3: vector<0x2::object::ID>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = ClaimDetails{coin_details: 0x1::vector::empty<CoinDetail>()};
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::ascii::String>(&arg1)) {
            let v2 = *0x1::vector::borrow<0x1::ascii::String>(&arg1, v1);
            let v3 = CoinDetail{
                coin_type : trim_address_zeros(&v2),
                amount    : *0x1::vector::borrow<u64>(&arg2, v1),
                object_id : *0x1::vector::borrow<0x2::object::ID>(&arg3, v1),
            };
        ...
        let v4 = ClaimParams{
            ...
            receiver_address : arg0,
        };
        0x2::transfer::share_object<ClaimParams>(v4);
    }

    public entry fun sendToken<T0>(arg0: &mut ClaimParams, arg1: 0x2::coin::Coin<T0>) {
        assert!(0x1::option::is_some<ClaimDetails>(&arg0.details), 0);
