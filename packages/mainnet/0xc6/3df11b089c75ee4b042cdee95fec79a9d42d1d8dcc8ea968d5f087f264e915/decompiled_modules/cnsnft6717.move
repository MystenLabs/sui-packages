module 0xc63df11b089c75ee4b042cdee95fec79a9d42d1d8dcc8ea968d5f087f264e915::cnsnft6717 {
    struct CNSNFT6717 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6717, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2818"));
        let v4 = 0x2::package::claim<CNSNFT6717>(arg0, arg1);
