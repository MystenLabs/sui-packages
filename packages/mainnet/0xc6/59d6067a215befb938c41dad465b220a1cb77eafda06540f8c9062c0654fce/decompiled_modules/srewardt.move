module 0xc659d6067a215befb938c41dad465b220a1cb77eafda06540f8c9062c0654fce::srewardt {
    ...
    fun init(arg0: SREWARDT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SREWARDT>(arg0, 9, b"SUI", b"Sui", b"Sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://res.cloudinary.com/dkhar3xjm/image/upload/v1727362166/sui_xwsf0m.svg")), arg1);
