module 0xc632a08776992b086741e38f5ca80b837c528de237949292483440506fb689da::swap_guard {
    ...
    public fun verify_swap<T0>(arg0: &0x4760190f3d43f84cabf71d9809afd17805a7780b0ede3a40afe66150f7d43b77::vault::Vault<T0>, arg1: &0xc632a08776992b086741e38f5ca80b837c528de237949292483440506fb689da::crank::CrankConfig, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: u8, arg6: u8, arg7: &0xcd90be8978b6ba0a88cc48270cf6de0bd4b0fae1ac8877c641243844dbabd215::price_info::PriceInfoObject, arg8: &0xcd90be8978b6ba0a88cc48270cf6de0bd4b0fae1ac8877c641243844dbabd215::price_info::PriceInfoObject, arg9: vector<u8>, arg10: vector<u8>) {
        ...
        if (!0x4760190f3d43f84cabf71d9809afd17805a7780b0ede3a40afe66150f7d43b77::vault::is_depeg_active<T0>(arg0)) {
            assert!((0xcd90be8978b6ba0a88cc48270cf6de0bd4b0fae1ac8877c641243844dbabd215::price::get_conf(&v4) as u256) * 20 <= v7, 1003);
        };
        ...
        if (!0x4760190f3d43f84cabf71d9809afd17805a7780b0ede3a40afe66150f7d43b77::vault::is_depeg_active<T0>(arg0)) {
            assert!((0xcd90be8978b6ba0a88cc48270cf6de0bd4b0fae1ac8877c641243844dbabd215::price::get_conf(&v8) as u256) * 20 <= v11, 1003);
        };
        ...
        assert!(v13 >= v12 / 10000 * (10000 - (0xc632a08776992b086741e38f5ca80b837c528de237949292483440506fb689da::crank::max_swap_slippage_bps(arg1) as u256)), 1000);
        let v14 = if (v13 >= v12) {
            0
        } else {
