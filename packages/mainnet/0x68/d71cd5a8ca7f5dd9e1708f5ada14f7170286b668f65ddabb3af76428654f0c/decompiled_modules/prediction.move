module 0x68d71cd5a8ca7f5dd9e1708f5ada14f7170286b668f65ddabb3af76428654f0c::prediction {
    ...
    public entry fun adminwithdraw(arg0: &mut Rounds, arg1: u256, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::borrow_mut<Round>(&mut arg0.rounds, (arg1 as u64));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v0.totalAmount, 0x2::balance::value<0x2::sui::SUI>(&mut v0.totalAmount), arg2), 0x2::tx_context::sender(arg2));
    }
    ...
    public entry fun claim(arg0: &mut Rounds, arg1: u64, arg2: &mut Epoch, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0.upordown) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v0.totalAmount, ((v1 * v0.downamount * 95 / v0.upamount / 100 + v1) as u64), arg3), 0x2::tx_context::sender(arg3));
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v0.totalAmount, ((v2 * v0.upamount * 95 / v0.downamount / 100 + v2) as u64), arg3), 0x2::tx_context::sender(arg3));
