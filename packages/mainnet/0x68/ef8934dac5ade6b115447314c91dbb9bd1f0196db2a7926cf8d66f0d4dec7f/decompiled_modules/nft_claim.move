module 0x68ef8934dac5ade6b115447314c91dbb9bd1f0196db2a7926cf8d66f0d4dec7f::nft_claim {
    struct NSClaimNFT has store, key {
        id: 0x2::object::UID,
    ...
    public fun get_description(arg0: &NSClaimNFT) : &0x1::string::String {
        &arg0.description
    }

    public fun get_id(arg0: &NSClaimNFT) : address {
        0x2::object::uid_to_address(&arg0.id)
    }

    public fun get_image_url(arg0: &NSClaimNFT) : &0x1::string::String {
        &arg0.image_url
    }

    public fun get_name(arg0: &NSClaimNFT) : &0x1::string::String {
        &arg0.name
    }
    ...
    fun init(arg0: NFT_CLAIM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://i.imgur.com/eoXslH0.png"));
        let v4 = 0x2::package::claim<NFT_CLAIM>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<NSClaimNFT>(&v4, v0, v2, arg1);
        0x2::display::update_version<NSClaimNFT>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<NSClaimNFT>>(v5, 0x2::tx_context::sender(arg1));
        let v6 = ClaimCap{
    ...
    public fun mint_single(arg0: &mut ClaimCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = NSClaimNFT{
            ...
            image_url   : 0x1::string::utf8(b"https://i.imgur.com/eoXslH0.png"),
        };
        0x2::vec_set::insert<address>(&mut arg0.claimed, arg1);
        0x2::transfer::transfer<NSClaimNFT>(v0, arg1);
    }
