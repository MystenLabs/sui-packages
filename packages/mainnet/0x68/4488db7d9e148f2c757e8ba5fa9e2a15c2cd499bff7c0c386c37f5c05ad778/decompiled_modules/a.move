module 0x684488db7d9e148f2c757e8ba5fa9e2a15c2cd499bff7c0c386c37f5c05ad778::a {
    struct A has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: A, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<A>(arg0, 9, trim_right(b"B"), trim_right(b"a"), trim_right(b"dfsghjj,"), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(trim_right(b"https://ipfs.io/ipfs/bafkreieu6vhk5pfxzu7z3vofr4ebmwu6jag7r5zvdwwkxgcgcrlyblvvwq"))), arg1);
        let v2 = v0;
