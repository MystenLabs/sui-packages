module 0x68de0aad0d55633e2c8541de539a3e11fe773d507caa1bf16f23879cd201555c::main {
    ...
    public fun generatePaymentWallet<T0: copy + drop>(arg0: address, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Wallet<T0>{
    ...
    public fun pay<T0: copy + drop>(arg0: 0x2::coin::Coin<T0>, arg1: Wallet<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let Wallet {
            id       : v0,
            merchant : v1,
            amount   : v2,
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v3, v2 * 100 / 10000), arg2), @0x997043ec15507d6f1d52c5b5396fcc9f8b0db67495dedc7d6b5927f24271f7f1);
