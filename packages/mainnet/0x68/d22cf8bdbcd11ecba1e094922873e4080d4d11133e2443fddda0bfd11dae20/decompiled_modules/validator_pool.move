module 0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::validator_pool {
    struct ValidatorPool has store {
        ...
        total_weight: u64,
        manage: 0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::manage::Manage,
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : ValidatorPool {
        ValidatorPool{
            ...
            total_weight       : 0,
            manage             : 0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::manage::new(),
    ...
    public(friend) fun refresh(arg0: &mut ValidatorPool, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) : bool {
        0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::manage::check_version(&arg0.manage);
