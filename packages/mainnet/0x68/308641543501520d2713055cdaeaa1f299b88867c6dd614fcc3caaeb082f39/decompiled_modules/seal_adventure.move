module 0x68308641543501520d2713055cdaeaa1f299b88867c6dd614fcc3caaeb082f39::seal_adventure {
    ...
    fun init(arg0: SEAL_ADVENTURE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Mint your unique Seal Adventure and embark on an epic journey!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreicmrowzx6hnlgev6btckxlhomb56uxusbswpshfpxyuceekztjyse"));
