module 0x68e4581fce730187b58dfcb443ca8fddb2f1d71c6f53f5dfa882769e384a0999::raffle {
    ...
    public entry fun create_coin_raffle_by_addresses_obj<T0, T1>(arg0: vector<u8>, arg1: &0x2::clock::Clock, arg2: &mut 0x68e4581fce730187b58dfcb443ca8fddb2f1d71c6f53f5dfa882769e384a0999::addresses_obj::AddressesObj<T1>, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: 0x2::coin::Coin<T0>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        create_coin_raffle<T0>(arg0, arg1, 0x68e4581fce730187b58dfcb443ca8fddb2f1d71c6f53f5dfa882769e384a0999::addresses_obj::update_adresses_and_return_old<T1>(arg2, 0x1::vector::empty<address>()), arg4, arg5, arg6);
    }
    ...
    public fun emit_coin_raffle_created<T0>(arg0: &Raffle<T0>) {
        ...
        0x2::event::emit<CoinRaffleCreated>(v2);
    }
    ...
    entry fun get_drandlib_round(arg0: &0x2::clock::Clock) {
        let v0 = 0x68e4581fce730187b58dfcb443ca8fddb2f1d71c6f53f5dfa882769e384a0999::drand_lib::get_current_round_by_time(0x2::clock::timestamp_ms(arg0));
        let v1 = TimeEvent{
