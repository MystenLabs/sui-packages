module 0x22f174163427b4cd62e956a2536f707b89a7e919e6241cc02fbb027969c2e2a3::suins_domains_manager {
    ...
    public fun cleanup_expired_domain(arg0: &mut SuiNSDomains, arg1: &mut 0x22f174163427b4cd62e956a2536f707b89a7e919e6241cc02fbb027969c2e2a3::suins_communities::Community, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) {
        validate_version(arg0);
        ...
        let v2 = SuiNSDomainKey{dummy_field: false};
        assert!(0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::has_expired(0x2::dynamic_object_field::borrow<SuiNSDomainKey, 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration>(&0x2::bag::borrow<SuiNSManagedKey, SuiNSManagedValue>(&arg0.managed_domains, v1).storage, v2), arg3), 17);
        let v3 = SuiNSManagedKey{id: arg2};
        let SuiNSManagedValue {
            owner   : v4,
            storage : v5,
        } = 0x2::bag::remove<SuiNSManagedKey, SuiNSManagedValue>(&mut arg0.managed_domains, v3);
        let v6 = v5;
        let v7 = SuiNSDomainKey{dummy_field: false};
        ...
        0x2::transfer::public_transfer<0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration>(0x2::dynamic_object_field::remove<SuiNSDomainKey, 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration>(&mut v6, v7), v4);
    }
    ...
    entry fun migrate(arg0: &0x2::package::Publisher, arg1: &mut SuiNSDomains) {
        assert!(0x2::package::from_package<SuiNSDomains>(arg0), 18);
        assert!(arg1.version < 6, 15);
        arg1.version = 6;
    }
