module 0x68de0e378e28e8e809314f85f1e849be26d3ebfee71bcdf43a196918fc58a4eb::oracle {
    ...
    struct MmtOracle has key {
        id: 0x2::object::UID,
        version: 0x68de0e378e28e8e809314f85f1e849be26d3ebfee71bcdf43a196918fc58a4eb::version::Version,
    ...
    public fun get_price(arg0: &MmtOracle, arg1: 0x1::type_name::TypeName, arg2: &0x2::clock::Clock) : u64 {
        0x68de0e378e28e8e809314f85f1e849be26d3ebfee71bcdf43a196918fc58a4eb::version::assert_current_version(&arg0.version);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = MmtOracle{
            ...
            version             : 0x68de0e378e28e8e809314f85f1e849be26d3ebfee71bcdf43a196918fc58a4eb::version::initialize(),
    ...
    public fun remove_primary_source<T0>(arg0: &AdminCap, arg1: &mut MmtOracle) {
        0x68de0e378e28e8e809314f85f1e849be26d3ebfee71bcdf43a196918fc58a4eb::version::assert_current_version(&arg1.version);
    ...
    public fun set_primary_price<T0, T1: drop>(arg0: T1, arg1: &mut PriceReceipt<T0>, arg2: &MmtOracle, arg3: u64, arg4: u64) {
        0x68de0e378e28e8e809314f85f1e849be26d3ebfee71bcdf43a196918fc58a4eb::version::assert_current_version(&arg2.version);
        assert!(0x2::table::contains<0x1::type_name::TypeName, PriceSources>(&arg2.sources, 0x1::type_name::get<T0>()), 2);
    ...
    public fun upgrade_major(arg0: &AdminCap, arg1: &mut MmtOracle) {
        0x68de0e378e28e8e809314f85f1e849be26d3ebfee71bcdf43a196918fc58a4eb::version::upgrade_major(&mut arg1.version);
    }

    public fun upgrade_minor(arg0: &AdminCap, arg1: &mut MmtOracle) {
        0x68de0e378e28e8e809314f85f1e849be26d3ebfee71bcdf43a196918fc58a4eb::version::upgrade_minor(&mut arg1.version);
    }

    public fun version(arg0: &MmtOracle) : &0x68de0e378e28e8e809314f85f1e849be26d3ebfee71bcdf43a196918fc58a4eb::version::Version {
        &arg0.version
    }
