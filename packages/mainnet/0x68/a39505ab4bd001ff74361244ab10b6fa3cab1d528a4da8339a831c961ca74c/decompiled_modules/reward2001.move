module 0x68a39505ab4bd001ff74361244ab10b6fa3cab1d528a4da8339a831c961ca74c::reward2001 {
    struct REWARD2001 has drop {
        dummy_field: bool,
    }

    struct TICKET_2001 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2001(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_2001>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2001, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2001>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2001>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2001>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2001>>(v5, 0x2::tx_context::sender(arg1));
    }
