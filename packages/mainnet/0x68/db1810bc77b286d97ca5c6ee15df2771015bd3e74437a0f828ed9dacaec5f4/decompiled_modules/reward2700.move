module 0x68db1810bc77b286d97ca5c6ee15df2771015bd3e74437a0f828ed9dacaec5f4::reward2700 {
    struct REWARD2700 has drop {
        dummy_field: bool,
    }

    struct TICKET_2700 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2700(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2700>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2700>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2700, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2700>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2700>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2700>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2700>>(v5, 0x2::tx_context::sender(arg1));
    }
