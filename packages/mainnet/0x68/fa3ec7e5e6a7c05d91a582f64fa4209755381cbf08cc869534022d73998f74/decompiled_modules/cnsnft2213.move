module 0x68fa3ec7e5e6a7c05d91a582f64fa4209755381cbf08cc869534022d73998f74::cnsnft2213 {
    struct CNSNFT2213 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2213, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2213>(arg0, arg1);
