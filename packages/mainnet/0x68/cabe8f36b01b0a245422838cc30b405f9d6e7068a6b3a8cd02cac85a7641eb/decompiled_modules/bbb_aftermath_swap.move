module 0x68cabe8f36b01b0a245422838cc30b405f9d6e7068a6b3a8cd02cac85a7641eb::bbb_aftermath_swap {
    ...
    public fun swap<T0, T1, T2>(arg0: &AftermathSwap, arg1: &mut 0x68cabe8f36b01b0a245422838cc30b405f9d6e7068a6b3a8cd02cac85a7641eb::bbb_vault::BBBVault, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &mut 0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool::Pool<T0>, arg5: &0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool_registry::PoolRegistry, arg6: &0x2d9316f1f1a95f6d7c85a4e690ef7c359e6649773ef2c37ad7d9857adb6bef06::vault::ProtocolFeeVault, arg7: &mut 0x64213b0e4a52bac468d4ac3f140242f70714381653a1919a6d57cd49c628207a::treasury::Treasury, arg8: &mut 0xa6baab1e668c7868991c1c3c11e144100f5734c407d020f72a01b9d1a8bcb97f::insurance_fund::InsuranceFund, arg9: &0xc66fabf1a9253e43c70f1cc02d40a1d18db183140ecaae2a3f58fa6b66c55acf::referral_vault::ReferralVault, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0x2::coin::from_balance<T1>(0x68cabe8f36b01b0a245422838cc30b405f9d6e7068a6b3a8cd02cac85a7641eb::bbb_vault::withdraw<T1>(arg1), arg11);
        let v10 = 0x2::coin::value<T1>(&v9);
        if (v10 == 0) {
            0x2::coin::destroy_zero<T1>(v9);
            return
        };
        let v11 = 0x68cabe8f36b01b0a245422838cc30b405f9d6e7068a6b3a8cd02cac85a7641eb::bbb_pyth::calc_amount_out(arg2, arg3, arg0.decimals_in, arg0.decimals_out, v10, arg0.max_age_secs, arg10);
        ...
        assert!(v13 >= (((v11 as u256) * (arg0.slippage as u256) / 1000000000000000000) as u64), 105);
        0x68cabe8f36b01b0a245422838cc30b405f9d6e7068a6b3a8cd02cac85a7641eb::bbb_vault::deposit<T2>(arg1, v12);
        let v14 = Swapped{
    ...
    public fun new<T0, T1, T2>(arg0: &0x68cabe8f36b01b0a245422838cc30b405f9d6e7068a6b3a8cd02cac85a7641eb::bbb_admin::BBBAdminCap, arg1: u8, arg2: u8, arg3: vector<u8>, arg4: vector<u8>, arg5: &0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool::Pool<T0>, arg6: u64, arg7: u64) : AftermathSwap {
