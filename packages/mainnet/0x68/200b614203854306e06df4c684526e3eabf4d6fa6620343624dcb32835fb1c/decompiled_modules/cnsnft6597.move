module 0x68200b614203854306e06df4c684526e3eabf4d6fa6620343624dcb32835fb1c::cnsnft6597 {
    struct CNSNFT6597 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6597, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6597>(arg0, arg1);
