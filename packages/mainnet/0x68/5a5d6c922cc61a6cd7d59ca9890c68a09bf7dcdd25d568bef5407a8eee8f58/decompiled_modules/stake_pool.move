module 0x685a5d6c922cc61a6cd7d59ca9890c68a09bf7dcdd25d568bef5407a8eee8f58::stake_pool {
    ...
    public fun deactivate_stake_pool<T0>(arg0: &mut StakePool<T0>) : 0x2::coin::TreasuryCap<T0> {
