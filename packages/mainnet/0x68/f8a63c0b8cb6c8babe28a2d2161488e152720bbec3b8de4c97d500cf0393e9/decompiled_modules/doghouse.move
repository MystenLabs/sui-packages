module 0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::doghouse {
    ...
    struct DogHouse has key {
        ...
        treats_tc: 0x2::coin::TreasuryCap<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>,
    ...
    public fun burn(arg0: &mut DogHouse, arg1: 0x2::coin::Coin<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>) {
        0x2::coin::burn<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>(&mut arg0.treats_tc, arg1);
    }

    public fun mint(arg0: &mut DogHouse, arg1: &AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS> {
        0x2::coin::mint<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>(&mut arg0.treats_tc, arg2, arg3)
    }

    public fun update_icon_url(arg0: &mut DogHouse, arg1: &AdminCap, arg2: &mut 0x2::coin::CoinMetadata<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>, arg3: 0x1::ascii::String) {
        0x2::coin::update_icon_url<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>(&arg0.treats_tc, arg2, arg3);
    }
    ...
    public fun buy_treats<T0>(arg0: &mut DogHouse, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS> {
        assert_valid_package_version(arg0);
        ...
        let v2 = Deposit<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>{
            amount : v1,
            user   : 0x2::tx_context::sender(arg2),
            memo   : 0x1::string::to_ascii(0x1::string::utf8(b"purchase")),
        };
        0x2::event::emit<Deposit<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>>(v2);
        let v3 = balance_mut<T0>(arg0);
        0x2::coin::put<T0>(v3, arg1);
        0x2::coin::mint<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>(&mut arg0.treats_tc, v1, arg2)
    }
    ...
    public fun buy_treats_for_account<T0>(arg0: &mut DogHouse, arg1: 0x2::coin::Coin<T0>, arg2: address) {
        ...
        let v3 = balance_mut<T0>(arg0);
        0x2::coin::put<T0>(v3, arg1);
        let v4 = 0x2::coin::mint_balance<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>(&mut arg0.treats_tc, v1);
        let v5 = custodial_pool_mut<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>(arg0, 0x1::type_name::get<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>());
        let v6 = Deposit<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>{
            amount : v1,
            user   : arg2,
            memo   : 0x1::string::to_ascii(0x1::string::utf8(b"purchase")),
        };
        0x2::event::emit<Deposit<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>>(v6);
        ...
        0x2::balance::join<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>(&mut v5.balance, v4);
    }
    ...
    public fun create_doghouse(arg0: &AdminCap, arg1: 0x2::coin::TreasuryCap<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = DogHouse{
            id              : 0x2::object::new(arg2),
        ...
        let v1 = &mut v0;
        create_custodial_pool<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>(v1, arg0, arg2);
    ...
    public fun mint_to(arg0: &mut DogHouse, arg1: &AdminCap, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>>(0x2::coin::mint<0x68f8a63c0b8cb6c8babe28a2d2161488e152720bbec3b8de4c97d500cf0393e9::treats::TREATS>(&mut arg0.treats_tc, arg2, arg4), arg3);
    }
