module 0x68aac2d6a88bc1e868c48ee99918b71373877308f7e63cb22ac1971cad9d6e67::lock {
    ...
    public entry fun lock_nft_to<T0: store + key>(arg0: T0, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x68aac2d6a88bc1e868c48ee99918b71373877308f7e63cb22ac1971cad9d6e67::utils::current_time(arg3);
        let v2 = v1 + arg2;
        let v3 = LockedNFT<T0>{
            id            : v0,
            nft           : arg0,
    ...
    public entry fun unlock_nft<T0: store + key>(arg0: LockedNFT<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x68aac2d6a88bc1e868c48ee99918b71373877308f7e63cb22ac1971cad9d6e67::utils::current_time(arg1);
        assert!(v6 >= v3, 1);
