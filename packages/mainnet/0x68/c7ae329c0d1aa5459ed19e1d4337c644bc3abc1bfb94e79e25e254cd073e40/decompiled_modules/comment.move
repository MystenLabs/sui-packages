module 0x68c7ae329c0d1aa5459ed19e1d4337c644bc3abc1bfb94e79e25e254cd073e40::comment {
    ...
    public entry fun reply_comment(arg0: &mut 0x68c7ae329c0d1aa5459ed19e1d4337c644bc3abc1bfb94e79e25e254cd073e40::community::Community, arg1: &mut Comment, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = CommentChild{
        ...
        0x68c7ae329c0d1aa5459ed19e1d4337c644bc3abc1bfb94e79e25e254cd073e40::community::update_total_comments(arg0, arg4);
    }
    ...
    public entry fun user_comment(arg0: &mut 0x68c7ae329c0d1aa5459ed19e1d4337c644bc3abc1bfb94e79e25e254cd073e40::community::Community, arg1: 0x1::string::String, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Comment{
        ...
        0x68c7ae329c0d1aa5459ed19e1d4337c644bc3abc1bfb94e79e25e254cd073e40::community::update_total_comments(arg0, arg3);
        0x68c7ae329c0d1aa5459ed19e1d4337c644bc3abc1bfb94e79e25e254cd073e40::community::update_list_comments(arg0, 0x2::object::id<Comment>(&v0), arg3);
