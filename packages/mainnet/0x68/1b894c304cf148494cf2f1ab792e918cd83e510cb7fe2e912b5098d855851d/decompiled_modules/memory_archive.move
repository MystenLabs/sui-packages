module 0x681b894c304cf148494cf2f1ab792e918cd83e510cb7fe2e912b5098d855851d::memory_archive {
    ...
    fun validate_metadata(arg0: &0x1::string::String, arg1: &0x1::string::String, arg2: &0x1::string::String, arg3: &vector<u8>, arg4: u8, arg5: u8) {
        assert!(0x1::vector::length<u8>(0x1::string::as_bytes(arg0)) <= 2048, 2);
        assert!(0x1::vector::length<u8>(0x1::string::as_bytes(arg1)) <= 256, 3);
        assert!(0x1::vector::length<u8>(0x1::string::as_bytes(arg2)) <= 2048, 4);
        assert!(arg5 <= 3, 5);
        assert!(arg4 <= 2, 5);
        if (arg5 == 0) {
            assert!(arg4 == 0, 10);
