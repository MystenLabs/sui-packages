module 0x684bb94dbb129192250088a1db58f5752af587944bafddb64fdfac7e1f3c0201::nft {
    ...
    public entry fun transfer(arg0: MainnetNFT, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun burn(arg0: MainnetNFT, arg1: &mut 0x2::tx_context::TxContext) {
        let MainnetNFT {
            id          : v0,
            name        : _,
            description : _,
    ...
    public entry fun update_description(arg0: &mut MainnetNFT, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
