module 0x6849e7792791ce81072dfb2eab468aa7f5077700a12b70509f8d405f66a73d86::treasury {
    ...
    fun check_version(arg0: &Treasury) {
        0x6849e7792791ce81072dfb2eab468aa7f5077700a12b70509f8d405f66a73d86::version::check_version(arg0.version);
    }

    public(friend) fun create_treasury(arg0: &mut 0x2::tx_context::TxContext) : Treasury {
        Treasury{
            id      : 0x2::object::new(arg0),
            version : 0x6849e7792791ce81072dfb2eab468aa7f5077700a12b70509f8d405f66a73d86::version::current_version(),
    ...
    public fun withdraw<T0>(arg0: &0x6849e7792791ce81072dfb2eab468aa7f5077700a12b70509f8d405f66a73d86::admin::AdminCap, arg1: &mut Treasury, arg2: &mut 0x2::tx_context::TxContext) {
        check_version(arg1);
    ...
    public fun withdraw_some<T0>(arg0: &0x6849e7792791ce81072dfb2eab468aa7f5077700a12b70509f8d405f66a73d86::admin::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        check_version(arg1);
