module 0x68bbdeb124dd0c3ff7dcf1101d690fbfc5ca2909abcd47bd09683607760486d1::reward3750 {
    struct REWARD3750 has drop {
        dummy_field: bool,
    }

    struct TICKET_3750 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3750(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3750>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3750>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3750, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3750>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3750>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3750>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3750>>(v5, 0x2::tx_context::sender(arg1));
    }
