module 0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::coin_escrow {
    ...
    struct TokenEscrow<phantom T0, phantom T1> has store, key {
        id: 0x2::object::UID,
        market_state: 0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::market_state::MarketState,
    ...
    public fun new<T0, T1>(arg0: 0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::market_state::MarketState, arg1: &mut 0x2::tx_context::TxContext) : TokenEscrow<T0, T1> {
        TokenEscrow<T0, T1>{
    ...
    public fun assert_quantum_invariant<T0, T1>(arg0: &TokenEscrow<T0, T1>) {
        if (0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::market_state::is_finalized(&arg0.market_state)) {
            let v0 = 0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::market_state::get_winning_outcome(&arg0.market_state);
    ...
    public fun burn_conditional<T0, T1, T2>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: 0x2::coin::Coin<T2>, arg4: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun burn_conditional_asset_and_withdraw<T0, T1, T2>(arg0: &mut TokenEscrow<T0, T1>, arg1: 0x2::coin::Coin<T2>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::market_state::is_finalized(&arg0.market_state), 101);
        let v0 = 0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::market_state::get_winning_outcome(&arg0.market_state);
    ...
    public fun decrement_lp_backing<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun decrement_outcome_allocation<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun decrement_pool_claim<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun decrement_supplies_for_all_outcomes<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun decrement_supply_for_outcome<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: u64, arg4: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
        assert!(arg1 < arg0.outcome_count, 5);
        if (arg2) {
            let v0 = 0x1::vector::borrow_mut<u64>(&mut arg0.asset_supplies, arg1);
            assert!(*v0 >= arg3, 103);
    ...
    public fun decrement_user_backing<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun decrement_wrapped_balance<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: u64, arg4: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun deposit_spot_liquidity<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public(friend) fun drop_recombine_asset_progress<T0, T1>(arg0: RecombineAssetProgress<T0, T1>) {
    ...
    public(friend) fun drop_recombine_stable_progress<T0, T1>(arg0: RecombineStableProgress<T0, T1>) {
    ...
    public(friend) fun drop_split_asset_progress<T0, T1>(arg0: SplitAssetProgress<T0, T1>) {
    ...
    public(friend) fun drop_split_stable_progress<T0, T1>(arg0: SplitStableProgress<T0, T1>) {
    ...
    public fun emergency_remove_asset_treasury_cap<T0, T1, T2>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::emergency_cap::EmergencyCap, arg3: &0x2::clock::Clock) : 0x2::coin::TreasuryCap<T2> {
        0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::emergency_cap::assert_ready(arg2, arg3);
        assert!(arg1 < arg0.outcome_count, 5);
        let v0 = AssetCapKey{outcome_index: arg1};
        0x2::dynamic_field::remove<AssetCapKey, 0x2::coin::TreasuryCap<T2>>(&mut arg0.id, v0)
    }

    public fun emergency_remove_stable_treasury_cap<T0, T1, T2>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::emergency_cap::EmergencyCap, arg3: &0x2::clock::Clock) : 0x2::coin::TreasuryCap<T2> {
        0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::emergency_cap::assert_ready(arg2, arg3);
        assert!(arg1 < arg0.outcome_count, 5);
    ...
    public fun emergency_withdraw_spot_balances<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::emergency_cap::EmergencyCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
    ...
    public fun get_market_state<T0, T1>(arg0: &TokenEscrow<T0, T1>) : &0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::market_state::MarketState {
        &arg0.market_state
    }

    public fun get_market_state_mut<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) : &mut 0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::market_state::MarketState {
    ...
    public fun increment_dust_created<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: u64, arg4: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
        if (arg2) {
    ...
    public fun increment_supplies_for_all_outcomes<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
        assert!(arg0.outcome_count > 0, 4);
        let v0 = 0;
        while (v0 < arg0.outcome_count) {
            if (arg1 > 0) {
    ...
    public fun increment_wrapped_balance<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: u64, arg4: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun lp_deposit_quantum<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) : (u64, u64) {
        assert!(arg0.outcome_count > 0, 4);
    ...
    public fun lp_withdraw_quantum<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::market_state::is_finalized(&arg0.market_state), 101);
        let v0 = 0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::market_state::get_winning_outcome(&arg0.market_state);
    ...
    public fun market_state_id<T0, T1>(arg0: &TokenEscrow<T0, T1>) : 0x2::object::ID {
        0x2::object::id<0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::market_state::MarketState>(&arg0.market_state)
    }

    public fun mint_conditional<T0, T1, T2>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: u64, arg4: &mut 0x2::tx_context::TxContext, arg5: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) : 0x2::coin::Coin<T2> {
    ...
    public fun register_conditional_caps<T0, T1, T2, T3>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: 0x2::coin::TreasuryCap<T2>, arg3: 0x2::coin::TreasuryCap<T3>) {
        assert!(arg1 < 0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::market_state::outcome_count(&arg0.market_state), 5);
    ...
    public fun track_collected_protocol_fees<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun track_swap_asset_to_stable<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
        let v0 = 0x1::vector::borrow_mut<u64>(&mut arg0.outcome_escrowed_asset, arg1);
        assert!(*v0 >= arg2, 103);
        let v1 = 0x1::vector::borrow_mut<u64>(&mut arg0.outcome_escrowed_stable, arg1);
    ...
    public fun track_swap_stable_to_asset<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun track_system_swap_asset_to_stable<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
        let v0 = 0x1::vector::borrow_mut<u64>(&mut arg0.asset_supplies, arg1);
        assert!(*v0 >= arg2, 103);
        *v0 = *v0 - arg2;
        let v1 = 0x1::vector::borrow_mut<u64>(&mut arg0.stable_supplies, arg1);
    ...
    public fun track_system_swap_stable_to_asset<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) {
        let v0 = 0x1::vector::borrow_mut<u64>(&mut arg0.stable_supplies, arg1);
        assert!(*v0 >= arg2, 103);
        *v0 = *v0 - arg2;
        let v1 = 0x1::vector::borrow_mut<u64>(&mut arg0.asset_supplies, arg1);
    ...
    public fun withdraw_asset_balance<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext, arg3: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) : 0x2::coin::Coin<T0> {
    ...
    public fun withdraw_stable_balance<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext, arg3: &0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::escrow_mutation_auth::EscrowMutationAuth) : 0x2::coin::Coin<T1> {
