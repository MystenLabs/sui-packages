module 0x681cb834438f0493c82bf4bd9d77fcfbac0843cc05242e30e0e7cb1a108a3859::PCW_TWAP_oracle {
    ...
    fun finalize_window(arg0: &mut SimpleTWAP, arg1: u64, arg2: u64, arg3: u128) {
        ...
        let v7 = if (v0 == 0) {
            ...
            let v8 = (v0 as u256) * (arg0.max_movement_ppm as u256) / (0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::ppm_denominator() as u256);
            assert!(v8 <= 340282366920938463463374607431768211455, 0);
            let (v9, v10) = if (v5 > v0) {
                (v5 - v0, true)
            } else {
                (v0 - v5, false)
            ...
            let v11 = if (arg2 > 0) {
                let v12 = (0x1::u128::max(1, (v8 as u128)) as u256) * (arg2 as u256);
        ...
        let v13 = if (v0 == 0) {
            if (v7 > 0 && arg2 > 0) {
                ...
                (v7 as u256) * ((v14 as u256) * (arg0.window_size_ms as u256) + (v1 as u256))
            } else {
                0
            }
        } else {
            let v15 = 0x1::u128::max(1, (((v0 as u256) * (arg0.max_movement_ppm as u256) / (0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::ppm_denominator() as u256)) as u128));
            let v16 = if (v7 > v0) {
                v7 - v0
            } else {
                v0 - v7
            ...
            if (v17 == 0) {
                ...
                let v19 = (v18 as u256) / (v15 as u256);
                let v20 = if (v19 >= ((arg2 - 1) as u256)) {
                    arg2 - 1
                } else {
                    (v19 as u64)
                };
                let v21 = if (arg2 > v20 + 1) {
                    (v18 as u256) * ((arg2 - 1 - v20) as u256)
                } else {
                    0
                };
                (arg0.window_size_ms as u256) * ((v15 as u256) * (v20 as u256) * ((v20 + 1) as u256) / 2 + v21) + v17 * (v1 as u256)
            }
        };
        if (v13 > 0) {
            if (v7 >= v0) {
                arg0.cumulative_total = arg0.cumulative_total + v13;
            } else if (arg0.cumulative_total >= v13) {
                arg0.cumulative_total = arg0.cumulative_total - v13;
            } else {
                arg0.cumulative_total = 0;
            };
        };
        let v22 = WindowFinalized{
            timestamp   : arg1,
            raw_twap    : v5,
            capped_twap : v7,
            num_windows : arg2,
        };
        0x2::event::emit<WindowFinalized>(v22);
    ...
    public(friend) fun force_commit_checkpoint(arg0: &mut SimpleTWAP, arg1: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg1);
        if (v0 > arg0.last_checkpoint_at && v0 - arg0.last_checkpoint_at >= 3600000) {
            record_checkpoint(arg0, v0);
        };
    }

    public fun get_ninety_day_twap(arg0: &SimpleTWAP, arg1: &0x2::clock::Clock) : 0x1::option::Option<u128> {
        get_window_twap(arg0, 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::ninety_days_ms(), arg1)
    }
    ...
    public fun get_window_twap(arg0: &SimpleTWAP, arg1: u64, arg2: &0x2::clock::Clock) : 0x1::option::Option<u128> {
        ...
        while (v3 > 0) {
            v3 = v3 - 1;
            if (0x1::vector::borrow<Checkpoint>(&arg0.checkpoints, v3).timestamp <= v0 - arg1) {
        ...
        let v4 = 0x1::vector::borrow<Checkpoint>(&arg0.checkpoints, 0x1::option::destroy_some<u64>(v2));
        let v5 = v0 - v4.timestamp;
        if (v5 == 0) {
            return 0x1::option::none<u128>()
        };
        let v6 = (projected_cumulative_arithmetic_to(arg0, v0) - v4.cumulative) / (v5 as u256);
        assert!(v6 <= 340282366920938463463374607431768211455, 0);
        0x1::option::some<u128>((v6 as u128))
    }
    ...
    fun maybe_commit_checkpoint(arg0: &mut SimpleTWAP, arg1: u64) {
        if (arg1 >= arg0.last_checkpoint_at + 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::one_week_ms()) {
    ...
    public fun new(arg0: u128, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) : SimpleTWAP {
        assert!(arg1 > 0, 1);
        assert!(arg2 > 0 && arg2 < 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::ppm_denominator(), 1);
    ...
    public fun new_default(arg0: u128, arg1: &0x2::clock::Clock) : SimpleTWAP {
        new(arg0, 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::twap_price_cap_window(), 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::default_twap_max_movement_ppm(), arg1)
    }

    public fun projected_cumulative_arithmetic_to(arg0: &SimpleTWAP, arg1: u64) : u256 {
    ...
    fun record_checkpoint(arg0: &mut SimpleTWAP, arg1: u64) {
        ...
        if (0x1::vector::length<Checkpoint>(&arg0.checkpoints) >= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_twap_checkpoints()) {
    ...
    public fun try_commit_checkpoint(arg0: &mut SimpleTWAP, arg1: &0x2::clock::Clock) : bool {
        let v0 = 0x2::clock::timestamp_ms(arg1);
        if (v0 >= arg0.last_checkpoint_at + 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::one_week_ms()) {
            record_checkpoint(arg0, v0);
            true
        } else {
            false
