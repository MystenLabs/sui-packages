module 0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::round {
    ...
    public(friend) fun new<T0>(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: bool, arg9: &mut 0x2::tx_context::TxContext) : RoundInfo<T0> {
        RoundInfo<T0>{
    ...
    public fun get_limit_per_tx<T0>(arg0: &RoundInfo<T0>) : u64 {
        arg0.limit_per_tx
    }
    ...
    public(friend) fun update<T0>(arg0: &mut RoundInfo<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64) {
        arg0.start_timestamp = arg1;
        arg0.end_timestamp = arg2;
        arg0.price = arg3;
        arg0.limit_per_wallet = arg4;
        arg0.limit_per_tx = arg5;
        arg0.allocation = arg6;
        arg0.start_mint_slot = arg7;
    }
