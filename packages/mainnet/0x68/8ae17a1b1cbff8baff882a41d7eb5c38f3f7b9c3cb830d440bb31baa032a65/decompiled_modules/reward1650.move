module 0x688ae17a1b1cbff8baff882a41d7eb5c38f3f7b9c3cb830d440bb31baa032a65::reward1650 {
    struct REWARD1650 has drop {
        dummy_field: bool,
    }

    struct TICKET_1650 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1650(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1650>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1650>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1650, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1650>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1650>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1650>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1650>>(v5, 0x2::tx_context::sender(arg1));
    }
