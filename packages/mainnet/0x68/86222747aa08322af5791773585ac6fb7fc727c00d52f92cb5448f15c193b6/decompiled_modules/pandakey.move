module 0x6886222747aa08322af5791773585ac6fb7fc727c00d52f92cb5448f15c193b6::pandakey {
    ...
    struct RoyaltyWitness has copy, drop, store {
        dummy_field: bool,
    }

    struct BpsRoyaltyConfig has drop, store {
        bps: u64,
        beneficiary: address,
    }
    ...
    public fun add_royalty_rule(arg0: &0x2::transfer_policy::TransferPolicyCap<PandaKeyNFT>, arg1: &mut 0x2::transfer_policy::TransferPolicy<PandaKeyNFT>, arg2: u64, arg3: address) {
        let v0 = BpsRoyaltyConfig{
            bps         : arg2,
            beneficiary : arg3,
        };
        let v1 = RoyaltyWitness{dummy_field: false};
        0x2::transfer_policy::add_rule<PandaKeyNFT, RoyaltyWitness, BpsRoyaltyConfig>(v1, arg1, arg0, v0);
    }
    ...
    fun init(arg0: PANDAKEY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::transfer_policy::new<PandaKeyNFT>(&v1, arg1);
        let v5 = v4;
        let v6 = v3;
        let v7 = &mut v6;
        add_royalty_rule(&v5, v7, 500, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<PandaKeyNFT>>(v5, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<PandaKeyNFT>>(v6);
    ...
    public fun pay_royalty(arg0: &0x2::transfer_policy::TransferPolicy<PandaKeyNFT>, arg1: 0x2::transfer_policy::TransferRequest<PandaKeyNFT>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<PandaKeyNFT> {
        let v0 = royalty_config(arg0);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) == 0x2::transfer_policy::paid<PandaKeyNFT>(&arg1) * v0.bps / 10000, 2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg2, v0.beneficiary);
        let v1 = RoyaltyWitness{dummy_field: false};
        0x2::transfer_policy::add_receipt<PandaKeyNFT, RoyaltyWitness>(v1, &mut arg1);
        arg1
    }

    public fun royalty_config(arg0: &0x2::transfer_policy::TransferPolicy<PandaKeyNFT>) : &BpsRoyaltyConfig {
        let v0 = RoyaltyWitness{dummy_field: false};
        0x2::dynamic_field::borrow<RoyaltyWitness, BpsRoyaltyConfig>(0x2::transfer_policy::uid<PandaKeyNFT>(arg0), v0)
    }
