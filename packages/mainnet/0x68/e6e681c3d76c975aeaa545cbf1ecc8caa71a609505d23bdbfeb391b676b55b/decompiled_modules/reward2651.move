module 0x68e6e681c3d76c975aeaa545cbf1ecc8caa71a609505d23bdbfeb391b676b55b::reward2651 {
    struct REWARD2651 has drop {
        dummy_field: bool,
    }

    struct TICKET_2651 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2651(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2651>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2651>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2651, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2651>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2651>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2651>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2651>>(v5, 0x2::tx_context::sender(arg1));
    }
