module 0x7413c110e3c4ec0e21240ab553321a9e4b4fbbf95e859a3669dd95392edffdf2::movexnft6189 {
    struct MOVEXNFT6189 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT6189, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT6189>(arg0, arg1);
