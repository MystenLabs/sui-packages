module 0x74feb2a4b9a798d06ae22806e041ae00ce823ddf133995085dbbb1622c12534b::state {
    ...
    entry fun set_config<T0: copy + drop + store, T1: copy + drop + store>(arg0: &mut State, arg1: T0, arg2: T1, arg3: &0x74feb2a4b9a798d06ae22806e041ae00ce823ddf133995085dbbb1622c12534b::capability::AdminCap) {
        0x2::dynamic_field::remove_if_exists<T0, T1>(&mut arg0.id, arg1);
        0x2::dynamic_field::add<T0, T1>(&mut arg0.id, arg1, arg2);
    }

    entry fun update(arg0: &mut State, arg1: bool, arg2: u16, arg3: u256, arg4: &0x74feb2a4b9a798d06ae22806e041ae00ce823ddf133995085dbbb1622c12534b::capability::AdminCap) {
