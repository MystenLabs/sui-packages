module 0x74bdadaf5b0426273edff0f878daefbcf7283b4a878fbdb85165f40dc65c7506::reward7208 {
    struct REWARD7208 has drop {
        dummy_field: bool,
    }

    struct TICKET_7208 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7208(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7208>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7208>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7208, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7208>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7208>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7208>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7208>>(v5, 0x2::tx_context::sender(arg1));
    }
