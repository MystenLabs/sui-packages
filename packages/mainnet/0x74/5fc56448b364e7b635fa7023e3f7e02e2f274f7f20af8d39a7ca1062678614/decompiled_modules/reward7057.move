module 0x745fc56448b364e7b635fa7023e3f7e02e2f274f7f20af8d39a7ca1062678614::reward7057 {
    struct REWARD7057 has drop {
        dummy_field: bool,
    }

    struct TICKET_7057 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7057(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7057>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7057>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7057, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7057>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7057>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7057>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7057>>(v5, 0x2::tx_context::sender(arg1));
    }
