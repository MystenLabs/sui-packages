module 0x7415c9758bf8ced58e45e0b35e4d6181f3b32a10eba5343a9042aa31af7d7303::deepbookv3_agg {
    ...
    public fun swap<T0, T1, T2>(arg0: &0xfddabf2333596909a075c8b11b6e8b42c2040806728ae63bebcff3a3bdde41b2::liquidator::Liquidator, arg1: &mut 0xfddabf2333596909a075c8b11b6e8b42c2040806728ae63bebcff3a3bdde41b2::custom_liquidate::CustomLiquidateReceipt<T0>, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T1, T2>, arg3: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg4: bool, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = if (arg4) {
            ...
            swap_a2b<T1, T2>(arg2, 0xfddabf2333596909a075c8b11b6e8b42c2040806728ae63bebcff3a3bdde41b2::custom_liquidate::take_balance<DeepbookV3Agg, T0, T1>(arg1, arg0, v3, arg5), arg3, arg6, arg7, arg8)
        } else {
            let v4 = DeepbookV3Agg{dummy_field: false};
            swap_b2a<T1, T2>(arg2, 0xfddabf2333596909a075c8b11b6e8b42c2040806728ae63bebcff3a3bdde41b2::custom_liquidate::take_balance<DeepbookV3Agg, T0, T2>(arg1, arg0, v4, arg5), arg3, arg6, arg7, arg8)
        };
        let v5 = v2;
        let v6 = v1;
        let v7 = v0;
        if (0x2::balance::value<T1>(&v7) > 0) {
            ...
            0xfddabf2333596909a075c8b11b6e8b42c2040806728ae63bebcff3a3bdde41b2::custom_liquidate::put_balance<DeepbookV3Agg, T0, T1>(arg1, arg0, v8, v7);
        } else {
            0x2::balance::destroy_zero<T1>(v7);
        };
        if (0x2::balance::value<T2>(&v6) > 0) {
            let v9 = DeepbookV3Agg{dummy_field: false};
            0xfddabf2333596909a075c8b11b6e8b42c2040806728ae63bebcff3a3bdde41b2::custom_liquidate::put_balance<DeepbookV3Agg, T0, T2>(arg1, arg0, v9, v6);
        } else {
