module 0x74291ed88c301a95b781e15e29342fe22005b0c95e282dd62d9c48123b1ecbae::reward2618 {
    struct REWARD2618 has drop {
        dummy_field: bool,
    }

    struct TICKET_2618 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2618(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2618>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2618>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2618, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2618>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2618>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2618>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2618>>(v5, 0x2::tx_context::sender(arg1));
    }
