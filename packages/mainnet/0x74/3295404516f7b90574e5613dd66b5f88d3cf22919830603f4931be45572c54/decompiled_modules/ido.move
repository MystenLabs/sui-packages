module 0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::ido {
    struct IDO has drop {
        dummy_field: bool,
    }
    ...
    public fun addMaxAllocations<T0>(arg0: &ManagerCap, arg1: vector<address>, arg2: vector<u64>, arg3: &mut Pool<T0>, arg4: &mut 0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg4, 1);
    ...
    public fun addMemberInVault(arg0: &Admincap, arg1: address, arg2: &mut Vault, arg3: &mut 0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg3, 1);
    ...
    public fun addWhitelist<T0>(arg0: &ManagerCap, arg1: &mut Pool<T0>, arg2: vector<address>, arg3: &mut 0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg3, 1);
    ...
    public fun buy<T0>(arg0: &mut Pool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg3, 1);
    ...
    public fun buyByTokenFree<T0>(arg0: &mut Pool<T0>, arg1: vector<address>, arg2: vector<u64>, arg3: vector<vector<u8>>, arg4: 0x2::coin::Coin<T0>, arg5: &ProviderCap, arg6: &0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg6, 1);
    ...
    public fun changeMemberInVault(arg0: &Admincap, arg1: address, arg2: &mut Vault, arg3: &mut 0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg3, 1);
    ...
    public fun changeOperationWallet(arg0: &mut Operation, arg1: &Vault, arg2: address, arg3: &mut 0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg3, 1);
    ...
    public fun changeStatus<T0>(arg0: &Admincap, arg1: &mut Pool<T0>, arg2: u8, arg3: &0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg3, 1);
    ...
    public fun configMaxInTurn<T0>(arg0: &Admincap, arg1: &mut Pool<T0>, arg2: bool, arg3: u128, arg4: &0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg4, 1);
    ...
    public fun createPool<T0>(arg0: &Admincap, arg1: vector<u8>, arg2: u128, arg3: u64, arg4: u64, arg5: u128, arg6: bool, arg7: &mut 0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg7, 1);
    ...
    fun init(arg0: IDO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::cap_vault::createVault<Admincap>(arg1);
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::cap_vault::createVault<TreasureCap>(arg1);
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::cap_vault::createVault<ProviderCap>(arg1);
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::cap_vault::createVault<ManagerCap>(arg1);
        let v4 = Operation{
    ...
    public fun removeMaxAllocations<T0>(arg0: &ManagerCap, arg1: vector<address>, arg2: &mut Pool<T0>, arg3: &mut 0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg3, 1);
    ...
    public fun removeWhitelist<T0>(arg0: &ManagerCap, arg1: &mut Pool<T0>, arg2: vector<address>, arg3: &mut 0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg3, 1);
        assert!(arg1.use_whitelist, 1006);
        assert!(0x1::vector::length<address>(&arg2) > 0, 1007);
        let v0 = &mut arg1.whitelist;
    ...
    public fun updateDefaultMaxAllocate<T0>(arg0: &Admincap, arg1: &mut Pool<T0>, arg2: u128, arg3: &0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg3, 1);
        assert!(arg2 > 0, 1004);
    ...
    public fun updateTargetedRaise<T0>(arg0: &Admincap, arg1: &mut Pool<T0>, arg2: u128, arg3: &0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg3, 1);
        assert!(arg2 > 0, 1004);
    ...
    public fun updateTime<T0>(arg0: &Admincap, arg1: &mut Pool<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg5, 1);
    ...
    public fun updateUseWhitelist<T0>(arg0: &Admincap, arg1: &mut Pool<T0>, arg2: bool, arg3: &0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg3, 1);
    ...
    public fun withdrawFundAll<T0>(arg0: &TreasureCap, arg1: &mut Pool<T0>, arg2: &Operation, arg3: &0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg3, 1);
    ...
    public fun withdrawFundAmount<T0>(arg0: &TreasureCap, arg1: &mut Pool<T0>, arg2: u64, arg3: &Operation, arg4: &0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        0x743295404516f7b90574e5613dd66b5f88d3cf22919830603f4931be45572c54::version::checkVersion(arg4, 1);
