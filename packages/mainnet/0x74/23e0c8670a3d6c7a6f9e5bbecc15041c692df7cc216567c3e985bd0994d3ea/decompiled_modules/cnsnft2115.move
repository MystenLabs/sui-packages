module 0x7423e0c8670a3d6c7a6f9e5bbecc15041c692df7cc216567c3e985bd0994d3ea::cnsnft2115 {
    struct CNSNFT2115 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2115, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2115>(arg0, arg1);
