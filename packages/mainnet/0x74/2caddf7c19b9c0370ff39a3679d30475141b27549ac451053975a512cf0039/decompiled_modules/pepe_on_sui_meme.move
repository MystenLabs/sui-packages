module 0x742caddf7c19b9c0370ff39a3679d30475141b27549ac451053975a512cf0039::pepe_on_sui_meme {
    struct PEPE_ON_SUI_MEME has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PEPE_ON_SUI_MEME, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PEPE_ON_SUI_MEME>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Pepe On Sui Meme"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Pepe On Sui Meme holders will be entered into the Giveaway for 25 Pepe On Sui OG Collection NFTs on April 15th."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreievwvvbmzcopdrincdihmhwuz3wgu4jann4mvcwewpkul2glvbvre"));
