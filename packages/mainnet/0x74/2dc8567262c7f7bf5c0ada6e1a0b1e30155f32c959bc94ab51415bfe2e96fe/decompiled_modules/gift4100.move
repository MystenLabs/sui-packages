module 0x742dc8567262c7f7bf5c0ada6e1a0b1e30155f32c959bc94ab51415bfe2e96fe::gift4100 {
    struct GIFT4100 has drop {
        dummy_field: bool,
    }

    struct TICKET_4100 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4100(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4100>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4100>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4100, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4100>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4100>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4100>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4100>>(v5, 0x2::tx_context::sender(arg1));
    }
