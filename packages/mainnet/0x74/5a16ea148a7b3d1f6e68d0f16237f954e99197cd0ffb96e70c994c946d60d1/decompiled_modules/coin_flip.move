module 0x745a16ea148a7b3d1f6e68d0f16237f954e99197cd0ffb96e70c994c946d60d1::coin_flip {
    ...
    public entry fun start_game_with_bullshark(arg0: &0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: u8, arg3: vector<u8>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut HouseData, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::kiosk::has_item_with_type<0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::suifrens::SuiFren<0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::bullshark::Bullshark>>(arg0, arg1), 11);
        let v0 = reduced_fee_in_bp(arg5);
        0x2::transfer::share_object<Game>(internal_start_game(arg2, arg3, arg4, arg5, v0, arg6));
    }
    ...
    public entry fun start_game_with_capy(arg0: &0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::suifrens::SuiFren<0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::capy::Capy>, arg1: u8, arg2: vector<u8>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut HouseData, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = reduced_fee_in_bp(arg4);
        0x2::transfer::share_object<Game>(internal_start_game(arg1, arg2, arg3, arg4, v0, arg5));
    }

    public entry fun start_game_with_dlab(arg0: &0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: u8, arg3: vector<u8>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut HouseData, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::kiosk::has_item_with_type<0x4edaf43ada89b42ba4dee9fbf74a4dee3eb01f3cfd311d4fb2c6946f87952e51::dlab::Dlab>(arg0, arg1), 12);
        let v0 = reduced_fee_in_bp(arg5);
        0x2::transfer::share_object<Game>(internal_start_game(arg2, arg3, arg4, arg5, v0, arg6));
    }
