module 0x74d1885e37610737287b1f5ad6f2e4fdadec23942fbd7eb0e5e650a3eb610b4f::reward4238 {
    struct REWARD4238 has drop {
        dummy_field: bool,
    }

    struct TICKET_4238 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4238(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4238>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4238>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4238, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4238>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4238>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4238>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4238>>(v5, 0x2::tx_context::sender(arg1));
    }
