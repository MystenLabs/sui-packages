module 0x7426f9b408b2dabba8738fa05370ee0baeee473d8ae6ae5f9c1d6afe3fdb7d04::dun {
    struct DUN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DUN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/BNbwPUhjbq8wXeUvt6HkH2v8TJimrMPPB9fysx1Spump.png                                                                                                                                                                                                                               ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DUN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DUN       ")))), trim_right(b"Dungeon Arena                   "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
