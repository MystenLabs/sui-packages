module 0x7481691cf110704b1ba0c10b9963761ef51113fe5803f6c0295c0266b955c204::cnsnft1184 {
    struct CNSNFT1184 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1184, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2245"));
        let v4 = 0x2::package::claim<CNSNFT1184>(arg0, arg1);
