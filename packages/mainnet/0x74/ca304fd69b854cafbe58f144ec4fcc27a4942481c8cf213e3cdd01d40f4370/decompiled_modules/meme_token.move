module 0x74ca304fd69b854cafbe58f144ec4fcc27a4942481c8cf213e3cdd01d40f4370::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"VSSA", b"Fucoin", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-31T12-03-39.680Z-images.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Fucoin"),
            symbol     : 0x1::string::utf8(b"VSSA"),
            decimals   : 9,
