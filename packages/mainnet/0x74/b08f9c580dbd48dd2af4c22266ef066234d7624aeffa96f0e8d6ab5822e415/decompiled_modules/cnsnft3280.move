module 0x74b08f9c580dbd48dd2af4c22266ef066234d7624aeffa96f0e8d6ab5822e415::cnsnft3280 {
    struct CNSNFT3280 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3280, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3280>(arg0, arg1);
