module 0x744e231a0915c6748d2f144ef03f7f675ebb233b1c51b7ad43a42afb678646a6::cnsnft6344 {
    struct CNSNFT6344 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6344, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9322"));
        let v4 = 0x2::package::claim<CNSNFT6344>(arg0, arg1);
