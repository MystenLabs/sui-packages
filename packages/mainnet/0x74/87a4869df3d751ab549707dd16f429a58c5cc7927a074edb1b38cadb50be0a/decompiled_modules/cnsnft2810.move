module 0x7487a4869df3d751ab549707dd16f429a58c5cc7927a074edb1b38cadb50be0a::cnsnft2810 {
    struct CNSNFT2810 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2810, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2810>(arg0, arg1);
