module 0x743f10827d7a7b755cc88e01015f39fbb8b5165a6b0d7254f4d34a1f8e1e63b1::treasury {
    ...
    public fun split_and_route(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: &FeeSplit, arg3: &mut Vaults, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        let v1 = v0 * arg2.faithed_bps / 10000;
        let v2 = v0 * arg2.manifest_bps / 10000;
        0x2::coin::join<0x2::sui::SUI>(&mut arg3.faithed, 0x2::coin::split<0x2::sui::SUI>(&mut arg0, v1, arg4));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg0, v2, arg4), arg1);
        0x2::coin::join<0x2::sui::SUI>(&mut arg3.ops, 0x2::coin::split<0x2::sui::SUI>(&mut arg0, v0 - v1 - v2, arg4));
