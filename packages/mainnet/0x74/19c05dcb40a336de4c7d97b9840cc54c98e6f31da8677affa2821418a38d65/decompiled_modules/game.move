module 0x7419c05dcb40a336de4c7d97b9840cc54c98e6f31da8677affa2821418a38d65::game {
    ...
    struct Played has copy, drop, store {
        game: 0x2::object::ID,
        player: address,
        win: bool,
        bet: u64,
    ...
    entry fun new<T0>(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Game<T0>{
            ...
            last_played        : 0x1::vector::empty<Played>(),
            total_plays        : 0,
            total_wins         : 0,
            total_losses       : 0,
            total_volume       : 0,
    ...
    fun bonus_play<T0>(arg0: &mut Game<T0>, arg1: &mut 0x2::random::RandomGenerator, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x7419c05dcb40a336de4c7d97b9840cc54c98e6f31da8677affa2821418a38d65::random_utils::weighted_random_choice<u64>(arg0.bonus_weights, arg0.bonus_values, arg1);
        let v1 = 0x7419c05dcb40a336de4c7d97b9840cc54c98e6f31da8677affa2821418a38d65::pay_utils::balance_split_percent_to_coin<T0>(&mut arg0.fees, v0, arg2);
        let v2 = 0x2::coin::value<T0>(&v1);
        update_bonus_stats<T0>(arg0, v2);
        ...
        0x2::event::emit<BonusPlayed>(v3);
    }

    entry fun burn_fees<T0>(arg0: &GameAdmin, arg1: &mut Game<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        assert_admin<T0>(arg1, arg0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x7419c05dcb40a336de4c7d97b9840cc54c98e6f31da8677affa2821418a38d65::pay_utils::balance_withdraw_all_to_coin<T0>(&mut arg1.fees, arg2), @0x0);
    }
    ...
    entry fun play<T0>(arg0: &mut Game<T0>, arg1: &0x2::random::Random, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x7419c05dcb40a336de4c7d97b9840cc54c98e6f31da8677affa2821418a38d65::pay_utils::coin_split_percent_to_coin<T0>(&mut arg2, arg0.fee_percentage, arg3);
        0x7419c05dcb40a336de4c7d97b9840cc54c98e6f31da8677affa2821418a38d65::pay_utils::balance_top_up<T0>(&mut arg0.fees, v0);
        assert!(0x2::balance::value<T0>(&arg0.pool) >= 0x2::coin::value<T0>(&arg2), 3);
        let v1 = 0x2::coin::value<T0>(&arg2);
        let v2 = v1 * 2;
        0x7419c05dcb40a336de4c7d97b9840cc54c98e6f31da8677affa2821418a38d65::pay_utils::balance_top_up<T0>(&mut arg0.pool, arg2);
        let v3 = 0x2::random::new_generator(arg1, arg3);
        let v4 = 0x2::random::generate_bool(&mut v3);
        if (v4) {
            0x7419c05dcb40a336de4c7d97b9840cc54c98e6f31da8677affa2821418a38d65::pay_utils::balance_withdraw<T0>(&mut arg0.pool, v2, arg3);
        };
        ...
        update_last_played<T0>(arg0, v5);
        0x2::event::emit<Played>(v5);
        if (is_bonus_play<T0>(arg0)) {
            let v6 = &mut v3;
            bonus_play<T0>(arg0, v6, arg3);
        };
    }
    ...
    entry fun top_up_pool<T0>(arg0: &mut Game<T0>, arg1: 0x2::coin::Coin<T0>) {
        0x7419c05dcb40a336de4c7d97b9840cc54c98e6f31da8677affa2821418a38d65::pay_utils::balance_top_up<T0>(&mut arg0.pool, arg1);
    }
    ...
    fun update_last_played<T0>(arg0: &mut Game<T0>, arg1: Played) {
        let v0 = &mut arg0.last_played;
        if (0x1::vector::length<Played>(v0) >= 10) {
            0x1::vector::reverse<Played>(v0);
            0x1::vector::pop_back<Played>(v0);
            0x1::vector::reverse<Played>(v0);
        };
        0x1::vector::push_back<Played>(v0, arg1);
    }
    ...
    entry fun withdraw_fees<T0>(arg0: &GameAdmin, arg1: &mut Game<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        assert_admin<T0>(arg1, arg0);
        0x7419c05dcb40a336de4c7d97b9840cc54c98e6f31da8677affa2821418a38d65::pay_utils::balance_withdraw_all<T0>(&mut arg1.fees, arg2);
    }

    entry fun withdraw_pool<T0>(arg0: &GameAdmin, arg1: &mut Game<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        assert_admin<T0>(arg1, arg0);
        0x7419c05dcb40a336de4c7d97b9840cc54c98e6f31da8677affa2821418a38d65::pay_utils::balance_withdraw_all<T0>(&mut arg1.pool, arg2);
    }
