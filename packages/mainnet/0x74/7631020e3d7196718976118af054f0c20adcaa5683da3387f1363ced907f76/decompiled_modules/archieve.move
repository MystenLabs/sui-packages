module 0x747631020e3d7196718976118af054f0c20adcaa5683da3387f1363ced907f76::archieve {
    ...
    public fun increaseGetNftDepegNonce(arg0: &mut UserArchieve, arg1: &0x2::tx_context::TxContext) : u128 {
        assert!(0x2::tx_context::sender(arg1) == arg0.owner, 8005);
    ...
    public fun verUpdateNftDepegNonce(arg0: u128, arg1: &mut UserArchieve, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg1.owner, 8005);
        assert!(arg1.depeg_nft_nonce < arg0, 8002);
        arg1.depeg_nft_nonce = arg0;
    }

    public fun verUpdateNftPegNonce(arg0: u128, arg1: &mut UserArchieve, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg1.owner, 8005);
