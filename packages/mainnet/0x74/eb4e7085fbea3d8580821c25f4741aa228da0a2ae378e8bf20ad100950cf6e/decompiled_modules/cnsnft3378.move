module 0x74eb4e7085fbea3d8580821c25f4741aa228da0a2ae378e8bf20ad100950cf6e::cnsnft3378 {
    struct CNSNFT3378 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3378, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1497"));
        let v4 = 0x2::package::claim<CNSNFT3378>(arg0, arg1);
