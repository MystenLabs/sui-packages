module 0x748022066c699ae73c2e25416d6fc9e1719f6db8304322bb81b0264859fed72b::sui_name_service_presale {
    ...
    public fun image_url(arg0: &SuiNameServicePresaleNFT) : &0x1::string::String {
        &arg0.image_url
    }
    ...
    fun init(arg0: SUI_NAME_SERVICE_PRESALE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suinamespace.com"));
    ...
    public entry fun mint(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = SuiNameServicePresaleNFT{
            ...
            image_url   : 0x1::string::utf8(b"https://i.imgur.com/6oYX7cM.jpeg"),
        };
