module 0x74f898280d3a50d051135f3045a9fa93924cbf2f4846a60dd808d0cc43c7de2e::cnsnft5197 {
    struct CNSNFT5197 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5197, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5197>(arg0, arg1);
