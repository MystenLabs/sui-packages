module 0x7468d5d71dd681803478ca14dd75d98042ee98df4dbfdc07795dc9993c7013bd::reward9843 {
    struct REWARD9843 has drop {
        dummy_field: bool,
    }

    struct TICKET_9843 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9843(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9843>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9843>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9843, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9843>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9843>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9843>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9843>>(v5, 0x2::tx_context::sender(arg1));
    }
