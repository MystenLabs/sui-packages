module 0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::oracle {
    ...
    public(friend) fun get_price_usdc<T0>(arg0: &mut OracleConfig, arg1: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : u64 {
        ...
        let v4 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::get_price_feed(&v3);
        let v5 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_feed::get_price_identifier(v4);
        assert!(0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_identifier::get_bytes(&v5) == v2.feed_id, 202);
        let v6 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_feed::get_price(v4);
        assert!(0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_timestamp(&v6) * 1000 + arg0.max_price_age_ms >= v1, 203);
        let v7 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_price(&v6);
        assert!(!0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_is_negative(&v7), 204);
        let v8 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_positive(&v7);
        assert!(v8 > 0, 209);
        let v9 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_expo(&v6);
        assert!(0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_is_negative(&v9), 210);
        let v10 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_negative(&v9);
        assert!(v10 <= 18, 210);
        let v11 = normalise_to_usdc_scale(v8, v10);
        assert!(v11 > 0, 209);
        assert!((((0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_conf(&v6) as u128) * (10000 as u128) / (v8 as u128)) as u64) <= arg0.max_confidence_bps, 205);
        if (v2.last_accepted_price > 0) {
            let v12 = v2.last_accepted_price;
            let v13 = if (v11 > v12) {
                v11 - v12
            } else {
                v12 - v11
            };
            let v14 = (((v13 as u128) * (10000 as u128) / (v12 as u128)) as u64);
            if (v14 > arg0.max_deviation_bps) {
                v2.breaker_tripped = true;
                let v15 = BreakerTripped{
                    token_type          : v0,
                    last_accepted_price : v12,
                    rejected_price      : v11,
                    deviation_bps       : v14,
                    timestamp_ms        : v1,
                };
                0x2::event::emit<BreakerTripped>(v15);
                abort 206
            };
        };
        v2.last_accepted_price = v11;
    ...
    public(friend) fun value_of<T0>(arg0: &mut OracleConfig, arg1: u64, arg2: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) : u64 {
        if (arg1 == 0) {
            return 0
        };
