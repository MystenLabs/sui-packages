module 0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::vault {
    ...
    struct SuiX5Vault has key {
        ...
        usdc_reserve: u64,
        suix5_treasury: 0x2::coin::TreasuryCap<0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::suix5::SUIX5>,
        suix5_supply: u64,
        oracle: 0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::oracle::OracleConfig,
        composition: 0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::composition::Composition,
        trading: 0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::trading::TradingConfig,
    ...
    entry fun register_feed<T0>(arg0: &mut SuiX5Vault, arg1: vector<u8>, arg2: u8, arg3: &0x2::tx_context::TxContext) {
        ...
        0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::oracle::register_feed<T0>(&mut arg0.oracle, arg1, arg2);
    }
    ...
    entry fun remove_feed<T0>(arg0: &mut SuiX5Vault, arg1: &0x2::tx_context::TxContext) {
        ...
        0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::oracle::remove_feed<T0>(&mut arg0.oracle);
    }

    entry fun reset_breaker<T0>(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
        0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::oracle::reset_breaker<T0>(&mut arg0.oracle, arg2);
    }

    entry fun remove_pool<T0>(arg0: &mut SuiX5Vault, arg1: &0x2::tx_context::TxContext) {
        if (arg0.require_admin_for_pools) {
            assert_admin(arg0, arg1);
        } else {
            assert_authorized(arg0, arg1);
        };
        0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::trading::remove_pool<T0>(&mut arg0.trading);
    }

    entry fun set_max_slippage(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
        0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::trading::set_max_slippage(&mut arg0.trading, arg2);
    }

    entry fun whitelist_pool<T0, T1>(arg0: &mut SuiX5Vault, arg1: 0x2::object::ID, arg2: bool, arg3: &0x2::tx_context::TxContext) {
        if (arg0.require_admin_for_pools) {
            assert_admin(arg0, arg3);
        } else {
            assert_authorized(arg0, arg3);
        };
        0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::trading::whitelist_pool<T0, T1>(&mut arg0.trading, arg1, arg2);
    }
    ...
    public(friend) fun burn_suix5(arg0: &mut SuiX5Vault, arg1: 0x2::coin::Coin<0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::suix5::SUIX5>) : u64 {
        let v0 = 0x2::coin::value<0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::suix5::SUIX5>(&arg1);
        assert!(v0 > 0, 105);
        assert!(arg0.suix5_supply >= v0, 104);
        arg0.suix5_supply = arg0.suix5_supply - v0;
        0x2::coin::burn<0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::suix5::SUIX5>(&mut arg0.suix5_treasury, arg1);
        v0
    }
    ...
    entry fun cancel_composition(arg0: &mut SuiX5Vault, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        ...
        0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::composition::cancel_pending(&mut arg0.composition, arg1, arg2);
    }
    ...
    public(friend) fun composition_mut(arg0: &mut SuiX5Vault) : &mut 0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::composition::Composition {
        &mut arg0.composition
    }

    public(friend) fun composition_ref(arg0: &SuiX5Vault) : &0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::composition::Composition {
        &arg0.composition
    }

    entry fun create_vault(arg0: 0x2::coin::TreasuryCap<0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::suix5::SUIX5>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = SuiX5Vault{
            ...
            suix5_treasury            : arg0,
            suix5_supply              : 0,
            oracle                    : 0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::oracle::new(arg1),
            composition               : 0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::composition::new(arg1),
            trading                   : 0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::trading::new(arg1),
    ...
    entry fun execute_composition(arg0: &mut SuiX5Vault, arg1: &0x2::clock::Clock) {
        0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::composition::execute_pending(&mut arg0.composition, &arg0.oracle, arg1);
    }
    ...
    public(friend) fun mint_suix5(arg0: &mut SuiX5Vault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::suix5::SUIX5> {
        assert!(arg1 > 0, 105);
        arg0.suix5_supply = arg0.suix5_supply + arg1;
        0x2::coin::mint<0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::suix5::SUIX5>(&mut arg0.suix5_treasury, arg1, arg2)
    }
    ...
    public(friend) fun oracle_mut(arg0: &mut SuiX5Vault) : &mut 0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::oracle::OracleConfig {
        &mut arg0.oracle
    }

    public(friend) fun oracle_ref(arg0: &SuiX5Vault) : &0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::oracle::OracleConfig {
        &arg0.oracle
    }
    ...
    public fun orphans(arg0: &SuiX5Vault) : vector<0x1::type_name::TypeName> {
        ...
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&arg0.discovered_tokens)) {
            ...
            if (tracked_balance(arg0, v2) > 0 && !0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::composition::contains(&arg0.composition, v2)) {
    ...
    entry fun propose_composition<T0, T1, T2, T3, T4>(arg0: &mut SuiX5Vault, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        ...
        0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::composition::propose(&mut arg0.composition, &arg0.oracle, v1, v3, arg6, arg7, arg8);
    }
    ...
    entry fun set_composition_timelock(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
        0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::composition::set_timelock(&mut arg0.composition, arg2);
    }
    ...
    entry fun set_genesis_composition<T0, T1, T2, T3, T4>(arg0: &mut SuiX5Vault, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        ...
        0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::composition::set_genesis(&mut arg0.composition, &arg0.oracle, v0, v2, arg6, arg7);
    }
    ...
    entry fun set_oracle_config(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::oracle::set_config(&mut arg0.oracle, arg2, arg3, arg4);
    }
    ...
    public(friend) fun trading_mut(arg0: &mut SuiX5Vault) : &mut 0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::trading::TradingConfig {
        &mut arg0.trading
    }

    public(friend) fun trading_ref(arg0: &SuiX5Vault) : &0x7462018d9266714d1f9f00533942232526d7a304125cf38228b74d51bf452df0::trading::TradingConfig {
        &arg0.trading
    }
