module 0x74fe82a500c04d9e0c1d135d9aa8244f8e357e14fb3d0a413f25019e6668cddc::cnsnft3019 {
    struct CNSNFT3019 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3019, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3019>(arg0, arg1);
