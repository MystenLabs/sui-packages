module 0x74424dce8ee935761f1c3de53c9212bb137bfb0f93cd626d34cd32e40ef20bef::router {
    struct SwapContext {
    ...
    public fun finish_swap<T0>(arg0: SwapContext, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(v12 >= v4, 0x74424dce8ee935761f1c3de53c9212bb137bfb0f93cd626d34cd32e40ef20bef::errors::err_amount_out_slippage_check_failed());
        assert!(0x2::bag::is_empty(&v8), 0x74424dce8ee935761f1c3de53c9212bb137bfb0f93cd626d34cd32e40ef20bef::errors::err_remains_balance());
    ...
    public fun merge_coin<T0, T1>(arg0: &mut SwapContext, arg1: u64, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun start_swap<T0, T1>(arg0: 0x1::string::String, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u32, arg4: address, arg5: &mut 0x2::tx_context::TxContext) : SwapContext {
        assert!(0x2::coin::value<T0>(&arg2) <= max_amount_in(), 0x74424dce8ee935761f1c3de53c9212bb137bfb0f93cd626d34cd32e40ef20bef::errors::err_exceed_max_amount_in());
        assert!(0x2::coin::value<T0>(&arg2) > 0, 0x74424dce8ee935761f1c3de53c9212bb137bfb0f93cd626d34cd32e40ef20bef::errors::err_amount_in_is_zero());
        if (arg3 > 0) {
            assert!(arg4 != @0x0, 0x74424dce8ee935761f1c3de53c9212bb137bfb0f93cd626d34cd32e40ef20bef::errors::err_invalid_fee_recipient());
        };
        assert!(arg3 <= 100000, 0x74424dce8ee935761f1c3de53c9212bb137bfb0f93cd626d34cd32e40ef20bef::errors::err_too_large_fee_rate());
    ...
    public fun take_coin<T0>(arg0: &mut SwapContext, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u64) {
        let v0 = take_balance<T0>(arg0, arg1);
        let v1 = 0x2::balance::value<T0>(&v0);
        if (v1 == 0) {
            0x2::balance::destroy_zero<T0>(v0);
            return (0x2::coin::zero<T0>(arg2), 0)
        };
