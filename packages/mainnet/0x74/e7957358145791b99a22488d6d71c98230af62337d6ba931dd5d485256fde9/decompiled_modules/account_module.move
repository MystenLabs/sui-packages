module 0x6f4d6c9144389922a62ad02ba69bc6772731466764259602917cb8ce49ce3cad::account_module {
    ...
    fun check_rate(arg0: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg1: u64) {
        assert!(get_apy(arg0) < arg1, 104);
    }

    fun get_apy(arg0: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market) : u64 {
        let v0 = 4294967296;
        let v1 = 10000;
        let v2 = 10;
        ...
        while (v7 < 0x1::vector::length<0x1::type_name::TypeName>(&v6)) {
            ...
            if (0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::interest_model::type_name(v10) == 0x1::type_name::get<0x2::sui::SUI>()) {
                let v15 = v1 * 0x1::fixed_point32::get_raw_value(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::borrow_dynamics::interest_rate(v9)) / 1361925194 * (v0 - 0x1::fixed_point32::get_raw_value(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::interest_model::revenue_factor(v10))) / v0 * v2 * v12 / (v11 + v12 - v13) * v1 / v2 / v1;
