module 0x7485d264ec1819dae93bef100a174faddadd1f6d800fdad02c134d309c36d80e::pebble__star__points {
    struct PEBBLE__STAR__POINTS has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let v0 = if (b"https://dxzj0lxt4bkn6mwx.public.blob.vercel-storage.com/starpoints-rEpU3skrg5NxxyeEkz0WoYfLn75S87.png" == b"") {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://dxzj0lxt4bkn6mwx.public.blob.vercel-storage.com/starpoints-rEpU3skrg5NxxyeEkz0WoYfLn75S87.png"))
        };
        let (v1, v2) = 0x2::coin::create_currency<T0>(arg0, 18, b"STRP", b"Star Points", b"The following contract regulates the functioning of Pebble Loyalty Tokens", v0, arg1);
