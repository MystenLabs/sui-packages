module 0x74d71762aa76af23cb0eb1a6677b81494e426860ea77c10bb37caa7a53bba2ef::kiosk_staking {
    ...
    public entry fun stake_finalize<T0: store + key>(arg0: &mut Global, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.enabled, 1);
        ...
        0x2::table::add<0x2::object::ID, StakedItemInfo>(&mut arg0.staked, arg2, v5);
        inc_active(arg0, v2);
        let v6 = Staked{
            kiosk            : v1,
            item             : arg2,
