module 0x74f2b7d851f8bcb7ee4c3597ce928d4d07418d78ba271cf223f241d0213dd8b0::reward8467 {
    struct REWARD8467 has drop {
        dummy_field: bool,
    }

    struct TICKET_8467 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8467(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8467>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8467>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8467, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8467>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8467>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8467>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8467>>(v5, 0x2::tx_context::sender(arg1));
    }
