module 0x91de198eb7f3053addc2ce9d42cf7287affe819733f9e17f1ae1e33d75f96285::reward9777 {
    struct REWARD9777 has drop {
        dummy_field: bool,
    }

    struct TICKET_9777 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9777(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9777>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9777>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9777, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9777>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9777>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9777>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9777>>(v5, 0x2::tx_context::sender(arg1));
    }
