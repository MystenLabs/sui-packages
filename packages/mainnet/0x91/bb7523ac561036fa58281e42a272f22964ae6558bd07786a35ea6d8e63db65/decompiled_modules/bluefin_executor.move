module 0xe0fb88401d43e89ce8a3a1452153831876201bd0a7ac12d63987d68b773e2780::bluefin_executor {
    ...
    public(friend) fun exec_add_liquidity<T0, T1, T2, T3>(arg0: &mut BluefinExecutorConfig, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg3: u32, arg4: u32, arg5: &mut 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::Vault<T0, T1>, arg6: &mut 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::VaultConfig, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let v2 = if (arg7 > 0) {
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::spend_harvest_asset<T0, T1, T2>(arg6, arg5, arg7, v1, arg10)
        } else {
            0x2::coin::zero<T2>(arg10)
        };
        let v3 = if (arg8 > 0) {
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::spend_harvest_asset<T0, T1, T3>(arg6, arg5, arg8, v1, arg10)
        } else {
        ...
        if (0x2::balance::value<T2>(&v9) > 0) {
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::add_harvest_assets<T0, T1, T2>(arg6, arg5, 0x2::coin::from_balance<T2>(v9, arg10), v1);
        } else {
            0x2::balance::destroy_zero<T2>(v9);
        };
        if (0x2::balance::value<T3>(&v8) > 0) {
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::add_harvest_assets<T0, T1, T3>(arg6, arg5, 0x2::coin::from_balance<T3>(v8, arg10), v1);
        } else {
            0x2::balance::destroy_zero<T3>(v8);
        };
        emit_event_add_liquidity<T2, T3>(arg0, arg2, 0x2::object::id<0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::Vault<T0, T1>>(arg5), v0, v4, v5, arg3, arg4);
        (v4, v5)
    }
    ...
    public(friend) fun exec_add_liquidity_have_coin_a_in_vault<T0, T1, T2>(arg0: &mut BluefinExecutorConfig, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg3: u32, arg4: u32, arg5: &mut 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::Vault<T0, T1>, arg6: &mut 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::VaultConfig, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let v1 = 0x1::option::borrow<0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::AccessCap>(&arg0.access_cap);
        let v2 = if (arg7 > 0) {
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::spend_vault_funds<T0, T1>(arg6, arg5, arg7, v1, arg10)
        } else {
            0x2::coin::zero<T0>(arg10)
        };
        let v3 = if (arg8 > 0) {
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::spend_harvest_asset<T0, T1, T2>(arg6, arg5, arg8, v1, arg10)
        } else {
            0x2::coin::zero<T2>(arg10)
        };
        ...
        if (0x2::balance::value<T0>(&v9) > 0) {
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::add_fund<T0, T1>(arg5, 0x2::coin::from_balance<T0>(v9, arg10), arg10);
        } else {
            0x2::balance::destroy_zero<T0>(v9);
        };
        if (0x2::balance::value<T2>(&v8) > 0) {
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::add_harvest_assets<T0, T1, T2>(arg6, arg5, 0x2::coin::from_balance<T2>(v8, arg10), v1);
        } else {
            0x2::balance::destroy_zero<T2>(v8);
        };
        emit_event_add_liquidity<T0, T2>(arg0, arg2, 0x2::object::id<0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::Vault<T0, T1>>(arg5), v0, v4, v5, arg3, arg4);
        (v4, v5)
    }
    ...
    public(friend) fun exec_add_liquidity_have_coin_b_in_vault<T0, T1, T2>(arg0: &mut BluefinExecutorConfig, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T0>, arg3: u32, arg4: u32, arg5: &mut 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::Vault<T0, T1>, arg6: &mut 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::VaultConfig, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let v3 = if (arg8 > 0) {
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::spend_vault_funds<T0, T1>(arg6, arg5, arg8, v1, arg10)
        } else {
            0x2::coin::zero<T0>(arg10)
        };
        ...
        if (0x2::balance::value<T0>(&v8) > 0) {
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::add_fund<T0, T1>(arg5, 0x2::coin::from_balance<T0>(v8, arg10), arg10);
        } else {
            0x2::balance::destroy_zero<T0>(v8);
        };
        emit_event_add_liquidity<T2, T0>(arg0, arg2, 0x2::object::id<0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::Vault<T0, T1>>(arg5), v0, v4, v5, arg3, arg4);
        (v4, v5)
    }
