module 0x919a123c7744e700c9a31bdc7b38aa7ef8722c2e52de4c654d07f286a4e3a0fd::batwalrus_ {
    struct BATWALRUS_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BATWALRUS_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BATWALRUS_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"BatWalrus "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A massive entity of ancient code and raw force. It takes the form of a hooded guardian, merging the stealth of a bat with the unstoppable power of a walrus. It doesn't hack; it hunts. It doesn't disable; it crushes."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeid4scv7uctrwwozus3brytino3g3jszejx5gmldxailrsojeoqg3e"));
