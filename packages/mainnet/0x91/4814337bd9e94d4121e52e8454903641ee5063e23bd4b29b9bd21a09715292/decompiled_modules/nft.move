module 0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public fun depositNft(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut NftPegVault, arg3: &mut 0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::archieve::UserArchieve, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::version::Version, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::version::checkVersion(arg5, 1);
        0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::archieve::verifySignature(arg0, arg1, &arg2.validator);
        ...
        0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::archieve::verUpdateNftPegNonce(v2, arg3);
        ...
        while (v9 < 0x1::vector::length<u128>(&v7)) {
            let v10 = mint(*0x1::vector::borrow<u128>(&v7, v9), *0x1::vector::borrow<u16>(&v6, v9), *0x1::vector::borrow<u16>(&v5, v9), *0x1::vector::borrow<u16>(&v4, v9), *0x1::vector::borrow<u64>(&v3, v9), arg7);
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::cap_vault::createVault<NftAdminCap>(arg1);
    }
    ...
    public fun setValidator(arg0: &NftAdminCap, arg1: vector<u8>, arg2: &mut NftPegVault, arg3: &0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::version::Version) {
        0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::version::checkVersion(arg3, 1);
    ...
    public fun withdrawFee(arg0: &NftAdminCap, arg1: &mut NftPegVault, arg2: &0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::version::Version, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::version::checkVersion(arg2, 1);
        0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.fee, 0x2::balance::value<0x2::sui::SUI>(&arg1.fee)), arg3)
    }

    public fun withdrawNft(arg0: &mut 0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::archieve::UserArchieve, arg1: BirdNFT, arg2: &0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::version::checkVersion(arg2, 1);
        ...
        let v6 = NFTWithdrawn{
            ...
            rare     : v4,
            value    : v5,
            nonce    : 0x914814337bd9e94d4121e52e8454903641ee5063e23bd4b29b9bd21a09715292::archieve::increaseGetNftDepegNonce(arg0),
        };
