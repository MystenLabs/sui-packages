module 0x917f6d71d87275f0589577c9e5145633440a22bf5b1028b0749c46586e039e6f::lsd_lockdrop {
    struct LsdLockdropVault has key {
        id: 0x2::object::UID,
        user_profile_access_cap: 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::ProfileDofOwnershipCapability,
        max_positions: u64,
        init_timestamp: u64,
        deposit_window: u64,
        ...
        hive_incentives_balance: 0x2::balance::Balance<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>,
    }
    ...
    public fun add_hive_incentives(arg0: &0x2::clock::Clock, arg1: &mut LsdLockdropVault, arg2: 0x2::coin::Coin<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        0x2::clock::timestamp_ms(arg0);
        let v0 = 0x2::coin::into_balance<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>(arg2);
        0x2::balance::join<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>(&mut arg1.hive_incentives_balance, 0x2::balance::split<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>(&mut v0, arg3));
        arg1.total_hive_incentives = arg1.total_hive_incentives + arg3;
        0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::coin_helper::destroy_or_transfer_balance<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>(v0, 0x2::tx_context::sender(arg4), arg4);
    ...
    public fun add_to_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::HiveProfile, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        0x2::clock::timestamp_ms(arg0);
        let (v0, v1, _, v3) = 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::get_profile_meta_info(arg3);
        let v4 = if (0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::exists_for_profile(arg3, 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::get_profile_dof_capability_identifier(&arg2.user_profile_access_cap))) {
            0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg7)
        } else {
        ...
        0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::entry_add_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v4, arg7);
        0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v5, 0x2::tx_context::sender(arg7), arg7);
    }
    ...
    fun allowed_withdrawal_amount(arg0: &LsdLockdropVault, arg1: u64, arg2: u64) : u64 {
        ...
        if (arg1 < v2) {
            (0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::math::mul_div_u256(((arg2 / 2) as u256), ((v2 - arg1) as u256), ((v2 - v1) as u256)) as u64)
        } else {
            0
        }
    }
    ...
    fun calculate_hive_rewards(arg0: u128, arg1: u128, arg2: u64) : u64 {
        if (arg1 == 0) {
            ...
            (0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::math::mul_div_u256((arg2 as u256), (arg0 as u256), (arg1 as u256)) as u64)
        }
    }

    fun calculate_weighted_units(arg0: u64, arg1: u64, arg2: &LsdLockdropVault) : u128 {
        (((arg0 as u256) * ((1000000000 as u256) + 0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::math::mul_div_u256(((arg1 - 1) as u256) * (arg2.weekly_multiplier as u256), (1000000000 as u256), (arg2.weekly_divider as u256)))) as u128)
    }

    public fun destroy_user_position(arg0: &0x2::clock::Clock, arg1: &0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::config::HiveEntryCap, arg2: &LsdLockdropVault, arg3: &mut 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::HiveProfile, arg4: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u64>, u128, u128) {
        0x2::clock::timestamp_ms(arg0);
        if (!0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::exists_for_profile(arg3, 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::get_profile_dof_capability_identifier(&arg2.user_profile_access_cap))) {
        ...
        } = 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg4);
        0x2::object::delete(v0);
        0x2::table::drop<u64, bool>(v5);
        (v1, v2, v3, v4, (v6 as u128), v7)
    }

    public fun does_user_have_position(arg0: &0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::HiveProfile, arg1: &LsdLockdropVault) : bool {
        0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::exists_for_profile(arg0, 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::get_profile_dof_capability_identifier(&arg1.user_profile_access_cap))
    }

    public fun get_user_position(arg0: &0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::HiveProfile, arg1: &LsdLockdropVault) : (vector<u64>, vector<u64>, vector<u64>, vector<u128>, vector<bool>, vector<u64>, u64, u64) {
        let v0 = 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::get_profile_dof_capability_identifier(&arg1.user_profile_access_cap);
        if (!0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::exists_for_profile(arg0, v0)) {
        ...
        let v1 = 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::borrow_from_profile<UserLsdLockdropPosition>(arg0, v0);
    ...
    public fun infuse_sui_hsui_pool(arg0: &0x2::clock::Clock, arg1: &0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x83f433589d54d1a4584e813513a0feee3161719f98e7936e23df8670ca29a2c4::hsui_vault::HSuiVault, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::hsui::HSUI>, 0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>, u64, u128) {
        let v0 = 0x2::balance::value<0x2::sui::SUI>(&arg2.sui_locked_balance) / 2;
        let v1 = 0x83f433589d54d1a4584e813513a0feee3161719f98e7936e23df8670ca29a2c4::hsui_vault::stake_sui_request(arg3, arg4, 0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, v0), 0x1::option::none<address>(), arg5);
        let v2 = SuiStakedForHiveSui{
            cur_timestamp      : 0x2::clock::timestamp_ms(arg0),
            total_sui_locked   : arg2.total_sui_locked,
            sui_to_stake       : v0,
            total_hsui_krafted : 0x2::balance::value<0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::hsui::HSUI>(&v1),
        };
        0x2::event::emit<SuiStakedForHiveSui>(v2);
        (v1, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg2.sui_locked_balance), 0x2::balance::withdraw_all<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>(&mut arg2.hive_incentives_balance), arg2.total_sui_locked, arg2.total_sui_weighted_units)
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
    }

    public entry fun initialize_global_lsd_lockdrop(arg0: &0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::config::HiveEntryCap, arg1: 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::ProfileDofOwnershipCapability, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : address {
        let v0 = LsdLockdropVault{
            ...
            hive_incentives_balance  : 0x2::balance::zero<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>(),
        };
    ...
    public fun simulate_withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &LsdLockdropVault, arg2: &0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::HiveProfile, arg3: u64, arg4: u64) : (u64, u64, bool) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        if (v0 < arg1.init_timestamp || v0 > arg1.init_timestamp + arg1.deposit_window + arg1.withdrawal_window) {
            return (0, 0, false)
        };
        let v1 = 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::get_profile_dof_capability_identifier(&arg1.user_profile_access_cap);
        if (!0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::exists_for_profile(arg2, v1)) {
            return (0, 0, false)
        };
        let v2 = 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::borrow_from_profile<UserLsdLockdropPosition>(arg2, v1);
    ...
    public fun withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::HiveProfile, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let (v1, v2, _, v4) = 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::get_profile_meta_info(arg3);
        0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::get_profile_dof_capability_identifier(&arg2.user_profile_access_cap);
        let v5 = 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg6);
        ...
        0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::entry_add_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v5, arg6);
        0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, arg4), v4, arg6);
    }
