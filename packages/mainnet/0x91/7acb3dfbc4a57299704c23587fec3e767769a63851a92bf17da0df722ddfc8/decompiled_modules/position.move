module 0x917acb3dfbc4a57299704c23587fec3e767769a63851a92bf17da0df722ddfc8::position {
    ...
    public(friend) fun check_position_cap_matches<T0>(arg0: &Position<T0>, arg1: &PositionCap) {
        assert!(0x2::object::id<Position<T0>>(arg0) == arg1.position_id, 0x917acb3dfbc4a57299704c23587fec3e767769a63851a92bf17da0df722ddfc8::errors::err_position_cap_not_match());
    }
    ...
    public(friend) fun destroy_position<T0>(arg0: Position<T0>, arg1: &0x917acb3dfbc4a57299704c23587fec3e767769a63851a92bf17da0df722ddfc8::config::GlobalConfig) {
        let Position {
            id                   : v0,
        ...
        0x2::transfer::public_transfer<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>>(v3, 0x917acb3dfbc4a57299704c23587fec3e767769a63851a92bf17da0df722ddfc8::config::collect_obligation_owner_cap_address(arg1));
    }
