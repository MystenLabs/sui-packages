module 0x911362009a1a45ba9d78555f25a4086bb94b2069c8c1004beb445d1afe9efd0f::sui_hoss {
    struct SUI_HOSS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_HOSS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_HOSS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SUI-HOSS"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Thoroughbred of SUI network "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeigwresqxvroqpdhshtgb3rzwlvy2jfogyxyzk4cufsevgtlzli4ry"));
