module 0x911558625531e6dac825e1f9eaa4e5221004917cf61eeaa2f24ff77268451578::cnsnft4006 {
    struct CNSNFT4006 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4006, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4006>(arg0, arg1);
