module 0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::staking_pool {
    ...
    public(friend) fun create_pool<T0>(arg0: &0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::admin::AdminCap, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun harvest<T0>(arg0: &mut StakingPool<T0>, arg1: &0x2::clock::Clock) {
        ...
        let v4 = 0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::math::mul_factor(v2, arg0.reward_amount, v3);
        ...
        arg0.index = arg0.index + 0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::math::mul_factor_u128((v4 as u128), 18446744073709551616, arg0.total_weight);
        *v1 = v0;
    }
    ...
    public(friend) fun harvest_position<T0>(arg0: &StakingPool<T0>, arg1: &mut StakedPosition<T0>, arg2: &0x2::clock::Clock) {
        ...
        arg1.harvested_rewards = arg1.harvested_rewards + (0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::math::mul_factor_u128(arg1.stake_weight, arg0.index - arg1.index, 18446744073709551616) as u64);
        arg1.index = arg0.index;
    }
    ...
    public(friend) fun refill_pool<T0>(arg0: &0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::admin::AdminCap, arg1: &mut StakingPool<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock) {
    ...
    public(friend) fun set_chakra_multipliers<T0>(arg0: &0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::admin::AdminCap, arg1: &mut StakingPool<T0>, arg2: vector<u64>) {
        arg1.chakra_multipliers = arg2;
    }

    public(friend) fun set_enabled<T0>(arg0: &0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::admin::AdminCap, arg1: &mut StakingPool<T0>, arg2: bool) {
        arg1.enabled = arg2;
    }

    public(friend) fun set_lock_durations<T0>(arg0: &0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::admin::AdminCap, arg1: &mut StakingPool<T0>, arg2: vector<u64>) {
        arg1.lock_durations = arg2;
    }

    public(friend) fun set_max_lock_time<T0>(arg0: &0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::admin::AdminCap, arg1: &mut StakingPool<T0>, arg2: u64) {
        arg1.max_lock_time = arg2;
    }

    public(friend) fun set_max_time_multiplier<T0>(arg0: &0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::admin::AdminCap, arg1: &mut StakingPool<T0>, arg2: u64) {
        arg1.max_time_multiplier = arg2;
    }

    public(friend) fun set_min_lock_time<T0>(arg0: &0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::admin::AdminCap, arg1: &mut StakingPool<T0>, arg2: u64) {
        arg1.min_lock_time = arg2;
    }

    public(friend) fun set_reward_amount<T0>(arg0: &0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::admin::AdminCap, arg1: &mut StakingPool<T0>, arg2: u64) {
        arg1.reward_amount = arg2;
    }

    public(friend) fun set_reward_end_time<T0>(arg0: &0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::admin::AdminCap, arg1: &mut StakingPool<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        harvest<T0>(arg1, arg3);
    ...
    public(friend) fun stake<T0>(arg0: &mut StakingPool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : StakedPosition<T0> {
        ...
        let (v0, v1, v2) = 0x9193d45dad53d69b83728cc015e398196fc7a35c06f1e758dfd5f71c51cf6edc::math::compute_stake_weight(0x2::coin::value<T0>(&arg1), arg2, arg0.min_lock_time, arg0.max_lock_time, arg0.max_time_multiplier, *0x1::vector::borrow<u64>(&arg0.chakra_multipliers, arg3));
