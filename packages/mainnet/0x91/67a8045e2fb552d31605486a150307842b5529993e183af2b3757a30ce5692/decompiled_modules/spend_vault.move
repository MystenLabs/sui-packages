module 0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault {
    ...
    public fun deposit_balance<T0>(arg0: &Vault, arg1: 0x2::balance::Balance<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 13836467951312175115);
    ...
    public fun destroy(arg0: Vault, arg1: OwnerCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault>(&arg0), 13835060267190321153);
        let Vault {
            id                 : v0,
            allowances         : v1,
    ...
    public fun mint_cap(arg0: &Vault, arg1: &OwnerCap, arg2: &mut 0x2::tx_context::TxContext) : SpenderCap {
        assert!(arg1.vault_id == 0x2::object::id<Vault>(arg0), 13835060722456854529);
        let v0 = SpenderCap{
    ...
    public fun renounce(arg0: &mut Vault, arg1: SpenderCap, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1.vault_id == v0, 13835344048564600835);
        let SpenderCap {
            id       : v1,
            vault_id : _,
        } = arg1;
    ...
    public fun revoke<T0>(arg0: &mut Vault, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : bool {
        assert!(arg1.vault_id == 0x2::object::id<Vault>(arg0), 13835062135501094913);
    ...
    public fun revoke_all(arg0: &mut Vault, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault>(arg0), 13835062388904165377);
    ...
    public fun set_allowance<T0>(arg0: &mut Vault, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: 0x1::option::Option<u64>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<Vault>(arg0);
        assert!(arg1.vault_id == v0, 13835061126183780353);
        assert!(arg4 == 18446744073709551615 || arg4 > 0x2::clock::timestamp_ms(arg6), 13836749993224699917);
        ...
        if (v3) {
            assert!(0x2::linked_table::contains<BudgetKey, Allowance>(&arg0.allowances, v2) && 0x2::linked_table::borrow<BudgetKey, Allowance>(&arg0.allowances, v2).remaining == 0x1::option::destroy_some<u64>(arg5), 13837031528331083791);
        };
    ...
    public fun spend<T0>(arg0: &mut Vault, arg1: &SpenderCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        assert!(arg1.vault_id == v0, 13835343168096305155);
        let v2 = 0x1::type_name::with_defining_ids<T0>();
        let v3 = BudgetKey{
            cap_id    : v1,
            coin_type : v2,
        };
        assert!(0x2::linked_table::contains<BudgetKey, Allowance>(&arg0.allowances, v3), 13835624677432885253);
        let v4 = 0x2::linked_table::borrow<BudgetKey, Allowance>(&arg0.allowances, v3);
        let v5 = v4.remaining;
        let v6 = v4.expires_at_ms;
        assert!(v6 == 18446744073709551615 || 0x2::clock::timestamp_ms(arg3) < v6, 13835906203949334535);
        assert!(arg2 > 0, 13836469171082887179);
        assert!(v5 == 18446744073709551615 || arg2 <= v5, 13836187713285914633);
    ...
    public fun withdraw<T0>(arg0: &mut Vault, arg1: &OwnerCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        let v0 = 0x2::object::id<Vault>(arg0);
        assert!(arg1.vault_id == v0, 13835063127638540289);
        assert!(arg2 > 0, 13836470506817716235);
        let v1 = Withdrawn{
            vault_id  : v0,
            coin_type : 0x1::type_name::with_defining_ids<T0>(),
            amount    : arg2,
    ...
    public fun withdraw_all<T0>(arg0: &mut Vault, arg1: &OwnerCap, arg2: &0x2::accumulator::AccumulatorRoot, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        let v0 = 0x2::object::id<Vault>(arg0);
        assert!(arg1.vault_id == v0, 13835063466940956673);
