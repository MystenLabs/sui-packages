module 0xcb03101bb6f75ab6a3d9fdb94edab3fd1b88f24b4cb768e262b791001e7843bb::rollup_news_claim {
    ...
    public entry fun create_claim_v3(arg0: address, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: vector<u8>, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<Claim>(v1, arg0);
    }
    ...
    public fun get_current_timestamp_ms(arg0: &0x2::clock::Clock) : u64 {
    ...
    public fun get_wallet_last_minting_period_ms_v2(arg0: &Treasury_v2, arg1: address) : u64 {
        if (!0x2::object_table::contains<address, Wallet>(&arg0.wallets, arg1)) {
            0
        } else {
            0x2::object_table::borrow<address, Wallet>(&arg0.wallets, arg1).last_minting_period_ms
        }
    }

    public fun get_wallet_minting_limit_v2(arg0: &Treasury_v2, arg1: address) : u64 {
        if (!0x2::object_table::contains<address, Wallet>(&arg0.wallets, arg1)) {
            0
        } else {
            0x2::object_table::borrow<address, Wallet>(&arg0.wallets, arg1).minting_limit
        }
    }
