module 0x91657507890f065ad5ac9ad5f585ad54cce127f51d893ada7a18fa331a88af3c::rewarder {
    ...
    public(friend) fun add_rewarder<T0>(arg0: &mut RewarderManager) {
        ...
        assert!(0x1::vector::length<Rewarder>(&arg0.rewarders) <= 2, 934062834076983206);
        let v1 = Rewarder{
    ...
    public fun deposit_reward<T0>(arg0: &0x91657507890f065ad5ac9ad5f585ad54cce127f51d893ada7a18fa331a88af3c::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) : u64 {
        ...
        if (!0x2::table::contains<0x1::type_name::TypeName, u128>(&arg1.available_balance, v0)) {
            ...
            let (v2, v3) = 0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::math_u128::overflowing_add(0x2::table::remove<0x1::type_name::TypeName, u128>(&mut arg1.available_balance, v0), (v1 as u128) << 64);
            if (v3) {
    ...
    public fun emergent_withdraw<T0>(arg0: &0x91657507890f065ad5ac9ad5f585ad54cce127f51d893ada7a18fa331a88af3c::config::AdminCap, arg1: &0x91657507890f065ad5ac9ad5f585ad54cce127f51d893ada7a18fa331a88af3c::config::GlobalConfig, arg2: &mut RewarderGlobalVault, arg3: u64) : 0x2::balance::Balance<T0> {
        0x91657507890f065ad5ac9ad5f585ad54cce127f51d893ada7a18fa331a88af3c::config::checked_package_version(arg1);
        let v0 = 0x1::type_name::get<T0>();
    ...
    public(friend) fun settle(arg0: &mut RewarderGlobalVault, arg1: &mut RewarderManager, arg2: u128, arg3: u64) {
        ...
        while (v2 < 0x1::vector::length<Rewarder>(&arg1.rewarders)) {
            ...
            let v4 = 0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::full_math_u128::mul_div_floor((v1 as u128), v3.emissions_per_second, arg2);
            let v5 = v4;
            let v6 = 0x2::table::remove<0x1::type_name::TypeName, u128>(&mut arg0.available_balance, v3.reward_coin);
            if (v6 <= v4 * arg2) {
                v3.emissions_per_second = 0;
                v5 = 0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::full_math_u128::mul_div_floor(v6, 1, arg2);
        ...
        arg1.points_growth_global = arg1.points_growth_global + 0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::full_math_u128::mul_div_floor((v1 as u128), 18446744073709551616000000, arg2);
    }
    ...
    public(friend) fun update_emission<T0>(arg0: &mut RewarderGlobalVault, arg1: &mut RewarderManager, arg2: u128, arg3: u128, arg4: u64) {
        ...
        if (arg3 > 0) {
            ...
            assert!(*0x2::table::borrow<0x1::type_name::TypeName, u128>(&arg0.available_balance, v0) >= 0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::full_math_u128::mul_shr((86400 as u128) << 64, arg3, 64), 928307230473046907);
        };
