module 0x9197409b381d12a86128c71d7b9009156872d0bbc196afb4697de8df9b88b1c2::reward2017 {
    struct REWARD2017 has drop {
        dummy_field: bool,
    }

    struct TICKET_2017 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2017(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2017>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2017>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2017, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2017>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2017>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2017>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2017>>(v5, 0x2::tx_context::sender(arg1));
    }
