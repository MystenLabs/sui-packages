module 0x9de5bfb1384ab65dec70bab89f47c4aeb16beec99b38b561a2cc5f27fc014f8f::dao {
    ...
    struct ProposalCreatedV2 has copy, drop {
        proposal_id: 0x2::object::ID,
        proposer: address,
        snapshot_registry_id: 0x2::object::ID,
    ...
    public fun create_proposal_v2<T0>(arg0: &mut DaoConfig, arg1: &0x2::coin::Coin<T0>, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        assert!(0x2::coin::value<T0>(arg1) >= arg0.min_propose_tokens, 1);
        assert!(!0x1::vector::is_empty<u8>(&arg2), 2);
        ...
        let v5 = ProposalCreatedV2{
            proposal_id          : v4,
            proposer             : 0x2::tx_context::sender(arg6),
            snapshot_registry_id : 0x9de5bfb1384ab65dec70bab89f47c4aeb16beec99b38b561a2cc5f27fc014f8f::snapshot::create_registry_raw(v4, v1, arg6),
            registration_end_ms  : v1,
            end_ms               : v2,
        };
        0x2::event::emit<ProposalCreatedV2>(v5);
        let v6 = Proposal{
            id               : v3,
            dao_id           : 0x2::object::id<DaoConfig>(arg0),
            proposer         : 0x2::tx_context::sender(arg6),
        ...
        0x2::transfer::share_object<Proposal>(v6);
        v4
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = DaoConfig{
            ...
            proposal_count     : 0,
            min_propose_tokens : 1000000000000000,
        };
    ...
    public fun start_ms(arg0: &Proposal) : u64 {
        arg0.start_ms
    }
    ...
    public fun update_min_propose_tokens(arg0: &AdminCap, arg1: &mut DaoConfig, arg2: u64) {
        arg1.min_propose_tokens = arg2;
    }
