module 0x91fdf8c07189fd8f1c380a1719f7c4a0153f49b24d25d786f86955a0c065b6b1::kiosk_swap {
    ...
    public fun deposit_counterparty(arg0: &mut SwapProposal, arg1: &mut SwapEscrow, arg2: &0x2::kiosk::Kiosk, arg3: 0x2::kiosk::KioskOwnerCap, arg4: 0x1::option::Option<0x2::coin::Coin<0x2::sui::SUI>>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::option::is_some<address>(&arg0.counterparty) && v0 == *0x1::option::borrow<address>(&arg0.counterparty) || true, 2);
        ...
        if (arg0.counterparty_sui_amount > 0) {
            let v3 = CounterpattySUIDeposited{
                proposal_id  : 0x2::object::id<SwapProposal>(arg0),
                counterparty : v0,
                amount       : arg0.counterparty_sui_amount,
            };
            0x2::event::emit<CounterpattySUIDeposited>(v3);
        };
    }
    ...
    public fun execute_swap(arg0: &mut SwapProposal, arg1: &mut SwapEscrow, arg2: &mut ProtocolConfig, arg3: &mut ProtocolTreasury, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1.proposal_id == 0x2::object::id<SwapProposal>(arg0), 6);
        let v4 = if (0x1::option::is_some<address>(&arg0.counterparty)) {
            *0x1::option::borrow<address>(&arg0.counterparty)
        } else {
            v0
        };
        ...
        if (0x1::option::is_some<0x2::kiosk::KioskOwnerCap>(&arg1.proposer_kiosk_cap)) {
            0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(0x1::option::extract<0x2::kiosk::KioskOwnerCap>(&mut arg1.proposer_kiosk_cap), v4);
        };
        if (0x1::option::is_some<0x2::kiosk::KioskOwnerCap>(&arg1.counterparty_kiosk_cap)) {
        ...
        let v6 = 0x2::balance::value<0x2::sui::SUI>(&arg1.proposer_sui_balance);
        let v7 = 0x2::balance::value<0x2::sui::SUI>(&arg1.counterparty_sui_balance);
        if (v6 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.proposer_sui_balance, v6, arg5), v4);
        };
        if (v7 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.counterparty_sui_balance, v7, arg5), arg0.proposer);
        };
        arg0.state = 3;
        let v8 = SwapExecuted{
            proposal_id             : 0x2::object::id<SwapProposal>(arg0),
            ...
            proposer_sui_amount     : v6,
            counterparty_sui_amount : v7,
