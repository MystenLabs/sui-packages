module 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager {
    ...
    public entry fun collect<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &mut Positions, arg2: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT, arg3: u64, arg4: u64, arg5: address, arg6: u64, arg7: &0x2::clock::Clock, arg8: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::dynamic_object_field::borrow_mut<address, Position>(&mut arg1.id, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(arg2));
        if (v1.liquidity > 0) {
            let (_, _) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::burn<T0, T1, T2>(arg0, v0, v1.tick_lower_index, v1.tick_upper_index, 0, arg7, arg9);
            let v4 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_position_key(v0, v1.tick_lower_index, v1.tick_upper_index);
            copy_position<T0, T1, T2>(arg0, v4, v1);
        };
        ...
        let (v9, v10) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::collect<T0, T1, T2>(arg0, arg5, v1.tick_lower_index, v1.tick_upper_index, v7, v8, arg9);
        0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::transfer_out<T0, T1, T2>(arg0, v9, v10, arg5, arg9);
        v1.tokens_owed_a = v1.tokens_owed_a - v7;
        v1.tokens_owed_b = v1.tokens_owed_b - v8;
        let v11 = CollectEvent{
            pool      : 0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>>(arg0),
            amount_a  : v9,
            amount_b  : v10,
            recipient : arg5,
        };
        0x2::event::emit<CollectEvent>(v11);
    }
    ...
    public entry fun collect_reward<T0, T1, T2, T3>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &mut Positions, arg2: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT, arg3: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::PoolRewardVault<T3>, arg4: u64, arg5: u64, arg6: address, arg7: u64, arg8: &0x2::clock::Clock, arg9: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::dynamic_object_field::borrow_mut<address, Position>(&mut arg1.id, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(arg2));
        if (v1.liquidity > 0) {
            let (_, _) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::burn<T0, T1, T2>(arg0, v0, v1.tick_lower_index, v1.tick_upper_index, 0, arg8, arg10);
            let v4 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_position_key(v0, v1.tick_lower_index, v1.tick_upper_index);
            copy_position<T0, T1, T2>(arg0, v4, v1);
        };
        assert!(arg4 < 0x1::vector::length<PositionRewardInfo>(&v1.reward_infos), 10);
        let v5 = 0x1::vector::borrow_mut<PositionRewardInfo>(&mut v1.reward_infos, arg4);
        ...
        let v7 = CollectRewardEvent{
            pool         : 0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>>(arg0),
            amount       : 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::collect_reward<T0, T1, T2, T3>(arg0, arg3, arg6, v1.tick_lower_index, v1.tick_upper_index, v6, arg4, arg10),
            vault        : 0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::PoolRewardVault<T3>>(arg3),
            reward_index : arg4,
            recipient    : arg6,
        };
        0x2::event::emit<CollectRewardEvent>(v7);
    }
    ...
    public entry fun mint<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &mut Positions, arg2: vector<0x2::coin::Coin<T0>>, arg3: vector<0x2::coin::Coin<T1>>, arg4: u32, arg5: bool, arg6: u32, arg7: bool, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: address, arg13: u64, arg14: &0x2::clock::Clock, arg15: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::from_u32_neg(arg4, arg5);
        let v2 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::from_u32_neg(arg6, arg7);
        let (v3, v4, v5) = add_liquidity<T0, T1, T2>(arg0, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::merge_coin<T0>(arg2), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::merge_coin<T1>(arg3), v0, v1, v2, arg8, arg9, arg14, arg16);
        assert!(v4 >= arg10 && v5 >= arg11, 5);
        let v6 = 0x2::object::new(arg16);
        let v7 = mint_nft<T0, T1, T2>(0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>>(arg0), 0x2::object::uid_to_inner(&v6), arg1, arg12, arg16);
        let v8 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_position_key(v0, v1, v2);
        let v9 = Position{
            id                  : v6,
            tick_lower_index    : v1,
            tick_upper_index    : v2,
            liquidity           : v3,
            fee_growth_inside_a : 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_position_fee_growth_inside_a<T0, T1, T2>(arg0, v8),
            fee_growth_inside_b : 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_position_fee_growth_inside_b<T0, T1, T2>(arg0, v8),
            tokens_owed_a       : 0,
            tokens_owed_b       : 0,
            reward_infos        : 0x1::vector::empty<PositionRewardInfo>(),
        };
        let v10 = &mut v9;
        copy_position<T0, T1, T2>(arg0, v8, v10);
        0x2::dynamic_object_field::add<address, Position>(&mut arg1.id, v7, v9);
        insert_user_position(arg1, 0x2::object::uid_to_inner(&v6), v7);
    ...
    public entry fun decrease_liquidity<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &mut Positions, arg2: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT, arg3: u128, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::burn<T0, T1, T2>(arg0, v0, v1.tick_lower_index, v1.tick_upper_index, arg3, arg7, arg9);
        assert!(v2 >= arg4 && arg5 >= arg5, 5);
        let v4 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_position_key(v0, v1.tick_lower_index, v1.tick_upper_index);
        copy_position<T0, T1, T2>(arg0, v4, v1);
        0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::transfer_out<T0, T1, T2>(arg0, v2, v3, v0, arg9);
        let v5 = DecreaseLiquidityEvent{
            pool      : 0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>>(arg0),
            amount_a  : v2,
            amount_b  : v3,
            liquidity : arg3,
        };
        0x2::event::emit<DecreaseLiquidityEvent>(v5);
    }
    ...
    public entry fun increase_liquidity<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &mut Positions, arg2: vector<0x2::coin::Coin<T0>>, arg3: vector<0x2::coin::Coin<T1>>, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &0x2::clock::Clock, arg11: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::dynamic_object_field::borrow_mut<address, Position>(&mut arg1.id, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(arg4));
        let (v2, v3, v4) = add_liquidity<T0, T1, T2>(arg0, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::merge_coin<T0>(arg2), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::merge_coin<T1>(arg3), v0, v1.tick_lower_index, v1.tick_upper_index, arg5, arg6, arg10, arg12);
        assert!(v3 >= arg7 && v4 >= arg8, 5);
        let v5 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_position_key(v0, v1.tick_lower_index, v1.tick_upper_index);
        copy_position<T0, T1, T2>(arg0, v5, v1);
        let v6 = IncreaseLiquidityEvent{
            pool      : 0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>>(arg0),
            amount_a  : v3,
            amount_b  : v4,
            liquidity : v2,
        };
        0x2::event::emit<IncreaseLiquidityEvent>(v6);
    }
