module 0x8bcbf839aa8d15014c4005d606171348e5edb3ac70405afdcdf8f2db7c85d9d9::vault_config {
    ...
    public(friend) fun borrow_withdraw_cap(arg0: &VaultTokenHolder) : &0xc817f81d46efbffa6ad581245145171f19d2fa7d4cf2d2608ba3f97100509c33::cloud_wallet_config::QuickWithdrawCap {
        0x2::dynamic_field::borrow<0x1::ascii::String, 0xc817f81d46efbffa6ad581245145171f19d2fa7d4cf2d2608ba3f97100509c33::cloud_wallet_config::QuickWithdrawCap>(&arg0.id, 0x1::ascii::string(b"quick_withdraw_cap"))
    }
    ...
    public fun remove_withdraw_cap(arg0: &VaultConfig, arg1: &mut VaultTokenHolder, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<0x1::ascii::String>(&arg1.id, 0x1::ascii::string(b"quick_withdraw_cap"))) {
            0xc817f81d46efbffa6ad581245145171f19d2fa7d4cf2d2608ba3f97100509c33::cloud_wallet_config::delete_quick_withdraw_cap(0x2::dynamic_field::remove<0x1::ascii::String, 0xc817f81d46efbffa6ad581245145171f19d2fa7d4cf2d2608ba3f97100509c33::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, 0x1::ascii::string(b"quick_withdraw_cap")));
        };
    }
    ...
    public fun set_cloud_wallet_withdraw_cap(arg0: &VaultConfig, arg1: &mut VaultTokenHolder, arg2: 0x2::transfer::Receiving<0xc817f81d46efbffa6ad581245145171f19d2fa7d4cf2d2608ba3f97100509c33::cloud_wallet_config::QuickWithdrawCap>, arg3: &mut 0x2::tx_context::TxContext) {
        only_admin(arg0, arg3);
        if (0x2::dynamic_field::exists_<0x1::ascii::String>(&arg1.id, 0x1::ascii::string(b"quick_withdraw_cap"))) {
            0xc817f81d46efbffa6ad581245145171f19d2fa7d4cf2d2608ba3f97100509c33::cloud_wallet_config::delete_quick_withdraw_cap(0x2::dynamic_field::remove<0x1::ascii::String, 0xc817f81d46efbffa6ad581245145171f19d2fa7d4cf2d2608ba3f97100509c33::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, 0x1::ascii::string(b"quick_withdraw_cap")));
        };
        0x2::dynamic_field::add<0x1::ascii::String, 0xc817f81d46efbffa6ad581245145171f19d2fa7d4cf2d2608ba3f97100509c33::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, 0x1::ascii::string(b"quick_withdraw_cap"), 0x2::transfer::public_receive<0xc817f81d46efbffa6ad581245145171f19d2fa7d4cf2d2608ba3f97100509c33::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, arg2));
    }
