module 0x2a74b5b27122aaf707fce12cdeb7f283f07509fa18dd9945d82ae443ca952171::random_vault {
    ...
    struct WinnerAddresses has copy, drop {
        number: u64,
    ...
    public(friend) fun draw_step_1_new(arg0: &mut RandomVault, arg1: &0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::staking::Staking, arg2: &0x2::clock::Clock, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0);
        let v0 = update_old_round_2(arg0, arg1, arg2, arg3, arg4);
        let v1 = new_round(arg0, 0x2::clock::timestamp_ms(arg2) / 1000, arg4);
        0x2::balance::join<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI>(&mut v1.vault, v0);
        0x2::dynamic_field::add<vector<u8>, Round>(&mut arg0.id, b"latest_round_key", v1);
    }
    ...
    public(friend) fun draw_step_2(arg0: &mut RandomVault, arg1: 0x2::coin::Coin<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI>, arg2: &0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::staking::Staking, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0);
        let v0 = new_round(arg0, 0x2::clock::timestamp_ms(arg3) / 1000, arg4);
        0x2::balance::join<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI>(&mut v0.vault, 0x2::coin::into_balance<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI>(arg1));
        0x2::dynamic_field::add<vector<u8>, Round>(&mut arg0.id, b"latest_round_key", v0);
    }
    ...
    public(friend) fun draw_step_2_new_after_step3(arg0: &mut RandomVault, arg1: &0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::staking::Staking, arg2: &vector<address>, arg3: &vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0);
        ...
        while (v2 < 0x1::vector::length<address>(arg2)) {
            ...
            let v5 = UserDeposited{
                ...
                ts           : v0.start_time,
                sui_amount   : v4,
                hasui_amount : 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::staking::get_stsui_by_sui(arg1, v4),
            };
            ...
            let v6 = UserInfo{
                ...
                withdrawed_amount : 0,
                account           : v3,
                share             : (v4 as u128) * (v1 as u128),
                last_deposit_time : v0.start_time,
            };
            v0.total_share = v0.total_share + v6.share;
            v0.total_deposit = v0.total_deposit + v4;
            0x2::table::add<address, UserInfo>(&mut v0.users, v3, v6);
            0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::push_back<address>(&mut v0.user_addresses, v3);
        };
    }

    public(friend) fun draw_step_2_new_find_users(arg0: &RandomVault, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (vector<address>, vector<u64>) {
        let v0 = 0x1::vector::empty<address>();
        let v1 = 0x1::vector::empty<u64>();
        let v2 = 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::borrow<Round>(&arg0.history_rounds, arg0.current_round - 1 - 1);
        assert!(v2.number == 61, 100000);
        if (0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::length<address>(&v2.user_addresses) > 0) {
            let v3 = 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::tail<address>(&v2.user_addresses);
            let v4 = v3;
            if (v3 > arg1 + arg2) {
            ...
            while (arg1 < v4) {
                let v5 = *0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::borrow<address>(&v2.user_addresses, arg1);
                let v6 = 0x2::table::borrow<address, UserInfo>(&v2.users, v5);
                arg1 = arg1 + 1;
                let v7 = v6.total_amount - v6.withdrawed_amount;
                if (v7 == 0) {
    ...
    fun draw_users(arg0: &Round, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) : vector<address> {
        let v0 = 0x2::random::new_generator(arg4, arg5);
        let v1 = 0x2::vec_set::empty<u64>();
        let v2 = vector[];
        let v3 = 0;
        while (v3 < arg1) {
            let v4 = 0x2::random::generate_u64_in_range(&mut v0, arg2, arg3 - 1);
            if (!0x2::vec_set::contains<u64>(&v1, &v4)) {
                let v5 = *0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::borrow<address>(&arg0.user_addresses, v4);
                if (0x2::table::borrow<address, UserInfo>(&arg0.users, v5).withdrawed_amount > 0) {
                    continue
                };
                0x2::vec_set::insert<u64>(&mut v1, v4);
    ...
    fun select_winner_2(arg0: &RandomVault, arg1: &0x2::clock::Clock, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) : vector<address> {
        let v0 = 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::borrow<Round>(&arg0.history_rounds, arg0.current_round - 1);
        if (0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::length<address>(&v0.user_addresses) == 0) {
            return vector[]
        };
        draw_users(v0, 0x2a74b5b27122aaf707fce12cdeb7f283f07509fa18dd9945d82ae443ca952171::config::get_prize_count(&arg0.config), 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::head<address>(&v0.user_addresses), 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::tail<address>(&v0.user_addresses), arg2, arg3)
    }
    ...
    fun update_old_round_2(arg0: &mut RandomVault, arg1: &0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::staking::Staking, arg2: &0x2::clock::Clock, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI> {
        let v0 = select_winner_2(arg0, arg2, arg3, arg4);
        let v1 = WinnerAddresses{
            number : arg0.current_round - 1,
            users  : v0,
        };
        0x2::event::emit<WinnerAddresses>(v1);
        let v2 = 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::borrow_mut<Round>(&mut arg0.history_rounds, arg0.current_round - 1);
        assert!(v2.end_time <= 0x2::clock::timestamp_ms(arg2) / 1000, 1);
        let v3 = 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::staking::get_stsui_by_sui(arg1, v2.total_deposit);
        let v4 = v3;
        let v5 = 0x2::balance::value<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI>(&v2.vault);
        if (v3 > v5) {
            v4 = v5;
        };
        v2.prize_pot = 0x2::balance::value<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI>(&v2.vault);
        let v6 = 0;
        let v7 = 0;
        while (v6 < 0x1::vector::length<address>(&v0)) {
            let v8 = *0x1::vector::borrow<address>(&v0, v6);
            let v9 = v2.prize_pot * 0x2a74b5b27122aaf707fce12cdeb7f283f07509fa18dd9945d82ae443ca952171::config::get_prize_rate(&arg0.config, v6) / 0x2a74b5b27122aaf707fce12cdeb7f283f07509fa18dd9945d82ae443ca952171::config::get_rate_denominator();
            let v10 = Winner{
                account      : v8,
                hasui_amount : v9,
            };
            0x1::vector::push_back<Winner>(&mut v2.winners, v10);
            let v11 = WinnerTicket{
                id          : 0x2::object::new(arg4),
                round       : v2.number,
                rank        : v6 + 1,
                amount      : v9,
                expire_time : v2.end_time + 5184000,
                claimed     : false,
            };
            0x2::transfer::transfer<WinnerTicket>(v11, v8);
            v7 = v7 + v9;
            v6 = v6 + 1;
        };
        0x2::balance::join<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI>(&mut arg0.fees, 0x2::balance::split<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI>(&mut v2.vault, v2.prize_pot - v7));
        0x2::event::emit<RoundClosed>(format_round(v2));
        0x2::balance::split<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI>(&mut v2.vault, v4)
    }
