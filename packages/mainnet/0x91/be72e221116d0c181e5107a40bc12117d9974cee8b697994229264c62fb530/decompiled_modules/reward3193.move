module 0x91be72e221116d0c181e5107a40bc12117d9974cee8b697994229264c62fb530::reward3193 {
    struct REWARD3193 has drop {
        dummy_field: bool,
    }

    struct TICKET_3193 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3193(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3193>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3193>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3193, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3193>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3193>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3193>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3193>>(v5, 0x2::tx_context::sender(arg1));
    }
