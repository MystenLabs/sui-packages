module 0x91db208b1c29b64fab2122be515729d3e79aa0e37be8150347ccd9e35f3eee67::reward3497 {
    struct REWARD3497 has drop {
        dummy_field: bool,
    }

    struct TICKET_3497 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3497(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3497>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3497>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3497, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3497>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3497>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3497>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3497>>(v5, 0x2::tx_context::sender(arg1));
    }
