module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land {
    ...
    fun maybe_raffle(arg0: &mut StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: u64, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::table::borrow<address, UserInfo>(&arg0.users, v0);
        let (v2, v3, v4, v5) = if (arg2 < v1.last_raffle_ts + 86400000) {
            (false, 0, 10000, 0)
        } else {
            (true, get_lands_without_cooldown_count(&v1.lands), get_idol_raffle_boost_from_staked_items(arg0, &v1.items), get_shovel_urr_chance_from_staked_items(arg0, &v1.items))
        };
        if (!v2) {
            return
        };
        ...
        let v7 = 0x2::random::generate_u128(&mut v6) % 1000000;
        let v8 = RaffleStarted{
            user : 0x2::tx_context::sender(arg4),
            roll : v7,
        };
        0x2::event::emit<RaffleStarted>(v8);
        if (v7 < 17 * v3 * v4 / 10000) {
            let v9 = 1 * 1000000000;
            mint_resource(arg0, arg1, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_phoenix_feather(), v9, arg4);
            let v10 = WonRareResource{
                user     : 0x2::tx_context::sender(arg4),
            ...
            0x2::event::emit<WonRareResource>(v10);
            let v11 = 0x1::vector::empty<0x1::string::String>();
            0x1::vector::push_back<0x1::string::String>(&mut v11, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0x6e82bb8cbed21683ac0109171135b4d75187fc74749593163f3dc426ef3b32b4::pawtato_coin_phoenix_feather::PAWTATO_COIN_PHOENIX_FEATHER>());
            let v12 = 0x1::vector::empty<0x1::string::String>();
            0x1::vector::push_back<0x1::string::String>(&mut v12, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u128_to_string(v9));
            let v13 = ResourcesProduced{
                user      : 0x2::tx_context::sender(arg4),
                resources : v11,
                amounts   : v12,
            };
            0x2::event::emit<ResourcesProduced>(v13);
        } else if (v7 < (17 + 270) * v3 * v4 / 10000) {
            let v14 = 1 * 1000000000;
            mint_resource(arg0, arg1, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_titanium_splinter(), v14, arg4);
            let v15 = WonRareResource{
                user     : 0x2::tx_context::sender(arg4),
            ...
            0x2::event::emit<WonRareResource>(v15);
            let v16 = 0x1::vector::empty<0x1::string::String>();
            0x1::vector::push_back<0x1::string::String>(&mut v16, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0x30021448e6d54825ced6d2b73f3b763a0da8a28c1c42fd6f0b864323ac60ab45::pawtato_coin_titanium_splinter::PAWTATO_COIN_TITANIUM_SPLINTER>());
            let v17 = 0x1::vector::empty<0x1::string::String>();
            0x1::vector::push_back<0x1::string::String>(&mut v17, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u128_to_string(v14));
            let v18 = ResourcesProduced{
                user      : 0x2::tx_context::sender(arg4),
                resources : v16,
                amounts   : v17,
            };
            0x2::event::emit<ResourcesProduced>(v18);
        } else if (v7 < (17 + 270 + 270) * v3 * v4 / 10000) {
            let v19 = 1 * 1000000000;
            mint_resource(arg0, arg1, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_chaos_seed(), v19, arg4);
            ...
            0x1::vector::push_back<0x1::string::String>(&mut v21, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xecc04712d7513fe9e9b27bb7366ded7c0acc78746c06276bc9fe8d17fc14061f::pawtato_coin_chaos_seed::PAWTATO_COIN_CHAOS_SEED>());
            ...
            if (v7 < (17 + 270 + 270) * v3 * v4 / 10000 + v5 * v3 * v4 / 10000 / 2) {
                let v24 = 1 * 1000000000;
                mint_resource(arg0, arg1, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_dawnstone(), v24, arg4);
                ...
                0x1::vector::push_back<0x1::string::String>(&mut v26, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xaf5981f9bee15d210e25f2933671ed587a810ed8cb8819d05fa967f2d4913ff::pawtato_coin_dawnstone::PAWTATO_COIN_DAWNSTONE>());
            ...
            } else if (v7 < (17 + 270 + 270) * v3 * v4 / 10000 + v5 * v3 * v4 / 10000) {
                let v29 = 1 * 1000000000;
                mint_resource(arg0, arg1, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_primal_loam(), v29, arg4);
                ...
                0x1::vector::push_back<0x1::string::String>(&mut v31, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xcc1bc09171bf5cff318ffa804077cbd47504d9ae0f2436d248dc6b9edc4556e4::pawtato_coin_primal_loam::PAWTATO_COIN_PRIMAL_LOAM>());
    ...
    public entry fun upgrade_version(arg0: &LandAdminCap, arg1: &mut StakingPool, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = arg1.version;
        assert!(v0 < 7, 13906836579525066751);
        arg1.version = 7;
