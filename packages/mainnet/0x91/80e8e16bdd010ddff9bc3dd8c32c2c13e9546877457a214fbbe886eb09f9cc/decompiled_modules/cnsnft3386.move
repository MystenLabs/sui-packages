module 0x9180e8e16bdd010ddff9bc3dd8c32c2c13e9546877457a214fbbe886eb09f9cc::cnsnft3386 {
    struct CNSNFT3386 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3386, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3386>(arg0, arg1);
