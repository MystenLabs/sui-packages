module 0x91ab1b214d998c7e73fc2b47b20f19c1abaa28d1dc88dfaa460fa44c804f1e55::reward9098 {
    struct REWARD9098 has drop {
        dummy_field: bool,
    }

    struct TICKET_9098 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9098(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9098>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9098>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9098, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9098>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9098>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9098>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9098>>(v5, 0x2::tx_context::sender(arg1));
    }
