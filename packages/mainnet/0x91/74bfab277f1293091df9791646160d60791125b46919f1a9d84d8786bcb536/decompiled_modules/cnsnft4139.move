module 0x9174bfab277f1293091df9791646160d60791125b46919f1a9d84d8786bcb536::cnsnft4139 {
    struct CNSNFT4139 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4139, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4139>(arg0, arg1);
