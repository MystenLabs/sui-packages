module 0x91dd6894b1352b330c60fe96a1c1c43dd1e9b8b042b74704378c60b575d6e811::reward8758 {
    struct REWARD8758 has drop {
        dummy_field: bool,
    }

    struct TICKET_8758 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8758(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8758>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8758>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8758, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8758>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8758>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8758>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8758>>(v5, 0x2::tx_context::sender(arg1));
    }
