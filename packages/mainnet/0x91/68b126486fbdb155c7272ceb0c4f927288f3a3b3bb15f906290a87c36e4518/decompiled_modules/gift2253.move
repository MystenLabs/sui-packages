module 0x9168b126486fbdb155c7272ceb0c4f927288f3a3b3bb15f906290a87c36e4518::gift2253 {
    struct GIFT2253 has drop {
        dummy_field: bool,
    }

    struct TICKET_2253 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2253(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2253>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2253>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2253, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2253>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2253>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2253>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2253>>(v5, 0x2::tx_context::sender(arg1));
    }
