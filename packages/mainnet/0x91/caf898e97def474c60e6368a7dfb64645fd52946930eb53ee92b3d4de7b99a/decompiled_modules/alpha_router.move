module 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::alpha_router {
    ...
    struct MemeboxManager has key {
        ...
        usdc_vault_admin_cap: 0x1::option::Option<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::AdminCap>,
        meme_vault_admin_cap: 0x1::option::Option<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::AdminCap>,
        paused: bool,
    }
    ...
    public entry fun approve(arg0: &mut MemeboxManager, arg1: &SuperAdminCap, arg2: &0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::USDCVault, arg3: &0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::SuperAdminCap, arg4: &0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::VaultManager, arg5: &0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::SuperAdminCap, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::option::is_none<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::AdminCap>(&arg0.usdc_vault_admin_cap) && 0x1::option::is_none<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::AdminCap>(&arg0.meme_vault_admin_cap), 11);
        verify_super_admin_cap(arg0, arg1);
        0x1::option::fill<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::AdminCap>(&mut arg0.usdc_vault_admin_cap, 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::create_admin_cap(arg2, arg3, arg6));
        0x1::option::fill<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::AdminCap>(&mut arg0.meme_vault_admin_cap, 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::create_admin_cap(arg4, arg5, arg6));
    }
    ...
    fun create_manager(arg0: &mut 0x2::tx_context::TxContext) : (MemeboxManager, SuperAdminCap) {
        ...
        let v1 = MemeboxManager{
            ...
            usdc_vault_admin_cap    : 0x1::option::none<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::AdminCap>(),
            meme_vault_admin_cap    : 0x1::option::none<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::AdminCap>(),
            paused                  : false,
        };
    ...
    public entry fun end_trade<T0, T1>(arg0: &MemeboxManager, arg1: &mut IntermediateStorage, arg2: &AdminCap, arg3: &mut 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::USDCVault, arg4: &mut 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::VaultManager, arg5: 0x1::string::String, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        verify_state(arg0);
        ...
        let v4 = 0x1::option::borrow<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::AdminCap>(&arg0.usdc_vault_admin_cap);
        let v5 = 0x1::option::borrow<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::AdminCap>(&arg0.meme_vault_admin_cap);
        if (is_usdc<T1>()) {
            ...
            0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::deposit_with_admin(arg3, v4, v6, arg7);
        } else {
            let v7 = extract_intermediate_coin<T1>(arg1, v0.to_amount, arg7);
            0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::deposit_with_admin<T1>(arg4, v5, v7, arg7);
        };
    ...
    public entry fun execute_bluefin_swap<T0, T1>(arg0: &mut MemeboxManager, arg1: &mut IntermediateStorage, arg2: &AdminCap, arg3: 0x1::string::String, arg4: u64, arg5: bool, arg6: u64, arg7: &0x2::clock::Clock, arg8: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg9: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg10: &mut 0x2::tx_context::TxContext) : u64 {
        if (arg5) {
            ...
            let v2 = 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::bluefin_wrapper::swap_a2b<T0, T1>(arg7, arg8, arg9, v1, arg10);
            ...
            let v4 = 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::bluefin_wrapper::swap_b2a<T0, T1>(arg7, arg8, arg9, v3, arg10);
    ...
    public entry fun execute_cetus_swap<T0, T1>(arg0: &mut MemeboxManager, arg1: &mut IntermediateStorage, arg2: &AdminCap, arg3: 0x1::string::String, arg4: u64, arg5: bool, arg6: u64, arg7: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg8: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg9: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : u64 {
        if (arg5) {
            ...
            let v2 = 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::cetus_wrapper::swap_a2b<T0, T1>(arg7, arg8, arg9, v1, arg10, arg11);
            after_execute<T1>(arg0, arg1, arg2, arg3, arg4, 1, v2, arg11);
            0x2::coin::value<T1>(&v2)
        } else {
            let v3 = before_execute<T1>(arg0, arg1, arg2, arg3, arg4, 1, arg6, arg11);
            let v4 = 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::cetus_wrapper::swap_b2a<T0, T1>(arg7, arg8, arg9, v3, arg10, arg11);
    ...
    public entry fun execute_flowx_v3_swap<T0, T1>(arg0: &mut MemeboxManager, arg1: &mut IntermediateStorage, arg2: &AdminCap, arg3: 0x1::string::String, arg4: u64, arg5: bool, arg6: u64, arg7: &mut 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool_manager::PoolRegistry, arg8: u64, arg9: &mut 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::versioned::Versioned, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : u64 {
        if (arg5) {
            ...
            let v2 = 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::flowx_v3_wrapper::swap_a2b<T0, T1>(arg7, arg8, v1, arg9, arg10, arg11);
            after_execute<T1>(arg0, arg1, arg2, arg3, arg4, 3, v2, arg11);
            0x2::coin::value<T1>(&v2)
        } else {
            let v3 = before_execute<T1>(arg0, arg1, arg2, arg3, arg4, 3, arg6, arg11);
            let v4 = 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::flowx_v3_wrapper::swap_b2a<T0, T1>(arg7, arg8, v3, arg9, arg10, arg11);
    ...
    public entry fun execute_turbos_swap<T0, T1, T2>(arg0: &mut MemeboxManager, arg1: &mut IntermediateStorage, arg2: &AdminCap, arg3: 0x1::string::String, arg4: u64, arg5: bool, arg6: u64, arg7: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg8: &0x2::clock::Clock, arg9: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg10: &mut 0x2::tx_context::TxContext) : u64 {
        if (arg5) {
            ...
            let v2 = 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::turbos_wrapper::swap_a2b<T0, T1, T2>(arg7, v1, arg8, arg9, arg10);
            after_execute<T1>(arg0, arg1, arg2, arg3, arg4, 2, v2, arg10);
            0x2::coin::value<T1>(&v2)
        } else {
            let v3 = before_execute<T1>(arg0, arg1, arg2, arg3, arg4, 2, arg6, arg10);
            let v4 = 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::turbos_wrapper::swap_b2a<T0, T1, T2>(arg7, v3, arg8, arg9, arg10);
    ...
    public entry fun start_trade<T0, T1>(arg0: &MemeboxManager, arg1: &mut IntermediateStorage, arg2: &AdminCap, arg3: &mut 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::USDCVault, arg4: &mut 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::VaultManager, arg5: 0x1::string::String, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        verify_state(arg0);
        verify_trade_is_clearing(arg1, arg5);
        assert!(0x2::object::id<IntermediateStorage>(arg1) == arg0.intermediate_storage_id, 1);
        verify_admin_permission(arg0, arg2, 0x2::tx_context::sender(arg7));
        ...
        let v1 = 0x1::option::borrow<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::AdminCap>(&arg0.usdc_vault_admin_cap);
        let v2 = 0x1::option::borrow<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::AdminCap>(&arg0.meme_vault_admin_cap);
        if (is_usdc<T0>()) {
            store_intermediate_coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg1, 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::withdraw_with_admin(arg3, v1, arg6, arg7));
        } else {
            store_intermediate_coin<T0>(arg1, 0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::withdraw_with_admin<T0>(arg4, v2, arg6, arg7));
        };
    }
    ...
    fun verify_state(arg0: &MemeboxManager) {
        ...
        assert!(0x1::option::is_some<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::usdc_vault::AdminCap>(&arg0.usdc_vault_admin_cap) && 0x1::option::is_some<0x91caf898e97def474c60e6368a7dfb64645fd52946930eb53ee92b3d4de7b99a::meme_vault::AdminCap>(&arg0.meme_vault_admin_cap), 12);
    }
