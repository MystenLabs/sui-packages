module 0x9144502f13ab81a7935653765c6f0de1040e2a0f568f4ebc9b6f59797e2eddc8::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"HITTY", b"Hittty Coin", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-03T13-36-47.871Z-hitman.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Hittty Coin"),
            symbol     : 0x1::string::utf8(b"HITTY"),
            decimals   : 9,
