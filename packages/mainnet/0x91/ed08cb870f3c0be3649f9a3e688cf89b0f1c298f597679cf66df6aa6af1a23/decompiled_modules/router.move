module 0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::router {
    ...
    public fun calculate_router_swap_result<T0, T1, T2, T3>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T3>, arg2: bool, arg3: bool, arg4: bool, arg5: u64) {
        if (arg4) {
            ...
            if (0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::expect_swap::expect_swap_result_is_exceed(&v0) || v1 > 18446744073709551615) {
                ...
                if (v6 > 18446744073709551615) {
                    ...
                    let v9 = CalculatedRouterSwapResult{
                        ...
                        is_exceed             : 0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::expect_swap::expect_swap_result_is_exceed(&v0) || 0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::expect_swap::expect_swap_result_is_exceed(&v5),
            ...
            let v11 = 0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::expect_swap::expect_swap<T2, T3>(arg1, arg3, arg4, arg5);
            let v12 = 0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::expect_swap::expect_swap_result_is_exceed(&v11);
            let v13 = 0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::expect_swap::expect_swap_result_amount_in(&v11);
            if (v12 || v13 > 18446744073709551615) {
                ...
                let v16 = (v13 as u64);
                let v17 = (0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::expect_swap::expect_swap_result_fee_amount(&v11) as u64);
                let v18 = 0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::expect_swap::expect_swap<T0, T1>(arg0, arg2, arg4, v16 + v17);
                let v19 = 0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::expect_swap::expect_swap_result_amount_in(&v18);
                if (v19 > 18446744073709551615) {
                    ...
                    let v22 = CalculatedRouterSwapResult{
                        amount_in             : (v19 as u64) + (0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::expect_swap::expect_swap_result_fee_amount(&v18) as u64),
                        amount_medium         : v16 + v17,
                        amount_out            : arg5,
                        is_exceed             : 0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::expect_swap::expect_swap_result_is_exceed(&v18) || v12,
                        current_sqrt_price_ab : 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg0),
                        current_sqrt_price_cd : 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T2, T3>(arg1),
                        target_sqrt_price_ab  : 0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::expect_swap::expect_swap_result_after_sqrt_price(&v18),
                        target_sqrt_price_cd  : 0x996c4d9480708fb8b92aa7acf819fb0497b5ec8e65ba06601cae2fb6db3312c3::expect_swap::expect_swap_result_after_sqrt_price(&v11),
                    };
