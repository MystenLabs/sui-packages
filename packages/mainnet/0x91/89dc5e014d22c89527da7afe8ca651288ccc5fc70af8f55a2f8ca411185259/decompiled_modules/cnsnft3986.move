module 0x9189dc5e014d22c89527da7afe8ca651288ccc5fc70af8f55a2f8ca411185259::cnsnft3986 {
    struct CNSNFT3986 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3986, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3986>(arg0, arg1);
