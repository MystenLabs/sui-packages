module 0xf95cf480d0dd219f6582f71b28ed4dc29a3b1380bcf3ce276ea248676ef99508::yolo_pump {
    ...
    public entry fun buy<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0xf95cf480d0dd219f6582f71b28ed4dc29a3b1380bcf3ce276ea248676ef99508::curves::calculate_add_liquidity_cost(v2.virtual_sui_reserves, v2.virtual_token_reserves, v5) + 1;
    ...
    public fun buy_returns_v2<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let v5 = 0xf95cf480d0dd219f6582f71b28ed4dc29a3b1380bcf3ce276ea248676ef99508::curves::calculate_add_liquidity_cost(v1.virtual_sui_reserves, v1.virtual_token_reserves, v3) + 1;
    ...
    public entry fun create_and_first_buy<T0>(arg0: &mut Configuration, arg1: 0x2::coin::TreasuryCap<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: 0x1::ascii::String, arg6: 0x1::ascii::String, arg7: 0x1::ascii::String, arg8: 0x1::ascii::String, arg9: 0x1::ascii::String, arg10: 0x1::ascii::String, arg11: 0x1::ascii::String, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<0x2::sui::SUI>(&arg2) > 0) {
            ...
            let v3 = 0xf95cf480d0dd219f6582f71b28ed4dc29a3b1380bcf3ce276ea248676ef99508::curves::calculate_add_liquidity_cost(arg0.initial_virtual_sui_reserves, arg0.initial_virtual_token_reserves, v2) + 1;
    ...
    public fun estimate_amount_out<T0>(arg0: &mut Configuration, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, Pool<T0>>(&mut arg0.id, 0x1::type_name::get_address(&v0));
        if (arg1 > 0 && arg2 == 0) {
            (0, 0xf95cf480d0dd219f6582f71b28ed4dc29a3b1380bcf3ce276ea248676ef99508::curves::calculate_token_amount_received(v1.virtual_sui_reserves, v1.virtual_token_reserves, arg1 - calculate_platform_fee(arg1, arg0.platform_fee)))
        } else if (arg1 == 0 && arg2 > 0) {
            let v4 = 0xf95cf480d0dd219f6582f71b28ed4dc29a3b1380bcf3ce276ea248676ef99508::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_sui_reserves, arg2);
    ...
    public entry fun sell<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v3 > 0, 2);
        let v4 = 0xf95cf480d0dd219f6582f71b28ed4dc29a3b1380bcf3ce276ea248676ef99508::curves::calculate_remove_liquidity_return(v2.virtual_token_reserves, v2.virtual_sui_reserves, v3);
