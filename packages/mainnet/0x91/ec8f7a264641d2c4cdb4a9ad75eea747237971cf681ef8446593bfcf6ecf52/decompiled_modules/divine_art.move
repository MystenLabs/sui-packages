module 0x91ec8f7a264641d2c4cdb4a9ad75eea747237971cf681ef8446593bfcf6ecf52::divine_art {
    ...
    fun init(arg0: DIVINE_ART, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<DivineArtNft>(&mut v5, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://{url}"));
    ...
    public entry fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: vector<u8>, arg3: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<DivineArtNft>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = DivineArtNft{
    ...
    public entry fun pub_mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = DivineArtNft{
