module 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::graduation {
    ...
    fun graduate_internal<T0>(arg0: &mut 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve::Curve<T0>, arg1: &mut 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::Treasury, arg2: &mut 0x2::coin_registry::Currency<T0>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg5: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::math::sqrt_price_x64(v10, 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::math::mul_div(v9, 10000 - 1, 10000));
        let v12 = 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve::cetus_tick_spacing();
        let (v13, v14) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::full_range_tick_range(v12);
        let (v15, v16, v17) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v3_with_creation_cap<T0, 0x2::sui::SUI>(arg3, arg4, 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve::pool_creation_cap<T0>(arg0), v12, v11, 0x1::string::utf8(b""), v13, v14, 0x2::coin::from_balance<T0>(v7, arg7), 0x2::coin::from_balance<0x2::sui::SUI>(v8, arg7), true, arg6, arg7);
        let v18 = v17;
        let v19 = v16;
        let v20 = v15;
        let v21 = 0x2::coin::value<T0>(&v19);
        0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve::burn_balance<T0>(arg0, 0x2::coin::into_balance<T0>(v19));
        let v22 = 0x2::coin::value<0x2::sui::SUI>(&v18);
        0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::deposit_season(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(v18));
        0x2::coin_registry::make_supply_burn_only<T0>(arg2, 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve::take_treasury_cap<T0>(arg0));
        let v23 = 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve::take_metadata_cap<T0>(arg0);
        ...
        let v25 = 0x2::object::id<0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve::Curve<T0>>(arg0);
        ...
        0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve::mark_graduated<T0>(arg0);
        let v27 = Graduated{
            curve_id      : v25,
            pool_id       : v24,
    ...
    fun harvest_internal<T0>(arg0: &mut TokenVault<T0>, arg1: &mut 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve::Curve<T0>, arg2: &mut 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::Treasury, arg3: &0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::math::mul_div(v3, 1000, 10000);
        if (v5 > 0) {
        ...
        0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::deposit_platform(arg2, v4);
        0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve::add_creator_fee<T0>(arg1, v2);
        let (v6, _, _) = 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve::fee_mode<T0>(arg1);
        let v9 = 0x2::coin::into_balance<T0>(v0);
        if (v6 < 10000) {
            0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve::stash_tokens_to_burn<T0>(arg1, 0x2::balance::split<T0>(&mut v9, 0x2::balance::value<T0>(&v9) - 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::math::mul_div(0x2::balance::value<T0>(&v9), v6, 10000)));
        };
        let v10 = 0x2::balance::value<T0>(&v9);
        if (v10 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v9, arg6), 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve::creator<T0>(arg1));
        } else {
