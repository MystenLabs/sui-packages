module 0x41a69d46b8e383a220d48c0927b9eee3ae22895af8305651a669ef8bf4b50d6a::q64x64 {
    ...
    public fun liquidity_from_amounts(arg0: u64, arg1: u64, arg2: u128) : u128 {
        0x41a69d46b8e383a220d48c0927b9eee3ae22895af8305651a669ef8bf4b50d6a::safe_math::u256_to_u128(((arg0 as u256) * (arg2 as u256) >> 64) + (arg1 as u256))
    }
    ...
    public fun log2(arg0: u128) : u128 {
        ...
        let v3 = 0x41a69d46b8e383a220d48c0927b9eee3ae22895af8305651a669ef8bf4b50d6a::bit_math::most_significant_bit(v1);
        let v4 = 64;
        let v5 = if (v3 >= v4) {
    ...
    public fun sqrt(arg0: u128) : u128 {
        ...
        let v0 = 0x41a69d46b8e383a220d48c0927b9eee3ae22895af8305651a669ef8bf4b50d6a::bit_math::most_significant_bit(arg0);
        let v1 = if (v0 >= 64) {
            1 << (v0 + 64) / 2
        } else {
            1 << (v0 + 64) / 2
