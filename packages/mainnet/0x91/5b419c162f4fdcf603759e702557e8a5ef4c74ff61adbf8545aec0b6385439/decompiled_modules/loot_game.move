module 0x915b419c162f4fdcf603759e702557e8a5ef4c74ff61adbf8545aec0b6385439::loot_game {
    ...
    public entry fun battle(arg0: &mut LOOT_GAME, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::string::utf8(b"Draw");
        let v1 = get_random_range(arg1, 100);
        if (v1 < arg0.no) {
        ...
        let v2 = EventGameOutCome{
            object_id   : 0x2::object::id<LOOT_GAME>(arg0),
            player_val  : arg0.no,
            machine_val : v1,
            outcome     : v0,
        };
    ...
    fun random_nft(arg0: &mut LOOT_GAME, arg1: &0x2::clock::Clock) {
        ...
        0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"Made by @Mulander-J"));
        arg0.traits = v8;
        arg0.url = svg_url(&arg0.traits);
