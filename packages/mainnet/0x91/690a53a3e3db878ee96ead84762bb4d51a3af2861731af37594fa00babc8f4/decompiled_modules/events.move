module 0x91690a53a3e3db878ee96ead84762bb4d51a3af2861731af37594fa00babc8f4::events {
    ...
    struct UpgradeConfigVersion has copy, drop {
        config_id: 0x2::object::ID,
        version: u64,
    }
    ...
    public(friend) fun emit_upgrade_config_version(arg0: 0x2::object::ID, arg1: u64) {
        let v0 = UpgradeConfigVersion{
            config_id : arg0,
            version   : arg1,
        };
        0x2::event::emit<UpgradeConfigVersion>(v0);
    }
