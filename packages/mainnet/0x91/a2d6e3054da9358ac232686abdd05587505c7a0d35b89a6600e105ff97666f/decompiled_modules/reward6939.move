module 0x91a2d6e3054da9358ac232686abdd05587505c7a0d35b89a6600e105ff97666f::reward6939 {
    struct REWARD6939 has drop {
        dummy_field: bool,
    }

    struct TICKET_6939 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6939(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6939>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6939>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6939, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6939>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6939>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6939>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6939>>(v5, 0x2::tx_context::sender(arg1));
    }
