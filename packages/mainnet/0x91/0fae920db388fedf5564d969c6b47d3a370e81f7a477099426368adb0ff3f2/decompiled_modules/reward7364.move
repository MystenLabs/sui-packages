module 0x910fae920db388fedf5564d969c6b47d3a370e81f7a477099426368adb0ff3f2::reward7364 {
    struct REWARD7364 has drop {
        dummy_field: bool,
    }

    struct TICKET_7364 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7364(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7364>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7364>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7364, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7364>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7364>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7364>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7364>>(v5, 0x2::tx_context::sender(arg1));
    }
