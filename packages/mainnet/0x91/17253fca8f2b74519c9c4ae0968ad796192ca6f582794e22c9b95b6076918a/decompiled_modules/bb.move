module 0x9117253fca8f2b74519c9c4ae0968ad796192ca6f582794e22c9b95b6076918a::bb {
    struct BB has drop {
        dummy_field: bool,
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<BB>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<BB>>(0x2::coin::mint<BB>(arg0, arg1, arg3), arg2);
    }

    public fun add_addr_from_deny_list(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCapV2<BB>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun remove_addr_from_deny_list(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCapV2<BB>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
