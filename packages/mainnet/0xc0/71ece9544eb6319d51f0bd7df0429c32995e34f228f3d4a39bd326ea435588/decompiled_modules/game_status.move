module 0xd441d82fa791d7e7fc89eb2a40b0714bd9a6a1aaf0c897d702802d30109c1f7b::game_status {
    ...
    struct LastOpeners has store {
        is_ended: bool,
        opening_counter: u64,
        queue: 0x2::linked_table::LinkedTable<u64, address>,
    }

    fun set_ended(arg0: &mut GameStatus) {
        borrow_last_opener_mut(arg0).is_ended = true;
    }
    ...
    public(friend) fun add_opener(arg0: &mut GameStatus, arg1: address) {
        let v0 = borrow_last_opener_mut(arg0);
        let v1 = &mut v0.queue;
        0x2::linked_table::push_front<u64, address>(v1, v0.opening_counter, arg1);
        if (0x2::linked_table::length<u64, address>(v1) > 0xd441d82fa791d7e7fc89eb2a40b0714bd9a6a1aaf0c897d702802d30109c1f7b::config::winner_count()) {
            let (_, _) = 0x2::linked_table::pop_back<u64, address>(v1);
        };
        v0.opening_counter = v0.opening_counter + 1;
    }
    ...
    fun borrow_last_opener(arg0: &GameStatus) : &LastOpeners {
        0x2::dynamic_field::borrow<vector<u8>, LastOpeners>(&arg0.id, b"v2 patch")
    }

    fun borrow_last_opener_mut(arg0: &mut GameStatus) : &mut LastOpeners {
        0x2::dynamic_field::borrow_mut<vector<u8>, LastOpeners>(&mut arg0.id, b"v2 patch")
    }
    ...
    public fun end_v2(arg0: &mut GameStatus, arg1: &mut 0xd441d82fa791d7e7fc89eb2a40b0714bd9a6a1aaf0c897d702802d30109c1f7b::final::FinalPool, arg2: &mut 0xd441d82fa791d7e7fc89eb2a40b0714bd9a6a1aaf0c897d702802d30109c1f7b::lootbox::LootboxPool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        if (is_ended_v2(arg0)) {
            return
        };
        set_ended(arg0);
        ...
        arg0.start_time = 0xd441d82fa791d7e7fc89eb2a40b0714bd9a6a1aaf0c897d702802d30109c1f7b::math::max_u64();
        arg0.end_time = 0xd441d82fa791d7e7fc89eb2a40b0714bd9a6a1aaf0c897d702802d30109c1f7b::math::max_u64();
        let v0 = &mut borrow_last_opener_mut(arg0).queue;
        let v1 = 0xd441d82fa791d7e7fc89eb2a40b0714bd9a6a1aaf0c897d702802d30109c1f7b::config::winner_share_distribution();
        let v2 = 0;
        while (!0x2::linked_table::is_empty<u64, address>(v0)) {
            let (_, v4) = 0x2::linked_table::pop_front<u64, address>(v0);
    ...
    public fun is_ended_v2(arg0: &GameStatus) : bool {
        borrow_last_opener(arg0).is_ended
    }
    ...
    public fun v2_patch(arg0: &mut GameStatus, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = LastOpeners{
            is_ended        : false,
            opening_counter : 0,
            queue           : 0x2::linked_table::new<u64, address>(arg1),
        };
        0x2::dynamic_field::add<vector<u8>, LastOpeners>(&mut arg0.id, b"v2 patch", v0);
        arg0.is_ended = true;
    }
