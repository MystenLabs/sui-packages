module 0xc00d37b051d29051cf6ae268c11ea51b152d5b6fda30fdef66f82958f9aaa658::exchange_airdrop {
    ...
    public fun get_airdrop<T0, T1>(arg0: &mut ExchangeAirdrop<T0, T1>, arg1: &mut 0x3c1fa2694dbcd7cd95d15bdad7ea287be2fbd566c59550a882c085906a86f51a::voting_escrow::VotingEscrow<T1>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x3c1fa2694dbcd7cd95d15bdad7ea287be2fbd566c59550a882c085906a86f51a::voting_escrow::create_lock<T1>(arg1, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.reserves, v0), arg4), 1456, true, arg3, arg4);
    }
