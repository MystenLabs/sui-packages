module 0xc043a82d918b4b0b8eb9f3c391212ee82ec860a42c3feb6905a9b80e0da278f9::dialog_management {
    ...
    public entry fun send_message(arg0: &mut Dialogs, arg1: &mut DialogsData, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: address, arg6: vector<u8>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        if (!0x2::table::contains<vector<u8>, 0x2::table::Table<u64, Message>>(&arg0.dialogs, arg2)) {
            0x2::table::add<vector<u8>, 0x2::table::Table<u64, Message>>(&mut arg0.dialogs, arg2, 0x2::table::new<u64, Message>(arg8));
        };
        if (0x2::table::contains<vector<u8>, DialogData>(&arg1.dialogs_data, arg3)) {
            ...
            v0.timestamp = arg7;
            v0.last_message = arg6;
        };
        if (0x2::table::contains<vector<u8>, DialogData>(&arg1.dialogs_data, arg4)) {
            let v1 = 0x2::table::borrow_mut<vector<u8>, DialogData>(&mut arg1.dialogs_data, arg4);
            v1.timestamp = arg7;
            v1.last_message = arg6;
        };
        let v2 = 0x2::table::borrow_mut<vector<u8>, 0x2::table::Table<u64, Message>>(&mut arg0.dialogs, arg2);
        let v3 = Message{
        ...
        0x2::table::add<u64, Message>(v2, 0x2::table::length<u64, Message>(v2), v3);
    }
