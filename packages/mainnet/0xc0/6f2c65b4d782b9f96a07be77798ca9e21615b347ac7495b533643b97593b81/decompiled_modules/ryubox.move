module 0xc06f2c65b4d782b9f96a07be77798ca9e21615b347ac7495b533643b97593b81::ryubox {
    ...
    fun init(arg0: RYUBOX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b" Ryu Test Box "));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"https://ryu.finance"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"https://ryu.finance"));
        ...
        let v7 = RyuBoxCollect{
            ...
            close_mint_time   : 1684910961,
            open_time         : 1683874162,
            limit_box         : 2000,
        };
    ...
    fun mint(arg0: &mut RyuBoxCollect, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = RYUBOXNFT{
            ...
            number      : arg0.number,
            img_url     : 0x2::url::new_unsafe_from_bytes(b"https://ipfs.bluemove.net/uploads2/wagmi-whales/images/467.webp"),
            link        : 0x2::url::new_unsafe_from_bytes(b"https://ryu.finance"),
            description : 0x1::string::utf8(b" Ryu Test Box"),
    ...
    public entry fun mint_by_white(arg0: &mut RyuBoxCollect, arg1: &mut 0x2::tx_context::TxContext) {
        mint(arg0, arg1);
    }
    ...
    public entry fun set_collect(arg0: &mut RyuBoxCollect, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == @0x3ec31c14f6739ff7da81c7f10912cbdea340319c95b30cd52b55e8e697655472, 1001);
