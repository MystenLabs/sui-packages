module 0xc0e536b692d0bfd0bef2a04c9cf3f5b4edb41042fbd1356bdfb6ee3635d7f3dd::cnsnft5242 {
    struct CNSNFT5242 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5242, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5242>(arg0, arg1);
