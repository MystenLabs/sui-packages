module 0x6fcc5671a287f45d16aeb215aea32f1507de38a163b4021781779a3339033aa2::my_first_contract {
    ...
    public entry fun return_new_coin<T0>(arg0: 0x2::coin::Coin<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::coin::destroy_zero<T0>(arg0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg0, 0x2::coin::value<T0>(&arg0), arg1), 0x2::tx_context::sender(arg1));
    }
