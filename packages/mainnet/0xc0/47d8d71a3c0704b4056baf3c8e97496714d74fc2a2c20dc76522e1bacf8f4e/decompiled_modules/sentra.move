module 0xc047d8d71a3c0704b4056baf3c8e97496714d74fc2a2c20dc76522e1bacf8f4e::sentra {
    ...
    struct PlatformFeesUpdated has copy, drop, store {
        admin: address,
        penalty_bps: u64,
        yield_fee_bps: u64,
        default_deposit_fee_bps: u64,
    ...
    public entry fun add_to_yield_lock<T0, T1>(arg0: &mut YieldLock<T1>, arg1: &mut Platform, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.principal_base_amount = arg0.principal_base_amount + safe_mul_div(arg3, v6, v3);
    ...
    public entry fun add_token_support<T0>(arg0: &AdminCap, arg1: &mut Platform, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x1::vector::contains<0x1::type_name::TypeName>(&arg1.supported_tokens, &v1)) {
            ...
            let v2 = TokenFeeConfig{
                deposit_fee_bps : arg1.default_deposit_fee_bps,
                min_deposit_fee : 0,
                max_deposit_fee : 0,
            };
    ...
    public entry fun complete_yield_withdrawal_with_redeemed_coin<T0, T1>(arg0: YieldLock<T1>, arg1: 0x2::coin::Coin<T0>, arg2: &mut Platform, arg3: &mut UserRegistry, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let (v18, v19) = if (v15 >= v3 + v4) {
            ...
            let v20 = safe_mul_div(v5, arg2.penalty_bps, 10000);
            let v21 = if (v5 > v20) {
                v5 - v20
            } else {
                0
        ...
        let (v22, v23) = if (v17 > 0) {
            let v24 = safe_mul_div(v17, arg2.yield_fee_bps, 10000);
            (v24, v17 - v24)
        } else {
            (0, 0)
        };
    ...
    public entry fun configure_platform_fees(arg0: &AdminCap, arg1: &mut Platform, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(v0 == arg1.admin, 1);
        assert!(0x2::object::id<AdminCap>(arg0) == arg1.admin_cap_id, 7);
        ...
        assert!(arg2 + arg3 <= 10000, 13);
        arg1.penalty_bps = arg2;
        arg1.yield_fee_bps = arg3;
        arg1.default_deposit_fee_bps = arg4;
        let v1 = PlatformFeesUpdated{
            admin                   : v0,
            penalty_bps             : arg2,
            yield_fee_bps           : arg3,
            default_deposit_fee_bps : arg4,
        };
        0x2::event::emit<PlatformFeesUpdated>(v1);
    }
    ...
    public entry fun create_yield_lock<T0, T1>(arg0: &mut Platform, arg1: &mut UserRegistry, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v4 > 0, 5);
        let v5 = safe_mul_div(arg4, v4, v2);
        ...
        let v10 = 0x2::object::id<YieldLock<T1>>(&v9);
        registry_add_yield_lock(arg1, v7, v10, arg7);
        update_yield_tvl<T0>(arg0, v4, true);
        0x2::table::add<0x2::object::ID, bool>(&mut arg0.global_yield_lock_list, v10, true);
        increment_token_yield_lock_count(arg0, v0);
        0x2::transfer::transfer<YieldLock<T1>>(v9, v7);
    ...
    public fun platform_default_deposit_fee_bps(arg0: &Platform) : u64 {
        arg0.default_deposit_fee_bps
    }
    ...
    public fun platform_penalty_bps(arg0: &Platform) : u64 {
        arg0.penalty_bps
    }
    ...
    public fun platform_yield_fee_bps(arg0: &Platform) : u64 {
        arg0.yield_fee_bps
    }
    ...
    public fun unlock_yield_lock_s_coin<T0>(arg0: &mut YieldLock<T0>, arg1: &Platform, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(!arg1.paused_withdrawals, 6);
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 1);
        assert!(!arg0.s_coin_unlocked, 10);
        let v0 = 0x2::balance::value<T0>(&arg0.s_coin_balance);
        assert!(v0 > 0, 5);
        arg0.s_coin_unlocked = true;
        0x2::coin::take<T0>(&mut arg0.s_coin_balance, v0, arg2)
    }
    ...
    public entry fun withdraw<T0>(arg0: Lock<T0>, arg1: &mut Platform, arg2: &mut UserRegistry, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let (v12, v13) = if (v11 >= v5 + v6) {
            ...
            let v14 = safe_mul_div(v10, arg1.penalty_bps, 10000);
            (v10 - v14, v14)
        };
        if (v12 > 0) {
