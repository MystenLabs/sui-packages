module 0xc046f2714674bc5dfa5d2bbcf129371f37a8e52278e52d6d20ad2c724ebf43e5::incentive {
    ...
    public fun get_incentive_pools(arg0: &0x2::clock::Clock, arg1: &mut Incentive, arg2: &mut 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::Storage, arg3: u8, arg4: u8, arg5: address) : vector<IncentivePoolInfo> {
        ...
        let (v1, _, _) = get_pool_from_asset_and_option(arg1, arg3, arg4);
        let v4 = v1;
    ...
    public fun new_owner_cap(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = OwnerCap{id: 0x2::object::new(arg0)};
        0x2::transfer::public_transfer<OwnerCap>(v0, 0x2::tx_context::sender(arg0));
    }
