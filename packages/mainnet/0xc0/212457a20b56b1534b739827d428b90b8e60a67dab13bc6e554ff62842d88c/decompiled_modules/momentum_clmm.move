module 0xc0212457a20b56b1534b739827d428b90b8e60a67dab13bc6e554ff62842d88c::momentum_clmm {
    ...
    public fun momentum_clmm_remove_liquidity<T0, T1>(arg0: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg2: &0x2::clock::Clock, arg3: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position, arg4: u128, arg5: u128, arg6: bool, arg7: bool, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v2 = v1;
        let v3 = v0;
        let (v4, v5) = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::collect::fee<T0, T1>(arg0, arg3, arg2, arg1, arg8);
        0x2::coin::join<T0>(&mut v3, v4);
        0x2::coin::join<T1>(&mut v2, v5);
        if (arg6) {
            0x2::coin::join<T0>(&mut v3, 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::collect::reward<T0, T1, T0>(arg0, arg3, arg2, arg1, arg8));
        };
        if (arg7) {
            0x2::coin::join<T1>(&mut v2, 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::collect::reward<T0, T1, T1>(arg0, arg3, arg2, arg1, arg8));
        };
        (v3, v2)
    }
