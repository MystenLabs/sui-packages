module 0xc0a8eeace7ce27ca201bba4ef09e05fbdd1b8343b91ccd3b8d5771954df61678::cetus_reward_w4 {
    struct CETUS_REWARD_W4 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = CETUS_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmdFiLeNgtBC33BnPmkPksELoxxWm7pGs9TEruYH8ho5k3"),
            };
    ...
    fun init(arg0: CETUS_REWARD_W4, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmdFiLeNgtBC33BnPmkPksELoxxWm7pGs9TEruYH8ho5k3"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        let v4 = 0x2::package::claim<CETUS_REWARD_W4>(arg0, arg1);
