module 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::pool {
    ...
    fun check_need_rebalance<T0>(arg0: &Pool<T0>, arg1: u128) : bool {
        ...
        if (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::lte(v0, v1) || 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::gte(v0, v2)) {
            return true
        };
        let v3 = 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::clmm_vault::rebalance_threshold(&arg0.clmm_vault);
    ...
    public fun flash_loan<T0, T1, T2>(arg0: &mut Pool<T2>, arg1: &0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::config::GlobalConfig, arg2: &0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::pyth_oracle::PythOracle, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoanCert) {
        ...
        let (v2, _) = 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::pyth_oracle::calculate_prices(&v0, &v1);
        let v4 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_ceil(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_floor(v2, arg3, 0x1::u64::pow(10, 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::utils::oracle_price_multiplier_decimal())), 10000 - (0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::config::get_swap_slippage<T0>(arg1) + 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::config::get_swap_slippage<T1>(arg1)) / 2, 10000);
        let v5 = 0x1::type_name::get<T1>();
        let (v6, v7) = 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::clmm_vault::coin_types(&arg0.clmm_vault);
        assert!(v5 == v6 || v5 == v7, 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::incorrect_repay());
        ...
        (0x2::coin::from_balance<T0>(0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::balance_bag::split<T0>(&mut arg0.buffer_assets, arg3), arg5), v8)
    }
