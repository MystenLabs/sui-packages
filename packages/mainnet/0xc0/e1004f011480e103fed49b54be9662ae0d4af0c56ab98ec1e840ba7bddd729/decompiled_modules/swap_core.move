module 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::swap_core {
    ...
    public entry fun swap<T0, T1, T2>(arg0: &GlobalConfig, arg1: &mut Pool<T0, T1, T2>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        if (arg6) {
            assert!(0x2::coin::value<T1>(&arg3) == 0, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::NotZeroBalance());
            let v0 = 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::split_coin_to_balance<T0>(arg2, arg4, arg7);
            ...
            assert!(0x2::coin::value<T0>(&arg2) == 0, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::NotZeroBalance());
            let v3 = 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::split_coin_to_balance<T1>(arg3, arg4, arg7);
    ...
    public entry fun add_liquidity<T0, T1, T2>(arg0: &GlobalConfig, arg1: &mut Pool<T0, T1, T2>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::split_coin_to_balance<T0>(arg2, arg4, arg6);
        let v1 = 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::split_coin_to_balance<T1>(arg3, arg5, arg6);
        ...
        0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::send_balance<T0>(v3, 0x2::tx_context::sender(arg6), arg6);
        0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::send_balance<T1>(v4, 0x2::tx_context::sender(arg6), arg6);
    }
    ...
    public fun base_add_liquidity<T0, T1, T2>(arg0: &GlobalConfig, arg1: &mut Pool<T0, T1, T2>, arg2: 0x2::balance::Balance<T0>, arg3: 0x2::balance::Balance<T1>, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<NLP<T0, T1, T2>>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert!(arg1.is_deposit_enabled && arg0.is_deposit_enabled, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::DepositDisabled());
        verify_version(arg0);
        let v0 = 0x2::balance::value<T0>(&arg2);
        let v1 = 0x2::balance::value<T1>(&arg3);
        assert!(v0 > 0 || v1 > 0, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::ZeroBalance());
    ...
    fun base_create_pool<T0, T1, T2>(arg0: &mut GlobalConfig, arg1: &mut PoolManager, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0x2::coin::CoinMetadata<T1>, arg4: &mut 0x2::tx_context::TxContext) : Pool<T0, T1, T2> {
        verify_version(arg0);
        assert!(arg0.is_create_pool_enabled, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::CreatePoolDisabled());
        let (v0, v1, v2) = get_pool_name<T0, T1, T2>();
        assert!(!0x2::table::contains<0x1::string::String, address>(&arg1.pools, v0), 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::PoolExists());
        assert!(!v2, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::SameTokenPair());
        assert!(!v1, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::IncorrectTokenOrder());
        let v3 = 0x2::object::new(arg4);
        0x1::debug::print<0x2::object::UID>(&v3);
    ...
    public fun base_remove_liquidity<T0, T1, T2>(arg0: &GlobalConfig, arg1: &mut Pool<T0, T1, T2>, arg2: 0x2::balance::Balance<NLP<T0, T1, T2>>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        verify_version(arg0);
        assert!(arg1.is_withdraw_enabled && arg0.is_withdraw_enabled, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::WithdrawDisabled());
        let v0 = 0x2::balance::value<NLP<T0, T1, T2>>(&arg2);
        assert!(v0 > 0, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::ZeroBalance());
    ...
    public fun base_swap_ab<T0, T1, T2>(arg0: &GlobalConfig, arg1: &mut Pool<T0, T1, T2>, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        verify_version(arg0);
        assert!(arg1.is_swap_enabled && arg0.is_swap_enabled, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::SwapDisabled());
        let v0 = &mut arg2;
        ...
        assert!(v3 >= arg3, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::Slippage());
        ...
        assert!(v4 >= calcualte_liquidity(0x2::balance::value<T0>(&arg1.reserve_a), 0x2::balance::value<T1>(&arg1.reserve_b)), 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::LiquidityLogicError());
        let v5 = SwapEvent{
            pool_id         : arg1.pool_id,
            amount_in       : v2,
            amount_out      : v3,
    ...
    public fun calculate_add_liquidity(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : (u64, u64) {
        ...
        let v0 = arg0;
        let v1 = 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::safe_mul_div(arg0, arg3, arg2);
        let v2 = v1;
        if (v1 > arg1) {
            v0 = 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::safe_mul_div(arg1, arg2, arg3);
            v2 = arg1;
        };
        (v0, v2)
    }
    ...
    public fun calculate_amount_out_by_pool<T0, T1, T2>(arg0: &Pool<T0, T1, T2>, arg1: u64, arg2: bool) : u64 {
        ...
        assert!(arg1 > 0 && v0 > 0 && v1 > 0, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::ZeroBalance());
    ...
    public fun calculate_withdrawable_amount_by_lp<T0, T1, T2>(arg0: &Pool<T0, T1, T2>, arg1: u64) : (u64, u64) {
        ...
        (0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::safe_mul_div(0x2::balance::value<T0>(&arg0.reserve_a), arg1, v0), 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::safe_mul_div(0x2::balance::value<T1>(&arg0.reserve_b), arg1, v0))
    }
    ...
    public fun create_pool<T0, T1, T2>(arg0: &mut GlobalConfig, arg1: &mut PoolManager, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0x2::coin::CoinMetadata<T1>, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Pool<T0, T1, T2>>(base_create_pool<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4));
    }

    public fun create_pool_and_add_liquidity<T0, T1, T2>(arg0: &mut GlobalConfig, arg1: &mut PoolManager, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0x2::coin::CoinMetadata<T1>, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T1>, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = base_create_pool<T0, T1, T2>(arg0, arg1, arg2, arg3, arg8);
        let v1 = &mut v0;
        add_liquidity<T0, T1, T2>(arg0, v1, arg4, arg5, arg6, arg7, arg8);
    ...
    public fun get_pool_name<T0, T1, T2>() : (0x1::string::String, bool, bool) {
        ...
        let v7 = v6;
        let v8 = 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::cmp_bytes(v3, v6);
        if (v8 == 1) {
            v1 = true;
        };
        if (v8 == 2) {
        ...
        assert!(0x1::string::index_of(&v9, &v11) == 0x1::string::length(&v9), 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::InvalidType());
        assert!(0x1::string::index_of(&v10, &v11) == 0x1::string::length(&v10), 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::InvalidType());
    ...
    public entry fun init_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0 <= 1000, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::MaxValueExceeded());
        assert!(arg1 <= 1000, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::MaxValueExceeded());
        assert!(arg2 <= 1000, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::MaxValueExceeded());
        assert!(arg3 <= 1000, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::MaxValueExceeded());
        let v0 = GlobalConfig{
    ...
    fun mint<T0, T1, T2>(arg0: &GlobalConfig, arg1: &mut Pool<T0, T1, T2>, arg2: 0x2::balance::Balance<T0>, arg3: 0x2::balance::Balance<T1>) : 0x2::balance::Balance<NLP<T0, T1, T2>> {
        ...
        if (0x2::balance::value<NLP<T0, T1, T2>>(&arg1.nlp_locked) == 0) {
            assert!(0x2::balance::value<NLP<T0, T1, T2>>(&v0) > arg0.min_liquidity, 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::LiquidityNotEnough());
    ...
    public entry fun remove_liquidity<T0, T1, T2>(arg0: &GlobalConfig, arg1: &mut Pool<T0, T1, T2>, arg2: 0x2::coin::Coin<NLP<T0, T1, T2>>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::split_coin_to_balance<NLP<T0, T1, T2>>(arg2, arg3, arg4);
        let (v1, v2) = base_remove_liquidity<T0, T1, T2>(arg0, arg1, v0, arg4);
        0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::send_balance<T0>(v1, 0x2::tx_context::sender(arg4), arg4);
        0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::send_balance<T1>(v2, 0x2::tx_context::sender(arg4), arg4);
    }
    ...
    fun take_protocol_fee_ab<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: &mut 0x2::balance::Balance<T0>) : u64 {
        let v0 = 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::safe_mul_div(0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::safe_mul_div(0x2::balance::value<T0>(arg1), arg0.lp_fee_rate, 1000), arg0.protocol_fee_rate, 1000);
    ...
    fun take_protocol_fee_ba<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: &mut 0x2::balance::Balance<T1>) : u64 {
        let v0 = 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::safe_mul_div(0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::safe_mul_div(0x2::balance::value<T1>(arg1), arg0.lp_fee_rate, 1000), arg0.protocol_fee_rate, 1000);
        0x2::balance::join<T1>(&mut arg0.protocol_fee_b, 0x2::balance::split<T1>(arg1, v0));
        v0
    }

    public fun verify_version(arg0: &GlobalConfig) {
        0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::pre_check_version(arg0.version);
    }

    public fun version_migrate(arg0: &SwapAdminCap, arg1: &mut GlobalConfig) {
        assert!(arg1.version < 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::version(), 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::IncorrectVersion());
        arg1.version = 0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::validation::version();
    }
    ...
    public entry fun withdraw_protocol_fee<T0, T1, T2>(arg0: &SwapAdminCap, arg1: &mut Pool<T0, T1, T2>, arg2: u64, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::send_balance<T0>(0x2::balance::split<T0>(&mut arg1.protocol_fee_a, arg3), arg4, arg5);
        0xc0e1004f011480e103fed49b54be9662ae0d4af0c56ab98ec1e840ba7bddd729::utils::send_balance<T1>(0x2::balance::split<T1>(&mut arg1.protocol_fee_b, arg2), arg4, arg5);
