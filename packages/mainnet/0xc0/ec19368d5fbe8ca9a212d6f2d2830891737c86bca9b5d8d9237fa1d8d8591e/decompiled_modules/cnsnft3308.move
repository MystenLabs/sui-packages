module 0xc0ec19368d5fbe8ca9a212d6f2d2830891737c86bca9b5d8d9237fa1d8d8591e::cnsnft3308 {
    struct CNSNFT3308 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3308, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3308>(arg0, arg1);
