module 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::pool {
    ...
    fun borrow_balance<T0, T1>(arg0: &Pool<T0>) : &0x2::balance::Balance<T1> {
        0x2::dynamic_field::borrow<0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::BalanceKey<T1>, 0x2::balance::Balance<T1>>(&arg0.id, 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::type_to_balance_key<T1>())
    }

    fun borrow_mut_balance<T0, T1>(arg0: &mut Pool<T0>) : &mut 0x2::balance::Balance<T1> {
        0x2::dynamic_field::borrow_mut<0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::BalanceKey<T1>, 0x2::balance::Balance<T1>>(&mut arg0.id, 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::type_to_balance_key<T1>())
    }
    ...
    public fun contains_type<T0, T1>(arg0: &Pool<T0>) : bool {
        let v0 = 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::type_to_string<T1>();
    ...
    public(friend) fun initialize_liquidity<T0, T1>(arg0: &mut 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::pool_registry::PoolRegistry, arg1: &mut Pool<T0>, arg2: 0x2::coin::Coin<T1>) {
        0x2::dynamic_field::add<0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::BalanceKey<T1>, 0x2::balance::Balance<T1>>(&mut arg1.id, 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::type_to_balance_key<T1>(), 0x2::balance::zero<T1>());
        join<T0, T1>(arg1, arg2);
        0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::pool_registry::add_coin<T1>(arg0);
    }
    ...
    public fun lp_type<T0>(arg0: &Pool<T0>) : 0x1::ascii::String {
        0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::type_to_string<T0>()
    }
    ...
    public(friend) fun new_pool<T0>(arg0: 0x2::coin::TreasuryCap<T0>, arg1: 0x2::coin::CoinMetadata<T0>, arg2: &mut 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::pool_registry::PoolRegistry, arg3: vector<u8>, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: u64, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<u64>, arg10: vector<u64>, arg11: 0x1::option::Option<vector<u8>>, arg12: bool, arg13: &mut 0x2::tx_context::TxContext) : Pool<T0> {
        ...
        0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::pool_registry::register_pool<T0>(arg2, &v2, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
        let (v3, v4) = if (arg12) {
    ...
    public(friend) fun type_to_index<T0, T1>(arg0: &Pool<T0>) : u64 {
        type_name_to_index<T0>(arg0, 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::type_to_string<T1>())
    }
