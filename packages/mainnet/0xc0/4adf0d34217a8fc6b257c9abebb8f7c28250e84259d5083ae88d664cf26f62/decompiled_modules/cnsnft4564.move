module 0xc04adf0d34217a8fc6b257c9abebb8f7c28250e84259d5083ae88d664cf26f62::cnsnft4564 {
    struct CNSNFT4564 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4564, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4564>(arg0, arg1);
