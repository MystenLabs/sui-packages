module 0xc0e7512dbb03949472b05e9ab015d07f64a52a4ffeeb5dfd72f56658ec91d3c2::sensui_nft {
    ...
    public entry fun mint_to_sender(arg0: &mut NFTMintData, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0;
        let v4 = 0;
        if (arg0.nft_minted <= 10 && v1 / 3600 - arg0.time_start_event / 3600 <= 2 && !arg0.is_resume) {
            if (arg5 >= 1 && arg5 <= 6) {
                v2 = 1200000;
            } else if (arg5 >= 7) {
                v2 = 1000000;
