module 0xc0f1ccb52aa11d4679b8342a8919594e012649c8639dcb20542d486ff3b93c5f::degen {
    ...
    fun init(arg0: DEGEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/8Y2P26XHQAFvYsoKesr8jhEaSVQvfZ1V73zciKWR9qyB.png?size=lg&key=54dce2                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DEGEN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DEGEN   ")))), trim_right(b"Degen Pines                     "), trim_right(b"Degen Pines is Dipper Pines imprisoned in a sock. Born out of the chaos of crypto culture, Degen Pines is a wild twist on a beloved character, trapped forever in the world of memes, fast trades, and unpredictable charts.                                                                                                    "), v2, arg1);
        let v5 = v3;
