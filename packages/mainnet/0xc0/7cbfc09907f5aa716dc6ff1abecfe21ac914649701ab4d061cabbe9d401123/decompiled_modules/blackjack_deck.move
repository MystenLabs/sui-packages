module 0xc07cbfc09907f5aa716dc6ff1abecfe21ac914649701ab4d061cabbe9d401123::blackjack_deck {
    ...
    public fun draw_fresh(arg0: &mut 0x2::random::RandomGenerator, arg1: &vector<u8>) : u8 {
        let v0;
        loop {
            v0 = 0xc07cbfc09907f5aa716dc6ff1abecfe21ac914649701ab4d061cabbe9d401123::randomness::u8_in_range(arg0, 0, 51);
    ...
    public fun shuffle(arg0: &mut 0x2::random::RandomGenerator, arg1: &mut vector<u8>) {
        ...
        0xc07cbfc09907f5aa716dc6ff1abecfe21ac914649701ab4d061cabbe9d401123::randomness::shuffle_u8(arg0, arg1);
    }

    public fun shuffled(arg0: &mut 0x2::random::RandomGenerator) : vector<u8> {
        let v0 = 0xc07cbfc09907f5aa716dc6ff1abecfe21ac914649701ab4d061cabbe9d401123::blackjack_cards::new_deck();
        let v1 = &mut v0;
        shuffle(arg0, v1);
        v0
    }
