module 0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::protocol_fee {
    ...
    public(friend) fun create_config<T0: drop>(arg0: &T0, arg1: &mut 0x2::tx_context::TxContext) : (ProtocolFeeConfig, ChangeFeeCap) {
        ...
        let v0 = ProtocolFeeConfig{
            ...
            total_protocol_fee_percent_base_18 : 100000000000000000,
            treasury_fee_percent_base_18       : 100000000000000000,
    ...
    public fun distribute_protocol_fees<T0>(arg0: &ProtocolFeeConfig, arg1: &0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::treasury::Treasury, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 > 0) {
            0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::treasury::deposit<T0>(arg1, 0x2::coin::split<T0>(arg2, v0, arg3));
        };
    ...
    public fun update_dev_wallet_address(arg0: &0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::admin::AdminCap, arg1: &mut ProtocolFeeConfig, arg2: address) {
        assert_interacting_with_most_up_to_date_package(arg1);
