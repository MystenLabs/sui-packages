module 0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::router {
    ...
    public fun begin_router_tx_and_collect_fees<T0>(arg0: vector<u8>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::protocol_fee::ProtocolFeeConfig, arg4: &0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::treasury::Treasury, arg5: &mut 0x2::tx_context::TxContext) : RouterSwapCap<T0> {
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert_route_starts_with_non_zero_value(v0);
        0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::protocol_fee::distribute_protocol_fees<T0>(arg3, arg4, &mut arg1, arg5);
        let v1 = SwapMetadata{
            typeName : type_to_bytes<T0>(),
            amount   : v0,
        };
    ...
    public fun end_router_tx<T0>(arg0: RouterSwapCap<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::events::emit_swap_completed_event(v8.typeName, v8.amount, v7.typeName, v7.amount, arg1);
    }

    public fun end_router_tx_and_pay_fees<T0, T1>(arg0: RouterSwapCap<T0>, arg1: &mut 0x2::coin::Coin<T1>, arg2: &0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::protocol_fee::ProtocolFeeConfig, arg3: &0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::treasury::Treasury, arg4: &mut 0x2::tx_context::TxContext) {
        assert_previous_swap_was_valid<T0>(&arg0);
        let v0 = &mut arg0;
        update_final_swap_metadata<T0>(v0);
        ...
        let v8 = v3;
        0x2::coin::destroy_zero<T0>(v1);
        0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::protocol_fee::distribute_protocol_fees<T1>(arg2, arg3, arg1, arg4);
        0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::events::emit_swap_completed_event(v8.typeName, v8.amount, v7.typeName, v7.amount, arg4);
    }

    fun init(arg0: ROUTER, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        0x2::transfer::public_transfer<0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::admin::AdminCap>(0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::admin::create_admin_cap(arg1), v0);
        let (v1, v2) = 0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::protocol_fee::create_config<ROUTER>(&arg0, arg1);
        0x2::transfer::public_share_object<0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::protocol_fee::ProtocolFeeConfig>(v1);
        0x2::transfer::public_transfer<0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::protocol_fee::ChangeFeeCap>(v2, v0);
        0x2::transfer::public_share_object<0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::treasury::Treasury>(0xc0268f9fdd722d235db09fc88b5a3b63a6d167d2a97e90b78e6ac4301e38661e::treasury::create_treasury(arg1));
    ...
    public fun update_path_metadata<T0>(arg0: vector<u8>, arg1: &mut RouterSwapCap<T0>, arg2: &0x2::object::UID, arg3: u64) {
        update_previous_swap_metadata<T0>(arg1, arg0, arg3);
    }
