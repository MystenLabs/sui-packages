module 0xbcd081de58a8f41d7692316b467051b17c75406bda68c0201f7d83727b176b53::portfolio {
    ...
    public fun borrow_mut_dof_position<T0: store + key>(arg0: &mut PositionManager, arg1: 0x2::object::ID) : &mut T0 {
    ...
    public fun disable_auto_compound<T0, T1>(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32) {
        ...
        0x2::dynamic_field::borrow_mut<PositionKey, HighFiPosition<T0, T1>>(&mut arg0.id, v0).settings.auto_compound = false;
    }

    public fun disable_auto_exit<T0, T1>(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32) {
        assert!(0x2::object::id<PositionManager>(arg0) == arg1.manager_id, 1);
        assert!(arg0.initialized, 3);
        let v0 = PositionKey{
            pool_id    : arg2,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow_mut<PositionKey, HighFiPosition<T0, T1>>(&mut arg0.id, v0).settings.auto_exit = false;
    }

    public fun disable_auto_harvest<T0, T1>(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32) {
        assert!(0x2::object::id<PositionManager>(arg0) == arg1.manager_id, 1);
        assert!(arg0.initialized, 3);
        let v0 = PositionKey{
            pool_id    : arg2,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow_mut<PositionKey, HighFiPosition<T0, T1>>(&mut arg0.id, v0).settings.auto_harvest = false;
    }

    public fun enable_auto_compound<T0, T1>(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32) {
        assert!(0x2::object::id<PositionManager>(arg0) == arg1.manager_id, 1);
        assert!(arg0.initialized, 3);
        let v0 = PositionKey{
            pool_id    : arg2,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow_mut<PositionKey, HighFiPosition<T0, T1>>(&mut arg0.id, v0).settings.auto_compound = true;
    }

    public fun enable_auto_exit<T0, T1>(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32) {
        assert!(0x2::object::id<PositionManager>(arg0) == arg1.manager_id, 1);
        assert!(arg0.initialized, 3);
        let v0 = PositionKey{
            pool_id    : arg2,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow_mut<PositionKey, HighFiPosition<T0, T1>>(&mut arg0.id, v0).settings.auto_exit = true;
    }

    public fun enable_auto_harvest<T0, T1>(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32) {
        assert!(0x2::object::id<PositionManager>(arg0) == arg1.manager_id, 1);
        assert!(arg0.initialized, 3);
        let v0 = PositionKey{
            pool_id    : arg2,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow_mut<PositionKey, HighFiPosition<T0, T1>>(&mut arg0.id, v0).settings.auto_harvest = true;
    }
    ...
    public fun is_enable_auto_compound<T0, T1>(arg0: &PositionManager, arg1: 0x2::object::ID, arg2: u32, arg3: u32) : bool {
        let v0 = PositionKey{
            pool_id    : arg1,
            tick_lower : arg2,
            tick_upper : arg3,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow<PositionKey, HighFiPosition<T0, T1>>(&arg0.id, v0).settings.auto_compound
    }

    public fun is_enable_auto_exit<T0, T1>(arg0: &PositionManager, arg1: 0x2::object::ID, arg2: u32, arg3: u32) : bool {
        let v0 = PositionKey{
            pool_id    : arg1,
            tick_lower : arg2,
            tick_upper : arg3,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow<PositionKey, HighFiPosition<T0, T1>>(&arg0.id, v0).settings.auto_exit
    }

    public fun is_enable_auto_harvest<T0, T1>(arg0: &PositionManager, arg1: 0x2::object::ID, arg2: u32, arg3: u32) : bool {
        let v0 = PositionKey{
            pool_id    : arg1,
            tick_lower : arg2,
            tick_upper : arg3,
        ...
        assert!(0x2::dynamic_field::exists_<PositionKey>(&arg0.id, v0), 2);
        0x2::dynamic_field::borrow<PositionKey, HighFiPosition<T0, T1>>(&arg0.id, v0).settings.auto_harvest
    }
    ...
    public fun open_position<T0, T1>(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = PositionSettings{
            auto_compound : false,
            auto_harvest  : false,
            auto_exit     : false,
        };
        let v2 = HighFiPosition<T0, T1>{
            pool_id             : arg2,
            tick_lower          : arg3,
            tick_upper          : arg4,
        ...
        0x2::dynamic_field::add<PositionKey, HighFiPosition<T0, T1>>(&mut arg0.id, v0, v2);
    ...
    public fun transfer_position_to_owner<T0: store + key, T1, T2>(arg0: &mut PositionManager, arg1: &OwnerCap, arg2: 0x2::object::ID, arg3: u32, arg4: u32) {
        assert!(verify_owner_cap(arg0, arg1), 1);
        assert!(position_exists<T1, T2>(arg0, arg2, arg3, arg4), 2);
        remove_df_position<T1, T2>(arg0, arg2, arg3, arg4);
        let v0 = remove_dof_position<T0>(arg0, arg2);
        0x2::transfer::public_transfer<T0>(v0, get_manager_owner(arg0));
    }
