module 0xc040957f4289093cc8a7a6f31753797a5030f0f9a0c60e89616b759ed525a7d9::gift6874 {
    struct GIFT6874 has drop {
        dummy_field: bool,
    }

    struct TICKET_6874 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6874(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6874>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6874>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6874, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6874>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6874>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6874>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6874>>(v5, 0x2::tx_context::sender(arg1));
    }
