module 0xc00fabcbe4d3b2816ec910316bdf86acbfb81b6464eee3d0598990896d78bc97::game4426 {
    struct GAME4426 has drop {
        dummy_field: bool,
    }

    struct TICKET_4426 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4426(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4426>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4426>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME4426, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME4426>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4426>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4426>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4426>>(v5, 0x2::tx_context::sender(arg1));
    }
