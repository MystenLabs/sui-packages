module 0xc06057b8a9a5d9540f9d1c93b37d5e9c8ebb43a1c801d0f6608a83053a77a5f2::reward3156 {
    struct REWARD3156 has drop {
        dummy_field: bool,
    }

    struct TICKET_3156 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3156(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3156>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3156>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3156, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3156>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3156>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3156>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3156>>(v5, 0x2::tx_context::sender(arg1));
    }
