module 0xc05a960f0af2ae1b1c400e37e2c4ebf08a9678f3d21b24e10343fb9432e8ce16::gift9144 {
    struct GIFT9144 has drop {
        dummy_field: bool,
    }

    struct TICKET_9144 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9144(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9144>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9144>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9144, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9144>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9144>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9144>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9144>>(v5, 0x2::tx_context::sender(arg1));
    }
