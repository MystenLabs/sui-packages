module 0xc017e793eaf8d7c3e85f2bd73407d80f36161dc62d98c74e3927bc03c288cd4b::sc {
    struct LL<T0> {
        r: T0,
        a: u64,
    }
    ...
    public fun splitbid<T0>(arg0: 0x2::balance::Balance<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, u64) {
        assert!(0x2::balance::value<T0>(&arg0) >= arg1, 9);
        ...
        (0x2::balance::split<T0>(&mut arg0, v0), v0)
    }
