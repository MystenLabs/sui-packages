module 0xc0d8f38b80da104965379c9fddb8dd8e20a4678de71adae4828b5fd986a25d3e::embryo {
    ...
    public entry fun mint(arg0: &0x2::package::Publisher, arg1: u64, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: address, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<Embryo>(arg0), 0);
        assert!(0x2::package::from_module<Embryo>(arg0), 0);
        assert!(arg1 > 0, 1);
        while (arg1 > 0) {
            let v0 = Embryo{
            ...
            0x2::transfer::public_transfer<Embryo>(v0, arg7);
            arg1 = arg1 - 1;
        };
    }
