module 0xc071d517a7f99ded71c0fccd90e73db4893acd0935aabad9d4db925767b5a9bd::cnsnft3001 {
    struct CNSNFT3001 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3001, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3001>(arg0, arg1);
