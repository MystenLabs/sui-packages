module 0xc0e2e2f4f1effc97703856791334100afade3c54e2c46e5680147b20ee224cd7::meme {
    ...
    fun init(arg0: MEME, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME>(arg0, 9, b"Monday", b"Monday", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://media-cdn-v2.laodong.vn/storage/newsportal/2024/10/11/1406466/Diddy-2.jpeg")), arg1);
        let v2 = v0;
