module 0xf5f7029970718c094119acdfc9cbc3b8c981a6cd2aa077ae30b68e85e1e870f::entry {
    ...
    public fun run_bluefin_momentum_flash_flip<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T0>, arg4: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg5: bool, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : u64 {
        if (arg6 == 0) {
            return 0
        };
        let (v0, v1) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::borrow_flashloan_quote<T0, T1>(arg0, arg6, arg9);
        let v2 = if (arg5) {
            let v3 = bluefin_buy_a<T0, T1>(arg1, arg2, 0x2::coin::into_balance<T1>(v0), arg8);
            mmt_buy_x<T1, T0>(arg3, arg4, v3, arg8, arg9)
        } else {
            let v4 = mmt_sell_x<T1, T0>(arg3, arg4, 0x2::coin::into_balance<T1>(v0), arg8, arg9);
            bluefin_sell_a<T0, T1>(arg1, arg2, v4, arg8)
        };
        let v5 = v2;
        assert!(0x2::balance::value<T1>(&v5) >= arg6 + arg7, 910);
    ...
    public fun run_cetus_momentum_flash_flip<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg3: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg4: bool, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : u64 {
        if (arg5 == 0) {
            return 0
        };
        let v0 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg1);
        let v1 = if (arg4) {
            let (v2, v3, v4) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg0, arg1, false, true, arg5, 79226673515401279992447579054, arg7);
            0x2::balance::destroy_zero<T1>(v3);
            let v5 = mmt_sell_x<T0, T1>(arg2, arg3, v2, arg7, arg8);
            assert!(0x2::balance::value<T1>(&v5) >= arg5 + arg6, 910);
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg0, arg1, 0x2::balance::zero<T0>(), 0x2::balance::split<T1>(&mut v5, arg5), v4);
            payout<T1>(v5, arg8);
            0x2::balance::value<T1>(&v5)
            ...
            let v9 = v8;
            0x2::balance::destroy_zero<T0>(v6);
            let v10 = mmt_buy_x<T0, T1>(arg2, arg3, v7, arg7, arg8);
            let v11 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T0, T1>(&v9);
            assert!(0x2::balance::value<T0>(&v10) >= v11 + b_to_a_units(arg6, v0), 910);
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg0, arg1, 0x2::balance::split<T0>(&mut v10, v11), 0x2::balance::zero<T1>(), v9);
            payout<T0>(v10, arg8);
        ...
        let v12 = FiredFlash{
            pair_cetus   : 0x2::object::id_address<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg1),
            pair_bluefin : 0x2::object::id_address<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>>(arg2),
            buy_on_cetus : arg4,
            spread_bps   : 0,
            size_b       : arg5,
            profit_b     : v1,
    ...
    public fun run_turbos_momentum_flash<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg2: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg3: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg4: bool, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : u64 {
        if (arg5 == 0) {
            return 0
        };
        let v0 = if (arg4) {
            let (v1, v2, v3) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::flash_swap<T0, T1, T2>(arg0, @0x0, false, (arg5 as u128), true, 79226673515401279992447579054, arg7, arg1, arg8);
            0x2::coin::destroy_zero<T1>(v2);
            let v4 = mmt_sell_x<T0, T1>(arg2, arg3, 0x2::coin::into_balance<T0>(v1), arg7, arg8);
            assert!(0x2::balance::value<T1>(&v4) >= arg5 + arg6, 910);
            0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::repay_flash_swap<T0, T1, T2>(arg0, 0x2::coin::zero<T0>(arg8), 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v4, arg5), arg8), v3, arg1);
            payout<T1>(v4, arg8);
            0x2::balance::value<T1>(&v4)
            ...
            let (v5, v6, v7) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::flash_swap<T0, T1, T2>(arg0, @0x0, true, (arg5 as u128), true, 4295048017, arg7, arg1, arg8);
            0x2::coin::destroy_zero<T0>(v5);
            let v8 = mmt_buy_x<T0, T1>(arg2, arg3, 0x2::coin::into_balance<T1>(v6), arg7, arg8);
            assert!(0x2::balance::value<T0>(&v8) >= arg5 + arg6, 910);
            0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::repay_flash_swap<T0, T1, T2>(arg0, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v8, arg5), arg8), 0x2::coin::zero<T1>(arg8), v7, arg1);
            payout<T0>(v8, arg8);
            0x2::balance::value<T0>(&v8)
    ...
    public fun run_turbos_momentum_flash_flip<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg2: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T0>, arg3: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg4: bool, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : u64 {
        if (arg5 == 0) {
            return 0
        };
        let v0 = if (arg4) {
            let (v1, v2, v3) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::flash_swap<T0, T1, T2>(arg0, @0x0, false, (arg5 as u128), true, 79226673515401279992447579054, arg7, arg1, arg8);
            0x2::coin::destroy_zero<T1>(v2);
            let v4 = mmt_buy_x<T1, T0>(arg2, arg3, 0x2::coin::into_balance<T0>(v1), arg7, arg8);
            assert!(0x2::balance::value<T1>(&v4) >= arg5 + arg6, 910);
            0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::repay_flash_swap<T0, T1, T2>(arg0, 0x2::coin::zero<T0>(arg8), 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v4, arg5), arg8), v3, arg1);
            payout<T1>(v4, arg8);
            0x2::balance::value<T1>(&v4)
            ...
            let (v5, v6, v7) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::flash_swap<T0, T1, T2>(arg0, @0x0, true, (arg5 as u128), true, 4295048017, arg7, arg1, arg8);
            0x2::coin::destroy_zero<T0>(v5);
            let v8 = mmt_sell_x<T1, T0>(arg2, arg3, 0x2::coin::into_balance<T1>(v6), arg7, arg8);
            assert!(0x2::balance::value<T0>(&v8) >= arg5 + arg6, 910);
            0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::repay_flash_swap<T0, T1, T2>(arg0, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v8, arg5), arg8), 0x2::coin::zero<T1>(arg8), v7, arg1);
            payout<T0>(v8, arg8);
            0x2::balance::value<T0>(&v8)
