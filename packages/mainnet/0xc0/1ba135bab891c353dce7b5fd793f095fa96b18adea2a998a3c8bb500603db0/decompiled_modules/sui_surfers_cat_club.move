module 0xc01ba135bab891c353dce7b5fd793f095fa96b18adea2a998a3c8bb500603db0::sui_surfers_cat_club {
    struct SUI_SURFERS_CAT_CLUB has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_SURFERS_CAT_CLUB, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_SURFERS_CAT_CLUB>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sui Surfers Cat Club"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"SSCC"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeif4vfyccmp7wi7hhuyvmfddaeyl4ynlqcco7f5mlx4zc32gdxz52m"));
