module 0xc024179952471e2eb546be0cc6a6a2cdc1578502909ef0422e8b0a84a540b636::outbox_bridge {
    ...
    fun create_merkle_update_message_hash(arg0: u64, arg1: vector<u8>) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0xc024179952471e2eb546be0cc6a6a2cdc1578502909ef0422e8b0a84a540b636::utils::u64_to_be_bytes(arg0));
    ...
    fun create_outbox_proof_hash(arg0: vector<u8>, arg1: vector<u8>, arg2: u64) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v1, 0xc024179952471e2eb546be0cc6a6a2cdc1578502909ef0422e8b0a84a540b636::utils::u64_to_be_bytes(arg2));
    ...
    fun verify_receive_signature(arg0: vector<u8>, arg1: vector<u8>, arg2: u64, arg3: vector<vector<u8>>, arg4: vector<u8>, arg5: vector<u8>) {
        assert!(0xc024179952471e2eb546be0cc6a6a2cdc1578502909ef0422e8b0a84a540b636::merkle::verify_merkle_aggregation(arg2, arg4, arg3, arg1), 7);
        let (v0, _) = 0xc024179952471e2eb546be0cc6a6a2cdc1578502909ef0422e8b0a84a540b636::alt_bn128::hash_to_g1(arg0);
        assert!(0xc024179952471e2eb546be0cc6a6a2cdc1578502909ef0422e8b0a84a540b636::alt_bn128::verify(arg5, arg4, v0), 8);
    }
    ...
    fun verify_update_signature(arg0: u64, arg1: vector<u8>, arg2: u64, arg3: vector<vector<u8>>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>) {
        assert!(0xc024179952471e2eb546be0cc6a6a2cdc1578502909ef0422e8b0a84a540b636::merkle::verify_merkle_aggregation(arg2, arg4, arg3, arg6), 7);
        let (v0, _) = 0xc024179952471e2eb546be0cc6a6a2cdc1578502909ef0422e8b0a84a540b636::alt_bn128::hash_to_g1(create_merkle_update_message_hash(arg0, arg1));
        assert!(0xc024179952471e2eb546be0cc6a6a2cdc1578502909ef0422e8b0a84a540b636::alt_bn128::verify(arg5, arg4, v0), 8);
    }
