module 0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::timecapsule {
    ...
    public entry fun take_out_objects<T0: store + key>(arg0: &mut TimecapsuleStore, arg1: &mut Timecapsule, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        if (0x2::object_bag::contains<0x1::ascii::String>(&arg1.object_bag, v0)) {
            0x2::transfer::public_transfer<T0>(0x2::object_bag::remove<0x1::ascii::String, T0>(&mut arg1.object_bag, v0), 0x2::tx_context::sender(arg2));
            let v1 = 1;
            let v2 = true;
            let v3 = b"{str:s}_{suffix:i}";
            let v4 = b"";
            let v5 = b"str";
            let v6 = 0x1::ascii::into_bytes(v0);
            0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::metadata::set<vector<u8>>(&mut v4, 0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::metadata::key(&v5), &v6);
            while (v2) {
                let v7 = b"suffix";
                0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::metadata::set<u64>(&mut v4, 0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::metadata::key(&v7), &v1);
                let v8 = 0x1::ascii::string(0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::format::format(&v3, &v4));
                v1 = v1 + 1;
                if (0x2::object_bag::contains<0x1::ascii::String>(&arg1.object_bag, v8)) {
                    0x2::transfer::public_transfer<T0>(0x2::object_bag::remove<0x1::ascii::String, T0>(&mut arg1.object_bag, v8), 0x2::tx_context::sender(arg2));
                    v2 = true;
                    continue
                };
                v2 = false;
