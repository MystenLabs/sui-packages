module 0xc0e214052ab8750481699a31a8db7e64579cb3a82387443cad0458d8cc83983a::roko {
    ...
    fun init(arg0: ROKO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<ROKO>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"ROKO    ")))), trim_right(b"ROKO'S BASILISK                 "), trim_right(b"After an attempt on President Trump's life during his last speech, he told everyone to FIGHT, encouraging us to continue fighting to Make America Great Again                                                                                                                                                                   "), v2, arg1);
