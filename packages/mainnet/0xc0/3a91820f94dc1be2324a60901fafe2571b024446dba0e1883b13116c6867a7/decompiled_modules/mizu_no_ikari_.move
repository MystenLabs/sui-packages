module 0xc03a91820f94dc1be2324a60901fafe2571b024446dba0e1883b13116c6867a7::mizu_no_ikari_ {
    struct MIZU_NO_IKARI_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MIZU_NO_IKARI_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MIZU_NO_IKARI_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Mizu No Ikari "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Mizu no Ikari - a community of ocean lovers and NFT enthusiasts.  Collect unique art, connect with fellow collectors, and ride the wave of the future."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeihi4uop67dk5fcch2jemohr5yb52mtzojbaoy6lw5nks3fhfwa3n4"));
