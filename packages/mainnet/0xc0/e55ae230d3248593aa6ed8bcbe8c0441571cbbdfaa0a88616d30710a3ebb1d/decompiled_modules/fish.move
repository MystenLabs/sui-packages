module 0xc0e55ae230d3248593aa6ed8bcbe8c0441571cbbdfaa0a88616d30710a3ebb1d::fish {
    ...
    fun init(arg0: FISH, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FISH>(arg0, 0, b"FISH", b"FISH", b"FISH Token description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://fishui.xyz/wp-content/uploads/2023/05/11-1-1011x1024.jpg")), arg1);
        let v2 = v0;
