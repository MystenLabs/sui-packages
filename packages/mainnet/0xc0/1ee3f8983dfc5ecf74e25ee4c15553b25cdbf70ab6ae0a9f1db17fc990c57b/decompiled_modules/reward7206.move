module 0xc01ee3f8983dfc5ecf74e25ee4c15553b25cdbf70ab6ae0a9f1db17fc990c57b::reward7206 {
    struct REWARD7206 has drop {
        dummy_field: bool,
    }

    struct TICKET_7206 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7206(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7206>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7206>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7206, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7206>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7206>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7206>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7206>>(v5, 0x2::tx_context::sender(arg1));
    }
