module 0xc0e02990a533992e81af97958d3284dd7aa8faea0a2631514211fef9917c8a4e::req_helpers {
    ...
    public(friend) fun msgFromReqSigningMessage(arg0: vector<u8>) : vector<u8> {
        ...
        if (*v1 == 1) {
            ...
            0x1::vector::push_back<vector<u8>>(v5, 0xc0e02990a533992e81af97958d3284dd7aa8faea0a2631514211fef9917c8a4e::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v3) + 29 + 66));
            ...
            0x1::vector::push_back<vector<u8>>(v8, 0xc0e02990a533992e81af97958d3284dd7aa8faea0a2631514211fef9917c8a4e::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v6) + 31 + 66));
            ...
            0x1::vector::push_back<vector<u8>>(v11, 0xc0e02990a533992e81af97958d3284dd7aa8faea0a2631514211fef9917c8a4e::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v9) + 29 + 66));
