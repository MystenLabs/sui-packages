module 0xc0ef8c073299462521b5b7224dcb5aba16d042b51fd32faf9c7b875384c4a65e::genescience {
    public fun breed_genes(arg0: u256, arg1: u256, arg2: u256, arg3: u256) : u256 {
        0 | slice_number(arg0, 4, 0) | 0 << 4 | mix_appearance_traits(arg0, arg1, arg2) | mix_power_traits(arg0, arg1, arg3)
    }
    ...
    public fun evolve_genes(arg0: u256, arg1: vector<u256>) : u256 {
        let v0 = (0xc0ef8c073299462521b5b7224dcb5aba16d042b51fd32faf9c7b875384c4a65e::math::min_u64((((slice_number(arg0, 3, 4) as u8) + 1) as u64), ((8 - 1) as u64)) as u8);
    ...
    public fun generate_genesis_genes(arg0: vector<u8>, arg1: u8) : u256 {
        assert!(arg1 <= 15, 0);
        let v0 = 0x2::hash::blake2b256(&arg0);
        let v1 = 0;
        let v2 = 0;
        while (v2 < 32) {
            v1 = v1 | (*0x1::vector::borrow<u8>(&v0, v2) as u256) << (v2 as u8) * 8;
            v2 = v2 + 1;
        };
        (v1 & 115792089237316195423570985008687907853269984665640564039457584007913129639920 | (arg1 as u256)) & 115792089237316195423570985008687907853269984665640564039457584007913129639695
    }

    public fun generate_genesis_genes_with_tier(arg0: vector<u8>, arg1: u64) : u256 {
        let v0 = 0x2::hash::blake2b256(&arg0);
        let v1 = 0;
        let v2 = if (arg1 >= 2) {
            arg1 - 2
        ...
        let v3 = 0;
        while (v3 < 28) {
            v1 = v1 | (0xc0ef8c073299462521b5b7224dcb5aba16d042b51fd32faf9c7b875384c4a65e::math::min_u64(v2 + (*0x1::vector::borrow<u8>(&v0, v3 * 3 % 32) as u64) % (3 + arg1 - v2 + 1), 31) as u256) << 4 + 3 + (v3 as u8) * 5;
            v3 = v3 + 1;
        };
        let v4 = if (arg1 >= 1) {
            arg1 - 1
        ...
        v3 = 0;
        while (v3 < 21) {
            v1 = v1 | (0xc0ef8c073299462521b5b7224dcb5aba16d042b51fd32faf9c7b875384c4a65e::math::min_u64(v4 + (*0x1::vector::borrow<u8>(&v0, (28 + v3) * 3 % 32) as u64) % (2 + arg1 - v4 + 1), 15) as u256) << 147 + (v3 as u8) * 4;
            v3 = v3 + 1;
        };
        v1
    }
