module 0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::chakra_nft {
    ...
    public fun admin_overwrite_referral(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: u64, arg2: u64, arg3: &mut GlobalConfig, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun admin_set_base_price(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.base_price = arg1;
    }

    public fun admin_set_boost_a(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_a = arg1;
    }

    public fun admin_set_boost_b(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_b = arg1;
    }

    public fun admin_set_boost_c(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_c = arg1;
    }

    public fun admin_set_boost_d(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_d = arg1;
    }

    public fun admin_set_boost_e(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_e = arg1;
    }

    public fun admin_set_boost_f(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_f = arg1;
    }

    public fun admin_set_display_url(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: &mut 0x2::display::Display<ChakraNFT>, arg2: 0x1::string::String, arg3: &0x2::tx_context::TxContext) {
        0x2::display::edit<ChakraNFT>(arg1, 0x1::string::utf8(b"image_url"), arg2);
        0x2::display::update_version<ChakraNFT>(arg1);
    }

    public fun admin_set_referral_price(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.referral_price = arg1;
    }

    public fun admin_set_refferal_limit_per_acc(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.max_codes_per_acc = arg1;
    }

    public fun admin_set_refferal_limit_per_whale(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.max_codes_per_whale = arg1;
    }

    public fun admin_set_status(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: bool, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.status = arg1;
    }
    ...
    public fun batch_update_a(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun batch_update_b(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        while (!0x1::vector::is_empty<address>(&arg2)) {
            let v0 = 0x1::vector::pop_back<address>(&mut arg2);
    ...
    public fun batch_update_c(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        while (!0x1::vector::is_empty<address>(&arg2)) {
            let v0 = 0x1::vector::pop_back<address>(&mut arg2);
    ...
    public fun batch_update_d(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        while (!0x1::vector::is_empty<address>(&arg2)) {
            let v0 = 0x1::vector::pop_back<address>(&mut arg2);
    ...
    public fun batch_update_e(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        while (!0x1::vector::is_empty<address>(&arg2)) {
            let v0 = 0x1::vector::pop_back<address>(&mut arg2);
    ...
    public fun batch_update_f(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        while (!0x1::vector::is_empty<address>(&arg2)) {
            let v0 = 0x1::vector::pop_back<address>(&mut arg2);
    ...
    public fun batch_update_free_wl(arg0: &0xc08bd02cddb748592c939f07178766a409480dad755c090d3bbd581e8831768f::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        while (!0x1::vector::is_empty<address>(&arg2)) {
            let v0 = 0x1::vector::pop_back<address>(&mut arg2);
