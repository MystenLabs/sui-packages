module 0xc02d591e6cdbad570ce7c039983bb914004e2c9209be0a9dc3caf86bee60b925::validator_pool {
    struct ValidatorPool has store {
        ...
        total_weight: u64,
        manage: 0xc02d591e6cdbad570ce7c039983bb914004e2c9209be0a9dc3caf86bee60b925::manage::Manage,
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : ValidatorPool {
        ValidatorPool{
            ...
            total_weight       : 0,
            manage             : 0xc02d591e6cdbad570ce7c039983bb914004e2c9209be0a9dc3caf86bee60b925::manage::new(),
    ...
    public(friend) fun refresh(arg0: &mut ValidatorPool, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) : bool {
        0xc02d591e6cdbad570ce7c039983bb914004e2c9209be0a9dc3caf86bee60b925::manage::check_version(&arg0.manage);
