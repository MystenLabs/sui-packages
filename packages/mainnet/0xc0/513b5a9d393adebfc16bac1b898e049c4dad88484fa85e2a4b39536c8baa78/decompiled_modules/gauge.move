module 0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::gauge {
    struct Gauge has store, key {
        id: 0x2::object::UID,
        config: 0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::gauge_config::GaugeConfig,
    ...
    public(friend) fun add_vote_max_bond(arg0: &mut Gauge, arg1: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::VotePowerConfig, arg2: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::epoch::EpochConfig, arg3: u64) {
    ...
    public(friend) fun add_vote_unlock_at(arg0: &mut Gauge, arg1: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::VotePowerConfig, arg2: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::epoch::EpochConfig, arg3: u64, arg4: u64) {
        arg0.total_vote_power = arg0.total_vote_power + 0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::vote_power_for_epoch_id(arg1, arg2, arg3, arg0.current_epoch_id, arg4);
        add_vote_power_unlocks(arg0, arg3, arg4);
    }

    public(friend) fun advance_epoch(arg0: &mut Gauge, arg1: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::VotePowerConfig, arg2: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::epoch::EpochConfig, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun assert_not_paused(arg0: &Gauge) {
        assert!(0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::gauge_config::is_paused(&arg0.config) == false, 7);
    }

    fun calculate_total_vote_power_at_epoch_id(arg0: &Gauge, arg1: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::VotePowerConfig, arg2: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::epoch::EpochConfig, arg3: u64) : u64 {
        let v0 = 0;
        let v1 = 0;
        while (v0 < 0x2::vec_map::size<u64, u64>(&arg0.vote_power_unlocks)) {
            ...
            let v5 = if (v4 == 18446744073709551615) {
                0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::vote_power_for_max_bond(arg1, *v3)
            } else {
                0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::vote_power_for_epoch_id(arg1, arg2, *v3, arg3, v4)
            };
            v1 = v1 + v5;
            v0 = v0 + 1;
        };
    ...
    fun check_fee_types<T0, T1>(arg0: &Gauge) {
        let (v0, v1) = 0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::gauge_config::coin_xy(&arg0.config);
    ...
    public fun coin_xy(arg0: &Gauge) : (0x1::type_name::TypeName, 0x1::type_name::TypeName) {
        0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::gauge_config::coin_xy(&arg0.config)
    }

    public(friend) fun create<T0, T1>(arg0: address, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Gauge {
        Gauge{
            id                    : 0x2::object::new(arg2),
            config                : 0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::gauge_config::create<T0, T1>(arg0, arg2),
    ...
    public fun paused(arg0: &Gauge) : bool {
        0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::gauge_config::is_paused(&arg0.config)
    }

    public(friend) fun pending_fees_max_bond(arg0: &Gauge, arg1: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::VotePowerConfig, arg2: u64, arg3: u64, arg4: u64) : (u64, u64) {
        check_finished_epoch_range(arg0, arg3, arg4);
        let v0 = 0;
        let v1 = 0;
        let v2 = 0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::vote_power_for_max_bond(arg1, arg2);
        while (arg3 <= arg4) {
            let v3 = 0x2::vec_map::get<u64, GaugeEpochState>(&arg0.epoch_history, &arg3);
            v0 = v0 + 0x731710adc6979ec0acfa6e969b3ce4740e961854c5c851d132abb0b2831c4d28::full_math_u64::mul_div_floor(v3.fee_x_amount, v2, v3.total_vote_power);
            v1 = v1 + 0x731710adc6979ec0acfa6e969b3ce4740e961854c5c851d132abb0b2831c4d28::full_math_u64::mul_div_floor(v3.fee_y_amount, v2, v3.total_vote_power);
            arg3 = arg3 + 1;
        };
        (v0, v1)
    }

    public(friend) fun pending_fees_normal(arg0: &Gauge, arg1: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::VotePowerConfig, arg2: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::epoch::EpochConfig, arg3: u64, arg4: u64, arg5: u64, arg6: u64) : (u64, u64) {
        check_finished_epoch_range(arg0, arg5, arg6);
        let v0 = 0;
        let v1 = 0;
        while (arg5 <= arg6) {
            let v2 = 0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::vote_power_for_epoch_id(arg1, arg2, arg3, arg5, arg4);
            if (v2 == 0) {
                break
            };
    ...
    public(friend) fun pending_incentive_max_bond<T0>(arg0: &Gauge, arg1: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::VotePowerConfig, arg2: u64, arg3: u64, arg4: u64) : u64 {
        let v0 = 0x1::type_name::get<T0>();
        check_finished_epoch_range(arg0, arg3, arg4);
        ...
        while (arg3 <= arg4) {
            ...
            v1 = v1 + 0x731710adc6979ec0acfa6e969b3ce4740e961854c5c851d132abb0b2831c4d28::full_math_u64::mul_div_floor(*0x2::vec_map::get<0x1::type_name::TypeName, u64>(&arg0.incentive_amount, &v0), 0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::vote_power_for_max_bond(arg1, arg2), v2.total_vote_power);
            arg3 = arg3 + 1;
        };
        v1
    }

    public(friend) fun pending_incentive_unlock_at<T0>(arg0: &Gauge, arg1: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::VotePowerConfig, arg2: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::epoch::EpochConfig, arg3: u64, arg4: u64, arg5: u64, arg6: u64) : u64 {
        let v0 = 0x1::type_name::get<T0>();
        check_finished_epoch_range(arg0, arg5, arg6);
        check_incentive_available(arg0, v0);
        let v1 = 0;
        while (arg5 <= arg6) {
            ...
            v1 = v1 + 0x731710adc6979ec0acfa6e969b3ce4740e961854c5c851d132abb0b2831c4d28::full_math_u64::mul_div_floor(*0x2::vec_map::get<0x1::type_name::TypeName, u64>(&arg0.incentive_amount, &v0), v2, v3.total_vote_power);
            arg5 = arg5 + 1;
        };
        v1
    }
    ...
    public fun pool_id(arg0: &Gauge) : address {
        0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::gauge_config::pool_id(&arg0.config)
    }
    ...
    public(friend) fun remove_vote_max_bound(arg0: &mut Gauge, arg1: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::VotePowerConfig, arg2: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::epoch::EpochConfig, arg3: u64) {
    ...
    public(friend) fun remove_vote_unlock_at(arg0: &mut Gauge, arg1: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::VotePowerConfig, arg2: &0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::epoch::EpochConfig, arg3: u64, arg4: u64) {
        let v0 = 0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::vote_power::vote_power_for_epoch_id(arg1, arg2, arg3, arg0.current_epoch_id, arg4);
    ...
    public(friend) fun set_paused(arg0: &mut Gauge, arg1: bool) {
        0xc0513b5a9d393adebfc16bac1b898e049c4dad88484fa85e2a4b39536c8baa78::gauge_config::set_paused(&mut arg0.config, arg1);
    }
