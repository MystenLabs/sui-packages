module 0xc06e61fa92a4cf89151c4bf1be7db533419f6b14a1c4a155a6b700d0fc9524e7::coin_decimals_registry {
    ...
    public fun register_decimals<T0>(arg0: &mut CoinDecimalsRegistry, arg1: &0x2::coin::CoinMetadata<T0>) {
    ...
    public fun register_from_currency<T0>(arg0: &mut CoinDecimalsRegistry, arg1: &0x2::coin_registry::Currency<T0>) {
        let v0 = 0x1::type_name::get<T0>();
        if (0x2::table::contains<0x1::type_name::TypeName, u8>(&arg0.table, v0)) {
            return
        };
        let v1 = 0x2::coin_registry::decimals<T0>(arg1);
        0x2::table::add<0x1::type_name::TypeName, u8>(&mut arg0.table, v0, v1);
        let v2 = 0x2::object::id<CoinDecimalsRegistry>(arg0);
        let v3 = CoinDecimalsRegistered{
            registry  : 0x2::object::id_to_address(&v2),
