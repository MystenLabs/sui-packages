module 0xc047e9e75ed7920e4b2efa72e7bf64c796eb4c4d05f32cc53248865e50889fe7::cnsnft5035 {
    struct CNSNFT5035 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5035, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5035>(arg0, arg1);
