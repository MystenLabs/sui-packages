module 0xc055a9fa2285fb3ccad3307971917a384b287f58695d1121fdeb45a5f897e3c9::reward5811 {
    struct REWARD5811 has drop {
        dummy_field: bool,
    }

    struct TICKET_5811 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5811(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5811>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5811>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5811, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5811>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5811>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5811>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5811>>(v5, 0x2::tx_context::sender(arg1));
    }
