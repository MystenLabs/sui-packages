module 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::vault {
    ...
    public(friend) fun deposit<T0>(arg0: &mut Vaults, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::utils::get_full_type<T0>();
    ...
    public(friend) fun withdraw<T0>(arg0: &mut Vaults, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::pay::split_and_transfer<T0>(0x2::dynamic_object_field::borrow_mut<0x1::string::String, 0x2::coin::Coin<T0>>(&mut arg0.id, 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::utils::get_full_type<T0>()), arg1, arg2, arg3);
        let v0 = OutVault{
            vault_id : 0x2::object::uid_to_inner(&arg0.id),
            amount   : arg1,
