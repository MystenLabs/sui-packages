module 0xc0760447cf4a159478069db1ae5b7cafcbc0d957d803a0d0761c97797e0ab5e0::babybonk {
    ...
    fun init(arg0: BABYBONK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/Cf1ZjYZi5UPbAyC7LhLkJYvebxrwam4AWVacymaBbonk.png?size=lg&key=1cfc1c                                                                                                                                                                                                            ");
