module 0xc0bfc90b3a663357d63878cef0ec80b623624eb0127300f3accda005cf155a73::drand_based_roulette {
    ...
    public fun claim_rebate<T0>(arg0: &mut HouseData<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2, v3) = 0xc0bfc90b3a663357d63878cef0ec80b623624eb0127300f3accda005cf155a73::rebate_manager::claim_rebate(&mut arg0.rebate_manager, v0);
        let v4 = v2;
        if (v1 > 0) {
    ...
    public entry fun complete<T0>(arg0: 0x2::object::ID, arg1: &HouseCap, arg2: &mut HouseData<T0>, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0.status != 0xc0bfc90b3a663357d63878cef0ec80b623624eb0127300f3accda005cf155a73::game_status::completed(), 1);
        assert!(account_owner(arg1) == 0x2::tx_context::sender(arg7), 4);
        ...
        while (v4 < v6) {
            ...
            let v11 = v10.player;
            let v12 = 0x2::balance::value<T0>(&v10.bet_size);
            if (v10.is_settled) {
                v4 = v4 + 1;
                continue
            };
            let v13 = 0xc0bfc90b3a663357d63878cef0ec80b623624eb0127300f3accda005cf155a73::bet_manager::get_bet_payout(v12, v10.bet_type);
            let v14 = 0xc0bfc90b3a663357d63878cef0ec80b623624eb0127300f3accda005cf155a73::bet_manager::won_bet(v10.bet_type, v2, v10.bet_number);
            0x1::vector::push_back<0xc0bfc90b3a663357d63878cef0ec80b623624eb0127300f3accda005cf155a73::events::BetResult<T0>>(&mut v8, 0xc0bfc90b3a663357d63878cef0ec80b623624eb0127300f3accda005cf155a73::events::new_bet_result<T0>(*0x2::object::uid_as_inner(&v10.id), v14, v10.bet_type, v10.bet_number, v12, v10.player));
            let v15 = 0x2::coin::take<T0>(&mut v10.bet_size, v12, arg7);
            v10.is_settled = true;
            let v16 = &mut v9.player_bets_table;
            if (0x2::table::contains<address, vector<BetDisplay<T0>>>(v16, v11)) {
                0x2::table::remove<address, vector<BetDisplay<T0>>>(v16, v11);
            };
            v9.settled_bets_count = v9.settled_bets_count + 1;
            if (v14) {
                0x2::coin::join<T0>(&mut v15, 0x2::coin::take<T0>(&mut arg2.balance, v13, arg7));
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v15, v11);
            } else {
    ...
    public entry fun place_bet<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u8, arg2: 0x1::option::Option<u64>, arg3: 0x2::object::ID, arg4: &mut HouseData<T0>, arg5: 0x1::option::Option<0x1::string::String>, arg6: 0x1::option::Option<0x2::object::ID>, arg7: 0x1::option::Option<0x1::string::String>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0xc0bfc90b3a663357d63878cef0ec80b623624eb0127300f3accda005cf155a73::rebate_manager::add_volume(&mut arg4.rebate_manager, v6, v0);
    }
    ...
    public fun set_referrer<T0>(arg0: &mut HouseData<T0>, arg1: address, arg2: &0x2::tx_context::TxContext) {
        0xc0bfc90b3a663357d63878cef0ec80b623624eb0127300f3accda005cf155a73::rebate_manager::register(&mut arg0.rebate_manager, 0x2::tx_context::sender(arg2), 0x1::option::some<address>(arg1));
    }
