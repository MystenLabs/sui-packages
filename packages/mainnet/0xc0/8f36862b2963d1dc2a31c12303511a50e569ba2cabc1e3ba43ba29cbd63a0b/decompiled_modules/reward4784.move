module 0xc08f36862b2963d1dc2a31c12303511a50e569ba2cabc1e3ba43ba29cbd63a0b::reward4784 {
    struct REWARD4784 has drop {
        dummy_field: bool,
    }

    struct TICKET_4784 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4784(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4784>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4784>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4784, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4784>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4784>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4784>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4784>>(v5, 0x2::tx_context::sender(arg1));
    }
