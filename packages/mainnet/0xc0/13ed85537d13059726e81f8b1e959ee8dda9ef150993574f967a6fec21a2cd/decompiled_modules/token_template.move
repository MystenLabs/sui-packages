module 0xc013ed85537d13059726e81f8b1e959ee8dda9ef150993574f967a6fec21a2cd::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"FIN096038", b"FixedInit 096038", b"Fixed with initial supply verification", 0x1::option::none<0x2::url::Url>(), arg1);
