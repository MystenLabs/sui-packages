module 0xc033f6ebf0371704d4f32200dbdf5b72477a18e76a97672b0b80af447c861c61::sale {
    ...
    struct UpgradeConfig<phantom T0> has store, key {
        id: 0x2::object::UID,
        owner: address,
        admin_public_key: vector<u8>,
    ...
    struct BuyLandEvent has copy, drop {
        buyer: address,
        amount: u64,
        price: u64,
    ...
    struct BuyMinerEvent has copy, drop {
        buyer: address,
        amount: u64,
        price: u64,
        type_name: 0x1::type_name::TypeName,
    ...
    struct UpgradeRequestEvent has copy, drop {
        ...
        amount_sent: u64,
        source_sale_id: u64,
        destination_sale_id: u64,
        sale_type: u8,
        first_ingredient_id: u64,
        second_ingredient_id: u64,
    }
    ...
    public entry fun buy_land<T0>(arg0: &SaleConfigLand<T0>, arg1: u64, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<BuyLandEvent>(v4);
    }
    ...
    public entry fun buy_miner<T0>(arg0: &SaleConfigMiner<T0>, arg1: &mut GlobalConfig<T0>, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<BuyMinerEvent>(v4);
    }

    public entry fun create_forge_request<T0>(arg0: &mut UpgradeConfig<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: u8, arg5: u64, arg6: u64, arg7: vector<u8>, arg8: vector<u8>, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(!0x2::table::contains<vector<u8>, bool>(&arg0.signatures, arg8), 8);
        assert!(0x2::bls12381::bls12381_min_pk_verify(&arg8, &arg0.admin_public_key, &arg7) == true, 4);
        0x2::table::add<vector<u8>, bool>(&mut arg0.signatures, arg8, true);
        let v0 = 0x2::coin::into_balance<T0>(arg1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg9), arg0.owner);
        let v1 = UpgradeRequestEvent{
            request_id           : 0x1::string::utf8(arg7),
            sender               : 0x2::tx_context::sender(arg9),
            amount_sent          : 0x2::balance::value<T0>(&v0),
            source_sale_id       : arg2,
            destination_sale_id  : arg3,
            sale_type            : arg4,
            first_ingredient_id  : arg5,
            second_ingredient_id : arg6,
        };
        0x2::event::emit<UpgradeRequestEvent>(v1);
    }
    ...
    public entry fun initialize_upgrade_config<T0>(arg0: &AdminCapability, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = UpgradeConfig<T0>{
            id               : 0x2::object::new(arg2),
            owner            : 0x2::tx_context::sender(arg2),
            admin_public_key : arg1,
            signatures       : 0x2::table::new<vector<u8>, bool>(arg2),
        };
        0x2::transfer::share_object<UpgradeConfig<T0>>(v0);
    }
