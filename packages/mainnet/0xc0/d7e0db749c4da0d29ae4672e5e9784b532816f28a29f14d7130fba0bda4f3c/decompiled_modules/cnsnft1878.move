module 0xc0d7e0db749c4da0d29ae4672e5e9784b532816f28a29f14d7130fba0bda4f3c::cnsnft1878 {
    struct CNSNFT1878 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1878, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1878>(arg0, arg1);
