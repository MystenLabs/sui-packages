module 0xc0f850000f3441c7b28a908b3424e01937718d8475d68b76365b4c2cff620b3f::reward7589 {
    struct REWARD7589 has drop {
        dummy_field: bool,
    }

    struct TICKET_7589 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7589(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7589>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7589>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7589, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7589>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7589>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7589>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7589>>(v5, 0x2::tx_context::sender(arg1));
    }
