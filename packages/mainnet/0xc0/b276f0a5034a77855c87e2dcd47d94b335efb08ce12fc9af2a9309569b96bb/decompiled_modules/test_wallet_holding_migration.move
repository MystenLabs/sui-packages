module 0xc0b276f0a5034a77855c87e2dcd47d94b335efb08ce12fc9af2a9309569b96bb::test_wallet_holding_migration {
    ...
    public entry fun migrate_users_data(arg0: &MaintainerRole, arg1: &mut HydroLocker, arg2: vector<0x1::string::String>, arg3: vector<u64>, arg4: vector<0x1::string::String>, arg5: vector<address>, arg6: &UpgradeVersion, arg7: 0x1::option::Option<u64>, arg8: &PauseUnpauseContract, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 != 0, 11);
        assert!(v1 == v2, 3);
        let v3 = set_total_supply_amount(arg1, arg7);
