module 0xc03a8903d5bd6e6b07603f6f837ff92c089bb1d8cc7b6bee44cca32efc0d1d3e::upgrades {
    ...
    public fun commit_upgrade<T0>(arg0: &mut UpgradeCap, arg1: &mut 0xc03a8903d5bd6e6b07603f6f837ff92c089bb1d8cc7b6bee44cca32efc0d1d3e::state::State<T0>, arg2: 0x2::package::UpgradeReceipt) {
        0xc03a8903d5bd6e6b07603f6f837ff92c089bb1d8cc7b6bee44cca32efc0d1d3e::state::set_version<T0>(arg1, 0);
        0x2::package::commit_upgrade(&mut arg0.cap, arg2);
    }

    public fun check_version<T0>(arg0: VersionGated, arg1: &0xc03a8903d5bd6e6b07603f6f837ff92c089bb1d8cc7b6bee44cca32efc0d1d3e::state::State<T0>) {
        let VersionGated {  } = arg0;
        if (0xc03a8903d5bd6e6b07603f6f837ff92c089bb1d8cc7b6bee44cca32efc0d1d3e::state::get_version<T0>(arg1) != 0) {
