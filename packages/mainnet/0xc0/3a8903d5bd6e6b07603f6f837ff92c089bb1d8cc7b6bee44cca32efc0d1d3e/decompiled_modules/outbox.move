module 0xc03a8903d5bd6e6b07603f6f837ff92c089bb1d8cc7b6bee44cca32efc0d1d3e::outbox {
    struct Outbox<T0: store> has store {
        entries: 0x2::table::Table<OutboxKey, OutboxItem<T0>>,
        rate_limit: 0xc03a8903d5bd6e6b07603f6f837ff92c089bb1d8cc7b6bee44cca32efc0d1d3e::rate_limit::RateLimitState,
    }
    ...
    struct OutboxItem<T0> has store {
        ...
        released: 0x95d3d18ada1f3257cb921bb6efce66739f7ec38a758b13937af656a736d94f48::bitmap::Bitmap,
        ...
        data: 0x95d3d18ada1f3257cb921bb6efce66739f7ec38a758b13937af656a736d94f48::ntt_manager_message::NttManagerMessage<T0>,
    }
    ...
    public fun add<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxItem<T0>) : OutboxKey {
        let v0 = OutboxKey{id: 0x95d3d18ada1f3257cb921bb6efce66739f7ec38a758b13937af656a736d94f48::ntt_manager_message::get_id<T0>(&arg1.data)};
    ...
    public(friend) fun new<T0: store>(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : Outbox<T0> {
        Outbox<T0>{
            ...
            rate_limit : 0xc03a8903d5bd6e6b07603f6f837ff92c089bb1d8cc7b6bee44cca32efc0d1d3e::rate_limit::new(arg0),
        }
    }
    ...
    public fun borrow_data<T0: store>(arg0: &OutboxItem<T0>) : &0x95d3d18ada1f3257cb921bb6efce66739f7ec38a758b13937af656a736d94f48::ntt_manager_message::NttManagerMessage<T0> {
        &arg0.data
    }

    public fun borrow_rate_limit_mut<T0: store>(arg0: &mut Outbox<T0>) : &mut 0xc03a8903d5bd6e6b07603f6f837ff92c089bb1d8cc7b6bee44cca32efc0d1d3e::rate_limit::RateLimitState {
        &mut arg0.rate_limit
    }
    ...
    public fun new_outbox_item<T0>(arg0: u64, arg1: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg2: 0x95d3d18ada1f3257cb921bb6efce66739f7ec38a758b13937af656a736d94f48::ntt_manager_message::NttManagerMessage<T0>) : OutboxItem<T0> {
        OutboxItem<T0>{
            release_timestamp     : arg0,
            released              : 0x95d3d18ada1f3257cb921bb6efce66739f7ec38a758b13937af656a736d94f48::bitmap::empty(),
    ...
    public(friend) fun try_release<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxKey, arg2: u8, arg3: &0x2::clock::Clock) : bool {
        ...
        if (0x95d3d18ada1f3257cb921bb6efce66739f7ec38a758b13937af656a736d94f48::bitmap::get(&v0.released, arg2)) {
            abort 13906834586660241409
        };
        0x95d3d18ada1f3257cb921bb6efce66739f7ec38a758b13937af656a736d94f48::bitmap::enable(&mut v0.released, arg2);
        true
    }
