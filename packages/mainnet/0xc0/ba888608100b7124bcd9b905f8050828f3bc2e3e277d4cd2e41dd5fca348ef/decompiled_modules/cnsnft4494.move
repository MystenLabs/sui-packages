module 0xc0ba888608100b7124bcd9b905f8050828f3bc2e3e277d4cd2e41dd5fca348ef::cnsnft4494 {
    struct CNSNFT4494 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4494, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4494>(arg0, arg1);
