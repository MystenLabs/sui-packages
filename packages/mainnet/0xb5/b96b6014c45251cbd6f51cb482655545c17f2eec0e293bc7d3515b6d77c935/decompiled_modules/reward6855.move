module 0xb5b96b6014c45251cbd6f51cb482655545c17f2eec0e293bc7d3515b6d77c935::reward6855 {
    struct REWARD6855 has drop {
        dummy_field: bool,
    }

    struct TICKET_6855 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6855(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6855>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6855>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6855, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6855>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6855>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6855>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6855>>(v5, 0x2::tx_context::sender(arg1));
    }
