module 0xb51cc232972f8ca2775a84285e5d0183f0504b2efd9002f753b28a9027bf8f93::reward2413 {
    struct REWARD2413 has drop {
        dummy_field: bool,
    }

    struct TICKET_2413 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2413(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2413>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2413>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2413, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2413>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2413>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2413>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2413>>(v5, 0x2::tx_context::sender(arg1));
    }
