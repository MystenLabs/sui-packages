module 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::constants {
    ...
    public fun position_display_description() : vector<u8> {
        b"This object represents your LP position in a SuiDex V3 CLMM Pool. Do not burn this object since this is the only way you can redeem your funds from the liquidity pool and claim rewards emissions."
    }

    public fun position_display_image_url() : vector<u8> {
        b"https://suitrump.com/logocircle.png"
    }

    public fun position_display_name() : vector<u8> {
        b"SuiDex V3 LP Position"
    }
