module 0xb53b92f5d6df62755b79cfde1fef3161cc7e2b91a5743eb5a3471a3e79ecc964::game9860 {
    struct GAME9860 has drop {
        dummy_field: bool,
    }

    struct TICKET_9860 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9860(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9860>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9860>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME9860, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME9860>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9860>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9860>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9860>>(v5, 0x2::tx_context::sender(arg1));
    }
