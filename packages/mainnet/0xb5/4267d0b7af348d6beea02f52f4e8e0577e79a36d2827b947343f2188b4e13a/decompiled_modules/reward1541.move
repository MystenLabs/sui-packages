module 0xb54267d0b7af348d6beea02f52f4e8e0577e79a36d2827b947343f2188b4e13a::reward1541 {
    struct REWARD1541 has drop {
        dummy_field: bool,
    }

    struct TICKET_1541 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1541(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1541>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1541>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1541, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1541>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1541>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1541>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1541>>(v5, 0x2::tx_context::sender(arg1));
    }
