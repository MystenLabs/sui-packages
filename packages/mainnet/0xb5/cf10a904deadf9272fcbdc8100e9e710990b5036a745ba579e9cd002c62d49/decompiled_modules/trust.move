module 0xb5cf10a904deadf9272fcbdc8100e9e710990b5036a745ba579e9cd002c62d49::trust {
    ...
    public entry fun assign_main(arg0: &Trust, arg1: &SettlorCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        is_settlor_cap_correct(arg0, arg1);
        let v0 = MainTrusteeCap{
            id       : 0x2::object::new(arg3),
            trust_id : 0x2::object::id<Trust>(arg0),
        };
        0x2::transfer::transfer<MainTrusteeCap>(v0, arg2);
    }
    ...
    public fun is_main_trustee_cap_correct(arg0: &Trust, arg1: &MainTrusteeCap) {
    ...
    public(friend) fun main_borrow<T0: copy + drop + store, T1: store>(arg0: &mut Trust, arg1: &MainTrusteeCap, arg2: T0) : 0x1::option::Option<T1> {
        is_main_trustee_cap_correct(arg0, arg1);
        0x2::dynamic_field::remove_if_exists<T0, T1>(&mut arg0.id, arg2)
    }

    public fun main_repay<T0: copy + drop + store, T1: store>(arg0: &mut Trust, arg1: &MainTrusteeCap, arg2: T0, arg3: T1) {
        is_main_trustee_cap_correct(arg0, arg1);
        0x2::dynamic_field::add<T0, T1>(&mut arg0.id, arg2, arg3);
    }

    public entry fun main_resign(arg0: MainTrusteeCap) {
        let MainTrusteeCap {
            id       : v0,
            trust_id : _,
        } = arg0;
