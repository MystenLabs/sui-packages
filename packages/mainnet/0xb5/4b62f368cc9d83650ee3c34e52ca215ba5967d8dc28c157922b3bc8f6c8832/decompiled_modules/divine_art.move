module 0xb54b62f368cc9d83650ee3c34e52ca215ba5967d8dc28c157922b3bc8f6c8832::divine_art {
    ...
    fun init(arg0: DIVINE_ART, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"Divine Art test 2"));
        0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"https://clutchy.app"));
