module 0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::pyth_oracle {
    ...
    public fun add_feed_objects<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator) {
        ...
        let v4 = object_address<0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator>(arg3);
        let v5 = 1;
        let v6 = 2;
        if (0x2::vec_map::contains<u8, address>(&v2.objects, &v5)) {
            *0x2::vec_map::get_mut<u8, address>(&mut v2.objects, &v5) = v3;
        } else {
            0x2::vec_map::insert<u8, address>(&mut v2.objects, v5, v3);
        };
        if (0x2::vec_map::contains<u8, address>(&v2.objects, &v6)) {
            *0x2::vec_map::get_mut<u8, address>(&mut v2.objects, &v6) = v4;
        } else {
            0x2::vec_map::insert<u8, address>(&mut v2.objects, v6, v4);
        };
        let v7 = 0x1::vector::empty<u8>();
        let v8 = &mut v7;
        0x1::vector::push_back<u8>(v8, 1);
        0x1::vector::push_back<u8>(v8, 2);
        let v9 = 0x1::vector::empty<address>();
        let v10 = &mut v9;
        0x1::vector::push_back<address>(v10, v3);
        0x1::vector::push_back<address>(v10, v4);
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_events::emit_feed_objects_set(v0, v7, v9);
    }
    ...
    public fun add_feeder(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: address) {
        ...
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_events::emit_feeder_updated(arg2, true);
    }
    ...
    public fun add_market<T0, T1>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: 0x1::string::String, arg3: u64, arg4: u64) : u64 {
        ...
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_events::emit_agg_oracle_market_added(v2, arg2, v0, v1);
        v2
    }

    fun aggregate_price_wad(arg0: u128, arg1: u128) : u128 {
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_math::mul_div_down(arg0, 1000000000000000000, arg1)
    }
    ...
    fun assert_feeder(arg0: &Oracle, arg1: &0x2::tx_context::TxContext) {
        assert!(is_feeder(arg0, 0x2::tx_context::sender(arg1)), 6);
    }
    ...
    fun assert_update_auth<T0: key>(arg0: &Oracle, arg1: 0x1::type_name::TypeName, arg2: u8, arg3: &T0, arg4: &0x2::tx_context::TxContext) {
        if (arg2 == 3) {
            assert_feeder(arg0, arg4);
        } else {
            assert_feed_object_allowed<T0>(arg0, arg1, arg2, arg3);
        };
    }
    ...
    fun default_weights() : 0x2::vec_map::VecMap<u8, u64> {
        ...
        0x2::vec_map::insert<u8, u64>(&mut v0, 1, (0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_math::mul_div_down((10000 as u128), 50, 100) as u64));
        0x2::vec_map::insert<u8, u64>(&mut v0, 2, (0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_math::mul_div_down((10000 as u128), 30, 100) as u64));
        0x2::vec_map::insert<u8, u64>(&mut v0, 3, (0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_math::mul_div_down((10000 as u128), 20, 100) as u64));
        v0
    }
    ...
    public fun del_feeder(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: address) {
        ...
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_events::emit_feeder_updated(arg2, false);
    }
    ...
    fun get_feed_object_addr(arg0: &Oracle, arg1: 0x1::type_name::TypeName, arg2: u8) : address {
        if (!0x2::table::contains<0x1::type_name::TypeName, FeedObjectsInfo>(&arg0.feed_objects, arg1)) {
            return @0x0
        };
        let v0 = &0x2::table::borrow<0x1::type_name::TypeName, FeedObjectsInfo>(&arg0.feed_objects, arg1).objects;
        if (!0x2::vec_map::contains<u8, address>(v0, &arg2)) {
            return @0x0
        };
        *0x2::vec_map::get<u8, address>(v0, &arg2)
    }
    ...
    public fun get_feed_object_addresses(arg0: &Oracle, arg1: 0x1::type_name::TypeName) : (address, address) {
        ...
        let v1 = 1;
        let v2 = 2;
        (*0x2::vec_map::get<u8, address>(&v0.objects, &v1), *0x2::vec_map::get<u8, address>(&v0.objects, &v2))
    }
    ...
    public fun get_oracle_info(arg0: &Oracle, arg1: u64) : AggOracleInfo {
        ...
        AggOracleInfo{
            ...
            base_price_info_id   : get_feed_object_addr(arg0, v0.base_token_type, 1),
            quote_price_info_id  : get_feed_object_addr(arg0, v0.quote_token_type, 1),
            base_aggregator_id   : get_feed_object_addr(arg0, v0.base_token_type, 2),
            quote_aggregator_id  : get_feed_object_addr(arg0, v0.quote_token_type, 2),
        }
    }
    ...
    public fun set_conf_liquidate_threshold<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: u128) {
        ...
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_events::emit_asset_conf_liquidate_threshold_updated(v0, arg2);
    }
    ...
    public fun set_conf_threshold<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: u128) {
        ...
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_events::emit_asset_conf_threshold_updated(v0, arg2);
    }
    ...
    public fun set_degrade_threshold<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: u64) {
        ...
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_events::emit_asset_degrade_threshold_updated(v0, arg2);
    }
    ...
    public fun set_deviation_threshold<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: u128) {
        ...
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_events::emit_asset_deviation_threshold_updated(v0, arg2);
    }

    public fun set_feed_objects<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, FeedObjectsInfo>(&arg0.feed_objects, v0), 19);
        assert_source(&arg0.sources, 1);
        assert_source(&arg0.sources, 2);
        let v1 = object_address<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg2);
        let v2 = object_address<0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator>(arg3);
        let v3 = 0x2::table::borrow_mut<0x1::type_name::TypeName, FeedObjectsInfo>(&mut arg0.feed_objects, v0);
        while (0x2::vec_map::length<u8, address>(&v3.objects) > 0) {
            let (v4, _) = 0x2::vec_map::get_entry_by_idx<u8, address>(&v3.objects, 0);
            let v6 = *v4;
            let (_, _) = 0x2::vec_map::remove<u8, address>(&mut v3.objects, &v6);
        };
        0x2::vec_map::insert<u8, address>(&mut v3.objects, 1, v1);
        0x2::vec_map::insert<u8, address>(&mut v3.objects, 2, v2);
        let v9 = 0x1::vector::empty<u8>();
        let v10 = &mut v9;
        0x1::vector::push_back<u8>(v10, 1);
        0x1::vector::push_back<u8>(v10, 2);
        let v11 = 0x1::vector::empty<address>();
        let v12 = &mut v11;
        0x1::vector::push_back<address>(v12, v1);
        0x1::vector::push_back<address>(v12, v2);
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_events::emit_feed_objects_set(v0, v9, v11);
    }
    ...
    public fun set_max_staleness<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: u64) {
        ...
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_events::emit_asset_max_staleness_updated(v0, arg2);
    }
    ...
    public fun set_source(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: u8, arg3: 0x1::string::String) {
        ...
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_events::emit_source_updated(arg2, arg3);
    }
    ...
    public fun set_weights<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: vector<u8>, arg3: vector<u64>) {
        ...
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_events::emit_asset_weights_updated(v0, arg2, arg3);
    }
    ...
    public(friend) fun update_price<T0: key>(arg0: &mut Oracle, arg1: 0x1::type_name::TypeName, arg2: u8, arg3: u128, arg4: u128, arg5: u64, arg6: &T0, arg7: &0x2::tx_context::TxContext) {
        ...
        assert!(arg5 > 0, 13);
        assert_update_auth<T0>(arg0, arg1, arg2, arg6, arg7);
        ...
        0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_events::emit_price_updated(0x2::tx_context::sender(arg7), arg1, arg2, arg3, arg4, arg5);
    }
    ...
    fun weighted_price_from_feed(arg0: &PriceFeed, arg1: &FeedObjectsInfo, arg2: bool, arg3: u64) : (u128, bool) {
        ...
        while (v18 < v12) {
            ...
            if (v24 <= 0xb58f355d03ce22d89d6f8ef94808a7ecbc8c5464c3cf2e03797ff93c8edfba9e::oracle_math::mul_div_down(v15, arg1.deviation_threshold, 10000)) {
