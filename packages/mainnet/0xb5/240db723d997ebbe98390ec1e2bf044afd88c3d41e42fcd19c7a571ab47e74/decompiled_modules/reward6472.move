module 0xb5240db723d997ebbe98390ec1e2bf044afd88c3d41e42fcd19c7a571ab47e74::reward6472 {
    struct REWARD6472 has drop {
        dummy_field: bool,
    }

    struct TICKET_6472 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6472(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6472>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6472>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6472, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6472>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6472>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6472>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6472>>(v5, 0x2::tx_context::sender(arg1));
    }
