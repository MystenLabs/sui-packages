module 0xb5ed810a6fb75a1ed15198669771d8c15a858fbc839bbc894bfcd14cfbc498a7::governance {
    ...
    public fun burn_admin_cap_via_governance<T0>(arg0: &Proposal<T0>, arg1: &GovernanceVault<T0>, arg2: 0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::AdminCap) {
        ...
        0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::burn_admin_cap(arg2);
    ...
    public fun create_proposal<T0>(arg0: &mut GovernanceVault<T0>, arg1: &0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::Vault<T0>, arg2: &0x2::token::Token<0x46ed88368c5c1fbac0f9da490d6fd76fe65f9dea33f64ccc75c74a161ffb11c2::receipt::RECEIPT>, arg3: u8, arg4: vector<u8>, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(0x2::token::value<0x46ed88368c5c1fbac0f9da490d6fd76fe65f9dea33f64ccc75c74a161ffb11c2::receipt::RECEIPT>(arg2) >= arg0.min_propose_balance, 1000);
        ...
        let v2 = Proposal<T0>{
            ...
            action_type    : arg3,
            payload        : arg4,
            total_eligible : 0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::total_receipts<T0>(arg1),
            yes_votes      : 0,
            no_votes       : 0,
    ...
    fun dispatch_action<T0>(arg0: &Proposal<T0>, arg1: &mut GovernanceVault<T0>, arg2: &mut 0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::Vault<T0>, arg3: &0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::AdminCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = arg0.action_type;
        if (v0 == 3) {
            let v1 = 0x2::bcs::new(arg0.payload);
            let v2 = 0x2::bcs::peel_u64(&mut v1);
            0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::floors::assert_rewards_fee(v2);
            0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::update_performance_fee<T0>(arg2, arg3, v2);
        } else if (v0 == 4) {
            let v3 = 0x2::bcs::new(arg0.payload);
            let v4 = 0x2::bcs::peel_u64(&mut v3);
            assert!(v4 >= 0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::max_tvl_cap<T0>(arg2), 1008);
            0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::update_tvl_cap<T0>(arg2, arg3, v4);
        } else if (v0 == 5) {
            ...
            0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::update_fee_recipient<T0>(arg2, arg3, 0x2::bcs::peel_address(&mut v9));
        };
    }

    public fun execute_proposal<T0>(arg0: &mut Proposal<T0>, arg1: &mut GovernanceVault<T0>, arg2: &mut 0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::Vault<T0>, arg3: &0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::AdminCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun vote<T0>(arg0: &mut Proposal<T0>, arg1: &mut 0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::Vault<T0>, arg2: &0x2::token::Token<0x46ed88368c5c1fbac0f9da490d6fd76fe65f9dea33f64ccc75c74a161ffb11c2::receipt::RECEIPT>, arg3: bool, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::token::value<0x46ed88368c5c1fbac0f9da490d6fd76fe65f9dea33f64ccc75c74a161ffb11c2::receipt::RECEIPT>(arg2);
        assert!(v1 > 0, 1006);
        if (arg3) {
        ...
        0x2f567f02e37a7e97cf603a7118e3b44f58401d4970cac2dda04d6bc71a25d9f5::vault::set_vote_lock<T0>(arg1, v0, arg0.voting_end_ms, arg4);
        let v2 = VoteEvent{
            proposal_id : arg0.proposal_id,
            voter       : v0,
            approve     : arg3,
