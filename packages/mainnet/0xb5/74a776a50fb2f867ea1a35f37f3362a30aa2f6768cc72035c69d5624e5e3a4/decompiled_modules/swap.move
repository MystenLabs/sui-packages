module 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap {
    ...
    public entry fun withdraw_fee<T0, T1>(arg0: &mut Dex_Info, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::utils::sort_token_type<T0, T1>()) {
            ...
            let v2 = 0x2::balance::value<LSP<T0, T1>>(&v1.fee_amount);
            if (v2 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<LSP<T0, T1>>>(0x2::coin::from_balance<LSP<T0, T1>>(0x2::balance::split<LSP<T0, T1>>(&mut v1.fee_amount, v2), arg1), v0);
            };
            let v3 = 0x2::balance::value<T0>(&v1.fee_x);
            if (v3 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v1.fee_x, v3), arg1), v0);
            };
            let v4 = 0x2::balance::value<T1>(&v1.fee_y);
            if (v4 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v1.fee_y, v4), arg1), v0);
            };
        } else {
            let v5 = get_pool<T1, T0>(arg0);
            let v6 = 0x2::balance::value<LSP<T1, T0>>(&v5.fee_amount);
            if (v6 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<LSP<T1, T0>>>(0x2::coin::from_balance<LSP<T1, T0>>(0x2::balance::split<LSP<T1, T0>>(&mut v5.fee_amount, v6), arg1), v0);
            };
            let v7 = 0x2::balance::value<T1>(&v5.fee_x);
            if (v7 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v5.fee_x, v7), arg1), v0);
            };
            let v8 = 0x2::balance::value<T0>(&v5.fee_y);
            if (v8 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v5.fee_y, v8), arg1), v0);
            };
        };
    }
    ...
    public entry fun withdraw_fee_direct<T0, T1>(arg0: u64, arg1: &mut Dex_Info, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::utils::sort_token_type<T0, T1>()) {
            ...
            withdraw_fee_<T0, T1>(arg0, v1, arg2);
        } else {
            let v2 = get_pool<T1, T0>(arg1);
            withdraw_fee_<T1, T0>(arg0, v2, arg2);
        };
    }
