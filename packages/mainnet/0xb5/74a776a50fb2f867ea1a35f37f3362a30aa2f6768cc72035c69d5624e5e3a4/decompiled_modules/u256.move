module 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::u256 {
    ...
    public fun ge(arg0: &U256, arg1: &U256) : bool {
        if (arg0.v3 != arg1.v3) {
            return arg0.v3 >= arg1.v3
        };
        if (arg0.v2 != arg1.v2) {
            return arg0.v2 >= arg1.v2
        };
        if (arg0.v1 != arg1.v1) {
            return arg0.v1 >= arg1.v1
        };
        arg0.v0 >= arg1.v0
    }
    ...
    public fun mul_u128(arg0: u128, arg1: u128) : U256 {
        let v0 = arg0 >> 64;
        let v1 = arg0 & 18446744073709551615;
        let v2 = arg1 >> 64;
        let v3 = arg1 & 18446744073709551615;
        let v4 = v1 * v3;
        let v5 = v0 * v3;
        let v6 = (v4 >> 64) + (v5 & 18446744073709551615);
        let v7 = v6;
        let v8 = v5 >> 64;
        let v9 = v8;
        if (v6 > 18446744073709551615) {
            v9 = v8 + (v6 >> 64);
            v7 = v6 & 18446744073709551615;
        };
        let v10 = v1 * v2;
        let v11 = v7 + (v10 & 18446744073709551615);
        v7 = v11;
        if (v11 > 18446744073709551615) {
            v9 = v9 + (v11 >> 64);
            v7 = v11 & 18446744073709551615;
        };
        let v12 = v9 + (v10 >> 64);
        v9 = v12;
        let v13 = v12 >> 64;
        let v14 = v13;
        if (v12 > 18446744073709551615) {
            v9 = v12 & 18446744073709551615;
        };
        let v15 = v0 * v2;
        let v16 = v9 + (v15 & 18446744073709551615);
        v9 = v16;
        if (v16 > 18446744073709551615) {
            v14 = v13 + (v16 >> 64);
            v9 = v16 & 18446744073709551615;
        };
        U256{
            v0 : ((v4 & 18446744073709551615) as u64),
            v1 : (v7 as u64),
            v2 : (v9 as u64),
            v3 : ((v14 + (v15 >> 64)) as u64),
        }
    }
