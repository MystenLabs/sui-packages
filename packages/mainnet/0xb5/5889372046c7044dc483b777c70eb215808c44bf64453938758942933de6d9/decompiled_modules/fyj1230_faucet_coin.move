module 0xb55889372046c7044dc483b777c70eb215808c44bf64453938758942933de6d9::fyj1230_faucet_coin {
    ...
    fun init(arg0: FYJ1230_FAUCET_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FYJ1230_FAUCET_COIN>(arg0, 9, b"FYJ1230_FAUCET", b"FYJ1230_FAUCET", b"fyj1230's faucet coin, everyone can access and mutate.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/167277561")), arg1);
