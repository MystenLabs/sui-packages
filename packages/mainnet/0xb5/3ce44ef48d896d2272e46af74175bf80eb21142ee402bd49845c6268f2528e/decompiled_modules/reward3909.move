module 0xb53ce44ef48d896d2272e46af74175bf80eb21142ee402bd49845c6268f2528e::reward3909 {
    struct REWARD3909 has drop {
        dummy_field: bool,
    }

    struct TICKET_3909 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3909(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3909>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3909>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3909, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3909>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3909>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3909>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3909>>(v5, 0x2::tx_context::sender(arg1));
    }
