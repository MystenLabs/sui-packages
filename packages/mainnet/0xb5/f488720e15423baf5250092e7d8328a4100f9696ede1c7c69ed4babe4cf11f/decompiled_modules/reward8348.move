module 0xb5f488720e15423baf5250092e7d8328a4100f9696ede1c7c69ed4babe4cf11f::reward8348 {
    struct REWARD8348 has drop {
        dummy_field: bool,
    }

    struct TICKET_8348 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8348(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8348>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8348>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8348, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8348>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8348>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8348>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8348>>(v5, 0x2::tx_context::sender(arg1));
    }
