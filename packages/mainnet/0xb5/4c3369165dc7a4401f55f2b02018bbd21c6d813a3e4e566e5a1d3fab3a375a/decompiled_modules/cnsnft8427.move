module 0xb54c3369165dc7a4401f55f2b02018bbd21c6d813a3e4e566e5a1d3fab3a375a::cnsnft8427 {
    struct CNSNFT8427 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8427, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8427>(arg0, arg1);
