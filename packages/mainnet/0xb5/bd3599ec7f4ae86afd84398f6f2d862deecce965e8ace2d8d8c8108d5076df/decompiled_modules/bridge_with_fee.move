module 0xb5bd3599ec7f4ae86afd84398f6f2d862deecce965e8ace2d8d8c8108d5076df::bridge_with_fee {
    ...
    public fun bridge_with_fee<T0: drop>(arg0: &mut 0xb5bd3599ec7f4ae86afd84398f6f2d862deecce965e8ace2d8d8c8108d5076df::state::State, arg1: &mut 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::state::State, arg2: &0x2::coin::CoinMetadata<T0>, arg3: BridgeWithFeeTicket<T0>) : (CctpBurnRequestBridgeWithFee, 0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::deposit_for_burn::DepositForBurnWithCallerTicket<T0, CircleAuth>) {
        ...
        let v10 = 0xb5bd3599ec7f4ae86afd84398f6f2d862deecce965e8ace2d8d8c8108d5076df::state::get_cctp_mayan_recipient(arg0, v3, 0x2::object::id_to_address(&v9));
        let v11 = 0xb5bd3599ec7f4ae86afd84398f6f2d862deecce965e8ace2d8d8c8108d5076df::state::get_cctp_mayan_caller(arg0, v3);
    ...
    public fun publish_bridge_with_fee(arg0: &mut 0xb5bd3599ec7f4ae86afd84398f6f2d862deecce965e8ace2d8d8c8108d5076df::state::State, arg1: CctpBurnRequestBridgeWithFee, arg2: &0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::Message) : 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::publish_message::MessageTicket {
        ...
        let v14 = 0xb5bd3599ec7f4ae86afd84398f6f2d862deecce965e8ace2d8d8c8108d5076df::burn_message::from_bytes(&v13);
        assert!(v0 == 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::destination_domain(arg2), 4);
        assert!(v1 == 0xb5bd3599ec7f4ae86afd84398f6f2d862deecce965e8ace2d8d8c8108d5076df::burn_message::mint_recipient(&v14), 4);
        assert!(v2 == 0xb5bd3599ec7f4ae86afd84398f6f2d862deecce965e8ace2d8d8c8108d5076df::burn_message::burn_token(&v14), 4);
        assert!(v3 == (0xb5bd3599ec7f4ae86afd84398f6f2d862deecce965e8ace2d8d8c8108d5076df::burn_message::amount(&v14) as u64), 4);
        ...
        let v15 = if (0x1::vector::length<u8>(&v12) > 0) {
            assert!(v5 == 0xb5bd3599ec7f4ae86afd84398f6f2d862deecce965e8ace2d8d8c8108d5076df::bwf_message::bwf_message_payload_type_custom(), 5);
            0x2::address::from_bytes(0x2::hash::keccak256(&v12))
        } else {
            assert!(v5 == 0xb5bd3599ec7f4ae86afd84398f6f2d862deecce965e8ace2d8d8c8108d5076df::bwf_message::bwf_message_payload_type_default(), 5);
            @0x0
        };
        let v16 = 0xb5bd3599ec7f4ae86afd84398f6f2d862deecce965e8ace2d8d8c8108d5076df::bwf_message::new(v5, 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::nonce(arg2), v6, v7, v8, v9, v3, v2, v15);
