module 0xb58cd92fd56c5f0c1495a7a1a96225e22751c7615e83193fa9f09c7c9b56a465::HYPER {
    struct HYPER has drop {
        dummy_field: bool,
    }

    fun init(arg0: HYPER, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<HYPER>(arg0, 2, b"HYPER", b"Hyperfy ON SUI", b"Hyperfy ON SUI", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/RVJrDhNvQaWjI9q03NjdzgLOsbrsqG8PA6CFhRXHnMQ?ext=png")), arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<HYPER>>(v2);
        0x2::transfer::public_transfer<0x2::coin::DenyCap<HYPER>>(v1, @0x7c3c58155b85c3ecf4864777fce255a7e405ffa3b6e443e736976588910f0e8d);
        let v3 = v0;
