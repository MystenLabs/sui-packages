module 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::training {
    ...
    public fun add_sample(arg0: &mut Dataset, arg1: vector<u256>, arg2: u64) {
        ...
        assert!(0x1::vector::length<u256>(&arg1) == 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::binary_math::chunks_needed(arg0.num_features), 503);
        let v0 = Sample{
            features     : arg1,
    ...
    public fun add_sample_from_bools(arg0: &mut Dataset, arg1: &vector<bool>, arg2: u64) {
        ...
        let v0 = 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::binary_math::create_zero_chunks(arg0.num_features);
        let v1 = 0;
        while (v1 < arg0.num_features) {
            if (*0x1::vector::borrow<bool>(arg1, v1)) {
                0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::binary_math::set_bit(&mut v0, v1, true);
            };
            v1 = v1 + 1;
        };
    ...
    public fun calculate_fitness(arg0: &0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::binary_network::BinaryNetwork, arg1: &Dataset) : u64 {
    ...
    public fun create_training_session(arg0: &0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::population::Population, arg1: &Dataset, arg2: TrainingConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : TrainingSession {
    ...
    public fun evaluate_network(arg0: &0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::binary_network::BinaryNetwork, arg1: &Dataset) : EvaluationResult {
        assert!(arg1.size > 0, 504);
        assert!(0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::binary_network::input_size(arg0) == arg1.num_features, 503);
        assert!(0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::binary_network::output_size(arg0) == arg1.num_classes, 503);
        let v0 = 0;
        ...
        while (v6 < arg1.size) {
            ...
            let v8 = 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::binary_network::predict_class(arg0, sample_to_activation(&v7));
            let v9 = v7.label;
    ...
    public fun evaluate_network_batch(arg0: &0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::binary_network::BinaryNetwork, arg1: &Dataset, arg2: u64, arg3: &mut 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::evolution::RNG) : EvaluationResult {
        assert!(arg1.size > 0, 504);
        assert!(0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::binary_network::input_size(arg0) == arg1.num_features, 503);
        ...
        let v8 = 0;
        while (v8 < v0) {
            let v9 = get_sample(arg1, 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::evolution::next_u64_range(arg3, arg1.size));
            let v10 = 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::binary_network::predict_class(arg0, sample_to_activation(&v9));
            let v11 = v9.label;
    ...
    public fun evaluate_population(arg0: &mut 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::population::Population, arg1: &Dataset) {
        let v0 = 0;
        while (v0 < 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::population::size(arg0)) {
            0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::population::set_fitness(arg0, v0, calculate_fitness(0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::population::get_individual(arg0, v0), arg1));
            v0 = v0 + 1;
        };
    }

    public fun evaluate_population_batch(arg0: &mut 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::population::Population, arg1: &Dataset, arg2: u64, arg3: &mut 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::evolution::RNG) {
        let v0 = 0;
        while (v0 < 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::population::size(arg0)) {
            let v1 = evaluate_network_batch(0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::population::get_individual(arg0, v0), arg1, arg2, arg3);
            0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::population::set_fitness(arg0, v0, v1.accuracy_bps);
            v0 = v0 + 1;
        };
    }
    ...
    public fun sample_to_activation(arg0: &Sample) : 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::binary_layer::BinaryActivation {
        0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::binary_layer::create_activation(arg0.features, arg0.num_features)
    }
    ...
    public fun train_step(arg0: &mut TrainingSession, arg1: &mut 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::population::Population, arg2: &Dataset, arg3: &mut 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::evolution::RNG, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : bool {
        if (arg0.complete) {
            return false
        };
        ...
        let v0 = 0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::population::get_best_fitness(arg1);
        ...
        0xb572e91a203288bf7b2e5c8c9b5f715b1b847155fcbc75ec0a2097f0e76fc0e9::population::evolve_generation(arg1, arg3, arg5);
