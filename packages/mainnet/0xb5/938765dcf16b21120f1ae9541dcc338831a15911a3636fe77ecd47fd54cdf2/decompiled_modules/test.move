module 0xb5938765dcf16b21120f1ae9541dcc338831a15911a3636fe77ecd47fd54cdf2::test {
    ...
    fun init(arg0: TEST, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST>(arg0, 9, b"TEST", b"NAME", b"", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
