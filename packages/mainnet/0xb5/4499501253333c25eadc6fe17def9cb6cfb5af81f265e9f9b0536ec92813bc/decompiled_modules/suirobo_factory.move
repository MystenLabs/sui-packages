module 0xb54499501253333c25eadc6fe17def9cb6cfb5af81f265e9f9b0536ec92813bc::suirobo_factory {
    ...
    struct SkillPriceUpdated has copy, drop {
        skill_id: 0x2::object::ID,
        new_price: u64,
    }
    ...
    public fun update_skill_price(arg0: &mut Skill, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.creator == 0x2::tx_context::sender(arg2), 4);
        arg0.price = arg1;
        let v0 = SkillPriceUpdated{
            skill_id  : 0x2::object::id<Skill>(arg0),
            new_price : arg1,
        };
        0x2::event::emit<SkillPriceUpdated>(v0);
    }
