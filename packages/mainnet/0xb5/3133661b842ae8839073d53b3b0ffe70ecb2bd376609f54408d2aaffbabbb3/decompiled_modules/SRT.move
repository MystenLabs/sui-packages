module 0xb53133661b842ae8839073d53b3b0ffe70ecb2bd376609f54408d2aaffbabbb3::SRT {
    struct SRT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SRT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SRT>(arg0, 9, b"SRT", b"Sui Reward Token", b"SRT", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://res.cloudinary.com/dovgmcejr/image/upload/v1716466866/suiRewardToken/suirt_lubzzf.png")), arg1);
