module 0xb5ba37aa0df13e581cba78c4744d3cc851142013ab03cbf8c52ca3b6ac476ad8::reward4184 {
    struct REWARD4184 has drop {
        dummy_field: bool,
    }

    struct TICKET_4184 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4184(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4184>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4184>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4184, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4184>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4184>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4184>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4184>>(v5, 0x2::tx_context::sender(arg1));
    }
