module 0xb51959fec1388bb48380008b2d90c19bbd8da1a319686bb21f27c0ec221cf84b::quest {
    ...
    public fun complete_journey(arg0: &mut Space, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::table::contains<address, bool>(&v0.completed_users, 0x2::tx_context::sender(arg2)), 7);
        assert!(0x2::table::contains<address, u64>(&v0.users_points, 0x2::tx_context::sender(arg2)), 8);
        assert!(*0x2::table::borrow<address, u64>(&v0.users_points, 0x2::tx_context::sender(arg2)) >= v0.reward_required_points, 8);
    ...
    public fun complete_quest(arg0: &VerifierCap, arg1: &mut Space, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: address, arg5: &0x2::clock::Clock) {
        ...
        assert!(!0x2::table::contains<address, bool>(&v1.completed_users, arg4), 5);
        ...
        0x2::table::add<address, bool>(&mut v1.completed_users, arg4, true);
    ...
    public fun create_journey(arg0: &mut SpaceHub, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &SpaceAdminCap, arg3: &mut Space, arg4: u64, arg5: 0x1::string::String, arg6: u64, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0xb51959fec1388bb48380008b2d90c19bbd8da1a319686bb21f27c0ec221cf84b::utils::handle_payment<0x2::sui::SUI>(&mut arg0.balance, arg1, arg0.fee_for_creating_journey, arg11);
        let v0 = Journey{
    ...
    public entry fun create_quest(arg0: &SpaceAdminCap, arg1: &mut Space, arg2: 0x2::object::ID, arg3: u64, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x2::object::ID, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: vector<0x1::string::String>, arg11: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        check_space_version(arg1);
    ...
    public entry fun create_space(arg0: &mut SpaceHub, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun journey_completed_users(arg0: &Space, arg1: 0x2::object::ID) : &0x2::table::Table<address, bool> {
        &0x2::object_table::borrow<0x2::object::ID, Journey>(&arg0.journeys, arg1).completed_users
    }

    public fun journey_quests(arg0: &Space, arg1: 0x2::object::ID) : &0x2::object_table::ObjectTable<0x2::object::ID, Quest> {
        &0x2::object_table::borrow<0x2::object::ID, Journey>(&arg0.journeys, arg1).quests
    }
    ...
    public fun quest_completed_users(arg0: &Space, arg1: 0x2::object::ID, arg2: 0x2::object::ID) : &0x2::table::Table<address, bool> {
        &0x2::object_table::borrow<0x2::object::ID, Quest>(&0x2::object_table::borrow<0x2::object::ID, Journey>(&arg0.journeys, arg1).quests, arg2).completed_users
    }
    ...
    entry fun withdraw(arg0: &AdminCap, arg1: &mut SpaceHub, arg2: &mut 0x2::tx_context::TxContext) {
        check_hub_version(arg1);
        0xb51959fec1388bb48380008b2d90c19bbd8da1a319686bb21f27c0ec221cf84b::utils::withdraw_balance<0x2::sui::SUI>(&mut arg1.balance, arg2);
    }
