module 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::config {
    ...
    public fun check_emergency_pause_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::acl::has_role(&arg0.acl, arg1, 2), 5);
    }
    ...
    public fun checked_package_version(arg0: &GlobalConfig) {
        assert!(10 >= arg0.package_version, 3);
    }
    ...
    public fun set_package_version(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: u64) {
        ...
        assert!(arg2 > v0 && arg2 <= current_version(), 6);
