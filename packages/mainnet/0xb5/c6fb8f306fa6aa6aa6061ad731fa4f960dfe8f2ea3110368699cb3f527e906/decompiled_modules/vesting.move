module 0xb5c6fb8f306fa6aa6aa6061ad731fa4f960dfe8f2ea3110368699cb3f527e906::vesting {
    ...
    public fun buy_csc(arg0: &mut 0x2::tx_context::TxContext, arg1: &mut VestingStorage, arg2: &mut ReferenceStorage, arg3: &0x2::clock::Clock, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: address) {
        if (0x2::tx_context::sender(arg0) != arg5) {
            ...
            if (0x2::object_bag::contains<address>(&arg2.referenceList, arg5) == true) {
                let v2 = 0x2::object_bag::borrow_mut<address, ReferenceInfo>(&mut arg2.referenceList, arg5);
                ...
                0x2::object_bag::add<address, ReferenceInfo>(&mut arg2.referenceList, arg5, v3);
            };
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(v0, v1, arg0), arg5);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg4, @0x8b0725d9ce1f37974984a6fe4c4e75fb50ccc5c4ab48ea802b220cec98b0f9d5);
        create_vesting(arg0, arg1, 0x2::balance::value<0x2::sui::SUI>(0x2::coin::balance<0x2::sui::SUI>(&mut arg4)) * 1000 / 15, arg3);
    }
