module 0xb56fdd75708854706069e7c158c0ec471de7966155c953af88408e8378fecabf::gift7092 {
    struct GIFT7092 has drop {
        dummy_field: bool,
    }

    struct TICKET_7092 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift7092(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7092>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7092>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT7092, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT7092>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7092>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7092>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7092>>(v5, 0x2::tx_context::sender(arg1));
    }
