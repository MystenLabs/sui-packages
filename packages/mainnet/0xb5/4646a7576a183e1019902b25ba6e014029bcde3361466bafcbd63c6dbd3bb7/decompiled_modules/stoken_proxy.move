module 0xb54646a7576a183e1019902b25ba6e014029bcde3361466bafcbd63c6dbd3bb7::stoken_proxy {
    ...
    public fun accept_limits<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_limits_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x2::clock::timestamp_ms(arg2));
    }
    ...
    public fun accept_manager_change<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_manager_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg0.manager, 0x2::clock::timestamp_ms(arg1));
    }
    ...
    public fun accept_processor_change<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_processor_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg0.processor, 0x2::clock::timestamp_ms(arg2));
    }
    ...
    public fun activate_target<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_target_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, true, 0x2::clock::timestamp_ms(arg3));
    }
    ...
    public fun add_target<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: address, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_target_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, true, 0x2::clock::timestamp_ms(arg4));
    }
    ...
    public fun create_proxy<T0>(arg0: 0x2::object::ID, arg1: address, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (ProxyAdminCap, ProxyManagerCap, ProxyProcessorCap) {
        ...
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_initialized(v2, arg0, 0x2::clock::timestamp_ms(arg3));
    ...
    public fun deactivate_target<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        v0.active = false;
        v0.updated_at = 0x2::clock::timestamp_ms(arg3) / 1000;
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_target_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, false, 0x2::clock::timestamp_ms(arg3));
    }
    ...
    public fun force_pause<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyAdminCap, arg2: &0x2::clock::Clock) {
        ...
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_paused(0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x2::clock::timestamp_ms(arg2));
    }
    ...
    public fun force_unpause<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyAdminCap, arg2: &0x2::clock::Clock) {
        ...
        arg0.paused = false;
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_unpaused(0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x2::clock::timestamp_ms(arg2));
    }
    ...
    public fun forward_funds_manager<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_funds_forwarded(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, arg3, 0x2::clock::timestamp_ms(arg4));
    ...
    public fun forward_to_ccam<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyProcessorCap, arg2: &mut 0xb54646a7576a183e1019902b25ba6e014029bcde3361466bafcbd63c6dbd3bb7::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg3: &0xb54646a7576a183e1019902b25ba6e014029bcde3361466bafcbd63c6dbd3bb7::stoken_cross_chain_asset_manager::CcamProcessorCap, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0xb54646a7576a183e1019902b25ba6e014029bcde3361466bafcbd63c6dbd3bb7::stoken_cross_chain_asset_manager::get_proxy_id<T0>(arg2) == 0x2::object::id<ProxyAssetManager<T0>>(arg0), 1);
        let v0 = 0x2::object::id<0xb54646a7576a183e1019902b25ba6e014029bcde3361466bafcbd63c6dbd3bb7::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>>(arg2);
        let v1 = forward_funds<T0>(arg0, arg1, 0x2::object::id_to_address(&v0), arg4, arg5, arg6);
        0xb54646a7576a183e1019902b25ba6e014029bcde3361466bafcbd63c6dbd3bb7::stoken_cross_chain_asset_manager::deposit<T0>(arg2, arg3, v1, arg6);
    }
    ...
    public fun propose_limits<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: 0x1::option::Option<u64>, arg8: &0x2::clock::Clock, arg9: &0x2::tx_context::TxContext) {
        ...
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_limits_change_pending(0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x2::clock::timestamp_ms(arg8) / 1000 + arg0.limits_cooldown, 0x2::clock::timestamp_ms(arg8));
    }
    ...
    public fun propose_manager_change<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_manager_change_pending(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, v0 / 1000 + arg0.manager_change_cooldown, v0);
    }
    ...
    public fun propose_processor_change<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_processor_change_pending(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, v0 / 1000 + arg0.processor_change_cooldown, v0);
    }
    ...
    public fun remove_target<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_target_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, false, 0);
    }
    ...
    public fun return_funds_manager<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x31e731046c31bb60832b0f3431a9c0156b1d413069fa1614bc0806a3e5f70485::stoken_events::emit_proxy_funds_returned(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, 0x2::clock::timestamp_ms(arg3));
