module 0xb52afe4040b69abc026504e49ae1cad71aacfdb97eff6ad8fa8bb53b0b925b44::ownable {
    ...
    public fun assert_version(arg0: &AdminCap) {
        assert!(arg0.version == 0xb52afe4040b69abc026504e49ae1cad71aacfdb97eff6ad8fa8bb53b0b925b44::version::get_program_version(), 2);
    }
    ...
    public(friend) fun grant_admin_cap(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = AdminCap{
            ...
            version : 0xb52afe4040b69abc026504e49ae1cad71aacfdb97eff6ad8fa8bb53b0b925b44::version::get_program_version(),
        };
    ...
    public(friend) fun migrate(arg0: &mut AdminCap, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0xb52afe4040b69abc026504e49ae1cad71aacfdb97eff6ad8fa8bb53b0b925b44::version::get_program_version();
