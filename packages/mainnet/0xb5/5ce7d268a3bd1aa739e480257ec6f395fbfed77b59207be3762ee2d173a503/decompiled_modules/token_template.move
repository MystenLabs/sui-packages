module 0xb55ce7d268a3bd1aa739e480257ec6f395fbfed77b59207be3762ee2d173a503::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"BT2438735", b"BatchToken2 438735", b"Second serial deployment", 0x1::option::none<0x2::url::Url>(), arg1);
