module 0xb5d9c4585562600329c8b717aa5e5b3b43ee86acb26647b72258f2e07ea0ec53::test1 {
    ...
    fun init(arg0: TEST1, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Test1 "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiglnz4zt4evxfyifuuhmoh2axlhthsq5vyxk6ad54nuk37ii7cu6u"));
