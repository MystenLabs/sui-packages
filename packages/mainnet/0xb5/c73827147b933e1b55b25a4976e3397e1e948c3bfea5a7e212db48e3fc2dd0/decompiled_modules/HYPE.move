module 0xb5c73827147b933e1b55b25a4976e3397e1e948c3bfea5a7e212db48e3fc2dd0::HYPE {
    ...
    fun init(arg0: HYPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<HYPE>(arg0, 9, b"TRUMP", b"Trump with Musk", b"Trump win election powered by Musk", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
