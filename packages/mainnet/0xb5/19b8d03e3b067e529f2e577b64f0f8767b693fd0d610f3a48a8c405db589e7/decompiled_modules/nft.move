module 0xb519b8d03e3b067e529f2e577b64f0f8767b693fd0d610f3a48a8c405db589e7::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public entry fun mint(arg0: &mut MintCap, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let arg1 = if (v9 > arg0.mint_price) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v9 - arg0.mint_price, arg2), 0x2::tx_context::sender(arg2));
            arg1
        } else {
            arg1
        };
