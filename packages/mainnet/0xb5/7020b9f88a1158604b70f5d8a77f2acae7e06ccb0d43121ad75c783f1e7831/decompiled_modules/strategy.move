module 0xb57020b9f88a1158604b70f5d8a77f2acae7e06ccb0d43121ad75c783f1e7831::strategy {
    ...
    public fun update(arg0: &mut Strategy, arg1: u8, arg2: u8, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        arg0.current_index = arg1;
        arg0.current_loop = arg2;
        arg0.completed = arg3;
        arg0.last_update_timestamp_ms = 0x2::clock::timestamp_ms(arg4);
