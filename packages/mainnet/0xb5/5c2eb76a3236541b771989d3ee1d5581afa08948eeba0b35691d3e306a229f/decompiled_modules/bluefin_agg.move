module 0xb55c2eb76a3236541b771989d3ee1d5581afa08948eeba0b35691d3e306a229f::bluefin_agg {
    ...
    public fun swap<T0, T1, T2>(arg0: &0x8736237bae5af0583f17c6a49cae695e8f703da342193753bec4ea1937dd4df1::liquidator::Liquidator, arg1: &mut 0x8736237bae5af0583f17c6a49cae695e8f703da342193753bec4ea1937dd4df1::custom_liquidate::CustomLiquidateReceipt<T0>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T2>, arg4: bool, arg5: u64, arg6: &0x2::clock::Clock) {
        let (v0, v1) = if (arg4) {
            ...
            swap_a2b<T1, T2>(arg2, arg3, 0x8736237bae5af0583f17c6a49cae695e8f703da342193753bec4ea1937dd4df1::custom_liquidate::take_balance<BluefinAgg, T0, T1>(arg1, arg0, v2, arg5), arg6)
        } else {
            let v3 = BluefinAgg{dummy_field: false};
            swap_b2a<T1, T2>(arg2, arg3, 0x8736237bae5af0583f17c6a49cae695e8f703da342193753bec4ea1937dd4df1::custom_liquidate::take_balance<BluefinAgg, T0, T2>(arg1, arg0, v3, arg5), arg6)
        };
        let v4 = v1;
        let v5 = v0;
        if (0x2::balance::value<T1>(&v5) > 0) {
            let v6 = BluefinAgg{dummy_field: false};
            0x8736237bae5af0583f17c6a49cae695e8f703da342193753bec4ea1937dd4df1::custom_liquidate::put_balance<BluefinAgg, T0, T1>(arg1, arg0, v6, v5);
        } else {
            0x2::balance::destroy_zero<T1>(v5);
        };
        if (0x2::balance::value<T2>(&v4) > 0) {
            let v7 = BluefinAgg{dummy_field: false};
            0x8736237bae5af0583f17c6a49cae695e8f703da342193753bec4ea1937dd4df1::custom_liquidate::put_balance<BluefinAgg, T0, T2>(arg1, arg0, v7, v4);
        } else {
