module 0xb5ed5f624f118becb10759ba1b6331dde72b0947db70d62206e3d6df987d5055::cnsnft3775 {
    struct CNSNFT3775 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3775, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3775>(arg0, arg1);
