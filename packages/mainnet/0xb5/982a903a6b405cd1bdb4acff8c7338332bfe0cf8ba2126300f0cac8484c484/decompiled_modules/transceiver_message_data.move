module 0xb5982a903a6b405cd1bdb4acff8c7338332bfe0cf8ba2126300f0cac8484c484::transceiver_message_data {
    struct TransceiverMessageData<T0> has copy, drop {
        ...
        ntt_manager_payload: 0xb5982a903a6b405cd1bdb4acff8c7338332bfe0cf8ba2126300f0cac8484c484::ntt_manager_message::NttManagerMessage<T0>,
    }

    public fun new<T0>(arg0: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg1: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg2: 0xb5982a903a6b405cd1bdb4acff8c7338332bfe0cf8ba2126300f0cac8484c484::ntt_manager_message::NttManagerMessage<T0>) : TransceiverMessageData<T0> {
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : TransceiverMessageData<vector<u8>> {
        ...
        TransceiverMessageData<vector<u8>>{
            ...
            ntt_manager_payload           : 0xb5982a903a6b405cd1bdb4acff8c7338332bfe0cf8ba2126300f0cac8484c484::ntt_manager_message::take_bytes(arg0),
        }
    }
    ...
    public fun to_bytes(arg0: TransceiverMessageData<vector<u8>>) : vector<u8> {
        ...
        let v4 = 0xb5982a903a6b405cd1bdb4acff8c7338332bfe0cf8ba2126300f0cac8484c484::ntt_manager_message::to_bytes(v2);
