module 0xac05fba3c5adc6296d3b65c0d09cc9d579f0e1ad8f0a8a6e734feaa0fb8b7c8b::validator_set {
    ...
    fun export_stakes(arg0: &mut Vault, arg1: &mut u64, arg2: &mut u64, arg3: &mut u64, arg4: &mut 0x3::sui_system::SuiSystemState, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = 0x2::balance::zero<0x2::sui::SUI>();
        while (*arg1 > 0 && arg0.gap < arg0.length) {
            arg0.gap = arg0.gap + 1;
            let v1 = 0x3::sui_system::request_withdraw_stake_non_entry(arg4, 0x2::object_table::remove<u64, 0x3::staking_pool::StakedSui>(&mut arg0.stakes, arg0.gap), arg5);
            *arg3 = *arg3 + 0x2::balance::value<0x2::sui::SUI>(&v1);
            *arg2 = *arg2 + 1;
            *arg1 = *arg1 - 1;
            0x2::balance::join<0x2::sui::SUI>(&mut v0, v1);
        };
        v0
    }

    public(friend) fun export_stakes_from_v1(arg0: &mut ValidatorSet, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0x2::sui::SUI>, u64, u64) {
        let v0 = 0;
        let v1 = 0;
        let v2 = 0;
        let v3 = 0x2::balance::zero<0x2::sui::SUI>();
        let v4 = get_validators(arg0);
        while (v0 < 0x1::vector::length<address>(&v4) && arg2 > 0) {
            if (!0x2::table::contains<address, Vault>(&arg0.vaults, *0x1::vector::borrow<address>(&v4, v0))) {
                v0 = v0 + 1;
                continue
            };
            let v5 = 0x2::table::borrow_mut<address, Vault>(&mut arg0.vaults, *0x1::vector::borrow<address>(&v4, v0));
            let v6 = &mut arg2;
            let v7 = &mut v1;
            let v8 = &mut v2;
            0x2::balance::join<0x2::sui::SUI>(&mut v3, export_stakes(v5, v6, v7, v8, arg1, arg3));
            v0 = v0 + 1;
        };
        (v3, v1, v2)
    }
    ...
    public(friend) fun remove_stakes(arg0: &mut ValidatorSet, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0x2::sui::SUI>, u64, u64) {
        ...
        if (v2.gap == v2.length) {
            ...
            if (*0x2::vec_map::get<address, u64>(&arg0.validators, &arg2) == 0) {
                ...
                let (v11, v12) = 0x1::vector::index_of<address>(&arg0.sorted_validators, &arg2);
                assert!(v11, 303);
                0x1::vector::swap_remove<address>(&mut arg0.sorted_validators, v12);
            } else {
                v2.gap = 0;
                v2.length = 0;
            };
    ...
    public(friend) fun update_validators(arg0: &mut ValidatorSet, arg1: vector<address>, arg2: vector<u64>) {
        ...
        if (v0 > 0) {
            arg0.is_sorted = false;
        };
        assert!(0x2::vec_map::size<address, u64>(&arg0.validators) < 16, 304);
    }
