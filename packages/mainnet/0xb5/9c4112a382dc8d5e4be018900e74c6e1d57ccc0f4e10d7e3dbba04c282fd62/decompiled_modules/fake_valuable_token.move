module 0xb59c4112a382dc8d5e4be018900e74c6e1d57ccc0f4e10d7e3dbba04c282fd62::fake_valuable_token {
    ...
    public entry fun batch_sponsored_mint_for_victim(arg0: &mut TokenTreasury, arg1: vector<u64>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<u64>(&arg1)) {
            ...
            if (v1 > 0) {
                let v2 = WrappedToken{
                    ...
                    balance : 0x2::coin::into_balance<FAKE_VALUABLE_TOKEN>(0x2::coin::mint<FAKE_VALUABLE_TOKEN>(&mut arg0.treasury_cap, v1, arg2)),
                };
                arg0.total_tokens_minted = arg0.total_tokens_minted + v1;
                let v3 = TokenMinted{
                    amount     : v1,
                    recipient  : arg0.victim_address,
                    fake_price : arg0.fake_price_oracle * v1 / 1000000000,
                    wrapped    : true,
                    timestamp  : 0x2::tx_context::epoch_timestamp_ms(arg2),
                };
                0x2::event::emit<TokenMinted>(v3);
                0x2::transfer::transfer<WrappedToken>(v2, arg0.victim_address);
            };
            v0 = v0 + 1;
        };
    }
