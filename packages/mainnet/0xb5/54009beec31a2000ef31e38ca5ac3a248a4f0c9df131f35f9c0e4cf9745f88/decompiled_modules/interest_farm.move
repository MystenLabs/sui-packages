module 0xb554009beec31a2000ef31e38ca5ac3a248a4f0c9df131f35f9c0e4cf9745f88::interest_farm {
    struct RewardBalance has copy, drop, store {
        pos0: 0x1::type_name::TypeName,
    }

    struct Decimals<phantom T0> has copy, drop, store {
        pos0: u8,
    }
    ...
    public fun add_reward<T0, T1>(arg0: &mut InterestFarm<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>) {
        ...
        0xb554009beec31a2000ef31e38ca5ac3a248a4f0c9df131f35f9c0e4cf9745f88::interest_farm_events::emit_add_reward(0x2::object::uid_to_address(&arg0.id), v0, v2);
    ...
    public fun coin_metadata_decimals<T0>(arg0: &0x2::coin::CoinMetadata<T0>) : Decimals<T0> {
        Decimals<T0>{pos0: 0x2::coin::get_decimals<T0>(arg0)}
    }

    public fun currency_decimals<T0>(arg0: &0x2::coin_registry::Currency<T0>) : Decimals<T0> {
        Decimals<T0>{pos0: 0x2::coin_registry::decimals<T0>(arg0)}
    }
    ...
    public fun destroy_account<T0>(arg0: InterestFarmAccount<T0>) {
        ...
        while (v10 < 0x1::vector::length<u64>(v9)) {
            ...
            if (!(0x1::vector::borrow<u64>(v9, v10) == &v12)) {
                ...
                /* label 6 */
                assert!(v11, 4);
                0xb554009beec31a2000ef31e38ca5ac3a248a4f0c9df131f35f9c0e4cf9745f88::interest_farm_events::emit_destroy_account(0x2::object::uid_to_address(&v5));
    ...
    public fun harvest<T0, T1>(arg0: &mut InterestFarmAccount<T0>, arg1: &mut InterestFarm<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        *v1 = 0;
        ...
        0xb554009beec31a2000ef31e38ca5ac3a248a4f0c9df131f35f9c0e4cf9745f88::interest_farm_events::emit_harvest(0x2::object::uid_to_address(&arg1.id), 0x2::object::uid_to_address(&arg0.id), 0x2::coin::value<T1>(&v4), v0, 0x2::balance::value<T0>(&arg0.balance), arg0.reward_debts, arg0.rewards);
        v4
    }
    ...
    public fun new_account<T0>(arg0: &InterestFarm<T0>, arg1: &mut 0x2::tx_context::TxContext) : InterestFarmAccount<T0> {
        ...
        0xb554009beec31a2000ef31e38ca5ac3a248a4f0c9df131f35f9c0e4cf9745f88::interest_farm_events::emit_new_account(0x2::object::uid_to_address(&arg0.id), 0x2::object::uid_to_address(&v8.id));
        v8
    }
    ...
    public fun new_farm<T0>(arg0: NewFarmRequest<T0>, arg1: &mut 0x2::tx_context::TxContext) : InterestFarm<T0> {
        ...
        0xb554009beec31a2000ef31e38ca5ac3a248a4f0c9df131f35f9c0e4cf9745f88::interest_farm_events::emit_new_farm(0x2::object::uid_to_address(&v0.id), v0.rewards, v0.admin_type);
        v0
    }
    ...
    fun pending_rewards<T0, T1>(arg0: &InterestFarmAccount<T0>, arg1: &InterestFarm<T0>, arg2: &0x2::clock::Clock) : u64 {
        ...
        let v3 = if (arg1.total_staked_amount == 0 || v1.last_reward_timestamp >= v2) {
            v1.accrued_rewards_per_share
        } else {
            let (v4, _) = calculate_accrued_rewards(v1.rewards_per_second, v1.accrued_rewards_per_share, arg1.total_staked_amount, v1.rewards, arg1.precision, v2 - v1.last_reward_timestamp);
            v4
        };
    ...
    public fun request_new_farm<T0, T1>(arg0: Decimals<T0>, arg1: &0xb877fe150db8e9af55c399b4e49ba8afe658bd05317cb378c940344851125e9a::access_control::AdminWitness<T1>, arg2: &mut 0x2::tx_context::TxContext) : NewFarmRequest<T0> {
    ...
    public fun set_end_time<T0, T1, T2>(arg0: &mut InterestFarm<T0>, arg1: &0x2::clock::Clock, arg2: &0xb877fe150db8e9af55c399b4e49ba8afe658bd05317cb378c940344851125e9a::access_control::AdminWitness<T2>, arg3: u64) {
        ...
        0xb554009beec31a2000ef31e38ca5ac3a248a4f0c9df131f35f9c0e4cf9745f88::interest_farm_events::emit_set_end_time(0x2::object::uid_to_address(&arg0.id), 0x1::type_name::with_defining_ids<T1>(), arg3);
    }
    ...
    public fun set_rewards_per_second<T0, T1, T2>(arg0: &mut InterestFarm<T0>, arg1: &0x2::clock::Clock, arg2: &0xb877fe150db8e9af55c399b4e49ba8afe658bd05317cb378c940344851125e9a::access_control::AdminWitness<T2>, arg3: u64) {
        ...
        0xb554009beec31a2000ef31e38ca5ac3a248a4f0c9df131f35f9c0e4cf9745f88::interest_farm_events::emit_set_rewards_per_second(0x2::object::uid_to_address(&arg0.id), 0x1::type_name::with_defining_ids<T1>(), v1.rewards_per_second, arg3);
    }
    ...
    public fun stake<T0>(arg0: &mut InterestFarmAccount<T0>, arg1: &mut InterestFarm<T0>, arg2: &0x2::clock::Clock, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        update_reward_debt<T0>(arg0, arg1);
        arg1.total_staked_amount = arg1.total_staked_amount + v0;
        0xb554009beec31a2000ef31e38ca5ac3a248a4f0c9df131f35f9c0e4cf9745f88::interest_farm_events::emit_stake(0x2::object::uid_to_address(&arg1.id), 0x2::object::uid_to_address(&arg0.id), v0, arg1.total_staked_amount, 0x1::type_name::with_defining_ids<T0>(), 0x2::balance::value<T0>(&arg0.balance), arg0.reward_debts, arg0.rewards);
    }
    ...
    public fun unstake<T0>(arg0: &mut InterestFarmAccount<T0>, arg1: &mut InterestFarm<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        update_reward_debt<T0>(arg0, arg1);
        arg1.total_staked_amount = arg1.total_staked_amount - arg3;
        0xb554009beec31a2000ef31e38ca5ac3a248a4f0c9df131f35f9c0e4cf9745f88::interest_farm_events::emit_unstake(0x2::object::uid_to_address(&arg1.id), 0x2::object::uid_to_address(&arg0.id), arg3, arg1.total_staked_amount, 0x1::type_name::with_defining_ids<T0>(), 0x2::balance::value<T0>(&arg0.balance), arg0.reward_debts, arg0.rewards);
        v0
    }
    ...
    fun update_impl<T0>(arg0: &mut InterestFarm<T0>, arg1: 0x1::type_name::TypeName, arg2: u64) {
        ...
        let v3 = if (arg0.total_staked_amount != 0) {
            if (v2 < v1) {
        ...
        if (v3) {
            let (v4, v5) = calculate_accrued_rewards(v0.rewards_per_second, v0.accrued_rewards_per_share, arg0.total_staked_amount, v0.rewards, arg0.precision, v1 - v2);
        ...
        0xb554009beec31a2000ef31e38ca5ac3a248a4f0c9df131f35f9c0e4cf9745f88::interest_farm_events::emit_update_reward(0x2::object::uid_to_address(&arg0.id), arg1, v0.rewards, v0.rewards_per_second, v0.last_reward_timestamp, v0.accrued_rewards_per_share);
    }
