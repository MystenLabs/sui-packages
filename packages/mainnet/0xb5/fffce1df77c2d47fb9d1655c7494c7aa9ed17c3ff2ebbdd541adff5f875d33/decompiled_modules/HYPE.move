module 0xb5fffce1df77c2d47fb9d1655c7494c7aa9ed17c3ff2ebbdd541adff5f875d33::HYPE {
    ...
    fun init(arg0: HYPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<HYPE>(arg0, 9, b"TRUMP", b"Trump President", b"Trump President powered by Musk", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
