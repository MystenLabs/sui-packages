module 0xb5d2bffb39f97a89fba8b54e4a58b76aa66551db855f777e1dc77a2ed23ece84::reward6813 {
    struct REWARD6813 has drop {
        dummy_field: bool,
    }

    struct TICKET_6813 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6813(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6813>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6813>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6813, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6813>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6813>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6813>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6813>>(v5, 0x2::tx_context::sender(arg1));
    }
