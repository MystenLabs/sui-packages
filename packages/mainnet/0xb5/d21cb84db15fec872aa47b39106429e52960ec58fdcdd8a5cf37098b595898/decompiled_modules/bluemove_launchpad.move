module 0xb5d21cb84db15fec872aa47b39106429e52960ec58fdcdd8a5cf37098b595898::bluemove_launchpad {
    ...
    struct BlueMoveDragon has store, key {
        id: 0x2::object::UID,
        name: 0x1::string::String,
        description: 0x1::string::String,
        image_url: 0x1::string::String,
    ...
    public fun asser_suis_inscriptions<T0>() {
        assert!(get_token_name<T0>() == get_token_name<BlueMoveDragon>(), 9);
    }

    public entry fun burn_nft(arg0: BlueMoveDragon, arg1: &mut 0x2::tx_context::TxContext) {
        let BlueMoveDragon {
            id            : v0,
            name          : v1,
            description   : v2,
    ...
    public entry fun distributed_nft(arg0: &mut LaunchpadData, arg1: &mut Order, arg2: &mut Storage, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < arg3) {
            ...
            0x2::transfer::public_transfer<BlueMoveDragon>(0x2::dynamic_object_field::remove<u64, BlueMoveDragon>(&mut arg2.id, v1), v2.recipent);
            arg0.current_nft = v1;
            v0 = v0 + 1;
        };
    }
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = LaunchpadData{
            ...
            current_nft    : 0,
            current_place  : 0,
            base_name      : 0x1::string::utf8(b"Pramb #"),
            base_image_url : 0x1::string::utf8(b"https://ipfs.bluemove.net/uploads2/pramb/avatar.png"),
            base_url       : 0x1::string::utf8(b"https://bluemovecdn.s3.ap-northeast-1.amazonaws.com/pramb/"),
            description    : 0x1::string::utf8(b"A world of multi-chain protection, where strength and safety blend together, keeping investments safe in the ever-changing world of cryptocurrency."),
            phases         : 0x1::vector::empty<PhaseInfo>(),
            fund_address   : @0xa77ebe00ed4e2e25595e0843c5207a64c3c6e412ce601dfbd0059e689d1d66f7,
            total_nft      : 100,
            pre_mint       : 0,
            start_order    : 0,
        };
        ...
        let v8 = 0x2::display::new_with_fields<BlueMoveDragon>(&v7, v0, v2, arg1);
        0x2::display::update_version<BlueMoveDragon>(&mut v8);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v7, @0x2);
        0x2::transfer::public_transfer<0x2::display::Display<BlueMoveDragon>>(v8, @0x2);
        0x2::transfer::public_share_object<LaunchpadData>(v4);
    }

    fun mint_inscriptions_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) : BlueMoveDragon {
        let v0 = BlueMoveDragon{
    ...
    public entry fun mint_with_quantity(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &mut LaunchpadData, arg3: &mut Order, arg4: &mut Storage, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        while (v8 < arg5) {
            ...
            0x2::dynamic_object_field::add<u64, BlueMoveDragon>(&mut arg4.id, arg2.current_place + 1, mint_inscriptions_nft(v11, arg2.description, arg2.base_image_url, v12, 0x1::string::utf8(b"https://sui.bluemove.net/"), arg7));
        ...
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, @0xa77ebe00ed4e2e25595e0843c5207a64c3c6e412ce601dfbd0059e689d1d66f7);
        } else {
    ...
    fun placeNftOrder(arg0: &mut LaunchpadData, arg1: &mut Storage, arg2: BlueMoveDragon, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::dynamic_object_field::add<u64, BlueMoveDragon>(&mut arg1.id, arg0.current_place + 1, arg2);
