module 0x14364804f79fd7b3504ff796b569534a0c27ab1c28c97f3f114e41052ea32b12::dex_dao {
    ...
    fun accrue_hive_for_bee_box<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut LpBeeBox<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hive_gems::HiveGems {
        ...
        if (v2 > 0 && arg1.total_staked > 0) {
            let v4 = (0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div_u256((arg0.gems_schedule.gems_per_epoch as u256), (v1 as u256), (arg0.total_gems_points as u256)) as u64);
            let v5 = 0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div_u256(((v2 * v4) as u256), (1000000 as u256), (arg1.total_staked as u256));
            ...
            let v8 = KraftedGemsForPoolHive{
                ...
                gems_per_epoch_for_hive : (v4 as u256),
                index_increment         : v5,
    ...
    fun get_unbonding_psns_and_expected_hive<T0>(arg0: &PoolsGovernor, arg1: &PoolHive<T0>, arg2: &LpBeeBox<T0>, arg3: u64) : (vector<u64>, vector<u64>, u64, u64) {
        ...
        if (v4 > 0 && v5 > 0 && arg1.total_staked > 0) {
            let v9 = 0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div_u256((((0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div_u256((arg0.gems_schedule.gems_per_epoch as u256), (v4 as u256), (arg0.total_gems_points as u256)) as u64) * v5) as u256), (1000000 as u256), (arg1.total_staked as u256));
            v7 = v6 + v9;
