module 0xb5a7ad0e5ef4e02fe7c49d2d685fa4b39f324a1e249eaeee31c9be13658cedf8::reward7690 {
    struct REWARD7690 has drop {
        dummy_field: bool,
    }

    struct TICKET_7690 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7690(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7690>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7690>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7690, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7690>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7690>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7690>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7690>>(v5, 0x2::tx_context::sender(arg1));
    }
