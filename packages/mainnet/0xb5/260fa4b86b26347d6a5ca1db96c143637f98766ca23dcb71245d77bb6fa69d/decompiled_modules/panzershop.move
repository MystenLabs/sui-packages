module 0x524ac2292d0862f294f1c4973b7d83b008e40e22c333156bc9747626053293f6::panzershop {
    ...
    public entry fun purchase_product_koban_into_vesting(arg0: &mut PanzerShop, arg1: u64, arg2: 0x2::coin::Coin<0x8400e7044d360c28dd338111d2aa54ca5bdc960a8d6b60bf3b28e1ca503df3e2::koban::KOBAN>, arg3: &mut 0xe036568c83c4b2876316404a5100b103d270527ec7671838459d929f661fa3a2::backvesting::PoolManager, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::borrow_mut<Product>(&mut arg0.products, arg1);
        assert!(v0.priceKoban > 0, 13);
        assert!(0x2::coin::value<0x8400e7044d360c28dd338111d2aa54ca5bdc960a8d6b60bf3b28e1ca503df3e2::koban::KOBAN>(&arg2) == v0.priceKoban, 12);
        ...
        0xe036568c83c4b2876316404a5100b103d270527ec7671838459d929f661fa3a2::backvesting::receive_payment(arg3, arg2, arg4, arg5);
        let v2 = &v0.productArguments;
        if (v2.objectType == 0x1::string::utf8(b"Panzerdog")) {
            0x524ac2292d0862f294f1c4973b7d83b008e40e22c333156bc9747626053293f6::panzerdogs::mint_to_address_pkg(*0x1::vector::borrow<0x1::string::String>(&v2.args, 0), *0x1::vector::borrow<0x1::string::String>(&v2.args, 1), *0x1::vector::borrow<0x1::string::String>(&v2.args, 2), *0x1::vector::borrow<0x1::string::String>(&v2.args, 3), 1, 0x2::tx_context::sender(arg5), arg5);
        } else if (v2.objectType == 0x1::string::utf8(b"Equipment")) {
            0x524ac2292d0862f294f1c4973b7d83b008e40e22c333156bc9747626053293f6::equipment::mint_to_address_pkg(*0x1::vector::borrow<0x1::string::String>(&v2.args, 0), *0x1::vector::borrow<0x1::string::String>(&v2.args, 1), *0x1::vector::borrow<0x1::string::String>(&v2.args, 2), *0x1::vector::borrow<0x1::string::String>(&v2.args, 3), *0x1::vector::borrow<0x1::string::String>(&v2.args, 4), 0x2::tx_context::sender(arg5), arg5);
        } else if (v2.objectType == 0x1::string::utf8(b"Cyberpill")) {
            0x524ac2292d0862f294f1c4973b7d83b008e40e22c333156bc9747626053293f6::cyberpills::mint_to_address_pkg(1, 0x2::tx_context::sender(arg5), arg5);
        } else if (v2.objectType == 0x1::string::utf8(b"TankPart")) {
            0x524ac2292d0862f294f1c4973b7d83b008e40e22c333156bc9747626053293f6::tankparts::mint_to_address_pkg(*0x1::vector::borrow<0x1::string::String>(&v2.args, 0), *0x1::vector::borrow<0x1::string::String>(&v2.args, 1), *0x1::vector::borrow<0x1::string::String>(&v2.args, 2), *0x1::vector::borrow<0x1::string::String>(&v2.args, 3), *0x1::vector::borrow<0x1::string::String>(&v2.args, 4), 1, 0x2::tx_context::sender(arg5), arg5);
        } else if (v2.objectType == 0x1::string::utf8(b"Merch")) {
            0x524ac2292d0862f294f1c4973b7d83b008e40e22c333156bc9747626053293f6::merch::mint_to_address_pkg(*0x1::vector::borrow<0x1::string::String>(&v2.args, 0), *0x1::vector::borrow<0x1::string::String>(&v2.args, 1), *0x1::vector::borrow<0x1::string::String>(&v2.args, 2), 0x2::tx_context::sender(arg5), arg5);
        };
        v0.purchases = v0.purchases + 1;
        let v3 = ProductPurchasedEvent{
            productId : 0x2::object::id<Product>(v0),
            sender    : 0x2::tx_context::sender(arg5),
        };
        0x2::event::emit<ProductPurchasedEvent>(v3);
    }
