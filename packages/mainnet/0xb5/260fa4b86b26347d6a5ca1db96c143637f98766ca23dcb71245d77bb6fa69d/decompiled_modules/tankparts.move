module 0x524ac2292d0862f294f1c4973b7d83b008e40e22c333156bc9747626053293f6::tankparts {
    ...
    struct TankPartBurnedEvent has copy, drop {
        id: 0x2::object::ID,
        game_id: 0x1::string::String,
        part_type: 0x1::string::String,
        rarity: 0x1::string::String,
    ...
    public entry fun burn(arg0: TankPart, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = TankPartBurnedEvent{
            id        : 0x2::object::id<TankPart>(&arg0),
            game_id   : arg0.game_id,
            part_type : arg0.part_type,
            rarity    : arg0.rarity,
            sender    : 0x2::tx_context::sender(arg1),
        };
        0x2::event::emit<TankPartBurnedEvent>(v0);
        let TankPart {
            id           : v1,
            game_id      : _,
            name         : _,
