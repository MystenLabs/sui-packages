module 0x524ac2292d0862f294f1c4973b7d83b008e40e22c333156bc9747626053293f6::equipment {
    ...
    struct EquipmentBurnedEvent has copy, drop {
        id: 0x2::object::ID,
        game_id: 0x1::string::String,
        slot: 0x1::string::String,
        rarity: 0x1::string::String,
    ...
    public entry fun burn(arg0: Equipment, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = EquipmentBurnedEvent{
            id      : 0x2::object::id<Equipment>(&arg0),
            game_id : arg0.game_id,
            slot    : arg0.slot,
            rarity  : arg0.rarity,
            sender  : 0x2::tx_context::sender(arg1),
        };
        0x2::event::emit<EquipmentBurnedEvent>(v0);
        let Equipment {
            id          : v1,
            game_id     : _,
            name        : _,
