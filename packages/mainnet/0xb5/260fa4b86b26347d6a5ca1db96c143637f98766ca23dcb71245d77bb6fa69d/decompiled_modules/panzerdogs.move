module 0x524ac2292d0862f294f1c4973b7d83b008e40e22c333156bc9747626053293f6::panzerdogs {
    ...
    struct PanzerdogBurnedEvent has copy, drop {
        id: 0x2::object::ID,
        name: 0x1::string::String,
        clan: 0x1::string::String,
        sender: address,
    ...
    public entry fun burn(arg0: &0x2::package::Publisher, arg1: Panzerdog, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<Panzerdog>(arg0), 1);
        let v0 = PanzerdogBurnedEvent{
            id     : 0x2::object::id<Panzerdog>(&arg1),
            name   : arg1.name,
            clan   : arg1.clan,
            sender : 0x2::tx_context::sender(arg2),
        };
        0x2::event::emit<PanzerdogBurnedEvent>(v0);
        let Panzerdog {
            id         : v1,
            name       : _,
            clan       : _,
