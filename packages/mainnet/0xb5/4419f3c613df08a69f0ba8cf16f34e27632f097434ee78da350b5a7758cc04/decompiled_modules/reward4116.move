module 0xb54419f3c613df08a69f0ba8cf16f34e27632f097434ee78da350b5a7758cc04::reward4116 {
    struct REWARD4116 has drop {
        dummy_field: bool,
    }

    struct TICKET_4116 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4116(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4116>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4116>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4116, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4116>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4116>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4116>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4116>>(v5, 0x2::tx_context::sender(arg1));
    }
