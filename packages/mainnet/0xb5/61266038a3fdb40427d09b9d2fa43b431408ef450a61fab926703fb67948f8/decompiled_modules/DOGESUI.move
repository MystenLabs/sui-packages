module 0xb561266038a3fdb40427d09b9d2fa43b431408ef450a61fab926703fb67948f8::DOGESUI {
    ...
    fun init(arg0: DOGESUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DOGESUI>(arg0, 9, b"DOGE", b"DOGESUI", b"", 0x1::option::none<0x2::url::Url>(), arg1);
