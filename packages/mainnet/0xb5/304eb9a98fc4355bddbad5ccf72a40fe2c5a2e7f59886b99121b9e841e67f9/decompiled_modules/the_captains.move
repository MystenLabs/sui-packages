module 0xb5304eb9a98fc4355bddbad5ccf72a40fe2c5a2e7f59886b99121b9e841e67f9::the_captains {
    ...
    public fun admin_add_royalty_rule(arg0: &AdminCap, arg1: &mut 0x2::transfer_policy::TransferPolicy<PfpNFT>, arg2: &0x2::transfer_policy::TransferPolicyCap<PfpNFT>, arg3: u16, arg4: u64) {
        0xb5304eb9a98fc4355bddbad5ccf72a40fe2c5a2e7f59886b99121b9e841e67f9::fixed_royalty_rule::add<PfpNFT>(arg1, arg2, arg3, arg4);
    }
    ...
    public fun create_transfer_policy(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::transfer_policy::new<PfpNFT>(arg0, arg1);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<PfpNFT>>(v0);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<PfpNFT>>(v1, 0x2::tx_context::sender(arg1));
    }

    public fun create_transfer_policy_with_royalty_and_lock(arg0: &0x2::package::Publisher, arg1: u16, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::transfer_policy::new<PfpNFT>(arg0, arg3);
        let v2 = v1;
        let v3 = v0;
        0xb5304eb9a98fc4355bddbad5ccf72a40fe2c5a2e7f59886b99121b9e841e67f9::fixed_royalty_rule::add<PfpNFT>(&mut v3, &v2, arg1, arg2);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<PfpNFT>>(v3);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<PfpNFT>>(v2, 0x2::tx_context::sender(arg3));
    }
    ...
    fun init(arg0: THE_CAPTAINS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = &mut v9;
        0x1::vector::push_back<0x1::string::String>(v10, 0x1::string::utf8(b"The Captain #{token_id}"));
    ...
    public fun mint(arg0: &PubKey, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: u8, arg7: u64, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: &mut Counter, arg12: &MintConfig, arg13: &mut MintStats, arg14: &Payout, arg15: 0x2::coin::Coin<0x2::sui::SUI>, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        ensure_stage_bucket(arg13, arg7, arg17);
        ...
        while (v6 < arg3) {
            ...
            0x2::transfer::public_transfer<PfpNFT>(v8, v3);
            v6 = v6 + 1;
        };
    }

    public fun mint_free(arg0: &PubKey, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: u8, arg7: u64, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: &mut Counter, arg12: &MintConfig, arg13: &mut MintStats, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) {
        assert!(!arg12.paused, 7);
        assert!(arg0.pubkey_set, 1);
        ...
        let v2 = take_suffix(&v1, 66);
        assert_minter_text_matches_prefixed64(arg4, &v2);
        let v3 = 0x2::tx_context::sender(arg15);
        assert!(v3 == arg4, 6);
        assert!(minted_count_in_stage(arg13, arg7, v3) + arg3 <= get_stage_limit(arg12, arg7), 11);
        if (0x2::table::contains<address, u64>(&arg13.per_address, v3)) {
            let v4 = 0x2::table::borrow_mut<address, u64>(&mut arg13.per_address, v3);
        ...
        ensure_stage_bucket(arg13, arg7, arg15);
        if (0x2::table::contains<address, u64>(0x2::table::borrow<u64, 0x2::table::Table<address, u64>>(&arg13.per_stage, arg7), v3)) {
            let v5 = 0x2::table::borrow_mut<address, u64>(0x2::table::borrow_mut<u64, 0x2::table::Table<address, u64>>(&mut arg13.per_stage, arg7), v3);
            *v5 = *v5 + arg3;
        } else {
