module 0xb5b34edeb0a1f82c0a8f44f2854763f4f80edeb4709f169b1e35ab7591e4939f::reward3632 {
    struct REWARD3632 has drop {
        dummy_field: bool,
    }

    struct TICKET_3632 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3632(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3632>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3632>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3632, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3632>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3632>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3632>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3632>>(v5, 0x2::tx_context::sender(arg1));
    }
