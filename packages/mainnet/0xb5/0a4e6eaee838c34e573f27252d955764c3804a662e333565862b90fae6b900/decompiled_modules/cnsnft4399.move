module 0xb50a4e6eaee838c34e573f27252d955764c3804a662e333565862b90fae6b900::cnsnft4399 {
    struct CNSNFT4399 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4399, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4399>(arg0, arg1);
