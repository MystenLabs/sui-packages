module 0xb5bad314dd8fc1851ee3333f87c5868492a3cef87ab6cafb5ef85baf50bbdfa8::cutter_banans_test_branchcutter_banans_test_branch {
    struct CUTTER_BANANS_TEST_BRANCHCUTTER_BANANS_TEST_BRANCH has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CUTTER_BANANS_TEST_BRANCHCUTTER_BANANS_TEST_BRANCH, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CUTTER_BANANS_TEST_BRANCHCUTTER_BANANS_TEST_BRANCH>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"cutter banans test branchcutter banans test branch"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"cutter banans test branchcutter banans test branch "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibwa4veslvvvhmfxvqm6kribr4uzw2z7dz5hfsxs6ibrqdpc2udty"));
