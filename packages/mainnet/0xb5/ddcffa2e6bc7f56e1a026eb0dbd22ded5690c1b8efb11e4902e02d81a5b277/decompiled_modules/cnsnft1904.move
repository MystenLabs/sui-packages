module 0xb5ddcffa2e6bc7f56e1a026eb0dbd22ded5690c1b8efb11e4902e02d81a5b277::cnsnft1904 {
    struct CNSNFT1904 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1904, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2229"));
        let v4 = 0x2::package::claim<CNSNFT1904>(arg0, arg1);
