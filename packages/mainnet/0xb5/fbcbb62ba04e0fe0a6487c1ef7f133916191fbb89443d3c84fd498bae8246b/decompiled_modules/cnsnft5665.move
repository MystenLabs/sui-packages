module 0xb5fbcbb62ba04e0fe0a6487c1ef7f133916191fbb89443d3c84fd498bae8246b::cnsnft5665 {
    struct CNSNFT5665 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5665, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5665>(arg0, arg1);
