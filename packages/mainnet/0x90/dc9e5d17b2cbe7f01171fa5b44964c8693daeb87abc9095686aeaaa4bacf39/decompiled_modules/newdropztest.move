module 0x90dc9e5d17b2cbe7f01171fa5b44964c8693daeb87abc9095686aeaaa4bacf39::newdropztest {
    struct NEWDROPZTEST has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NEWDROPZTEST, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NEWDROPZTEST>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"newdropztest"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"newdropztest "));
