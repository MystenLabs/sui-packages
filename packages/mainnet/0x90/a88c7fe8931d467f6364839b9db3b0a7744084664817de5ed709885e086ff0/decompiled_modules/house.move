module 0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::house {
    ...
    public(friend) fun add_game_config<T0, T1: drop>(arg0: &mut House<T0>, arg1: u64, arg2: u64, arg3: u64) {
        let v0 = 0x1::type_name::get<T1>();
        assert!(!0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 0);
        let v1 = GameConfig{
            max_risk             : arg1,
            player_rebate_rate   : arg2,
            referrer_rebate_rate : arg3,
        };
    ...
    public(friend) fun add_volume<T0, T1: drop>(arg0: &mut House<T0>, arg1: address, arg2: 0x1::option::Option<address>, arg3: u64) {
        ...
        0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::events::emit_earn_playing_rebate<T0, T1>(arg1, v3);
        ...
        0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::events::emit_earn_referral_rebate<T0, T1>(v6, v7);
    }
    ...
    public(friend) fun claim_rebate<T0>(arg0: &mut House<T0>, arg1: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::events::emit_claim_rebate<T0>(v0, v2);
    ...
    public(friend) fun update_game_config<T0, T1: drop>(arg0: &mut House<T0>, arg1: u64, arg2: u64, arg3: u64) {
        let v0 = 0x1::type_name::get<T1>();
        assert!(0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 1);
        let v1 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, GameConfig>(&mut arg0.id, v0);
        v1.max_risk = arg1;
        v1.player_rebate_rate = arg2;
        v1.referrer_rebate_rate = arg3;
    }
