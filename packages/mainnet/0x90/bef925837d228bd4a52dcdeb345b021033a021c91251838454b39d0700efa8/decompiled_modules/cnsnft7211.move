module 0x90bef925837d228bd4a52dcdeb345b021033a021c91251838454b39d0700efa8::cnsnft7211 {
    struct CNSNFT7211 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7211, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7211>(arg0, arg1);
