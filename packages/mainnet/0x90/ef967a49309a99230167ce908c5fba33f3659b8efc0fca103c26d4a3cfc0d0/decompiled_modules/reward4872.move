module 0x90ef967a49309a99230167ce908c5fba33f3659b8efc0fca103c26d4a3cfc0d0::reward4872 {
    struct REWARD4872 has drop {
        dummy_field: bool,
    }

    struct TICKET_4872 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4872(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4872>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4872>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4872, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4872>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4872>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4872>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4872>>(v5, 0x2::tx_context::sender(arg1));
    }
