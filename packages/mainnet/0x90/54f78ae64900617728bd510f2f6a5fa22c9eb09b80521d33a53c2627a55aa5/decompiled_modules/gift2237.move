module 0x9054f78ae64900617728bd510f2f6a5fa22c9eb09b80521d33a53c2627a55aa5::gift2237 {
    struct GIFT2237 has drop {
        dummy_field: bool,
    }

    struct TICKET_2237 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2237(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2237>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2237>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2237, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2237>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2237>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2237>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2237>>(v5, 0x2::tx_context::sender(arg1));
    }
