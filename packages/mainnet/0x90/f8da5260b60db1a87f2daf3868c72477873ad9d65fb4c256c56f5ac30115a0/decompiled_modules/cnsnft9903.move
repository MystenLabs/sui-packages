module 0x90f8da5260b60db1a87f2daf3868c72477873ad9d65fb4c256c56f5ac30115a0::cnsnft9903 {
    struct CNSNFT9903 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9903, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8210"));
        let v4 = 0x2::package::claim<CNSNFT9903>(arg0, arg1);
