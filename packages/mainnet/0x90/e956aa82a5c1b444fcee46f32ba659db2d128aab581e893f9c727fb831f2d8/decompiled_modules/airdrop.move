module 0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::airdrop {
    struct Airdrop has store, key {
        id: 0x2::object::UID,
        balance: 0x2::balance::Balance<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>,
        is_enabled: bool,
        start_time: u64,
        duration: u64,
    ...
    public fun claim(arg0: &mut Airdrop, arg1: &mut VendettaAirdropNFT, arg2: &mut Allocation, arg3: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::Version, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA> {
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::validate_version(arg3, 1);
        ...
        0x2::coin::from_balance<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(0x2::balance::split<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(&mut arg0.balance, v1), arg5)
    }

    public fun add_admin_wallet(arg0: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::AdminCap, arg1: &mut Airdrop, arg2: address, arg3: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::Version) {
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::validate_version(arg3, 1);
        assert!(arg2 != @0x0, 9);
        arg1.admin_wallet = arg2;
    }

    public fun add_funds_for_airdrop(arg0: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::AdminCap, arg1: &mut Airdrop, arg2: &mut Allocation, arg3: 0x2::coin::Coin<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>, arg4: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::Version) {
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::validate_version(arg4, 1);
        arg2.total_allocation = arg2.total_allocation + 0x2::coin::value<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(&arg3);
        0x2::balance::join<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(&mut arg1.balance, 0x2::coin::into_balance<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(arg3));
        let v0 = FundsAdded{total_funds: 0x2::balance::value<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(&arg1.balance)};
        0x2::event::emit<FundsAdded>(v0);
    }

    public fun add_game_stats(arg0: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::OperatorCap, arg1: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::OperatorCapsBag, arg2: &Airdrop, arg3: 0x1::string::String, arg4: vector<u64>, arg5: vector<u64>, arg6: &mut GameStatsConfig, arg7: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::Version) {
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::is_operator(arg0, arg1);
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::validate_version(arg7, 1);
    ...
    public fun add_vesting_time_for_airdrop(arg0: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::OperatorCap, arg1: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::OperatorCapsBag, arg2: &mut Airdrop, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::Version) {
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::is_operator(arg0, arg1);
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::validate_version(arg6, 1);
        assert!(arg4 > 0x2::clock::timestamp_ms(arg3), 6);
        arg2.start_time = arg4;
        arg2.duration = arg5;
    }

    public fun airdrop_nft(arg0: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::OperatorCap, arg1: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::OperatorCapsBag, arg2: &mut Airdrop, arg3: &GameStatsConfig, arg4: &mut Allocation, arg5: vector<address>, arg6: vector<u64>, arg7: vector<u64>, arg8: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::Version, arg9: &mut 0x2::tx_context::TxContext) {
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::is_operator(arg0, arg1);
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::validate_version(arg8, 1);
        ...
        assert!(v1 <= 0x2::balance::value<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(&arg2.balance), 4);
    }
    ...
    public fun claim_for_game(arg0: &mut Airdrop, arg1: &mut VendettaAirdropNFT, arg2: &mut Allocation, arg3: &GameStatsConfig, arg4: 0x1::string::String, arg5: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::Version, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA> {
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::validate_version(arg5, 1);
        assert!(arg0.is_enabled, 2);
        let v0 = arg1.allocated_amount - arg1.claimed;
        ...
        0x2::coin::from_balance<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(0x2::balance::split<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(&mut arg0.balance, v2), arg6)
    }
    ...
    public fun enable_airdrop(arg0: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::AdminCap, arg1: &mut Airdrop, arg2: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::Version) {
    ...
    public fun get_airdrop_balance(arg0: &Airdrop) : u64 {
        0x2::balance::value<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(&arg0.balance)
    }
    ...
    fun init(arg0: AIRDROP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Airdrop{
            ...
            balance           : 0x2::balance::zero<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(),
            is_enabled        : false,
            start_time        : 0,
            duration          : 0,
            admin_wallet      : @0x0,
    ...
    public fun mint_nft(arg0: &mut Airdrop, arg1: &GameStatsConfig, arg2: &mut Allocation, arg3: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::validate_version(arg3, 1);
        assert!(arg0.is_enabled, 2);
    ...
    public fun set_minimum_threshold(arg0: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::OperatorCap, arg1: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::OperatorCapsBag, arg2: &mut Airdrop, arg3: u64, arg4: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::Version) {
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::is_operator(arg0, arg1);
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::validate_version(arg4, 1);
        assert!(!arg2.is_enabled, 3);
    ...
    public fun set_slash_percentage(arg0: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::OperatorCap, arg1: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::OperatorCapsBag, arg2: &mut Airdrop, arg3: u64, arg4: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::Version) {
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::is_operator(arg0, arg1);
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::validate_version(arg4, 1);
    ...
    public fun unlock_v(arg0: &mut Airdrop, arg1: &mut VendettaAirdropNFT, arg2: &mut Allocation, arg3: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::Version, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA> {
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::validate_version(arg3, 1);
        assert!(arg0.is_enabled, 2);
        ...
        let v1 = if (v0 <= arg0.minimum_threshold) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>>(0x2::coin::from_balance<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(0x2::balance::split<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(&mut arg0.balance, v2), arg4), arg0.admin_wallet);
            v3
        };
        ...
        0x2::coin::from_balance<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(0x2::balance::split<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(&mut arg0.balance, v1), arg4)
    }
    ...
    public fun withdraw_airdrop_funds(arg0: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::role::AdminCap, arg1: &mut Airdrop, arg2: &0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.admin_wallet != @0x0, 9);
        assert!(0x2::balance::value<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(&arg1.balance) > 0, 0);
        assert!(!arg1.is_enabled, 2);
        0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta_version::validate_version(arg2, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>>(0x2::coin::from_balance<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(0x2::balance::withdraw_all<0x90e956aa82a5c1b444fcee46f32ba659db2d128aab581e893f9c727fb831f2d8::vendetta::VENDETTA>(&mut arg1.balance), arg3), arg1.admin_wallet);
    }
