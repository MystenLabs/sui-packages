module 0x904a0fec4bed3489543108aec4c069a2fd96ba5aefba51c7dec95d4b66b3de5b::FUCKU {
    ...
    fun init(arg0: FUCKU, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FUCKU>(arg0, 2, b"FKU", b"FUCKU", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raw.githubusercontent.com/GJJJJJJJ/test/main/daqianxie.jpg")), arg1);
