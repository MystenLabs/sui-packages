module 0x903492dbc73c22bee21382d51e2f65d55140da3287472acf27add3bf843ec3dc::house {
    ...
    public entry fun withdraw_all_fees(arg0: &AdminCap, arg1: &mut Treasury, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg1.balance);
        assert!(v0 > 0, 2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1.balance, v0, arg2), 0x2::tx_context::sender(arg2));
    }

    public entry fun withdraw_fees(arg0: &AdminCap, arg1: &mut Treasury, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 2);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1.balance) >= arg2, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1.balance, arg2, arg3), 0x2::tx_context::sender(arg3));
    }
