module 0x90ad9d3eac5721e34bded051112f65f6046263a9500e79dfaaa6ccf9dc9812a2::cnsnft4679 {
    struct CNSNFT4679 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4679, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4679>(arg0, arg1);
