module 0x906abba33de397de556ff18b83c9aa2db423ef4f89908422ee61397446490e75::fetcher {
    struct TickData {
    ...
    public fun fetch_ticks<T0, T1>(arg0: vector<u32>, arg1: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>) : vector<TickData> {
        ...
        while (v2 < 0x1::vector::length<u32>(&arg0)) {
            let v3 = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::i32::from_u32(*0x1::vector::borrow<u32>(&arg0, v2));
            let v4 = TickData{
                index           : v3,
