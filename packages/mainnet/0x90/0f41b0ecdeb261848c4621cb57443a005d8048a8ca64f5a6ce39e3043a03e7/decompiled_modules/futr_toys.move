module 0x900f41b0ecdeb261848c4621cb57443a005d8048a8ca64f5a6ce39e3043a03e7::futr_toys {
    struct FUTR_TOYS has drop {
        dummy_field: bool,
    }

    struct VictoryAstro has store, key {
        id: 0x2::object::UID,
        issue: u64,
        token_id: u64,
    ...
    public fun add_new_toy(arg0: &0x5b1dc549bfcb09721baf6fa9ac539b6fcae1fbb76be61761bb1f44268789eedd::registry::RegistryCap, arg1: &mut 0x5b1dc549bfcb09721baf6fa9ac539b6fcae1fbb76be61761bb1f44268789eedd::registry::Registry, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>) {
        0x5b1dc549bfcb09721baf6fa9ac539b6fcae1fbb76be61761bb1f44268789eedd::registry::add_new_toy<VictoryAstro>(arg1, arg0, 0x5b1dc549bfcb09721baf6fa9ac539b6fcae1fbb76be61761bb1f44268789eedd::toy::create(0x1::string::utf8(b"Victory Astro"), 2, 0x1::string::utf8(b"Second original Astro"), 0x2::url::new_unsafe_from_bytes(b"https://aggregator.walrus-mainnet.walrus.space/v1/blobs/by-quilt-patch-id/YTqrEMiyB0-FinDmGsdr22O4Gu3S8k1NP3hVARoPnNoBAQAMAA"), 0x2::url::new_unsafe_from_bytes(b"https://aggregator.walrus-mainnet.walrus.space/v1/blobs/by-quilt-patch-id/YTqrEMiyB0-FinDmGsdr22O4Gu3S8k1NP3hVARoPnNoBXgCSAg"), 0x2::url::new_unsafe_from_bytes(b"https://aggregator.walrus-mainnet.walrus.space/v1/blobs/by-quilt-patch-id/YTqrEMiyB0-FinDmGsdr22O4Gu3S8k1NP3hVARoPnNoBDABeAA"), 0x2::vec_map::from_keys_values<0x1::string::String, 0x1::string::String>(arg2, arg3), 350000, 100));
    }

    public fun burn(arg0: VictoryAstro, arg1: &mut 0x2::tx_context::TxContext) {
        let VictoryAstro {
            id          : v0,
            issue       : _,
            token_id    : _,
    ...
    public fun init_display(arg0: &mut 0x2::display_registry::DisplayRegistry, arg1: 0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1::string::utf8(b"Victory Astro");
        ...
        let (v5, v6) = 0x2::display_registry::new_with_publisher<VictoryAstro>(arg0, &mut arg1, arg2);
        let v7 = v6;
        let v8 = v5;
        let v9 = 0;
        while (v9 < 4) {
            0x2::display_registry::set<VictoryAstro>(&mut v8, &v7, *0x1::vector::borrow<0x1::string::String>(&v0, v9), *0x1::vector::borrow<0x1::string::String>(&v3, v9));
            v9 = v9 + 1;
        };
        0x2::display_registry::share<VictoryAstro>(v8);
        0x2::transfer::public_transfer<0x2::display_registry::DisplayCap<VictoryAstro>>(v7, 0x2::tx_context::sender(arg2));
    ...
    public fun premint_toys(arg0: &0x5b1dc549bfcb09721baf6fa9ac539b6fcae1fbb76be61761bb1f44268789eedd::store::StoreCap, arg1: &mut 0x5b1dc549bfcb09721baf6fa9ac539b6fcae1fbb76be61761bb1f44268789eedd::store::Store, arg2: &mut 0x5b1dc549bfcb09721baf6fa9ac539b6fcae1fbb76be61761bb1f44268789eedd::registry::Registry, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<VictoryAstro>();
        let v1 = 0x5b1dc549bfcb09721baf6fa9ac539b6fcae1fbb76be61761bb1f44268789eedd::registry::borrow_toy<VictoryAstro>(arg2);
        let v2 = 1;
        while (v2 <= arg3) {
            let v3 = VictoryAstro{
            ...
            0x1::vector::push_back<VictoryAstro>(&mut v0, v3);
            v2 = v2 + 1;
        };
        0x5b1dc549bfcb09721baf6fa9ac539b6fcae1fbb76be61761bb1f44268789eedd::store::add_preminted<VictoryAstro>(arg1, arg0, arg2, v0);
