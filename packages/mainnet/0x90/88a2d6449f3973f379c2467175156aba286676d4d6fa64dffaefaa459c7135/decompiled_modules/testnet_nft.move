module 0x9088a2d6449f3973f379c2467175156aba286676d4d6fa64dffaefaa459c7135::testnet_nft {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = TestnetNFT{
            ...
            name        : 0x1::string::utf8(b"name"),
            description : 0x1::string::utf8(b"description"),
            url         : 0x2::url::new_unsafe_from_bytes(b"url"),
        };
        let v2 = NFTMinted{
    ...
    public fun mint_to_sender(arg0: &mut Supply, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        if (arg0.current_supply >= 2) {
            abort 1
        };
