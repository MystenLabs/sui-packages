module 0x902db66d394acf8368ca0efee45bd7193e0b9dfa7e4407df732757cd082bd7a0::d0 {
    ...
    struct D<phantom T0, phantom T1> has key {
        id: 0x2::object::UID,
        v: 0x2::object::ID,
        k: 0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::VaultTradeCap<T1>,
        a: 0x2::object::ID,
        m: 0x2::object::ID,
        po: 0x2::object::ID,
        pc: 0x2::object::ID,
    ...
    public fun c0<T0, T1>(arg0: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::Vault<T1>, arg1: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::VaultAdminCap<T1>, arg2: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::config::LotusConfig, arg3: 0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::VaultTradeCap<T1>, arg4: 0x2::object::ID, arg5: 0x2::object::ID, arg6: 0x2::object::ID, arg7: 0x2::object::ID, arg8: 0x2::object::ID, arg9: 0x2::object::ID, arg10: vector<u64>, arg11: vector<u64>, arg12: &mut 0x2::tx_context::TxContext) : D<T0, T1> {
        ...
        D<T0, T1>{
            ...
            v  : 0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::id<T1>(arg0),
            k  : arg3,
            a  : arg4,
            m  : arg5,
            po : arg6,
    ...
    public(friend) fun hk(arg0: &vector<u64>, arg1: &vector<u64>) : bool {
        ...
        let v0 = vector[6, 8, 9, 13, 17, 20, 21, 23, 25];
    ...
    public(friend) fun kb<T0, T1>(arg0: &D<T0, T1>) : &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::VaultTradeCap<T1> {
        &arg0.k
    }
    ...
    public fun n1<T0, T1>(arg0: &mut D<T0, T1>, arg1: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::Vault<T1>, arg2: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::VaultAdminCap<T1>, arg3: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::config::LotusConfig, arg4: &mut 0x2::tx_context::TxContext) : U1 {
        0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::config::assert_governance(arg3);
        0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::assert_admin<T1>(arg1, arg2);
        assert!(arg0.v == 0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::id<T1>(arg1), 0);
        let v0 = U1{
    ...
    public fun t0<T0, T1>(arg0: &mut D<T0, T1>, arg1: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::Vault<T1>, arg2: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::VaultAdminCap<T1>, arg3: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::config::LotusConfig, arg4: vector<u64>, arg5: vector<u64>) {
        0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::config::assert_governance(arg3);
        0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::assert_admin<T1>(arg1, arg2);
        assert!(arg0.v == 0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::id<T1>(arg1), 0);
        check(&arg4);
    ...
    public fun u0<T0, T1>(arg0: &mut D<T0, T1>, arg1: &U1, arg2: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::config::LotusConfig, arg3: vector<u64>) {
        0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::config::assert_governance(arg2);
    ...
    public fun xb<T0, T1>(arg0: &mut D<T0, T1>, arg1: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::Vault<T1>, arg2: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::VaultAdminCap<T1>, arg3: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::config::LotusConfig, arg4: u8, arg5: 0x2::object::ID) {
        0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::config::assert_governance(arg3);
        0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::assert_admin<T1>(arg1, arg2);
        assert!(arg0.v == 0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::id<T1>(arg1), 0);
        let v0 = XKey{k: arg4};
    ...
    public fun z0<T0, T1>(arg0: &mut D<T0, T1>, arg1: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::Vault<T1>, arg2: &0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::VaultAdminCap<T1>, arg3: bool) {
        0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::assert_admin<T1>(arg1, arg2);
        assert!(arg0.v == 0x5527631dd82b25e102273e7d32376902645631966b9d2a12e77ab7de71c96a9f::vault::id<T1>(arg1), 0);
        arg0.z = arg3;
    }
