module 0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::supra {
    public fun get_price(arg0: &0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::OracleConfig, arg1: &mut 0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::OracleHolder, arg2: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg3: &0x2::clock::Clock) {
        ...
        assert!(0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::oracle_type(arg0) == 0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::oracle_type_supra(), 1);
        let v0 = 0x2::bcs::new(0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::oracle_id(arg0));
        ...
        let (v2, v3) = if (0x1::vector::length<u32>(&v1) == 1) {
            ...
            ((0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::div_u128(v4, 0x1::u128::pow(10, (v5 as u8))) as u64), ((v6 / 1000) as u64))
        } else {
            ...
            ((0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::div_u128(v16, 0x1::u128::pow(10, (v17 as u8))) as u64), ((0x1::u128::min(v10, v14) / 1000) as u64))
        };
        assert!(v3 + 0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::max_staleness_threshold_s(arg0) >= 0x2::clock::timestamp_ms(arg3) / 1000, 2);
        0x2::vec_map::insert<0x2::object::ID, 0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::PriceFeed>(0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::price_feeds_mut(arg1), 0x2::object::id<0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::OracleConfig>(arg0), 0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::new_price_feed(v2, 0x1::option::none<u64>(), v3));
    }

    public fun new_oracle(arg0: vector<u32>, arg1: u64, arg2: u64, arg3: &0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::AdminCap, arg4: &mut 0x2::tx_context::TxContext) {
        validate_supra_id(arg0);
        0x2::transfer::public_share_object<0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::OracleConfig>(0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::new_config(arg1, arg2, 0x2::bcs::to_bytes<vector<u32>>(&arg0), 0x90c601a7b7212937755c9ed66697023b3869234d0ecbe4fb83bc883fbf9c04fa::oracle::oracle_type_supra(), arg4));
    }
