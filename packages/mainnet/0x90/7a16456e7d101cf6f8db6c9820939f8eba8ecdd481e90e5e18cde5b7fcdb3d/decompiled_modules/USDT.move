module 0x907a16456e7d101cf6f8db6c9820939f8eba8ecdd481e90e5e18cde5b7fcdb3d::USDT {
    ...
    fun init(arg0: USDT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<USDT>(arg0, 9, b"USDT", b"USDT", b"USDT default coin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://icon.vipssy163.com/public.png")), arg1);
