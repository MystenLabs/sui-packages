module 0x90a41a4ec5ecb7863a44c27fd7109529dbc2ccc9de39f3e6959b5414dc38c3f7::meme {
    ...
    fun init(arg0: MEME, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME>(arg0, 18, b"MEME", b"MEME Exchange", b"MEME Exchange, Mining Pool, Defi, Launch Pad, Top MEME exchange, DAO Community Governance Exchange", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://ipfs.io/ipfs/QmWGqd4SdwwtDyTC1bTdpELaZsffSaPZKq1CGyZGwMPCFN/"))), arg1);
