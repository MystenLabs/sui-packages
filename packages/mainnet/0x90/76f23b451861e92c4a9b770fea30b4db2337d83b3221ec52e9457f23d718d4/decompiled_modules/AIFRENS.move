module 0x9076f23b451861e92c4a9b770fea30b4db2337d83b3221ec52e9457f23d718d4::AIFRENS {
    ...
    fun init(arg0: AIFRENS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AIFRENS>(arg0, 2, b"aifrens", b"AIFRENS", b"", 0x1::option::none<0x2::url::Url>(), arg1);
