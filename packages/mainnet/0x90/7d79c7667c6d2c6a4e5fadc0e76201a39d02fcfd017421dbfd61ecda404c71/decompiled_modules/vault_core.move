module 0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_core {
    ...
    public(friend) fun assert_vault_operator(arg0: &Vault, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(&arg0.config.operator == &v0, 0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::errors::unauthorized());
    }
    ...
    public(friend) fun recover_shares(arg0: &0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::AdminCap, arg1: &mut Vault, arg2: &0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::VaultUser, arg3: address, arg4: address, arg5: &0x2::clock::Clock) {
        0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::assert_lost_user(arg2, arg3, arg5);
    ...
    public entry fun set_developer(arg0: &mut Vault, arg1: &0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::VaultUser, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun set_operator(arg0: &mut Vault, arg1: &0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::VaultUser, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::assert_vault_admin(arg1, arg3);
    ...
    public entry fun update_deposit_range(arg0: &mut Vault, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1 <= arg0.config.max_deposit_value && arg2 >= arg0.config.min_deposit_value, 0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::errors::invalid_amount());
    ...
    public entry fun update_slippage_tolerance(arg0: &mut Vault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert_vault_operator(arg0, arg2);
        assert!(arg1 <= 5000, 0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::errors::invalid_slippage());
    ...
    public(friend) fun update_vault_shares(arg0: &mut Vault, arg1: &0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::VaultUser, arg2: address, arg3: u64, arg4: bool, arg5: u64) : (u64, u64, u64, u64) {
        assert!(arg3 > 0, 0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::errors::insufficient_share());
        if (arg4) {
            arg0.shares_supply = arg0.shares_supply + arg3;
        } else {
            assert!(arg0.shares_supply >= arg3, 0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::errors::insufficient_share());
            arg0.shares_supply = arg0.shares_supply - arg3;
        };
        ...
        let (v2, v3, v4) = 0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::get_user_level_data(arg1, arg2);
        let v5 = 1000;
