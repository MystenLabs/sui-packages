module 0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_profit {
    ...
    public entry fun batch_update_users_interest(arg0: &mut VaultProfit, arg1: &0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::VaultUser, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::assert_vault_admin(arg1, arg4);
    ...
    public(friend) fun recover_interest(arg0: &0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::AdminCap, arg1: &mut VaultProfit, arg2: &0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::VaultUser, arg3: address, arg4: address, arg5: &0x2::clock::Clock) {
    ...
    public(friend) fun recover_profit_shares(arg0: &0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::AdminCap, arg1: &mut VaultProfit, arg2: &0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::VaultUser, arg3: address, arg4: address, arg5: &0x2::clock::Clock) {
        0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::assert_lost_user(arg2, arg3, arg5);
    ...
    public(friend) fun update_profit_shares(arg0: &mut VaultProfit, arg1: &0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::VaultUser, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: u64) {
        update_single_share(arg0, arg2, true, true, arg3, arg7, arg8);
        let v0 = arg6;
        let v1 = 0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::get_referrer(arg1, arg2);
        if (v1 != @0x2012) {
            update_single_share(arg0, v1, false, true, arg4, arg7, arg8);
        } else {
            v0 = arg6 + arg4;
        };
        let v2 = 0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::get_referrer(arg1, v1);
        if (v2 != @0x2012) {
    ...
    public(friend) fun update_referrers_shares(arg0: &mut VaultProfit, arg1: &0x907d79c7667c6d2c6a4e5fadc0e76201a39d02fcfd017421dbfd61ecda404c71::vault_user::VaultUser, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: u64) {
        if (arg2 == @0x2012) {
            return
        };
