module 0x90ae263b6877bd01fc6130370fc7560d6907468bb98a66c2afb3500363861cfe::panda_whale_club {
    struct PANDA_WHALE_CLUB has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PANDA_WHALE_CLUB, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PANDA_WHALE_CLUB>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Panda Whale Club"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Panda Whale Club is one of the important components of the entire PANS ecosystem."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidqweihsx75u4ix2sv7fbog6annrrwaajlhuotkh72tnndawm4vgq"));
