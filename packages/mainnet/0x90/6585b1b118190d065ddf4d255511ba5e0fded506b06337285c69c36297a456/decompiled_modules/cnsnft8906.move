module 0x906585b1b118190d065ddf4d255511ba5e0fded506b06337285c69c36297a456::cnsnft8906 {
    struct CNSNFT8906 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8906, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8906>(arg0, arg1);
