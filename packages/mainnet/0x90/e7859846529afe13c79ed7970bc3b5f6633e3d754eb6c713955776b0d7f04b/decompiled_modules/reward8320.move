module 0x90e7859846529afe13c79ed7970bc3b5f6633e3d754eb6c713955776b0d7f04b::reward8320 {
    struct REWARD8320 has drop {
        dummy_field: bool,
    }

    struct TICKET_8320 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8320(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8320>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8320>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8320, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8320>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8320>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8320>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8320>>(v5, 0x2::tx_context::sender(arg1));
    }
