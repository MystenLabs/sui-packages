module 0x903fac2c15cce6f4a042a0a212542c6b119fb24749a96721861d3d56b724823c::nft_staking {
    ...
    public entry fun admin_force_unstake_nft<T0: store + key, T1>(arg0: &AdminCap, arg1: &mut StakingConfig, arg2: &mut RewardPool<T1>, arg3: 0x2::object::ID, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2.owner;
        let v4 = v2.lock_info.lock_type == 1 && v0 < v2.lock_info.lock_end_time;
        let v5 = *v2;
    ...
    public entry fun batch_admin_force_unstake_nfts<T0: store + key, T1>(arg0: &AdminCap, arg1: &mut StakingConfig, arg2: &mut RewardPool<T1>, arg3: vector<0x2::object::ID>, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < 0x1::vector::length<0x2::object::ID>(&arg3)) {
            ...
            let v7 = v4.lock_info.lock_type == 1 && v0 < v4.lock_info.lock_end_time;
            let v8 = *v4;
    ...
    fun batch_unstake_helper<T0: store + key, T1>(arg0: &mut StakingConfig, arg1: &mut RewardPool<T1>, arg2: vector<0x2::object::ID>, arg3: address, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<0x2::object::ID>(&arg2)) {
            ...
            if (arg4) {
                ...
                let v7 = v6;
                let v8 = v5.lock_info.lock_type == 1 && v2 < v5.lock_info.lock_end_time;
                let v9 = 0;
                if (v8) {
    ...
    fun calculate_reward_for_token_type<T0>(arg0: &StakingConfig, arg1: &RewardPool<T0>, arg2: StakeInfo, arg3: 0x1::type_name::TypeName, arg4: &0x2::clock::Clock) : u64 {
        ...
        if (v6 < arg0.min_stake_period_days * 86400000) {
            return 0
        };
        if (v0 == 1) {
    ...
    public entry fun create_staking_pool<T0>(arg0: &AdminCap, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: bool, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = StakingConfig{
            ...
            max_lock_period_months    : arg8,
            early_withdrawal_fee      : arg9,
            paused                    : false,
            referral_info             : v4,
        ...
        let v6 = StakingStats{
            id                      : 0x2::object::new(arg11),
            total_staked_nfts       : 0,
            stake_info              : 0x2::table::new<0x2::object::ID, StakeInfo>(arg11),
            total_reward_multiplier : 0,
            user_stats              : 0x2::table::new<address, UserStakingStats>(arg11),
        };
    ...
    public entry fun unstake_nft<T0: store + key, T1>(arg0: &mut StakingConfig, arg1: &mut RewardPool<T1>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::dynamic_field::borrow_mut<vector<u8>, StakingStats>(&mut arg0.id, b"stats");
        assert!(0x2::table::contains<0x2::object::ID, StakeInfo>(&v2.stake_info, arg2), 5);
        let v3 = 0x2::table::borrow<0x2::object::ID, StakeInfo>(&v2.stake_info, arg2);
        assert!(v3.owner == 0x2::tx_context::sender(arg4), 1);
        assert!(v0 >= v3.stake_time + arg0.min_stake_period_days * 86400000, 31);
        let v4 = v3.owner;
        v2.total_staked_nfts = v2.total_staked_nfts - 1;
        v2.total_reward_multiplier = v2.total_reward_multiplier - v3.lock_info.reward_multiplier;
        0x2::table::remove<0x2::object::ID, StakeInfo>(&mut v2.stake_info, arg2);
        0x2::transfer::public_transfer<T0>(0x2::dynamic_field::remove<0x2::object::ID, T0>(&mut arg0.id, arg2), v4);
        let v5 = calculate_reward<T1>(arg0, arg1, *v3, arg3);
        assert!(v5 > 0, 28);
        transfer_reward<T1>(arg1, v5, v4, arg4);
        let v6 = 0x2::dynamic_field::borrow_mut<vector<u8>, StakingStats>(&mut arg0.id, b"stats");
        if (0x2::table::contains<address, UserStakingStats>(&v6.user_stats, v4)) {
            let v7 = 0x2::table::borrow_mut<address, UserStakingStats>(&mut v6.user_stats, v4);
            if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&v7.total_rewards_earned, &v1)) {
                *0x2::vec_map::get_mut<0x1::type_name::TypeName, u64>(&mut v7.total_rewards_earned, &v1) = *0x2::vec_map::get<0x1::type_name::TypeName, u64>(&v7.total_rewards_earned, &v1) + v5;
            } else {
                0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut v7.total_rewards_earned, v1, v5);
            };
        };
        if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.total_rewards_distributed, &v1)) {
            *0x2::vec_map::get_mut<0x1::type_name::TypeName, u64>(&mut arg0.total_rewards_distributed, &v1) = *0x2::vec_map::get<0x1::type_name::TypeName, u64>(&arg0.total_rewards_distributed, &v1) + v5;
        } else {
            0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut arg0.total_rewards_distributed, v1, v5);
        };
        let v8 = 0x2::vec_map::get_mut<0x1::type_name::TypeName, RewardPoolInfo>(&mut arg0.reward_pools, &v1);
        v8.reward_config.distributed_rewards = v8.reward_config.distributed_rewards + v5;
        let v9 = NFTUnstaked{
            nft_id                      : arg2,
            staker                      : v4,
            unstake_time                : v0,
    ...
    fun unstake_single_nft<T0: store + key, T1>(arg0: &mut StakingConfig, arg1: &mut RewardPool<T1>, arg2: 0x2::object::ID, arg3: address, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0;
        let v5 = v3.lock_info.lock_type == 1 && v0 < v3.lock_info.lock_end_time;
        if (arg4) {
