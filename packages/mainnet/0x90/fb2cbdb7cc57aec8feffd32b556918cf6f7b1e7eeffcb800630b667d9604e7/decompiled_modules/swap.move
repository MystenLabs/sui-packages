module 0x90fb2cbdb7cc57aec8feffd32b556918cf6f7b1e7eeffcb800630b667d9604e7::swap {
    ...
    fun apply_wrapper_fees<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : (u64, u64) {
        ...
        if (arg3 > 0) {
            let v3 = 0x90fb2cbdb7cc57aec8feffd32b556918cf6f7b1e7eeffcb800630b667d9604e7::fee::calculate_fee_by_rate(arg2, v0);
            arg2 = arg2 - v3;
        } else if (arg4 > 0) {
            let v4 = 0x90fb2cbdb7cc57aec8feffd32b556918cf6f7b1e7eeffcb800630b667d9604e7::fee::calculate_fee_by_rate(arg1, v0);
            arg1 = arg1 - v4;
        };
        (arg1, arg2)
    }

    public fun swap_exact_base_for_quote_input_fee<T0, T1>(arg0: &mut 0x90fb2cbdb7cc57aec8feffd32b556918cf6f7b1e7eeffcb800630b667d9604e7::wrapper::Wrapper, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v8 = 0x90fb2cbdb7cc57aec8feffd32b556918cf6f7b1e7eeffcb800630b667d9604e7::fee::charge_swap_fee<T1>(&mut v4, v5);
        0x90fb2cbdb7cc57aec8feffd32b556918cf6f7b1e7eeffcb800630b667d9604e7::wrapper::join_protocol_fee<T1>(arg0, v8);
        validate_minimum_output<T1>(&v4, arg3);
        let v9 = SwapExecuted<T0, T1>{
            wrapper_id      : 0x2::object::id<0x90fb2cbdb7cc57aec8feffd32b556918cf6f7b1e7eeffcb800630b667d9604e7::wrapper::Wrapper>(arg0),
    ...
    public fun swap_exact_quote_for_base_input_fee<T0, T1>(arg0: &mut 0x90fb2cbdb7cc57aec8feffd32b556918cf6f7b1e7eeffcb800630b667d9604e7::wrapper::Wrapper, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        0x90fb2cbdb7cc57aec8feffd32b556918cf6f7b1e7eeffcb800630b667d9604e7::wrapper::verify_version(arg0);
        ...
        let v4 = v0;
        let (v5, _, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_trade_params<T0, T1>(arg1);
        let v8 = 0x90fb2cbdb7cc57aec8feffd32b556918cf6f7b1e7eeffcb800630b667d9604e7::fee::charge_swap_fee<T0>(&mut v4, v5);
        0x90fb2cbdb7cc57aec8feffd32b556918cf6f7b1e7eeffcb800630b667d9604e7::wrapper::join_protocol_fee<T0>(arg0, v8);
