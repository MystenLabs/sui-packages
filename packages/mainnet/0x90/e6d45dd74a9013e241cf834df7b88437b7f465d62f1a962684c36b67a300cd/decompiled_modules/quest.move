module 0x90e6d45dd74a9013e241cf834df7b88437b7f465d62f1a962684c36b67a300cd::quest {
    ...
    public fun create_journey(arg0: &mut SpaceHub, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &SpaceAdminCap, arg3: &mut Space, arg4: u64, arg5: 0x1::string::String, arg6: u64, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x90e6d45dd74a9013e241cf834df7b88437b7f465d62f1a962684c36b67a300cd::utils::handle_payment<0x2::sui::SUI>(&mut arg0.balance, arg1, arg0.fee_for_creating_journey, arg11);
        let v0 = Journey{
    ...
    entry fun withdraw(arg0: &AdminCap, arg1: &mut SpaceHub, arg2: &mut 0x2::tx_context::TxContext) {
        check_hub_version(arg1);
        0x90e6d45dd74a9013e241cf834df7b88437b7f465d62f1a962684c36b67a300cd::utils::withdraw_balance<0x2::sui::SUI>(&mut arg1.balance, arg2);
    }
