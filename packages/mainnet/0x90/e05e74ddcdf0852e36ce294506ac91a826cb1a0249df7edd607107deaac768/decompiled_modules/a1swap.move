module 0x90e05e74ddcdf0852e36ce294506ac91a826cb1a0249df7edd607107deaac768::a1swap {
    ...
    public entry fun atomic_swap_full<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2::coin::Coin<T1>, arg2: bool, arg3: u64, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = zero_owned<T0>(arg7);
        let v1 = 0x2::coin::split<T1>(arg1, arg3, arg7);
        swap_b2a<T0, T1>(arg0, v0, v1, arg2, arg3, arg4, arg5, arg6, arg7);
    }
    ...
    public fun zero_owned<T0>(arg0: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
