module 0x90e62c8a9cf33ecca12d1b1395f712245c948cd0eeae5f6b2ebfe6ef9ba61613::turtwig {
    struct TURTWIG has drop {
        dummy_field: bool,
    }

    fun init(arg0: TURTWIG, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TURTWIG>(arg0, 6, b"Turtwig", b"Turtwig Sui", x"547572747769672069732061204772617373207479706520506f6bc3a96d6f6e20696e74726f647563656420696e2047656e65726174696f6e20342c207265636f676e697a6564206173207468652054696e79204c65616620506f6b656d6f6e2e", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/bafkreibene56kollwueqxifonu7hxjbdgokmto2ndmsuenbfc5cbfnqr2u")), arg1);
