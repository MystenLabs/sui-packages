module 0x90bdc9cfdb20117842b5382503022ccd20385a41950115be458212e560259051::nft {
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<MegaTowerNFT>(&mut v1, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(0x90bdc9cfdb20117842b5382503022ccd20385a41950115be458212e560259051::constants::project_url()));
        0x2::display::add<MegaTowerNFT>(&mut v1, 0x1::string::utf8(b"creator"), 0x1::string::utf8(0x90bdc9cfdb20117842b5382503022ccd20385a41950115be458212e560259051::constants::creator()));
