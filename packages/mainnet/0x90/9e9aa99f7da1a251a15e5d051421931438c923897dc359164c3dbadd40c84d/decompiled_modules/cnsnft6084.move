module 0x909e9aa99f7da1a251a15e5d051421931438c923897dc359164c3dbadd40c84d::cnsnft6084 {
    struct CNSNFT6084 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6084, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6084>(arg0, arg1);
