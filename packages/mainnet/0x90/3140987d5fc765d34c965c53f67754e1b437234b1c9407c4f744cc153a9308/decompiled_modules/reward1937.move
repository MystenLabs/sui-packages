module 0x903140987d5fc765d34c965c53f67754e1b437234b1c9407c4f744cc153a9308::reward1937 {
    struct REWARD1937 has drop {
        dummy_field: bool,
    }

    struct TICKET_1937 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1937(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1937>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1937>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1937, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1937>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1937>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1937>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1937>>(v5, 0x2::tx_context::sender(arg1));
    }
