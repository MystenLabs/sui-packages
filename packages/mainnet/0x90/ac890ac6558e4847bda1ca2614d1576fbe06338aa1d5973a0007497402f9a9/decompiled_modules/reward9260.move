module 0x90ac890ac6558e4847bda1ca2614d1576fbe06338aa1d5973a0007497402f9a9::reward9260 {
    struct REWARD9260 has drop {
        dummy_field: bool,
    }

    struct TICKET_9260 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9260(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9260>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9260>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9260, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9260>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9260>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9260>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9260>>(v5, 0x2::tx_context::sender(arg1));
    }
