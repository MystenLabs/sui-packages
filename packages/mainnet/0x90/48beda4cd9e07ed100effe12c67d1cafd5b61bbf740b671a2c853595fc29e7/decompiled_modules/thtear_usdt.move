module 0x9048beda4cd9e07ed100effe12c67d1cafd5b61bbf740b671a2c853595fc29e7::thtear_usdt {
    ...
    fun init(arg0: THTEAR_USDT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<THTEAR_USDT>(arg0, 9, trim_right(b"USDT"), trim_right(b"Thtear USDT"), trim_right(b""), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(trim_right(b"https://ipfs.io/ipfs/bafkreicbmczfunilkzp7c73sl7bfbar2jncttdixne2pvl73powk33x4k4"))), arg1);
        let v2 = v0;
        if (25000000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<THTEAR_USDT>>(0x2::coin::mint<THTEAR_USDT>(&mut v2, 25000000000000000, arg1), 0x2::tx_context::sender(arg1));
        };
