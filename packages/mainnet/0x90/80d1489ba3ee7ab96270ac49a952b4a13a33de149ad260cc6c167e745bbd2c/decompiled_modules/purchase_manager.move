module 0x9080d1489ba3ee7ab96270ac49a952b4a13a33de149ad260cc6c167e745bbd2c::purchase_manager {
    ...
    fun init(arg0: PURCHASE_MANAGER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://squidapp.io"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"SquidLabs"));
    ...
    public fun set_display(arg0: &0x9080d1489ba3ee7ab96270ac49a952b4a13a33de149ad260cc6c167e745bbd2c::config::PackageVersion, arg1: &0x2::package::Publisher, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: &mut 0x2::tx_context::TxContext) {
