module 0x9080d1489ba3ee7ab96270ac49a952b4a13a33de149ad260cc6c167e745bbd2c::duration {
    struct DurationManager has store {
        start_time: u64,
        white_list_duration: u64,
    ...
    public fun new(arg0: u64, arg1: u64, arg2: &0x2::clock::Clock) : DurationManager {
        assert!(current_time(arg2) <= arg0, 2);
        assert!(arg1 >= 0, 3);
        DurationManager{
            start_time          : arg0,
            white_list_duration : arg1,
            purchase_duration   : 604800,
            lock_up_duration    : 31536000,
        }
    }

    public fun update(arg0: &0x9080d1489ba3ee7ab96270ac49a952b4a13a33de149ad260cc6c167e745bbd2c::config::AdminCap, arg1: &mut DurationManager, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(is_init_period(arg1, arg4), 1);
        if (arg2 > 0) {
            assert!(current_time(arg4) < arg2, 2);
            arg1.start_time = arg2;
        };
        if (arg3 > 0) {
            arg1.white_list_duration = arg3;
        };
    }
