module 0x9080d1489ba3ee7ab96270ac49a952b4a13a33de149ad260cc6c167e745bbd2c::factory {
    ...
    public fun create_oversubscribe_pool<T0, T1>(arg0: &0x9080d1489ba3ee7ab96270ac49a952b4a13a33de149ad260cc6c167e745bbd2c::config::AdminCap, arg1: &0x9080d1489ba3ee7ab96270ac49a952b4a13a33de149ad260cc6c167e745bbd2c::config::PackageVersion, arg2: &mut Pools, arg3: address, arg4: u128, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: 0x2::coin::Coin<T0>, arg12: u64, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x9080d1489ba3ee7ab96270ac49a952b4a13a33de149ad260cc6c167e745bbd2c::oversubscribe_pool::create<T0, T1>(arg0, arg3, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14);
        let v5 = PoolInfo{
            pool_id    : v4,
            pool_key   : v2,
            sale_type  : v0,
        ...
        0x2::transfer::public_share_object<0x9080d1489ba3ee7ab96270ac49a952b4a13a33de149ad260cc6c167e745bbd2c::oversubscribe_pool::OversubcribePool<T0, T1>>(v3);
    }
    ...
    fun new_pools(arg0: &mut 0x2::tx_context::TxContext) : (Pools, 0x2::object::ID) {
        ...
        (v0, 0x2::object::uid_to_inner(&v0.id))
    }
