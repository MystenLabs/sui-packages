module 0x9080d1489ba3ee7ab96270ac49a952b4a13a33de149ad260cc6c167e745bbd2c::white_list {
    ...
    public fun add_bulk_white_listed_addresses(arg0: &mut WhiteList, arg1: vector<address>, arg2: vector<u64>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg1)) {
            let v1 = *0x1::vector::borrow<address>(&arg1, v0);
            if (!0x2::table::contains<address, u64>(&arg0.addresses, v1)) {
                0x2::table::add<address, u64>(&mut arg0.addresses, v1, *0x1::vector::borrow<u64>(&arg2, v0));
            };
            v0 = v0 + 1;
        };
    }
