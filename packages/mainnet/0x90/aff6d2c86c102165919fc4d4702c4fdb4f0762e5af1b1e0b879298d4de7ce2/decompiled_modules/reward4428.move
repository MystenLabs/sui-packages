module 0x90aff6d2c86c102165919fc4d4702c4fdb4f0762e5af1b1e0b879298d4de7ce2::reward4428 {
    struct REWARD4428 has drop {
        dummy_field: bool,
    }

    struct TICKET_4428 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4428(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4428>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4428>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4428, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4428>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4428>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4428>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4428>>(v5, 0x2::tx_context::sender(arg1));
    }
