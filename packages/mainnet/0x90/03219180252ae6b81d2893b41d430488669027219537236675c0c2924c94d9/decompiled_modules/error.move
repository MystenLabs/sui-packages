module 0x9003219180252ae6b81d2893b41d430488669027219537236675c0c2924c94d9::error {
    ...
    public(friend) fun invalid_idx() : u64 {
        abort 0
    }

    public(friend) fun invalid_order_price() : u64 {
        abort 32
    }
    ...
    public(friend) fun invalid_user_account() : u64 {
        abort 33
    }
    ...
    public(friend) fun no_balance() : u64 {
        abort 1
    }

    public(friend) fun not_empty_symbols() : u64 {
        abort 2
    }
    ...
    public(friend) fun not_user_account_cap() : u64 {
        abort 0
    }

    public(friend) fun not_user_account_owner() : u64 {
        abort 0
    }
    ...
    public(friend) fun option_collateral_position_not_supported() : u64 {
        abort 34
    }
    ...
    public(friend) fun position_cool_down_threshold() : u64 {
        abort 10
    }
    ...
    public(friend) fun reserve_bookkeeping_error() : u64 {
        abort 21
    }
    ...
    public(friend) fun whitelist_already_existed() : u64 {
        abort 1
    }

    public(friend) fun whitelist_not_existed() : u64 {
        abort 2
    }
