module 0x9024639a4c580da16002b024d25df84d15363882bcaed097f56ef9583934800c::launchpad {
    ...
    public entry fun purchase<T0>(arg0: &mut LaunchInfo<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, *0x1::vector::borrow<address>(&arg0.inviters, (((0x2::clock::timestamp_ms(arg1) as u256) * (v1 as u256) * (arg0.remain_pay_supply as u256)) as u64) % 0x1::vector::length<address>(&arg0.inviters)));
