module 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault {
    ...
    struct Vault<phantom T0, phantom T1> has key {
        ...
        time_locked_profit: 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::TimeLockedBalance<T0>,
    ...
    public(friend) fun new<T0, T1>(arg0: 0x2::coin::TreasuryCap<T1>, arg1: &mut 0x2::tx_context::TxContext) : AdminCap<T1> {
        ...
        let v0 = Vault<T0, T1>{
            ...
            time_locked_profit               : 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::create<T0>(0x2::balance::zero<T0>(), 0, 0),
            lp_treasury                      : arg0,
    ...
    public(friend) fun add_strategy<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : VaultAccess {
        ...
        let v2 = if (0x2::vec_map::length<0x2::object::ID, StrategyState>(&arg1.strategies) == 0) {
            10000
        } else {
            0
        };
    ...
    public fun calc_rebalance_amounts<T0, T1>(arg0: &Vault<T0, T1>, arg1: &0x2::clock::Clock) : RebalanceAmounts {
        ...
        let v3 = 0 + 0x2::balance::value<T0>(&arg0.free_balance) + 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::max_withdrawable<T0>(&arg0.time_locked_profit, arg1);
        let v4 = 0;
        while (v4 < 0x2::vec_map::length<0x2::object::ID, StrategyState>(&arg0.strategies)) {
        ...
        while (v10) {
            ...
            while (v11 < 0x1::vector::length<u64>(&v1)) {
                ...
                let v19 = 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::util::muldiv(v8, v15.target_alloc_weight_bps, v9);
        ...
        while (v20 < 0x1::vector::length<u64>(&v1)) {
            ...
            let v26 = 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::util::muldiv(v8, v23.target_alloc_weight_bps, v9);
            if (v26 >= v23.borrowed) {
        ...
        while (v27 < 0x1::vector::length<u64>(&v2)) {
            ...
            let v33 = 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::util::muldiv(v8, v30.target_alloc_weight_bps, v9);
            if (v33 >= v30.borrowed) {
    ...
    public fun deposit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        if (has_rate_limiter<T0, T1>(arg0)) {
            let v0 = rate_limiter_mut<T0, T1>(arg0);
            0xe829c047cf805d54bde8ff2390883004d4557193d33bac516f3232105a2f2bb2::net_sliding_sum_limiter::consume_inflow(v0, 0x2::balance::value<T0>(&arg1), arg2);
        };
        if (0x2::coin::total_supply<T1>(&arg0.lp_treasury) == 0) {
            0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.time_locked_profit, 0, arg2);
            0x2::balance::join<T0>(&mut arg0.free_balance, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::skim_extraneous_balance<T0>(&mut arg0.time_locked_profit));
            0x2::balance::join<T0>(&mut arg0.free_balance, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::withdraw_all<T0>(&mut arg0.time_locked_profit, arg2));
        ...
        let v2 = if (v1 == 0) {
            ...
            0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::util::muldiv(0x2::coin::total_supply<T1>(&arg0.lp_treasury), 0x2::balance::value<T0>(&arg1), v1)
        };
        let v3 = DepositEvent<T1>{
            amount    : 0x2::balance::value<T0>(&arg1),
            lp_minted : v2,
        };
        0x2::event::emit<DepositEvent<T1>>(v3);
    ...
    fun has_rate_limiter<T0, T1>(arg0: &Vault<T0, T1>) : bool {
        0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"rate_limiter")
    }

    entry fun migrate<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>) {
        assert!(arg1.version < 3, 10);
        arg1.version = 3;
    }
    ...
    entry fun pull_unlocked_profits_to_free_balance<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>, arg2: &0x2::clock::Clock) {
        assert_version<T0, T1>(arg1);
        0x2::balance::join<T0>(&mut arg1.free_balance, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::withdraw_all<T0>(&mut arg1.time_locked_profit, arg2));
    }

    fun rate_limiter_mut<T0, T1>(arg0: &mut Vault<T0, T1>) : &mut 0xe829c047cf805d54bde8ff2390883004d4557193d33bac516f3232105a2f2bb2::net_sliding_sum_limiter::NetSlidingSumLimiter {
        0x2::dynamic_field::borrow_mut<vector<u8>, 0xe829c047cf805d54bde8ff2390883004d4557193d33bac516f3232105a2f2bb2::net_sliding_sum_limiter::NetSlidingSumLimiter>(&mut arg0.id, b"rate_limiter")
    }
    ...
    public fun redeem_withdraw_ticket<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: WithdrawTicket<T0, T1>) : 0x2::balance::Balance<T0> {
        ...
        let v4 = v3;
        let v5 = v2;
        while (0x2::vec_map::length<0x2::object::ID, StrategyWithdrawInfo<T0>>(&v5) > 0) {
    ...
    entry fun remove_rate_limiter<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>) {
        assert_version<T0, T1>(arg1);
        0x2::dynamic_field::remove<vector<u8>, 0xe829c047cf805d54bde8ff2390883004d4557193d33bac516f3232105a2f2bb2::net_sliding_sum_limiter::NetSlidingSumLimiter>(&mut arg1.id, b"rate_limiter");
    }
    ...
    public fun remove_strategy<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>, arg2: StrategyRemovalTicket<T0, T1>, arg3: vector<0x2::object::ID>, arg4: vector<u64>, arg5: &0x2::clock::Clock) {
        ...
        if (v11 > v8) {
            0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::top_up<T0>(&mut arg1.time_locked_profit, 0x2::balance::split<T0>(&mut v2, v11 - v8), arg5);
        };
    ...
    entry fun set_max_inflow_and_outflow_limits<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>, arg2: 0x1::option::Option<u256>, arg3: 0x1::option::Option<u256>) {
        assert_version<T0, T1>(arg1);
        let v0 = rate_limiter_mut<T0, T1>(arg1);
        0xe829c047cf805d54bde8ff2390883004d4557193d33bac516f3232105a2f2bb2::net_sliding_sum_limiter::set_max_inflow_limit(v0, arg2);
        0xe829c047cf805d54bde8ff2390883004d4557193d33bac516f3232105a2f2bb2::net_sliding_sum_limiter::set_max_outflow_limit(v0, arg3);
    }
    ...
    public fun set_rate_limiter<T0, T1, T2: store>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>, arg2: T2) {
        assert_version<T0, T1>(arg1);
        0x2::dynamic_field::add<vector<u8>, T2>(&mut arg1.id, b"rate_limiter", arg2);
    }
    ...
    entry fun set_strategy_target_alloc_weights_bps<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>, arg2: vector<0x2::object::ID>, arg3: vector<u64>) {
        ...
        let v1 = 0;
        let v2 = 0;
        let v3 = 0x2::vec_map::length<0x2::object::ID, StrategyState>(&arg1.strategies);
    ...
    entry fun set_withdrawals_disabled<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>, arg2: bool) {
        assert_version<T0, T1>(arg1);
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg1.id, b"withdrawals_disabled")) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, bool>(&mut arg1.id, b"withdrawals_disabled") = arg2;
        } else {
            0x2::dynamic_field::add<vector<u8>, bool>(&mut arg1.id, b"withdrawals_disabled", arg2);
        };
    }
    ...
    public(friend) fun strategy_hand_over_profit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultAccess, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        ...
        let v0 = 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::util::muldiv(0x2::balance::value<T0>(&arg2), arg0.performance_fee_bps, 10000);
        let v1 = if (v0 > 0) {
            let v2 = 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::util::muldiv(0x2::coin::total_supply<T1>(&arg0.lp_treasury), v0, total_available_balance<T0, T1>(arg0, arg3) - v0);
        ...
        0x2::balance::join<T0>(&mut arg0.free_balance, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::withdraw_all<T0>(&mut arg0.time_locked_profit, arg3));
        0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.time_locked_profit, 0, arg3);
        let v4 = 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::skim_extraneous_balance<T0>(&mut arg0.time_locked_profit);
        0x2::balance::join<T0>(&mut v4, arg2);
        0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::change_unlock_start_ts_sec<T0>(&mut arg0.time_locked_profit, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::util::timestamp_sec(arg3), arg3);
        0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.time_locked_profit, 0x1::u64::divide_and_round_up(0x2::balance::value<T0>(&v4), arg0.profit_unlock_duration_sec), arg3);
        0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::top_up<T0>(&mut arg0.time_locked_profit, v4, arg3);
    }
    ...
    public fun total_available_balance<T0, T1>(arg0: &Vault<T0, T1>, arg1: &0x2::clock::Clock) : u64 {
        let v0 = 0 + 0x2::balance::value<T0>(&arg0.free_balance) + 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::max_withdrawable<T0>(&arg0.time_locked_profit, arg1);
        let v1 = 0;
        while (v1 < 0x2::vec_map::length<0x2::object::ID, StrategyState>(&arg0.strategies)) {
    ...
    public fun withdraw<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T1>, arg2: &0x2::clock::Clock) : WithdrawTicket<T0, T1> {
        ...
        assert!(withdrawals_disabled<T0, T1>(arg0) == false, 13);
        arg0.withdraw_ticket_issued = true;
        let v0 = create_withdraw_ticket<T0, T1>(arg0);
        0x2::balance::join<T1>(&mut v0.lp_to_burn, arg1);
        0x2::balance::join<T0>(&mut arg0.free_balance, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::withdraw_all<T0>(&mut arg0.time_locked_profit, arg2));
        let v1 = 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::util::muldiv(0x2::balance::value<T1>(&v0.lp_to_burn), total_available_balance<T0, T1>(arg0, arg2), 0x2::coin::total_supply<T1>(&arg0.lp_treasury));
        if (has_rate_limiter<T0, T1>(arg0)) {
            let v2 = rate_limiter_mut<T0, T1>(arg0);
            0xe829c047cf805d54bde8ff2390883004d4557193d33bac516f3232105a2f2bb2::net_sliding_sum_limiter::consume_outflow(v2, v1, arg2);
        };
        v0.to_withdraw_from_free_balance = 0x1::u64::min(v1, 0x2::balance::value<T0>(&arg0.free_balance));
        let v3 = v1 - v0.to_withdraw_from_free_balance;
        let v4 = v3;
        if (v3 == 0) {
            return v0
        };
        let v5 = 0;
        let v6 = 0;
        while (v6 < 0x1::vector::length<0x2::object::ID>(&arg0.strategy_withdraw_priority_order) && v4 > 0) {
            ...
            v5 = v12 - v9;
            0x2::vec_map::get_mut<0x2::object::ID, StrategyWithdrawInfo<T0>>(&mut v0.strategy_infos, v7).to_withdraw = v9;
            v6 = v6 + 1;
        };
        if (v4 == 0) {
            return v0
        ...
        while (v13 < 0x1::vector::length<0x2::object::ID>(&arg0.strategy_withdraw_priority_order)) {
            ...
            let v15 = 0x2::vec_map::get_mut<0x2::object::ID, StrategyWithdrawInfo<T0>>(&mut v0.strategy_infos, v14);
            let v16 = 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::util::muldiv(0x2::vec_map::get<0x2::object::ID, StrategyState>(&arg0.strategies, v14).borrowed - v15.to_withdraw, v4, v5);
        ...
        while (v17 < 0x1::vector::length<0x2::object::ID>(&arg0.strategy_withdraw_priority_order)) {
            ...
            let v19 = 0x2::vec_map::get_mut<0x2::object::ID, StrategyWithdrawInfo<T0>>(&mut v0.strategy_infos, v18);
            let v20 = 0x1::u64::min(0x2::vec_map::get<0x2::object::ID, StrategyState>(&arg0.strategies, v18).borrowed - v19.to_withdraw, v4);
    ...
    public fun withdraw_t_amt<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: &mut 0x2::balance::Balance<T1>, arg3: &0x2::clock::Clock) : WithdrawTicket<T0, T1> {
        let v0 = 0x2::balance::split<T1>(arg2, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::util::muldiv_round_up(arg1, 0x2::coin::total_supply<T1>(&arg0.lp_treasury), total_available_balance<T0, T1>(arg0, arg3)));
    ...
    public fun withdrawals_disabled<T0, T1>(arg0: &Vault<T0, T1>) : bool {
        0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"withdrawals_disabled") && *0x2::dynamic_field::borrow<vector<u8>, bool>(&arg0.id, b"withdrawals_disabled")
    }
