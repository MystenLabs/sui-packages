module 0x90389cf09180c6e2dab33254ade82a201d4ab6d2b3035540c6465358fcd22689::suins {
    ...
    public fun add_dynamic_field<T0: copy + drop + store, T1: store>(arg0: &AdminCap, arg1: &mut PASS, arg2: T0, arg3: T1) {
        0x2::dynamic_field::add<T0, T1>(&mut arg1.id, arg2, arg3);
    }

    public fun add_dynamic_object_field<T0: copy + drop + store, T1: store + key>(arg0: &AdminCap, arg1: &mut PASS, arg2: T0, arg3: T1) {
    ...
    public fun borrow_dynamic_field<T0: copy + drop + store, T1: store>(arg0: &PASS, arg1: T0) : &T1 {
        0x2::dynamic_field::borrow<T0, T1>(&arg0.id, arg1)
    }

    public fun borrow_dynamic_object_field<T0: copy + drop + store, T1: store + key>(arg0: &PASS, arg1: T0) : &T1 {
        0x2::dynamic_object_field::borrow<T0, T1>(&arg0.id, arg1)
    }

    public fun borrow_mut_dynamic_field<T0: copy + drop + store, T1: store>(arg0: &AdminCap, arg1: &mut PASS, arg2: T0) : &mut T1 {
        0x2::dynamic_field::borrow_mut<T0, T1>(&mut arg1.id, arg2)
    }

    public fun borrow_mut_dynamic_object_field<T0: copy + drop + store, T1: store + key>(arg0: &AdminCap, arg1: &mut PASS, arg2: T0) : &mut T1 {
        0x2::dynamic_object_field::borrow_mut<T0, T1>(&mut arg1.id, arg2)
    }

    public entry fun burn_nft(arg0: PASS, arg1: &mut NFTCollection) {
        let PASS {
            id          : v0,
            name        : _,
            description : _,
    ...
    fun create_nft(arg0: &NFTCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : PASS {
        let v0 = 0x1::string::utf8(b"SUINS Pro Pass #");
        ...
        PASS{
            ...
            name        : v0,
            description : 0x1::string::utf8(b"SUINS Pro Pass gives you access to the suinspro.com website. It is used to reward early users of the website & provide early access to the platform."),
            image_url   : v2,
            attributes  : v1,
            token_id    : arg1,
        }
    ...
    public fun get_token_id(arg0: &PASS) : u64 {
        arg0.token_id
    }
    ...
    public fun has_dynamic_field<T0: copy + drop + store>(arg0: &PASS, arg1: T0) : bool {
        0x2::dynamic_field::exists_<T0>(&arg0.id, arg1)
    }

    public fun has_dynamic_object_field<T0: copy + drop + store>(arg0: &PASS, arg1: T0) : bool {
        0x2::dynamic_object_field::exists_<T0>(&arg0.id, arg1)
    }

    fun init(arg0: SUINS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUINS>(arg0, arg1);
        ...
        let v4 = 0x2::display::new<PASS>(&v0, arg1);
        0x2::display::add<PASS>(&mut v4, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<PASS>(&mut v4, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<PASS>(&mut v4, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://images.suinssniper.com/{token_id}.png"));
        0x2::display::add<PASS>(&mut v4, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{attributes}"));
        0x2::display::update_version<PASS>(&mut v4);
        let (v5, v6) = 0x2::transfer_policy::new<PASS>(&v0, arg1);
        0x2::transfer::transfer<AdminCap>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<PASS>>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<PASS>>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<PASS>>(v5);
    ...
    public entry fun mint_all(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PASS>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 && v8 > 0) {
            while (v12 < v8) {
                ...
                0x2::kiosk::lock<PASS>(arg5, arg6, arg2, v14);
                let v15 = NFTMinted{
                    nft_id   : 0x2::object::id<PASS>(&v14),
                    token_id : v13,
                    minter   : v0,
                    phase    : 1,
                };
        ...
        if (v4 && v9 > 0) {
            ...
            while (v16 < v9) {
                ...
                0x2::kiosk::lock<PASS>(arg5, arg6, arg2, v18);
                let v19 = NFTMinted{
                    nft_id   : 0x2::object::id<PASS>(&v18),
                    token_id : v17,
                    minter   : v0,
                    phase    : 2,
                };
    ...
    public entry fun mint_phase1(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PASS>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < arg7) {
            ...
            arg0.minted = arg0.minted + 1;
            arg0.phase1_minted = arg0.phase1_minted + 1;
            0x2::kiosk::lock<PASS>(arg5, arg6, arg2, v6);
            let v7 = NFTMinted{
                nft_id   : 0x2::object::id<PASS>(&v6),
                token_id : v5,
                minter   : v0,
                phase    : 1,
            };
    ...
    public entry fun mint_phase2(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PASS>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        assert!(v1 <= arg0.phase_end, 3);
    ...
    public entry fun mint_public(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PASS>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        ...
        while (v3 < arg7) {
            ...
            0x2::kiosk::lock<PASS>(arg5, arg6, arg2, v5);
            let v6 = NFTMinted{
                nft_id   : 0x2::object::id<PASS>(&v5),
                token_id : v4,
                minter   : v0,
                phase    : 100,
            };
    ...
    public fun remove_dynamic_field<T0: copy + drop + store, T1: store>(arg0: &AdminCap, arg1: &mut PASS, arg2: T0) : T1 {
        0x2::dynamic_field::remove<T0, T1>(&mut arg1.id, arg2)
    }

    public fun remove_dynamic_object_field<T0: copy + drop + store, T1: store + key>(arg0: &AdminCap, arg1: &mut PASS, arg2: T0) : T1 {
    ...
    public entry fun team_mint(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: &0x2::transfer_policy::TransferPolicy<PASS>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 1;
        while (v0 <= 0) {
            let v1 = remove_specific_id(arg1, v0);
            let v2 = create_nft(arg1, v1, arg5);
            arg1.minted = arg1.minted + 1;
            0x2::kiosk::lock<PASS>(arg3, arg4, arg2, v2);
            let v3 = NFTMinted{
                nft_id   : 0x2::object::id<PASS>(&v2),
                token_id : v1,
    ...
    public entry fun team_mint_batch(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: &0x2::transfer_policy::TransferPolicy<PASS>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        while (arg5 <= arg6) {
            let v0 = remove_specific_id(arg1, arg5);
            let v1 = create_nft(arg1, v0, arg7);
            arg1.minted = arg1.minted + 1;
            0x2::kiosk::lock<PASS>(arg3, arg4, arg2, v1);
            let v2 = NFTMinted{
                nft_id   : 0x2::object::id<PASS>(&v1),
                token_id : v0,
