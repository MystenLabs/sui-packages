module 0x909c8dfbddbf86b68f970e4d8e9b1a767ce07f1d46b1b3d3918314e2e6c1ad08::cetus_reward_w2 {
    struct CETUS_REWARD_W2 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = CETUS_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmRnQUPsdXT2ybgTaMJw23ocHX6nwHMNpW1XKrNa11QHvu"),
            };
    ...
    fun init(arg0: CETUS_REWARD_W2, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmRnQUPsdXT2ybgTaMJw23ocHX6nwHMNpW1XKrNa11QHvu"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        let v4 = 0x2::package::claim<CETUS_REWARD_W2>(arg0, arg1);
