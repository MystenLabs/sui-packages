module 0x708bf97c029ac8363f6a0516a2e724327d84e6ff7da082da62d84b7c39a6bd47::cetus_reward_tt {
    struct CETUS_REWARD_TT has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = CETUS_REWARD{
                ...
                image_url   : 0x1::string::utf8(b"ipfs://QmQnt4tfe6kaFNuR7tVcSR7A4Ejm8GfyVEdHTKwbWQhDbN"),
                description : 0x1::string::utf8(b"TBA"),
                Reward      : 0x1::string::utf8(b"TBA"),
            };
    ...
    fun init(arg0: CETUS_REWARD_TT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmQnt4tfe6kaFNuR7tVcSR7A4Ejm8GfyVEdHTKwbWQhDbN"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        let v4 = 0x2::package::claim<CETUS_REWARD_TT>(arg0, arg1);
