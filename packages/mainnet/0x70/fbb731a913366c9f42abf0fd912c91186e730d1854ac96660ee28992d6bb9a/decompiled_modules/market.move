module 0x70fbb731a913366c9f42abf0fd912c91186e730d1854ac96660ee28992d6bb9a::market {
    ...
    entry fun new(arg0: &0x2::package::Publisher, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0);
        let v0 = Market{
            ...
            offers                      : 0x2::table::new<address, vector<0x2::object::ID>>(arg4),
            fee_percentage              : 2,
    ...
    public(friend) fun assert_active(arg0: &Market, arg1: &0x2::clock::Clock) {
        assert!(status(arg0, arg1) == 0, 9223372934503464969);
    }

    fun assert_admin(arg0: &0x2::package::Publisher) {
        assert!(0x2::package::from_module<MARKET>(arg0), 9223373162136600583);
    }

    public(friend) fun assert_closed(arg0: &Market, arg1: &0x2::clock::Clock) {
        assert!(status(arg0, arg1) == 2, 9223372977453400077);
    }

    public(friend) fun assert_coin_type<T0>(arg0: &Market) {
        assert!(0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get_with_original_ids<T0>())) == 0x1::string::into_bytes(*0x1::option::borrow<0x1::string::String>(&arg0.coin_type)), 9223373016108236815);
    }

    public(friend) fun assert_settlement(arg0: &Market, arg1: &0x2::clock::Clock) {
        assert!(status(arg0, arg1) == 1, 9223372951683465227);
    }
    ...
    entry fun settlement(arg0: &mut Market, arg1: &0x2::package::Publisher, arg2: vector<u8>, arg3: u8, arg4: &0x2::clock::Clock) {
        assert_admin(arg1);
        arg0.settlement_end_timestamp_ms = 0x1::option::some<u64>(0x2::clock::timestamp_ms(arg4) + 300000);
    ...
    entry fun unsettlement(arg0: &mut Market, arg1: &0x2::package::Publisher) {
        assert_admin(arg1);
    ...
    entry fun withdraw(arg0: &mut Market, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg1);
        0x70fbb731a913366c9f42abf0fd912c91186e730d1854ac96660ee28992d6bb9a::utils::withdraw_balance<0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN>(&mut arg0.balance, arg2);
    }
