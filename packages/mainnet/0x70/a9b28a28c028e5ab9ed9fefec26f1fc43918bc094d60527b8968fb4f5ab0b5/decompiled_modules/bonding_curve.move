module 0xb205fea41ccedac051bc66498e6ca68cb802c4a6ea06da12e524bed09c80d9b0::bonding_curve {
    ...
    fun circulating_supply<T0>(arg0: &Curve<T0>) : u64 {
        let v0 = 0x2::coin::total_supply<T0>(treasury_ref<T0>(arg0));
    ...
    fun do_graduate_inline<T0>(arg0: &mut Curve<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::balance::value<T0>(&v3) > 0) {
            let v4 = treasury_mut<T0>(arg0);
            0x2::coin::burn<T0>(v4, 0x2::coin::from_balance<T0>(v3, arg1));
        } else {
    ...
    public fun execute_buyback<T0>(arg0: &mut Curve<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.buyback.burn) {
            ...
            let v14 = 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.token_reserve, v11), arg2);
            pay_out_to_payouts<T0>(&arg0.payouts, v14, arg2);
        };
