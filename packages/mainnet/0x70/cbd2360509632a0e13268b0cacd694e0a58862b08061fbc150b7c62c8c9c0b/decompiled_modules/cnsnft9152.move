module 0x70cbd2360509632a0e13268b0cacd694e0a58862b08061fbc150b7c62c8c9c0b::cnsnft9152 {
    struct CNSNFT9152 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9152, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5611"));
        let v4 = 0x2::package::claim<CNSNFT9152>(arg0, arg1);
