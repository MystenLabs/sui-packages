module 0x70a6d2a103fb1738b20bebce6332c8199d9ac10c26f63771e545d18c1d0557eb::cnsnft2522 {
    struct CNSNFT2522 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2522, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2099"));
        let v4 = 0x2::package::claim<CNSNFT2522>(arg0, arg1);
