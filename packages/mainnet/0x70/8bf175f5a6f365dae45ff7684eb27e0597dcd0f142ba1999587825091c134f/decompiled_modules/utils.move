module 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils {
    public fun delegate_extract_balance<T0>(arg0: address, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64) : 0x2::balance::Balance<T0> {
        let (v0, v1) = public_extract_balance<T0>(arg1, arg2);
        let v2 = v0;
        while (!0x1::vector::is_empty<0x2::coin::Coin<T0>>(&v2)) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x1::vector::pop_back<0x2::coin::Coin<T0>>(&mut v2), arg0);
        };
    ...
    public fun extract_balance<T0>(arg0: vector<0x2::coin::Coin<T0>>, arg1: u64, arg2: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        delegate_extract_balance<T0>(0x2::tx_context::sender(arg2), arg0, arg1)
    }
    ...
    public fun get_flagged_u64_padding_value(arg0: &vector<u64>, arg1: u64) : (bool, u64) {
        if (0x1::vector::length<u64>(arg0) > arg1) {
            let v0 = *0x1::vector::borrow<u64>(arg0, arg1);
            if (v0 >= 9223372036854775808) {
                return (true, v0 - 9223372036854775808)
            };
        };
        (false, 0)
    }
    ...
    public fun public_extract_balance<T0>(arg0: vector<0x2::coin::Coin<T0>>, arg1: u64) : (vector<0x2::coin::Coin<T0>>, 0x2::balance::Balance<T0>) {
        ...
        assert!(arg1 == 0, insufficient_balance());
        (arg0, v0)
    }
