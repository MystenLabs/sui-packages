module 0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::policy {
    struct SlippageKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    fun assert_agent_gates(arg0: &Policy, arg1: &0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::Vault, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.agent, 13906836115668598785);
        assert!(!arg0.suspended, 13906836119963697155);
        assert!(0x2::object::id<0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::Vault>(arg1) == arg0.vault_id, 13906836124258795525);
    }
    ...
    fun assert_binding(arg0: &Policy, arg1: &0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::OwnerCap) {
        assert!(0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::owner_cap_vault_id(arg1) == arg0.vault_id, 13906836339007291399);
    }

    fun assert_slippage_in_bound<T0, T1>(arg0: &Policy, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: u128) {
        let v0 = SlippageKey{dummy_field: false};
        if (!0x2::dynamic_field::exists<SlippageKey>(&arg0.id, v0)) {
            return
        };
        let v1 = SlippageKey{dummy_field: false};
        let v2 = *0x2::dynamic_field::borrow<SlippageKey, u64>(&arg0.id, v1);
        if (v2 == 0) {
            return
        };
        assert_within_bps(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg1), arg2, v2);
    }

    fun assert_within_bps(arg0: u128, arg1: u128, arg2: u64) {
        ...
        assert!(v2 * 10000 <= v0 * (arg2 as u256), 13906836287467945995);
    }
    ...
    public fun create(arg0: &0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::Vault, arg1: &0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::OwnerCap, arg2: address, arg3: address, arg4: 0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::SpenderCap, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        assert!(0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::owner_cap_vault_id(arg1) == v0, 13906834758459326471);
        assert!(0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::spender_cap_vault_id(&arg4) == v0, 13906834762754162693);
        let v1 = Policy{
    ...
    public fun max_slippage_bps(arg0: &Policy) : 0x1::option::Option<u64> {
        let v0 = SlippageKey{dummy_field: false};
        if (0x2::dynamic_field::exists<SlippageKey>(&arg0.id, v0)) {
            let v2 = SlippageKey{dummy_field: false};
            0x1::option::some<u64>(*0x2::dynamic_field::borrow<SlippageKey, u64>(&arg0.id, v2))
        } else {
            0x1::option::none<u64>()
        }
    }
    ...
    public fun set_max_slippage_bps(arg0: &mut Policy, arg1: &0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::OwnerCap, arg2: u64) {
        assert_binding(arg0, arg1);
        assert!(arg2 <= 500, 13906835136416841741);
        let v0 = SlippageKey{dummy_field: false};
        if (0x2::dynamic_field::exists<SlippageKey>(&arg0.id, v0)) {
            let v1 = SlippageKey{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<SlippageKey, u64>(&mut arg0.id, v1) = arg2;
        } else {
            let v2 = SlippageKey{dummy_field: false};
            0x2::dynamic_field::add<SlippageKey, u64>(&mut arg0.id, v2, arg2);
        };
        emit_updated(arg0);
    }
    ...
    public fun set_pool_allowed(arg0: &mut Policy, arg1: &0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::OwnerCap, arg2: 0x2::object::ID, arg3: bool) {
        ...
        } else if (0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_pools, &arg2)) {
    ...
    public fun swap_and_route<T0, T1>(arg0: &mut Policy, arg1: &mut 0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::Vault, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: bool, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_pools, &v0), 13906835424179388425);
        assert_slippage_in_bound<T0, T1>(arg0, arg3, arg6);
    ...
    public fun swap_balance_a2b<T0, T1>(arg0: 0x2::balance::Balance<T0>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: u64, arg4: u128, arg5: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let v3 = v2;
        0x2::balance::destroy_zero<T0>(v0);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg1, arg2, 0x2::balance::split<T0>(&mut arg0, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T0, T1>(&v3)), 0x2::balance::zero<T1>(), v3);
        (arg0, v1)
    }

    public fun swap_balance_b2a<T0, T1>(arg0: 0x2::balance::Balance<T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: u64, arg4: u128, arg5: &0x2::clock::Clock) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>) {
        let (v0, v1, v2) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg1, arg2, false, true, arg3, arg4, arg5);
        let v3 = v2;
        0x2::balance::destroy_zero<T1>(v1);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg1, arg2, 0x2::balance::zero<T0>(), 0x2::balance::split<T1>(&mut arg0, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T0, T1>(&v3)), v3);
        (arg0, v0)
    }
