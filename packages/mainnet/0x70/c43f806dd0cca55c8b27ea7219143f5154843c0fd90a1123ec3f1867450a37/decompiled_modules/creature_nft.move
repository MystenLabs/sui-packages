module 0x70c43f806dd0cca55c8b27ea7219143f5154843c0fd90a1123ec3f1867450a37::creature_nft {
    ...
    public entry fun mint_creature_nft(arg0: &mut BrainrotCollection, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>();
        if (0x1::vector::length<u8>(&arg3) > 0) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0, 0x1::string::utf8(b"head"), 0x1::string::utf8(arg3));
        };
        if (0x1::vector::length<u8>(&arg4) > 0) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0, 0x1::string::utf8(b"head_accessory"), 0x1::string::utf8(arg4));
        };
        if (0x1::vector::length<u8>(&arg5) > 0) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0, 0x1::string::utf8(b"body"), 0x1::string::utf8(arg5));
        };
        if (0x1::vector::length<u8>(&arg6) > 0) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0, 0x1::string::utf8(b"hand"), 0x1::string::utf8(arg6));
        };
        if (0x1::vector::length<u8>(&arg7) > 0) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0, 0x1::string::utf8(b"leg"), 0x1::string::utf8(arg7));
        };
        if (0x1::vector::length<u8>(&arg8) > 0) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0, 0x1::string::utf8(b"environment"), 0x1::string::utf8(arg8));
        };
        let v1 = mint_nft(arg0, 0x1::string::utf8(arg1), 0x1::string::utf8(arg2), v0, 0x1::string::utf8(arg9), arg10, arg11, arg12);
        0x2::transfer::public_transfer<CreatureNFT>(v1, 0x2::tx_context::sender(arg12));
    }
