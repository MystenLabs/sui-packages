module 0x700597da5d4344c0c7ed34f6bbf9e927f57a4f292f1801a455870b15ab1ff2cf::meme_airdrop_tracker {
    ...
    struct MemeStatsUpdated has copy, drop {
        meme_address: 0x1::string::String,
        chain_id: 0x1::string::String,
        meme_name: 0x1::string::String,
        total_purchases: u64,
    ...
    public fun add_purchase_record(arg0: &GlobalConfig, arg1: &mut MemeStatsTable, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: u64, arg8: 0x1::string::String, arg9: &mut 0x2::tx_context::TxContext) : (bool, u64, u64) {
        ...
        let v8 = MemeStatsUpdated{
            meme_address            : v4.meme_address,
            chain_id                : v4.chain_id,
            meme_name               : v4.meme_name,
            total_purchases         : v4.total_purchases,
            total_purchase_count    : v4.total_purchase_count,
            total_airdrop_rounds    : v4.total_airdrop_rounds,
            executed_airdrop_rounds : v4.executed_airdrop_rounds,
            total_claims            : v4.total_claims,
            total_claimed_amount    : v4.total_claimed_amount,
            threshold               : v4.threshold,
            airdrop_ratio           : v4.airdrop_ratio,
            last_airdrop_time       : v4.last_airdrop_time,
        };
        0x2::event::emit<MemeStatsUpdated>(v8);
    ...
    public fun claim_airdrop(arg0: &mut MemeStatsTable, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = MemeStatsUpdated{
            meme_address            : v1.meme_address,
            chain_id                : v1.chain_id,
            meme_name               : v1.meme_name,
            total_purchases         : v1.total_purchases,
            total_purchase_count    : v1.total_purchase_count,
            total_airdrop_rounds    : v1.total_airdrop_rounds,
            executed_airdrop_rounds : v1.executed_airdrop_rounds,
            total_claims            : v1.total_claims,
            total_claimed_amount    : v1.total_claimed_amount,
            threshold               : v1.threshold,
            airdrop_ratio           : v1.airdrop_ratio,
            last_airdrop_time       : v1.last_airdrop_time,
        };
        0x2::event::emit<MemeStatsUpdated>(v2);
    ...
    public fun execute_airdrop(arg0: &AdminCap, arg1: &GlobalConfig, arg2: &mut MemeStatsTable, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        0x2::event::emit<MemeStatsUpdated>(v6);
        let v7 = AirdropExecuted{
            meme_address    : v1.meme_address,
            chain_id        : v1.chain_id,
            rounds_executed : v4,
            total_amount    : v5,
        ...
        0x2::event::emit<AirdropExecuted>(v7);
        (v4, v5)
    }
