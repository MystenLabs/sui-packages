module 0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::loyalty_program {
    ...
    struct CardCompleteEvent has copy, drop {
        customer: address,
        shop: address,
        card_number: u64,
        nft_id: address,
    ...
    fun award_card_completion(arg0: &LoyaltyProgram, arg1: address, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = card_size(arg0, arg2) - 1;
        let v1 = arg4 / v0;
        while (v1 < arg5 / v0) {
            ...
            let v4 = CardCompleteEvent{
                customer    : arg1,
                shop        : arg2,
                card_number : v1 + 1,
                nft_id      : 0x2::object::uid_to_address(&v2),
                timestamp   : arg6,
            };
            0x2::event::emit<CardCompleteEvent>(v4);
            0x2::transfer::transfer<RewardNFT>(v3, arg1);
            v1 = v1 + 1;
        };
    }
    ...
    public fun card_size(arg0: &LoyaltyProgram, arg1: address) : u64 {
        if (0x2::dynamic_field::exists_with_type<address, u64>(&arg0.id, arg1)) {
    ...
    public entry fun record_batch_purchases(arg0: &mut CustomerShopAccount, arg1: &mut CustomerProfile, arg2: &mut 0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::coffee_shop_registry::CoffeeShop, arg3: &mut LoyaltyProgram, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        award_card_completion(arg3, arg0.customer, v1, arg1.level, arg0.purchases, arg0.purchases, v0, arg6);
    ...
    public entry fun record_purchase(arg0: &mut CustomerShopAccount, arg1: &mut CustomerProfile, arg2: &mut 0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::coffee_shop_registry::CoffeeShop, arg3: &mut LoyaltyProgram, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        award_card_completion(arg3, arg0.customer, v1, arg1.level, arg0.purchases, arg0.purchases, v0, arg5);
    }
    ...
    public entry fun record_purchase_attested(arg0: &mut CustomerShopAccount, arg1: &mut CustomerProfile, arg2: &mut 0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::coffee_shop_registry::CoffeeShop, arg3: &mut LoyaltyProgram, arg4: &StampAuthority, arg5: vector<u8>, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        award_card_completion(arg3, arg0.customer, v1, arg1.level, arg0.purchases, arg0.purchases, v0, arg9);
    }
    ...
    public entry fun set_card_size(arg0: &mut LoyaltyProgram, arg1: &0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::coffee_shop_registry::CoffeeShop, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::coffee_shop_registry::get_shop_owner(arg1);
        assert!(0x2::tx_context::sender(arg3) == v0, 2);
        assert!(arg2 >= 2, 15);
        if (0x2::dynamic_field::exists_with_type<address, u64>(&arg0.id, v0)) {
            *0x2::dynamic_field::borrow_mut<address, u64>(&mut arg0.id, v0) = arg2;
        } else {
            0x2::dynamic_field::add<address, u64>(&mut arg0.id, v0, arg2);
        };
    }
