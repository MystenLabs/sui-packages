module 0x70fca4b4624f06ec3967d982bc7712a5da21a77047659e4ad52ca8f662d7a48b::nft {
    ...
    struct Registry has key {
        ...
        bet_rounds: vector<BetRound>,
        betted_image_url: vector<u8>,
    }
    ...
    public entry fun add_operator(arg0: &0x2::package::Publisher, arg1: &mut Registry, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<Registry>(arg0), 23);
    ...
    public entry fun bet(arg0: &0x2::clock::Clock, arg1: &mut Registry, arg2: vector<CubicNft>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<BetRound>(&arg1.bet_rounds) - 1;
        let v1 = 0x1::vector::borrow_mut<BetRound>(&mut arg1.bet_rounds, v0);
        assert!(v1.winner_guild_num == 0, 21);
        let v2 = 0x2::clock::timestamp_ms(arg0);
        assert!(v2 >= v1.start_time && v2 < v1.end_time, 21);
        let v3 = 0x2::tx_context::sender(arg4);
        assert!(!0x1::vector::contains<address>(&v1.user_addrs, &v3), 22);
        let v4 = 0x1::vector::empty<0x2::object::ID>();
        let v5 = 0;
        while (v5 < 0x1::vector::length<CubicNft>(&arg2)) {
            let v6 = 0x1::vector::pop_back<CubicNft>(&mut arg2);
            let v7 = Attribute{
                name  : 0x1::string::utf8(b"Betted"),
                value : 0x1::string::utf8(b"33X Token Reward"),
            };
            assert!(!0x1::vector::contains<Attribute>(&v6.attributes, &v7), 25);
            0x1::vector::push_back<0x2::object::ID>(&mut v4, 0x2::object::id<CubicNft>(&v6));
            v6.image_url = 0x2::url::new_unsafe_from_bytes(arg1.betted_image_url);
            v6.attributes = 0x1::vector::empty<Attribute>();
            let v8 = &mut v6.attributes;
            add_attribute(v8, b"Betted", b"33X Token Reward");
            v6.opened = true;
            0x2::transfer::public_transfer<CubicNft>(v6, v3);
            v5 = v5 + 1;
        };
        ...
        0x1::vector::push_back<address>(&mut v1.user_addrs, v3);
        0x1::vector::push_back<Bet>(&mut v1.bets, v9);
        let v10 = BetEvent{
            user_addr : v3,
            nft_ids   : v4,
            guild_num : arg3,
    ...
    public entry fun createRegistry(arg0: &0x2::package::Publisher, arg1: &Collection, arg2: bool, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = BetRound{
            ...
            winner_guild_num : 0,
            user_addrs       : 0x1::vector::empty<address>(),
            winners          : 0x1::vector::empty<address>(),
        };
        let v1 = 0x1::vector::empty<BetRound>();
        0x1::vector::push_back<BetRound>(&mut v1, v0);
        let v2 = Registry{
            id               : 0x2::object::new(arg4),
            collection       : 0x2::object::id<Collection>(arg1),
            status           : arg2,
            operators        : 0x2::table::new<address, bool>(arg4),
            bet_rounds       : v1,
            betted_image_url : arg3,
        };
    ...
    fun isWhitelist<T0>(arg0: &mut Phaser<T0>, arg1: u64, arg2: vector<vector<u8>>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        0x70fca4b4624f06ec3967d982bc7712a5da21a77047659e4ad52ca8f662d7a48b::merkle_proof::verify(&arg2, arg3, 0x1::hash::sha2_256(0x2::bcs::to_bytes<Ticket>(&v0)))
    }
    ...
    fun mint<T0>(arg0: &0x2::clock::Clock, arg1: &mut Collection, arg2: &mut Phaser<T0>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v8 < arg3) {
            ...
            let v12 = &mut v11;
            add_attribute(v12, b"Unbetted", b"1X Token Reward");
            let v13 = CubicNft{
    ...
    public entry fun oneRegistry(arg0: &0x2::package::Publisher, arg1: &Collection, arg2: bool, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        createRegistry(arg0, arg1, arg2, arg3, arg4);
    }
    ...
    public entry fun set_winner(arg0: &0x2::clock::Clock, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<address, bool>(&arg1.operators, 0x2::tx_context::sender(arg4)), 24);
        assert!(arg2 == 0x1::vector::length<BetRound>(&arg1.bet_rounds) - 1, 20);
        let v0 = 0x1::vector::borrow_mut<BetRound>(&mut arg1.bet_rounds, arg2);
        v0.winner_guild_num = arg3;
        let v1 = 0;
        while (v1 < 0x1::vector::length<address>(&v0.user_addrs)) {
            let v2 = 0x1::vector::borrow<Bet>(&v0.bets, v1);
            if (v2.guild_num == arg3) {
                0x1::vector::push_back<address>(&mut v0.winners, v2.user_addr);
            };
            v1 = v1 + 1;
        };
        ...
        let v4 = BetRound{
            id               : 0x2::object::new(arg4),
            start_time       : v3,
            end_time         : v3 + 86400000,
            bets             : 0x1::vector::empty<Bet>(),
            winner_guild_num : 0,
            user_addrs       : 0x1::vector::empty<address>(),
            winners          : 0x1::vector::empty<address>(),
        };
        0x1::vector::push_back<BetRound>(&mut arg1.bet_rounds, v4);
    }
