module 0x704596ec157c59eff020d2d0bb117360314f3d1a1da8b16933ea62bcba8f109b::bluemove_launchpad {
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = LaunchpadData{
            ...
            current_nft    : 0,
            current_place  : 0,
            base_name      : 0x1::string::utf8(b"BlueMove x Navi #"),
            base_image_url : 0x1::string::utf8(b"https://ipfs.bluemove.net/uploads2/navi/avatar.mp4"),
            base_url       : 0x1::string::utf8(b"https://bluemovecdn.s3.ap-northeast-1.amazonaws.com/bluemove-navi/"),
            description    : 0x1::string::utf8(b"A commemorative NFT collection marks the exclusive StakeFit.com powered by BlueMove and Navi Protocol collaboration"),
