module 0x70874e01aaaddd65da1940a5dc0432f6158b6c73190256f413341de589893734::royalty_proportional_rule {
    ...
    public fun new<T0: drop>(arg0: 0x70874e01aaaddd65da1940a5dc0432f6158b6c73190256f413341de589893734::royalty_share::Shares, arg1: u16, arg2: &mut 0x2::tx_context::TxContext) : RoyaltyProportional<T0> {
    ...
    public fun pay<T0: drop, T1: store + key>(arg0: &0x2::transfer_policy::TransferPolicy<T1>, arg1: &mut 0x2::transfer_policy::TransferRequest<T1>, arg2: &mut RoyaltyProportional<T0>, arg3: 0x70874e01aaaddd65da1940a5dc0432f6158b6c73190256f413341de589893734::royalty_basis::RoyaltyBasis<T0>, arg4: &mut 0x2::balance::Balance<0x2::sui::SUI>) {
        let v0 = Rule{dummy_field: false};
        assert!(0x2::object::id<RoyaltyProportional<T0>>(arg2) == 0x2::transfer_policy::get_rule<T1, Rule, Config>(v0, arg0).royalty_id, 0);
        0x2::balance::join<0x2::sui::SUI>(&mut arg2.balance, 0x2::balance::split<0x2::sui::SUI>(arg4, (((0x70874e01aaaddd65da1940a5dc0432f6158b6c73190256f413341de589893734::royalty_basis::basis<T0>(&arg3) as u128) * (arg2.amount_bps as u128) / (10000 as u128)) as u64)));
