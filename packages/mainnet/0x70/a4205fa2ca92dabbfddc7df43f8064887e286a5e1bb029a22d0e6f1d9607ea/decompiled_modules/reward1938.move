module 0x70a4205fa2ca92dabbfddc7df43f8064887e286a5e1bb029a22d0e6f1d9607ea::reward1938 {
    struct REWARD1938 has drop {
        dummy_field: bool,
    }

    struct TICKET_1938 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1938(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1938>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1938>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1938, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1938>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1938>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1938>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1938>>(v5, 0x2::tx_context::sender(arg1));
    }
