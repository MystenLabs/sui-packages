module 0x707cc6230b51ca25cd2bc2b4955d275071836b087741623cec99303dcb561996::usdt {
    ...
    fun init(arg0: USDT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3, v4) = 0x2::coin::create_regulated_currency_v2<USDT>(arg0, 6, trim_right(b"USDT"), trim_right(b"USDT  "), trim_right(b"USDT "), v1, true, arg1);
        let v5 = v2;
        let v6 = 0x2::tx_context::sender(arg1);
        if (10000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<USDT>>(0x2::coin::mint<USDT>(&mut v5, 10000000000000, arg1), v6);
        };
