module 0x7023263662175fab1a6a29ee51b85aa40f3d59cf8d324c53d0d16ed3b7a08b33::balls {
    ...
    fun init(arg0: BALLS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/5zn1VMUeYhZXY8rdwgLEMqQkYXLgWcoKpwM1hpuReRDo.png                                                                                                                                                                                                                               ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BALLS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BALLS     ")))), trim_right(b"Diamond Balls                   "), trim_right(b"Diamond Balls                                                                                                                                                                                                                                                                                                                   "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
