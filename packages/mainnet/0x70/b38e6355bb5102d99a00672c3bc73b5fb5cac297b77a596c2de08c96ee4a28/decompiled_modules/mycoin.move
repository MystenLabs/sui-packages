module 0x70b38e6355bb5102d99a00672c3bc73b5fb5cac297b77a596c2de08c96ee4a28::mycoin {
    ...
    fun init(arg0: MYCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MYCOIN>(arg0, 9, b"U5DT ", b"Tgtex ", b"My custom token", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://bridge-assets.sui.io/usdt.png")), arg1);
        let v2 = v0;
        0x2::coin::mint_and_transfer<MYCOIN>(&mut v2, 80000001000000000, 0x2::tx_context::sender(arg1), arg1);
