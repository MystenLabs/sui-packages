module 0x704707920b6c122e15a27d230105abeb7f167d58aa7b04be63138fc5d58054d0::manifest69b {
    struct MANIFEST69B has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MANIFEST69B, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MANIFEST69B>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"MANIFEST69B"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"$manifest"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiboiig7yrombhehnskcuqlbc7nzrdg5mgm6d6jhtiuzicel56macy"));
