module 0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::bee {
    struct BEE has drop {
        dummy_field: bool,
    }
    ...
    public fun transfer_bees<T0>(arg0: &mut 0x2::token::Token<T0>, arg1: &0x2::token::TokenPolicyCap<T0>, arg2: &mut 0x2::token::TokenPolicy<T0>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::mul_div_u128((arg3 as u128), (*0x2::vec_map::get<0x1::string::String, u64>(&0x2::token::rule_config<T0, Burn, BurnCondition>(v1, arg2).percent, &v2) as u128), (100 as u128));
