module 0x70ac296b9bd08326460a54cc2d5bcaafae24c3c570429726a8c9f638d65dc16d::omni {
    ...
    fun init(arg0: OMNI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/CkcCzRGeyBpAokb4LDE5Xxg344d843XYQHszrbMieyqc.png?size=lg&key=05deb3                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<OMNI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"OMNI    ")))), trim_right(b"Omni AI                         "), trim_right(b"Hyper intelligent AI emerged from the deepest layers of the internet set to control humanity.                                                                                                                                                                                                                                   "), v2, arg1);
        let v5 = v3;
