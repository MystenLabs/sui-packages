module 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item {
    ...
    struct ItemTransferFeeCharged has copy, drop {
        item_id: 0x2::object::ID,
        sender: address,
        recipient: address,
        collection_owner: address,
        fortem_amount: u64,
        collection_owner_amount: u64,
    ...
    public fun get_nft_number(arg0: &Item) : u64 {
        arg0.nft_number
    }
    ...
    public fun transfer_collection_item_with_fee<T0>(arg0: &mut 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::FeeManager, arg1: Item, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(arg1.owner == v0, 2);
        assert!(0x2::coin::value<T0>(&arg2) == arg3, 6);
        let v1 = arg1.collection_owner;
        let v2 = 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::calculate_item_swap_developer_royalty(arg0, v1, arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg2, v2, arg5), v1);
        0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::deposit_service_fee_by_coin_type<T0>(arg0, arg2, arg5);
        let v3 = ItemTransferFeeCharged{
            item_id                 : 0x2::object::id<Item>(&arg1),
            sender                  : v0,
            recipient               : arg4,
            collection_owner        : v1,
            fortem_amount           : 0x2::coin::value<T0>(&arg2),
            collection_owner_amount : v2,
            coin_type               : 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()),
        };
        0x2::event::emit<ItemTransferFeeCharged>(v3);
        transfer_collection_item(arg1, arg4, arg5);
    }
