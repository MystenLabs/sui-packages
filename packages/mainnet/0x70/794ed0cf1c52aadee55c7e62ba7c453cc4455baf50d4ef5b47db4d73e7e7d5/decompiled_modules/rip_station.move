module 0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::rip_station {
    ...
    struct PacksBoughtOrderEvent has copy, drop {
        order_id: u128,
    }
    ...
    entry fun buy_packs<T0>(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut Store, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg7: bool, arg8: u128, arg9: u64, arg10: vector<u8>, arg11: &mut 0x2::tx_context::TxContext) {
        verify_version(arg2);
        assert!(0x2::clock::timestamp_ms(arg0) < arg9, 6);
        assert!(!0x2::table::contains<u128, bool>(&arg2.orders, arg8), 5);
        let v0 = 0x1::vector::empty<u8>();
        ...
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<u64>(&arg4));
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<u64>(&arg5));
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<bool>(&arg7));
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<u128>(&arg8));
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<u64>(&arg9));
        assert!(0x2::ed25519::ed25519_verify(&arg10, &arg2.public_key, &v0), 4);
        let (v2, v3) = 0x2::kiosk::new(arg11);
        let v4 = v3;
        let v5 = v2;
        let v6 = &mut v5;
        buy_packs_into_kiosk<T0>(arg1, arg2, arg3, arg4, arg5, arg6, v6, &v4, arg7, arg11);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v5);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::transfer_to_sender(0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::new(&mut v5, v4, arg11), arg11);
        0x2::table::add<u128, bool>(&mut arg2.orders, arg8, true);
        let v7 = PacksBoughtOrderEvent{order_id: arg8};
        0x2::event::emit<PacksBoughtOrderEvent>(v7);
    }
    ...
    entry fun buy_packs_for_recipient<T0>(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut Store, arg3: 0x1::string::String, arg4: u64, arg5: bool, arg6: address, arg7: u64, arg8: vector<u8>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<0x1::string::String, Config>(&arg2.vault_configs, arg3), 11);
        let v2 = 0x2::table::borrow<0x1::string::String, Config>(&arg2.vault_configs, arg3).price;
        let (v3, v4) = 0x2::kiosk::new(arg9);
        let v5 = v4;
        let v6 = v3;
        let v7 = 0x2::coin::zero<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg9);
        let v8 = &mut v6;
        buy_packs_into_kiosk<T0>(arg1, arg2, arg3, arg4, v2, v7, v8, &v5, arg5, arg9);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::create_for(&mut v6, v5, arg6, arg9);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v6);
    }

    fun buy_packs_into_kiosk<T0>(arg0: &0x2::random::Random, arg1: &mut Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: bool, arg9: &mut 0x2::tx_context::TxContext) {
        verify_version(arg1);
        assert!(0x2::table::contains<0x1::string::String, 0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::vault::Vault>(&arg1.vaults, arg2), 10);
        ...
        if (0x2::tx_context::sender(arg9) != arg1.operator) {
            assert!(0x2::coin::value<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&arg5) == arg3 * arg4, 3);
        };
        0x2::balance::join<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg1.balance, 0x2::coin::into_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg5));
        let v3 = 0x2::random::new_generator(arg0, arg9);
        let v4 = &mut v3;
        ...
        while (arg3 > 0) {
            ...
            while (v6 < v1.pack_size) {
                ...
                0x2::kiosk::lock<0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::card::Card<T0>>(arg6, arg7, 0x2::bag::borrow<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicy<0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::card::Card<T0>>>(&arg1.transfer_policies, 0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::vault::card_type(v0)), v8);
                v6 = v6 + 1;
            };
        ...
        if (arg8) {
            deposit_cards_for_reveal<T0>(arg1, v5, arg6, arg7, arg9);
        };
    }

    entry fun buy_packs_with_personal_kiosk<T0>(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut Store, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg7: &mut 0x2::kiosk::Kiosk, arg8: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg9: bool, arg10: u128, arg11: u64, arg12: vector<u8>, arg13: &mut 0x2::tx_context::TxContext) {
        verify_version(arg2);
        assert!(0x2::clock::timestamp_ms(arg0) < arg11, 6);
        assert!(!0x2::table::contains<u128, bool>(&arg2.orders, arg10), 5);
        let v0 = 0x1::vector::empty<u8>();
        ...
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<u64>(&arg4));
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<u64>(&arg5));
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<bool>(&arg9));
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<u128>(&arg10));
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<u64>(&arg11));
        assert!(0x2::ed25519::ed25519_verify(&arg12, &arg2.public_key, &v0), 4);
        buy_packs_into_kiosk<T0>(arg1, arg2, arg3, arg4, arg5, arg6, arg7, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg8), arg9, arg13);
        0x2::table::add<u128, bool>(&mut arg2.orders, arg10, true);
        let v2 = PacksBoughtOrderEvent{order_id: arg10};
        0x2::event::emit<PacksBoughtOrderEvent>(v2);
    }
