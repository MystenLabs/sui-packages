module 0x7019b7a168e0205f992b625ce3548a3a461f0f2bbbb6b036d2de660aee53e11a::cnsnft9832 {
    struct CNSNFT9832 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9832, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1834"));
        let v4 = 0x2::package::claim<CNSNFT9832>(arg0, arg1);
