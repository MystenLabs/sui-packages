module 0x705b48d247295eeef8bc959d92ea3837974cf9df7fb165cfcb53280b7de93f12::cnsnft8324 {
    struct CNSNFT8324 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8324, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7584"));
        let v4 = 0x2::package::claim<CNSNFT8324>(arg0, arg1);
