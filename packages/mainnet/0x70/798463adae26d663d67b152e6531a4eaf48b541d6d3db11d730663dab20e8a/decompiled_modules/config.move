module 0x97fea95545c04dc73f8174c6195013b100a26e3fa978e7cf8b100a51dfaf8354::config {
    ...
    struct NotionalLimitSet has copy, drop {
        config: 0x2::object::ID,
        previous_usd: u64,
        usd: u64,
    }
    ...
    public fun migrate(arg0: &mut Config, arg1: &AdminCap) {
        ...
        if (0x2::dynamic_field::exists<VersionKey>(&arg0.id, v0)) {
            let v1 = VersionKey{dummy_field: false};
            0x2::dynamic_field::remove<VersionKey, u64>(&mut arg0.id, v1);
        };
        let v2 = VersionKey{dummy_field: false};
        0x2::dynamic_field::add<VersionKey, u64>(&mut arg0.id, v2, 17);
    }
    ...
    public fun params_copy(arg0: &Config) : Params {
        arg0.params
    }
    ...
    public fun set_max_notional(arg0: &mut Config, arg1: &AdminCap, arg2: u64) {
        authorize(arg0, arg1);
        assert!(arg2 >= 1000 && arg2 <= 100000000, 1);
        arg0.params.max_notional_usd = arg2;
        let v0 = NotionalLimitSet{
            config       : 0x2::object::id<Config>(arg0),
            previous_usd : arg0.params.max_notional_usd,
            usd          : arg2,
        };
        0x2::event::emit<NotionalLimitSet>(v0);
    }
    ...
    public fun validate(arg0: &Params) {
        ...
        assert!(v1, 1);
        assert!(arg0.max_notional_usd >= 1000 && arg0.max_notional_usd <= 100000000, 1);
    }
    ...
    public fun version(arg0: &Config) : u64 {
        ...
        if (0x2::dynamic_field::exists<VersionKey>(&arg0.id, v0)) {
            let v2 = VersionKey{dummy_field: false};
            *0x2::dynamic_field::borrow<VersionKey, u64>(&arg0.id, v2)
        } else {
            0
        }
    }
    ...
    public fun with_max_notional(arg0: Params, arg1: u64) : Params {
        arg0.max_notional_usd = arg1;
        arg0
    }
