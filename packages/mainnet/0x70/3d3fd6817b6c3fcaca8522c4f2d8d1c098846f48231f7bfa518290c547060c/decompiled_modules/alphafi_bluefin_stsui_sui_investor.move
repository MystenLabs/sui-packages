module 0xeea4b39278f417d8320a581b34af2f312c505f89d94a9e74a16c0964cc5ba0d1::alphafi_bluefin_stsui_sui_investor {
    ...
    fun autocompound_internal<T0: drop, T1, T2>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T1>, arg5: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<T0>, arg6: &mut 0x3::sui_system::SuiSystemState, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, bool) {
        ...
        let (_, _, v9, v10) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_fee<T0, T1>(arg7, arg2, arg3, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"));
        let v11 = v10;
        let v12 = v9;
        let v13 = (0x2::coin::value<T1>(&v0) as u128) * (arg0.performance_fee as u128) / 10000 + (0x2::balance::value<T0>(&v12) as u128) * (arg0.performance_fee as u128) / 10000;
        let v14 = (0x2::balance::value<T1>(&v11) as u128) * (arg0.performance_fee as u128) / 10000;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v12, (v13 as u64)), arg8), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::get_fee_wallet_address(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v11, (v14 as u64)), arg8), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::get_fee_wallet_address(arg1));
        let (v15, v16) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, v12, v11, arg3, arg5, arg6, arg8);
        let (_, v18, v19, v20) = get_balances_in_ratio<T0, T1>(arg0, v15, v16, arg3, true, arg8);
        let v21 = v19;
        let v22 = v18;
        ...
        let v25 = AutoCompoundingEvent{
            ...
            fee_collected_a   : (v13 as u64),
            fee_collected_b   : (v14 as u64),
    ...
    fun convert_inner_type<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: 0x2::balance::Balance<T2>) : 0x2::balance::Balance<T3> {
        update_free_rewards<T0, T1, T2>(arg0, arg1);
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::get<T3>()) == true, 9223373578748035071);
    ...
    fun get_total_balance_in_ratio_with_limit<T0: drop, T1>(arg0: &mut Investor<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<T0>, arg5: &mut 0x3::sui_system::SuiSystemState, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        if (v16 > 0) {
            ...
            let v22 = convert_inner_type<T0, T1, 0x2::sui::SUI, T1>(arg0, v21);
            ...
            let v27 = convert_inner_type<T0, T1, T1, 0x2::sui::SUI>(arg0, v26);
    ...
    public fun rebalance_v2<T0: drop, T1, T2>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::RebalanceCap, arg2: &0xeea4b39278f417d8320a581b34af2f312c505f89d94a9e74a16c0964cc5ba0d1::version::Version, arg3: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: u32, arg6: u32, arg7: u32, arg8: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg9: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T1>, arg10: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<T0>, arg11: &mut 0x3::sui_system::SuiSystemState, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        while (v10 < arg7 + 1) {
            ...
            let (_, _, v13, v14) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::remove_liquidity<T0, T1>(arg4, arg8, &mut v0, v8, arg12);
            let v15 = v14;
            let v16 = v13;
            ...
            let (v17, v18) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, v16, v15, arg8, arg10, arg11, arg13);
            let (_, v20, v21, v22) = get_balances_in_ratio<T0, T1>(arg0, v17, v18, arg8, true, arg13);
            let v23 = v21;
            let v24 = v20;
            if (0x2::balance::value<T0>(&v24) > 100 || 0x2::balance::value<T1>(&v23) > 100) {
                let (v25, v26) = if (0x2::balance::value<T0>(&v24) == 0 || v22 == false) {
                    let (v27, v28, v29, v30) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg12, arg4, arg8, &mut v1, v24, v23, 0x2::balance::value<T1>(&v23), false);
                    let _ = v28;
                    let _ = v27;
                    (v29, v30)
                } else {
                    let (v33, v34, v35, v36) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg12, arg4, arg8, &mut v1, v24, v23, 0x2::balance::value<T0>(&v24), true);
                    let _ = v34;
                    let _ = v33;
                    (v35, v36)
                };
        ...
        let (v37, v38, v39) = autocompound_internal<T0, T1, T2>(arg0, arg3, arg4, arg8, arg9, arg10, arg11, arg12, arg13);
        let v40 = v38;
        let v41 = v37;
        close_position<T0, T1>(arg8, 0x2::dynamic_field::remove<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"), arg4, arg12);
        ...
        if (0x2::balance::value<T0>(&v41) > 100 || 0x2::balance::value<T1>(&v40) > 100) {
            deposit<T0, T1>(arg0, arg4, arg8, v41, v40, v39, arg12);
        } else {
            0x2::balance::join<T0>(&mut arg0.free_balance_a, v41);
            0x2::balance::join<T1>(&mut arg0.free_balance_b, v40);
        };
        let v42 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::liquidity(0x2::dynamic_field::borrow<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&arg0.id, b"Position"));
        let (v43, v44) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::get_amount_by_liquidity(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.lower_tick), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.upper_tick), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg8), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg8), v42, false);
        let v45 = RebalancePoolEvent{
            investor_id       : 0x2::object::uid_to_inner(&arg0.id),
            amount_a_before   : v3,
            amount_b_before   : v4,
            amount_a_after    : v43,
        ...
        0x2::event::emit<RebalancePoolEvent>(v45);
