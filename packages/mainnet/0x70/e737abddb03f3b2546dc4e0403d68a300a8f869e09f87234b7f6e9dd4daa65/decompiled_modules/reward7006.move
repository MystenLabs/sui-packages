module 0x70e737abddb03f3b2546dc4e0403d68a300a8f869e09f87234b7f6e9dd4daa65::reward7006 {
    struct REWARD7006 has drop {
        dummy_field: bool,
    }

    struct TICKET_7006 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7006(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7006>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7006>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7006, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7006>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7006>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7006>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7006>>(v5, 0x2::tx_context::sender(arg1));
    }
