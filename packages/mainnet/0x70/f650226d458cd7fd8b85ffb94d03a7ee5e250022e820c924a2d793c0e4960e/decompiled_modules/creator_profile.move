module 0x70f650226d458cd7fd8b85ffb94d03a7ee5e250022e820c924a2d793c0e4960e::creator_profile {
    ...
    public entry fun create_profile(arg0: &0x70f650226d458cd7fd8b85ffb94d03a7ee5e250022e820c924a2d793c0e4960e::user_profile::UserProfile, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(0x70f650226d458cd7fd8b85ffb94d03a7ee5e250022e820c924a2d793c0e4960e::user_profile::get_user(arg0) == v0, 1);
        assert!(0x70f650226d458cd7fd8b85ffb94d03a7ee5e250022e820c924a2d793c0e4960e::user_profile::is_creator(arg0), 4);
        let v2 = CreatorProfile{
            id                : 0x2::object::new(arg4),
            creator           : v0,
            user_profile_id   : 0x2::object::id<0x70f650226d458cd7fd8b85ffb94d03a7ee5e250022e820c924a2d793c0e4960e::user_profile::UserProfile>(arg0),
            handle            : arg1,
            banner_url        : arg2,
