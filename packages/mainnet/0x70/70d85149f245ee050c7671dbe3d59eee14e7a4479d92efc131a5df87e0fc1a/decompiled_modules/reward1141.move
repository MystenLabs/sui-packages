module 0x7070d85149f245ee050c7671dbe3d59eee14e7a4479d92efc131a5df87e0fc1a::reward1141 {
    struct REWARD1141 has drop {
        dummy_field: bool,
    }

    struct TICKET_1141 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1141(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1141>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1141>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1141, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1141>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1141>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1141>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1141>>(v5, 0x2::tx_context::sender(arg1));
    }
