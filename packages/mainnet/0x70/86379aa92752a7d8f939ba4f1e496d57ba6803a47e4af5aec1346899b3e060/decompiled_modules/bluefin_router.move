module 0x7086379aa92752a7d8f939ba4f1e496d57ba6803a47e4af5aec1346899b3e060::bluefin_router {
    ...
    public entry fun buy_exact_in<T0, T1>(arg0: &FeeObject, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: u64, arg7: u128, arg8: &0x2::clock::Clock, arg9: bool, arg10: 0x1::string::String, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = arg5 - v0;
        if (arg9) {
            0x7086379aa92752a7d8f939ba4f1e496d57ba6803a47e4af5aec1346899b3e060::utils::send_coin<T0>(0x2::coin::split<T0>(&mut arg3, v0, arg11), arg0.admin);
        } else {
            0x7086379aa92752a7d8f939ba4f1e496d57ba6803a47e4af5aec1346899b3e060::utils::send_coin<T1>(0x2::coin::split<T1>(&mut arg4, v0, arg11), arg0.admin);
        };
        ...
        0x7086379aa92752a7d8f939ba4f1e496d57ba6803a47e4af5aec1346899b3e060::utils::send_balance<T0>(v5, 0x2::tx_context::sender(arg11), arg11);
        0x7086379aa92752a7d8f939ba4f1e496d57ba6803a47e4af5aec1346899b3e060::utils::send_balance<T1>(v4, 0x2::tx_context::sender(arg11), arg11);
        if (arg9) {
            let v7 = BuyEvent<T1>{
    ...
    public entry fun sell_exact_in<T0, T1>(arg0: &FeeObject, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: u64, arg7: u128, arg8: &0x2::clock::Clock, arg9: bool, arg10: 0x1::string::String, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg9) {
            0x7086379aa92752a7d8f939ba4f1e496d57ba6803a47e4af5aec1346899b3e060::utils::send_coin<T1>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v2, v5), arg11), arg0.admin);
        } else {
            0x7086379aa92752a7d8f939ba4f1e496d57ba6803a47e4af5aec1346899b3e060::utils::send_coin<T0>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v3, v5), arg11), arg0.admin);
        };
        assert!(v4 - v5 >= arg6, 1);
        0x7086379aa92752a7d8f939ba4f1e496d57ba6803a47e4af5aec1346899b3e060::utils::send_balance<T0>(v3, 0x2::tx_context::sender(arg11), arg11);
        0x7086379aa92752a7d8f939ba4f1e496d57ba6803a47e4af5aec1346899b3e060::utils::send_balance<T1>(v2, 0x2::tx_context::sender(arg11), arg11);
        if (arg9) {
            let v6 = SellEvent<T0>{
                recipient  : 0x2::tx_context::sender(arg11),
                amount_in  : arg5,
