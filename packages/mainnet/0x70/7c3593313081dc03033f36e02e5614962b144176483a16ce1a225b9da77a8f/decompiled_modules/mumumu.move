module 0x707c3593313081dc03033f36e02e5614962b144176483a16ce1a225b9da77a8f::mumumu {
    ...
    public entry fun airdrop(arg0: &mut Mumumu, arg1: address, arg2: u64, arg3: &0x2::transfer_policy::TransferPolicy<NFT>, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: MUMUMU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = &mut v4;
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"D #{token_id}"));
    ...
    public fun paused(arg0: &Mumumu) : u8 {
        arg0.paused
    }
    ...
    public entry fun set_paused(arg0: &mut Mumumu, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0);
    ...
    public entry fun update_royalty_policy(arg0: &Mumumu, arg1: &mut 0x2::transfer_policy::TransferPolicy<NFT>, arg2: &0x2::transfer_policy::TransferPolicyCap<NFT>, arg3: u16, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
