module 0x70572d4baafa9c40547dce2bf0f13fca3e5b9c65cec6b5a0152ce7e3c675cccd::gift1784 {
    struct GIFT1784 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift1784(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT1784, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1784>(arg0, arg1);
