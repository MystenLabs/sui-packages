module 0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::farm {
    ...
    public(friend) fun add_balance_to_compounding_asset<T0>(arg0: &mut Farm, arg1: 0x2::balance::Balance<T0>) {
        let v0 = 0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::utils::get_type_name_str<T0>();
    ...
    public(friend) fun add_liquidity_with_return<T0, T1, T2>(arg0: &mut Farm, arg1: &mut 0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::position::JewelTurbosPosition, arg2: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg3: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg4: vector<0x2::coin::Coin<T0>>, arg5: vector<0x2::coin::Coin<T1>>, arg6: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let (v0, _) = 0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::position::get_position_info(arg1);
        ...
        let (v8, v9) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::increase_liquidity_with_return_<T0, T1, T2>(arg2, arg3, arg4, arg5, arg6, arg7, arg8, 0, 0, 0x2::clock::timestamp_ms(arg9) + 60000, arg9, arg10, arg11);
        let (_, _, v12) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg3, v2);
        let v13 = if (v5 == 0) {
            v12 - v5
        } else {
            v7 * (v12 - v5) / v5
        };
        0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::position::increase_share(arg1, v13);
        arg0.total_share = arg0.total_share + v13;
        (v8, v9)
    }

    public fun borrow_mut_turbos_position_nft(arg0: &mut Farm) : &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT {
    ...
    public(friend) fun create_farm<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg2: vector<0x2::coin::Coin<T0>>, arg3: vector<0x2::coin::Coin<T1>>, arg4: u32, arg5: bool, arg6: u32, arg7: bool, arg8: u64, arg9: u64, arg10: &0x2::clock::Clock, arg11: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::position::transfer_position_and_coins<T0, T1>(0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::position::new(v9, v7, arg12), v1, v2, 0x2::tx_context::sender(arg12));
    ...
    public(friend) fun do_distribute_fee_or_reward<T0>(arg0: &0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::global_config::GlobalConfig, arg1: &mut Farm, arg2: 0x2::coin::Coin<T0>) {
        let v0 = 0x2::coin::into_balance<T0>(arg2);
        add_balance_to_protocol_asset<T0>(arg1, 0x2::balance::split<T0>(&mut v0, 0x2::balance::value<T0>(&v0) * 0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::global_config::get_global_config_info(arg0) / 100000));
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::permission::new_admin(0x2::tx_context::sender(arg0), arg0);
        0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::global_config::new_global_config(5000, arg0);
    }
    ...
    public(friend) fun remove_liquidity_with_return<T0, T1, T2>(arg0: &mut Farm, arg1: &mut 0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::position::JewelTurbosPosition, arg2: u128, arg3: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg5: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT, arg6: &0x2::clock::Clock, arg7: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let (v0, v1) = 0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::position::get_position_info(arg1);
        assert!(v0 == 0x2::object::id<Farm>(arg0), 101);
        assert!(arg2 <= v1, 102);
        let v2 = get_turbos_position_nft_address(arg0);
        ...
        let (_, v7) = get_farm_info(arg0);
        let v8 = v5 * arg2 / v7;
        let (v9, v10) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::decrease_liquidity_with_return_<T0, T1, T2>(arg3, arg4, arg5, v8, 0, 0, 0x2::clock::timestamp_ms(arg6) + 60000, arg6, arg7, arg8);
        let (_, _, v13) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg4, v2);
        assert!(v8 == v5 - v13, 103);
        0x4c5fda184a01e211d0f8d3f051b0c164494be7552079d6ba92fc818c2e35350::position::decrease_share(arg1, arg2);
