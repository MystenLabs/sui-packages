module 0x67b49498b9e3d942c9ba3c5442fc85aa2011abcdc1a2edf73d83cb4af46f46e0::pawtato_tool_upgrades {
    ...
    fun internal_consume_quality_upgrade<T0>(arg0: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg7: &mut ToolUpgrades, arg8: &0x2::random::Random, arg9: &mut 0x2::tx_context::TxContext) : bool {
        check_version(arg7);
        check_not_paused(arg7);
        assert!(0x2::coin::value<T0>(&arg2) >= arg3, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_item_insufficient_payment());
        ...
        assert!(0x1::option::is_some<u64>(&v0), 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_quality_not_initialized());
        ...
        assert!(v2 < 100, 100);
        let v3 = 0x2::random::new_generator(arg8, arg9);
        let v4 = 0x2::random::generate_u64(&mut v3) % 10000 < arg4;
        let v5 = if (v4) {
            let v6 = v2 + arg5;
            if (v6 > 100) {
                100
        ...
        0x2::event::emit<ToolQualityUpgraded>(v7);
        v4
    }
    ...
    public entry fun upgrade_version(arg0: &ToolUpgradeAdminCap, arg1: &mut ToolUpgrades, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version < 1, 13906835514373177343);
        arg1.version = 1;
    }
