module 0x4ec932daa5676dcdf45490d9e4a4a669b0b43d4c3a52c16a90b087dd769fd6e::cnsnft4087 {
    struct CNSNFT4087 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4087, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4087>(arg0, arg1);
