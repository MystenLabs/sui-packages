module 0x4143d932a93fa6ea60ca11b77e7c19473ede04e6fa48fd5b0b5f72232fc848d::reward2407 {
    struct REWARD2407 has drop {
        dummy_field: bool,
    }

    struct TICKET_2407 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2407(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2407>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2407>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2407, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2407>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2407>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2407>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2407>>(v5, 0x2::tx_context::sender(arg1));
    }
