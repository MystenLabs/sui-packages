module 0x42376a479cb25e1047a45e00d0ca81e90fb979fcfca08c4dbdcf2a93beb1b55::req_helpers {
    ...
    public(friend) fun BRIDGE_CHANNEL() : vector<u8> {
        b"Merlin mBTC Bridge"
    }

    public(friend) fun ETH_SIGN_HEADER() : vector<u8> {
        x"19457468657265756d205369676e6564204d6573736167653a0a"
    }

    public(friend) fun EXPIRE_EXTRA_PERIOD() : u64 {
        345600
    }

    public(friend) fun EXPIRE_PERIOD() : u64 {
        259200
    }

    public(friend) fun PROPOSE_PERIOD() : u64 {
        172800
    }
    ...
    public(friend) fun amountFrom(arg0: vector<u8>, arg1: &ReqHelpersStorage) : u64 {
        ...
        let v1 = v0;
        let v2 = *0x2::table::borrow<u8, u8>(&arg1.tokenDecimals, decodeTokenIndex(arg0));
        if (v2 > 6) {
            v1 = v0 * 0x1::u64::pow(10, v2 - 6);
        } else if (v2 < 6) {
            v1 = v0 / 0x1::u64::pow(10, 6 - v2);
        };
        v1
    }

    public(friend) fun assertFromChainOnly(arg0: vector<u8>) {
        assert!(164 == *0x1::vector::borrow<u8>(&arg0, 16), 4);
    }

    public(friend) fun assertToChainOnly(arg0: vector<u8>) {
        assert!(164 == *0x1::vector::borrow<u8>(&arg0, 17), 5);
    }

    public(friend) fun checkCreatedTimeFrom(arg0: vector<u8>, arg1: &0x2::clock::Clock) : u64 {
        let v0 = createdTimeFrom(arg0);
        assert!(v0 > 0x2::clock::timestamp_ms(arg1) / 1000 - PROPOSE_PERIOD(), 6);
        assert!(v0 < 0x2::clock::timestamp_ms(arg1) / 1000 + 60, 7);
        v0
    }

    public(friend) fun checkTokenType<T0>(arg0: u8, arg1: &ReqHelpersStorage) {
        assert!(*0x2::table::borrow<u8, 0x1::type_name::TypeName>(&arg1.tokens, arg0) == 0x1::type_name::get<T0>(), 9);
    }
    ...
    public(friend) fun msgFromReqSigningMessage(arg0: vector<u8>) : vector<u8> {
        ...
        let v1 = &v0;
        if (*v1 == 1) {
            let v3 = BRIDGE_CHANNEL();
            let v4 = 0x1::vector::empty<vector<u8>>();
            let v5 = &mut v4;
            0x1::vector::push_back<vector<u8>>(v5, ETH_SIGN_HEADER());
            0x1::vector::push_back<vector<u8>>(v5, 0x42376a479cb25e1047a45e00d0ca81e90fb979fcfca08c4dbdcf2a93beb1b55::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v3) + 29 + 66));
            0x1::vector::push_back<vector<u8>>(v5, b"[");
            0x1::vector::push_back<vector<u8>>(v5, BRIDGE_CHANNEL());
            ...
            let v6 = BRIDGE_CHANNEL();
            let v7 = 0x1::vector::empty<vector<u8>>();
            let v8 = &mut v7;
            0x1::vector::push_back<vector<u8>>(v8, ETH_SIGN_HEADER());
            0x1::vector::push_back<vector<u8>>(v8, 0x42376a479cb25e1047a45e00d0ca81e90fb979fcfca08c4dbdcf2a93beb1b55::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v6) + 31 + 66));
            0x1::vector::push_back<vector<u8>>(v8, b"[");
            0x1::vector::push_back<vector<u8>>(v8, BRIDGE_CHANNEL());
            ...
            assert!(*v1 == 3, 10);
            let v9 = BRIDGE_CHANNEL();
            let v10 = 0x1::vector::empty<vector<u8>>();
            let v11 = &mut v10;
            0x1::vector::push_back<vector<u8>>(v11, ETH_SIGN_HEADER());
            0x1::vector::push_back<vector<u8>>(v11, 0x42376a479cb25e1047a45e00d0ca81e90fb979fcfca08c4dbdcf2a93beb1b55::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v9) + 29 + 66));
            0x1::vector::push_back<vector<u8>>(v11, b"[");
            0x1::vector::push_back<vector<u8>>(v11, BRIDGE_CHANNEL());
