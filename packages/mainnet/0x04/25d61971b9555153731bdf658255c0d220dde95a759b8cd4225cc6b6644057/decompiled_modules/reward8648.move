module 0x425d61971b9555153731bdf658255c0d220dde95a759b8cd4225cc6b6644057::reward8648 {
    struct REWARD8648 has drop {
        dummy_field: bool,
    }

    struct TICKET_8648 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8648(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8648>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8648>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8648, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8648>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8648>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8648>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8648>>(v5, 0x2::tx_context::sender(arg1));
    }
