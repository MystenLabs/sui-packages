module 0x4d11d0f44957d4a6219e896d5ad8a49fffa88d7e8131777707fd2fcf2803917::usdt {
    ...
    fun init(arg0: USDT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (15000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<USDT>>(0x2::coin::mint<USDT>(&mut v5, 15000000000000, arg1), v6);
        };
