module 0x4acc1afae796ae00132a045bc682a629932ca9ec270dac79eb8d48b249088d8::navi_reward_w9 {
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = NAVI_REWARD{
                ...
                image_url   : 0x1::string::utf8(b"ipfs://QmdsHGpreY4v5HKeYrTajF1Fdmrf659DWQ5tMMgyZBc7kB"),
    ...
    fun init(arg0: NAVI_REWARD_W9, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmdsHGpreY4v5HKeYrTajF1Fdmrf659DWQ5tMMgyZBc7kB"));
