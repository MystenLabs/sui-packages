module 0x42314748192959439919df45a46dd6c724d6a382935d338ecb74b58781d75f0::vault {
    ...
    entry fun change_limit<T0>(arg0: &mut Vault<T0>, arg1: &0x42314748192959439919df45a46dd6c724d6a382935d338ecb74b58781d75f0::owner_cap::OwnerCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun create_vault<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x42314748192959439919df45a46dd6c724d6a382935d338ecb74b58781d75f0::owner_cap::create_owner_cap(&v0.id, 0x2::tx_context::sender(arg2), arg2);
    ...
    entry fun liquidate_vault<T0>(arg0: &mut Vault<T0>, arg1: &0x42314748192959439919df45a46dd6c724d6a382935d338ecb74b58781d75f0::owner_cap::OwnerCap, arg2: &mut 0x2::tx_context::TxContext) {
        0x42314748192959439919df45a46dd6c724d6a382935d338ecb74b58781d75f0::owner_cap::is_owned(&arg0.id, arg1);
