module 0x4e482b7d0cc6aaca9b45f84c004a78fe8258f71c22dd202acf6e5a17421ff7d::woofi {
    ...
    fun init(arg0: WOOFI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"qqbIklXst5_hxgcO                                                                                                                                                                                                                                                                                                                ");
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<WOOFI>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<WOOFI>>(v4);
    }
