module 0x4a71c22c146b721bb237445aa651ce65bf0bf96f906a06b24267855bc88fc06::hsui_vault {
    ...
    fun calculate_staked_sui_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &0x3::staking_pool::StakedSui, arg2: u64) : u64 {
        0x4a71c22c146b721bb237445aa651ce65bf0bf96f906a06b24267855bc88fc06::helper::calculate_rewards(arg0, 0x3::staking_pool::pool_id(arg1), 0x3::staking_pool::staked_sui_amount(arg1), 0x3::staking_pool::stake_activation_epoch(arg1), arg2)
    }
    ...
    public fun query_all_staked_sui_objs_for_pool(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &HSuiVault, arg2: address, arg3: 0x1::option::Option<u64>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (vector<u64>, vector<u64>, vector<u64>, vector<u64>, u64) {
        ...
        while (0x1::option::is_some<u64>(&v6) && 0 < arg4) {
            ...
            0x1::vector::push_back<u64>(&mut v4, 0x4a71c22c146b721bb237445aa651ce65bf0bf96f906a06b24267855bc88fc06::helper::calculate_rewards(arg0, 0x3::staking_pool::pool_id(v8), v10, v9, 0x2::tx_context::epoch(arg5)));
    ...
    public fun query_staked_sui_obj_for_pool(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &HSuiVault, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        (v1, v2, 0x4a71c22c146b721bb237445aa651ce65bf0bf96f906a06b24267855bc88fc06::helper::calculate_rewards(arg0, 0x3::staking_pool::pool_id(v0), v2, v1, 0x2::tx_context::epoch(arg4)))
    }
