module 0x4fd9ac29eec38d6e97993fae3934f170ac64de7eb8832af0309cb046b004bf5::party {
    ...
    public entry fun consumeCoin<T0>(arg0: &mut Reserve<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::coin::destroy_zero<T0>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.sui, 5), arg1));
    }
    ...
    public entry fun testSwap<T0, T1, T2>(arg0: &mut Reserve<T0>, arg1: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg2: &0x2::clock::Clock, arg3: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::swap_router::swap_a_b<T0, T1, T2>(arg1, 0x2::coin::divide_into_n<T0>(&mut v0, 1, arg4), 100000000, 0, 4295048016, true, @0x5062e00485cc6992d6d2cf4356898fde27fa1392444b4d278ef5dd50cc7f49f3, 1786901767461, arg2, arg3, arg4);
