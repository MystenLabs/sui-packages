module 0x4b012eff9e38f7a6bd37e7f26cf825f6cd039f862a3a5206656596807863b07f::getYourThing {
    ...
    struct WeaponObject has store, key {
        id: 0x2::object::UID,
    ...
    entry fun Migrate(arg0: Weapon, arg1: &mut 0x2::tx_context::TxContext) {
        let Weapon {
            id        : v0,
            image     : v1,
            name      : v2,
        ...
        0x2::transfer::public_transfer<WeaponObject>(v5, 0x2::tx_context::sender(arg1));
    }
    ...
    entry fun getYourWeapon(arg0: &WeaponMap, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = WeaponObject{
            ...
            image_url : *0x1::vector::borrow<0x1::string::String>(0x1::vector::borrow<vector<0x1::string::String>>(&arg0.map, v1), 1),
        ...
        let v3 = WepaonMinted{
            id       : 0x2::object::id<WeaponObject>(&v2),
            name     : v2.name,
            receiver : 0x2::tx_context::sender(arg2),
        };
        0x2::event::emit<WepaonMinted>(v3);
        0x2::transfer::public_transfer<WeaponObject>(v2, 0x2::tx_context::sender(arg2));
    }
