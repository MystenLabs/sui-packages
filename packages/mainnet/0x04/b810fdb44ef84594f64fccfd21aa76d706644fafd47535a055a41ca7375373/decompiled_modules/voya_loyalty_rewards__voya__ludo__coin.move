module 0x4b810fdb44ef84594f64fccfd21aa76d706644fafd47535a055a41ca7375373::voya_loyalty_rewards__voya__ludo__coin {
    ...
    fun init(arg0: VOYA_LOYALTY_REWARDS__VOYA__LUDO__COIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::token::new_policy<VOYA_LOYALTY_REWARDS__VOYA__LUDO__COIN>(&v0, arg1);
        let v3 = v2;
        let v4 = v1;
        0x746d4e65fe817d0528d097a5e44de2a2266373fb45dc902886a870ad664188a0::core::set_rules<VOYA_LOYALTY_REWARDS__VOYA__LUDO__COIN>(&mut v4, &v3, arg1);
        0x746d4e65fe817d0528d097a5e44de2a2266373fb45dc902886a870ad664188a0::core::create_protected_treasury_policy_caps<VOYA_LOYALTY_REWARDS__VOYA__LUDO__COIN>(v0, v3, arg1);
        0x2::token::share_policy<VOYA_LOYALTY_REWARDS__VOYA__LUDO__COIN>(v4);
    }
