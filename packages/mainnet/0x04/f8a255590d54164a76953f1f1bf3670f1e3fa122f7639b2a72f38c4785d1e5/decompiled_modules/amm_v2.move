module 0x4f8a255590d54164a76953f1f1bf3670f1e3fa122f7639b2a72f38c4785d1e5::amm_v2 {
    ...
    fun calculate_lp_mint_amount(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u128) : u64 {
        ...
        let v2 = (0x1::u64::sqrt(v0 + arg1 + arg3) as u128) * (0x1::u64::sqrt(v1 + arg2 + arg4) as u128);
        let v3 = if (arg0 == 0) {
            (0x1::u64::sqrt(arg3) as u128) * (0x1::u64::sqrt(arg4) as u128)
        } else {
    ...
    public fun create_pool_with_lp_tokens<T0, T1>(arg0: &mut Global, arg1: &mut PoolRegistry, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: u64, arg6: u8, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: vector<u8>, arg11: u64, arg12: u64, arg13: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        if (v6 > 0) {
            ...
            let v7 = calculate_lp_mint_amount(0, v6, 0, arg11, arg12, v2);
            if (v7 > 0) {
                v4.lp_supply = v7;
