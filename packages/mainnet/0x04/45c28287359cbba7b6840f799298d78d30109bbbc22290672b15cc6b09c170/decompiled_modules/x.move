module 0x445c28287359cbba7b6840f799298d78d30109bbbc22290672b15cc6b09c170::x {
    struct X has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: X, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<X>(arg0, 7, b"x", b"x", b"sfdsfds", v1, arg1);
        let v4 = v2;
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<X>>(v3);
        0x2::coin::mint_and_transfer<X>(&mut v4, 100000000000000, v0, arg1);
