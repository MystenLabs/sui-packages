module 0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::vault {
    ...
    struct Treasury has key {
        id: 0x2::object::UID,
        rewardsTreasury: 0x2::balance::Balance<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>,
    ...
    public entry fun getReward(arg0: &mut UserState, arg1: &mut RewardState, arg2: &mut Treasury, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        *v1 = 0;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>>(0x2::coin::take<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>(&mut arg2.rewardsTreasury, *v1, arg4), 0x2::tx_context::sender(arg4));
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Treasury{
            id                  : 0x2::object::new(arg0),
            rewardsTreasury     : 0x2::balance::zero<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>(),
    ...
    public entry fun setRewardAmount(arg0: &AdminCap, arg1: 0x2::coin::Coin<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>, arg2: &mut UserState, arg3: &mut RewardState, arg4: &mut Treasury, arg5: &0x2::clock::Clock) {
        let v0 = 0x2::coin::value<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>(&arg1);
        ...
        0x2::balance::join<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>(&mut arg4.rewardsTreasury, 0x2::coin::into_balance<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>(arg1));
        ...
        assert!(arg3.rewardRate * arg3.duration <= 0x2::balance::value<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>(&arg4.rewardsTreasury), 103);
    ...
    public entry fun stake(arg0: 0x2::coin::Coin<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>, arg1: u64, arg2: &mut UserState, arg3: &mut RewardState, arg4: &mut Treasury, arg5: &mut 0x2::coin::TreasuryCap<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>>(0x2::coin::mint<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>(arg5, v3, arg7), v0);
    ...
    public entry fun withdraw(arg0: &mut UserState, arg1: &mut RewardState, arg2: &mut Treasury, arg3: &mut 0x2::coin::TreasuryCap<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::burn<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>(arg3, 0x2::coin::take<0x43ad0ebeb17b7086bb795148101151f30a9be81afa6226c680e98f4dd1fb95d::stpop::STPOP>(&mut arg2.rewardsTreasury, v11, arg6));
