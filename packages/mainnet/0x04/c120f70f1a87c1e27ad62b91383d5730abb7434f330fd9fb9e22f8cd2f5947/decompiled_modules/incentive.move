module 0x4c120f70f1a87c1e27ad62b91383d5730abb7434f330fd9fb9e22f8cd2f5947::incentive {
    ...
    struct EraningObject has copy, drop {
        pool: address,
        amount: u256,
        funds: address,
    }
    ...
    public fun calculate_user_effective_amount(arg0: u8, arg1: u256, arg2: u256, arg3: u256) : u256 {
        ...
        let v2 = 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::ray_math::ray_mul(arg3, arg2);
        if (arg1 > v2) {
            return arg1 - v2
        };
        0
    ...
    public fun earned(arg0: &0x2::clock::Clock, arg1: &Incentive, arg2: &mut 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::Storage, arg3: u8, arg4: u8, arg5: address) : (vector<address>, vector<u64>) {
        let v0 = 0x1::vector::empty<address>();
        let v1 = 0x1::vector::empty<u64>();
        let (_, _, v4) = get_pool_from_asset_and_option(arg1, arg3, arg4);
        let v5 = v4;
        let v6 = 0x1::vector::length<address>(&v5);
        let (v7, v8) = 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::get_user_balance(arg2, arg3, arg5);
        while (v6 > 0) {
            let v9 = 0x2::table::borrow<address, IncentivePool>(&arg1.pools, *0x1::vector::borrow<address>(&v5, v6 - 1));
            calculate_user_effective_amount(arg4, v7, v8, v9.factor);
            let v10 = 0;
            if (0x2::table::contains<address, u256>(&v9.total_claimed_of_users, arg5)) {
                v10 = *0x2::table::borrow<address, u256>(&v9.total_claimed_of_users, arg5);
            };
            0x1::vector::push_back<address>(&mut v0, *0x1::vector::borrow<address>(&v5, v6 - 1));
            0x1::vector::push_back<u64>(&mut v1, (v10 as u64));
            v6 = v6 - 1;
        };
        (v0, v1)
    }
    ...
    public fun get_pool_to_object(arg0: &0x2::clock::Clock, arg1: &Incentive, arg2: &mut 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::Storage, arg3: u8, arg4: u8, arg5: address) : vector<EraningObject> {
        let v0 = 0x1::vector::empty<EraningObject>();
        ...
        while (v5 > 0) {
            let v8 = 0x2::table::borrow<address, IncentivePool>(&arg1.pools, *0x1::vector::borrow<address>(&v4, v5 - 1));
            calculate_user_effective_amount(arg4, v6, v7, v8.factor);
            let v9 = 0;
            if (0x2::table::contains<address, u256>(&v8.total_claimed_of_users, arg5)) {
                v9 = *0x2::table::borrow<address, u256>(&v8.total_claimed_of_users, arg5);
            };
            let v10 = EraningObject{
                pool   : 0x2::object::uid_to_address(&v8.id),
                amount : v9,
                funds  : v8.funds,
            };
            0x1::vector::push_back<EraningObject>(&mut v0, v10);
            v5 = v5 - 1;
        };
        v0
    }
    ...
    fun update_reward_one(arg0: &0x2::clock::Clock, arg1: &mut IncentivePool, arg2: u256, arg3: address, arg4: u256) {
        ...
        let v2 = arg1.index_reward + 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::safe_math::div(0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::safe_math::mul((calculate_release_rate(arg1) as u256), ((v1 - arg1.last_update_at) as u256)), arg2);
