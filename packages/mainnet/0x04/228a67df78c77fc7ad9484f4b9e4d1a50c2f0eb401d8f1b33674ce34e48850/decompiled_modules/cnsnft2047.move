module 0x4228a67df78c77fc7ad9484f4b9e4d1a50c2f0eb401d8f1b33674ce34e48850::cnsnft2047 {
    struct CNSNFT2047 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2047, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6128"));
        let v4 = 0x2::package::claim<CNSNFT2047>(arg0, arg1);
