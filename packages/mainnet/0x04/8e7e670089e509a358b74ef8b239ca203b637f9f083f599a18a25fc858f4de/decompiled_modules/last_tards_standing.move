module 0x48e7e670089e509a358b74ef8b239ca203b637f9f083f599a18a25fc858f4de::last_tards_standing {
    ...
    public fun boink(arg0: &mut LastTardsStanding, arg1: &mut 0x2::balance::Balance<0x2cddfc6d4fc855917e990e71cd122b1ee8098aa890186ee15a84524ed17cd8c9::suitard::SUITARD>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<0x2cddfc6d4fc855917e990e71cd122b1ee8098aa890186ee15a84524ed17cd8c9::suitard::SUITARD>(arg1) >= 69000000000, 4);
        if ((0x2::clock::timestamp_ms(arg2) <= arg0.end_time || 0x2::linked_table::length<u64, address>(&arg0.last_tards) < 10) && !arg0.has_ended) {
            ...
            if (arg0.total_boinks == 10) {
                arg0.end_time = 0x2::clock::timestamp_ms(arg2) + 60000;
            } else if (arg0.total_boinks > 10) {
                arg0.end_time = arg0.end_time + 60000;
            };
            0x2::balance::join<0x2cddfc6d4fc855917e990e71cd122b1ee8098aa890186ee15a84524ed17cd8c9::suitard::SUITARD>(&mut arg0.booty, 0x2::balance::split<0x2cddfc6d4fc855917e990e71cd122b1ee8098aa890186ee15a84524ed17cd8c9::suitard::SUITARD>(arg1, 69000000000));
    ...
    public fun settle(arg0: &LilTurd, arg1: &mut LastTardsStanding, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2cddfc6d4fc855917e990e71cd122b1ee8098aa890186ee15a84524ed17cd8c9::suitard::SUITARD> {
        ...
        while (!0x2::linked_table::is_empty<u64, address>(&arg1.last_tards)) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2cddfc6d4fc855917e990e71cd122b1ee8098aa890186ee15a84524ed17cd8c9::suitard::SUITARD>>(0x2::coin::from_balance<0x2cddfc6d4fc855917e990e71cd122b1ee8098aa890186ee15a84524ed17cd8c9::suitard::SUITARD>(0x2::balance::split<0x2cddfc6d4fc855917e990e71cd122b1ee8098aa890186ee15a84524ed17cd8c9::suitard::SUITARD>(&mut arg1.booty, 0x2::balance::value<0x2cddfc6d4fc855917e990e71cd122b1ee8098aa890186ee15a84524ed17cd8c9::suitard::SUITARD>(&arg1.booty) * (10000 - 2000) / 10 * 10000), arg3), v1);
        };
