module 0xfbe80a932600e422235aa6cbff8d30f106ea354723ba1b31008dcf2c7f55f5c6::sui_swapper {
    ...
    public entry fun magma_swap_a_to_b<T0, T1>(arg0: &mut SwapperConfig, arg1: &mut CoinVault<T0>, arg2: u64, arg3: u64, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 6);
        assert!(0x2::tx_context::sender(arg6) == arg0.swap_op, 5);
        assert!(arg2 > 0, 3);
        assert!(0x2::balance::value<T0>(&arg1.balance) >= arg2, 2);
        arg0.total_volume = arg0.total_volume + arg2;
        let (v0, v1) = 0xfbe80a932600e422235aa6cbff8d30f106ea354723ba1b31008dcf2c7f55f5c6::magma_clmm_integration::magma_clmm_swap_a_to_b<T0, T1>(0x2::coin::take<T0>(&mut arg1.balance, arg2, arg6), arg3, arg4, arg5, arg6);
        let v2 = v1;
        let v3 = v0;
        let v4 = SwapEvent{
            pool_id    : 0xfbe80a932600e422235aa6cbff8d30f106ea354723ba1b31008dcf2c7f55f5c6::magma_clmm_integration::get_magma_clmm_pool_id(&v2),
            a2b        : true,
            amount_in  : arg2,
            amount_out : 0x2::coin::value<T1>(&v3),
            fee_amount : 0xfbe80a932600e422235aa6cbff8d30f106ea354723ba1b31008dcf2c7f55f5c6::magma_clmm_integration::get_magma_clmm_fee(&v2),
            operator   : 0x2::tx_context::sender(arg6),
        };
    ...
    public entry fun magma_swap_b_to_a<T0, T1>(arg0: &mut SwapperConfig, arg1: &mut CoinVault<T1>, arg2: u64, arg3: u64, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 6);
        assert!(0x2::tx_context::sender(arg6) == arg0.swap_op, 5);
        assert!(arg2 > 0, 3);
        assert!(0x2::balance::value<T1>(&arg1.balance) >= arg2, 2);
        arg0.total_volume = arg0.total_volume + arg2;
        let (v0, v1) = 0xfbe80a932600e422235aa6cbff8d30f106ea354723ba1b31008dcf2c7f55f5c6::magma_clmm_integration::magma_clmm_swap_b_to_a<T0, T1>(0x2::coin::take<T1>(&mut arg1.balance, arg2, arg6), arg3, arg4, arg5, arg6);
        let v2 = v1;
        let v3 = v0;
        let v4 = SwapEvent{
            pool_id    : 0xfbe80a932600e422235aa6cbff8d30f106ea354723ba1b31008dcf2c7f55f5c6::magma_clmm_integration::get_magma_clmm_pool_id(&v2),
    ...
    public entry fun momentum_swap_a_to_b<T0, T1>(arg0: &mut SwapperConfig, arg1: &mut CoinVault<T0>, arg2: u64, arg3: u64, arg4: u128, arg5: address, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 6);
        assert!(0x2::tx_context::sender(arg7) == arg0.swap_op, 5);
        assert!(arg2 > 0, 3);
        assert!(0x2::balance::value<T0>(&arg1.balance) >= arg2, 2);
        arg0.total_volume = arg0.total_volume + arg2;
        let (v0, v1) = 0xfbe80a932600e422235aa6cbff8d30f106ea354723ba1b31008dcf2c7f55f5c6::momentum_clmm_integration::momentum_clmm_swap_a_to_b<T0, T1>(0x2::coin::take<T0>(&mut arg1.balance, arg2, arg7), arg3, arg5, arg4, arg6, arg7);
        let v2 = v1;
        let v3 = v0;
        let v4 = SwapEvent{
            pool_id    : 0xfbe80a932600e422235aa6cbff8d30f106ea354723ba1b31008dcf2c7f55f5c6::momentum_clmm_integration::get_momentum_clmm_pool_id(&v2),
            a2b        : true,
            amount_in  : arg2,
            amount_out : 0x2::coin::value<T1>(&v3),
            fee_amount : 0xfbe80a932600e422235aa6cbff8d30f106ea354723ba1b31008dcf2c7f55f5c6::momentum_clmm_integration::get_momentum_clmm_fee(&v2),
            operator   : 0x2::tx_context::sender(arg7),
        };
        0x2::event::emit<SwapEvent>(v4);
    ...
    public entry fun momentum_swap_b_to_a<T0, T1>(arg0: &mut SwapperConfig, arg1: &mut CoinVault<T1>, arg2: u64, arg3: u64, arg4: u128, arg5: address, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 6);
        assert!(0x2::tx_context::sender(arg7) == arg0.swap_op, 5);
        assert!(arg2 > 0, 3);
        assert!(0x2::balance::value<T1>(&arg1.balance) >= arg2, 2);
        arg0.total_volume = arg0.total_volume + arg2;
        let (v0, v1) = 0xfbe80a932600e422235aa6cbff8d30f106ea354723ba1b31008dcf2c7f55f5c6::momentum_clmm_integration::momentum_clmm_swap_b_to_a<T0, T1>(0x2::coin::take<T1>(&mut arg1.balance, arg2, arg7), arg3, arg5, arg4, arg6, arg7);
        let v2 = v1;
        let v3 = v0;
        let v4 = SwapEvent{
            pool_id    : 0xfbe80a932600e422235aa6cbff8d30f106ea354723ba1b31008dcf2c7f55f5c6::momentum_clmm_integration::get_momentum_clmm_pool_id(&v2),
