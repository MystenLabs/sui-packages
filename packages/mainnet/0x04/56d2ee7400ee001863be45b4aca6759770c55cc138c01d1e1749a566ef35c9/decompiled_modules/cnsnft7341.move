module 0x456d2ee7400ee001863be45b4aca6759770c55cc138c01d1e1749a566ef35c9::cnsnft7341 {
    struct CNSNFT7341 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7341, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7341>(arg0, arg1);
