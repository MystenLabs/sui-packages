module 0x4d833601129f2426b85bbdb5596f9c0ae354476e7436d23238c1ebf897e4b51::world_cup_pool {
    ...
    public entry fun deposit_victory_tokens(arg0: &mut Tournament, arg1: 0x2::coin::Coin<0xbfac5e1c6bf6ef29b12f7723857695fd2f4da9a11a7d88162c15e9124c243a4a::victory_token::VICTORY_TOKEN>, arg2: &AdminCap, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg3), 2);
        0x2::coin::put<0xbfac5e1c6bf6ef29b12f7723857695fd2f4da9a11a7d88162c15e9124c243a4a::victory_token::VICTORY_TOKEN>(&mut arg0.victory_pool, arg1);
    }
        ...
        while (v2 < 0x1::vector::length<address>(&arg1)) {
            ...
            if (0x2::table::contains<address, Entry>(&arg0.entries, v3) && !0x2::table::contains<address, bool>(&arg0.claimed, v3)) {
                if (0x2::table::borrow<address, Entry>(&arg0.entries, v3).team == *v0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<0xbfac5e1c6bf6ef29b12f7723857695fd2f4da9a11a7d88162c15e9124c243a4a::victory_token::VICTORY_TOKEN>>(0x2::coin::from_balance<0xbfac5e1c6bf6ef29b12f7723857695fd2f4da9a11a7d88162c15e9124c243a4a::victory_token::VICTORY_TOKEN>(0x2::balance::split<0xbfac5e1c6bf6ef29b12f7723857695fd2f4da9a11a7d88162c15e9124c243a4a::victory_token::VICTORY_TOKEN>(&mut arg0.victory_pool, v1), arg3), v3);
    ...
    public fun get_victory_pool(arg0: &Tournament) : u64 {
    ...
    public entry fun set_winner(arg0: &mut Tournament, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &AdminCap, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.is_open = false;
        let v0 = 0x2::balance::value<0xbfac5e1c6bf6ef29b12f7723857695fd2f4da9a11a7d88162c15e9124c243a4a::victory_token::VICTORY_TOKEN>(&arg0.victory_pool);
    ...
    public entry fun withdraw_prize_pool_sui(arg0: &mut Tournament, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg2), 2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.prize_pool, 0x2::balance::value<0x2::sui::SUI>(&arg0.prize_pool)), arg2), 0x2::tx_context::sender(arg2));
    }
