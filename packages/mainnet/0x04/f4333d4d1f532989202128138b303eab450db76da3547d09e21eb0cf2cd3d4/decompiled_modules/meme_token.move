module 0x4f4333d4d1f532989202128138b303eab450db76da3547d09e21eb0cf2cd3d4::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"GenX", b"GenXCrypto", b"Launching a crypto educational mobile app while trying to have some fun.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-08T23-11-35.094Z-x.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"GenXCrypto"),
            symbol     : 0x1::string::utf8(b"GenX"),
            decimals   : 9,
