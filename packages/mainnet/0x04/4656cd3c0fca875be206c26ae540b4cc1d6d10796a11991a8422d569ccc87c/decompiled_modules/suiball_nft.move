module 0x44656cd3c0fca875be206c26ae540b4cc1d6d10796a11991a8422d569ccc87c::suiball_nft {
    ...
    public fun get_price(arg0: &ItemStore) : u64 {
        arg0.price_per_nft
    }

    public fun get_recipient(arg0: &ItemStore) : address {
        arg0.recipient_address
    }

    public fun get_version(arg0: &ItemStore) : u64 {
        arg0.version
    }
    ...
    public fun mint_to_sender(arg0: &mut ItemStore, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg2 > 0, 2);
        assert!(arg2 <= 10, 3);
        let v0 = arg0.price_per_nft * arg2;
        assert!(0x2::coin::value<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&arg1) == v0, 4);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>>(arg1, arg0.recipient_address);
    ...
    fun setup_store(arg0: &mut 0x2::tx_context::TxContext) : (ItemStore, StoreOwnerCap) {
        let v0 = ItemStore{
            ...
            version           : 1,
            price_per_nft     : 10000,
            recipient_address : @0xb5977ee8b565fb51a9be2f032111dec12f3df06a7a49ae67f2d81378e3b0aa45,
        };
        let v1 = StoreOwnerCap{id: 0x2::object::new(arg0)};
        (v0, v1)
    }

    public fun update_price(arg0: &StoreOwnerCap, arg1: &mut ItemStore, arg2: u64) {
        arg1.price_per_nft = arg2;
    }

    public fun update_recipient(arg0: &StoreOwnerCap, arg1: &mut ItemStore, arg2: address) {
        arg1.recipient_address = arg2;
    }

    public fun upgrade_version(arg0: &StoreOwnerCap, arg1: &mut ItemStore, arg2: u64) {
        arg1.version = arg2;
    }
