module 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::reward {
    ...
    struct RewardRefundCounterKey has copy, drop, store {
        reward_coin: 0x1::type_name::TypeName,
    }
    ...
    fun add_overflow_refund_counter(arg0: &mut RewardManager, arg1: 0x1::type_name::TypeName, arg2: u128) {
        if (arg2 == 0) {
            return
        };
        let v0 = RewardRefundCounterKey{reward_coin: arg1};
        if (0x2::bag::contains<RewardRefundCounterKey>(&arg0.vault, v0)) {
            let v1 = 0x2::bag::borrow_mut<RewardRefundCounterKey, u128>(&mut arg0.vault, v0);
            assert!(340282366920938463463374607431768211455 - *v1 >= arg2, 13906836231634288665);
            *v1 = *v1 + arg2;
        } else {
            0x2::bag::add<RewardRefundCounterKey, u128>(&mut arg0.vault, v0, arg2);
        };
    }
    ...
    public(friend) fun add_reward<T0>(arg0: &mut RewardManager, arg1: 0x1::option::Option<u64>, arg2: u64, arg3: 0x2::balance::Balance<T0>, arg4: &0x2::clock::Clock) {
        assert!(!arg0.emergency_reward_pause, 13906835145007431703);
        let v0 = 0x2::clock::timestamp_ms(arg4) / 1000;
        assert!(arg2 > v0, 13906835157891809295);
        let v1 = if (0x1::option::is_none<u64>(&arg1)) {
            v0
        } else {
            let v2 = 0x1::option::extract<u64>(&mut arg1);
            assert!(v2 >= v0, 13906835179366514701);
            assert!(v2 < arg2, 13906835183661481997);
            v2
        };
        ...
        if (v1 == v0) {
            assert!(340282366920938463463374607431768211455 - v5.current_emission_rate >= v3, 13906835333985206283);
    ...
    public(friend) fun borrow_mut_reward_by_type<T0>(arg0: &mut RewardManager) : &mut Reward {
        ...
        assert!(0x1::option::is_some<u64>(&v0), 13906836485036048389);
    ...
    public fun borrow_reward_by_type<T0>(arg0: &RewardManager) : &Reward {
        let v0 = reward_index<T0>(arg0);
        assert!(0x1::option::is_some<u64>(&v0), 13906836536575655941);
    ...
    fun current_period_end_time(arg0: u64) : u64 {
        assert!(arg0 >= 1757332800, 13906837756347416597);
    ...
    public(friend) fun emergency_pause(arg0: &mut RewardManager) {
        assert!(!arg0.emergency_reward_pause, 13906834749870702619);
    ...
    public(friend) fun emergency_unpause(arg0: &mut RewardManager) {
        assert!(arg0.emergency_reward_pause, 13906834788525408283);
    ...
    public(friend) fun emergency_withdraw_settlement_overflow_reward<T0>(arg0: &mut RewardManager) : 0x2::balance::Balance<T0> {
        get_index<T0>(arg0);
        let v0 = remove_overflow_refund_counter(arg0, 0x1::type_name::with_defining_ids<T0>());
        withdraw<T0>(arg0, ((v0 / 18446744073709551616) as u64))
    }

    public fun get_index<T0>(arg0: &RewardManager) : u64 {
        let v0 = reward_index<T0>(arg0);
        assert!(0x1::option::is_some<u64>(&v0), 13906837124986175493);
    ...
    public(friend) fun initialize_reward<T0>(arg0: &mut RewardManager, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = reward_index<T0>(arg0);
        assert!(0x1::option::is_none<u64>(&v0), 13906834973207298049);
        assert!(0x1::vector::length<Reward>(&arg0.rewards) < 5, 13906834977502396419);
        assert!(!arg0.emergency_reward_pause, 13906834981798674455);
        let v1 = Reward{
    ...
    public(friend) fun make_private(arg0: &mut RewardManager) {
        assert!(arg0.is_public, 13906834865834819611);
        arg0.is_public = false;
    }

    public(friend) fun make_public(arg0: &mut RewardManager) {
        assert!(!arg0.is_public, 13906834827180113947);
        arg0.is_public = true;
    }
    ...
    public fun overflow_refund_counter<T0>(arg0: &RewardManager) : u128 {
        get_index<T0>(arg0);
        let v0 = RewardRefundCounterKey{reward_coin: 0x1::type_name::with_defining_ids<T0>()};
        if (!0x2::bag::contains<RewardRefundCounterKey>(&arg0.vault, v0)) {
            return 0
        };
        *0x2::bag::borrow<RewardRefundCounterKey, u128>(&arg0.vault, v0)
    }
    ...
    public(friend) fun refund_overflow_rewards(arg0: &mut RewardManager, arg1: vector<u128>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<Reward>(&arg0.rewards)) {
            ...
            v2.reward_released = v2.reward_released - (v1 as u256);
            add_overflow_refund_counter(arg0, v2.reward_coin, v1);
            v0 = v0 + 1;
        };
    }
    ...
    public(friend) fun refund_rewards(arg0: &mut RewardManager, arg1: vector<u128>) {
        ...
        while (v0 < 0x1::vector::length<Reward>(&arg0.rewards)) {
            ...
            assert!(340282366920938463463374607431768211455 - v1.reward_refunded >= *0x1::vector::borrow<u128>(&arg1, v0), 13906835948166447129);
            v1.reward_refunded = v1.reward_refunded + *0x1::vector::borrow<u128>(&arg1, v0);
            v0 = v0 + 1;
        };
    }

    fun remove_overflow_refund_counter(arg0: &mut RewardManager, arg1: 0x1::type_name::TypeName) : u128 {
        let v0 = RewardRefundCounterKey{reward_coin: arg1};
        if (0x2::bag::contains<RewardRefundCounterKey>(&arg0.vault, v0)) {
            0x2::bag::remove<RewardRefundCounterKey, u128>(&mut arg0.vault, v0)
        } else {
            0
        }
    }
    ...
    public(friend) fun rollover_refunds_into_remaining_time(arg0: &mut RewardManager, arg1: vector<u128>, arg2: &0x2::clock::Clock) {
        ...
        while (v0 < 0x1::vector::length<Reward>(&arg0.rewards)) {
            ...
            assert!(340282366920938463463374607431768211455 - v2.current_emission_rate >= v4, 13906835853676249099);
    ...
    public(friend) fun settle_rewards(arg0: &mut RewardManager, arg1: &0x2::clock::Clock) : vector<u128> {
        ...
        assert!(v0 < v1, 13906835467128930311);
        let v2 = 0;
        ...
        while (v2 < 0x1::vector::length<Reward>(&arg0.rewards)) {
            ...
            while (0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::option_u64::is_some(&v5) && v1 > v0) {
                ...
                let v8 = ((0x1::u64::min(v1, v7) - v0) as u128);
                let v9 = if (v8 == 0 || v4.current_emission_rate == 0) {
                    0
                } else {
                    assert!(v8 <= 340282366920938463463374607431768211455 / v4.current_emission_rate, 13906835574503899155);
                    v8 * v4.current_emission_rate
                };
                assert!(340282366920938463463374607431768211455 - v6 >= v9, 13906835600273702931);
                v6 = v6 + v9;
                if (v1 < v7) {
                    break
                };
                let v10 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::add(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::from(v4.current_emission_rate), *0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::skip_list::borrow<0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::I128>(&v4.period_emission_rates, v7));
                assert!(!0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::is_neg(v10), 13906835643223244817);
                v4.current_emission_rate = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::as_u128(v10);
                v0 = v7;
    ...
    public(friend) fun withdraw<T0>(arg0: &mut RewardManager, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.vault, v1), 13906836686899773449);
        let v2 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.vault, v1);
        assert!(0x2::balance::value<T0>(v2) >= arg1, 13906836695489708041);
