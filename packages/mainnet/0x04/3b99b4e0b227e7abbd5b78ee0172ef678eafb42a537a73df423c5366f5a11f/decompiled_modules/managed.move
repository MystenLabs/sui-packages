module 0x43b99b4e0b227e7abbd5b78ee0172ef678eafb42a537a73df423c5366f5a11f::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 6, b"OKOKTEST", b"OKOKT", b"", 0x1::option::none<0x2::url::Url>(), arg1);
