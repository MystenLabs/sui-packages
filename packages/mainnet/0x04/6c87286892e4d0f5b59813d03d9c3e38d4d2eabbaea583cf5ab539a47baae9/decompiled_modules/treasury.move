module 0x46c87286892e4d0f5b59813d03d9c3e38d4d2eabbaea583cf5ab539a47baae9::treasury {
    struct Treasury has store, key {
        id: 0x2::object::UID,
        vaults: 0x2::bag::Bag,
    }

    public fun deposit<T0>(arg0: &0x46c87286892e4d0f5b59813d03d9c3e38d4d2eabbaea583cf5ab539a47baae9::admin_cap::AdminCap, arg1: &mut Treasury, arg2: 0x2::balance::Balance<T0>) {
    ...
    public entry fun withdraw<T0>(arg0: &0x46c87286892e4d0f5b59813d03d9c3e38d4d2eabbaea583cf5ab539a47baae9::admin_cap::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::bag::contains<0x1::type_name::TypeName>(&arg1.vaults, v0)) {
            abort 20
        };
