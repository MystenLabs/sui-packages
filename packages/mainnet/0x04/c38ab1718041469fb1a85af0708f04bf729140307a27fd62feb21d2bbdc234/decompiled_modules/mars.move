module 0x4c38ab1718041469fb1a85af0708f04bf729140307a27fd62feb21d2bbdc234::mars {
    ...
    fun init(arg0: MARS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<MARS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MARS        ")))), trim_right(b"Mars                            "), trim_right(b"On June 26, Posie and Pluto welcomed a healthy baby boy at Tanganyika Wildlife Park in Kansas. The Mars community has donated over $11,000 USD and is largely responsible for him being named, Mars! 100% of creator rewards are donated to Tanganyika Wildlife Park in support of conservation worldwide and have officially on"), v2, arg1);
