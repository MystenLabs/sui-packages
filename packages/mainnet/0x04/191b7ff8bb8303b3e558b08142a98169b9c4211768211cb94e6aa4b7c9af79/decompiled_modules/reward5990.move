module 0x4191b7ff8bb8303b3e558b08142a98169b9c4211768211cb94e6aa4b7c9af79::reward5990 {
    struct REWARD5990 has drop {
        dummy_field: bool,
    }

    struct TICKET_5990 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5990(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5990>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5990>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5990, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5990>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5990>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5990>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5990>>(v5, 0x2::tx_context::sender(arg1));
    }
