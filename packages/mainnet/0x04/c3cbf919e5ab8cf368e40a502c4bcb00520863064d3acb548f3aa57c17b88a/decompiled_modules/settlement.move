module 0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::settlement {
    ...
    public fun claim_direct<T0: drop>(arg0: &mut SettlementState, arg1: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg2: address, arg3: u64, arg4: address, arg5: u64, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3 * (arg0.protocol_fee_bps as u64) / 10000;
        if (v4 > 0) {
            assert!(arg0.protocol_fee_recipient != @0x0, 13);
            let v5 = arg0.protocol_fee_recipient;
            accrue_fee<T0>(arg0, v5, 0x2::coin::split<T0>(&mut v2, v4, arg7));
        };
        let v6 = if (arg3 > 0 && arg4 != @0x0) {
            accrue_fee<T0>(arg0, arg4, 0x2::coin::split<T0>(&mut v2, arg3, arg7));
            arg3
        } else {
            0
        };
        let v7 = if (arg5 > 0 && arg6 != @0x0) {
            accrue_fee<T0>(arg0, arg6, 0x2::coin::split<T0>(&mut v2, arg5, arg7));
            arg5
        } else {
            0
        };
        ...
        if (v8) {
            0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::events::emit_fees_accrued(arg0.protocol_fee_recipient, v4, arg4, v6, arg6, v7);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v2, arg2);
        0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::events::emit_order_fulfilled_direct(v3, arg2, v4, v6, v7);
    }
    ...
    public fun claim_usdc<T0: drop>(arg0: &mut SettlementState, arg1: u32, arg2: u64, arg3: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FulfillReceipt) {
        ...
        if (v13) {
            0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::events::emit_fees_accrued(arg0.protocol_fee_recipient, v9, v4, v11, v6, v12);
        };
    ...
    public fun complete_fulfill<T0: drop>(arg0: &mut SettlementState, arg1: FulfillReceipt, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::tx_context::TxContext) {
        ...
        0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::events::emit_order_fulfilled(v0, v1, v10, v14, v2, v4, 0x2::tx_context::sender(arg3), v5, v11, v6, v12);
    }
    ...
    public fun create_fulfill_receipt<T0>(arg0: &mut SettlementState, arg1: u32, arg2: u64, arg3: &mut 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) : FulfillReceipt {
        ...
        if (v12) {
            0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::events::emit_fees_accrued(arg0.protocol_fee_recipient, v8, v4, v10, v6, v11);
        };
        FulfillReceipt{
            src_eid              : v1.src_eid,
            cctp_nonce           : v1.cctp_nonce,
    ...
    public fun fulfill_order_swap_a_to_b<T0, T1>(arg0: &mut SettlementState, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: u32, arg4: u64, arg5: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (v15) {
            0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::events::emit_fees_accrued(arg0.protocol_fee_recipient, v11, v7, v13, v9, v14);
        };
        let (v16, v17) = 0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::aggregator::swap_a_to_b<T0, T1>(arg1, arg2, v10, v3, arg6, arg7);
        let v18 = v17;
        let v19 = v16;
        ...
        0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::events::emit_order_fulfilled(arg3, arg4, 0, 0x2::coin::value<T1>(&v19), v2, v4, 0x2::tx_context::sender(arg7), v5, v11, v13, v14);
    }
    ...
    public fun fulfill_order_swap_b_to_a<T0, T1>(arg0: &mut SettlementState, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: u32, arg4: u64, arg5: 0x2::transfer::Receiving<0x2::coin::Coin<T1>>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let (v16, v17) = 0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::aggregator::swap_b_to_a<T0, T1>(arg1, arg2, v10, v3, arg6, arg7);
        let v18 = v17;
        let v19 = v16;
        ...
        0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::events::emit_order_fulfilled(arg3, arg4, 0, 0x2::coin::value<T0>(&v19), v2, v4, 0x2::tx_context::sender(arg7), v5, v11, v13, v14);
    }
    ...
    public fun fulfill_order_usdc<T0: drop>(arg0: &mut SettlementState, arg1: u32, arg2: u64, arg3: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::events::emit_order_fulfilled(arg1, arg2, 0, v16, v2, v4, 0x2::tx_context::sender(arg5), v5, v11, v13, v14);
    }
    ...
    public fun lz_receive(arg0: &mut SettlementState, arg1: &0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp, arg2: 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Call<0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::LzReceiveParam, 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Void>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::events::emit_swap_order_received(v0, v10, v11, v12, v13, v14);
    }
    ...
    public fun withdraw_fallback<T0: drop>(arg0: &mut SettlementState, arg1: u32, arg2: u64, arg3: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x4c3cbf919e5ab8cf368e40a502c4bcb00520863064d3acb548f3aa57c17b88a::events::emit_fallback_withdrawn(arg1, arg2, 0x2::coin::value<T0>(&v6), v4, v5);
    }
