module 0x49d38dae7ba5353208335a9044bcf4339be4fd8ab0ff7f91e51fe474dccbdd0::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"BT1438735", b"BatchToken1 438735", b"First serial deployment", 0x1::option::none<0x2::url::Url>(), arg1);
