module 0x4a4117289c8d49250db68fd06f4b6f1bc62ba621a977db1dbe3e216dfe10a836::reward1978 {
    struct REWARD1978 has drop {
        dummy_field: bool,
    }

    struct TICKET_1978 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1978(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1978>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1978>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1978, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1978>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1978>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1978>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1978>>(v5, 0x2::tx_context::sender(arg1));
    }
