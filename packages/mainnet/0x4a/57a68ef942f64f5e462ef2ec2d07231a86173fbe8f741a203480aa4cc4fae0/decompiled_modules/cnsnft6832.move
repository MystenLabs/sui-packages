module 0x4a57a68ef942f64f5e462ef2ec2d07231a86173fbe8f741a203480aa4cc4fae0::cnsnft6832 {
    struct CNSNFT6832 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6832, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTRU2LVfvwnEAZceKHWq2ZqZaJWjcNtV2Bqi2hkhVDpvB?ref=7426"));
        let v4 = 0x2::package::claim<CNSNFT6832>(arg0, arg1);
