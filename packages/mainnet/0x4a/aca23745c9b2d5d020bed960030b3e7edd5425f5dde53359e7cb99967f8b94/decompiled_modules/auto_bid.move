module 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::auto_bid {
    ...
    entry fun exercise<T0, T1>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: &mut StrategyPoolV2, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        let v16 = 0x2::object::id<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::BidVault>(0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_mut_bid_vault(v8, arg2));
        let v17 = 0;
        while (v17 < v15) {
        ...
        let v20 = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_mut_bid_vault_by_id(v8, &v16);
        let v21 = 0;
        while (v21 < v15) {
            let v22 = 0x2::table_vec::borrow_mut<StrategyV2>(v14, v21);
            if (!0x1::vector::is_empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v22.receipts)) {
                let v23 = 0x1::vector::empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>();
                let v24 = 0;
                let v25 = 0x1::vector::length<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v22.receipts);
                while (v24 < v25) {
                    if (v16 == 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_receipt_vid(0x1::vector::borrow<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v22.receipts, v24))) {
                        0x1::vector::push_back<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&mut v23, 0x1::vector::remove<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&mut v22.receipts, v24));
                        v25 = v25 - 1;
                        continue
                    };
                    v24 = v24 + 1;
                };
                if (!0x1::vector::is_empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v23)) {
                    let (v26, v27, v28) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::delegate_exercise<T0>(v20, v23);
                    if (!0x2::dynamic_field::exists_<0x1::string::String>(&v22.id, 0x1::string::utf8(b"profit"))) {
                        0x2::dynamic_field::add<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v22.id, 0x1::string::utf8(b"profit"), 0x2::balance::zero<T0>());
                    };
                    0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v22.id, 0x1::string::utf8(b"profit")), v28);
                    v22.accumulated_profit = v22.accumulated_profit + v26;
                    0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::emit_exercise_event(v13, v26, v27, 0x1::option::none<0x1::type_name::TypeName>(), 0, v22.user);
                    update_u64_padding<T0, T1>(v22);
                    let v29 = 0x1::vector::borrow_mut<u64>(&mut v22.u64_padding, 2);
                    *v29 = *v29 + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_vault_u64_padding_value(v20, 1) * v27 / 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_o_token_decimal(v13)) * 11000 / 10000 * (10000 - 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_vault_u64_padding_value(v20, 2)) / 10000;
                } else {
                    0x1::vector::destroy_empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(v23);
                };
            };
            v21 = v21 + 1;
        };
