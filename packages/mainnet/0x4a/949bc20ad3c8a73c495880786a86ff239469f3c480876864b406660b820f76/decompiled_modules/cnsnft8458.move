module 0x4a949bc20ad3c8a73c495880786a86ff239469f3c480876864b406660b820f76::cnsnft8458 {
    struct CNSNFT8458 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8458, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4601"));
        let v4 = 0x2::package::claim<CNSNFT8458>(arg0, arg1);
