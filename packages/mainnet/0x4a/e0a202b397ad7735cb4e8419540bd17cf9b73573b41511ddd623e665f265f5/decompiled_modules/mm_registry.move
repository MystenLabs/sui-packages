module 0x4ae0a202b397ad7735cb4e8419540bd17cf9b73573b41511ddd623e665f265f5::mm_registry {
    struct MMRegistry has key {
        id: 0x2::object::UID,
        owner: address,
        pool_configs: 0x2::table::Table<0x2::object::ID, PoolConfig>,
        default_config: 0x4ae0a202b397ad7735cb4e8419540bd17cf9b73573b41511ddd623e665f265f5::config::MMConfig,
    }

    struct PoolConfig has copy, drop, store {
        pool_id: 0x2::object::ID,
        config: 0x4ae0a202b397ad7735cb4e8419540bd17cf9b73573b41511ddd623e665f265f5::config::MMConfig,
        enabled: bool,
        quote_decimals: u8,
        base_decimals: u8,
    }
    ...
    public fun configure_pool(arg0: &mut MMRegistry, arg1: &MMAdminCap, arg2: 0x2::object::ID, arg3: u8, arg4: u8, arg5: &0x2::clock::Clock) {
        ...
        0x4ae0a202b397ad7735cb4e8419540bd17cf9b73573b41511ddd623e665f265f5::events::emit_pool_registered(arg2, arg0.default_config, 0x2::clock::timestamp_ms(arg5));
    }

    public fun configure_pool_with_config(arg0: &mut MMRegistry, arg1: &MMAdminCap, arg2: 0x2::object::ID, arg3: u8, arg4: u8, arg5: 0x4ae0a202b397ad7735cb4e8419540bd17cf9b73573b41511ddd623e665f265f5::config::MMConfig, arg6: &0x2::clock::Clock) {
        assert!(!0x2::table::contains<0x2::object::ID, PoolConfig>(&arg0.pool_configs, arg2), 3);
        let v0 = PoolConfig{
            pool_id        : arg2,
            config         : arg5,
        ...
        0x2::table::add<0x2::object::ID, PoolConfig>(&mut arg0.pool_configs, arg2, v0);
        0x4ae0a202b397ad7735cb4e8419540bd17cf9b73573b41511ddd623e665f265f5::events::emit_pool_registered(arg2, arg5, 0x2::clock::timestamp_ms(arg6));
    }
    ...
    public fun disable_pool(arg0: &mut MMRegistry, arg1: &MMAdminCap, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) {
        ...
        0x4ae0a202b397ad7735cb4e8419540bd17cf9b73573b41511ddd623e665f265f5::events::emit_pool_status_changed(arg2, false, 0x2::clock::timestamp_ms(arg3));
    }
    ...
    public fun enable_pool(arg0: &mut MMRegistry, arg1: &MMAdminCap, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) {
        ...
        0x4ae0a202b397ad7735cb4e8419540bd17cf9b73573b41511ddd623e665f265f5::events::emit_pool_status_changed(arg2, true, 0x2::clock::timestamp_ms(arg3));
    }
    ...
    public fun get_pool_config(arg0: &MMRegistry, arg1: 0x2::object::ID) : &0x4ae0a202b397ad7735cb4e8419540bd17cf9b73573b41511ddd623e665f265f5::config::MMConfig {
    ...
    fun init(arg0: MM_REGISTRY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = MMRegistry{
            ...
            default_config : 0x4ae0a202b397ad7735cb4e8419540bd17cf9b73573b41511ddd623e665f265f5::config::default(),
        };
    ...
    public fun update_default_config(arg0: &mut MMRegistry, arg1: &MMAdminCap, arg2: 0x4ae0a202b397ad7735cb4e8419540bd17cf9b73573b41511ddd623e665f265f5::config::MMConfig) {
        arg0.default_config = arg2;
    }

    public fun update_pool_config(arg0: &mut MMRegistry, arg1: &MMAdminCap, arg2: 0x2::object::ID, arg3: 0x4ae0a202b397ad7735cb4e8419540bd17cf9b73573b41511ddd623e665f265f5::config::MMConfig, arg4: &0x2::clock::Clock) {
        assert!(0x2::table::contains<0x2::object::ID, PoolConfig>(&arg0.pool_configs, arg2), 2);
