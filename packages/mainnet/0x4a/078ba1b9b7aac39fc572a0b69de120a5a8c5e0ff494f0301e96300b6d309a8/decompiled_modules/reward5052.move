module 0x4a078ba1b9b7aac39fc572a0b69de120a5a8c5e0ff494f0301e96300b6d309a8::reward5052 {
    struct REWARD5052 has drop {
        dummy_field: bool,
    }

    struct TICKET_5052 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5052(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5052>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5052>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5052, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5052>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5052>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5052>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5052>>(v5, 0x2::tx_context::sender(arg1));
    }
