module 0x4a2bcd73fea5d354ccb3557ef417fb95ba1bf667f93f4a23af64f3ae8903b559::seal_adventure {
    ...
    fun init(arg0: SEAL_ADVENTURE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Mint your unique Seal Aventure and embark on an epic journey!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiedh6iiuldh32df2i6hwopjsrtjsjw2sq2lkk6ikpu4mttzng223a"));
