module 0x4ac133ca7efc3c2a63a41c660c2d5015352851fc66c512252383a4575a832e28::cnsnft2916 {
    struct CNSNFT2916 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2916, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2916>(arg0, arg1);
