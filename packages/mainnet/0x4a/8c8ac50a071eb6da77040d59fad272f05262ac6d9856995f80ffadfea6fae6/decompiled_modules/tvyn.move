module 0x4a8c8ac50a071eb6da77040d59fad272f05262ac6d9856995f80ffadfea6fae6::tvyn {
    ...
    public entry fun create_and_share_mint_vault(arg0: 0x2::coin::TreasuryCap<TVYN>, arg1: &mut 0x4a8c8ac50a071eb6da77040d59fad272f05262ac6d9856995f80ffadfea6fae6::config_registry::Config, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = MintVault{
            id  : 0x2::object::new(arg2),
            cap : arg0,
        };
        0x4a8c8ac50a071eb6da77040d59fad272f05262ac6d9856995f80ffadfea6fae6::config_registry::set_mint_vault_id(arg1, 0x2::object::id<MintVault>(&v0));
    ...
    fun init(arg0: TVYN, arg1: &mut 0x2::tx_context::TxContext) {
        create_currency_and_supply_internal(arg0, b"TEstEd", b"TESTeted", b"Native token for testing of the platform", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://amethyst-high-woodpecker-414.mypinata.cloud/ipfs/bafkreianashificfb7k4murmlw4ef7qi63sgnsd44ypwr2sjuo5cwatgae")), 9, arg1);
    }
