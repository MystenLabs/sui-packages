module 0x4ad24a24af4a614c4b7940908af5cac623347a649b70362ab19deecbc79c09ad::rock_paper_scissors {
    struct GamingResultEvent has copy, drop {
        is_win: bool,
        your_choice: 0x1::string::String,
        xunfragrant_choice: 0x1::string::String,
    ...
    public fun play(arg0: u8, arg1: &0x2::clock::Clock) {
        ...
        let v3 = GamingResultEvent{
            ...
            xunfragrant_choice : map_choice_to_string(v0),
            result             : v1,
        };
