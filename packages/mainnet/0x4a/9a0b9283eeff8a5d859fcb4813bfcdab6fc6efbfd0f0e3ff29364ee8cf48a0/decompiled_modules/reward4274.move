module 0x4a9a0b9283eeff8a5d859fcb4813bfcdab6fc6efbfd0f0e3ff29364ee8cf48a0::reward4274 {
    struct REWARD4274 has drop {
        dummy_field: bool,
    }

    struct TICKET_4274 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4274(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4274>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4274>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4274, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4274>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4274>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4274>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4274>>(v5, 0x2::tx_context::sender(arg1));
    }
