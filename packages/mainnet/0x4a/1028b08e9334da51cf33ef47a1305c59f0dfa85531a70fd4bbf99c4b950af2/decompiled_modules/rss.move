module 0x4a1028b08e9334da51cf33ef47a1305c59f0dfa85531a70fd4bbf99c4b950af2::rss {
    struct RSS has drop {
        dummy_field: bool,
    }
    ...
    public fun add_item(arg0: &mut RSSFeed, arg1: vector<0x1::string::String>, arg2: vector<0x1::string::String>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Authorization {
    ...
    public fun give_up_publisher(arg0: &mut RSSFeed, arg1: RSSPublishCap) {
        let RSSPublishCap {
            id     : v0,
            rss_id : v1,
        } = arg1;
    ...
    fun init(arg0: RSS, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::package::claim_and_keep<RSS>(arg0, arg1);
        let v0 = RSSRegistry{
            id    : 0x2::object::new(arg1),
            feeds : 0x2::table::new<0x1::string::String, 0x2::object::ID>(arg1),
        };
        0x2::transfer::share_object<RSSRegistry>(v0);
    }

    public fun new_publisher(arg0: &mut RSSFeed, arg1: &RSSAdminCap, arg2: &mut 0x2::tx_context::TxContext) : RSSPublishCap {
    ...
    public fun new_rss(arg0: &mut RSSRegistry, arg1: &0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (RSSFeed, RSSAdminCap) {
    ...
    fun print_rss(arg0: &RSSFeed, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) : 0x1::string::String {
    ...
    public fun revoke_publisher(arg0: &mut RSSFeed, arg1: &RSSAdminCap, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::uid_to_inner(&arg0.id) == arg1.rss_id, 2);
        assert!(arg0.cap_id == 0x2::object::uid_to_inner(&arg1.id), 4);
    ...
    public fun set_metadata(arg0: &mut RSSFeed, arg1: &RSSAdminCap, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::uid_to_inner(&arg0.id) == arg1.rss_id, 2);
        assert!(arg0.cap_id == 0x2::object::uid_to_inner(&arg1.id), 4);
    ...
    public fun share_rss(arg0: RSSFeed) {
        0x2::transfer::share_object<RSSFeed>(arg0);
    }

    public fun take_over(arg0: &mut RSSRegistry, arg1: &mut RSSFeed, arg2: &0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : RSSAdminCap {
