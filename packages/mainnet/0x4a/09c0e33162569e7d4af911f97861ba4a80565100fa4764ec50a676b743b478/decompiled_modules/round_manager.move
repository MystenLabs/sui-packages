module 0xc04019567fddb33fab28ab016dde34a518aad824668411fb4a18fe4a11916e38::round_manager {
    ...
    fun settle(arg0: &mut Global, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 > 0) {
            0xc04019567fddb33fab28ab016dde34a518aad824668411fb4a18fe4a11916e38::treasury::split_and_route_internal(0xc04019567fddb33fab28ab016dde34a518aad824668411fb4a18fe4a11916e38::treasury::withdraw_faithed(&mut arg0.vaults, v2, arg3), &arg0.fee_split, &mut arg0.vaults, arg3);
        };
        0xc04019567fddb33fab28ab016dde34a518aad824668411fb4a18fe4a11916e38::godlode::accrue(&mut arg0.godlode);
        let (v12, v13) = 0xc04019567fddb33fab28ab016dde34a518aad824668411fb4a18fe4a11916e38::godlode::maybe_hit(&mut arg0.godlode, arg2 + 7919);
        if (v12 && v5 > 0) {
            let v14 = 0;
            while (v14 < v5) {
