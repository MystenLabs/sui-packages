module 0x4a25c9153d59dd70d1ec7b27aca3bac94606233154c6dd27fb78261d71ad6080::crit_bit_u64 {
    ...
    public fun borrow<T0>(arg0: &CB<T0>, arg1: u64) : &T0 {
    ...
    public fun borrow_mut<T0>(arg0: &mut CB<T0>, arg1: u64) : &mut T0 {
        assert!(!is_empty<T0>(arg0), 3);
    ...
    fun b_s_o<T0>(arg0: &CB<T0>, arg1: u64) : &O<T0> {
        if (is_out(arg0.r)) {
    ...
    fun b_s_o_m<T0>(arg0: &mut CB<T0>, arg1: u64) : &mut O<T0> {
        if (is_out(arg0.r)) {
    ...
    fun crit_bit(arg0: u64, arg1: u64) : u8 {
        let v0 = 0;
        let v1 = 63;
        let v2;
        loop {
    ...
    public fun has_key<T0>(arg0: &CB<T0>, arg1: u64) : bool {
        if (is_empty<T0>(arg0)) {
            return false
        };
    ...
    public fun insert<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: T0) {
    ...
    fun insert_above<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: T0, arg3: u64, arg4: u64, arg5: u64, arg6: u8) {
    ...
    fun insert_above_root<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: T0, arg3: u64, arg4: u64, arg5: u8) {
        let v0 = arg0.r;
    ...
    fun insert_below<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: T0, arg3: u64, arg4: u64, arg5: u64, arg6: bool, arg7: u64, arg8: u64, arg9: u8) {
        if (arg6 == true) {
    ...
    fun insert_below_walk<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: T0, arg3: u64, arg4: u64, arg5: u64, arg6: u8) {
    ...
    fun insert_empty<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: T0) {
        let v0 = O<T0>{
            k : arg1,
            v : arg2,
    ...
    fun insert_general<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: T0, arg3: u64) {
    ...
    fun insert_singleton<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: T0) {
    ...
    fun is_set(arg0: u64, arg1: u8) : bool {
        arg0 >> arg1 & 1 == 1
    }

    public fun max_key<T0>(arg0: &CB<T0>) : u64 {
    ...
    public fun min_key<T0>(arg0: &CB<T0>) : u64 {
        assert!(!is_empty<T0>(arg0), 7);
    ...
    public fun pop<T0>(arg0: &mut CB<T0>, arg1: u64) : T0 {
    ...
    fun pop_general<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: u64) : T0 {
    ...
    fun pop_singleton<T0>(arg0: &mut CB<T0>, arg1: u64) : T0 {
    ...
    fun push_back_insert_nodes<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: T0, arg3: u64, arg4: u8, arg5: u64, arg6: bool, arg7: u64, arg8: u64) {
        let (v0, v1) = if (arg6) {
            (arg7, arg8)
        } else {
            (arg8, arg7)
    ...
    fun search_outer<T0>(arg0: &CB<T0>, arg1: u64) : (u64, bool, u64, u64, u8) {
        let v0 = 0x1::vector::borrow<I>(&arg0.i, arg0.r);
        let v1;
        let v2;
        loop {
        ...
        let v3 = 0x1::vector::borrow<O<T0>>(&arg0.o, o_v(v1));
        (v1, v2, v3.k, v3.p, v0.c)
    }

    public fun singleton<T0>(arg0: u64, arg1: T0) : CB<T0> {
        let v0 = CB<T0>{
            r : 0,
            i : 0x1::vector::empty<I>(),
            o : 0x1::vector::empty<O<T0>>(),
    ...
    fun traverse_c_i<T0>(arg0: &CB<T0>, arg1: u64, arg2: u64, arg3: bool) : u64 {
        let v0 = 0x1::vector::borrow<I>(&arg0.i, arg2);
    ...
    public fun traverse_init_mut<T0>(arg0: &mut CB<T0>, arg1: bool) : (u64, &mut T0, u64, u64) {
        let v0 = if (arg1 == true) {
    ...
    public fun traverse_mut<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: u64, arg3: bool) : (u64, &mut T0, u64, u64) {
        let v0 = traverse_c_i<T0>(arg0, arg1, arg2, arg3);
        let v1 = 0x1::vector::borrow_mut<O<T0>>(&mut arg0.o, o_v(v0));
        (v1.k, &mut v1.v, v1.p, v0)
    }

    public fun traverse_p_init_mut<T0>(arg0: &mut CB<T0>) : (u64, &mut T0, u64, u64) {
        traverse_init_mut<T0>(arg0, true)
    }

    public fun traverse_p_mut<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: u64) : (u64, &mut T0, u64, u64) {
        traverse_mut<T0>(arg0, arg1, arg2, true)
    }

    public fun traverse_p_pop_mut<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : (u64, &mut T0, u64, u64, T0) {
        traverse_pop_mut<T0>(arg0, arg1, arg2, arg3, arg4, true)
    }

    public fun traverse_pop_mut<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: bool) : (u64, &mut T0, u64, u64, T0) {
    ...
    public fun traverse_s_init_mut<T0>(arg0: &mut CB<T0>) : (u64, &mut T0, u64, u64) {
        traverse_init_mut<T0>(arg0, false)
    }

    public fun traverse_s_mut<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: u64) : (u64, &mut T0, u64, u64) {
        traverse_mut<T0>(arg0, arg1, arg2, false)
    }

    public fun traverse_s_pop_mut<T0>(arg0: &mut CB<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : (u64, &mut T0, u64, u64, T0) {
