module 0x4ab912c1f21a66c58717acc33405a194ff6405906da192854888e46130e0a338::cnsnft1985 {
    struct CNSNFT1985 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1985, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1985>(arg0, arg1);
