module 0x4a005d1512e35120c273bb731c1833ba6c695cec4c2579d99247b5fb52b00f4b::reward6305 {
    struct REWARD6305 has drop {
        dummy_field: bool,
    }

    struct TICKET_6305 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6305(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6305>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6305>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6305, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6305>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6305>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6305>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6305>>(v5, 0x2::tx_context::sender(arg1));
    }
