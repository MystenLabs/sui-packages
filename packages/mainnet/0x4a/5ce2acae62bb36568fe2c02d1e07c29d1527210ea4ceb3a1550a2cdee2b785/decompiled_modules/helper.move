module 0x4a5ce2acae62bb36568fe2c02d1e07c29d1527210ea4ceb3a1550a2cdee2b785::helper {
    public fun calculate_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ...
        let v4 = if (v2 == 0) {
            (0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::mul_div_u256((arg2 as u256), (0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::mul_to_u128(get_sui_amount(&v3), 1) as u256), (0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::mul_to_u128(1, get_token_amount(&v3)) as u256)) as u64)
        } else {
            (0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::mul_div_u256((arg2 as u256), (0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::mul_to_u128(get_sui_amount(&v3), get_token_amount(&v1)) as u256), (0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::mul_to_u128(v2, get_token_amount(&v3)) as u256)) as u64)
        };
        v4 - arg2
    }
