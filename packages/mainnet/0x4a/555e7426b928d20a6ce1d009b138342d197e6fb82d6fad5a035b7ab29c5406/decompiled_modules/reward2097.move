module 0x4a555e7426b928d20a6ce1d009b138342d197e6fb82d6fad5a035b7ab29c5406::reward2097 {
    struct REWARD2097 has drop {
        dummy_field: bool,
    }

    struct TICKET_2097 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2097(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2097>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2097>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2097, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2097>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2097>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2097>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2097>>(v5, 0x2::tx_context::sender(arg1));
    }
