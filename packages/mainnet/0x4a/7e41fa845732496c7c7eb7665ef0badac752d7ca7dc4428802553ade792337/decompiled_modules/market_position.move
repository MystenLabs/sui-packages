module 0x4a7e41fa845732496c7c7eb7665ef0badac752d7ca7dc4428802553ade792337::market_position {
    ...
    public fun join(arg0: &0x82d35fd978ebf1588e73c8d69b810a1615d03afe8ca2c2c600f6ecaf6269ab93::version::Version, arg1: &mut MarketPosition, arg2: MarketPosition, arg3: &0x2::clock::Clock) {
        0x82d35fd978ebf1588e73c8d69b810a1615d03afe8ca2c2c600f6ecaf6269ab93::version::assert_current_version(arg0);
        assert!(market_state_id(arg1) == market_state_id(&arg2), 0x82d35fd978ebf1588e73c8d69b810a1615d03afe8ca2c2c600f6ecaf6269ab93::error::market_invalid_market_position());
        increase_lp_amount(arg1, lp_amount(&arg2), arg3);
        let v0 = 0;
        while (v0 < 0x2::vec_map::length<0x2::object::ID, u256>(&arg2.rewards_debt)) {
            let (v1, v2) = 0x2::vec_map::get_entry_by_idx<0x2::object::ID, u256>(&arg2.rewards_debt, v0);
            if (0x2::vec_map::contains<0x2::object::ID, u256>(&arg1.rewards_debt, v1)) {
                let v3 = 0x2::vec_map::get_mut<0x2::object::ID, u256>(&mut arg1.rewards_debt, v1);
                *v3 = *v3 + *v2;
            } else {
                0x2::vec_map::insert<0x2::object::ID, u256>(&mut arg1.rewards_debt, *v1, *v2);
            };
            v0 = v0 + 1;
        };
        v0 = 0;
        while (v0 < 0x2::vec_map::length<0x2::object::ID, u64>(&arg2.rewards_harvested)) {
            let (v4, v5) = 0x2::vec_map::get_entry_by_idx<0x2::object::ID, u64>(&arg2.rewards_harvested, v0);
            if (0x2::vec_map::contains<0x2::object::ID, u64>(&arg1.rewards_harvested, v4)) {
                let v6 = 0x2::vec_map::get_mut<0x2::object::ID, u64>(&mut arg1.rewards_harvested, v4);
                *v6 = *v6 + *v5;
            } else {
                0x2::vec_map::insert<0x2::object::ID, u64>(&mut arg1.rewards_harvested, *v4, *v5);
            };
            v0 = v0 + 1;
        };
        let MarketPosition {
    ...
    public(friend) fun mint(arg0: 0x2::object::ID, arg1: 0x1::string::String, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : MarketPosition {
        ...
        let v1 = if (arg2 > 0x2::clock::timestamp_ms(arg3)) {
            (arg2 - 0x2::clock::timestamp_ms(arg3)) / 86400000
        } else {
            0
        };
        MarketPosition{
            ...
            lp_amount         : 0,
            expiry_days       : v1,
            lp_amount_display : u64_to_float_string_with_decimal_value(0, 9),
    ...
    public(friend) fun update_lp_display(arg0: &mut MarketPosition, arg1: u8) {
        arg0.lp_amount_display = u64_to_float_string_with_decimal_value(arg0.lp_amount, arg1);
    }
