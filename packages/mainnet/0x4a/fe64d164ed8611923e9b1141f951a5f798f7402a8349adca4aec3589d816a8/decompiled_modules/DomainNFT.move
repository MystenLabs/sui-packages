module 0x4afe64d164ed8611923e9b1141f951a5f798f7402a8349adca4aec3589d816a8::DomainNFT {
    ...
    public entry fun transfer(arg0: DomNFT, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun burn(arg0: DomNFT, arg1: &mut 0x2::tx_context::TxContext) {
        let DomNFT {
            id          : v0,
            name        : _,
            description : _,
    ...
    public entry fun update_description(arg0: &mut DomNFT, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
