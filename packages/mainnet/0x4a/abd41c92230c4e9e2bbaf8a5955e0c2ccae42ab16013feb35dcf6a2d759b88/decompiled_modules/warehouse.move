module 0x4aabd41c92230c4e9e2bbaf8a5955e0c2ccae42ab16013feb35dcf6a2d759b88::warehouse {
    ...
    struct Warehouse has key {
        id: 0x2::object::UID,
        version: u64,
        card_templates: 0x2::table::Table<0x2::object::ID, CardTemplate>,
        card_pack_templates: 0x2::vec_map::VecMap<0x2::object::ID, CardPackTemplate>,
        restored_assets: 0x2::table::Table<0x2::object::ID, 0x2::object::ID>,
        revoked_caps: 0x2::vec_map::VecMap<0x2::object::ID, bool>,
    }

    public fun add_card_template_to_pack(arg0: &AdminCap, arg1: &mut Warehouse, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: u64) {
        assert_version(arg1);
        assert!(is_admincap_valid(arg1, arg0), 10006);
        assert!(arg4 > 0, 10002);
        assert!(0x2::vec_map::contains<0x2::object::ID, CardPackTemplate>(&arg1.card_pack_templates, &arg2), 10003);
        assert!(0x2::table::contains<0x2::object::ID, CardTemplate>(&arg1.card_templates, arg3), 10003);
    ...
    public fun add_linked_pack_template(arg0: &AdminCap, arg1: &mut Warehouse, arg2: 0x2::object::ID, arg3: 0x2::object::ID) {
        ...
        assert!(is_admincap_valid(arg1, arg0), 10006);
        assert!(0x2::vec_map::contains<0x2::object::ID, CardPackTemplate>(&arg1.card_pack_templates, &arg2), 10003);
        assert!(0x2::vec_map::contains<0x2::object::ID, CardPackTemplate>(&arg1.card_pack_templates, &arg3), 10003);
        assert!(arg2 != arg3, 10007);
        assert!(0x2::vec_map::get<0x2::object::ID, CardPackTemplate>(&arg1.card_pack_templates, &arg3).unopened_pack_count == 0, 10009);
        let v0 = 0x2::vec_map::get_mut<0x2::object::ID, CardPackTemplate>(&mut arg1.card_pack_templates, &arg2);
        assert!(v0.unopened_pack_count == 0, 10009);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x2::object::ID>(&v0.linked_pack_template_ids)) {
            assert!(*0x1::vector::borrow<0x2::object::ID>(&v0.linked_pack_template_ids, v1) != arg3, 10008);
            v1 = v1 + 1;
        };
        0x1::vector::push_back<0x2::object::ID>(&mut v0.linked_pack_template_ids, arg3);
    }

    public(friend) fun assert_version(arg0: &Warehouse) {
        assert!(arg0.version == 1, 10010);
    }

    public(friend) fun borrow_card_pack_template(arg0: &mut Warehouse, arg1: 0x2::object::ID) : &mut CardPackTemplate {
        assert!(0x2::vec_map::contains<0x2::object::ID, CardPackTemplate>(&arg0.card_pack_templates, &arg1), 10003);
        0x2::vec_map::get_mut<0x2::object::ID, CardPackTemplate>(&mut arg0.card_pack_templates, &arg1)
    }

    public(friend) fun borrow_card_pack_template_ref(arg0: &Warehouse, arg1: &0x2::object::ID) : &CardPackTemplate {
        assert!(0x2::vec_map::contains<0x2::object::ID, CardPackTemplate>(&arg0.card_pack_templates, arg1), 10003);
        0x2::vec_map::get<0x2::object::ID, CardPackTemplate>(&arg0.card_pack_templates, arg1)
    }

    public(friend) fun borrow_card_template(arg0: &mut Warehouse, arg1: 0x2::object::ID) : &mut CardTemplate {
        assert!(0x2::table::contains<0x2::object::ID, CardTemplate>(&arg0.card_templates, arg1), 10003);
        0x2::table::borrow_mut<0x2::object::ID, CardTemplate>(&mut arg0.card_templates, arg1)
    }

    public(friend) fun borrow_card_template_ref(arg0: &Warehouse, arg1: 0x2::object::ID) : &CardTemplate {
        assert!(0x2::table::contains<0x2::object::ID, CardTemplate>(&arg0.card_templates, arg1), 10003);
        0x2::table::borrow<0x2::object::ID, CardTemplate>(&arg0.card_templates, arg1)
    }

    public fun create_admin_cap(arg0: &SuperAdminCap, arg1: &Warehouse, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg1);
    ...
    public fun create_card_template(arg0: &AdminCap, arg1: &mut Warehouse, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x2::table::add<0x2::object::ID, CardTemplate>(&mut arg1.card_templates, v1, v2);
        v1
    }

    public fun create_minter_cap(arg0: &SuperAdminCap, arg1: &Warehouse, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg1);
    ...
    public(friend) fun decrement_pack_template_unopened_pack_count(arg0: &mut CardPackTemplate, arg1: u64) {
        assert!(arg0.unopened_pack_count >= arg1, 10005);
    ...
    public fun delete_card_pack_template(arg0: &AdminCap, arg1: &mut Warehouse, arg2: 0x2::object::ID) {
        ...
        assert!(is_admincap_valid(arg1, arg0), 10006);
        assert!(0x2::vec_map::contains<0x2::object::ID, CardPackTemplate>(&arg1.card_pack_templates, &arg2), 10003);
        assert!(0x2::vec_map::get<0x2::object::ID, CardPackTemplate>(&arg1.card_pack_templates, &arg2).unopened_pack_count == 0, 10009);
    ...
    public fun delete_card_template(arg0: &AdminCap, arg1: &mut Warehouse, arg2: 0x2::object::ID) {
        assert_version(arg1);
        assert!(is_admincap_valid(arg1, arg0), 10006);
        assert!(0x2::table::contains<0x2::object::ID, CardTemplate>(&arg1.card_templates, arg2), 10003);
        0x2::table::remove<0x2::object::ID, CardTemplate>(&mut arg1.card_templates, arg2);
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        let v1 = 0;
        while (v1 < 0x2::vec_map::size<0x2::object::ID, CardPackTemplate>(&arg1.card_pack_templates)) {
            let (v2, _) = 0x2::vec_map::get_entry_by_idx<0x2::object::ID, CardPackTemplate>(&arg1.card_pack_templates, v1);
            0x1::vector::push_back<0x2::object::ID>(&mut v0, *v2);
            v1 = v1 + 1;
        };
        let v4 = 0;
        while (v4 < 0x1::vector::length<0x2::object::ID>(&v0)) {
            let v5 = 0x2::vec_map::get_mut<0x2::object::ID, CardPackTemplate>(&mut arg1.card_pack_templates, 0x1::vector::borrow<0x2::object::ID>(&v0, v4));
            if (0x2::vec_map::contains<0x2::object::ID, u64>(&v5.card_templates_and_weights, &arg2)) {
                let (_, _) = 0x2::vec_map::remove<0x2::object::ID, u64>(&mut v5.card_templates_and_weights, &arg2);
                update_pack_template_total_weight(v5);
            };
            v4 = v4 + 1;
        };
    }
    ...
    public fun get_restored_asset(arg0: &Warehouse, arg1: 0x2::object::ID) : 0x2::object::ID {
        *0x2::table::borrow<0x2::object::ID, 0x2::object::ID>(&arg0.restored_assets, arg1)
    }
    ...
    public fun has_restored_asset(arg0: &Warehouse, arg1: 0x2::object::ID) : bool {
        0x2::table::contains<0x2::object::ID, 0x2::object::ID>(&arg0.restored_assets, arg1)
    }

    public(friend) fun increment_pack_template_counter(arg0: &mut CardPackTemplate) {
        if (arg0.max_supply > 0) {
            assert!(arg0.current_supply < arg0.max_supply, 10004);
        };
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = Warehouse{
            ...
            version             : 1,
            card_templates      : 0x2::table::new<0x2::object::ID, CardTemplate>(arg0),
            card_pack_templates : 0x2::vec_map::empty<0x2::object::ID, CardPackTemplate>(),
            restored_assets     : 0x2::table::new<0x2::object::ID, 0x2::object::ID>(arg0),
            revoked_caps        : 0x2::vec_map::empty<0x2::object::ID, bool>(),
        };
        ...
        0x2::transfer::share_object<Warehouse>(v3);
    }

    public fun is_admincap_valid(arg0: &Warehouse, arg1: &AdminCap) : bool {
        let v0 = 0x2::object::id<AdminCap>(arg1);
        !0x2::vec_map::contains<0x2::object::ID, bool>(&arg0.revoked_caps, &v0)
    }

    public fun is_mintercap_valid(arg0: &Warehouse, arg1: &MinterCap) : bool {
        let v0 = 0x2::object::id<MinterCap>(arg1);
        !0x2::vec_map::contains<0x2::object::ID, bool>(&arg0.revoked_caps, &v0)
    }

    entry fun migrate(arg0: &mut Warehouse, arg1: &SuperAdminCap) {
        assert!(arg0.version < 1, 10010);
        arg0.version = 1;
    }

    public(friend) fun record_restored_asset(arg0: &mut Warehouse, arg1: 0x2::object::ID, arg2: 0x2::object::ID) {
        assert_version(arg0);
        assert!(!0x2::table::contains<0x2::object::ID, 0x2::object::ID>(&arg0.restored_assets, arg1), 10013);
        0x2::table::add<0x2::object::ID, 0x2::object::ID>(&mut arg0.restored_assets, arg1, arg2);
    }
    ...
    public fun restore_card_pack_template(arg0: &SuperAdminCap, arg1: &mut Warehouse, arg2: 0x2::object::ID, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64) {
        assert_version(arg1);
        assert!(!0x2::vec_map::contains<0x2::object::ID, CardPackTemplate>(&arg1.card_pack_templates, &arg2), 10011);
        assert!(arg11 > 0, 10001);
        assert!(arg8 == 0 || arg9 <= arg8, 10012);
        assert!(arg10 <= arg9, 10012);
        let v0 = CardPackTemplate{
            id                         : arg2,
            name                       : arg3,
            description                : arg4,
            image_url                  : arg5,
            ...
            max_supply                 : arg8,
            current_supply             : arg9,
            unopened_pack_count        : arg10,
            cards_per_pack             : arg11,
            card_templates_and_weights : 0x2::vec_map::empty<0x2::object::ID, u64>(),
            total_weight               : 0,
            open_until                 : arg12,
            linked_pack_template_ids   : 0x1::vector::empty<0x2::object::ID>(),
        };
        0x2::vec_map::insert<0x2::object::ID, CardPackTemplate>(&mut arg1.card_pack_templates, arg2, v0);
    }

    public fun restore_card_template(arg0: &SuperAdminCap, arg1: &mut Warehouse, arg2: 0x2::object::ID, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: u64, arg9: u64) {
        assert_version(arg1);
        assert!(!0x2::table::contains<0x2::object::ID, CardTemplate>(&arg1.card_templates, arg2), 10011);
        assert!(arg8 == 0 || arg9 <= arg8, 10012);
        let v0 = CardTemplate{
            id             : arg2,
            name           : arg3,
        ...
        0x2::table::add<0x2::object::ID, CardTemplate>(&mut arg1.card_templates, arg2, v0);
    }

    public fun restore_linked_pack_template(arg0: &SuperAdminCap, arg1: &mut Warehouse, arg2: 0x2::object::ID, arg3: 0x2::object::ID) {
        assert_version(arg1);
        assert!(0x2::vec_map::contains<0x2::object::ID, CardPackTemplate>(&arg1.card_pack_templates, &arg2), 10003);
        assert!(0x2::vec_map::contains<0x2::object::ID, CardPackTemplate>(&arg1.card_pack_templates, &arg3), 10003);
        assert!(arg2 != arg3, 10007);
    ...
    public fun revoke_admin_cap(arg0: &SuperAdminCap, arg1: &mut Warehouse, arg2: 0x2::object::ID) {
        assert_version(arg1);
        if (!0x2::vec_map::contains<0x2::object::ID, bool>(&arg1.revoked_caps, &arg2)) {
            0x2::vec_map::insert<0x2::object::ID, bool>(&mut arg1.revoked_caps, arg2, true);
        };
    }

    public fun revoke_minter_cap(arg0: &SuperAdminCap, arg1: &mut Warehouse, arg2: 0x2::object::ID) {
        assert_version(arg1);
        if (!0x2::vec_map::contains<0x2::object::ID, bool>(&arg1.revoked_caps, &arg2)) {
            0x2::vec_map::insert<0x2::object::ID, bool>(&mut arg1.revoked_caps, arg2, true);
        };
    ...
    public fun update_card_pack_template(arg0: &AdminCap, arg1: &mut Warehouse, arg2: 0x2::object::ID, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: u64, arg9: u64, arg10: u64) {
        ...
        assert!(0x2::vec_map::contains<0x2::object::ID, CardPackTemplate>(&arg1.card_pack_templates, &arg2), 10003);
        let v0 = 0x2::vec_map::get_mut<0x2::object::ID, CardPackTemplate>(&mut arg1.card_pack_templates, &arg2);
        assert!(arg10 > 0, 10001);
        assert!(arg9 == 0 || arg9 >= v0.current_supply, 10004);
        v0.name = arg3;
        v0.description = arg4;
        v0.image_url = arg5;
        v0.url = arg6;
    ...
    public fun update_card_template(arg0: &AdminCap, arg1: &mut Warehouse, arg2: 0x2::object::ID, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: u64) {
        ...
        assert!(is_admincap_valid(arg1, arg0), 10006);
        assert!(0x2::table::contains<0x2::object::ID, CardTemplate>(&arg1.card_templates, arg2), 10003);
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, CardTemplate>(&mut arg1.card_templates, arg2);
        assert!(arg8 == 0 || arg8 >= v0.current_supply, 10004);
        v0.name = arg3;
        v0.description = arg4;
        v0.image_url = arg5;
        v0.url = arg6;
