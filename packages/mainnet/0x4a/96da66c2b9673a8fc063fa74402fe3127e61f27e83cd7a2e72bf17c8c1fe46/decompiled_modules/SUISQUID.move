module 0x4a96da66c2b9673a8fc063fa74402fe3127e61f27e83cd7a2e72bf17c8c1fe46::SUISQUID {
    ...
    fun init(arg0: SUISQUID, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUISQUID>(arg0, 9, b"SuiSquid", b"SSQUID", b"Multi-Ultility Meme, web : https://suisquid.xyz , tg : @suisquidportal", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.pinata.cloud/ipfs/QmRo3EAbeNajei7Q1tsY778W4BBfy2SvrcFCmJPKVZUfhN?_gl=1*1coko6v*rs_ga*NGMxYTE0YzUtNjg3OS00MTMxLThhM2EtMGZiMjljNzQ2OWYz*rs_ga_5RMPXG14TE*MTY4MzI4ODI5My4xLjEuMTY4MzI4ODQ5Mi40OC4wLjA")), arg1);
        let v2 = v0;
