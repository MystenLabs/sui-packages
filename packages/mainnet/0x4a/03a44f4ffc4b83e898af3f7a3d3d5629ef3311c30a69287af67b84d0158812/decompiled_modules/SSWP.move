module 0x4a03a44f4ffc4b83e898af3f7a3d3d5629ef3311c30a69287af67b84d0158812::SSWP {
    ...
    fun init(arg0: SSWP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<SSWP>>(0x2::coin::from_balance<SSWP>(0x2::balance::increase_supply<SSWP>(&mut v2, 10000000000), arg1), 0x2::tx_context::sender(arg1));
