module 0x4a8dc6f897031f6841b190522cbd0e9858b2eabafb20ca2725317be99741a023::faith {
    ...
    public fun accrue_to(arg0: address, arg1: u64, arg2: &mut SupplyCap, arg3: &RefiningIndex, arg4: &mut Buckets, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.minted + arg1 <= arg2.cap, 0);
        ...
        if (v0) {
            ...
            0x1::vector::push_back<Unclaimed>(&mut arg4.buckets, v3);
        };
    }
