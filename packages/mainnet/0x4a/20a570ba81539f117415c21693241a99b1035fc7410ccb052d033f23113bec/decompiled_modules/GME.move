module 0x4a20a570ba81539f117415c21693241a99b1035fc7410ccb052d033f23113bec::GME {
    struct GME has drop {
        dummy_field: bool,
    }

    fun init(arg0: GME, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<GME>(arg0, 2, b"GME", b"GameStop", b"GameStop", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/SGFD_KfgfRqxKRQ72f3losdWXAZ4B2Ke8IDTzEJEwHA?ext=png")), arg1);
