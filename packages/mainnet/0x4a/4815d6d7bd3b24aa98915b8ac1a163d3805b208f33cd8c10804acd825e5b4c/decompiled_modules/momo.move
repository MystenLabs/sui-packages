module 0x4a4815d6d7bd3b24aa98915b8ac1a163d3805b208f33cd8c10804acd825e5b4c::momo {
    ...
    fun init(arg0: MOMO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/4UgDSXCqUBLgy8FFesr71sq1qXgxaBs82ArRkStGbonk.png?size=lg&key=a62dea                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<MOMO>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MOMO    ")))), trim_right(b"MOMO                            "), trim_right(b"The sister of BONK                                                                                                                                                                                                                                                                                                              "), v2, arg1);
        let v5 = v3;
