module 0x4a46a0c4d615d9d39f5be704b5ecab0e98dba1d48b5eb6165d4e18cc7f0eb63e::shttoken {
    ...
    fun init(arg0: SHTTOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SHTTOKEN>(arg0, 9, b"SHT", b"Sweet Hatch Tonic", b"Utility token designed to fuel ecosystem", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://duckdynasty.io/sht.png")), arg1);
        let v2 = v0;
