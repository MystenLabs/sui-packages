module 0x4a8d3e54274e78b94a96f95cfb61f812b6d2b63d89a77aeacde0acc480a0eb8c::reward2530 {
    struct REWARD2530 has drop {
        dummy_field: bool,
    }

    struct TICKET_2530 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2530(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2530>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2530>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2530, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2530>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2530>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2530>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2530>>(v5, 0x2::tx_context::sender(arg1));
    }
