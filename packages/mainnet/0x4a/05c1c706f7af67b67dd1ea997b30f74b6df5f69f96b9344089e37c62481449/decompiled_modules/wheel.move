module 0x4a05c1c706f7af67b67dd1ea997b30f74b6df5f69f96b9344089e37c62481449::wheel {
    ...
    public entry fun play_wheel(arg0: &mut 0x4a05c1c706f7af67b67dd1ea997b30f74b6df5f69f96b9344089e37c62481449::house_pool::HousePool, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: u8, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = 0x4a05c1c706f7af67b67dd1ea997b30f74b6df5f69f96b9344089e37c62481449::house_pool::process_bet(arg0, arg1, v5, v7, b"wheel", arg5);
        let v9 = WheelResult{
            player        : v0,
            bet_amount    : v1,
            won           : v5,
