module 0x97077c74e70cbc90408950f61aa13a7b2a2b066ebbc7dce261161cdfac392663::voting {
    ...
    public entry fun add_project(arg0: &AdminCap, arg1: &mut Votes, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String) {
        let v0 = Project{
            id              : 0x1::vector::length<Project>(&arg1.project_list),
            name            : arg2,
            description     : arg3,
            video_blob_id   : arg6,
            walrus_site_url : 0x2::url::new_unsafe(0x1::string::to_ascii(arg5)),
            github_url      : 0x2::url::new_unsafe(0x1::string::to_ascii(arg4)),
            votes           : 0,
        };
        0x1::vector::push_back<Project>(&mut arg1.project_list, v0);
    }
