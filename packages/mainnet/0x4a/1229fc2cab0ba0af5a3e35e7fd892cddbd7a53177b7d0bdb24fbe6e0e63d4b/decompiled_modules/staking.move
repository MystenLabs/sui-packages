module 0x4a1229fc2cab0ba0af5a3e35e7fd892cddbd7a53177b7d0bdb24fbe6e0e63d4b::staking {
    ...
    struct StakingPool<phantom T0> has store, key {
        ...
        lock_time: u64,
        deposits_pool_reward_manager: 0x4a1229fc2cab0ba0af5a3e35e7fd892cddbd7a53177b7d0bdb24fbe6e0e63d4b::liquidity_mining::PoolRewardManager,
    ...
    struct UserStakeManager has store, key {
        ...
        user_reward_manager: 0x4a1229fc2cab0ba0af5a3e35e7fd892cddbd7a53177b7d0bdb24fbe6e0e63d4b::liquidity_mining::UserRewardManager,
    }
    ...
    public fun add_pool_reward<T0, T1>(arg0: &mut StakingPoolRegistry, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x4a1229fc2cab0ba0af5a3e35e7fd892cddbd7a53177b7d0bdb24fbe6e0e63d4b::liquidity_mining::add_pool_reward<T1>(&mut borrow_mut_staking_pool<T0>(arg0, arg1).deposits_pool_reward_manager, 0x2::coin::into_balance<T1>(arg2), arg3, arg4, arg5, arg6);
    }
    ...
    public fun cancel_pool_reward<T0, T1>(arg0: &mut StakingPoolRegistry, arg1: 0x2::object::ID, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x2::coin::from_balance<T1>(0x4a1229fc2cab0ba0af5a3e35e7fd892cddbd7a53177b7d0bdb24fbe6e0e63d4b::liquidity_mining::cancel_pool_reward<T1>(&mut borrow_mut_staking_pool<T0>(arg0, arg1).deposits_pool_reward_manager, arg2, arg3), arg4)
    }
    ...
    public fun claim_rewards<T0, T1>(arg0: &mut StakingPoolRegistry, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v1 = 0x4a1229fc2cab0ba0af5a3e35e7fd892cddbd7a53177b7d0bdb24fbe6e0e63d4b::liquidity_mining::claim_rewards<T1>(&mut v0.deposits_pool_reward_manager, &mut 0x2::table::borrow_mut<address, UserStakeManager>(&mut v0.user_table, 0x2::tx_context::sender(arg4)).user_reward_manager, arg2, arg3);
    ...
    public fun close_pool_reward<T0, T1>(arg0: &mut StakingPoolRegistry, arg1: 0x2::object::ID, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert_valid_package_version(arg0);
        assert_sender_is_manager(arg0, arg4);
        0x2::coin::from_balance<T1>(0x4a1229fc2cab0ba0af5a3e35e7fd892cddbd7a53177b7d0bdb24fbe6e0e63d4b::liquidity_mining::close_pool_reward<T1>(&mut borrow_mut_staking_pool<T0>(arg0, arg1).deposits_pool_reward_manager, arg2, arg3), arg4)
    }
    ...
    public fun create_staking_pool<T0>(arg0: &mut StakingPoolRegistry, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = StakingPool<T0>{
            ...
            lock_time                    : arg1,
            deposits_pool_reward_manager : 0x4a1229fc2cab0ba0af5a3e35e7fd892cddbd7a53177b7d0bdb24fbe6e0e63d4b::liquidity_mining::new_pool_reward_manager(arg2),
    ...
    public fun stake<T0>(arg0: &mut StakingPoolRegistry, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, UserStakeManager>(&v0.user_table, 0x2::tx_context::sender(arg4))) {
            ...
            0x4a1229fc2cab0ba0af5a3e35e7fd892cddbd7a53177b7d0bdb24fbe6e0e63d4b::liquidity_mining::change_user_reward_manager_share(&mut v0.deposits_pool_reward_manager, &mut v5.user_reward_manager, 0x4a1229fc2cab0ba0af5a3e35e7fd892cddbd7a53177b7d0bdb24fbe6e0e63d4b::liquidity_mining::shares(&v5.user_reward_manager) + v1, arg3);
        } else {
            let v6 = 0x4a1229fc2cab0ba0af5a3e35e7fd892cddbd7a53177b7d0bdb24fbe6e0e63d4b::liquidity_mining::new_user_reward_manager(&mut v0.deposits_pool_reward_manager, arg3);
            0x4a1229fc2cab0ba0af5a3e35e7fd892cddbd7a53177b7d0bdb24fbe6e0e63d4b::liquidity_mining::change_user_reward_manager_share(&mut v0.deposits_pool_reward_manager, &mut v6, v1, arg3);
