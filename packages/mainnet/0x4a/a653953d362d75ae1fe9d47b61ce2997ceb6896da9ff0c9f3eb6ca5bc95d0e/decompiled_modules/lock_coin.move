module 0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::lock_coin {
    ...
    public fun unlock_coin<T0>(arg0: LockedCoin<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v4 = v1;
        let v5 = v0;
        assert!(v3 <= 0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::utils::now_timestamp(arg1), 1);
