module 0x4ad6e947da61694ce602d5a2a791bb046fdd148b743c6c6f7e113d3e73c1de84::cnsnft9488 {
    struct CNSNFT9488 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9488, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2451"));
        let v4 = 0x2::package::claim<CNSNFT9488>(arg0, arg1);
