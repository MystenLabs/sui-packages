module 0x872d08a70db3db498aa7853276acea8091fdd9871b2d86bc8dcb8524526df622::saving {
    ...
    struct SavingPool<phantom T0> has store, key {
        id: 0x2::object::UID,
    ...
    public fun new<T0>(arg0: &0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::admin::AdminCap, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &mut 0x2::tx_context::TxContext) : SavingPool<T0> {
        let v0 = 0x2::object::new(arg2);
        0x872d08a70db3db498aa7853276acea8091fdd9871b2d86bc8dcb8524526df622::events::emit_new_saving_pool_event<T0>(0x2::object::uid_to_inner(&v0));
    ...
    public fun assert_coin_minimum<T0>(arg0: &0x2::coin::Coin<T0>, arg1: u64) {
    ...
    public fun assert_minted_lp_minimum<T0>(arg0: &DepositResponse<T0>, arg1: u64) {
        if (arg0.minted_lp_amount < arg1) {
            err_below_threshold();
        };
    }

    public fun burn(arg0: &mut 0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::Treasury, arg1: &0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::admin::AdminCap, arg2: 0x2::coin::Coin<0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::USDB>) {
        0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::burn<0x872d08a70db3db498aa7853276acea8091fdd9871b2d86bc8dcb8524526df622::witness::BucketV2Saving>(arg0, 0x872d08a70db3db498aa7853276acea8091fdd9871b2d86bc8dcb8524526df622::witness::witness(), 0x872d08a70db3db498aa7853276acea8091fdd9871b2d86bc8dcb8524526df622::version::package_version(), arg2);
    }
    ...
    public fun check_deposit_response<T0>(arg0: DepositResponse<T0>, arg1: &mut SavingPool<T0>, arg2: &0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::Treasury) {
        0x872d08a70db3db498aa7853276acea8091fdd9871b2d86bc8dcb8524526df622::version::assert_valid_package(arg2);
        let DepositResponse {
            account_address            : v0,
    ...
    public fun default<T0>(arg0: &0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::admin::AdminCap, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_share_object<SavingPool<T0>>(new<T0>(arg0, arg1, arg2));
    }
    ...
    public fun deposit<T0>(arg0: &mut SavingPool<T0>, arg1: &mut 0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::Treasury, arg2: address, arg3: 0x2::coin::Coin<0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::USDB>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : DepositResponse<T0> {
        0x872d08a70db3db498aa7853276acea8091fdd9871b2d86bc8dcb8524526df622::version::assert_valid_package(arg1);
        ...
        let v1 = deposit_<T0>(arg0, 0x2::coin::into_balance<0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::USDB>(arg3), arg4);
        ...
        0x872d08a70db3db498aa7853276acea8091fdd9871b2d86bc8dcb8524526df622::events::emit_deposit_event<T0>(0x2::object::id<SavingPool<T0>>(arg0), arg2, v0, v2);
        if (!0x2::vec_set::is_empty<address>(&arg0.position_locker)) {
            err_ongoing_action();
        };
        0x2::vec_set::insert<address>(&mut arg0.position_locker, arg2);
        0x2::table::borrow_mut<address, Position<T0>>(&mut arg0.positions, arg2).last_update_timestamp = 0x2::clock::timestamp_ms(arg4);
        DepositResponse<T0>{
    ...
    fun deposit_<T0>(arg0: &mut SavingPool<T0>, arg1: 0x2::balance::Balance<0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::USDB>, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        let v0 = lp_supply<T0>(arg0);
        let v1 = if (v0 == 0) {
        ...
        let v2 = 0x2::balance::increase_supply<T0>(&mut arg0.lp_supply, v1);
        if (v0 == 0) {
            if (v1 < 1000) {
                err_below_minimum_liquidity();
            };
            let v3 = @0x0;
            if (0x2::table::contains<address, Position<T0>>(&arg0.positions, v3)) {
                0x2::balance::join<T0>(&mut 0x2::table::borrow_mut<address, Position<T0>>(&mut arg0.positions, v3).balance, 0x2::balance::split<T0>(&mut v2, 1000));
            } else {
                let v4 = Position<T0>{
                    balance               : 0x2::balance::split<T0>(&mut v2, 1000),
                    last_update_timestamp : 0x2::clock::timestamp_ms(arg2),
                };
                0x2::table::add<address, Position<T0>>(&mut arg0.positions, v3, v4);
            };
        };
        v2
    }
    ...
    fun err_below_minimum_liquidity() {
        abort 110
    }

    fun err_below_threshold() {
        abort 109
    }
    ...
    fun err_exceed_max_saving_rate() {
        abort 107
    }
    ...
    public fun supply<T0>(arg0: &mut SavingPool<T0>, arg1: 0x2::balance::Balance<0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::USDB>) {
        0x872d08a70db3db498aa7853276acea8091fdd9871b2d86bc8dcb8524526df622::events::emit_supply_event<T0>(0x2::object::id<SavingPool<T0>>(arg0), 0x2::balance::value<0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::USDB>(&arg1));
        0x2::balance::join<0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::USDB>(&mut arg0.usdb_reserve_balance, arg1);
    }
    ...
    public fun update_deposit_cap<T0>(arg0: &mut SavingPool<T0>, arg1: &0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::admin::AdminCap, arg2: 0x1::option::Option<u64>) {
        ...
        0x872d08a70db3db498aa7853276acea8091fdd9871b2d86bc8dcb8524526df622::events::emit_update_deposit_cap_event<T0>(0x2::object::id<SavingPool<T0>>(arg0), arg2);
    }
    ...
    public fun update_saving_rate<T0>(arg0: &mut SavingPool<T0>, arg1: &0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::admin::AdminCap, arg2: &mut 0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::Treasury, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x872d08a70db3db498aa7853276acea8091fdd9871b2d86bc8dcb8524526df622::events::emit_update_saving_rate_event<T0>(0x2::object::id<SavingPool<T0>>(arg0), arg3);
    }
    ...
    public fun withdraw<T0>(arg0: &mut SavingPool<T0>, arg1: &mut 0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::Treasury, arg2: &0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::AccountRequest, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::USDB>, WithdrawResponse<T0>) {
        ...
        0x2::table::borrow_mut<address, Position<T0>>(&mut arg0.positions, v0).last_update_timestamp = 0x2::clock::timestamp_ms(arg4);
        ...
        0x872d08a70db3db498aa7853276acea8091fdd9871b2d86bc8dcb8524526df622::events::emit_withdraw_event<T0>(0x2::object::id<SavingPool<T0>>(arg0), v0, arg3, 0x2::coin::value<0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::USDB>(&v7));
        if (!0x2::vec_set::is_empty<address>(&arg0.position_locker)) {
            err_ongoing_action();
        };
    ...
    fun withdraw_<T0>(arg0: &mut SavingPool<T0>, arg1: 0x2::balance::Balance<T0>) : 0x2::balance::Balance<0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::USDB> {
        ...
        0x2::balance::split<0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::USDB>(&mut arg0.usdb_reserve_balance, v0)
    }
