module 0x4ad7297bd2ddb58083036fc6deebd036698185fff2915b1e1ab1eccca2e5e7f0::TOKEN {
    struct TOKEN has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN>(arg0, 9, b"TokenSYMBOL", b"TokenName", b"tHIS IS A TEST TOKEN", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://www.google.com/")), arg1);
        let v2 = v0;
