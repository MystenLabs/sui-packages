module 0x4a46360d57a966148cc5ca0175b70f82eabf2254a267afbb94ae15534e61c779::gnon {
    ...
    fun init(arg0: GNON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<GNON>(&mut v3, 690000000000000000, 0x2::tx_context::sender(arg1), arg1);
    ...
    public fun swap_sell(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCapV2<GNON>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::deny_list_v2_remove<GNON>(arg0, arg1, arg2, arg3);
    }
