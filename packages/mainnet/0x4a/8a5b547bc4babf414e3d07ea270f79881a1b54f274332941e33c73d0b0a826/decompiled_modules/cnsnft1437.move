module 0x4a8a5b547bc4babf414e3d07ea270f79881a1b54f274332941e33c73d0b0a826::cnsnft1437 {
    struct CNSNFT1437 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1437, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1437>(arg0, arg1);
