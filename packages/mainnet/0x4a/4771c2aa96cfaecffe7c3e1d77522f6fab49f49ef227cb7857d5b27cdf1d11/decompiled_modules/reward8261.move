module 0x4a4771c2aa96cfaecffe7c3e1d77522f6fab49f49ef227cb7857d5b27cdf1d11::reward8261 {
    struct REWARD8261 has drop {
        dummy_field: bool,
    }

    struct TICKET_8261 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8261(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8261>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8261>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8261, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8261>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8261>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8261>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8261>>(v5, 0x2::tx_context::sender(arg1));
    }
