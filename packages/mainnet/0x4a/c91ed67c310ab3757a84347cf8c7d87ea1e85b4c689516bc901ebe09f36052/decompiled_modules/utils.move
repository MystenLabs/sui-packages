module 0x4ac91ed67c310ab3757a84347cf8c7d87ea1e85b4c689516bc901ebe09f36052::utils {
    public fun check_ticket_price(arg0: u64) : bool {
    ...
    public fun get_name_by_level(arg0: 0x1::string::String, arg1: u8) : 0x1::string::String {
        let v0 = arg0;
        let v1 = if (arg1 == 1) {
            0x1::string::utf8(b"1")
        } else if (arg1 == 2) {
    ...
    public fun u64_to_string(arg0: u64) : 0x1::string::String {
        let v0 = 0x1::vector::empty<u8>();
        0x1::vector::push_back<u8>(&mut v0, (arg0 as u8) + 48);
        0x1::string::utf8(v0)
    }
