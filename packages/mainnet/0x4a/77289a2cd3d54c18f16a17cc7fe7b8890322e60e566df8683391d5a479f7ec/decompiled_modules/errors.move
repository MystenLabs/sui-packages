module 0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::errors {
    ...
    public fun e_tree_lock_below_minimum() : u64 {
        133
    }

    public fun e_tree_lock_overflow() : u64 {
        136
    }

    public fun e_tree_lock_still_locked() : u64 {
        134
    }

    public fun e_tree_lock_wrong_owner() : u64 {
        135
    }
