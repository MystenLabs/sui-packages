module 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::user_account {
    ...
    public(friend) fun check_owner(arg0: &UserAccount, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg1), 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::not_user_account_owner());
    }
    ...
    public(friend) fun remove_user_account(arg0: &mut 0x2::object::UID, arg1: address, arg2: UserAccountCap) {
        ...
        let v5 = v3;
        assert!(0x1::vector::is_empty<0x1::type_name::TypeName>(&v5), 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::not_empty_symbols());
    ...
    public(friend) fun withdraw<T0>(arg0: &mut UserAccount, arg1: 0x1::option::Option<u64>, arg2: &UserAccountCap) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x1::vector::contains<0x1::type_name::TypeName>(&arg0.symbols, &v0), 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::no_balance());
        assert!(arg2.user_account_id == 0x2::object::id<UserAccount>(arg0), 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::not_user_account_cap());
        if (0x1::option::is_none<u64>(&arg1)) {
            let (v2, v3) = 0x1::vector::index_of<0x1::type_name::TypeName>(&arg0.symbols, &v0);
            assert!(v2, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::no_balance());
