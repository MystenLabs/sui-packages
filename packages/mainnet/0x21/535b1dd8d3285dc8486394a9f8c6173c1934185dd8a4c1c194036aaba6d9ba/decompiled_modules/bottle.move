module 0x21535b1dd8d3285dc8486394a9f8c6173c1934185dd8a4c1c194036aaba6d9ba::bottle {
    ...
    public fun get_pending_coll(arg0: &Bottle, arg1: &BottleTable) : u64 {
        (0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor_u128((arg0.stake_amount as u128), ((arg1.reward_per_unit_stake - arg0.reward_coll_snapshot) as u128), 0x21535b1dd8d3285dc8486394a9f8c6173c1934185dd8a4c1c194036aaba6d9ba::constants::distribution_precision()) as u64)
    }

    public fun get_pending_debt(arg0: &Bottle, arg1: &BottleTable) : u64 {
        (0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor_u128((arg0.stake_amount as u128), ((arg1.debt_per_unit_stake - arg0.reward_debt_snapshot) as u128), 0x21535b1dd8d3285dc8486394a9f8c6173c1934185dd8a4c1c194036aaba6d9ba::constants::distribution_precision()) as u64)
    }
    ...
    public(friend) fun record_borrow(arg0: &mut Bottle, arg1: u64, arg2: u64) {
        arg0.collateral_amount = arg0.collateral_amount + arg1;
        arg0.buck_amount = arg0.buck_amount + arg2;
        assert!(arg0.buck_amount >= 0x21535b1dd8d3285dc8486394a9f8c6173c1934185dd8a4c1c194036aaba6d9ba::constants::minimal_bottle_size(), 3);
    }
    ...
    public(friend) fun record_redistribution(arg0: &mut BottleTable, arg1: u64, arg2: u64, arg3: address) {
        ...
        let v1 = 0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor_u128((arg1 as u128), 0x21535b1dd8d3285dc8486394a9f8c6173c1934185dd8a4c1c194036aaba6d9ba::constants::distribution_precision(), 1) + arg0.last_reward_error;
        let v2 = 0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor_u128((arg2 as u128), 0x21535b1dd8d3285dc8486394a9f8c6173c1934185dd8a4c1c194036aaba6d9ba::constants::distribution_precision(), 1) + arg0.last_debt_error;
        let v3 = v1 / v0;
        let v4 = v2 / v0;
    ...
    public(friend) fun record_repay(arg0: &mut Bottle, arg1: u64, arg2: bool) : (bool, u64) {
    ...
    public(friend) fun record_repay_capped<T0>(arg0: &mut Bottle, arg1: u64, arg2: &0x336be2a5fbdb2cce40356139c85fdda55d8fd35301ac204fb900a656ac7eaa5::bucket_oracle::BucketOracle, arg3: &0x2::clock::Clock, arg4: u64, arg5: u8) : (bool, u64) {
        let (v0, v1) = 0x336be2a5fbdb2cce40356139c85fdda55d8fd35301ac204fb900a656ac7eaa5::bucket_oracle::get_price<T0>(arg2, arg3);
