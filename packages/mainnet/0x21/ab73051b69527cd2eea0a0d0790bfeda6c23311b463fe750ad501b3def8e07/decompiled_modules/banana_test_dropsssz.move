module 0x21ab73051b69527cd2eea0a0d0790bfeda6c23311b463fe750ad501b3def8e07::banana_test_dropsssz {
    struct BANANA_TEST_DROPSSSZ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BANANA_TEST_DROPSSSZ, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BANANA_TEST_DROPSSSZ>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"banana test dropsssz"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"dsadas"));
