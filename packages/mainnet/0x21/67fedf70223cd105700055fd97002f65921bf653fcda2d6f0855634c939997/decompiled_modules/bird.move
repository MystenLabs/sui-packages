module 0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::bird {
    ...
    public fun claimPreyReward(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdVault, arg3: &mut 0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::UserArchieve, arg4: &0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::checkVersion(arg4, 2);
    ...
    public fun claimPreyReward2(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdVault, arg3: &mut 0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::Archieve<BIRD>, arg4: &0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::checkVersion(arg4, 2);
        0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::checkVersion(arg4, 2);
        0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::verifySignature(arg0, arg1, &arg2.validator);
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::bcs::new(arg1);
        let v2 = 0x2::bcs::peel_u128(&mut v1);
        assert!(103 == 0x2::bcs::peel_u8(&mut v1), 8005);
        assert!(v0 == 0x2::bcs::peel_address(&mut v1), 8001);
        0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::verUpdatePegNonce<BIRD>(v2, arg3);
        let v3 = ClaimPreyRewardEvent{
            owner   : v0,
            hunt_id : 0x2::bcs::peel_u128(&mut v1),
            nonce   : v2,
    ...
    public fun feedWorm(arg0: vector<u8>, arg1: vector<u8>, arg2: 0x356d0c33487d727fa31198d1ac9e082a5b57a89c6b56dd37fdf9d54db9d9f98d::nft::BirdNFT, arg3: &mut BirdVault, arg4: &mut 0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::UserArchieve, arg5: &0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::checkVersion(arg5, 2);
    ...
    public fun feedWorm2(arg0: vector<u8>, arg1: vector<u8>, arg2: 0x356d0c33487d727fa31198d1ac9e082a5b57a89c6b56dd37fdf9d54db9d9f98d::nft::BirdNFT, arg3: &mut BirdVault, arg4: &mut 0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::Archieve<BIRD>, arg5: &0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::Version, arg6: &0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::version::Version, arg7: &mut 0x2::tx_context::TxContext) {
        0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::checkVersion(arg5, 2);
        0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::checkVersion(arg5, 2);
        0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::verifySignature(arg0, arg1, &arg3.validator);
        let v0 = 0x2::bcs::new(arg1);
        ...
        assert!(101 == 0x2::bcs::peel_u8(&mut v0), 8005);
        assert!(v4 == 0x2::bcs::peel_address(&mut v0), 8001);
        0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::verUpdatePegNonce<BIRD>(v2, arg4);
        assert!(v1 > 0, 8003);
        assert!(0x2::object::id_address<0x356d0c33487d727fa31198d1ac9e082a5b57a89c6b56dd37fdf9d54db9d9f98d::nft::BirdNFT>(&arg2) == v3, 8004);
        0x356d0c33487d727fa31198d1ac9e082a5b57a89c6b56dd37fdf9d54db9d9f98d::nft::burn3(arg2, arg6, arg7);
        let v5 = FeedWormEvent{
            owner   : v4,
            bird_id : 0x2::bcs::peel_u64(&mut v0),
            power   : v1,
    ...
    public fun preyBird2(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdVault, arg3: &mut 0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::Archieve<BIRD>, arg4: &0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::checkVersion(arg4, 2);
        0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::checkVersion(arg4, 2);
        0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::verifySignature(arg0, arg1, &arg2.validator);
        let v0 = 0x2::bcs::new(arg1);
        ...
        let v4 = 0x2::bcs::peel_u64(&mut v0);
        let v5 = 0x2::tx_context::sender(arg5);
        assert!(102 == 0x2::bcs::peel_u8(&mut v0), 8005);
        assert!(v5 == 0x2::bcs::peel_address(&mut v0), 8001);
        assert!(v3 > 0 && v4 > 0, 8002);
        0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::verUpdatePegNonce<BIRD>(v1, arg3);
        assert!(v2 > 0, 8003);
        let v6 = PreyBirdEvent{
            owner      : v5,
            id         : 0,
    ...
    public fun updateValidator(arg0: &AdminCap, arg1: vector<u8>, arg2: &mut BirdVault, arg3: &0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::Version) {
        ...
        0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::checkVersion(arg3, 2);
        0x1::option::swap_or_fill<vector<u8>>(&mut arg2.validator, arg1);
    }

    public fun updateValidator2(arg0: &AdminCap, arg1: vector<u8>, arg2: &mut BirdVault, arg3: &0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::Version) {
        0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::checkVersion(arg3, 2);
        0x144229c18a420c77196e6b768820f34a2caeeb6571d6ccd4e590eae2e268b88c::version::checkVersion(arg3, 2);
        0x1::option::swap_or_fill<vector<u8>>(&mut arg2.validator, arg1);
    }
