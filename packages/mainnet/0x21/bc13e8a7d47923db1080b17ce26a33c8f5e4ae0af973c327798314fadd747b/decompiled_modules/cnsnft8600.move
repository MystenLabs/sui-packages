module 0x21bc13e8a7d47923db1080b17ce26a33c8f5e4ae0af973c327798314fadd747b::cnsnft8600 {
    struct CNSNFT8600 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8600, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8600>(arg0, arg1);
