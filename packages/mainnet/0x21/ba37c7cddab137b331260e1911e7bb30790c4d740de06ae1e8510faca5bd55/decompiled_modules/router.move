module 0x21ba37c7cddab137b331260e1911e7bb30790c4d740de06ae1e8510faca5bd55::router {
    struct SwapContext {
    ...
    public fun finish_swap<T0>(arg0: SwapContext, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(v9 == v2, 0x21ba37c7cddab137b331260e1911e7bb30790c4d740de06ae1e8510faca5bd55::errors::err_target_mismatch());
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&v8, v9), 0x21ba37c7cddab137b331260e1911e7bb30790c4d740de06ae1e8510faca5bd55::errors::err_target_not_found());
        ...
        assert!(v13 >= v4, 0x21ba37c7cddab137b331260e1911e7bb30790c4d740de06ae1e8510faca5bd55::errors::err_amount_out_slippage_check_failed());
        assert!(0x2::bag::is_empty(&v8), 0x21ba37c7cddab137b331260e1911e7bb30790c4d740de06ae1e8510faca5bd55::errors::err_remains_balance());
    ...
    public fun start_swap<T0, T1>(arg0: 0x1::string::String, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u32, arg4: address, arg5: &mut 0x2::tx_context::TxContext) : SwapContext {
        assert!(0x2::coin::value<T0>(&arg2) <= max_amount_in(), 0x21ba37c7cddab137b331260e1911e7bb30790c4d740de06ae1e8510faca5bd55::errors::err_exceed_max_amount_in());
        assert!(0x2::coin::value<T0>(&arg2) > 0, 0x21ba37c7cddab137b331260e1911e7bb30790c4d740de06ae1e8510faca5bd55::errors::err_amount_in_is_zero());
        if (arg3 > 0) {
            assert!(arg4 != @0x0, 0x21ba37c7cddab137b331260e1911e7bb30790c4d740de06ae1e8510faca5bd55::errors::err_invalid_fee_recipient());
        };
        assert!(arg3 <= 100000, 0x21ba37c7cddab137b331260e1911e7bb30790c4d740de06ae1e8510faca5bd55::errors::err_too_large_fee_rate());
