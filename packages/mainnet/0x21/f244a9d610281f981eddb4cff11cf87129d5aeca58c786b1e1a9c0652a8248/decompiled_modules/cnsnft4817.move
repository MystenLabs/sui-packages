module 0x21f244a9d610281f981eddb4cff11cf87129d5aeca58c786b1e1a9c0652a8248::cnsnft4817 {
    struct CNSNFT4817 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4817, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9980"));
        let v4 = 0x2::package::claim<CNSNFT4817>(arg0, arg1);
