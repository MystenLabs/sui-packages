module 0x21726826f8df6f875eb1d1d9e04cbfec2cc565b7eedcc362ec16b9dfd40ce7e8::subscription {
    ...
    fun collect_finalize_market_fee<T0, T1>(arg0: &0x21726826f8df6f875eb1d1d9e04cbfec2cc565b7eedcc362ec16b9dfd40ce7e8::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun finalize_market<T0, T1>(arg0: &0x21726826f8df6f875eb1d1d9e04cbfec2cc565b7eedcc362ec16b9dfd40ce7e8::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = @0x0;
        let v2 = 0;
        let v3 = 0x21726826f8df6f875eb1d1d9e04cbfec2cc565b7eedcc362ec16b9dfd40ce7e8::vault::new_lp_vault<T0, T1>(0x2::bag::new(arg7), arg1.curator, arg1.admin_public_key, 0x21726826f8df6f875eb1d1d9e04cbfec2cc565b7eedcc362ec16b9dfd40ce7e8::main::admin_key_id(arg0), arg7);
        if (arg1.is_auto_add_liquidity) {
            ...
            if (v11) {
                ...
                0x21726826f8df6f875eb1d1d9e04cbfec2cc565b7eedcc362ec16b9dfd40ce7e8::vault::add_position<T0, T1>(&mut v3, v20);
                ...
                0x21726826f8df6f875eb1d1d9e04cbfec2cc565b7eedcc362ec16b9dfd40ce7e8::vault::add_position<T0, T1>(&mut v3, v29);
        ...
        let v32 = arg1.soft_cap - arg1.soft_cap * 0x21726826f8df6f875eb1d1d9e04cbfec2cc565b7eedcc362ec16b9dfd40ce7e8::main::finalize_market_fee_bps(arg0) / 10000;
        let v33 = v32;
        if (arg1.is_auto_add_liquidity) {
        ...
        0x21726826f8df6f875eb1d1d9e04cbfec2cc565b7eedcc362ec16b9dfd40ce7e8::vault::share_lp_vault<T0, T1>(v3);
    }
    ...
    fun validate_params(arg0: &0x21726826f8df6f875eb1d1d9e04cbfec2cc565b7eedcc362ec16b9dfd40ce7e8::main::MainConfig, arg1: u64, arg2: u128, arg3: u64, arg4: u64, arg5: bool, arg6: u64) {
        assert!(arg3 + 0x21726826f8df6f875eb1d1d9e04cbfec2cc565b7eedcc362ec16b9dfd40ce7e8::main::finalize_market_fee_bps(arg0) <= 10000, 1);
        let v0 = 0;
        if (arg5) {
