module 0x9cac37ad544a16120a128a1237363766b9348f511d853f15794f1bfd5a9e0f53::errors {
    ...
    public fun deprecated_entry() : u64 {
        443
    }
    ...
    public fun maker_price_band() : u64 {
        444
    }
    ...
    public fun maker_scale_mismatch() : u64 {
        446
    }

    public fun maker_tick_mismatch() : u64 {
        441
    }
