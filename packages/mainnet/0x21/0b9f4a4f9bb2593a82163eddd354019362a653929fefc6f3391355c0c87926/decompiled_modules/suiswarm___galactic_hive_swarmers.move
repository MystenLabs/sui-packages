module 0x210b9f4a4f9bb2593a82163eddd354019362a653929fefc6f3391355c0c87926::suiswarm___galactic_hive_swarmers {
    struct SUISWARM___GALACTIC_HIVE_SWARMERS has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"3d901085-8f5e-49fc-a748-579990a4edf4"),
        };
    ...
    fun init(arg0: SUISWARM___GALACTIC_HIVE_SWARMERS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUISWARM___GALACTIC_HIVE_SWARMERS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SuiSwarm - Galactic Hive Swarmers"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Join the Galactic Hive Swarmers, cosmic defenders protecting the hive and thriving among the stars."));
