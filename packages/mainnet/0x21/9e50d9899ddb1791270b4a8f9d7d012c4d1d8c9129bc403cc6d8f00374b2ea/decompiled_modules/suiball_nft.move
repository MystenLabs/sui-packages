module 0x219e50d9899ddb1791270b4a8f9d7d012c4d1d8c9129bc403cc6d8f00374b2ea::suiball_nft {
    ...
    public entry fun mint_to_sender(arg0: &mut ItemStore, arg1: 0x2::coin::Coin<0x219e50d9899ddb1791270b4a8f9d7d012c4d1d8c9129bc403cc6d8f00374b2ea::usdc::USDC>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.counter < 5000, 1);
        assert!(arg2 > 0, 2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x219e50d9899ddb1791270b4a8f9d7d012c4d1d8c9129bc403cc6d8f00374b2ea::usdc::USDC>>(arg1, @0x78ef91440656f79fcd69c4b8867eb1c1f7866f4c36afa6cf55ee3c5a5597e467);
        let v0 = 0;
