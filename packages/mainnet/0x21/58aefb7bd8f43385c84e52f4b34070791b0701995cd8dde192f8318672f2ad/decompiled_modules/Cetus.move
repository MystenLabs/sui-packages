module 0x2158aefb7bd8f43385c84e52f4b34070791b0701995cd8dde192f8318672f2ad::Cetus {
    ...
    fun init(arg0: CETUS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CETUS>(arg0, 6, b"! Cetusairdrop com Airdrop token", b"CetusAirdrop.Scom", b"Token drop to active users of the CETUS platform", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.ibb.co/grMWK5X/photo-2024-10-25-20-04-32.jpg")), arg1);
