module 0x2111d27da5b48922feb0ded080f6cc2942be2abe1a7f3494ef2c623bf2554796::reward9022 {
    struct REWARD9022 has drop {
        dummy_field: bool,
    }

    struct TICKET_9022 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9022(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9022>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9022>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9022, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9022>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9022>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9022>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9022>>(v5, 0x2::tx_context::sender(arg1));
    }
