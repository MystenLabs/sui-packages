module 0x21b04746784e6dd60f811412c4eb1f787098ce9d22d4fc94c02713eed6035110::cnsnft2965 {
    struct CNSNFT2965 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2965, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2965>(arg0, arg1);
