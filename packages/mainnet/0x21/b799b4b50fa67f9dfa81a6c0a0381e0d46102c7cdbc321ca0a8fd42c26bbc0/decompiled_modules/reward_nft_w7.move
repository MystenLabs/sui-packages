module 0x21b799b4b50fa67f9dfa81a6c0a0381e0d46102c7cdbc321ca0a8fd42c26bbc0::reward_nft_w7 {
    struct REWARD_NFT_W7 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = REWARD_NFT{
                ...
                image_url   : 0x1::string::utf8(b"ipfs://Qmb8aa8CSAYrahTMCmMS8fMykqYm5xBMYUnmB5erU2V3vf"),
    ...
    fun init(arg0: REWARD_NFT_W7, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://Qmb8aa8CSAYrahTMCmMS8fMykqYm5xBMYUnmB5erU2V3vf"));
        ...
        let v4 = 0x2::package::claim<REWARD_NFT_W7>(arg0, arg1);
