module 0x21d9bc60185bf0f17afa78e85d323a69cc5a16acb19796c0062a9b614ac308b0::tako {
    ...
    fun init(arg0: TAKO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TAKO>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Tako"));
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreifdipemztdi3xziu3rzccqidgsfdmdmoyifihshqr2fp4pudbtp5m"));
