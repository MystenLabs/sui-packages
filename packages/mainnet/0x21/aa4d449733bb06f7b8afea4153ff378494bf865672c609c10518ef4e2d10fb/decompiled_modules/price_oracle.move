module 0x21aa4d449733bb06f7b8afea4153ff378494bf865672c609c10518ef4e2d10fb::price_oracle {
    ...
    public fun get_exchange_rate(arg0: 0x1::ascii::String, arg1: 0x1::ascii::String, arg2: &ExchangeRate) : u64 {
        ...
        let v0 = 0x21aa4d449733bb06f7b8afea4153ff378494bf865672c609c10518ef4e2d10fb::collection_utils::get_composite_key(arg0, arg1);
    ...
    public fun update_exchange_rates(arg0: vector<vector<0x1::ascii::String>>, arg1: vector<u64>, arg2: &AdminCap, arg3: &mut ExchangeRate) {
        ...
        while (v1 < v0) {
            ...
            let (v6, v7) = if (0x21aa4d449733bb06f7b8afea4153ff378494bf865672c609c10518ef4e2d10fb::collection_utils::compare_ascii_strings(v3, v4) == 1) {
                (v3, v4)
            } else {
                *v5 = get_reverse_rate(*v5);
                (v4, v3)
            };
            let v8 = 0x21aa4d449733bb06f7b8afea4153ff378494bf865672c609c10518ef4e2d10fb::collection_utils::get_composite_key(*v6, *v7);
