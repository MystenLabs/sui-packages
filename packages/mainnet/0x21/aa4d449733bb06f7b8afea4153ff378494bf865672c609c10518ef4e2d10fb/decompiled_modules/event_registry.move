module 0x21aa4d449733bb06f7b8afea4153ff378494bf865672c609c10518ef4e2d10fb::event_registry {
    ...
    public entry fun create_event(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>, arg5: u32, arg6: u64, arg7: u64, arg8: u16, arg9: u16, arg10: &Config, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<address>(&arg10.operators)) {
            0x2::transfer::public_transfer<0x21aa4d449733bb06f7b8afea4153ff378494bf865672c609c10518ef4e2d10fb::attendance::OperatorCap>(0x21aa4d449733bb06f7b8afea4153ff378494bf865672c609c10518ef4e2d10fb::attendance::create_op_cap(0x21aa4d449733bb06f7b8afea4153ff378494bf865672c609c10518ef4e2d10fb::event::create_event(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg11), arg11), *0x1::vector::borrow<address>(&arg10.operators, v0));
            v0 = v0 + 1;
        };
    }
