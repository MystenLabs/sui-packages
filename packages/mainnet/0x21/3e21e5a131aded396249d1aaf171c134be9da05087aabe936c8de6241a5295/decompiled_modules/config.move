module 0x213e21e5a131aded396249d1aaf171c134be9da05087aabe936c8de6241a5295::config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x213e21e5a131aded396249d1aaf171c134be9da05087aabe936c8de6241a5295::acl::ACL,
        package_version: u64,
    }
    ...
    public fun add_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        ...
        0x213e21e5a131aded396249d1aaf171c134be9da05087aabe936c8de6241a5295::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0x213e21e5a131aded396249d1aaf171c134be9da05087aabe936c8de6241a5295::acl::Member> {
        0x213e21e5a131aded396249d1aaf171c134be9da05087aabe936c8de6241a5295::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address) {
        checked_package_version(arg1);
        0x213e21e5a131aded396249d1aaf171c134be9da05087aabe936c8de6241a5295::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0x213e21e5a131aded396249d1aaf171c134be9da05087aabe936c8de6241a5295::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u128) {
        checked_package_version(arg1);
        0x213e21e5a131aded396249d1aaf171c134be9da05087aabe936c8de6241a5295::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    public fun checked_vault_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x213e21e5a131aded396249d1aaf171c134be9da05087aabe936c8de6241a5295::acl::has_role(&arg0.acl, arg1, 0), 1);
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            id              : 0x2::object::new(arg0),
            acl             : 0x213e21e5a131aded396249d1aaf171c134be9da05087aabe936c8de6241a5295::acl::new(arg0),
            package_version : 1,
        };
