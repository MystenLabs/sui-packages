module 0x21cc3708c515f15db49bef9e12cb520aa8cb1e4a94db4e0cb7c54f76a1690dfc::config {
    ...
    struct ProtocolConfig has store, key {
        ...
        suspicious_position_table: 0x2::table::Table<0x2::object::ID, bool>,
    }
    ...
    public(friend) fun add_suspicious_position(arg0: &AdminCap, arg1: &mut ProtocolConfig, arg2: 0x2::object::ID) {
        if (0x2::table::contains<0x2::object::ID, bool>(&arg1.suspicious_position_table, arg2)) {
            return
        };
        0x2::table::add<0x2::object::ID, bool>(&mut arg1.suspicious_position_table, arg2, true);
    }

    public(friend) fun assert_allow_staking(arg0: &ProtocolConfig) {
        assert!(arg0.open_staking, 0x21cc3708c515f15db49bef9e12cb520aa8cb1e4a94db4e0cb7c54f76a1690dfc::errors::error_not_allow_stake());
    }

    public(friend) fun assert_current_version_invalid(arg0: &ProtocolConfig) {
        assert!(arg0.version >= 1, 0x21cc3708c515f15db49bef9e12cb520aa8cb1e4a94db4e0cb7c54f76a1690dfc::errors::error_invalid_protocol_version());
    }

    public(friend) fun assert_max_staked_amount(arg0: &ProtocolConfig, arg1: u64) {
        assert!(arg0.max_staking_amount >= arg1, 0x21cc3708c515f15db49bef9e12cb520aa8cb1e4a94db4e0cb7c54f76a1690dfc::errors::error_max_staked_amount());
    }

    public(friend) fun assert_reward_info_registered(arg0: &ProtocolConfig, arg1: &0x1::type_name::TypeName) {
        assert!(0x2::vec_map::contains<0x1::type_name::TypeName, RewardConfig>(&arg0.reward_configs, arg1), 0x21cc3708c515f15db49bef9e12cb520aa8cb1e4a94db4e0cb7c54f76a1690dfc::errors::error_not_exist_reward_config());
    }

    public(friend) fun assert_suspicious_position(arg0: &ProtocolConfig, arg1: 0x2::object::ID) {
        assert!(!0x2::table::contains<0x2::object::ID, bool>(&arg0.suspicious_position_table, arg1), 0x21cc3708c515f15db49bef9e12cb520aa8cb1e4a94db4e0cb7c54f76a1690dfc::errors::error_suspicious_position());
    }
    ...
    public fun check_is_suspicious_position(arg0: &ProtocolConfig, arg1: 0x2::object::ID) : bool {
        0x2::table::contains<0x2::object::ID, bool>(&arg0.suspicious_position_table, arg1)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = ProtocolConfig{
            ...
            suspicious_position_table : 0x2::table::new<0x2::object::ID, bool>(arg0),
        };
        let v1 = AdminCap{id: 0x2::object::new(arg0)};
        0x21cc3708c515f15db49bef9e12cb520aa8cb1e4a94db4e0cb7c54f76a1690dfc::events::emit_init_config(0x2::object::id<AdminCap>(&v1), 0x2::object::id<ProtocolConfig>(&v0));
    ...
    public(friend) fun remove_suspicious_position(arg0: &AdminCap, arg1: &mut ProtocolConfig, arg2: 0x2::object::ID) {
        if (!0x2::table::contains<0x2::object::ID, bool>(&arg1.suspicious_position_table, arg2)) {
            return
        };
        0x2::table::remove<0x2::object::ID, bool>(&mut arg1.suspicious_position_table, arg2);
    }
    ...
    public(friend) fun set_reward_config<T0>(arg0: &AdminCap, arg1: &mut ProtocolConfig, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x21cc3708c515f15db49bef9e12cb520aa8cb1e4a94db4e0cb7c54f76a1690dfc::events::emit_update_reward_config(arg2, arg3, arg4);
    }
    ...
    public fun start_staking(arg0: &AdminCap, arg1: &mut ProtocolConfig) {
        ...
        0x21cc3708c515f15db49bef9e12cb520aa8cb1e4a94db4e0cb7c54f76a1690dfc::events::emit_update_staking_status(arg1.open_staking);
    }
    ...
    public fun update_package_version(arg0: &AdminCap, arg1: &mut ProtocolConfig, arg2: u64) {
        ...
        0x21cc3708c515f15db49bef9e12cb520aa8cb1e4a94db4e0cb7c54f76a1690dfc::events::emit_update_package_version(arg2);
    }
