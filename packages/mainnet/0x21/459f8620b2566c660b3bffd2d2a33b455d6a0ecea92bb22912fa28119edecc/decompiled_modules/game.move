module 0x21459f8620b2566c660b3bffd2d2a33b455d6a0ecea92bb22912fa28119edecc::game {
    ...
    public(friend) fun add_ticket_commit<T0>(arg0: &mut Game<T0>, arg1: &mut 0x21459f8620b2566c660b3bffd2d2a33b455d6a0ecea92bb22912fa28119edecc::fee_collector::FeeCollector<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 0, 5);
        let v0 = arg0.ticket_price;
        assert!(0x2::coin::value<T0>(&arg2) >= v0, 4);
        let v1 = 0x2::coin::into_balance<T0>(arg2);
        0x21459f8620b2566c660b3bffd2d2a33b455d6a0ecea92bb22912fa28119edecc::fee_collector::add_fee<T0>(arg1, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v1, calculate_pay_fee(v0, arg0.pay_fee_bp)), arg3));
    ...
    public(friend) fun new_and_shared<T0>(arg0: u64, arg1: u16, arg2: u16, arg3: u16, arg4: u16, arg5: u64, arg6: &mut 0x21459f8620b2566c660b3bffd2d2a33b455d6a0ecea92bb22912fa28119edecc::counter::Counter<T0>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, u64) {
        let v0 = Game<T0>{
        ...
        0x21459f8620b2566c660b3bffd2d2a33b455d6a0ecea92bb22912fa28119edecc::counter::increment<T0>(arg6);
    ...
    public(friend) fun to_happy_end_state<T0>(arg0: &mut Game<T0>, arg1: &mut 0x21459f8620b2566c660b3bffd2d2a33b455d6a0ecea92bb22912fa28119edecc::fee_collector::FeeCollector<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        assert!(arg0.status == 1, 5);
        ...
        0x21459f8620b2566c660b3bffd2d2a33b455d6a0ecea92bb22912fa28119edecc::fee_collector::add_fee<T0>(arg1, 0x2::coin::take<T0>(&mut arg0.total_balance, v0, arg3));
        let v2 = 0;
    ...
    public(friend) fun to_sad_end_state<T0>(arg0: &mut Game<T0>, arg1: &mut 0x21459f8620b2566c660b3bffd2d2a33b455d6a0ecea92bb22912fa28119edecc::fee_collector::FeeCollector<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 1, 5);
        0x21459f8620b2566c660b3bffd2d2a33b455d6a0ecea92bb22912fa28119edecc::fee_collector::add_last_round_pool_balance<T0>(arg1, 0x2::coin::take<T0>(&mut arg0.total_balance, 0x2::balance::value<T0>(&arg0.total_balance), arg3));
        arg0.status = 3;
        arg0.reveal_end_at = 0x2::clock::timestamp_ms(arg2);
    }
