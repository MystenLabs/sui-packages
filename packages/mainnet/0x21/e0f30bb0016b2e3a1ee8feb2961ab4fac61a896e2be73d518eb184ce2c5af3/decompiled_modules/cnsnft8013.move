module 0x21e0f30bb0016b2e3a1ee8feb2961ab4fac61a896e2be73d518eb184ce2c5af3::cnsnft8013 {
    struct CNSNFT8013 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8013, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2349"));
        let v4 = 0x2::package::claim<CNSNFT8013>(arg0, arg1);
