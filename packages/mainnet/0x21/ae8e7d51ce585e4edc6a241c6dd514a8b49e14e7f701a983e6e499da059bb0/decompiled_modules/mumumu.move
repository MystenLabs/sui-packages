module 0x21ae8e7d51ce585e4edc6a241c6dd514a8b49e14e7f701a983e6e499da059bb0::mumumu {
    ...
    fun init(arg0: MUMUMU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = &mut v4;
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Munakata #{token_id}"));
