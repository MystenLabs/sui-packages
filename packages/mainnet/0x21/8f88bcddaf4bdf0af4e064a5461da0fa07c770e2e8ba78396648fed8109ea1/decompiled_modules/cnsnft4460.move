module 0x218f88bcddaf4bdf0af4e064a5461da0fa07c770e2e8ba78396648fed8109ea1::cnsnft4460 {
    struct CNSNFT4460 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4460, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4460>(arg0, arg1);
