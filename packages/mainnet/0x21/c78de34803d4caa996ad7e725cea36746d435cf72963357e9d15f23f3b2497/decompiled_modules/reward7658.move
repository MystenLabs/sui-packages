module 0x21c78de34803d4caa996ad7e725cea36746d435cf72963357e9d15f23f3b2497::reward7658 {
    struct REWARD7658 has drop {
        dummy_field: bool,
    }

    struct TICKET_7658 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7658(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7658>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7658>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7658, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7658>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7658>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7658>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7658>>(v5, 0x2::tx_context::sender(arg1));
    }
