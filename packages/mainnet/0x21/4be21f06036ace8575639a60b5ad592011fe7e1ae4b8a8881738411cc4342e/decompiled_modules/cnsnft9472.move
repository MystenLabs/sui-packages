module 0x214be21f06036ace8575639a60b5ad592011fe7e1ae4b8a8881738411cc4342e::cnsnft9472 {
    struct CNSNFT9472 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9472, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9472>(arg0, arg1);
