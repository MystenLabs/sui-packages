module 0x21356de82004c19a114d008ceb02453df99bc3f212cb8c70eb78e609deb40e93::cnsnft9170 {
    struct CNSNFT9170 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9170, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6707"));
        let v4 = 0x2::package::claim<CNSNFT9170>(arg0, arg1);
