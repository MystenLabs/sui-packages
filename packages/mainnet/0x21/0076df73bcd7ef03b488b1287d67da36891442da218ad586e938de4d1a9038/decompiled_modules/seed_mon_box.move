module 0x210076df73bcd7ef03b488b1287d67da36891442da218ad586e938de4d1a9038::seed_mon_box {
    ...
    fun init(arg0: SEED_MON_BOX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A Random Seed Mox Box contain your loving Seed Mon. Go for our Adventure...<3"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidlnunirjyhp6y3sa5d46nadoxstsiv7x72znzx7sg6sokqagbl2q"));
