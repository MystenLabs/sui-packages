module 0x21448151cbea9e6b37388bcdc340a60ae25f5e3d03e0d6743fd46964de905c06::tokenservice {
    ...
    public entry fun add_pair_claiming<T0: store + key>(arg0: &mut AirdropPoolInfo, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun claim_tokendrop<T0>(arg0: &mut AirdropPoolInfo, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.delegate, 0);
    ...
    public entry fun init_airdrop_staking(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut AirdropPoolInfo, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2.initialized) {
    ...
    public entry fun init_claim_mechanism(arg0: &mut AirdropPoolInfo, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
