module 0x21919ebcc2772737bd3819405fe87b793cfc6a5f9001010663803c7e36689654::PEEPO {
    ...
    fun init(arg0: PEEPO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PEEPO>(arg0, 3, b"PEEPO", b"PEEPO", b"PEEPO on the SUI blockchain.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://www.dextools.io/resources/tokens/logos/ether/0xaada04204e9e1099daf67cf3d5d137e84e41cf41.jpeg?1682300532097")), arg1);
