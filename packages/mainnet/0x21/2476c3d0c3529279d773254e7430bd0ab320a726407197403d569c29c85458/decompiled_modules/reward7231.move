module 0x212476c3d0c3529279d773254e7430bd0ab320a726407197403d569c29c85458::reward7231 {
    struct REWARD7231 has drop {
        dummy_field: bool,
    }

    struct TICKET_7231 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7231(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7231>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7231>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7231, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7231>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7231>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7231>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7231>>(v5, 0x2::tx_context::sender(arg1));
    }
