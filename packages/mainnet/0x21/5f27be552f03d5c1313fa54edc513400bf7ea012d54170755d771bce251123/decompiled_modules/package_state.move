module 0x215f27be552f03d5c1313fa54edc513400bf7ea012d54170755d771bce251123::package_state {
    ...
    public(friend) fun check_version(arg0: &State) {
        assert!(0x215f27be552f03d5c1313fa54edc513400bf7ea012d54170755d771bce251123::consts::VERSION() >= arg0.available_version, 3);
    }

    fun get_feature_bit(arg0: &State, arg1: u8, arg2: u8) : bool {
        0x215f27be552f03d5c1313fa54edc513400bf7ea012d54170755d771bce251123::utils::get_bit(*0x1::vector::borrow<u256>(&arg0.features, (arg1 as u64)), arg2)
    }
    ...
    public(friend) fun init_(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = State{
            ...
            available_version : 0x215f27be552f03d5c1313fa54edc513400bf7ea012d54170755d771bce251123::consts::VERSION(),
