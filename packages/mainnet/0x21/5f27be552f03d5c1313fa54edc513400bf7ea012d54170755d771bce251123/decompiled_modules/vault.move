module 0x215f27be552f03d5c1313fa54edc513400bf7ea012d54170755d771bce251123::vault {
    ...
    public(friend) fun borrow<T0>(arg0: &Vault) : &0x2::balance::Balance<T0> {
        0x2::dynamic_field::borrow<0x1::ascii::String, 0x2::balance::Balance<T0>>(&arg0.id, 0x215f27be552f03d5c1313fa54edc513400bf7ea012d54170755d771bce251123::utils::get_type_name_string<T0>())
    }

    public(friend) fun borrow_mut<T0>(arg0: &mut Vault) : &mut 0x2::balance::Balance<T0> {
        0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x215f27be552f03d5c1313fa54edc513400bf7ea012d54170755d771bce251123::utils::get_type_name_string<T0>())
    }
    ...
    fun makesure<T0>(arg0: &mut Vault) {
        let v0 = 0x215f27be552f03d5c1313fa54edc513400bf7ea012d54170755d771bce251123::utils::get_type_name_string<T0>();
