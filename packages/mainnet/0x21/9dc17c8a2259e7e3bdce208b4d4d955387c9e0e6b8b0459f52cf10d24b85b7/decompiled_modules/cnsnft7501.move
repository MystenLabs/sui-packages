module 0x219dc17c8a2259e7e3bdce208b4d4d955387c9e0e6b8b0459f52cf10d24b85b7::cnsnft7501 {
    struct CNSNFT7501 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7501, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9520"));
        let v4 = 0x2::package::claim<CNSNFT7501>(arg0, arg1);
