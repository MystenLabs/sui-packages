module 0x215a680e8733db4f6fcdca9efd8ef7c0ded7c3e129e92221bb520ade3a1575f5::cnsnft2209 {
    struct CNSNFT2209 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2209, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2209>(arg0, arg1);
