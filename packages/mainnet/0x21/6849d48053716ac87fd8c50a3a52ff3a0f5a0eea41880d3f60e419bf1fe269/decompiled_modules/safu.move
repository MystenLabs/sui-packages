module 0x4a68c41bfa2b908ce449e411d0e16718839a62780df0fee568bc027ee2d14ebb::safu {
    ...
    public fun reduce_fund<T0>(arg0: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg1: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::TypusLeaderboardRegistry, arg2: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::TypusUserRegistry, arg3: &0x4a68c41bfa2b908ce449e411d0e16718839a62780df0fee568bc027ee2d14ebb::version::Version, arg4: &mut Registry, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        0x4a68c41bfa2b908ce449e411d0e16718839a62780df0fee568bc027ee2d14ebb::version::version_check(arg3);
        assert!(!arg4.transaction_suspended, 0);
        let v0 = 0x2::dynamic_field::remove<0x1::ascii::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::ManagerCap>(&mut arg4.id, 0x1::ascii::string(b"typus_manager_cap"));
        ...
        let v4 = 0;
        let v5 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::length(&v1.share);
        if (v5 > 0) {
            let v6 = (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::slice_size(&v1.share) as u64);
            let v7 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_slice<Share>(&v1.share, 0);
            while (v4 < v5) {
                if (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_from_slice<Share>(v7, v4 % v6).user == v2) {
                    break
                };
                if (v4 + 1 < v5 && (v4 + 1) % v6 == 0) {
                    let v8 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::get_slice_idx<Share>(v7) + 1;
                    v7 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_slice<Share>(&v1.share, v8);
                };
                v4 = v4 + 1;
            };
        };
        assert!(v4 < v5, 5);
        let v9 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_mut<Share>(&mut v1.share, v4);
        let v10 = 0;
        *0x1::vector::borrow_mut<u64>(&mut v9.u64_padding, 1) = 0x2::clock::timestamp_ms(arg9);
        0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::score(&v0, arg0, arg1, 0x1::ascii::string(b"depositor_program"), v2, v10, arg9, arg10);
        0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::add_tails_exp_amount(&v0, arg0, arg2, v2, v10);
        let v11 = if (*0x1::vector::borrow<u64>(&v9.share, 3) < arg6) {
            *0x1::vector::borrow<u64>(&v9.share, 3)
        } else {
            arg6
        };
        *0x1::vector::borrow_mut<u64>(&mut v9.share, 3) = *0x1::vector::borrow<u64>(&v9.share, 3) - v11;
        *0x1::vector::borrow_mut<u64>(&mut v1.share_supply, 3) = *0x1::vector::borrow<u64>(&v1.share_supply, 3) - v11;
        0x2::balance::join<T0>(&mut v3, 0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut v1.id, 0x1::ascii::string(b"deposit_balance")), v11));
        let v12 = if (*0x1::vector::borrow<u64>(&v9.share, 0) < arg7) {
            *0x1::vector::borrow<u64>(&v9.share, 0)
        } else {
            arg7
        };
        *0x1::vector::borrow_mut<u64>(&mut v9.share, 0) = *0x1::vector::borrow<u64>(&v9.share, 0) - v12;
        *0x1::vector::borrow_mut<u64>(&mut v1.share_supply, 0) = *0x1::vector::borrow<u64>(&v1.share_supply, 0) - v12;
        *0x1::vector::borrow_mut<u64>(&mut v9.share, 1) = *0x1::vector::borrow<u64>(&v9.share, 1) + v12;
        *0x1::vector::borrow_mut<u64>(&mut v1.share_supply, 1) = *0x1::vector::borrow<u64>(&v1.share_supply, 1) + v12;
        let v13 = if (*0x1::vector::borrow<u64>(&v9.share, 2) < arg8) {
            *0x1::vector::borrow<u64>(&v9.share, 2)
        } else {
            arg8
        };
        *0x1::vector::borrow_mut<u64>(&mut v9.share, 2) = *0x1::vector::borrow<u64>(&v9.share, 2) - v13;
        *0x1::vector::borrow_mut<u64>(&mut v1.share_supply, 2) = *0x1::vector::borrow<u64>(&v1.share_supply, 2) - v13;
        0x2::balance::join<T0>(&mut v3, 0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut v1.id, 0x1::ascii::string(b"deposit_balance")), v13));
        *0x1::vector::borrow_mut<u64>(&mut v9.u64_padding, 0) = ((((*0x1::vector::borrow<u64>(&v9.share, 0) + *0x1::vector::borrow<u64>(&v9.share, 3)) as u128) * (*0x1::vector::borrow<u64>(&v1.info, 6) as u128) / 10000 / (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::utility::multiplier(*0x1::vector::borrow<u64>(&v1.info, 9)) as u128)) as u64);
        assert!(v11 + v12 + v13 > 0, 1);
        let v14 = 0x1::vector::empty<u64>();
        let v15 = &mut v14;
        0x1::vector::push_back<u64>(v15, arg5);
        0x1::vector::push_back<u64>(v15, *0x1::vector::borrow<u64>(&v1.info, 1));
        0x1::vector::push_back<u64>(v15, v11);
        0x1::vector::push_back<u64>(v15, v12);
        0x1::vector::push_back<u64>(v15, v13);
        0x1::vector::push_back<u64>(v15, v10);
        let v16 = UserEvent{
            action      : 0x1::ascii::string(b"reduce_fund"),
            log         : v14,
            bcs_padding : vector[],
        };
        0x2::event::emit<UserEvent>(v16);
        0x2::dynamic_field::add<0x1::ascii::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::ManagerCap>(&mut arg4.id, 0x1::ascii::string(b"typus_manager_cap"), v0);
        v3
    }
    ...
    public fun snapshot(arg0: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg1: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::TypusLeaderboardRegistry, arg2: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::TypusUserRegistry, arg3: &0x4a68c41bfa2b908ce449e411d0e16718839a62780df0fee568bc027ee2d14ebb::version::Version, arg4: &mut Registry, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0;
        let v4 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::length(&v1.share);
        if (v4 > 0) {
            let v5 = (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::slice_size(&v1.share) as u64);
            let v6 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_slice<Share>(&v1.share, 0);
            while (v3 < v4) {
                if (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_from_slice<Share>(v6, v3 % v5).user == v2) {
                    break
                };
                if (v3 + 1 < v4 && (v3 + 1) % v5 == 0) {
                    let v7 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::get_slice_idx<Share>(v6) + 1;
                    v6 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_slice<Share>(&v1.share, v7);
                };
                v3 = v3 + 1;
            };
        };
        ...
        let v8 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_mut<Share>(&mut v1.share, v3);
        let v9 = 0;
        *0x1::vector::borrow_mut<u64>(&mut v8.u64_padding, 1) = 0x2::clock::timestamp_ms(arg6);
        0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::score(&v0, arg0, arg1, 0x1::ascii::string(b"depositor_program"), v2, v9, arg6, arg7);
        0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::add_tails_exp_amount(&v0, arg0, arg2, v2, v9);
        *0x1::vector::borrow_mut<u64>(&mut v8.u64_padding, 0) = ((((*0x1::vector::borrow<u64>(&v8.share, 0) + *0x1::vector::borrow<u64>(&v8.share, 3)) as u128) * (*0x1::vector::borrow<u64>(&v1.info, 6) as u128) / 10000 / (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::utility::multiplier(*0x1::vector::borrow<u64>(&v1.info, 9)) as u128)) as u64);
        let v10 = 0x1::vector::empty<u64>();
        let v11 = &mut v10;
        0x1::vector::push_back<u64>(v11, arg5);
        0x1::vector::push_back<u64>(v11, *0x1::vector::borrow<u64>(&v1.info, 1));
        0x1::vector::push_back<u64>(v11, v9);
        let v12 = UserEvent{
