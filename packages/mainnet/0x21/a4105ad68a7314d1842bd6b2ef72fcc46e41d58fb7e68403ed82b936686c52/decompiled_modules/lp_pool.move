module 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::lp_pool {
    ...
    struct LiquidityPool has store, key {
        ...
        liquidated_unsettled_receipts: vector<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>,
    ...
    public fun swap<T0, T1>(arg0: &mut 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: 0x2::coin::Coin<T0>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        ...
        assert!(v6 != v7, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::invalid_token_type());
        let v8 = get_mut_token_pool(v0, &v6);
        let v9 = v8.config;
        let v10 = get_mut_token_pool(v0, &v7);
        let v11 = v10.config;
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3) == v9.oracle_id, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg4) == v11.oracle_id, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
        let v12 = get_mut_token_pool(v0, &v6);
        let v13 = v12.state;
        let v14 = get_mut_token_pool(v0, &v7);
        let v15 = v14.state;
        assert!(v13.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_inactive());
        assert!(v15.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_inactive());
        let v16 = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::amount_to_usd(v5, v9.liquidity_token_decimal, v1, v2);
        let (v17, v18) = calculate_swap_fee(v0, v6, v5, v16, true);
        let (_, v20) = calculate_swap_fee(v0, v7, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::usd_to_amount(v16, v11.liquidity_token_decimal, v3, v4), v16, false);
        let (v21, v22) = if (v18 > v20) {
            (v17, v18)
        } else {
            (0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::usd_to_amount(v20, v9.liquidity_token_decimal, v1, v2), v20)
        };
        let v23 = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::usd_to_amount(v16 - v22, v11.liquidity_token_decimal, v3, v4);
        assert!(v23 >= arg6, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::reach_slippage_threshold());
        let v24 = get_mut_token_pool(v0, &v6);
        let v25 = 0x2::coin::into_balance<T0>(arg5);
        let v26 = 0x2::balance::value<T0>(&v25);
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::charge_fee<T0>(arg0, 0x2::balance::split<T0>(&mut v25, (((v21 as u128) * (v24.config.spot_config.swap_fee_protocol_share_bp as u128) / 10000) as u64)));
        ...
        assert!(v27.state.liquidity_amount + v26 <= v27.config.spot_config.max_capacity, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::reach_max_capacity());
        ...
        assert!(v29.state.liquidity_amount >= v29.state.reserved_amount, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::liquidity_not_enough());
    ...
    fun deposit_scallop_basic<T0>(arg0: &mut LiquidityPool, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg2: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg3: &0x2::clock::Clock, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::set_u64_vector_value(&mut v2.state.current_lending_amount, 0, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_u64_vector_value(&v2.state.current_lending_amount, 0) + 0x2::balance::value<T0>(&v1));
        let (v3, v4) = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::lending::deposit_scallop_basic<T0>(v1, arg1, arg2, arg3, arg5);
        let v5 = v4;
        ...
        let v9 = &mut v8;
        0x1::vector::push_back<u64>(v9, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_u64_vector_value(&v7.state.current_lending_amount, 0));
    ...
    fun withdraw_scallop_basic<T0>(arg0: &mut 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut LiquidityPool, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &0x2::clock::Clock, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : vector<u64> {
        let v0 = 0x1::type_name::get<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>();
        let (v1, v2) = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::lending::withdraw_scallop_basic<T0>(0x2::coin::from_balance<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(0x2::balance::split<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(&mut arg1.id, v0), arg5), arg6), arg2, arg3, arg4, arg6);
        let v3 = v2;
        let v4 = v1;
        let v5 = 0x1::type_name::get<T0>();
        let v6 = get_token_pool(arg1, &v5);
        let v7 = (((0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_u64_vector_value(&v6.state.current_lending_amount, 0) as u128) * (arg5 as u128) / (0x2::balance::value<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(0x2::dynamic_field::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(&arg1.id, v0)) as u128)) as u64);
        ...
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::charge_fee<T0>(arg0, 0x2::balance::split<T0>(&mut v4, v9));
        ...
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::set_u64_vector_value(&mut v11.state.current_lending_amount, 0, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_u64_vector_value(&v11.state.current_lending_amount, 0) - v7);
        v11.state.liquidity_amount = v11.state.liquidity_amount + 0x2::balance::value<T0>(&v4) - v7;
        let v12 = 0x1::vector::empty<u64>();
        let v13 = &mut v12;
        0x1::vector::push_back<u64>(v13, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_u64_vector_value(&v11.state.current_lending_amount, 0));
    ...
    entry fun add_liquidity_token<T0>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: &0x2::clock::Clock, arg23: &0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg23);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        let v1 = 0x1::type_name::get<T0>();
        assert!(!0x1::vector::contains<0x1::type_name::TypeName>(&v0.liquidity_tokens, &v1), 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::liquidity_token_existed());
        0x1::vector::push_back<0x1::type_name::TypeName>(&mut v0.liquidity_tokens, v1);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        assert!(arg8 <= 30, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::invalid_config_range());
        assert!(arg9 <= 30, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::invalid_config_range());
        assert!(arg10 <= 30, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::invalid_config_range());
        assert!(arg11 <= 30, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::invalid_config_range());
        assert!(arg12 <= 30, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::invalid_config_range());
        assert!(arg13 <= 10000, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::invalid_config_range());
        assert!(arg14 <= 3000, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::invalid_config_range());
        let v2 = if (arg18 > 0) {
            if (arg18 < arg19) {
                arg19 < 10000
            } else {
        ...
        assert!(v2, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::invalid_config_range());
        assert!(arg20 > 0, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::invalid_config_range());
        assert!(arg21 > 0, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::invalid_config_range());
        let v3 = SpotConfig{
            min_deposit                : arg6,
            max_capacity               : arg7,
    ...
    public fun burn_lp<T0, T1>(arg0: &mut 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::treasury_caps::TreasuryCaps, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: 0x2::coin::Coin<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        deprecated();
        0x2::coin::destroy_zero<T1>(arg5);
        0x2::coin::zero<T0>(arg7)
    }

    fun burn_lp_<T0, T1>(arg0: &mut 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::treasury_caps::TreasuryCaps, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: 0x2::balance::Balance<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(v9.state.liquidity_amount >= v9.state.reserved_amount, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::liquidity_not_enough());
        ...
        0x2::coin::burn<T0>(0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::treasury_caps::get_mut_treasury_cap<T0>(arg3), 0x2::coin::from_balance<T0>(arg5, arg7));
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::charge_fee<T1>(arg0, 0x2::balance::split<T1>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut v10.id, v0), v7));
        let v11 = BurnLpEvent{
    ...
    public(friend) fun calculate_burn_lp(arg0: &Registry, arg1: u64, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: u64, arg5: u64) : (u64, u64, u64, u64) {
        ...
        assert!(v0.pool_info.total_share_supply > 0, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::zero_total_supply());
        let v2 = (((arg5 as u128) * (v0.pool_info.tvl_usd as u128) / (v0.pool_info.total_share_supply as u128)) as u64);
        let v3 = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::usd_to_amount(v2, v1.config.liquidity_token_decimal, arg3, arg4);
    ...
    public(friend) fun calculate_lp_fee(arg0: &LiquidityPool, arg1: 0x1::type_name::TypeName, arg2: u64, arg3: u64, arg4: bool) : (u64, u64) {
        ...
        let v5 = if (arg4) {
            ...
            assert!(v2 >= arg3, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::liquidity_not_enough());
            v2 - arg3
        };
        let v6 = if (v3 > v5) {
            v3 - v5
    ...
    public(friend) fun calculate_mint_lp(arg0: &Registry, arg1: u64, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: u64, arg5: u64) : (u64, u64, u64) {
        let v0 = get_liquidity_pool(arg0, arg1);
        let v1 = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::amount_to_usd(arg5, get_token_pool(v0, &arg2).config.liquidity_token_decimal, arg3, arg4);
        let (_, v3) = calculate_lp_fee(v0, arg2, arg5, v1, true);
        assert!(v1 >= v3, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::insufficient_amount_for_mint_fee());
    ...
    public(friend) fun check_remove_liquidity_token_process_status(arg0: &RemoveLiquidityTokenProcess, arg1: u64) {
        let v0 = if (arg0.status == 0) {
            0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::process_should_remove_position()
        } else if (arg0.status == 1) {
            0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::process_should_remove_order()
        } else if (arg0.status == 2) {
            0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::process_should_swap()
        } else {
            assert!(arg0.status == 3, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::unsupported_process_status_code());
            0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::process_should_repay_liquidity()
        };
    ...
    public(friend) fun check_token_pool_status<T0>(arg0: &Registry, arg1: u64, arg2: bool) {
        let v0 = 0x1::type_name::get<T0>();
        if (arg2) {
            assert!(get_token_pool(get_liquidity_pool(arg0, arg1), &v0).state.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_inactive());
        } else {
            assert!(!get_token_pool(get_liquidity_pool(arg0, arg1), &v0).state.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_already_active());
        };
    }
    ...
    public fun claim<T0, T1>(arg0: &mut 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::treasury_caps::TreasuryCaps, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::version_check(arg0);
        let v0 = get_liquidity_pool(arg1, arg2);
        assert!(0x1::type_name::get<T0>() == v0.lp_token_type, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::lp_token_type_mismatched());
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        assert!(check_tvl_updated(v0, arg5), 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::tvl_not_yet_updated());
        let v1 = 0x1::type_name::get<T1>();
        let v2 = get_token_pool(v0, &v1);
        assert!(v2.state.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_inactive());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg4) == v2.config.oracle_id, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
        ...
        assert!(0x2::table::contains<address, vector<DeactivatingShares<T0>>>(v4, v5), 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::user_deactivating_shares_not_existed());
        ...
        if (0x2::balance::value<T0>(&v8) > 0) {
            0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::set_u64_vector_value(&mut v3.u64_padding, 0, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_u64_vector_value(&v3.u64_padding, 0) - 0x2::balance::value<T0>(&v8));
        };
        burn_lp_<T0, T1>(arg0, arg1, arg2, arg3, arg4, v8, arg5, arg6)
    }

    public fun complete_rebalancing<T0, T1>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: 0x2::balance::Balance<T1>, arg6: RebalanceProcess, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg8);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        let v1 = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_u64_vector_value(&v0.u64_padding, 2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        ...
        assert!(v11.state.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_already_active());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3) == v11.config.oracle_id, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
        let v12 = v11.state.liquidity_amount;
        let v13 = 0x1::type_name::get<T1>();
        let v14 = get_mut_token_pool(v0, &v13);
        assert!(v14.state.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_already_active());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg4) == v14.config.oracle_id, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
        let v15 = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::amount_to_usd(0x2::balance::value<T1>(&arg5), v14.config.liquidity_token_decimal, v8, v9);
        ...
        assert!(arg2 == v16, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::rebalance_process_field_mismatched());
        assert!(v17 == 0x1::type_name::get<T0>(), 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::rebalance_process_field_mismatched());
        assert!(v18 == v3, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::rebalance_process_field_mismatched());
        assert!(v20 == v6, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::rebalance_process_field_mismatched());
        assert!(v22 == 0x1::type_name::get<T1>(), 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::rebalance_process_field_mismatched());
        assert!(v23 == v5, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::rebalance_process_field_mismatched());
        assert!(v24 == v8, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::rebalance_process_field_mismatched());
        assert!((((v15 as u128) * ((10000 + v1) as u128) / 10000) as u64) >= v21, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::exceed_rebalance_cost_threshold());
    ...
    public fun complete_remove_liquidity_token_process<T0>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: RemoveLiquidityTokenProcess, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(v0, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::friction_too_large());
    ...
    entry fun create_deactivating_shares<T0>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg3);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        assert!(!0x2::dynamic_field::exists_<0x1::string::String>(&v0.id, 0x1::string::utf8(b"deactivating_shares")), 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::deactivating_shares_already_existed());
        ...
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::set_u64_vector_value(&mut v0.u64_padding, 0, 0);
    }
    ...
    public(friend) fun get_expired_receipt_collateral_bcs(arg0: &Registry, arg1: &0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg2: u64) : vector<vector<u8>> {
        ...
        let v2 = 0;
        while (v2 < 0x1::vector::length<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>(v1)) {
            let v3 = 0x1::vector::borrow<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>(v1, v2);
            let v4 = true;
            let v5 = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::get_bid_receipts(v3);
            let v6 = 0;
            ...
            if (v4) {
                0x1::vector::push_back<vector<u8>>(&mut v0, 0x2::bcs::to_bytes<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>(v3));
            };
            v2 = v2 + 1;
        };
        v0
    ...
    public(friend) fun get_mut_token_pool(arg0: &mut LiquidityPool, arg1: &0x1::type_name::TypeName) : &mut TokenPool {
        ...
        abort 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::liquidity_token_not_existed()
    }

    public fun get_pool_liquidity(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &Registry, arg2: u64) : (u64, u64, vector<0x1::type_name::TypeName>, vector<u64>, vector<u64>) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::version_check(arg0);
        let v0 = get_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        let v1 = 0;
    ...
    public(friend) fun get_receipt_collateral(arg0: &mut LiquidityPool) : vector<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt> {
        let v0 = 0x1::vector::empty<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>();
        while (0x1::vector::length<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>(&arg0.liquidated_unsettled_receipts) > 0) {
            0x1::vector::push_back<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>(&mut v0, 0x1::vector::pop_back<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>(&mut arg0.liquidated_unsettled_receipts));
        };
        v0
    }
    ...
    public(friend) fun get_receipt_collateral_bcs(arg0: &Registry, arg1: u64) : vector<vector<u8>> {
        ...
        let v2 = 0;
        while (v2 < 0x1::vector::length<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>(v1)) {
            0x1::vector::push_back<vector<u8>>(&mut v0, 0x2::bcs::to_bytes<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>(0x1::vector::borrow<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>(v1, v2)));
            v2 = v2 + 1;
        };
        v0
    }
    ...
    entry fun manager_deposit_scallop<T0>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg4: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg5: &0x2::clock::Clock, arg6: 0x1::option::Option<u64>, arg7: &mut 0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg7);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        let v1 = 0x1::type_name::get<T0>();
        let v2 = get_mut_token_pool(v0, &v1);
        assert!(v2.state.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_already_active());
        let v3 = v2.state.liquidity_amount - v2.state.reserved_amount;
        let v4 = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_u64_vector_value(&v2.state.current_lending_amount, 0) + 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_u64_vector_value(&v2.state.current_lending_amount, 1);
        let v5 = if (v3 >= v4) {
            v3 - v4
        } else {
            0
    ...
    entry fun manager_emergency_deposit<T0, T1>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x2::coin::into_balance<T0>(arg3);
        let v2 = 0x2::balance::value<T0>(&v1);
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg4);
        let v3 = get_liquidity_pool(arg1, arg2);
        assert!(0x1::type_name::get<T1>() == v3.lp_token_type, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::lp_token_type_mismatched());
        assert!(v3.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        assert!(get_token_pool(v3, &v0).state.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_inactive());
    ...
    entry fun manager_emergency_withdraw<T0, T1>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: ManagerDepositReceiptV2, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        ...
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg4);
        assert!(v2 == arg2, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_index_mismatched());
        assert!(v0 == v3, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::invalid_token_type());
        let v6 = get_liquidity_pool(arg1, arg2);
        assert!(0x1::type_name::get<T1>() == v6.lp_token_type, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::lp_token_type_mismatched());
        assert!(v6.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        assert!(get_token_pool(v6, &v0).state.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_inactive());
    ...
    public fun manager_flash_remove_liquidity<T0>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: RemoveLiquidityTokenProcess, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, RemoveLiquidityTokenProcess) {
        ...
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3) == v3.config.oracle_id, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
        ...
        arg4.removed_usd = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::amount_to_usd(v2, v3.config.liquidity_token_decimal, v4, v5);
    ...
    public fun manager_flash_repay_liquidity<T0>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: RemoveLiquidityTokenProcess, arg5: 0x2::balance::Balance<T0>, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) : RemoveLiquidityTokenProcess {
        ...
        assert!(v3.state.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_inactive());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3) == v3.config.oracle_id, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
        ...
        let v7 = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::amount_to_usd(v4, v3.config.liquidity_token_decimal, v5, v6);
    ...
    entry fun manager_remove_liquidity_token<T0>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg3);
        check_token_pool_status<T0>(arg1, arg2, false);
        let v0 = 0x1::type_name::get<T0>();
        let v1 = get_mut_liquidity_pool(arg1, arg2);
    ...
    entry fun manager_withdraw_scallop<T0>(arg0: &mut 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg4: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg5: &0x2::clock::Clock, arg6: 0x1::option::Option<u64>, arg7: &mut 0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg7);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        let v1 = 0x1::type_name::get<T0>();
    ...
    public fun mint_lp<T0, T1>(arg0: &mut 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: &mut 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::treasury_caps::TreasuryCaps, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: u64, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let v0 = 0x1::type_name::get<T0>();
        ...
        assert!(0x1::type_name::get<T1>() == v5.lp_token_type, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::lp_token_type_mismatched());
        assert!(v5.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        assert!(check_tvl_updated(v5, arg6), 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::tvl_not_yet_updated());
        let v6 = get_token_pool(v5, &v0);
        assert!(v4 >= v6.config.spot_config.min_deposit, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::deposit_amount_insufficient());
        assert!(v6.state.liquidity_amount + v4 <= v6.config.spot_config.max_capacity, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::reach_max_capacity());
        assert!(v6.state.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_inactive());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3) == v6.config.oracle_id, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
        ...
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::charge_fee<T0>(arg0, v11);
        ...
        0x2::coin::mint<T1>(0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::treasury_caps::get_mut_treasury_cap<T1>(arg2), v9, arg7)
    }

    entry fun new_liquidity_pool<T0>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg4);
        ...
        let v3 = LiquidityPool{
            ...
            pool_info                     : v0,
            liquidated_unsettled_receipts : 0x1::vector::empty<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>(),
            u64_padding                   : v1,
    ...
    public(friend) fun order_filled<T0>(arg0: &mut LiquidityPool, arg1: bool, arg2: u64, arg3: 0x2::balance::Balance<T0>) {
        assert!(arg0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
    ...
    public(friend) fun put_collateral<T0>(arg0: &mut LiquidityPool, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64) {
        ...
        v1.state.value_in_usd = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::amount_to_usd(v1.state.liquidity_amount, v2.liquidity_token_decimal, arg2, arg3);
        let v3 = 0;
        let v4 = 0;
    ...
    public(friend) fun put_receipt_collaterals(arg0: &mut LiquidityPool, arg1: vector<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>) {
        0x1::vector::append<0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::escrow::UnsettledBidReceipt>(&mut arg0.liquidated_unsettled_receipts, arg1);
    }

    public fun rebalance<T0, T1>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) : (RebalanceProcess, 0x2::balance::Balance<T0>) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg7);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        let v1 = 0x1::type_name::get<T0>();
        ...
        assert!(v11.state.liquidity_amount >= v11.state.reserved_amount, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::liquidity_not_enough());
        let v12 = v11.state.liquidity_amount;
        let v13 = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::amount_to_usd(arg5, v2, v5, v6);
        let v14 = 0x1::type_name::get<T1>();
        let v15 = get_mut_token_pool(v0, &v14);
        assert!(v15.state.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_already_active());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg4) == v15.config.oracle_id, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
    ...
    public fun redeem<T0>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: 0x2::balance::Balance<T0>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::version_check(arg0);
        update_borrow_info(arg0, arg1, arg2, arg4);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        assert!(check_tvl_updated(v0, arg4), 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::tvl_not_yet_updated());
        assert!(0x1::type_name::get<T0>() == v0.lp_token_type, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::lp_token_type_mismatched());
        let v1 = 0x2::tx_context::sender(arg5);
        let v2 = 0x2::balance::value<T0>(&arg3);
        let v3 = 0x2::clock::timestamp_ms(arg4);
        let v4 = v3 + 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_u64_vector_value(&v0.u64_padding, 1);
        ...
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::set_u64_vector_value(&mut v0.u64_padding, 0, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_u64_vector_value(&v0.u64_padding, 0) + v2);
        let v8 = RedeemEvent{
            sender          : v1,
            index           : arg2,
            share           : v2,
            share_price     : (((v0.pool_info.tvl_usd as u128) * (0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::multiplier(0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_usd_decimal()) as u128) / (v0.pool_info.total_share_supply as u128)) as u64),
            timestamp_ts_ms : v3,
            unlock_ts_ms    : v4,
            u64_padding     : 0x1::vector::empty<u64>(),
        };
    ...
    public(friend) fun request_collateral<T0>(arg0: &mut LiquidityPool, arg1: u64, arg2: u64, arg3: u64) : 0x2::balance::Balance<T0> {
        ...
        v2.state.value_in_usd = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::amount_to_usd(v2.state.liquidity_amount, v3.liquidity_token_decimal, arg2, arg3);
        let v4 = 0;
        let v5 = 0;
    ...
    entry fun resume_pool(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg3);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(!v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_already_active());
    ...
    entry fun resume_token_pool<T0>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg3);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        let v1 = 0x1::type_name::get<T0>();
    ...
    public(friend) fun safety_check(arg0: &LiquidityPool, arg1: 0x1::type_name::TypeName, arg2: address) {
        assert!(check_active(arg0), 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        assert!(oracle_matched(arg0, arg1, arg2), 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
    }

    public fun start_remove_liquidity_token_process<T0>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x2::tx_context::TxContext) : RemoveLiquidityTokenProcess {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg4);
        check_token_pool_status<T0>(arg1, arg2, false);
        let v0 = 0x1::type_name::get<T0>();
        ...
        assert!(v2 == v1.oracle_id, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
    ...
    entry fun suspend_pool(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg3);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
    ...
    entry fun suspend_token_pool<T0>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg3);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        let v1 = 0x1::type_name::get<T0>();
    ...
    public fun update_borrow_info(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::clock::Clock) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::version_check(arg0);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
    ...
    public fun update_liquidity_value<T0>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::version_check(arg0);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        let v1 = 0x1::type_name::get<T0>();
    ...
    entry fun update_rebalance_cost_threshold_bp(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg4);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        assert!(arg3 >= 0 && arg3 < 100, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::invalid_config_range());
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::set_u64_vector_value(&mut v0.u64_padding, 2, arg3);
        let v1 = UpdateRebalanceCostThresholdBpEvent{
            sender                               : 0x2::tx_context::sender(arg4),
            index                                : arg2,
            previous_rebalance_cost_threshold_bp : 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_u64_vector_value(&v0.u64_padding, 2),
    ...
    fun update_tvl(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut LiquidityPool, arg2: 0x1::type_name::TypeName, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x2::clock::Clock) : vector<u64> {
        ...
        let v4 = v3.config;
        assert!(v4.oracle_id == 0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3), 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
        v3.state.value_in_usd = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::amount_to_usd(v3.state.liquidity_amount, v4.liquidity_token_decimal, v1, v2);
    ...
    entry fun update_unlock_countdown_ts_ms(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::verify(arg0, arg4);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::pool_inactive());
        0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::set_u64_vector_value(&mut v0.u64_padding, 1, arg3);
        let v1 = UpdateUnlockCountdownTsMsEvent{
            sender                          : 0x2::tx_context::sender(arg4),
            index                           : arg2,
            previous_unlock_countdown_ts_ms : 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::get_u64_vector_value(&v0.u64_padding, 1),
    ...
    public(friend) fun view_swap_result<T0, T1>(arg0: &0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::admin::Version, arg1: &Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: u64, arg6: &0x2::clock::Clock) : vector<u64> {
        ...
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3) == v7.oracle_id, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg4) == v8.oracle_id, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::oracle_mismatched());
        let v9 = get_token_pool(v0, &v5).state;
        let v10 = get_token_pool(v0, &v6).state;
        assert!(v9.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_inactive());
        assert!(v10.is_active, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::error::token_pool_inactive());
        let v11 = 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::amount_to_usd(arg5, v7.liquidity_token_decimal, v1, v2);
        let (v12, v13) = calculate_swap_fee(v0, v5, arg5, v11, true);
        let (_, v15) = calculate_swap_fee(v0, v6, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::usd_to_amount(v11, v8.liquidity_token_decimal, v3, v4), v11, false);
        let (v16, v17) = if (v13 > v15) {
            (v12, v13)
        } else {
            (0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::usd_to_amount(v15, v7.liquidity_token_decimal, v1, v2), v15)
        };
        let v18 = 0x1::vector::empty<u64>();
        let v19 = &mut v18;
        0x1::vector::push_back<u64>(v19, 0x21a4105ad68a7314d1842bd6b2ef72fcc46e41d58fb7e68403ed82b936686c52::math::usd_to_amount(v11 - v17, v8.liquidity_token_decimal, v3, v4));
