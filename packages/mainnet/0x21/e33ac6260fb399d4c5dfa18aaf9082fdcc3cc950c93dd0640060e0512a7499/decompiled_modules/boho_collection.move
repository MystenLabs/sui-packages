module 0x31363086e130d0495bd41284c04d1b4700c08b67e448f068b9cab483a2f682f3::boho_collection {
    ...
    public entry fun update_hardd(arg0: &mut InfoCollection, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x31363086e130d0495bd41284c04d1b4700c08b67e448f068b9cab483a2f682f3::witness::check_owner(arg3), 1);
        arg0.sum_nft = arg1;
        arg0.supply = arg2;
    }

    public entry fun update_metadata(arg0: &mut InfoCollection, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x31363086e130d0495bd41284c04d1b4700c08b67e448f068b9cab483a2f682f3::witness::check_owner(arg1), 1);
        arg0.metadata = 0x1::string::utf8(0x31363086e130d0495bd41284c04d1b4700c08b67e448f068b9cab483a2f682f3::utils::get_metadata_url());
    }
