module 0x21bc2df4141064eefb7ca69db0620b6f13fba934df69baaef0ffadd6a2f0c212::cnsnft1992 {
    struct CNSNFT1992 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1992, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1992>(arg0, arg1);
