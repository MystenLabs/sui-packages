module 0x21d114251c6b3712d9ee219af995c9bf71727e3b78fc605d7d60f8768d3cc524::w_xy {
    ...
    fun init(arg0: W_XY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<W_XY>(arg0, 9, b"FTST3", b"FinalTest3", b"TestWX", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://fastly.picsum.photos/id/457/200/200.jpg?hmac=joY8RjIQZTMCo8z_GiovGX8NznT0ZEznz7f1Xy0NQQg"))), arg1);
        let v2 = v0;
