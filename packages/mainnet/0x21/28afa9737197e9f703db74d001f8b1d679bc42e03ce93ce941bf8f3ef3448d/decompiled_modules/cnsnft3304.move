module 0x2128afa9737197e9f703db74d001f8b1d679bc42e03ce93ce941bf8f3ef3448d::cnsnft3304 {
    struct CNSNFT3304 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3304, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3304>(arg0, arg1);
