module 0x2132f846be6b40cac03f581cebe58464c7b8d8e85e14822a69f15822447d82f0::config {
    ...
    public(friend) fun increase_version(arg0: &mut GlobalConfig) : (u64, u64) {
        assert!(arg0.version < 5, 0x2132f846be6b40cac03f581cebe58464c7b8d8e85e14822a69f15822447d82f0::errors::verion_cant_be_increased());
    ...
    public(friend) fun remove_reward_manager(arg0: &mut GlobalConfig, arg1: address) {
        assert!(verify_reward_manager(arg0, arg1), 0x2132f846be6b40cac03f581cebe58464c7b8d8e85e14822a69f15822447d82f0::errors::reward_manager_not_found());
        let v0 = 0;
    ...
    public(friend) fun set_reward_manager(arg0: &mut GlobalConfig, arg1: address) {
        assert!(!verify_reward_manager(arg0, arg1), 0x2132f846be6b40cac03f581cebe58464c7b8d8e85e14822a69f15822447d82f0::errors::already_a_reward_manger());
    ...
    public fun verify_version(arg0: &GlobalConfig) {
        assert!(arg0.version == 5, 0x2132f846be6b40cac03f581cebe58464c7b8d8e85e14822a69f15822447d82f0::errors::version_mismatch());
    }
