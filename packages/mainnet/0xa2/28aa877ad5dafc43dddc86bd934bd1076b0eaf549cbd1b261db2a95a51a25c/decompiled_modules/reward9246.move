module 0xa228aa877ad5dafc43dddc86bd934bd1076b0eaf549cbd1b261db2a95a51a25c::reward9246 {
    struct REWARD9246 has drop {
        dummy_field: bool,
    }

    struct TICKET_9246 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9246(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_9246>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9246, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9246>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9246>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9246>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9246>>(v5, 0x2::tx_context::sender(arg1));
    }
