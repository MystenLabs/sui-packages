module 0xa2934fabc5a994f97e05c7452fb122bfa94c06ff5726dc06dd3f9f1db5102eed::d {
    struct Ld has drop {
        mra: u64,
        mla: u64,
    ...
    public fun gold_d(arg0: &0xa2934fabc5a994f97e05c7452fb122bfa94c06ff5726dc06dd3f9f1db5102eed::admin::AdminCap, arg1: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg3: &0xca5a5a62f01c79a104bf4d31669e29daa387f325c241de4edbe30986a9bc8b0d::coin_decimals_registry::CoinDecimalsRegistry, arg4: &0x1478a432123e4b3d61878b629f2c692969fdb375644f1251cd278a4b1e7d7cd6::x_oracle::XOracle, arg5: &0x2::clock::Clock) : OldD {
        ...
        if (0xad013d5fde39e15eabda32b3dbdafd67dac32b798ce63237c27a8f73339b9b6f::fixed_point32_empower::gt(v1, v0)) {
            ...
            while (v4 < 0x1::vector::length<0x1::type_name::TypeName>(&v3)) {
                ...
                let v7 = 0x1::u64::pow(10, 0xca5a5a62f01c79a104bf4d31669e29daa387f325c241de4edbe30986a9bc8b0d::coin_decimals_registry::decimals(arg3, v6));
                let v8 = 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::price::get_price(arg4, v6, arg5);
                let v9 = 0;
                while (v9 < 0x1::vector::length<0x1::type_name::TypeName>(&v5)) {
                    let v10 = *0x1::vector::borrow<0x1::type_name::TypeName>(&v5, v9);
