module 0xa28bda673dfcf4a9856efea9b7cb88fb2d453688585afd4f265ff6fa983d5e18::USDT {
    ...
    fun init(arg0: USDT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<USDT>(arg0, 6, b"USDT  ", b"USDT ", b"USDTOKEN", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://bridge-assets.sui.io/usdt.png")), arg1);
