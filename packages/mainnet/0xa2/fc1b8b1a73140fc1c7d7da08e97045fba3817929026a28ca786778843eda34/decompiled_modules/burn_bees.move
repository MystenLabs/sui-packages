module 0x30c54cc0593068a1f2a2ca7758e0e7315401adf5bf44b198683a49ee49b811e::burn_bees {
    ...
    public fun bees_tokens_to_coin<T0>(arg0: &mut 0x2::token::Token<T0>, arg1: &BurnCap<T0>, arg2: &mut 0x2::token::TokenPolicy<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v8 = &mut v3;
        verify<T0>(arg2, v8, arg4);
        let (_, _, _, _) = 0x2::token::confirm_request_mut<T0>(arg2, v3, arg4);
        v1
    }
    ...
    public fun testing_update_policy<T0>(arg0: &mut 0x2::token::TokenPolicy<T0>, arg1: &mut BurnCap<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::token::add_rule_for_action<T0, Burn>(arg0, &arg1.policy_cap, 0x2::token::spend_action(), arg2);
        0x2::token::add_rule_for_action<T0, Burn>(arg0, &arg1.policy_cap, 0x2::token::from_coin_action(), arg2);
    }
    ...
    public fun transfer_bees<T0>(arg0: &mut 0x2::token::Token<T0>, arg1: &BurnCap<T0>, arg2: &mut 0x2::token::TokenPolicy<T0>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::token::spend<T0>(0x2::token::split<T0>(&mut v0, 0x37a0fdbfe809f23fe6f8a5e4b7f350b77019823e8f5c54b9382508578ff573c3::math::mul_div_u128((arg3 as u128), (3 as u128), (100 as u128)), arg5), arg5);
        let (_, _, _, _) = 0x2::token::confirm_with_policy_cap<T0>(&arg1.policy_cap, 0x2::token::transfer<T0>(v0, arg4, arg5), arg5);
        let v6 = &mut v1;
        verify<T0>(arg2, v6, arg5);
        let (_, _, _, _) = 0x2::token::confirm_request_mut<T0>(arg2, v1, arg5);
    }
