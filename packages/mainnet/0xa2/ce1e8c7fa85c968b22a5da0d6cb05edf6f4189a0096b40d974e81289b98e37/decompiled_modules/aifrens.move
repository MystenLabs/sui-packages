module 0xa2ce1e8c7fa85c968b22a5da0d6cb05edf6f4189a0096b40d974e81289b98e37::aifrens {
    ...
    public entry fun beta_claim(arg0: &mut BetaPool, arg1: &0x2::clock::Clock, arg2: &0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::AifrensGenesis, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        0xa2ce1e8c7fa85c968b22a5da0d6cb05edf6f4189a0096b40d974e81289b98e37::event::airdrop_event(v1, v2);
        v2
    }

    fun calc_claim_after_4_days(arg0: u64, arg1: u64, arg2: u64) : u64 {
        let v0 = if (arg1 + 3 * 86400000 < arg2) {
            0xa2ce1e8c7fa85c968b22a5da0d6cb05edf6f4189a0096b40d974e81289b98e37::math::mul_div(arg0, 95, 100)
        } else {
            arg0
        };
        let v1 = if (arg1 + 4 * 86400000 < arg2) {
            0xa2ce1e8c7fa85c968b22a5da0d6cb05edf6f4189a0096b40d974e81289b98e37::math::mul_div(v0, 94, 100)
        } else {
            v0
        };
        let v2 = if (arg1 + 5 * 86400000 < arg2) {
            0xa2ce1e8c7fa85c968b22a5da0d6cb05edf6f4189a0096b40d974e81289b98e37::math::mul_div(v1, 93, 100)
        } else {
            v1
        };
        if (arg1 + 6 * 86400000 < arg2) {
            0xa2ce1e8c7fa85c968b22a5da0d6cb05edf6f4189a0096b40d974e81289b98e37::math::mul_div(v2, 92, 100)
        } else {
            v2
        }
    }
    ...
    public fun can_claim_amount(arg0: &AifrensPool, arg1: &0x2::clock::Clock, arg2: address) : u64 {
        ...
        if (v0 >= arg0.max_addresses) {
            ...
            while (v3 < 0xa2ce1e8c7fa85c968b22a5da0d6cb05edf6f4189a0096b40d974e81289b98e37::math::mul_div(v0 + 1, 100 * 1000000000000, arg0.max_addresses)) {
                let v4 = v2 * 80;
                v2 = v4 / 100;
    ...
    public fun can_claim_beta_amount(arg0: &BetaPool, arg1: &0x2::clock::Clock, arg2: &0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::AifrensGenesis) : u64 {
        ...
        let v2 = if (v1 > 1683693900000 + 2 * 86400000) {
            arg0.init_claim
        } else if (v1 > 1683693900000 + 86400000) {
            arg0.init_claim * 4
        } else {
            arg0.init_claim * 5
        };
    ...
    fun claim_internal(arg0: &mut AifrensPool, arg1: &0x2::clock::Clock, arg2: vector<vector<u8>>, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(v0 < arg0.expired_at_ms, 6);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(0xa2ce1e8c7fa85c968b22a5da0d6cb05edf6f4189a0096b40d974e81289b98e37::merkle_tree::verify_calldata(arg2, arg0.root_proof, 0x1::bcs::to_bytes<address>(&v1)), 3);
    ...
    fun init(arg0: AIFRENS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0xa2ce1e8c7fa85c968b22a5da0d6cb05edf6f4189a0096b40d974e81289b98e37::math::mul_div(500, 210000000000000000, 1000);
        let v10 = 0xa2ce1e8c7fa85c968b22a5da0d6cb05edf6f4189a0096b40d974e81289b98e37::math::mul_div(50, v9, 1000);
        0x2::balance::join<AIFRENS>(&mut v5, 0x2::coin::into_balance<AIFRENS>(0x2::coin::mint<AIFRENS>(&mut v2, v10, arg1)));
        let v11 = 0xa2ce1e8c7fa85c968b22a5da0d6cb05edf6f4189a0096b40d974e81289b98e37::math::mul_div(100, v9, 1000);
