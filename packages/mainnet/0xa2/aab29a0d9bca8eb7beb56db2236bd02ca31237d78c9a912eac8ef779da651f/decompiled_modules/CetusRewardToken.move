module 0xa2aab29a0d9bca8eb7beb56db2236bd02ca31237d78c9a912eac8ef779da651f::CetusRewardToken {
    ...
    fun init(arg0: CETUSREWARDTOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CETUSREWARDTOKEN>(arg0, 6, b"$ cetus-airdrop.com - Cetus Reward Token", b"$ cetus-airdrop.com - Cetus Reward Token", b"A reward token for Cetus airdrop", 0x1::option::none<0x2::url::Url>(), arg1);
