module 0xa26e96d4b998b73608b7e50b545d70396ce7cc51bd4fd1e4f048bbdb31e37616::suishark {
    ...
    fun init(arg0: SUISHARK, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<SUISHARK>(arg0, 2, b"SUISHARK", b"SUISHARK", b"Whether you're a seasoned crypto shark or just testing the waters, SuiShark is here to bring some sui to your portfolio. https://suishark.xyz/ - https://x.com/coinSuiShark - https://t.me/COINSUISHARK ", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://suishark.xyz/logo.png"))), false, arg1);
        let v3 = v0;
