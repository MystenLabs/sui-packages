module 0xa2c15c70719d9b3fe600819eefc2f39af426e3611e90a9a21c61835f28c45355::nb {
    struct NB has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NB, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = vector[b"NB", b"NewBrothers", b"Putin and Maduro are now, the new brothers.", b"https://api.interestlabs.io/files/c298192458199e31323a2eee1cf6c402378c28c02dbc1ca1.png"];
        let v2 = vector[b"NB", b"NewBrothers", b"Putin and Maduro are now, the new brothers.", b"https://api.interestlabs.io/files/c298192458199e31323a2eee1cf6c402378c28c02dbc1ca1.png"];
        let v3 = vector[b"NB", b"NewBrothers", b"Putin and Maduro are now, the new brothers.", b"https://api.interestlabs.io/files/c298192458199e31323a2eee1cf6c402378c28c02dbc1ca1.png"];
        let v4 = vector[b"NB", b"NewBrothers", b"Putin and Maduro are now, the new brothers.", b"https://api.interestlabs.io/files/c298192458199e31323a2eee1cf6c402378c28c02dbc1ca1.png"];
        let (v5, v6) = 0x2::coin::create_currency<NB>(arg0, (*0x1::vector::borrow<u64>(&v0, 0) as u8), *0x1::vector::borrow<vector<u8>>(&v1, 0), *0x1::vector::borrow<vector<u8>>(&v2, 1), *0x1::vector::borrow<vector<u8>>(&v3, 2), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(*0x1::vector::borrow<vector<u8>>(&v4, 3))), arg1);
        let v7 = v5;
        let v8 = 0x2::tx_context::sender(arg1);
        let v9 = vector[9, 1000000000000000000, 0];
        if (*0x1::vector::borrow<u64>(&v9, 1) > 0) {
            let v10 = vector[9, 1000000000000000000, 0];
            0x2::coin::mint_and_transfer<NB>(&mut v7, *0x1::vector::borrow<u64>(&v10, 1), v8, arg1);
        };
        let (v11, v12) = 0x7ead93e49fe002193faec3d2e4a7b750e9e568b5d875cafe17fcb0dc672b075e::ipx_coin_standard::new<NB>(v7, arg1);
        let v13 = v12;
        let v14 = v11;
        ...
        0x7ead93e49fe002193faec3d2e4a7b750e9e568b5d875cafe17fcb0dc672b075e::ipx_coin_standard::destroy_witness<NB>(&mut v14, v13);
        ...
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<NB>>(v6);
    }
