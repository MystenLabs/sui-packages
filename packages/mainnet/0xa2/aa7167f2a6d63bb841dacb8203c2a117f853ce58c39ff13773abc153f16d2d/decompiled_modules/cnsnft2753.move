module 0xa2aa7167f2a6d63bb841dacb8203c2a117f853ce58c39ff13773abc153f16d2d::cnsnft2753 {
    struct CNSNFT2753 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2753, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://nsclaim1123img-0951.vercel.app/api/{id}"));
        ...
        let v4 = 0x2::package::claim<CNSNFT2753>(arg0, arg1);
