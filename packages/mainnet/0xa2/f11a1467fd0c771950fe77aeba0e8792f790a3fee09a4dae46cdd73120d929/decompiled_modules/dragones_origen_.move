module 0xa2f11a1467fd0c771950fe77aeba0e8792f790a3fee09a4dae46cdd73120d929::dragones_origen_ {
    ...
    fun init(arg0: DRAGONES_ORIGEN_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DRAGONES_ORIGEN_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Dragones origen "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifncbozmp5d4pkuyofcjefaifd7axrnpzdknrnbfyuuvulfpfplye"));
