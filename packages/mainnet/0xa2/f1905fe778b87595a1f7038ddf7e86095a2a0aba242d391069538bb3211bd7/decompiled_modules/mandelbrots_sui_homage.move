module 0xa2f1905fe778b87595a1f7038ddf7e86095a2a0aba242d391069538bb3211bd7::mandelbrots_sui_homage {
    struct MANDELBROTS_SUI_HOMAGE has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"a7e4ddb5-85a8-47a6-9357-28b43f73a2ad"),
        };
        0x2::event::emit<AddNftMetadataEvent>(v0);
    }

    fun init(arg0: MANDELBROTS_SUI_HOMAGE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MANDELBROTS_SUI_HOMAGE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Mandelbrots Sui Homage"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Homage to the OG Mandelbrots collection recognizing the rollout of TradePort's launchpad on Sui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmaQEAY9YpuipiFaZfACPczJvs3TBkUJCVFd3adfHJUjRS"));
