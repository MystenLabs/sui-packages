module 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild_v2 {
    ...
    public fun migrate(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::AdminCap, arg1: &mut 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::Config, arg2: u64) {
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::migrate(arg0, arg1, arg2);
    }
    ...
    public fun claim_reward<T0>(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::Config, arg1: &mut 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::UserArchive, arg2: &mut GuildVault, arg3: u128, arg4: u128, arg5: vector<u8>, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::verify_config(arg0, 0x1::string::utf8(b"GUILD_MODULE"));
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::verify_signature_v2(arg0, arg5, arg6);
        let v0 = 0x2::tx_context::sender(arg8);
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::validate_archive_owner(arg1, arg8);
        ...
        assert!(arg4 == v2, 6015);
        assert!(v3 > 0, 6001);
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::update_user_reward<T0>(arg1, v3);
        let v4 = RewardClaimedEvent{
            ...
            rw_id      : v2,
            amount     : v3,
            nonce      : 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::update_user_nonce(arg1, 0x2::bcs::peel_u8(&mut v1), 0x2::bcs::peel_u128(&mut v1)),
        };
    ...
    public fun create_guild<T0>(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::Config, arg1: &mut GuildVault, arg2: &mut 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::UserArchive, arg3: u128, arg4: vector<u8>, arg5: vector<u8>, arg6: 0x2::coin::Coin<T0>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::verify_config(arg0, 0x1::string::utf8(b"GUILD_MODULE"));
    ...
    public fun deposit_fund_to_vault<T0>(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::TreasureCap, arg1: &mut GuildVault, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
    ...
    public fun rename_guild<T0>(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::Config, arg1: &mut GuildVault, arg2: &mut 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::UserArchive, arg3: u128, arg4: 0x1::string::String, arg5: vector<u8>, arg6: vector<u8>, arg7: 0x2::coin::Coin<T0>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::verify_config(arg0, 0x1::string::utf8(b"GUILD_MODULE"));
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::verify_signature_v2(arg0, arg5, arg6);
        ...
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::set_archive_change_name_time(arg2, arg0, arg8);
    ...
    public fun set_fund_receiver(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::AdminCap, arg1: &mut GuildVault, arg2: address) {
        arg1.fund_receiver = arg2;
        let v0 = SetFundReceiverEvent{new_receiver: arg2};
        0x2::event::emit<SetFundReceiverEvent>(v0);
    }

    public fun update_guild<T0>(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::Config, arg1: &mut GuildVault, arg2: &mut 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::UserArchive, arg3: u128, arg4: u64, arg5: vector<u8>, arg6: vector<u8>, arg7: 0x2::coin::Coin<T0>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::verify_config(arg0, 0x1::string::utf8(b"GUILD_MODULE"));
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::verify_signature_v2(arg0, arg5, arg6);
        let v0 = 0x2::tx_context::sender(arg9);
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::validate_archive_owner(arg2, arg9);
        ...
        let v3 = UpdateGuildEvent{
            ...
            updater     : v0,
            guild_level : arg4,
            nonce       : 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::update_user_nonce(arg2, 0x2::bcs::peel_u8(&mut v1), 0x2::bcs::peel_u128(&mut v1)),
        };
    ...
    public fun withdraw_amount_from_vault<T0>(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::TreasureCap, arg1: &mut GuildVault, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
