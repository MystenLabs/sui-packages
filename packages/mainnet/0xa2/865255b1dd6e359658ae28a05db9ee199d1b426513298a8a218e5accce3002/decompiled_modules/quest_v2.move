module 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::quest_v2 {
    ...
    struct ClaimBonusEventV2 has copy, drop, store {
        user: address,
        task_id: 0x1::string::String,
        sub_task_id: 0x1::string::String,
        point: u128,
    ...
    public fun set_checkin_fee<T0>(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::AdminCap, arg1: &mut 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::Config, arg2: u64) {
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::set_checkin_fee(arg0, arg1, arg2);
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::set_fee_type<T0>(arg0, arg1, 0x1::string::utf8(b"QUEST_MODULE"));
    ...
    public fun set_max_check_in_days(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::AdminCap, arg1: &mut 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::Config, arg2: u64) {
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::set_max_check_in_days(arg0, arg1, arg2);
    }

    public fun checkin<T0>(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::Config, arg1: &mut QuestVault, arg2: &mut 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::UserArchive, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::verify_config(arg0, 0x1::string::utf8(b"QUEST_MODULE"));
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::validate_archive_owner(arg2, arg5);
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::init_checkin(arg2);
        assert!(0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::get_fee_type(arg0, 0x1::string::utf8(b"QUEST_MODULE")) == 0x1::type_name::get<T0>(), 8005);
        assert!(0x2::coin::value<T0>(&arg3) >= 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::get_checkin_fee(arg0), 8004);
        let (v0, v1) = 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::set_checkin(arg0, arg2, arg4);
    ...
    public fun claim_bonus_coin<T0>(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::Config, arg1: &mut QuestVault, arg2: &mut 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::UserArchive, arg3: vector<u8>, arg4: vector<u8>, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::verify_config(arg0, 0x1::string::utf8(b"QUEST_MODULE"));
        let v0 = 0x2::tx_context::sender(arg7);
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::validate_archive_owner(arg2, arg7);
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::verify_signature_v2(arg0, arg3, arg4);
        let v1 = 0x2::clock::timestamp_ms(arg6);
        let v2 = 0x2::bcs::new(arg4);
        let v3 = 0x2::bcs::peel_vec_vec_u8(&mut v2);
        let v4 = 0x2::bcs::peel_vec_u64(&mut v2);
        let v5 = 0x2::bcs::peel_vec_u64(&mut v2);
        let v6 = 0x2::bcs::peel_vec_u8(&mut v2);
        ...
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::update_claim_bonus_coin_time_range(arg2, b"QUEST_CLAIM_BONUS_COIN_TIME_RANGE", v6, v3, v4, v5);
        assert!(v1 < v7, 8003);
        ...
        let v8 = ClaimBonusEventV2{
            user            : v0,
            task_id         : 0x1::string::utf8(v6),
        ...
        0x2::event::emit<ClaimBonusEventV2>(v8);
    }
    ...
    public fun claim_bonus_point<T0>(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::Config, arg1: &mut QuestVault, arg2: &mut 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::UserArchive, arg3: vector<u8>, arg4: vector<u8>, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<T0>(&arg5) == 0x2::bcs::peel_u64(&mut v2), 8004);
        assert!(0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())) == 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v2)), 8006);
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::update_task_time_range(arg2, b"QUEST_CLAIM_BONUS_POINT_TIME_RANGE", v5, v3, v4);
        assert!(v1 < v6, 8003);
        deposit_to_vault<T0>(arg1, 0x2::coin::into_balance<T0>(arg5), arg6);
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::set_archive_last_name_time(arg2, v1);
    ...
    public fun deposit_fund_to_vault<T0>(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::TreasureCap, arg1: &mut QuestVault, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
    ...
    public fun paused(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::AdminCap, arg1: &mut 0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::Config, arg2: bool) {
        0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::paused_v2(arg0, arg1, 0x1::string::utf8(b"QUEST_MODULE"), arg2);
    }

    public fun set_fund_receiver(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::AdminCap, arg1: &mut QuestVault, arg2: address) {
    ...
    public fun withdraw_amount_from_vault<T0>(arg0: &0xa2865255b1dd6e359658ae28a05db9ee199d1b426513298a8a218e5accce3002::guild::TreasureCap, arg1: &mut QuestVault, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
