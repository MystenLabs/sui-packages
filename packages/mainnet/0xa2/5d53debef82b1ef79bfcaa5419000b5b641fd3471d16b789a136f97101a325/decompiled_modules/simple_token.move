module 0xa25d53debef82b1ef79bfcaa5419000b5b641fd3471d16b789a136f97101a325::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"SUISSY", b"SUISSY INU", b"SEXY Doge On SUI", 0x1::option::none<0x2::url::Url>(), arg1);
