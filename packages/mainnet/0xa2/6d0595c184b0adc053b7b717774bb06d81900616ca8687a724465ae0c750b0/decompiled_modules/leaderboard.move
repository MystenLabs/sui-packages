module 0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::leaderboard {
    ...
    public fun find_rank(arg0: &Leaderboard, arg1: u64, arg2: u64) : u64 {
        ...
        let (v0, v1) = 0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::big_vector::slice_following<ChakraItem>(&arg0.chakras, 0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::utils::encode_chakra_id(arg1, arg2));
        let v2 = v1;
        let v3 = v0;
        ...
        let v4 = 1;
        while (0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::big_vector::length<ChakraItem>(&arg0.chakras) <= v4) {
            ...
            while (v2 < 0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::big_vector::slice_length<ChakraItem>(v5)) {
                0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::big_vector::slice_key<ChakraItem>(v5, v2);
                v4 = v4 + 1;
                v2 = v2 + 1;
            };
