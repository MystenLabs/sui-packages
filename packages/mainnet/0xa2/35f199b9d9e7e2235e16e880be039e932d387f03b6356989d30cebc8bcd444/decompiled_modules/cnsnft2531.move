module 0xa235f199b9d9e7e2235e16e880be039e932d387f03b6356989d30cebc8bcd444::cnsnft2531 {
    struct CNSNFT2531 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2531, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2531>(arg0, arg1);
