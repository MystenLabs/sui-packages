module 0x92d5efc1eec7e45b9e806fbc88ba175555dc605e63fa2db9da2b90b8b68f2e5c::loan_registry {
    ...
    public(friend) fun system_close_active_loan<T0, T1>(arg0: &mut Loan<T0, T1>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 0x1::string::utf8(b"FundTransferred"), 3);
        arg0.status = 0x1::string::utf8(b"Finished");
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(&mut arg0.collateral), arg2), arg1);
    }
