module 0x92d5efc1eec7e45b9e806fbc88ba175555dc605e63fa2db9da2b90b8b68f2e5c::offer_registry {
    ...
    public(friend) fun system_cancel_offer<T0>(arg0: &mut Offer<T0>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<T0>(&arg1) == v0, 3);
        let v2 = 0x2::coin::zero<T0>(arg3);
        0x2::coin::join<T0>(&mut v2, arg1);
        0x2::coin::join<T0>(&mut v2, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v2, v1);
        arg0.status = 0x1::string::utf8(b"Cancelled");
        let v3 = CancelledOfferEvent{
            offer_id : 0x2::object::id<Offer<T0>>(arg0),
            amount   : v0,
            duration : arg0.duration,
            interest : arg0.interest,
        ...
        0x2::event::emit<CancelledOfferEvent>(v3);
    }

    public(friend) fun system_close_offer<T0>(arg0: &mut Offer<T0>) {
        assert!(arg0.status == 0x1::string::utf8(b"Created") || arg0.status == 0x1::string::utf8(b"Loaned"), 1);
        if (arg0.status == 0x1::string::utf8(b"Created")) {
            arg0.status = 0x1::string::utf8(b"Cancelled");
        };
    }
