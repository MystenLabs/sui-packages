module 0xd2e44dc1311833ddb0427f2141e2935720cf5454cf0ef39141fc80c19e1e6caa::lootbox {
    ...
    public fun create_lootbox_with_amount_display<T0>(arg0: &AdminCap, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::display::new<LootboxWithAmount<T0>>(arg1, arg2);
        0x2::display::add<LootboxWithAmount<T0>>(&mut v0, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"SLP Lootbox"));
        0x2::display::add<LootboxWithAmount<T0>>(&mut v0, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"SLP Lootbox for your gains!"));
        0x2::display::add<LootboxWithAmount<T0>>(&mut v0, 0x1::string::utf8(b"link"), 0x1::string::utf8(b"https://www.sudo.finance/"));
        0x2::display::add<LootboxWithAmount<T0>>(&mut v0, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(b"https://scard.sudo.finance/"));
        0x2::display::add<LootboxWithAmount<T0>>(&mut v0, 0x1::string::utf8(b"creator"), 0x1::string::utf8(b"Sudo Finance"));
        0x2::display::add<LootboxWithAmount<T0>>(&mut v0, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://img.sudofinance.xyz/slootbox/lootbox.webp"));
        0x2::display::update_version<LootboxWithAmount<T0>>(&mut v0);
        0x2::transfer::public_transfer<0x2::display::Display<LootboxWithAmount<T0>>>(v0, 0x2::tx_context::sender(arg2));
    }
    ...
    entry fun open_lootbox<T0>(arg0: &mut LootboxTreasury, arg1: Lootbox, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &LootboxSettings, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = get_prize_amount(v1, v2, 0x1::u64::pow(10, 0x2::coin::get_decimals<T0>(arg2)), arg3);
    ...
    public entry fun open_lootbox_public<T0>(arg0: &mut LootboxTreasury, arg1: Lootbox, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &LootboxSettings, arg4: &mut 0x2::tx_context::TxContext) {
        let Lootbox {
            id               : v0,
            magic            : v1,
            tier             : v2,
    ...
    entry fun open_lootbox_with_amount<T0>(arg0: &mut LootboxTreasury, arg1: LootboxWithAmount<T0>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v1 * 0x1::u64::pow(10, 0x2::coin::get_decimals<T0>(arg2));
        0x2::object::delete(v0);
    ...
    public entry fun open_lootbox_with_amount_public<T0>(arg0: &mut LootboxTreasury, arg1: LootboxWithAmount<T0>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let LootboxWithAmount {
            id               : v0,
            amount           : v1,
            expiration_epoch : v2,
