module 0xa2cd6c7cbcf9facad6ec29e948d4693803f931c1880340981a7e92022769ceda::cnsnft3538 {
    struct CNSNFT3538 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3538, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3538>(arg0, arg1);
