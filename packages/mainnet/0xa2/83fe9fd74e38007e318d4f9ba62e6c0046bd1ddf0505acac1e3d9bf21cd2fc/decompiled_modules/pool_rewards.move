module 0x17aa7d1e8f59d5a869847b308837e7bdee73ee19b11b970dba0f2a8435bec549::pool_rewards {
    ...
    public fun claim_rewards_dynamic(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = if (calculate_total_current_weight(v0, v2) == 0) {
            true
        } else if (v4 == 0) {
            true
        } else {
        ...
        let v7 = if (v6) {
            ...
            let v8 = (v4 as u128) * (0x2::balance::value<0x2::sui::SUI>(&v0.sui_reward_pool) as u128) / (v5 as u128);
    ...
    public fun get_user_reward_details_dynamic(arg0: &PoolSystem, arg1: 0x2::object::ID, arg2: address, arg3: &0x2::clock::Clock) : (u64, u64, u64, u64, u64, u64) {
        ...
        let v7 = if (v6) {
            let v8 = (v3 as u128) * (0x2::balance::value<0x2::sui::SUI>(&v0.sui_reward_pool) as u128) / (v5 as u128);
            if (v8 > 18446744073709551615) {
                18446744073709551615
            } else {
                (v8 as u64)
        ...
        (v2.nft_count, v3, v4, v7, v1 - v2.stake_start_time, v2.last_reward_claim)
    }
