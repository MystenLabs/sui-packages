module 0xa2a183df0d239fad5130bd886a76a1a49fa3154c7c1305d7d4ca20d08216e3b4::etf_utils {
    ...
    public fun take_fee<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: address, arg2: 0x1::option::Option<address>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<address>(&arg2)) {
            ...
            0xa2a183df0d239fad5130bd886a76a1a49fa3154c7c1305d7d4ca20d08216e3b4::events::emit_fee_event(arg1, *v2, v0, v3, 0x1::type_name::get<T0>());
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg0, v0, arg4), arg1);
            0xa2a183df0d239fad5130bd886a76a1a49fa3154c7c1305d7d4ca20d08216e3b4::events::emit_fee_event(arg1, arg1, v0, 0, 0x1::type_name::get<T0>());
        };
    }
