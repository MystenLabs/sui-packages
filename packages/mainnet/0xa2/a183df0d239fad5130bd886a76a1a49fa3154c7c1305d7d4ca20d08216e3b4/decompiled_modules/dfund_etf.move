module 0xa2a183df0d239fad5130bd886a76a1a49fa3154c7c1305d7d4ca20d08216e3b4::dfund_etf {
    ...
    public fun activate_fund(arg0: FundETF, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xa2a183df0d239fad5130bd886a76a1a49fa3154c7c1305d7d4ca20d08216e3b4::etf_utils::get_total_weight(get_coin_weights(&arg0)) == 1000, 3);
    ...
    public fun add_coin_type<T0>(arg0: FundETF, arg1: u64, arg2: u8, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) : FundETF {
        ...
        assert!(!0xa2a183df0d239fad5130bd886a76a1a49fa3154c7c1305d7d4ca20d08216e3b4::etf_utils::is_coin_type_in_fund(get_coin_types_in_fund(&arg0), v0), 2);
    ...
    public fun contribute_sui_to_fund(arg0: &mut FundETF, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x1::option::Option<HotPotatoContributionTransaction>, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<HotPotatoContributionTransaction> {
        ...
        0xa2a183df0d239fad5130bd886a76a1a49fa3154c7c1305d7d4ca20d08216e3b4::etf_utils::take_fee<0x2::sui::SUI>(&mut arg1, arg0.creator, arg3, arg0.in_fee, arg4);
        let (v2, v3) = find_metadata_index_from_coin_type(arg0, v0);
        assert!(v2, 2);
        let v4 = 0x1::vector::borrow<FundAssetMetadata>(&arg0.assets_metadata, v3).weight;
        add_position_to_fund<0x2::sui::SUI>(arg0, v0, arg1, arg4);
        update_contribution_transaction(arg0, arg2, v0, v1, v1, v4, v3)
    }
    ...
    public fun contribute_to_fund<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: &mut FundETF, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: 0x1::option::Option<address>, arg5: &0x2::clock::Clock, arg6: 0x1::option::Option<HotPotatoContributionTransaction>, arg7: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<HotPotatoContributionTransaction> {
        ...
        let v0 = 0x1::type_name::get<T0>();
        0xa2a183df0d239fad5130bd886a76a1a49fa3154c7c1305d7d4ca20d08216e3b4::etf_utils::take_fee<0x2::sui::SUI>(&mut arg3, arg2.creator, arg4, arg2.in_fee, arg7);
        let (v1, v2) = find_metadata_index_from_coin_type(arg2, v0);
        assert!(v1, 2);
        let v3 = 0x1::vector::borrow<FundAssetMetadata>(&arg2.assets_metadata, v2);
        let v4 = v3.weight;
        assert!(v3.pool_id == 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>>(arg1), 5);
        let (v5, v6) = swap_and_add_position<T0>(arg0, arg1, arg2, arg3, arg5, arg7);
        if (v6 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v5, 0x2::tx_context::sender(arg7));
        } else {
            0x2::coin::destroy_zero<0x2::sui::SUI>(v5);
        };
        update_contribution_transaction(arg2, arg6, v0, v6, 0x2::coin::value<0x2::sui::SUI>(&arg3), v4, v2)
    }
    ...
    public fun swap_and_add_position<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: &mut FundETF, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, u64) {
        ...
        assert!(v1, 2);
        let (v3, v4) = 0xa2a183df0d239fad5130bd886a76a1a49fa3154c7c1305d7d4ca20d08216e3b4::swapper::cetus_swap_b2a<T0, 0x2::sui::SUI>(arg3, arg1, arg0, arg4, arg5);
        let v5 = v3;
    ...
    fun swap_position_to_sui<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: &FundETF, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, u64) {
        ...
        assert!(v0, 2);
        let (v2, v3) = 0xa2a183df0d239fad5130bd886a76a1a49fa3154c7c1305d7d4ca20d08216e3b4::swapper::cetus_swap_a2b<T0, 0x2::sui::SUI>(arg3, arg1, arg0, arg4, arg5);
        let v4 = v3;
    ...
    public fun withdraw_from_fund<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: &mut FundETF, arg3: &0x2::clock::Clock, arg4: &UserFundShare, arg5: 0x1::option::Option<HotPotatoWithdrawalTransaction>, arg6: 0x1::option::Option<address>, arg7: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<HotPotatoWithdrawalTransaction> {
        ...
        let v5 = if (v0 == 0x1::type_name::get<0x2::sui::SUI>()) {
            0xa2a183df0d239fad5130bd886a76a1a49fa3154c7c1305d7d4ca20d08216e3b4::etf_utils::take_fee<T0>(&mut v4, arg2.creator, arg6, arg2.out_fee, arg7);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v4, 0x2::tx_context::sender(arg7));
            0x2::coin::value<T0>(&v4)
        } else {
            let (v6, _) = swap_position_to_sui<T0>(arg0, arg1, arg2, v4, arg3, arg7);
            let v8 = v6;
            0xa2a183df0d239fad5130bd886a76a1a49fa3154c7c1305d7d4ca20d08216e3b4::etf_utils::take_fee<0x2::sui::SUI>(&mut v8, arg2.creator, arg6, arg2.out_fee, arg7);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v8, 0x2::tx_context::sender(arg7));
            0x2::coin::value<0x2::sui::SUI>(&v8)
        };
        if (0x1::option::is_some<HotPotatoWithdrawalTransaction>(&arg5)) {
            ...
            v10.sui_amount = v10.sui_amount + v5;
