module 0xa2de2bc5408110914d34c16b93416f9d6462eaff2cf250050adfad0650abe4de::single_roulette {
    ...
    struct RouletteTable<phantom T0> has store, key {
        ...
        host: address,
        max_risk: u64,
        risk_manager: 0xa2de2bc5408110914d34c16b93416f9d6462eaff2cf250050adfad0650abe4de::risk_manager::RiskManager,
    ...
    public fun add_bet<T0>(arg0: &mut SinglePlayerRouletteConfig<T0>, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: u8, arg4: 0x1::option::Option<u64>, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let (_, _) = 0xa2de2bc5408110914d34c16b93416f9d6462eaff2cf250050adfad0650abe4de::risk_manager::add_risk(&mut v0.risk_manager, arg3, arg4, 0xa2de2bc5408110914d34c16b93416f9d6462eaff2cf250050adfad0650abe4de::bet_manager::get_bet_payout(v1, arg3));
        assert!(0xa2de2bc5408110914d34c16b93416f9d6462eaff2cf250050adfad0650abe4de::risk_manager::total_risk(&v0.risk_manager) <= v0.max_risk, 0);
    ...
    public fun create_roulette_table<T0>(arg0: &mut 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::UniHouse, arg1: &mut SinglePlayerRouletteConfig<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v0 = RouletteTable<T0>{
            ...
            risk_manager   : 0xa2de2bc5408110914d34c16b93416f9d6462eaff2cf250050adfad0650abe4de::risk_manager::new_manager(),
    ...
    public fun resolve_bet_outcome<T0>(arg0: &mut SinglePlayerRouletteConfig<T0>, arg1: address, arg2: 0x1::option::Option<0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::bls_settler::BetOutcomeWithDraw<T0, SingleRoulette>>) {
        assert_valid_version<T0>(arg0);
        assert!(table_exists<T0>(arg0, arg1), 7);
        let v0 = borrow_table_mut<T0>(arg0, arg1);
        assert!(!0x2::table::contains<u64, u64>(&v0.rounds_settled, v0.round_number), 16);
        let (_, _, v3, v4) = 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::bls_settler::destroy_bet_outcome_with_draw<T0, SingleRoulette>(0x1::option::destroy_some<0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::bls_settler::BetOutcomeWithDraw<T0, SingleRoulette>>(arg2));
        ...
        0x2::table::add<u64, u64>(&mut v0.rounds_settled, v0.round_number, v3);
        0x1::vector::destroy_empty<0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::bls_settler::BetWithDraw<T0>>(v4);
    }
    ...
    public fun settle_or_continue<T0>(arg0: &mut 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::UniHouse, arg1: &mut SinglePlayerRouletteConfig<T0>, arg2: address, arg3: 0x1::option::Option<u64>, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v6 < v5 && 0x2::linked_table::length<address, vector<Bet>>(&v1.current_bets) > 0) {
            ...
            while (v6 < v5 && 0x1::vector::length<Bet>(&v10) != 0) {
                ...
                let v17 = 0xa2de2bc5408110914d34c16b93416f9d6462eaff2cf250050adfad0650abe4de::bet_manager::won_bet(v13, *v2, v14);
                ...
                if (v17) {
                    ...
                    let v20 = 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::split<T0, SingleRoulette>(v19, arg0, 0xa2de2bc5408110914d34c16b93416f9d6462eaff2cf250050adfad0650abe4de::bet_manager::get_bet_payout(v15, v13));
        ...
        if (0x2::linked_table::length<address, vector<Bet>>(&v1.current_bets) == 0) {
            v1.risk_manager = 0xa2de2bc5408110914d34c16b93416f9d6462eaff2cf250050adfad0650abe4de::risk_manager::new_manager();
            v1.status = 0;
