module 0xa2384bb94401c5cee365b31b307435bd84bb85183af956344308d2d86dec1b0e::lambo {
    ...
    fun init(arg0: LAMBO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/avalanche/0x6f43ff77a9c0cf552b5b653268fbfe26a052429b.png?size=lg&key=03d807                                                                                                                                                                                                           ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<LAMBO>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"LAMBO   ")))), trim_right(b"LAMBO                           "), trim_right(b"WEN LAMBO? Calculate how many Lamborghinis you can buy with $LAMBO                                                                                                                                                                                                                                                              "), v2, arg1);
        let v5 = v3;
