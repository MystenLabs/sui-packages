module 0xa22e7e0300242b6c928814dcdadc7e22fb8af121347f3b489db487ef4b18e9cc::dex_deepbook {
    ...
    public fun get_deepbook_package() : address {
        0xa22e7e0300242b6c928814dcdadc7e22fb8af121347f3b489db487ef4b18e9cc::constants::deepbook_package()
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = DeepBookRealSwapExecuted{
            ...
            pool_id         : arg2,
            package         : 0xa22e7e0300242b6c928814dcdadc7e22fb8af121347f3b489db487ef4b18e9cc::constants::deepbook_package(),
