module 0xa29e198c08e0d07313a69d9adf65126449c7ad9e2cc6e21e0e78cb9dc1053967::cnsnft1930 {
    struct CNSNFT1930 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1930, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9843"));
        let v4 = 0x2::package::claim<CNSNFT1930>(arg0, arg1);
