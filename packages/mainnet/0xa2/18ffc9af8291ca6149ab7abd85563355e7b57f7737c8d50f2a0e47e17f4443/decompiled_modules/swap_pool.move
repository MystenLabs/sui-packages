module 0x443ab6e1662cc575e99f368dc661dbc94ee12fbf43dd4c09538ae465b7a7acac::swap_pool {
    ...
    fun calc_amount_out<T0>(arg0: &State, arg1: u64, arg2: u8, arg3: u64, arg4: u8) : u64 {
        let v0 = (arg1 as u128) * (0x1::u64::pow(10, 9 + arg4 - arg2) as u128) / (arg3 as u128);
        assert!(v0 < 18446744073709551615, 122);
        let v1 = (v0 as u64);
        assert!(v1 <= get_balance_amount<T0>(arg0), 108);
        v1
    }
    ...
    fun check_dex_price_deviation<T0, T1>(arg0: &State, arg1: u64, arg2: u8, arg3: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg4: &0x2::clock::Clock) {
        if (!arg0.price_check) {
            return
        };
        let v0 = 0x2::object::id<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>>(arg3);
        assert!(0x1::option::contains<0x2::object::ID>(&arg0.dex_pool, &v0), 114);
        let v1 = get_twap_price_from_dex<T0, T1>(arg3, arg2, arg4);
        assert!(v1 * ((10000 - arg0.price_deviation_ratio) as u256) / (10000 as u256) <= (arg1 as u256), 106);
        assert!(v1 * ((10000 + arg0.price_deviation_ratio) as u256) / (10000 as u256) >= (arg1 as u256), 107);
    }
    ...
    fun check_oracle_price(arg0: u64, arg1: u64) : (u64, u8) {
        assert!(arg1 == (8 as u64), 119);
        assert!(arg0 < 184467440737095, 117);
        (arg0, (arg1 as u8))
    }
    ...
    public fun get_amount_out_v2<T0, T1>(arg0: &State, arg1: u64, arg2: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) : u64 {
        check_version(arg0);
        let (_, v1) = check_coin<T0>(arg0);
        let (v2, v3) = get_price_v2(arg0, arg2, arg3);
        calc_amount_out<T1>(arg0, arg1, v1, v2, v3)
    }

    public fun get_balance_amount<T0>(arg0: &State) : u64 {
        0x2::balance::value<T0>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg0.balances, 0x1::type_name::with_defining_ids<T0>()))
    }
    ...
    public fun get_price_from_oracle_v2(arg0: &State, arg1: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : (u64, u8) {
        let v0 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::pyth::get_price_no_older_than(arg1, arg2, 90);
        ...
        let v3 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_identifier::get_bytes(&v2);
        ...
        let v5 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_price(&v0);
        check_oracle_price(0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_positive(&v5), 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_negative(&v4))
    }

    public fun get_price_v2(arg0: &State, arg1: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : (u64, u8) {
        let (v0, v1) = get_price_from_oracle_v2(arg0, arg1, arg2);
        (price_adjust(arg0, v0, arg2), v1)
    }

    fun get_swap_price_v2<T0, T1>(arg0: &State, arg1: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg2: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) : (u64, u8) {
        let (v0, v1) = get_price_from_oracle_v2(arg0, arg1, arg3);
        check_dex_price_deviation<T0, T1>(arg0, v0, v1, arg2, arg3);
        (price_adjust(arg0, v0, arg3), v1)
    }
    ...
    public fun get_twap_price_from_dex<T0, T1>(arg0: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: u8, arg2: &0x2::clock::Clock) : u256 {
        ...
        let v1 = &mut v0;
        0x1::vector::push_back<u64>(v1, 240);
    ...
    entry fun set_coin_whitelist<T0>(arg0: &mut State, arg1: bool, arg2: u8, arg3: &0x2::tx_context::TxContext) {
        ...
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(&v0 != 0x1::option::borrow<0x1::type_name::TypeName>(&arg0.xaum), 123);
        assert!(arg2 <= 9 + 8, 118);
        let v1 = 0x1::type_name::with_defining_ids<T0>();
        if (0x2::table::contains<0x1::type_name::TypeName, u8>(&arg0.coin_whitelist, v1)) {
            if (!arg1) {
                0x2::table::remove<0x1::type_name::TypeName, u8>(&mut arg0.coin_whitelist, v1);
            };
        } else if (arg1) {
            0x2::table::add<0x1::type_name::TypeName, u8>(&mut arg0.coin_whitelist, v1, arg2);
    ...
    entry fun set_price_factor(arg0: &mut State, arg1: u64, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        check_version(arg0);
        check_owner(arg0, arg3);
        assert!(arg1 <= 10000 && arg2 <= 10000, 120);
    ...
    entry fun set_weekday_param(arg0: &mut State, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        check_version(arg0);
        check_owner(arg0, arg4);
        assert!(arg1 <= 0x2::clock::timestamp_ms(arg3) / 1000, 121);
    ...
    fun swap_at_price<T0, T1>(arg0: &mut State, arg1: &SwapCap, arg2: &mut 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        check_version(arg0);
        ...
        merge_coin_into_balances<T0>(arg0, 0x2::coin::split<T0>(arg2, arg3, arg6));
        let v3 = calc_amount_out<T1>(arg0, arg3, v2, arg4, arg5);
        ...
        0x2::coin::take<T1>(get_balance_mut<T1>(v4), v3, arg6)
    }

    public fun swap_v2<T0, T1, T2>(arg0: &mut State, arg1: &SwapCap, arg2: &mut 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>, arg5: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let (v0, v1) = get_swap_price_v2<T1, T2>(arg0, arg5, arg4, arg6);
        swap_at_price<T0, T1>(arg0, arg1, arg2, arg3, v0, v1, arg7)
    }
