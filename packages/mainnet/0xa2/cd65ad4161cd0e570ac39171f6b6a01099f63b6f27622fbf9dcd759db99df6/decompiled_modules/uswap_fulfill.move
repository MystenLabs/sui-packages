module 0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::uswap_fulfill {
    ...
    fun begin_fulfill_inner<T0>(arg0: &mut FulfillRegistry, arg1: vector<u8>, arg2: vector<0x2::transfer::Receiving<0x2::coin::Coin<T0>>>) : (0x2::coin::Coin<T0>, FulfillReceipt) {
        let v0 = 0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::parse(arg1);
        assert!(0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::dst_chain_id(&v0) == 101, 1);
        let v1 = 0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::intent_id(&v0);
        let v2 = receive_all<T0>(arg0, v1, arg2);
        let v3 = 0x2::coin::value<T0>(&v2);
        assert!(v3 > 0, 3);
        let v4 = FulfillReceipt{
            intent_id      : v1,
            dst_token_hash : 0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::dst_token_hash(&v0),
            dst_recipient  : 0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::dst_recipient(&v0),
            min_final_out  : 0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::min_final_out(&v0),
            usdc_in        : v3,
        };
        (v2, v4)
    }
    ...
    fun deliver_usdc_inner<T0>(arg0: &mut FulfillRegistry, arg1: vector<u8>, arg2: vector<0x2::transfer::Receiving<0x2::coin::Coin<T0>>>, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        let v0 = 0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::parse(arg1);
        assert!(0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::dst_chain_id(&v0) == 101, 1);
        let v1 = 0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::dst_recipient(&v0);
        let v2 = 0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::intent_id(&v0);
        if (0x2::tx_context::sender(arg4) != v1) {
            assert!(0x2::clock::timestamp_ms(arg3) > 0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::deadline(&v0) * 1000 + 600000, 6);
        };
    ...
    fun refund_redeposit_inner<T0>(arg0: &mut FulfillRegistry, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<0x2::transfer::Receiving<0x2::coin::Coin<T0>>>, arg4: &mut 0x11e58df8dd107e4659428957c975db68eec2e31f60496ad267d73efac8b9a7ca::liquidity_pool::Bank, arg5: &mut 0x720bd34fe57ed60f76a71c2005274e0a42bce885e352bc24921363008c5770a4::inbox_bridge::InboxBridge, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        ...
        let v0 = 0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::parse(arg1);
        assert!(0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::dst_chain_id(&v0) == 101, 1);
        assert!(0x2::clock::timestamp_ms(arg6) > 0xa2cd65ad4161cd0e570ac39171f6b6a01099f63b6f27622fbf9dcd759db99df6::blob::deadline(&v0) * 1000 + 600000, 12);
