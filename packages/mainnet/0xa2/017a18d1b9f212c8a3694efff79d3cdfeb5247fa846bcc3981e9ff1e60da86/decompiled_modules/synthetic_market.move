module 0xa2017a18d1b9f212c8a3694efff79d3cdfeb5247fa846bcc3981e9ff1e60da86::synthetic_market {
    ...
    public fun redeem_winning<T0, T1>(arg0: &mut Market<T0, T1>, arg1: 0x1::option::Option<0x2::coin::Coin<T0>>, arg2: 0x1::option::Option<0x2::coin::Coin<T1>>, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 == 1 && arg0.status == 1 || arg3 == 0 && arg0.status == 2, 3);
        let v0 = if (arg3 == 1) {
    ...
    public fun resolve_market<T0, T1>(arg0: &AdminCap, arg1: &mut Market<T0, T1>, arg2: u8) {
