module 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones {
    ...
    public entry fun burn_for_bones(arg0: &mut 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFTCollection, arg1: &mut BonesBank, arg2: 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = arg1.bones_per_burn;
        assert!(v1 > 0, 1);
        0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::burn_nft_internal(arg2, arg0);
        ...
        let v2 = DoonieBurnedForBones{
            burner   : v0,
            token_id : 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::get_token_id(&arg2),
            amount   : v1,
        };
