module 0xa2ced462a513d404f847f03fae53284cbe8531038a339de19a36c24450dcc78a::HYPE {
    ...
    fun init(arg0: HYPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<HYPE>(arg0, 9, b"TSLA", b"Tesla AI", b"Tesla AI for Musk", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
