module 0xa2dbf9a325cc4c5b7e9c644eed7508945e5d4af65ce3756533c0cdbf6d28de46::last_forever {
    struct LAST_FOREVER has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LAST_FOREVER, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<LAST_FOREVER>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Last forever"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Soon it will d..."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://ovm0Ask0gC51VfG3yFredvoTGAXebJaVEeU0uF1gWfg"));
