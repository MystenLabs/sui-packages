module 0xa20cdc6237b54270cc50ea688d2e0a134c45b6ab2ec7bbc3711c4ea3e77f0fc2::cnsnft2197 {
    struct CNSNFT2197 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2197, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2197>(arg0, arg1);
