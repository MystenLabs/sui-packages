module 0xa260797fe88fbf93b1020c6688e9c40d5d95c374892faea632f0b2b04c3f602a::dex_kriya {
    ...
    public fun swap_exact_sui_for_token<T0>(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: vector<u8>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, @0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66);
    ...
    public fun swap_exact_token_for_sui<T0>(arg0: 0x2::coin::Coin<T0>, arg1: vector<u8>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        assert!(v0 > 0, 1);
        assert!(calculate_output_amount(v0, 3000) >= arg2, 3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg0, @0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66);
