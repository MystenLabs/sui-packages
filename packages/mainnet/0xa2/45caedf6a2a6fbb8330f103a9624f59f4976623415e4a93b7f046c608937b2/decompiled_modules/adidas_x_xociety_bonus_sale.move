module 0xa245caedf6a2a6fbb8330f103a9624f59f4976623415e4a93b7f046c608937b2::adidas_x_xociety_bonus_sale {
    struct ADIDAS_X_XOCIETY_BONUS_SALE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ADIDAS_X_XOCIETY_BONUS_SALE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ADIDAS_X_XOCIETY_BONUS_SALE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"ADIDAS x XOCIETY BONUS SALE"));
