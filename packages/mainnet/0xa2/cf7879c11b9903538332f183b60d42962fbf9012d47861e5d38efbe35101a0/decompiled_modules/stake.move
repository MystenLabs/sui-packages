module 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::stake {
    ...
    public fun stake<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg3, 1);
    ...
    public fun change_admin(arg0: Admincap, arg1: address, arg2: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg2, 1);
        0x2::transfer::public_transfer<Admincap>(arg0, arg1);
    }

    public entry fun claimRewards<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg2, 1);
        assert!(!arg0.paused, 8008);
    ...
    public entry fun createPool<T0, T1>(arg0: &Admincap, arg1: u64, arg2: u128, arg3: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg3, 1);
        assert!(arg2 > 0, 8001);
    ...
    public entry fun depositRewardCoins<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version, arg3: 0x2::coin::Coin<T1>) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg2, 1);
    ...
    public entry fun migrateNewVersion<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut MigrateInfor, arg4: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg4, 1);
    ...
    public fun set_treasury_admin_address<T0, T1>(arg0: &Admincap, arg1: &mut MigrateInfor, arg2: address, arg3: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg3, 1);
        arg1.admin_address = arg2;
    }

    public entry fun stakeRewards<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg2, 1);
        assert!(!arg0.paused, 8008);
        let v0 = 0x2::tx_context::sender(arg3);
    ...
    public fun start_migrate<T0, T1>(arg0: &Admincap, arg1: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg1, 1);
        let v0 = MigrateInfor{
    ...
    public entry fun stopEmergency<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: vector<address>, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg5, 1);
        let v0 = 0;
    ...
    public fun unstake<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: u128, arg2: &0x2::clock::Clock, arg3: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg3, 1);
        assert!(!arg0.paused, 8008);
    ...
    public entry fun updateApy<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: vector<address>, arg3: u128, arg4: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version, arg5: &0x2::clock::Clock) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg4, 1);
        assert!(arg3 > 0, 8001);
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
    ...
    public entry fun updateApyV2<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: vector<address>, arg3: u128, arg4: u128, arg5: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version, arg6: &0x2::clock::Clock) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg5, 1);
        assert!(arg3 > 0, 8001);
        arg1.apy = arg3;
        let v0 = 0;
    ...
    public entry fun updateUnlockTime<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: u64, arg3: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg3, 1);
        assert!(arg2 > 0, 8001);
    ...
    public entry fun withdrawRewardCoins<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg2, 1);
    ...
    public entry fun withdrawSpt<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x3f4371b17a47e72d99c1380d1bfb3e291ebe4891a0cf75cca1704902aea3804b::version::checkVersion(arg2, 1);
        assert!(!arg0.paused, 8008);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::table::contains<address, UserStake>(&mut arg0.stakes, v0), 8003);
