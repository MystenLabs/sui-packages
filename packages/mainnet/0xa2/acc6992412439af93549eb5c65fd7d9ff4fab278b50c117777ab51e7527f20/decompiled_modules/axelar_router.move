module 0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::axelar_router {
    struct AxelarRouterAdminCap has store, key {
        id: 0x2::object::UID,
        router_id: 0x2::object::ID,
        whitelist_admin_cap: 0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::whitelist::WhitelistAdminCap,
    }

    struct AxelarRouter has store, key {
        id: 0x2::object::UID,
        whitelist: 0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::whitelist::Whitelist,
    ...
    public fun new(arg0: &mut 0x2::tx_context::TxContext) : AxelarRouterAdminCap {
        let (v0, v1) = 0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::whitelist::new(arg0);
        let v2 = AxelarRouter{
    ...
    public fun borrow_whitelist_mut(arg0: &mut AxelarRouter) : &mut 0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::whitelist::Whitelist {
        &mut arg0.whitelist
    }
    ...
    public fun register_write_u256(arg0: &mut 0x2b839b25c7133e5e0f8f585cb2e89bf430a6585a88c4a0343ae3b246372d431c::discovery::RelayerDiscovery, arg1: &AxelarRouter) {
        ...
        0x1::vector::push_back<vector<u8>>(v1, 0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::concat::concat<u8>(x"00", 0x2::address::to_bytes(0x2::object::id_address<AxelarRouter>(arg1))));
    ...
    public fun send(arg0: &AxelarRouter, arg1: &0xeb055ffc3237c24e305a2bb760fe6551f6ff7c5fdb68735169c0f528fccab373::gateway::Gateway, arg2: 0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::message::Message) {
        let v0 = 0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::message::bridge(arg2);
        if (0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::bridge::is_axelar(&v0)) {
            let v1 = 0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::message::chain_id(arg2);
            let v2 = 0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::message::destination(arg2);
            let v3 = 0x2::bcs::to_bytes<u32>(&v2);
            let v4 = 0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::message::payload(arg2);
            ...
            assert!(0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::bridge::is_null(&v0), 3);
            abort 9999
        };
    }
    ...
    public fun set_axelar_chain_string(arg0: &AxelarRouterAdminCap, arg1: &mut AxelarRouter, arg2: u32, arg3: 0x1::ascii::String) {
        ...
        0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::table::update_or_add_in_table<u32, 0x1::ascii::String>(&mut arg1.axelar_chain_id_to_string, arg2, arg3);
        0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::table::update_or_add_in_table<0x1::ascii::String, u32>(&mut arg1.axelar_chain_string_to_id, arg3, arg2);
    }

    public fun set_peer_router(arg0: &AxelarRouterAdminCap, arg1: &mut AxelarRouter, arg2: u32, arg3: 0x1::ascii::String) {
        assert_correct_axelar_router_admin_cap(arg0, arg1);
        0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::table::update_or_add_in_table<u32, 0x1::ascii::String>(&mut arg1.axelar_chain_id_to_peer_router, arg2, arg3);
    }
    ...
    public fun write_u256(arg0: 0xeb055ffc3237c24e305a2bb760fe6551f6ff7c5fdb68735169c0f528fccab373::channel::ApprovedMessage, arg1: &mut AxelarRouter) {
        ...
        let v4 = 0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::abi::new_reader(v3);
        let v5 = WriteU256Received{
            value          : 0xa2acc6992412439af93549eb5c65fd7d9ff4fab278b50c117777ab51e7527f20::abi::read_u256(&mut v4),
            source_chain   : v0,
            message_id     : v1,
            source_address : v2,
            payload        : v3,
