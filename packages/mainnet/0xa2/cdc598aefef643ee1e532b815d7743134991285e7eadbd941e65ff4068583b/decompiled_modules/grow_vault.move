module 0xa2cdc598aefef643ee1e532b815d7743134991285e7eadbd941e65ff4068583b::grow_vault {
    ...
    fun convert_to_assets_internal(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        (((arg0 as u256) * (arg2 as u256) * 1000000000000000000 / (arg1 as u256) / 1000000000000000000) as u64)
    }
    ...
    fun convert_to_shares_internal(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        (((arg0 as u256) * (arg1 as u256) * 1000000000000000000 / (arg2 as u256) / 1000000000000000000) as u64)
    }
    ...
    public(friend) fun create_vault<T0, T1>(arg0: 0x2::coin::TreasuryCap<T1>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 < 10000, 9223372247308435461);
        ...
        0xa2cdc598aefef643ee1e532b815d7743134991285e7eadbd941e65ff4068583b::events::vault_created(0x2::object::id_address<GrowVault<T0, T1>>(&v0), 0x1::type_name::get<T0>(), 0x1::type_name::get<T1>());
    ...
    public fun finalize_deposit<T0, T1>(arg0: &mut GrowVault<T0, T1>, arg1: &mut 0x2662bcdf06c7b58473eb9f6215b81b45f97a4e86bb566e988c60032fd21fca57::session_flow::SessionFlow<T0, T1>, arg2: &0x2::clock::Clock, arg3: &0xa2cdc598aefef643ee1e532b815d7743134991285e7eadbd941e65ff4068583b::version::Version, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        0xa2cdc598aefef643ee1e532b815d7743134991285e7eadbd941e65ff4068583b::version::assert_current_version(arg3);
        assert!(!0x2662bcdf06c7b58473eb9f6215b81b45f97a4e86bb566e988c60032fd21fca57::session_flow::can_consoom<T0, T1>(arg1), 9223372393337192451);
        assert!(0x2662bcdf06c7b58473eb9f6215b81b45f97a4e86bb566e988c60032fd21fca57::session_flow::is_deposit<T0, T1>(arg1), 9223372397632028673);
        ...
        0xa2cdc598aefef643ee1e532b815d7743134991285e7eadbd941e65ff4068583b::events::deposit(0x2::object::id_address<GrowVault<T0, T1>>(arg0), v0, v1, 0x2::tx_context::sender(arg4));
    ...
    public fun initiate_withdrawal<T0, T1>(arg0: &mut GrowVault<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &0x2::clock::Clock, arg3: &0xa2cdc598aefef643ee1e532b815d7743134991285e7eadbd941e65ff4068583b::version::Version) : 0x2662bcdf06c7b58473eb9f6215b81b45f97a4e86bb566e988c60032fd21fca57::session_flow::SessionFlow<T0, T1> {
        0xa2cdc598aefef643ee1e532b815d7743134991285e7eadbd941e65ff4068583b::version::assert_current_version(arg3);
    ...
    fun share_price_internal(arg0: u64, arg1: u64) : u64 {
        ...
        (((arg1 as u256) * 1000000000000000000 / (arg0 as u256) / 1000000000000000000) as u64)
    }

    public fun take_fees<T0, T1>(arg0: &0x58e1e537fb40c9e8fba75714cd06338ae43a86d1b00a29272dcbcd2ac5742dd1::admin::AdminCap, arg1: &mut GrowVault<T0, T1>, arg2: &0x2::clock::Clock, arg3: &0xa2cdc598aefef643ee1e532b815d7743134991285e7eadbd941e65ff4068583b::version::Version, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        0xa2cdc598aefef643ee1e532b815d7743134991285e7eadbd941e65ff4068583b::version::assert_current_version(arg3);
        ...
        0xa2cdc598aefef643ee1e532b815d7743134991285e7eadbd941e65ff4068583b::events::fees_taken(0x2::object::id_address<GrowVault<T0, T1>>(arg1), v1, v2, v4);
    ...
    public fun update_debt<T0, T1>(arg0: &0x58e1e537fb40c9e8fba75714cd06338ae43a86d1b00a29272dcbcd2ac5742dd1::admin::AdminCap, arg1: &mut GrowVault<T0, T1>, arg2: u64, arg3: &0xa2cdc598aefef643ee1e532b815d7743134991285e7eadbd941e65ff4068583b::version::Version, arg4: &0x2::clock::Clock) {
        0xa2cdc598aefef643ee1e532b815d7743134991285e7eadbd941e65ff4068583b::version::assert_current_version(arg3);
        ...
        0xa2cdc598aefef643ee1e532b815d7743134991285e7eadbd941e65ff4068583b::events::assets_updated(0x2::object::id_address<GrowVault<T0, T1>>(arg1), v1, arg2, v0);
    }
