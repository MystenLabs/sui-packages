module 0xa2039db61cc568bc1130410816a295a2b2f072fc55ab071547f3b2781193c1fe::cnsnft9457 {
    struct CNSNFT9457 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9457, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8182"));
        let v4 = 0x2::package::claim<CNSNFT9457>(arg0, arg1);
