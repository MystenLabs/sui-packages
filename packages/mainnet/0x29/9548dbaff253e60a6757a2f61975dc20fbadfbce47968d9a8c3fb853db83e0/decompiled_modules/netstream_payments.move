module 0x299548dbaff253e60a6757a2f61975dc20fbadfbce47968d9a8c3fb853db83e0::netstream_payments {
    struct NETSTREAM_PAYMENTS has drop {
        dummy_field: bool,
    }
    ...
    public fun get_total_payments(arg0: &Config) : u64 {
        arg0.total_payments
    }
    ...
    fun init(arg0: NETSTREAM_PAYMENTS, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun process_payment<T0>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0xa55da33f92dc59fcf429bd5fbc506dfe454a3ca41073a2aeb5c70afb3aa9d1f6::affiliate_system::Registry<T0>, arg5: &mut Config, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        arg5.total_payments = arg5.total_payments + 1;
