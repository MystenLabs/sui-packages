module 0x299c92f4da068c69041b376d9051d5513dfe9c45f956adb1da126da39579824b::polynomial {
    ...
    fun add(arg0: &Polynomial, arg1: &Polynomial) : Polynomial {
        ...
        let v3 = 0;
        while (v3 < v1) {
            0x1::vector::push_back<u8>(&mut v2, 0x299c92f4da068c69041b376d9051d5513dfe9c45f956adb1da126da39579824b::gf256::add(*0x1::vector::borrow<u8>(&arg0.coefficients, v3), *0x1::vector::borrow<u8>(&arg1.coefficients, v3)));
            v3 = v3 + 1;
        };
        let v4 = 0;
        while (v4 < v0 - v1) {
    ...
    fun div(arg0: &Polynomial, arg1: u8) : Polynomial {
        scale(arg0, 0x299c92f4da068c69041b376d9051d5513dfe9c45f956adb1da126da39579824b::gf256::div(1, arg1))
    }
            ...
            if (v3 > v1) {
                ...
                loop {
                    if (v3 <= degree(arg0) && v1 - v3 <= degree(arg1)) {
                        v2 = 0x299c92f4da068c69041b376d9051d5513dfe9c45f956adb1da126da39579824b::gf256::add(v2, 0x299c92f4da068c69041b376d9051d5513dfe9c45f956adb1da126da39579824b::gf256::mul(*0x1::vector::borrow<u8>(&arg0.coefficients, v3), *0x1::vector::borrow<u8>(&arg1.coefficients, v1 - v3)));
                    };
                    if (v3 >= v1) {
                        break
                    };
    ...
    public fun evaluate(arg0: &Polynomial, arg1: u8) : u8 {
        ...
        let v2 = 0;
        while (v2 < v1) {
            let v3 = 0x299c92f4da068c69041b376d9051d5513dfe9c45f956adb1da126da39579824b::gf256::mul(v0, arg1);
            v0 = 0x299c92f4da068c69041b376d9051d5513dfe9c45f956adb1da126da39579824b::gf256::add(v3, *0x1::vector::borrow<u8>(&arg0.coefficients, v1 - v2 - 1));
            v2 = v2 + 1;
        };
        v0
    }
        ...
        while (v2 < v0) {
            ...
            while (v4 < v0) {
                if (v4 != v2) {
                    ...
                    let v7 = div(&v6, 0x299c92f4da068c69041b376d9051d5513dfe9c45f956adb1da126da39579824b::gf256::sub(*0x1::vector::borrow<u8>(arg0, v2), *0x1::vector::borrow<u8>(arg0, v4)));
                    v3 = mul(v5, &v7);
                };
                v4 = v4 + 1;
            };
    ...
    fun monic_linear(arg0: &u8) : Polynomial {
        ...
        let v1 = &mut v0;
        0x1::vector::push_back<u8>(v1, 0x299c92f4da068c69041b376d9051d5513dfe9c45f956adb1da126da39579824b::gf256::sub(0, *arg0));
    ...
    fun scale(arg0: &Polynomial, arg1: u8) : Polynomial {
        ...
        while (v2 < 0x1::vector::length<u8>(v0)) {
            0x1::vector::push_back<u8>(&mut v1, 0x299c92f4da068c69041b376d9051d5513dfe9c45f956adb1da126da39579824b::gf256::mul(*0x1::vector::borrow<u8>(v0, v2), arg1));
            v2 = v2 + 1;
        };
