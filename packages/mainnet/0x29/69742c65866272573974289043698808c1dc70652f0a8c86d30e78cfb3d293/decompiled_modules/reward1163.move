module 0x2969742c65866272573974289043698808c1dc70652f0a8c86d30e78cfb3d293::reward1163 {
    struct REWARD1163 has drop {
        dummy_field: bool,
    }

    struct TICKET_1163 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1163(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1163>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1163>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1163, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1163>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1163>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1163>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1163>>(v5, 0x2::tx_context::sender(arg1));
    }
