module 0x29c2312bdffe774784580ce721cf01566b1ec99cc0864f5c1bc8104e941cc84e::collection {
    ...
    struct RoyaltySplitter has key {
        id: 0x2::object::UID,
        cap: 0x2::transfer_policy::TransferPolicyCap<Bags>,
    ...
    entry fun admin_mint_to_kiosk(arg0: &AdminCap, arg1: &mut Collection, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<Bags>, arg5: u64, arg6: address, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) {
        assert_mint_ready(arg1);
    ...
    public fun attributes(arg0: &Bags) : &0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
        &arg0.attributes
    }
    ...
    entry fun claim_mint_from_kiosk_to_kiosk<T0: store + key>(arg0: &mut ClaimGate, arg1: &mut Collection, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<Bags>, arg5: 0x2::object::ID, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun claim_mint_from_personal_kiosk_to_kiosk<T0: store + key>(arg0: &mut ClaimGate, arg1: &mut Collection, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg4: &0x2::transfer_policy::TransferPolicy<Bags>, arg5: 0x2::object::ID, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.gate_type, 25);
    ...
    entry fun claim_mint_to_kiosk<T0: key>(arg0: &mut ClaimGate, arg1: &mut Collection, arg2: &T0, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &0x2::transfer_policy::TransferPolicy<Bags>, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.gate_type, 25);
        do_claim_to_kiosk(arg0, arg1, 0x2::object::id<T0>(arg2), arg3, arg4, arg5, arg6, arg7, arg8);
    }

    entry fun claim_mint_to_new_kiosk<T0: key>(arg0: &mut ClaimGate, arg1: &mut Collection, arg2: &T0, arg3: &0x2::transfer_policy::TransferPolicy<Bags>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::random::Random, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.gate_type, 25);
    ...
    public fun create_royalty_splitter(arg0: &AdminCap, arg1: 0x2::transfer_policy::TransferPolicyCap<Bags>, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun distribute(arg0: &mut RoyaltySplitter, arg1: &mut 0x2::transfer_policy::TransferPolicy<Bags>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::transfer_policy::withdraw<Bags>(arg1, &arg0.cap, 0x1::option::none<u64>(), arg2);
    ...
    fun do_claim_to_kiosk(arg0: &mut ClaimGate, arg1: &mut Collection, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &0x2::transfer_policy::TransferPolicy<Bags>, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) : vector<0x2::object::ID> {
    ...
    fun draw_and_lock(arg0: &mut Collection, arg1: u64, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<Bags>, arg5: address, arg6: &mut 0x2::random::RandomGenerator, arg7: &mut 0x2::tx_context::TxContext) : vector<0x2::object::ID> {
        ...
        while (v1 < arg1) {
            ...
            0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x2::object::id<Bags>(&v3));
            0x2::kiosk::lock<Bags>(arg2, arg3, arg4, v3);
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public fun fix_metadata(arg0: &Corrections, arg1: &mut Bags, arg2: &0x2::tx_context::TxContext) {
        ...
        let v0 = ItemMetadataFixed{
            object_id        : 0x2::object::id<Bags>(arg1),
            index            : arg1.index,
    ...
    fun forge_one(arg0: &mut Collection, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : Bags {
        ...
        let v4 = ItemMinted{
            object_id : 0x2::object::id<Bags>(&v3),
            number    : v1,
            index     : v2,
            recipient : arg2,
        };
    ...
    public fun index(arg0: &Bags) : u64 {
        arg0.index
    }
    ...
    fun init(arg0: COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::display::new<Bags>(&v1, arg1);
        0x2::display::add<Bags>(&mut v2, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"Bags #{index}"));
        0x2::display::add<Bags>(&mut v2, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"A bunch of weirdos with bags on their heads. Same bag, different faces, different traits, different personalities. Some are clean, some are rekt, and some are completely unhinged. Just like you. Find your bag!"));
        let v3 = 0x1::string::utf8(b"https://assets.alienz.tech/collections/2f3de4af661868cd3a3a8d5a37708564752e22ba771ad3ffde3c8182ea54e5a2/tokens/");
        0x1::string::append(&mut v3, 0x1::string::utf8(b"{index}."));
        0x1::string::append(&mut v3, 0x1::string::utf8(b"webp"));
        0x2::display::add<Bags>(&mut v2, 0x1::string::utf8(b"image_url"), v3);
        if (false) {
            let v4 = 0x1::string::utf8(b"https://assets.alienz.tech/collections/2f3de4af661868cd3a3a8d5a37708564752e22ba771ad3ffde3c8182ea54e5a2/tokens/");
            0x1::string::append(&mut v4, 0x1::string::utf8(b"{index}."));
            0x1::string::append(&mut v4, 0x1::string::utf8(b"mp4"));
            0x2::display::add<Bags>(&mut v2, 0x1::string::utf8(b"animation_url"), v4);
        };
        0x2::display::add<Bags>(&mut v2, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(b"https://hive.alienz.tech"));
        0x2::display::add<Bags>(&mut v2, 0x1::string::utf8(b"creator"), 0x1::string::utf8(b"Alienztech"));
        0x2::display::update_version<Bags>(&mut v2);
        let (v5, v6) = 0x2::transfer_policy::new<Bags>(&v1, arg1);
        let v7 = v6;
        let v8 = v5;
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Bags>(&mut v8, &v7, 300, 100000000);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::add<Bags>(&mut v8, &v7);
        let v9 = Collection{
            id               : 0x2::object::new(arg1),
            name             : 0x1::string::utf8(b"Bags"),
            size             : 3333,
            minted           : 0,
            drawn            : 0,
            seeded           : 0,
        ...
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<Bags>>(v8);
        0x2::transfer::share_object<Collection>(v9);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<Bags>>(v7, v0);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v1, v0);
        0x2::transfer::public_transfer<0x2::display::Display<Bags>>(v2, v0);
    ...
    public fun is_revealed(arg0: &Bags) : bool {
        arg0.index != 0
    }

    public fun metadata_version(arg0: &Bags) : u64 {
        arg0.metadata_version
    }

    fun mint_boxes_into_kiosk(arg0: &mut MintConfig, arg1: &mut Collection, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<Bags>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : vector<0x2::object::ID> {
        ...
        while (v2 < arg7) {
            ...
            0x2::kiosk::lock<Bags>(arg2, arg3, arg4, v4);
            v2 = v2 + 1;
        };
        v1
    }
    ...
    fun mint_one(arg0: &mut Collection, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x2::transfer::public_transfer<Bags>(v0, arg2);
        0x2::object::id<Bags>(&v0)
    }
    ...
    entry fun mint_pinned_to_kiosk(arg0: &mut ReservationBook, arg1: &mut Collection, arg2: &MintConfig, arg3: u64, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &0x2::transfer_policy::TransferPolicy<Bags>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::kiosk::lock<Bags>(arg4, arg5, arg6, v5);
        let v6 = PinnedMinted{
            book_id   : 0x2::object::id<ReservationBook>(arg0),
            index     : arg3,
            object_id : 0x2::object::id<Bags>(&v5),
            recipient : v0,
            price     : v2,
        };
    ...
    public fun number(arg0: &Bags) : u64 {
        arg0.number
    }
    ...
    entry fun public_mint_box_many_to_kiosk(arg0: &mut MintConfig, arg1: &mut Collection, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<Bags>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun public_mint_many_to_kiosk(arg0: &mut MintConfig, arg1: &mut Collection, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<Bags>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: u64, arg8: u64, arg9: &0x2::random::Random, arg10: &mut 0x2::tx_context::TxContext) {
        assert_mint_ready(arg1);
        assert_supply(arg1, arg7);
    ...
    entry fun public_mint_many_to_new_kiosk(arg0: &mut MintConfig, arg1: &mut Collection, arg2: &0x2::transfer_policy::TransferPolicy<Bags>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) {
        assert_mint_ready(arg1);
        assert_supply(arg1, arg5);
    ...
    entry fun reveal(arg0: &mut Collection, arg1: &mut Bags, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun reveal_in_kiosk(arg0: &mut Collection, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::random::new_generator(arg4, arg5);
        let v1 = 0x2::kiosk::borrow_mut<Bags>(arg1, arg2, arg3);
        let v2 = &mut v0;
        reveal_inner(arg0, v1, v2, arg5);
    }

    fun reveal_inner(arg0: &mut Collection, arg1: &mut Bags, arg2: &mut 0x2::random::RandomGenerator, arg3: &0x2::tx_context::TxContext) {
    ...
    entry fun reveal_many(arg0: &mut Collection, arg1: vector<Bags>, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<Bags>(&arg1);
        assert!(v0 > 0, 4);
        assert!(v0 <= 10, 6);
        let v1 = 0x2::random::new_generator(arg2, arg3);
        while (!0x1::vector::is_empty<Bags>(&arg1)) {
            let v2 = 0x1::vector::pop_back<Bags>(&mut arg1);
            let v3 = &mut v2;
            let v4 = &mut v1;
            reveal_inner(arg0, v3, v4, arg3);
            0x2::transfer::public_transfer<Bags>(v2, 0x2::tx_context::sender(arg3));
        };
        0x1::vector::destroy_empty<Bags>(arg1);
    }

    entry fun reveal_many_and_lock(arg0: &mut Collection, arg1: vector<Bags>, arg2: &0x2::transfer_policy::TransferPolicy<Bags>, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<Bags>(&arg1);
        assert!(v0 > 0, 4);
        assert!(v0 <= 10, 6);
        ...
        let v5 = v2;
        while (!0x1::vector::is_empty<Bags>(&arg1)) {
            let v6 = 0x1::vector::pop_back<Bags>(&mut arg1);
            let v7 = &mut v6;
            let v8 = &mut v1;
            reveal_inner(arg0, v7, v8, arg4);
            0x2::kiosk::lock<Bags>(&mut v5, &v4, arg2, v6);
        };
        0x1::vector::destroy_empty<Bags>(arg1);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v5);
    ...
    entry fun reveal_many_in_kiosk(arg0: &mut Collection, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: vector<0x2::object::ID>, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0;
        while (v2 < v0) {
            let v3 = 0x2::kiosk::borrow_mut<Bags>(arg1, arg2, *0x1::vector::borrow<0x2::object::ID>(&arg3, v2));
            let v4 = &mut v1;
    ...
    entry fun reveal_many_in_personal_kiosk(arg0: &mut Collection, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg3: vector<0x2::object::ID>, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0;
        while (v3 < v0) {
            let v4 = 0x2::kiosk::borrow_mut<Bags>(arg1, v1, *0x1::vector::borrow<0x2::object::ID>(&arg3, v3));
            let v5 = &mut v2;
