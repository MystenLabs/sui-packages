module 0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::market_state {
    ...
    struct MarketState has store, key {
        ...
        amm_pools: 0x1::option::Option<vector<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>>,
        status: MarketStatus,
    ...
    public fun new(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u64, arg3: vector<0x1::string::String>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : MarketState {
        assert!(arg2 >= 0x5d369bb8a96e9d5d3e9ed434f5d1ba3de449ce392dc574d23b86791e08ee2129::constants::min_outcomes(), 16);
        assert!(arg2 <= 0x5d369bb8a96e9d5d3e9ed434f5d1ba3de449ce392dc574d23b86791e08ee2129::constants::protocol_max_outcomes(), 16);
        ...
        MarketState{
            ...
            amm_pools          : 0x1::option::none<vector<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>>(),
            status             : v0,
    ...
    public fun borrow_amm_pools(arg0: &MarketState) : &vector<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool> {
        assert!(0x1::option::is_some<vector<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>>(&arg0.amm_pools), 19);
        0x1::option::borrow<vector<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>>(&arg0.amm_pools)
    }
    ...
    public fun finalize_from_execution_success(arg0: &mut MarketState, arg1: &0x2::clock::Clock, arg2: &0x664a0e25093ade2eb071799f7b24a821a5eeb6f355986f6bc15c582b60d0c6a0::market_state_mutation_auth::MarketStateMutationAuth) {
        assert!(arg0.status.in_execution_window, 12);
        assert!(!arg0.status.finalized, 2);
    ...
    public fun finalize_from_timeout(arg0: &mut MarketState, arg1: &0x2::clock::Clock, arg2: &0x664a0e25093ade2eb071799f7b24a821a5eeb6f355986f6bc15c582b60d0c6a0::market_state_mutation_auth::MarketStateMutationAuth) {
        assert!(arg0.status.in_execution_window, 12);
        assert!(!arg0.status.finalized, 2);
        let v0 = 0x2::clock::timestamp_ms(arg1);
        assert!(0x1::option::is_some<u64>(&arg0.execution_deadline), 12);
    ...
    public fun finalize_immediately_with_reject(arg0: &mut MarketState, arg1: vector<u128>, arg2: &0x2::clock::Clock, arg3: &0x664a0e25093ade2eb071799f7b24a821a5eeb6f355986f6bc15c582b60d0c6a0::market_state_mutation_auth::MarketStateMutationAuth) {
        assert!(arg0.status.trading_started, 6);
        assert!(!arg0.status.trading_ended, 3);
        assert!(!arg0.status.finalized, 2);
    ...
    public fun get_pool_by_outcome(arg0: &MarketState, arg1: u64) : &0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool {
        assert!(arg1 < arg0.outcome_count, 1);
        assert!(0x1::option::is_some<vector<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>>(&arg0.amm_pools), 19);
        0x1::vector::borrow<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>(0x1::option::borrow<vector<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>>(&arg0.amm_pools), arg1)
    }

    public fun get_pool_mut_by_outcome(arg0: &mut MarketState, arg1: u64, arg2: &0x664a0e25093ade2eb071799f7b24a821a5eeb6f355986f6bc15c582b60d0c6a0::escrow_mutation_auth::EscrowMutationAuth) : &mut 0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool {
        assert!(arg1 < arg0.outcome_count, 1);
        assert!(0x1::option::is_some<vector<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>>(&arg0.amm_pools), 19);
        0x1::vector::borrow_mut<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>(0x1::option::borrow_mut<vector<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>>(&mut arg0.amm_pools), arg1)
    }
    ...
    public fun has_amm_pools(arg0: &MarketState) : bool {
        0x1::option::is_some<vector<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>>(&arg0.amm_pools)
    }
    ...
    public fun set_amm_pools(arg0: &mut MarketState, arg1: vector<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>, arg2: &0x664a0e25093ade2eb071799f7b24a821a5eeb6f355986f6bc15c582b60d0c6a0::market_state_mutation_auth::MarketStateMutationAuth) {
        assert!(0x1::option::is_none<vector<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>>(&arg0.amm_pools), 15);
        assert!(0x1::vector::length<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>(&arg1) == arg0.outcome_count, 18);
        let v0 = 0;
        while (v0 < 0x1::vector::length<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>(&arg1)) {
            assert!(0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::get_ms_id(0x1::vector::borrow<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>(&arg1, v0)) == 0x2::object::id<MarketState>(arg0), 22);
            assert!((0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::get_outcome_idx(0x1::vector::borrow<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>(&arg1, v0)) as u64) == v0, 24);
            v0 = v0 + 1;
        };
        0x1::option::fill<vector<0x29d852734017c426b90b1824549ec43b06cbdc3fcd3182d26af601fc6b636c81::conditional_amm::LiquidityPool>>(&mut arg0.amm_pools, arg1);
    }

    public fun start_execution_window(arg0: &mut MarketState, arg1: u64, arg2: vector<u128>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0x664a0e25093ade2eb071799f7b24a821a5eeb6f355986f6bc15c582b60d0c6a0::market_state_mutation_auth::MarketStateMutationAuth) {
        assert!(arg0.status.trading_started, 6);
        assert!(!arg0.status.trading_ended, 3);
        assert!(!arg0.status.in_execution_window, 9);
        assert!(!arg0.status.finalized, 2);
        ...
        assert!(arg1 >= 0x5d369bb8a96e9d5d3e9ed434f5d1ba3de449ce392dc574d23b86791e08ee2129::constants::min_execution_window_ms() && arg1 <= 0x5d369bb8a96e9d5d3e9ed434f5d1ba3de449ce392dc574d23b86791e08ee2129::constants::max_execution_window_ms(), 13);
    ...
    public fun start_trading(arg0: &mut MarketState, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x664a0e25093ade2eb071799f7b24a821a5eeb6f355986f6bc15c582b60d0c6a0::market_state_mutation_auth::MarketStateMutationAuth) {
        assert!(!arg0.status.trading_started, 0);
        assert!(arg1 > 0 && arg1 <= 0x5d369bb8a96e9d5d3e9ed434f5d1ba3de449ce392dc574d23b86791e08ee2129::constants::max_trading_duration_ms(), 7);
