module 0x29b31eb7e82addb88d86c7430424d4a1c803cd3a43c87a232662f163c3581637::reward6293 {
    struct REWARD6293 has drop {
        dummy_field: bool,
    }

    struct TICKET_6293 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6293(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6293>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6293>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6293, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6293>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6293>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6293>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6293>>(v5, 0x2::tx_context::sender(arg1));
    }
