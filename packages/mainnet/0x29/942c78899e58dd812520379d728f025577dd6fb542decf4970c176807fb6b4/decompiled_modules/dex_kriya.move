module 0x29942c78899e58dd812520379d728f025577dd6fb542decf4970c176807fb6b4::dex_kriya {
    ...
    public fun get_package() : address {
        0x29942c78899e58dd812520379d728f025577dd6fb542decf4970c176807fb6b4::constants::kriya_package()
    }

    public fun get_pool_config() : address {
        0x29942c78899e58dd812520379d728f025577dd6fb542decf4970c176807fb6b4::constants::kriya_sui_usdc_pool()
    }
    ...
    public entry fun swap_sui_to_usdc_real(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = KriyaSwapExecuted{
            ...
            amount_in      : v0,
            min_amount_out : arg1,
            pool_id        : 0x29942c78899e58dd812520379d728f025577dd6fb542decf4970c176807fb6b4::constants::kriya_sui_usdc_pool(),
        };
        0x2::event::emit<KriyaSwapExecuted>(v2);
    }
