module 0x29e9ca41bd07ff7608c9379cd708cc39cc06ab6cf00537f3b6d0d7cb0031bb88::reward4065 {
    struct REWARD4065 has drop {
        dummy_field: bool,
    }

    struct TICKET_4065 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4065(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4065>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4065>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4065, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4065>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4065>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4065>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4065>>(v5, 0x2::tx_context::sender(arg1));
    }
