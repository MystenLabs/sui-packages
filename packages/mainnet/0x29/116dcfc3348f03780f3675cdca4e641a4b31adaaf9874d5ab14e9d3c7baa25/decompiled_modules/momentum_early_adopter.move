module 0x29116dcfc3348f03780f3675cdca4e641a4b31adaaf9874d5ab14e9d3c7baa25::momentum_early_adopter {
    struct MOMENTUM_EARLY_ADOPTER has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOMENTUM_EARLY_ADOPTER, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MOMENTUM_EARLY_ADOPTER>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Momentum Early Adopter"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"MOMENTUM Finance offers official SDK to allow developers to seamlessly integrate with MOMENTUM CLMM Dex."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreigsuumkckfkqsfdtrdmrg4cig2zonawhwc7y64s56nqhm3vbxab5a"));
