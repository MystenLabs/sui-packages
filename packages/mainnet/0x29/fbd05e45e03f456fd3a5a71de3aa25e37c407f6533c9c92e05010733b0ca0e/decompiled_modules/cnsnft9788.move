module 0x29fbd05e45e03f456fd3a5a71de3aa25e37c407f6533c9c92e05010733b0ca0e::cnsnft9788 {
    struct CNSNFT9788 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9788, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2702"));
        let v4 = 0x2::package::claim<CNSNFT9788>(arg0, arg1);
