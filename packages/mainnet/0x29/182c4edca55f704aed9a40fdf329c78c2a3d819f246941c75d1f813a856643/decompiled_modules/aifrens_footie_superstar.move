module 0x414abb429e44ddff03fe84d407ea3985c93fe55bd3ed79a8e2e57f50daf2e21c::aifrens_footie_superstar {
    ...
    public fun fusion_ref<T0>(arg0: &mut AifrensSuperstarGlobal, arg1: &mut PriceGlobal<T0>, arg2: &AifrensSeason, arg3: &0x2::clock::Clock, arg4: &mut 0x2::coin::Coin<T0>, arg5: u64, arg6: 0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::AifrensGenesis, arg7: 0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::AifrensGenesis, arg8: vector<0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::AifrensLol>, arg9: address, arg10: &mut ReferralSystem, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 3);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(v0 > arg0.start_time_ms, 1);
        assert!(v0 < arg0.expired_time_ms, 2);
        ...
        let v5 = 0x1::vector::length<0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::AifrensLol>(&arg8);
        let v6 = 0;
        while (v6 < v5) {
            0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::burn_token(0x1::vector::pop_back<0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::AifrensLol>(&mut arg8));
            v6 = v6 + 1;
        ...
        0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::burn_token(arg6);
        0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::burn_token(arg7);
        let v7 = mint_token(arg2, arg3, 0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::birthdate(&arg6), 0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::genes(&arg6), 0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::birth_location(&arg6), get_rate(arg0, arg5, v5), arg11);
    ...
    public fun recruit_ref<T0>(arg0: &mut AifrensSuperstarGlobal, arg1: &mut PriceGlobal<T0>, arg2: &AifrensSeason, arg3: &0x2::clock::Clock, arg4: vector<u8>, arg5: vector<u8>, arg6: &mut 0x2::coin::Coin<T0>, arg7: u64, arg8: vector<0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::AifrensLol>, arg9: address, arg10: &mut ReferralSystem, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 3);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(v0 > arg0.start_time_ms, 1);
        assert!(v0 < arg0.expired_time_ms, 2);
        ...
        let v6 = 0x1::vector::length<0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::AifrensLol>(&arg8);
        let v7 = 0;
        while (v7 < v6) {
            0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::burn_token(0x1::vector::pop_back<0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::AifrensLol>(&mut arg8));
            v7 = v7 + 1;
