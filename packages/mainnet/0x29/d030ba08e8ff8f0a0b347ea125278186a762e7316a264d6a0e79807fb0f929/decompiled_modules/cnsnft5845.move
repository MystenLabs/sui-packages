module 0x29d030ba08e8ff8f0a0b347ea125278186a762e7316a264d6a0e79807fb0f929::cnsnft5845 {
    struct CNSNFT5845 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5845, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5845>(arg0, arg1);
