module 0x2936f08bdf97cc71752771f0e803cafbaf7f941740323ed6570a6c43c7bac6ee::potm {
    ...
    fun init(arg0: POTM, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<POTM>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Potm"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"All In"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiannpet24qejv773evpomyip3w5hjqw6jegfwitsmnl5fb2lagd6m"));
