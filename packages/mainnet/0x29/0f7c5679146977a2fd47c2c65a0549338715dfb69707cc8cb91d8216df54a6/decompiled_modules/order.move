module 0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::order {
    ...
    entry fun create_pool<T0, T1>(arg0: &0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::ExchangePool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        create_pool_internal<T0, T1>(arg0, arg1, v0, arg2, arg3);
    }

    fun create_pool_internal<T0, T1>(arg0: &0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::ExchangePool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::get_pool_id<T0, T1>(arg0);
        let v1 = 1000 * 0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::get_usdc_unit<T0, T1>(arg0);
    ...
    entry fun create_principal_only_pool<T0, T1>(arg0: &0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::ExchangePool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::zero<T0>(arg2);
        let v1 = 0x2::tx_context::sender(arg2);
        create_pool_internal<T0, T1>(arg0, v0, v1, arg1, arg2);
    }
    ...
    public fun get_payment_range<T0, T1>(arg0: &0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::ExchangePool<T0, T1>) : (u64, u64) {
        let v0 = 0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::get_usdc_unit<T0, T1>(arg0);
        (100 * v0, 10000 * v0)
    }
    ...
    public fun is_principal_only() : bool {
        true
    }

    public fun migrate_reward_reserve_to_exchange<T0, T1>(arg0: &mut OrderPool<T0, T1>, arg1: &OrderAdminCap<T0, T1>, arg2: &mut 0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::ExchangePool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_admin<T0, T1>(arg0, arg1);
        assert!(arg0.exchange_pool_id == 0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::get_pool_id<T0, T1>(arg2), 2);
        assert!(0x2::balance::value<T0>(&arg0.reward_reserve) >= arg3, 5);
        let v0 = RewardReserveUpdated{
            pool_id       : 0x2::object::id<OrderPool<T0, T1>>(arg0),
            deposited     : false,
            amount        : arg3,
        ...
        0x2::event::emit<RewardReserveUpdated>(v0);
        0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::fund_ast_reserve<T0, T1>(arg2, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.reward_reserve, arg3), arg5), arg4, arg5);
    }
    ...
    fun redeem_internal<T0, T1>(arg0: &mut OrderPool<T0, T1>, arg1: StakeOrder<T0, T1>, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<T0>(&mut arg0.reward_reserve, v10);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v9, arg4), arg2);
        if (v2 > 0) {
            let v17 = RewardReserveUpdated{
                pool_id       : 0x2::object::id<OrderPool<T0, T1>>(arg0),
                deposited     : true,
                amount        : v2,
                reserve_after : 0x2::balance::value<T0>(&arg0.reward_reserve),
            ...
            0x2::event::emit<RewardReserveUpdated>(v17);
        };
    ...
    fun subscribe_with_period<T0, T1>(arg0: &mut OrderPool<T0, T1>, arg1: &mut 0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::ExchangePool<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: address, arg6: u64, arg7: u64, arg8: u8, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 1);
        assert!(arg0.exchange_pool_id == 0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::get_pool_id<T0, T1>(arg1), 2);
        let v0 = 0x2::coin::value<T1>(&arg2);
        let v1 = 0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::get_usdc_unit<T0, T1>(arg1);
        assert!(v0 >= 100 * v1 && v0 <= 10000 * v1, 3);
        assert!(arg8 >= 9 && arg8 <= 99, 4);
        let (v2, v3) = 0x290f7c5679146977a2fd47c2c65a0549338715dfb69707cc8cb91d8216df54a6::exchange::buy_for_order<T0, T1>(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg9, arg10);
        let v4 = daily_rate_for_period(arg8);
        let v5 = 0;
        let v6 = 0x2::tx_context::sender(arg10);
        let v7 = 0x2::clock::timestamp_ms(arg9);
        let v8 = v7 + (arg8 as u64) * 86400000;
        let v9 = StakeOrder<T0, T1>{
            ...
            payment_usdc     : v0,
            principal_ast    : v2,
            reward_ast       : 0x2::balance::zero<T0>(),
            period_days      : arg8,
            daily_rate_e6    : v4,
            price_e8         : arg3,
            price_version    : arg4,
        ...
        arg0.total_usdc_paid = arg0.total_usdc_paid + (v0 as u128);
        arg0.total_ast_principal = arg0.total_ast_principal + (v3 as u128);
        arg0.total_ast_rewards_reserved = arg0.total_ast_rewards_reserved + (v5 as u128);
        arg0.locked_ast_principal = arg0.locked_ast_principal + (v3 as u128);
        arg0.locked_ast_rewards = arg0.locked_ast_rewards + (v5 as u128);
        let v10 = OrderCreated{
            order_id         : 0x2::object::id<StakeOrder<T0, T1>>(&v9),
            pool_id          : 0x2::object::id<OrderPool<T0, T1>>(arg0),
            exchange_pool_id : arg0.exchange_pool_id,
            owner            : v6,
            payment_usdc     : v0,
        ...
        0x2::event::emit<OrderCreated>(v10);
        0x2::transfer::transfer<StakeOrder<T0, T1>>(v9, v6);
    }
