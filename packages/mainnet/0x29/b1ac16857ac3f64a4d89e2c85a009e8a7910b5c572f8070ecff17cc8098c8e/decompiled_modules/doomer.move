module 0x29b1ac16857ac3f64a4d89e2c85a009e8a7910b5c572f8070ecff17cc8098c8e::doomer {
    ...
    fun init(arg0: DOOMER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/BoxzM9bmgrDKrrogWxcoB2tG4Y3KXGobvvK3Q5oWV5Bf.png                                                                                                                                                                                                                               ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DOOMER>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"doomer      ")))), trim_right(b"doomer                          "), trim_right(b"Doomer is a character that is typically characterized as an early 20's male who suffers from depression and has a bleak outlook on the world.                                                                                                                                                                                   "), v2, arg1);
