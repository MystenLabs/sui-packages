module 0x295b8635f0daeedce6d908d97054c89db799f8863cda5ba23dbc7a28af83cfc3::pox {
    struct POX has drop {
        dummy_field: bool,
    }
    ...
    public fun add_price_feeders<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::package::Publisher, arg2: vector<address>) {
        assert!(0x2::package::from_module<POX>(arg1), 13906836364776701951);
    ...
    public fun create_pool<T0, T1>(arg0: &0x2::package::Publisher, arg1: &mut PoolRegistry, arg2: u8, arg3: u8, arg4: u8, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : Pool<T0, T1> {
        assert!(0x2::package::from_module<POX>(arg0), 13906834943142526975);
    ...
    public fun deposit<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &LiquidityProviderCap, arg2: 0x2::balance::Balance<T0>, arg3: 0x2::balance::Balance<T1>) {
        assert!(0x2::object::id<Pool<T0, T1>>(arg0) == arg1.pool, 13906834427746451455);
    ...
    public fun grant_lp_cap<T0, T1>(arg0: &0x2::package::Publisher, arg1: &Pool<T0, T1>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_module<POX>(arg0), 13906834341847105535);
    ...
    public fun quote_x_to_y<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64) : (u64, u64, u64) {
        quote_x_to_y_internal<T0, T1>(arg0, arg1, true)
    }

    fun quote_x_to_y_internal<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: bool) : (u64, u64, u64) {
        if (!arg2) {
        ...
        while (v1 < 0x1::vector::length<u64>(&arg0.bids) && v2 > 0) {
            if (v2 >= *0x1::vector::borrow<u64>(&arg0.bids, v1)) {
                ...
                if (v3 > 0) {
                    v0 = v0 + (v3 as u128) * ((arg0.bid_ref_price as u128) - (((arg0.ref_price_step as u64) * (v1 as u64)) as u128)) * 0x1::u128::pow(10, arg0.y_decimals) / 0x1::u128::pow(10, arg0.x_decimals) / 0x1::u128::pow(10, arg0.price_decimals);
                    v2 = v2 - v3;
                    if (!arg2) {
                ...
                let v4 = v2;
                v0 = v0 + (v2 as u128) * ((arg0.bid_ref_price as u128) - (arg0.ref_price_step as u128) * (v1 as u128)) * 0x1::u128::pow(10, arg0.y_decimals) / 0x1::u128::pow(10, arg0.x_decimals) / 0x1::u128::pow(10, arg0.price_decimals);
                v2 = 0;
                if (!arg2) {
                    let v5 = 0x1::vector::borrow_mut<u64>(&mut arg0.bids, v1);
                    *v5 = *v5 - v4;
                };
            };
            v1 = v1 + 1;
    ...
    public fun quote_y_to_x<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64) : (u64, u64, u64) {
        quote_y_to_x_internal<T0, T1>(arg0, arg1, true)
    }

    fun quote_y_to_x_internal<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: bool) : (u64, u64, u64) {
        if (!arg2) {
            assert!(!arg0.stopped, 1);
        };
        let v0 = 0;
        ...
        while (v1 < 0x1::vector::length<u64>(&arg0.asks) && v2 > 0) {
            if (v2 >= *0x1::vector::borrow<u64>(&arg0.asks, v1)) {
                let v3 = *0x1::vector::borrow<u64>(&arg0.asks, v1);
                if (v3 > 0) {
                    v0 = v0 + (v3 as u128) * 0x1::u128::pow(10, arg0.price_decimals) * 0x1::u128::pow(10, arg0.x_decimals) / 0x1::u128::pow(10, arg0.y_decimals) / ((arg0.ask_ref_price + (arg0.ref_price_step as u64) * (v1 as u64)) as u128);
                    v2 = v2 - v3;
                    if (!arg2) {
                ...
                let v4 = v2;
                v0 = v0 + (v2 as u128) * 0x1::u128::pow(10, arg0.x_decimals) * 0x1::u128::pow(10, arg0.price_decimals) / ((arg0.ask_ref_price + (arg0.ref_price_step as u64) * (v1 as u64)) as u128) / 0x1::u128::pow(10, arg0.y_decimals);
                v2 = 0;
                if (!arg2) {
                    let v5 = 0x1::vector::borrow_mut<u64>(&mut arg0.asks, v1);
                    *v5 = *v5 - v4;
                };
            };
            v1 = v1 + 1;
    ...
    public fun remove_price_feeders<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::package::Publisher, arg2: vector<address>) {
        assert!(0x2::package::from_module<POX>(arg1), 13906836403431407615);
        0x1::vector::reverse<address>(&mut arg2);
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
    ...
    public fun swap_x_to_y<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let (v1, v2, v3) = quote_x_to_y_internal<T0, T1>(arg0, v0, false);
        let v4 = if (v3 > 0) {
    ...
    public fun swap_y_to_x<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::balance::Balance<T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let (v1, v2, v3) = quote_y_to_x_internal<T0, T1>(arg0, v0, false);
        let v4 = if (v3 > 0) {
    ...
    public fun update_all_asks<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: vector<u64>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::length<u64>(&arg2) <= 0x1::vector::length<u64>(&arg0.asks), 13906835784956116991);
    ...
    public fun update_all_bids<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: vector<u64>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(address_is_price_feeder<T0, T1>(arg0, 0x2::tx_context::sender(arg4)), 3);
        assert!(0x1::vector::length<u64>(&arg2) <= 0x1::vector::length<u64>(&arg0.bids), 13906835892330299391);
    ...
    public fun update_ask<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1, 13906835643222196223);
    }
    ...
    public fun update_bid<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1, 13906835737711476735);
    }
    ...
    fun validate_asks_prices_amounts(arg0: &vector<u64>, arg1: &vector<u64>) {
        assert!(0x1::vector::length<u64>(arg0) == 0x1::vector::length<u64>(arg1), 2);
        let v0 = 0;
        let v1;
        while (v0 < 0x1::u64::max(0x1::vector::length<u64>(arg0), 1) - 1) {
    ...
    fun validate_bids_prices_amounts(arg0: &vector<u64>, arg1: &vector<u64>) {
        assert!(0x1::vector::length<u64>(arg0) == 0x1::vector::length<u64>(arg1), 2);
        let v0 = 0;
        let v1;
        while (v0 < 0x1::u64::max(0x1::vector::length<u64>(arg0), 1) - 1) {
    ...
    public fun withdraw<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &LiquidityProviderCap, arg2: u64, arg3: u64) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert!(0x2::object::id<Pool<T0, T1>>(arg0) == arg1.pool, 13906834565185404927);
        let v0 = if (arg2 == 0) {
            0x2::balance::zero<T0>()
        } else {
