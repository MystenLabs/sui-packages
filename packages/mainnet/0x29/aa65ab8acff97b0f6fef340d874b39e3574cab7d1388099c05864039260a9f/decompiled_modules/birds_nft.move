module 0x29aa65ab8acff97b0f6fef340d874b39e3574cab7d1388099c05864039260a9f::birds_nft {
    ...
    public fun buy(arg0: &mut BirdConfig, arg1: &mut SaleConfig, arg2: u8, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : BirdNFT {
        assert!(arg0.version == 1, 1002);
    ...
    public fun mint(arg0: &mut BirdConfig, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut Register, arg3: vector<u8>, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : BirdNFT {
        ...
        let v5 = if (0x2::table::contains<address, u128>(&arg2.nonce, v0)) {
