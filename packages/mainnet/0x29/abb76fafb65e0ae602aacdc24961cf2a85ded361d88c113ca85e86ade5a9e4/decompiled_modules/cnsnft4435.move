module 0x29abb76fafb65e0ae602aacdc24961cf2a85ded361d88c113ca85e86ade5a9e4::cnsnft4435 {
    struct CNSNFT4435 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4435, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4435>(arg0, arg1);
