module 0x2956f60ebae548db1e46d1689b9cb30757abe3c591a999b7b19488c0855b72e0::cnsnft9597 {
    struct CNSNFT9597 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9597, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3208"));
        let v4 = 0x2::package::claim<CNSNFT9597>(arg0, arg1);
