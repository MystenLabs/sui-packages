module 0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::rewards {
    ...
    public fun add_reward_token<T0, T1, T2: store, T3>(arg0: &mut RewardsManager, arg1: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::GlobalConfig, arg2: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::check_package_version(arg1);
        0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::check_reward_manager_role(arg1, 0x2::tx_context::sender(arg4));
        let v0 = 0x2::object::id<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>>(arg2);
        ...
        if (!0x2::bag::contains<0x1::type_name::TypeName>(&v1.reward_vault, v2)) {
            0x2::bag::add<0x1::type_name::TypeName, 0x2::balance::Balance<T3>>(&mut v1.reward_vault, v2, 0x2::balance::zero<T3>());
        };
    ...
    public fun claim<T0, T1, T2: store, T3>(arg0: &mut RewardsManager, arg1: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::GlobalConfig, arg2: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T3> {
        0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::check_package_version(arg1);
        let v0 = 0x2::object::id<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>>(arg2);
        assert!(0x2::linked_table::contains<0x2::object::ID, PoolRewards>(&arg0.pools, v0), 0);
        let v1 = 0x2::linked_table::borrow_mut<0x2::object::ID, PoolRewards>(&mut arg0.pools, v0);
        update_all_rewards(v1, arg3);
        settle_user_one<T3>(v1, 0x2::tx_context::sender(arg4));
        let v2 = 0x1::type_name::with_defining_ids<T3>();
        ...
        let v6 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T3>>(&mut v1.reward_vault, v2);
        ...
        let v9 = 0x2::coin::from_balance<T3>(0x2::balance::split<T3>(v6, v8), arg4);
    ...
    fun ensure_lp_vault_and_join<T0, T1>(arg0: &mut 0x2::bag::Bag, arg1: 0x2::balance::Balance<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>) {
        let v0 = 0x1::type_name::with_defining_ids<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>();
        if (!0x2::bag::contains<0x1::type_name::TypeName>(arg0, v0)) {
            0x2::bag::add<0x1::type_name::TypeName, 0x2::balance::Balance<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>>(arg0, v0, 0x2::balance::zero<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>());
        };
        0x2::balance::join<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>>(arg0, v0), arg1);
    }
    ...
    public fun fund<T0, T1, T2: store, T3>(arg0: &mut RewardsManager, arg1: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::GlobalConfig, arg2: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>, arg3: 0x2::coin::Coin<T3>, arg4: &mut 0x2::tx_context::TxContext) {
        0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::check_package_version(arg1);
        assert!(0x2::coin::value<T3>(&arg3) > 0, 2);
        let v0 = 0x2::object::id<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>>(arg2);
        assert!(0x2::linked_table::contains<0x2::object::ID, PoolRewards>(&arg0.pools, v0), 0);
        let v1 = 0x2::linked_table::borrow_mut<0x2::object::ID, PoolRewards>(&mut arg0.pools, v0);
        let v2 = 0x1::type_name::with_defining_ids<T3>();
        ...
        let v3 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T3>>(&mut v1.reward_vault, v2);
        0x2::balance::join<T3>(v3, 0x2::coin::into_balance<T3>(arg3));
        let v4 = FundEvent{
            reward_type   : v2,
            amount        : 0x2::coin::value<T3>(&arg3),
            vault_balance : 0x2::balance::value<T3>(v3),
        };
    ...
    public fun is_pool_registered<T0, T1, T2: store>(arg0: &RewardsManager, arg1: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>) : bool {
        0x2::linked_table::contains<0x2::object::ID, PoolRewards>(&arg0.pools, 0x2::object::id<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>>(arg1))
    }

    public fun register_pool<T0, T1, T2: store>(arg0: &mut RewardsManager, arg1: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::GlobalConfig, arg2: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>, arg3: &mut 0x2::tx_context::TxContext) {
        0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::check_package_version(arg1);
        0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::check_reward_manager_role(arg1, 0x2::tx_context::sender(arg3));
        let v0 = 0x2::object::id<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>>(arg2);
    ...
    public fun schedule_reward<T0, T1, T2: store, T3>(arg0: &mut RewardsManager, arg1: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::GlobalConfig, arg2: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::check_package_version(arg1);
        0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::check_reward_manager_role(arg1, 0x2::tx_context::sender(arg7));
        ...
        let v3 = (0x2::balance::value<T3>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T3>>(&mut v1.reward_vault, v2)) as u128);
    ...
    fun settle_user_one_impl(arg0: &0x2::vec_map::VecMap<0x1::type_name::TypeName, RewardState>, arg1: &mut Staker, arg2: u64, arg3: 0x1::type_name::TypeName) {
        ...
        if (v0 > v3 && arg2 > 0) {
            v2.rewards = v2.rewards + (0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::math128::mul_div_down((arg2 as u128), v0 - v3, 1000000) as u64);
        };
        v2.reward_per_lp_paid = v0;
    }

    public fun stake<T0, T1, T2: store>(arg0: &mut RewardsManager, arg1: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::GlobalConfig, arg2: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>, arg3: &mut 0x2::coin::Coin<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::check_package_version(arg1);
        assert!(arg4 > 0 && 0x2::coin::value<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>(arg3) >= arg4, 2);
        let v0 = 0x2::object::id<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>>(arg2);
        assert!(0x2::linked_table::contains<0x2::object::ID, PoolRewards>(&arg0.pools, v0), 0);
        let v1 = 0x2::linked_table::borrow_mut<0x2::object::ID, PoolRewards>(&mut arg0.pools, v0);
        ...
        ensure_lp_vault_and_join<T0, T1>(v3, 0x2::coin::into_balance<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>(0x2::coin::split<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>(arg3, arg4, arg6)));
    ...
    public fun unstake<T0, T1, T2: store>(arg0: &mut RewardsManager, arg1: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::GlobalConfig, arg2: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>> {
        0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::check_package_version(arg1);
        assert!(arg3 > 0, 2);
        let v0 = 0x2::object::id<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>>(arg2);
        assert!(0x2::linked_table::contains<0x2::object::ID, PoolRewards>(&arg0.pools, v0), 0);
        ...
        0x2::coin::from_balance<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>(0x2::balance::split<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>>(&mut v1.lp_vault, 0x1::type_name::with_defining_ids<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::LpToken<T0, T1>>()), arg3), arg5)
    }
    ...
    fun update_all_rewards(arg0: &mut PoolRewards, arg1: &0x2::clock::Clock) {
        ...
        while (v2 < 0x1::vector::length<0x1::type_name::TypeName>(&arg0.reward_types)) {
            ...
            if (v6 > v5 && v4.emission_per_sec > 0) {
                ...
                if (v1 > 0) {
                    v4.reward_per_lp = v4.reward_per_lp + 0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::math128::mul_div_down(v7, 1000000, (v1 as u128));
                };
            };
    ...
    public fun withdraw<T0, T1, T2: store, T3>(arg0: &mut RewardsManager, arg1: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::GlobalConfig, arg2: &0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T3> {
        0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::check_package_version(arg1);
        0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::global_config::check_reward_manager_role(arg1, 0x2::tx_context::sender(arg5));
        let v0 = 0x2::object::id<0x290e32ad1fc4cc653da0dc986c8db46f42667fcd66a4ff258a1a299950d38cd7::pool::Pool<T0, T1, T2>>(arg2);
        assert!(0x2::linked_table::contains<0x2::object::ID, PoolRewards>(&arg0.pools, v0), 0);
        let v1 = 0x2::linked_table::borrow_mut<0x2::object::ID, PoolRewards>(&mut arg0.pools, v0);
        let v2 = 0x1::type_name::with_defining_ids<T3>();
        ...
        let v4 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T3>>(&mut v1.reward_vault, v2);
        let v5 = (0x2::balance::value<T3>(v4) as u128);
        let v6 = if (v5 > v3) {
            v5 - v3
        } else {
            0
        ...
        0x2::coin::from_balance<T3>(0x2::balance::split<T3>(v4, arg3), arg5)
    }
