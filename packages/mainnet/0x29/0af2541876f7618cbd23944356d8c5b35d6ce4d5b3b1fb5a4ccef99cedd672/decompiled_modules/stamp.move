module 0xdde7f6b816b0a602ed57f3b5c2e264ab74726b96c4daef1ffe7f01eef25be761::stamp {
    ...
    public(friend) fun mint_and_emit(arg0: 0x2::object::ID, arg1: 0x2::vec_map::VecMap<0x1::ascii::String, u64>, arg2: &mut 0x2::tx_context::TxContext) : Stamp {
        let v0 = Stamp{
            ...
            dao_fund_id : arg0,
            image_url   : 0x2::url::new_unsafe_from_bytes(b"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8jhjLfzOaubP5IMgY_NOEGvAeWcKweura4CWUgYye8Y_7U-DWCJRd6Zn3bpfs0OyMNu8&usqp=CAU"),
            assets      : arg1,
        };
