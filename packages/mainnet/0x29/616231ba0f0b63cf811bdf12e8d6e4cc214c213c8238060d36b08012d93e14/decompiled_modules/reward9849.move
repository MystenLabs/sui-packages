module 0x29616231ba0f0b63cf811bdf12e8d6e4cc214c213c8238060d36b08012d93e14::reward9849 {
    struct REWARD9849 has drop {
        dummy_field: bool,
    }

    struct TICKET_9849 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9849(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9849>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9849>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9849, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9849>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9849>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9849>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9849>>(v5, 0x2::tx_context::sender(arg1));
    }
