module 0x29e04d6d4af4887fdf7408cd4a9d6126bb4abd315135e60e640650c355be7140::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"DRAG", b"Drogon", b"DRAG was launched by the X account.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/media/G2u8dZ9bcAAWj2P.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Drogon"),
            symbol     : 0x1::string::utf8(b"DRAG"),
            decimals   : 9,
