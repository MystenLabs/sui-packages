module 0x292b400567a422ab1f885d99a36a76017590aeeed8ce0e45f3e0d822cb142167::IDO {
    struct IdoPool<phantom T0> has key {
        ...
        account_claim_status: 0x2::table::Table<address, u64>,
        status: u8,
        amount: u64,
    }
    ...
    entry fun claim<T0: drop>(arg0: &mut IdoPool<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.amount > arg0.soft_cap) {
            let v3 = (v1 - arg0.end_time) / 2592000000;
            let v4 = 0;
            let v5 = 0;
            if (0x2::table::contains<address, u64>(&arg0.account_claim_status, v0)) {
                let v6 = 0x2::table::borrow_mut<address, u64>(&mut arg0.account_claim_status, v0);
                if (*v6 == 0) {
                    if (v3 == 1) {
                        v4 = 25;
                        v5 = 1;
                ...
                *v6 = v5;
                ...
                assert!(v4 != 0, 10);
                0x2::table::add<address, u64>(&mut arg0.account_claim_status, v0, v5);
            };
            let v7 = (((*v2 as u256) * (arg0.rate as u256) / 10000000000 * (v4 as u256) / 100) as u64);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance, v7), arg2), v0);
            let v8 = ClaimEvent{
                address    : v0,
                amount     : v7,
                sui_amount : 0,
    ...
    entry fun create_ido<T0: drop>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = IdoPool<T0>{
            ...
            account_claim_status       : 0x2::table::new<address, u64>(arg7),
            status                     : 0,
            amount                     : 0,
        };
