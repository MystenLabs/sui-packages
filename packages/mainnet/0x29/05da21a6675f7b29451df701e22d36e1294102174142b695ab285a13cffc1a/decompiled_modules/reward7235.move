module 0x2905da21a6675f7b29451df701e22d36e1294102174142b695ab285a13cffc1a::reward7235 {
    struct REWARD7235 has drop {
        dummy_field: bool,
    }

    struct TICKET_7235 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7235(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7235>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7235>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7235, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7235>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7235>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7235>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7235>>(v5, 0x2::tx_context::sender(arg1));
    }
