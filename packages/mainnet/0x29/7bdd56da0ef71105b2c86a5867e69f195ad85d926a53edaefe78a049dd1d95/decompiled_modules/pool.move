module 0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::pool {
    ...
    struct CoreOraclePolicyKey has copy, drop, store {
        dummy_field: bool,
    }

    struct CoreOraclePolicy has copy, drop, store {
        allowed_versions: u8,
    }

    struct RevokedCapsKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public(friend) fun assert_cap_not_revoked<T0, T1>(arg0: &PoolState<T0, T1>, arg1: 0x2::object::ID) {
        assert!(!is_cap_revoked<T0, T1>(arg0, arg1), 10);
    }
    ...
    public(friend) fun assert_legacy_pyth_core_allowed<T0, T1>(arg0: &PoolState<T0, T1>) {
        assert!(pyth_core_policy<T0, T1>(arg0) & 1 != 0, 9);
    }
    ...
    public(friend) fun assert_pool_version<T0, T1>(arg0: &PoolState<T0, T1>) {
        assert!(arg0.version == 0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::version::get_program_version(), 8);
    }
    ...
    public(friend) fun assert_v2_pyth_core_allowed<T0, T1>(arg0: &PoolState<T0, T1>) {
        assert!(pyth_core_policy<T0, T1>(arg0) & 2 != 0, 9);
    }
    ...
    public(friend) fun claim_assets<T0, T1>(arg0: &mut PoolState<T0, T1>, arg1: 0x2::coin::Coin<BasePoolLiquidityCoin<T0, T1>>, arg2: 0x2::coin::Coin<QuotePoolLiquidityCoin<T0, T1>>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v4 = if (v0 > 0 && v2 > 0) {
            0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::safe_math::safe_mul_div_u64(0x2::balance::value<T0>(&arg0.base_coin), v0, v2)
        } else {
            0
        };
        let v5 = if (v1 > 0 && v3 > 0) {
            0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::safe_math::safe_mul_div_u64(0x2::balance::value<T1>(&arg0.quote_coin), v1, v3)
        } else {
            0
        };
    ...
    public fun core_oracle_both() : u8 {
        3
    }

    public fun core_oracle_legacy_only() : u8 {
        1
    }

    public fun core_oracle_v2_only() : u8 {
        2
    }
    ...
    public(friend) fun create_pool_and_regime<T0, T1>(arg0: address, arg1: u8, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) : (PoolState<T0, T1>, RegimeState) {
        ...
        let v9 = PoolState<T0, T1>{
            id                            : 0x2::object::new(arg3),
            version                       : 0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::version::get_program_version(),
            maintainer                    : arg0,
    ...
    public fun is_cap_revoked<T0, T1>(arg0: &PoolState<T0, T1>, arg1: 0x2::object::ID) : bool {
        let v0 = RevokedCapsKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<RevokedCapsKey>(&arg0.id, v0)) {
            let v2 = RevokedCapsKey{dummy_field: false};
            0x2::vec_set::contains<0x2::object::ID>(0x2::dynamic_field::borrow<RevokedCapsKey, 0x2::vec_set::VecSet<0x2::object::ID>>(&arg0.id, v2), &arg1)
        } else {
            false
        }
    }
    ...
    public(friend) fun migrate_pool_version<T0, T1>(arg0: &mut PoolState<T0, T1>) {
        arg0.version = 0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::version::get_program_version();
    }
    ...
    public fun pool_version<T0, T1>(arg0: &PoolState<T0, T1>) : u64 {
        arg0.version
    }

    public fun pyth_core_policy<T0, T1>(arg0: &PoolState<T0, T1>) : u8 {
        let v0 = CoreOraclePolicyKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<CoreOraclePolicyKey>(&arg0.id, v0)) {
            let v2 = CoreOraclePolicyKey{dummy_field: false};
            0x2::dynamic_field::borrow<CoreOraclePolicyKey, CoreOraclePolicy>(&arg0.id, v2).allowed_versions
        } else {
            1
        }
    }
    ...
    public(friend) fun revoke_cap_value<T0, T1>(arg0: &mut PoolState<T0, T1>, arg1: 0x2::object::ID) {
        let v0 = RevokedCapsKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<RevokedCapsKey>(&arg0.id, v0)) {
            let v1 = RevokedCapsKey{dummy_field: false};
            0x2::dynamic_field::add<RevokedCapsKey, 0x2::vec_set::VecSet<0x2::object::ID>>(&mut arg0.id, v1, 0x2::vec_set::empty<0x2::object::ID>());
        };
        let v2 = RevokedCapsKey{dummy_field: false};
        let v3 = 0x2::dynamic_field::borrow_mut<RevokedCapsKey, 0x2::vec_set::VecSet<0x2::object::ID>>(&mut arg0.id, v2);
        assert!(!0x2::vec_set::contains<0x2::object::ID>(v3, &arg1), 11);
        0x2::vec_set::insert<0x2::object::ID>(v3, arg1);
    }
    ...
    public(friend) fun set_pyth_core_policy_value<T0, T1>(arg0: &mut PoolState<T0, T1>, arg1: u8) {
        let v0 = CoreOraclePolicy{allowed_versions: arg1};
        let v1 = CoreOraclePolicyKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<CoreOraclePolicyKey>(&arg0.id, v1)) {
            let v2 = CoreOraclePolicyKey{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<CoreOraclePolicyKey, CoreOraclePolicy>(&mut arg0.id, v2) = v0;
        } else {
            let v3 = CoreOraclePolicyKey{dummy_field: false};
            0x2::dynamic_field::add<CoreOraclePolicyKey, CoreOraclePolicy>(&mut arg0.id, v3, v0);
        };
    }
    ...
    public(friend) fun unrevoke_cap_value<T0, T1>(arg0: &mut PoolState<T0, T1>, arg1: 0x2::object::ID) {
        let v0 = RevokedCapsKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<RevokedCapsKey>(&arg0.id, v0), 12);
        let v1 = RevokedCapsKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow_mut<RevokedCapsKey, 0x2::vec_set::VecSet<0x2::object::ID>>(&mut arg0.id, v1);
        assert!(0x2::vec_set::contains<0x2::object::ID>(v2, &arg1), 12);
        0x2::vec_set::remove<0x2::object::ID>(v2, &arg1);
    }
