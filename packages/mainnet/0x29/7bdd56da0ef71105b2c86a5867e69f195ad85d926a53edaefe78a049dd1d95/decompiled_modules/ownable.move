module 0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::ownable {
    ...
    struct ParamCap<phantom T0, phantom T1> has store, key {
        id: 0x2::object::UID,
        version: u64,
        pool_id: 0x2::object::ID,
    }
    ...
    public fun assert_liquidity_operator_cap_matches<T0, T1>(arg0: &LiquidityOperatorCap<T0, T1>, arg1: 0x2::object::ID) {
        assert!(arg0.version == 0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::version::get_program_version(), 1);
        assert!(arg0.pool_id == arg1, 2);
    }

    public fun assert_param_cap_matches<T0, T1>(arg0: &ParamCap<T0, T1>, arg1: 0x2::object::ID) {
        assert!(arg0.version == 0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::version::get_program_version(), 1);
        assert!(arg0.pool_id == arg1, 2);
    }
    ...
    public(friend) fun grant_param_cap<T0, T1>(arg0: address, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = ParamCap<T0, T1>{
            id      : 0x2::object::new(arg2),
            version : 0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::version::get_program_version(),
            pool_id : arg1,
        };
        0x2::transfer::transfer<ParamCap<T0, T1>>(v0, arg0);
    }
    ...
    public(friend) fun migrate_liquidity_operator_cap_version<T0, T1>(arg0: &mut LiquidityOperatorCap<T0, T1>, arg1: 0x2::object::ID) {
        assert!(arg0.pool_id == arg1, 2);
        arg0.version = 0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::version::get_program_version();
    }

    public(friend) fun migrate_param_cap_version<T0, T1>(arg0: &mut ParamCap<T0, T1>, arg1: 0x2::object::ID) {
        assert!(arg0.pool_id == arg1, 2);
        arg0.version = 0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::version::get_program_version();
    }

    public(friend) fun migrate_pool_admin_cap_version<T0, T1>(arg0: &mut PoolAdminCap<T0, T1>, arg1: 0x2::object::ID) {
        assert!(arg0.pool_id == arg1, 2);
        arg0.version = 0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::version::get_program_version();
    }

    public(friend) fun migrate_pusher_cap_version<T0, T1>(arg0: &mut PusherCap<T0, T1>, arg1: 0x2::object::ID) {
        assert!(arg0.pool_id == arg1, 2);
        arg0.version = 0x297bdd56da0ef71105b2c86a5867e69f195ad85d926a53edaefe78a049dd1d95::version::get_program_version();
    }
    ...
    public fun param_cap_pool_id<T0, T1>(arg0: &ParamCap<T0, T1>) : 0x2::object::ID {
        arg0.pool_id
    }
