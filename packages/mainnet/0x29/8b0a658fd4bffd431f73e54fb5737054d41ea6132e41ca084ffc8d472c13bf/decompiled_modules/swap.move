module 0x298b0a658fd4bffd431f73e54fb5737054d41ea6132e41ca084ffc8d472c13bf::swap {
    ...
    entry fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<LSP<T0, T1>>>(0x2::coin::from_balance<LSP<T0, T1>>(0x2::balance::increase_supply<LSP<T0, T1>>(&mut arg0.lsp_supply, 0x1::u64::min(0x2::balance::value<T0>(&v3) * v2 / v0, 0x2::balance::value<T1>(&v4) * v2 / v1)), arg3), 0x2::tx_context::sender(arg3));
    }
    ...
    entry fun create_pool<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<LSP<T0, T1>>>(0x2::coin::from_balance<LSP<T0, T1>>(0x2::balance::increase_supply<LSP<T0, T1>>(&mut v3, 0x1::u64::sqrt(v0) * 0x1::u64::sqrt(v1)), arg2), 0x2::tx_context::sender(arg2));
    }
