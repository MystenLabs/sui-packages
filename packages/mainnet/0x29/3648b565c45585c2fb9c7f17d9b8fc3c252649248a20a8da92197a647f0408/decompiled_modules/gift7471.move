module 0x293648b565c45585c2fb9c7f17d9b8fc3c252649248a20a8da92197a647f0408::gift7471 {
    struct GIFT7471 has drop {
        dummy_field: bool,
    }

    struct TICKET_7471 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift7471(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7471>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7471>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT7471, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT7471>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7471>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7471>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7471>>(v5, 0x2::tx_context::sender(arg1));
    }
