module 0x862810efecf0296db2e9df3e075a7af8034ba374e73ff1098e88cc4bb7c15437::doubleup_citizens {
    ...
    struct DoubleUpCitizens has drop {
        dummy_field: bool,
    }
    ...
    struct CitizensToXUP has store, key {
        id: 0x2::object::UID,
        citizens: 0x2::table::Table<0x2::object::ID, bool>,
    }
    ...
    public fun admin_mint_revealed_citizen(arg0: &mut CitizensRegistry, arg1: &0x862810efecf0296db2e9df3e075a7af8034ba374e73ff1098e88cc4bb7c15437::admin::CitizenCap, arg2: Attributes, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) : DoubleUpCitizen {
        ...
        let v2 = MintEvent{
            ...
            minted_by      : 0x2::tx_context::sender(arg5),
        };
    ...
    public fun admin_new_citizens_to_xup(arg0: &0x862810efecf0296db2e9df3e075a7af8034ba374e73ff1098e88cc4bb7c15437::admin::CitizenCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = CitizensToXUP{
            id       : 0x2::object::new(arg1),
            citizens : 0x2::table::new<0x2::object::ID, bool>(arg1),
        };
        0x2::transfer::public_share_object<CitizensToXUP>(v0);
    }
    ...
    public fun check_citizen_redeemed(arg0: 0x2::object::ID, arg1: &mut CitizensToXUP) : bool {
        0x2::table::contains<0x2::object::ID, bool>(&arg1.citizens, arg0)
    }
    ...
    fun get_citizen_allocation(arg0: u64) : u64 {
        if (arg0 > 0 && arg0 <= 50) {
            4500 * 6
        } else if (arg0 > 50 && arg0 <= 200) {
            2200 * 6
        } else if (arg0 > 200 && arg0 <= 800) {
            880 * 6
        } else {
            440 * 6
        }
    ...
    public fun redeem_citizen(arg0: &DoubleUpCitizen, arg1: &mut CitizensToXUP, arg2: &mut 0xd81afdfa708a23c8f089aae1a0d2c2276942813132e120ca09463ce15eabb5a1::up::UpAdmin, arg3: &mut 0xd81afdfa708a23c8f089aae1a0d2c2276942813132e120ca09463ce15eabb5a1::x_up::UPTreasury, arg4: &mut 0x2::tx_context::TxContext) {
        abort 0
    }

    public fun redeem_citizen_2(arg0: &DoubleUpCitizen, arg1: &mut CitizensToXUP, arg2: &mut 0x87dfe1248a1dc4ce473bd9cb2937d66cdc6c30fee63f3fe0dbb55c7a09d35dec::up::UpAdmin, arg3: &mut 0x87dfe1248a1dc4ce473bd9cb2937d66cdc6c30fee63f3fe0dbb55c7a09d35dec::x_up::UPTreasury, arg4: &mut 0x2::tx_context::TxContext) {
        if (arg0.number == 0) {
            abort 0
        };
        let v0 = 0x2::object::id<DoubleUpCitizen>(arg0);
        if (0x2::table::contains<0x2::object::ID, bool>(&arg1.citizens, v0)) {
            abort 1
        };
        0x2::table::add<0x2::object::ID, bool>(&mut arg1.citizens, v0, true);
        let v1 = DoubleUpCitizens{dummy_field: false};
        0x87dfe1248a1dc4ce473bd9cb2937d66cdc6c30fee63f3fe0dbb55c7a09d35dec::x_up::new_external<DoubleUpCitizens>(arg3, arg2, v1, 1747699200000, 10368000000, get_citizen_allocation(arg0.number), 0x2::tx_context::sender(arg4), arg4);
    }

    public fun redeem_citizen_with_xup(arg0: &DoubleUpCitizen, arg1: &mut CitizensToXUP, arg2: &mut 0xd81afdfa708a23c8f089aae1a0d2c2276942813132e120ca09463ce15eabb5a1::x_up::XUP, arg3: &mut 0xd81afdfa708a23c8f089aae1a0d2c2276942813132e120ca09463ce15eabb5a1::up::UpAdmin, arg4: &mut 0xd81afdfa708a23c8f089aae1a0d2c2276942813132e120ca09463ce15eabb5a1::x_up::UPTreasury) {
        abort 0
    }

    public fun redeem_citizen_with_xup_2(arg0: &DoubleUpCitizen, arg1: &mut CitizensToXUP, arg2: &mut 0x87dfe1248a1dc4ce473bd9cb2937d66cdc6c30fee63f3fe0dbb55c7a09d35dec::x_up::XUP, arg3: &mut 0x87dfe1248a1dc4ce473bd9cb2937d66cdc6c30fee63f3fe0dbb55c7a09d35dec::up::UpAdmin, arg4: &mut 0x87dfe1248a1dc4ce473bd9cb2937d66cdc6c30fee63f3fe0dbb55c7a09d35dec::x_up::UPTreasury) {
        if (arg0.number == 0) {
            abort 0
        };
        let v0 = 0x2::object::id<DoubleUpCitizen>(arg0);
        ...
        0x2::table::add<0x2::object::ID, bool>(&mut arg1.citizens, v0, true);
        let v1 = DoubleUpCitizens{dummy_field: false};
        0x87dfe1248a1dc4ce473bd9cb2937d66cdc6c30fee63f3fe0dbb55c7a09d35dec::x_up::set_amount_external<DoubleUpCitizens>(arg4, arg3, v1, arg2, 0x87dfe1248a1dc4ce473bd9cb2937d66cdc6c30fee63f3fe0dbb55c7a09d35dec::x_up::amount(arg2) + get_citizen_allocation(arg0.number));
    }
