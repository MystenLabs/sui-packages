module 0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::walstaking {
    struct Staking has key {
        id: 0x2::object::UID,
        version: u64,
        config: 0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::config::StakingConfig,
        wal_vault: 0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::vault::Vault<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>,
        protocol_wal_vault: 0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::vault::Vault<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>,
        hawal_treasury_cap: 0x2::coin::TreasuryCap<0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::hawal::HAWAL>,
        total_staked: u64,
        total_unstaked: u64,
        total_rewards: u64,
    ...
    public(friend) fun claim_collect_rewards_fee(arg0: &0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::system::System, arg1: &mut 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staking::Staking, arg2: &mut Staking, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::vault::withdraw_max<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>(&mut arg2.protocol_wal_vault, arg2.collected_protocol_fees_pending);
        let v2 = v0;
        let v3 = withdraw_wal_bal(arg0, arg1, arg2, v1, arg4);
        0x2::balance::join<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>(&mut v2, v3);
        arg2.collected_protocol_fees = arg2.collected_protocol_fees + arg2.collected_protocol_fees_pending;
        arg2.uncollected_protocol_fees = arg2.uncollected_protocol_fees - arg2.collected_protocol_fees_pending;
        arg2.collected_protocol_fees_pending = 0;
    ...
    fun do_validator_request_withdraw(arg0: &mut Staking, arg1: &mut 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staking::Staking, arg2: 0x2::object::ID, arg3: u64, arg4: u32, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        while (arg3 > 0 && v3 < 0x1::vector::length<u32>(&v2)) {
            ...
            if (v4 <= arg4) {
                ...
                let v12 = 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staked_wal::withdraw_epoch(&v11);
                let v13 = calculate_staked_wal_rewards(arg1, &v11, v12);
                if (0x2::vec_map::contains<u32, 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staked_wal::StakedWal>(&v1.withdrawing, &v12)) {
                    0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staked_wal::join(0x2::vec_map::get_mut<u32, 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staked_wal::StakedWal>(&mut v1.withdrawing, &v12), v11);
                } else {
                    0x2::vec_map::insert<u32, 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staked_wal::StakedWal>(&mut v1.withdrawing, v12, v11);
                };
                let v14 = v0 + v7;
                v0 = v14 + v13;
                if (v7 + v13 <= arg3) {
        ...
        if (arg3 != arg3) {
            let v16 = PoolSystemUnstaked{
                validator  : arg2,
                epoch      : arg4,
                wal_amount : v0,
            };
            0x2::event::emit<PoolSystemUnstaked>(v16);
        };
        arg3
    }
    ...
    public fun get_config_mut(arg0: &mut Staking) : &mut 0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::config::StakingConfig {
        assert_version(arg0);
        &mut arg0.config
    }
    ...
    fun get_epoch_time_info(arg0: &mut Staking, arg1: u32) : (u64, u64, u64, u64) {
        ...
        let v1 = 0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::config::get_walrus_start_epoch(v0);
        let v2 = 0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::config::get_walrus_start_timestamp_ms(v0);
        let v3 = 0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::config::get_walrus_epoch_duration(v0);
        assert!(v2 > 0 && v3 > 0, 9);
        assert!(arg1 >= v1, 9);
    ...
    public fun get_protocol_wal_vault_amount(arg0: &Staking) : u64 {
        0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::vault::vault_amount<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>(&arg0.protocol_wal_vault)
    }
    ...
    public fun get_staked_pools(arg0: &mut Staking, arg1: 0x2::object::ID) : &mut PoolInfo {
        assert!(0x2::table::contains<0x2::object::ID, PoolInfo>(&arg0.pools, arg1), 9223376409131483135);
    ...
    public fun get_wal_vault_amount(arg0: &Staking) : u64 {
        0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::vault::vault_amount<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>(&arg0.wal_vault)
    }
    ...
    public(friend) fun initialize(arg0: 0x2::coin::TreasuryCap<0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::hawal::HAWAL>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Staking{
            id                              : 0x2::object::new(arg1),
            version                         : 0,
            config                          : 0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::config::new(0, 1000000, 0, 900000, 72000000, 10, 0, 1735664760000, 172800000),
            wal_vault                       : 0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::vault::new<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>(arg1),
            protocol_wal_vault              : 0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::vault::new<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>(arg1),
    ...
    public(friend) fun request_collect_rewards_fee(arg0: &0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::system::System, arg1: &mut 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staking::Staking, arg2: &mut Staking, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::system::epoch(arg0);
        let v1 = arg2.uncollected_protocol_fees;
        assert!(arg2.collected_protocol_fees_pending == 0, 9223375760591421439);
        let v2 = arg2.validators;
        let v3 = 0;
        while (v3 < 0x1::vector::length<0x2::object::ID>(&v2) && v1 > 0) {
            v1 = do_validator_request_withdraw(arg2, arg1, *0x1::vector::borrow<0x2::object::ID>(&v2, v3), v1, v0 + 2, arg3);
            v3 = v3 + 1;
        };
        assert!(v1 == 0, 9);
        arg2.collected_protocol_fees_pending = arg2.uncollected_protocol_fees;
        let v4 = RequestRewardsFeeCollected{
            owner      : 0x2::tx_context::sender(arg3),
            epoch      : v0,
            wal_amount : arg2.collected_protocol_fees_pending,
        };
        0x2::event::emit<RequestRewardsFeeCollected>(v4);
    }

    public fun request_stake_coin(arg0: &mut 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staking::Staking, arg1: &mut Staking, arg2: 0x2::coin::Coin<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::hawal::HAWAL> {
        assert_version(arg1);
        ...
        let v3 = 0x2::coin::mint<0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::hawal::HAWAL>(&mut arg1.hawal_treasury_cap, v1, arg4);
        if (arg3 != 0x2::object::id_from_address(@0x0) && 0x1::vector::contains<0x2::object::ID>(&arg1.active_validators, &arg3)) {
        ...
        arg1.hawal_supply = 0x2::coin::total_supply<0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::hawal::HAWAL>(&arg1.hawal_treasury_cap);
        let v5 = UserStaked{
            owner        : v2,
            wal_amount   : v0,
            hawal_amount : v1,
    ...
    public fun request_withdraw_stake(arg0: &mut 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::system::System, arg1: &mut 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staking::Staking, arg2: &mut Staking, arg3: &0x2::clock::Clock, arg4: 0x2::coin::Coin<0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::hawal::HAWAL>, arg5: &mut 0x2::tx_context::TxContext) {
        assert_version(arg2);
        assert!(!arg2.pause_unstake, 8);
        let v0 = 0x2::coin::value<0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::hawal::HAWAL>(&arg4);
        assert!(v0 > 0, 6);
        ...
        0x2::coin::burn<0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::hawal::HAWAL>(&mut arg2.hawal_treasury_cap, arg4);
        ...
        arg2.hawal_supply = 0x2::coin::total_supply<0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::hawal::HAWAL>(&arg2.hawal_treasury_cap);
        ...
        while (v17 < 0x1::vector::length<0x2::object::ID>(&v15) && v16 > 0) {
            v16 = do_validator_request_withdraw(arg2, arg1, *0x1::vector::borrow<0x2::object::ID>(&v15, v17), v16, v2, arg5);
            v17 = v17 + 1;
        };
        assert!(v16 == 0, 9);
    }
    ...
    public(friend) fun update_validator_rewards(arg0: &mut Staking, arg1: &0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::system::System, arg2: &0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staking::Staking, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = (((v1 as u128) * (0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::config::get_reward_fee(&arg0.config) as u128) / (10000000 as u128)) as u64);
    ...
    fun withdraw_wal_bal(arg0: &0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::system::System, arg1: &mut 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staking::Staking, arg2: &mut Staking, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL> {
        let (v0, v1) = 0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::vault::withdraw_max<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>(&mut arg2.wal_vault, arg3);
        let v2 = v0;
        arg3 = v1;
        if (v1 > 0) {
            ...
            0x297bc228c226306806757c5b5a52948929c9b0d3b0e069542b51edfd7ec7e54b::vault::deposit<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>(&mut arg2.wal_vault, v3);
        };
        v2
    }
