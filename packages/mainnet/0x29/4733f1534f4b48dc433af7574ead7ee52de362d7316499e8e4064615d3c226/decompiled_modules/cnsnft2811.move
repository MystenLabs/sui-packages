module 0x294733f1534f4b48dc433af7574ead7ee52de362d7316499e8e4064615d3c226::cnsnft2811 {
    struct CNSNFT2811 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2811, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2811>(arg0, arg1);
