module 0x298f5718a2fa7460af5fb1a0c1b742dd5b6fa4b8825a631370b946d92399f327::llv_admin {
    ...
    public(friend) fun accept_owner(arg0: &mut LLVGlobal, arg1: &0x2::tx_context::TxContext) {
        ...
        arg0.owner = v0;
        0x298f5718a2fa7460af5fb1a0c1b742dd5b6fa4b8825a631370b946d92399f327::llv_events::emit_owner_changed(arg0.owner, v0);
    }
    ...
    public(friend) fun migrate(arg0: &mut LLVGlobal, arg1: &0x2::tx_context::TxContext) {
        ...
        arg0.version = 2;
        0x298f5718a2fa7460af5fb1a0c1b742dd5b6fa4b8825a631370b946d92399f327::llv_events::emit_global_migrated(arg0.version, 2);
    }
    ...
    public(friend) fun set_global_paused(arg0: &mut LLVGlobal, arg1: bool, arg2: &0x2::tx_context::TxContext) {
        ...
        arg0.paused = arg1;
        0x298f5718a2fa7460af5fb1a0c1b742dd5b6fa4b8825a631370b946d92399f327::llv_events::emit_global_paused(arg1);
    }
    ...
    public(friend) fun set_owner(arg0: &mut LLVGlobal, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        0x298f5718a2fa7460af5fb1a0c1b742dd5b6fa4b8825a631370b946d92399f327::llv_events::emit_pending_owner_set(arg0.owner, arg1);
    }
