module 0xc74a7df07b4089d92f196d1db73ce0574db7f58ae0ba2b19b2a59d402958d394::vault {
    ...
    public fun auto_swap_deposit_to_owner<T0>(arg0: &mut TaliseVault, arg1: 0x2::balance::Balance<T0>, arg2: SwapTicket, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == 0x2::object::id<TaliseVault>(arg0), 204);
        let v3 = 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()));
        if (0x2::bag::contains<vector<u8>>(&arg0.balances, v3)) {
            0x2::balance::join<T0>(&mut arg1, 0x2::bag::remove<vector<u8>, 0x2::balance::Balance<T0>>(&mut arg0.balances, v3));
        };
        ...
        arg0.auto_swaps_total = arg0.auto_swaps_total + 1;
        let v4 = VaultAutoSwap{
            vault_id    : 0x2::object::id<TaliseVault>(arg0),
            from_type   : v1,
            to_type     : 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())),
            from_amount : v2,
            to_amount   : 0x2::balance::value<T0>(&arg1),
            ts_ms       : 0x2::clock::timestamp_ms(arg3),
        };
        0x2::event::emit<VaultAutoSwap>(v4);
    }
    ...
    public entry fun share_existing_cap<T0>(arg0: 0xc74a7df07b4089d92f196d1db73ce0574db7f58ae0ba2b19b2a59d402958d394::auto_swap::AutoSwapCap<T0>, arg1: &0x2::tx_context::TxContext) {
