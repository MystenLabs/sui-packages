module 0x29a7f9e8e451549f415dfece0e19cb0b063f8ccb4b0decf760463e2f6760758a::deepbook {
    ...
    public fun swap_a2b<T0, T1>(arg0: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &0xdee9::custodian_v2::AccountCap, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let (v1, v2, _) = 0xdee9::clob_v2::swap_exact_base_for_quote<T0, T1>(arg0, 0, arg4, v0, 0x2::coin::split<T0>(&mut arg2, v0, arg6), arg3, arg5, arg6);
        let v4 = v2;
        let v5 = v1;
        let v6 = Swap{
