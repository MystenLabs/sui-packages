module 0x29f2fe3ad565b0573618af965e1b7d0d43b5581e16f03ca5858b1e8232a76923::flipcoin {
    ...
    public entry fun add_first_liquidity(arg0: &mut FlipCoin, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x2b1500ea64ee033cc2ecbc90ac2b1665727088c929d4715a930fe1a398a3cf99, 0);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = FlipCoin{
            ...
            admin_address : @0x2b1500ea64ee033cc2ecbc90ac2b1665727088c929d4715a930fe1a398a3cf99,
            fee           : 5,
        };
