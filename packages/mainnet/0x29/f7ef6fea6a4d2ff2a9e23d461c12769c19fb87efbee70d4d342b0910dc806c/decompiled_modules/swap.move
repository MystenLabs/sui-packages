module 0x47989e1f044f37b797ed052aba94874872b5dfd2d0d2afb1278f967d0d895867::swap {
    ...
    public fun swap_for_base_asset_by_cetus<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: 0x47989e1f044f37b797ed052aba94874872b5dfd2d0d2afb1278f967d0d895867::cross::NormalizedSwapData, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, u64) {
        ...
        assert!(v16 >= (((v15 as u256) * (100000000 as u256) / (v7 as u256) * (v1 as u256) / (100000000 as u256)) as u64), 5);
    ...
    public fun swap_for_base_asset_by_deepbook<T0, T1>(arg0: &mut 0xdee9::clob::Pool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: 0x47989e1f044f37b797ed052aba94874872b5dfd2d0d2afb1278f967d0d895867::cross::NormalizedSwapData, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, u64) {
        ...
        let v11 = v9;
        assert!(v10 >= ((((v7 - 0x2::coin::value<T1>(&v11)) as u256) * (100000000 as u256) / (v7 as u256) * (v1 as u256) / (100000000 as u256)) as u64), 5);
        (v8, v11, v10)
    }

    public fun swap_for_base_asset_by_deepbook_v2<T0, T1>(arg0: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &0xdee9::custodian_v2::AccountCap, arg3: u64, arg4: 0x47989e1f044f37b797ed052aba94874872b5dfd2d0d2afb1278f967d0d895867::cross::NormalizedSwapData, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, u64) {
        assert!(right_type<T1>(0x47989e1f044f37b797ed052aba94874872b5dfd2d0d2afb1278f967d0d895867::cross::swap_sending_asset_id(arg4)), 2);
        assert!(right_type<T0>(0x47989e1f044f37b797ed052aba94874872b5dfd2d0d2afb1278f967d0d895867::cross::swap_receiving_asset_id(arg4)), 2);
        let v0 = 0x47989e1f044f37b797ed052aba94874872b5dfd2d0d2afb1278f967d0d895867::cross::swap_call_data(arg4);
        let v1 = 0;
        let v2 = 44;
        let (v3, v4) = 0x1::vector::index_of<u8>(&v0, &v2);
        let v5 = if (v3) {
        ...
        assert!(v5 == b"DeepBookV2", 1);
        let v7 = 0x2::coin::value<T1>(&arg1);
        let (v8, v9, v10) = 0xdee9::clob_v2::swap_exact_quote_for_base<T0, T1>(arg0, arg3, arg2, v7, arg5, arg1, arg6);
        let v11 = v9;
        assert!(v10 >= ((((v7 - 0x2::coin::value<T1>(&v11)) as u256) * (100000000 as u256) / (v7 as u256) * (v1 as u256) / (100000000 as u256)) as u64), 5);
        (v8, v11, v10)
    }
    ...
    public fun swap_for_quote_asset_by_deepbook<T0, T1>(arg0: &mut 0xdee9::clob::Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x47989e1f044f37b797ed052aba94874872b5dfd2d0d2afb1278f967d0d895867::cross::NormalizedSwapData, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, u64) {
        ...
        let v11 = v8;
        assert!(v10 >= ((((v7 - 0x2::coin::value<T0>(&v11)) as u256) * (100000000 as u256) / (v7 as u256) * (v1 as u256) / (100000000 as u256)) as u64), 5);
        (v11, v9, v10)
    }

    public fun swap_for_quote_asset_by_deepbook_v2<T0, T1>(arg0: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0xdee9::custodian_v2::AccountCap, arg3: u64, arg4: 0x47989e1f044f37b797ed052aba94874872b5dfd2d0d2afb1278f967d0d895867::cross::NormalizedSwapData, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, u64) {
        assert!(right_type<T0>(0x47989e1f044f37b797ed052aba94874872b5dfd2d0d2afb1278f967d0d895867::cross::swap_sending_asset_id(arg4)), 2);
        assert!(right_type<T1>(0x47989e1f044f37b797ed052aba94874872b5dfd2d0d2afb1278f967d0d895867::cross::swap_receiving_asset_id(arg4)), 2);
        let v0 = 0x47989e1f044f37b797ed052aba94874872b5dfd2d0d2afb1278f967d0d895867::cross::swap_call_data(arg4);
        let v1 = 0;
        let v2 = 44;
        let (v3, v4) = 0x1::vector::index_of<u8>(&v0, &v2);
        ...
        assert!(v5 == b"DeepBookV2", 1);
        let v7 = 0x2::coin::value<T0>(&arg1);
        let (v8, v9, v10) = 0xdee9::clob_v2::swap_exact_base_for_quote<T0, T1>(arg0, arg3, arg2, v7, arg1, 0x2::coin::zero<T1>(arg6), arg5, arg6);
        let v11 = v8;
        assert!(v10 >= ((((v7 - 0x2::coin::value<T0>(&v11)) as u256) * (100000000 as u256) / (v7 as u256) * (v1 as u256) / (100000000 as u256)) as u64), 5);
        (v11, v9, v10)
    }
