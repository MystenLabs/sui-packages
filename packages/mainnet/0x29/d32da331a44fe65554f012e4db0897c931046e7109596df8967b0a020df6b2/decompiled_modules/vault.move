module 0x29d32da331a44fe65554f012e4db0897c931046e7109596df8967b0a020df6b2::vault {
    ...
    public(friend) fun assert_deposits_enabled<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: u64) {
        assert!(arg0.deposits_enabled && 0x2::balance::value<T2>(&arg0.seed_vt) > 0 && arg1 < arg0.deposit_limit, 0x29d32da331a44fe65554f012e4db0897c931046e7109596df8967b0a020df6b2::error::deposits_disabled());
    }

    public(friend) fun assert_vault_cap<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &VaultCap) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1, T2>>(arg0), 0x29d32da331a44fe65554f012e4db0897c931046e7109596df8967b0a020df6b2::error::invalid_vault_cap());
    }
