module 0x292771bbebf01d55373fae54cbf58017a0b3d12f41ff2130aaf761baebbe5122::memesai {
    ...
    fun init(arg0: MEMESAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<MEMESAI>(&mut v3, 1000000000000000000, 0x2::tx_context::sender(arg1), arg1);
