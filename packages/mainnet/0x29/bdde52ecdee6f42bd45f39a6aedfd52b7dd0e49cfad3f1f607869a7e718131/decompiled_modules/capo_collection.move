module 0x29bdde52ecdee6f42bd45f39a6aedfd52b7dd0e49cfad3f1f607869a7e718131::capo_collection {
    ...
    public entry fun create_collection(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_share_object<CapoCollection>(v0);
    }

    public fun get_collection_id(arg0: &CapoCollection) : 0x2::object::ID {
