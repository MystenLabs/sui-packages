module 0xd57d3cd41944feaf45cb3f9c509fa9d1106297c3ffb178bb0b7c92d82184ffa::nft_swap {
    ...
    public entry fun accept_trade_for_collection_a<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::transfer_policy::TransferPolicy<T0>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(is_compatible_version(arg0), 13);
        accept_trade_improved<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    }

    public entry fun accept_trade_for_collection_b<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::transfer_policy::TransferPolicy<T0>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(is_compatible_version(arg0), 13);
        accept_trade_improved<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    }

    public fun accept_trade_improved<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::transfer_policy::TransferPolicy<T0>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(is_compatible_version(arg0), 13);
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, Trade>(&arg0.id, arg5), 3);
        let v0 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Trade>(&mut arg0.id, arg5);
        assert!(v0.active, 6);
        if (v0.expiration != 0 && 0x2::tx_context::epoch(arg8) > v0.expiration) {
            v0.active = false;
            abort 6
        };
        if (v0.sui_requested > 0) {
            assert!(0x2::coin::value<0x2::sui::SUI>(arg6) >= v0.sui_requested, 5);
        };
        ...
        while (v2 < 0x1::vector::length<TradeItem>(&v1)) {
            ...
            assert!(0x2::kiosk::has_item(arg3, v3.item_id), 7);
            v2 = v2 + 1;
        };
        let v4 = v0.creator;
        ...
        if (v0.partial_accept_at == 0) {
            v0.partial_accept_at = 0x2::tx_context::epoch(arg8);
        };
        let v18 = 0x2::tx_context::sender(arg8);
        let v19 = if (v5 > 0) {
            let v20 = v5 * arg0.fee_percentage / 10000;
            if (v20 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg6, v20, arg8), arg0.fee_address);
                v20
            } else {
                0
            }
        ...
        if (v5 > 0) {
            let v21 = v5 - v19;
            if (v21 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg6, v21, arg8), v4);
            };
        };
        let v22 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Trade>(&mut arg0.id, arg5);
        let v23 = if (v6 > 0) {
        ...
        while (v24 < 0x1::vector::length<0x2::object::ID>(&v10)) {
            ...
            if (*0x1::vector::borrow<0x1::string::String>(&v11, v24) == v7 && 0x2::kiosk::has_item(arg3, v25)) {
                if (0x2::kiosk::is_listed(arg3, v25)) {
                    0x2::kiosk::delist<T0>(arg3, arg4, v25);
                };
                let (v26, v27) = 0x2::kiosk::purchase_with_cap<T0>(arg3, 0x2::kiosk::list_with_purchase_cap<T0>(arg3, arg4, v25, 0, arg8), 0x2::coin::zero<0x2::sui::SUI>(arg8));
                0x2::kiosk::lock<T0>(arg1, arg2, arg7, v26);
                let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg7, v27);
            };
            v24 = v24 + 1;
        };
        let v31 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Trade>(&mut arg0.id, arg5);
        let v32 = 0;
            ...
            if (*0x1::vector::borrow<0x1::string::String>(&v9, v32) == v7 && 0x2::kiosk::has_item(arg1, v33)) {
                ...
                if (0x2::dynamic_object_field::exists_<vector<u8>>(&v31.id, v34)) {
                    if (0x2::kiosk::is_listed(arg1, v33)) {
                        0x2::kiosk::delist<T0>(arg1, arg2, v33);
                    };
                    0x2::kiosk::return_purchase_cap<T0>(arg1, 0x2::dynamic_object_field::remove<vector<u8>, 0x2::kiosk::PurchaseCap<T0>>(&mut v31.id, v34));
                    let (v35, v36) = 0x2::kiosk::purchase_with_cap<T0>(arg1, 0x2::kiosk::list_with_purchase_cap<T0>(arg1, arg2, v33, 0, arg8), 0x2::coin::zero<0x2::sui::SUI>(arg8));
                    0x2::kiosk::lock<T0>(arg3, arg4, arg7, v35);
                    let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg7, v36);
                };
            };
            v32 = v32 + 1;
        };
        ...
        let Trade {
            ...
            expiration         : _,
            partial_accept_at  : _,
        } = 0x2::dynamic_object_field::remove<0x2::object::ID, Trade>(&mut arg0.id, arg5);
        ...
        while (v38 < 0x1::vector::length<0x2::object::ID>(&v17)) {
            ...
            if (0x2::kiosk::has_item(arg1, v39)) {
                ...
                if (0x2::dynamic_object_field::exists_<vector<u8>>(&v40.id, v41)) {
                    ...
                    0x2::kiosk::lock<T0>(arg5, arg6, arg9, v42);
                ...
                if (0x2::dynamic_object_field::exists_<vector<u8>>(&v47.id, v48)) {
                    ...
                    0x2::kiosk::lock<T0>(arg5, arg6, arg9, v49);
    ...
    public entry fun execute_multi_type_trade<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::transfer_policy::TransferPolicy<T0>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(is_compatible_version(arg0), 13);
        if (!0x2::dynamic_object_field::exists_with_type<0x2::object::ID, Trade>(&arg0.id, arg5)) {
            return
        };
        0x2::dynamic_object_field::borrow<0x2::object::ID, Trade>(&arg0.id, arg5);
