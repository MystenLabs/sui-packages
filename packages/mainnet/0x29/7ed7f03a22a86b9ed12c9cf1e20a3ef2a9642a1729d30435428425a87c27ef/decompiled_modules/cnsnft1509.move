module 0x297ed7f03a22a86b9ed12c9cf1e20a3ef2a9642a1729d30435428425a87c27ef::cnsnft1509 {
    struct CNSNFT1509 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1509, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1509>(arg0, arg1);
