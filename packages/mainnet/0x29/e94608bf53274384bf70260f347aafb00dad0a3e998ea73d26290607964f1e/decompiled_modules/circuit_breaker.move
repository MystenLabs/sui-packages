module 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::circuit_breaker {
    ...
    public fun admin_activate_emergency(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &mut BreakerRegistry, arg2: vector<u8>) {
    ...
    public fun admin_deactivate_emergency(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &mut BreakerRegistry, arg2: vector<u8>, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(0x2::table::contains<vector<u8>, BreakerState>(&arg1.states, arg2), 3);
        assert!(arg3 > 0, 7);
        let v0 = 0x2::table::borrow_mut<vector<u8>, BreakerState>(&mut arg1.states, arg2);
    ...
    public fun admin_update_n_max(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &mut BreakerRegistry, arg2: vector<u8>, arg3: u64) {
        assert!(0x2::table::contains<vector<u8>, BreakerState>(&arg1.states, arg2), 3);
        assert!(arg3 > 0, 8);
    ...
    public fun register_breaker(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &mut BreakerRegistry, arg2: vector<u8>, arg3: u64, arg4: u64) {
