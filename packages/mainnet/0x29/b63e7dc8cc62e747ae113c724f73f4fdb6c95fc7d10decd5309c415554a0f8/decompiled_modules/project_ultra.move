module 0x29b63e7dc8cc62e747ae113c724f73f4fdb6c95fc7d10decd5309c415554a0f8::project_ultra {
    struct PROJECT_ULTRA has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PROJECT_ULTRA, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PROJECT_ULTRA>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Project Ultra"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Ultra NFTs are the Project Ultra collection on Sui, a community focused on helping you become a better content creator, find Web3 job opportunities, and provide rewards for the community."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeieinatx7bicantclfaimgjijzcdrezpzxjsytqmvhgthlgs5ko75u"));
