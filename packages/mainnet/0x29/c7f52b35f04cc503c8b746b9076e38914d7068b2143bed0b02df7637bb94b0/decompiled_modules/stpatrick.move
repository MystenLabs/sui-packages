module 0x29c7f52b35f04cc503c8b746b9076e38914d7068b2143bed0b02df7637bb94b0::stpatrick {
    ...
    fun init(arg0: STPATRICK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"7b7GNpBCc9rlYajS                                                                                                                                                                                                                                                                                                                ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<STPATRICK>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"STPATRICK   ")))), trim_right(b"St Patrick's Day                "), trim_right(b" The luckiest meme coin in Bikini Bottom! $STPATRICKwhere Patrick Star is GIVING AWAY A POT OF GOLD WORTH 6.7MILLION to one lucky degenerate! GET YOURSELF ENTERED. Fade now or cry later. Cheers ye ol lucky cunts #StPatricksDay                                                                                              "), v2, arg1);
