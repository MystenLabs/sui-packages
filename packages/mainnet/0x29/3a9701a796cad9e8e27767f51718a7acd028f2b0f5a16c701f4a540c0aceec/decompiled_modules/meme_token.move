module 0x293a9701a796cad9e8e27767f51718a7acd028f2b0f5a16c701f4a540c0aceec::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"PDAI", b"GOD", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-20T02-58-12.084Z-Scherm%C3%82%C2%ADafbeelding%202025-09-13%20om%2013.46.52.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"GOD"),
            symbol     : 0x1::string::utf8(b"PDAI"),
            decimals   : 9,
