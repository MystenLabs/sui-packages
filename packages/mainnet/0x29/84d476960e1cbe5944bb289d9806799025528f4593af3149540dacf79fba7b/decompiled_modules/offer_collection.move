module 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::offer_collection {
    ...
    struct AcceptOfferCollectionEventV2 has copy, drop, store {
        ...
        offerer_kiosk_id: 0x2::object::ID,
        accepter: address,
        accepter_kiosk_id: 0x2::object::ID,
        collection_type: 0x1::string::String,
        amount_per_item: u64,
        amount_recived: u64,
        quantity_offer_items: u64,
    ...
    public entry fun accept_offer_collection<T0: store + key>(arg0: &mut 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::marketplace::MarketplaceConfig, arg1: &mut 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::creator_bluemove_fee::RoyaltyCollection, arg2: &mut 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::marketplace::CreatorConfig, arg3: &mut OfferCollectionData, arg4: u64, arg5: T0, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = if (0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::creator_bluemove_fee::check_exists_royalty_collection<T0>(arg1, arg6)) {
            let (v6, v7, v8, v9) = 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::creator_bluemove_fee::caculate_royalty_collection<T0>(arg1, v4, &mut v3, arg6);
            assert!(v1 == v9, 1);
            0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::marketplace::add_creator_fee(arg2, v7, v6, arg6);
            v8
        } else {
            0
        };
        let v10 = v4 * 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::marketplace::get_market_fee(arg0, arg6) / 10000;
        0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::marketplace::add_market_fee(arg0, 0x2::coin::split<0x2::sui::SUI>(&mut v3, v10, arg6), arg6);
    ...
    public entry fun accept_offer_collection_standard<T0: store + key>(arg0: &mut 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::marketplace::MarketplaceConfig, arg1: &mut 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::marketplace::CreatorConfig, arg2: &mut OfferCollectionData, arg3: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::BpsRoyaltyStrategy<T0>, arg4: u64, arg5: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<T0>, arg6: T0, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v5 * 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::marketplace::get_market_fee(arg0, arg7) / 10000;
        ...
        0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::marketplace::add_market_fee(arg0, 0x2::coin::split<0x2::sui::SUI>(&mut v4, v6, arg7), arg7);
        if (0x1::vector::length<address>(&v3) > 0 && 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::has_domain<T0, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::creators::Creators>(arg5) && v7 > 0) {
            ...
            while (v10 < v9) {
                0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::marketplace::add_creator_fee(arg1, 0x2::coin::split<0x2::sui::SUI>(&mut v11, v7 / v9, arg7), 0x1::vector::pop_back<address>(&mut v3), arg7);
                v10 = v10 + 1;
            };
