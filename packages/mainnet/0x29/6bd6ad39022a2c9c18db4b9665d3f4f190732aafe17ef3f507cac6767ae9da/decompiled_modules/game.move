module 0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::game {
    ...
    struct GameInfo has key {
        id: 0x2::object::UID,
        version: u8,
        balance: 0x2::balance::Balance<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>,
        gas_fee: u16,
        woner: address,
        ref1: u16,
        ref2: u16,
    ...
    entry fun add_treasury_cap(arg0: &OwnerCap, arg1: &mut GameInfo, arg2: 0x2::coin::TreasuryCap<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>) {
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::TreasuryCap<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>>(&mut arg1.id, 0x1::string::utf8(b"treasury"), arg2);
    }
    ...
    public entry fun claim_status(arg0: &mut GameInfo, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x2::dynamic_object_field::exists_<address>(&arg0.id, v0), 5);
        let v1 = 0x2::dynamic_object_field::borrow<address, PlayerInfo>(&arg0.id, v0);
        assert!(0x2::clock::timestamp_ms(arg1) >= (v1.next_claim as u64), 6);
        v1.next_claim
    }
    ...
    entry fun create_user(arg0: &mut GameInfo, arg1: address, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.woner == 0x2::tx_context::sender(arg8), 4);
        ...
        send_tokens(arg0, arg1, 1000000000, arg8);
        let v3 = CreateUser{
            user_address : arg1,
            ref_address  : arg2,
        };
    ...
    public entry fun feed_ref1(arg0: &mut GameInfo, arg1: u16, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.woner == 0x2::tx_context::sender(arg2), 4);
        arg0.ref1 = arg1;
    }

    public entry fun feed_ref2(arg0: &mut GameInfo, arg1: u16, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.woner == 0x2::tx_context::sender(arg2), 4);
        arg0.ref2 = arg1;
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = GameInfo{
            ...
            version     : 1,
            balance     : 0x2::balance::zero<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>(),
            gas_fee     : 3000,
            woner       : v0,
            ref1        : 2000,
            ref2        : 500,
    ...
    entry fun remove_treasury_cap(arg0: &OwnerCap, arg1: &mut GameInfo, arg2: &0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::TreasuryCap<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>>(&mut arg1.id, 0x1::string::utf8(b"treasury")), 0x2::tx_context::sender(arg2));
    }

    fun send_tokens(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>(&arg0.balance);
        let v1 = 0;
        if (v0 >= arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>>(0x2::coin::from_balance<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>(0x2::balance::split<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>(&mut arg0.balance, arg2), arg3), arg1);
        } else if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>>(0x2::coin::from_balance<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>(0x2::balance::withdraw_all<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>(&mut arg0.balance), arg3), arg1);
            v1 = arg2 - v0;
        } else {
            v1 = arg2;
        };
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>>(0x2::coin::mint<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::TreasuryCap<0x296bd6ad39022a2c9c18db4b9665d3f4f190732aafe17ef3f507cac6767ae9da::tonminer::TONMINER>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), v1, arg3), arg1);
        };
    }
    ...
    entry fun update_map(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        assert!(arg0.version <= 1, 2);
        assert!(arg0.woner == 0x2::tx_context::sender(arg5), 4);
