module 0x2995a1fe7814ce5cb44afa5b4b00549c8c6f3b29337faed8f8f19a8edd0c58e4::factory {
    ...
    public fun create_pool<T0, T1>(arg0: &mut Factory, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2995a1fe7814ce5cb44afa5b4b00549c8c6f3b29337faed8f8f19a8edd0c58e4::lp_coin::LP<T0, T1>> {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= 8000000000, 0);
        ...
        let (v2, v3) = 0x2995a1fe7814ce5cb44afa5b4b00549c8c6f3b29337faed8f8f19a8edd0c58e4::pool::create_pool<T0, T1>(arg2, arg3, arg0.fee_collector, arg4);
        let v4 = v2;
        let v5 = 0x2::object::id_address<0x2995a1fe7814ce5cb44afa5b4b00549c8c6f3b29337faed8f8f19a8edd0c58e4::pool::Pool<T0, T1>>(&v4);
        0x2::table::add<PairKey, address>(&mut arg0.pools, v0, v5);
        0x2995a1fe7814ce5cb44afa5b4b00549c8c6f3b29337faed8f8f19a8edd0c58e4::pool::share_pool<T0, T1>(v4);
        let v6 = PoolCreated{
            pool_id  : v5,
            coin_a   : v0.coin_a,
            coin_b   : v0.coin_b,
    ...
    fun is_sorted(arg0: 0x1::type_name::TypeName, arg1: 0x1::type_name::TypeName) : bool {
        compare_vectors(0x1::ascii::as_bytes(0x1::type_name::as_string(&arg0)), 0x1::ascii::as_bytes(0x1::type_name::as_string(&arg1)))
    }
    ...
    public fun update_fee_collector(arg0: &AdminCap, arg1: &mut Factory, arg2: address) {
