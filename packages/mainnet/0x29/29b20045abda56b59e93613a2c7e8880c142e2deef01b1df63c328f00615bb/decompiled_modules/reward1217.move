module 0x2929b20045abda56b59e93613a2c7e8880c142e2deef01b1df63c328f00615bb::reward1217 {
    struct REWARD1217 has drop {
        dummy_field: bool,
    }

    struct TICKET_1217 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1217(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1217>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1217>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1217, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1217>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1217>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1217>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1217>>(v5, 0x2::tx_context::sender(arg1));
    }
