module 0x29f32b823606a9a19dc37b3bbc77e82a0677a088ba82aab6ae018f3ca7c220d2::reward2866 {
    struct REWARD2866 has drop {
        dummy_field: bool,
    }

    struct TICKET_2866 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2866(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_2866>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2866, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2866>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2866>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2866>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2866>>(v5, 0x2::tx_context::sender(arg1));
    }
