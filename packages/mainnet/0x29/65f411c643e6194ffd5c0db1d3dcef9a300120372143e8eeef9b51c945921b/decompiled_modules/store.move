module 0x2965f411c643e6194ffd5c0db1d3dcef9a300120372143e8eeef9b51c945921b::store {
    ...
    public entry fun create_store(arg0: &0x2::clock::Clock, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: bool, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 != @0xbd98eff8cb12fbcb269a334137c00c693d704ce878d8e1fed640acedb235254f || v0 != @0xbd98eff8cb12fbcb269a334137c00c693d704ce878d8e1fed640acedb235254f) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg8) >= 300000000000, 8);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg8, 300000000000, arg9), @0xbd98eff8cb12fbcb269a334137c00c693d704ce878d8e1fed640acedb235254f);
