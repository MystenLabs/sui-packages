module 0x5e53b65ce90cfb6ed7b626a9ed81288aee0872a7e7a872dcc284058da155cef0::prediction {
    ...
    public entry fun claim(arg0: &mut Rounds, arg1: u64, arg2: &mut Epoch, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0.upordown) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v0.totalAmount, ((v1 * v0.downamount / v0.upamount + v1) as u64), arg3), 0x2::tx_context::sender(arg3));
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v0.totalAmount, ((v2 * v0.upamount / v0.downamount + v2) as u64), arg3), 0x2::tx_context::sender(arg3));
