module 0x5e89e3341c25e747fef338469016cf968e90150192237ed9bb191f9302ec3217::cnsnft8891 {
    struct CNSNFT8891 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8891, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8891>(arg0, arg1);
