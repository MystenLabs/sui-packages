module 0x5ece0ec9c9a401d166d38f2ec7e855c4f3fb30ff6f6a8694b7c28f583f04c96f::reward1085 {
    struct REWARD1085 has drop {
        dummy_field: bool,
    }

    struct TICKET_1085 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1085(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1085>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1085>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1085, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1085>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1085>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1085>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1085>>(v5, 0x2::tx_context::sender(arg1));
    }
