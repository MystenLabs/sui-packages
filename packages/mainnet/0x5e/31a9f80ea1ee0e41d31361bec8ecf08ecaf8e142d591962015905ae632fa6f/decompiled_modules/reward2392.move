module 0x5e31a9f80ea1ee0e41d31361bec8ecf08ecaf8e142d591962015905ae632fa6f::reward2392 {
    struct REWARD2392 has drop {
        dummy_field: bool,
    }

    struct TICKET_2392 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2392(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2392>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2392>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2392, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2392>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2392>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2392>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2392>>(v5, 0x2::tx_context::sender(arg1));
    }
