module 0x5eb76741f3aec2e56c1f0d3e0e601fcc40cbaf50037786e21d3e70bfa44e3acc::token {
    ...
    fun init(arg0: TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN>(arg0, 9, b"CETUS_R7846", b"Cetus Token (Reserve)", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://decentanft.link/token-image/token-TjrPIT3ZXa.svg"))), arg1);
