module 0x5ebc9321e8f2748a492504cdb17b316535b899b29d98157a335fc12fec38b850::jerry_github_nft {
    struct JerryGithubNFT has store, key {
        id: 0x2::object::UID,
        nft_id: u64,
    ...
    struct JERRY_GITHUB_NFT has drop {
        dummy_field: bool,
    }

    public entry fun burn(arg0: &mut MintRecord, arg1: JerryGithubNFT) {
    ...
    fun init(arg0: JERRY_GITHUB_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::package::claim<JERRY_GITHUB_NFT>(arg0, arg1);
        let v6 = 0x2::display::new_with_fields<JerryGithubNFT>(&v5, v0, v2, arg1);
        0x2::display::update_version<JerryGithubNFT>(&mut v6);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v5, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<JerryGithubNFT>>(v6, 0x2::tx_context::sender(arg1));
    ...
    public entry fun mint(arg0: &mut MintRecord, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = NFTMinted{
            object_id : 0x2::object::id<JerryGithubNFT>(&v1),
            creator   : 0x2::tx_context::sender(arg4),
            name      : v1.name,
        };
        0x2::event::emit<NFTMinted>(v2);
        0x2::transfer::public_transfer<JerryGithubNFT>(v1, arg3);
    }
