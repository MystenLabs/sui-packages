module 0x5eb8dad7ad7c2548da6ea5af2fa2a5653737478a7f81ee4822af18587c9a28fd::game {
    ...
    public entry fun place_bet(arg0: &mut GameState, arg1: &mut 0x5eb8dad7ad7c2548da6ea5af2fa2a5653737478a7f81ee4822af18587c9a28fd::player_registry::Registry, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::coin::value<0x2::sui::SUI>(&arg2);
        let v2 = 0x2::clock::timestamp_ms(arg4);
        assert!(v1 >= 0 && v1 <= 1000000000000, 4);
        0x5eb8dad7ad7c2548da6ea5af2fa2a5653737478a7f81ee4822af18587c9a28fd::player_registry::register_player(arg1, v0, arg3, 0x5eb8dad7ad7c2548da6ea5af2fa2a5653737478a7f81ee4822af18587c9a28fd::player_registry::get_jackpot_game_id(), arg4);
        let v3 = if (0x5eb8dad7ad7c2548da6ea5af2fa2a5653737478a7f81ee4822af18587c9a28fd::player_registry::is_valid_referrer(arg1, arg3)) {
            let v4 = 0x5eb8dad7ad7c2548da6ea5af2fa2a5653737478a7f81ee4822af18587c9a28fd::player_registry::get_player_address(arg1, arg3);
            if (v4 == v0) {
                arg0.admin
            } else {
                v4
        ...
        0x5eb8dad7ad7c2548da6ea5af2fa2a5653737478a7f81ee4822af18587c9a28fd::player_registry::update_jackpot_deposit(arg1, v0, v1);
        if (v3 != arg0.admin) {
            let v9 = v1 * 1 / 100;
            if (v9 > 0) {
