module 0x5ead9817e62a520bf09ca106ec3d29cf55c3cbb598131d101c1881e613d9f2f5::cnsnft7687 {
    struct CNSNFT7687 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7687, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8823"));
        let v4 = 0x2::package::claim<CNSNFT7687>(arg0, arg1);
