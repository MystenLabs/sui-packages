module 0x5e0df1288391511c69a1eec9471382c2eaae34380eb387bea5d5e58721ea2559::stake {
    ...
    struct StakingOrder has drop, store {
        id: u64,
        token: vector<u8>,
        amount: u64,
        timestamp: u64,
    ...
    public fun balanceToken<T0>(arg0: &Vault, arg1: &0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage) : u64 {
    ...
    public fun orderList(arg0: &YubiBao, arg1: &mut 0x2::tx_context::TxContext) : &vector<StakingOrder> {
        0x2::table::borrow<address, vector<StakingOrder>>(&arg0.users, 0x2::tx_context::sender(arg1))
    }

    public entry fun redemptionUSDT<T0>(arg0: u64, arg1: &mut YubiBao, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg6: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg1.vault;
        let v1 = 0x2::table::borrow_mut<address, vector<StakingOrder>>(&mut arg1.users, 0x2::tx_context::sender(arg8));
        let v2 = 0;
        while (v2 < 0x1::vector::length<StakingOrder>(v1)) {
            let v3 = 0x1::vector::borrow_mut<StakingOrder>(v1, v2);
            if (v3.id == arg0) {
                assert!(v3.status == 0, 1);
                let v4 = get_daily_interest_rate((0x2::clock::timestamp_ms(arg7) - v3.timestamp) / 86400000);
                v3.status = 1;
                v3.interest = v4;
                let v5 = withdrawToken<T0>(v0, v4 + v3.amount, arg2, arg3, arg4, arg5, arg7, arg6, arg8);
    ...
    public entry fun stakeUSDT<T0>(arg0: &mut YubiBao, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        depositToken<T0>(&mut arg0.vault, arg1, arg2, arg3, arg4, arg5, arg6);
    }
    ...
    public entry fun withdrawUSDT<T0>(arg0: u64, arg1: &mut YubiBao, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg6: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.admin == 0x2::tx_context::sender(arg8), 1);
        let v0 = withdrawToken<T0>(&mut arg1.vault, arg0, arg2, arg3, arg4, arg5, arg7, arg6, arg8);
