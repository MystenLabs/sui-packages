module 0x5e7a3b801543e8798159db652c6b6c4090ab9bc3e6387dbd5965a05bfe611358::kang_swap {
    ...
    public fun provide<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun remove<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LiquidityToken<T0, T1>>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun swap_a_to_b<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun swap_b_to_a<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) {
