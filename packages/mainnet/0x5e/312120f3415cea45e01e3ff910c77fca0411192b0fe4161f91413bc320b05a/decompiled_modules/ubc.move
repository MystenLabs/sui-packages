module 0x5e312120f3415cea45e01e3ff910c77fca0411192b0fe4161f91413bc320b05a::ubc {
    struct UBC has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: UBC, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<UBC>(&mut v3, 100000000000000000, 0x2::tx_context::sender(arg1), arg1);
