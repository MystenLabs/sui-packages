module 0x5e4a7120390c29f8d623633cada8eb3900321f1f171830ae8b30a0459ea14556::bird {
    ...
    public fun action(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut BirdStore, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::ed25519::ed25519_verify(&arg0, &arg3.validator_pubkey, &arg2), 8000);
        let v0 = 0x2::bcs::new(arg2);
        let v1 = 0x2::bcs::peel_u8(&mut v0);
        assert!(v1 <= 1, 8004);
        if (v1 == 1) {
            checkIn(0x2::bcs::peel_address(&mut v0), 0x2::bcs::peel_u64(&mut v0), 0x2::bcs::peel_u128(&mut v0), arg3, arg4, arg5);
        } else if (v1 == 0) {
            breakEgg(0x2::bcs::peel_address(&mut v0), 0x2::bcs::peel_u64(&mut v0), 0x2::bcs::peel_u128(&mut v0), arg3, arg4, arg5);
        };
    }
    ...
    public entry fun change_admin(arg0: BirdAdminCap, arg1: address, arg2: &mut 0x5e4a7120390c29f8d623633cada8eb3900321f1f171830ae8b30a0459ea14556::version::Version) {
        0x5e4a7120390c29f8d623633cada8eb3900321f1f171830ae8b30a0459ea14556::version::checkVersion(arg2, 1);
    ...
    public entry fun set_validator(arg0: &BirdAdminCap, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut 0x5e4a7120390c29f8d623633cada8eb3900321f1f171830ae8b30a0459ea14556::version::Version) {
        0x5e4a7120390c29f8d623633cada8eb3900321f1f171830ae8b30a0459ea14556::version::checkVersion(arg3, 1);
