module 0x5e0364a85381d7525c3b3ea7e4fb1820ba890d9ad438b86f68988161630c5d2d::reward2848 {
    struct REWARD2848 has drop {
        dummy_field: bool,
    }

    struct TICKET_2848 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2848(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2848>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2848>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2848, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2848>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2848>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2848>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2848>>(v5, 0x2::tx_context::sender(arg1));
    }
