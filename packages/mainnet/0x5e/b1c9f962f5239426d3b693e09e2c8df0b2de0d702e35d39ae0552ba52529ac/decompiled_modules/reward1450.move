module 0x5eb1c9f962f5239426d3b693e09e2c8df0b2de0d702e35d39ae0552ba52529ac::reward1450 {
    struct REWARD1450 has drop {
        dummy_field: bool,
    }

    struct TICKET_1450 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1450(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1450>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1450>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1450, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1450>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1450>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1450>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1450>>(v5, 0x2::tx_context::sender(arg1));
    }
