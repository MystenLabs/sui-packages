module 0x5e01eb950e3e205f132b6b1ae999f7d15c7fa856febd63b276dbdd5e876dbf60::acl {
    ...
    public fun finish_transfer<T0>(arg0: SuperAdmin<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x5e01eb950e3e205f132b6b1ae999f7d15c7fa856febd63b276dbdd5e876dbf60::sam_events::finish_super_admin_transfer(v0);
    }
    ...
    public fun new_admin<T0>(arg0: &mut ACL<T0>, arg1: &SuperAdmin<T0>, arg2: &mut 0x2::tx_context::TxContext) : Admin<T0> {
        ...
        0x5e01eb950e3e205f132b6b1ae999f7d15c7fa856febd63b276dbdd5e876dbf60::sam_events::new_admin(0x2::object::uid_to_address(&v0.id));
        v0
    }
    ...
    public fun revoke<T0>(arg0: &mut ACL<T0>, arg1: &SuperAdmin<T0>, arg2: address) {
        ...
        0x5e01eb950e3e205f132b6b1ae999f7d15c7fa856febd63b276dbdd5e876dbf60::sam_events::revoke_admin(arg2);
    }
    ...
    public fun start_transfer<T0>(arg0: &mut SuperAdmin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.new_admin = arg1;
        0x5e01eb950e3e205f132b6b1ae999f7d15c7fa856febd63b276dbdd5e876dbf60::sam_events::start_super_admin_transfer(arg1, arg0.start);
    }
