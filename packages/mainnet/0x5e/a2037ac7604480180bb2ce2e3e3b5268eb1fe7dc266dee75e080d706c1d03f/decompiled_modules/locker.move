module 0x5ea2037ac7604480180bb2ce2e3e3b5268eb1fe7dc266dee75e080d706c1d03f::locker {
    ...
    public fun consume_score<T0>(arg0: &mut vector<Locker<T0>>, arg1: u64) {
        let v0 = 0;
        let v1 = 0;
        while (v0 < arg1) {
            let v2 = 0x1::vector::borrow_mut<Locker<T0>>(arg0, v1);
            let v3 = v2.score;
            if (v0 + v3 < arg1) {
                v0 = v0 + v3;
                v2.score = 0;
