module 0x5e6895742d3b90b282a6143a6f857e68c822b239b1ffddd863531056e4a11b73::my_collection5 {
    ...
    fun init(arg0: MY_COLLECTION5, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MY_COLLECTION5>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"My collection5"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This is my collection3"));
