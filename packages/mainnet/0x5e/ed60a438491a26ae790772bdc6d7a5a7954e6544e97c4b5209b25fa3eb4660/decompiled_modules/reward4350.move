module 0x5eed60a438491a26ae790772bdc6d7a5a7954e6544e97c4b5209b25fa3eb4660::reward4350 {
    struct REWARD4350 has drop {
        dummy_field: bool,
    }

    struct TICKET_4350 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4350(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4350>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4350>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4350, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4350>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4350>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4350>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4350>>(v5, 0x2::tx_context::sender(arg1));
    }
