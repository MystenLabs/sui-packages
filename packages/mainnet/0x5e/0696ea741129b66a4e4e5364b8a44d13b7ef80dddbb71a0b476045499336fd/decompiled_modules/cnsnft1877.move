module 0x5e0696ea741129b66a4e4e5364b8a44d13b7ef80dddbb71a0b476045499336fd::cnsnft1877 {
    struct CNSNFT1877 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1877, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1877>(arg0, arg1);
