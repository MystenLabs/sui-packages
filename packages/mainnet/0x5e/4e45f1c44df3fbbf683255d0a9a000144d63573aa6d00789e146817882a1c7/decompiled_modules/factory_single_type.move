module 0x5e4e45f1c44df3fbbf683255d0a9a000144d63573aa6d00789e146817882a1c7::factory_single_type {
    ...
    public entry fun create_treasury_cap_one_time(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = TokenMarker{dummy_field: false};
        let (v1, v2) = 0x2::coin::create_currency<TokenMarker>(v0, 9, b"TM", b"TokenMarker", b"TokenMarker for Meme Hedge Factory", 0x1::option::none<0x2::url::Url>(), arg0);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<TokenMarker>>(v1, 0x2::tx_context::sender(arg0));
