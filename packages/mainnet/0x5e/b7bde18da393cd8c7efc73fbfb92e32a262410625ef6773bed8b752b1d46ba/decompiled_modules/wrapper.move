module 0x5eb7bde18da393cd8c7efc73fbfb92e32a262410625ef6773bed8b752b1d46ba::wrapper {
    ...
    public fun create_fund_cap(arg0: &0x5eb7bde18da393cd8c7efc73fbfb92e32a262410625ef6773bed8b752b1d46ba::admin::AdminCap, arg1: &DeepBookV3RouterWrapper, arg2: &mut 0x2::tx_context::TxContext) : DeepBookV3FundCap {
        DeepBookV3FundCap{
    ...
    public fun swap_exact_base_for_quote<T0, T1>(arg0: &mut DeepBookV3RouterWrapper, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v4 = v2;
        join(arg0, v3);
        transfer_if_nonzero<T0>(v1, 0x2::tx_context::sender(arg5));
    ...
    public fun swap_exact_quote_for_base<T0, T1>(arg0: &mut DeepBookV3RouterWrapper, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = if (0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::whitelisted<T0, T1>(arg1)) {
            0x2::coin::zero<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(arg5)
        } else {
            0x2::coin::from_balance<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(0x2::balance::split<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(&mut arg0.deep_reserves, 0x2::balance::value<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(&arg0.deep_reserves)), arg5)
        ...
        let v4 = v1;
        join(arg0, v3);
        transfer_if_nonzero<T1>(v2, 0x2::tx_context::sender(arg5));
        let (v5, _, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_trade_params<T0, T1>(arg1);
        let v8 = &mut v4;
    ...
    public fun withdraw_charged_fee<T0>(arg0: &DeepBookV3FundCap, arg1: &mut DeepBookV3RouterWrapper, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg0.wrapper_id == 0x2::object::uid_to_inner(&arg1.id), 9223372878668365825);
        let v0 = ChargedFeeKey<T0>{dummy_field: false};
