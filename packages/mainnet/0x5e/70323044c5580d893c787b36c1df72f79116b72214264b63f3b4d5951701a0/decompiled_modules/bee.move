module 0x5e70323044c5580d893c787b36c1df72f79116b72214264b63f3b4d5951701a0::bee {
    struct BEE has drop {
        dummy_field: bool,
    }
    ...
    public fun bees_tokens_to_coin<T0>(arg0: &mut 0x2::token::Token<T0>, arg1: &BeeCap<T0>, arg2: &mut 0x2::token::TokenPolicy<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v3 = 0x6c981865f9945278a43801b6bc294ecad49dd84b215bc9e2fbbf987c4c4b8291::math::mul_div_u128((arg3 as u128), (*0x2::vec_map::get<0x1::string::String, u64>(&0x2::token::rule_config<T0, Burn, BurnCondition>(v1, arg2).percent, &v2) as u128), (100 as u128));
