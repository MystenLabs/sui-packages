module 0x5e5e3ff3c361e2727a178ed6b140057de78966b6d6c76c348b8454616947e6dc::cnsnft8797 {
    struct CNSNFT8797 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8797, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7334"));
        let v4 = 0x2::package::claim<CNSNFT8797>(arg0, arg1);
