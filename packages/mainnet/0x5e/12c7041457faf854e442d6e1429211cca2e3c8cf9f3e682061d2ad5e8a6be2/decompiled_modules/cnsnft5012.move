module 0x5e12c7041457faf854e442d6e1429211cca2e3c8cf9f3e682061d2ad5e8a6be2::cnsnft5012 {
    struct CNSNFT5012 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5012, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8370"));
        let v4 = 0x2::package::claim<CNSNFT5012>(arg0, arg1);
