module 0x5e5e18d70942a6ccbbd79a2d0bc4e3936c290ed66ab41a4a0b1da01c79573805::cnsnft4499 {
    struct CNSNFT4499 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4499, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4499>(arg0, arg1);
