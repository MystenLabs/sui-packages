module 0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::lb_position {
    ...
    fun add_or_update_bin(arg0: &mut LBPositionInfo, arg1: u32, arg2: LBBinPosition) {
        let (v0, v1) = calculate_bin_group_index(arg1);
        if (!0x2::table::contains<u32, PackedBins>(&arg0.bins, v0)) {
            0x2::table::add<u32, PackedBins>(&mut arg0.bins, v0, create_empty_pack());
        };
        let v2 = 0x2::table::borrow_mut<u32, PackedBins>(&mut arg0.bins, v0);
        if (is_bin_active_in_bitmap(v2.active_bins_bitmap, v1)) {
            *0x1::vector::borrow_mut<LBBinPosition>(&mut v2.bin_data, count_active_bins_before_position(v2.active_bins_bitmap, v1)) = arg2;
        } else {
            0x1::vector::insert<LBBinPosition>(&mut v2.bin_data, arg2, count_active_bins_before_position(v2.active_bins_bitmap, v1));
            v2.active_bins_bitmap = set_bit_in_bitmap(v2.active_bins_bitmap, v1);
        };
    }

    public(friend) fun add_total_fees_gen(arg0: &mut LBPositionInfo, arg1: u128) {
        arg0.total_fees_gen = 0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::safe_math::add_u128(arg0.total_fees_gen, arg1);
    }
    ...
    fun calculate_bin_group_index(arg0: u32) : (u32, u64) {
        (arg0 / (64 as u32), ((arg0 % (64 as u32)) as u64))
    }

    fun clear_bit_in_bitmap(arg0: u64, arg1: u64) : u64 {
        arg0 & 18446744073709551615 - (1 << (arg1 as u8))
    }
    ...
    public(friend) fun collect_fees(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        (((0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::safe_math::mul_u128(v3, 0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::safe_math::sub_u128(arg3, v2.fee_growth_inside_last_x)) >> 64) as u64), ((0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::safe_math::mul_u128(v3, 0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::safe_math::sub_u128(arg4, v2.fee_growth_inside_last_y)) >> 64) as u64))
    }

    fun count_active_bins(arg0: u64) : u64 {
        ...
        (v2 & 255) + (v2 >> 8 & 255) + (v2 >> 16 & 255) + (v2 >> 24 & 255) + (v2 >> 32 & 255) + (v2 >> 40 & 255) + (v2 >> 48 & 255) + (v2 >> 56 & 255)
    }

    fun count_active_bins_before_position(arg0: u64, arg1: u64) : u64 {
        if (arg1 == 0) {
            return 0
        };
        count_active_bins(arg0 & (1 << (arg1 as u8)) - 1)
    }
    ...
    fun create_empty_pack() : PackedBins {
        PackedBins{
    ...
    public(friend) fun decrease_liquidity(arg0: &mut LBPositionManager, arg1: &mut 0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::bin_manager::BinManager, arg2: &LBPosition, arg3: u32, arg4: u128, arg5: &0x2::clock::Clock) : u128 {
        ...
        0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::bin_manager::decrement_total_supply(arg1, arg3, arg4)
    }
    ...
    fun find_nth_active_bin(arg0: u64, arg1: u64, arg2: u32) : u32 {
        let v0 = 0;
        let v1 = 0;
        while (v1 < 64 && v0 <= arg1) {
    ...
    fun get_bin(arg0: &LBPositionInfo, arg1: u32) : 0x1::option::Option<LBBinPosition> {
        ...
        0x1::option::some<LBBinPosition>(*0x1::vector::borrow<LBBinPosition>(&v2.bin_data, count_active_bins_before_position(v2.active_bins_bitmap, v1)))
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        let v3 = arg2 / (64 as u32);
        while (v3 <= arg3 / (64 as u32)) {
            if (0x2::table::contains<u32, PackedBins>(&v2.bins, v3)) {
                ...
                while (v5 < 0x1::vector::length<LBBinPosition>(&v4.bin_data)) {
                    ...
                    let v7 = find_nth_active_bin(v4.active_bins_bitmap, v5, v3 * (64 as u32));
                    let v8 = if (v7 >= arg2) {
                        if (v7 <= arg3) {
                            v6.amount > 0
                        } else {
            ...
            v3 = 0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }
    ...
    public fun get_total_pending_fees_with_growth(arg0: &LBPositionManager, arg1: &LBPosition, arg2: &vector<u32>, arg3: &vector<u128>, arg4: &vector<u128>) : (u64, u64) {
        ...
        while (v2 < 0x1::vector::length<u32>(arg2)) {
            ...
            v0 = 0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::safe_math::add_u64(v0, v3);
            v1 = 0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::safe_math::add_u64(v1, v4);
            v2 = v2 + 1;
        };
        (v0, v1)
    }
    ...
    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &mut 0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::bin_manager::BinManager, arg2: &LBPosition, arg3: u32, arg4: u128) : u128 {
        let v0 = borrow_mut_position_info(arg0, 0x2::object::id<LBPosition>(arg2));
        let v1 = get_bin(v0, arg3);
        if (0x1::option::is_some<LBBinPosition>(&v1)) {
            let v2 = 0x1::option::extract<LBBinPosition>(&mut v1);
            let v3 = LBBinPosition{
                amount                   : 0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::safe_math::add_u128(v2.amount, arg4),
                fee_growth_inside_last_x : v2.fee_growth_inside_last_x,
                fee_growth_inside_last_y : v2.fee_growth_inside_last_y,
            };
        ...
        0x5efcb531fd4d7611259bbf2baebc6bbb936394b7b695e826b8b76d18ab38c290::bin_manager::increment_total_supply(arg1, arg3, arg4)
    }
    ...
    fun is_bin_active_in_bitmap(arg0: u64, arg1: u64) : bool {
        arg0 >> (arg1 as u8) & 1 == 1
    }
    ...
    public fun is_position_empty(arg0: &LBPositionInfo, arg1: u64) : bool {
        ...
        if (arg0.reward_claimed_bitmap != v0) {
            return false
        };
        true
    }
    ...
    fun remove_bin(arg0: &mut LBPositionInfo, arg1: u32) : bool {
        ...
        0x1::vector::remove<LBBinPosition>(&mut v2.bin_data, count_active_bins_before_position(v2.active_bins_bitmap, v1));
    ...
    fun set_bit_in_bitmap(arg0: u64, arg1: u64) : u64 {
        arg0 | 1 << (arg1 as u8)
    }
