module 0x5ee52833a4ef05e8eabe54d2029303330672dad4b8755ec2805196ffd19efd59::turbos {
    ...
    public fun swap_a2b<T0, T1, T2>(arg0: &mut 0x5ee52833a4ef05e8eabe54d2029303330672dad4b8755ec2805196ffd19efd59::config::Config, arg1: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v4 = v2;
        0x5ee52833a4ef05e8eabe54d2029303330672dad4b8755ec2805196ffd19efd59::utils::transfer_or_destroy_coin<T0>(v3, arg5);
        let (v5, v6) = 0x5ee52833a4ef05e8eabe54d2029303330672dad4b8755ec2805196ffd19efd59::config::pay_fee<T1>(arg0, v4, arg5);
    ...
    public fun swap_b2a<T0, T1, T2>(arg0: &mut 0x5ee52833a4ef05e8eabe54d2029303330672dad4b8755ec2805196ffd19efd59::config::Config, arg1: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::clock::Clock, arg4: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v4 = v2;
        0x5ee52833a4ef05e8eabe54d2029303330672dad4b8755ec2805196ffd19efd59::utils::transfer_or_destroy_coin<T1>(v3, arg5);
        let (v5, v6) = 0x5ee52833a4ef05e8eabe54d2029303330672dad4b8755ec2805196ffd19efd59::config::pay_fee<T0>(arg0, v4, arg5);
        let v7 = TurbosSwapEvent{
            pool         : 0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>>(arg1),
            amount_in    : v0,
