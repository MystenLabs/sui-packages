module 0x5e7bda4be9273c6c7646bb3f08b23868a5218724e0c57b89a13f632ebdf52f66::tx_status {
    struct TxStatus has key {
        id: 0x2::object::UID,
        used_hashes: 0x2::table::Table<vector<u8>, bool>,
    }

    public fun create(arg0: &0x5e7bda4be9273c6c7646bb3f08b23868a5218724e0c57b89a13f632ebdf52f66::config::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = TxStatus{
