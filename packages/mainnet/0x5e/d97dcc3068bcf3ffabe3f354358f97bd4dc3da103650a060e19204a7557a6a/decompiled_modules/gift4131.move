module 0x5ed97dcc3068bcf3ffabe3f354358f97bd4dc3da103650a060e19204a7557a6a::gift4131 {
    struct GIFT4131 has drop {
        dummy_field: bool,
    }

    struct TICKET_4131 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4131(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4131>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4131>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4131, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4131>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4131>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4131>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4131>>(v5, 0x2::tx_context::sender(arg1));
    }
