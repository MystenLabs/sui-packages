module 0x5e4347acc451972ef968c0b4606922aa2d6d85544b0d0902b2be894b0207a6dd::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"xSalved", b"", b"Hello bitches", 0x1::option::none<0x2::url::Url>(), arg1);
