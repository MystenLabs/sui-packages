module 0x5e0de2df3bf01ebafb3a221ff800bb222de27758b41ef0faff10cc3ca2e74a5c::reward3191 {
    struct REWARD3191 has drop {
        dummy_field: bool,
    }

    struct TICKET_3191 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3191(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3191>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3191>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3191, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3191>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3191>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3191>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3191>>(v5, 0x2::tx_context::sender(arg1));
    }
