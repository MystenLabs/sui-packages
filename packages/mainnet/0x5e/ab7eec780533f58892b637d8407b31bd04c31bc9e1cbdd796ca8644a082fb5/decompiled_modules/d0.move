module 0x5eab7eec780533f58892b637d8407b31bd04c31bc9e1cbdd796ca8644a082fb5::d0 {
    ...
    fun check(arg0: &vector<u64>) {
        assert!(0x1::vector::length<u64>(arg0) == 22, 1);
    ...
    public(friend) fun hk(arg0: &vector<u64>, arg1: &vector<u64>) : bool {
        if (0x1::vector::length<u64>(arg1) != 22) {
            return false
        };
        let v0 = vector[6, 8, 9, 13, 17, 20, 21];
