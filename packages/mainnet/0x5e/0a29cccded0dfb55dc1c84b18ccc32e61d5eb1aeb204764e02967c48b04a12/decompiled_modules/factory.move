module 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::factory {
    ...
    fun active_bin_bounds(arg0: u16) : (u32, u32) {
        ...
        let v1 = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::constants::price_range_num_low() / (arg0 as u32);
        let v2 = if (v0 > v1) {
            v0 - v1
        } else {
            1
        };
        let v3 = (v0 as u64) + ((0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::constants::price_range_num() / (arg0 as u32)) as u64);
    ...
    public entry fun create_pool<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::OperatorCap, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg2: &mut PoolRegistry, arg3: PoolInitParams, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::assert_operator_cap(arg1, arg0);
        let (v0, v1) = prepare_create<T0, T1>(arg2, &arg3);
        let v2 = 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::pool::create_and_share_pool<T0, T1>(arg3.fee_params, arg3.active_bin_id, arg3.min_liquidity_x, arg3.min_liquidity_y, arg3.lazer_feed_id_x, arg3.lazer_feed_id_y, arg5);
    ...
    public entry fun create_pool_with_lending<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::OperatorCap, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg2: &mut PoolRegistry, arg3: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg4: PoolInitParams, arg5: 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::PoolLendingConfig, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::assert_operator_cap(arg1, arg0);
        let (v0, v1) = prepare_create<T0, T1>(arg2, &arg4);
        0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::assert_enabled_markets_exist(arg3, &arg5);
        let v2 = 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::pool::create_and_share_pool_with_lending<T0, T1>(arg4.fee_params, arg4.active_bin_id, arg4.min_liquidity_x, arg4.min_liquidity_y, arg4.lazer_feed_id_x, arg4.lazer_feed_id_y, arg3, arg5, arg7);
    ...
    fun emit_creation_feed_ids(arg0: 0x2::object::ID, arg1: &PoolInitParams) {
        if (arg1.lazer_feed_id_x != 0 || arg1.lazer_feed_id_y != 0) {
            0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::pool::emit_lazer_feed_ids_set(arg0, arg1.lazer_feed_id_x, arg1.lazer_feed_id_y);
        };
    }
    ...
    public entry fun migrate(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::OperatorCap, arg2: &mut PoolRegistry) {
        0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::assert_operator_cap(arg0, arg1);
        assert!(arg2.version < 2, 504);
        arg2.version = 2;
    ...
    public fun new_pool_init_params(arg0: u32, arg1: 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fee_params::FeeParameters, arg2: u64, arg3: u64) : PoolInitParams {
    ...
    public fun pause_creation(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::GuardianCap, arg2: &mut PoolRegistry) {
    ...
    public fun pool_init_bin_step(arg0: &PoolInitParams) : u16 {
        0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fee_params::bin_step(&arg0.fee_params)
    }

    public fun pool_init_fee_params(arg0: &PoolInitParams) : 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fee_params::FeeParameters {
        arg0.fee_params
    }
    ...
    fun prepare_create<T0, T1>(arg0: &PoolRegistry, arg1: &PoolInitParams) : (vector<u8>, vector<u8>) {
        ...
        let (v0, v1) = active_bin_bounds(0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fee_params::bin_step(&arg1.fee_params));
    ...
    fun record_pool(arg0: &mut PoolRegistry, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: vector<u8>, arg4: 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fee_params::FeeParameters, arg5: u32, arg6: u64, arg7: u64, arg8: address, arg9: u64) {
        let v0 = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fee_params::bin_step(&arg4);
        let v1 = PoolCreated{
            pool_id         : arg1,
        ...
        let v2 = PoolMetadata{
            ...
            swap_enabled        : true,
            base_fee_rate       : 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fee::get_base_fee(&arg4),
        };
        0x2::table::add<0x2::object::ID, PoolMetadata>(&mut arg0.metadata, arg1, v2);
        arg0.pool_count = increment_pool_count(arg0.pool_count);
    }

    public entry fun refresh_pool_metadata<T0, T1>(arg0: &mut PoolRegistry, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::pool::Pool<T0, T1>) {
        assert_version(arg0);
        ...
        v1.swap_enabled = 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::pool::is_swap_enabled<T0, T1>(arg1);
        v1.base_fee_rate = 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::pool::base_fee_rate<T0, T1>(arg1);
    }
    ...
    public entry fun set_pool_routing_flag(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::OperatorCap, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg2: &mut PoolRegistry, arg3: 0x2::object::ID, arg4: bool, arg5: &0x2::tx_context::TxContext) {
        assert_version(arg2);
        0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::assert_operator_cap(arg1, arg0);
    ...
    public fun unpause_creation(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminCap, arg1: &mut PoolRegistry) {
        assert_version(arg1);
    ...
    public fun with_lazer_feed_ids(arg0: PoolInitParams, arg1: u32, arg2: u32) : PoolInitParams {
        0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::pool::assert_valid_lazer_feed_ids(arg1, arg2);
