module 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin {
    ...
    public entry fun accept_admin(arg0: &AdminRegistry, arg1: PendingAdminTransfer, arg2: 0x2::transfer::Receiving<AdminCap>, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
    ...
    public entry fun apply_fee_recipient(arg0: &AdminCap, arg1: &mut AdminRegistry, arg2: &0x2::clock::Clock) {
    ...
    public(friend) fun assert_registry_version(arg0: &AdminRegistry) {
        assert!(2 == arg0.version, 106);
    }

    public entry fun cancel_admin_transfer(arg0: &AdminRegistry, arg1: PendingAdminTransfer, arg2: 0x2::transfer::Receiving<AdminCap>, arg3: &0x2::tx_context::TxContext) {
        assert_registry_recovery_version(arg0);
        let PendingAdminTransfer {
            id              : v0,
            admin_cap_id    : v1,
    ...
    public entry fun cancel_fee_recipient(arg0: &AdminCap, arg1: &mut AdminRegistry) {
        assert_registry_version(arg1);
        assert!(0x1::option::is_some<PendingFeeRecipient>(&arg1.pending_fee_recipient), 107);
        let PendingFeeRecipient {
            new_address : v0,
    ...
    public entry fun guardian_cancel_admin_transfer(arg0: &AdminRegistry, arg1: &GuardianCap, arg2: PendingAdminTransfer, arg3: 0x2::transfer::Receiving<AdminCap>) {
    ...
    public fun max_guardian_caps() : u64 {
        32
    }

    public fun max_operator_caps() : u64 {
        32
    }

    public entry fun migrate_registry(arg0: &AdminCap, arg1: &mut AdminRegistry) {
        migrate_registry_impl(arg1);
    }

    fun migrate_registry_impl(arg0: &mut AdminRegistry) {
        assert!(2 > arg0.version, 109);
        let v0 = arg0.version;
        let v1 = 2;
        arg0.version = v1;
    ...
    public entry fun mint_guardian_cap(arg0: &AdminCap, arg1: &mut AdminRegistry, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        assert_registry_version(arg1);
        assert_nonzero_recipient(arg2);
        assert!(0x2::vec_set::length<0x2::object::ID>(&arg1.valid_guardian_caps) < 32, 112);
    ...
    public entry fun mint_operator_cap(arg0: &AdminCap, arg1: &mut AdminRegistry, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        assert_registry_version(arg1);
        assert_nonzero_recipient(arg2);
        assert!(0x2::vec_set::length<0x2::object::ID>(&arg1.valid_operator_caps) < 32, 111);
    ...
    public entry fun propose_admin(arg0: AdminCap, arg1: &AdminRegistry, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_registry_version(arg1);
        assert_nonzero_recipient(arg2);
    ...
    public entry fun propose_fee_recipient(arg0: &AdminCap, arg1: &mut AdminRegistry, arg2: address, arg3: &0x2::clock::Clock) {
        assert_registry_version(arg1);
        assert!(arg2 != @0x0, 113);
    ...
    public entry fun revoke_all_caps(arg0: &AdminCap, arg1: &mut AdminRegistry) {
        assert_registry_version(arg1);
    ...
    public entry fun revoke_guardian_cap(arg0: &AdminCap, arg1: &mut AdminRegistry, arg2: 0x2::object::ID) {
        assert_registry_recovery_version(arg1);
    ...
    public entry fun revoke_operator_cap(arg0: &AdminCap, arg1: &mut AdminRegistry, arg2: 0x2::object::ID) {
        assert_registry_recovery_version(arg1);
