module 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::partner {
    ...
    public entry fun create_partner(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminCap, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg2: vector<u8>, arg3: u16, arg4: address, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun migrate(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::OperatorCap, arg2: &mut Partner) {
        0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::assert_operator_cap(arg0, arg1);
        assert!(arg2.version < 2, 703);
        arg2.version = 2;
    ...
    public entry fun rotate_partner_cap(arg0: &PartnerRecoveryCap, arg1: &mut Partner, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg1);
    ...
    public entry fun rotate_partner_recovery_cap(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminCap, arg1: &mut Partner, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg1);
        0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::assert_nonzero_recipient(arg2);
        let v0 = 0x2::object::new(arg3);
        let v1 = 0x2::object::uid_to_inner(&v0);
    ...
    public entry fun set_partner_active(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminCap, arg1: &mut Partner, arg2: bool) {
        assert_version(arg1);
        arg1.is_active = arg2;
    ...
    public entry fun set_ref_fee_bps(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminCap, arg1: &mut Partner, arg2: u16) {
        assert_version(arg1);
