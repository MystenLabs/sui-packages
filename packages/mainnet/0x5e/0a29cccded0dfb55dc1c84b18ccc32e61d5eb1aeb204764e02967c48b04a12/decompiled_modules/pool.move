module 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::pool {
    struct FullExitYieldReapedEvent has copy, drop {
    ...
    struct RemovalClaim has copy, drop {
        numerator: u64,
        denominator: u64,
        idle_x: u64,
        idle_y: u64,
    ...
    public fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: vector<u32>, arg4: vector<u128>, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let (v0, v1, _, _) = remove_liquidity_impl<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, false, 0x1::option::none<RemovalClaim>());
        (v0, v1)
    }
    ...
    public entry fun admin_set_lazer_feed_ids<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminCap, arg1: &mut Pool<T0, T1>, arg2: u32, arg3: u32) {
    ...
    public entry fun admin_set_min_liquidity<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminCap, arg1: &mut Pool<T0, T1>, arg2: u64, arg3: u64) {
        assert_version<T0, T1>(arg1);
        assert_not_flash_active<T0, T1>(arg1);
    ...
    fun assert_add<T0, T1>(arg0: &Pool<T0, T1>) {
        ...
        assert!(!perms_bypass_venue(&arg0.permissions), 418);
    }
    ...
    fun assert_bin_floor<T0, T1>(arg0: &Pool<T0, T1>, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: u32) {
        let v0 = 0x2::table::borrow<u32, 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::Bin<T0, T1>>(&arg0.bins, arg2);
        assert!(meets_bin_floor(arg0.min_liquidity_x, arg0.min_liquidity_y, 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::reserve_x<T0, T1>(v0), 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::reserve_y<T0, T1>(v0), 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::total_shares<T0, T1>(v0), 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::shares_in_bin(arg1, arg2)), 426);
    }
    ...
    fun close_dust_removals<T0, T1>(arg0: &Pool<T0, T1>, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &vector<u32>, arg3: &mut vector<u128>) : bool {
        let (_, _, v2) = quote_remove_liquidity<T0, T1>(arg0, arg1, arg2, arg3);
        let v3 = v2;
        let v4 = false;
        let v5 = 0;
        while (v5 < 0x1::vector::length<u32>(arg2)) {
            if (!*0x1::vector::borrow<bool>(&v3, v5)) {
                let v6 = 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::shares_in_bin(arg1, *0x1::vector::borrow<u32>(arg2, v5));
                if (*0x1::vector::borrow<u128>(arg3, v5) < v6) {
                    *0x1::vector::borrow_mut<u128>(arg3, v5) = v6;
                    v4 = true;
                };
            };
            v5 = v5 + 1;
    ...
    public entry fun collect_protocol_fees<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg1: &mut Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        assert_version<T0, T1>(arg1);
        assert_not_flash_active<T0, T1>(arg1);
    ...
    fun collect_remove<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &vector<u32>, arg3: &vector<u128>, arg4: bool) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, vector<u64>, vector<u64>, vector<u128>, vector<u64>, vector<u64>, vector<u64>) {
        ...
        let v7 = vector[];
        let v8 = 0;
        while (v8 < 0x1::vector::length<u32>(arg2)) {
            let v9 = *0x1::vector::borrow<u32>(arg2, v8);
            assert!(0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::has_bin(arg1, v9), 419);
            0x1::vector::push_back<u64>(&mut v5, 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::bin_generation(arg1, v9));
            let v10 = 0x2::table::contains<u32, 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::Bin<T0, T1>>(&arg0.bins, v9) && 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::matches_generation(arg1, v9, bin_generation<T0, T1>(arg0, v9));
            let v11 = if (arg4) {
                0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::shares_in_bin(arg1, v9)
            } else {
                0
            };
            let v12 = 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::remove_shares(arg1, v9, *0x1::vector::borrow<u128>(arg3, v8));
            if (!v10) {
                if (arg4) {
            ...
            credit_bin_yield<T0, T1>(arg0, v9);
            if (arg4) {
                let v13 = 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::total_shares<T0, T1>(0x2::table::borrow<u32, 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::Bin<T0, T1>>(&arg0.bins, v9));
                assert!(v13 > 0, 412);
                assert!(v11 <= v13, 412);
                let (v14, v15) = position_values_from_bin<T0, T1>(arg0, v9, v11);
                0x1::vector::push_back<u64>(&mut v6, v14);
                0x1::vector::push_back<u64>(&mut v7, v15);
            };
            let (v16, v17) = 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::remove_liquidity<T0, T1>(0x2::table::borrow_mut<u32, 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::Bin<T0, T1>>(&mut arg0.bins, v9), &mut arg0.custody, v12);
            let v18 = v17;
            let v19 = v16;
            0x2::balance::join<T0>(&mut v0, v19);
            0x2::balance::join<T1>(&mut v1, v18);
            0x1::vector::push_back<u64>(&mut v2, 0x2::balance::value<T0>(&v19));
            0x1::vector::push_back<u64>(&mut v3, 0x2::balance::value<T1>(&v18));
            0x1::vector::push_back<u128>(&mut v4, v12);
            if (0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::total_shares<T0, T1>(0x2::table::borrow<u32, 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::Bin<T0, T1>>(&arg0.bins, v9)) == 0) {
                0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::destroy_empty<T0, T1>(0x2::table::remove<u32, 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::Bin<T0, T1>>(&mut arg0.bins, v9));
                0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::bitmap::unset(&mut arg0.bitmap, v9);
            } else {
                assert_bin_floor<T0, T1>(arg0, arg1, v9);
            };
            v8 = v8 + 1;
        };
    ...
    fun finish_remove<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: 0x2::object::ID, arg3: vector<u32>, arg4: &vector<u128>, arg5: RemovalAccountingReady<T0, T1>, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext, arg9: bool) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, vector<u64>, vector<u64>) {
        ...
        let (v4, v5, v6, v7, v8, v9, v10, v11) = collect_remove<T0, T1>(arg0, arg1, &arg3, arg4, arg9);
        let v12 = v5;
        let v13 = v4;
        assert!(0x2::balance::value<T0>(&v13) >= arg6 && 0x2::balance::value<T1>(&v12) >= arg7, 402);
        let (v14, v15) = finalize_remove<T0, T1>(arg0, arg2, v3, arg3, v13, v12, v6, v7, v8, v9, arg8);
        (v14, v15, v10, v11)
    }
    ...
    public fun get_position_bin<T0, T1>(arg0: &Pool<T0, T1>, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: u32) : (u64, u64, u128) {
        assert_not_flash_active<T0, T1>(arg0);
        assert_position_pool<T0, T1>(arg0, arg1);
        if (0x2::table::contains<u32, 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::Bin<T0, T1>>(&arg0.bins, arg2) && 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::matches_generation(arg1, arg2, bin_generation<T0, T1>(arg0, arg2))) {
            get_bin<T0, T1>(arg0, arg2)
        } else {
            (0, 0, 0)
        }
    }
    ...
    public fun get_position_value<T0, T1>(arg0: &Pool<T0, T1>, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position) : (u64, u64) {
        position_value<T0, T1>(arg0, arg1, false)
    }

    public fun get_position_value_upper_bound<T0, T1>(arg0: &Pool<T0, T1>, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position) : (u64, u64) {
        position_value<T0, T1>(arg0, arg1, true)
    }

    public entry fun guardian_disable<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::GuardianCap, arg2: &mut Pool<T0, T1>, arg3: u64) {
    ...
    public entry fun guardian_pause<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::GuardianCap, arg2: &mut Pool<T0, T1>) {
        0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::assert_guardian_cap(arg0, arg1);
        assert_version<T0, T1>(arg2);
        assert_not_flash_active<T0, T1>(arg2);
        arg2.paused = true;
    ...
    public fun lending_initialized<T0, T1>(arg0: &Pool<T0, T1>) : bool {
        0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::is_initialized(&arg0.lending)
    }
    ...
    public(friend) fun maybe_distribute_lp_yield<T0, T1>(arg0: &mut Pool<T0, T1>) {
        let v0 = 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::pending_protocol_yield_x(&arg0.lending);
        let v1 = 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::pending_protocol_yield_y(&arg0.lending);
        ...
        let v2 = 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::pending_protocol_yield_x(&arg0.lending);
        let v3 = 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::pending_protocol_yield_y(&arg0.lending);
        if (v2 > v0 || v3 > v1) {
            let v4 = FullExitYieldReapedEvent{
                pool_id  : 0x2::object::id<Pool<T0, T1>>(arg0),
                amount_x : v2 - v0,
                amount_y : v3 - v1,
            };
            0x2::event::emit<FullExitYieldReapedEvent>(v4);
        };
    }

    fun meets_bin_floor(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u128, arg5: u128) : bool {
        ...
        let v1 = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor((arg2 as u128), arg5, arg4);
        let v2 = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor((arg3 as u128), arg5, arg4);
        v1 > 0 && v1 >= (arg0 as u128) || v2 > 0 && v2 >= (arg1 as u128)
    }

    public entry fun migrate<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::OperatorCap, arg2: &mut Pool<T0, T1>) {
    ...
    public entry fun operator_disable<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::OperatorCap, arg2: &mut Pool<T0, T1>, arg3: u64) {
        assert_known_flags(arg3);
        0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::assert_operator_cap(arg0, arg1);
        assert_version<T0, T1>(arg2);
        assert_not_flash_active<T0, T1>(arg2);
    ...
    public entry fun operator_enable<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::OperatorCap, arg2: &mut Pool<T0, T1>, arg3: u64) {
        assert_known_flags(arg3);
        0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::assert_operator_cap(arg0, arg1);
        assert_version<T0, T1>(arg2);
        assert_not_flash_active<T0, T1>(arg2);
    ...
    public entry fun pause<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminCap, arg1: &mut Pool<T0, T1>) {
        assert_version<T0, T1>(arg1);
        assert_not_flash_active<T0, T1>(arg1);
        arg1.paused = true;
        let v0 = PoolPausedEvent{
    ...
    fun position_value<T0, T1>(arg0: &Pool<T0, T1>, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: bool) : (u64, u64) {
        assert_not_flash_active<T0, T1>(arg0);
        assert_position_pool<T0, T1>(arg0, arg1);
        ...
        while (v3 < 0x1::vector::length<u32>(v0)) {
            ...
            if (0x2::table::contains<u32, 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::Bin<T0, T1>>(&arg0.bins, v4) && 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::matches_generation(arg1, v4, bin_generation<T0, T1>(arg0, v4))) {
                ...
                if (v7 > 0) {
                    ...
                    let v10 = if (arg2) {
                        0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_ceil((v8 as u128), v6, v7)
                    } else {
                        0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor((v8 as u128), v6, v7)
                    };
                    v1 = v1 + v10;
                    let v11 = if (arg2) {
                        0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_ceil((v9 as u128), v6, v7)
                    } else {
                        0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor((v9 as u128), v6, v7)
                    };
                    v2 = v2 + v11;
                };
            };
        ...
        let v12 = if (0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::fits_u64(v1)) {
            (v1 as u64)
        } else {
            18446744073709551615
        };
        let v13 = if (0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::fits_u64(v2)) {
            (v2 as u64)
        } else {
            18446744073709551615
        };
    ...
    fun position_values_from_bin<T0, T1>(arg0: &Pool<T0, T1>, arg1: u32, arg2: u128) : (u64, u64) {
        let v0 = 0x2::table::borrow<u32, 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::Bin<T0, T1>>(&arg0.bins, arg1);
        let v1 = 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::total_shares<T0, T1>(v0);
        ((0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor((0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::reserve_x<T0, T1>(v0) as u128), arg2, v1) as u64), (0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor((0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::bin::reserve_y<T0, T1>(v0) as u128), arg2, v1) as u64))
    }
    ...
    fun prepare_remove<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: &vector<u32>, arg4: &mut vector<u128>, arg5: &0x2::clock::Clock, arg6: &0x1::option::Option<RemovalClaim>) : (u64, u64) {
        assert_version<T0, T1>(arg0);
        assert_not_flash_active<T0, T1>(arg0);
        ...
        assert!(v0 > 0, 404);
        assert!(0x1::option::is_some<RemovalClaim>(arg6) || v0 == 0x1::vector::length<u128>(arg4), 405);
        ...
        maybe_distribute_lp_yield<T0, T1>(arg0);
        if (0x1::option::is_some<RemovalClaim>(arg6)) {
            let v1 = 0x1::option::borrow<RemovalClaim>(arg6);
            *arg4 = quote_remove_liquidity_for_claim<T0, T1>(arg0, arg1, arg3, v1.numerator, v1.denominator, v1.idle_x, v1.idle_y);
            close_dust_removals<T0, T1>(arg0, arg1, arg3, arg4);
        };
    ...
    public fun quote_remove_liquidity<T0, T1>(arg0: &Pool<T0, T1>, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &vector<u32>, arg3: &vector<u128>) : (vector<u64>, vector<u64>, vector<bool>) {
        assert_not_flash_active<T0, T1>(arg0);
        assert_position_pool<T0, T1>(arg0, arg1);
        assert!(0x1::vector::length<u32>(arg2) == 0x1::vector::length<u128>(arg3), 405);
        assert_ascending_bins(arg2);
        let v0 = vector[];
        let v1 = vector[];
        let v2 = vector[];
        ...
        while (v3 < 0x1::vector::length<u32>(arg2)) {
            ...
            assert!(0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::has_bin(arg1, v4), 419);
            let v5 = 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::shares_in_bin(arg1, v4);
            let v6 = 0x1::u128::min(*0x1::vector::borrow<u128>(arg3, v3), v5);
            let (v7, v8, v9) = get_position_bin<T0, T1>(arg0, arg1, v4);
            let (v10, v11, v12) = if (v9 == 0) {
                (0, 0, true)
            } else {
                let v13 = (0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor((v7 as u128), v6, v9) as u64);
                let v14 = (0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor((v8 as u128), v6, v9) as u64);
                (v13, v14, meets_bin_floor(arg0.min_liquidity_x, arg0.min_liquidity_y, v7 - v13, v8 - v14, v9 - v6, v5 - v6))
            };
    ...
    public fun quote_remove_liquidity_for_claim<T0, T1>(arg0: &Pool<T0, T1>, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &vector<u32>, arg3: u64, arg4: u64, arg5: u64, arg6: u64) : vector<u128> {
        assert_not_flash_active<T0, T1>(arg0);
        assert_position_pool<T0, T1>(arg0, arg1);
        assert_ascending_bins(arg2);
        assert!(arg3 > 0 && arg3 <= arg4, 448);
        let v0 = (arg5 as u128);
        let v1 = (arg6 as u128);
        let v2 = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor(v0, (arg3 as u128), (arg4 as u128));
        let v3 = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor(v1, (arg3 as u128), (arg4 as u128));
        let v4 = vector[];
        let v5 = 0;
        while (v5 < 0x1::vector::length<u32>(arg2)) {
            let v6 = *0x1::vector::borrow<u32>(arg2, v5);
            assert!(0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::has_bin(arg1, v6), 419);
            let v7 = 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::shares_in_bin(arg1, v6);
            let (v8, v9, v10) = get_position_bin<T0, T1>(arg0, arg1, v6);
            let v11 = if (arg3 == arg4 || v10 == 0) {
                v7
            } else {
                let v12 = v0 + 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor((v8 as u128), v7, v10);
                v0 = v12;
                let v13 = v1 + 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor((v9 as u128), v7, v10);
                v1 = v13;
                v2 = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor(v12, (arg3 as u128), (arg4 as u128));
                v3 = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_floor(v13, (arg3 as u128), (arg4 as u128));
                let v14 = if (v8 == 0) {
                    0
                } else {
                    0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_ceil(v2 - v2, v10, (v8 as u128))
                };
                let v15 = if (v9 == 0) {
                    0
                } else {
                    0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::mul_div_ceil(v3 - v3, v10, (v9 as u128))
                };
                0x1::u128::max(v14, v15)
            };
            0x1::vector::push_back<u128>(&mut v4, v11);
            v5 = v5 + 1;
        };
        v4
    }
    ...
    fun refresh_claim_removal<T0, T1>(arg0: &Pool<T0, T1>, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &vector<u32>, arg3: &mut vector<u128>, arg4: &RemovalClaim) : bool {
        let v0 = quote_remove_liquidity_for_claim<T0, T1>(arg0, arg1, arg2, arg4.numerator, arg4.denominator, arg4.idle_x, arg4.idle_y);
        let v1 = false;
        let v2 = 0;
        while (v2 < 0x1::vector::length<u128>(&v0)) {
            if (*0x1::vector::borrow<u128>(&v0, v2) > *0x1::vector::borrow<u128>(arg3, v2)) {
                *0x1::vector::borrow_mut<u128>(arg3, v2) = *0x1::vector::borrow<u128>(&v0, v2);
                v1 = true;
            };
            v2 = v2 + 1;
        };
        close_dust_removals<T0, T1>(arg0, arg1, arg2, arg3) || v1
    }
    ...
    public fun remove_liquidity_for_claim<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: vector<u32>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, vector<u64>, vector<u64>) {
        let v0 = RemovalClaim{
            numerator   : arg4,
            denominator : arg5,
            idle_x      : arg6,
        ...
        remove_liquidity_impl<T0, T1>(arg0, arg1, arg2, arg3, vector[], arg8, arg9, arg10, arg11, arg12, true, 0x1::option::some<RemovalClaim>(v0))
    }

    fun remove_liquidity_impl<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: vector<u32>, arg4: vector<u128>, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext, arg10: bool, arg11: 0x1::option::Option<RemovalClaim>) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, vector<u64>, vector<u64>) {
        assert_not_sui<T0>();
        assert_not_sui<T1>();
        check_remove_deadline(arg8, arg7);
        let v0 = &mut arg4;
        let (v1, v2) = prepare_remove<T0, T1>(arg0, arg1, arg2, &arg3, v0, arg8, &arg11);
        let v3 = v2;
        let v4 = v1;
        ...
        let v7;
        loop {
            let v8 = 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::lp_yield_growth_x(&arg0.lending);
            let v9 = 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::lp_yield_growth_y(&arg0.lending);
            v7 = new_remove_plan<T0, T1>(arg0, v4, v3);
            let (v10, v11) = remove_needs<T0, T1>(&v7);
            if (should_jit_recall<T0, T1>(arg0)) {
                0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::jit_recall_if_short_x<T0, T1>(&mut arg0.lending, &mut arg0.custody, arg2, v5, v10, arg8, arg9);
                0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::jit_recall_if_short_y<T0, T1>(&mut arg0.lending, &mut arg0.custody, arg2, v5, v11, arg8, arg9);
            };
            if (0x1::option::is_some<RemovalClaim>(&arg11)) {
                maybe_distribute_lp_yield<T0, T1>(arg0);
            };
            let v12 = v8 != 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::lp_yield_growth_x(&arg0.lending) || v9 != 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::lp_yield_growth_y(&arg0.lending);
            let v13 = if (0x1::option::is_some<RemovalClaim>(&arg11)) {
                if (v12) {
                    let v14 = &mut arg4;
                    refresh_claim_removal<T0, T1>(arg0, arg1, &arg3, v14, 0x1::option::borrow<RemovalClaim>(&arg11))
                } else {
                    false
                }
            } else {
            ...
            if (v13 && !v6) {
                ...
                let (v18, v19) = preview_remove<T0, T1>(arg0, arg1, &arg3, &arg4);
                v3 = v19;
                v4 = v18;
                v6 = true;
            } else {
        ...
        let v20 = finish_remove_recall<T0, T1>(arg0, arg1, &arg3, &arg4, v7);
        finish_remove<T0, T1>(arg0, arg1, v5, arg3, &arg4, v20, arg5, arg6, arg9, arg10)
    }
    ...
    public fun remove_liquidity_no_lending<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: vector<u32>, arg3: vector<u128>, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let (v0, v1, _, _) = remove_liquidity_no_lending_impl<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, false);
        (v0, v1)
    }

    fun remove_liquidity_no_lending_impl<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: vector<u32>, arg3: vector<u128>, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext, arg9: bool) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, vector<u64>, vector<u64>) {
        ...
        finish_remove<T0, T1>(arg0, arg1, v2, arg2, &arg3, v4, arg4, arg5, arg8, arg9)
    }

    public fun remove_liquidity_no_lending_with_position_values<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: vector<u32>, arg3: vector<u128>, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, vector<u64>, vector<u64>) {
        remove_liquidity_no_lending_impl<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, true)
    }

    public fun remove_liquidity_with_position_values<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: vector<u32>, arg4: vector<u128>, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, vector<u64>, vector<u64>) {
        remove_liquidity_impl<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, true, 0x1::option::none<RemovalClaim>())
    }
    ...
    public fun remove_liquidity_x_sui<T0>(arg0: &mut Pool<0x2::sui::SUI, T0>, arg1: &mut 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: vector<u32>, arg4: vector<u128>, arg5: &mut 0x3::sui_system::SuiSystemState, arg6: u64, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        let (v0, v1, _, _) = remove_liquidity_x_sui_impl<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, false, 0x1::option::none<RemovalClaim>());
        (v0, v1)
    }

    public fun remove_liquidity_x_sui_for_claim<T0>(arg0: &mut Pool<0x2::sui::SUI, T0>, arg1: &mut 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: vector<u32>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: u64, arg10: u64, arg11: u64, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>, vector<u64>, vector<u64>) {
        let v0 = RemovalClaim{
            numerator   : arg4,
            denominator : arg5,
            idle_x      : arg6,
        ...
        remove_liquidity_x_sui_impl<T0>(arg0, arg1, arg2, arg3, vector[], arg8, arg9, arg10, arg11, arg12, arg13, true, 0x1::option::some<RemovalClaim>(v0))
    }

    fun remove_liquidity_x_sui_impl<T0>(arg0: &mut Pool<0x2::sui::SUI, T0>, arg1: &mut 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: vector<u32>, arg4: vector<u128>, arg5: &mut 0x3::sui_system::SuiSystemState, arg6: u64, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext, arg11: bool, arg12: 0x1::option::Option<RemovalClaim>) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>, vector<u64>, vector<u64>) {
        check_remove_deadline(arg9, arg8);
        let v0 = &mut arg4;
        let (v1, v2) = prepare_remove<0x2::sui::SUI, T0>(arg0, arg1, arg2, &arg3, v0, arg9, &arg12);
        let v3 = v2;
        let v4 = v1;
        let v5 = 0x2::object::id<Pool<0x2::sui::SUI, T0>>(arg0);
        let v6 = false;
        let v7;
        loop {
            let v8 = 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::lp_yield_growth_x(&arg0.lending);
            let v9 = 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::lp_yield_growth_y(&arg0.lending);
            v7 = new_remove_plan<0x2::sui::SUI, T0>(arg0, v4, v3);
            let (v10, v11) = remove_needs<0x2::sui::SUI, T0>(&v7);
            if (should_jit_recall<0x2::sui::SUI, T0>(arg0)) {
                0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::jit_recall_if_short_x_sui<T0>(&mut arg0.lending, &mut arg0.custody, arg2, v5, v10, arg5, arg9, arg10);
                0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::jit_recall_if_short_y<0x2::sui::SUI, T0>(&mut arg0.lending, &mut arg0.custody, arg2, v5, v11, arg9, arg10);
            };
            if (0x1::option::is_some<RemovalClaim>(&arg12)) {
                maybe_distribute_lp_yield<0x2::sui::SUI, T0>(arg0);
            };
            let v12 = v8 != 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::lp_yield_growth_x(&arg0.lending) || v9 != 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending::lp_yield_growth_y(&arg0.lending);
            let v13 = if (0x1::option::is_some<RemovalClaim>(&arg12)) {
                if (v12) {
                    let v14 = &mut arg4;
                    refresh_claim_removal<0x2::sui::SUI, T0>(arg0, arg1, &arg3, v14, 0x1::option::borrow<RemovalClaim>(&arg12))
                } else {
                    false
                }
            } else {
            ...
            if (v13 && !v6) {
                ...
                let (v18, v19) = preview_remove<0x2::sui::SUI, T0>(arg0, arg1, &arg3, &arg4);
                v3 = v19;
                v4 = v18;
                v6 = true;
            } else {
        ...
        let v20 = finish_remove_recall<0x2::sui::SUI, T0>(arg0, arg1, &arg3, &arg4, v7);
        finish_remove<0x2::sui::SUI, T0>(arg0, arg1, v5, arg3, &arg4, v20, arg6, arg7, arg10, arg11)
    }

    public fun remove_liquidity_x_sui_with_position_values<T0>(arg0: &mut Pool<0x2::sui::SUI, T0>, arg1: &mut 0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::position::Position, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: vector<u32>, arg4: vector<u128>, arg5: &mut 0x3::sui_system::SuiSystemState, arg6: u64, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>, vector<u64>, vector<u64>) {
        remove_liquidity_x_sui_impl<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, true, 0x1::option::none<RemovalClaim>())
    }
    ...
    public entry fun set_pool_fee_params<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminRegistry, arg1: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::OperatorCap, arg2: &mut Pool<T0, T1>, arg3: 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fee_params::FeeParameters) {
        0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::assert_operator_cap(arg0, arg1);
        assert_version<T0, T1>(arg2);
        assert_not_flash_active<T0, T1>(arg2);
    ...
    public entry fun set_pool_permissions<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminCap, arg1: &mut Pool<T0, T1>, arg2: u64) {
    ...
    public entry fun unpause<T0, T1>(arg0: &0x2a42d9160d0f08ca0041572966b8fabbb242a25e8bd27e569310462755baa34e::admin::AdminCap, arg1: &mut Pool<T0, T1>) {
        assert_version<T0, T1>(arg1);
        assert_not_flash_active<T0, T1>(arg1);
        arg1.paused = false;
