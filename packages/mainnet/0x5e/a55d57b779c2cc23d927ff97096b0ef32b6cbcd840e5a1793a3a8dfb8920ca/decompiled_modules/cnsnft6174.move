module 0x5ea55d57b779c2cc23d927ff97096b0ef32b6cbcd840e5a1793a3a8dfb8920ca::cnsnft6174 {
    struct CNSNFT6174 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6174, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6174>(arg0, arg1);
