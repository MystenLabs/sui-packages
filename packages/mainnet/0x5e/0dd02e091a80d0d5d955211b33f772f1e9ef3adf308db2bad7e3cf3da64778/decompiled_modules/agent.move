module 0x5e0dd02e091a80d0d5d955211b33f772f1e9ef3adf308db2bad7e3cf3da64778::agent {
    ...
    fun init(arg0: AGENT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AGENT>(arg0, 9, b"TESTAISUIX", b"testaisuiXXX", b"test agent on aiSUI, check if everything is OK", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/bafkreigmh4amjri7cfpchgyaw23tuzhbnmqrvbkmewi26hsulqrezg6mly")), arg1);
