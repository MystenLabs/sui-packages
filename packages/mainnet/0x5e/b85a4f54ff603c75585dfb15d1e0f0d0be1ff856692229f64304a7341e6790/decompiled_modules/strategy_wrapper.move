module 0x5eb85a4f54ff603c75585dfb15d1e0f0d0be1ff856692229f64304a7341e6790::strategy_wrapper {
    ...
    public fun create_strategy_owner_cap<T0>(arg0: 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) : StrategyOwnerCap<T0> {
        assert!(is_valid_strategy_type(arg1), 2);
        let v0 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::obligation_id<T0>(&arg0);
        let v1 = StrategyOwnerCap<T0>{
            id            : 0x2::object::new(arg2),
            version       : 1,
            inner_cap     : arg0,
            strategy_type : arg1,
        };
        let v2 = CreatedStrategyOwnerCap{
            cap_id        : 0x2::object::id_address<StrategyOwnerCap<T0>>(&v1),
            obligation_id : 0x2::object::id_to_address(&v0),
            strategy_type : v1.strategy_type,
        };
        0x2::event::emit<CreatedStrategyOwnerCap>(v2);
        v1
    }
