module 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::rip_station {
    ...
    struct Store has store, key {
        ...
        vaults: 0x2::table::Table<0x1::string::String, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::Vault>,
    ...
    entry fun init_card_type<T0>(arg0: &mut Store, arg1: &0x2::package::Publisher, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::init_card_type<T0>(arg1, arg2, arg3, arg4, arg5);
        0x2::bag::add<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicy<0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>>(&mut arg0.transfer_policies, v0, v1);
        0x2::bag::add<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicyCap<0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>>(&mut arg0.transfer_policy_caps, v0, v2);
    ...
    entry fun burn_cards<T0>(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: 0x1::string::String, arg3: vector<0x2::object::ID>, arg4: u64, arg5: vector<u8>, arg6: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<0x1::string::String, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::Vault>(&arg1.vaults, arg2), 10);
        let v2 = 0x2::table::borrow_mut<0x1::string::String, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::Vault>(&mut arg1.vaults, arg2);
        let v3 = 0;
        while (v3 < 0x1::vector::length<0x2::object::ID>(&arg3)) {
            let v4 = *0x1::vector::borrow<0x2::object::ID>(&arg3, v3);
            0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::burn_card<T0>(0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::remove_by_id<T0>(v2, v4), false);
    ...
    entry fun burn_redeem_card<T0>(arg0: &0x2::clock::Clock, arg1: &Store, arg2: 0x1::string::String, arg3: 0x2::object::ID, arg4: &mut 0x2::kiosk::Kiosk, arg5: u64, arg6: vector<u8>, arg7: &0x2::tx_context::TxContext) {
        ...
        0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::burn_card<T0>(0x2::bag::remove<RedeemTicket, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>(v4, v5), true);
    ...
    fun buy_packs_into_kiosk<T0>(arg0: &0x2::random::Random, arg1: &mut Store, arg2: 0x1::string::String, arg3: u64, arg4: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: bool, arg8: &mut 0x2::tx_context::TxContext) {
        verify_version(arg1);
        assert!(0x2::table::contains<0x1::string::String, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::Vault>(&arg1.vaults, arg2), 10);
        let v0 = 0x2::table::borrow_mut<0x1::string::String, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::Vault>(&mut arg1.vaults, arg2);
        ...
        let v4 = &mut v3;
        assert!(0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::card_type(v0) == 0x1::type_name::with_defining_ids<T0>(), 13);
        let v5 = 0x1::vector::empty<0x2::object::ID>();
        while (arg3 > 0) {
            let v6 = 0;
            let v7 = 0x1::vector::empty<0x2::object::ID>();
            while (v6 < v1.pack_size) {
                let v8 = 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::remove_by_index<T0>(v0, 0x2::random::generate_u64_in_range(v4, 0, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::length(v0) - 1));
                0x1::vector::push_back<0x2::object::ID>(&mut v5, 0x2::object::id<0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>(&v8));
                0x1::vector::push_back<0x2::object::ID>(&mut v7, 0x2::object::id<0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>(&v8));
                0x2::kiosk::lock<0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>(arg5, arg6, 0x2::bag::borrow<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicy<0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>>(&arg1.transfer_policies, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::card_type(v0)), v8);
                v6 = v6 + 1;
            };
    ...
    public fun deposit_card_for_redeem<T0>(arg0: &Store, arg1: &mut RedeemCardsRequest, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::bag::add<RedeemTicket, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>(0x2::kiosk_extension::storage_mut<RipStationExt>(v4, arg3), v5, v3);
    ...
    public fun deposit_cards_for_reveal<T0>(arg0: &Store, arg1: vector<0x2::object::ID>, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < 0x1::vector::length<0x2::object::ID>(&arg1)) {
            ...
            0x2::bag::add<RevealTicket, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>(0x2::kiosk_extension::storage_mut<RipStationExt>(v4, arg2), v5, v3);
    ...
    fun init(arg0: RIP_STATION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Store{
            ...
            vaults               : 0x2::table::new<0x1::string::String, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::Vault>(arg1),
    ...
    entry fun mint_cards<T0>(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: vector<0x1::string::String>, arg3: vector<vector<u8>>, arg4: 0x1::string::String, arg5: u64, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<u64>(&arg5));
        assert!(0x2::ed25519::ed25519_verify(&arg6, &arg1.public_key, &v0), 4);
        assert!(0x2::table::contains<0x1::string::String, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::Vault>(&arg1.vaults, arg4), 10);
        let v2 = 0x2::table::borrow_mut<0x1::string::String, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::Vault>(&mut arg1.vaults, arg4);
        ...
        assert!(0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::card_type(v2) == 0x1::type_name::with_defining_ids<T0>(), 13);
        let v4 = 0x1::vector::length<0x1::string::String>(&arg2);
        assert!(v4 == 0x1::vector::length<vector<u8>>(&arg3), 9);
        let v5 = 0;
        while (v5 < v4) {
            let v6 = 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::mint_card<T0>(v3.placeholder_name, v3.placeholder_description, v3.placeholder_media_url, 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>(), *0x1::vector::borrow<vector<u8>>(&arg3, v5), false, arg7);
            0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::add<T0>(v2, v6);
            let v7 = CardMintedEvent{
                id         : *0x1::vector::borrow<0x1::string::String>(&arg2, v5),
                card_id    : 0x2::object::id<0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>(&v6),
                vault_name : arg4,
            };
    ...
    public fun redeem_card<T0>(arg0: &Store, arg1: &mut RedeemCardsRequest, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0, 9);
        0x1::vector::swap_remove<0x2::object::ID>(&mut arg1.card_ids, v1);
        0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::burn_card<T0>(remove_card_from_kiosk<T0>(arg0, arg3, arg4, arg2, arg5), true);
        let v2 = CardRedeemedEvent{card_id: arg2};
        0x2::event::emit<CardRedeemedEvent>(v2);
    }

    fun remove_card_from_kiosk<T0>(arg0: &Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) : 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0> {
        let (v0, v1) = 0x2::kiosk::purchase_with_cap<0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>(arg1, 0x2::kiosk::list_with_purchase_cap<0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>(arg1, arg2, arg3, 0, arg4), 0x2::coin::zero<0x2::sui::SUI>(arg4));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicy<0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>>(&arg0.transfer_policies, 0x1::type_name::with_defining_ids<T0>()), v1);
        v0
    }
    ...
    entry fun reveal_and_return<T0>(arg0: &0x2::clock::Clock, arg1: &Store, arg2: 0x2::object::ID, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: vector<0x1::string::String>, arg7: vector<0x1::string::String>, arg8: vector<u8>, arg9: u64, arg10: vector<u8>, arg11: &mut 0x2::kiosk::Kiosk, arg12: &0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::bag::remove<RevealTicket, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>(v3, v4);
        0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::reveal_card<T0>(&mut v5, arg3, arg4, arg5, 0x2::vec_map::from_keys_values<0x1::string::String, 0x1::string::String>(arg6, arg7), arg8);
        let v6 = RipStationExt{dummy_field: false};
        0x2::kiosk_extension::lock<RipStationExt, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>(v6, arg11, v5, 0x2::bag::borrow<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicy<0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::Card<T0>>>(&arg1.transfer_policies, 0x1::type_name::with_defining_ids<T0>()));
    ...
    public fun sell_card<T0>(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: u128, arg3: 0x2::object::ID, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: vector<u8>, arg9: &mut 0x2::kiosk::Kiosk, arg10: &0x2::kiosk::KioskOwnerCap, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::card::burn_card<T0>(remove_card_from_kiosk<T0>(arg1, arg9, arg10, arg3, arg11), true);
    ...
    entry fun set_vault_config<T0>(arg0: &mut Store, arg1: 0x1::string::String, arg2: bool, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<0x1::string::String, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::Vault>(&arg0.vaults, arg1)) {
            0x2::table::add<0x1::string::String, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::Vault>(&mut arg0.vaults, arg1, 0x5e705cef767cfec2153cbc0f1a9af1603db254ff1baf958d3b99405f17b93c4d::vault::new<T0>(arg9));
        };
