module 0x5eccf0f69e2dacf63ab6cbe5bab390ed1319dc0ea2f95f410d70d3839268b97e::cnsnft6396 {
    struct CNSNFT6396 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6396, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4144"));
        let v4 = 0x2::package::claim<CNSNFT6396>(arg0, arg1);
