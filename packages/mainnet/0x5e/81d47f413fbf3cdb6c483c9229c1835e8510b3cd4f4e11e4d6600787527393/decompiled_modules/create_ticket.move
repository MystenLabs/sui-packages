module 0x5e81d47f413fbf3cdb6c483c9229c1835e8510b3cd4f4e11e4d6600787527393::create_ticket {
    ...
    fun init(arg0: CREATE_TICKET, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://vwin.wtf"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{img_url}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"vwin.wtf, Try Your Luck!!"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://vwin.wtf"));
