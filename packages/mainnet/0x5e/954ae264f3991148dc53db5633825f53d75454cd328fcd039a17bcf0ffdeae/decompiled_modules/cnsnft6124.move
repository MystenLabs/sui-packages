module 0x5e954ae264f3991148dc53db5633825f53d75454cd328fcd039a17bcf0ffdeae::cnsnft6124 {
    struct CNSNFT6124 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6124, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6124>(arg0, arg1);
