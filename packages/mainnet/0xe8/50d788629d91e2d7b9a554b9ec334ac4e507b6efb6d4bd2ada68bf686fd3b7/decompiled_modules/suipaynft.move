module 0xe850d788629d91e2d7b9a554b9ec334ac4e507b6efb6d4bd2ada68bf686fd3b7::suipaynft {
    ...
    fun mintInternal(arg0: vector<0x1::string::String>, arg1: &mut ContractInfo, arg2: u64, arg3: 0x1::string::String, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = NFT{
            ...
            traits : arg0,
            name   : arg3,
            nr     : convert((genNextFree(0xe850d788629d91e2d7b9a554b9ec334ac4e507b6efb6d4bd2ada68bf686fd3b7::random::rand_u64(arg6) % (1234 as u64), arg1) as u16)),
        };
        let v1 = NFTMinted{
