module 0xacbb0ff390420ba37e097f110e2fa5d63e647a42545c1643789f223c8b086aed::asset {
    ...
    public(friend) fun new<T0>(arg0: 0xacbb0ff390420ba37e097f110e2fa5d63e647a42545c1643789f223c8b086aed::interest::InterestModel, arg1: AssetConfig, arg2: &mut 0x2::tx_context::TxContext) : Asset<T0> {
        let v0 = Asset<T0>{
    ...
    public(friend) fun interest_model<T0>(arg0: &Asset<T0>) : &0xacbb0ff390420ba37e097f110e2fa5d63e647a42545c1643789f223c8b086aed::interest::InterestModel {
        &arg0.interest_model
    }
    ...
    public(friend) fun update_interest_model<T0>(arg0: &mut Asset<T0>, arg1: 0xacbb0ff390420ba37e097f110e2fa5d63e647a42545c1643789f223c8b086aed::interest::InterestModel) {
