module 0xe8b1463753a8ae9f01f4a4a4d5c09548198984889ae1767b9ce02c0285293dd0::delayed_relays {
    struct DELAYED_RELAYS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DELAYED_RELAYS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DELAYED_RELAYS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Delayed Relays"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Delayed Relays "));
