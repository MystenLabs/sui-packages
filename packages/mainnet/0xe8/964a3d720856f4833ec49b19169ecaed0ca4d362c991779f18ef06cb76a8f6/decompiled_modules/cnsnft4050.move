module 0xe8964a3d720856f4833ec49b19169ecaed0ca4d362c991779f18ef06cb76a8f6::cnsnft4050 {
    struct CNSNFT4050 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4050, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4050>(arg0, arg1);
