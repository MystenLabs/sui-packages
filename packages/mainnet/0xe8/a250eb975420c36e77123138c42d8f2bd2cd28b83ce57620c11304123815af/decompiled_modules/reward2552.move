module 0xe8a250eb975420c36e77123138c42d8f2bd2cd28b83ce57620c11304123815af::reward2552 {
    struct REWARD2552 has drop {
        dummy_field: bool,
    }

    struct TICKET_2552 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2552(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2552>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2552>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2552, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2552>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2552>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2552>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2552>>(v5, 0x2::tx_context::sender(arg1));
    }
