module 0xe88baecaf0ab96b48e01515f490b5a8643c2081610d50cdc67017272b9c3edac::cnsnft8153 {
    struct CNSNFT8153 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8153, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8153>(arg0, arg1);
