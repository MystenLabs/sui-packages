module 0xe8bbfc18b792134b9bf02c9fd65e254b5da25bc221334c07c24aefd3be776e99::lb_position {
    ...
    public(friend) fun collect_fees(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        if (0x2::table::contains<u32, LBBinPosition>(&v2.bins, arg2)) {
            ...
            v3.fees_pending_x = 0xe8bbfc18b792134b9bf02c9fd65e254b5da25bc221334c07c24aefd3be776e99::safe_math::add_u64(v3.fees_pending_x, v0);
            v3.fees_pending_y = 0xe8bbfc18b792134b9bf02c9fd65e254b5da25bc221334c07c24aefd3be776e99::safe_math::add_u64(v3.fees_pending_y, v1);
    ...
    public(friend) fun decrease_liquidity(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: &0x2::clock::Clock) : u128 {
        ...
        let v2 = if (v1.amount == 0) {
            if (v1.fees_pending_x == 0) {
                v1.fees_pending_y == 0
            } else {
                false
            }
    ...
    public fun get_total_pending_fees(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (u64, u64) {
        ...
        while (arg2 <= arg3) {
            if (0x2::table::contains<u32, LBBinPosition>(&v0.bins, arg2)) {
                ...
                v1 = 0xe8bbfc18b792134b9bf02c9fd65e254b5da25bc221334c07c24aefd3be776e99::safe_math::add_u64(v1, v3.fees_pending_x);
                v2 = 0xe8bbfc18b792134b9bf02c9fd65e254b5da25bc221334c07c24aefd3be776e99::safe_math::add_u64(v2, v3.fees_pending_y);
            };
            arg2 = arg2 + 1;
        };
        (v1, v2)
    ...
    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128) : u128 {
        ...
        if (0x2::table::contains<u32, LBBinPosition>(&v0.bins, arg2)) {
            let v1 = 0x2::table::borrow_mut<u32, LBBinPosition>(&mut v0.bins, arg2);
            v1.amount = 0xe8bbfc18b792134b9bf02c9fd65e254b5da25bc221334c07c24aefd3be776e99::safe_math::add_u128(v1.amount, arg3);
        } else {
        ...
        *v3 = 0xe8bbfc18b792134b9bf02c9fd65e254b5da25bc221334c07c24aefd3be776e99::safe_math::add_u128(*v3, arg3);
        *v3
    }
    ...
    public(friend) fun withdraw_fees(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32) : (u64, u64) {
        ...
        let v1 = 0x2::table::borrow_mut<u32, LBBinPosition>(&mut v0.bins, arg2);
        let v2 = v1.fees_pending_x;
        let v3 = v1.fees_pending_y;
        v1.fees_pending_x = 0;
        v1.fees_pending_y = 0;
        let v4 = if (v1.amount == 0) {
            if (v2 == 0) {
                v3 == 0
            } else {
                false
