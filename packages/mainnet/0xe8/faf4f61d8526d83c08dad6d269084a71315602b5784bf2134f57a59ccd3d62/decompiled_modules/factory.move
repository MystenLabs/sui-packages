module 0xe8faf4f61d8526d83c08dad6d269084a71315602b5784bf2134f57a59ccd3d62::factory {
    ...
    struct FeeCollectorUpdated has copy, drop {
    ...
    public fun create_pool<T0, T1>(arg0: &mut Factory, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xe8faf4f61d8526d83c08dad6d269084a71315602b5784bf2134f57a59ccd3d62::lp_coin::LP<T0, T1>> {
        ...
        let (v2, v3) = 0xe8faf4f61d8526d83c08dad6d269084a71315602b5784bf2134f57a59ccd3d62::pool::create_pool<T0, T1>(arg2, arg3, arg0.fee_collector, arg4, arg5);
        let v4 = v2;
        let v5 = 0x2::object::id_address<0xe8faf4f61d8526d83c08dad6d269084a71315602b5784bf2134f57a59ccd3d62::pool::Pool<T0, T1>>(&v4);
        0x2::table::add<PairKey, address>(&mut arg0.pools, v0, v5);
        arg0.pool_count = arg0.pool_count + 1;
        0xe8faf4f61d8526d83c08dad6d269084a71315602b5784bf2134f57a59ccd3d62::pool::share_pool<T0, T1>(v4);
        let v6 = PoolCreated{
            pool_id     : v5,
            coin_a      : v0.coin_a,
            coin_b      : v0.coin_b,
    ...
    public entry fun update_fee_collector(arg0: &AdminCap, arg1: &mut Factory, arg2: address) {
        ...
        let v0 = FeeCollectorUpdated{
            old_collector : arg1.fee_collector,
            new_collector : arg2,
        };
        0x2::event::emit<FeeCollectorUpdated>(v0);
    }
