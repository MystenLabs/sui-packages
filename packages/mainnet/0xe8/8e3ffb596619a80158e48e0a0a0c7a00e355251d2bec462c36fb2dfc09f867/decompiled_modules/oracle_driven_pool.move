module 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::oracle_driven_pool {
    ...
    struct BaseKConfigKey has copy, drop, store {
        dummy_field: bool,
    }

    struct BasePriceFeedIdProKey has copy, drop, store {
        dummy_field: bool,
    }

    struct QuoteUsdPriceBoundsKey has copy, drop, store {
        dummy_field: bool,
    }

    struct BaseKConfig has drop, store {
        size_thresholds: vector<u64>,
        buy_k_tiers: vector<u64>,
        sell_k_tiers: vector<u64>,
    }

    struct BasePriceFeedIdPro has drop, store {
        feed_id: u32,
    }

    struct QuoteUsdPriceBounds has drop, store {
        lower: u64,
        upper: u64,
    }
    ...
    struct UpdateBaseKConfigEvent has copy, drop {
        pool_id: 0x2::object::ID,
        operator: address,
        size_thresholds: vector<u64>,
        buy_k_tiers: vector<u64>,
    ...
    struct RemoveBaseKConfigEvent has copy, drop {
        pool_id: 0x2::object::ID,
        operator: address,
    }

    struct UpdateBasePriceFeedIdProEvent has copy, drop {
        pool_id: 0x2::object::ID,
        operator: address,
        feed_id: u32,
    }
    ...
    struct UpdateQuoteUsdPriceBoundsEvent has copy, drop {
        pool_id: 0x2::object::ID,
        operator: address,
        lower: u64,
        upper: u64,
    ...
    public fun add_pool<T0, T1>(arg0: &mut 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::ownable::AdminCap, arg1: &0x2::coin::CoinMetadata<T0>, arg2: &0x2::coin::CoinMetadata<T1>, arg3: address, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::ownable::register_pool(arg0, 0x1::string::from_ascii(v6), v3);
    ...
    fun assert_base_k_config(arg0: &vector<u64>, arg1: &vector<u64>, arg2: &vector<u64>) {
        let v0 = 0x1::vector::length<u64>(arg0);
        assert!(v0 > 0, 14);
        assert!(v0 == 0x1::vector::length<u64>(arg1), 14);
        ...
        while (v1 < v0) {
            ...
            assert_valid_k_value(*0x1::vector::borrow<u64>(arg1, v1));
            assert_valid_k_value(*0x1::vector::borrow<u64>(arg2, v1));
            v1 = v1 + 1;
        };
    }

    public fun assert_buying_allowed<T0, T1>(arg0: &Pool<T0, T1>) {
        assert!(arg0.controls.buying_allowed, 7);
    }

    public fun assert_closed<T0, T1>(arg0: &Pool<T0, T1>) {
        assert!(get_closed<T0, T1>(arg0), 10);
    }

    public fun assert_deposit_base_allowed<T0, T1>(arg0: &Pool<T0, T1>) {
        assert!(arg0.controls.deposit_base_allowed, 2);
    }

    public fun assert_deposit_quote_allowed<T0, T1>(arg0: &Pool<T0, T1>) {
        assert!(arg0.controls.deposit_quote_allowed, 3);
    }

    public fun assert_not_closed<T0, T1>(arg0: &Pool<T0, T1>) {
        assert!(!get_closed<T0, T1>(arg0), 9);
    }

    public fun assert_selling_allowed<T0, T1>(arg0: &Pool<T0, T1>) {
        assert!(arg0.controls.selling_allowed, 8);
    }

    public fun assert_trade_allowed<T0, T1>(arg0: &Pool<T0, T1>) {
        assert!(arg0.controls.trade_allowed, 6);
    }

    fun assert_valid_k_value(arg0: u64) {
        assert!(0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::lt_one(arg0), 1);
        assert!(arg0 > 0, 1);
    }

    public fun assert_version<T0, T1>(arg0: &Pool<T0, T1>) {
        assert!(arg0.version == 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::version::get_program_version(), 12);
    }
    ...
    public(friend) fun base_coin_pay_in<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::balance::Balance<T0>) {
        ...
        assert!(get_base_balance<T0, T1>(arg0) <= get_base_balance_limit<T0, T1>(arg0), 4);
    ...
    fun calculate_deviation_amounts<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64) : (vector<u64>, vector<u64>) {
        ...
        while (v0 < 0x1::vector::length<u64>(&arg0.core_data.deviation_thresholds)) {
            let v3 = 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::safe_mul_div_u64(*0x1::vector::borrow<u64>(&arg0.core_data.deviation_thresholds, v0), arg1, 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::get_one());
    ...
    fun calculate_total_slippage<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64, arg2: bool, arg3: u64) : u64 {
        calculate_trade_slippage<T0, T1>(arg0, arg1, arg2, arg3)
    }

    fun calculate_trade_slippage<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64, arg2: bool, arg3: u64) : u64 {
        ...
        let v9 = if (arg2) {
            ...
            while (v11 < 0x1::vector::length<u64>(&v8)) {
                0x1::vector::push_back<u64>(&mut v10, 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::mul(*0x1::vector::borrow<u64>(&v8, v11), arg3));
                v11 = v11 + 1;
            };
            v10
        };
        ...
        while (v14 < 0x1::vector::length<u64>(&v12)) {
            ...
            if (v16 > 0) {
                ...
                if (v14 == 0) {
                    v15 = v15 + 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::mul(v17, get_trade_k_without_deviation<T0, T1>(arg0, arg2, get_trade_base_amount(arg1, arg2, arg3)));
                } else {
                    v15 = v15 + 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::mul(v17, *0x1::vector::borrow<u64>(&arg0.core_data.k_deviation_tiers, v14 - 1));
                };
            };
            v14 = v14 + 1;
        };
    ...
    public fun check_parameters<T0, T1>(arg0: &Pool<T0, T1>) {
        assert_valid_k_value(get_k_without_deviation<T0, T1>(arg0));
        if (has_base_k_config<T0, T1>(arg0)) {
            let v0 = BaseKConfigKey{dummy_field: false};
            let v1 = 0x2::dynamic_field::borrow<BaseKConfigKey, BaseKConfig>(&arg0.id, v0);
            assert_base_k_config(&v1.size_thresholds, &v1.buy_k_tiers, &v1.sell_k_tiers);
        };
    }
    ...
    public(friend) fun claim_assets<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<BasePoolLiquidityCoin<T0, T1>>, arg2: 0x2::coin::Coin<QuotePoolLiquidityCoin<T0, T1>>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        assert!(v0 > 0 || v1 > 0, 11);
        let v2 = if (v0 > 0) {
            0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::safe_mul_div_u64(get_quote_balance<T0, T1>(arg0), v0, get_quote_capital_coin_supply<T0, T1>(arg0))
        } else {
            0
        };
        let v3 = if (v1 > 0) {
            0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::safe_mul_div_u64(get_base_balance<T0, T1>(arg0), v1, get_base_capital_coin_supply<T0, T1>(arg0))
        } else {
            0
        };
    ...
    fun copy_vector_u64(arg0: &vector<u64>) : vector<u64> {
    ...
    public(friend) fun destroy_pool<T0, T1>(arg0: &mut 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::ownable::AdminCap, arg1: &Pool<T0, T1>) {
        assert_closed<T0, T1>(arg1);
        assert!(get_base_balance<T0, T1>(arg1) == 0 || get_quote_balance<T0, T1>(arg1) == 0, 13);
        let (_, _, v2) = get_coin_types<T0, T1>();
        0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::ownable::destroy_pool(arg0, 0x1::string::from_ascii(v2));
    }
    ...
    public fun get_base_k_config<T0, T1>(arg0: &Pool<T0, T1>) : (bool, vector<u64>, vector<u64>, vector<u64>) {
        if (!has_base_k_config<T0, T1>(arg0)) {
            return (false, 0x1::vector::empty<u64>(), 0x1::vector::empty<u64>(), 0x1::vector::empty<u64>())
        };
        let v0 = BaseKConfigKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow<BaseKConfigKey, BaseKConfig>(&arg0.id, v0);
        (true, copy_vector_u64(&v1.size_thresholds), copy_vector_u64(&v1.buy_k_tiers), copy_vector_u64(&v1.sell_k_tiers))
    }

    fun get_base_k_for_amount(arg0: &BaseKConfig, arg1: bool, arg2: u64) : u64 {
        let v0 = &arg0.size_thresholds;
        let v1 = if (arg1) {
            &arg0.buy_k_tiers
        } else {
            &arg0.sell_k_tiers
        ...
        let v3 = 0;
        while (v3 < v2) {
            if (arg2 <= *0x1::vector::borrow<u64>(v0, v3)) {
                return *0x1::vector::borrow<u64>(v1, v3)
            };
            v3 = v3 + 1;
        };
    ...
    public fun get_base_price_feed_id_pro<T0, T1>(arg0: &Pool<T0, T1>) : u32 {
        assert!(has_base_price_feed_id_pro<T0, T1>(arg0), 15);
        let v0 = BasePriceFeedIdProKey{dummy_field: false};
        0x2::dynamic_field::borrow<BasePriceFeedIdProKey, BasePriceFeedIdPro>(&arg0.id, v0).feed_id
    }
    ...
    public fun get_lp_base_balance<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64) : u64 {
        ...
        if (v0 == 0) {
            ...
            0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::safe_mul_div_u64(arg1, get_base_balance<T0, T1>(arg0), v0)
        }
    }
    ...
    public fun get_lp_quote_balance<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64) : u64 {
        ...
        if (v0 == 0) {
            ...
            0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::safe_mul_div_u64(arg1, get_quote_balance<T0, T1>(arg0), v0)
        }
    }
    ...
    public fun get_quote_usd_price_bounds<T0, T1>(arg0: &Pool<T0, T1>) : (u64, u64) {
        let v0 = QuoteUsdPriceBoundsKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<QuoteUsdPriceBoundsKey>(&arg0.id, v0)) {
            let v3 = QuoteUsdPriceBoundsKey{dummy_field: false};
            let v4 = 0x2::dynamic_field::borrow<QuoteUsdPriceBoundsKey, QuoteUsdPriceBounds>(&arg0.id, v3);
            (v4.lower, v4.upper)
        } else {
    ...
    fun get_trade_base_amount(arg0: u64, arg1: bool, arg2: u64) : u64 {
        if (arg1) {
            arg0
        } else {
            0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::mul(arg0, arg2)
        }
    }

    public fun get_trade_k_without_deviation<T0, T1>(arg0: &Pool<T0, T1>, arg1: bool, arg2: u64) : u64 {
        if (!has_base_k_config<T0, T1>(arg0)) {
            return arg0.core_data.k_without_deviation
        };
        let v0 = BaseKConfigKey{dummy_field: false};
        get_base_k_for_amount(0x2::dynamic_field::borrow<BaseKConfigKey, BaseKConfig>(&arg0.id, v0), arg1, normalize_base_amount(get_base_coin_decimals<T0, T1>(arg0), arg2))
    }
    ...
    public fun has_base_k_config<T0, T1>(arg0: &Pool<T0, T1>) : bool {
        let v0 = BaseKConfigKey{dummy_field: false};
        0x2::dynamic_field::exists_<BaseKConfigKey>(&arg0.id, v0)
    }

    public fun has_base_price_feed_id_pro<T0, T1>(arg0: &Pool<T0, T1>) : bool {
        let v0 = BasePriceFeedIdProKey{dummy_field: false};
        0x2::dynamic_field::exists_<BasePriceFeedIdProKey>(&arg0.id, v0)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::ownable::grant_admin_cap(0x2::tx_context::sender(arg0), arg0);
    }
    ...
    fun make_pool<T0, T1>(arg0: u8, arg1: u8, arg2: address, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : Pool<T0, T1> {
        ...
        Pool<T0, T1>{
            ...
            version             : 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::version::get_program_version(),
            controls            : v3,
            maintainer          : arg2,
            oracle_config       : v2,
    ...
    public(friend) fun migrate<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::version::get_program_version();
        assert!(arg0.version < v0, 12);
    ...
    fun normalize_base_amount(arg0: u8, arg1: u64) : u64 {
        if (arg0 > 9) {
            arg1 / 0x1::u64::pow(10, arg0 - 9)
        } else if (arg0 < 9) {
            arg1 * 0x1::u64::pow(10, 9 - arg0)
        } else {
            arg1
        }
    }
    ...
    fun query_buy_base_coin_internal<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64, arg2: u64) : u64 {
        ...
        0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::mul(0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::mul(arg2, 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::get_one() + calculate_total_slippage<T0, T1>(arg0, arg2, true, 0)), arg1)
    }
    ...
    fun query_sell_base_coin_internal<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64, arg2: u64) : u64 {
        ...
        0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::safe_mul_div_u64(arg2, arg1, 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::get_one() + calculate_total_slippage<T0, T1>(arg0, 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::mul(arg2, arg1), false, 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::safe_mul_div_u64(0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::get_one(), 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::get_one(), arg1)))
    }
    ...
    fun query_sell_quote_coin_internal<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64, arg2: u64) : u64 {
        ...
        0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::safe_mul_div_u64(arg2, arg1, 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::get_one() + calculate_total_slippage<T0, T1>(arg0, 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::mul(arg2, arg1), true, 0))
    }
    ...
    public(friend) fun quote_coin_pay_in<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::balance::Balance<T1>) {
        ...
        assert!(get_quote_balance<T0, T1>(arg0) <= get_quote_balance_limit<T0, T1>(arg0), 5);
    ...
    public(friend) fun remove_base_k_config<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::tx_context::TxContext) {
        let v0 = BaseKConfigKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<BaseKConfigKey>(&arg0.id, v0)) {
            let v1 = BaseKConfigKey{dummy_field: false};
            0x2::dynamic_field::remove<BaseKConfigKey, BaseKConfig>(&mut arg0.id, v1);
        };
        let v2 = RemoveBaseKConfigEvent{
            pool_id  : 0x2::object::id<Pool<T0, T1>>(arg0),
            operator : 0x2::tx_context::sender(arg1),
        };
        0x2::event::emit<RemoveBaseKConfigEvent>(v2);
    }
    ...
    public(friend) fun set_base_k_config<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<u64>, arg2: vector<u64>, arg3: vector<u64>, arg4: &0x2::tx_context::TxContext) {
        assert_base_k_config(&arg1, &arg2, &arg3);
        let v0 = BaseKConfigKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<BaseKConfigKey>(&arg0.id, v0)) {
            let v1 = BaseKConfigKey{dummy_field: false};
            0x2::dynamic_field::remove<BaseKConfigKey, BaseKConfig>(&mut arg0.id, v1);
        };
        let v2 = BaseKConfigKey{dummy_field: false};
        let v3 = BaseKConfig{
            size_thresholds : copy_vector_u64(&arg1),
            buy_k_tiers     : copy_vector_u64(&arg2),
            sell_k_tiers    : copy_vector_u64(&arg3),
        };
        0x2::dynamic_field::add<BaseKConfigKey, BaseKConfig>(&mut arg0.id, v2, v3);
        let v4 = UpdateBaseKConfigEvent{
            pool_id         : 0x2::object::id<Pool<T0, T1>>(arg0),
            operator        : 0x2::tx_context::sender(arg4),
            size_thresholds : arg1,
            buy_k_tiers     : arg2,
            sell_k_tiers    : arg3,
        };
        0x2::event::emit<UpdateBaseKConfigEvent>(v4);
        check_parameters<T0, T1>(arg0);
    }

    public(friend) fun set_base_price_feed_id_pro<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u32, arg2: &0x2::tx_context::TxContext) {
        let v0 = BasePriceFeedIdProKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<BasePriceFeedIdProKey>(&arg0.id, v0)) {
            let v1 = BasePriceFeedIdProKey{dummy_field: false};
            0x2::dynamic_field::remove<BasePriceFeedIdProKey, BasePriceFeedIdPro>(&mut arg0.id, v1);
        };
        let v2 = BasePriceFeedIdProKey{dummy_field: false};
        let v3 = BasePriceFeedIdPro{feed_id: arg1};
        0x2::dynamic_field::add<BasePriceFeedIdProKey, BasePriceFeedIdPro>(&mut arg0.id, v2, v3);
        let v4 = UpdateBasePriceFeedIdProEvent{
            pool_id  : 0x2::object::id<Pool<T0, T1>>(arg0),
            operator : 0x2::tx_context::sender(arg2),
            feed_id  : arg1,
        };
        0x2::event::emit<UpdateBasePriceFeedIdProEvent>(v4);
    }
    ...
    public(friend) fun set_quote_usd_price<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64) {
        let (v0, v1) = get_quote_usd_price_bounds<T0, T1>(arg0);
        assert!(arg1 >= v0 && arg1 <= v1, 16);
        let v2 = UpdateQuotePriceEvent{
            pool_id   : 0x2::object::id<Pool<T0, T1>>(arg0),
            old_price : arg0.tx_data.quote_usd_price,
            new_price : arg1,
        };
        0x2::event::emit<UpdateQuotePriceEvent>(v2);
        arg0.tx_data.quote_usd_price = arg1;
    }

    public(friend) fun set_quote_usd_price_bounds<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert!(arg1 >= 1 && arg1 <= arg2, 17);
        let v0 = QuoteUsdPriceBoundsKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<QuoteUsdPriceBoundsKey>(&arg0.id, v0)) {
            let v1 = QuoteUsdPriceBoundsKey{dummy_field: false};
            0x2::dynamic_field::remove<QuoteUsdPriceBoundsKey, QuoteUsdPriceBounds>(&mut arg0.id, v1);
        };
        let v2 = QuoteUsdPriceBoundsKey{dummy_field: false};
        let v3 = QuoteUsdPriceBounds{
            lower : arg1,
            upper : arg2,
        };
        0x2::dynamic_field::add<QuoteUsdPriceBoundsKey, QuoteUsdPriceBounds>(&mut arg0.id, v2, v3);
        let v4 = UpdateQuoteUsdPriceBoundsEvent{
            pool_id  : 0x2::object::id<Pool<T0, T1>>(arg0),
            operator : 0x2::tx_context::sender(arg3),
            lower    : arg1,
            upper    : arg2,
        };
        0x2::event::emit<UpdateQuoteUsdPriceBoundsEvent>(v4);
    }
