module 0x11e58df8dd107e4659428957c975db68eec2e31f60496ad267d73efac8b9a7ca::gum_wire {
    public fun action_cancel_withdrawal_v2(arg0: address) : vector<u8> {
        let v0 = b"";
        let v1 = &mut v0;
        write_u8(v1, 7);
        let v2 = &mut v0;
    ...
    public fun action_kind_cancel_withdrawal_v2() : u8 {
        7
    }
    ...
    public fun action_kind_withdraw_v2() : u8 {
        6
    }
    ...
    public fun action_withdraw_v2<T0>(arg0: address, arg1: u64, arg2: address, arg3: address) : vector<u8> {
        let v0 = b"";
        let v1 = &mut v0;
        write_u8(v1, 6);
        let v2 = &mut v0;
    ...
    public fun decode_cancel_withdrawal_v2_action(arg0: &vector<u8>) : address {
        let (v0, v1) = read_u8(arg0, 0);
        assert!(v0 == 7, 103);
        let (v2, v3) = read_address(arg0, v1);
        assert!(v3 == 0x1::vector::length<u8>(arg0), 109);
        v2
    }
    ...
    public fun decode_withdraw_v2_action<T0>(arg0: &vector<u8>) : (address, u64, address, address) {
        let (v0, v1) = read_u8(arg0, 0);
        assert!(v0 == 6, 103);
        let (v2, v3) = read_address(arg0, v1);
        let (v4, v5) = read_u256_as_u64(arg0, read_sui_token_name<T0>(arg0, v3));
        let (v6, v7) = read_address(arg0, v5);
        let (v8, v9) = read_address(arg0, v7);
        assert!(v9 == 0x1::vector::length<u8>(arg0), 109);
        (v2, v4, v6, v8)
    }
    ...
    public fun encode_deposited_v2<T0>(arg0: address, arg1: u64) : vector<u8> {
        let v0 = b"";
        let v1 = &mut v0;
        write_u8(v1, 7);
        let v2 = &mut v0;
    ...
    public fun encode_withdrawal_cancelled(arg0: address) : vector<u8> {
        let v0 = b"";
        let v1 = &mut v0;
        write_u8(v1, 6);
        let v2 = &mut v0;
    ...
    fun type_name_to_wire_payload(arg0: 0x1::type_name::TypeName) : vector<u8> {
        ...
        assert!(0x1::vector::length<u8>(&v3) <= 128, 110);
        v3
    }
