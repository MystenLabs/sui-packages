module 0xe8838f240d927214cb71f2e6a1160711591598644724348ff736082d100749b2::swap {
    ...
    fun init(arg0: SWAP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SWAP>(arg0, 6, b"SWAP", b"SWAP", b"test swap", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
