module 0xe87404847b08ddba2796a4b279633857ff1a3a18ce6414efb820a2393c758dff::gem_miner {
    ...
    public entry fun hire_miners(arg0: &mut GameState, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<address>(&arg0.id, v5)) {
            let v6 = 0x2::dynamic_field::borrow_mut<address, MinerInfo>(&mut arg0.id, v5);
            v6.claimed_eggs = v6.claimed_eggs + v1 * 1 / 100;
        };
