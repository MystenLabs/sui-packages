module 0xe8d71df3f151676f2299e39e63d99b79baaa634576e5fd0c69faf8a616f1b5b3::cnsnft8672 {
    struct CNSNFT8672 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8672, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8672>(arg0, arg1);
