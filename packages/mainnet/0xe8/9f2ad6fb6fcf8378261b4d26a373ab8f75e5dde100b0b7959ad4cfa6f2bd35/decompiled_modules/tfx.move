module 0x639fc9a599c22c4fb0f28279c6f7624258a9c4ab4e54fbddc3661b6a830de357::tfx {
    ...
    public fun bt<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T0>, arg2: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T1>, arg3: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::partner::Partner, arg5: &0x2::clock::Clock, arg6: vector<u128>, arg7: vector<u64>, arg8: vector<u64>, arg9: u64, arg10: vector<u128>, arg11: vector<u64>, arg12: vector<u64>, arg13: u64, arg14: u8, arg15: u8, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        while (v10 < 0x1::vector::length<u128>(&arg6)) {
            ...
            v5 = v5 + v14;
            v8 = v8 + v15;
            v1 = 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::balance_of<T1>(arg2);
            v0 = 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::balance_of<T0>(arg1);
            v10 = v10 + 1;
        };
        v10 = 0;
        while (v10 < 0x1::vector::length<u128>(&arg10)) {
            ...
            v9 = v9 + v20;
            v0 = 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::balance_of<T0>(arg1);
            0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::balance_of<T1>(arg2);
            v10 = v10 + 1;
        };
        if (v2 > 0 || v3 > 0) {
            let v21 = BSE<T0, T1>{
    ...
    fun op<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: bool, arg2: u128, arg3: u128, arg4: u64, arg5: u64, arg6: u8, arg7: u8, arg8: u64) : (u64, u64) {
        assert!(arg4 > 0, 1);
        assert!(arg4 <= arg5, 2);
        assert!(arg8 < arg4, 3);
        let v0 = 0;
        ...
        while (v4 < arg6) {
            ...
            let (v5, v6, v7, v8) = st<T0, T1, T2>(arg0, v3, arg1, arg2);
            if (v7) {
                break
            };
            if (!pk(v6, arg3, arg1)) {
        ...
        while (v4 < arg7) {
            ...
            let v9 = (v2 + v3) / 2;
            let (v10, v11, v12, v13) = st<T0, T1, T2>(arg0, v9, arg1, arg2);
    ...
    fun st<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: u64, arg2: bool, arg3: u128) : (u64, u128, bool, u64) {
        if (arg1 == 0) {
            return (0, 0, true, 0)
        };
    ...
    fun sw<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T0>, arg2: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T1>, arg3: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::partner::Partner, arg5: &0x2::clock::Clock, arg6: u128, arg7: bool, arg8: u64, arg9: u64, arg10: u8, arg11: u8, arg12: u64, arg13: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        let v2 = sp(arg6);
        let (v3, v4) = op<T0, T1, T2>(arg0, arg7, arg6, v2, arg8, arg9, arg10, arg11, arg12);
        if (v3 < arg8) {
            return (0, 0, 0)
        };
        let v5 = !arg7;
        let (v6, v7, v8) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::flash_swap_partner<T0, T1, T2>(arg0, arg4, v5, (v3 as u128), true, arg6, arg5, arg3, arg13);
        let v9 = v7;
        let v10 = v6;
        assert!(v3 <= arg9, 5);
        let v11 = if (v5) {
        ...
        let v12 = v3 - (((v4 as u128) * 300000 * (0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::partner::current_ref_fee_rate(arg4, 0x2::clock::timestamp_ms(arg5) / 1000) as u128) / 1000000 * 10000) as u64);
        let v13 = imo(v12, v2, arg7);
        assert!(v11 >= v13, 6);
        let (v14, v15) = if (v5) {
        ...
        let v17 = v14;
        let (v18, v19) = if (v5) {
            (0x2::coin::split<T0>(&mut v17, v3, arg13), 0x2::coin::zero<T1>(arg13))
        } else {
            (0x2::coin::zero<T0>(arg13), 0x2::coin::split<T1>(&mut v16, v3, arg13))
        };
        0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::repay_flash_swap_partner<T0, T1, T2>(arg0, arg4, v18, v19, v8, arg3);
        0x2::coin::join<T0>(&mut v17, v10);
        0x2::coin::join<T1>(&mut v16, v9);
