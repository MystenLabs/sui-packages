module 0xe8ee495c2f6150942a8b62f634bed1e26c5c1ec62868f2098fd4f8a3c89b51c2::ika_golden_key {
    struct IKA_GOLDEN_KEY has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: IKA_GOLDEN_KEY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<IKA_GOLDEN_KEY>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"IKA GOLDEN KEY"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"IKA GOLDEN KEY is a limited 100 NFTs collection, HOLD FOR FUTURE BENEFITS."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifmat2gyvl4g5fbi2xlilvqhx7ywjsi6q27migf2pcd3ss53e3jka"));
