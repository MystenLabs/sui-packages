module 0xe8f3c11e3e722498da4b1990cb534bdd849567e60c4a9fd25a9f36c0af3fa397::dao {
    ...
    public fun invest<T0, T1, T2>(arg0: &mut DAO<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T2>, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T0>, arg4: bool, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(arg0.owner == v0, 4);
        assert!(arg0.is_finalized, 5);
        let v1 = 0x2::balance::split<T0>(&mut arg0.raised_balance, arg0.funded_amount * 90 / 100);
        if (arg4) {
            swap<T0, T2>(arg1, arg2, v1, 0x2::balance::zero<T2>(), true, 0x2::balance::value<T0>(&v1), arg5, arg6, arg7, v0, arg8);
        } else {
            swap<T2, T0>(arg1, arg3, 0x2::balance::zero<T2>(), v1, false, 0x2::balance::value<T0>(&v1), arg5, arg6, arg7, v0, arg8);
        };
    }
