module 0xe8b74a22c293cc9bc7e97b08db0d881dd0eb7704b26185c9b52d751f66ef453b::cnsnft3359 {
    struct CNSNFT3359 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3359, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3359>(arg0, arg1);
