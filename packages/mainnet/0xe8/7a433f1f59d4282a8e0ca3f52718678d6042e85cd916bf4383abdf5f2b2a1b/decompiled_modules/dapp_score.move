module 0xe87a433f1f59d4282a8e0ca3f52718678d6042e85cd916bf4383abdf5f2b2a1b::dapp_score {
    ...
    public fun check_is_dapp_admin(arg0: &Dapp, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::contains<address>(&arg0.admins, &v0) || 0x1::vector::length<address>(&arg0.admins) == 0, 0xe87a433f1f59d4282a8e0ca3f52718678d6042e85cd916bf4383abdf5f2b2a1b::error::not_authorized_error());
    }

    fun check_is_super_admin(arg0: &DappScoreManager, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x1::vector::contains<address>(&arg0.admins, &v0) || arg0.creator == 0x2::tx_context::sender(arg1), 0xe87a433f1f59d4282a8e0ca3f52718678d6042e85cd916bf4383abdf5f2b2a1b::error::not_authorized_error());
    }

    public fun check_is_updater(arg0: &DappScoreManager, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.updater == 0x2::tx_context::sender(arg1), 0xe87a433f1f59d4282a8e0ca3f52718678d6042e85cd916bf4383abdf5f2b2a1b::error::not_authorized_error());
    }
    ...
    public fun create_dapp_score_update_request(arg0: address, arg1: u64, arg2: address, arg3: 0x1::option::Option<address>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun delete_dapp_score_update_request(arg0: &DappScoreManager, arg1: DappScoreUpadteRequest, arg2: &0x2::tx_context::TxContext) {
        ...
        let v5 = DeleteDappScoreUpdateRequestEvent{
            user       : v1,
            dapp_index : v3,
            by         : 0x2::tx_context::sender(arg2),
        };
        0x2::event::emit<DeleteDappScoreUpdateRequestEvent>(v5);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = DappScoreManager{
            ...
            next_dapp_index : 0,
            updater         : 0x2::tx_context::sender(arg0),
            version         : 1,
        };
        let v1 = &mut v0;
    ...
    fun internal_add_dapp_admin(arg0: &mut DappScoreManager, arg1: u64, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(!0x1::vector::contains<address>(&v0.admins, &arg2), 0xe87a433f1f59d4282a8e0ca3f52718678d6042e85cd916bf4383abdf5f2b2a1b::error::duplicated_error());
    ...
    fun internal_remove_dapp_admin(arg0: &mut DappScoreManager, arg1: u64, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(v2 && v4, 0xe87a433f1f59d4282a8e0ca3f52718678d6042e85cd916bf4383abdf5f2b2a1b::error::not_authorized_error());
        0x1::vector::remove<address>(&mut v0.admins, v3);
        assert!(0x1::vector::length<address>(&v0.admins) > 0, 0xe87a433f1f59d4282a8e0ca3f52718678d6042e85cd916bf4383abdf5f2b2a1b::error::not_authorized_error());
    ...
    fun internal_remove_super_admin(arg0: &mut DappScoreManager, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::length<address>(&arg0.admins) > 0, 0xe87a433f1f59d4282a8e0ca3f52718678d6042e85cd916bf4383abdf5f2b2a1b::error::not_authorized_error());
