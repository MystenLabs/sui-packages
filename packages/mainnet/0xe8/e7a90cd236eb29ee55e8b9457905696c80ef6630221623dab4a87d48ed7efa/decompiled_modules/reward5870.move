module 0xe8e7a90cd236eb29ee55e8b9457905696c80ef6630221623dab4a87d48ed7efa::reward5870 {
    struct REWARD5870 has drop {
        dummy_field: bool,
    }

    struct TICKET_5870 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5870(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5870>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5870>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5870, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5870>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5870>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5870>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5870>>(v5, 0x2::tx_context::sender(arg1));
    }
