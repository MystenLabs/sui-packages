module 0xe8932c37ba8b8cbe6990084dfc1bf790e3545e85652903b26dd42e6065d50237::deep_manager {
    ...
    public fun ensure_deep_balance<T0, T1, T2, T3>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T2, T3>, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg4: u64, arg5: u64, arg6: &0xe8932c37ba8b8cbe6990084dfc1bf790e3545e85652903b26dd42e6065d50237::config::MMConfig, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) : (u64, bool) {
        if (!0xe8932c37ba8b8cbe6990084dfc1bf790e3545e85652903b26dd42e6065d50237::config::enable_deep_payment(arg6)) {
            return (0, false)
        };
        ...
        let v2 = v0 * 0xe8932c37ba8b8cbe6990084dfc1bf790e3545e85652903b26dd42e6065d50237::config::deep_buffer_multiplier(arg6) / 10;
        let v3 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T2>(arg2);
        if (v3 >= v2) {
            0xe8932c37ba8b8cbe6990084dfc1bf790e3545e85652903b26dd42e6065d50237::events::emit_deep_balance_check(v3, v2, 0, arg4, arg5, v0, 0x2::clock::timestamp_ms(arg7));
            return (v3, false)
        };
        let v4 = 0xe8932c37ba8b8cbe6990084dfc1bf790e3545e85652903b26dd42e6065d50237::config::min_deep_purchase(arg6);
        let v5 = (v2 - v3) * 2;
        let v6 = v5;
        if (v5 < v4) {
            v6 = v4;
        };
        0xe8932c37ba8b8cbe6990084dfc1bf790e3545e85652903b26dd42e6065d50237::events::emit_deep_balance_check(v3, v2, 1, arg4, arg5, v0, 0x2::clock::timestamp_ms(arg7));
        ...
        0xe8932c37ba8b8cbe6990084dfc1bf790e3545e85652903b26dd42e6065d50237::events::emit_deep_purchase(v10, v13, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T3>(arg2) - v12, v11, v12, v13 > 0, 0x2::clock::timestamp_ms(arg7));
        (v11, true)
    }
