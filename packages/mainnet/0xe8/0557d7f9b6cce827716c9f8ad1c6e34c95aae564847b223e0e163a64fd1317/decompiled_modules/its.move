module 0xe80557d7f9b6cce827716c9f8ad1c6e34c95aae564847b223e0e163a64fd1317::its {
    ...
    public fun register_transaction(arg0: &mut 0x2b839b25c7133e5e0f8f585cb2e89bf430a6585a88c4a0343ae3b246372d431c::discovery::RelayerDiscovery, arg1: &Singleton, arg2: &0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::interchain_token_service::InterchainTokenService, arg3: &0x2::clock::Clock) {
        ...
        0x1::vector::push_back<vector<u8>>(v1, 0xe80557d7f9b6cce827716c9f8ad1c6e34c95aae564847b223e0e163a64fd1317::utils::concat<u8>(x"00", 0x2::address::to_bytes(0x2::object::id_address<0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::interchain_token_service::InterchainTokenService>(arg2))));
        0x1::vector::push_back<vector<u8>>(v1, x"03");
        0x1::vector::push_back<vector<u8>>(v1, 0xe80557d7f9b6cce827716c9f8ad1c6e34c95aae564847b223e0e163a64fd1317::utils::concat<u8>(x"00", 0x2::address::to_bytes(0x2::object::id_address<0x2::clock::Clock>(arg3))));
    ...
    public fun get_final_transaction(arg0: &Singleton, arg1: &0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::interchain_token_service::InterchainTokenService, arg2: vector<u8>, arg3: &0x2::clock::Clock) : 0x2b839b25c7133e5e0f8f585cb2e89bf430a6585a88c4a0343ae3b246372d431c::transaction::Transaction {
        ...
        0x1::vector::push_back<vector<u8>>(v1, 0xe80557d7f9b6cce827716c9f8ad1c6e34c95aae564847b223e0e163a64fd1317::utils::concat<u8>(x"00", 0x2::address::to_bytes(0x2::object::id_address<Singleton>(arg0))));
        0x1::vector::push_back<vector<u8>>(v1, 0xe80557d7f9b6cce827716c9f8ad1c6e34c95aae564847b223e0e163a64fd1317::utils::concat<u8>(x"00", 0x2::address::to_bytes(0x2::object::id_address<0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::interchain_token_service::InterchainTokenService>(arg1))));
        0x1::vector::push_back<vector<u8>>(v1, 0xe80557d7f9b6cce827716c9f8ad1c6e34c95aae564847b223e0e163a64fd1317::utils::concat<u8>(x"00", 0x2::address::to_bytes(0x2::object::id_address<0x2::clock::Clock>(arg3))));
        let (v2, _, _, _) = 0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::discovery::interchain_transfer_info(arg2);
        let v6 = 0x1::type_name::with_defining_ids<Singleton>();
        let v7 = 0x1::type_name::address_string(&v6);
    ...
    public fun register_coin<T0>(arg0: &mut 0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::interchain_token_service::InterchainTokenService, arg1: &0x2::coin::CoinMetadata<T0>) : 0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::token_id::TokenId {
        0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::interchain_token_service::register_coin_from_metadata<T0>(arg0, arg1, 0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::coin_management::new_locked<T0>())
    }
    ...
    public fun register_coin_with_cap<T0>(arg0: &mut 0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::interchain_token_service::InterchainTokenService, arg1: &0x2::coin::CoinMetadata<T0>, arg2: 0x2::coin::TreasuryCap<T0>) : 0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::token_id::TokenId {
        0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::interchain_token_service::register_coin_from_metadata<T0>(arg0, arg1, 0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::coin_management::new_with_cap<T0>(arg2))
    }
