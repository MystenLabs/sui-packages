module 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::config {
    ...
    struct GlobalConfig has key {
        ...
        package_version: u64,
        acl: 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::acl::ACL,
    }
    ...
    public fun add_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        ...
        0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun remove_member(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address) {
        checked_package_version(arg1);
        0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u128) {
        checked_package_version(arg1);
        0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    public fun add_swap_slippage<T0>(arg0: &mut GlobalConfig, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.swap_slippages, &v0), 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::slippage_config_exists());
    ...
    public fun check_operation_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::acl::has_role(&arg0.acl, arg1, 1) || 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::acl::has_role(&arg0.acl, arg1, 2), 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::no_operation_manager_permission());
    }

    public fun check_oracle_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::acl::has_role(&arg0.acl, arg1, 4), 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::no_oracle_manager_permission());
    }

    public fun check_pool_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::acl::has_role(&arg0.acl, arg1, 3), 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::no_pool_manager_permission());
    }

    public fun check_protocol_fee_claim_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::acl::has_role(&arg0.acl, arg1, 0), 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::no_protocol_fee_claim_permission());
    }

    public fun check_rebalance_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::acl::has_role(&arg0.acl, arg1, 2), 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::no_operation_manager_permission());
    }

    public fun check_reinvest_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::acl::has_role(&arg0.acl, arg1, 1), 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::no_operation_manager_permission());
    }

    public fun checked_package_version(arg0: &GlobalConfig) {
        assert!(1 >= arg0.package_version, 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::package_version_deprecate());
    }
    ...
    public fun get_swap_slippage<T0>(arg0: &GlobalConfig) : u64 {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.swap_slippages, &v0), 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::slippage_config_not_exists());
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = GlobalConfig{
            ...
            protocol_fee_rate : 0,
            package_version   : 1,
            acl               : 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::acl::new(arg0),
        };
        ...
        let v3 = &mut v1;
        set_roles(&v0, v3, 0x2::tx_context::sender(arg0), 0 | 1 << 3 | 1 << 4);
    ...
    public entry fun update_package_version(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: u64) {
        let v0 = arg1.package_version;
        assert!(arg2 > v0, 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::wrong_package_version());
    ...
    public fun update_protocol_fee_rate(arg0: &mut GlobalConfig, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_pool_manager_role(arg0, 0x2::tx_context::sender(arg2));
        assert!(arg1 <= 2000, 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::invalid_protocol_fee_rate());
