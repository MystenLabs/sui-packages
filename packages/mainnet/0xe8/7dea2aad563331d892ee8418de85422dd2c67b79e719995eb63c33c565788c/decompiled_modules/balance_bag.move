module 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::balance_bag {
    ...
    public fun join<T0>(arg0: &mut BalanceBag, arg1: 0x2::balance::Balance<T0>) {
        ...
        if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.balances, &v0)) {
            *0x2::vec_map::get_mut<0x1::type_name::TypeName, u64>(&mut arg0.balances, &v0) = 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::utils::add_balance_to_bag<T0>(&mut arg0.bag, arg1);
        } else {
            0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut arg0.balances, v0, 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::utils::add_balance_to_bag<T0>(&mut arg0.bag, arg1));
        };
    }
    ...
    public fun split<T0>(arg0: &mut BalanceBag, arg1: u64) : 0x2::balance::Balance<T0> {
        let (v0, v1) = 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::utils::remove_balance_from_bag<T0>(&mut arg0.bag, arg1, false);
    ...
    public fun withdraw_all<T0>(arg0: &mut BalanceBag) : 0x2::balance::Balance<T0> {
        let (v0, _) = 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::utils::remove_balance_from_bag<T0>(&mut arg0.bag, 0, true);
        let v2 = 0x1::type_name::get<T0>();
        if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.balances, &v2)) {
