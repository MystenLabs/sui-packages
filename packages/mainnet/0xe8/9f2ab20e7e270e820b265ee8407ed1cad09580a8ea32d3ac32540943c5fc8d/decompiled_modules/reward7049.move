module 0xe89f2ab20e7e270e820b265ee8407ed1cad09580a8ea32d3ac32540943c5fc8d::reward7049 {
    struct REWARD7049 has drop {
        dummy_field: bool,
    }

    struct TICKET_7049 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7049(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7049>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7049>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7049, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7049>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7049>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7049>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7049>>(v5, 0x2::tx_context::sender(arg1));
    }
