module 0xe8388b1ea818ec43e1b837c195b77fbab18adcb5e8969dfaf8d9e85af7dc4685::game {
    ...
    public entry fun place_bet(arg0: &mut GameState, arg1: &mut 0xe8388b1ea818ec43e1b837c195b77fbab18adcb5e8969dfaf8d9e85af7dc4685::player_registry::Registry, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::coin::value<0x2::sui::SUI>(&arg2);
        let v2 = 0x2::clock::timestamp_ms(arg4);
        assert!(v1 >= 0 && v1 <= 1000000000000, 4);
        0xe8388b1ea818ec43e1b837c195b77fbab18adcb5e8969dfaf8d9e85af7dc4685::player_registry::register_player(arg1, v0, arg3, arg4);
        0xe8388b1ea818ec43e1b837c195b77fbab18adcb5e8969dfaf8d9e85af7dc4685::player_registry::update_deposit(arg1, v0, v1);
        let v3 = if (0xe8388b1ea818ec43e1b837c195b77fbab18adcb5e8969dfaf8d9e85af7dc4685::player_registry::is_valid_referrer(arg1, arg3)) {
            let v4 = 0xe8388b1ea818ec43e1b837c195b77fbab18adcb5e8969dfaf8d9e85af7dc4685::player_registry::get_player_address(arg1, arg3);
            if (v4 == v0) {
                arg0.admin
            } else {
                v4
        ...
        if (v3 != arg0.admin) {
            let v7 = v1 * 1 / 100;
            if (v7 > 0) {
                0xe8388b1ea818ec43e1b837c195b77fbab18adcb5e8969dfaf8d9e85af7dc4685::player_registry::add_referral_reward(arg1, v3, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v6, v7), arg5), arg4);
            };
        };
