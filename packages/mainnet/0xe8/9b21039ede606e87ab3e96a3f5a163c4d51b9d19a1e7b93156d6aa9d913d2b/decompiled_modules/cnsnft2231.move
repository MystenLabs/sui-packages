module 0xe89b21039ede606e87ab3e96a3f5a163c4d51b9d19a1e7b93156d6aa9d913d2b::cnsnft2231 {
    struct CNSNFT2231 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2231, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2231>(arg0, arg1);
