module 0xe80fb108d77878d34681443cb485ce78f968fb1256b0292e8eb7985fe91fde5f::espresso_foundation {
    struct ESPRESSO_FOUNDATION has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ESPRESSO_FOUNDATION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ESPRESSO_FOUNDATION>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Espresso Foundation"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Claim your Composable and become a Prototyper, a Vanguard, a Creator, a Brewer, or a Steward. Each of these personas has their own traits and represents roles that we each play in building an ecosystem where all chains work together as one."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://QNWHK92aqWFpodw9A6OvwzxNZJuqdvcQV34yIoBeI4g"));
