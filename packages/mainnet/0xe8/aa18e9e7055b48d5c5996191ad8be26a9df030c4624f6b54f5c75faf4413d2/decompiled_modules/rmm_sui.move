module 0xe8aa18e9e7055b48d5c5996191ad8be26a9df030c4624f6b54f5c75faf4413d2::rmm_sui {
    struct RMM_SUI has drop {
        dummy_field: bool,
    }

    fun init(arg0: RMM_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = vector[];
        let v1 = 0x1::vector::empty<u64>();
        let v2 = &mut v1;
        0x1::vector::push_back<u64>(v2, 778100000000000000);
        0x1::vector::push_back<u64>(v2, 221900000000000018);
        ...
        while (v3 < 0x1::vector::length<u64>(&v1)) {
            ...
            0x2::transfer::public_transfer<0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool::CreatePoolCapV2>(0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool::create_pool_cap_and_set_decimals<RMM_SUI>(arg0, b"AF_LP_RMM_SUI", b"Af Lp rmmSui", b"Rmm Sui/USDC Coin", v8, 0x1::option::some<vector<u8>>(v6), false, v0, 144 - 144, arg1), 0x2::tx_context::sender(arg1));
            return
        };
        /* goto 4 */
    }
