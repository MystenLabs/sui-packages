module 0xe8ba45c08c080a0a136a69a89d00d0f712570da8999c5b1f938cda2728a4184a::cnsnft4279 {
    struct CNSNFT4279 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4279, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4279>(arg0, arg1);
