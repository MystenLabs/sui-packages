module 0xe887a45770a0d087b41d7ede5ecc7b918f3fb54cedff16b7a3c25ef7e0b8c8ed::suipaynft {
    ...
    fun mintInternal(arg0: &mut ContractInfo, arg1: u8, arg2: u16, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        if (arg2 == 0) {
            arg2 = ((0xe887a45770a0d087b41d7ede5ecc7b918f3fb54cedff16b7a3c25ef7e0b8c8ed::pseudorandom::rand_u32(arg5) % 65535) as u16);
        };
        ...
        0x2::transfer::public_transfer<NFT>(v16, arg4);
    }
