module 0xe877828378499e24713c4a0d1bfb27e205852090b768055f7b04f4f350c19b8f::interfaces {
    ...
    struct AllReserveIndexs has copy, drop {
        data: vector<LendingReserveIndex>,
    }

    struct LendingReserveIndex has copy, drop {
        dola_pool_id: u16,
        borrow_index: u256,
    ...
    struct LendingReserveBaseInfo has copy, drop {
        dola_pool_id: u16,
    ...
    struct AllReserveBaseInfo has copy, drop {
        reserve_infos: vector<LendingReserveBaseInfo>,
    }
    ...
    public entry fun get_all_reserve_base_info(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage) {
        let v0 = 0x1::vector::empty<LendingReserveBaseInfo>();
        let v1 = 0;
        while (v1 < 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_reserve_length(arg0)) {
            let v2 = (v1 as u16);
            let (v3, v4, v5, v6) = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_borrow_rate_factors(arg0, v2);
            let v7 = LendingReserveBaseInfo{
                dola_pool_id            : v2,
                base_borrow_rate        : v3,
                borrow_rate_slope1      : v4,
                borrow_rate_slope2      : v5,
                optimal_utilization     : v6,
                supply_cap_ceiling      : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_reserve_supply_ceiling(arg0, v2),
                borrow_cap_ceiling      : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_reserve_borrow_ceiling(arg0, v2),
                borrow_coefficient      : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_borrow_coefficient(arg0, v2),
                collateral_coefficient  : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_collateral_coefficient(arg0, v2),
                treasury_factor         : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_treasury_factor(arg0, v2),
                borrowable_in_isolation : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::can_borrow_in_isolation(arg0, v2),
                is_isolated_asset       : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::is_isolated_asset(arg0, v2),
            };
            0x1::vector::push_back<LendingReserveBaseInfo>(&mut v0, v7);
            v1 = v1 + 1;
        };
        let v8 = AllReserveBaseInfo{reserve_infos: v0};
        0x2::event::emit<AllReserveBaseInfo>(v8);
    }

    public entry fun get_all_reserve_index(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage) {
        let v0 = 0x1::vector::empty<LendingReserveIndex>();
        let v1 = 0;
        while (v1 < 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_reserve_length(arg0)) {
            let v2 = (v1 as u16);
            let v3 = LendingReserveIndex{
                dola_pool_id    : v2,
                borrow_index    : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_borrow_index(arg0, v2),
                liquidity_index : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_liquidity_index(arg0, v2),
            };
            0x1::vector::push_back<LendingReserveIndex>(&mut v0, v3);
        };
        let v4 = AllReserveIndexs{data: v0};
        0x2::event::emit<AllReserveIndexs>(v4);
    }
    ...
    public fun get_reward_pool_apy(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle::PriceOracle, arg2: u64, arg3: u16, arg4: address, arg5: u16, arg6: &0x2::clock::Clock) : (u256, u256, u256) {
        let v0 = if (arg3 == 3) {
            9
        } else if (arg3 == 8) {
            6
        ...
        let v1 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::get_reward_pool(0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::get_reward_pool_infos(arg0, arg5), 0x2::object::id_from_address(arg4));
        let (v2, v3) = if (0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::get_reward_action(v1) == 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_codec::get_supply_type()) {
            (0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::total_otoken_supply(arg0, arg5), 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::user_collateral_balance(arg0, arg2, arg5))
        } else {
            (0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::total_dtoken_supply(arg0, arg5), 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::user_loan_balance(arg0, arg2, arg5))
        };
        let v4 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_value(arg1, arg5, v2);
        let v5 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::get_reward_per_second(v1) * 31536000;
        let v6 = v5;
        if (v0 > 8) {
            v6 = v5 / (0x2::math::pow(10, v0 - 8) as u256);
        } else if (v0 < 8) {
            v6 = v5 * (0x2::math::pow(10, 8 - v0) as u256);
        };
        let v7 = if (v4 == 0 || 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_timestamp(arg6) >= 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::get_end_time(v1)) {
            0
        } else {
            0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_value(arg1, arg3, v6) * 10000 / v4 / 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray()
        };
        (v7, v4, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_value(arg1, arg5, v3))
    }
    ...
    public entry fun get_user_allowed_borrow(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::pool_manager::PoolManagerInfo, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg2: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle::PriceOracle, arg3: u16, arg4: vector<u8>, arg5: u64, arg6: u16, arg7: u256) {
        assert!(arg7 >= 1004000000000000000000000000, 0);
        if (0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::user_health_factor(arg1, arg2, arg5) <= arg7) {
        ...
        let v4 = UserAllowedBorrow{
            borrow_token      : 0x1::ascii::into_bytes(0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::pool_manager::get_pool_name_by_id(arg0, arg6)),
            max_borrow_amount : v2,
            max_borrow_value  : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_value(arg2, arg6, v2),
            borrow_amount     : v3,
            borrow_value      : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_value(arg2, arg6, v3),
        };
        0x2::event::emit<UserAllowedBorrow>(v4);
    }
    ...
    public entry fun get_user_allowed_withdraw(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::pool_manager::PoolManagerInfo, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg2: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle::PriceOracle, arg3: u16, arg4: vector<u8>, arg5: u64, arg6: u16, arg7: bool, arg8: u256) {
        assert!(arg8 >= 1004000000000000000000000000, 0);
        ...
        let (v3, v4, v5) = if (0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::is_liquid_asset(arg1, arg5, arg6)) {
            let v6 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::user_collateral_balance(arg1, arg5, arg6);
            let v5 = v6;
            let v7 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::min(v6, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::pool_manager::get_app_liquidity(arg0, arg6, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_app_id(arg1)));
            if (arg7) {
                v5 = v6 * 10;
            };
            (v7, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_value(arg2, arg6, v7), v5)
        } else {
            if (0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::user_health_factor(arg1, arg2, arg5) <= arg8) {
                let v8 = UserAllowedWithdraw{
                ...
                0x2::event::emit<UserAllowedWithdraw>(v8);
                return
            };
            let v9 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_amount(arg2, arg6, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray_div(v0 - 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray_mul(v1, arg8), v2));
            let v10 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::user_collateral_balance(arg1, arg5, arg6);
            let v11 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::min(v9, v10);
            let v5 = v11;
            let v12 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::min(v11, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::pool_manager::get_app_liquidity(arg0, arg6, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_app_id(arg1)));
            let v13 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_value(arg2, arg6, v12);
            let v14 = if (v1 > 0) {
                0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray_div(v0 - 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray_mul(v13, v2), v1)
            } else {
                115792089237316195423570985008687907853269984665640564039457584007913129639935
            };
            if (arg7 && v14 > arg8 && v9 >= v10) {
                v5 = v11 * 10;
            };
            (v12, v13, v5)
        };
        let v15 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::min(v5, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::pool_manager::get_pool_liquidity(arg0, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::dola_address::create_dola_address(arg3, arg4)));
        let v16 = UserAllowedWithdraw{
            withdraw_token      : 0x1::ascii::into_bytes(0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::pool_manager::get_pool_name_by_id(arg0, arg6)),
            max_withdraw_amount : v3,
            max_withdraw_value  : v4,
            withdraw_amount     : v15,
            withdraw_value      : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_value(arg2, arg6, v15),
        };
        0x2::event::emit<UserAllowedWithdraw>(v16);
    }
    ...
    public entry fun get_user_reward_pool_apys(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle::PriceOracle, arg2: u64, arg3: vector<u16>, arg4: vector<address>, arg5: vector<u16>, arg6: &0x2::clock::Clock) {
        let v0 = 0x1::vector::empty<RewardPoolApy>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<address>(&arg4)) {
            let v2 = *0x1::vector::borrow<address>(&arg4, v1);
            let (v3, v4, v5) = get_reward_pool_apy(arg0, arg1, arg2, *0x1::vector::borrow<u16>(&arg3, v1), v2, *0x1::vector::borrow<u16>(&arg5, v1), arg6);
            let v6 = RewardPoolApy{
                reward_pool_info : v2,
                apy              : v3,
                total_value      : v4,
                user_value       : v5,
            };
            0x1::vector::push_back<RewardPoolApy>(&mut v0, v6);
            v1 = v1 + 1;
        };
        let v7 = RewardPoolApys{apys: v0};
        0x2::event::emit<RewardPoolApys>(v7);
    }
    ...
    public fun get_user_rewrad(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg1: address, arg2: u64, arg3: u16, arg4: &0x2::clock::Clock) : (u256, u256, u8) {
        ...
        let v2 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::get_total_scaled_balance(arg0, arg3, v1);
        let v3 = if (v2 == 0) {
            0
        } else {
        ...
        (v6 + 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray_mul(v3 - v4, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::get_user_scaled_balance(arg0, arg3, arg2, v1)), v5, v1)
    }
    ...
    public fun get_user_total_allowed_borrow(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::pool_manager::PoolManagerInfo, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg2: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle::PriceOracle, arg3: u64, arg4: u256) {
        assert!(arg4 >= 1004000000000000000000000000, 0);
        let v0 = 0x1::vector::empty<UserTotalBorrowInfo>();
        let v1 = true;
        if (0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::user_health_factor(arg1, arg2, arg3) <= arg4) {
            v1 = false;
        };
        let v2 = 0;
