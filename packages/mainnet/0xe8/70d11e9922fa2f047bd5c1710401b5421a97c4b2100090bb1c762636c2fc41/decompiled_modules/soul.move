module 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul {
    ...
    public fun animacraft_native_equipment_id_v8(arg0: &SoulState) : 0x2::object::ID {
        *0x2::dynamic_field::borrow<u8, 0x2::object::ID>(&arg0.id, 10)
    }

    public fun animacraft_native_v8_binding_id(arg0: &SoulState) : 0x2::object::ID {
        assert!(has_animacraft_native_v8_binding(arg0), 20);
        *0x2::dynamic_field::borrow<u8, 0x2::object::ID>(&arg0.id, 9)
    }
    ...
    public(friend) fun bind_animacraft_native_equipment_v8(arg0: &mut SoulState, arg1: 0x2::object::ID) {
        assert!(has_animacraft_native_v8_binding(arg0), 20);
        assert!(!has_animacraft_native_equipment_v8(arg0), 28);
        0x2::dynamic_field::add<u8, 0x2::object::ID>(&mut arg0.id, 10, arg1);
    }

    public(friend) fun bind_animacraft_native_v8(arg0: &mut SoulState, arg1: 0x2::object::ID) {
        assert!(!has_animacraft_provenance(arg0), 19);
        0x2::dynamic_field::add<u8, 0x2::object::ID>(&mut arg0.id, 9, arg1);
    }
    ...
    public fun has_animacraft_native_equipment_v8(arg0: &SoulState) : bool {
        0x2::dynamic_field::exists_with_type<u8, 0x2::object::ID>(&arg0.id, 10)
    }

    public fun has_animacraft_native_v8_binding(arg0: &SoulState) : bool {
        0x2::dynamic_field::exists_with_type<u8, 0x2::object::ID>(&arg0.id, 9)
    }

    public fun has_animacraft_provenance(arg0: &SoulState) : bool {
        has_animacraft_native_v8_binding(arg0)
    }
    ...
    public(friend) fun rotate_owner(arg0: &mut SoulState, arg1: address, arg2: 0x2::object::ID) {
        assert!(!has_animacraft_native_equipment_v8(arg0), 29);
        assert!(arg1 != @0x0, 3);
    ...
    public(friend) fun set_listed(arg0: &mut SoulState, arg1: bool) {
        assert!(!arg1 || !has_animacraft_native_equipment_v8(arg0), 29);
        arg0.is_listed = arg1;
    }
    ...
    public(friend) fun unbind_animacraft_native_equipment_v8(arg0: &mut SoulState, arg1: 0x2::object::ID) {
        assert!(animacraft_native_equipment_id_v8(arg0) == arg1, 28);
        0x2::dynamic_field::remove<u8, 0x2::object::ID>(&mut arg0.id, 10);
    }
