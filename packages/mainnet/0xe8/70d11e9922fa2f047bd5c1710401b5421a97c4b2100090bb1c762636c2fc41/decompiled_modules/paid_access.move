module 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::paid_access {
    ...
    public fun add_access(arg0: &mut SoulPaidAccessList, arg1: &0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::SoulState, arg2: &0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::kind_registry::KindRegistry, arg3: address, arg4: u32, arg5: u64, arg6: 0x1::option::Option<u64>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg8) == 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::current_owner(arg1), 1);
        assert_paid_access_list_matches_state(arg0, arg1);
        assert_kind_supports_paid_with_scope(arg2, arg4, arg5);
        0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::grant::assert_valid_scope_mask(arg5);
        let v0 = 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::ownership_epoch(arg1);
    ...
    fun assert_kind_supports_paid_with_scope(arg0: &0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::kind_registry::KindRegistry, arg1: u32, arg2: u64) {
        let v0 = 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::kind_registry::borrow_descriptor(arg0, arg1);
        assert!(0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::kind_registry::descriptor_read_mode_mask(v0) & 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::kind_registry::read_paid() != 0, 11);
        assert!(arg2 == 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::kind_registry::descriptor_default_grant_scope_mask(v0), 9);
    }

    public fun assert_paid_access_list_matches_state(arg0: &SoulPaidAccessList, arg1: &0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::SoulState) {
        assert!(arg0.soul_id == 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::soul_id(arg1), 5);
        let v0 = 0x2::object::id<SoulPaidAccessList>(arg0);
        assert!(0x1::option::contains<0x2::object::ID>(0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::access_list_id(arg1), &v0), 5);
    }

    public fun cleanup_stale_entries(arg0: &mut SoulPaidAccessList, arg1: &0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::SoulState, arg2: vector<address>, arg3: vector<u32>, arg4: &0x2::tx_context::TxContext) {
        assert_paid_access_list_matches_state(arg0, arg1);
        ...
        while (!0x1::vector::is_empty<address>(&arg2) && !0x1::vector::is_empty<u32>(&arg3)) {
            ...
            if (0x2::table::contains<address, 0x2::table::Table<u32, KindPaidEntry>>(&arg0.entries, v0)) {
                ...
                if (0x2::table::contains<u32, KindPaidEntry>(v2, v1)) {
                    if (0x2::table::borrow<u32, KindPaidEntry>(v2, v1).ownership_epoch_snapshot != 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::ownership_epoch(arg1)) {
    ...
    public fun configure_paid_access_kind(arg0: &mut SoulPaidAccessList, arg1: &0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::SoulState, arg2: &0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::kind_registry::KindRegistry, arg3: u32, arg4: u64, arg5: u64, arg6: 0x1::option::Option<u64>, arg7: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg7) == 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::current_owner(arg1), 1);
        assert_paid_access_list_matches_state(arg0, arg1);
    ...
    public fun delete_paid_access_kind(arg0: &mut SoulPaidAccessList, arg1: &0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::SoulState, arg2: u32, arg3: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::current_owner(arg1), 1);
        assert_paid_access_list_matches_state(arg0, arg1);
    ...
    public fun has_access(arg0: &SoulPaidAccessList, arg1: &0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::SoulState, arg2: address, arg3: u32, arg4: u64, arg5: &0x2::clock::Clock) : bool {
        assert_paid_access_list_matches_state(arg0, arg1);
        ...
        if (v1.ownership_epoch_snapshot != 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::ownership_epoch(arg1)) {
            return false
        };
    ...
    public(friend) fun record_purchase(arg0: &mut SoulPaidAccessList, arg1: &0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::SoulState, arg2: address, arg3: u32, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_paid_access_list_matches_state(arg0, arg1);
        ...
        let v1 = 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::ownership_epoch(arg1);
    ...
    public fun revoke_access(arg0: &mut SoulPaidAccessList, arg1: &0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::SoulState, arg2: address, arg3: u32, arg4: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::current_owner(arg1), 1);
        assert_paid_access_list_matches_state(arg0, arg1);
    ...
    public fun seal_approve_content_paid_access(arg0: vector<u8>, arg1: &0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::soul::SoulState, arg2: &SoulPaidAccessList, arg3: &0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::content::SoulContent, arg4: u32, arg5: 0x1::string::String, arg6: u64, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        assert_paid_access_list_matches_state(arg2, arg1);
        let v0 = 0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::content::assert_valid_content_seal_request(arg0, arg1, arg3, arg4, arg5, arg6);
        0xe870d11e9922fa2f047bd5c1710401b5421a97c4b2100090bb1c762636c2fc41::content::assert_slot_paid_read_allowed(arg3, arg4, arg5, arg6);
        assert!(v0 != 0, 6);
