module 0xe8cf94f4a58225c15ca1dab82aa5bbbc9c61eec4914c306019c95a2ff7de535b::jake {
    ...
    fun init(arg0: JAKE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/EMs5H1gn1Dk6RAFvGjHK1xyAqZTy6PFvX9LGuz7q8hqk.png?size=lg&key=f7ba34                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<JAKE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"JAKE    ")))), trim_right(b"Jake Dog                        "), trim_right(b"Jake the Dog is a magical, shape-shifting bulldog from the fantastical Land of Ooo, a world full of candy people, monsters, and adventure. Born from a bump on his dads head after a bite from a shape-shifting creature, Jake possesses the amazing power to stretch and transform his body into anything imaginable.          "), v2, arg1);
        let v5 = v3;
