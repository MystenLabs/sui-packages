module 0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::implements {
    ...
    public(friend) fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<LP<T0, T1>>, vector<u64>) {
        ...
        let v9 = if (0 == v6) {
            let v10 = 0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::math::sqrt(0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::math::mul_to_u128(v7, v8));
            assert!(v10 > 1000, 8);
    ...
    public fun calc_optimal_coin_values(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : (u64, u64) {
        ...
        let v0 = 0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::math::mul_div(arg0, arg5, arg4);
        if (v0 <= arg1) {
            assert!(v0 >= arg3, 4);
            return (arg0, v0)
        };
        let v1 = 0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::math::mul_div(arg1, arg4, arg5);
        assert!(v1 <= arg0, 6);
        assert!(v1 >= arg2, 3);
        (v1, arg1)
    }
    ...
    public fun get_amount_out(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::math::mul_div_u128(v0, (arg2 as u128), (arg1 as u128) * (10000 as u128) + v0)
    }
    ...
    public fun get_fee_to_fundation(arg0: u64, arg1: u64) : u64 {
        0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::math::mul_div(arg0, arg1, 10000)
    }
    ...
    public fun get_swap_out<T0, T1>(arg0: &mut Global, arg1: u64, arg2: bool) : u64 {
        ...
        let v1 = arg1;
        if (arg2) {
            let v3 = get_mut_pool<T0, T1>(arg0, arg2);
            let v4 = is_tax_coin<T0>(0x1::ascii::into_bytes(v3.tax_coin));
            let (v5, v6, _) = get_reserves_size<T0, T1>(v3);
            assert!(v5 > 0 && v6 > 0, 1);
            if (v4) {
                v1 = arg1 - arg1 * (v3.free_ratio as u64) / 100;
            };
            let v8 = get_amount_out(v1 - get_fee_to_fundation(v1, v0), v5, v6);
            let v9 = v8;
            if (!v4) {
                v9 = v8 - v8 * (v3.free_ratio as u64) / 100;
            };
            v9
        } else {
            ...
            if (v11) {
                v1 = arg1 - 0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::math::mul_div(arg1, (v10.free_ratio as u64), 100);
            };
            let v15 = get_amount_out(v1 - get_fee_to_fundation(v1, v0), v13, v12);
            let v16 = v15;
            if (!v11) {
                v16 = v15 - v15 * (v10.free_ratio as u64) / 100;
            };
            v16
        }
    }
    ...
    public fun is_order<T0, T1>() : bool {
        ...
        let v2 = 0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::comparator::compare<0x1::type_name::TypeName>(&v0, &v1);
        assert!(!0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::comparator::is_equal(&v2), 9);
        0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::comparator::is_smaller_than(&v2)
    }
    ...
    public fun is_sui<T0>() : bool {
        ...
        let v2 = 0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::comparator::compare<0x1::ascii::String>(&v1, &v0);
        0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::comparator::is_equal(&v2)
    }
    ...
    public(friend) fun modify_pool_config<T0, T1>(arg0: &mut Global, arg1: bool, arg2: bool, arg3: address, arg4: address, arg5: u8, arg6: 0x1::ascii::String) {
        let v0 = get_mut_pool<T0, T1>(arg0, is_order<T0, T1>());
        v0.sell_paused = arg1;
        v0.buy_paused = arg2;
        v0.market_address = arg3;
        v0.burn_address = arg4;
        v0.free_ratio = arg5;
        v0.tax_coin = arg6;
    }
    ...
    public(friend) fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LP<T0, T1>>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        (0x2::coin::take<T0>(&mut arg0.coin_x, 0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::math::mul_div(v1, v0, v3), arg3), 0x2::coin::take<T1>(&mut arg0.coin_y, 0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::math::mul_div(v2, v0, v3), arg3))
    }
    ...
    public(friend) fun swapCoin<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (arg3) {
            ...
            if (v19) {
                let v26 = 0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::math::mul_div(v23, (v18.free_ratio as u64), 100);
    ...
    public(friend) fun swap_out<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        if (arg3) {
            let v2 = get_mut_pool<T0, T1>(arg0, arg3);
            if (!is_tax_coin<T0>(0x1::ascii::into_bytes(v2.tax_coin)) && !v2.buy_paused) {
                abort 16
            };
            let v3 = is_tax_coin<T0>(0x1::ascii::into_bytes(v2.tax_coin));
            let (v4, v5, _) = get_reserves_size<T0, T1>(v2);
            ...
            if (!is_tax_coin<T0>(0x1::ascii::into_bytes(v20.tax_coin)) && !v20.sell_paused) {
                abort 16
            };
            ...
            if (v21) {
                let v28 = 0xe8f91bcd58770b8830a53de378826f17619ba21dbe6ac3739dd13849628917b9::math::mul_div(v25, (v20.free_ratio as u64), 100);
