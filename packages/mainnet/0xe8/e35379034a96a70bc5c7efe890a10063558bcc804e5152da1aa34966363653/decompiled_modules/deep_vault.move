module 0xe8e35379034a96a70bc5c7efe890a10063558bcc804e5152da1aa34966363653::deep_vault {
    ...
    public fun add_whitelist(arg0: &0xe8e35379034a96a70bc5c7efe890a10063558bcc804e5152da1aa34966363653::admin_cap::AdminCap, arg1: &mut DeepVault, arg2: 0x2::object::ID, arg3: bool) {
        0x2::table::add<0x2::object::ID, bool>(&mut arg1.whitelist, arg2, arg3);
    }

    public fun deepbook_swap_base_to_quote_sponsored_with_return<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut DeepVault, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, u64) {
        ...
        let (v5, v6, v7) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::swap_exact_base_for_quote<T0, T1>(arg0, arg2, 0x2::coin::from_balance<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(0x2::balance::split<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(&mut arg1.balance, v3), arg5), arg3, arg4, arg5);
        let v8 = v7;
        let v9 = v6;
        let v10 = 0x2::coin::value<T1>(&v9);
        destroy_or_transfer<T0>(v5, arg5);
    ...
    public fun deepbook_swap_quote_to_base_sponsored_with_return<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut DeepVault, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u64) {
        let v0 = 0x2::object::id<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>>(arg0);
        assert!(is_whitelisted(arg1, v0), 1);
    ...
    public fun remove_whitelist(arg0: &0xe8e35379034a96a70bc5c7efe890a10063558bcc804e5152da1aa34966363653::admin_cap::AdminCap, arg1: &mut DeepVault, arg2: 0x2::object::ID) {
