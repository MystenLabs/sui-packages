module 0xe8ff1a3194904562be6c7fe7c8e7c8dbc91fbba0d92876a23cd41d53495734f4::villa_dnft {
    ...
    public fun user_withdraw_sui_for_self(arg0: &mut UserVault, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        assert!(arg0.owner == 0x2::tx_context::sender(arg4), 34);
    ...
    public fun user_withdraw_usdc_for_self(arg0: &mut UserVault, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC> {
        assert!(arg0.owner == 0x2::tx_context::sender(arg4), 34);
        assert!(0x2::balance::value<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&arg0.usdc_balance) >= arg1, 29);
        arg0.updated_at = 0x2::clock::timestamp_ms(arg3);
        let v0 = TokenWithdrawn{
            vault_id   : 0x2::object::uid_to_inner(&arg0.id),
            owner      : arg0.owner,
        ...
        0x2::event::emit<TokenWithdrawn>(v0);
        0x2::coin::from_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(0x2::balance::split<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg0.usdc_balance, arg1), arg4)
    }
