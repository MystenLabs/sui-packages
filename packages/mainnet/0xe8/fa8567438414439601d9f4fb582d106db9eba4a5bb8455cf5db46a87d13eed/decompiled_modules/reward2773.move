module 0xe8fa8567438414439601d9f4fb582d106db9eba4a5bb8455cf5db46a87d13eed::reward2773 {
    struct REWARD2773 has drop {
        dummy_field: bool,
    }

    struct TICKET_2773 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2773(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2773>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2773>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2773, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2773>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2773>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2773>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2773>>(v5, 0x2::tx_context::sender(arg1));
    }
