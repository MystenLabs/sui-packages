module 0xe80589f9838c0b2ac8c51d991dc183a287fdc2763df5a5f04f701e58b43c44e4::diamond_token {
    ...
    fun init(arg0: DIAMOND_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DIAMOND_TOKEN>(arg0, 9, b"DIAMOND", b"Soyara Diamond Token", b"Official Reward & Governance Token earned by staking Soyara Pro NFTs. Earn 10 Diamond per day per NFT.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.pinata.cloud/ipfs/QmZq8H7bY5n2bX9J1V4Q3W8G6L2k9p7R1Y3w5Z6x7y8z9a")), arg1);
