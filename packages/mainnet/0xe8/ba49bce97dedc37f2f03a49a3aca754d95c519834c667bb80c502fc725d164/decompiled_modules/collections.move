module 0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::collections {
    ...
    public fun add(arg0: &mut WhitelistedCollections, arg1: 0x1::string::String, arg2: vector<address>, arg3: &0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::AdminConfig, arg4: &mut 0x2::tx_context::TxContext) : address {
        assert!(0x2::tx_context::sender(arg4) == 0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::get_owner(arg3), 1);
    ...
    public fun add_item(arg0: &mut WhitelistedCollections, arg1: address, arg2: address, arg3: &0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::AdminConfig, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == 0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::get_owner(arg3), 1);
    ...
    public fun add_items(arg0: &mut WhitelistedCollections, arg1: address, arg2: vector<address>, arg3: &0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::AdminConfig, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == 0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::get_owner(arg3), 1);
    ...
    public(friend) fun init_(arg0: &0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::AdminConfig, arg1: &mut 0x2::tx_context::TxContext) : WhitelistedCollections {
        WhitelistedCollections{
            id          : 0x2::object::new(arg1),
            admin_id    : 0x2::object::id<0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::AdminConfig>(arg0),
            whitelisted : 0x2::object_table::new<address, WhitelistedCollection>(arg1),
        }
    }

    public fun is_admin(arg0: &WhitelistedCollections, arg1: &0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::AdminConfig) : bool {
        arg0.admin_id == 0x2::object::id<0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::AdminConfig>(arg1)
    }
    ...
    public fun remove_empty(arg0: &mut WhitelistedCollections, arg1: address, arg2: &0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::AdminConfig, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == 0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::get_owner(arg2), 1);
    ...
    public fun remove_item(arg0: &mut WhitelistedCollections, arg1: address, arg2: address, arg3: &0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::AdminConfig, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == 0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::get_owner(arg3), 1);
    ...
    public fun set_enabled(arg0: &mut WhitelistedCollections, arg1: address, arg2: bool, arg3: &0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::AdminConfig, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == 0xe8ba49bce97dedc37f2f03a49a3aca754d95c519834c667bb80c502fc725d164::admin::get_owner(arg3), 1);
