module 0xe865145996954c371b1d6832a261c1f1c9bec37c1b20a7a467ea8ab25e19661b::trusted_pull_oracle {
    ...
    struct TrustedPullOracle has key {
        id: 0x2::object::UID,
        trusted_price_data_cap: 0xe865145996954c371b1d6832a261c1f1c9bec37c1b20a7a467ea8ab25e19661b::trusted_prices::TrustedPriceDataCap,
    ...
    public fun new(arg0: 0xe865145996954c371b1d6832a261c1f1c9bec37c1b20a7a467ea8ab25e19661b::trusted_prices::TrustedPriceDataCap, arg1: vector<u8>, arg2: &mut 0xe865145996954c371b1d6832a261c1f1c9bec37c1b20a7a467ea8ab25e19661b::global::GlobalInfo, arg3: &mut 0x2::tx_context::TxContext) : TrustedPullOracleCap {
        ...
        0xe865145996954c371b1d6832a261c1f1c9bec37c1b20a7a467ea8ab25e19661b::global::update_shared_object_id<TrustedPullOracleCap>(arg2, b"trusted_oracle", &v1);
        v1
    }
    ...
    public fun destroy(arg0: TrustedPullOracle, arg1: TrustedPullOracleCap) : 0xe865145996954c371b1d6832a261c1f1c9bec37c1b20a7a467ea8ab25e19661b::trusted_prices::TrustedPriceDataCap {
    ...
    public fun make_trusted_prices_data(arg0: &TrustedPullOracle, arg1: vector<SignedPrice>, arg2: u64, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0xe865145996954c371b1d6832a261c1f1c9bec37c1b20a7a467ea8ab25e19661b::trusted_prices::TrustedPriceData {
        ...
        let v2 = 0xe865145996954c371b1d6832a261c1f1c9bec37c1b20a7a467ea8ab25e19661b::trusted_prices::create_empty_trusted_price_data(&arg0.trusted_price_data_cap, arg5);
        ...
        while (v3 < 0x1::vector::length<SignedPrice>(&arg1)) {
            ...
            0xe865145996954c371b1d6832a261c1f1c9bec37c1b20a7a467ea8ab25e19661b::trusted_prices::set_price_raw(&mut v2, v4.asset, v4.price, &arg0.trusted_price_data_cap);
            v3 = v3 + 1;
        };
