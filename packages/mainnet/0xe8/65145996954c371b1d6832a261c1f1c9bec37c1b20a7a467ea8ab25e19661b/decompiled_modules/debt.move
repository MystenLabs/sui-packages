module 0xe865145996954c371b1d6832a261c1f1c9bec37c1b20a7a467ea8ab25e19661b::debt {
    ...
    public fun calc_debt(arg0: &Debt, arg1: &mut 0xe865145996954c371b1d6832a261c1f1c9bec37c1b20a7a467ea8ab25e19661b::trusted_prices::TrustedPriceData) : u64 {
        ...
        while (!0x1::vector::is_empty<0x1::type_name::TypeName>(&v0)) {
            ...
            let v3 = 0xe865145996954c371b1d6832a261c1f1c9bec37c1b20a7a467ea8ab25e19661b::trusted_prices::pull_raw_price(arg1, v2);
            v1 = v1 + 0xe865145996954c371b1d6832a261c1f1c9bec37c1b20a7a467ea8ab25e19661b::price::calc_value(&v3, *0x2::table::borrow<0x1::type_name::TypeName, u64>(&arg0.open_debt, v2));
        };
        v1
    }
