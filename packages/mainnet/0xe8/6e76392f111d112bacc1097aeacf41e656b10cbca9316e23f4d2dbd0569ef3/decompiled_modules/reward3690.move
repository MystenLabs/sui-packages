module 0xe86e76392f111d112bacc1097aeacf41e656b10cbca9316e23f4d2dbd0569ef3::reward3690 {
    struct REWARD3690 has drop {
        dummy_field: bool,
    }

    struct TICKET_3690 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3690(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3690>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3690>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3690, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3690>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3690>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3690>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3690>>(v5, 0x2::tx_context::sender(arg1));
    }
