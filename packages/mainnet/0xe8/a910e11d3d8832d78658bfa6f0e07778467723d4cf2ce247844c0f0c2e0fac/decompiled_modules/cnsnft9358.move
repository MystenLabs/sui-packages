module 0xe8a910e11d3d8832d78658bfa6f0e07778467723d4cf2ce247844c0f0c2e0fac::cnsnft9358 {
    struct CNSNFT9358 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9358, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7993"));
        let v4 = 0x2::package::claim<CNSNFT9358>(arg0, arg1);
