module 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle {
    ...
    fun has_interest_index(arg0: &Bottle) : bool {
        0x2::dynamic_object_field::exists_with_type<vector<u8>, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::BottleInterestIndex>(&arg0.id, b"interest_index")
    }
    ...
    public fun is_interest_index_exists(arg0: &Bottle) : bool {
        0x2::dynamic_object_field::exists_<vector<u8>>(&arg0.id, b"interest_index")
    }
