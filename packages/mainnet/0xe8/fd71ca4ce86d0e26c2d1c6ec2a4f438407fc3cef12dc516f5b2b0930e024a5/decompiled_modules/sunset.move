module 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::sunset {
    ...
    struct Contract<phantom T0, phantom T1> has key {
        ...
        burst_ratio: u8,
        global_network_data: 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::GlobalNetworkData,
        admin: address,
        rebot: address,
    ...
    struct Router has key {
        id: 0x2::object::UID,
        cap: 0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::implements::SwapCap,
    }

    public fun adminDeposit_pre<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::app_version::check_version(arg0.version);
        0x2::balance::join<T0>(&mut arg0.pre_balance, 0x2::coin::into_balance<T0>(arg1));
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pre_deposit_amount(&mut arg0.global_network_data, 0x2::coin::value<T0>(&arg1));
    }
    ...
    public fun adminDeposit_pst<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pst_deposit_amount(&mut arg0.global_network_data, 0x2::coin::value<T1>(&arg1));
    }

    fun apply_reward(arg0: &mut User, arg1: &mut 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::GlobalNetworkData, arg2: u64, arg3: bool) {
        ...
        if (arg3) {
            ...
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_dividend_asset(arg1, v1);
        } else {
            arg0.release_asset = arg0.release_asset + v1;
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_release_asset(arg1, v1);
        };
        arg0.total_earning = arg0.total_earning + v1;
        arg0.today_earning = arg0.today_earning + v1;
        if (arg3) {
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_static_power_distributed(arg1, v1);
        } else {
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_dynamic_power_distributed_amount(arg1, v1);
        };
    }
    ...
    public fun appointUserLevel<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: address, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::updateLevel(&mut arg0.global_network_data, get_user_level(v0), arg2);
    ...
    public(friend) fun batch_import_user_base_data<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: vector<address>, arg2: vector<address>, arg3: vector<vector<address>>, arg4: vector<u8>) {
        ...
        while (v2 < v0) {
            ...
            if (0x2::table::contains<address, User>(v1, v3)) {
                ...
                0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_user(&mut arg0.global_network_data, 1);
            };
            v2 = v2 + 1;
        };
    }
    ...
    public fun batch_update_area_stats_v2<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: vector<address>, arg2: vector<u64>, arg3: vector<u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < v0) {
            ...
            if (v4 > v5) {
                0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::updateLevel(&mut arg0.global_network_data, v5, v4);
                v3.level = v4;
            };
            v1 = v1 + 1;
        };
    ...
    fun calc_level_diff(arg0: &mut 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64) {
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 100) {
            ...
            if (v8 > 0) {
                ...
                if (v7.invest_amount > 0) {
                    ...
                    0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::addTeamReward(arg0, v11);
                    0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_reward_asset(arg0, v11);
                    let v12 = v11 * 2 / 100;
                    if (v12 > 0) {
    ...
    public fun claimInterest<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: u64, arg2: &0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::PriceOracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::app_version::check_version(arg0.version);
        ...
        let v8 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pre_amount(arg2, v7);
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_caimed_stake_interest(v3, v8, v7);
    ...
    public fun claim_pre_asset<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::sub_total_pre_balance(&mut arg0.global_network_data, arg1);
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_claimed_amount(&mut arg0.global_network_data, arg1);
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pre_claimed_amount(&mut arg0.global_network_data, arg1);
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pre_claimed_handling_fee(&mut arg0.global_network_data, v3);
    ...
    public fun claim_pst_asset<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::sub_total_pst_balance(&mut arg0.global_network_data, arg1);
        let v2 = arg1 * 10 / 100;
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_claimed_amount(&mut arg0.global_network_data, arg1);
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pst_claimed_amount(&mut arg0.global_network_data, arg1);
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pst_claimed_handling_fee(&mut arg0.global_network_data, v2);
        withdraw_pst<T0, T1>(arg0, v0, arg1 - v2, arg3);
        transfer_project_pst<T0, T1>(arg0, v2, arg3);
    }

    fun distribute_burst_reward(arg0: &mut 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64, arg4: u8) {
        if (arg4 == 0) {
            return
        };
        let v0 = 0x2::table::borrow_mut<address, User>(arg1, arg2).inviter;
            ...
            if (v4.studio_level) {
                ...
                if (v6) {
                    ...
                    if (v8 > 0) {
                        ...
                        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_explosion_order_reward(arg0, v8);
                        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_reward_asset(arg0, v8);
    ...
    fun distribute_pre_level_reward<T0, T1>(arg0: address, arg1: u64, arg2: &0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::PriceOracle, arg3: &mut Contract<T0, T1>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::option::is_some<address>(&v2) && v3 <= 50) {
            ...
            if (v7 > 0 && check_stake_pre_amount_by_level(v6, v7)) {
                ...
                let v9 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pre_amount(arg2, v8);
                let v10 = PreReward{
                    user   : v5,
                    amount : v9,
                };
                0x1::vector::push_back<PreReward>(&mut v4, v10);
                0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_team_stake_team_reward(v0, v9, v8);
            };
            v2 = v6.inviter;
            v3 = v3 + 1;
        };
    ...
    fun distribute_same_level_team_reward(arg0: &mut 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: 0x1::option::Option<address>, arg3: u8, arg4: u64, arg5: &mut vector<address>) {
        let v0 = 1;
        while (0x1::option::is_some<address>(&arg2) && v0 <= 50) {
            ...
            if (v3) {
                ...
                0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_same_level_reward(arg0, v5);
                0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_reward_asset(arg0, v5);
                break
            };
            arg2 = v2.inviter;
            v0 = v0 + 1;
    ...
    public fun exchange_dividend_asset<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: &0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::PriceOracle, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::app_version::check_version(arg0.version);
        let v0 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pre_amount(arg1, arg2);
        ...
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::sub_total_dividend_asset(&mut arg0.global_network_data, arg2);
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pre_balance(&mut arg0.global_network_data, v0);
    }

    public fun exchange_release_asset<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: &0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::PriceOracle, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::app_version::check_version(arg0.version);
        assert!(arg2 > 0, 202);
        let v0 = arg2 * 80 / 100;
        let v1 = arg2 * 10 / 100;
        let v2 = arg2 - v0 - v1;
        let v3 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pst_amount(arg1, v0);
        let v4 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pst_amount(arg1, v1);
        ...
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::sub_total_release_asset(&mut arg0.global_network_data, arg2);
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pst_balance(&mut arg0.global_network_data, v3);
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_repurchase_points(&mut arg0.global_network_data, v2);
        transfer_project_pst<T0, T1>(arg0, v4, arg3);
    }

    public fun exchange_reward_asset<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: &0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::PriceOracle, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::app_version::check_version(arg0.version);
        assert!(arg2 > 0, 202);
        let v0 = arg2 * 80 / 100;
        let v1 = arg2 * 10 / 100;
        ...
        let v3 = v0 * 80 / 100;
        let v4 = v1 * 80 / 100;
        let v5 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pre_amount(arg1, v3);
        let v6 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pst_amount(arg1, v0 - v3);
        let v7 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pre_amount(arg1, v4);
        let v8 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pst_amount(arg1, v1 - v4);
        ...
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::sub_total_reward_asset(&mut arg0.global_network_data, arg2);
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pre_balance(&mut arg0.global_network_data, v5);
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pst_balance(&mut arg0.global_network_data, v6);
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_repurchase_points(&mut arg0.global_network_data, v2);
    ...
    public fun freezeUser<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: address, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2 == 1) {
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_freeze_user(&mut arg0.global_network_data, 1);
        } else {
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::sub_total_freeze_user(&mut arg0.global_network_data, 1);
        };
    }
    ...
    fun handler_out(arg0: &mut 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::GlobalNetworkData, arg1: address, arg2: &mut 0x2::table::Table<address, User>) {
        let v0 = 0;
        ...
        if (v0 > 0) {
            ...
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::sub_total_asset_invested(arg0, v0);
        };
    }
    ...
    public(friend) fun init_contract<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Contract<T0, T1>{
            ...
            burst_ratio            : 1,
            global_network_data    : 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::new(),
            ...
            burn_address           : @0x0,
            withdraw_fee_recipient : @0x29133ab324f14e250c74a2a9529f1c69856f859e0f29c219cc5c3764a2f0c89b,
            version                : 1,
        };
        0x2::transfer::share_object<Contract<T0, T1>>(v2);
    }

    public fun init_router(arg0: 0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::implements::SwapCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Router{
            id  : 0x2::object::new(arg1),
            cap : arg0,
        };
    ...
    public fun investment<T0, T1, T2>(arg0: &mut Contract<T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T2>, arg4: &0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::PriceOracle, arg5: u64, arg6: u8, arg7: &0x2::clock::Clock, arg8: &mut 0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::implements::Global, arg9: &mut 0x2::tx_context::TxContext) {
        abort 0
    }

    public fun investment_v1<T0, T1, T2>(arg0: &mut Contract<T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T2>, arg4: &0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::PriceOracle, arg5: u64, arg6: u8, arg7: &0x2::clock::Clock, arg8: &mut 0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::implements::Global, arg9: &Router, arg10: &mut 0x2::tx_context::TxContext) {
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::app_version::check_version(arg0.version);
        ...
        let v8 = &arg9.cap;
        if (arg6 == 1) {
            let v9 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_sui_amount(arg4, arg5);
            let v10 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_sui_amount(arg4, arg5 * 70 / 100);
            v5 = v9;
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::interface::swap_coin<T0, T1>(arg8, 0x2::coin::split<T0>(&mut arg1, v10, arg10), 0, v8, arg10), v3);
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::interface::swap_coin<T0, T2>(arg8, 0x2::coin::split<T0>(&mut arg1, v9 - v10, arg10), 0, v8, arg10), v3);
            0x2::coin::send_funds<T0>(arg1, v0);
            0x2::coin::send_funds<T1>(arg2, v0);
            0x2::coin::send_funds<T2>(arg3, v0);
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_sui_invested(v2, v9, arg5);
        } else if (arg6 == 2) {
            let v11 = arg5 * 70 / 100;
            let v12 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pst_amount(arg4, v11);
            let v13 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pst_amount(arg4, arg5 - v11);
            let v14 = v12 + v13;
            v7 = v14;
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::interface::swap_coin<T0, T1>(arg8, 0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::interface::swap_coin<T2, T0>(arg8, 0x2::coin::split<T2>(&mut arg3, v12, arg10), 0, v8, arg10), 0, v8, arg10), v3);
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::split<T2>(&mut arg3, v13, arg10), v3);
            0x2::coin::send_funds<T0>(arg1, v0);
            0x2::coin::send_funds<T1>(arg2, v0);
            0x2::coin::send_funds<T2>(arg3, v0);
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pst_invested(v2, v14, arg5);
        } else {
            let v15 = arg5 * 70 / 100;
            let v16 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pre_amount(arg4, v15);
            let v17 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pre_amount(arg4, arg5 - v15);
            let v18 = v16 + v17;
            v6 = v18;
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg2, v16, arg10), v3);
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::interface::swap_coin<T0, T2>(arg8, 0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::interface::swap_coin<T1, T0>(arg8, 0x2::coin::split<T1>(&mut arg2, v17, arg10), 0, v8, arg10), 0, v8, arg10), v3);
            0x2::coin::send_funds<T0>(arg1, v0);
            0x2::coin::send_funds<T1>(arg2, v0);
            0x2::coin::send_funds<T2>(arg3, v0);
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pre_invested(v2, v18, arg5);
        };
        ...
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_asset_invested(v2, arg5);
        if (v20.invest_amount == 0) {
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_effective_user(v2, 1);
        };
    ...
    fun release_dynamic_power(arg0: &mut User, arg1: &mut 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::GlobalNetworkData) {
        ...
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::sub_total_dynamic_power(arg1, v0);
        apply_reward(arg0, arg1, v0, false);
    }

    fun release_static_power(arg0: &mut User, arg1: &mut 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::GlobalNetworkData, arg2: u64) {
    ...
    public fun repurchase<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::sub_total_repurchase_points(v2, v4);
        ...
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_asset_invested(v2, v4);
    ...
    public fun setDynamicPower<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2 > v1) {
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_dynamic_power(&mut arg0.global_network_data, arg2 - v1);
        } else if (v1 > arg2) {
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::sub_total_dynamic_power(&mut arg0.global_network_data, v1 - arg2);
        };
    }
    ...
    public fun stake<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: &0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::PriceOracle, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::app_version::check_version(arg0.version);
        ...
        assert!(v2.state == 0, 303);
        let v3 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_usdt_from_pre(arg1, v0);
        0x2::balance::join<T0>(&mut arg0.pre_balance, 0x2::coin::into_balance<T0>(arg2));
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_cumulative_stake(&mut arg0.global_network_data, v0, v3);
        let v4 = StakeOrder{
    ...
    public fun unStake<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_redemption_pre(&mut arg0.global_network_data, v4);
    ...
    fun update_dynamic_power(arg0: &mut 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64) {
        let v0 = 0x2::table::borrow_mut<address, User>(arg1, arg2).inviter;
        let v1 = 1;
        while (0x1::option::is_some<address>(&v0) && v1 <= 30) {
            ...
            if (v8.invest_amount > 0 && v7 > 0) {
                ...
                0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_dynamic_power_distributed(arg0, v9);
            };
            v0 = v8.inviter;
            v1 = v1 + 1;
        };
