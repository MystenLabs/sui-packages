module 0xe83e1347b7360199c652beb51be942ad90986e19348e523a20faa541edc6f861::suipaynft {
    ...
    fun init(arg0: SUIPAYNFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v25 = v22;
        let v26 = 30;
        0xe83e1347b7360199c652beb51be942ad90986e19348e523a20faa541edc6f861::floor_price_rule::add<NFT>(&mut v25, &v24, v26);
    ...
    fun mintInternal(arg0: &mut ContractInfo, arg1: u8, arg2: u16, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        if (arg2 == 0) {
            arg2 = ((0xe83e1347b7360199c652beb51be942ad90986e19348e523a20faa541edc6f861::pseudorandom::rand_u32(arg7) % 65535) as u16);
        };
