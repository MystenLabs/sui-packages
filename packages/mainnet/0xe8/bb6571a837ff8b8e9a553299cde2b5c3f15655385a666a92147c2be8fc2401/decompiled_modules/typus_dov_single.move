module 0xa76499eda1d37751473de5f30e106f35943ada2f6ea764861243e7f5aa5bcc97::typus_dov_single {
    ...
    fun activate_<T0, T1, T2>(arg0: &ManagerCap, arg1: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::UserShareRegistry, arg2: &mut PortfolioVault<T0, T1, T2>, arg3: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::DepositVault<ManagerCap, T0>, arg4: u64, arg5: &0x6a11e0f3583b4bb8b22c3263f9c808f53dd12fdf36ebda5be4417a7d9e4a20dd::oracle::Oracle<T2>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::activate<ManagerCap, T0>(arg0, arg1, arg3, arg2.config.has_next, arg7);
        let v4 = arg2.config.activation_ts_ms + arg4;
        new_auction_<T0, T1, T2>(arg2, v4, arg5, arg6, arg7);
    }
    ...
    fun delivery_<T0, T1, T2>(arg0: &ManagerCap, arg1: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::UserShareRegistry, arg2: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::UserShareRegistry, arg3: &mut PortfolioVault<T0, T1, T2>, arg4: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::DepositVault<ManagerCap, T0>, arg5: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::BidVault<ManagerCap, T1>, arg6: &0x6a11e0f3583b4bb8b22c3263f9c808f53dd12fdf36ebda5be4417a7d9e4a20dd::oracle::Oracle<T2>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let (v6, v7, v8, v9, v10, v11, v12) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::dutch::delivery<ManagerCap, T1>(arg0, 0x1::option::extract<0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::dutch::Auction<ManagerCap, T1>>(&mut arg3.auction), v3, arg3.config.b_token_decimal, arg3.config.o_token_decimal, v4, v5, arg7, arg8);
        let v13 = DeliveryInfo{
        ...
        arg3.info.delivery_info = 0x1::option::some<DeliveryInfo>(v13);
        let v14 = if (v3 > 0) {
            ((((0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::active_share_supply<ManagerCap, T0>(arg4) + 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::deactivating_share_supply<ManagerCap, T0>(arg4)) as u128) * ((v3 - v10) as u128) / (v3 as u128)) as u64)
        } else {
            0
        };
        0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::delivery<ManagerCap, T0, T1>(arg0, arg1, arg2, arg4, arg5, v14, v6, v7, arg8);
        let v15 = Delivery<T0, T1, T2>{
        ...
        0x2::event::emit<Delivery<T0, T1, T2>>(v15);
    }
    ...
    public(friend) entry fun evolution<T0, T1, T2>(arg0: &ManagerCap, arg1: &mut Registry, arg2: u64, arg3: &0x6a11e0f3583b4bb8b22c3263f9c808f53dd12fdf36ebda5be4417a7d9e4a20dd::oracle::Oracle<T2>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = &mut arg1.id;
        let v1 = get_mut_portfolio_vault<T0, T1, T2>(v0, arg2);
        let v2 = get_auction_start_delay_ts_ms(&v1.id);
        let v3 = &mut arg1.deposit_vault_registry.user_share_registry;
        let v4 = &mut arg1.bid_vault_registry.user_share_registry;
        let v5 = &mut arg1.deposit_vault_registry.id;
        let v6 = get_mut_deposit_vault<T0>(v5, arg2);
        let v7 = &mut arg1.bid_vault_registry.id;
        let v8 = get_mut_bid_vault<T1>(v7, arg2);
        evolution_<T0, T1, T2>(arg0, v3, v4, v1, v6, v8, v2, arg3, arg4, arg5);
        let v9 = Evolution<T0, T1, T2>{
            signer : 0x2::tx_context::sender(arg5),
            index  : arg2,
        };
        0x2::event::emit<Evolution<T0, T1, T2>>(v9);
    }

    fun evolution_<T0, T1, T2>(arg0: &ManagerCap, arg1: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::UserShareRegistry, arg2: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::UserShareRegistry, arg3: &mut PortfolioVault<T0, T1, T2>, arg4: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::DepositVault<ManagerCap, T0>, arg5: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::BidVault<ManagerCap, T1>, arg6: u64, arg7: &0x6a11e0f3583b4bb8b22c3263f9c808f53dd12fdf36ebda5be4417a7d9e4a20dd::oracle::Oracle<T2>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<DeliveryInfo>(&arg3.info.delivery_info) && 0x1::option::borrow<DeliveryInfo>(&arg3.info.delivery_info).round == arg3.info.round) {
            settle_<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, arg5, arg7, arg8, arg9);
        };
        if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::has_next<ManagerCap, T0>(arg4)) {
            activate_<T0, T1, T2>(arg0, arg1, arg3, arg4, arg6, arg7, arg8, arg9);
        };
    }
    ...
    public(friend) fun get_auction_max_size<T0, T1, T2>(arg0: &Registry, arg1: u64, arg2: &0x6a11e0f3583b4bb8b22c3263f9c808f53dd12fdf36ebda5be4417a7d9e4a20dd::oracle::Oracle<T2>, arg3: &0x2::clock::Clock) : u64 {
        ...
        let (_, v3) = 0x6a11e0f3583b4bb8b22c3263f9c808f53dd12fdf36ebda5be4417a7d9e4a20dd::oracle::get_price<T2>(arg2, arg3);
        let v4 = 0x1::vector::borrow<PayoffConfig>(&v0.config.active_vault_config.payoff_configs, 0);
        calculate_max_auction_size(v0.config.o_token_decimal, v0.config.leverage, 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::active_balance<ManagerCap, T0>(v1) + 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::deactivating_balance<ManagerCap, T0>(v1), calculate_max_loss_per_unit(v0.config.option_type, calculate_spot(*0x1::option::borrow<u64>(&v4.strike), v4.strike_pct), v3, v0.config.d_token_decimal, v0.config.o_token_decimal, v0.config.active_vault_config.payoff_configs, v0.config.leverage), v0.config.lot_size)
    }

    fun get_auction_start_delay_ts_ms(arg0: &0x2::object::UID) : u64 {
        if (0x2::dynamic_field::exists_with_type<vector<u8>, u64>(arg0, b"auction_start_delay_ts_ms")) {
            *0x2::dynamic_field::borrow<vector<u8>, u64>(arg0, b"auction_start_delay_ts_ms")
        } else {
            0
        }
    }
    ...
    public(friend) fun get_max_loss_per_unit<T0, T1, T2>(arg0: &Registry, arg1: u64, arg2: &0x6a11e0f3583b4bb8b22c3263f9c808f53dd12fdf36ebda5be4417a7d9e4a20dd::oracle::Oracle<T2>, arg3: &0x2::clock::Clock) : u64 {
        let v0 = get_portfolio_vault<T0, T1, T2>(&arg0.id, arg1);
        let (_, v2) = 0x6a11e0f3583b4bb8b22c3263f9c808f53dd12fdf36ebda5be4417a7d9e4a20dd::oracle::get_price<T2>(arg2, arg3);
        let v3 = 0x1::vector::borrow<PayoffConfig>(&v0.config.active_vault_config.payoff_configs, 0);
        calculate_max_loss_per_unit(v0.config.option_type, calculate_spot(*0x1::option::borrow<u64>(&v3.strike), v3.strike_pct), v2, v0.config.d_token_decimal, v0.config.o_token_decimal, v0.config.active_vault_config.payoff_configs, v0.config.leverage)
    }
    ...
    public(friend) entry fun new_bid<T0, T1, T2>(arg0: &mut Registry, arg1: u64, arg2: &0x6a11e0f3583b4bb8b22c3263f9c808f53dd12fdf36ebda5be4417a7d9e4a20dd::oracle::Oracle<T2>, arg3: &0x2::clock::Clock, arg4: vector<0x2::coin::Coin<T1>>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = calculate_max_auction_size(v1.config.o_token_decimal, v1.config.leverage, 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::active_balance<ManagerCap, T0>(v3) + 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::deactivating_balance<ManagerCap, T0>(v3), calculate_max_loss_per_unit(v1.config.option_type, calculate_spot(*0x1::option::borrow<u64>(&v6.strike), v6.strike_pct), v5, v1.config.d_token_decimal, v1.config.o_token_decimal, v1.config.active_vault_config.payoff_configs, v1.config.leverage), v1.config.lot_size);
        let v8 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::dutch::total_bid_size<ManagerCap, T1>(0x1::option::borrow<0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::dutch::Auction<ManagerCap, T1>>(&v1.auction));
        assert!(v8 < v7, 11);
        if (v8 + arg5 > v7) {
            arg5 = v7 - v8;
        };
        ...
        let (v11, v12, v13, v14, v15, _) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::dutch::new_bid<ManagerCap, T1>(0x1::option::borrow_mut<0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::dutch::Auction<ManagerCap, T1>>(&mut v1.auction), arg5, v1.config.b_token_decimal, v1.config.o_token_decimal, v1.config.lot_size, arg4, v9, v10, arg3, arg6);
        let v17 = NewBid<T0, T1, T2>{
        ...
        0x2::event::emit<NewBid<T0, T1, T2>>(v17);
    }
    ...
    public(friend) entry fun update_auction_start_delay_ts_ms<T0, T1, T2>(arg0: &ManagerCap, arg1: &mut Registry, arg2: u64, arg3: u64) {
        version_check(arg1);
        let v0 = &mut arg1.id;
        let v1 = get_mut_portfolio_vault<T0, T1, T2>(v0, arg2);
        if (0x2::dynamic_field::exists_<vector<u8>>(&v1.id, b"auction_start_delay_ts_ms")) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, u64>(&mut v1.id, b"auction_start_delay_ts_ms") = arg3;
        } else {
            0x2::dynamic_field::add<vector<u8>, u64>(&mut v1.id, b"auction_start_delay_ts_ms", arg3);
        };
    }
    ...
    public(friend) entry fun upgrade_registry(arg0: &ManagerCap, arg1: &mut Registry) {
        assert!(6 > arg1.version, 1000);
        arg1.version = 6;
    }

    fun version_check(arg0: &Registry) {
        assert!(6 == arg0.version, 1000);
    }
