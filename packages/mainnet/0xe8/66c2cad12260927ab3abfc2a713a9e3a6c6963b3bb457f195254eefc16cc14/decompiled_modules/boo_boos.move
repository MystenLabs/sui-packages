module 0xe866c2cad12260927ab3abfc2a713a9e3a6c6963b3bb457f195254eefc16cc14::boo_boos {
    ...
    fun init(arg0: BOO_BOOS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BOO_BOOS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Boo Boos"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Boos Roaming on SUI "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://jz2g6e9eviX8fz3_xTjodfSkgvm0vlpQW53rmfHNy7A"));
