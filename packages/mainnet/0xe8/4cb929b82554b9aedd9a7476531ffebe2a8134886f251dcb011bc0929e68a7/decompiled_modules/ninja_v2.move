module 0xe84cb929b82554b9aedd9a7476531ffebe2a8134886f251dcb011bc0929e68a7::ninja_v2 {
    ...
    public fun accept_offer<T0: store + key, T1: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &mut 0x2::kiosk::Kiosk, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: 0x2::object::ID, arg8: &0x2::transfer_policy::TransferPolicy<T0>, arg9: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        let v7 = AcceptOffer<T1>{
            id           : 0x2::object::new(arg9),
            receiver     : v1,
            kiosk_id     : 0x2::object::id<0x2::kiosk::Kiosk>(arg1),
            nft_id       : arg3,
            purchase_cap : 0x2::kiosk::list_with_purchase_cap<T1>(arg1, arg2, arg3, 0, arg9),
            status       : 0,
        };
        0x2::dynamic_object_field::add<0x2::object::ID, AcceptOffer<T1>>(&mut arg0.id, arg3, v7);
        let (v8, v9) = 0x2::kiosk::purchase_with_cap<T0>(arg4, v5, 0x2::coin::zero<0x2::sui::SUI>(arg9));
        0x2::kiosk::lock<T0>(arg5, arg6, arg8, v8);
        let v10 = ClaimOffer{
    ...
    public fun create_offer<T0: store + key, T1: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun emergency_reset_acceptoffer<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        let AcceptOffer {
            id           : v0,
            receiver     : _,
            kiosk_id     : _,
        ...
        assert!(0x2::tx_context::sender(arg3) == @0x349c65d3fa8c667107fafe276f2260f54d0c97b6e403ce1686f3063a611e554d, 0);
        0x2::object::delete(v0);
        0x2::kiosk::return_purchase_cap<T0>(arg1, v4);
    }

    public fun emergency_reset_swapoffer<T0: store + key, T1: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        let SwapOffer {
            id            : v0,
            offerer       : _,
            offered_kiosk : _,
