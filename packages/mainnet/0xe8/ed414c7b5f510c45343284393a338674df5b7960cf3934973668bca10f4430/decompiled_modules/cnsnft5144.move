module 0xe8ed414c7b5f510c45343284393a338674df5b7960cf3934973668bca10f4430::cnsnft5144 {
    struct CNSNFT5144 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5144, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5144>(arg0, arg1);
