module 0xe8405ef1b9f20ee9337a05c5257e8f142a693fb1982f0216417d47f11b0c9aa3::dfund_etf {
    ...
    fun add_position_to_fund<T0>(arg0: &mut FundETF, arg1: 0x1::type_name::TypeName, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun contribute_sui_to_fund(arg0: &mut FundETF, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x1::option::Option<HotPotatoContributionTransaction>, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<HotPotatoContributionTransaction> {
        ...
        let v1 = &mut arg1;
        take_fee<0x2::sui::SUI>(v1, arg0.creator, arg3, arg0.in_fee, arg4);
        ...
        update_contribution_transaction(arg0, arg2, v0, v2, v2, v5, v4)
    }
    ...
    fun emit_fee_event(arg0: address, arg1: address, arg2: u64, arg3: u64, arg4: 0x1::type_name::TypeName) {
        let v0 = FeeEvent{
            creator       : arg0,
            affiliate     : arg1,
            creator_fee   : arg2,
    ...
    fun swap_position_to_sui<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: &FundETF, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, u64) {
        ...
        assert!(v0, 2);
        let (v2, v3) = 0xe8405ef1b9f20ee9337a05c5257e8f142a693fb1982f0216417d47f11b0c9aa3::swapper::cetus_swap_a2b<T0, 0x2::sui::SUI>(arg3, arg1, arg0, arg4, arg5);
        let v4 = v3;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v4, 0x2::tx_context::sender(arg5));
        (v2, 0x2::coin::value<T0>(&v4))
    }

    fun take_fee<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: address, arg2: 0x1::option::Option<address>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        if (arg3 == 0) {
            return
        };
