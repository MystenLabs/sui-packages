module 0xe8aa8601cf73030bea5f10ec136d1b44ec81aacb10e8b69e95a4115523aa2068::reward8516 {
    struct REWARD8516 has drop {
        dummy_field: bool,
    }

    struct TICKET_8516 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8516(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8516>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8516>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8516, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8516>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8516>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8516>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8516>>(v5, 0x2::tx_context::sender(arg1));
    }
