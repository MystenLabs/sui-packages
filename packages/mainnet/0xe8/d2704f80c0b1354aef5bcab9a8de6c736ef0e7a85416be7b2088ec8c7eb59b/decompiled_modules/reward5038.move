module 0xe8d2704f80c0b1354aef5bcab9a8de6c736ef0e7a85416be7b2088ec8c7eb59b::reward5038 {
    struct REWARD5038 has drop {
        dummy_field: bool,
    }

    struct TICKET_5038 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5038(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5038>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5038>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5038, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5038>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5038>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5038>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5038>>(v5, 0x2::tx_context::sender(arg1));
    }
