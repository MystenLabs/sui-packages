module 0x5da13a1e55b05f6da745dcc293f46970de58429cc2badb373bf1cfcd66b4cb76::llv_pool {
    ...
    struct ManagementFeeCapBpsKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public fun get_management_fee_cap_bps<T0, T1>(arg0: &LLVPool<T0, T1>) : u64 {
        let v0 = management_fee_cap_bps_key();
        if (0x2::dynamic_field::exists<ManagementFeeCapBpsKey>(&arg0.id, v0)) {
            *0x2::dynamic_field::borrow<ManagementFeeCapBpsKey, u64>(&arg0.id, v0)
        } else {
            500
        }
    }
    ...
    fun management_fee_cap_bps_key() : ManagementFeeCapBpsKey {
        ManagementFeeCapBpsKey{dummy_field: false}
    }
    ...
    public(friend) fun set_management_fee_cap_bps<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0x2::tx_context::TxContext, arg2: u64) {
        ...
        let v0 = management_fee_cap_bps_key();
        if (0x2::dynamic_field::exists<ManagementFeeCapBpsKey>(&arg0.id, v0)) {
            *0x2::dynamic_field::borrow_mut<ManagementFeeCapBpsKey, u64>(&mut arg0.id, v0) = arg2;
        } else {
            0x2::dynamic_field::add<ManagementFeeCapBpsKey, u64>(&mut arg0.id, v0, arg2);
        };
    }
