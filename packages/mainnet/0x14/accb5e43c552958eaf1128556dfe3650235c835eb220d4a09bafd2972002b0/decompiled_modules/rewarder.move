module 0x14accb5e43c552958eaf1128556dfe3650235c835eb220d4a09bafd2972002b0::rewarder {
    ...
    public fun deposit_reward<T0>(arg0: &0x14accb5e43c552958eaf1128556dfe3650235c835eb220d4a09bafd2972002b0::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) : u64 {
    ...
    public fun emergent_withdraw<T0>(arg0: &0x14accb5e43c552958eaf1128556dfe3650235c835eb220d4a09bafd2972002b0::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x14accb5e43c552958eaf1128556dfe3650235c835eb220d4a09bafd2972002b0::config::checked_package_version(arg0);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg3), 0x14accb5e43c552958eaf1128556dfe3650235c835eb220d4a09bafd2972002b0::config::get_reward_receiver(arg0));
    ...
    public(friend) fun settle(arg0: &mut RewarderManager, arg1: u128, arg2: u64) {
        ...
        while (v2 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            ...
            0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v2).growth_global = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).growth_global + 0x5f7a7744be085d6f92587f4a0aa5d6ff85a6c804196c5a1f1bb34b0cb2db6c54::full_math_u128::mul_div_floor((v1 as u128), v3, arg1);
            v2 = v2 + 1;
        };
        let v4 = 18446744073709551616000000;
        arg0.points_released = arg0.points_released + (v1 as u128) * v4;
        arg0.points_growth_global = arg0.points_growth_global + 0x5f7a7744be085d6f92587f4a0aa5d6ff85a6c804196c5a1f1bb34b0cb2db6c54::full_math_u128::mul_div_floor((v1 as u128), v4, arg1);
    }
