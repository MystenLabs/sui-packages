module 0x143eb55f7efedcc3f39b317e7f7794e5a0cd203782f01f8c1718ee72137c0001::nft {
    ...
    public entry fun batch_mint(arg0: &mut MembershipCap, arg1: &mut CollectionDetails, arg2: &mut Supply, arg3: &mut QuestionInfo, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::ascii::String, arg7: bool, arg8: u64, arg9: u64, arg10: address, arg11: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun edit_question(arg0: &Admin, arg1: &mut QuestionInfo, arg2: 0x1::string::String, arg3: u64, arg4: u64) {
        arg1.question = arg2;
    ...
    public fun question_id(arg0: &NFT) : &u64 {
        &arg0.question_id
    }

    public entry fun question_register(arg0: &Admin, arg1: &mut Supply, arg2: &mut CollectionDetails, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!0x2::dynamic_object_field::exists_<u64>(&arg2.id, arg4), 0);
        let v0 = QuestionInfo{
        ...
        0x2::dynamic_object_field::add<u64, QuestionValidity>(&mut arg2.id, arg4, v1);
    ...
    public entry fun set_membership(arg0: &Admin, arg1: vector<address>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 != 0) {
            let v1 = MembershipCap{id: 0x2::object::new(arg2)};
            let v2 = MemberAddedEvent{
                new_member : 0x1::vector::pop_back<address>(&mut arg1),
                member_id  : 0x2::object::uid_to_inner(&v1.id),
            };
            0x2::event::emit<MemberAddedEvent>(v2);
            0x2::transfer::share_object<MembershipCap>(v1);
            v0 = v0 - 1;
        };
    }
