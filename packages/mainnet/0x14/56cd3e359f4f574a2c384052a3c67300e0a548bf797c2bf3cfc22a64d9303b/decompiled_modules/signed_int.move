module 0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::signed_int {
    ...
    public fun signed_w_div_to_zero(arg0: SignedInt, arg1: SignedInt) : SignedInt {
        SignedInt{
            value       : 0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::math::mul_div_down(arg0.value, 0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::math::wad(), arg1.value),
    ...
    public fun signed_w_mul_to_zero(arg0: SignedInt, arg1: SignedInt) : SignedInt {
        SignedInt{
            value       : 0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::math::mul_div_down(arg0.value, arg1.value, 0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::math::wad()),
            is_negative : arg0.is_negative != arg1.is_negative,
        }
    }
    ...
    public fun w_exp(arg0: SignedInt) : SignedInt {
        if (arg0.is_negative && arg0.value > 0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::math::ln_wei()) {
            return signed_zero()
        };
        if (!arg0.is_negative && arg0.value >= 0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::math::wexp_upper_bound()) {
            return signed_from_u128(0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::math::wexp_upper_value())
        };
        let v0 = if (arg0.is_negative) {
            QValue{q: (arg0.value + 0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::math::ln_2() / 2) / 0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::math::ln_2(), is_negative: true}
        } else {
            QValue{q: (arg0.value + 0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::math::ln_2() / 2) / 0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::math::ln_2(), is_negative: false}
        };
        let v1 = v0;
        let v2 = v1.q * 0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::math::ln_2();
        ...
        let v6 = signed_add(signed_from_u128(0x1456cd3e359f4f574a2c384052a3c67300e0a548bf797c2bf3cfc22a64d9303b::math::wad()), signed_add(v3, v5));
        if (v1.is_negative) {
            let v8 = if (v1.q > 127) {
                127
            } else {
