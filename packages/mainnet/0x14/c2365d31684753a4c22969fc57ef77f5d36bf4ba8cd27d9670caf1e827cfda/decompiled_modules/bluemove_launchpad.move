module 0x6a68d41497c29eddc172bcf381822040acdc3a4114f2aa1b79a6f82d9d9ba2bc::bluemove_launchpad {
    ...
    public entry fun burn_nft(arg0: Eggworld, arg1: &mut 0x2::tx_context::TxContext) {
        let Eggworld {
            id          : v0,
            name        : v1,
            description : _,
        ...
        let v5 = BurnEvent{
            object_id : 0x2::object::id<Eggworld>(&arg0),
    ...
    public entry fun claim_nfts(arg0: &mut LaunchpadData, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v11 > 0) {
            ...
            let v13 = arg0.base_name;
            0x1::string::append(&mut v13, num_str(v12));
            let v14 = arg0.base_image_url;
            0x1::string::append(&mut v14, num_str(v12));
            0x1::string::append(&mut v14, 0x1::string::utf8(b".png"));
            let v15 = arg0.base_url;
            0x1::string::append(&mut v15, num_str(v12));
            0x1::string::append(&mut v15, 0x1::string::utf8(b".json"));
            let v16 = Eggworld{
            ...
            let v17 = MintNFTEvent{
                object_id : 0x2::object::id<Eggworld>(&v16),
                creator   : v0,
                name      : v13,
            };
            0x2::event::emit<MintNFTEvent>(v17);
            0x2::transfer::public_transfer<Eggworld>(v16, v0);
            arg0.current_nft = v12 + 1;
            v11 = v11 - 1;
        };
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LaunchpadData{
            ...
            minted         : 0,
            current_nft    : 0,
            base_name      : 0x1::string::utf8(b"Tropolis Club #"),
            base_url       : 0x1::string::utf8(b"https://static.bluemove.net/tropolis-club/"),
            base_image_url : 0x1::string::utf8(b"https://ipfs.bluemove.net/uploads2/tropolis-club/images/"),
            description    : 0x1::string::utf8(b"Project with world of daily missions/tasks for our DAO. Earn $TCT meme coin by staking, be first!"),
            ...
            fund_address   : @0x83790fc9c3963344be91e401992d9dde0ba3865efc554e1e2528b1d8897802ea,
            balance        : 0x2::balance::zero<0x2::sui::SUI>(),
            total_nft      : v0,
            pre_mint       : 0,
        };
        let v2 = 0x2::tx_context::sender(arg1);
        let (v3, v4) = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::create_with_mint_cap<BLUEMOVE_LAUNCHPAD, Eggworld>(&arg0, 0x1::option::some<u64>(v0), arg1);
        let v5 = v3;
        let v6 = Witness{dummy_field: false};
        let v7 = 0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::from_witness<Eggworld, Witness>(v6);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::add_domain<Eggworld, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::creators::Creators>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::creators::new(0x2::vec_set::singleton<address>(v2)));
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::add_domain<Eggworld, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::display_info::DisplayInfo>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::display_info::new(0x1::string::utf8(b"Tropolis Club"), 0x1::string::utf8(b"Project with world of daily missions/tasks for our DAO. Earn $TCT meme coin by staking, be first!")));
        ...
        let v11 = 0x2::display::new<Eggworld>(&v8, arg1);
        0x2::display::add<Eggworld>(&mut v11, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<Eggworld>(&mut v11, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<Eggworld>(&mut v11, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"{image_url}"));
        0x2::display::add<Eggworld>(&mut v11, 0x1::string::utf8(b"tags"), 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::display::from_vec(v9));
        0x2::display::update_version<Eggworld>(&mut v11);
        0x2::transfer::public_transfer<0x2::display::Display<Eggworld>>(v11, 0x2::tx_context::sender(arg1));
        let (v12, v13) = 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::init_policy<Eggworld>(&v8, arg1);
        let v14 = v13;
        let v15 = v12;
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::enforce<Eggworld>(&mut v15, &v14);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::transfer_allowlist::enforce<Eggworld>(&mut v15, &v14);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::create_domain_and_add_strategy<Eggworld>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty::from_address(@0x83790fc9c3963344be91e401992d9dde0ba3865efc554e1e2528b1d8897802ea, arg1), 500, arg1);
        0x2::transfer::public_transfer<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<Eggworld>>(v4, v2);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v8, v2);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<Eggworld>>(v14, v2);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<Eggworld>>(v15);
        0x2::transfer::public_share_object<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<Eggworld>>(v5);
    ...
    public entry fun pre_nfts(arg0: &mut LaunchpadData, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg1 > 0) {
            ...
            0x2::transfer::public_transfer<Eggworld>(v4, arg2);
            arg0.current_nft = v0;
