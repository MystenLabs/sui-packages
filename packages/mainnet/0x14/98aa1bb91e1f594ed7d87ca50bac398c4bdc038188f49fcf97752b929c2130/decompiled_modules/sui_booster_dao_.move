module 0x1498aa1bb91e1f594ed7d87ca50bac398c4bdc038188f49fcf97752b929c2130::sui_booster_dao_ {
    struct SUI_BOOSTER_DAO_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_BOOSTER_DAO_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_BOOSTER_DAO_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sui Booster DAO "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
