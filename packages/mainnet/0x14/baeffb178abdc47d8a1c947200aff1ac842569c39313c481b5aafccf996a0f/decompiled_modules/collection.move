module 0x14baeffb178abdc47d8a1c947200aff1ac842569c39313c481b5aafccf996a0f::collection {
    ...
    public entry fun changeCollectionDescription(arg0: 0x1::string::String, arg1: &mut Collection, arg2: &mut 0x2::tx_context::TxContext) {
        0x14baeffb178abdc47d8a1c947200aff1ac842569c39313c481b5aafccf996a0f::admin::is_admin(arg1.admin, 0x2::tx_context::sender(arg2));
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Collection{
            ...
            name                   : 0x1::string::utf8(b"SpacyGuilds"),
            description            : 0x1::string::utf8(b"555 Solders at war for an intergalactic mission. Come become a part of a revolution. 0% Royalties. 100% Community Driven."),
            supply                 : 555,
            url                    : 0x2::url::new_unsafe_from_bytes(b"https://bettasui.xyz/collection/35/profile.png"),
            metadata_uri           : 0x1::string::utf8(b"https://ipfs.io/ipfs/QmdvVMbykZwT4w9Gryt8bvxSzZweddeP8VXPqcJZT38ZB5/Spacy Guilds"),
            minted                 : 0,
            max_mint_per_whitelist : 3000000000,
            whitelist_price        : 0,
            max_public_per_wallet  : 555,
            public_price           : 3000000000,
            launchpad_fee          : 3,
            creator                : @0x92dab9eff3a64619cad5168ad6745424bf3c5b2c0f05b1c50fe5d0bbf67752a1,
