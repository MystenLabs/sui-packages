module 0x14490ec93ef29a63174ce74fcb5f3c37b3500b44951beebcef55f1d49252ea6c::dege {
    ...
    fun init(arg0: DEGE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/CPG7gjcjcdZGHE5EJ6LoAL4xqZtNFeWEXXmtkYjAoVaF.png?size=lg&key=994fc2                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DEGE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Dege    ")))), trim_right(b"DegeCoin                        "), trim_right(b"$DEGE - Dogecoins degenerate brother.                                                                                                                                                                                                                                                                                           "), v2, arg1);
        let v5 = v3;
