module 0x14593f6318c8da20da7bd0fbce4f2fae5b287e95b3bf053392d6c19066275984::cnsnft4478 {
    struct CNSNFT4478 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4478, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8515"));
        let v4 = 0x2::package::claim<CNSNFT4478>(arg0, arg1);
