module 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::treasury_router {
    ...
    fun pay_and_mint_internal(arg0: address, arg1: u8, arg2: u64, arg3: vector<u8>, arg4: bool, arg5: vector<u8>, arg6: vector<u8>, arg7: address, arg8: u64, arg9: u64, arg10: 0x2::coin::Coin<0x2::sui::SUI>, arg11: &0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::config_registry::Config, arg12: &mut 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::pricing_guard::Guard, arg13: &mut 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::MintVault, arg14: &mut 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::pol_treasury::Treasury, arg15: &mut 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::daily_mints::DailyMints, arg16: &mut 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::memory_ledger::MemoryLedger, arg17: &0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::timate_params::TimateParams, arg18: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg19: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg20: &0x2::clock::Clock, arg21: &mut 0x2::tx_context::TxContext) {
        ...
        let v16 = 0;
        let v17 = 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::config_registry::dev_addr(arg11);
        let v18 = 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::config_registry::dev_tvyn_ratio_bps(arg11);
        ...
        let v19 = if (arg1 == 1) {
            ...
            if (v20 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN>>(0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::mint_for_protocol(arg13, v20, arg21), arg0);
                v16 = v20;
                let v21 = v20 * v18 / 10000;
                if (v21 > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN>>(0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::mint_for_protocol(arg13, v21, arg21), v17);
                };
            };
            if (arg4) {
                let v22 = 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::anniversary_vault::mint_ticket(arg2, arg3, arg5, arg6, arg7, 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::config_registry::default_royalty_bps(arg11), v0, arg20, arg21);
                let v23 = 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::anniversary_vault::ticket_id(&v22);
                0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::memory_ledger::note_today(arg16, v23, arg7, arg2);
                0x2::transfer::public_transfer<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::anniversary_vault::Today365>(v22, arg7);
                0x1::option::some<0x2::object::ID>(v23)
            } else {
                let v24 = 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::ghost_memory::mint(0x2::clock::timestamp_ms(arg20), arg7, 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::config_registry::default_royalty_bps(arg11), arg21);
                0x2::transfer::public_transfer<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::ghost_memory::GhostMemory>(v24, arg7);
                0x1::option::some<0x2::object::ID>(0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::ghost_memory::id(&v24))
            }
        } else {
            let v25 = if (v0) {
            ...
            let v26 = 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::timate_params::reward_per_mate_tvyn(arg17);
            if (v25 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN>>(0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::mint_for_protocol(arg13, v25, arg21), arg0);
                v16 = v25;
                let v27 = v25 * v18 / 10000;
                if (v27 > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN>>(0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::mint_for_protocol(arg13, v27, arg21), v17);
                };
            };
            let v28 = ((arg2 / 10000) as u64);
            let v19 = if (arg4) {
                let v29 = 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::nostalgia_ticket::mint_ticket((v28 as u16), arg3, arg5, arg6, arg7, 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::config_registry::default_royalty_bps(arg11), 0x2::clock::timestamp_ms(arg20), arg21);
                0x2::transfer::public_transfer<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::nostalgia_ticket::NostalgiaTicket>(v29, arg7);
                0x1::option::some<0x2::object::ID>(0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::nostalgia_ticket::ticket_id(&v29))
            } else {
                let v30 = 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::ghost_memory::mint(0x2::clock::timestamp_ms(arg20), arg7, 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::config_registry::default_royalty_bps(arg11), arg21);
                0x2::transfer::public_transfer<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::ghost_memory::GhostMemory>(v30, arg7);
                0x1::option::some<0x2::object::ID>(0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::ghost_memory::id(&v30))
            };
            let v31 = 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::memory_ledger::pair_or_wait_nostalgia(arg16, arg0, v28);
            if (0x1::option::is_some<address>(&v31)) {
                ...
                if (v26 > 0) {
                    ...
                    0x2::transfer::public_transfer<0x2::coin::Coin<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN>>(0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::mint_for_protocol(arg13, v26, arg21), v32);
                    v16 = v16 + v26;
                    let v33 = v26 * 2 * v18 / 10000;
                    if (v33 > 0) {
                        0x2::transfer::public_transfer<0x2::coin::Coin<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN>>(0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::mint_for_protocol(arg13, v33, arg21), v17);
                    };
                };
