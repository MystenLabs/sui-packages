module 0x146773f468b2b623a10b5ef8cfb921299f1a6a77ceab207a3b070af96fdc049c::acl {
    ...
    public fun finish_transfer<T0>(arg0: SuperAdmin<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x146773f468b2b623a10b5ef8cfb921299f1a6a77ceab207a3b070af96fdc049c::events::finish_super_admin_transfer(v0);
    }
    ...
    public fun new_admin<T0>(arg0: &mut ACL<T0>, arg1: &SuperAdmin<T0>, arg2: &mut 0x2::tx_context::TxContext) : Admin<T0> {
        ...
        0x146773f468b2b623a10b5ef8cfb921299f1a6a77ceab207a3b070af96fdc049c::events::new_admin(0x2::object::uid_to_address(&v0.id));
        v0
    }
    ...
    public fun revoke<T0>(arg0: &mut ACL<T0>, arg1: &SuperAdmin<T0>, arg2: address) {
        ...
        0x146773f468b2b623a10b5ef8cfb921299f1a6a77ceab207a3b070af96fdc049c::events::revoke_admin(arg2);
    }
    ...
    public fun start_transfer<T0>(arg0: &mut SuperAdmin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.new_admin = arg1;
        0x146773f468b2b623a10b5ef8cfb921299f1a6a77ceab207a3b070af96fdc049c::events::start_super_admin_transfer(arg1, arg0.start);
    }
