module 0x14dd8099f58b1a94746d578c715092505dfe7c59c67e8fdd57c3441d4462bc2c::reward2534 {
    struct REWARD2534 has drop {
        dummy_field: bool,
    }

    struct TICKET_2534 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2534(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2534>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2534>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2534, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2534>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2534>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2534>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2534>>(v5, 0x2::tx_context::sender(arg1));
    }
