module 0x14ca4a580810bd018af57ebd60b06c2aad31c7337f0dd4ba4811662c01f0b632::cnsnft8235 {
    struct CNSNFT8235 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8235, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9693"));
        let v4 = 0x2::package::claim<CNSNFT8235>(arg0, arg1);
