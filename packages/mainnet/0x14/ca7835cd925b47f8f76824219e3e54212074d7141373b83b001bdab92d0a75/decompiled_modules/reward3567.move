module 0x14ca7835cd925b47f8f76824219e3e54212074d7141373b83b001bdab92d0a75::reward3567 {
    struct REWARD3567 has drop {
        dummy_field: bool,
    }

    struct TICKET_3567 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3567(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3567>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3567>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3567, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3567>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3567>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3567>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3567>>(v5, 0x2::tx_context::sender(arg1));
    }
