module 0x146134d9e09d4cfae8308758b262863d3e273d8b7d2b98ba660827cfce08db9b::cnsnft4633 {
    struct CNSNFT4633 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4633, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4633>(arg0, arg1);
