module 0x14d05323b0a0685b3f1d8db0fbab75acac3d510170a9bf6d5b4a8c624b7c4941::suiball_nft {
    ...
    public entry fun transfer(arg0: SuiballNFT, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<SuiballNFT>(arg0, arg1);
    }
    ...
    fun init(arg0: SUIBALL_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"SUIBALL NFT"));
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"SuiballNFT"));
    ...
    public entry fun mint_to_sender(arg0: &mut ItemStore, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0;
        loop {
            let v1 = SuiballNFT{id: 0x2::object::new(arg3)};
            arg0.counter = arg0.counter + 1;
            0x2::transfer::public_transfer<SuiballNFT>(v1, 0x2::tx_context::sender(arg3));
            v0 = v0 + 1;
            if (v0 == arg2) {
                break
            };
