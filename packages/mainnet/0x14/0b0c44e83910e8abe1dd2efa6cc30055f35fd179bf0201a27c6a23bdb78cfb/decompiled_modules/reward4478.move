module 0x140b0c44e83910e8abe1dd2efa6cc30055f35fd179bf0201a27c6a23bdb78cfb::reward4478 {
    struct REWARD4478 has drop {
        dummy_field: bool,
    }

    struct TICKET_4478 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4478(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4478>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4478>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4478, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4478>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4478>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4478>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4478>>(v5, 0x2::tx_context::sender(arg1));
    }
