module 0x14afcae1376d0be424c2cd8b6780fcfc2775e6dfc2afdb8e1489ddf225f2bd4c::state {
    ...
    public(friend) fun new(arg0: 0x2::package::UpgradeCap, arg1: address, arg2: address, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : State {
        ...
        0x2::dynamic_field::add<CurrentVersion, 0x14afcae1376d0be424c2cd8b6780fcfc2775e6dfc2afdb8e1489ddf225f2bd4c::version_control::V__1_0_0>(&mut v0.id, v1, 0x14afcae1376d0be424c2cd8b6780fcfc2775e6dfc2afdb8e1489ddf225f2bd4c::version_control::current_version());
        v0
    }
