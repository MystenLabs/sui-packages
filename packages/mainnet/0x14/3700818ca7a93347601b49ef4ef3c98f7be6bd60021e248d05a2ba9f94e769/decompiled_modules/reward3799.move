module 0x143700818ca7a93347601b49ef4ef3c98f7be6bd60021e248d05a2ba9f94e769::reward3799 {
    struct REWARD3799 has drop {
        dummy_field: bool,
    }

    struct TICKET_3799 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3799(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3799>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3799>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3799, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3799>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3799>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3799>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3799>>(v5, 0x2::tx_context::sender(arg1));
    }
