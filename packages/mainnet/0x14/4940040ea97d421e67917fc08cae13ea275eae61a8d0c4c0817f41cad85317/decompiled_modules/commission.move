module 0x144940040ea97d421e67917fc08cae13ea275eae61a8d0c4c0817f41cad85317::commission {
    ...
    public fun new(arg0: address, arg1: u8, arg2: u64, arg3: bool, arg4: bool) : Commission {
        if (arg1 != 0x144940040ea97d421e67917fc08cae13ea275eae61a8d0c4c0817f41cad85317::commission_type::percentage() && arg1 != 0x144940040ea97d421e67917fc08cae13ea275eae61a8d0c4c0817f41cad85317::commission_type::flat() || arg2 == 0) {
            abort 0
        };
        Commission{
            partner         : arg0,
