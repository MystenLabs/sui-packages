module 0x14589d315a3d7726385285baad693e3cab942a97bcedd3b32150ee0974723de1::dbke {
    ...
    public fun elb<T0, T1, T2>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x61e43d6889970253a03978b179967d46a01ced914ff3b5581b76fb0d9f283c8a::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2::clock::Clock, arg4: bool, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<bool>, arg10: vector<u64>, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < 0x1::vector::length<u64>(&arg7)) {
            ...
            let v7 = *0x1::vector::borrow<u64>(&arg7, v4);
            let v8 = *0x1::vector::borrow<bool>(&arg9, v4);
            let v9 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg0, arg2, &v0, v4, *0x1::vector::borrow<u8>(&arg5, v4), *0x1::vector::borrow<u8>(&arg6, v4), v7, *0x1::vector::borrow<u64>(&arg8, v4), v8, true, v5, arg3, arg11);
            if (v8) {
                v1 = v1 + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v9);
                v2 = v2 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v9) * v7 / 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() + 1;
            } else {
                v1 = v1 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v9);
                let v10 = v2 + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v9) * v7 / 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling();
                v2 = v10 - 1;
            };
            v3 = v3 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::paid_fees(&v9);
            v4 = v4 + 1;
        };
    }
    ...
    public fun elf<T0, T1, T2>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x61e43d6889970253a03978b179967d46a01ced914ff3b5581b76fb0d9f283c8a::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2::clock::Clock, arg4: &mut 0x67a4708740dcc8cfd86aea52b11d1972fe1fd9e9f3070b49763d55fe609611a1::sq::SQR, arg5: u64, arg6: bool, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u64>, arg10: vector<u64>, arg11: vector<bool>, arg12: vector<u64>, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        while (v12 < 0x1::vector::length<u64>(&arg9)) {
            ...
            if (v15 == 111) {
                if (!v9) {
                    let (v21, _, v23, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::get_level2_ticks_from_mid<T0, T1>(arg0, 1, arg3);
                    v10 = v21;
                    v11 = v23;
                    v9 = true;
                };
                let v25 = sp(&v10, &v11, v3, v17, v19);
                if (v25 == 0) {
                    let v26 = EE{
                        e : 1,
                        l : v12,
            ...
            let (v27, v28) = vbac<T0, T1>(arg0, v6, v7, v8, v3, v4, v5, v20, v18, v19, cim(v15), true);
            if (v28 != 0) {
                let v29 = EE{
                    e : v28,
                    l : v12,
            ...
            let v30 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg0, arg2, &v2, v12, v15, v16, v20, v27, v19, true, v13, arg3, arg13);
            if (v19) {
                v6 = v6 + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v30);
                v7 = v7 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v30) * v20 / 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() + 1;
            } else {
                v6 = v6 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v30);
                let v31 = v7 + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v30) * v20 / 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling();
                v7 = v31 - 1;
            };
            v8 = v8 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::paid_fees(&v30);
            v12 = v12 + 1;
        };
    }

    public fun sp(arg0: &vector<u64>, arg1: &vector<u64>, arg2: u64, arg3: u64, arg4: bool) : u64 {
        if (arg4) {
