module 0x1654c207d5032d4147510a10de53bfbc2703bfc96353b0b4547435a9f6ca5583::lb_sale {
    ...
    public entry fun admin_update_price<T0, T1>(arg0: &mut SaleConfig<T0, T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun buyLb<T0, T1>(arg0: &mut SaleConfig<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.lb_balance, v2), arg3), v0);
