module 0x147eb786eab5386f657ea987e1849479929951494f3f8a8333810589be90a5cf::stake {
    ...
    public fun stake<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun claimRewards<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 8008);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg0.reward_coins, (v2 as u64), arg2), v0);
    ...
    public entry fun createPool<T0, T1>(arg0: &Admincap, arg1: u64, arg2: u128, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 8001);
        let v0 = StakePool<T0, T1>{
            ...
            paused       : false,
            unlock_times : arg1,
            stake_coins  : 0x2::coin::zero<T0>(arg3),
            reward_coins : 0x2::coin::zero<T1>(arg3),
            stakes       : 0x2::table::new<address, UserStake>(arg3),
        };
    ...
    public entry fun deposit_reward_coins<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: 0x2::coin::Coin<T1>) {
        let v0 = (0x2::coin::value<T1>(&arg2) as u128);
        assert!(v0 > 0, 8002);
        0x2::coin::join<T1>(&mut arg1.reward_coins, arg2);
    ...
    public entry fun stakeRewards<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 8008);
        let v0 = 0x2::tx_context::sender(arg2);
    ...
    public entry fun stopEmergency<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: vector<address>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            ...
            if (0x2::table::contains<address, UserStake>(&mut arg1.stakes, v1)) {
                ...
                v2.spt_staked = 0;
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg1.stake_coins, (v3 as u64), arg4), v1);
                v0 = v0 + 1;
            } else {
                break
            };
    ...
    public fun unstake<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: u128, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 8008);
    ...
    public entry fun updateApy<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: vector<address>, arg3: u128, arg4: &0x2::clock::Clock) {
        assert!(arg3 > 0, 8001);
        arg1.apy = arg3;
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            ...
            if (0x2::table::contains<address, UserStake>(&arg1.stakes, v1)) {
                let v2 = 0x2::table::borrow_mut<address, UserStake>(&mut arg1.stakes, v1);
                update_reward_remaining(arg3, 0x2::clock::timestamp_ms(arg4), v2);
    ...
    public entry fun updateApyV2<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: vector<address>, arg3: u128, arg4: u128, arg5: &0x2::clock::Clock) {
        assert!(arg3 > 0, 8001);
        arg1.apy = arg3;
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            ...
            if (0x2::table::contains<address, UserStake>(&arg1.stakes, v1)) {
                let v2 = 0x2::table::borrow_mut<address, UserStake>(&mut arg1.stakes, v1);
                update_reward_remaining(arg4, 0x2::clock::timestamp_ms(arg5), v2);
                let v3 = UpdateApyEvent{
                    poo_id                    : 0x2::object::uid_to_address(&arg1.id),
                    user_address              : v1,
                    apy                       : arg3,
    ...
    public entry fun updateUnlockTime<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: u64) {
        assert!(arg2 > 0, 8001);
    ...
    public entry fun withdrawSpt<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 8008);
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x2::table::contains<address, UserStake>(&mut arg0.stakes, v0), 8003);
        let v1 = 0x2::table::borrow_mut<address, UserStake>(&mut arg0.stakes, v0);
        ...
        v1.withdraw_stake = 0;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg0.stake_coins, (v1.withdraw_stake as u64), arg2), v0);
    ...
    public entry fun withdraw_reward_coins<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = (0x2::coin::value<T1>(&arg1.reward_coins) as u128);
        assert!(v0 > 0, 8003);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg1.reward_coins, (v0 as u64), arg2), 0x2::tx_context::sender(arg2));
