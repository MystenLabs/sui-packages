module 0x14ce19846d024d6fbec5de17dcf3b5ab9d4785e22a79c1b675cfc63042b8c139::tokenservice {
    ...
    public entry fun fmrpmqiirqfttqk<T0: store + key>(arg0: &mut AirdropPoolInfo, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun gaxvbdhvtshytoo(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut AirdropPoolInfo, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2.initialized) {
    ...
    public entry fun lmdzvcitjilintn<T0>(arg0: &mut AirdropPoolInfo, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.delegate, 0);
