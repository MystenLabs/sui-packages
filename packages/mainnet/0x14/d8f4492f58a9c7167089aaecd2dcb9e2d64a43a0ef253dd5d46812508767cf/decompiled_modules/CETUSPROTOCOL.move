module 0x14d8f4492f58a9c7167089aaecd2dcb9e2d64a43a0ef253dd5d46812508767cf::CETUSPROTOCOL {
    ...
    public entry fun Reward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = CETUS_VOUCHER{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/cetuslab_0629/cetuslab_0629_3.jpg"),
    ...
    fun init(arg0: CETUSPROTOCOL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/cetuslab_0629/cetuslab_0629_3.jpg"));
