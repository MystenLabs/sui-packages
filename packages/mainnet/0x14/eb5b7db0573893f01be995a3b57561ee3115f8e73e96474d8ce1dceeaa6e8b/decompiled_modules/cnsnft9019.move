module 0x14eb5b7db0573893f01be995a3b57561ee3115f8e73e96474d8ce1dceeaa6e8b::cnsnft9019 {
    struct CNSNFT9019 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9019, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3973"));
        let v4 = 0x2::package::claim<CNSNFT9019>(arg0, arg1);
