module 0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::hashi_rewards {
    ...
    public fun claim_reward<T0>(arg0: &mut HashiRewardRegistry, arg1: &mut HashiRewardBatch<T0>, arg2: 0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::pool::MinerWorkRecord, arg3: &0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::pool::RoundHistory, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == 1, 13906835359754616837);
        assert!(0x2::clock::timestamp_ms(arg4) < arg1.claim_deadline_ms, 13906835364049715207);
        let (v0, v1, v2) = 0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::pool::consume_work_record(arg2);
        assert!(v0 == arg1.round_id, 13906835381229846539);
        assert!(v0 == 0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::pool::round_history_round_id(arg3), 13906835385524813835);
        assert!(v1 == 0x2::tx_context::sender(arg5), 13906835389820043279);
        let v3 = 0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::pool::round_history_total_work(arg3);
    ...
    public fun open_and_fund_round_batch<T0>(arg0: &mut HashiRewardRegistry, arg1: &mut 0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::hashi_vault::HashiVault<T0>, arg2: &0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::pool::RoundHistory, arg3: &mut 0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::hashi_pool::BlockDepositRecord, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::hashi_pool::record_round_id(arg3) == 0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::pool::round_history_round_id(arg2), 13906834925963313163);
        assert!(0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::hashi_pool::is_confirmed(arg3), 13906834934553640977);
        let v0 = 0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::hashi_pool::record_amount_sats(arg3);
        assert!(v0 > 0, 13906834947438673939);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        let v2 = 0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::pool::round_history_round_id(arg2);
        ...
        0x2::balance::join<T0>(&mut v3.balance, 0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::hashi_vault::take_exact_hbtc<T0>(arg1, v0));
        arg0.total_batches = arg0.total_batches + 1;
        let v4 = 0x2::object::uid_to_address(&v3.id);
        0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::hashi_pool::mark_funded(arg3, v4);
    ...
    public fun recycle_expired_to_vault<T0>(arg0: &mut HashiRewardRegistry, arg1: &mut HashiRewardBatch<T0>, arg2: &mut 0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::hashi_vault::HashiVault<T0>, arg3: &0x2::clock::Clock) {
        ...
        if (v0 > 0) {
            0x148619c0e6796e1a111d52e099add274020bb0e5b10ff84017d55dae93ce1151::hashi_vault::deposit_hbtc<T0>(arg2, 0x2::balance::split<T0>(&mut arg1.balance, v0));
        };
        arg1.status = 3;
