module 0x148261507470b83681f57641d9b8233cb39a49f8610e223abc444eb7f7923dbd::dao {
    ...
    public entry fun commit<T0>(arg0: &mut DAOFund<T0>, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.balance) < v0, 1006);
        let v1 = v0 - 0x2::balance::value<0x2::sui::SUI>(&arg0.balance);
        ...
        if (!is_existed_user_dao<T0>(arg0, 0x2::tx_context::sender(arg4))) {
            let v4 = 0x2::table::new<address, Record>(arg4);
            0x2::table::add<address, Record>(&mut v4, 0x2::tx_context::sender(arg4), v3);
            let v5 = UserDAO{
                dao_type               : arg0.phase,
            ...
            0x2::table::add<address, UserDAO>(&mut arg0.tracked_addresses, 0x2::tx_context::sender(arg4), v5);
        } else {
            let v6 = 0x2::table::borrow_mut<address, UserDAO>(&mut arg0.tracked_addresses, 0x2::tx_context::sender(arg4));
            assert!(v6.total_committed_amount + v1 <= v6.max_committable_amount, 1007);
            v6.total_committed_amount = v6.total_committed_amount + v1;
        };
        let v7 = arg0.price * v1;
        let v8 = mint_dao_token<T0>(arg0, v7, arg3, arg4);
        ...
        let v9 = CommittedEvent{
            dao_fund_id  : 0x2::object::id<DAOFund<T0>>(arg0),
            sender       : 0x2::tx_context::sender(arg4),
            amount       : arg1,
            committed_at : v2,
        };
        0x2::event::emit<CommittedEvent>(v9);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x148261507470b83681f57641d9b8233cb39a49f8610e223abc444eb7f7923dbd::dao_config::new_global_dao_fee_and_shared(arg0);
    }
    ...
    public entry fun set_platform_fee(arg0: &OperatorCap, arg1: &mut 0x148261507470b83681f57641d9b8233cb39a49f8610e223abc444eb7f7923dbd::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0x148261507470b83681f57641d9b8233cb39a49f8610e223abc444eb7f7923dbd::dao_config::set_platform_fee(arg1, arg2, arg3, arg4);
    }
