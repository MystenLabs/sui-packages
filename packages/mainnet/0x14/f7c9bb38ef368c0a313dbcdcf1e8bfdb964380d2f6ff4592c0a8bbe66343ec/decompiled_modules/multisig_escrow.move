module 0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::multisig_escrow {
    ...
    struct Escrow<phantom T0> has store, key {
        ...
        fee_recipient: address,
        fee_amount: u64,
        buyer_warranty: 0x1::option::Option<0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::Warranty>,
        warranty_price_recipient: address,
        asset: AssetInfo,
        version: u64,
    }
    ...
    public fun cancel_escrow<T0>(arg0: &mut Listings, arg1: Escrow<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::Warranty>(&v13)) {
            0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::delete(0x1::option::extract<0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::Warranty>(&mut v13));
        };
        0x1::option::destroy_none<0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::Warranty>(v13);
    ...
    public fun create_escrow_review<T0>(arg0: &mut Escrow<T0>, arg1: u64, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = if (arg0.seller_address == v0) {
            0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::review::review_side_seller()
        } else {
            0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::review::review_side_buyer()
        };
        let v4 = arg0.asset;
        0x2::dynamic_field::add<0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::review::ReviewKey, 0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::review::Review>(&mut arg0.id, v3, 0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::review::create_review(v0, v1, 0x2::object::id<Escrow<T0>>(arg0), v2, v4.asset_id, v4.asset_type, v4.asset_group_id, arg1, arg2, arg3));
    }
    ...
    public fun fulfill_escrow<T0>(arg0: &mut Listings, arg1: &mut Escrow<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<0x2::coin::Coin<T0>>(&arg1.payment)) {
            ...
            if (0x1::option::is_some<0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::Warranty>(&arg1.buyer_warranty)) {
                let v2 = 0x1::option::extract<0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::Warranty>(&mut arg1.buyer_warranty);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v1, 0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::price(&v2), arg3), arg1.warranty_price_recipient);
                0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::transfer_to_beneficiary(v2, 0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::activate_warranty(&mut v2, arg2));
            };
    ...
    fun get_operator(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>) : address {
        ...
        0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::multisig::derive_multisig_address_quiet(v0, x"010101", 2)
    }
    ...
    public fun new_escrow<T0>(arg0: &mut Listings, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: 0x2::coin::Coin<T0>, arg4: vector<vector<u8>>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        new_escrow_internal<T0>(arg0, arg1, arg2, arg3, arg4, arg5, 0, arg6);
    }

    fun new_escrow_internal<T0>(arg0: &mut Listings, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: 0x2::coin::Coin<T0>, arg4: vector<vector<u8>>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 107);
        assert!(arg0.version == 2, 106);
        ...
        let v4 = 0x1::option::none<0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::Warranty>();
        if (0x1::vector::length<vector<u8>>(&arg4) > 0) {
            0x1::option::fill<0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::Warranty>(&mut v4, 0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::new_warranty(v3, arg4, arg0.signer_public_key, arg7));
        };
        let v5 = 0x2::balance::value<T0>(0x2::coin::balance<T0>(&arg3));
        let v6 = v0.coin_type_name;
        check_coin_type_match<T0>(v6);
        let v7 = v0.price;
        let v8 = safe_mul_u64(v7, arg5);
        let v9 = v8;
        if (arg6 > 0) {
            v9 = v8 - calculate_discount_amount(v8, arg6);
        };
        let v10 = if (0x1::option::is_some<0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::Warranty>(&v4)) {
            0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::price(0x1::option::borrow<0x14f7c9bb38ef368c0a313dbcdcf1e8bfdb964380d2f6ff4592c0a8bbe66343ec::warranty::Warranty>(&v4))
        } else {
            0
        };
        let v11 = safe_add_u64(v9, v10);
        assert!(v5 >= v11, 3);
        if (v5 > v11) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg3, v5 - v11, arg7), 0x2::tx_context::sender(arg7));
        };
        let v12 = v0.asset;
        let v13 = Bid{
            id                    : 0x2::object::new(arg7),
        ...
        let v14 = Escrow<T0>{
            ...
            fee_amount               : calculate_fee(v9, arg0.fee_rate),
            buyer_warranty           : v4,
            warranty_price_recipient : arg0.warranty_price_recipient,
            asset                    : v12,
            version                  : 2,
        };
        0x2::transfer::public_share_object<Escrow<T0>>(v14);
        let v15 = EscrowCreated{
            escrow_id             : v3,
            listing_id            : arg1,
            bid_id                : 0x2::object::id<Bid>(&v13),
            seller_address        : v0.seller_address,
            buyer_address         : 0x2::tx_context::sender(arg7),
            operator              : v1,
            coin_type_name        : v6,
        ...
        0x2::event::emit<EscrowCreated>(v15);
    }

    public fun new_escrow_with_discount<T0>(arg0: &mut Listings, arg1: 0x2::object::ID, arg2: &Discount, arg3: vector<u8>, arg4: 0x2::coin::Coin<T0>, arg5: vector<vector<u8>>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
