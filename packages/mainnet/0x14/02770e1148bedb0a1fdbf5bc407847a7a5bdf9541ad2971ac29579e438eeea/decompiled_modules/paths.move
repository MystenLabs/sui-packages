module 0x1402770e1148bedb0a1fdbf5bc407847a7a5bdf9541ad2971ac29579e438eeea::paths {
        ...
        while (v1 < 0x1::vector::length<PriceNode>(arg1)) {
            ...
            if (v4 > 0) {
                ...
                while (v5 < v4) {
                    ...
                    let v8 = 0x1402770e1148bedb0a1fdbf5bc407847a7a5bdf9541ad2971ac29579e438eeea::arithmetic::mul_128(0x1::vector::borrow<Route>(&v3, v5).sqrtPrice, v2.sqrtPrice);
                    if (v8 > v7 || v6 < arg2) {
