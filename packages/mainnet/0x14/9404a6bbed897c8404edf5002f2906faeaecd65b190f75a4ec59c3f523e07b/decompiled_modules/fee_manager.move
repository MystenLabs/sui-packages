module 0x149404a6bbed897c8404edf5002f2906faeaecd65b190f75a4ec59c3f523e07b::fee_manager {
    ...
    public fun get_flat_fee(arg0: &PlatformConfig, arg1: 0x1::type_name::TypeName) : u64 {
        if (0x2::table::contains<0x1::type_name::TypeName, CollectionConfig>(&arg0.registry, arg1)) {
            let v1 = 0x2::table::borrow<0x1::type_name::TypeName, CollectionConfig>(&arg0.registry, arg1);
            if (v1.is_verified) {
                v1.flat_fee_override
            } else {
