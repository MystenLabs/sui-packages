module 0x1451004af0c6a4b529abfc7207e094bdc3b5a45896939f66eff81bd7e683608f::kekius {
    ...
    fun init(arg0: KEKIUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/M4S2hTLGmTqtNaZC?width=64&height=64&fit=crop&quality=95&format=auto                                                                                                                                                                                                                      ");
