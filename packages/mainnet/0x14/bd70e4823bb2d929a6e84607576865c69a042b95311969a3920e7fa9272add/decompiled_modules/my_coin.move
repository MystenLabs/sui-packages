module 0x14bd70e4823bb2d929a6e84607576865c69a042b95311969a3920e7fa9272add::my_coin {
    ...
    fun init(arg0: MY_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MY_COIN>(arg0, 10, b"MY_COIN001", b"", b"", 0x1::option::none<0x2::url::Url>(), arg1);
