module 0x14217453d2972ad196d8aaab322ead307d6a34d6bae0ce9c2aa3902b24ca7fce::cnsnft2109 {
    struct CNSNFT2109 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2109, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2109>(arg0, arg1);
