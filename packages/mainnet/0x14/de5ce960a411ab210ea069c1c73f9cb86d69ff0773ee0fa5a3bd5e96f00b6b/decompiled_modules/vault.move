module 0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::vault {
    ...
    struct Vault<phantom T0> has key {
        ...
        treasury_cap: 0x2::coin::TreasuryCap<0xf2d4feb34c74452570fc0b857b5aaf07d6435742cede2206408d98dc00585d84::receipt::RECEIPT>,
    ...
    public fun borrow_treasury_ref<T0>(arg0: &Vault<T0>, arg1: &AdminCap) : &0x2::coin::TreasuryCap<0xf2d4feb34c74452570fc0b857b5aaf07d6435742cede2206408d98dc00585d84::receipt::RECEIPT> {
        &arg0.treasury_cap
    }
    ...
    public fun commit_strategy<T0, T1>(arg0: &mut Vault<T0>, arg1: BorrowReceipt<T0>, arg2: 0x2::balance::Balance<T1>, arg3: u8, arg4: u64) {
        ...
        if (v0 > 0) {
            assert!(arg4 >= v0 - v0 * 0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::floors::max_slippage_ceil() / 10000, 207);
        };
    ...
    public fun create_vault<T0>(arg0: 0x2::coin::TreasuryCap<0xf2d4feb34c74452570fc0b857b5aaf07d6435742cede2206408d98dc00585d84::receipt::RECEIPT>, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
    ...
    public fun deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::token::Token<0xf2d4feb34c74452570fc0b857b5aaf07d6435742cede2206408d98dc00585d84::receipt::RECEIPT> {
        assert!(!arg0.auto_paused, 204);
        ...
        let v2 = if (arg0.total_receipts == 0) {
            ...
            0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::floors::assert_heartbeat_age(0x2::clock::timestamp_ms(arg2) - arg0.last_heartbeat_ms);
        ...
        0x2::token::mint<0xf2d4feb34c74452570fc0b857b5aaf07d6435742cede2206408d98dc00585d84::receipt::RECEIPT>(&mut arg0.treasury_cap, v2, arg3)
    }
    ...
    public fun set_vote_lock<T0>(arg0: &mut Vault<T0>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock) {
        ...
        0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::floors::assert_vote_lock_duration(v1);
    ...
    public fun update_heartbeat_tvl<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock) {
        ...
        if (v1 > 0) {
            ...
            0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::floors::assert_tvl_delta((((v2 as u128) * 10000 / (v1 as u128)) as u64));
        };
    ...
    public fun withdraw<T0>(arg0: &mut Vault<T0>, arg1: 0x2::token::Token<0xf2d4feb34c74452570fc0b857b5aaf07d6435742cede2206408d98dc00585d84::receipt::RECEIPT>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = 0x2::token::value<0xf2d4feb34c74452570fc0b857b5aaf07d6435742cede2206408d98dc00585d84::receipt::RECEIPT>(&arg1);
        assert!(v1 > 0, 200);
        let v2 = if (arg0.total_receipts == 0) {
            0
        } else {
        ...
        assert!(v2 > 0, 200);
        assert!(v2 >= arg2, 203);
        0x2::token::burn<0xf2d4feb34c74452570fc0b857b5aaf07d6435742cede2206408d98dc00585d84::receipt::RECEIPT>(&mut arg0.treasury_cap, arg1);
