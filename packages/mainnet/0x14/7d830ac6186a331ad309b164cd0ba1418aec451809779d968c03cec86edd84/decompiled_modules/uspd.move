module 0x147d830ac6186a331ad309b164cd0ba1418aec451809779d968c03cec86edd84::uspd {
    ...
    fun init(arg0: USPD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3, v4) = 0x2::coin::create_regulated_currency_v2<USPD>(arg0, 9, trim_right(b"USPD"), trim_right(b"USPD  "), trim_right(b"USBD"), v1, true, arg1);
        let v5 = v2;
