module 0x14b0535f6f591b365474e73fcb548bc5e87ef2dd421668747e40659065b15b20::reward5767 {
    struct REWARD5767 has drop {
        dummy_field: bool,
    }

    struct TICKET_5767 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5767(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5767>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5767>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5767, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5767>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5767>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5767>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5767>>(v5, 0x2::tx_context::sender(arg1));
    }
