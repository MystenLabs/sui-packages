module 0x144c87eac82ab30b9509e6111f00594fa129d9a97018626f83376081d9cdeed9::secure_file_storage_v3 {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<u8, u64>(&mut v2, 0, 3);
        0x2::table::add<u8, u64>(&mut v2, 1, 3);
        0x2::table::add<u8, u64>(&mut v2, 2, 3);
