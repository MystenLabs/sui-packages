module 0x2e6cf466d9f4d65db02702b1eac6d1a45561675c6b112e6c9170e1fcf97ba119::hardstaking {
    ...
    entry fun add_admin(arg0: &OwnerCap, arg1: &mut AdminRegistry, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_set::length<address>(&arg1.admins) < arg1.max_admins, 1100);
    ...
    entry fun admin_stake_for_user(arg0: &AdminCap, arg1: &mut StakingConfig, arg2: &mut UserStakeRegistry, arg3: &AdminRegistry, arg4: &mut StakingVault, arg5: address, arg6: u64, arg7: u64, arg8: u64, arg9: 0x2::coin::Coin<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        check_version(arg3, arg1, arg2, arg4);
        let v0 = 0x2::tx_context::sender(arg11);
        let v1 = 0x2::clock::timestamp_ms(arg10);
        let v2 = 0x2::coin::value<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>(&arg9);
        ...
        let v4 = if (arg6 == v2) {
            0x2::coin::into_balance<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>(arg9)
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>>(0x2::coin::split<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>(&mut arg9, v2 - arg6, arg11), v0);
            0x2::coin::into_balance<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>(arg9)
        };
        ...
        *v6 = safe_add(*v6, 1);
        ...
        0x2::balance::join<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>(&mut arg4.balance, v4);
    ...
    entry fun remove_admin(arg0: &OwnerCap, arg1: &mut AdminRegistry, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(is_owner(arg1, v0), 1401);
        assert!(arg2 != @0x0, 1200);
        assert!(0x2::vec_set::length<address>(&arg1.admins) > 0, 1101);
    ...
    entry fun stake(arg0: &mut StakingConfig, arg1: &mut UserStakeRegistry, arg2: &mut StakingVault, arg3: &AdminRegistry, arg4: u64, arg5: u64, arg6: 0x2::coin::Coin<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        check_version(arg3, arg0, arg1, arg2);
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg7);
        let v2 = 0x2::coin::value<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>(&arg6);
        ...
        let v3 = if (arg5 == v2) {
            0x2::coin::into_balance<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>(arg6)
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>>(0x2::coin::split<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>(&mut arg6, v2 - arg5, arg8), v0);
            0x2::coin::into_balance<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>(arg6)
        };
        ...
        *v5 = safe_add(*v5, 1);
        ...
        0x2::balance::join<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>(&mut arg2.balance, v3);
    ...
    entry fun unstake(arg0: &mut UserStakeRegistry, arg1: &mut StakingVault, arg2: &mut StakingConfig, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3.amount;
        assert!(v4 > 0, 1004);
        assert!(0x2::balance::value<0x1a8f4bc33f8ef7fbc851f156857aa65d397a6a6fd27a7ac2ca717b51f2fd9489::alkimi::ALKIMI>(&arg1.balance) >= v4, 1600);
        v3.claimed = true;
