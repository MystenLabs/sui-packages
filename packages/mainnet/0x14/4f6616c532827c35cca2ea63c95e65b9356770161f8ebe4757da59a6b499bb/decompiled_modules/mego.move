module 0x144f6616c532827c35cca2ea63c95e65b9356770161f8ebe4757da59a6b499bb::mego {
    ...
    fun init(arg0: MEGO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<MEGO>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MEGO    ")))), trim_right(b"MEGO                            "), trim_right(b"MEGO FIGHT                                                                                                                                                                                                                                                                                                                      "), v2, arg1);
