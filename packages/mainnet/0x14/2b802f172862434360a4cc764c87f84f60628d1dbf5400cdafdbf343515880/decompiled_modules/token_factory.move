module 0x142b802f172862434360a4cc764c87f84f60628d1dbf5400cdafdbf343515880::token_factory {
    ...
    fun init(arg0: TOKEN_FACTORY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_FACTORY>(arg0, 6, b"VENT", b"Oreo Token", b"Test Token for Pool Creation", 0x1::option::none<0x2::url::Url>(), arg1);
