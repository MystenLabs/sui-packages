module 0x1454b1900323364b8ccb1752d4b536131c082c9dca3ddfd4333ddad7e9f2ce0d::cnsnft6116 {
    struct CNSNFT6116 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6116, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6116>(arg0, arg1);
