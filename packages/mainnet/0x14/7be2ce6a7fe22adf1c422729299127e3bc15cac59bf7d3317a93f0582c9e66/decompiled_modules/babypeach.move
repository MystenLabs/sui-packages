module 0x147be2ce6a7fe22adf1c422729299127e3bc15cac59bf7d3317a93f0582c9e66::babypeach {
    ...
    fun init(arg0: BABYPEACH, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<BABYPEACH>(arg0, 9, b"BabyPeach", b"BabyPeach", b"BabyPeach Meme Coin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), false, arg1);
        let v3 = v0;
