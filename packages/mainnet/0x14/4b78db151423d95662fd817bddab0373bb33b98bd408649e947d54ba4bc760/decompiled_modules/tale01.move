module 0x144b78db151423d95662fd817bddab0373bb33b98bd408649e947d54ba4bc760::tale01 {
    ...
    fun init(arg0: TALE01, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = v6;
        let v8 = v5;
        0x144b78db151423d95662fd817bddab0373bb33b98bd408649e947d54ba4bc760::royalty_rule::add<Nft>(&mut v8, &v7, 2000, 0);
