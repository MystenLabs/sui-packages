module 0x14a4350a95c434c3b1f3913cc0a35d67e220d40623db677dd16108a9ce3574ed::db {
    ...
    struct AtomaDb has key {
        ...
        fee_treasury: 0x2::balance::Balance<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>,
        communal_treasury: 0x2::balance::Balance<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>,
    ...
    struct NodeEntry has store {
        ...
        collateral: 0x2::balance::Balance<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>,
        last_fee_epoch: u64,
    ...
    public fun create_manager_badge(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) : AtomaManagerBadge {
        assert!(0x2::package::from_module<0x14a4350a95c434c3b1f3913cc0a35d67e220d40623db677dd16108a9ce3574ed::atoma::ATOMA>(arg0), 312012002);
    ...
    public(friend) fun deposit_fee_to_node(arg0: &mut AtomaDb, arg1: SmallId, arg2: 0x2::balance::Balance<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>, arg3: &0x2::tx_context::TxContext) {
        if (!0x2::table::contains<SmallId, NodeEntry>(&arg0.nodes, arg1)) {
            deposit_to_communal_treasury(arg0, arg2);
        } else {
            attribute_fee_to_node(arg0, arg1, 0x2::balance::value<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(&arg2), arg3);
            0x2::balance::join<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(&mut arg0.fee_treasury, arg2);
        };
    }

    public(friend) fun deposit_to_communal_treasury(arg0: &mut AtomaDb, arg1: 0x2::balance::Balance<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>) {
        0x2::balance::join<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(&mut arg0.communal_treasury, arg1);
    }

    public(friend) fun deposit_to_fee_treasury(arg0: &mut AtomaDb, arg1: 0x2::balance::Balance<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>) {
        0x2::balance::join<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(&mut arg0.fee_treasury, arg1);
    }
    ...
    public entry fun destroy_disabled_node(arg0: &mut AtomaDb, arg1: NodeBadge, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>>(0x2::coin::from_balance<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(v1, arg2), 0x2::tx_context::sender(arg2));
        let NodeBadge {
            id       : v6,
            small_id : _,
        } = arg1;
    ...
    fun get_node_id_if_unslashed_or_swap_remove(arg0: &0x2::table::Table<SmallId, NodeEntry>, arg1: &mut 0x2::table_vec::TableVec<SmallId>, arg2: u64) : 0x1::option::Option<SmallId> {
        ...
        if (0x2::table::contains<SmallId, NodeEntry>(arg0, v0)) {
            ...
            if (0x2::balance::value<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(&v1.collateral) > 0 && 0x1::option::is_none<u64>(&v1.was_disabled_in_epoch)) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = AtomaDb{
            ...
            fee_treasury                              : 0x2::balance::zero<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(),
            communal_treasury                         : 0x2::balance::zero<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(),
    ...
    public(friend) fun refund_to_user(arg0: &mut AtomaDb, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>>(0x2::coin::from_balance<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(0x2::balance::split<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(&mut arg0.fee_treasury, arg2), arg3), arg1);
        };
    }

    public fun register_node(arg0: &mut AtomaDb, arg1: &mut 0x2::balance::Balance<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>, arg2: &mut 0x2::tx_context::TxContext) : NodeBadge {
        ...
        let v1 = NodeEntry{
            ...
            collateral            : 0x2::balance::split<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(arg1, arg0.registration_collateral_in_protocol_token),
    ...
    public entry fun register_node_entry(arg0: &mut AtomaDb, arg1: &mut 0x2::coin::Coin<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::balance_mut<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(arg1);
    ...
    fun sample_node(arg0: &0x2::table::Table<SmallId, NodeEntry>, arg1: &mut 0x2::table_vec::TableVec<SmallId>, arg2: &mut 0x2::random::RandomGenerator) : 0x1::option::Option<SmallId> {
        ...
        loop {
            ...
            if (0x2::table::contains<SmallId, NodeEntry>(arg0, v0)) {
                ...
                if (0x2::balance::value<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(&v5.collateral) > 0 && 0x1::option::is_none<u64>(&v5.was_disabled_in_epoch)) {
                    break
                };
            };
    ...
    public(friend) fun slash_node_on_dispute(arg0: &mut AtomaDb, arg1: SmallId) : 0x2::balance::Balance<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA> {
        if (!0x2::table::contains<SmallId, NodeEntry>(&arg0.nodes, arg1)) {
            0x2::balance::zero<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>()
        } else {
            0x2::balance::withdraw_all<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(&mut 0x2::table::borrow_mut<SmallId, NodeEntry>(&mut arg0.nodes, arg1).collateral)
        }
    }

    public(friend) fun slash_node_on_timeout(arg0: &mut AtomaDb, arg1: SmallId) : 0x2::balance::Balance<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA> {
        if (!0x2::table::contains<SmallId, NodeEntry>(&arg0.nodes, arg1)) {
            return 0x2::balance::zero<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>()
        };
        let v0 = 0x2::table::borrow_mut<SmallId, NodeEntry>(&mut arg0.nodes, arg1);
        let v1 = 0x2::balance::value<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(&v0.collateral);
        if (v1 == 0) {
            0x2::balance::zero<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>()
        } else {
            0x2::balance::split<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(&mut v0.collateral, 0x1::u64::divide_and_round_up(v1 * arg0.permille_to_slash_node_on_timeout, 1000))
        }
    }
