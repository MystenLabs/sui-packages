module 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::req_helpers {
    ...
    public(friend) fun msgFromReqSigningMessage(arg0: vector<u8>) : vector<u8> {
        ...
        if (*v1 == 1) {
            ...
            0x1::vector::push_back<vector<u8>>(v5, 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v3) + 29 + 66));
            ...
            0x1::vector::push_back<vector<u8>>(v8, 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v6) + 31 + 66));
            ...
            0x1::vector::push_back<vector<u8>>(v11, 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v9) + 29 + 66));
