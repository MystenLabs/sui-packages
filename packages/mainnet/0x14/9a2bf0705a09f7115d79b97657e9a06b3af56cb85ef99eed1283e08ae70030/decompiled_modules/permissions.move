module 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::permissions {
    ...
    fun checkExecutorsForIndex(arg0: vector<vector<u8>>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &PermissionsStorage) {
        0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::utils::assertEthAddressList(arg0);
    ...
    fun checkSignature(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>) {
        ...
        assert!(0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::utils::recoverEthAddress(arg0, arg1, arg2) == arg3, 34);
    }
    ...
    public entry fun updateExecutors(arg0: vector<vector<u8>>, arg1: u64, arg2: u64, arg3: vector<vector<u8>>, arg4: vector<vector<u8>>, arg5: vector<vector<u8>>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut PermissionsStorage) {
        ...
        checkExecutorsNotDuplicated(arg0);
        let v0 = 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::req_helpers::BRIDGE_CHANNEL();
        let v1 = 0x1::vector::empty<vector<u8>>();
        let v2 = &mut v1;
        0x1::vector::push_back<vector<u8>>(v2, 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::req_helpers::ETH_SIGN_HEADER());
        0x1::vector::push_back<vector<u8>>(v2, 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v0) + 29 + 43 * 0x1::vector::length<vector<u8>>(&arg0) + 12 + 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::utils::smallU64Log10(arg1) + 1 + 25 + 25 + 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::utils::smallU64Log10(arg6) + 1));
        0x1::vector::push_back<vector<u8>>(v2, b"[");
        0x1::vector::push_back<vector<u8>>(v2, 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::req_helpers::BRIDGE_CHANNEL());
        ...
        0x1::vector::push_back<vector<u8>>(v2, 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::utils::smallU64ToString(arg1));
        0x1::vector::push_back<vector<u8>>(v2, x"0a");
        0x1::vector::push_back<vector<u8>>(v2, b"Active since: ");
        0x1::vector::push_back<vector<u8>>(v2, 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::utils::smallU64ToString(arg2));
        0x1::vector::push_back<vector<u8>>(v2, x"0a");
        0x1::vector::push_back<vector<u8>>(v2, b"Current executors index: ");
        0x1::vector::push_back<vector<u8>>(v2, 0x149a2bf0705a09f7115d79b97657e9a06b3af56cb85ef99eed1283e08ae70030::utils::smallU64ToString(arg6));
