module 0x141520ced4b2aaebc1fb8668e4a7aa20e0b30030f2f8e30b96cb343b3b936984::reward1297 {
    struct REWARD1297 has drop {
        dummy_field: bool,
    }

    struct TICKET_1297 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1297(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1297>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1297>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1297, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1297>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1297>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1297>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1297>>(v5, 0x2::tx_context::sender(arg1));
    }
