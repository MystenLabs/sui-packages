module 0xd855575a5636833bb9f1893443782a520be6cecec8ffc01a0452d640f9f990fc::portfolio {
    ...
    public entry fun create_viewer_count(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = ViewerCount{
            id    : 0x2::object::new(arg1),
            count : arg0,
        };
        0x2::transfer::share_object<ViewerCount>(v0);
    }

    public entry fun increment(arg0: &mut ViewerCount) {
    ...
    fun init(arg0: PORTFOLIO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<ViewerCount>(v6);
