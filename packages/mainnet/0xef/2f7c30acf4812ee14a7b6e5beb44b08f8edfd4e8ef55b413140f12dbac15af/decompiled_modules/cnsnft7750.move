module 0xef2f7c30acf4812ee14a7b6e5beb44b08f8edfd4e8ef55b413140f12dbac15af::cnsnft7750 {
    struct CNSNFT7750 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7750, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7750>(arg0, arg1);
