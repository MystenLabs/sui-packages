module 0xef8f2858bf7cbeea8de08eb2d8fe800f9b46997635767650562e6a906e00b357::reward5413 {
    struct REWARD5413 has drop {
        dummy_field: bool,
    }

    struct TICKET_5413 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5413(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5413>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5413>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5413, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5413>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5413>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5413>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5413>>(v5, 0x2::tx_context::sender(arg1));
    }
