module 0xef609ee12687caba38f34da572be0b585dc594246b6a5b065746c54e44b0daa0::vault {
    ...
    public fun put_vaults_in_manager(arg0: &mut VaultManager, arg1: vector<Vault>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<Vault>(&arg1)) {
            let v1 = 0x1::vector::pop_back<Vault>(&mut arg1);
            assert_vault_manager_is_the_same(arg0, &v1);
            0x2::object_table::add<0x2::object::ID, Vault>(&mut arg0.vaults, 0x2::object::id<Vault>(&v1), v1);
            v0 = v0 + 1;
        };
        0x1::vector::destroy_empty<Vault>(arg1);
    }
