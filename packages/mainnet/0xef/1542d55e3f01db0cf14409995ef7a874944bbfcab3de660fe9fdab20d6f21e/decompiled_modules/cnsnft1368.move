module 0xef1542d55e3f01db0cf14409995ef7a874944bbfcab3de660fe9fdab20d6f21e::cnsnft1368 {
    struct CNSNFT1368 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1368, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7370"));
        let v4 = 0x2::package::claim<CNSNFT1368>(arg0, arg1);
