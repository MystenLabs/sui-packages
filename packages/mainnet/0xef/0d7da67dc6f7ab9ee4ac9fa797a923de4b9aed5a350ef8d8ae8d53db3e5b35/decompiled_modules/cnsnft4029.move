module 0xef0d7da67dc6f7ab9ee4ac9fa797a923de4b9aed5a350ef8d8ae8d53db3e5b35::cnsnft4029 {
    struct CNSNFT4029 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4029, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4029>(arg0, arg1);
