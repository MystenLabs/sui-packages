module 0xef7a2d09bb4fcdff94ad8a7359751380ba1cdb13797ea21bc747815bddf50a31::llv_admin {
    ...
    public(friend) fun migrate(arg0: &mut LLVGlobal, arg1: &0x2::tx_context::TxContext) {
        ...
        arg0.version = 1;
        0xef7a2d09bb4fcdff94ad8a7359751380ba1cdb13797ea21bc747815bddf50a31::llv_events::emit_global_migrated(arg0.version);
    }
    ...
    public(friend) fun set_global_paused(arg0: &mut LLVGlobal, arg1: bool, arg2: &0x2::tx_context::TxContext) {
        ...
        arg0.paused = arg1;
        0xef7a2d09bb4fcdff94ad8a7359751380ba1cdb13797ea21bc747815bddf50a31::llv_events::emit_global_paused(arg1);
    }
    ...
    public(friend) fun set_owner(arg0: &mut LLVGlobal, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 3);
        arg0.owner = arg1;
        0xef7a2d09bb4fcdff94ad8a7359751380ba1cdb13797ea21bc747815bddf50a31::llv_events::emit_owner_changed(arg0.owner, arg1);
    }
