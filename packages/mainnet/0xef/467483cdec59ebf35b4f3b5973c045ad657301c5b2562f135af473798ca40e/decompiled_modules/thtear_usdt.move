module 0xef467483cdec59ebf35b4f3b5973c045ad657301c5b2562f135af473798ca40e::thtear_usdt {
    ...
    fun init(arg0: THTEAR_USDT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<THTEAR_USDT>(arg0, 9, trim_right(b"USDT"), trim_right(b"ThtearUSDT"), trim_right(b"my coin"), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(trim_right(b"https://ipfs.io/ipfs/bafkreicbmczfunilkzp7c73sl7bfbar2jncttdixne2pvl73powk33x4k4"))), arg1);
        let v2 = v0;
