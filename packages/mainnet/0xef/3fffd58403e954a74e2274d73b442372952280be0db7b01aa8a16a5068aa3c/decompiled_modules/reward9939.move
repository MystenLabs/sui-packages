module 0xef3fffd58403e954a74e2274d73b442372952280be0db7b01aa8a16a5068aa3c::reward9939 {
    struct REWARD9939 has drop {
        dummy_field: bool,
    }

    struct TICKET_9939 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9939(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9939>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9939>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9939, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9939>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9939>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9939>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9939>>(v5, 0x2::tx_context::sender(arg1));
    }
