module 0xefa479281ee250c8a8eeac213648fd19c77e23d805d8b4ff618276aa628ce2be::adaptor_pyth {
    ...
    fun normalize_to_wad(arg0: u64, arg1: bool, arg2: u32) : u128 {
        assert!(arg2 <= 38, 3);
        let v0 = (arg0 as u128);
        let v1 = 0xefa479281ee250c8a8eeac213648fd19c77e23d805d8b4ff618276aa628ce2be::oracle_math::pow10(arg2);
        if (arg1) {
            0xefa479281ee250c8a8eeac213648fd19c77e23d805d8b4ff618276aa628ce2be::oracle_math::mul_div_down(v0, 1000000000000000000, v1)
        } else {
            assert!(v1 <= 340282366920938463463 / v0, 3);
            0xefa479281ee250c8a8eeac213648fd19c77e23d805d8b4ff618276aa628ce2be::oracle_math::mul_checked(0xefa479281ee250c8a8eeac213648fd19c77e23d805d8b4ff618276aa628ce2be::oracle_math::mul_checked(v0, v1), 1000000000000000000)
        }
    }

    public fun update_price<T0>(arg0: &mut 0xefa479281ee250c8a8eeac213648fd19c77e23d805d8b4ff618276aa628ce2be::pyth_oracle::Oracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
