module 0xef44c12fad3cc2c4e04d8ca3870df598c50fa75b3a98cce91a1ce6752b92ecdc::HYPE {
    ...
    fun init(arg0: HYPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<HYPE>(arg0, 9, b"TRUMPUSA", b"Trump USA great again", b"Trump USA great again $$$", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
