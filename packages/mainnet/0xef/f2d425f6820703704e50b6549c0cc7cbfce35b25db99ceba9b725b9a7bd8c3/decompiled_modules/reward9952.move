module 0xeff2d425f6820703704e50b6549c0cc7cbfce35b25db99ceba9b725b9a7bd8c3::reward9952 {
    struct REWARD9952 has drop {
        dummy_field: bool,
    }

    struct TICKET_9952 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9952(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9952>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9952>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9952, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9952>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9952>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9952>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9952>>(v5, 0x2::tx_context::sender(arg1));
    }
