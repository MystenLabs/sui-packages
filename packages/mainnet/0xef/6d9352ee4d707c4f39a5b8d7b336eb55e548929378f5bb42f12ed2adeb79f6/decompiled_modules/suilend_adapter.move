module 0x9836dde65645122832d2c89a4b37394119ce3fee14afa74a80b83963132f0f71::suilend_adapter {
    ...
    public fun new<T0, T1, T2>(arg0: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg1: u64, arg2: vector<0x1::type_name::TypeName>, arg3: vector<u64>, arg4: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::acl::AdminWitness<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam::SAM>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::length<0x1::type_name::TypeName>(&arg2) == 0x1::vector::length<u64>(&arg3), 13906834427746451455);
    ...
    public fun fund_reward_buffer<T0, T1, T2, T3>(arg0: &mut SuilendAdapter<T0, T1, T2>, arg1: 0x2::coin::Coin<T3>, arg2: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::acl::AdminWitness<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam::SAM>) {
        let v0 = &mut arg0.id;
    ...
    public fun set_reward_index_table<T0, T1, T2>(arg0: &mut SuilendAdapter<T0, T1, T2>, arg1: vector<0x1::type_name::TypeName>, arg2: vector<0x1::type_name::TypeName>, arg3: vector<u64>, arg4: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::acl::AdminWitness<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam::SAM>) {
        ...
        0x1::vector::reverse<u64>(&mut arg3);
        assert!(0x1::vector::length<0x1::type_name::TypeName>(&arg2) == 0x1::vector::length<u64>(&arg3), 13906834535120633855);
        0x1::vector::reverse<0x1::type_name::TypeName>(&mut arg2);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&arg2)) {
    ...
    fun swap_rewards_route<T0, T1, T2, T3, T4>(arg0: &mut SuilendAdapter<T0, T1, T2>, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T3, T4>, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T4>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        let v0 = min_reward_redeem(&arg0.id);
        let v1 = &mut arg0.id;
        ...
        let (v4, v5, v6) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T3, T4>(arg2, arg3, true, true, 0x2::balance::value<T3>(&v2), 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::min_sqrt_price(), arg5);
        let v7 = v6;
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T3, T4>(arg2, arg3, 0x2::balance::split<T3>(&mut v2, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T3, T4>(&v7)), 0x2::balance::zero<T4>(), v7);
        0x2::balance::join<T3>(&mut v2, v4);
        let v8 = &mut arg0.id;
        buffer_put<T3>(v8, v2);
        let v9 = &mut arg0.id;
        let v10 = buffer_join_take<T4>(v9, v5);
        if (0x2::balance::value<T4>(&v10) < v0) {
            let v11 = &mut arg0.id;
            buffer_put<T4>(v11, v10);
            return 0x2::balance::zero<T1>()
        };
        let (v12, v13, v14) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T1, T4>(arg2, arg4, false, true, 0x2::balance::value<T4>(&v10), 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::max_sqrt_price(), arg5);
        let v15 = v14;
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T1, T4>(arg2, arg4, 0x2::balance::zero<T1>(), 0x2::balance::split<T4>(&mut v10, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T1, T4>(&v15)), v15);
        0x2::balance::join<T4>(&mut v10, v13);
        let v16 = &mut arg0.id;
        buffer_put<T4>(v16, v10);
        v12
    }
