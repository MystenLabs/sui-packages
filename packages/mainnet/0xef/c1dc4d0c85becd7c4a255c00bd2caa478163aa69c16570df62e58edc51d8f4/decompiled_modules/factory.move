module 0xefc1dc4d0c85becd7c4a255c00bd2caa478163aa69c16570df62e58edc51d8f4::factory {
    ...
    public(friend) fun create_pair<T0, T1>(arg0: &mut Factory, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) : address {
        ...
        let v3 = 0xefc1dc4d0c85becd7c4a255c00bd2caa478163aa69c16570df62e58edc51d8f4::pair::new<T0, T1>(arg1, arg2, arg0.team_1_address, arg0.team_2_address, arg0.dev_address, arg0.locker_address, arg0.buyback_address, arg3);
        let v4 = 0x2::object::id_address<0xefc1dc4d0c85becd7c4a255c00bd2caa478163aa69c16570df62e58edc51d8f4::pair::Pair<T0, T1>>(&v3);
        0x2::table::add<TokenPair, address>(&mut arg0.pairs, v2, v4);
        0x1::vector::push_back<address>(&mut arg0.all_pairs, v4);
        0xefc1dc4d0c85becd7c4a255c00bd2caa478163aa69c16570df62e58edc51d8f4::pair::share_pair<T0, T1>(v3);
        let v5 = PairCreated{
            token0   : v0,
            token1   : v1,
            pair     : v4,
    ...
    public entry fun update_pair_fee_addresses<T0, T1>(arg0: &Factory, arg1: &mut 0xefc1dc4d0c85becd7c4a255c00bd2caa478163aa69c16570df62e58edc51d8f4::pair::Pair<T0, T1>, arg2: address, arg3: address, arg4: address, arg5: address, arg6: address, arg7: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg7) == arg0.admin, 4);
        0xefc1dc4d0c85becd7c4a255c00bd2caa478163aa69c16570df62e58edc51d8f4::pair::update_fee_addresses<T0, T1>(arg1, arg2, arg3, arg4, arg5, arg6);
    }
