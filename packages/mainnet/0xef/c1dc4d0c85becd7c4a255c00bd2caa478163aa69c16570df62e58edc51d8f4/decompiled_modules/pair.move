module 0xefc1dc4d0c85becd7c4a255c00bd2caa478163aa69c16570df62e58edc51d8f4::pair {
    ...
    public(friend) fun mint<T0, T1>(arg0: &mut Pair<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LPCoin<T0, T1>> {
        ...
        let v2 = if (arg0.total_supply == 0) {
            let v3 = 0xefc1dc4d0c85becd7c4a255c00bd2caa478163aa69c16570df62e58edc51d8f4::math_utils::integer_sqrt(v0 * v1);
            assert!(v3 > 1000, 102);
            v3 - 1000
        } else {
