module 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_deepbook {
    ...
    public fun authorize_swap<T0>(arg0: &0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiVault<T0>, arg1: &0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiLeaderCap, arg2: u64, arg3: u64, arg4: bool, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : SwapAuthorization {
        assert!(0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::leader_cap_vault_id(arg1) == 0x2::object::id<0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiVault<T0>>(arg0), 1);
        assert!(arg2 > 0, 3);
        let v0 = 0x2::object::id<0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiVault<T0>>(arg0);
    ...
    public fun consume_swap_for_buy<T0>(arg0: SwapAuthorization, arg1: &mut 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiVault<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, TradingObligation) {
        ...
        assert!(v1 == 0x2::object::id<0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiVault<T0>>(arg1), 1);
        assert!(v4, 3);
        ...
        (0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::extract_usdc_for_trading<T0>(arg1, v2, arg3), v7)
    }
    ...
    public fun create_asset_vault<T0, T1>(arg0: &0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiVault<T0>, arg1: &0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiLeaderCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::leader_cap_vault_id(arg1) == 0x2::object::id<0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiVault<T0>>(arg0), 1);
        let v0 = 0x2::object::id<0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiVault<T0>>(arg0);
    ...
    public fun deposit_usdc_from_sell<T0>(arg0: &mut 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiVault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64) {
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert!(v0 >= arg2, 5);
        0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::deposit_usdc_from_trading<T0>(arg0, arg1);
        let v1 = SwapExecuted{
            vault_id      : 0x2::object::id<0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiVault<T0>>(arg0),
            input_amount  : 0,
            output_amount : v0,
            is_buy        : false,
        };
    ...
    public fun repay_obligation_with_usdc<T0>(arg0: TradingObligation, arg1: &mut 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiVault<T0>, arg2: 0x2::coin::Coin<T0>, arg3: u64) {
        let TradingObligation {
            vault_id         : v0,
            amount_extracted : _,
        } = arg0;
        assert!(v0 == 0x2::object::id<0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::SuiVault<T0>>(arg1), 1);
        let v2 = 0x2::coin::value<T0>(&arg2);
        assert!(v2 >= arg3, 5);
        0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_vault::deposit_usdc_from_trading<T0>(arg1, arg2);
        let v3 = SwapExecuted{
            vault_id      : v0,
            input_amount  : 0,
            output_amount : v2,
