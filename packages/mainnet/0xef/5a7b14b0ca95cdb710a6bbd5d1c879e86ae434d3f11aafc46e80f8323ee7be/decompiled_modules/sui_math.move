module 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_math {
    ...
    public fun calculate_buy_price_capped(arg0: u64, arg1: u64, arg2: u64) : u64 {
        let v0 = 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::bps();
    ...
    public fun calculate_exit_fee_bps(arg0: u64, arg1: &vector<0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::ExitFeeTier>) : u64 {
        let v0 = 0x1::vector::length<0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::ExitFeeTier>(arg1);
        if (v0 == 0) {
            return 0
        };
        let v1 = v0;
        while (v1 > 0) {
            v1 = v1 - 1;
            let v2 = 0x1::vector::borrow<0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::ExitFeeTier>(arg1, v1);
            if (arg0 >= 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::exit_tier_days_held(v2)) {
                return 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::exit_tier_fee_bps(v2)
            };
        };
        0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::exit_tier_fee_bps(0x1::vector::borrow<0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::ExitFeeTier>(arg1, 0))
    }

    public fun calculate_nav(arg0: u64, arg1: u64, arg2: u64) : u64 {
        if (arg1 == 0 && arg2 == 0) {
            return 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::precision()
        };
        let v0 = (arg1 as u128) + (arg2 as u128);
        if (v0 == 0) {
            return 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::precision()
        };
        ((((arg0 as u128) + (arg2 as u128)) * (0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::precision() as u128) / v0) as u64)
    }
    ...
    public fun calculate_performance_fee(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        ...
        let v0 = 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::precision();
        mul_div(mul_div(mul_div(arg0, arg1 - arg2, v0), arg3, 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::bps()), v0, arg1)
    }
    ...
    public fun calculate_virtual_base_usdc(arg0: u64, arg1: u64) : u64 {
        mul_div(arg0, arg1, 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::precision())
    }
    ...
    public fun percentage_bps(arg0: u64, arg1: u64) : u64 {
        ...
        mul_div(arg0, 0xef5a7b14b0ca95cdb710a6bbd5d1c879e86ae434d3f11aafc46e80f8323ee7be::sui_types::bps(), arg1)
    }
