module 0xef5b210d6573c3985f76ab9c53225628b3324b90c36316dd9f5162c6abde8042::cnsnft3907 {
    struct CNSNFT3907 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3907, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3907>(arg0, arg1);
