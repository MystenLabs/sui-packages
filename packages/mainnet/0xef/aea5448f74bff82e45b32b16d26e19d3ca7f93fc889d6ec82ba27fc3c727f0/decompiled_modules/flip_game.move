module 0xefaea5448f74bff82e45b32b16d26e19d3ca7f93fc889d6ec82ba27fc3c727f0::flip_game {
    ...
    public fun admin_mint(arg0: &mut GameConfig, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.admin, 0);
        assert!(arg0.total_distributed + arg1 <= 10000000, 3);
        arg0.total_distributed = arg0.total_distributed + arg1;
        0x2::transfer::public_transfer<0x2::coin::Coin<FLIP_GAME>>(0x2::coin::mint<FLIP_GAME>(&mut arg0.treasury, arg1, arg3), arg2);
    }
