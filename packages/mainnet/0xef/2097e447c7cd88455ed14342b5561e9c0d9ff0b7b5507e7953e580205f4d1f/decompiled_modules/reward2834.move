module 0xef2097e447c7cd88455ed14342b5561e9c0d9ff0b7b5507e7953e580205f4d1f::reward2834 {
    struct REWARD2834 has drop {
        dummy_field: bool,
    }

    struct TICKET_2834 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2834(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2834>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2834>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2834, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2834>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2834>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2834>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2834>>(v5, 0x2::tx_context::sender(arg1));
    }
