module 0xef250af2f398507f81a81f8f5009c3399a72dda0f46c2e24004bcd82cb255f5d::dialog_management {
    ...
    struct DialogHashDebugEvent has copy, drop {
    ...
    public entry fun verify_dialog_hash(arg0: &UserDialogHashes, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
        if (0x2::table::contains<vector<u8>, vector<u8>>(&arg0.dialog_hashes, arg1)) {
            let v0 = UserDialogHashesEvent{
                address     : arg1,
                dialog_hash : *0x2::table::borrow<vector<u8>, vector<u8>>(&arg0.dialog_hashes, arg1),
            ...
            let v1 = DialogHashDebugEvent{
                operation   : 0x1::string::utf8(b"verify"),
                address     : arg1,
                dialog_hash : b"",
                success     : false,
            };
            0x2::event::emit<DialogHashDebugEvent>(v1);
        };
    }
