module 0x8988fad4a4c250d909736b1c2c9a56ff9b9f5c250b85cd6694f324c40eeb5ab2::aaa_roulette_game {
    ...
    public fun join_game<T0>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::object::ID, arg2: &mut GameRegistry, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = PlayerJoinedEvent{
            player    : v1,
            pot_type  : 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get_with_original_ids<T0>())),
            bet_value : 0x2::balance::value<T0>(&v3),
        };
        0x2::event::emit<PlayerJoinedEvent>(v4);
    }
    ...
    public fun resolve_game_pot<T0>(arg0: &mut AdminCap, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u8, arg6: vector<u8>, arg7: &mut GameRegistry, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x1::vector::length<u8>(&arg6) % 0x1::vector::length<address>(&v0.players_in_game_order) - 1;
        let v4 = v3;
        if (v3 < 0) {
            v4 = 0x1::vector::length<address>(&v0.players_in_game_order) - 1;
        };
        let v5 = 0x1::vector::borrow<address>(&v0.players_in_game_order, v4);
        let (v6, v7) = 0x1::vector::index_of<address>(&v0.players, v5);
        if (!v6) {
            abort 9
        };
        let v8 = 0x1::vector::borrow_mut<0x2::balance::Balance<T0>>(&mut v0.bets, v7);
        let v9 = 0x2::balance::value<T0>(v8);
        let v10 = v9 * 25 / 1000;
        let v11 = v9 * 25 / 1000;
        let v12 = 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v8, v10), arg8);
        let v13 = 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v8, v11), arg8);
        let v14 = (v9 - v10 - v11) / (0x1::vector::length<address>(&v0.players) - 1);
        let v15 = 0;
        let v16 = 0x1::vector::length<address>(&v0.players);
        let v17 = 0x1::vector::empty<address>();
        while (v15 < v16) {
            let v18 = 0x1::vector::borrow<address>(&v0.players, v15);
            if (v18 != v5) {
                0x1::vector::push_back<address>(&mut v17, *v18);
                let v19 = &mut v0.bets;
                let v20 = split_loser_bet<T0>(v19, v7, v14);
                let v21 = 0x1::vector::borrow_mut<0x2::balance::Balance<T0>>(&mut v0.bets, v15);
                0x2::balance::join<T0>(v21, v20);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(v21), arg8), *v18);
            };
            v15 = v15 + 1;
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(0x1::vector::borrow_mut<0x2::balance::Balance<T0>>(&mut v0.bets, v7)), arg8), 0x2::tx_context::sender(arg8));
        let v22 = 0;
        while (v22 < v16) {
            0x2::balance::destroy_zero<T0>(0x1::vector::pop_back<0x2::balance::Balance<T0>>(&mut v0.bets));
            v22 = v22 + 1;
        };
        let v23 = GameResolvedEvent{
            pot_id                  : arg1,
            pot_type                : 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get_with_original_ids<T0>())),
            vrf_output              : arg2,
            public_key              : arg3,
            ...
            winners                 : v17,
            loser_bet_value         : v9,
            amount_per_winner       : v14,
            creator_reward          : v10,
            platform_fee            : v11,
        };
        0x2::event::emit<GameResolvedEvent>(v23);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v12, v0.creator_address);
