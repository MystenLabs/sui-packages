module 0xef50f52801086d6193eb292d2153137c4cfefe7f806189f0d51e8937c189c673::market {
    ...
    fun update_tables(arg0: &mut Market, arg1: 0x2::object::ID, arg2: bool, arg3: bool, arg4: address) {
        ...
        if (!0x1::vector::contains<0x2::object::ID>(0x2::table::borrow<address, vector<0x2::object::ID>>(v0, arg4), &arg1)) {
        ...
        } else if (!0x2::table::contains<0x2::object::ID, 0x2::object::ID>(&arg0.filled_offers, arg1)) {
