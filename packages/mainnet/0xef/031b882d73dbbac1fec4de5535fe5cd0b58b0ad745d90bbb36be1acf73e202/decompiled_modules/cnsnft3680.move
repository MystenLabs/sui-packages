module 0xef031b882d73dbbac1fec4de5535fe5cd0b58b0ad745d90bbb36be1acf73e202::cnsnft3680 {
    struct CNSNFT3680 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3680, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3680>(arg0, arg1);
