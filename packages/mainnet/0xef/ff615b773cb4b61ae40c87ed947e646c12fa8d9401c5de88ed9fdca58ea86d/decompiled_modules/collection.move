module 0xefff615b773cb4b61ae40c87ed947e646c12fa8d9401c5de88ed9fdca58ea86d::collection {
    ...
    fun init(arg0: COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Blubber>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"Blubbers Whitelist Ticket"));
        0x2::display::add<Blubber>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"You have been whitelisted to mint a Blubber. You can mint one by burning this ticket on chain!"));
