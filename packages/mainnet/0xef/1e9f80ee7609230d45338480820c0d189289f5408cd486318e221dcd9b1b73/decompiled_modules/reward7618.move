module 0xef1e9f80ee7609230d45338480820c0d189289f5408cd486318e221dcd9b1b73::reward7618 {
    struct REWARD7618 has drop {
        dummy_field: bool,
    }

    struct TICKET_7618 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7618(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7618>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7618>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7618, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7618>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7618>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7618>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7618>>(v5, 0x2::tx_context::sender(arg1));
    }
