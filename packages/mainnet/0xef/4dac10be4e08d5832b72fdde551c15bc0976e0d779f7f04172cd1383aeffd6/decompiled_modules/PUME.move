module 0xef4dac10be4e08d5832b72fdde551c15bc0976e0d779f7f04172cd1383aeffd6::PUME {
    ...
    fun init(arg0: PUME, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::transfer::public_transfer<0x2::coin::Coin<PUME>>(0x2::coin::mint<PUME>(&mut v2, 21000000000000, arg1), 0x2::tx_context::sender(arg1));
