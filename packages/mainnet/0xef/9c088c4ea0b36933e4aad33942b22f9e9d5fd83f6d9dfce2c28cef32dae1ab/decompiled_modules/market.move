module 0x780911cb11b6e6df09b2020d576810341c2df462c32047ab32f71316e44d2f5d::market {
    ...
    public fun join_position(arg0: &mut MarketPosition, arg1: MarketPosition, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.market_state_id == arg1.market_state_id, 0x780911cb11b6e6df09b2020d576810341c2df462c32047ab32f71316e44d2f5d::error::market_invalid_market_position());
        arg0.lp_amount = arg0.lp_amount + arg1.lp_amount;
        let MarketPosition {
            id              : v0,
            market_state_id : _,
            expiry          : _,
