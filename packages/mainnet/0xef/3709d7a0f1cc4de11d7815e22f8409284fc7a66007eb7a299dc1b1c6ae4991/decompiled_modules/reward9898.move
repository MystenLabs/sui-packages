module 0xef3709d7a0f1cc4de11d7815e22f8409284fc7a66007eb7a299dc1b1c6ae4991::reward9898 {
    struct REWARD9898 has drop {
        dummy_field: bool,
    }

    struct TICKET_9898 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9898(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9898>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9898>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9898, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9898>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9898>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9898>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9898>>(v5, 0x2::tx_context::sender(arg1));
    }
