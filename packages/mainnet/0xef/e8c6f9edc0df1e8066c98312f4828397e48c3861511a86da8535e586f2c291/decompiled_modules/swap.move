module 0xefe8c6f9edc0df1e8066c98312f4828397e48c3861511a86da8535e586f2c291::swap {
    struct OrderService has store, key {
        id: 0x2::object::UID,
        balances: 0xefe8c6f9edc0df1e8066c98312f4828397e48c3861511a86da8535e586f2c291::balance_bag::BalanceBag,
    ...
    public entry fun deposit<T0>(arg0: &mut OrderService, arg1: &AdminCap, arg2: 0x2::coin::Coin<T0>) {
        ...
        if (!0xefe8c6f9edc0df1e8066c98312f4828397e48c3861511a86da8535e586f2c291::balance_bag::contains<T0>(&arg0.balances)) {
            0xefe8c6f9edc0df1e8066c98312f4828397e48c3861511a86da8535e586f2c291::balance_bag::init_balance<T0>(&mut arg0.balances);
            0x1::vector::push_back<0x1::ascii::String>(&mut arg0.coins, 0x1::type_name::into_string(0x1::type_name::get<T0>()));
        };
        0xefe8c6f9edc0df1e8066c98312f4828397e48c3861511a86da8535e586f2c291::balance_bag::join<T0>(&mut arg0.balances, 0x2::coin::into_balance<T0>(arg2));
    }

    public entry fun get_balance<T0>(arg0: &mut OrderService, arg1: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = BalanceResultEvent{balance: 0xefe8c6f9edc0df1e8066c98312f4828397e48c3861511a86da8535e586f2c291::balance_bag::value<T0>(&arg0.balances)};
        0x2::event::emit<BalanceResultEvent>(v0);
        0xefe8c6f9edc0df1e8066c98312f4828397e48c3861511a86da8535e586f2c291::balance_bag::value<T0>(&arg0.balances)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = OrderService{
            ...
            balances : 0xefe8c6f9edc0df1e8066c98312f4828397e48c3861511a86da8535e586f2c291::balance_bag::new(arg0),
    ...
    fun withdraw<T0>(arg0: &mut OrderService, arg1: &AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        check_admin(arg0, arg1);
        assert!(0xefe8c6f9edc0df1e8066c98312f4828397e48c3861511a86da8535e586f2c291::balance_bag::value<T0>(&arg0.balances) >= arg2, 4);
        0x2::coin::from_balance<T0>(0xefe8c6f9edc0df1e8066c98312f4828397e48c3861511a86da8535e586f2c291::balance_bag::split<T0>(&mut arg0.balances, arg2), arg3)
    }
