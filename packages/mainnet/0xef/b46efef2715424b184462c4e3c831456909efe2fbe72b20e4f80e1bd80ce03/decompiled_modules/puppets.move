module 0xefb46efef2715424b184462c4e3c831456909efe2fbe72b20e4f80e1bd80ce03::puppets {
    ...
    fun init(arg0: PUPPETS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<PUPPETS_NFT>(&mut v4, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://walrus.doonies.net/puppets/{token_id}.png"));
