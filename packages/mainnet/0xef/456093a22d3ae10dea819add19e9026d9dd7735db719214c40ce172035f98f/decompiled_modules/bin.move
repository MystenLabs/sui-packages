module 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::bin {
    ...
    public(friend) fun accumulate_fee(arg0: &mut Bin, arg1: u64, arg2: u64) {
        arg0.fee_a_growth_global = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_add(arg0.fee_a_growth_global, 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_growth_by_amount(arg1, arg0.liquidity_supply));
        arg0.fee_b_growth_global = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_add(arg0.fee_b_growth_global, 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_growth_by_amount(arg2, arg0.liquidity_supply));
    }

    public(friend) fun accumulate_rewards(arg0: &mut Bin, arg1: vector<u128>) {
        let v0 = 0;
        assert!(arg0.liquidity_supply > 0, 13906836029770039309);
        while (v0 < 0x1::vector::length<u128>(&arg1)) {
            if (0x1::vector::length<u128>(&arg0.rewards_growth_global) <= v0) {
                0x1::vector::push_back<u128>(&mut arg0.rewards_growth_global, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_floor(*0x1::vector::borrow<u128>(&arg1, v0), 1 << 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::scale_offset(), arg0.liquidity_supply));
            } else {
                let v1 = 0x1::vector::borrow_mut<u128>(&mut arg0.rewards_growth_global, v0);
                *v1 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_add(*v1, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_floor(*0x1::vector::borrow<u128>(&arg1, v0), 1 << 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::scale_offset(), arg0.liquidity_supply));
            };
            v0 = v0 + 1;
        };
    }
    ...
    public fun bin_score(arg0: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32) : u64 {
        let v0 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::add(arg0, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from(0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::price_math::bin_bound())));
        assert!(v0 >= 0 && v0 <= 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::price_math::bin_bound() * 2, 13906837103511207939);
        (v0 as u64)
    }
    ...
    public(friend) fun borrow_bin(arg0: &BinManager, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32) : &Bin {
        assert!(contains(arg0, arg1), 13906834689739456513);
    ...
    public(friend) fun borrow_bin_from_score(arg0: &BinManager, arg1: u64) : &Bin {
        assert!(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::skip_list::contains<Bin>(&arg0.bins, arg1), 13906836330416963585);
    ...
    public(friend) fun borrow_bin_mut(arg0: &mut BinManager, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32) : &mut Bin {
        assert!(contains(arg0, arg1), 13906834758458933249);
    ...
    public fun calculate_out_amount(arg0: &Bin, arg1: u128) : (u64, u64) {
        0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_amounts_by_liquidity(arg0.amount_a, arg0.amount_b, arg1, arg0.liquidity_supply)
    }

    public(friend) fun decrease_liquidity(arg0: &mut Bin, arg1: u128) : (u64, u64) {
        assert!(arg1 <= arg0.liquidity_supply, 13906835239495663623);
        if (arg0.liquidity_supply == 0) {
            return (0, 0)
        };
        let (v0, v1) = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_amounts_by_liquidity(arg0.amount_a, arg0.amount_b, arg1, arg0.liquidity_supply);
    ...
    fun default_bin(arg0: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg1: u16) : Bin {
        Bin{
            ...
            amount_a              : 0,
            amount_b              : 0,
            price                 : 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::price_math::get_price_from_id(arg0, arg1),
            liquidity_supply      : 0,
    ...
    public fun fetch_bins(arg0: &BinManager, arg1: vector<u32>, arg2: u64) : vector<BinInfo> {
        ...
        let v1 = if (0x1::vector::is_empty<u32>(&arg1)) {
            ...
            assert!(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::skip_list::contains<Bin>(&arg0.bins, v2), 13906836497920688129);
    ...
    public(friend) fun increase_liquidity(arg0: &mut Bin, arg1: u64, arg2: u64, arg3: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32) : u128 {
        if (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(id(arg0), arg3)) {
            ...
            assert!(arg2 == 0, 13906835123531415557);
            arg0.amount_a = arg0.amount_a + arg1;
        } else {
            assert!(arg1 == 0, 13906835136416317445);
            arg0.amount_b = arg0.amount_b + arg2;
        };
        let v0 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_liquidity_by_amounts(arg1, arg2, arg0.price);
    ...
    public(friend) fun remove_bin(arg0: &mut BinManager, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32) {
        assert!(contains(arg0, arg1), 13906834951732461569);
        let Bin {
            id                    : _,
            amount_a              : v1,
            amount_b              : v2,
        ...
        assert!(v8, 13906834986092724233);
    }
    ...
    public(friend) fun swap_exact_amount_in(arg0: &mut Bin, arg1: u64, arg2: bool, arg3: u64, arg4: u64) : (u64, u64, u64, u64) {
        let (v0, v1, v2, v3) = if (arg2) {
            let v4 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_fee_inclusive(arg1, arg3);
            let v5 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_amount_out(arg1 - v4, arg0.price, arg2);
            let (v6, v7, v8) = if (v5 <= arg0.amount_b) {
                (arg1, (v5 as u64), v4)
            } else {
                let v9 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_amount_in(arg0.amount_b, arg0.price, arg2);
                let v10 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_fee_exclusive(v9, arg3);
                let v11 = v9 + v10;
                assert!(v11 <= arg1, 13906835471424159755);
                let v7 = (arg0.amount_b as u64);
                ((v11 as u64), v7, (v10 as u64))
            };
            let v12 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_fee_inclusive(v8, arg4);
            arg0.amount_a = arg0.amount_a + v6 - v8;
            arg0.amount_b = arg0.amount_b - v7;
            accumulate_fee(arg0, v8 - v12, 0);
            (v12, v6, v7, v8)
        } else {
            let v13 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_fee_inclusive(arg1, arg3);
            let v14 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_amount_out(arg1 - v13, arg0.price, arg2);
            let (v15, v16, v17) = if (v14 <= arg0.amount_a) {
                (arg1, (v14 as u64), v13)
            } else {
                let v18 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_amount_in(arg0.amount_a, arg0.price, arg2);
                let v19 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_fee_exclusive(v18, arg3);
                let v20 = v18 + v19;
                assert!(v20 <= arg1, 13906835587388276747);
                let v16 = (arg0.amount_a as u64);
                ((v20 as u64), v16, (v19 as u64))
            };
            let v21 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_fee_inclusive(v17, arg4);
    ...
    public(friend) fun swap_exact_amount_out(arg0: &mut Bin, arg1: u64, arg2: bool, arg3: u64, arg4: u64) : (u64, u64, u64, u64) {
        if (arg2) {
            ...
            let v5 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_amount_in(v4, arg0.price, arg2);
            let v6 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_fee_exclusive(v5, arg3);
            let v7 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_fee_inclusive(v6, arg4);
            ...
            let v9 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_amount_in(v8, arg0.price, arg2);
            let v10 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_fee_exclusive(v9, arg3);
            let v11 = 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::dlmm_math::calculate_fee_inclusive(v10, arg4);
