module 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::reward {
    ...
    public(friend) fun add_reward<T0>(arg0: &mut RewardManager, arg1: vector<u64>, arg2: u64, arg3: 0x2::balance::Balance<T0>, arg4: &0x2::clock::Clock) {
        ...
        assert!((arg2 - 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::reward_period_start_at()) % 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::reward_period() == 0, 13906835080582397967);
        let v1 = if (0x1::vector::is_empty<u64>(&arg1)) {
            v0
        } else {
            assert!(0x1::vector::length<u64>(&arg1) == 1, 13906835097762136077);
            let v2 = 0x1::vector::pop_back<u64>(&mut arg1);
            assert!(v2 >= v0, 13906835106352070669);
            assert!(v2 < arg2, 13906835110647037965);
            assert!((v2 - 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::reward_period_start_at()) % 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::reward_period() == 0, 13906835123531939853);
            v2
        };
        let v3 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_floor((0x2::balance::value<T0>(&arg3) as u128), 1 << 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::scale_offset(), ((arg2 - v1) as u128));
        let v4 = get_index<T0>(arg0);
        let v5 = borrow_mut_reward(arg0, v4);
        if ((v1 - 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::reward_period_start_at()) % 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::reward_period() == 0) {
        ...
        if (v1 == v0) {
            assert!(340282366920938463463374607431768211455 - v5.current_emission_rate >= v3, 13906835278150631435);
    ...
    public(friend) fun borrow_mut_reward_by_type<T0>(arg0: &mut RewardManager) : &mut Reward {
        ...
        assert!(0x1::option::is_some<u64>(&v0), 13906836021179580421);
    ...
    public fun borrow_reward_by_type<T0>(arg0: &RewardManager) : &Reward {
        let v0 = reward_index<T0>(arg0);
        assert!(0x1::option::is_some<u64>(&v0), 13906836072719187973);
    ...
    fun current_period_end_time(arg0: u64) : u64 {
        assert!(arg0 >= 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::reward_period_start_at(), 13906837202296635413);
        arg0 + 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::reward_period() - (arg0 - 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::reward_period_start_at()) % 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::reward_period()
    }
    ...
    public fun get_index<T0>(arg0: &RewardManager) : u64 {
        let v0 = reward_index<T0>(arg0);
        assert!(0x1::option::is_some<u64>(&v0), 13906836618180034565);
    ...
    public(friend) fun initialize_reward<T0>(arg0: &mut RewardManager, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::length<Reward>(&arg0.rewards) < 0xef456093a22d3ae10dea819add19e9026d9dd7735db719214c40ce172035f98f::constants::max_reward_num(), 13906834904487952387);
        let v1 = Reward{
    ...
    public(friend) fun rollover_refunds_into_remaining_time(arg0: &mut RewardManager, arg1: vector<u128>, arg2: &0x2::clock::Clock) {
        ...
        while (v0 < 0x1::vector::length<Reward>(&arg0.rewards)) {
            ...
            assert!(v2.reward_refunded < 340282366920938463463374607431768211455, 13906835686173048851);
    ...
    public(friend) fun settle_rewards(arg0: &mut RewardManager, arg1: &0x2::clock::Clock) : vector<u128> {
        ...
        assert!(v0 < v1, 13906835406999388167);
        let v2 = 0;
        ...
        while (v2 < 0x1::vector::length<Reward>(&arg0.rewards)) {
            ...
            while (0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::option_u64::is_some(&v5) && v1 > v0) {
                ...
                assert!(!0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::is_neg(v8), 13906835527259127825);
    ...
    public(friend) fun withdraw<T0>(arg0: &mut RewardManager, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.vault, v1), 13906836223043305481);
        let v2 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.vault, v1);
        assert!(0x2::balance::value<T0>(v2) >= arg1, 13906836231633240073);
