module 0x9cac37ad544a16120a128a1237363766b9348f511d853f15794f1bfd5a9e0f53::maker {
    ...
    public(friend) fun plan<T0, T1>(arg0: &MakerKernel<T0, T1>, arg1: u8, arg2: u64, arg3: u64, arg4: u64, arg5: bool, arg6: bool) : (u64, u8, bool) {
        ...
        let v2 = if (v1 == 2) {
            px_b(arg3, param<T0, T1>(arg0, 7), arg1)
        } else if (v1 == 3) {
            px_c(arg2, param<T0, T1>(arg0, 7), arg4, param<T0, T1>(arg0, 1), arg1)
        } else {
            px_a(arg2, param<T0, T1>(arg0, 7), (param<T0, T1>(arg0, 0) as u8), arg1)
        };
        (v2, v1, v0)
    }
    ...
    fun px_a(arg0: u64, arg1: u64, arg2: u8, arg3: u8) : u64 {
        ...
        let v3 = if (arg3 == 1 && !v0 || !!v0) {
            assert!(arg0 > v2, 0x9cac37ad544a16120a128a1237363766b9348f511d853f15794f1bfd5a9e0f53::errors::maker_price_underflow());
            arg0 - v2
        } else {
