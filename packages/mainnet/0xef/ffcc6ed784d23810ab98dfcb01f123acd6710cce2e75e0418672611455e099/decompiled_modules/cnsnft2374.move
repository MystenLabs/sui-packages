module 0xefffcc6ed784d23810ab98dfcb01f123acd6710cce2e75e0418672611455e099::cnsnft2374 {
    struct CNSNFT2374 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2374, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2374>(arg0, arg1);
