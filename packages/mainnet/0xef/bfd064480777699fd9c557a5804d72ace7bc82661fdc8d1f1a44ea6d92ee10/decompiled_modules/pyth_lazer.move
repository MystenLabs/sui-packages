module 0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::pyth_lazer {
    public fun parse_and_verify_le_ecdsa_update(arg0: &0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::state::State, arg1: &0x2::clock::Clock, arg2: vector<u8>) : 0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::update::Update {
        0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::update::from_v2(parse_and_verify_le_ecdsa_update_v2(arg0, arg1, arg2))
    }

    public fun parse_and_verify_le_ecdsa_update_v2(arg0: &0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::state::State, arg1: &0x2::clock::Clock, arg2: vector<u8>) : 0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::update_v2::Update {
        let v0 = 0x2::bcs::new(arg2);
        assert!(0x2::bcs::peel_u32(&mut v0) == 1296547300, 13906834569480830984);
        ...
        assert!((0x2::bcs::peel_u16(&mut v0) as u64) == 0x1::vector::length<u8>(&v3), 13906834633905602572);
        let v4 = 0x2::bcs::new(v3);
        assert!(0x2::bcs::peel_u32(&mut v4) == 2479346549, 13906834655380307978);
        verify_le_ecdsa_message(arg0, arg1, &v1, &v3);
        0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::update_v2::parse_from_cursor(v4)
    }
    ...
    public(friend) fun verify_le_ecdsa_message(arg0: &0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::state::State, arg1: &0x2::clock::Clock, arg2: &vector<u8>, arg3: &vector<u8>) {
        ...
        while (v3 < 0x1::vector::length<0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::state::TrustedSignerInfo>(v2)) {
            if (0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::state::public_key(0x1::vector::borrow<0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::state::TrustedSignerInfo>(v2, v3)) == &v1) {
                ...
                /* label 4 */
                assert!(0x1::option::is_some<u64>(&v4), 13906834432041615364);
                assert!(0x2::clock::timestamp_ms(arg1) < 0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::state::expires_at_ms(0x1::vector::borrow<0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::state::TrustedSignerInfo>(v2, 0x1::option::extract<u64>(&mut v4))), 13906834444926648326);
                return
            };
            v3 = v3 + 1;
        };
