module 0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::update_v2 {
    struct Update has copy, drop {
        timestamp: u64,
        channel: 0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::channel_v2::Channel,
    ...
    public(friend) fun parse_from_cursor(arg0: 0x2::bcs::BCS) : Update {
        ...
        assert!(0x1::vector::length<u8>(&v2) == 0, 13906834427746451457);
        Update{
            timestamp : 0x2::bcs::peel_u64(&mut arg0),
            channel   : 0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::channel_v2::from_u8(0x2::bcs::peel_u8(&mut arg0)),
            feeds     : v0,
        }
    }

    public fun channel(arg0: &Update) : 0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::channel_v2::Channel {
        arg0.channel
    }
    ...
    public(friend) fun new(arg0: u64, arg1: 0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::channel_v2::Channel, arg2: vector<0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::feed::Feed>) : Update {
        Update{
            timestamp : arg0,
            channel   : arg1,
            feeds     : arg2,
