module 0xef484f6dc504a7f02ed2a4cb349847f50766f8e4b10f21c281a9c6458389193d::reward3922 {
    struct REWARD3922 has drop {
        dummy_field: bool,
    }

    struct TICKET_3922 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3922(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3922>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3922>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3922, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3922>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3922>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3922>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3922>>(v5, 0x2::tx_context::sender(arg1));
    }
