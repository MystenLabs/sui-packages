module 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook {
    ...
    public(friend) fun add_listing<T0: store + key, T1>(arg0: &mut Store, arg1: &0x2::object::UID, arg2: 0x2::object::ID, arg3: address, arg4: 0x2::object::ID, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::utils::encode_order_id(false, arg5, arg0.index);
        let v4 = Listing{
            listing_id : arg2,
            market     : v0,
            index      : v3,
        ...
        if (!0x2::dynamic_field::exists<OrderbookKey>(&arg0.id, v5)) {
            0x2::dynamic_field::add<OrderbookKey, 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::BigVector<0x2::object::ID>>(&mut arg0.id, v5, 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::empty<0x2::object::ID>(64, 64, arg6));
        };
        0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::insert<0x2::object::ID>(0x2::dynamic_field::borrow_mut<OrderbookKey, 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::BigVector<0x2::object::ID>>(&mut arg0.id, v5), v3, arg2);
    ...
    public fun get_floor_listing<T0: store + key, T1>(arg0: &Store) : (bool, 0x2::object::ID, 0x1::ascii::String, address, 0x2::object::ID, 0x1::ascii::String, u64) {
        ...
        let v1 = 0x2::dynamic_field::borrow<OrderbookKey, 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::BigVector<0x2::object::ID>>(&arg0.id, v0);
        let (v2, v3) = 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::min_slice<0x2::object::ID>(v1);
        let v4 = v2;
        if (0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::slice_is_null(&v4)) {
            return empty_listing<T1>()
        };
        let v5 = 0x2::dynamic_field::borrow<0x2::object::ID, Listing>(&arg0.id, *0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::slice_borrow<0x2::object::ID>(0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::borrow_slice<0x2::object::ID>(v1, v4), v3));
    ...
    public fun get_next_floor_listing<T0: store + key, T1>(arg0: &Store, arg1: 0x2::object::ID) : (bool, 0x2::object::ID, 0x1::ascii::String, address, 0x2::object::ID, 0x1::ascii::String, u64) {
        ...
        let v5 = 0x2::dynamic_field::borrow<OrderbookKey, 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::BigVector<0x2::object::ID>>(&arg0.id, v2);
        let (v6, v7) = 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::slice_around<0x2::object::ID>(v5, v4);
        let (v8, v9) = 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::next_slice<0x2::object::ID>(v5, v6, v7);
        let v10 = v8;
        if (0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::slice_is_null(&v10)) {
            return empty_listing<T1>()
        };
        let v11 = 0x2::dynamic_field::borrow<0x2::object::ID, Listing>(&arg0.id, *0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::slice_borrow<0x2::object::ID>(0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::borrow_slice<0x2::object::ID>(v5, v10), v9));
    ...
    public(friend) fun remove_listing<T0: store + key, T1>(arg0: &mut Store, arg1: &0x2::object::UID, arg2: 0x2::object::ID) {
        ...
        0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::remove<0x2::object::ID>(0x2::dynamic_field::borrow_mut<OrderbookKey, 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::big_vector::BigVector<0x2::object::ID>>(&mut arg0.id, v3), v2.index);
        let Listing {
            listing_id : v4,
            market     : v5,
            index      : _,
