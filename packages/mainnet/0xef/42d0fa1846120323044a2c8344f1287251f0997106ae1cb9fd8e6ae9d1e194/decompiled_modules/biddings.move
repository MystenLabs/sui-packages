module 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::biddings {
    ...
    public fun accept_bid_with_transfer_policy<T0: store + key, T1>(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: 0x2::object::ID, arg3: 0x1::option::Option<0x2::object::ID>, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: 0x2::object::ID, arg7: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg8: &mut 0xc0033a3335c357bc25d6f0aef2edd0f714dae79b9f106901fe27b8ca31b7e2b::royalty_vault::RoyaltyVault<T0, T1>, arg9: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        let v1 = 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::transfers::royalty_amount<T0>(arg7, v0.price);
        assert!(v1 <= v0.royalty, 6);
        let (v2, v3) = 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::transfers::zero_purchase<T0>(arg4, 0x2::kiosk::list_with_purchase_cap<T0>(arg4, arg5, arg6, 0, arg9), arg7, arg9);
        let v4 = v3;
        let v5 = v2;
        ...
        0xc0033a3335c357bc25d6f0aef2edd0f714dae79b9f106901fe27b8ca31b7e2b::royalty_vault::deposit<T0, T1>(arg8, arg7, 0x2::balance::split<T1>(&mut v0.balance, v1));
        deposit<T1>(arg1, 0x2::balance::withdraw_all<T1>(&mut v0.balance));
        consume_bid<T1>(v0, 0x2::object::id<T0>(&v5), 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::transfers::transfer_to<T0>(arg7, &mut v4, v5, v0.buyer, arg9));
        v4
    }
    ...
    public fun create_bid_with_transfer_policy<T0: store + key, T1>(arg0: &mut Store, arg1: u64, arg2: 0x1::option::Option<0x2::object::ID>, arg3: 0x1::option::Option<0x2::object::ID>, arg4: 0x1::option::Option<vector<u8>>, arg5: 0x1::option::Option<u64>, arg6: u64, arg7: &0x2::transfer_policy::TransferPolicy<T0>, arg8: 0x2::coin::Coin<T1>, arg9: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        if (0x1::type_name::with_defining_ids<T1>() != 0x1::type_name::with_defining_ids<0x2::sui::SUI>()) {
            0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::transfers::assert_settleable<T0>(arg7);
            assert!(0xc0033a3335c357bc25d6f0aef2edd0f714dae79b9f106901fe27b8ca31b7e2b::royalty_vault::has_vault<T0, T1>(arg7), 12);
        };
        ...
        create_bid<T0, T1>(arg0, arg1, v1, arg2, arg3, arg4, arg5, arg6, 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::transfers::royalty_amount<T0>(arg7, arg6), arg8, arg9)
    }
