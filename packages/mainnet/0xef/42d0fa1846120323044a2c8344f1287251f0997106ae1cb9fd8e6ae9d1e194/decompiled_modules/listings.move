module 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::listings {
    ...
    public fun buy_ob_listing_with_transfer_policy<T0: store + key, T1>(arg0: &mut Store, arg1: &mut 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::Store, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: address, arg6: 0x2::object::ID, arg7: &mut 0x2::coin::Coin<T1>, arg8: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg9: &mut 0xc0033a3335c357bc25d6f0aef2edd0f714dae79b9f106901fe27b8ca31b7e2b::royalty_vault::RoyaltyVault<T0, T1>, arg10: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        verify_version(arg0);
        ...
        if (0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::is_market_authorized(arg1, &arg0.id)) {
            0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::remove_listing<T0, T1>(arg1, &arg0.id, 0x2::object::uid_to_inner(&v7));
        };
        let v8 = 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::transfers::royalty_amount<T0>(arg8, v4);
        let v9 = market_fee(arg0, v4);
        assert!(0x2::coin::value<T1>(arg7) >= v4 + v8 + v9, 4);
        let (v10, v11) = 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::transfers::zero_purchase<T0>(arg2, 0x2::dynamic_object_field::remove<0x2::object::ID, 0x2::kiosk::PurchaseCap<T0>>(&mut v0.id, arg6), arg8, arg10);
        let v12 = v11;
        0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::transfers::place_or_lock<T0>(arg8, &mut v12, v10, arg3, arg4);
        deposit<T1>(arg0, 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::transfers::settle_payment<T0, T1>(arg7, arg9, arg8, v5, v4, v8, v9, arg10));
    ...
    public fun buy_ob_listing_without_transfer_policy<T0: store + key, T1>(arg0: &mut Store, arg1: &mut 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::Store, arg2: 0x2::object::ID, arg3: &mut 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, SimpleListing<T0, T1>>(&arg0.id, arg2), 3);
        ...
        if (0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::is_market_authorized(arg1, &arg0.id)) {
            0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::remove_listing<T0, T1>(arg1, &arg0.id, 0x2::object::uid_to_inner(&v8));
        };
    ...
    public fun cancel_ob_listing_with_transfer_policy<T0: store + key, T1>(arg0: &mut Store, arg1: &mut 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::Store, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID) {
        verify_version(arg0);
    ...
    public fun cancel_ob_listing_without_transfer_policy<T0: store + key, T1>(arg0: &mut Store, arg1: &mut 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::Store, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, SimpleListing<T0, T1>>(&arg0.id, arg2), 3);
        remove_sponsored_listing_if_exists<T0>(arg0, arg2);
    ...
    public fun create_ob_listing_with_transfer_policy<T0: store + key, T1>(arg0: &mut Store, arg1: &mut 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::Store, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: address, arg6: 0x2::object::ID, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = if (0x1::type_name::with_defining_ids<T1>() == 0x1::type_name::with_defining_ids<0x2::sui::SUI>()) {
            ...
            0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::transfers::assert_settleable<T0>(arg4);
            assert!(0xc0033a3335c357bc25d6f0aef2edd0f714dae79b9f106901fe27b8ca31b7e2b::royalty_vault::has_vault<T0, T1>(arg4), 8);
            0
        };
        ...
        if (0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::is_market_authorized(arg1, &arg0.id)) {
            0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::add_listing<T0, T1>(arg1, &arg0.id, 0x2::object::uid_to_inner(&v3.id), arg5, arg6, arg7, arg8);
        };
    ...
    public fun create_ob_listing_without_transfer_policy<T0: store + key, T1>(arg0: &mut Store, arg1: &mut 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::Store, arg2: T0, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0;
        ...
        if (0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::is_market_authorized(arg1, &arg0.id)) {
            0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::add_listing<T0, T1>(arg1, &arg0.id, 0x2::object::uid_to_inner(&v3.id), v0, v2, arg3, arg4);
        };
        let v4 = CreateSimpleListingEvent{
            type                  : v1,
            nft_id                : v2,
    ...
    public fun get_listing_price_with_transfer_policy<T0: store + key, T1>(arg0: &Store, arg1: 0x2::object::ID, arg2: &0x2::transfer_policy::TransferPolicy<T0>) : u64 {
        ...
        v0.price + market_fee(arg0, v0.price) + 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::transfers::royalty_amount<T0>(arg2, v0.price)
    }
    ...
    public fun relist_ob_listing_with_transfer_policy<T0: store + key, T1>(arg0: &mut Store, arg1: &mut 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::Store, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, SimpleListing<T0, T1>>(&arg0.id, arg4), 3);
        ...
        if (0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::is_market_authorized(arg1, &arg0.id)) {
            0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::remove_listing<T0, T1>(arg1, &arg0.id, v1);
            0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::add_listing<T0, T1>(arg1, &arg0.id, v1, v0.seller, arg4, arg5, arg6);
        };
        let v2 = if (0x1::type_name::with_defining_ids<T1>() == 0x1::type_name::with_defining_ids<0x2::sui::SUI>()) {
            arg5
        } else {
    ...
    public fun relist_ob_listing_without_transfer_policy<T0: store + key, T1>(arg0: &mut Store, arg1: &mut 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::Store, arg2: 0x2::object::ID, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, SimpleListing<T0, T1>>(&arg0.id, arg2), 3);
        ...
        if (0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::is_market_authorized(arg1, &arg0.id)) {
            0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::remove_listing<T0, T1>(arg1, &arg0.id, v1);
            0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::add_listing<T0, T1>(arg1, &arg0.id, v1, v0.seller, arg2, arg3, arg4);
        };
    ...
    public fun report_ob_listing<T0: store + key, T1>(arg0: &Store, arg1: &mut 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::Store, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, SimpleListing<T0, T1>>(&arg0.id, arg2), 3);
        let v0 = 0x2::dynamic_object_field::borrow<0x2::object::ID, SimpleListing<T0, T1>>(&arg0.id, arg2);
        if (0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::is_market_authorized(arg1, &arg0.id)) {
            0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::orderbook::add_listing<T0, T1>(arg1, &arg0.id, 0x2::object::uid_to_inner(&v0.id), v0.seller, arg2, v0.price, arg3);
        };
    }
