module 0xef42d0fa1846120323044a2c8344f1287251f0997106ae1cb9fd8e6ae9d1e194::transfers {
    ...
    public(friend) fun settle_payment<T0, T1>(arg0: &mut 0x2::coin::Coin<T1>, arg1: &mut 0xc0033a3335c357bc25d6f0aef2edd0f714dae79b9f106901fe27b8ca31b7e2b::royalty_vault::RoyaltyVault<T0, T1>, arg2: &0x2::transfer_policy::TransferPolicy<T0>, arg3: address, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        assert!(0x2::coin::value<T1>(arg0) >= arg4 + arg5 + arg6, 2);
        if (arg4 > 0) {
            0x2::coin::send_funds<T1>(0x2::coin::split<T1>(arg0, arg4, arg7), arg3);
        };
        if (arg5 > 0) {
            0xc0033a3335c357bc25d6f0aef2edd0f714dae79b9f106901fe27b8ca31b7e2b::royalty_vault::deposit<T0, T1>(arg1, arg2, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(arg0, arg5, arg7)));
        };
        if (arg6 > 0) {
