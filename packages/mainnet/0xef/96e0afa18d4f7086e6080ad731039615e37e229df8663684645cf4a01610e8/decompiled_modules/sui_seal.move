module 0xef96e0afa18d4f7086e6080ad731039615e37e229df8663684645cf4a01610e8::sui_seal {
    ...
    fun init(arg0: SUI_SEAL, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_SEAL>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"sui seal"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiacaas4d23qlwhdx4pd4djmdromrd7mz4tjaei2odxodkri5wrnym"));
