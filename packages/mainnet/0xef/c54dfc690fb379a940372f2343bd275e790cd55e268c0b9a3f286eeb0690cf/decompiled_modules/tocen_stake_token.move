module 0x19d1ef8ca93685979877113a5839a10885b7d44437ff90e389a963b68ec0ab30::tocen_stake_token {
    ...
    public entry fun u_refund_flexible<T0>(arg0: &mut Flexible<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x19d1ef8ca93685979877113a5839a10885b7d44437ff90e389a963b68ec0ab30::witness::check_owner(arg2), 1);
    ...
    public entry fun u_refund_poolstake<T0>(arg0: &mut PoolStake<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x19d1ef8ca93685979877113a5839a10885b7d44437ff90e389a963b68ec0ab30::witness::check_owner(arg2), 1);
        let InfoUserStake {
            id                : v0,
            user_total_stake  : _,
