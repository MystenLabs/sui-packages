module 0xeff48c7e821fa7e96b390c6c8c332e6ddd86b970dd94f44c4ef376e23a739fb2::nautilus_oracle {
    ...
    public entry fun update_prices(arg0: &EnclaveConfig, arg1: &mut NautilusDataStore, arg2: vector<0x2::object::ID>, arg3: vector<u64>, arg4: vector<u64>, arg5: vector<u64>, arg6: vector<u64>, arg7: vector<u64>, arg8: vector<u8>, arg9: vector<u64>, arg10: vector<u8>, arg11: vector<u8>, arg12: &0x2::clock::Clock) {
        ...
        assert!(verify_enclave_signature(arg0, &arg10, &arg11, v0), 1);
        let v1 = 0x1::vector::length<0x2::object::ID>(&arg2);
        assert!(0x1::vector::length<u64>(&arg3) == v1, 7);
        assert!(0x1::vector::length<u64>(&arg4) == v1 * 10, 8);
        assert!(0x1::vector::length<u64>(&arg5) == v1 * 10, 8);
        assert!(0x1::vector::length<u64>(&arg6) == v1, 7);
        assert!(0x1::vector::length<u64>(&arg7) == v1, 7);
        assert!(0x1::vector::length<u8>(&arg8) == v1, 7);
        assert!(0x1::vector::length<u64>(&arg9) == v1, 7);
        let v2 = 0;
        while (v2 < v1) {
            let v3 = *0x1::vector::borrow<0x2::object::ID>(&arg2, v2);
            let v4 = *0x1::vector::borrow<u64>(&arg3, v2);
            let v5 = *0x1::vector::borrow<u64>(&arg7, v2);
            let v6 = *0x1::vector::borrow<u8>(&arg8, v2);
            let v7 = 0x1::vector::empty<u64>();
            let v8 = 0x1::vector::empty<u64>();
            let v9 = 0;
            while (v9 < 10) {
                let v10 = v2 * 10 + v9;
                0x1::vector::push_back<u64>(&mut v7, *0x1::vector::borrow<u64>(&arg4, v10));
                0x1::vector::push_back<u64>(&mut v8, *0x1::vector::borrow<u64>(&arg5, v10));
                v9 = v9 + 1;
            };
            assert!(v4 > 0, 2);
            assert!(v6 == 1 || v6 == 0, 6);
            ...
            emit_timestamp_drift_observability(v3, v11, arg0.max_timestamp_drift_ms);
            assert!(v11 <= arg0.max_timestamp_drift_ms, 3);
            let v12 = RichPriceData{
                market_id    : v3,
                price        : v4,
                bids         : v7,
                asks         : v8,
                volume       : *0x1::vector::borrow<u64>(&arg6, v2),
                timestamp_ms : v5,
                session_flag : v6,
                confidence   : *0x1::vector::borrow<u64>(&arg9, v2),
            };
            if (0x2::table::contains<0x2::object::ID, RichPriceData>(&arg1.prices, v3)) {
                *0x2::table::borrow_mut<0x2::object::ID, RichPriceData>(&mut arg1.prices, v3) = v12;
            } else {
                0x2::table::add<0x2::object::ID, RichPriceData>(&mut arg1.prices, v3, v12);
            };
            v2 = v2 + 1;
        };
    }
