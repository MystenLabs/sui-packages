module 0xdadb7fa2771c2952f96161fc1f0c105d1f22d53926b9ff2498a8eea2f6eb204::doghouse {
    ...
    public fun admin_withdraw_all_balance<T0>(arg0: &mut DogHouse, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_valid_package_version(arg0);
    ...
    public fun admin_withdraw_custodial_pool<T0>(arg0: &mut DogHouse, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_valid_package_version(arg0);
        let v0 = custodial_pool_mut<T0>(arg0, 0x1::type_name::get<T0>());
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v0.balance, 0x2::balance::value<T0>(&v0.balance)), arg2)
    }
    ...
    public fun manager_deposit_custodial_pool<T0>(arg0: &mut DogHouse, arg1: vector<address>, arg2: vector<u64>, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        assert_valid_package_version(arg0);
        assert_sender_is_manager(arg0, arg4);
        if (0x1::vector::length<address>(&arg1) != 0x1::vector::length<u64>(&arg2)) {
            err_address_len_mismatch();
