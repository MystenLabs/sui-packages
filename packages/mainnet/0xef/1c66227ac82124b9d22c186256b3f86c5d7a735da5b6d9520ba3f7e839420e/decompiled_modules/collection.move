module 0xef1c66227ac82124b9d22c186256b3f86c5d7a735da5b6d9520ba3f7e839420e::collection {
    ...
    fun init(arg0: COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3;
        let v5 = v2;
        0xef1c66227ac82124b9d22c186256b3f86c5d7a735da5b6d9520ba3f7e839420e::royalty_rule::add<HouseCollectionBannerNFT>(&mut v5, &v4, 600, 0);
        0xef1c66227ac82124b9d22c186256b3f86c5d7a735da5b6d9520ba3f7e839420e::kiosk_lock_rule::add<HouseCollectionBannerNFT>(&mut v5, &v4);
    ...
    public fun mint(arg0: u64, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) : HouseCollectionBannerNFT {
        ...
        let v0 = HouseCollectionBannerNFT{
            ...
            url  : 0x2::url::new_unsafe_from_bytes(0xef1c66227ac82124b9d22c186256b3f86c5d7a735da5b6d9520ba3f7e839420e::constant::get_nft_image(arg0)),
            tier : arg0,
        };
