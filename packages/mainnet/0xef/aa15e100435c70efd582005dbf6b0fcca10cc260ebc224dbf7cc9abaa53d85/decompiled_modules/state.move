module 0xefaa15e100435c70efd582005dbf6b0fcca10cc260ebc224dbf7cc9abaa53d85::state {
    ...
    entry fun set_config<T0: copy + drop + store, T1: copy + drop + store>(arg0: &mut State, arg1: T0, arg2: T1, arg3: &0xefaa15e100435c70efd582005dbf6b0fcca10cc260ebc224dbf7cc9abaa53d85::capability::AdminCap) {
        0x2::dynamic_field::remove_if_exists<T0, T1>(&mut arg0.id, arg1);
        0x2::dynamic_field::add<T0, T1>(&mut arg0.id, arg1, arg2);
    }

    entry fun update(arg0: &mut State, arg1: bool, arg2: u16, arg3: u256, arg4: &0xefaa15e100435c70efd582005dbf6b0fcca10cc260ebc224dbf7cc9abaa53d85::capability::AdminCap) {
