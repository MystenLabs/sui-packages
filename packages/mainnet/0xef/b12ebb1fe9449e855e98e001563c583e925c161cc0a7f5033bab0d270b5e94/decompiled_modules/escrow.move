module 0xefb12ebb1fe9449e855e98e001563c583e925c161cc0a7f5033bab0d270b5e94::escrow {
    ...
    public entry fun deposit_payment(arg0: vector<u8>, arg1: address, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0xefb12ebb1fe9449e855e98e001563c583e925c161cc0a7f5033bab0d270b5e94::main::WhitelistStorage, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg2);
        assert!(v0 > 0, 0);
        assert!(0xefb12ebb1fe9449e855e98e001563c583e925c161cc0a7f5033bab0d270b5e94::main::is_whitelisted(arg3, arg1), 2);
        let v1 = Escrow{
            id             : 0x2::object::new(arg4),
            appointment_id : arg0,
            amount         : v0,
            client         : 0x2::tx_context::sender(arg4),
            lawyer         : arg1,
            is_completed   : false,
    ...
    public entry fun refund_to_client(arg0: &AdminCap, arg1: &mut Escrow, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.balance, arg1.amount), arg2), arg1.client);
    ...
    public entry fun release_to_lawyer(arg0: &AdminCap, arg1: &mut Escrow, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.is_completed, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.balance, arg1.amount), arg2), arg1.lawyer);
        arg1.is_completed = true;
