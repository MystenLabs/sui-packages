module 0xef58f64579d0ed7d9ecbe7c31fc6c14dc570fcd243c4d5f84b71332ddd1e4a9e::optimizer {
    ...
    fun join_staged_route(arg0: vector<Hop>, arg1: vector<StagedHop>) : vector<Hop> {
        ...
        while (0x1::vector::length<Hop>(&arg0) > 0) {
            ...
            assert!(v13, 3);
            let v14 = 0x1::vector::pop_back<Hop>(&mut v7);
            assert!(v2.kind == 2 && v14.kind == 2 || v2.kind == 3 && v14.kind == 3, 1);
            0x1::vector::push_back<Hop>(&mut v1, v14);
        };
