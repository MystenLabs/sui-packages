module 0xeffd69d3daa181f47b719cfa231344687d92b49a3f34df602b1710fbdba4a370::cnsnft1297 {
    struct CNSNFT1297 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1297, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1297>(arg0, arg1);
