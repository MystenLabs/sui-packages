module 0xefa9a077b21e818362a655ee184d6cd901f4069eb4ceedd30e95d28751a781fc::reward8787 {
    struct REWARD8787 has drop {
        dummy_field: bool,
    }

    struct TICKET_8787 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8787(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8787>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8787>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8787, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8787>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8787>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8787>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8787>>(v5, 0x2::tx_context::sender(arg1));
    }
