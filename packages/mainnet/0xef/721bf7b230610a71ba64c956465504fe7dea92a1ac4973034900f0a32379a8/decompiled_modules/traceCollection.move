module 0xef721bf7b230610a71ba64c956465504fe7dea92a1ac4973034900f0a32379a8::traceCollection {
    ...
    public entry fun lock_nft_in_kiosk(arg0: TraceNFT, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<TraceNFT>, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::kiosk::lock<TraceNFT>(arg1, arg2, arg3, arg0);
    }

    public entry fun mint(arg0: &mut Collection, arg1: address, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: vector<0x1::string::String>, arg8: vector<0x1::string::String>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(is_admin(arg0, 0x2::tx_context::sender(arg10)), 0);
        ...
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1, 0x1::string::utf8(b"collection_name"), arg0.name);
        let v2 = 0;
        ...
        0x2::transfer::transfer<TraceNFT>(v5, arg1);
    }
    ...
    public entry fun place_nft_in_kiosk(arg0: TraceNFT, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::kiosk::place<TraceNFT>(arg1, arg2, arg0);
    }
    ...
    public fun take_nft_from_kiosk(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID) : TraceNFT {
        0x2::kiosk::take<TraceNFT>(arg0, arg1, arg2)
    }
