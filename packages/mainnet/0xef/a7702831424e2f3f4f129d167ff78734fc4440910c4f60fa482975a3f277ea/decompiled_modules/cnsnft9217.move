module 0xefa7702831424e2f3f4f129d167ff78734fc4440910c4f60fa482975a3f277ea::cnsnft9217 {
    struct CNSNFT9217 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9217, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9217>(arg0, arg1);
